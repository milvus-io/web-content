...
<div class="alert note">
If you install your Milvus cluster with the original **docker-compose.yml** file, the data will be stored under **./volume** directory. To change the mapped directory, you can either change it directly in the **docker-compose.yml** file, or run <code>$ export DOCKER_VOLUME_DIRECTORY=</path/to/your/directory></code>.
</div>
