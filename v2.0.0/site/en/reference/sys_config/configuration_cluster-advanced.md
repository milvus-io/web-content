...
> You do not need to change this session if you use the default [**milvus-cluster-docker-compose.yml**](https://github.com/milvus-io/milvus/releases/download/v2.0.0/milvus-cluster-docker-compose.yml) for third-party services.
