...
1. 安装 PyMilvus 及依赖库:
```Python
pip3 install pymilvus==v2.0.0rc6
```
...
```Python
$ wget https://raw.githubusercontent.com/milvus-io/pymilvus/vv2.0.0rc6/examples/hello_milvus.py
```
...
for raw_result in res:
    for result in raw_result:
        ...
        print(id, distance)
```
更多详情，参考 [API Reference](/api-reference/pymilvus/v2.0.0rc6/results.html)。
