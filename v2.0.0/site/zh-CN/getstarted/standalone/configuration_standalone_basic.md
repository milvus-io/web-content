...
<div class="tab-wrapper"><a href="install_standalone-docker.md" class=''>使用 Docker Compose 安装</a><a href="configuration_standalone_basic.md" class='active '>Basic Configurations</a><a href="install_standalone-helm.md" class=''>使用 Helm 安装</a><a href="configuration_standalone_advanced.md" class=''>Advanced Configurations</a></div>
