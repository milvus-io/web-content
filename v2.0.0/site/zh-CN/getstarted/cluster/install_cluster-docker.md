...
<div class="tab-wrapper"><a href="install_cluster-docker.md" class='active '>使用 Docker Compose 安装</a><a href="install_cluster-helm.md" class=''>使用 Kubernetes 安装</a><a href="install_cluster-milvusoperator.md" class=''>使用 Milvus Operator 安装</a></div>
