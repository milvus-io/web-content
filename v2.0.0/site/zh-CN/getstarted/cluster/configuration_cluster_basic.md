...
<div class="tab-wrapper"><a href="install_cluster-docker.md" class=''>使用 Docker Compose 安装</a><a href="configuration_cluster_basic.md" class='active '>Basic Configurations</a><a href="install_cluster-helm.md" class=''>使用 Helm 安装</a><a href="configuration_cluster_advanced.md" class=''>Advanced Configurations</a></div>
