...
> 如使用默认 [**milvus-cluster-docker-compose.yml**](https://github.com/milvus-io/milvus/releases/download/v2.0.0/milvus-cluster-docker-compose.yml) 文件启动第三方服务，则无需修改该部分参数。
