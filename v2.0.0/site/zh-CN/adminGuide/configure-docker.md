...
Download the installation file for Milvus [standalone](https://github.com/milvus-io/milvus/releases/download/v/milvus-cluster-docker-compose.yml), and save it as `docker-compose.yml`.
