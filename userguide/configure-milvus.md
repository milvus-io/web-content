...
2. Modify the parameters in the file.
   ...
   | gpu_index      | If you have multiple GPUs, specify here which GPU will be used for Milvus. Currently, you can only designate one GPU. Default value is 0. | 0 ~ GPU number - 1             |
