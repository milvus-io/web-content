...
This guide describes how to upgrade your Milvus cluster from v2.5.x to v2.6.2 using Milvus Operator.
...
#### 2.3 Upgrade to v2.6.2

Once v2.5.16 is running successfully with `mixCoord`, upgrade to v2.6.2:
