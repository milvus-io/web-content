...
This guide describes how to upgrade your Milvus cluster from v2.5.x to v2.6.24 using Milvus Operator.
...
- You **must** upgrade to v2.5.16 or later with `mixCoord` enabled before upgrading to v2.6.24.
...
#### 2.3 Upgrade to v2.6.24

Once v2.5.16 is running successfully with `mixCoord`, upgrade to v2.6.24:
