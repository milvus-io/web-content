...
![Alert_metric](https://milvus-docs.s3.us-west-2.amazonaws.com/assets/alert_metric.png)

### 2. Save the dashboard
Save the dashboard, and wait for a few minutes to see the alert.

![Alert_dashboard](https://milvus-docs.s3.us-west-2.amazonaws.com/assets/alert_dashboard.png)
...
![Alert_query](https://milvus-docs.s3.us-west-2.amazonaws.com/assets/alert_query.png)
...
![Alert_notification](https://milvus-docs.s3.us-west-2.amazonaws.com/assets/alert_notification.png)

If the alert is successfully created and triggered, you will receive the notification as shown in the screenshot below.

![Notification_message](https://milvus-docs.s3.us-west-2.amazonaws.com/assets/notification_message.png)

To delete an alert, go to the "Alert" panel and click the delete button.

![Delete_alert](https://milvus-docs.s3.us-west-2.amazonaws.com/assets/delete_alert.png)
