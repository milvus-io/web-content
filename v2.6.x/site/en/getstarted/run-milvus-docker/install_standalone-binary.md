...
You can download the RPM/DEB package according to your system architecture from the [Milvus Releases page](https://github.com/milvus-io/milvus/releases/tag/v2.6.21).

- For x86_64/amd64, download the **milvus_2.6.21-1_amd64.deb** or **milvus_2.6.21-1_amd64.rpm** package.
- For ARM64, download the **milvus_2.6.21-1_arm64.deb** or **milvus_2.6.21-1_arm64.rpm** package.
...
```shell
yum install -y ./milvus_2.6.21-1_amd64.rpm
rpm -qa| grep milvus
```
...
```shell
apt install -y  ./milvus_2.6.21-1_amd64.deb
dpkg -l | grep milvus
```
