...
You can download the RPM/DEB package according to your system architecture from the [Milvus Releases page](https://github.com/milvus-io/milvus/releases/tag/v2.6.5).
...
```shell
wget https://github.com/milvus-io/milvus/releases/download/v2.6.5/milvus_2.6.0-1_amd64.rpm -O milvus_2.6.0-1_amd64.rpm
```
