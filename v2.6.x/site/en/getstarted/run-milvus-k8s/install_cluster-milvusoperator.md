...
The command above deploys a Milvus cluster with **Woodpecker** as the message queue (recommended for v2.6.3) and all new architectural components including the Streaming Node. 
