...
<div class="tab-wrapper"><a href="milvus_distributions-cpu.md" class='tab-icon-cpu'>CPU 版 Milvus</a><a href="milvus_distributions-gpu.md" class='active tab-icon-gpu'>GPU 版 Milvus</a></div> 
