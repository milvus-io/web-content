...
<div class="tab-wrapper"><a href="attu_install-docker.md" class=''>Install with Docker Compose</a><a href="milvus_migration-sqlite.md" class=''>SQLite-based Milvus</a><a href="attu_install-helm.md" class=''>Install with Helm Chart</a><a href="milvus_migration-mysql.md" class=''>MySQL-based Milvus</a><a href="attu_install-package.md" class=''>Install with Package</a><a href="milvus_migration-faiss.md" class=''>FAISS</a></div>
