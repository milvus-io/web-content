...
<div class="tab-wrapper"><a href="install_standalone-helm.md" class='active '>使用 Helm 安装</a><a href="install_standalone-docker.md" class=''>使用 Docker Compose 安装</a></div>
