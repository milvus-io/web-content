...
- To upgrade Milvus from v2.2.3 or later releases to 2.5.0-beta, you can [conduct a rolling upgrade](#Conduct-a-rolling-upgrade).
- To upgrade Milvus from a minor release before v2.2.3 to 2.5.0-beta, you are advised to [upgrade Milvus by changing its image version](#Upgrade-Milvus-by-changing-its-image).
- To upgrade Milvus from v2.1.x to 2.5.0-beta, you need to [migrate the metadata](#Migrate-the-metadata) before the actual upgrade.
