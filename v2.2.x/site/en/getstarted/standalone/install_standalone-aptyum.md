...
```bash
$ wget https://github.com/milvus-io/milvus/releases/download/v2.2.0/milvus_2.1.4-1_amd64.deb
$ sudo apt-get update
...
```bash
$ sudo yum install https://github.com/milvus-io/milvus/releases/download/v2.2.0/milvus-2.1.4-1.el7.x86_64.rpm
```
