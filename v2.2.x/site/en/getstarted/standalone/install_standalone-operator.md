...
helm install milvus-operator \
  ...
  --wait --wait-for-jobs \
  https://github.com/milvus-io/milvus-operator/releases/download/v0.7.11/milvus-operator-0.7.11.tgz
```
...
```
$ kubectl delete -f https://raw.githubusercontent.com/milvus-io/milvus-operator/v0.7.11/deploy/manifests/deployment.yaml
```
