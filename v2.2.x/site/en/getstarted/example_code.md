...
- [Milvus 2.2.5](install_standalone-docker.md)
- Python 3 (3.71 or later)
- [PyMilvus 2.2.4](install-pymilvus.md)


## Download example code

[Download](https://raw.githubusercontent.com/milvus-io/pymilvus/v2.2.4/examples/hello_milvus.py) `hello_milvus.py` directly or with the following command.
