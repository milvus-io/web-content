...
- [Milvus 2.2.7](install_standalone-docker.md)
...
[Download](https://raw.githubusercontent.com/milvus-io/pymilvus/v2.2.8/examples/hello_milvus.py) `hello_milvus.py` directly or with the following command.
