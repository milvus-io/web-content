...
[Download](https://github.com/milvus-io/milvus/releases/download/v2.2.7/milvus-cluster-docker-compose.yml) `milvus-cluster-docker-compose.yml` and save it as `docker-compose.yml` manually, or with the following command.
