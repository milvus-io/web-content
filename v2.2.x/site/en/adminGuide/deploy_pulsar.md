...
<div class="alert note">Configurations only take effect after Milvus starts. See <a href=https://milvus.io/docs/v2.2.0/install_cluster-docker.md#Start-Milvus>Start Milvus</a> for more information.</div>
