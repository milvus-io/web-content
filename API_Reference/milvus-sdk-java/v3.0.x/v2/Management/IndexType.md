...
Sets the index type to FMINDEX. This applies to VarChar fields. An exact byte-level substring index that answers anchored LIKE (prefix/infix/suffix) queries with no candidate recheck.
