...
<div>
    ...
    <span style="font-weight: bold;">  http://${MILVUS_URI}/v2/vectordb/users/grant_role</span>
</div>

This operation grants a specified role to the current user. Once granted the role, the user gets permissions allowed for the current role and can perform certain Operations (v2).
