...
<div>
    ...
    <span style="font-weight: bold;">  http://${MILVUS_URI}/v2/vectordb/partitions/drop</span>
</div>
...
curl --location --request POST "http://${MILVUS_URI}/v2/vectordb/partitions/drop" \
...
- Header parameters
    ...
    |------------------|-------------------------------------------------------------------------------------------|
    | `Request-Timeout`  | **integer**(required)<br/>The timeout duration for this operation.<br/>Setting this to None indicates that this operation timeouts when any response arrives or any error occurs.|
