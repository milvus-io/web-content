...
This operation modifies the properties of a specific database.

```javascript
alterDatabase(data): Promise<ResStatus>
```

## Request Syntax

```javascript
milvusClient.alterDatabase({
    db_name: string,
...
- **properties** (*Properties*) -
    ...
    The properties to modify and their expected values in a TypeScript **Record**. Possible properties are as follows:
