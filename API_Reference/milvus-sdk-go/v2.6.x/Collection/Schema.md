...
- `Validate() error`
    ...
    This validates the schema before collection creation. 

    From v2.6.5, validation checks struct-array fields and rejects nil fields, empty sub-field names, duplicate sub-field names, nested array or struct sub-fields, sparse-vector sub-fields, and top-level-only flags on struct sub-fields.
