# NewSparseInvertedIndex()

This function creates a SPARSE_INVERTED_INDEX configuration for sparse vector search using an inverted index structure.
...
idx := index.NewSparseInvertedIndex(entity.COSINE, 0.2)
