...
- **kwargs** -
    ...
    - **is_primary** (*bool*)
        ...
        As an alternative, you can set **primary_field** when creating a **[CollectionSchema](../CollectionSchema/CollectionSchema.md)** object.
    ...
    - **is_partition_key** (*bool*) 
        ...
        As an alternative, you can set **partition_key_field** when creating a **[CollectionSchema](../CollectionSchema/CollectionSchema.md)** object.
