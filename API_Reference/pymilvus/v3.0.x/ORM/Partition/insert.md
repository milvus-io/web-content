...
Using the **partition_name** parameter in the **insert()** method of a **[Collection](../Collection/Collection.md)** object is equivalent to using the **insert()** method of a **[Partition](Partition.md)** object.
