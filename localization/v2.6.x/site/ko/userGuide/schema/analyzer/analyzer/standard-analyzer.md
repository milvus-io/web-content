...
<ul>
<li><p><strong>토큰화 도구</strong>: <code translate="no">standard</code> 토큰화기를 사용하여 문법 규칙에 따라 텍스트를 개별 단어 단위로 분할합니다. 자세한 내용은 <a href="/docs/ko/standard-tokenizer.md">표준 토큰화기를</a> 참조하세요.</p></li>
<li><p><strong>필터</strong>: <code translate="no">lowercase</code> 필터를 사용하여 모든 토큰을 소문자로 변환하여 대소문자를 구분하지 않고 검색할 수 있도록 합니다. 자세한 내용은 <a href="/docs/ko/lowercase-filter.md">소문자를</a> 참조하세요.</p></li>
</ul>
