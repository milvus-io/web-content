...
<li><p>쿼리 벡터가 대상 컬렉션에 이미 존재하는 경우, 검색 전에 검색 벡터를 검색하는 대신 <code translate="no">ids</code> 을 사용하는 것이 좋습니다. 자세한 내용은 <a href="/docs/ko/v2.6.x/primary-key-search.md">기본 키 검색을</a> 참조하세요.</p></li>
</ul>
