...
summary: >-
  ...
  검색을 통해 효율적인 검색 환경을 제공합니다. 이 페이지에서는 기본적인 ANN 검색을 수행하는 방법을 알아볼 수 있습니다.
---
...
<li><p>텍스트 검색</p>
<p>Milvus의 키워드 검색은 특정 용어를 기반으로 정확한 문서 검색을 가능하게 합니다. 이 기능은 주로 특정 조건을 충족하는 필터링 검색에 사용되며, 스칼라 필터링을 통합하여 쿼리 결과를 구체화할 수 있어 스칼라 기준을 충족하는 벡터 내에서 유사도 검색이 가능합니다.</p>
...
<li><p>재랭킹 사용</p>
<p>랭킹러를 사용하여 검색 결과 관련성을 높이는 방법에 대한 자세한 내용은 감점 <a href="/docs/ko/decay-ranker-overview.md">랭킹러 개요</a> 및 <a href="/docs/ko/model-ranker-overview.md">모델 랭킹러 개요를</a> 참조하세요.</p></li>
</ul>
