...
<p>또한, 기본 파라미터로 "RRFRanker"를 사용하여 재랭크 전략을 적용했습니다. 리랭커를 커스터마이징하려면 <a href="https://milvus.io/docs/weighted-ranker.md">Milvus 리랭킹 가이드에</a> 따라 <code translate="no">hybrid_ranker</code> 및 <code translate="no">hybrid_ranker_params</code> 에서 설정할 수 있습니다.</p>
