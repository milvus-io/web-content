...
---
<div class="tab-wrapper"><a href="/docs/ko/v2.6.x/upgrade_milvus_cluster-operator.md" class=''>밀버스</a><a href="/docs/ko/v2.6.x/upgrade_milvus_cluster-helm.md" class='active '>오퍼레이터헬름</a></div>
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">헬름 차트로 밀버스 클러스터 업그레이드하기<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>이 가이드는 헬름 차트를 사용하여 Milvus 클러스터를 v2.5.x에서 v2.6.16으로 업그레이드하는 방법을 설명한다.</p>
...
<ul>
<li>밀버스 v2.6.0-rc1은 v2.6.16과 <strong>호환되지 않는다</strong>. 릴리스 후보에서 직접 업그레이드하는 것은 지원되지 않는다.</li>
...
<li>v2.6.16으로 업그레이드하기 전에 <code translate="no">mixCoordinator</code> 을 활성화한 상태에서 v2.5.16 이상으로 <strong>업그레이드해야</strong> 합니다.</li>
</ul>
...
<h3 id="Step-2-Upgrade-to-v2516-with-mixCoordinator" class="common-anchor-header">2단계: mixCoordinator로 v2.5.16으로 업그레이드하기<button data-href="#Step-2-Upgrade-to-v2516-with-mixCoordinator" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>현재 클러스터에서 별도의 코디네이터를 사용하고 있는지 확인합니다:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v2616" class="common-anchor-header">3단계: v2.6.16으로 업그레이드하기<button data-href="#Step-3-Upgrade-to-v2616" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>v2.5.16이 <code translate="no">mixCoordinator</code> 에서 성공적으로 실행되면 v2.6.16으로 업그레이드합니다:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
