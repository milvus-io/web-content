...
<h2 id="Upgrade-process" class="common-anchor-header">업그레이드 프로세스<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Upgrade-to-v2516" class="common-anchor-header">1단계: v2.5.16으로 업그레이드</h3><div class="alert note">
...
<h3 id="Step-2-Upgrade-to-v260" class="common-anchor-header">2단계: v2.6.0으로 업그레이드하기</h3><p>v2.5.16이 성공적으로 실행되면 v2.6.0으로 업그레이드합니다:</p>
<ol>
