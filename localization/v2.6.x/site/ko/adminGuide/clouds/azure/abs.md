---
id: abs.md
title: 워크로드 신원별로 블롭 스토리지 액세스 구성하기
related_key: 'blob storage, workload identity, iam'
summary: 워크로드 아이덴티티로 Blob 스토리지를 구성하는 방법을 알아보세요.
---
<h1 id="Configure-Blob-Storage-Access-by-Workload-Identity" class="common-anchor-header">워크로드 신원별로 블롭 스토리지 액세스 구성하기<button data-href="#Configure-Blob-Storage-Access-by-Workload-Identity" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
