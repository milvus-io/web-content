...
---
<div class="tab-wrapper"><a href="/docs/ko/v2.6.x/upgrade_milvus_standalone-operator.md" class=''>밀버스</a><a href="/docs/ko/v2.6.x/upgrade_milvus_standalone-helm.md" class='active '>오퍼레이터헬름도커</a><a href="/docs/ko/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>컴포즈</a></div>
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">헬름 차트로 밀버스 스탠드얼론 업그레이드하기<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>이 가이드는 헬름 차트를 사용하여 Milvus 독립 실행형 배포를 v2.5.x에서 v2.6.16으로 업그레이드하는 방법을 설명한다.</p>
