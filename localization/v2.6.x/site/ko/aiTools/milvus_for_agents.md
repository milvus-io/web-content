...
<div class="start_card_container">
  <a href="/docs/ko/integrations_overview.md" style="text-decoration: none; color: inherit;">
    <p class="link-btn" style="font-size: 1rem; white-space: nowrap;">에이전트 프레임워크</p>
    <p style="font-size: 0.875rem; font-weight: 400; color: #555;">LangChain, LlamaIndex, OpenAI 에이전트 및 기타 에이전트 오케스트레이션 프레임워크와 통합.</p>
  </a>
</div>
</div>
...
<tr><td>개발</td><td><a href="/docs/ko/install_standalone-docker.md">Milvus 스탠드얼론</a></td><td>단일 노드 Docker 배포. 현실적인 데이터 볼륨으로 로컬 개발 및 테스트에 적합합니다.</td></tr>
...
<p>에이전트 워크로드의 경우 프로덕션용으로 <strong>Zilliz Cloud를</strong> 사용하는 것이 좋습니다. 에이전트는 일반적으로 인프라를 관리하지 않으므로 서버리스 배포는 운영 오버헤드를 없애고 자동 확장을 제공합니다.</p>
</div>
<h2 id="Quick-connection-examples" class="common-anchor-header">빠른 연결 예시<button data-href="#Quick-connection-examples" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>상담원 코드에서 Milvus에 연결합니다:</p>
...
<li><a href="/docs/ko/quickstart.md">빠른 시작</a> - 몇 분 안에 첫 Milvus 검색을 실행합니다.</li>
<li><a href="/docs/ko/integrations_overview.md">에이전트 프레임워크 통합</a> - Milvus를 LangChain, LlamaIndex, OpenAI 에이전트 등과 연결하세요.</li>
</ul>
