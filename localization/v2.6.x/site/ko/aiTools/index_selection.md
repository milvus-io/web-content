...
<p>자동 인덱스, HNSW, DiskANN, IVF 및 스파스 인덱스를 포함한 Milvus 인덱스 선택 및 조정을 위한 결정 가이드 및 구성 규칙을 확인하세요. 아래의 전체 프롬프트를 AI 도구에 복사하여 이러한 규칙을 자동으로 적용하세요. 모든 프롬프트에 대한 개요는 <a href="/docs/ko/ai_prompts_landing.md">AI 프롬프트를</a> 참조하세요.</p>
