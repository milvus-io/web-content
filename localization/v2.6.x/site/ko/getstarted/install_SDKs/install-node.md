...
title: Milvus Node.js SDK 설치
---
<h1 id="Install-Milvus-Nodejs-SDK" class="common-anchor-header">Milvus Node.js SDK 설치<button data-href="#Install-Milvus-Nodejs-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>이 항목에서는 Milvus용 Milvus Node.js SDK를 설치하는 방법을 설명합니다.</p>
<h2 id="Compatibility" class="common-anchor-header">호환성<button data-href="#Compatibility" class="anchor-icon" translate="no">
    ...
    </button></h2><p>다음 표에는 Milvus 버전과 권장되는 @zilliz/milvus2-sdk-node 버전이 나와 있습니다.</p>
<table>
<thead>
...
<h2 id="Requirement" class="common-anchor-header">필수 사항<button data-href="#Requirement" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Installation" class="common-anchor-header">설치<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Node.js 클라이언트를 사용하기 시작하는 권장 방법은 npm(Node 패키지 관리자)을 사용하여 프로젝트에 종속성을 설치하는 것입니다.</p>
<pre><code translate="no" class="language-javascript">npm install @zilliz/milvus2-sdk-node
# or ...
yarn add @zilliz/milvus2-sdk-node
<button class="copy-code-btn"></button></code></pre>
<p>이렇게 하면 Milvus Node.js SDK가 다운로드되고 package.json 파일에 의존성 항목이 추가됩니다.</p>
<h2 id="Whats-next" class="common-anchor-header">다음 단계<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Node.js SDK를 설치한 후에는 다음을 수행할 수 있습니다:</p>
<ul>
<li><p><a href="https://github.com/milvus-io/milvus-sdk-node">Milvus Node.js SDK 퀵 스타트</a> 보기</p></li>
<li><p>Milvus의 기본 작동 방식 알아보기:</p>
<ul>
...
<li><p><a href="/api-reference/node/v2.6.x/About.md">Milvus Node.js API 참조</a> 살펴보기</p></li>
</ul>
