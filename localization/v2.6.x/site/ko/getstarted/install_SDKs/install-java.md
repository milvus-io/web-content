...
<h2 id="Requirement" class="common-anchor-header">필수 조건<button data-href="#Requirement" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Install-Milvus-Java-SDK" class="common-anchor-header">Milvus Java SDK 설치<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
    ...
    </button></h2><p>다음 명령어를 실행하여 Milvus Java SDK를 설치하십시오.</p>
<ul>
<li>Apache Maven</li>
</ul>
...
<h2 id="Whats-next" class="common-anchor-header">다음 단계<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Java SDK를 설치한 후에는 다음을 수행할 수 있습니다:</p>
<ul>
...
<li><p><a href="/api-reference/java/v2.6.x/About.md">Milvus Java API 참조</a> 살펴보기</p></li>
</ul>
