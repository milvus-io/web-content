...
<h1 id="Install-Milvus-Standalone-with-RPMDEB-Package" class="common-anchor-header">RPM/DEB 패키지를 사용하여 Milvus 독립형 버전 설치<button data-href="#Install-Milvus-Standalone-with-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h1><p>이 페이지에서는 미리 빌드된 RPM/DEB 패키지를 사용하여 Milvus Standalone을 설치하는 방법을 설명합니다.</p>
...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">RPM/DEB 패키지 다운로드<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.24">Milvus 릴리스 페이지에서</a> 사용자의 시스템 아키텍처에 맞는 RPM/DEB 패키지를 다운로드할 수 있습니다.</p>
<ul>
<li>x86_64/amd64의 경우, <strong>milvus_2.6.24-1_amd64.deb</strong> 또는 <strong>milvus_2.6.24-1_amd64.rpm</strong> 패키지를 다운로드하십시오.</li>
<li>ARM64의 경우, <strong>milvus_2.6.24-1_arm64.deb</strong> 또는 <strong>milvus_2.6.24-1_arm64.rpm</strong> 패키지를 다운로드하십시오.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<p>Milvus 바이너리는 <code translate="no">/usr/bin/milvus</code> 에서, systemd 서비스 파일은 <code translate="no">/lib/systemd/system/milvus.service</code> 에서, 종속성 패키지는 <code translate="no">/usr/lib/milvus/</code> 에서 확인할 수 있습니다.</p>
