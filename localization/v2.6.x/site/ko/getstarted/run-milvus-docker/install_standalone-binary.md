...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">RPM/DEB 패키지 다운로드<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.20">Milvus 릴리스 페이지에서</a> 시스템 아키텍처에 맞는 RPM/DEB 패키지를 다운로드할 수 있습니다.</p>
<ul>
<li>x86_64/amd64의 경우, <strong>milvus_2.6.20-1_amd64.deb</strong> 또는 <strong>milvus_2.6.20-1_amd64.rpm</strong> 패키지를 다운로드하십시오.</li>
<li>ARM64의 경우, <strong>milvus_2.6.20-1_arm64.deb</strong> 또는 <strong>milvus_2.6.20-1_arm64.rpm</strong> 패키지를 다운로드하십시오.</li>
</ul>
