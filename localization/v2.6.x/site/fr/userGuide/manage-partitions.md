...
<p>Pour les préparations, utilisez <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Client/MilvusClientV2.md"><code translate="no">MilvusClientV2</code></a> pour se connecter à Milvus et <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createCollection.md"><code translate="no">createCollection()</code></a> pour créer une collection en mode d'installation rapide.</p>
</div>
...
<h2 id="Load--Release-Partitions" class="common-anchor-header">Charger et libérer des partitions<button data-href="#Load--Release-Partitions" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Vous pouvez charger et libérer des partitions spécifiques afin de les rendre disponibles ou non pour les recherches et les requêtes.</p>
<h3 id="Get-Load-Status" class="common-anchor-header">Obtenir l'état de chargement<button data-href="#Get-Load-Status" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Load-Partitions" class="common-anchor-header">Charger les partitions<button data-href="#Load-Partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Release-Partitions" class="common-anchor-header">Libération des partitions<button data-href="#Release-Partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
