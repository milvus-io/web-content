...
summary: >-
  Vous pouvez supprimer les entités qui ne sont plus nécessaires en filtrant les
  conditions ou leurs clés primaires.
---
...
<h2 id="Delete-Entities-by-Filtering-Conditions" class="common-anchor-header">Suppression d'entités par conditions de filtrage<button data-href="#Delete-Entities-by-Filtering-Conditions" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Lorsque vous supprimez plusieurs entités qui partagent certains attributs dans un lot, vous pouvez utiliser des expressions de filtrage. L'exemple de code ci-dessous utilise l'opérateur <strong>in</strong> pour supprimer en bloc toutes les entités dont le champ <strong>couleur</strong> est défini sur les valeurs <strong>rouge</strong> et <strong>violet</strong>. Vous pouvez également utiliser d'autres opérateurs pour construire des expressions de filtre qui répondent à vos besoins. Pour plus d'informations sur les expressions de filtrage, veuillez vous référer au document <a href="/docs/fr/v2.6.x/boolean.md">Filtering Explained (Le filtrage expliqué)</a>.</p>
