...
<p>Avant de commencer, lisez <a href="/docs/fr/v2.6.x/milvus_cdc_overview.md">Milvus CDC</a> pour comprendre le modèle primaire-standby et les options de basculement.</p>
