...
<h2 id="Current-version" class="common-anchor-header">Version actuelle<button data-href="#Current-version" class="anchor-icon" translate="no">
    ...
    </button></h2><p>La version actuelle de Milvus_CLI est 1.2.1. Pour connaître la version installée et savoir si vous devez la mettre à jour, exécutez <code translate="no">milvus_cli --version</code>.</p>
