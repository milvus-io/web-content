...
summary: >-
  ...
  Voici un exemple illustrant la manière dont les champs ARRAY stockent les
  données :
---
...
<li><p><strong>Valeurs par défaut</strong>: les champs ARRAY ne prennent pas en charge les valeurs par défaut. Cependant, vous pouvez définir l’attribut « <code translate="no">nullable</code> » sur « <code translate="no">True</code> » pour autoriser les valeurs nulles. Pour plus de détails, reportez-vous à la section « <a href="/docs/fr/v2.6.x/nullable-and-default.md">Nullable &amp; Default</a> ».</p></li>
