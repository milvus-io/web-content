...
<button class="copy-code-btn"></button></code></pre>
<p>Le filtre <code translate="no">cncharonly</code> fonctionne sur les termes générés par le tokenizer, il doit donc être utilisé en combinaison avec un tokenizer. Pour obtenir une liste des tokenizers disponibles dans Milvus, reportez-vous à <a href="/docs/fr/jieba-tokenizer.md">Jieba</a> et à ses pages apparentées.</p>
