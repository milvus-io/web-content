...
<h1 id="Remove-Punct" class="common-anchor-header">Supprimer la ponctuation<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.5.11+</span><button data-href="#Remove-Punct" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Le filtre <code translate="no">removepunct</code> supprime les signes de ponctuation, les espaces et les retours à la ligne que certains tokenizers, tels que <code translate="no">jieba</code>, <code translate="no">lindera</code> et <code translate="no">icu</code>, conservent normalement. Utilisez-le lorsque vous souhaitez obtenir un flux de jetons plus propre, contenant uniquement des jetons de texte significatifs, sans virgules, points et autres signes de ponctuation.</p>
