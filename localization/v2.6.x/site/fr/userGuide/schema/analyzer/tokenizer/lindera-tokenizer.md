...
<h2 id="Prerequisites" class="common-anchor-header">Conditions préalables<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pour utiliser le tokenizer <code translate="no">lindera</code>, vous devez utiliser une version spécialement compilée de Milvus. Tous les dictionnaires doivent être explicitement activés lors de la compilation pour être utilisés.</p>
...
<p>La liste complète des dictionnaires disponibles est la suivante : <code translate="no">lindera-ipadic</code>, <code translate="no">lindera-ipadic-neologd</code>, <code translate="no">lindera-unidic</code>, <code translate="no">lindera-ko-dic</code>, <code translate="no">lindera-cc-cedict</code>.</p>
...
<h2 id="Configuration" class="common-anchor-header">Configuration<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pour configurer un analyseur utilisant le tokenizer <code translate="no">lindera</code>, définissez <code translate="no">tokenizer.type</code> à <code translate="no">lindera</code> et choisissez un dictionnaire avec <code translate="no">dict_kind</code>.</p>
...
<table>
   ...
   <tr>
     ...
     <td><p>Un dictionnaire utilisé pour définir le vocabulaire. Valeurs possibles :</p>
<ul>
