...
<p>Pour une configuration plus simple, vous pouvez choisir d'utiliser l'analyseur <a href="/docs/fr/standard-analyzer.md"><code translate="no">standard</code></a> qui combine le tokenizer <code translate="no">standard</code> et le filtre <a href="/docs/fr/lowercase-filter.md"><code translate="no">lowercase</code></a> et <a href="/docs/fr/lowercase-filter.md"> le filtre</a>.</p>
</div>
