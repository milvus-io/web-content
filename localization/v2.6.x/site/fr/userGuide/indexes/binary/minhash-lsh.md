...
<h3 id="Connect-to-Milvus" class="common-anchor-header">Se connecter à Milvus</h3><pre><code translate="no" class="language-python"><span class="hljs-keyword">from</span> pymilvus <span class="hljs-keyword">import</span> MilvusClient
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Define-collection-schema" class="common-anchor-header">Définir un schéma de collecte</h3><p>Définissez un schéma avec :</p>
<ul>
<li><p>La clé primaire</p></li>
<li><p>Un champ <code translate="no">BINARY_VECTOR</code> pour les signatures MinHash</p></li>
<li><p>Un champ <code translate="no">VARCHAR</code> pour le jeu de jetons d'origine (si la recherche affinée est activée)</p></li>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Build-index-parameters-and-create-collection" class="common-anchor-header">Établir les paramètres de l'index et créer la collection</h3><p>Créez un index <code translate="no">MINHASH_LSH</code> en activant l'affinage Jaccard :</p>
...
<h3 id="Insert-data" class="common-anchor-header">Insérer les données</h3><p>Pour chaque document, préparer</p>
<ul>
