...
<li><p>Comme les données PQ sont stockées de manière redondante à proximité de plusieurs nœuds, la taille du fichier d'index augmente de manière significative, ce qui consomme plus d'espace disque.</p></li>
</ul>
