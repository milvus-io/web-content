...
<li><p>Le module Function traite uniquement les champs explicitement définis dans le schéma de la collection ; il ne génère pas de représentations pour les champs dynamiques.</p></li>
...
<h2 id="Supported-embedding-service-providers" class="common-anchor-header">Fournisseurs de services d’intégration pris en charge<button data-href="#Supported-embedding-service-providers" class="anchor-icon" translate="no">
   ...
   <tr>
     <td><p><a href="/docs/fr/v2.6.x/hugging-face-tei.md">Hugging Face TEI</a></p></td>
     <td><p>Tout modèle pris en charge par TEI</p></td>
     <td><p><code translate="no">FLOAT_VECTOR</code></p></td>
     <td><p>Clé API facultative</p></td>
   </tr>
   <tr>
     <td><p><a href="/docs/fr/v2.6.x/hugging-face.md">Hugging Face</a></p></td>
...
<p>Pour plus de détails sur la configuration des identifiants via des variables d’environnement, consultez la documentation du fournisseur de service d’intégration (par exemple, <a href="/docs/fr/v2.6.x/openai.md">OpenAI</a> ou <a href="/docs/fr/v2.6.x/azure-openai.md">Azure OpenAI</a>).</p></li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<p>Pour plus d’informations sur la manière d’appliquer la configuration de Milvus, consultez la section « <a href="/docs/fr/v2.6.x/dynamic_config.md">Configurer Milvus à la volée</a> ».</p>
...
<pre><code translate="no" class="language-bash"><span class="hljs-comment"># restful</span>
<button class="copy-code-btn"></button></code></pre>
<p>Pour plus d’informations sur les opérations de recherche et de requête, consultez la section « <a href="/docs/fr/v2.6.x/single-vector-search.md">Recherche vectorielle</a> et <a href="/docs/fr/v2.6.x/get-and-scalar-query.md">requêtes</a> <a href="/docs/fr/v2.6.x/single-vector-search.md">de base</a> ».</p>
<h2 id="FAQ" class="common-anchor-header">FAQ<button data-href="#FAQ" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Les deux méthodes fonctionnent, mais l’utilisation d’ <code translate="no">milvus.yaml</code> est l’approche recommandée, car elle permet une gestion centralisée des identifiants et une nomenclature cohérente de ceux-ci pour tous les fournisseurs. Lorsque vous utilisez des variables d’environnement, les noms de variables varient en fonction du fournisseur de service d’encodage ; consultez donc la page dédiée à chaque fournisseur pour connaître les noms de variables d’environnement spécifiques requis (par exemple, <a href="/docs/fr/v2.6.x/openai.md">OpenAI</a> ou <a href="/docs/fr/v2.6.x/azure-openai.md">Azure OpenAI</a>).</p>
...
<li>Si ni les identifiants du fichier ` <code translate="no">milvus.yaml</code> ` ni les variables d’environnement ne sont configurés, Milvus renvoie une erreur</li>
</ol>
