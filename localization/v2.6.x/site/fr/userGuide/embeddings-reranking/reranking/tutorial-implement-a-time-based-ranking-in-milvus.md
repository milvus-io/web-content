...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Step-4-Prepare-sample-data" class="common-anchor-header">Etape 4 : Préparer les données d'échantillon<button data-href="#Step-4-Prepare-sample-data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Pour ce tutoriel, nous allons créer un ensemble d'articles de presse avec différentes dates de publication. Remarquez que nous avons inclus des paires d'articles au contenu presque identique, mais avec des dates différentes, afin de démontrer clairement l'effet de classement décroissant :</p>
