...
<p>Le tableau suivant montre comment ces métriques de similarité largement utilisées s'adaptent à diverses formes de données d'entrée et aux index Milvus. Actuellement, Milvus prend en charge différents types de données, y compris les intégrations à virgule flottante (souvent connues sous le nom de vecteurs à virgule flottante ou de vecteurs denses), les intégrations binaires (également connues sous le nom de vecteurs binaires) et les intégrations éparses (également connues sous le nom de vecteurs épars).</p>
<div class="filter">
...
<h3 id="Euclidean-distance-L2" class="common-anchor-header">Distance euclidienne (L2)<button data-href="#Euclidean-distance-L2" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>La distance euclidienne mesure essentiellement la longueur d'un segment reliant deux points.</p>
...
<p>C'est la mesure de distance la plus couramment utilisée et elle est très utile lorsque les données sont continues.</p>
...
<h3 id="Inner-product-IP" class="common-anchor-header">Produit intérieur (PI)<button data-href="#Inner-product-IP" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>La distance IP entre deux intégrations vectorielles est définie comme suit :</p>
<p>
...
<h3 id="Cosine-Similarity" class="common-anchor-header">Similitude en cosinus<button data-href="#Cosine-Similarity" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Jaccard-distance" class="common-anchor-header">Distance de Jaccard<button data-href="#Jaccard-distance" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Le coefficient de similarité de Jaccard mesure la similarité entre deux ensembles d'échantillons et est défini comme la cardinalité de l'intersection des ensembles définis divisée par la cardinalité de leur union. Il ne peut être appliqué qu'à des ensembles d'échantillons finis.</p>
<p>
...
<h3 id="Hamming-distance" class="common-anchor-header">Distance de Hamming<button data-href="#Hamming-distance" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>La distance de Hamming mesure les chaînes de données binaires. La distance entre deux chaînes de même longueur est le nombre de positions de bits auxquelles les bits sont différents.</p>
...
<h3 id="Structural-Similarity" class="common-anchor-header">Similitude structurelle<button data-href="#Structural-Similarity" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Lorsqu'une structure chimique fait partie d'une structure chimique plus importante, la première est appelée sous-structure et la seconde superstructure. Par exemple, l'éthanol est une sous-structure de l'acide acétique et l'acide acétique est une superstructure de l'éthanol.</p>
