...
<tr><td>LogicalOp</td><td>Un LogicalOp est un opérateur logique qui permet de combiner plusieurs opérations relationnelles en une seule comparaison. La valeur renvoyée par un LogicalOp est soit TRUE (1), soit FALSE (0). Il existe deux types de LogicalOps : les BinaryLogicalOps et les UnaryLogicalOps.</td></tr>
...
<h2 id="Operators" class="common-anchor-header">Opérateurs<button data-href="#Operators" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Logical-operators" class="common-anchor-header">Opérateurs logiques<button data-href="#Logical-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Les opérateurs logiques effectuent une comparaison entre deux expressions.</p>
<table>
<thead>
...
<h3 id="Binary-arithmetic-operators" class="common-anchor-header">Opérateurs arithmétiques binaires<button data-href="#Binary-arithmetic-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Les opérateurs arithmétiques binaires contiennent deux opérandes et peuvent effectuer des opérations arithmétiques de base et renvoyer le résultat correspondant.</p>
<table>
<thead>
<tr><th>Symbole</th><th>Opération</th><th>Exemple</th><th>Description</th></tr>
</thead>
...
<h3 id="Relational-operators" class="common-anchor-header">Opérateurs relationnels<button data-href="#Relational-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Les opérateurs relationnels utilisent des symboles pour vérifier l'égalité, l'inégalité ou l'ordre relatif entre deux expressions.</p>
<table>
<thead>
...
<tr><td>&gt;</td><td>Plus grand que</td><td>a &gt; b</td><td>Vrai si a est supérieur à b.</td></tr>
