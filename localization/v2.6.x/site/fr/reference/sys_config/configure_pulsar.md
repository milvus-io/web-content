...
<h1 id="pulsar-related-Configurations" class="common-anchor-header">Configurations liées à pulsar<button data-href="#pulsar-related-Configurations" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Configuration connexe de pulsar, utilisée pour gérer les journaux Milvus des opérations de mutation récentes, produire des journaux en continu et fournir des services de publication et d'abonnement de journaux.</p>
<h2 id="pulsaraddress" class="common-anchor-header"><code translate="no">pulsar.address</code><button data-href="#pulsaraddress" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Adresse IP du service Pulsar.</li>      
        <li>Variable d'environnement : PULSAR_ADDRESS</li>      
        <li>pulsar.address et pulsar.port génèrent ensemble l'accès valide à Pulsar.</li>      
        <li>Pulsar acquiert de préférence l'adresse IP valide à partir de la variable d'environnement PULSAR_ADDRESS au démarrage de Milvus.</li>      
        <li>La valeur par défaut s'applique lorsque Pulsar fonctionne sur le même réseau que Milvus.</li>      </td>
      <td>localhost</td>
    </tr>
  </tbody>
</table>
...
<h2 id="pulsarwebport" class="common-anchor-header"><code translate="no">pulsar.webport</code><button data-href="#pulsarwebport" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Port web du service Pulsar. Si vous vous connectez directement sans proxy, vous devez utiliser 8080.      </td>
      <td>80</td>
    </tr>
  </tbody>
</table>
...
<h2 id="pulsartenant" class="common-anchor-header"><code translate="no">pulsar.tenant</code><button data-href="#pulsartenant" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Pulsar peut être provisionné pour des locataires spécifiques avec une capacité appropriée allouée au locataire.</li>      
        <li>Pour partager une instance Pulsar entre plusieurs instances Milvus, vous pouvez changer cette valeur pour un locataire Pulsar au lieu de la valeur par défaut pour chaque instance Milvus avant de les démarrer. Toutefois, si vous ne souhaitez pas de multi-locataires Pulsar, il est conseillé de modifier msgChannel.chanNamePrefix.cluster avec une valeur différente.</li>      </td>
      <td>public</td>
    </tr>
  </tbody>
</table>
<h2 id="pulsarnamespace" class="common-anchor-header"><code translate="no">pulsar.namespace</code><button data-href="#pulsarnamespace" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Un espace de noms Pulsar est la nomenclature de l'unité administrative au sein d'un locataire.      </td>
      <td>par défaut</td>
    </tr>
  </tbody>
</table>
<h2 id="pulsarrequestTimeout" class="common-anchor-header"><code translate="no">pulsar.requestTimeout</code><button data-href="#pulsarrequestTimeout" class="anchor-icon" translate="no">
  ...
  <thead>
    <tr>
      <th class="width80">Description de l'espace de noms</th>
      <th class="width20">Valeur par défaut</th> 
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>        Délai d'attente pour les requêtes globales du client Pulsar en secondes      </td>
      <td>60</td>
    </tr>
  </tbody>
</table>
<h2 id="pulsarenableClientMetrics" class="common-anchor-header"><code translate="no">pulsar.enableClientMetrics</code><button data-href="#pulsarenableClientMetrics" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Indique s'il faut enregistrer les métriques du client pulsar dans le chemin des métriques de milvus.      </td>
      <td>faux</td>
    </tr>
  </tbody>
</table>
