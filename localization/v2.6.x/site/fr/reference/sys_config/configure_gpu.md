...
summary: Apprendre à configurer le gpu pour Milvus.
---
<h1 id="gpu-related-Configurations" class="common-anchor-header">Configurations liées au GPU<button data-href="#gpu-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>#Lors de l'utilisation de l'indexation GPU, Milvus utilisera un pool de mémoire pour éviter l'allocation et la désallocation fréquentes de la mémoire.</p>
...
<h2 id="gpuinitMemSize" class="common-anchor-header"><code translate="no">gpu.initMemSize</code><button data-href="#gpuinitMemSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Taille d'initialisation du pool de mémoire GPU   </td>
      <td>2048</td>
    </tr>
  </tbody>
</table>
<h2 id="gpumaxMemSize" class="common-anchor-header"><code translate="no">gpu.maxMemSize</code><button data-href="#gpumaxMemSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Taille maximale du pool de mémoire Gpu   </td>
      <td>4096</td>
    </tr>
  </tbody>
</table>
