...
summary: >-
  ...
  (Retrieval-Augmented Generation) avec Milvus et SiliconFlow.
title: Construire RAG avec Milvus et SiliconFlow
---
<h1 id="Build-RAG-with-Milvus-and-SiliconFlow" class="common-anchor-header">Construire RAG avec Milvus et SiliconFlow<button data-href="#Build-RAG-with-Milvus-and-SiliconFlow" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p><a href="https://siliconflow.cn/">SiliconFlow</a> s'est engagé à construire une plate-forme d'infrastructure d'IA évolutive, normalisée et très performante. SiliconCloud est l'une des offres phares de SiliconFlow, décrite comme une plate-forme de modèle en tant que service (MaaS). Elle fournit un environnement complet pour le déploiement de divers modèles d'IA, y compris les grands modèles de langage (LLM) et les modèles d'intégration. SiliconCloud regroupe de nombreux modèles open-source, ce qui permet aux utilisateurs d'accéder facilement à ces ressources et de les utiliser sans avoir à mettre en place une infrastructure étendue.</p>
<p>Dans ce tutoriel, nous allons vous montrer comment construire un pipeline RAG (Retrieval-Augmented Generation) avec Milvus et SiliconFlow.</p>
...
<h3 id="Prepare-the-Embedding-Model" class="common-anchor-header">Préparation du modèle d'intégration<button data-href="#Prepare-the-Embedding-Model" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Nous initialisons un client pour préparer le modèle d'intégration. SiliconFlow active l'API de style OpenAI, et vous pouvez utiliser la même API avec des ajustements mineurs pour appeler le modèle d'intégration et le LLM.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Définissez une fonction pour générer des encastrements de texte à l'aide du client. Nous utilisons le modèle <code translate="no">BAAI/bge-large-en-v1.5</code> comme exemple.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Générez un embedding de test et imprimez sa dimension et ses premiers éléments.</p>
...
&quot;&quot;&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>Utiliser le modèle <code translate="no">deepseek-ai/DeepSeek-V2.5</code> fourni par SiliconCloud pour générer une réponse basée sur les invites.</p>
...
<p>C'est super ! Nous avons réussi à construire un pipeline RAG avec Milvus et SiliconFlow.</p>
