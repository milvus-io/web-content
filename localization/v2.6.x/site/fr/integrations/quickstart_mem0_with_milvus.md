...
<h3 id="Configure-Mem0-with-Milvus" class="common-anchor-header">Configurer Mem0 avec Milvus<button data-href="#Configure-Mem0-with-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Managing-User-Memories-with-Mem0-and-Milvus" class="common-anchor-header">Gestion des mémoires d'utilisateur avec Mem0 et Milvus<button data-href="#Managing-User-Memories-with-Mem0-and-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Adding-a-Memory" class="common-anchor-header">Ajout d'une mémoire<button data-href="#Adding-a-Memory" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>La fonction <code translate="no">add</code> stocke du texte non structuré dans Milvus en tant que mémoire, en l'associant à un utilisateur spécifique et à des métadonnées facultatives.</p>
...
<h3 id="Update-a-Memory" class="common-anchor-header">Mise à jour d'un souvenir<button data-href="#Update-a-Memory" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Nous pouvons utiliser la valeur de retour de la fonction <code translate="no">add</code> pour récupérer l'ID de la mémoire, ce qui nous permet de mettre à jour cette mémoire avec de nouvelles informations via <code translate="no">update</code>.</p>
...
<h3 id="Get-All-Memory-For-a-User" class="common-anchor-header">Obtenir toutes les mémoires d'un utilisateur<button data-href="#Get-All-Memory-For-a-User" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>La fonction <code translate="no">get_all</code> permet d'afficher toutes les mémoires insérées ou de les filtrer par <code translate="no">user_id</code> dans Milvus.</p>
...
<h3 id="View-Memory-Update-History" class="common-anchor-header">Afficher l'historique des mises à jour de la mémoire<button data-href="#View-Memory-Update-History" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Nous pouvons également consulter l'historique des mises à jour de la mémoire en spécifiant l'identifiant de la mémoire qui nous intéresse via la fonction <code translate="no">history</code>.</p>
...
<h3 id="Search-Memory" class="common-anchor-header">Rechercher une mémoire<button data-href="#Search-Memory" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Nous pouvons utiliser la fonction <code translate="no">search</code> pour rechercher la mémoire la plus proche de l'utilisateur.</p>
...
<h3 id="Delete-Memory" class="common-anchor-header">Supprimer une mémoire<button data-href="#Delete-Memory" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Nous pouvons également <code translate="no">delete</code> un souvenir en fournissant le <code translate="no">memory_id</code> correspondant.</p>
