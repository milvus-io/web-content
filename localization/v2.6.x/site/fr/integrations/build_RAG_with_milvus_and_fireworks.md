...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Prepare-the-LLM-and-Embedding-Model" class="common-anchor-header">Préparer le LLM et le modèle d'intégration</h3><p>Nous initialisons un client pour préparer le LLM et le modèle d'intégration. Fireworks AI active l'API de type OpenAI et vous pouvez utiliser la même API avec des ajustements mineurs pour appeler le modèle d'intégration et le LLM.</p>
