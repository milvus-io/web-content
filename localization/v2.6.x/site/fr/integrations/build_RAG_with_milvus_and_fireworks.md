...
summary: >-
  ...
  (Retrieval-Augmented Generation) avec Milvus et Fireworks AI.
title: Construire RAG avec Milvus et Fireworks AI
---
<h1 id="Build-RAG-with-Milvus-and-Fireworks-AI" class="common-anchor-header">Construire RAG avec Milvus et Fireworks AI<button data-href="#Build-RAG-with-Milvus-and-Fireworks-AI" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Fireworks AI utilise l'API de type OpenAI. Vous pouvez vous connecter à son site officiel et préparer la <a href="https://docs.fireworks.ai/getting-started/introduction">clé api</a> <code translate="no">FIREWORKS_API_KEY</code> comme variable d'environnement.</p>
...
<h3 id="Prepare-the-LLM-and-Embedding-Model" class="common-anchor-header">Préparer le LLM et le modèle d'intégration<button data-href="#Prepare-the-LLM-and-Embedding-Model" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Nous initialisons un client pour préparer le LLM et le modèle d'intégration. Fireworks AI active l'API de type OpenAI et vous pouvez utiliser la même API avec des ajustements mineurs pour appeler le modèle d'intégration et le LLM.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Définissez une fonction pour générer des enchâssements de texte à l'aide du client. Nous utilisons le modèle <code translate="no">nomic-ai/nomic-embed-text-v1.5</code> comme exemple.</p>
...
&quot;&quot;&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>Utiliser le modèle <code translate="no">llama-v3p1-405b-instruct</code> fourni par Fireworks pour générer une réponse basée sur les invites.</p>
...
<p>C'est super ! Nous avons réussi à construire un pipeline RAG avec Milvus et Fireworks AI.</p>
