...
<p>Règles et guides de décision pour concevoir des schémas de collecte Milvus corrects, y compris les types de champs, les clés primaires, la configuration BM25 et les contraintes d'immuabilité des schémas. Copiez l'invite complète ci-dessous dans votre outil d'IA pour appliquer ces règles automatiquement. Pour obtenir une vue d'ensemble de toutes les invites, voir <a href="/docs/fr/ai_prompts_landing.md">Invites AI</a>.</p>
