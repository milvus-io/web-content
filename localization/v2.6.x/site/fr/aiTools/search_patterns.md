...
title: 'Prompt : Les schémas de recherche de Milvus'
summary: >-
  Règles pour les assistants de codage IA afin de mettre en œuvre la recherche,
  la recherche hybride et la recherche en texte intégral dans Milvus.
---
<h1 id="Search-Patterns" class="common-anchor-header">Modèles de recherche<button data-href="#Search-Patterns" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><strong>Copiez</strong> l'invite complète à partir de la section Invite <a href="#full-prompt">complète</a> ci-dessous.</li>
