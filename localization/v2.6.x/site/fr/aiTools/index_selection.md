...
<p>Guides de décision et règles de configuration pour le choix et le réglage des index Milvus, y compris AUTOINDEX, HNSW, DiskANN, IVF et les index épars. Copiez l'invite complète ci-dessous dans votre outil d'IA pour appliquer ces règles automatiquement. Pour une présentation de toutes les invites, voir <a href="/docs/fr/milvus_for_agents.md">Invites AI</a>.</p>
