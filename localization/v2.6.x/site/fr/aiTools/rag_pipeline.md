...
<p>Règles de bout en bout pour construire des pipelines RAG avec Milvus, y compris l'ingestion, le chunking, l'embedding, la récupération hybride avec BM25, et les mises à jour de documents avec upsert. Copiez l'invite complète ci-dessous dans votre outil d'IA pour appliquer ces règles automatiquement. Pour une vue d'ensemble de toutes les invites, voir <a href="/docs/fr/milvus_for_agents.md">Invites AI</a>.</p>
