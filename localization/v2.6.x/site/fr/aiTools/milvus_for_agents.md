...
<h2 id="AI-prompts" class="common-anchor-header">Invites AI<button data-href="#AI-prompts" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Des invites sélectionnées qui aident les assistants de codage IA à écrire un code Milvus correct. Chaque message encode les règles et les modèles qui permettent d'éviter les erreurs les plus courantes.</p>
