...
<div class="start_card_container">
  <a href="/docs/fr/integrations_overview.md" style="text-decoration: none; color: inherit;">
    <p class="link-btn" style="font-size: 1rem; white-space: nowrap;">Cadres d'agents</p>
    <p style="font-size: 0.875rem; font-weight: 400; color: #555;">Intégrations avec LangChain, LlamaIndex, OpenAI Agents, et d'autres frameworks d'orchestration d'agents.</p>
  </a>
</div>
</div>
<h2 id="AI-prompts" class="common-anchor-header">Messages-guides pour l'IA<button data-href="#AI-prompts" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Des invites curatives qui aident les assistants de codage de l'IA à écrire du code Milvus correct. Chaque invite codifie les règles et les modèles qui permettent d'éviter les erreurs les plus courantes.</p>
...
<p>Pour les charges de travail des agents, <strong>Zilliz Cloud</strong> est recommandé pour une utilisation en production. Les agents ne gèrent généralement pas l'infrastructure, de sorte qu'un déploiement sans serveur élimine la surcharge opérationnelle et fournit une mise à l'échelle automatique.</p>
</div>
<h2 id="Quick-connection-examples" class="common-anchor-header">Exemples de connexion rapide<button data-href="#Quick-connection-examples" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Connectez-vous à Milvus à partir du code de votre agent :</p>
...
<li><a href="/docs/fr/quickstart.md">Démarrage rapide</a> - Exécutez votre première recherche Milvus en quelques minutes.</li>
<li><a href="/docs/fr/integrations_overview.md">Intégrations du cadre d'agent</a> - Connectez Milvus à LangChain, LlamaIndex, OpenAI Agents, etc.</li>
</ul>
