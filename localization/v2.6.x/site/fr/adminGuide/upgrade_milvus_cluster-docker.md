...
<p>En règle générale, vous pouvez <a href="#Upgrade-Milvus-by-changing-its-image">mettre à niveau Milvus en modifiant son image</a>. Cependant, vous devez <a href="#Migrate-the-metadata">migrer les métadonnées</a> avant toute mise à niveau de la version v2.1.x vers la version v2.6.24.</p>
<div class="alert note">
<p><strong>Limitations relatives aux files d’attente de messages</strong>: lors de la mise à niveau vers Milvus v2.6.24, vous devez conserver votre choix actuel de file d’attente de messages. Le changement de système de file d’attente de messages pendant la mise à niveau n’est pas pris en charge. La prise en charge du changement de système de file d’attente de messages sera disponible dans les prochaines versions.</p>
</div>
<h2 id="Upgrade-Milvus-by-changing-its-image" class="common-anchor-header">Mettre à niveau Milvus en modifiant son image<button data-href="#Upgrade-Milvus-by-changing-its-image" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Dans des conditions normales, vous pouvez mettre à niveau Milvus comme suit :</p>
<ol>
<li><p>Modifiez les balises d’image de Milvus dans <code translate="no">docker-compose.yaml</code>.</p>
...
<li><p>Arrêtez tous les composants Milvus.</p>
...
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Préparez le fichier de configuration <code translate="no">migrate.yaml</code> pour la migration des métadonnées.</p>
...
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Lancez le conteneur de migration.</p>
...
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Redémarrez les composants Milvus avec la nouvelle image Milvus.</p>
