...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Mise à niveau de Milvus Standalone avec Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Ce guide décrit comment mettre à niveau votre déploiement Milvus Standalone de la version v2.5.x à la version v2.6.23 à l’aide de Milvus Operator.</p>
<h2 id="Before-you-start" class="common-anchor-header">Avant de commencer<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v2623" class="common-anchor-header">Nouveautés de la version 2.6.23<button data-href="#Whats-new-in-v2623" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>La mise à niveau de Milvus 2.5.x vers la version 2.6.23 implique des changements architecturaux importants :</p>
<ul>
...
<li><strong>Suppression de composants</strong>: <code translate="no">indexNode</code> a été supprimé et regroupé</li>
</ul>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>n’</strong> est <strong>pas compatible</strong> avec la version v2.6.23. Les mises à niveau directes à partir de versions candidates ne sont pas prises en charge.</li>
...
<li>Vous <strong>devez</strong> effectuer une mise à niveau vers la v2.5.16 ou une version ultérieure avant de passer à la v2.6.23.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Upgrade-your-Milvus-standalone" class="common-anchor-header">Étape 2 : Mise à niveau de votre instance autonome de Milvus<button data-href="#Step-2-Upgrade-your-Milvus-standalone" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Créez un fichier de configuration <code translate="no">milvusupgrade.yaml</code> pour effectuer la mise à jour vers la version v2.5.16 :</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2623" class="common-anchor-header">2.2 Mise à niveau vers la version 2.6.23</h4><p>Une fois que la version 2.5.16 fonctionne correctement, effectuez la mise à niveau vers la version 2.6.23 :</p>
