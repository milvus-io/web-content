...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Mise à niveau de Milvus Standalone avec Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Ce guide décrit comment mettre à niveau votre déploiement Milvus autonome de la version 2.5.x à la version 2.6.14 à l'aide de Milvus Operator.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2614" class="common-anchor-header">2.2 Mise à niveau vers la version 2.6.14</h4><p>Une fois que la version 2.5.16 fonctionne correctement, passez à la version 2.6.14 :</p>
