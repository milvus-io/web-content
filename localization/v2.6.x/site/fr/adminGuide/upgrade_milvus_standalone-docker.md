...
---
<div class="tab-wrapper"><a href="/docs/fr/v2.6.x/upgrade_milvus_standalone-operator.md" class=''>Milvus</a><a href="/docs/fr/v2.6.x/upgrade_milvus_standalone-helm.md" class=''>OperatorHelmDocker</a><a href="/docs/fr/v2.6.x/upgrade_milvus_standalone-docker.md" class='active '>Compose</a></div>
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Mise à niveau de Milvus Standalone avec Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Ce guide décrit comment mettre à niveau votre déploiement Milvus autonome de la version 2.5.x à la version 2.6.16 à l'aide de Docker Compose.</p>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>n'</strong> est <strong>pas compatible</strong> avec v2.6.16. Les mises à niveau directes à partir des versions candidates ne sont pas prises en charge.</li>
...
<p>Pour des raisons de sécurité, Milvus met à niveau son MinIO vers RELEASE.2024-12-18T13-15-44Z avec la sortie de la v2.6.16.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v2616" class="common-anchor-header">Étape 2 : Mise à niveau vers la version 2.6.16<button data-href="#Step-2-Upgrade-to-v2616" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Une fois que la version 2.5.16 fonctionne correctement, passez à la version 2.6.16 :</p>
<ol>
...
<li>Apprendre à <a href="/docs/fr/v2.6.x/eks.md">déployer Milvus sur Amazon EKS avec Terraform</a></li>
<li>Apprendre à <a href="/docs/fr/v2.6.x/gcp.md">déployer le cluster Milvus sur GCP avec Kubernetes</a></li>
<li>Apprendre à <a href="/docs/fr/v2.6.x/azure.md">déployer Milvus sur Microsoft Azure avec Kubernetes</a></li>
</ul></li>
</ul>
