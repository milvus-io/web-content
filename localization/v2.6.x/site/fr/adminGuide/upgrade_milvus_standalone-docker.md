...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Mise à niveau de Milvus en mode autonome avec Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Ce guide décrit comment mettre à niveau votre déploiement autonome de Milvus de la version v2.5.x à la version v2.6.24 à l'aide de Docker Compose.</p>
...
<p>Pour des raisons de sécurité, Milvus met à jour son MinIO vers la version RELEASE.2024-12-18T13-15-44Z avec la sortie de la version v2.6.24.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v2624" class="common-anchor-header">Étape 2 : Mise à niveau vers la version 2.6.24<button data-href="#Step-2-Upgrade-to-v2624" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
