...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Mise à niveau de Milvus en mode autonome à l'aide d'un Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Ce guide explique comment mettre à niveau votre déploiement Milvus Standalone de la version v2.5.x à la version v2.6.23 à l'aide d'un Helm Chart.</p>
<h2 id="Before-you-start" class="common-anchor-header">Avant de commencer<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v2623" class="common-anchor-header">Nouveautés de la version v2.6.23<button data-href="#Whats-new-in-v2623" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Upgrade-process" class="common-anchor-header">Processus de mise à jour<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Upgrade-Helm-Chart" class="common-anchor-header">Étape 1 : Mise à niveau du Helm Chart<button data-href="#Step-1-Upgrade-Helm-Chart" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<div class="alert note">
Le dépôt des charts Helm de Milvus situé à l’adresse <code translate="no">https://milvus-io.github.io/milvus-helm/</code> a été archivé. Utilisez le nouveau dépôt <code translate="no">https://zilliztech.github.io/milvus-helm/</code> pour les versions 4.0.31 et ultérieures des charts.
</div>
...
<h3 id="Step-2-Upgrade-to-v2516" class="common-anchor-header">Étape 2 : Mise à niveau vers la version v2.5.16<button data-href="#Step-2-Upgrade-to-v2516" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Ignorez cette étape si votre déploiement autonome fonctionne déjà sous la version 2.5.16 ou une version ultérieure.</p>
</div>
<p>Mettez à niveau votre instance autonome de Milvus vers la version 2.5.16 :</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v2623" class="common-anchor-header">Étape 3 : Mise à niveau vers la version 2.6.23<button data-href="#Step-3-Upgrade-to-v2623" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
