...
---
<div class="tab-wrapper"><a href="/docs/fr/v2.6.x/upgrade_milvus_standalone-operator.md" class=''>Milvus</a><a href="/docs/fr/v2.6.x/upgrade_milvus_standalone-helm.md" class='active '>OperatorHelmDocker</a><a href="/docs/fr/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>Compose</a></div>
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Mise à niveau de Milvus Standalone avec Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Ce guide décrit comment mettre à niveau votre déploiement Milvus autonome de la version 2.5.x à la version 2.6.16 à l'aide de Helm Chart.</p>
...
<p>Ce processus de mise à niveau garantit une migration correcte vers la nouvelle architecture. Pour plus d'informations sur les modifications de l'architecture, voir la <a href="/docs/fr/v2.6.x/architecture_overview.md">présentation de l'architecture Milvus</a>.</p>
...
<li>Milvus standalone déployé via Helm Chart</li>
</ul>
...
<li>Vous <strong>devez</strong> effectuer une mise à niveau vers la version 2.5.16 ou une version ultérieure avant d'effectuer une mise à niveau vers la version 2.6.16.</li>
</ul>
...
<p>Sautez cette étape si votre déploiement autonome exécute déjà la version 2.5.16 ou une version supérieure.</p>
</div>
<p>Mettre à niveau votre Milvus autonome vers la version 2.5.16 :</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
  --<span class="hljs-built_in">set</span> image.all.tag=<span class="hljs-string">&quot;v2.5.16&quot;</span> \
  --reset-then-reuse-values \
  --version=4.2.58
<button class="copy-code-btn"></button></code></pre>
<p>Attendre la fin de la mise à niveau :</p>
<pre><code translate="no" class="language-bash"><span class="hljs-comment"># Verify all pods are ready</span>
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v2616" class="common-anchor-header">Etape 3 : Mise à niveau vers la version 2.6.16<button data-href="#Step-3-Upgrade-to-v2616" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Une fois que la version 2.5.16 fonctionne correctement, procéder à la mise à niveau vers la version 2.6.16 :</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
