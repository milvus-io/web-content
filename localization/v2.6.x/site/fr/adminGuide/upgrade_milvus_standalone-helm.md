...
<p>La mise à niveau de Milvus 2.5.x (ou versions antérieures) vers 2.6.0-rc1 implique des changements architecturaux importants qui rendent cette mise à niveau <strong>irréversible</strong>. En raison de l'introduction de nouveaux composants (tels que Woodpecker et Streaming Node) et de la suppression de certains composants, <strong>il n'est pas possible de revenir à une version antérieure une fois la mise à niveau terminée</strong>. Pour plus de détails sur les modifications architecturales introduites dans la version 2.6.0-rc1, reportez-vous à la section <a href="/docs/fr/v2.6.x/architecture_overview.md">Présentation de l'architecture Milvus</a>.</p>
</div>
...
<div style="display: none;">- [Effectuer une mise à niveau continue](#conduct-a-rolling-upgrade) de Milvus v2.2.3 et versions ultérieures vers v2.6.0-rc1.</div>
<ul>
<li><p><a href="#Upgrade-Milvus-using-Helm">Mettre à niveau Milvus à l'aide de Helm</a> pour une mise à niveau d'une version mineure antérieure à v2.2.3 vers v2.6.0-rc1.</p></li>
<li><p><a href="#Migrate-the-metadata">Migrer les métadonnées</a> avant la mise à niveau de Milvus v2.1.x vers v2.6.0-rc1.</p></li>
</ul>
...
<p>Une fois que vous vous êtes assuré que tous les déploiements de votre instance Milvus sont dans leur état normal, vous pouvez exécuter la commande suivante pour mettre à niveau l'instance Milvus vers 2.6.0-rc1. Vous pouvez exécuter la commande suivante pour mettre à niveau l'instance Milvus vers la version 2.6.0-rc1.</p>
...
<h4 id="2-Upgrade-Milvus-from-v21x-to-260-rc1" class="common-anchor-header">2. Mise à niveau de Milvus de la version 2.1.x vers la version 2.6.0-rc1</h4><p>Les commandes suivantes supposent que vous mettez à niveau Milvus de la version 2.1.4 à la version 2.6.0-rc1. Modifiez-les pour obtenir les versions qui répondent à vos besoins.</p>
<ol>
