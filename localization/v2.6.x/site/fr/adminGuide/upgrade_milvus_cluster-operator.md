...
<li>Vous <strong>devez</strong> effectuer une mise à niveau vers la version v2.5.16 ou une version ultérieure avec l'option « <code translate="no">mixCoord</code> » activée avant de passer à la version v2.6.18.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2618" class="common-anchor-header">2.3 Mise à niveau vers la version 2.6.18</h4><p>Une fois que la version 2.5.16 fonctionne correctement avec l'<code translate="no">mixCoord</code>, effectuez la mise à niveau vers la version 2.6.18 :</p>
