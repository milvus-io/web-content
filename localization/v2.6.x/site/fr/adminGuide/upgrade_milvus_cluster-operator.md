...
<h2 id="Before-you-start" class="common-anchor-header">Avant de commencer<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v260" class="common-anchor-header">Nouveautés de la version 2.6.0</h3><p>La mise à niveau de Milvus 2.5.x vers 2.6.0 implique des changements architecturaux importants :</p>
<ul>
...
<h3 id="Requirements" class="common-anchor-header">Exigences</h3><p><strong>Configuration requise :</strong></p>
<ul>
...
<li>Vous <strong>devez</strong> passer à la version 2.5.16 ou à une version ultérieure avec <code translate="no">mixCoord</code> activé avant de passer à la version 2.6.0.</li>
</ul>
<h2 id="Upgrade-process" class="common-anchor-header">Processus de mise à niveau<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Upgrade-Milvus-Operator" class="common-anchor-header">Étape 1 : Mise à niveau de Milvus Operator</h3><p>Commencez par mettre à niveau votre Milvus Operator vers la version 1.3.0 :</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Upgrade-your-Milvus-cluster" class="common-anchor-header">Etape 2 : Mise à niveau du cluster Milvus</h3><h4 id="21-Check-current-coordinator-configuration" class="common-anchor-header">2.1 Vérifier la configuration actuelle du coordinateur</h4><p>Vérifiez si votre cluster utilise déjà <code translate="no">mixCoord</code>:</p>
