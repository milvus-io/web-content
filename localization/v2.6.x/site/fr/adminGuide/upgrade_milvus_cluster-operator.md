...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Mise à niveau du cluster Milvus avec Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Ce guide décrit comment mettre à niveau votre cluster Milvus de la version 2.5.x à la version 2.6.9 à l'aide de Milvus Operator.</p>
...
<li>Vous <strong>devez</strong> passer à la version 2.5.16 ou à une version ultérieure avec <code translate="no">mixCoord</code> activé avant de passer à la version 2.6.9.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v269" class="common-anchor-header">2.3 Mise à niveau vers la version 2.6.9</h4><p>Une fois que la version 2.5.16 fonctionne correctement avec <code translate="no">mixCoord</code>, passez à la version 2.6.9 :</p>
