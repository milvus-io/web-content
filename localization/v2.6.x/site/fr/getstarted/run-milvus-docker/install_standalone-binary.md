...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Télécharger le paquet RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Vous pouvez télécharger le paquet RPM/DEB correspondant à l'architecture de votre système depuis la <a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.21">page « Milvus Releases</a> ».</p>
<ul>
<li>Pour x86_64/amd64, téléchargez le paquet <strong>milvus_2.6.21-1_amd64.deb</strong> ou <strong>milvus_2.6.21-1_amd64.rpm</strong>.</li>
<li>Pour ARM64, téléchargez le paquet <strong>milvus_2.6.21-1_arm64.deb</strong> ou <strong>milvus_2.6.21-1_arm64.rpm</strong>.</li>
</ul>
