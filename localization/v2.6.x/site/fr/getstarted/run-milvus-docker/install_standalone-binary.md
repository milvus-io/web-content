...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Télécharger le paquetage RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Vous pouvez télécharger le paquetage RPM/DEB correspondant à l'architecture de votre système à partir de la <a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.18">page Milvus Releases</a>.</p>
<ul>
