...
<p><strong>Nouveautés de la version 2.6.24 :</strong></p>
<ul>
...
<p>Téléchargez toujours la dernière configuration Docker Compose pour garantir la compatibilité avec les fonctionnalités de la v2.6.24.</p>
<ul>
...
<ul>
<li>Le conteneur <strong>milvus-etcd</strong> n'expose aucun port vers l'hôte et mappe ses données vers <strong>le répertoire volumes/etcd</strong> dans le dossier actuel.</li>
...
La procédure suivante part du principe que vous devez remplacer le fichier ` <code translate="no">proxy.healthCheckTimeout</code>` par défaut. Pour connaître les éléments de configuration concernés, consultez la section « <a href="/docs/fr/v2.6.x/system_configuration.md">Configuration du système</a> ».</p>
