...
<p><strong>Nouveautés de la version 2.6.19 :</strong></p>
<ul>
...
<p>Téléchargez toujours la dernière configuration Docker Compose pour garantir la compatibilité avec les fonctionnalités de la v2.6.19.</p>
<ul>
