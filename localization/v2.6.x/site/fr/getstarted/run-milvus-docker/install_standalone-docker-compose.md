...
<p><strong>Nouveautés de la version 2.6.7 :</strong></p>
<ul>
...
<p>Téléchargez toujours la dernière configuration de Docker Compose pour garantir la compatibilité avec les fonctionnalités de la version 2.6.7.</p>
<ul>
