...
<li><a href="/docs/fr/v2.6.x/prerequisite-docker.md">Vérifier la configuration matérielle et logicielle requise</a> avant l'installation.</li>
</ul>
...
<p><strong>Nouveautés de la version 2.6.16 :</strong></p>
<ul>
...
<p>Téléchargez toujours la dernière configuration de Docker Compose pour garantir la compatibilité avec les fonctionnalités de la version 2.6.16.</p>
<ul>
