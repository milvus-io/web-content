...
<p>Téléchargez toujours la dernière configuration Docker Compose pour garantir la compatibilité avec les fonctionnalités de la v2.6.23.</p>
<ul>
<li><p>Si vous n'avez pas réussi à exécuter la commande ci-dessus, veuillez vérifier si Docker Compose V1 est installé sur votre système. Si tel est le cas, il vous est conseillé de migrer vers Docker Compose V2 en raison des remarques figurant sur <a href="https://docs.docker.com/compose/">cette page</a>.</p></li>
...
La procédure suivante part du principe que vous devez remplacer le fichier ` <code translate="no">proxy.healthCheckTimeout</code>` par défaut. Pour connaître les éléments de configuration concernés, reportez-vous à <a href="/docs/fr/v2.6.x/system_configuration.md">la</a> section « <a href="/docs/fr/v2.6.x/system_configuration.md">Configuration du système</a> ».</p>
...
<h2 id="Whats-next" class="common-anchor-header">Et ensuite ?<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Maintenant que vous avez installé Milvus dans Docker, vous pouvez :</p>
<ul>
...
<li><p>Découvrez <a href="https://github.com/zilliztech/attu">Attu</a>, un outil graphique open source permettant de gérer Milvus de manière intuitive.</p></li>
