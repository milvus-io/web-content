...
<ul>
<li>Le conteneur <strong>milvus-etcd</strong> n’expose aucun port vers l’hôte et mappe ses données vers le répertoire <strong>volumes/etcd</strong> dans le dossier actuel.</li>
