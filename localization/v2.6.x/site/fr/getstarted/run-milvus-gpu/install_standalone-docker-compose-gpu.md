...
<li><a href="/docs/fr/v2.6.x/prerequisite-gpu.md">Vérifiez la configuration matérielle et logicielle requise</a> avant de procéder à l'installation.</li>
</ul>
...
<h3 id="1-Download-and-configure-the-YAML-file" class="common-anchor-header">1. Téléchargez et configurez le fichier YAML<button data-href="#1-Download-and-configure-the-YAML-file" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Télécharger <a href="https://github.com/milvus-io/milvus/releases/download/v2.6.18/milvus-standalone-docker-compose-gpu.yml"><code translate="no">milvus-standalone-docker-compose-gpu.yml</code></a> et enregistrez-le sous docker-compose.yml manuellement ou à l'aide de la commande suivante.</p>
...
<h3 id="2-Start-Milvus" class="common-anchor-header">2. Démarrer Milvus<button data-href="#2-Start-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Dans le répertoire qui contient docker-compose.yml, démarrez Milvus en exécutant :</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Vous pouvez également accéder à l'interface Web Milvus à l'adresse <code translate="no">http://127.0.0.1:9091/webui/</code> pour en savoir plus sur votre instance Milvus. Pour plus de détails, voir <a href="/docs/fr/v2.6.x/milvus-webui.md">Milvus WebUI</a>.</p>
...
<ul>
<li><p>Consulter <a href="/docs/fr/v2.6.x/quickstart.md">Quickstart</a> pour voir ce que Milvus peut faire.</p></li>
<li><p>Consulter l'<a href="/docs/fr/v2.6.x/milvus-webui.md">interface Web Milvus</a> pour en savoir plus sur l'instance Milvus.</p></li>
...
<li><a href="/docs/fr/v2.6.x/insert-update-delete.md">Insérer, Upsert et Supprimer</a></li>
