...
<ul>
<li><strong>File d'attente de messages</strong>: Utilise WoodPecker (réduit la maintenance de l'infrastructure)</li>
...
<h3 id="2-Check-Milvus-cluster-status" class="common-anchor-header">2. Vérifier l'état du cluster Milvus</h3><p>Exécutez la commande suivante pour vérifier l'état du cluster Milvus</p>
