...
<button class="copy-code-btn"></button></code></pre>
<p>La commande ci-dessus déploie un cluster Milvus utilisant <strong>Woodpecker</strong> comme file d’attente de messages (recommandé pour la version 2.6.20) et intégrant tous les nouveaux composants architecturaux, y compris le nœud de streaming.</p>
...
<li><strong>Nœud de streaming</strong>: activé pour un traitement des données amélioré</li>
