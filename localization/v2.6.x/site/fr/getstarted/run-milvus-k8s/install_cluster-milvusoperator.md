...
<h2 id="Overview" class="common-anchor-header">Présentation<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Operator est une solution qui vous aide à déployer et à gérer une pile de services Milvus complète sur des clusters Kubernetes (K8s). La pile comprend tous les composants Milvus ainsi que les dépendances associées, telles que etcd, Pulsar et MinIO.</p>
