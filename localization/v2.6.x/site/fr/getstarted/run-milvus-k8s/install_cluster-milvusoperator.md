...
<h2 id="Overview" class="common-anchor-header">Présentation<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Operator est une solution qui vous aide à déployer et à gérer une pile de services Milvus complète sur des clusters Kubernetes (K8s). Cette pile comprend tous les composants Milvus ainsi que les dépendances associées, telles qu’etcd, Pulsar et MinIO.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>La commande ci-dessus déploie un cluster Milvus avec <strong>Woodpecker</strong> comme file d’attente de messages (recommandé pour la version 2.6.24) et tous les nouveaux composants architecturaux, y compris le nœud de streaming.</p>
...
<h2 id="Uninstall-Milvus" class="common-anchor-header">Désinstallation de Milvus<button data-href="#Uninstall-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<ul>
<li><p>Consulter la section « <a href="/docs/fr/v2.6.x/quickstart.md">Hello Milvus</a> » pour découvrir les fonctionnalités de Milvus.</p></li>
