...
<p>Récupérez ensuite les charts Milvus depuis le dépôt comme suit :</p>
...
<p>La commande suivante déploie un cluster Milvus avec des paramètres optimisés pour la version 2.6.23, en utilisant Woodpecker comme file d’attente de messages recommandée :</p>
<pre><code translate="no" class="language-bash">helm install my-release zilliztech/milvus \
  --<span class="hljs-built_in">set</span> image.all.tag=v2.6.23 \
  --<span class="hljs-built_in">set</span> pulsarv3.enabled=<span class="hljs-literal">false</span> \
  --<span class="hljs-built_in">set</span> woodpecker.enabled=<span class="hljs-literal">true</span> \
...
<li>Désactive l'ancien <strong>Index Node</strong> (cette fonctionnalité est désormais gérée par le Data Node)</li>
...
<button class="copy-code-btn"></button></code></pre>
<p><strong>Attendez que tous les pods affichent le statut « Running ».</strong> Avec la configuration v2.6.23, vous devriez voir des pods similaires à ceux-ci :</p>
...
<p>La procédure suivante part du principe que vous souhaitez activer <code translate="no">proxy.http</code>.</p>
...
<p>Pour connaître les éléments de configuration concernés, consultez la section « <a href="/docs/fr/v2.6.x/system_configuration.md">Configuration du système</a> ».</p></li>
...
<h3 id="2-Download-image-pulling-script" class="common-anchor-header">2. Télécharger le script de récupération des images<button data-href="#2-Download-image-pulling-script" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Le script de récupération d’images est développé en Python. Vous devez télécharger le script ainsi que ses dépendances dans le fichier <code translate="no">requirement.txt</code>.</p>
...
<h2 id="Upgrade-running-Milvus-cluster" class="common-anchor-header">Mise à jour d’un cluster Milvus en cours d’exécution<button data-href="#Upgrade-running-Milvus-cluster" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Exécutez la commande suivante pour mettre à jour votre cluster Milvus en cours d'exécution vers la dernière version :</p>
...
<li><a href="/docs/fr/v2.6.x/manage-partitions.md">Gérer des partitions</a></li>
...
<li><p>Découvrez <a href="/docs/fr/v2.6.x/birdwatcher_overview.md">Birdwatcher</a>, un outil open source permettant de déboguer Milvus et d'effectuer des mises à jour dynamiques de la configuration.</p></li>
<li><p>Découvrez <a href="https://github.com/zilliztech/attu">Attu</a>, un outil graphique open source permettant une gestion intuitive de Milvus.</p></li>
