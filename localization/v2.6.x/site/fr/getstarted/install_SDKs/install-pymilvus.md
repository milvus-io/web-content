...
Il est recommandé d'installer une version de PyMilvus correspondant à la version du serveur Milvus que vous avez installée. Pour plus d'informations, voir les <a href="/docs/fr/v2.6.x/release_notes.md">notes de mise à jour</a>.</div>
