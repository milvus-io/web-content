...
<h3 id="Core-260-features-recall" class="common-anchor-header">Rappel des fonctionnalités du Core 2.6.0</h3><div class="alert note">
...
<h3 id="Architecture-Changes" class="common-anchor-header">Modifications de l'architecture</h3><p>Depuis la version 2.6, Milvus introduit d'importantes modifications architecturales visant à améliorer les performances, l'évolutivité et la facilité d'utilisation. Pour plus d'informations, voir la <a href="/docs/fr/architecture_overview.md">présentation de l'architecture Milvus</a>.</p>
...
<p>Pour plus d'informations, reportez-vous à la section <a href="/docs/fr/add-fields-to-an-existing-collection.md">Ajouter des champs à une collection existante</a>.</p>
