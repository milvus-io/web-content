...
summary: construire un chiffon avec milvus
title: Construire RAG avec Milvus
---
<h1 id="Build-RAG-with-Milvus" class="common-anchor-header">Construire RAG avec Milvus<button data-href="#Build-RAG-with-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Dans ce tutoriel, nous allons vous montrer comment construire un pipeline RAG (Retrieval-Augmented Generation) avec Milvus.</p>
...
<h2 id="Quick-Deploy" class="common-anchor-header">Déploiement rapide<button data-href="#Quick-Deploy" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pour savoir comment démarrer une démo en ligne avec ce tutoriel, veuillez vous référer à l'<a href="https://github.com/milvus-io/bootcamp/tree/master/tutorials/quickstart/apps/rag_search_with_milvus">application d'exemple</a>.</p>
