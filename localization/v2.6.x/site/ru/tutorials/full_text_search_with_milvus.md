...
<h2 id="Initialization-with-BM25-Function" class="common-anchor-header">Инициализация с помощью функции BM25<button data-href="#Initialization-with-BM25-Function" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Hybrid-Search" class="common-anchor-header">Гибридный поиск<button data-href="#Hybrid-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="BM25-search-without-embedding" class="common-anchor-header">Поиск BM25 без встраивания<button data-href="#BM25-search-without-embedding" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Multi-language-Analyzer" class="common-anchor-header">Многоязычный анализатор<button data-href="#Multi-language-Analyzer" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Milvus поддерживает многоязычные анализаторы для документов на нескольких языках. Используйте <code translate="no">multi_analyzer_params</code> в <code translate="no">BM25BuiltInFunction</code>:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Более подробную информацию см. в <a href="https://milvus.io/docs/multi-language-analyzers.md">документации по мультиязычному анализатору</a>.</p>
