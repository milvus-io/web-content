...
<h2 id="Insert-data​" class="common-anchor-header">Вставка данных<button data-href="#Insert-data​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Вы можете использовать модели встраивания, доступные в pymilvus, для генерации векторных вложений для ваших текстов. Подробности см. в разделе <a href="https://milvus.io/docs/embeddings.md">Обзор вкраплений</a>. В этом разделе мы вставим в коллекцию случайно сгенерированные данные.</p>
