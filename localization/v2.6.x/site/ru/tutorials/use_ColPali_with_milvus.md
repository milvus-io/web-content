...
<p>Функция MaxSim сравнивает запрос и документ (то, что вы ищете), просматривая их вкрапления лексем. Для каждого слова в запросе она выбирает наиболее похожее слово из документа (используя косинусоидальное сходство или квадратичное расстояние L2) и суммирует эти максимальные сходства по всем словам в запросе.</p>
