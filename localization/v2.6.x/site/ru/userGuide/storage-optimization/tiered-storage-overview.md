...
<li><p><strong>Индексы</strong>: Загружаются по требованию на <strong>уровне сегментов</strong>. Файлы индексов должны загружаться как целые единицы и не могут быть разделены на куски.</p></li>
</ul>
<p><strong>Конфигурация</strong></p>
