...
<h1 id="Manage-Aliases" class="common-anchor-header">Управление псевдонимами<button data-href="#Manage-Aliases" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus предоставляет возможности управления псевдонимами. На этой странице показаны процедуры создания, перечисления, изменения и удаления псевдонимов.</p>
<h2 id="Overview" class="common-anchor-header">Обзор<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Вы можете создавать псевдонимы для своих коллекций. Коллекция может иметь несколько псевдонимов, но коллекции не могут совместно использовать псевдоним.</p>
<p>Получив запрос на коллекцию, Milvus находит ее по указанному имени. Если коллекции по указанному имени не существует, Milvus продолжает поиск по указанному имени в качестве псевдонима. Вы можете использовать псевдонимы коллекций, чтобы адаптировать свой код к различным сценариям.</p>
