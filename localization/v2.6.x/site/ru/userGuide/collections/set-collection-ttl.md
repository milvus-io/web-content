...
<p>Сущности с истекшим сроком хранения не будут отображаться в результатах поиска или запросов. Однако они могут оставаться в хранилище до последующего уплотнения данных, которое должно быть выполнено в течение следующих 24 часов.</p>
...
<p>Свойство TTL в коллекции Milvus задается как целое число в секундах. После установки этого свойства все данные, которые превысили свой TTL, будут автоматически удалены из коллекции.</p>
...
<ul>
<li><p><a href="/docs/ru/v2.6.x/set-collection-ttl.md#Set-TTL-when-creating-a-collection">Создании коллекции.</a></p></li>
<li><p><a href="/docs/ru/v2.6.x/set-collection-ttl.md#Set-TTL-for-an-existing-collection">Изменить свойство TTL существующей коллекции.</a></p></li>
</ul>
<h3 id="Set-TTL-when-creating-a-collection" class="common-anchor-header">Установка TTL при создании коллекции<button data-href="#Set-TTL-when-creating-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Следующий фрагмент кода демонстрирует, как установить свойство TTL при создании коллекции.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Set-TTL-for-an-existing-collection" class="common-anchor-header">Установка TTL для существующей коллекции<button data-href="#Set-TTL-for-an-existing-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Следующий фрагмент кода демонстрирует, как изменить свойство TTL в существующей коллекции.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
