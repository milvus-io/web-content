...
<table>
   ...
   <tr>
     ...
     <td><p>Определяет размер промежуточных результатов, сохраняемых во время поиска. Большее значение может улучшить запоминание в ущерб производительности поиска. Оно должно быть, по крайней мере, равно конечному значению top-k (limit) и, как правило, равно 2 (например, 16, 32, 64, 128).</p></td>
     <td><p>Пустой</p></td>
   </tr>
   <tr>
