...
<p><strong>Значение по умолчанию</strong>: <code translate="no">SQ8</code></p></td>
   ...
   <tr>
     ...
     <td><p>Булевский флаг, который определяет, будет ли применяться шаг уточнения во время поиска. Уточнение заключается в повторном ранжировании исходных результатов путем вычисления точных расстояний между вектором запроса и кандидатами.</p></td>
...
<p><strong>Значение по умолчанию</strong>: 1</p></td>
     <td><p>Более высокие значения <code translate="no">refine_k</code> могут улучшить отзыв и точность, но также увеличат время поиска и использование ресурсов. Значение 1 означает, что в процессе уточнения рассматриваются только первые K результатов.</p></td>
   </tr>
</table>
