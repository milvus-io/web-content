...
<li><p>MINHASH_LSH</p></li>
   ...
   <tr>
     <td><p>VARCHAR</p></td>
     <td><ul>
<li><p>ИНВЕРТИРОВАННЫЙ (Рекомендуется)</p></li>
<li><p>BITMAP</p></li>
<li><p>Тройка</p></li>
</ul></td>
   </tr>
   <tr>
     <td><p>BOOL</p></td>
     <td><ul>
<li>BITMAP (рекомендуется)</li>
<li>ИНВЕРТИРОВАННЫЙ</li>
</ul></td>
   </tr>
   <tr>
     <td><ul>
...
<ul>
<li><p><strong>Скалярная квантование</strong> (например, <strong>SQ8</strong>) позволяет Milvus сжимать каждую размерность вектора в один байт (8 бит), сокращая потребление памяти на 75 % по сравнению с 32-битными плавающими числами при сохранении разумной точности.</p></li>
