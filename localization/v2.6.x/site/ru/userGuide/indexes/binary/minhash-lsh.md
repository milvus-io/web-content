...
<table>
   ...
   <tr>
     ...
     <td><p>Для 128-мерных сигнатур: начните с 32 полос (4 значения/полосу). Увеличьте до 64 для повышения запоминаемости, уменьшите до 16 для повышения производительности. Длина подписи должна делиться равномерно.</p></td>
   </tr>
   <tr>
