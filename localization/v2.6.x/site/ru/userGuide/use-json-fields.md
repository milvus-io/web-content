...
title: Использование полей JSON
---
<h1 id="Use-JSON-Fields" class="common-anchor-header">Использование полей JSON<button data-href="#Use-JSON-Fields" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>В этом руководстве рассказывается об использовании полей JSON, в том числе о вставке значений JSON, а также о поиске и запросе в полях JSON с помощью базовых и расширенных операторов.</p>
<h2 id="Overview" class="common-anchor-header">Обзор<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>JSON расшифровывается как Javascript Object Notation, это легкий и простой текстовый формат данных. Данные в JSON структурированы в виде пар ключ-значение, где каждый ключ - это строка, которая сопоставляется со значением числа, строки, булевого числа, списка или массива. В кластерах Milvus можно хранить словари как значения полей в коллекциях.</p>
<p>Например, следующий код случайным образом генерирует пары ключ-значение, каждая из которых содержит JSON-поле с ключом <strong>color</strong>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Вы можете просмотреть структуру сгенерированных данных, проверив их первую запись.</p>
...
<p><b>примечания</b></p>
<ul>
<li><p>Убедитесь, что все значения в списке или массиве имеют одинаковый тип данных.</p></li>
<li><p>Любые вложенные словари в значении поля JSON будут считаться строками.</p></li>
<li><p>Используйте только буквенно-цифровые символы и символы подчеркивания для названия ключей JSON, так как другие символы могут вызвать проблемы с фильтрацией или поиском.</p></li>
<li>В настоящее время индексирование полей JSON недоступно, что может сделать фильтрацию трудоемкой. Однако это ограничение будет устранено в ближайших выпусках.</li>
</ul>
</div>
<h2 id="Define-JSON-field" class="common-anchor-header">Определение поля JSON<button data-href="#Define-JSON-field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Чтобы определить поле JSON, просто выполните ту же процедуру, что и при определении полей других типов.</p>
<div class="language-python">
<p>Для получения дополнительной информации о параметрах см. <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_schema.md"><code translate="no">create_schema()</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/CollectionSchema/add_field.md"><code translate="no">add_field()</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/add_index.md"><code translate="no">add_index()</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_collection.md"><code translate="no">create_collection()</code></a>, и <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/get_load_state.md"><code translate="no">get_load_state()</code></a> в справочнике SDK.</p>
</div>
<div class="language-java">
<p>Для получения дополнительной информации о параметрах см. <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Client/MilvusClientV2.md"><code translate="no">MilvusClientV2</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createSchema.md"><code translate="no">createSchema()</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/CollectionSchema/addField.md"><code translate="no">addField()</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Management/IndexParam.md"><code translate="no">IndexParam</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createCollection.md"><code translate="no">createCollection()</code></a>, и <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Management/getLoadState.md"><code translate="no">getLoadState()</code></a> в справочнике SDK.</p>
</div>
<div class="language-javascript">
<p>Для получения дополнительной информации о параметрах см. <a href="https://milvus.io/api-reference/node/v2.4.x/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a> и <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a> и <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a> в справочнике SDK.</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<div class="language-javascript">
<p>Для получения дополнительной информации о параметрах см. <a href="https://milvus.io/api-reference/node/v2.4.x/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a>, <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a>, и <a href="https://milvus.io/api-reference/node/v2.4.x/Management/getLoadState.md"><code translate="no">getLoadState()</code></a> в справочнике SDK.</p>
</div>
<h2 id="Insert-field-values" class="common-anchor-header">Вставка значений полей<button data-href="#Insert-field-values" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>После создания коллекции из объекта <code translate="no">CollectionSchema</code> в нее можно вставить словари, подобные приведенному выше.</p>
<div class="language-python">
<p>Для этого воспользуйтесь методом <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/insert.md"><code translate="no">insert()</code></a> для вставки данных в коллекцию.</p>
</div>
<div class="language-java">
<p>Используйте <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/insert.md"><code translate="no">insert()</code></a> для вставки данных в коллекцию.</p>
</div>
<div class="language-javascript">
<p>Используйте метод <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/insert.md"><code translate="no">insert()</code></a> для вставки данных в коллекцию.</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<h2 id="Basic-scalar-filtering" class="common-anchor-header">Базовая скалярная фильтрация<button data-href="#Basic-scalar-filtering" class="anchor-icon" translate="no">
    ...
    </button></h2><p>После того как все данные добавлены, вы можете выполнять поиск и запросы по ключам в JSON-поле так же, как и в стандартном скалярном поле.</p>
<div class="language-python">
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Advanced-scalar-filtering" class="common-anchor-header">Расширенная скалярная фильтрация<button data-href="#Advanced-scalar-filtering" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Milvus предоставляет набор расширенных фильтров для скалярной фильтрации полей JSON. Этими фильтрами являются <code translate="no">JSON_CONTAINS</code>, <code translate="no">JSON_CONTAINS_ALL</code> и <code translate="no">JSON_CONTAINS_ANY</code>.</p>
<ul>
<li><p>Фильтрует все сущности, у которых в качестве эталонного набора цветов используется <code translate="no">[&quot;blue&quot;, &quot;brown&quot;, &quot;grey&quot;]</code>.</p>
...
<li><p>Фильтрует сущности, имеющие координатор <code translate="no">[4, 5]</code>.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Фильтрует сущности, координатор которых содержит либо <code translate="no">4</code>, либо <code translate="no">5</code>.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;test_collection&quot;</span>,
...
<h2 id="Reference-on-JSON-filters" class="common-anchor-header">Справочник по фильтрам JSON<button data-href="#Reference-on-JSON-filters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>При работе с JSON-полями вы можете использовать либо сами JSON-поля в качестве фильтров, либо некоторые из их специфических ключей.</p>
<div class="admonition note">
<p><b>Примечания</b></p>
<ul>
<li>Milvus сохраняет строковые значения в поле JSON как есть, не выполняя семантического экранирования или преобразования. </li>
</ul>
<p>Например, <code translate="no">'a"b'</code>, <code translate="no">"a'b"</code>, <code translate="no">'a\\\\'b'</code> и <code translate="no">"a\\\\"b"</code> будут сохранены как есть, а <code translate="no">'a'b'</code> и <code translate="no">"a"b"</code> будут рассматриваться как недопустимые значения.</p>
<ul>
<li><p>Для построения выражений фильтрации по полю JSON можно использовать ключи внутри поля. </p></li>
<li><p>Если значение ключа является целым числом или плавающей запятой, его можно сравнить с другим целым числом или плавающей запятой или с полем INT32/64 или FLOAT32/64.</p></li>
<li><p>Если значение ключа является строкой, его можно сравнивать только с другим строковым ключом или полем VARCHAR.</p></li>
</ul>
</div>
<h3 id="Basic-Operators-in-JSON-Fields" class="common-anchor-header">Основные операторы в полях JSON<button data-href="#Basic-Operators-in-JSON-Fields" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>В следующей таблице предполагается, что значение поля JSON с именем <code translate="no">json_key</code> имеет ключ с именем <code translate="no">A</code>. Используйте ее как справочник при построении булевых выражений с использованием ключей полей JSON.</p>
<table>
<thead>
<tr><th><strong>Оператор</strong></th><th><strong>Примеры</strong></th><th><strong>Примечания</strong></th></tr>
</thead>
<tbody>
<tr><td><strong>&lt;</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &lt; 3'</code></td><td>Это выражение принимает значение true, если значение <code translate="no">json_field[&quot;A&quot;]</code> меньше <code translate="no">3</code>.</td></tr>
<tr><td><strong>&gt;</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &gt; 1'</code></td><td>Это выражение считается истинным, если значение <code translate="no">json_field[&quot;A&quot;]</code> больше, чем <code translate="no">1</code>.</td></tr>
<tr><td><strong>==</strong></td><td><code translate="no">'json_field[&quot;A&quot;] == 1'</code></td><td>Это выражение считается истинным, если значение <code translate="no">json_field[&quot;A&quot;]</code> равно <code translate="no">1</code>.</td></tr>
<tr><td><strong>!=</strong></td><td><code translate="no">'json_field[&quot;A&quot;][0]' != &quot;abc&quot;'</code></td><td>Это выражение равно true, если<br/> - <code translate="no">json_field</code> не имеет ключа с именем <code translate="no">A</code>.<br/> - У <code translate="no">json_field</code> есть ключ с именем <code translate="no">A</code>, но <code translate="no">json_field[&quot;A&quot;]</code> не является массивом.<br/> - <code translate="no">json_field[&quot;A&quot;]</code> - пустой массив.<br/> - <code translate="no">json_field[&quot;A&quot;]</code> - массив, но первый элемент не <code translate="no">abc</code>.<br/></td></tr>
<tr><td><strong>&lt;=</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &lt;= 5'</code></td><td>Это выражение равно true, если значение <code translate="no">json_field[&quot;A&quot;]</code> меньше или равно <code translate="no">5</code>.</td></tr>
<tr><td><strong>&gt;=</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &gt;= 1'</code></td><td>Это выражение считается истинным, если значение <code translate="no">json_field[&quot;A&quot;]</code> больше или равно <code translate="no">1</code>.</td></tr>
<tr><td><strong>не</strong></td><td><code translate="no">'not json_field[&quot;A&quot;] == 1'</code></td><td>Это выражение равно true, если<br/> - <code translate="no">json_field</code> не имеет ключа с именем <code translate="no">A</code>.<br/> - <code translate="no">json_field[&quot;A&quot;]</code> не равно <code translate="no">1</code>.<br/></td></tr>
<tr><td><strong>в</strong></td><td><code translate="no">'json_field[&quot;A&quot;] in [1, 2, 3]'</code></td><td>Это выражение равно true, если значение <code translate="no">json_field[&quot;A&quot;]</code> равно <code translate="no">1</code>, <code translate="no">2</code> или <code translate="no">3</code>.</td></tr>
<tr><td><strong>и (&amp;&amp;)</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &gt; 1 &amp;&amp; json_field[&quot;A&quot;] &lt; 3'</code></td><td>Это выражение равно true, если значение <code translate="no">json_field[&quot;A&quot;]</code> больше 1 и меньше <code translate="no">3</code>.</td></tr>
<tr><td><strong>или (||)</strong></td><td><code translate="no">‘json_field[“A”] > 1 || json_field[“A”] < 3’</code></td><td>Это выражение считается истинным, если значение <code translate="no">json_field[&quot;A&quot;]</code> больше <code translate="no">1</code> или меньше <code translate="no">3</code>.</td></tr>
<tr><td><strong>существует</strong></td><td><code translate="no">'exists json_field[&quot;A&quot;]'</code></td><td>Это выражение равно true, если у <code translate="no">json_field</code> есть ключ с именем <code translate="no">A</code>.</td></tr>
</tbody>
</table>
<h3 id="Advanced-Operators" class="common-anchor-header">Расширенные операторы<button data-href="#Advanced-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Следующие операторы специфичны для полей JSON:</p>
<ul>
<li><p><code translate="no">json_contains(identifier, jsonExpr)</code></p>
<p>Этот оператор фильтрует сущности, идентификатор которых содержит указанное выражение JSON.</p>
<ul>
<li><p>Пример 1: <code translate="no">{&quot;x&quot;: [1,2,3]}</code></p>
...
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Пример 2: <code translate="no">{&quot;x&quot;, [[1,2,3], [4,5,6], [7,8,9]]}</code></p>
...
<p>Этот оператор фильтрует сущности, идентификатор которых содержит все члены JSON-выражения.</p>
<p>Пример: <code translate="no">{&quot;x&quot;: [1,2,3,4,5,7,8]}</code></p>
...
<p>Этот оператор фильтрует сущности, идентификатор которых содержит любой член выражения JSON.</p>
<p>Пример: <code translate="no">{&quot;x&quot;: [1,2,3,4,5,7,8]}</code></p>
