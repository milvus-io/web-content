...
<div class="alert note">
<p>Чтобы получить файл конфигурации Milvus<strong>(docker-compose.yaml</strong>), обратитесь к разделу <a href="/docs/ru/configure-docker.md#Download-an-installation-file">"Скачать установочный файл"</a>.</p>
</div>
<ol>
...
<div class="alert note">
<p>Чтобы получить файл конфигурации Milvus<strong>(values.yaml</strong>), обратитесь к разделу <a href="/docs/ru/configure-helm.md#Configure-Milvus-via-configuration-file">Настройка Milvus через файл конфигурации</a>.</p>
</div>
<ol>
...
<table>
   ...
   <tr>
     ...
     <td><p>Регион для службы Vertex AI. В настоящее время встраивания Vertex AI в основном поддерживают регион us-central1. По умолчанию - us-central1.</p></td>
     <td><p>Нет</p></td>
