...
<table>
   ...
   <tr>
     ...
     <td><p>Да</p></td>
     <td><p>Модель рерайтинга Cohere, которую следует использовать из поддерживаемых моделей на платформе Cohere.</p><p>Список доступных моделей рерайтинга см. в <a href="https://docs.cohere.com/docs/rerank">документации Cohere</a>.</p></td>
