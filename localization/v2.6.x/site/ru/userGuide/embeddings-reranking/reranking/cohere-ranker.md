...
<table>
   ...
   <tr>
     ...
     <td><p>Да</p></td>
     <td><p>Модель реранкинга Cohere, которую следует использовать из поддерживаемых моделей на платформе Cohere. Список доступных моделей реранкинга см. в <a href="https://docs.cohere.com/docs/rerank">документации Cohere</a>.</p></td>
