...
<p>Чтобы применить вышеуказанные настройки к вашему кластеру Milvus, выполните действия, описанные в разделах <a href="/docs/ru/v2.6.x/configure-helm.md#Configure-Milvus-via-configuration-file">"Настройка Milvus с помощью Helm"</a> и <a href="/docs/ru/v2.6.x/configure_operator.md">"Настройка Milvus с помощью Milvus Operators</a>".</p>
