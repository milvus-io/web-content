...
<h3 id="Step-1-Create-a-collection" class="common-anchor-header">Шаг 1: Создание коллекции<button data-href="#Step-1-Create-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Insert-randomly-generated-entities" class="common-anchor-header">Шаг 2: Вставьте случайно сгенерированные сущности<button data-href="#Step-2-Insert-randomly-generated-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Create-partitions-and-insert-more-entities" class="common-anchor-header">Шаг 3: Создание разделов и вставка дополнительных сущностей<button data-href="#Step-3-Create-partitions-and-insert-more-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Get-entities-from-partitions" class="common-anchor-header">Получение сущностей из разделов<button data-href="#Get-entities-from-partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Вы также можете получить сущности из определенных разделов.</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<h3 id="Count-entities" class="common-anchor-header">Подсчитать сущности<button data-href="#Count-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Подсчитывает общее количество сущностей в определенных разделах.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Подсчитывает количество сущностей, соответствующих условию фильтрации</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<h2 id="Reference-on-scalar-filters" class="common-anchor-header">Справочник по скалярным фильтрам<button data-href="#Reference-on-scalar-filters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><h3 id="Basic-Operators" class="common-anchor-header">Основные операторы<button data-href="#Basic-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><strong>Булево выражение</strong> - это всегда <strong>строка, состоящая из имен полей, объединенных операторами</strong>. В этом разделе вы узнаете больше об основных операторах.</p>
<table>
<thead>
<tr><th><strong>Оператор</strong></th><th><strong>Описание</strong></th></tr>
</thead>
<tbody>
<tr><td><strong>и (&amp;&amp;)</strong></td><td>Истинно, если оба операнда истинны</td></tr>
<tr><td><strong>или (||)</strong></td><td>Истинно, если оба операнда истинны</td></tr>
<tr><td><strong>+, -, *, /</strong></td><td>Сложение, вычитание, умножение и деление</td></tr>
<tr><td><strong>**</strong></td><td>Экспонента</td></tr>
<tr><td><strong>%</strong></td><td>Модуль</td></tr>
<tr><td><strong><, ></strong></td><td>Меньше, чем, больше, чем</td></tr>
<tr><td><strong>==, !=</strong></td><td>Равно, не равно</td></tr>
<tr><td><strong><=, >=</strong></td><td>Меньше или равно, больше или равно</td></tr>
<tr><td><strong>не</strong></td><td>Отменяет результат выполнения заданного условия.</td></tr>
<tr><td><strong>подобно</strong></td><td>Сравнивает значение с похожими значениями с помощью операторов подстановки.<br/> Например, like "prefix%" сопоставляет строки, начинающиеся с "prefix".</td></tr>
<tr><td><strong>in</strong></td><td>Проверяет, совпадает ли выражение с любым значением в списке значений.</td></tr>
</tbody>
</table>
<h3 id="Advanced-operators" class="common-anchor-header">Дополнительные операторы<button data-href="#Advanced-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Подсчитывает точное количество сущностей в коллекции. Используйте это поле в качестве выходного поля, чтобы получить точное количество сущностей в коллекции или разделе.</p>
<p><div class="admonition note"></p>
<p><p><b>заметки</b></p></p>
<p><p>Этот параметр применяется к загруженным коллекциям. Вы должны использовать его в качестве единственного выходного поля.</p></p>
<p></div></p></li>
</ul>
