...
<p>Для более простой настройки вы можете использовать <a href="/docs/ru/standard-analyzer.md"><code translate="no">standard</code></a> <a href="/docs/ru/standard-analyzer.md">анализатор</a>, который сочетает в себе токенизатор <code translate="no">standard</code> и <a href="/docs/ru/lowercase-filter.md"><code translate="no">lowercase</code></a><a href="/docs/ru/lowercase-filter.md"> фильтром</a>.</p>
</div>
