...
<h2 id="Overview" class="common-anchor-header">Обзор<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>В Milvus <strong>сущность</strong> относится к записям данных в <strong>Коллекции</strong>, которые имеют одну и ту же <strong>схему</strong>, при этом данные в каждом поле строки представляют собой сущность. Поэтому сущности в одной Коллекции имеют одинаковые атрибуты (например, имена полей, типы данных и другие ограничения).</p>
