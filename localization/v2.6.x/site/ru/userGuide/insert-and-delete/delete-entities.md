...
summary: >-
  Вы можете удалить сущности, которые больше не нужны, с помощью условий
  фильтрации или их первичных ключей.
---
<h1 id="Delete-Entities" class="common-anchor-header">Удаление сущностей<button data-href="#Delete-Entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Вы можете удалить сущности, которые больше не нужны, с помощью условий фильтрации или их первичных ключей.</p>
<h2 id="Delete-Entities-by-Filtering-Conditions" class="common-anchor-header">Удаление сущностей по условиям фильтрации<button data-href="#Delete-Entities-by-Filtering-Conditions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>При пакетном удалении нескольких сущностей, имеющих общие атрибуты, можно использовать выражения фильтрации. В приведенном ниже примере используется оператор <strong>in</strong> для массового удаления всех сущностей, для поля <strong>color</strong> которых установлены значения <strong>red</strong> и <strong>purple</strong>. Вы также можете использовать другие операторы для построения выражений фильтрации, отвечающих вашим требованиям. Для получения дополнительной информации о выражениях фильтрации обратитесь к разделу <a href="/docs/ru/v2.6.x/boolean.md">Filtering Explained</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Delete-Entities-by-Primary-Keys" class="common-anchor-header">Удаление сущностей по первичным ключам<button data-href="#Delete-Entities-by-Primary-Keys" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>В большинстве случаев первичный ключ однозначно идентифицирует сущность. Вы можете удалять сущности, задавая их первичные ключи в запросе на удаление. В примере ниже показано, как удалить две сущности с первичными ключами <strong>18</strong> и <strong>19</strong>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Delete-Entities-from-Partitions" class="common-anchor-header">Удаление сущностей из разделов<button data-href="#Delete-Entities-from-Partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Вы также можете удалять сущности, хранящиеся в определенных разделах. Следующие фрагменты кода предполагают, что в вашей коллекции есть раздел с именем <strong>PartitionA</strong>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
<pre><code translate="no" class="language-python">res = client.delete(
    collection_name=<span class="hljs-string">&quot;quick_setup&quot;</span>,
