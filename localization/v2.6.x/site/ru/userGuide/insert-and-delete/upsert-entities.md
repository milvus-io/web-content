...
<p>Если для целевой коллекции включено <code translate="no">autoid</code> для ее первичного поля, Milvus сгенерирует новый первичный ключ для данных, содержащихся в полезной нагрузке запроса, прежде чем вставить их.</p>
...
<p>Например, если данные, включенные в запрос, - <code translate="no">{extras: {&quot;author&quot;: &quot;Jane&quot;, &quot;genre&quot;: &quot;fantasy&quot;}}</code>, то пары ключ-значение в поле <code translate="no">extras</code> целевой сущности после udpate станут <code translate="no">{&quot;author&quot;: &quot;Jane&quot;, &quot;year&quot;: 2020, &quot;tags&quot;: [&quot;fiction&quot;], &quot;genre&quot;: &quot;fantasy&quot;}</code>.</p></li>
</ul></li>
</ul>
