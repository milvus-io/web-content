...
<tbody>
<tr><td><code translate="no">enable</code></td><td>Указывает, нужно ли включать уплотнение кластеризации.<br>Установите значение <code translate="no">true</code>, если вам нужно включить эту функцию для каждой коллекции, имеющей ключ кластеризации.</td><td><code translate="no">false</code></td></tr>
