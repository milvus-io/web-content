...
<p>Если основной сервер все еще доступен, используйте <a href="/docs/ru/v2.6.x/cdc_switchover.md">переключение</a>. Переключение позволяет избежать потери данных.</p>
