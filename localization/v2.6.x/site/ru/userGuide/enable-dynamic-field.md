...
<p>После определения поля необходимо включить его при вставке данных. Что делать, если некоторые поля не всегда присутствуют во всех ваших записях данных? Здесь на помощь приходит динамическое поле.</p>
