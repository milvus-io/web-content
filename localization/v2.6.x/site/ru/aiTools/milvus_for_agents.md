...
<tr><td>Самостоятельное производство</td><td><a href="/docs/ru/install_cluster-helm.md">Распределенный Milvus</a></td><td>Многоузловое развертывание Kubernetes для команд, которым необходим полный контроль над инфраструктурой.</td></tr>
</tbody>
</table>
