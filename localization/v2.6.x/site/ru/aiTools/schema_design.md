...
<p>Правила и руководства по принятию решений для разработки правильных схем коллекций Milvus, включая типы полей, первичные ключи, конфигурацию BM25 и ограничения неизменяемости схем. Скопируйте приведенный ниже полный текст подсказки в свой инструмент искусственного интеллекта, чтобы применить эти правила автоматически. Обзор всех подсказок см. в разделе <a href="/docs/ru/milvus_for_agents.md">Подсказки AI</a>.</p>
