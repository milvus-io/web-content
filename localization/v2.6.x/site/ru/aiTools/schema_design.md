...
<h1 id="Schema-Design" class="common-anchor-header">Проектирование схем<button data-href="#Schema-Design" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Правила и руководства по принятию решений для разработки правильных схем коллекций Milvus, включая типы полей, первичные ключи, конфигурацию BM25 и ограничения неизменяемости схемы. Скопируйте приведенный ниже полный текст подсказки в свой инструмент AI, чтобы применить эти правила автоматически. Обзор всех подсказок см. в разделе <a href="/docs/ru/milvus_for_agents.md">Подсказки AI</a>.</p>
