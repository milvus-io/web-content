...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Обновление автономной версии Milvus с помощью Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>В данном руководстве описано, как обновить автономную версию Milvus с версии v2.5.x до v2.6.23 с помощью Milvus Operator.</p>
...
<p>Этот процесс обновления обеспечивает правильный переход на новую архитектуру. Дополнительную информацию об изменениях в архитектуре см. в <a href="/docs/ru/v2.6.x/architecture_overview.md">обзоре архитектуры Milvus</a>.</p>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>несовместим</strong> с версией v2.6.23. Прямые обновления с кандидатов в релизы не поддерживаются.</li>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2623" class="common-anchor-header">2.2 Обновление до версии 2.6.23</h4><p>После успешного запуска версии v2.5.16 выполните обновление до версии v2.6.23:</p>
