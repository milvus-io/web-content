...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Обновление кластера Milvus с помощью диаграммы Helm<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>В этом руководстве описано, как обновить кластер Milvus с версии v2.5.x до v2.6.23 с помощью Helm Chart.</p>
<h2 id="Before-you-start" class="common-anchor-header">Перед началом<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Обновление с Milvus 2.5.x до 2.6.23 сопряжено со значительными архитектурными изменениями:</p>
<ul>
...
<li>Перед обновлением до версии v2.6.23 <strong>необходимо</strong> выполнить обновление до версии v2.5.16 или более поздней с включенной функцией « <code translate="no">mixCoordinator</code> ».</li>
</ul>
...
<h3 id="Step-3-Upgrade-to-v2623" class="common-anchor-header">Шаг 3: Обновление до версии v2.6.23<button data-href="#Step-3-Upgrade-to-v2623" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Как только версия 2.5.16 начнет успешно работать с <code translate="no">mixCoordinator</code>, обновите систему до версии 2.6.23:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
