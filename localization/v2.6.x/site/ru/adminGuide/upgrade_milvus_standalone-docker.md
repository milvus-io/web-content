...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Обновление автономной версии Milvus с помощью Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>В данном руководстве описано, как обновить автономную версию Milvus с версии v2.5.x до версии v2.6.24 с помощью Docker Compose.</p>
...
<li><strong>Новые компоненты</strong>: введено потоковое узеловое решение для усовершенствованной обработки данных</li>
...
<li>Перед обновлением до версии v2.6.24 <strong>необходимо</strong> обновиться до версии v2.5.16 или более поздней.</li>
</ul>
...
<p>Из соображений безопасности в версии v2.6.24 Milvus обновляет MinIO до версии RELEASE.2024-12-18T13-15-44Z.</p>
</div>
<h2 id="Upgrade-process" class="common-anchor-header">Процесс обновления<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Upgrade-to-v2516" class="common-anchor-header">Шаг 1: Обновление до версии v2.5.16<button data-href="#Step-1-Upgrade-to-v2516" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
docker compose up -d
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Проверьте обновление до версии v2.5.16:</p>
<pre><code translate="no" class="language-bash">docker compose ps
<button class="copy-code-btn"></button></code></pre></li>
</ol>
<h3 id="Step-2-Upgrade-to-v2624" class="common-anchor-header">Шаг 2: Обновление до версии v2.6.24<button data-href="#Step-2-Upgrade-to-v2624" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>После успешного запуска версии v2.5.16 выполните обновление до версии v2.6.24:</p>
<ol>
<li><p>Отредактируйте существующий файл ` <code translate="no">docker-compose.yaml</code> ` и обновите теги образов Milvus и MinIO:</p>
<pre><code translate="no" class="language-yaml"><span class="hljs-string">...</span>
...
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Примените окончательное обновление:</p>
<pre><code translate="no" class="language-bash">docker compose down
docker compose up -d
<button class="copy-code-btn"></button></code></pre></li>
</ol>
