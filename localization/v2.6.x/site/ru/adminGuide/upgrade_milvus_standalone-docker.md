...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Обновление автономной версии Milvus с помощью Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>В данном руководстве описано, как обновить автономную версию Milvus с версии v2.5.x до версии v2.6.23 с помощью Docker Compose.</p>
<h2 id="Before-you-start" class="common-anchor-header">Перед началом<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Обновление с Milvus 2.5.x до 2.6.23 сопряжено со значительными изменениями в архитектуре:</p>
<ul>
...
<li><strong>Новые компоненты</strong>: введение потокового узла (Streaming Node) для улучшенной обработки данных</li>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>не совместим</strong> с версией v2.6.23. Прямое обновление с кандидатских версий не поддерживается.</li>
<li>Если вы в настоящее время используете версию v2.6.0-rc1 и хотите сохранить свои данные, пожалуйста, ознакомьтесь с <a href="https://github.com/milvus-io/milvus/issues/43538#issuecomment-3112808997">этим руководством сообщества</a>, чтобы получить помощь по миграции.</li>
...
<p>Из соображений безопасности в версии v2.6.23 Milvus обновляет MinIO до версии RELEASE.2024-12-18T13-15-44Z.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v2623" class="common-anchor-header">Шаг 2: Обновление до версии v2.6.23<button data-href="#Step-2-Upgrade-to-v2623" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>После успешного запуска версии v2.5.16 выполните обновление до версии v2.6.23:</p>
<ol>
