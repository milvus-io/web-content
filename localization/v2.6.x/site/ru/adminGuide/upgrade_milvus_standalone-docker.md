...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Обновление Milvus Standalone с помощью Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>В этом руководстве описано, как обновить автономное развертывание Milvus с версии 2.5.x до версии 2.6.8 с помощью Docker Compose.</p>
...
<li>Перед переходом на v2.6.8 <strong>необходимо</strong> обновить версию до v2.5.16 или более поздней.</li>
</ul>
...
<p>По соображениям безопасности Milvus обновляет MinIO до RELEASE.2024-12-18T13-15-44Z с выходом v2.6.8.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v268" class="common-anchor-header">Шаг 2: Обновление до v2.6.8<button data-href="#Step-2-Upgrade-to-v268" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>После успешной работы v2.5.16 обновитесь до v2.6.8:</p>
<ol>
