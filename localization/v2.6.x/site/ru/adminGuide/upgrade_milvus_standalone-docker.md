...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Обновление автономной системы Milvus с помощью Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>В этом руководстве описано, как обновить автономное развертывание Milvus с версии 2.5.x до версии 2.6.11 с помощью Docker Compose.</p>
...
<p>По соображениям безопасности Milvus обновляет MinIO до RELEASE.2024-12-18T13-15-44Z с выходом v2.6.11.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v2611" class="common-anchor-header">Шаг 2: Обновление до v2.6.11<button data-href="#Step-2-Upgrade-to-v2611" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>После успешной работы v2.5.16 перейдите на v2.6.11:</p>
<ol>
