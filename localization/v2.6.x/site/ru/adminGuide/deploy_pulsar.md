...
<p>Подробности о настройке Milvus с помощью Helm см. в разделе <a href="/docs/ru/v2.6.x/configure-helm.md">«Настройка Milvus с помощью диаграмм Helm</a>». Подробности о параметрах конфигурации, связанных с Pulsar, см. в разделе <a href="/docs/ru/v2.6.x/configure_pulsar.md">«Настройки, связанные с Pulsar</a>».
|</p>
