...
title: Обновление автономной системы Milvus с помощью Helm Chart
---
<div class="tab-wrapper"><a href="/docs/ru/v2.6.x/upgrade_milvus_standalone-operator.md" class=''>Milvus</a><a href="/docs/ru/v2.6.x/upgrade_milvus_standalone-helm.md" class='active '>OperatorHelmDocker</a><a href="/docs/ru/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>Compose</a></div>
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Обновление автономной системы Milvus с помощью Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>В этом руководстве описано, как обновить автономное развертывание Milvus с версии 2.5.x до версии 2.6.16 с помощью Helm Chart.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v2616" class="common-anchor-header">Шаг 3: Обновление до v2.6.16<button data-href="#Step-3-Upgrade-to-v2616" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>После успешного запуска v2.5.16 обновитесь до v2.6.16:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
