...
<p><strong>Что нового в версии 2.6.7:</strong></p>
<ul>
...
<p>Всегда загружайте последнюю версию конфигурации Docker Compose для обеспечения совместимости с функциями v2.6.7.</p>
<ul>
