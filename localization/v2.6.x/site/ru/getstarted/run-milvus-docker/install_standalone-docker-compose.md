...
<p><strong>Что нового в версии 2.6.2:</strong></p>
<ul>
...
<p>Всегда загружайте последнюю версию конфигурации Docker Compose, чтобы обеспечить совместимость с функциями версии 2.6.2.</p>
<ul>
