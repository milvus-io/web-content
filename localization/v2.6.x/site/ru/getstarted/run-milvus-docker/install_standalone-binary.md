...
<button class="copy-code-btn"></button></code></pre>
<p>Бинарный файл Milvus находится по адресу <code translate="no">/usr/bin/milvus</code>, файл службы systemd — по адресу <code translate="no">/lib/systemd/system/milvus.service</code>, а зависимости — по адресу <code translate="no">/usr/lib/milvus/</code>.</p>
