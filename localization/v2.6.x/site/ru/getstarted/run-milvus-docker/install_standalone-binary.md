...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Загрузите пакет RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Вы можете скачать пакет RPM/DEB, соответствующий архитектуре вашей системы, со <a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.22">страницы «Выпуски Milvus</a>».</p>
<ul>
<li>Для x86_64/amd64 загрузите пакет <strong>milvus_2.6.22-1_amd64.deb</strong> или <strong>milvus_2.6.22-1_amd64.rpm</strong>.</li>
<li>Для ARM64 загрузите пакет <strong>milvus_2.6.22-1_arm64.deb</strong> или <strong>milvus_2.6.22-1_arm64.rpm</strong>.</li>
</ul>
