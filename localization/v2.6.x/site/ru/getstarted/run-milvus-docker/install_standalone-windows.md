...
<h2 id="Run-Milvus-in-Docker​" class="common-anchor-header">Запуск Milvus в Docker​<button data-href="#Run-Milvus-in-Docker​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus предоставляет скрипт установки для установки в виде контейнера Docker. После установки Docker Desktop в Microsoft Windows вы можете получить доступ к командной строке Docker из PowerShell или командной строки Windows в режиме <strong>администратора</strong>, а также из WSL 2. ​</p>
...
<h3 id="From-WSL-2​" class="common-anchor-header">Из WSL 2​<button data-href="#From-WSL-2​" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Если вы предпочитаете запускать Milvus с помощью команд Linux и скриптов оболочки в Windows, убедитесь, что у вас уже установлен WSL 2. Подробности об установке WSL 2 см. в этой <a href="https://learn.microsoft.com/en-us/windows/wsl/install#install-wsl-command">статье Microsoft</a>.​</p>
<ol>
...
<h2 id="Run-Milvus-with-Docker-Compose​" class="common-anchor-header">Запустите Milvus с помощью Docker Compose​<button data-href="#Run-Milvus-with-Docker-Compose​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>После установки Docker Desktop в Microsoft Windows вы можете получить доступ к командной строке Docker (CLI) из PowerShell или командной строки Windows в режиме <strong>администратора</strong>. Для запуска Milvus можно запустить Docker Compose в PowerShell, командной строке Windows или WSL 2.</p>
<h3 id="From-PowerShell-or-Windows-Command-Prompt​" class="common-anchor-header">Из PowerShell или командной строки Windows​<button data-href="#From-PowerShell-or-Windows-Command-Prompt​" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
...
<li><p>Контейнер <strong>milvus-minio</strong> обслуживает порты <strong>9090</strong> и <strong>9091</strong> локально с использованием учетных данных по умолчанию и сопоставляет свои данные с <strong>папкой volumes/minio</strong> в текущем каталоге.​</p></li>
