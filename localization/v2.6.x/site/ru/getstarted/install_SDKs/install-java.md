...
<h1 id="Install-Milvus-Java-SDK" class="common-anchor-header">Установка Milvus Java SDK<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>В этом разделе описано, как установить Milvus Java SDK для Milvus.</p>
...
<h2 id="Install-Milvus-Java-SDK" class="common-anchor-header">Установка Java SDK для Milvus<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Выполните следующую команду для установки Java SDK Milvus.</p>
<ul>
<li>Apache Maven</li>
</ul>
...
<h2 id="Whats-next" class="common-anchor-header">Что дальше<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>После установки Milvus Java SDK вы сможете:</p>
<ul>
...
<li><a href="/docs/ru/v2.6.x/single-vector-search.md">Поиск по отдельному вектору</a></li>
<li><a href="/docs/ru/v2.6.x/multi-vector-search.md">Гибридный поиск</a></li>
</ul></li>
<li><p>Ознакомьтесь со <a href="/api-reference/java/v2.4.x/About.md">справочником по Java API Milvus</a></p></li>
</ul>
