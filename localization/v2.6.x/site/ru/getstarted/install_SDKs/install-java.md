...
<li>Java (версия 8 или более поздней)</li>
...
<h2 id="Install-Milvus-Java-SDK" class="common-anchor-header">Установка Java SDK для Milvus<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Выполните следующую команду, чтобы установить Java SDK Milvus.</p>
<ul>
<li>Apache Maven</li>
</ul>
...
<li><p>Ознакомьтесь со <a href="/api-reference/java/v2.6.x/About.md">справочником по Java API Milvus</a></p></li>
</ul>
