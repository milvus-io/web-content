...
<h1 id="Install-Milvus-Python-SDK" class="common-anchor-header">Установка Python SDK для Milvus<button data-href="#Install-Milvus-Python-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>В этом разделе описано, как установить SDK Milvus для Python (pymilvus) для Milvus.</p>
...
<li><p>Ознакомьтесь со <a href="/api-reference/pymilvus/v2.4.x/About.md">справочником по API PyMilvus</a></p></li>
</ul>
