...
Рекомендуется установить версию PyMilvus, соответствующую версии установленного вами сервера Milvus. Для получения дополнительной информации см. информацию <a href="/docs/ru/release_notes.md">о выпуске</a>.</div>
