...
<p>Мы рекомендуем использовать <code translate="no">pymilvus</code>. Вы можете использовать <code translate="no">pip install</code> с <code translate="no">-U</code> для принудительного обновления до последней версии, и <code translate="no">milvus-lite</code> будет установлен автоматически.</p>
...
<h2 id="Connect-to-Milvus-Lite" class="common-anchor-header">Подключение к Milvus Lite<button data-href="#Connect-to-Milvus-Lite" class="anchor-icon" translate="no">
    ...
    </button></h2><p>В <code translate="no">pymilvus</code> укажите локальное имя файла в качестве параметра uri MilvusClient, чтобы использовать Milvus Lite.</p>
...
<h3 id="Collection" class="common-anchor-header">Коллекция<button data-href="#Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Field--Schema" class="common-anchor-header">Поле и схема<button data-href="#Field--Schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Insert--Search" class="common-anchor-header">Вставка и поиск<button data-href="#Insert--Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Load--Release" class="common-anchor-header">Загрузка и освобождение<button data-href="#Load--Release" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Index" class="common-anchor-header">Индекс<button data-href="#Index" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Vector-Index-Types" class="common-anchor-header">Типы векторных индексов<button data-href="#Vector-Index-Types" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Milvus Lite поддерживает только тип индекса <a href="https://milvus.io/docs/index.md?tab=floating#FLAT">FLAT</a>. Он использует тип FLAT независимо от указанного типа индекса в коллекции.</p>
<h3 id="Search-Features" class="common-anchor-header">Особенности поиска<button data-href="#Search-Features" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Milvus Lite поддерживает разреженный векторный, многовекторный и гибридный поиск.</p>
<h3 id="Partition" class="common-anchor-header">Раздел<button data-href="#Partition" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Milvus Lite не поддерживает разделы и методы, связанные с разделами.</p>
<h3 id="Users--Roles" class="common-anchor-header">Пользователи и роли<button data-href="#Users--Roles" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Milvus Lite не поддерживает пользователей и роли, а также связанные с ними методы.</p>
<h3 id="Alias" class="common-anchor-header">Псевдоним<button data-href="#Alias" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Milvus Lite не поддерживает псевдонимы и методы, связанные с псевдонимами.</p>
