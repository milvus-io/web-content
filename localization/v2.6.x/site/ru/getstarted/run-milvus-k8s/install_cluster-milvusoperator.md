...
<button class="copy-code-btn"></button></code></pre>
<p>Команда выше развертывает кластер Milvus с <strong>Woodpecker</strong> в качестве очереди сообщений (рекомендуется для версии 2.6.18) и всеми новыми архитектурными компонентами, включая Streaming Node.</p>
