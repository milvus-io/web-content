...
<p>Дополнительные сведения см. в разделе <a href="/docs/ru/v2.6.x/add-fields-to-an-existing-collection.md">"Добавление полей в существующую коллекцию</a>".</p>
