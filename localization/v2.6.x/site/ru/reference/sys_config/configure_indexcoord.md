...
summary: 'Узнайте, как настроить indexCoord для Milvus.'
---
<h1 id="indexCoord-related-Configurations" class="common-anchor-header">Конфигурации, связанные с IndexCoord<button data-href="#indexCoord-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>        Это пороговое значение. Если число строк сегмента меньше этого значения, сегмент не будет индексироваться      </td>
      <td>1024</td>
    </tr>
  </tbody>
</table>
