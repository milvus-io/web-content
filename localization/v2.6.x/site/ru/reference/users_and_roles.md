...
<ul>
<li>Если тип объекта <code translate="no">Global</code>, имя объекта должно быть установлено на подстановочный знак (<code translate="no">*</code>), указывающий на все объекты указанного типа.</li>
