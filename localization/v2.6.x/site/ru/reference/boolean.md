...
<tr><td>BinaryLogicalOp</td><td>Бинарные логические операторы, которые выполняют действия над двумя операндами. В сложных выражениях с двумя и более операндами порядок оценки зависит от правил старшинства.</td></tr>
