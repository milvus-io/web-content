...
<h3 id="Prepare-the-LLM-and-Embedding-Model" class="common-anchor-header">Подготовка LLM и модели встраивания<button data-href="#Prepare-the-LLM-and-Embedding-Model" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Мы инициализируем клиент для подготовки LLM и модели встраивания. Fireworks AI позволяет использовать API в стиле OpenAI, и вы можете использовать этот же API с небольшими изменениями для вызова модели встраивания и LLM.</p>
