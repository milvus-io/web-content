...
<h1 id="Evaluation-with-Ragas" class="common-anchor-header">Оценка с помощью Ragas<button data-href="#Evaluation-with-Ragas" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Это руководство демонстрирует, как использовать Ragas для оценки конвейера Retrieval-Augmented Generation (RAG), построенного на базе <a href="https://milvus.io/">Milvus</a>.</p>
...
<table border="1" class="dataframe">
  <thead>
    <tr style="text-align: right;">
      <th></th>
      <th>пользовательский_ввод</th>
      <th>полученные_контексты</th>
      <th>ответ</th>
      <th>ссылка</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th>0</th>
      <td>какие требования к аппаратному обеспечению...</td>
...
<h2 id="Evaluation-with-Ragas" class="common-anchor-header">Оценка с помощью Ragas<button data-href="#Evaluation-with-Ragas" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Мы используем Ragas для оценки производительности результатов работы нашего конвейера RAG.</p>
