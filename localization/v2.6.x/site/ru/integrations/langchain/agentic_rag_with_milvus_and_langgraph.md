...
<p><a href="https://langchain-ai.github.io/langgraph/">LangGraph</a> - это библиотека для создания многоакторных приложений с LLM, построенная на основе LangChain. <a href="https://milvus.io/">Milvus</a> - самая продвинутая в мире векторная база данных с открытым исходным кодом, созданная для работы с приложениями поиска сходства встраивания и искусственного интеллекта.</p>
<p>В этом учебном пособии мы создадим агентную систему RAG, которая сможет:</p>
<ul>
