...
<p>在一般情況下，您可以<a href="#Upgrade-Milvus-by-changing-its-image">透過更換映像檔來升級 Milvus</a>。然而，在從 v2.1.x 升級至 v2.6.24 之前，您必須<a href="#Migrate-the-metadata">先遷移元資料</a>。</p>
...
<ol>
<li><p>在<code translate="no">docker-compose.yaml</code> 中修改 Milvus 映像標籤。</p>
<p>請注意，您需要變更代理伺服器、所有協調器以及所有工作節點的映像標籤。</p>
...
<button class="copy-code-btn"></button></code></pre></li>
<li><p>為元數據遷移準備配置檔案<code translate="no">migrate.yaml</code> 。</p>
...
<button class="copy-code-btn"></button></code></pre></li>
<li><p>使用新的 Milvus 映像重新啟動 Milvus 組件。</p>
