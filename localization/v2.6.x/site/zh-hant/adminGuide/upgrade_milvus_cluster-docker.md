...
<h1 id="Upgrade-Milvus-Cluster-with-Docker-Compose" class="common-anchor-header">使用 Docker Compose 升級 Milvus 叢集<button data-href="#Upgrade-Milvus-Cluster-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本主題說明如何使用 Docker Compose 升級您的 Milvus。</p>
<p>通常情況下，您可以<a href="#Upgrade-Milvus-by-changing-its-image">透過更換映像檔來升級 Milvus</a>。然而，在從 v2.1.x 升級至 v2.6.23 之前，您必須<a href="#Migrate-the-metadata">先遷移元資料</a>。</p>
<div class="alert note">
<p><strong>訊息佇列限制</strong>：升級至 Milvus v2.6.23 時，必須維持當前的訊息佇列選項。升級過程中不支援在不同的訊息佇列系統之間切換。未來版本將支援變更訊息佇列系統。</p>
</div>
<h2 id="Upgrade-Milvus-by-changing-its-image" class="common-anchor-header">透過更換映像檔升級 Milvus<button data-href="#Upgrade-Milvus-by-changing-its-image" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>在一般情況下，您可以依照以下步驟升級 Milvus：</p>
<ol>
<li><p>在 `<code translate="no">docker-compose.yaml</code>` 中變更 Milvus 映像標籤。</p>
<p>請注意，您需要變更代理伺服器、所有協調器以及所有工作節點的映像檔標籤。</p>
...
<li>了解如何<a href="/docs/zh-hant/v2.6.x/gcp.md">透過 Kubernetes 在 GCP 上部署 Milvus 叢集</a></li>
<li>了解如何<a href="/docs/zh-hant/v2.6.x/azure.md">使用 Kubernetes 在 Microsoft Azure 上部署 Milvus</a></li>
</ul></li>
</ul>
