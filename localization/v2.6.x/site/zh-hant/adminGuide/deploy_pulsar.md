...
<p><strong>訊息佇列限制</strong>：升級至 Milvus v2.6.18 時，您必須維持目前的訊息佇列選擇。升級期間不支援在不同的訊息佇列系統之間切換。未來版本將支援變更訊息佇列系統。</p>
</div>
...
<p>有關如何使用 Helm<a href="/docs/zh-hant/v2.6.x/configure-helm.md">設定</a> Milvus 的詳細資訊，請參閱使用<a href="/docs/zh-hant/v2.6.x/configure-helm.md">Helm Charts 設定 Milvus</a>。有關 Pulsar 相關組態項目的詳細資訊，請參閱<a href="/docs/zh-hant/v2.6.x/configure_pulsar.md">Pulsar 相關組態</a>。</p>
...
<h2 id="Configure-RocksMQ-with-Helm" class="common-anchor-header">使用 Helm 配置 RocksMQ<button data-href="#Configure-RocksMQ-with-Helm" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus standalone 使用 RocksMQ 作為預設的訊息儲存空間。有關如何使用 Helm 配置 Milvus 的詳細步驟，請參考<a href="/docs/zh-hant/v2.6.x/configure-helm.md">Configure Milvus with Helm Charts</a>。關於 RocksMQ 相關配置項的詳細步驟，請參考<a href="/docs/zh-hant/v2.6.x/configure_rocksmq.md">RocksMQ 相關配置</a>。</p>
<ul>
