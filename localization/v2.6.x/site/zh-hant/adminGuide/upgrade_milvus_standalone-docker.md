...
<h2 id="Before-you-start" class="common-anchor-header">在您開始之前<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v260" class="common-anchor-header">v2.6.0 的新功能</h3><p>從 Milvus 2.5.x 升級到 2.6.0 涉及重大的架構變更：</p>
<ul>
...
<h2 id="Upgrade-process" class="common-anchor-header">升級程序<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Upgrade-to-v2516" class="common-anchor-header">步驟 1：升級至 v2.5.16</h3><div class="alert note">
...
<h3 id="Step-2-Upgrade-to-v260" class="common-anchor-header">步驟 2：升級至 v2.6.0</h3><p>v2.5.16 成功執行後，升級至 v2.6.0：</p>
<ol>
