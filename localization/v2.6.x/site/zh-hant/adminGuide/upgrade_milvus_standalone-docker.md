...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">使用 Docker Compose 升級 Milvus 獨立部署<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本指南說明如何使用 Docker Compose 將您的 Milvus 獨立部署從 v2.5.x 升級至 v2.6.20。</p>
...
<ul>
<li>Milvus v2.6.0-rc1 與 v2.6.20<strong>不相容</strong>。不支援直接從候選版本升級。</li>
...
<p>基於安全性考量，Milvus 將於 v2.6.20 版本發布時，將 MinIO 升級至 RELEASE.2024-12-18T13-15-44Z 版本。</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v2620" class="common-anchor-header">步驟 2：升級至 v2.6.20<button data-href="#Step-2-Upgrade-to-v2620" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
