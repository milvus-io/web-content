...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">使用 Milvus Operator 升級 Milvus 集群<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本指南描述如何使用 Milvus Operator 將您的 Milvus 集群從 v2.5.x 升級到 v2.6.18。</p>
...
<li>在升級至 v2.6.18 之前，您<strong>必須先升級</strong>至 v2.5.16 或更新版本，並啟用<code translate="no">mixCoord</code> 。</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2618" class="common-anchor-header">2.3 升級至 v2.6.18</h4><p>一旦 v2.5.16 在<code translate="no">mixCoord</code> 上成功運行，請升級至 v2.6.18：</p>
