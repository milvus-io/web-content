...
<h3 id="Download-a-configuration-file" class="common-anchor-header">下載配置檔<button data-href="#Download-a-configuration-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Start-Milvus" class="common-anchor-header">啟動 Milvus<button data-href="#Start-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>修改完配置文件後，就可以用該文件啟動 Milvus。</p>
...
<h3 id="Check-the-configurable-parameters" class="common-anchor-header">檢查可配置的參數<button data-href="#Check-the-configurable-parameters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>在升級之前，你可以用 Helm 圖表檢查可配置的參數。</p>
...
<h3 id="Start-Milvus" class="common-anchor-header">啟動 Milvus<button data-href="#Start-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h3><p>在升級指令中加入<code translate="no">--values</code> 或<code translate="no">--set</code> ，設定並啟動 Milvus。</p>
