...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">使用 Milvus Operator 升級 Milvus 單機版<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本指南描述如何使用 Milvus Operator 將您的 Milvus 獨立部署從 v2.5.x 升級到 v2.6.16。</p>
<h2 id="Before-you-start" class="common-anchor-header">在您開始之前<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>從 Milvus 2.5.x 升級到 2.6.16 涉及重大的架構變更：</p>
<ul>
...
<p><strong>訊息佇列限制</strong>：升級到Milvus v2.6.16時，您必須維持目前的訊息佇列選擇。升級期間不支援在不同訊息佇列系統之間切換。未來版本將支援變更訊息佇列系統。</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2616" class="common-anchor-header">2.2 升級至 v2.6.16</h4><p>當 v2.5.16 成功執行後，升級至 v2.6.16：</p>
