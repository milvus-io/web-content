...
---
<div class="tab-wrapper"><a href="/docs/zh-hant/v2.6.x/upgrade_milvus_standalone-operator.md" class='active '>Milvus</a><a href="/docs/zh-hant/v2.6.x/upgrade_milvus_standalone-helm.md" class=''>OperatorHelmDocker</a><a href="/docs/zh-hant/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>Compose</a></div>
...
<h2 id="Upgrade-your-Milvus-operator" class="common-anchor-header">升級你的 Milvus 操作系統<button data-href="#Upgrade-your-Milvus-operator" class="anchor-icon" translate="no">
    ...
    </button></h2><p>執行以下指令，將您的 Milvus Operator 版本升級為 v1.3.0-rc1-hotfix。</p>
...
<p>一旦你升級你的 Milvus 操作員到最新版本，你有以下選擇：</p>
<ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Apply-the-new-configuration" class="common-anchor-header">2.套用新設定</h3><p>執行下列指令套用新設定。</p>
