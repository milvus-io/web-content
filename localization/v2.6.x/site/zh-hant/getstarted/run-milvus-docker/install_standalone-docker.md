...
<li><strong>Woodpecker MQ</strong>：改進訊息佇列並降低維護開銷，詳情請參閱《<a href="/docs/zh-hant/v2.6.x/use-woodpecker.md">使用 Woodpecker</a>》</li>
<li><strong>架構優化</strong>：整合組件以提升效能</li>
</ul>
<p>請務必下載最新版本的腳本，以確保您能獲得最新的配置與架構改良。</p>
...
<li>嵌入式 etcd 已與 Milvus 一同安裝在同一個容器中，並於<strong>2379</strong> 埠提供服務。其設定檔對應至當前資料夾中的<strong>embedEtcd.yaml</strong>檔案。</li>
...
<p>您可以透過<code translate="no">http://127.0.0.1:9091/webui/</code> 存取 Milvus WebUI，以進一步了解您的 Milvus 實例。詳情請參閱<a href="/docs/zh-hant/v2.6.x/milvus-webui.md">Milvus WebUI</a>。</p>
