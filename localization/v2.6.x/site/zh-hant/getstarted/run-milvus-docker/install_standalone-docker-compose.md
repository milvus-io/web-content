...
<p><strong>v2.6.16 的新功能：</strong></p>
<ul>
...
<p>請務必下載最新的 Docker Compose 配置，以確保與 v2.6.16 功能相容。</p>
<ul>
...
<li><p>新增額外的配置以覆寫預設配置。以下假設您需要覆寫預設的<code translate="no">proxy.healthCheckTimeout</code> 。有關適用的組態項目，請參閱<a href="/docs/zh-hant/v2.6.x/system_configuration.md">系統組態</a>。</p>
