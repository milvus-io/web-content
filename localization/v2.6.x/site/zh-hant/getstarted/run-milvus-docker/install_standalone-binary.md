...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">下載 RPM/DEB 套件<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>您可以從<a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.21">Milvus 發行版頁面</a>，根據您的系統架構下載 RPM/DEB 套件。</p>
<ul>
<li>若為 x86_64/amd64 架構，請下載<strong>milvus_2.6.21-1_amd64.deb</strong>或<strong>milvus_2.6.21-1_amd64.rpm</strong>套件。</li>
<li>若為 ARM64 架構，請下載<strong>milvus_2.6.21-1_arm64.deb</strong>或<strong>milvus_2.6.21-1_arm64.rpm</strong>套件。</li>
</ul>
