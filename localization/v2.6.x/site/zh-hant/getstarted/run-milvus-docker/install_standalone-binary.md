...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">下載 RPM/DEB 套件<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>您可以從 [Milvus Releases page] (https://github.com/milvus-io/milvus/releases/tag/v{{ var.milvus_release_version }}) 下載符合您系統架構的 RPM/DEB 套件。</p>
<ul>
<li>對於 x86_64/amd64，請下載<strong>{{ var.milvus_deb_amd64 }}</strong>或<strong>{{ var.milvus_rpm_amd64 }}</strong>套件。</li>
<li>對於 ARM64，請下載<strong>{{ var.milvus_deb_arm64 }}</strong>或<strong>{{ var.milvus_rpm_arm64 }}</strong>套件。</li>
</ul>
