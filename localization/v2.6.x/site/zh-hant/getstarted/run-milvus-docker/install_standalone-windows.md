...
label: Docker
related_key: Docker
summary: 了解如何使用 Windows 版的 Docker Desktop 安裝 Milvus 獨立版本。
...
<h3 id="From-PowerShell-or-Windows-Command-Prompt​" class="common-anchor-header">透過 PowerShell 或 Windows 命令提示字元​<button data-href="#From-PowerShell-or-Windows-Command-Prompt​" class="anchor-icon" translate="no">
    ...
    </button></h3><p>若您較熟悉 PowerShell 或 Windows 命令提示字元，請參照以下指令。​</p>
<ol>
...
<li><p>檢查您是否已以<strong>系統管理員</strong>模式啟動 Docker Desktop。​</p>
