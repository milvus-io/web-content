...
<button class="copy-code-btn"></button></code></pre>
<p>上述指令會部署一個以<strong>Woodpecker</strong>作為訊息佇列（建議用於 v2.6.19）的 Milvus 叢集，並包含所有新的架構元件，包括串流節點。</p>
...
<p>一旦您的 Milvus 叢集準備就緒，Milvus 叢集中所有 Pod 的狀態應類似於以下內容。</p>
...
<h2 id="Uninstall-Milvus-Operator" class="common-anchor-header">解除安裝 Milvus Operator<button data-href="#Uninstall-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h2><p>解除安裝 Milvus Operator 也有兩種方法。</p>
<ul>
...
<li><p>探索<a href="/docs/zh-hant/v2.6.x/milvus-webui.md">Milvus WebUI</a>，這是專為 Milvus 可觀測性與管理而設計的直覺式網頁介面。</p></li>
