...
<button class="copy-code-btn"></button></code></pre>
<p>上面的指令會部署一個以<strong>Woodpecker</strong>作為訊息佇列（建議使用 v2.6.13）的 Milvus 叢集，以及包括 Streaming Node 在內的所有新架構元件。</p>
...
<li>若要連同 Milvus 叢集一起刪除相依性和持久性磁碟區索賠 (PVC)，請參閱<a href="https://github.com/zilliztech/milvus-operator/blob/main/config/samples/milvus_deletion.yaml">設定檔</a>。</li>
</ul>
</div>
