...
<h1 id="Install-Milvus-Java-SDK" class="common-anchor-header">安裝 Milvus Java SDK<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本主題描述如何為 Milvus 安裝 Milvus Java SDK。</p>
...
<h2 id="Install-Milvus-Java-SDK" class="common-anchor-header">安裝 Milvus Java SDK<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
    ...
    </button></h2><p>執行以下指令來安裝 Milvus Java SDK。</p>
<ul>
<li>Apache Maven</li>
</ul>
<pre><code translate="no" class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">dependency</span>&gt;</span>
    ...
    <span class="hljs-tag">&lt;<span class="hljs-name">version</span>&gt;</span>2.6.19<span class="hljs-tag">&lt;/<span class="hljs-name">version</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">dependency</span>&gt;</span>
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Gradle/Grails</li>
</ul>
<pre><code translate="no"><span class="hljs-attribute">implementation</span> <span class="hljs-string">&#x27;io.milvus:milvus-sdk-java:2.6.19&#x27;</span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Whats-next" class="common-anchor-header">下一步<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>安裝 Milvus Java SDK 後，您可以</p>
<ul>
