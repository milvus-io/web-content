...
<h3 id="Prepare-the-data" class="common-anchor-header">準備資料<button data-href="#Prepare-the-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>我們使用<a href="https://github.com/milvus-io/milvus-docs/releases/download/v2.4.6-preview/milvus_docs_2.4.x_en.zip">Milvus Documentation 2.4.x</a>中的 FAQ 頁面作為 RAG 中的私有知識，對於簡單的 RAG 管道來說，這是一個很好的資料來源。</p>
...
<h3 id="Prepare-the-Embedding-Model" class="common-anchor-header">準備嵌入模型<button data-href="#Prepare-the-Embedding-Model" class="anchor-icon" translate="no">
    ...
    </button></h3><p>我們初始化一個用戶端來準備嵌入模型。SiliconFlow 啟用 OpenAI 風格的 API，您可以使用相同的 API，只要稍作調整，就可以呼叫嵌入模型和 LLM。</p>
