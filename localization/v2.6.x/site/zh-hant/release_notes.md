...
<h3 id="Architecture-Changes" class="common-anchor-header">架構變更</h3><p>自 2.6 起，Milvus 引進了重大的架構變更，目的在於改善效能、可擴充性和易用性。如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.6.x/architecture_overview.md">Milvus 架構概述</a>。</p>
...
<h3 id="Key-Features" class="common-anchor-header">主要功能</h3><h4 id="RaBitQ-1-bit-Quantization" class="common-anchor-header">RaBitQ 1 位元量化</h4><p>為了處理大型資料集，1 位元量化是改善資源利用率和搜尋效能的有效技術。然而，傳統方法會對召回率造成負面影響。Milvus 2.6 與原研究作者合作推出了 RaBitQ，這是一種 1 位元量化解決方案，可維持高召回準確度，同時提供 1 位元壓縮的資源與效能優勢。</p>
<p>如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.6.x/ivf-rabitq.md">IVF_RABITQ</a>。</p>
...
<ul>
<li>新的<a href="/docs/zh-hant/v2.6.x/analyzer-overview.md#Example-use">Run Analyzer</a>語法可用來驗證 tokenizer 配置。</li>
<li>整合了<a href="/docs/zh-hant/v2.6.x/lindera-tokenizer.md">Lindera tokenizer</a>，以改善對日文和韓文等亞洲語言的支援。</li>
<li>現在支援 Row-level tokenizer 選擇，並提供通用<a href="/docs/zh-hant/v2.6.x/icu-tokenizer.md">ICU tokenizer</a>作為多國語言方案的備用功能。</li>
</ul>
...
<p>如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.6.x/embedding-function-overview.md">嵌入功能概述</a>。</p>
...
<p>如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.6.x/phrase-match.md">短語匹配</a>。</p>
...
<p>如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.6.x/decay-ranker-overview.md">Decay Ranker 概觀</a>。</p>
<h4 id="Add-Field-for-Online-Schema-Evolution" class="common-anchor-header">新增線上模式演進欄位</h4><p>為了提供更高的模式彈性，Milvus 2.6 現在支援線上新增標量或向量欄位到現有集合的模式。這避免了在應用程式需求改變時，需要建立新的資料集和執行擾亂性的資料遷移。</p>
<p>如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.6.x/add-fields-to-an-existing-collection.md">新增欄位到現有的集合</a>。</p>
...
<p>如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.6.x/dense-vector.md">密集向量</a>。</p>
