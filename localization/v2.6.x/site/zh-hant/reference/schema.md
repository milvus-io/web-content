...
<h3 id="Field-schema-properties" class="common-anchor-header">欄位模式屬性<button data-href="#Field-schema-properties" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Create-a-field-schema" class="common-anchor-header">建立欄位模式<button data-href="#Create-a-field-schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>為了降低資料插入的複雜性，Milvus 允許您在建立欄位模式時，為每個標量欄位指定預設值，但不包括主鍵欄位。這表示，如果您在插入資料時讓欄位為空，您為這個欄位指定的預設值就會適用。</p>
<p>建立常規欄位模式：</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Supported-data-types" class="common-anchor-header">支援的資料類型<button data-href="#Supported-data-types" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><code translate="no">DataType</code> 定義欄位包含的資料類型。不同的欄位支援不同的資料類型。</p>
<ul>
<li><p>主鍵欄位支援</p>
<ul>
...
<h3 id="Collection-schema-properties" class="common-anchor-header">集合模式屬性<button data-href="#Collection-schema-properties" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Create-a-collection-schema" class="common-anchor-header">建立集合模式<button data-href="#Create-a-collection-schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>閱讀更多關於<a href="/docs/zh-hant/multi_tenancy.md">Multi-tenancy</a> 中的 partition-key 的資訊。</li>
</ul>
