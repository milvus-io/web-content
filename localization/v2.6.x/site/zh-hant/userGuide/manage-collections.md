...
<h3 id="Quick-setup" class="common-anchor-header">快速設定<button data-href="#Quick-setup" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>啟用此設定可確保主鍵自動遞增。在插入資料時，不需要手動提供主索引鍵。</p></li>
...
<h3 id="Customized-setup" class="common-anchor-header">客製化設定<button data-href="#Customized-setup" class="anchor-icon" translate="no">
    ...
    </button></h3><p>與其讓 Milvus 為您的集合決定幾乎一切，您可以自行決定集合的<strong>模式</strong>和<strong>索引參數</strong>。</p>
...
<div class="language-shell">
<p>要設定索引參數，您需要定義一個 JSON 物件，該物件必須遵循索引參數格式，如 <a href="https://milvus.io/api-reference/restful/v2.4.x/v2/Collection%20(v2)/Create.md"><code translate="no">POST /v2/vectordb/collections/create</code></a>API 端點參考頁面所顯示的索引參數格式。</p>
</div>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#go">Go</a> <a href="#shell">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
  ...
  <tbody>
    ...
    <tr>
      <td><code translate="no">index_params</code></td>
      <td>一個<strong>IndexParams</strong>物件，包含一個<strong>IndexParam</strong>物件清單。</td>
    </tr>
  </tbody>
</table>
</li>
...
<h3 id="Load-a-collection" class="common-anchor-header">載入資料集<button data-href="#Load-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash">}</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Load-a-collection-partially-Public-Preview" class="common-anchor-header">部分載入收藏集 (公開預覽)<button data-href="#Load-a-collection-partially-Public-Preview" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Release-a-collection" class="common-anchor-header">釋放集合<button data-href="#Release-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Create-aliases" class="common-anchor-header">建立別名<button data-href="#Create-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="List-aliases" class="common-anchor-header">列出別名<button data-href="#List-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash"><span class="hljs-string">}</span></span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Describe-aliases" class="common-anchor-header">描述別名<button data-href="#Describe-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash"><span class="hljs-string">}</span></span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Reassign-aliases" class="common-anchor-header">重新指定別名<button data-href="#Reassign-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash"><span class="hljs-string">}</span></span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Drop-aliases" class="common-anchor-header">刪除別名<button data-href="#Drop-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Set-TTL" class="common-anchor-header">設定 TTL<button data-href="#Set-TTL" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>設定集合中資料的 Time-To-Live (TTL)，指定資料在自動刪除前的保留時間。</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Set-MMAP" class="common-anchor-header">設定 MMAP<button data-href="#Set-MMAP" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>設定集合的記憶體映射 (MMAP) 屬性，它決定資料是否映射到記憶體以改善查詢效能。如需詳細資訊，請參閱<a href="https://milvus.io/docs/mmap.md#Configure-memory-mapping">配置記憶體映射</a> 。</p>
<div class="alert note">
