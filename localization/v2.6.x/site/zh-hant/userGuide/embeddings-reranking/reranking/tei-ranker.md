...
<h2 id="Prerequisites" class="common-anchor-header">先決條件<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p>在 Milvus 中實作 TEI Ranker 之前，請確保您擁有</p>
<ul>
<li><p>具有<code translate="no">VARCHAR</code> 欄位的 Milvus 資料庫，其中包含要重新排序的文字。</p></li>
<li><p>具有重新排名功能的執行中 TEI 服務。有關設定 TEI 服務的詳細說明，請參閱<a href="https://huggingface.co/docs/text-embeddings-inference/en/quick_tour">TEI 官方文件</a>。</p></li>
</ul>
...
<table>
   ...
   <tr>
     ...
     <td><p>否</p></td>
     <td><p>當輸入太長時要截斷的方向：</p><ul><li><p><code translate="no">"Right"</code> (預設)：  從序列末尾移除標記，直到符合最大支援大小為止。</p></li><li><p><code translate="no">"Left"</code>:標記會從序列的開始移除。</p></li></ul></td>
