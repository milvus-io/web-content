...
<p>此整合功能使用託管的 Hugging Face 路由器。若要透過獨立部署的文字嵌入推論 (TEI) 服務進行重新排序，請參閱<a href="/docs/zh-hant/v2.6.x/tei-ranker.md">TEI Ranker</a>。</p>
...
<li>有關共享模型排名器的運作方式與限制，請參閱《<a href="/docs/zh-hant/v2.6.x/model-ranker-overview.md">模型排名器概覽</a>》。</li>
<li>若要透過託管的 Hugging Face 推論提供者產生嵌入向量，請參閱<a href="/docs/zh-hant/v2.6.x/hugging-face.md">Hugging Face</a>。</li>
<li>若要將排序器應用於混合搜尋，請參閱《<a href="/docs/zh-hant/v2.6.x/multi-vector-search.md">多向量混合搜尋</a>》。</li>
</ul>
