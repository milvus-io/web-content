...
<li><p>針對不同的模型變異（rerank-2、rerank-lite 等）進行性能微調</p></li>
</ul>
...
<h2 id="Create-a-Voyage-AI-ranker-function" class="common-anchor-header">建立 Voyage AI Ranker 功能<button data-href="#Create-a-Voyage-AI-ranker-function" class="anchor-icon" translate="no">
    ...
    </button></h2><p>要在您的 Milvus 應用程式中使用 Voyage AI Ranker，請建立一個 Function 物件，指定重排的操作方式。此函數將會傳給 Milvus 搜尋作業，以提升結果排名。</p>
...
<h3 id="Voyage-AI-ranker-specific-parameters" class="common-anchor-header">Voyage AI 排名器特定參數<button data-href="#Voyage-AI-ranker-specific-parameters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>以下參數是 Voyage AI ranker 的特定參數：</p>
<table>
   <tr>
   ...
   <tr>
     ...
     <td><p>是</p></td>
     <td><p>從 Voyage AI 平台支援的模型中使用的 Voyage AI reranker。 如需可用的 reranker 清單，請參閱<a href="https://docs.voyageai.com/docs/reranker">Voyage AI</a><a href="https://docs.voyageai.com/docs/reranker"> 文件</a>。</p></td>
