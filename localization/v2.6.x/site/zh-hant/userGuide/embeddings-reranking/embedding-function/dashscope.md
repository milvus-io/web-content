...
<table>
   ...
   <tr>
     ...
     <td><p>8,192</p></td>
     <td><p>中文、英文、西班牙文、法文、葡萄牙文、印尼文、日文、韓文、德文、俄文，以及超過 50 種其他語言</p></td>
   </tr>
   <tr>
     <td><p>文字嵌入-v2</p></td>
     <td><p>1,536</p></td>
...
<p>下面的範例新增了一個 Function 模組 (<code translate="no">ali</code>)，將標量欄位<code translate="no">&quot;document&quot;</code> 轉換為嵌入，將產生的向量存入先前定義的<code translate="no">&quot;dense&quot;</code> 向量欄位。</p>
