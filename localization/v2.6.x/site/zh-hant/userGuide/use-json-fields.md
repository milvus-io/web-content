...
title: 使用 JSON 欄位
---
<h1 id="Use-JSON-Fields" class="common-anchor-header">使用 JSON 欄位<button data-href="#Use-JSON-Fields" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>本指南說明如何使用 JSON 欄位，例如插入 JSON 值，以及使用基本和進階運算符在 JSON 欄位中搜尋和查詢。</p>
<h2 id="Overview" class="common-anchor-header">概述<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>JSON 是 Javascript Object Notation 的縮寫，是一種輕量且簡單的文字型資料格式。JSON 中的資料以 key-value 對的方式結構，其中每個 key 都是一個字串，對應到數字、字串、布林、列表或陣列的值。使用 Milvus 叢集，可以將字典儲存為集合中的欄位值。</p>
<p>例如，以下程式碼會隨機產生鍵值對，每個鍵值對都包含一個具有關鍵<strong>顏色</strong>的 JSON 欄位。</p>
...
<p><b>注意事項</b></p>
<ul>
<li><p>確保清單或陣列中的所有值都是相同的資料類型。</p></li>
<li><p>JSON 欄位值中的任何巢狀字典都會被視為字串。</p></li>
<li><p>僅使用字母數字字符和下劃線來命名 JSON 鍵，因為其他字符可能會導致過濾或搜尋出現問題。</p></li>
<li>目前，無法為 JSON 欄位編制索引，這會使篩選工作變得耗時。不過，這個限制將在即將發行的版本中解決。</li>
</ul>
</div>
<h2 id="Define-JSON-field" class="common-anchor-header">定義 JSON 欄位<button data-href="#Define-JSON-field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>要定義 JSON 欄位，只要遵循定義其他類型欄位的相同步驟即可。</p>
<div class="language-python">
<p>有關參數的詳細資訊，請參閱 <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_schema.md"><code translate="no">create_schema()</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/CollectionSchema/add_field.md"><code translate="no">add_field()</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/add_index.md"><code translate="no">add_index()</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_collection.md"><code translate="no">create_collection()</code></a>和 <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/get_load_state.md"><code translate="no">get_load_state()</code></a>在 SDK 參考資料中。</p>
</div>
<div class="language-java">
<p>有關參數的詳細資訊，請參閱 <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Client/MilvusClientV2.md"><code translate="no">MilvusClientV2</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createSchema.md"><code translate="no">createSchema()</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/CollectionSchema/addField.md"><code translate="no">addField()</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Management/IndexParam.md"><code translate="no">IndexParam</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createCollection.md"><code translate="no">createCollection()</code></a>和 <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Management/getLoadState.md"><code translate="no">getLoadState()</code></a>在 SDK 參考資料中。</p>
</div>
<div class="language-javascript">
<p>有關參數的詳細資訊，請參閱 <a href="https://milvus.io/api-reference/node/v2.4.x/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a>和 <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a>和 <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a>在 SDK 參考資料中。</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<div class="language-python">
<p>如需參數的詳細資訊，請參閱 <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_schema.md"><code translate="no">create_schema()</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/CollectionSchema/add_field.md"><code translate="no">add_field()</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/add_index.md"><code translate="no">add_index()</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_collection.md"><code translate="no">create_collection()</code></a>和 <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/get_load_state.md"><code translate="no">get_load_state()</code></a>在 SDK 參考資料中。</p>
</div>
<div class="language-java">
<p>有關參數的詳細資訊，請參閱 <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Client/MilvusClientV2.md"><code translate="no">MilvusClientV2</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createSchema.md"><code translate="no">createSchema()</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/CollectionSchema/addField.md"><code translate="no">addField()</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Management/IndexParam.md"><code translate="no">IndexParam</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createCollection.md"><code translate="no">createCollection()</code></a>和 <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Management/getLoadState.md"><code translate="no">getLoadState()</code></a>在 SDK 參考資料中。</p>
</div>
<div class="language-javascript">
<p>有關參數的詳細資訊，請參閱 <a href="https://milvus.io/api-reference/node/v2.4.x/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a>, <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a>和 <a href="https://milvus.io/api-reference/node/v2.4.x/Management/getLoadState.md"><code translate="no">getLoadState()</code></a>SDK 參考資料中。</p>
</div>
<h2 id="Insert-field-values" class="common-anchor-header">插入欄位值<button data-href="#Insert-field-values" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>從<code translate="no">CollectionSchema</code> 物件建立一個集合後，就可以將如上的字典插入其中。</p>
<div class="language-python">
...
<div class="language-javascript">
<p>使用 <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/insert.md"><code translate="no">insert()</code></a>方法將資料插入集合。</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<h2 id="Basic-scalar-filtering" class="common-anchor-header">基本標量篩選<button data-href="#Basic-scalar-filtering" class="anchor-icon" translate="no">
    ...
    </button></h2><p>一旦添加了所有資料，您就可以使用 JSON 欄位中的關鍵進行搜尋和查詢，方式與使用標準標量值欄位相同。</p>
<div class="language-python">
...
<div class="language-javascript">
<p>有關參數的詳細資訊，請參閱 <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/search.md"><code translate="no">search()</code></a>的 SDK 參考資料。</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Advanced-scalar-filtering" class="common-anchor-header">進階標量篩選<button data-href="#Advanced-scalar-filtering" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Milvus 提供一組進階過濾器，用於 JSON 欄位中的標量過濾。這些篩選器是<code translate="no">JSON_CONTAINS</code>,<code translate="no">JSON_CONTAINS_ALL</code>, 和<code translate="no">JSON_CONTAINS_ANY</code> 。</p>
<ul>
<li><p>篩選以<code translate="no">[&quot;blue&quot;, &quot;brown&quot;, &quot;grey&quot;]</code> 作為參考顏色集的所有實體。</p>
...
<li><p>過濾具有<code translate="no">[4, 5]</code> 協調器的實體。</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>篩選擁有包含<code translate="no">4</code> 或<code translate="no">5</code> 協調器的實體。</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;test_collection&quot;</span>,
...
<h2 id="Reference-on-JSON-filters" class="common-anchor-header">JSON 篩選器參考<button data-href="#Reference-on-JSON-filters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>在處理 JSON 欄位時，您可以使用 JSON 欄位作為篩選器，或是使用它的某些特定鍵。</p>
<div class="admonition note">
<p><b>注意</b></p>
<ul>
<li>Milvus 會原樣儲存 JSON 欄位中的字串值，而不會執行語意轉換或轉換。 </li>
</ul>
<p>例如，<code translate="no">'a"b'</code>,<code translate="no">"a'b"</code>,<code translate="no">'a\\\\'b'</code>, 和<code translate="no">"a\\\\"b"</code> 將以原樣儲存，而<code translate="no">'a'b'</code> 和<code translate="no">"a"b"</code> 將被視為無效值。</p>
<ul>
<li><p>要使用 JSON 欄位建立篩選表達式，您可以利用欄位中的鍵。 </p></li>
<li><p>如果鍵的值是整數或浮點數，您可以將它與另一個整數或浮點數鍵或 INT32/64 或 FLOAT32/64 欄位進行比較。</p></li>
<li><p>如果鍵的值是字串，則只能與另一個字串鍵或 VARCHAR 欄位比較。</p></li>
</ul>
</div>
<h3 id="Basic-Operators-in-JSON-Fields" class="common-anchor-header">JSON 欄位中的基本運算符號<button data-href="#Basic-Operators-in-JSON-Fields" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>下表假設名為<code translate="no">json_key</code> 的 JSON 欄位的值有一個名為<code translate="no">A</code> 的 key 。在使用 JSON 欄位鍵建構布林表達式時，請使用它作為參考。</p>
<table>
<thead>
<tr><th><strong>運算符號</strong></th><th><strong>範例</strong></th><th><strong>備註</strong></th></tr>
</thead>
<tbody>
<tr><td><strong>&lt;</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &lt; 3'</code></td><td>如果<code translate="no">json_field[&quot;A&quot;]</code> 的值小於<code translate="no">3</code> ，此表達式的值為真。</td></tr>
<tr><td><strong>&gt;</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &gt; 1'</code></td><td>如果<code translate="no">json_field[&quot;A&quot;]</code> 的值大於<code translate="no">1</code> ，則此表達式的值為真。</td></tr>
<tr><td><strong>==</strong></td><td><code translate="no">'json_field[&quot;A&quot;] == 1'</code></td><td>如果<code translate="no">json_field[&quot;A&quot;]</code> 的值等於<code translate="no">1</code> ，此表達式的值為真。</td></tr>
<tr><td><strong>!=</strong></td><td><code translate="no">'json_field[&quot;A&quot;][0]' != &quot;abc&quot;'</code></td><td>如果<br/> -<code translate="no">json_field</code> 沒有名為<code translate="no">A</code> 的 key，此表達式的值為真。<br/> -<code translate="no">json_field</code> 有一個名為<code translate="no">A</code> 的 key，但<code translate="no">json_field[&quot;A&quot;]</code> 不是一個陣列。<br/> -<code translate="no">json_field[&quot;A&quot;]</code> 是一個空陣列。<br/> -<code translate="no">json_field[&quot;A&quot;]</code> 是一個陣列，但第一個元素不是<code translate="no">abc</code>.<br/></td></tr>
<tr><td><strong>&lt;=</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &lt;= 5'</code></td><td>如果<code translate="no">json_field[&quot;A&quot;]</code> 的值小於或等於<code translate="no">5</code> ，則此表達式的值為真。</td></tr>
<tr><td><strong>&gt;=</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &gt;= 1'</code></td><td>如果<code translate="no">json_field[&quot;A&quot;]</code> 的值大於或等於<code translate="no">1</code> ，此表達式的值為真。</td></tr>
<tr><td><strong>不</strong></td><td><code translate="no">'not json_field[&quot;A&quot;] == 1'</code></td><td>如果<br/> -<code translate="no">json_field</code> 沒有名為<code translate="no">A</code> 的 key，此表達式的值為真。<br/> -<code translate="no">json_field[&quot;A&quot;]</code> 不等於<code translate="no">1</code>.<br/></td></tr>
<tr><td><strong>在</strong></td><td><code translate="no">'json_field[&quot;A&quot;] in [1, 2, 3]'</code></td><td>如果<code translate="no">json_field[&quot;A&quot;]</code> 的值是<code translate="no">1</code>,<code translate="no">2</code>, 或<code translate="no">3</code> ，則此表達式的值為真。</td></tr>
<tr><td><strong>和 (&amp;&amp;)</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &gt; 1 &amp;&amp; json_field[&quot;A&quot;] &lt; 3'</code></td><td>如果<code translate="no">json_field[&quot;A&quot;]</code> 的值大於 1 且小於<code translate="no">3</code> ，則此表達式的值為真。</td></tr>
<tr><td><strong>或 (||)</strong></td><td><code translate="no">‘json_field[“A”] > 1 || json_field[“A”] < 3’</code></td><td>如果<code translate="no">json_field[&quot;A&quot;]</code> 的值大於<code translate="no">1</code> 或小於<code translate="no">3</code> ，則此表達式的值為真。</td></tr>
<tr><td><strong>存在</strong></td><td><code translate="no">'exists json_field[&quot;A&quot;]'</code></td><td>如果<code translate="no">json_field</code> 具有名为<code translate="no">A</code> 的键，则此表达式的值为 true。</td></tr>
</tbody>
</table>
<h3 id="Advanced-Operators" class="common-anchor-header">進階運算符<button data-href="#Advanced-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>以下運算符號是 JSON 欄位特有的：</p>
<ul>
<li><p><code translate="no">json_contains(identifier, jsonExpr)</code></p>
<p>此運算符可過濾其識別碼包含指定 JSON 表達式的實體。</p>
<ul>
<li><p>範例 1：<code translate="no">{&quot;x&quot;: [1,2,3]}</code></p>
...
<button class="copy-code-btn"></button></code></pre></li>
<li><p>範例 2：<code translate="no">{&quot;x&quot;, [[1,2,3], [4,5,6], [7,8,9]]}</code></p>
...
<p>此操作符可過濾其識別碼包含 JSON 表達式所有成員的實體。</p>
<p>範例：<code translate="no">{&quot;x&quot;: [1,2,3,4,5,7,8]}</code></p>
...
<p>此操作符可過濾其識別碼包含 JSON 表達式中任何成員的實體。</p>
<p>範例：<code translate="no">{&quot;x&quot;: [1,2,3,4,5,7,8]}</code></p>
