...
order: 3
summary: 本指南示範如何依 ID 取得實體並進行標量式篩選。
title: 取得與標量查詢
---
<h1 id="Get--Scalar-Query" class="common-anchor-header">取得與標量查詢<button data-href="#Get--Scalar-Query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>本指南示範如何依 ID 取得實體並進行標量式篩選。標量篩選擷取符合指定篩選條件的實體。</p>
<h2 id="Overview" class="common-anchor-header">概述<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>標量查詢使用布林表達式，根據定義的條件篩選集合中的實體。查詢結果是符合定義條件的實體集合。向量搜尋會找出集合中最接近指定向量的向量，查詢則不同，它會根據特定條件篩選實體。</p>
<p>在 Milvus 中，<strong>篩選器總是一個由字段名稱和運算符號組成的字串</strong>。在本指南中，您可以找到各種篩選器範例。要了解更多關於運算符的詳細資訊，請<a href="https://milvus.io/docs/get-and-scalar-query.md#Reference-on-scalar-filters">參閱參考</a>部分。</p>
<h2 id="Preparations" class="common-anchor-header">準備工作<button data-href="#Preparations" class="anchor-icon" translate="no">
    ...
    </button></h2><p>以下步驟重用程式碼來連接 Milvus，快速建立一個集合，並插入超過 1,000 個隨機產生的實體到集合中。</p>
<h3 id="Step-1-Create-a-collection" class="common-anchor-header">步驟 1：建立集合<button data-href="#Step-1-Create-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>使用 <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Client/MilvusClientV2.md"><code translate="no">MilvusClientV2</code></a>連接至 Milvus 伺服器，並使用 <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createCollection.md"><code translate="no">createCollection()</code></a>來建立資料夾。</p>
</div>
<div class="language-javascript">
<p>使用 <a href="https://milvus.io/api-reference/node/v2.4.x/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a>連接至 Milvus 伺服器並 <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a>來建立一個集合。</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Insert-randomly-generated-entities" class="common-anchor-header">步驟 2：插入隨機產生的實體<button data-href="#Step-2-Insert-randomly-generated-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<div class="language-java">
<p>使用 <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/insert.md"><code translate="no">insert()</code></a>將實體插入集合。</p>
</div>
<div class="language-javascript">
<p>使用 <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/insert.md"><code translate="no">insert()</code></a>將實體插入集合。</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Create-partitions-and-insert-more-entities" class="common-anchor-header">步驟 3：建立分區並插入更多實體<button data-href="#Step-3-Create-partitions-and-insert-more-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>使用 <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Partitions/create_partition.md"><code translate="no">create_partition()</code></a>來建立分區，並使用 <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/insert.md"><code translate="no">insert()</code></a>將更多實體插入集合。</p>
</div>
<div class="language-java">
<p>使用 <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Partitions/createPartition.md"><code translate="no">createPartition()</code></a>建立分區，並 <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/insert.md"><code translate="no">insert()</code></a>將更多實體插入到集合中。</p>
</div>
<div class="language-javascript">
<p>使用 <a href="https://milvus.io/api-reference/node/v2.4.x/Partitions/createPartition.md"><code translate="no">createPartition()</code></a>建立分區，並 <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/insert.md"><code translate="no">insert()</code></a>以插入更多實體到集合中。</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Get-Entities-by-ID" class="common-anchor-header">依 ID 取得實體<button data-href="#Get-Entities-by-ID" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>如果您知道您感興趣的實體的 ID，您可以使用 <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/get.md"><code translate="no">get()</code></a>方法。</p>
</div>
<div class="language-java">
<p>如果您知道您感興趣的實體的 ID，您可以使用 <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/get.md"><code translate="no">get()</code></a>方法。</p>
</div>
<div class="language-javascript">
<p>如果您知道您感興趣的實體的 ID，您可以使用 <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/get.md"><code translate="no">get()</code></a>方法。</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Get-entities-from-partitions" class="common-anchor-header">從分區取得實體<button data-href="#Get-entities-from-partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Use-Basic-Operators" class="common-anchor-header">使用基本運算符<button data-href="#Use-Basic-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>在本節中，您會找到如何在標量篩選中使用基本運算符的範例。您也可以將這些篩選應用於<a href="https://milvus.io/docs/single-vector-search.md#Filtered-search">向量</a> <a href="https://milvus.io/docs/insert-update-delete.md#Delete-entities">搜尋和資料刪除</a>。</p>
<div class="language-python">
<p>如需詳細資訊，請參閱 <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/query.md"><code translate="no">query()</code></a>SDK 參考資料中的</p>
</div>
<div class="language-java">
<p>如需更多資訊，請參閱 <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/query.md"><code translate="no">query()</code></a>在 SDK 參考資料中。</p>
</div>
<div class="language-javascript">
<p>如需詳細資訊，請參閱 <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/query.md"><code translate="no">query()</code></a>SDK 參考資料。</p>
</div>
<ul>
<li><p>篩選標籤值介於 1,000 到 1,500 之間的實體。</p>
...
<li><p>篩選<strong>顏色值</strong>設為<strong>棕色</strong>的實體。</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>篩選<strong>顏色值</strong>未設定為<strong>綠色</strong>和<strong>紫色的</strong>實體。</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;quick_setup&quot;</span>,
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>篩選顏色標籤<strong>以紅色</strong>開頭的文章。</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;quick_setup&quot;</span>,
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>篩選顏色設定為紅色，且標籤值在 1,000 至 1,500 範圍內的實體。</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;quick_setup&quot;</span>,
...
<h2 id="Use-Advanced-Operators" class="common-anchor-header">使用進階運算符<button data-href="#Use-Advanced-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>在本節中，您將找到如何在標量篩選中使用進階運算符的範例。您也可以將這些篩選應用於<a href="https://milvus.io/docs/single-vector-search.md#Filtered-search">向量</a> <a href="https://milvus.io/docs/insert-update-delete.md#Delete-entities">搜尋和資料刪除</a>。</p>
<h3 id="Count-entities" class="common-anchor-header">計算實體<button data-href="#Count-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Reference-on-scalar-filters" class="common-anchor-header">標量篩選器參考<button data-href="#Reference-on-scalar-filters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><h3 id="Basic-Operators" class="common-anchor-header">基本運算符號<button data-href="#Basic-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><strong>布林表達式</strong>總是<strong>由字段名稱與運算符號組成的字串</strong>。在本節中，您將學習更多關於基本運算符的資訊。</p>
<table>
<thead>
<tr><th><strong>運算符號</strong></th><th><strong>說明</strong></th></tr>
</thead>
<tbody>
<tr><td><strong>和 (&amp;&amp;)</strong></td><td>如果兩個操作數都為真，則為 True</td></tr>
<tr><td><strong>或 (||)</strong></td><td>如果任一操作項為真，則為真</td></tr>
<tr><td><strong>+, -, *, /</strong></td><td>加法、減法、乘法和除法</td></tr>
<tr><td><strong>**</strong></td><td>指數</td></tr>
<tr><td><strong>%</strong></td><td>模數</td></tr>
<tr><td><strong><, ></strong></td><td>小於、大於</td></tr>
<tr><td><strong>==, !=</strong></td><td>等於，不等於</td></tr>
<tr><td><strong><=, >=</strong></td><td>小於或等於，大於或等於</td></tr>
<tr><td><strong>不</strong></td><td>反轉指定條件的結果。</td></tr>
<tr><td><strong>相似</strong></td><td>使用通配符將一個值與相似的值比較。<br/> 例如，like "prefix%「 會比較以 」prefix" 開頭的字串。</td></tr>
<tr><td><strong>中</strong></td><td>測試表達式是否匹配值清單中的任何值。</td></tr>
</tbody>
</table>
...
<p>計算集合中實體的確切數目。使用此作為輸出欄位，可取得集合或分割區中實體的確切數目。</p>
<p><div class="admonition note"></p>
<p><p><b>註解</b></p></p>
<p><p>這適用於載入的集合。您應將其作為唯一的輸出欄位。</p></p>
<p></div></p></li>
</ul>
