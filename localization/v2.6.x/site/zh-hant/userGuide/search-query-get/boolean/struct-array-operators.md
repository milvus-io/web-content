...
<p>您可以使用比較、範圍和算術運算符建立條件，並使用邏輯運算符串連多個條件，如<a href="/docs/zh-hant/v2.6.x/basic-operators.md">基本運</a>算符所示。</p>
...
<ul>
<li><p><a href="/docs/zh-hant/v2.6.x/struct-array-operators.md#MATCHANY"><code translate="no">MATCH_ANY(identifier, predicate)</code></a>: 返回在<code translate="no">text</code> 子字段中至少包含一個以 "Red "開頭的 chunk 的實體；在語義上，這等同於<code translate="no">element_filter</code> 。</p></li>
<li><p><a href="/docs/zh-hant/v2.6.x/struct-array-operators.md#MATCHALL"><code translate="no">MATCH_ALL(identifier, predicate)</code></a>：............返回所有分塊中的文字子字段都以 "Red "開頭的實體。</p></li>
<li><p><a href="/docs/zh-hant/v2.6.x/struct-array-operators.md#MATCHLEAST"><code translate="no">MATCH_LEAST(identifier, predicate, k)</code></a>：......返回在<code translate="no">text</code> 子字段中至少包含以 "Red "開頭的<code translate="no">k</code> 元組的實體。</p></li>
<li><p><a href="/docs/zh-hant/v2.6.x/struct-array-operators.md#MATCHMOST"><code translate="no">MATCH_MOST(identifier, predicate, k)</code></a>：......返回在<code translate="no">text</code> 子字段中最多包含以 "Red "開頭的<code translate="no">k</code> chunk 的實體。</p></li>
<li><p><a href="/docs/zh-hant/v2.6.x/struct-array-operators.md#MATCHEXACT"><code translate="no">MATCH_EXACT(identifier, predicate, k)</code></a>MATCH_ANY : 返回在<code translate="no">text</code> 子字段中恰好包含以「Red」開頭的<code translate="no">k</code> 元組的實體。</p></li>
</ul>
