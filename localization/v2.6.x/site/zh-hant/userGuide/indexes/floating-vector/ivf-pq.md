...
<table>
   ...
   <tr>
     ...
     <td><p>用來以壓縮形式表示每個子向量的中心點索引的位元數。它直接決定每個編碼簿的大小。每個編碼本將包含<sup>2</sup>位元的中心點。例如，如果<code translate="no">nbits</code> 設定為 8，每個子向量將以 8 位元的中心點索引來表示。這樣，該子向量的編碼簿中就有<sup>28</sup>(256) 個可能的中心點。</p></td>
