...
<h1 id="ICU" class="common-anchor-header">ICU<button data-href="#ICU" class="anchor-icon" translate="no">
    ...
    </button></h1><p><code translate="no">icu</code> tokenizer 建立在<a href="http://site.icu-project.org/">國際化 Unicode 元件 (Internationalization Components of Unicode</a>, ICU) 開放源碼專案上，該專案提供軟體國際化的關鍵工具。透過使用 ICU 的分詞演算法，tokenizer 可以準確地將文字分割成世界上大多數語言的單字。</p>
