...
title: 建立資料集
summary: 您可以透過定義模式、索引參數、度量類型，以及是否在建立時載入，來建立集合。本頁面將介紹如何從頭開始建立集合。
---
...
<p>若要建立資料集，您需要</p>
<ul>
<li><p><a href="/docs/zh-hant/v2.6.x/create-collection.md#Create-Schema">建立模式</a></p></li>
<li><p><a href="/docs/zh-hant/v2.6.x/create-collection.md#Optional-Set-Index-Parameters">設定索引參數</a>（可選）</p></li>
<li><p><a href="/docs/zh-hant/v2.6.x/create-collection.md#Create-a-Collection">建立集合</a></p></li>
</ul>
<h2 id="Create-Schema" class="common-anchor-header">建立模式<button data-href="#Create-Schema" class="anchor-icon" translate="no">
    ...
    </button></h2><p>模式定義集合的資料結構。建立資料集時，您需要根據需求設計模式。如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.6.x/schema.md">Schema Explained</a>。</p>
...
<p>您可以為任何標量欄位設定預設值，並使其可為空。詳情請參閱<a href="/docs/zh-hant/v2.6.x/nullable-and-default.md">Nullable &amp; Default</a>。</p>
</div>
...
<p>如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.6.x/index-vector-fields.md">索引向量欄位</a>和<a href="/docs/zh-hant/v2.6.x/index-scalar-fields.md">索引標量欄位</a>。</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<h3 id="Enable-mmap" class="common-anchor-header">啟用 mmap<button data-href="#Enable-mmap" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Milvus 在所有集合上預設啟用 mmap，允許 Milvus 將原始欄位資料映射到記憶體，而不是完全載入它們。這可以減少記憶體佔用量並增加集合容量。有關 mmap 的詳細資訊，請參閱<a href="/docs/zh-hant/v2.6.x/mmap.md">使用 mmap</a>。</p>
<div class="multipleCode">
...
<button class="copy-code-btn"></button></code></pre>
<p>有關一致性層級的更多資訊，請參閱<a href="/docs/zh-hant/v2.6.x/tune_consistency.md">一致性</a>層級。</p>
...
<p>有關如何使用動態欄位的詳細資訊，請參閱<a href="/docs/zh-hant/v2.6.x/enable-dynamic-field.md">動態</a>欄位。</p>
