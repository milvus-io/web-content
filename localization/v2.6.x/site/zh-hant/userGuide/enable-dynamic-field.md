...
<p>如果非模式定義欄位的名稱包含數位、字母和下劃線以外的字元，例如加號 (+)、星號 (*) 或美元符號 (<span class="katex-error" title="ParseError: KaTeX parse error: Expected group after &#x27;_&#x27; at position 39: …the key within _̲_" style="color:#cc0000">) ，當您在</span>布林表達式中使用它或在輸出欄位中包含它時<span class="katex-error" title="ParseError: KaTeX parse error: Expected group after &#x27;_&#x27; at position 39: …the key within _̲_" style="color:#cc0000">，您必須在 __meta</span>[]__中包含該<span class="katex-error" title="ParseError: KaTeX parse error: Expected group after &#x27;_&#x27; at position 39: …the key within _̲_" style="color:#cc0000">關鍵</span>，如以下程式碼片段所示。</p>
