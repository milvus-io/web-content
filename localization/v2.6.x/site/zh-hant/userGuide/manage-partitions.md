...
<h2 id="Overview" class="common-anchor-header">概述<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>在 Milvus 中，分區代表一個集合的子分區。此功能允許將集合的實體儲存區分為多個部分，藉由將焦點縮小到較小的資料子集，而非整個集合，以改善查詢效能。</p>
...
<div class="admonition note">
<p><b>注意事項</b></p>
<p>在上面的程式碼片段中，集合的索引已和集合一起建立，表示集合在建立時已被載入。</p>
</div>
...
<h3 id="Get-Load-Status" class="common-anchor-header">取得載入狀態<button data-href="#Get-Load-Status" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Load-Partitions" class="common-anchor-header">載入分割<button data-href="#Load-Partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Release-Partitions" class="common-anchor-header">釋放分區<button data-href="#Release-Partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
