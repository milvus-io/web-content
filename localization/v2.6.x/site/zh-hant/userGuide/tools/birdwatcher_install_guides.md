...
<h3 id="Prepare-deploymentyml" class="common-anchor-header">準備部署.yml</h3><pre><code translate="no" class="language-yml"><span class="hljs-attr">apiVersion:</span> <span class="hljs-string">apps/v1</span>
