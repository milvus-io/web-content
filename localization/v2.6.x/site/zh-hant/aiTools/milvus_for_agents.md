...
<div class="start_card_container">
  <a href="/docs/zh-hant/integrations_overview.md" style="text-decoration: none; color: inherit;">
    <p class="link-btn" style="font-size: 1rem; white-space: nowrap;">代理框架</p>
    <p style="font-size: 0.875rem; font-weight: 400; color: #555;">與 LangChain、LlamaIndex、OpenAI Agents 及其他代理協調框架整合。</p>
  </a>
</div>
</div>
...
<p>對於代理工作負載，建議在生產中使用<strong>Zilliz Cloud</strong>。代理通常不管理基礎架構，因此無伺服器部署可消除作業開銷，並提供自動擴充功能。</p>
</div>
<h2 id="Quick-connection-examples" class="common-anchor-header">快速連接範例<button data-href="#Quick-connection-examples" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>從您的代理程式碼連線至 Milvus：</p>
...
<li><a href="/docs/zh-hant/quickstart.md">快速入門</a>- 在幾分鐘內執行您的第一次 Milvus 搜尋。</li>
<li><a href="/docs/zh-hant/integrations_overview.md">代理程式架構整合</a>- 將 Milvus 與 LangChain、LlamaIndex、OpenAI 代理程式等連接。</li>
</ul>
