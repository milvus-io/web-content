...
<p>使用 Milvus 建立 RAG 管道的端對端規則，包括攝取、分塊、嵌入、使用 BM25 的混合檢索，以及使用 upsert 的文件更新。將以下完整提示複製到您的 AI 工具中，以自動套用這些規則。如需所有提示的概覽，請參閱<a href="/docs/zh-hant/ai_prompts_landing.md">AI 提示</a>。</p>
