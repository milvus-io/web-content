...
summary: 人工智能編碼助手使用 MilvusClient 寫出正確 Milvus Python 程式碼的規則。
---
<h1 id="Python-SDK" class="common-anchor-header">Python SDK<button data-href="#Python-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>使用 MilvusClient 介面撰寫正確的 Milvus Python 程式碼的規則，包括 ORM 移轉、連線模式和常見操作。將以下完整的提示複製到您的 AI 工具中，以自動套用這些規則。如需所有提示的概覽，請參閱<a href="/docs/zh-hant/milvus_for_agents.md">AI 提示</a>。</p>
