...
<h3 id="Standalone" class="common-anchor-header">Standalone</h3><p>A single instance of Milvus that runs all components in one process, which is suitable for small datasets and low workload.
