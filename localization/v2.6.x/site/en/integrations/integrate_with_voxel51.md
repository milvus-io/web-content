...
<p>For detailed information on these parameters, see the <a href="/docs/v2.6.x/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/v2.6.x/consistency.md">Milvus consistency levels documentation</a>.</p>
