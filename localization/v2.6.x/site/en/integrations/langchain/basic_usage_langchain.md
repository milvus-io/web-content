...
<h3 id="Credentials" class="common-anchor-header">Credentials<button data-href="#Credentials" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>No credentials are needed to use the <code translate="no">Milvus</code> vector store.</p>
<h2 id="Initialization" class="common-anchor-header">Initialization<button data-href="#Initialization" class="anchor-icon" translate="no">
    ...
    </button></h2><pre><code translate="no" class="language-{=mdx}">import EmbeddingTabs from &quot;@theme/EmbeddingTabs&quot;;
