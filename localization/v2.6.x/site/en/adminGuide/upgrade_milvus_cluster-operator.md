...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Upgrade Milvus Cluster with Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>This guide describes how to upgrade your Milvus cluster from v2.5.x to v2.6.19 using Milvus Operator.</p>
...
<li>You <strong>must</strong> upgrade to v2.5.16 or later with <code translate="no">mixCoord</code> enabled before upgrading to v2.6.19.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2619" class="common-anchor-header">2.3 Upgrade to v2.6.19</h4><p>Once v2.5.16 is running successfully with <code translate="no">mixCoord</code>, upgrade to v2.6.19:</p>
