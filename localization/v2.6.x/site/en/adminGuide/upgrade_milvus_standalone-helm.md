...
<h4 id="2-Upgrade-Milvus-from-v21x-to-2423" class="common-anchor-header">2. Upgrade Milvus from v2.1.x to 2.4.23</h4><p>The following commands assume that you upgrade Milvus from v2.1.4 to 2.4.23. Change them to the versions that fit your needs.</p>
<ol>
