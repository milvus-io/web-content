...
---
<div class="tab-wrapper"><a href="/docs/v2.6.x/upgrade_milvus_standalone-operator.md" class=''>Milvus Operator</a><a href="/docs/v2.6.x/upgrade_milvus_cluster-operator.md" class=''>Milvus Operator</a><a href="/docs/v2.6.x/configure_operator.md" class=''>Milvus Operator</a><a href="/docs/v2.6.x/configure-helm.md" class=''>Helm</a><a href="/docs/v2.6.x/configure-docker.md" class=''>Docker Compose</a><a href="/docs/v2.6.x/upgrade_milvus_standalone-helm.md" class=''>Helm</a><a href="/docs/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>Docker Compose</a><a href="/docs/v2.6.x/upgrade_milvus_cluster-helm.md" class=''>Helm</a></div>
...
<p>In normal cases, you can <a href="#Upgrade-Milvus-by-changing-its-image">upgrade Milvus by changing its image</a>. However, you need to <a href="#Migrate-the-metadata">migrate the metadata</a> before any upgrade from v2.1.x to v2.6.5.</p>
...
<span class="hljs-attr">config:</span>
  ...
  <span class="hljs-attr">targetVersion:</span> <span class="hljs-number">2.6</span><span class="hljs-number">.5</span>
