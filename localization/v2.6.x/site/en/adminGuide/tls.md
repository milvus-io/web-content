...
<h3 id="Modify-the-detail-of-certificate-files-optional" class="common-anchor-header">Modify the detail of certificate files (optional)<button data-href="#Modify-the-detail-of-certificate-files-optional" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>After generating the certificate, you can modify the detail of the certificate files according to your own need.</p>
...
<h3 id="1-Modify-the-Milvus-server-configuration" class="common-anchor-header">1. Modify the Milvus server configuration<button data-href="#1-Modify-the-Milvus-server-configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>To enable TLS, set <code translate="no">common.security.tlsMode</code> in <code translate="no">milvus.yaml</code> to <code translate="no">1</code> (for one-way TLS) or <code translate="no">2</code> (for two-way TLS).</p>
...
<h3 id="2-Map-certificate-files-to-the-container" class="common-anchor-header">2. Map certificate files to the container<button data-href="#2-Map-certificate-files-to-the-container" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="One-way-TLS-connection" class="common-anchor-header">One-way TLS connection<button data-href="#One-way-TLS-connection" class="anchor-icon" translate="no">
    ...
    </button></h3><pre><code translate="no" class="language-bash">curl --cacert path_to/ca.pem https://localhost:19530/v2/vectordb/collections/list
<button class="copy-code-btn"></button></code></pre>
<h3 id="Two-way-TLS-connection" class="common-anchor-header">Two-way TLS connection<button data-href="#Two-way-TLS-connection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
    ...
    </button></h3><pre><code translate="no" class="language-bash">curl --cert path_to/client.pem --key path_to/client.key --cacert path_to/ca.pem https://localhost:19530/v2/vectordb/collections/list
<button class="copy-code-btn"></button></code></pre>
