...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Upgrade Milvus Standalone with Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>This guide describes how to upgrade your Milvus standalone deployment from v2.5.x to v2.6.11 using Milvus Operator.</p>
...
<li>You <strong>must</strong> upgrade to v2.5.16 or later before upgrading to v2.6.11.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2611" class="common-anchor-header">2.2 Upgrade to v2.6.11</h4><p>Once v2.5.16 is running successfully, upgrade to v2.6.11:</p>
