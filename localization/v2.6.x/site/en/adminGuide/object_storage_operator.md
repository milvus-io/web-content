...
<h3 id="Internal-object-storage" class="common-anchor-header">Internal object storage<button data-href="#Internal-object-storage" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>By default, Milvus Operator deploys an in-cluster MinIO for Milvus. The following is an example configuration to demonstrate how to use this MinIO as an internal object storage.</p>
...
<h3 id="External-object-storage" class="common-anchor-header">External object storage<button data-href="#External-object-storage" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Using <code translate="no">external</code> in the template YAML file indicates using an external object storage service. To use an external object storage, you need to properly set fields under <code translate="no">spec.dependencies.storage</code> and <code translate="no">spec.config.minio</code> in the Milvus CRD.</p>
