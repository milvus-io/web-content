...
<p>In this tutorial, we will show you how to build a RAG(Retrieval-Augmented Generation) pipeline with Milvus.</p>
...
<h2 id="Quick-Deploy" class="common-anchor-header">Quick Deploy<button data-href="#Quick-Deploy" class="anchor-icon" translate="no">
    ...
    </button></h2><p>To learn about how to start an online demo with this tutorial, please refer to <a href="https://github.com/milvus-io/bootcamp/tree/master/bootcamp/tutorials/quickstart/apps/rag_search_with_milvus">the example application</a>.</p>
