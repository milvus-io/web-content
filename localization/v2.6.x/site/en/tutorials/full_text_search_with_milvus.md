...
<h3 id="Multi-language-Analyzer" class="common-anchor-header">Multi-language Analyzer<button data-href="#Multi-language-Analyzer" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Milvus supports multi-language analyzers for documents in multiple languages. Use <code translate="no">multi_analyzer_params</code> in <code translate="no">BM25BuiltInFunction</code>:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>For more details, see the <a href="https://milvus.io/docs/multi-language-analyzers.md">multi-language analyzer documentation</a>.</p>
