...
<button class="copy-code-btn"></button></code></pre>
<p>The command above deploys a Milvus cluster with <strong>Woodpecker</strong> as the message queue (recommended for v2.6.3) and all new architectural components including the Streaming Node.</p>
