...
Milvus CDC can replicate data changes from one Milvus cluster to another for primary-standby disaster recovery. For details, refer to <a href="/docs/v2.6.x/milvus_cdc_overview.md">Milvus CDC</a>.</p></li>
