...
<p>The <code translate="no">rootcoord.minSegmentSizeToEnableIndex</code> parameter determines the index-building threshold for a segment, and is set to 1024 rows by default. See <a href="/docs/v2.6.x/system_configuration.md">System Configuration</a> for more information.</p>
...
<li>Join our <a href="https://discord.com/invite/8uyFbECzPX">Discord channel</a> to find support and engage with our open-source community.</li>
</ul>
