...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.6.x/assets/sparse-vector.png" alt="Sparse Vector" class="doc-image" id="sparse-vector" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.6.x/assets/use-sparse-vector.png" alt="Use Sparse Vector" class="doc-image" id="use-sparse-vector" />
