...
<p>If you are unsure which mode to choose, <a href="/docs/v2.6.x/primary-field.md#Quickstart-Use-AutoID">start with AutoID</a> for simpler ingestion and guaranteed uniqueness.</p>
</div>
