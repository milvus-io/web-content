...
<h3 id="Benefits-of-using-iterators" class="common-anchor-header">Benefits of using iterators<button data-href="#Benefits-of-using-iterators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
