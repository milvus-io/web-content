...
<h3 id="Install-via-pip" class="common-anchor-header">Install via pip<button data-href="#Install-via-pip" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Run the following command to install Milvus_CLI.</p>
...
<h3 id="Prerequisites" class="common-anchor-header">Prerequisites<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Docker 19.03 or later is required.</p>
<h3 id="Install-based-on-Docker-image" class="common-anchor-header">Install based on Docker image<button data-href="#Install-based-on-Docker-image" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Install-from-an-exe-file" class="common-anchor-header">Install from an .exe file<button data-href="#Install-from-an-exe-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><div class="alert note"> This installation method only applies to Windows. </div>
