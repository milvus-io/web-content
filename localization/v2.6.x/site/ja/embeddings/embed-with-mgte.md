...
order: 13
summary: >-
  この記事では、MGTEEmbeddingFunction を使用して、mGTE
...
<p>次に、MGTEEmbeddingFunction をインスタンス化します：</p>
...
<p>エンコーディングに使用する mGTE 埋め込みモデルの名前。デフォルトは<code translate="no">Alibaba-NLP/gte-multilingual-base</code> 。</p></li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<p>クエリ用の埋め込みを作成するには、<code translate="no">encode_queries()</code> メソッドを使います：</p>
