...
<p>挿入するエンティティには、すべてのスキーマ定義フィールドを含める必要があります。これらのフィールドのいくつかをオプションにするには、ダイナミック・フィールドを有効にすることを検討します。詳細については、「<a href="/docs/ja/enable-dynamic-field.md">動的フィールド</a>」を参照してください。</p>
<ul>
...
<p>検索とクエリの詳細については、検索と再ランクの章の記事を参照してください：</p>
<ul>
