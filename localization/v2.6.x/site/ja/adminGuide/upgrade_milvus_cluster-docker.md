...
<p>通常、<a href="#Upgrade-Milvus-by-changing-its-image">Milvusはイメージを変更することでアップグレード</a>できます。ただし、v2.1.x から v2.6.23 へのアップグレードを行う前には、<a href="#Migrate-the-metadata">メタデータの移行を行う</a>必要があります。</p>
<div class="alert note">
<p><strong>メッセージキューの制限事項</strong>：Milvus v2.6.23 にアップグレードする際は、現在のメッセージキューの設定を維持する必要があります。アップグレード中に異なるメッセージキューシステムへ切り替えることはサポートされていません。メッセージキューシステムの変更機能は、将来のバージョンで提供される予定です。</p>
</div>
...
<button class="copy-code-btn"></button></code></pre></li>
<li><p>メタデータの移行に向けて、設定ファイル<code translate="no">migrate.yaml</code> を準備します。</p>
