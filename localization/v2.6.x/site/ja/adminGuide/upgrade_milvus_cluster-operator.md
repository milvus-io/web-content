...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2617" class="common-anchor-header">2.3 v2.6.17 へのアップグレード</h4><p><code translate="no">mixCoord</code> が有効な状態で v2.5.16 が正常に動作していることを確認したら、v2.6.17 にアップグレードします:</p>
