...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Upgrade-your-Milvus-standalone" class="common-anchor-header">ステップ 2: Milvusスタンドアロンのアップグレード</h3><h4 id="21-Upgrade-to-v2516" class="common-anchor-header">2.1 v2.5.16へのアップグレード</h4><div class="alert-note">
