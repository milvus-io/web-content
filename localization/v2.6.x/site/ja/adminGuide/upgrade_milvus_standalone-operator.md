...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Milvus Operator を使用した Milvus スタンドアロンのアップグレード<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>このガイドでは、Milvus Operator を使用して、Milvus スタンドアロン環境を v2.5.x から v2.6.23 にアップグレードする方法について説明します。</p>
...
<ul>
<li>Milvus Operatorを介してMilvusスタンドアロンがデプロイされたKubernetesクラスター</li>
...
<h2 id="Upgrade-process" class="common-anchor-header">アップグレード手順<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h3><p>まず、Milvus Operator を v1.3.7 にアップグレードしてください：</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2623" class="common-anchor-header">2.2 v2.6.23 へのアップグレード</h4><p>v2.5.16が正常に動作したら、v2.6.23にアップグレードします:</p>
