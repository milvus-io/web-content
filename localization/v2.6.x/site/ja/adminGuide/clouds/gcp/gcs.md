...
<h1 id="Configure-GCS-Access-by-Workload-Identity" class="common-anchor-header">ワークロードIDによるGCSアクセスの構成<button data-href="#Configure-GCS-Access-by-Workload-Identity" class="anchor-icon" translate="no">
    ...
    </button></h1><p>helmでMilvusをインストールした場合のWorkload Identityによるgcsアクセスの設定方法を紹介します。 詳細は<a href="https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity">Workload Identityを</a>参照してください。</p>
