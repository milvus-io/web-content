...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Docker Compose を使用した Milvus スタンドアロンのアップグレード<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>このガイドでは、Docker Compose を使用して Milvus スタンドアロン環境を v2.5.x から v2.6.22 にアップグレードする方法について説明します。</p>
...
<li>v2.6.22 にアップグレードする前に、v2.5.16 以降にアップグレード<strong>する必要があります</strong>。</li>
</ul>
...
<p>セキュリティ上の理由により、Milvus v2.6.22のリリースに伴い、MinIOがRELEASE.2024-12-18T13-15-44Zにアップグレードされます。</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v2622" class="common-anchor-header">ステップ 2: v2.6.22 へのアップグレード<button data-href="#Step-2-Upgrade-to-v2622" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>v2.5.16が正常に動作していることを確認したら、v2.6.22にアップグレードします:</p>
<ol>
