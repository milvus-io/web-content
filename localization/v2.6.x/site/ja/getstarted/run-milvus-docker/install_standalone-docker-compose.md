...
以下では、デフォルトの<code translate="no">proxy.healthCheckTimeout</code> を上書きする必要がある場合を想定しています。適用可能な設定項目については、「<a href="/docs/ja/v2.6.x/system_configuration.md">システム設定</a>」を参照してください。</p>
