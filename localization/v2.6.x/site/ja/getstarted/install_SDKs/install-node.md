...
related_key: SDK
summary: MilvusのNode.js SDKのインストール方法をご覧ください。
title: Milvus Node.js SDK のインストール
---
<h1 id="Install-Milvus-Nodejs-SDK" class="common-anchor-header">Milvus Node.js SDK のインストール<button data-href="#Install-Milvus-Nodejs-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>このトピックでは、Milvus 用の Milvus Node.js SDK のインストール方法について説明します。</p>
<h2 id="Compatibility" class="common-anchor-header">互換性<button data-href="#Compatibility" class="anchor-icon" translate="no">
    ...
    </button></h2><p>以下の表に、Milvusのバージョンと推奨される@zilliz/milvus2-sdk-nodeのバージョンを示します。</p>
<table>
<thead>
<tr><th style="text-align:center">Milvusのバージョン</th><th style="text-align:center">推奨される @zilliz/milvus2-sdk-node のバージョン</th></tr>
</thead>
<tbody>
<tr><td style="text-align:center">2.5.x</td><td style="text-align:center">最新</td></tr>
...
<h2 id="Installation" class="common-anchor-header">インストール<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Node.js クライアントの使用を開始するには、npm（Node パッケージマネージャー）を使用してプロジェクトに依存関係をインストールすることをお勧めします。</p>
<pre><code translate="no" class="language-javascript">npm install @zilliz/milvus2-sdk-node
# or ...
yarn add @zilliz/milvus2-sdk-node
<button class="copy-code-btn"></button></code></pre>
<p>これにより、Milvus Node.js SDK がダウンロードされ、package.json ファイルに依存関係のエントリが追加されます。</p>
<h2 id="Whats-next" class="common-anchor-header">次の手順<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Node.js SDK をインストールしたら、以下の操作が可能です:</p>
<ul>
<li><p><a href="https://github.com/milvus-io/milvus-sdk-node">Milvus Node.js SDKのクイックスタートを</a>参照する</p></li>
...
<li><p><a href="/api-reference/node/v2.6.x/About.md">Milvus Node.js API リファレンスを</a>参照する</p></li>
</ul>
