...
related_key: SDK
summary: MilvusのJava SDKのインストール方法について学びましょう。
title: Milvus Java SDK のインストール
---
<h1 id="Install-Milvus-Java-SDK" class="common-anchor-header">Milvus Java SDK のインストール<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>このトピックでは、Milvus 用 Milvus Java SDK のインストール方法について説明します。</p>
<p>現在のバージョンの Milvus では、Python、Node.js、GO、および Java 用の SDK がサポートされています。</p>
...
<h2 id="Install-Milvus-Java-SDK" class="common-anchor-header">Milvus Java SDKのインストール<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
    ...
    </button></h2><p>以下のコマンドを実行して、Milvus Java SDKをインストールしてください。</p>
<ul>
<li>Apache Maven</li>
</ul>
...
<h2 id="Whats-next" class="common-anchor-header">次の手順<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Java SDKのインストールが完了したら、以下の操作が可能です：</p>
<ul>
...
<li><p><a href="/api-reference/java/v2.4.x/About.md">Milvus Java API リファレンスを</a>参照する</p></li>
</ul>
