...
<h1 id="Install-Milvus-Java-SDK" class="common-anchor-header">Milvus Java SDK のインストール<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>このトピックでは、Milvus 用の Milvus Java SDK のインストール方法について説明します。</p>
<p>現在のバージョンのMilvusでは、Python、Node.js、GO、およびJava用のSDKがサポートされています。</p>
...
<h2 id="Whats-next" class="common-anchor-header">次の手順<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Java SDK をインストールしたら、次のことができます:</p>
<ul>
