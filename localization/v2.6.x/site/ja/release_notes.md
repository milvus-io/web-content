...
<h2 id="v269" class="common-anchor-header">v2.6.9<button data-href="#v269" class="anchor-icon" translate="no">
    ...
    </button></h2><p>リリース日: 2026年1月16日</p>
<table>
<thead>
...
<li>主キーによる検索をサポート<a href="https://github.com/milvus-io/milvus/pull/46528">(#46528</a>)</li>
</ul>
...
<li>観測性を向上させるため、ストレージのバージョンラベルの指標を追加しました<a href="https://github.com/milvus-io/milvus/pull/47014">(#47014</a>)</li>
<li>QueryCoordにおいて、マニフェストパスが変更された場合のセグメントの再開がサポートされました<a href="https://github.com/milvus-io/milvus/pull/46921">(#46921</a>)。</li>
<li>データやスキーマが変更された場合にセグメントを再開できるようになりました<a href="https://github.com/milvus-io/milvus/pull/46412">(#46412</a>)</li>
<li>スローログの性能と効率を改善しました<a href="https://github.com/milvus-io/milvus/pull/47086">(#47086</a>)。</li>
<li>バージョン移行を容易にするために、ストレージのバージョンアップ圧縮ポリシーを追加した<a href="https://github.com/milvus-io/milvus/pull/47011">(#47011</a>)</li>
<li>C++ロギングにおける余分なメモリコピー操作を削除し、パフォーマンスを改善した<a href="https://github.com/milvus-io/milvus/pull/46992">(#46992</a>)。</li>
<li>不正アクセスを防止するために/exprエンドポイントのセキュリティ制御を追加した<a href="https://github.com/milvus-io/milvus/pull/46978">(#46978</a>)</li>
<li>必要なストリーミングノード数に達するまで、ストリーミングサービスを有効に保つようにした<a href="https://github.com/milvus-io/milvus/pull/46982">(#46982</a>)</li>
<li>セグメント情報の更新において、冗長な etcd put 操作を削除した(<a href="https://github.com/milvus-io/milvus/pull/46794">#46794</a>)。</li>
<li>ソートコンパクションにおける行数の検証を改善し、誤解を招く警告ログを削減した<a href="https://github.com/milvus-io/milvus/pull/46824">(#46824</a>)</li>
<li>インデックス構築のログメッセージを整理した(<a href="https://github.com/milvus-io/milvus/pull/46769">#46769</a>)。</li>
<li>リソースの枯渇を防ぐため、ワーカーあたりのベクトルインデックスの同時構築数を制限した<a href="https://github.com/milvus-io/milvus/pull/46877">(#46877</a>)。</li>
<li>jiebaおよびlinderaアナライザのクローン操作を最適化し、パフォーマンスを向上させた<a href="https://github.com/milvus-io/milvus/pull/46757">(#46757</a>)。</li>
<li>CGOログをzapロガーに転送するglogシンクを追加し、ロギングの統一を図った<a href="https://github.com/milvus-io/milvus/pull/46741">(#46741</a>)</li>
<li>ストレージV2フォーマットの使用を強制し、V1書き込みを非推奨にした<a href="https://github.com/milvus-io/milvus/pull/46889">(#46889</a>)</li>
<li>ngram操作のバッチ処理を実装し、効率化を図った<a href="https://github.com/milvus-io/milvus/pull/46703">(#46703</a>)</li>
<li>信頼性向上のため、binlog書き込み操作の自動再試行機構を追加<a href="https://github.com/milvus-io/milvus/pull/46854">(#46854</a>)</li>
<li>不要な処理を減らすために、消費側からの空のタイムティックメッセージをフィルタリングした<a href="https://github.com/milvus-io/milvus/pull/46730">(#46730</a>)</li>
<li>主キーによる検索において、重複チェックと anns_field の自動推論を改良した(<a href="https://github.com/milvus-io/milvus/pull/46745">#46745</a>)</li>
<li>siliconflowおよびcohereエンベッディングプロバイダのディメンションパラメータをサポートした(<a href="https://github.com/milvus-io/milvus/pull/47081">#47081</a>)</li>
</ul>
...
<li>セグメントロードの推定において、インデックスメモリの二重カウントを修正した<a href="https://github.com/milvus-io/milvus/pull/47046">(#47046</a>)</li>
<li>macOS 14 でのコンパイルの問題を修正した<a href="https://github.com/milvus-io/milvus/pull/47048">(#47048</a>)</li>
<li>ストリーミングサービスディスカバリのグローバルバージョンにリビジョンを使用するようにし、整合性を向上させました<a href="https://github.com/milvus-io/milvus/pull/47023">(#47023</a>)。</li>
<li>use-after-freeクラッシュを防止するため、例外発生時にすべてのfutureが完了するようにした<a href="https://github.com/milvus-io/milvus/pull/46960">(#46960</a>)。</li>
<li>シャードインターセプターが<code translate="no">FlushAllMsg</code> 操作を誤ってスキップしていた問題を修正した<a href="https://github.com/milvus-io/milvus/pull/47004">(#47004</a>)。</li>
<li>無効な設定を防止するため、コレクションのTTLに有効範囲の検証を追加しました<a href="https://github.com/milvus-io/milvus/pull/47010">(#47010</a>)。</li>
<li><code translate="no">GetCredentialInfo</code> が RPC レスポンスをキャッシュしていなかった問題を修正した<a href="https://github.com/milvus-io/milvus/pull/46945">(#46945</a>)。</li>
<li>複数の関数が無効となった場合に<code translate="no">AlterFunction</code> を呼び出せない問題を修正した<a href="https://github.com/milvus-io/milvus/pull/46986">(#46986</a>)</li>
<li>転置インデックスの NULL オフセットファイルが圧縮されない問題を修正<a href="https://github.com/milvus-io/milvus/pull/46950">(#46950</a>)</li>
<li>インデックス化されたJSONフィールドでis_null_exprを使用するとクラッシュする問題を修正した<a href="https://github.com/milvus-io/milvus/pull/46894">(#46894</a>)。</li>
<li>RESTful v2 insert APIにおいて、allow_insert_auto_idフラグのチェックを追加した<a href="https://github.com/milvus-io/milvus/pull/46931">(#46931</a>)。</li>
<li>loonマニフェストから読み込む前に、カラムグループにフィールドが存在するかチェックするようにした(<a href="https://github.com/milvus-io/milvus/pull/46924">#46924</a>)</li>
<li>highlightパラメータが正しく動作しない不具合を修正しました<a href="https://github.com/milvus-io/milvus/pull/46876">(#46876</a>)</li>
<li>デリゲータが回復状態にある場合、クォータセンターがデリゲータを無視するようになった<a href="https://github.com/milvus-io/milvus/pull/46858">(#46858</a>)</li>
<li>WKT/WKBの変換オプションを整列し、操作の一貫性を確保した<a href="https://github.com/milvus-io/milvus/pull/46874">(#46874</a>)</li>
<li>voyageaiモデルのint8のバグを修正<a href="https://github.com/milvus-io/milvus/pull/46821">(#46821</a>)</li>
<li>リカバリストレージオペレーションで<code translate="no">FlushAllMsg</code> の処理が抜けていたのを修正<a href="https://github.com/milvus-io/milvus/pull/46803">(#46803</a>)</li>
<li>パニックを回避するため、querytaskのshardclientmgrフィールドが欠落していたのを修正した<a href="https://github.com/milvus-io/milvus/pull/46838">(#46838</a>)。</li>
<li>スケジューラのleaderactionのstaleチェックにleaderidを使用するようにし、精度を向上した<a href="https://github.com/milvus-io/milvus/pull/46788">(#46788</a>)。</li>
<li>2.6で失われたPulsarのテナント/名前空間のサポートを復活<a href="https://github.com/milvus-io/milvus/pull/46759">(#46759</a>)</li>
<li>ロードコンフィグの変更が失われないようにロードコンフィグウォッチャーを追加<a href="https://github.com/milvus-io/milvus/pull/46786">(#46786</a>)</li>
<li>関数編集インターフェイスのバグを修正<a href="https://github.com/milvus-io/milvus/pull/46782">(#46782</a>)</li>
<li>コンパクションがスタックするのを防ぐため、コレクションのTTLプロパティの検証を追加<a href="https://github.com/milvus-io/milvus/pull/46736">(#46736</a>)</li>
</ul>
...
<p>Milvus 2.6.8のリリースをお知らせいたします！このバージョンでは、検索結果のハイライト表示を導入し、検索体験を大幅に向上させました。また、クエリ処理、リソーススケジューリング、キャッシュ機構を最適化し、優れたパフォーマンスと安定性を実現しました。さらに、このリリースでは、データ・セキュリティ、ストレージ処理、および並行処理に関連する重大なバグに対処しています。より効率的で信頼性の高い本番環境を実現するため、すべてのユーザーにこのバージョンへのアップグレードを強くお勧めします。</p>
...
<li>クエリ最適化ロジックをプロキシに移動し、パフォーマンスを改善した<a href="https://github.com/milvus-io/milvus/pull/46549">(#46549</a>)</li>
<li>STLソートを使用した<code translate="no">LIKE</code> 演算子のパフォーマンスを最適化した(<a href="https://github.com/milvus-io/milvus/pull/46535">#46535</a>)</li>
<li>複数フィールドに対するテキストインデックスタスクの同時実行を可能にした<a href="https://github.com/milvus-io/milvus/pull/46306">(#46306</a>)</li>
<li>コレクションレベルでのGCの一時停止をサポート<a href="https://github.com/milvus-io/milvus/pull/46201">(#46201</a>)</li>
<li>QueryNodesのリソース枯渇に対するペナルティポリシーを実装した<a href="https://github.com/milvus-io/milvus/pull/46086">(#46086</a>)</li>
<li>複数の行グループを単一のキャッシュセルにマッピングすることで、データキャッシングを最適化した<a href="https://github.com/milvus-io/milvus/pull/46542">(#46542</a>)</li>
<li>QuotaCenterのCPU使用率を削減しました<a href="https://github.com/milvus-io/milvus/pull/46615">(#46615</a>)</li>
<li><code translate="no">TIMESTAMPTZ</code> 、データ比較の性能を改善しました<a href="https://github.com/milvus-io/milvus/pull/46655">(#46655</a>)。</li>
<li>空のJSONオブジェクトをデフォルト値とする、NULL可能な動的フィールドをサポートした<a href="https://github.com/milvus-io/milvus/pull/46445">(#46445</a>)。</li>
<li>コレクションプロパティのみを変更する場合に、不必要なセグメントシーリングが発生しないようにした<a href="https://github.com/milvus-io/milvus/pull/46489">(#46489</a>)</li>
<li>Proxy for RESTful v2でDMLとDQLの転送をサポートした<a href="https://github.com/milvus-io/milvus/pull/46021">(#46021</a>,<a href="https://github.com/milvus-io/milvus/pull/46037">#46037</a>)</li>
<li>レート制限エラー時にオブジェクトストレージの読み込みを再試行する仕組みを追加<a href="https://github.com/milvus-io/milvus/pull/46464">(#46464</a>)</li>
<li>ProxyとRootCoordメタテーブルのロギングを強化した<a href="https://github.com/milvus-io/milvus/pull/46701">(#46701</a>)</li>
<li>埋め込みモデルとスキーマフィールド型の検証を追加しました<a href="https://github.com/milvus-io/milvus/pull/46422">(#46422</a>)</li>
<li>コレクションのドロップ操作を遅延させる許容期間を導入した<a href="https://github.com/milvus-io/milvus/pull/46252">(#46252</a>)</li>
<li>フィールドのサイズと型に基づいてスロットを推定することでインデックスタスクのスケジューリングを改善した<a href="https://github.com/milvus-io/milvus/pull/46276">(#46276</a>,<a href="https://github.com/milvus-io/milvus/pull/45851">#45851</a>)</li>
<li>条件付き書き込みをサポートしていないオブジェクトストレージにアクセスする際の、書き込みパスのフォールバック機構を追加しました<a href="https://github.com/milvus-io/milvus/pull/46022">(#46022</a>)。</li>
<li>IDFのオラクル同期ロジックを最適化した(<a href="https://github.com/milvus-io/milvus/pull/46079">#46079</a>)</li>
<li>RootCoordのデフォルトポートを非エフェメラルポートに変更<a href="https://github.com/milvus-io/milvus/pull/46268">(#46268</a>)</li>
<li>Jemallocキャッシュメモリを監視するメトリックを追加した<a href="https://github.com/milvus-io/milvus/pull/45973">(#45973</a>)</li>
<li>クラスタクォータが変更された場合のディスククォータメトリクスの精度を改善しました<a href="https://github.com/milvus-io/milvus/pull/46304">(#46304</a>)</li>
<li>スカラー式のトレース観測性を改善した<a href="https://github.com/milvus-io/milvus/pull/45823">(#45823</a>)</li>
<li>upsertバッチリクエストで主キーの重複を拒否するようにした(<a href="https://github.com/milvus-io/milvus/pull/46035">#46035</a>)</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">バグ修正<button data-href="#Bug-fixes" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<li>コレクションを削除する際に、ETCD RPC サイズの上限を超えるエラーが発生する問題を修正<a href="https://github.com/milvus-io/milvus/pull/46645">(#46645</a>)</li>
<li>サーバがアイドル状態のときのレプリケーションの遅延問題を修正しました<a href="https://github.com/milvus-io/milvus/pull/46612">(#46612</a>)。</li>
<li>無効な<code translate="no">TIMESTAMPTZ</code> デフォルト値の検証を修正しました<a href="https://github.com/milvus-io/milvus/pull/46556">(#46556</a>)。</li>
<li>コンパクションタスクのリストアを修正し、適切なクリーンアップを行うようにした<a href="https://github.com/milvus-io/milvus/pull/46578">(#46578</a>)</li>
<li>バランスチャネルタスクのスタックを回避するため、読み取り専用ノードの処理を統一<a href="https://github.com/milvus-io/milvus/pull/46513">(#46513</a>)</li>
<li>複数フィールドのカラムグループに対するフィールドデータのドロップを防止<a href="https://github.com/milvus-io/milvus/pull/46425">(#46425</a>)</li>
<li>ETCDを再視聴する際に、陳腐化したプロキシクライアントを削除<a href="https://github.com/milvus-io/milvus/pull/46490">(#46490</a>)</li>
<li>チャンクイテレータのマージ順序を修正した(<a href="https://github.com/milvus-io/milvus/pull/46462">#46462</a>)</li>
<li>自動コミットを無効にしてKafkaコンシューマーグループを作成しないようにした<a href="https://github.com/milvus-io/milvus/pull/46509">(#46509</a>)</li>
<li>階層化ストレージパラメータのホットロードを禁止した<a href="https://github.com/milvus-io/milvus/pull/46438">(#46438</a>)</li>
<li>バイナリベクトルの検索イテレータを有効にした<a href="https://github.com/milvus-io/milvus/pull/46334">(#46334</a>)</li>
<li>ストレージ初期化の競合状態を修正<a href="https://github.com/milvus-io/milvus/pull/46338">(#46338</a>)</li>
<li>BM25以外の検索でハイライトクエリが動作しない問題を修正<a href="https://github.com/milvus-io/milvus/pull/46295">(#46295</a>)</li>
<li>JSONガベージコレクション中のスタックオーバーフローを修正した<a href="https://github.com/milvus-io/milvus/pull/46318">(#46318</a>)。</li>
<li>ビンログ書き込み時のリトライを保証した<a href="https://github.com/milvus-io/milvus/pull/46310">(#46310</a>)</li>
<li>JSONフィールドのインデックス使用チェックを修正した<a href="https://github.com/milvus-io/milvus/pull/46281">(#46281</a>)。</li>
<li>スケーリング中にレプリカのノードが不足した場合にターゲットの更新がブロックされないようにした<a href="https://github.com/milvus-io/milvus/pull/46291">(#46291</a>)。</li>
<li><code translate="no">char_group</code> のトークナイザが半角の区切り文字のみをサポートするように制限した<a href="https://github.com/milvus-io/milvus/pull/46196">(#46196</a>)。</li>
<li>クエリパスに数字が含まれる場合にJSONパスインデックスの使用をスキップするようにした<a href="https://github.com/milvus-io/milvus/pull/46247">(#46247</a>)。</li>
<li>MinIOにおいて、ルートパスが". "である場合のパス連結エラーを修正した<a href="https://github.com/milvus-io/milvus/pull/46221">(#46221</a>)。</li>
<li>レプリケートの遅延メトリックの計算を修正することで、ヘルスチェックで誤検出する問題を修正した<a href="https://github.com/milvus-io/milvus/pull/46122">(#46122</a>)</li>
<li><code translate="no">TIMESTAMPTZ</code> での RESTful v2 の解析とスキーマのデフォルトを修正した<a href="https://github.com/milvus-io/milvus/pull/46239">(#46239</a>)。</li>
<li>出力ジオメトリフィールドで空の結果を検索する際のパニックを修正<a href="https://github.com/milvus-io/milvus/pull/46231">(#46231</a>)</li>
<li>部分更新時のパニックを防止するため、フィールドデータの整列検証を追加した<a href="https://github.com/milvus-io/milvus/pull/46180">(#46180</a>)。</li>
<li>RESTful v2におけるデータベースの損失問題を修正<a href="https://github.com/milvus-io/milvus/pull/46172">(#46172</a>)</li>
<li>gRPCクライアントセッションにおける不正なコンテキストの使用を修正した<a href="https://github.com/milvus-io/milvus/pull/46184">(#46184</a>)</li>
<li>RESTful v2におけるアップグレード時の不正な権限転送を修正<a href="https://github.com/milvus-io/milvus/pull/46140">(#46140</a>)</li>
<li>構造体削減ロジックの誤りを修正<a href="https://github.com/milvus-io/milvus/pull/46151">(#46151</a>)</li>
<li>検索結果が空の場合に蛍光ペンがエラーを返す問題を修正<a href="https://github.com/milvus-io/milvus/pull/46111">(#46111</a>)</li>
<li>フィールドの生データを読み込む際のロジックを修正<a href="https://github.com/milvus-io/milvus/pull/46155">(#46155</a>)</li>
<li>インデックスでチャンクをスキップした後にカーソルが移動する問題を修正<a href="https://github.com/milvus-io/milvus/pull/46055">(#46055</a>)</li>
<li><code translate="no">TIMESTAMPTZ</code> のスカラーインデックス出力のループロジックを修正<a href="https://github.com/milvus-io/milvus/pull/46110">(#46110</a>)</li>
<li>RESTful APIによるジオメトリフィールドのデフォルト値の設定を修正<a href="https://github.com/milvus-io/milvus/pull/46064">(#46064</a>)</li>
<li>起動時に準備ができていないコンポーネントがあった場合、高速フェイルを実装<a href="https://github.com/milvus-io/milvus/pull/46070">(#46070</a>)</li>
</ul>
<h2 id="v267" class="common-anchor-header">v2.6.7<button data-href="#v267" class="anchor-icon" translate="no">
    ...
    </button></h2><p>リリース日：2025年12月4日</p>
<table>
<thead>
<tr><th style="text-align:left">Milvusバージョン</th><th style="text-align:left">Python SDKバージョン</th><th style="text-align:left">Node.js SDKバージョン</th><th style="text-align:left">Java SDKバージョン</th><th style="text-align:left">Go SDKバージョン</th></tr>
</thead>
...
<p>Milvus 2.6.7は2.6.xシリーズの重要な安定化アップデートです。このリリースでは、分散障害に対するシステムの堅牢化と、高負荷時のリソース利用の最適化に重点を置いています。I/O処理、メモリ管理、Kubernetesの統合が大幅に改善され、スケール時の信頼性向上とスムーズな運用を実現するため、すべての本番ユーザに対して本バージョンへのアップグレードを強く推奨します。</p>
<h3 id="Features" class="common-anchor-header">特徴<button data-href="#Features" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
...
<li><code translate="no">/livez</code> 、Kubernetesネイティブのlivenessプローブをサポートするエンドポイントを追加し、コンテナオーケストレーションの安定性を向上しました<a href="https://github.com/milvus-io/milvus/pull/45481">(#45481</a>)。</li>
<li><code translate="no">TIMESTAMPTZ</code> フィールドに対する<strong>GroupBy</strong>オペレーションをサポートし、時系列分析機能を強化した<a href="https://github.com/milvus-io/milvus/pull/45763">(#45763</a>)</li>
<li>JSONシュレッディングの共有キーインデックスの<code translate="no">mmap</code> をサポートし、RAMフットプリントを削減した<a href="https://github.com/milvus-io/milvus/pull/45861">(#45861</a>)。</li>
</ul>
<h3 id="Improvements" class="common-anchor-header">改良点<button data-href="#Improvements" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<li>プロキシにおけるDMLリクエストの転送をサポートし、書き込みの可用性とルーティングの耐性を改善した<a href="https://github.com/milvus-io/milvus/pull/45922">(#45922</a>)。</li>
<li>etcdをv3.5.23にアップグレードし、コンセンサスの安定性と性能に関する不具合を修正した<a href="https://github.com/milvus-io/milvus/pull/45953">(#45953</a>)。</li>
<li>Etcd サーバのクラッシュに対する堅牢なエラー処理を追加し、コンポーネントの障害が連鎖しないようにしました<a href="https://github.com/milvus-io/milvus/pull/45633">(#45633</a>)。</li>
<li>単純なセッションの有効性チェックのための高価なウォッチャーを削除することで、Etcdの負荷を軽減しました<a href="https://github.com/milvus-io/milvus/pull/45974">(#45974</a>)。</li>
<li>WAL保持戦略を強化し、ディスク使用量とデータ復旧の安全性のバランスを改善した<a href="https://github.com/milvus-io/milvus/pull/45784">(#45784</a>)。</li>
<li>ログの非同期書き込み同期をサポートし、ディスクI/Oブロッキングがメインの実行パスに影響を与えないようにした<a href="https://github.com/milvus-io/milvus/pull/45806">(#45806</a>)。</li>
<li>OSのページキャッシュの使用率とスループットを最適化するために、優先度の高い負荷タスクに対してBuffered I/Oを強制的に使用するようにした<a href="https://github.com/milvus-io/milvus/pull/45958">(#45958</a>)。</li>
<li><code translate="no">mmap</code> 戦略を最適化し、単一のシステムコールでグループチャンクをマップすることで、セグメントロード中のカーネルオーバーヘッドを削減した<a href="https://github.com/milvus-io/milvus/pull/45893">(#45893</a>)。</li>
<li>JSONのシュレッディングにおけるメモリの推定精度を改善し、OOMキルや利用不足を防止した<a href="https://github.com/milvus-io/milvus/pull/45876">(#45876</a>)。</li>
<li>退避状態とウォームアップ状態の両方を考慮するように、セグメントロードの見積もりを改良しました<a href="https://github.com/milvus-io/milvus/pull/45891">(#45891</a>)。</li>
<li>クエリオペレータにきめ細かいキャンセルチェックを追加し、中断またはタイムアウトしたクエリをより速く終了できるようにしました<a href="https://github.com/milvus-io/milvus/pull/45894">(#45894</a>)。</li>
<li>ファイルリソース設定における冗長なリソースタイプチェックを削除しました<a href="https://github.com/milvus-io/milvus/pull/45727">(#45727</a>)。</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">バグ修正<button data-href="#Bug-fixes" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<li>GoとC++のログを統一されたストリームにインターリーブし、デバッグ時に正しい時系列で表示するようにしました<a href="https://github.com/milvus-io/milvus/pull/46005">(#46005</a>)。</li>
<li>並行性の高い書き込みにおいて、<code translate="no">LastConfirmedMessageID</code> が不正になるレースコンディションを解決しました<a href="https://github.com/milvus-io/milvus/pull/45874">(#45874</a>)。</li>
<li>複数の検索結果から<code translate="no">allsearchcount</code> を集計する際の計算エラーを修正した<a href="https://github.com/milvus-io/milvus/pull/45904">(#45904</a>)。</li>
<li>JSON配列内の文字列を含むロジックを正しく扱うようにTerm式を修正した<a href="https://github.com/milvus-io/milvus/pull/45956">(#45956</a>)。</li>
<li>構文解析の動作を修正し、パフォーマンスを改善するために、<code translate="no">JSONContainsExpr</code> の<code translate="no">json.doc()</code> を<code translate="no">json.dom_doc()</code> に置き換えた<a href="https://github.com/milvus-io/milvus/pull/45786">(#45786</a>)。</li>
<li>シャットダウンシーケンス中のスタンバイMixCoordコンポーネントのパニックを修正した<a href="https://github.com/milvus-io/milvus/pull/45898">(#45898</a>)。</li>
<li>リーダーチェッカーを修正し、セグメントの配布がリードオンリーノードに正しく同期されるようにした<a href="https://github.com/milvus-io/milvus/pull/45991">(#45991</a>)。</li>
<li>正しいロードバランストポロジーを維持するために、ノードの再ウォッチ中に<code translate="no">HandleNodeUp</code> がトリガーされるようにした<a href="https://github.com/milvus-io/milvus/pull/45963">(#45963</a>)。</li>
<li>ローカルWALストレージが使用できなくなった場合に、リモートWALストレージへのフォールバックを実装しました<a href="https://github.com/milvus-io/milvus/pull/45754">(#45754</a>)。</li>
<li>IndexNodeバインディングモードで実行中のパニックを防止するため、<code translate="no">EmptySessionWatcher</code> を追加しました<a href="https://github.com/milvus-io/milvus/pull/45912">(#45912</a>)。</li>
<li>プロトコルバッファからブロードキャストタスクをリカバリする際のメモリ状態の一貫性を確保した<a href="https://github.com/milvus-io/milvus/pull/45788">(#45788</a>)。</li>
<li>SegCoreコレクションスキーマの更新におけるスレッド安全性の問題に対処しました<a href="https://github.com/milvus-io/milvus/pull/45618">(#45618</a>)。</li>
<li><code translate="no">ListImport</code> および<code translate="no">GetImportProgress</code> APIに対するアクセス制御(RBAC)のチェックを強化した<a href="https://github.com/milvus-io/milvus/pull/45862">(#45862</a>)。</li>
<li>入力に空の構造体リストが含まれる場合にBulkImportが失敗するバグを修正しました<a href="https://github.com/milvus-io/milvus/pull/45692">(#45692</a>)。</li>
</ul>
...
<li>alter コレクションをブロードキャストする前にスキーマプロパティを設定するようにしました<a href="https://github.com/milvus-io/milvus/pull/45529">(#45529</a>)。</li>
...
<li>イメージビルダーで<strong>Goのバージョンを1.24.6にアップグレードした</strong><a href="https://github.com/milvus-io/milvus/pull/44763">(#44763</a>)</li>
