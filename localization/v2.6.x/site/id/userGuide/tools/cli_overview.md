...
<h2 id="Current-version" class="common-anchor-header">Versi saat ini<button data-href="#Current-version" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Versi Milvus_CLI saat ini adalah 1.0.1. Untuk menemukan versi yang terinstal dan melihat apakah Anda perlu melakukan update, jalankan <code translate="no">milvus_cli --version</code>.</p>
