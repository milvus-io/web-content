...
<ul>
<li><p>Jika Anda tidak yakin mode mana yang harus dipilih, <a href="/docs/id/v2.6.x/primary-field.md#Quickstart-Use-AutoID">mulailah dengan AutoID</a> untuk penggunaan yang lebih sederhana dan keunikan yang terjamin.</p></li>
...
<h3 id="Step-2-Insert-Data" class="common-anchor-header">Langkah 2: Memasukkan Data<button data-href="#Step-2-Insert-Data" class="anchor-icon" translate="no">
    ...
    </button></h3><p><strong>Penting:</strong> Jangan sertakan kolom field utama dalam data Anda. Milvus akan membuat ID secara otomatis.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<p>Untuk detail konfigurasi, lihat <a href="/docs/id/v2.6.x/modify-collection.md#Example-5-Enable-allowinsertautoid">Memodifikasi Koleksi</a>.</p>
...
<h2 id="Reference-How-AutoID-works" class="common-anchor-header">Referensi: Bagaimana AutoID bekerja<button data-href="#Reference-How-AutoID-works" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Memahami bagaimana AutoID menghasilkan pengidentifikasi unik secara internal dapat membantu Anda <a href="/docs/id/v2.6.x/primary-field.md#Ensure-global-AutoID-uniqueness-across-clusters">mengonfigurasi ID cluster</a> dengan benar dan memecahkan masalah terkait ID.</p>
