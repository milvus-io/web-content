...
<p>Jika Anda tidak yakin mode mana yang harus dipilih, <a href="/docs/id/primary-field.md#Quickstart-Use-AutoID">mulailah dengan AutoID</a> untuk penggunaan yang lebih sederhana dan keunikan yang terjamin.</p>
</div>
...
<h3 id="Step-1-Create-a-collection-with-AutoID" class="common-anchor-header">Langkah 1: Membuat koleksi dengan AutoID<button data-href="#Step-1-Create-a-collection-with-AutoID" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Aktifkan <code translate="no">auto_id=True</code> di definisi bidang utama Anda. Milvus akan menangani pembuatan ID secara otomatis.</p>
