...
<table>
   ...
   <tr>
     ...
     <td><p>Apakah akan menyimpan data vektor asli di samping representasi terkuantisasi. Jika diaktifkan, hal ini memungkinkan penghitungan kemiripan yang lebih akurat selama fase pemeringkatan ulang dengan menggunakan vektor asli, bukan perkiraan yang dikuantisasi.</p></td>
