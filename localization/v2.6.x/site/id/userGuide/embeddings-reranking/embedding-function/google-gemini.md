...
<h2 id="Choose-an-embedding-model" class="common-anchor-header">Memilih model penyematan<button data-href="#Choose-an-embedding-model" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus mendukung model penyematan yang disediakan oleh Google Gemini. Di bawah ini adalah model penyematan Gemini yang tersedia saat ini untuk referensi cepat:</p>
<table>
   <tr>
...
<li><p><code translate="no">CLASSIFICATION</code> - Mengoptimalkan penyematan untuk klasifikasi teks.</p></li>
