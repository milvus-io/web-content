...
<li><p><a href="/docs/id/v2.6.x/hugging-face-ranker.md">Peringkat Hugging Face</a></p></li>
</ul>
...
<ul>
<li><p>Koleksi Milvus dengan bidang ` <code translate="no">VARCHAR</code> ` yang berisi teks yang akan diurutkan ulang</p></li>
