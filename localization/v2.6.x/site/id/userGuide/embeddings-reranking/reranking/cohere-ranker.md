...
<table>
   ...
   <tr>
     ...
     <td><p>Ya</p></td>
     <td><p>Model perangkingan ulang Cohere yang akan digunakan dari model yang didukung di platform Cohere. Untuk daftar model perangkingan ulang yang tersedia, lihat <a href="https://docs.cohere.com/docs/rerank">dokumentasi Cohere</a>.</p></td>
...
<h2 id="Apply-to-hybrid-search" class="common-anchor-header">Menerapkan ke pencarian hibrida<button data-href="#Apply-to-hybrid-search" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Cohere Ranker juga dapat digunakan dengan pencarian hibrida untuk menggabungkan metode pengambilan padat dan jarang:</p>
<div class="multipleCode">
