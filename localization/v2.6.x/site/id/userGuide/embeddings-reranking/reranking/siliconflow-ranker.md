...
<table>
   ...
   <tr>
     ...
     <td><p>Ya</p></td>
     <td><p>Model pemeringkatan ulang SiliconFlow yang akan digunakan dari model yang didukung pada platform SiliconFlow.</p><p>Untuk daftar model peringkat ulang yang tersedia, lihat <a href="https://docs.siliconflow.cn/en/api-reference/rerank/create-rerank">dokumentasi SiliconFlow</a>.</p></td>
