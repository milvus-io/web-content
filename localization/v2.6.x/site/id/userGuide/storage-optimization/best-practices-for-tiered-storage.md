...
<ul>
<li><p>Pemanasan menghilangkan latensi pemanggilan pertama untuk indeks skalar dan vektor frekuensi tinggi.</p></li>
...
<h2 id="Additional-tuning-tips" class="common-anchor-header">Tips penyetelan tambahan<button data-href="#Additional-tuning-tips" class="anchor-icon" translate="no">
   ...
   <tr>
     ...
     <td><p>Nonaktifkan untuk set data panas yang stabil; aktifkan (misalnya, 1-3 hari) untuk data dinamis.</p></td>
