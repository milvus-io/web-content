...
<h2 id="Load-Collection" class="common-anchor-header">Memuat Koleksi<button data-href="#Load-Collection" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ketika Anda memuat koleksi, Milvus memuat file indeks dan data mentah dari semua bidang ke dalam memori untuk respons cepat terhadap pencarian dan kueri. Entitas yang dimasukkan setelah koleksi dimuat secara otomatis diindeks dan dimuat.</p>
