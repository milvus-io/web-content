...
title: Jatuhkan Koleksi
summary: Anda dapat membuang koleksi jika sudah tidak diperlukan lagi.
---
<h1 id="Drop-Collection" class="common-anchor-header">Jatuhkan Koleksi<button data-href="#Drop-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Anda dapat membuang koleksi jika sudah tidak diperlukan lagi.</p>
<h2 id="Examples" class="common-anchor-header">Contoh<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Cuplikan kode berikut ini mengasumsikan bahwa Anda memiliki koleksi bernama <strong>my_collection</strong>.</p>
