...
<h3 id="Alter-database-properties" class="common-anchor-header">Mengubah properti basis data<button data-href="#Alter-database-properties" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Anda dapat mengubah properti database yang sudah ada sebagai berikut. Contoh berikut ini membatasi jumlah koleksi yang dapat Anda buat di dalam basis data.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
