...
---
<h1 id="Use-Milvus-as-a-LangChain-Vector-Store" class="common-anchor-header">Menggunakan Milvus sebagai Penyimpan Vektor LangChain<button data-href="#Use-Milvus-as-a-LangChain-Vector-Store" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Buku catatan ini menunjukkan cara menggunakan fungsionalitas yang terkait dengan <a href="https://milvus.io/docs/overview.md">Milvus</a> sebagai <a href="https://python.langchain.com/docs/integrations/vectorstores/">penyimpan vektor LangChain</a>.</p>
<h2 id="Setup" class="common-anchor-header">Penyiapan<button data-href="#Setup" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Anda harus menginstal <code translate="no">langchain-milvus</code> dan dependensi lain yang diperlukan.</p>
...
<p>Versi terbaru dari pymilvus dilengkapi dengan basis data vektor lokal Milvus Lite, yang bagus untuk pembuatan prototipe. Jika Anda memiliki data berskala besar, seperti lebih dari satu juta dokumen, kami sarankan untuk menyiapkan server Milvus yang lebih berkinerja baik di <a href="https://milvus.io/docs/install_standalone-docker.md#Start-Milvus">docker atau kubernetes</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Compartmentalize-the-data-with-Milvus-Collections" class="common-anchor-header">Mengelompokkan data dengan Koleksi Milvus<button data-href="#Compartmentalize-the-data-with-Milvus-Collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Anda dapat menyimpan dokumen yang berbeda yang tidak terkait dalam koleksi yang berbeda dalam instance Milvus yang sama untuk mempertahankan konteksnya</p>
<p>Berikut ini cara membuat koleksi penyimpanan vektor baru dari dokumen:</p>
...
<h3 id="Add-items-to-vector-store" class="common-anchor-header">Menambahkan item ke penyimpanan vektor<button data-href="#Add-items-to-vector-store" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Kita dapat menambahkan item ke penyimpanan vektor dengan menggunakan fungsi <code translate="no">add_documents</code>.</p>
...
<h3 id="Delete-items-from-vector-store" class="common-anchor-header">Menghapus item dari penyimpanan vektor<button data-href="#Delete-items-from-vector-store" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Query-directly" class="common-anchor-header">Menanyakan secara langsung<button data-href="#Query-directly" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><h4 id="Similarity-search" class="common-anchor-header">Pencarian kesamaan</h4><p>Melakukan pencarian kemiripan sederhana dengan pemfilteran pada metadata dapat dilakukan sebagai berikut:</p>
...
<p>Untuk daftar lengkap semua opsi pencarian yang tersedia saat menggunakan penyimpanan vektor <code translate="no">Milvus</code>, Anda dapat mengunjungi <a href="https://python.langchain.com/api_reference/milvus/vectorstores/langchain_milvus.vectorstores.milvus.Milvus.html">referensi API</a>.</p>
<h3 id="Query-by-turning-into-retriever" class="common-anchor-header">Kueri dengan mengubah menjadi retriever<button data-href="#Query-by-turning-into-retriever" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Anda juga dapat mengubah penyimpanan vektor menjadi retriever untuk penggunaan yang lebih mudah di dalam rantai Anda.</p>
...
<h2 id="Usage-for-Retrieval-Augmented-Generation" class="common-anchor-header">Penggunaan untuk Pengambilan-Pembangkitan yang Ditambah<button data-href="#Usage-for-Retrieval-Augmented-Generation" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Untuk panduan tentang cara menggunakan penyimpanan vektor ini untuk pembuatan retrieval-augmented (RAG), lihat <a href="https://milvus.io/docs/integrate_with_langchain.md">panduan RAG</a> ini.</p>
<h3 id="Per-User-Retrieval" class="common-anchor-header">Pengambilan Per-Pengguna<button data-href="#Per-User-Retrieval" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="API-reference" class="common-anchor-header">Referensi API<button data-href="#API-reference" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Untuk dokumentasi rinci, kunjungi referensi API: https://reference.langchain.com/python/integrations/langchain_milvus/</p>
