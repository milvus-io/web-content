...
<h3 id="Setting-Up-OpenAI-API-Key" class="common-anchor-header">Menyiapkan Kunci API OpenAI<button data-href="#Setting-Up-OpenAI-API-Key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Kita akan menggunakan OpenAI sebagai LLM dalam contoh ini. Anda harus menyiapkan <a href="https://platform.openai.com/docs/quickstart">OPENAI_API_KEY</a> sebagai variabel lingkungan.</p>
...
<h3 id="Process-the-Crawled-Content" class="common-anchor-header">Memproses Konten yang Dirayapi<button data-href="#Process-the-Crawled-Content" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk membuat konten yang di-crawl dapat dikelola untuk dimasukkan ke dalam Milvus, kita cukup menggunakan "#" untuk memisahkan konten, yang secara kasar dapat memisahkan konten dari setiap bagian utama dari file markdown yang di-crawl.</p>
...
<h2 id="Build-RAG" class="common-anchor-header">Membangun RAG<button data-href="#Build-RAG" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Mari tentukan pertanyaan kueri tentang situs web yang baru saja kita rayapi.</p>
