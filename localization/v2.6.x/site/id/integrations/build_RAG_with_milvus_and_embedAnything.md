...
<h1 id="Building-RAG-with-Milvus-and-EmbedAnything" class="common-anchor-header">Membangun RAG dengan Milvus dan EmbedAnything<button data-href="#Building-RAG-with-Milvus-and-EmbedAnything" class="anchor-icon" translate="no">
    ...
    </button></h1><p><a href="https://github.com/StarlightSearch/EmbedAnything">EmbedAnything</a> adalah pipeline penyisipan yang sangat cepat dan ringan yang dibangun di Rust yang mendukung teks, PDF, gambar, audio, dan banyak lagi.</p>
...
<h3 id="Clone-the-Repository-and-Load-Adapter" class="common-anchor-header">Kloning Repositori dan Load Adapter<button data-href="#Clone-the-Repository-and-Load-Adapter" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Build-RAG" class="common-anchor-header">Membangun RAG<button data-href="#Build-RAG" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Initialize-Milvus" class="common-anchor-header">Inisialisasi Milvus<button data-href="#Initialize-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sebelum kita menyisipkan berkas, kita perlu menyiapkan dua komponen yang berinteraksi dengan Milvus:</p>
<ol>
...
<h3 id="Initialize-Embedding-Model-and-Embed-PDF-Document" class="common-anchor-header">Inisialisasi Model Penyematan dan Sematkan Dokumen PDF<button data-href="#Initialize-Embedding-Model-and-Embed-PDF-Document" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Retrieve-and-Generate-Response" class="common-anchor-header">Mengambil dan Menghasilkan Tanggapan<button data-href="#Retrieve-and-Generate-Response" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
