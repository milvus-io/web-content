...
<h2 id="Preparation" class="common-anchor-header">Persiapan<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Dependencies-and-Environment" class="common-anchor-header">Ketergantungan dan Lingkungan</h3><pre><code translate="no" class="language-shell"><span class="hljs-meta prompt_">$ </span><span class="language-bash">pip install --upgrade pymilvus openai requests tqdm matplotlib seaborn</span>
...
<h3 id="Retrieve-Data-for-a-Query" class="common-anchor-header">Mengambil Data untuk Kueri</h3><p>Mari siapkan pertanyaan untuk pencarian.</p>
...
<h3 id="Dimensionality-reduction-to-2-d-by-t-SNE" class="common-anchor-header">Pengurangan dimensi menjadi 2-d dengan t-SNE</h3><p>Mari kita kurangi dimensi sematan menjadi 2-d dengan t-SNE. Kita akan menggunakan pustaka <code translate="no">sklearn</code> untuk melakukan transformasi t-SNE.</p>
