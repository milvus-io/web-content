...
<h1 id="AGENTSmd--Milvus" class="common-anchor-header">AGENTS.md - Milvus<button data-href="#AGENTSmd--Milvus" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus adalah sebuah database vektor sumber terbuka untuk pencarian kemiripan, pencarian hibrida, dan RAG. Anda berinteraksi dengannya melalui antarmuka <code translate="no">MilvusClient</code> PyMilvus SDK. Salin perintah lengkap di bawah ini ke dalam alat AI Anda untuk menerapkan aturan-aturan ini secara otomatis. Untuk perintah khusus tugas yang terperinci, lihat Perintah <a href="/docs/id/ai_prompts_landing.md">AI</a>.</p>
