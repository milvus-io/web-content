...
<h2 id="Configure-memory-mapping" class="common-anchor-header">Mengonfigurasi pemetaan memori<button data-href="#Configure-memory-mapping" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Dimulai dengan Milvus 2.4, Anda memiliki fleksibilitas untuk menyesuaikan file konfigurasi statis untuk mengonfigurasi pengaturan pemetaan memori default untuk seluruh cluster sebelum penerapan. Selain itu, terdapat opsi bagi Anda untuk mengubah parameter secara dinamis untuk menyempurnakan pengaturan pemetaan memori di tingkat cluster dan indeks. Ke depannya, pembaruan di masa mendatang akan memperluas kemampuan pemetaan memori untuk menyertakan konfigurasi tingkat bidang.</p>
<h3 id="Before-cluster-deployment-global-configuration" class="common-anchor-header">Sebelum penerapan cluster: konfigurasi global<button data-href="#Before-cluster-deployment-global-configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="During-cluster-operation-dynamic-configuration" class="common-anchor-header">Selama operasi cluster: konfigurasi dinamis<button data-href="#During-cluster-operation-dynamic-configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Selama waktu kerja cluster, Anda dapat menyesuaikan pengaturan pemetaan memori secara dinamis pada tingkat koleksi atau indeks.</p>
...
<li><p><strong>Jika saya mengupgrade dari Milvus 2.3 dan telah mengonfigurasi jalur direktori pemetaan memori, apa yang akan terjadi?</strong></p>
