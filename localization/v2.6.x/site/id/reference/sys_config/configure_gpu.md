...
summary: Pelajari cara mengonfigurasi gpu untuk Milvus.
---
<h1 id="gpu-related-Configurations" class="common-anchor-header">Konfigurasi terkait GPU<button data-href="#gpu-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>#Saat menggunakan pengindeksan GPU, Milvus akan menggunakan sebuah pool memori untuk menghindari alokasi dan deallokasi memori yang sering terjadi.</p>
