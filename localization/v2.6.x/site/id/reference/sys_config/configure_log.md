...
summary: Pelajari cara mengonfigurasi log untuk Milvus.
---
<h1 id="log-related-Configurations" class="common-anchor-header">Konfigurasi terkait log<button data-href="#log-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Mengkonfigurasi output log sistem.</p>
<h2 id="loglevel" class="common-anchor-header"><code translate="no">log.level</code><button data-href="#loglevel" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Tingkat log Milvus. Opsi: debug, info, peringatan, kesalahan, panik, dan fatal. </li>      
        <li>Disarankan untuk menggunakan level debug di lingkungan pengujian dan pengembangan, dan level info di lingkungan produksi.</li>      </td>
      <td>info</td>
    </tr>
  </tbody>
</table>
<h2 id="logfilerootPath" class="common-anchor-header"><code translate="no">log.file.rootPath</code><button data-href="#logfilerootPath" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Jalur root ke file log.</li>      
        <li>Nilai default diatur kosong, yang mengindikasikan untuk mengeluarkan file log ke output standar (stdout) dan kesalahan standar (stderr).</li>      
        <li>Jika parameter ini diatur ke jalur lokal yang valid, Milvus akan menulis dan menyimpan file log pada jalur ini.</li>      
        <li>Atur parameter ini sebagai jalur yang Anda memiliki izin untuk menulis.</li>      </td>
      <td></td>
    </tr>
  </tbody>
</table>
<h2 id="logfilemaxSize" class="common-anchor-header"><code translate="no">log.file.maxSize</code><button data-href="#logfilemaxSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Ukuran maksimum file log, satuan: MB.      </td>
      <td>300</td>
    </tr>
  </tbody>
</table>
<h2 id="logfilemaxAge" class="common-anchor-header"><code translate="no">log.file.maxAge</code><button data-href="#logfilemaxAge" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Waktu penyimpanan maksimum sebelum file log dihapus secara otomatis, satuan: hari. Nilai minimumnya adalah 1.  </td>
      <td>10</td>
    </tr>
  </tbody>
</table>
<h2 id="logfilemaxBackups" class="common-anchor-header"><code translate="no">log.file.maxBackups</code><button data-href="#logfilemaxBackups" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Jumlah maksimum file log yang akan dicadangkan, satuan: hari. Nilai minimumnya adalah 1.  </td>
      <td>20</td>
    </tr>
  </tbody>
</table>
<h2 id="logformat" class="common-anchor-header"><code translate="no">log.format</code><button data-href="#logformat" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Format log Milvus. Opsi: teks dan JSON    </td>
      <td>teks</td>
    </tr>
  </tbody>
</table>
<h2 id="logstdout" class="common-anchor-header"><code translate="no">log.stdout</code><button data-href="#logstdout" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Stdout diaktifkan atau tidak     </td>
      <td>benar</td>
    </tr>
  </tbody>
</table>
