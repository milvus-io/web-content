...
<h3 id="Field-schema-properties" class="common-anchor-header">Properti skema field<button data-href="#Field-schema-properties" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Create-a-field-schema" class="common-anchor-header">Membuat skema bidang<button data-href="#Create-a-field-schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk mengurangi kerumitan dalam penyisipan data, Milvus memungkinkan Anda untuk menentukan nilai default untuk setiap field skalar selama pembuatan skema field, tidak termasuk field kunci utama. Hal ini mengindikasikan bahwa jika Anda mengosongkan sebuah field ketika memasukkan data, nilai default yang Anda tentukan untuk field tersebut akan berlaku.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Supported-data-types" class="common-anchor-header">Tipe data yang didukung<button data-href="#Supported-data-types" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><code translate="no">DataType</code> menentukan jenis data yang berisi bidang. Bidang yang berbeda mendukung tipe data yang berbeda.</p>
<ul>
...
<h3 id="Collection-schema-properties" class="common-anchor-header">Properti skema koleksi<button data-href="#Collection-schema-properties" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Create-a-collection-schema" class="common-anchor-header">Membuat skema koleksi<button data-href="#Create-a-collection-schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p><br/>
Anda juga bisa membuat koleksi dengan <code translate="no">Collection.construct_from_dataframe</code>, yang secara otomatis membuat skema koleksi dari DataFrame dan membuat koleksi.</p>
