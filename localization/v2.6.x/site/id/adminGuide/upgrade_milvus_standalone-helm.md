...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Memutakhirkan Milvus Standalone dengan Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini menjelaskan cara mengupgrade deployment mandiri Milvus Anda dari v2.5.x ke v2.6.0 menggunakan Helm Chart.</p>
...
<li>Anda <strong>harus</strong> meningkatkan ke v2.5.16 atau yang lebih baru sebelum meningkatkan ke v2.6.0.</li>
</ul>
...
<h2 id="Upgrade-process" class="common-anchor-header">Proses peningkatan<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Upgrade-Helm-Chart" class="common-anchor-header">Langkah 1: Tingkatkan Bagan Helm</h3><p>Pertama, tingkatkan bagan Milvus Helm Anda ke versi 5.0.0:</p>
...
<h3 id="Step-2-Upgrade-to-v2516" class="common-anchor-header">Langkah 2: Tingkatkan ke versi v2.5.16</h3><div class="alert-note">
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v260" class="common-anchor-header">Langkah 3: Tingkatkan ke v2.6.0</h3><p>Setelah v2.5.16 berjalan dengan sukses, tingkatkan ke v2.6.0:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
