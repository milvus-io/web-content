...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Memutakhirkan Milvus Standalone dengan Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini menjelaskan cara mengupgrade deployment mandiri Milvus Anda dari v2.5.x ke v2.6.2 dengan menggunakan Helm Chart.</p>
...
<li>Anda <strong>harus</strong> meningkatkan ke v2.5.16 atau yang lebih baru sebelum meningkatkan ke v2.6.2.</li>
</ul>
