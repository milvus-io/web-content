...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Memperbarui Kluster Milvus dengan Helm Chart<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini menjelaskan cara meng-upgrade kluster Milvus Anda dari v2.5.x ke v2.6.23 menggunakan Helm Chart.</p>
...
<li>Anda <strong>harus</strong> melakukan pembaruan ke v2.5.16 atau versi yang lebih baru dengan mengaktifkan fitur " <code translate="no">mixCoordinator</code> " sebelum melakukan pembaruan ke v2.6.23.</li>
</ul>
<p><strong>Batasan Antrian Pesan</strong>: Saat melakukan peningkatan ke Milvus v2.6.23, Anda harus mempertahankan pilihan antrian pesan Anda saat ini. Pergantian antara sistem antrian pesan yang berbeda selama proses peningkatan tidak didukung. Dukungan untuk mengganti sistem antrian pesan akan tersedia pada versi mendatang.</p>
...
<h2 id="Upgrade-process" class="common-anchor-header">Proses pembaruan<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Pertama, perbarui chart Helm Milvus Anda ke versi 5.0.22:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v2623" class="common-anchor-header">Langkah 3: Perbarui ke v2.6.23<button data-href="#Step-3-Upgrade-to-v2623" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Setelah v2.5.16 berjalan dengan lancar menggunakan <code translate="no">mixCoordinator</code>, lakukan pembaruan ke v2.6.23:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
