...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Meningkatkan Versi Kluster Milvus dengan Helm Chart<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini menjelaskan cara meng-upgrade kluster Milvus Anda dari v2.5.x ke v2.6.17 menggunakan Helm Chart.</p>
...
<li>Anda <strong>harus</strong> melakukan peningkatan ke v2.5.16 atau yang lebih baru dengan mengaktifkan fitur " <code translate="no">mixCoordinator</code> " sebelum melakukan peningkatan ke v2.6.17.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v2617" class="common-anchor-header">Langkah 3: Lakukan pembaruan ke v2.6.17<button data-href="#Step-3-Upgrade-to-v2617" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Setelah v2.5.16 berjalan dengan lancar menggunakan <code translate="no">mixCoordinator</code>, lakukan pembaruan ke v2.6.17:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
