...
<li><strong>Batasan peningkatan</strong>: <strong>Keterbatasan Antrian Pesan</strong>: Ketika mengupgrade ke Milvus v2.6.14, anda harus mempertahankan pilihan antrian pesan anda saat ini. Beralih antara sistem antrian pesan yang berbeda selama upgrade tidak didukung. Dukungan untuk mengubah sistem antrian pesan akan tersedia di versi mendatang.</li>
</ul>
