...
<h2 id="Create-a-new-user" class="common-anchor-header">Membuat pengguna baru<button data-href="#Create-a-new-user" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Setelah tersambung sebagai pengguna default <code translate="no">root</code>, Anda dapat membuat dan mengautentikasi pengguna baru sebagai berikut:</p>
