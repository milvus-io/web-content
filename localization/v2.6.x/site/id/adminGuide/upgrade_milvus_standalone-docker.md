...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Memperbarui Milvus Standalone dengan Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini menjelaskan cara memperbarui deployment Milvus standalone Anda dari v2.5.x ke v2.6.24 menggunakan Docker Compose.</p>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>tidak kompatibel</strong> dengan v2.6.24. Peningkatan versi langsung dari kandidat rilis tidak didukung.</li>
...
<li>Anda <strong>harus</strong> melakukan pembaruan ke v2.5.16 atau versi yang lebih baru sebelum melakukan pembaruan ke v2.6.24.</li>
</ul>
<p><strong>Batasan Antrian Pesan</strong>: Saat melakukan pembaruan ke Milvus v2.6.24, Anda harus mempertahankan pilihan antrian pesan saat ini. Pergantian antara sistem antrian pesan yang berbeda selama proses pembaruan tidak didukung. Dukungan untuk mengganti sistem antrian pesan akan tersedia di versi mendatang.</p>
<div class="alter note">
<p>Karena alasan keamanan, Milvus memperbarui MinIO-nya ke RELEASE.2024-12-18T13-15-44Z bersamaan dengan rilis v2.6.24.</p>
</div>
<h2 id="Upgrade-process" class="common-anchor-header">Proses peningkatan versi<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Upgrade-to-v2516" class="common-anchor-header">Langkah 1: Memperbarui ke v2.5.16<button data-href="#Step-1-Upgrade-to-v2516" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<ol>
<li><p>Edit file ` <code translate="no">docker-compose.yaml</code> ` yang sudah ada dan perbarui tag gambar Milvus menjadi v2.5.16:</p>
...
<h3 id="Step-2-Upgrade-to-v2624" class="common-anchor-header">Langkah 2: Lakukan pembaruan ke v2.6.24<button data-href="#Step-2-Upgrade-to-v2624" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Setelah v2.5.16 berjalan dengan sukses, lakukan pembaruan ke v2.6.24:</p>
<ol>
...
<h2 id="Verify-the-upgrade" class="common-anchor-header">Verifikasi pembaruan<button data-href="#Verify-the-upgrade" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pastikan deployment mandiri Anda sudah menjalankan versi baru:</p>
...
<li>Pelajari cara <a href="/docs/id/v2.6.x/gcp.md">menerapkan kluster Milvus di GCP dengan Kubernetes</a></li>
<li>Pelajari cara <a href="/docs/id/v2.6.x/azure.md">menerapkan Milvus di Microsoft Azure menggunakan Kubernetes</a></li>
</ul></li>
</ul>
