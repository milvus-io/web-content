...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Memutakhirkan Milvus Standalone dengan Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini menjelaskan cara memutakhirkan rilis mandiri Milvus Anda dari v2.5.x ke v2.6.8 menggunakan Docker Compose.</p>
<h2 id="Before-you-start" class="common-anchor-header">Sebelum Anda memulai<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Memutakhirkan dari Milvus 2.5.x ke 2.6.8 melibatkan perubahan arsitektur yang signifikan:</p>
<ul>
...
<li>Anda <strong>harus</strong> meng-upgrade ke v2.5.16 atau yang lebih baru sebelum meng-upgrade ke v2.6.8.</li>
</ul>
<p><strong>Keterbatasan Antrian Pesan</strong>: Ketika meningkatkan ke Milvus v2.6.8, anda harus mempertahankan pilihan antrean pesan anda saat ini. Beralih di antara sistem antrian pesan yang berbeda selama upgrade tidak didukung. Dukungan untuk mengubah sistem antrian pesan akan tersedia di versi mendatang.</p>
<div class="alter note">
<p>Karena masalah keamanan, Milvus mengupgrade MinIO ke RELEASE.2024-12-18T13-15-44Z dengan rilis v2.6.8.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v268" class="common-anchor-header">Langkah 2: Tingkatkan ke v2.6.8<button data-href="#Step-2-Upgrade-to-v268" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Setelah v2.5.16 berjalan dengan sukses, tingkatkan ke v2.6.8:</p>
<ol>
