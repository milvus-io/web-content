...
<h2 id="Before-you-start" class="common-anchor-header">Sebelum Anda memulai<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Memutakhirkan dari Milvus 2.5.x ke 2.6.0 melibatkan perubahan arsitektur yang signifikan:</p>
<ul>
...
<ol>
<li><p>Edit berkas <code translate="no">docker-compose.yaml</code> yang ada dan perbarui tag gambar Milvus ke v2.5.16:</p>
...
<h3 id="Step-2-Upgrade-to-v260" class="common-anchor-header">Langkah 2: Tingkatkan ke v2.6.0<button data-href="#Step-2-Upgrade-to-v260" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Setelah v2.5.16 berjalan dengan sukses, tingkatkan ke v2.6.0:</p>
<ol>
