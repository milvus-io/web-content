...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Meningkatkan Versi Kluster Milvus dengan Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini menjelaskan cara melakukan upgrade kluster Milvus Anda dari v2.5.x ke v2.6.20 menggunakan Milvus Operator.</p>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>tidak kompatibel</strong> dengan v2.6.20. Peningkatan langsung dari kandidat rilis tidak didukung.</li>
...
<li>Anda <strong>harus</strong> melakukan peningkatan ke v2.5.16 atau yang lebih baru dengan mengaktifkan fitur " <code translate="no">mixCoord</code> " sebelum meningkatkan ke v2.6.20.</li>
</ul>
<p><strong>Batasan Antrian Pesan</strong>: Saat melakukan upgrade ke Milvus v2.6.20, Anda harus mempertahankan pilihan antrian pesan Anda saat ini. Beralih antar sistem antrian pesan yang berbeda selama proses upgrade tidak didukung. Dukungan untuk mengganti sistem antrian pesan akan tersedia di versi mendatang.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2620" class="common-anchor-header">2.3 Tingkatkan ke v2.6.20</h4><p>Setelah v2.5.16 berjalan dengan lancar dengan fitur " <code translate="no">mixCoord</code>", lakukan pembaruan ke v2.6.20:</p>
