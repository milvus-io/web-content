---
id: ingress.md
title: Mengonfigurasi ingress nginx dengan Milvus
related_key: ingress nginx
summary: Pelajari cara mengonfigurasi akses masuk nginx dengan Milvus.
---
<h1 id="Configure-ingress-nginx-with-Milvus" class="common-anchor-header">Mengonfigurasi ingress nginx dengan Milvus<button data-href="#Configure-ingress-nginx-with-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Topik ini memperkenalkan cara mengonfigurasi ingress nginx dengan Milvus. Untuk detail lebih lanjut, lihat <a href="https://learn.microsoft.com/en-us/azure/aks/ingress-tls?tabs=azure-cli">ingress-nginx</a>.</p>
<h2 id="Configure-ingress-nginx" class="common-anchor-header">Mengonfigurasi ingress nginx<button data-href="#Configure-ingress-nginx" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Dapatkan alamat IP eksternal.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Konfigurasikan FQDN untuk pengontrol akses masuk Anda.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Install-cert-manager" class="common-anchor-header">Instal cert-manager<button data-href="#Install-cert-manager" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Create-a-CA-cluster-issuer" class="common-anchor-header">Membuat penerbit klaster CA<button data-href="#Create-a-CA-cluster-issuer" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Buatlah penerbit klaster, seperti cluster-issuer.yaml, dengan menggunakan manifes contoh berikut. Ganti MY_EMAIL_ADDRESS dengan alamat yang valid dari organisasi Anda.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Terapkan penerbit menggunakan perintah kubectl apply.</li>
</ul>
...
<h2 id="Deploy-Milvus" class="common-anchor-header">Menerapkan Milvus<button data-href="#Deploy-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>lihat <a href="https://milvus.io/docs/azure.md">Azure</a>, perhatikan nilai config <code translate="no">service.type</code>, Anda perlu mengubahnya menjadi <code translate="no">ClusterIP</code>.</p>
<h2 id="Create-Milvus-ingress-route" class="common-anchor-header">Membuat rute masuk Milvus<button data-href="#Create-Milvus-ingress-route" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Verify" class="common-anchor-header">Verifikasi<button data-href="#Verify" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Hello-Milvus" class="common-anchor-header">Halo Milvus<button data-href="#Hello-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Silakan merujuk ke <a href="https://milvus.io/docs/v2.3.x/example_code.md">Hello Milvus</a>, ubah uri args, lalu jalankan kodenya.</p>
