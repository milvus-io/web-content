...
---
<div class="tab-wrapper"><a href="/docs/id/v2.6.x/upgrade_milvus_standalone-operator.md" class='active '>Milvus</a><a href="/docs/id/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>Operator</a>, Helm, Docker<a href="/docs/id/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>Compose</a></div>
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Memperbarui Milvus Standalone dengan Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini menjelaskan cara memperbarui deployment Milvus standalone Anda dari v2.5.x ke v2.6.24 menggunakan Milvus Operator.</p>
...
<ul>
<li><strong>Konsolidasi koordinator</strong>: Koordinator terpisah versi lama (<code translate="no">dataCoord</code>, <code translate="no">queryCoord</code>, <code translate="no">indexCoord</code>) telah dikonsolidasikan menjadi satu <code translate="no">mixCoord</code></li>
...
<p>Proses peningkatan ini memastikan migrasi yang tepat ke arsitektur baru. Untuk informasi lebih lanjut mengenai perubahan arsitektur, lihat <a href="/docs/id/v2.6.x/architecture_overview.md">Gambaran Umum Arsitektur Milvus</a>.</p>
...
<ul>
<li>Cluster Kubernetes dengan Milvus standalone yang diimplementasikan melalui Milvus Operator</li>
<li><code translate="no">kubectl</code> yang dikonfigurasi untuk mengakses kluster Anda</li>
<li>Helm 3.x telah diinstal</li>
</ul>
<p><strong>Persyaratan kompatibilitas:</strong></p>
<ul>
<li>Milvus v2.6.0-rc1 <strong>tidak kompatibel</strong> dengan v2.6.24. Peningkatan langsung dari kandidat rilis tidak didukung.</li>
...
<li>Anda <strong>harus</strong> melakukan pembaruan ke v2.5.16 atau yang lebih baru sebelum melakukan pembaruan ke v2.6.24.</li>
</ul>
<p><strong>Batasan Antrian Pesan</strong>: Saat melakukan peningkatan ke Milvus v2.6.24, Anda harus mempertahankan pilihan antrian pesan Anda saat ini. Pergantian antara sistem antrian pesan yang berbeda selama proses peningkatan tidak didukung. Dukungan untuk mengubah sistem antrian pesan akan tersedia di versi mendatang.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Upgrade-your-Milvus-standalone" class="common-anchor-header">Langkah 2: Tingkatkan Milvus standalone Anda<button data-href="#Step-2-Upgrade-your-Milvus-standalone" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Buat berkas konfigurasi ` <code translate="no">milvusupgrade.yaml</code> ` untuk memperbarui ke versi v2.5.16:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2624" class="common-anchor-header">2.2 Meningkatkan ke v2.6.24</h4><p>Setelah v2.5.16 berjalan dengan lancar, perbarui ke v2.6.24:</p>
