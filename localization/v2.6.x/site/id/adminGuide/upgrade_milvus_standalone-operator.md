...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Memutakhirkan Milvus Standalone dengan Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini menjelaskan cara mengupgrade deployment mandiri Milvus Anda dari v2.5.x ke v2.6.14 menggunakan Milvus Operator.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2614" class="common-anchor-header">2.2 Tingkatkan ke v2.6.14</h4><p>Setelah v2.5.16 berjalan dengan sukses, tingkatkan ke v2.6.14:</p>
