...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Memperbarui Milvus Standalone dengan Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini menjelaskan cara memperbarui deployment Milvus standalone Anda dari v2.5.x ke v2.6.23 menggunakan Milvus Operator.</p>
...
<ul>
<li>Cluster Kubernetes dengan Milvus standalone yang telah diimplementasikan melalui Milvus Operator</li>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>tidak kompatibel</strong> dengan v2.6.23. Pembaruan langsung dari rilis kandidat tidak didukung.</li>
...
<li>Anda <strong>harus</strong> melakukan pembaruan ke v2.5.16 atau yang lebih baru sebelum melakukan pembaruan ke v2.6.23.</li>
</ul>
<p><strong>Batasan Antrian Pesan</strong>: Saat melakukan pembaruan ke Milvus v2.6.23, Anda harus mempertahankan pilihan antrian pesan saat ini. Pergantian antara sistem antrian pesan yang berbeda selama proses pembaruan tidak didukung. Dukungan untuk mengganti sistem antrian pesan akan tersedia pada versi mendatang.</p>
<h2 id="Upgrade-process" class="common-anchor-header">Proses peningkatan<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Upgrade-Milvus-Operator" class="common-anchor-header">Langkah 1: Tingkatkan Milvus Operator<button data-href="#Step-1-Upgrade-Milvus-Operator" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2623" class="common-anchor-header">2.2 Memperbarui ke v2.6.23</h4><p>Setelah v2.5.16 berhasil berjalan, lakukan pembaruan ke v2.6.23:</p>
