...
related_key: SDK
summary: Pelajari cara menginstal Java SDK Milvus.
...
<li>Java (versi 8 atau yang lebih baru)</li>
<li>Apache Maven atau Gradle/Grails</li>
</ul>
<h2 id="Install-Milvus-Java-SDK" class="common-anchor-header">Instal Milvus Java SDK<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Jalankan perintah berikut untuk menginstal SDK Java Milvus.</p>
<ul>
<li>Apache Maven</li>
</ul>
...
<li><p>Jelajahi <a href="/api-reference/java/v2.6.x/About.md">referensi API Java Milvus</a></p></li>
</ul>
