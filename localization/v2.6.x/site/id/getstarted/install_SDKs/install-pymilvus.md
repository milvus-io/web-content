...
related_key: SDK
summary: Pelajari cara menginstal SDK Python dari Milvus.
...
<h1 id="Install-Milvus-Python-SDK" class="common-anchor-header">Menginstal Milvus Python SDK<button data-href="#Install-Milvus-Python-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Topik ini menjelaskan cara menginstal SDK Python Milvus (pymilvus) untuk Milvus.</p>
...
<li>Diperlukan Python 3.7 atau yang lebih baru.</li>
<li>Google Protobuf harus sudah terinstal. Anda dapat menginstalnya dengan perintah ` <code translate="no">pip3 install protobuf==3.20.0</code>`.</li>
<li>grpcio-tools harus sudah terinstal. Anda dapat menginstalnya dengan perintah ` <code translate="no">pip3 install grpcio-tools</code>`.</li>
</ul>
<h2 id="Install-PyMilvus-via-pip" class="common-anchor-header">Instal PyMilvus melalui pip<button data-href="#Install-PyMilvus-via-pip" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
Disarankan untuk menginstal versi PyMilvus yang sesuai dengan versi server Milvus yang telah Anda instal. Untuk informasi lebih lanjut, lihat <a href="/docs/id/v2.6.x/release_notes.md">Catatan Rilis</a>.
</div>
...
<h2 id="Verify-installation" class="common-anchor-header">Verifikasi instalasi<button data-href="#Verify-installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Jika PyMilvus terinstal dengan benar, tidak akan ada pengecualian yang muncul saat Anda menjalankan perintah berikut.</p>
...
<li><a href="/docs/id/v2.6.x/insert-update-delete.md">Menyisipkan, Upsert, dan Menghapus</a></li>
...
<li><p>Jelajahi <a href="/api-reference/pymilvus/v2.6.x/About.md">referensi API PyMilvus</a></p></li>
</ul>
