...
title: Menginstal Milvus Node.js SDK
---
<h1 id="Install-Milvus-Nodejs-SDK" class="common-anchor-header">Menginstal Milvus Node.js SDK<button data-href="#Install-Milvus-Nodejs-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Compatibility" class="common-anchor-header">Kompatibilitas<button data-href="#Compatibility" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Koleksi berikut menunjukkan versi Milvus dan versi @zilliz/milvus2-sdk-node yang direkomendasikan:</p>
<table>
<thead>
...
<h2 id="Installation" class="common-anchor-header">Pemasangan<button data-href="#Installation" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Cara yang disarankan untuk mulai menggunakan klien Node.js Milvus adalah dengan menggunakan npm (Node Package Manager) untuk menginstal dependensi tersebut ke dalam proyek Anda.</p>
<pre><code translate="no" class="language-javascript">npm install @zilliz/milvus2-sdk-node
# or ...
yarn add @zilliz/milvus2-sdk-node
<button class="copy-code-btn"></button></code></pre>
<p>Ini akan mengunduh SDK Milvus Node.js dan menambahkan entri dependensi ke berkas package.json Anda.</p>
<h2 id="Whats-next" class="common-anchor-header">Langkah Selanjutnya<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Setelah menginstal SDK Milvus Node.js, Anda dapat:</p>
<ul>
<li><p>Melihat <a href="https://github.com/milvus-io/milvus-sdk-node">panduan cepat SDK Milvus Node.js</a></p></li>
...
<li><a href="/docs/id/v2.6.x/insert-update-delete.md">Menyisipkan, Mengupdate, dan Menghapus</a></li>
...
<li><p>Jelajahi <a href="/api-reference/node/v2.6.x/About.md">referensi API Milvus Node.js</a></p></li>
</ul>
