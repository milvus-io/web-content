...
<li><p><a href="/docs/id/v2.6.x/prerequisite-helm.md#How-can-I-start-a-K8s-cluster-locally-for-test-purposes">Buat cluster K8s</a>.</p></li>
...
<button class="copy-code-btn"></button></code></pre>
<p>Perintah di atas men-deploy cluster Milvus dengan <strong>Woodpecker</strong> sebagai antrean pesan (disarankan untuk v2.6.16) dan semua komponen arsitektur baru termasuk Streaming Node.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Sekarang, Anda dapat menyambung ke Milvus menggunakan port yang diteruskan.</p>
...
<ul>
<li><p>Memeriksa <a href="/docs/id/v2.6.x/quickstart.md">Halo Milvus</a> untuk melihat apa yang dapat dilakukan Milvus.</p></li>
