...
<h2 id="Overview" class="common-anchor-header">Gambaran Umum<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Operator adalah solusi yang membantu Anda menerapkan dan mengelola tumpukan layanan Milvus lengkap untuk menargetkan kluster Kubernetes (K8s). Tumpukan tersebut mencakup semua komponen Milvus dan dependensi terkait seperti etcd, Pulsar, dan MinIO.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Perintah di atas mengimplementasikan kluster Milvus dengan <strong>Woodpecker</strong> sebagai antrian pesan (direkomendasikan untuk v2.6.23) dan semua komponen arsitektur baru, termasuk Streaming Node.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Milvus Operator membuat dependensi Milvus, seperti etcd, Pulsar, dan MinIO, kemudian komponen Milvus, seperti proxy, koordinator, dan node.</p>
...
<div class="alert note">
<ul>
<li>Saat Anda menghapus kluster Milvus menggunakan konfigurasi default, dependensi seperti etcd, Pulsar, dan MinIO tidak akan dihapus. Oleh karena itu, saat Anda menginstal instans kluster Milvus yang sama di lain waktu, dependensi ini akan digunakan kembali.</li>
...
<ul>
<li><p>Kunjungi <a href="/docs/id/v2.6.x/quickstart.md">Hello Milvus</a> untuk melihat apa saja yang dapat dilakukan Milvus.</p></li>
...
<li><a href="/docs/id/v2.6.x/insert-update-delete.md">Sisipkan, Perbarui, dan Hapus</a></li>
...
<li><p>Jelajahi <a href="/docs/id/v2.6.x/milvus-webui.md">Milvus WebUI</a>, antarmuka web intuitif untuk observabilitas dan pengelolaan Milvus.</p></li>
