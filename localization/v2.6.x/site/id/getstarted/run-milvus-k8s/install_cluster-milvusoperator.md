...
<h3 id="Install-with-Helm" class="common-anchor-header">Menginstal dengan Helm<button data-href="#Install-with-Helm" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Jalankan perintah berikut untuk menginstal Milvus Operator dengan Helm.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Install-with-kubectl" class="common-anchor-header">Instal dengan kubectl<button data-href="#Install-with-kubectl" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Jalankan perintah berikut untuk menginstal Milvus Operator dengan <code translate="no">kubectl</code>.</p>
