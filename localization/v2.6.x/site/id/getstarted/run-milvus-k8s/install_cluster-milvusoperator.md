...
<h2 id="Install-Milvus-Operator" class="common-anchor-header">Instal Milvus Operator<button data-href="#Install-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Operator mendefinisikan sumber daya khusus kluster Milvus di atas <a href="https://kubernetes.io/docs/concepts/extend-kubernetes/api-extension/custom-resources/">Sumber Daya Khusus Kubernetes</a>. Saat sumber daya khusus didefinisikan, Anda dapat menggunakan API K8s secara deklaratif dan mengelola tumpukan penyebaran Milvus untuk memastikan skalabilitas dan ketersediaan tinggi.</p>
<div class="filter">
 <a href="#helm">Helm</a>
...
<button class="copy-code-btn"></button></code></pre>
<p>Perintah di atas mengimplementasikan kluster Milvus dengan <strong>Woodpecker</strong> sebagai antrian pesan (direkomendasikan untuk v2.6.24) dan semua komponen arsitektur baru, termasuk Streaming Node.</p>
...
<p>Setelah kluster Milvus Anda siap, status semua pod di kluster Milvus seharusnya mirip dengan yang berikut ini.</p>
...
<li>Untuk menghapus dependensi dan persistent volume claims (PVC) bersama dengan kluster Milvus, lihat <a href="https://github.com/zilliztech/milvus-operator/blob/main/config/samples/milvus_deletion.yaml">berkas konfigurasi</a>.</li>
</ul>
</div>
...
<ul>
<li><p>Kunjungi <a href="/docs/id/v2.6.x/quickstart.md">Hello Milvus</a> untuk melihat apa saja yang bisa dilakukan Milvus.</p></li>
