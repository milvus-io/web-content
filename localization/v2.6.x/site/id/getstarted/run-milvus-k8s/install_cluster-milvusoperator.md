...
<button class="copy-code-btn"></button></code></pre>
<p>Perintah di atas men-deploy cluster Milvus dengan <strong>Woodpecker</strong> sebagai antrean pesan (disarankan untuk v2.6.17) dan semua komponen arsitektur baru termasuk Streaming Node.</p>
