...
related_key: Docker
summary: >-
  Pelajari cara menginstal Milvus versi mandiri menggunakan Docker Desktop untuk
  Windows.
...
<h1 id="Run-Milvus-in-Docker-Windows" class="common-anchor-header">Menjalankan Milvus di Docker (Windows)<button data-href="#Run-Milvus-in-Docker-Windows" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Halaman ini menunjukkan cara menjalankan Milvus di Windows menggunakan Docker Desktop untuk Windows.​</p>
...
<li><p>Embed etcd diinstal bersama Milvus dalam wadah yang sama dan berjalan di port <strong>2379</strong>. File konfigurasinya dipetakan ke <strong>embedEtcd.yaml</strong> di folder saat ini.​</p></li>
...
<p>Tergantung pada koneksi jaringan Anda, mengunduh gambar untuk instalasi Milvus mungkin membutuhkan waktu cukup lama. Setelah kontainer bernama <strong>milvus-standalone</strong>, <strong>milvus-minio</strong>, dan <strong>milvus-etcd</strong> aktif, Anda dapat melihat bahwa ​</p>
<ul>
...
<h3 id="How-can-I-deal-with-WSL-related-issues-while-deploying-Milvus​" class="common-anchor-header">Bagaimana cara mengatasi masalah terkait WSL saat menerapkan Milvus?​<button data-href="#How-can-I-deal-with-WSL-related-issues-while-deploying-Milvus​" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><p>Pilih dari distribusi WSL 2 yang telah terinstal mana yang ingin Anda aktifkan integrasi Docker-nya dengan membuka: <strong>Pengaturan</strong> &gt; <strong>Sumber Daya</strong> &gt; <strong>Integrasi WSL</strong>.</p>
<p><span class="img-wrapper">
