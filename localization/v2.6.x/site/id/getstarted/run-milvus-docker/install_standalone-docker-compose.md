...
<p>Selalu unduh konfigurasi Docker Compose terbaru untuk memastikan kompatibilitas dengan fitur v2.6.16.</p>
<ul>
...
<li><p>Tambahkan konfigurasi tambahan untuk mengganti konfigurasi default. Berikut ini mengasumsikan bahwa Anda perlu mengganti <code translate="no">proxy.healthCheckTimeout</code> default. Untuk item konfigurasi yang berlaku, lihat <a href="/docs/id/v2.6.x/system_configuration.md">Konfigurasi Sistem</a>.</p>
