...
<p><strong>Apa yang baru di v2.6.11:</strong></p>
<ul>
<li><strong>Streaming Node</strong>: Kemampuan pemrosesan data yang ditingkatkan</li>
<li><strong>Woodpecker MQ</strong>: Antrian pesan yang ditingkatkan dengan pengurangan overhead pemeliharaan, lihat <a href="/docs/id/use-woodpecker.md">Gunakan Woodpecker</a> untuk detailnya</li>
