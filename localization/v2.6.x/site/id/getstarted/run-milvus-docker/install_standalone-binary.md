...
<h1 id="Install-Milvus-Standalone-with-RPMDEB-Package" class="common-anchor-header">Menginstal Milvus Standalone dengan Paket RPM/DEB<button data-href="#Install-Milvus-Standalone-with-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Halaman ini menjelaskan cara menginstal Milvus standalone menggunakan paket RPM/DEB yang sudah siap pakai.</p>
...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Unduh Paket RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Anda dapat mengunduh paket RPM/DEB sesuai dengan arsitektur sistem Anda dari <a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.21">halaman Rilis Milvus</a>.</p>
<ul>
<li>Untuk x86_64/amd64, unduh paket <strong>milvus_2.6.21-1_amd64.deb</strong> atau <strong>milvus_2.6.21-1_amd64.rpm</strong>.</li>
<li>Untuk ARM64, unduh paket <strong>milvus_2.6.21-1_arm64.deb</strong> atau <strong>milvus_2.6.21-1_arm64.rpm</strong>.</li>
</ul>
...
dpkg -l | grep milvus
<button class="copy-code-btn"></button></code></pre>
<h2 id="Start-Milvus-Standalone" class="common-anchor-header">Menjalankan Milvus Standalone<button data-href="#Start-Milvus-Standalone" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
