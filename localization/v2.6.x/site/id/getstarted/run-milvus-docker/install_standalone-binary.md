...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Mengunduh Paket RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Anda dapat mengunduh paket RPM/DEB sesuai dengan arsitektur sistem Anda dari [Halaman Rilis Milvus](https://github.com/milvus-io/milvus/releases/tag/v{{ var.milvus_release_version }}).</p>
<ul>
<li>Untuk x86_64/amd64, unduh paket <strong>{{ var.milvus_deb_amd64 }}</strong> atau <strong>{{ var.milvus_rpm_amd64 }}</strong>.</li>
<li>Untuk ARM64, unduh paket <strong>{{ var.milvus_deb_arm64 }}</strong> atau <strong>{{ var.milvus_rpm_arm64 }}</strong>.</li>
</ul>
