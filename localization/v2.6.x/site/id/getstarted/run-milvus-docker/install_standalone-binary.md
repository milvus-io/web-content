...
summary: >-
  Pelajari cara menginstal Milvus secara mandiri dengan paket RPM/DEB yang telah
  dibuat sebelumnya.
...
<h1 id="Install-Milvus-Standalone-with-RPMDEB-Package" class="common-anchor-header">Menginstal Milvus Standalone dengan Paket RPM/DEB<button data-href="#Install-Milvus-Standalone-with-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Halaman ini mengilustrasikan cara menginstal Milvus mandiri dengan paket RPM/DEB yang telah dibuat sebelumnya.</p>
...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Mengunduh Paket RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Anda dapat mengunduh paket RPM/DEB sesuai dengan arsitektur sistem Anda dari <a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.7">halaman Rilis Milvus</a>.</p>
<ul>
<li>Untuk x86_64/amd64, unduh paket <strong>milvus_2.6.6-1_amd64.deb</strong> atau <strong>milvus_2.6.6-1_amd64.rpm</strong>.</li>
<li>Untuk ARM64, unduh paket <strong>milvus_2.6.6-1_arm64.deb</strong> atau <strong>milvus_2.6.6-1_arm64.rpm</strong>.</li>
</ul>
<p>Perintah berikut ini mengasumsikan bahwa Anda akan menjalankan Milvus Standalone pada mesin x86_64/amd64.</p>
<pre><code translate="no" class="language-shell">wget https://github.com/milvus-io/milvus/releases/download/v2.6.7/milvus_2.6.6-1_amd64.rpm -O milvus_2.6.6-1_amd64.rpm
<button class="copy-code-btn"></button></code></pre>
<h2 id="Install-the-RPMDEB-Package" class="common-anchor-header">Menginstal Paket RPM/DEB<button data-href="#Install-the-RPMDEB-Package" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Untuk menginstall paket RPM/DEB, Anda dapat menggunakan manajer paket pada sistem Anda.</p>
<p>Untuk sistem berbasis RPM (seperti CentOS, Fedora, dan RHEL), gunakan perintah <code translate="no">yum</code> untuk menginstal paket.</p>
...
<h2 id="Start-Milvus-Standalone" class="common-anchor-header">Memulai Milvus Standalone<button data-href="#Start-Milvus-Standalone" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Setelah instalasi selesai, Milvus terinstal sebagai sebuah layanan systemd dan dapat dijalankan dengan menggunakan perintah berikut:</p>
<pre><code translate="no" class="language-shell">systemctl start milvus
<button class="copy-code-btn"></button></code></pre>
<p>Anda dapat memeriksa status dari layanan Milvus dengan menggunakan perintah berikut:</p>
<pre><code translate="no" class="language-shell">systemctl status milvus
<button class="copy-code-btn"></button></code></pre>
<p>Jika Milvus berjalan dengan sukses, Anda akan melihat keluaran berikut ini:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Anda dapat menemukan biner Milvus pada <code translate="no">/usr/bin/milvus</code>, file layanan systemd pada <code translate="no">/lib/systemd/system/milvus.service</code>, dan ketergantungan pada <code translate="no">/usr/lib/milvus/</code>.</p>
<h2 id="Optional-Update-Milvus-configurations" class="common-anchor-header">(Opsional) Memperbarui konfigurasi Milvus<button data-href="#Optional-Update-Milvus-configurations" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Anda dapat memodifikasi konfigurasi Milvus pada berkas <code translate="no">/etc/milvus/configs/milvus.yaml</code>. Sebagai contoh, untuk mengubah <code translate="no">proxy.healthCheckTimeout</code> ke <code translate="no">1000</code> ms, Anda dapat mencari parameter target dan memodifikasinya. Untuk item konfigurasi yang berlaku, lihat <a href="/docs/id/system_configuration.md">Konfigurasi Sistem</a>.</p>
<h2 id="Stop-Milvus-Standalone" class="common-anchor-header">Menghentikan Milvus Standalone<button data-href="#Stop-Milvus-Standalone" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Uninstall-Milvus-Standalone" class="common-anchor-header">Copot pemasangan Milvus Standalone<button data-href="#Uninstall-Milvus-Standalone" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
