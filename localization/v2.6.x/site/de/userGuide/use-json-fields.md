...
<h3 id="Basic-Operators-in-JSON-Fields" class="common-anchor-header">Grundlegende Operatoren in JSON-Feldern<button data-href="#Basic-Operators-in-JSON-Fields" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Die folgende Tabelle geht davon aus, dass der Wert eines JSON-Feldes namens <code translate="no">json_key</code> einen Schlüssel namens <code translate="no">A</code> hat. Verwenden Sie sie als Referenz, wenn Sie boolesche Ausdrücke mit JSON-Feldschlüsseln konstruieren.</p>
<table>
<thead>
...
<h3 id="Advanced-Operators" class="common-anchor-header">Erweiterte Operatoren<button data-href="#Advanced-Operators" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Die folgenden Operatoren sind spezifisch für JSON-Felder:</p>
<ul>
