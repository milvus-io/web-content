...
<p>Bei einer erfolgreichen Antwort sollten die Dokumente nach Relevanzbewertungen geordnet zurückgegeben werden, ähnlich wie bei der OpenAI rerank API-Antwort.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="vLLM-ranker-specific-parameters" class="common-anchor-header">vLLM-Ranker-spezifische Parameter</h3><p>Die folgenden Parameter sind spezifisch für den vLLM Ranker:</p>
<table>
   <tr>
     <th><p>Parameter</p></th>
   ...
   <tr>
     ...
     <td><p>Keine</p></td>
     <td><p>Wenn dieser Parameter auf eine ganze Zahl <em>k</em> gesetzt ist, werden nur die letzten <em>k</em> Zeichen der Eingabeaufforderung verwendet (d. h. Abschneiden nach links). Der Standardwert ist None (d.h. keine Trunkierung).</p></td>
...
<h2 id="Apply-to-hybrid-search" class="common-anchor-header">Auf hybride Suche anwenden<button data-href="#Apply-to-hybrid-search" class="anchor-icon" translate="no">
    ...
    </button></h2><p>vLLM Ranker kann auch mit hybrider Suche verwendet werden, um dichte und spärliche Suchmethoden zu kombinieren:</p>
