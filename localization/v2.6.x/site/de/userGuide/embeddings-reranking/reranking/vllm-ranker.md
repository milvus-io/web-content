...
<table>
   ...
   <tr>
     ...
     <td><p>Nein</p></td>
     <td><p>Wenn diese Option auf eine ganze Zahl <em>k</em> gesetzt ist, werden nur die letzten <em>k</em> Zeichen der Eingabeaufforderung verwendet (d. h. linke Trunkierung). Der Standardwert ist None (d.h. keine Trunkierung).</p></td>
