...
<h2 id="Build-a-time-aware-search-system" class="common-anchor-header">Aufbau eines zeitabhängigen Suchsystems<button data-href="#Build-a-time-aware-search-system" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Wir werden ein Suchsystem für Nachrichtenartikel erstellen, das zeigt, wie man Inhalte sowohl nach Relevanz als auch nach Zeit effektiv einordnen kann. Beginnen wir mit der Implementierung:</p>
