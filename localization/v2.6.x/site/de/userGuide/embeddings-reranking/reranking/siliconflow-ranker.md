...
<ul>
<li><p>Hochentwickeltes Dokumenten-Chunking mit konfigurierbarer Überlappung zur Bearbeitung langer Dokumente</p></li>
...
<table>
   ...
   <tr>
     ...
     <td><p>Ja</p></td>
     <td><p>Das SiliconFlow-Reranking-Modell, das aus den von der SiliconFlow-Plattform unterstützten Modellen verwendet werden soll.</p><p>Eine Liste der verfügbaren Reranking-Modelle finden Sie in der <a href="https://docs.siliconflow.cn/en/api-reference/rerank/create-rerank">SiliconFlow-Dokumentation</a>.</p></td>
