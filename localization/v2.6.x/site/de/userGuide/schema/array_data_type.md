...
title: Array-Feld
summary: >-
  Ein ARRAY-Feld speichert eine geordnete Menge von Elementen desselben
  Datentyps. Hier ist ein Beispiel dafür, wie ARRAY-Felder Daten speichern:
---
<h1 id="Array-Field" class="common-anchor-header">Array-Feld<button data-href="#Array-Field" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Ein ARRAY-Feld speichert eine geordnete Menge von Elementen desselben Datentyps. Hier ist ein Beispiel dafür, wie ARRAY-Felder Daten speichern:</p>
...
<li><p><strong>Standardwerte</strong>: ARRAY-Felder unterstützen keine Standardwerte. Sie können jedoch das Attribut „ <code translate="no">nullable</code> “ auf „ <code translate="no">True</code> “ setzen, um Nullwerte zuzulassen. Weitere Informationen finden Sie unter <a href="/docs/de/v2.6.x/nullable-and-default.md">„Nullable &amp; Default</a>“.</p></li>
...
<p>Im folgenden Beispiel werden Indizes für das Vektorfeld „ <code translate="no">embedding</code> “ und das ARRAY-Feld „ <code translate="no">tags</code> “ erstellt, beide unter Verwendung des Indextyps „ <code translate="no">AUTOINDEX</code> “. Bei diesem Typ wählt Milvus automatisch den am besten geeigneten Index basierend auf dem Datentyp aus. Sie können den Indextyp und die Parameter auch für jedes Feld individuell anpassen. Weitere Informationen finden Sie unter <a href="/docs/de/v2.6.x/index-explained.md">„Index erklärt</a>“.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
...
<button class="copy-code-btn"></button></code></pre>
<p>Darüber hinaus unterstützt Milvus erweiterte Array-Filteroperatoren wie „ <code translate="no">ARRAY_CONTAINS</code> “, „ <code translate="no">ARRAY_CONTAINS_ALL</code> “, „ <code translate="no">ARRAY_CONTAINS_ANY</code> “ und „ <code translate="no">ARRAY_LENGTH</code> “, um die Abfragefunktionen weiter zu verbessern. Weitere Informationen finden Sie unter <a href="/docs/de/v2.6.x/array-operators.md">„ARRAY-Operatoren</a>“.</p>
