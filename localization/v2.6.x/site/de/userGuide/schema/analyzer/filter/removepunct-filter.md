...
<h1 id="Remove-Punct" class="common-anchor-header">Satzzeichen entfernen<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.5.11+</span><button data-href="#Remove-Punct" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Der Filter <code translate="no">removepunct</code> entfernt Interpunktionszeichen, Leerzeichen und Zeilenumbrüche, die einige Tokenizer - wie <code translate="no">jieba</code>, <code translate="no">lindera</code> und <code translate="no">icu</code>- normalerweise beibehalten. Verwenden Sie ihn, wenn Sie einen sauberen Token-Stream wünschen, der nur sinnvolle Text-Token enthält, frei von Kommas, Punkten und anderen Satzzeichen.</p>
