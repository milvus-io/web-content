...
<p>Weitere Informationen finden Sie im <a href="https://github.com/fxsjy/jieba">Jieba GitHub Projekt</a>.</p></li>
   ...
   <tr>
     ...
     <td><p>Ein boolesches Flag, das angibt, ob das Hidden Markov Model (HMM) für die probabilistische Segmentierung von Wörtern, die nicht im Wörterbuch gefunden werden, aktiviert werden soll.</p></td>
