...
<h2 id="How-it-works" class="common-anchor-header">Wie es funktioniert<button data-href="#How-it-works" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Wenn das dynamische Feld aktiviert ist, fügt Milvus ein verstecktes <code translate="no">$meta</code> Feld zu jeder Entität hinzu. Beim Einfügen von Daten wird jedes Feld, das nicht im Schema deklariert ist, automatisch als Schlüssel-Wert-Paar in diesem dynamischen Feld gespeichert.</p>
...
<h2 id="Insert-entities-to-the-collection" class="common-anchor-header">Einfügen von Entitäten in die Sammlung<button data-href="#Insert-entities-to-the-collection" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Mit dem dynamischen Feld können Sie zusätzliche Felder einfügen, die nicht im Schema definiert sind. Diese Felder werden automatisch in <code translate="no">$meta</code> gespeichert.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<h3 id="Index-non-JSON-keys-in-the-dynamic-field" class="common-anchor-header">Indizieren von Nicht-JSON-Schlüsseln im dynamischen Feld</h3><p>Sie können jeden Nicht-JSON-Schlüssel (z. B. <code translate="no">overview</code>, <code translate="no">words</code>) indizieren, indem Sie seinen Schlüsselnamen direkt in <code translate="no">json_path</code> referenzieren:</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<pre><code translate="no" class="language-bash"><span class="hljs-comment"># restful</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Index-JSON-keys-in-the-dynamic-field" class="common-anchor-header">JSON-Schlüssel im dynamischen Feld indizieren</h3><p>Wenn ein Schlüssel im dynamischen Feld (<code translate="no">$meta</code>) ein JSON-Objekt speichert, können Sie seine internen Schlüssel mit der Klammerschreibweise in <code translate="no">json_path</code> indizieren.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
