...
<ul>
<li><p><a href="/docs/de/v2.6.x/use-partition-key.md#Set-Partition-Key">Legen Sie den Partitionsschlüssel fest</a>,</p></li>
<li><p><a href="/docs/de/v2.6.x/use-partition-key.md#Set-Partition-Numbers">die Anzahl der zu erstellenden Partitionen festlegen</a> (optional), und</p></li>
<li><p><a href="/docs/de/v2.6.x/use-partition-key.md#Create-Filtering-Condition">eine Filterbedingung auf der Grundlage des Partitionsschlüssels erstellen</a>.</p></li>
</ul>
