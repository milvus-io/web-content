...
<h2 id="Overview" class="common-anchor-header">Übersicht<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Eine Sammlung kann verschiedene Arten von skalaren Feldern speichern. Sie können Milvus Entitäten basierend auf einem oder mehreren skalaren Feldern filtern lassen. Milvus bietet drei Arten von Abfragen: Query, Get und QueryIterator. Die folgende Tabelle vergleicht diese drei Abfragetypen.</p>
<table>
   <tr>
     <th></th>
     <th><p>Abfrage</p></th>
   ...
   <tr>
     ...
     <td><p>Durch filternde Ausdrücke.</p></td>
   </tr>
   <tr>
