...
summary: >-
  ...
  den Cache vor, bevor ein Segment abfragbar wird, um sicherzustellen, dass
...
<table>
   ...
   <tr>
     ...
     <td><p>Verwenden Sie diesen Modus für leistungskritische Daten, die sofort verfügbar sein müssen, wie z. B. skalare Indizes mit hoher Frequenz oder Schlüsselvektorindizes, die bei der Suche verwendet werden.</p></td>
   </tr>
   <tr>
