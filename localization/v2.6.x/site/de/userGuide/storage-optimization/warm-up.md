...
summary: >-
  ...
  wird. Einmal konfiguriert, lädt Warm Up ausgewählte Feldtypen oder Indizes in
  den Cache vor, bevor ein Segment abfragbar wird, und stellt so sicher, dass
  Daten, auf die häufig zugegriffen wird, sofort nach dem Laden verfügbar sind.
beta: Milvus 2.6.4+
---
...
<table>
   ...
   <tr>
     ...
     <td><p>Verwenden Sie diesen Modus für leistungskritische Daten, die sofort verfügbar sein müssen, z. B. skalare Indizes mit hoher Frequenz oder Schlüsselvektorindizes, die bei der Suche verwendet werden.</p></td>
   </tr>
   <tr>
...
<li><p>Überwachen Sie die Abfragelatenz und die Cachemetriken und erweitern Sie das Preloading dann nach Bedarf.</p></li>
