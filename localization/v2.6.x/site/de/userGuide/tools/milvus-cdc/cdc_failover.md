...
<p>Wenn der Primärserver noch erreichbar ist, verwenden Sie stattdessen <a href="/docs/de/v2.6.x/cdc_switchover.md">Switchover</a>. Switchover vermeidet Datenverluste.</p>
...
<li>Entfernen Sie <code translate="no">cluster-a</code> von Schreibendpunkten, Lastverteilern, DNS-Einträgen und Automatisierungen.</li>
