...
<h2 id="Delete-Entities-by-Filtering-Conditions" class="common-anchor-header">Entitäten durch Filterbedingungen löschen<button data-href="#Delete-Entities-by-Filtering-Conditions" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Wenn Sie mehrere Entitäten, die einige Attribute gemeinsam haben, in einem Stapel löschen, können Sie Filterausdrücke verwenden. Der Beispielcode unten verwendet den <strong>in-Operator</strong>, um alle Entitäten zu löschen, deren <strong>Farbfeld</strong> auf die Werte <strong>Rot</strong> und <strong>Violett</strong> gesetzt ist. Sie können auch andere Operatoren verwenden, um Filterausdrücke zu konstruieren, die Ihren Anforderungen entsprechen. Weitere Informationen zu Filterausdrücken finden Sie unter <a href="/docs/de/boolean.md">Filtering Explained</a>.</p>
