...
<h3 id="Advanced-Data-Types" class="common-anchor-header">Erweiterte Datentypen<button data-href="#Advanced-Data-Types" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Zusätzlich zu den primitiven Datentypen unterstützt Milvus verschiedene fortgeschrittene Datentypen und ihre jeweils anwendbaren Distanzmetriken.</p>
<ul>
