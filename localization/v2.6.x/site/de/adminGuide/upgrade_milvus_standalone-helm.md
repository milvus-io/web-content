...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Upgrade von Milvus Standalone mit Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Diese Anleitung beschreibt, wie Sie Ihr Milvus Standalone-Einsatz von v2.5.x auf v2.6.10 mit Helm Chart aktualisieren.</p>
<h2 id="Before-you-start" class="common-anchor-header">Bevor Sie beginnen<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Das Upgrade von Milvus 2.5.x auf 2.6.10 bringt erhebliche Änderungen in der Architektur mit sich:</p>
<ul>
...
<li>Vor dem Upgrade auf v2.6.10 <strong>müssen</strong> Sie auf v2.5.16 oder höher aktualisieren.</li>
</ul>
<p><strong>Einschränkungen bei der Nachrichtenwarteschlange</strong>: Wenn Sie auf Milvus v2.6.9 aktualisieren, müssen Sie Ihre aktuelle Auswahl an Nachrichtenwarteschlangen beibehalten. Ein Wechsel zwischen verschiedenen Message-Queue-Systemen während des Upgrades wird nicht unterstützt. Unterstützung für den Wechsel von Nachrichtenwarteschlangensystemen wird in zukünftigen Versionen verfügbar sein.</p>
...
<h3 id="Step-3-Upgrade-to-v2610" class="common-anchor-header">Schritt 3: Upgrade auf v2.6.10<button data-href="#Step-3-Upgrade-to-v2610" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Sobald v2.5.16 erfolgreich läuft, aktualisieren Sie auf v2.6.10:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
