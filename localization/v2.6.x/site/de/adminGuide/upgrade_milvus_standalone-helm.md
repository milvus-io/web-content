...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Milvus Standalone mit Helm Chart aktualisieren<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>In dieser Anleitung wird beschrieben, wie Sie Ihre Milvus-Standalone-Bereitstellung mithilfe eines Helm-Charts von Version 2.5.x auf Version 2.6.22 aktualisieren können.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v2622" class="common-anchor-header">Schritt 3: Upgrade auf v2.6.22<button data-href="#Step-3-Upgrade-to-v2622" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sobald Version 2.5.16 erfolgreich läuft, führen Sie ein Upgrade auf Version 2.6.22 durch:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
