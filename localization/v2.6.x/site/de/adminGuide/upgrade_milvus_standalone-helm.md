...
---
<div class="tab-wrapper"><a href="/docs/de/v2.6.x/upgrade_milvus_standalone-operator.md" class=''>Milvus</a><a href="/docs/de/v2.6.x/upgrade_milvus_standalone-helm.md" class='active '>OperatorHelmDocker</a><a href="/docs/de/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>Zusammenstellen</a></div>
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Upgrade von Milvus Standalone mit Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Diese Anleitung beschreibt, wie Sie Ihr Milvus Standalone mit Milvus Helm Charts aktualisieren können.</p>
<div class="alert note">
<p>Das Upgrade von Milvus 2.5.x (oder früheren Versionen) auf 2.6.0-rc1 beinhaltet signifikante architektonische Änderungen, die dieses Upgrade <strong>unumkehrbar</strong> machen. Aufgrund der Einführung neuer Komponenten (wie Woodpecker und Streaming Node) und der Entfernung bestimmter Komponenten <strong>können Sie nicht zu einer früheren Version zurückkehren, sobald das Upgrade abgeschlossen ist</strong>. Einzelheiten zu den mit 2.6.0-rc1 eingeführten architektonischen Änderungen finden Sie in der <a href="/docs/de/v2.6.x/architecture_overview.md">Milvus-Architekturübersicht</a>.</p>
</div>
...
<div style="display: none;">- [Führen Sie ein rollendes Upgrade durch](#conduct-a-rolling-upgrade) von Milvus v2.2.3 und späteren Versionen auf v2.6.0-rc1.</div>
<ul>
<li><p><a href="#Upgrade-Milvus-using-Helm">Führen Sie ein Upgrade von Milvus mit Helm</a> für ein Upgrade von einer Nebenversion vor v2.2.3 auf v2.6.0-rc1<a href="#Upgrade-Milvus-using-Helm">durch</a>.</p></li>
<li><p><a href="#Migrate-the-metadata">Migrieren Sie die Metadaten</a> vor dem Upgrade von Milvus v2.1.x auf v2.6.0-rc1.</p></li>
</ul>
...
<p>Sobald Sie sichergestellt haben, dass sich alle Einsätze in Ihrer Milvus-Instanz in ihrem normalen Status befinden, können Sie den folgenden Befehl ausführen. Sie können den folgenden Befehl ausführen, um die Milvus-Instanz auf 2.6.0-rc1 zu aktualisieren.</p>
...
<h4 id="2-Upgrade-Milvus-from-v21x-to-260-rc1" class="common-anchor-header">2. Upgrade von Milvus von v2.1.x auf 2.6.0-rc1</h4><p>Die folgenden Befehle gehen davon aus, dass Sie Milvus von v2.1.4 auf 2.6.0-rc1 aktualisieren. Ändern Sie sie auf die Versionen, die Ihren Anforderungen entsprechen.</p>
<ol>
