...
<p>Normalerweise können Sie <a href="#Upgrade-Milvus-by-changing-its-image">Milvus durch Ändern des Images aktualisieren</a>. Vor einem Upgrade von v2.1.x auf v2.6.22 müssen Sie jedoch <a href="#Migrate-the-metadata">die Metadaten migrieren</a>.</p>
