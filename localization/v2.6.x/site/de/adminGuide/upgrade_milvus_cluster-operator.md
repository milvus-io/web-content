...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Milvus-Cluster mit Milvus Operator aktualisieren<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>In dieser Anleitung wird beschrieben, wie Sie Ihren Milvus-Cluster mithilfe von Milvus Operator von Version 2.5.x auf Version 2.6.22 aktualisieren.</p>
<h2 id="Before-you-start" class="common-anchor-header">Bevor Sie beginnen<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v2622" class="common-anchor-header">Neuerungen in Version 2.6.22<button data-href="#Whats-new-in-v2622" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Das Upgrade von Milvus 2.5.x auf 2.6.22 bringt erhebliche architektonische Änderungen mit sich:</p>
<ul>
...
<ul>
<li>Milvus v2.6.0-rc1 ist <strong>nicht</strong> mit v2.6.22 <strong>kompatibel</strong>. Direkte Upgrades von Release-Kandidaten werden nicht unterstützt.</li>
...
<li>Sie <strong>müssen</strong> vor dem Upgrade auf v2.6.22 ein Upgrade auf v2.5.16 oder höher durchführen, wobei „ <code translate="no">mixCoord</code> “ aktiviert sein muss.</li>
</ul>
<p><strong>Einschränkungen bei der Nachrichtenwarteschlange</strong>: Beim Upgrade auf Milvus v2.6.22 müssen Sie Ihre aktuelle Auswahl der Nachrichtenwarteschlange beibehalten. Ein Wechsel zwischen verschiedenen Nachrichtenwarteschlangensystemen während des Upgrades wird nicht unterstützt. Die Unterstützung für den Wechsel des Nachrichtenwarteschlangensystems wird in zukünftigen Versionen verfügbar sein.</p>
...
<h3 id="Step-2-Upgrade-your-Milvus-cluster" class="common-anchor-header">Schritt 2: Aktualisieren Sie Ihren Milvus-Cluster<button data-href="#Step-2-Upgrade-your-Milvus-cluster" class="anchor-icon" translate="no">
    ...
    </button></h3><h4 id="21-Check-current-coordinator-configuration" class="common-anchor-header">2.1 Überprüfen Sie die aktuelle Koordinator-Konfiguration</h4><p>Überprüfen Sie, ob Ihr Cluster bereits „ <code translate="no">mixCoord</code> “ verwendet:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2622" class="common-anchor-header">2.3 Upgrade auf Version 2.6.22</h4><p>Sobald Version 2.5.16 erfolgreich mit „ <code translate="no">mixCoord</code> “ läuft, führen Sie ein Upgrade auf Version 2.6.22 durch:</p>
