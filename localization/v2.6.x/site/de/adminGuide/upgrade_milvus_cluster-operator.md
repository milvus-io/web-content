...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Upgrade des Milvus-Clusters mit Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Diese Anleitung beschreibt, wie Sie Ihren Milvus-Cluster mit Milvus Operator von v2.5.x auf v2.6.15 aktualisieren.</p>
<h2 id="Before-you-start" class="common-anchor-header">Bevor Sie beginnen<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Das Upgrade von Milvus 2.5.x auf 2.6.15 bringt erhebliche Änderungen der Architektur mit sich:</p>
<ul>
...
<li>Vor dem Upgrade auf v2.6.15 <strong>müssen</strong> Sie ein Upgrade auf v2.5.16 oder höher mit aktiviertem <code translate="no">mixCoord</code> durchführen.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2615" class="common-anchor-header">2.3 Upgrade auf v2.6.15</h4><p>Sobald v2.5.16 erfolgreich mit <code translate="no">mixCoord</code> läuft, führen Sie ein Upgrade auf v2.6.15 durch:</p>
