...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Upgrade des Milvus-Clusters mit Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Diese Anleitung beschreibt, wie Sie Ihren Milvus-Cluster mit Milvus Operator von v2.5.x auf v2.6.2 aktualisieren.</p>
...
<li>Vor dem Upgrade auf v2.6.2 <strong>müssen</strong> Sie auf v2.5.16 oder höher aktualisieren und <code translate="no">mixCoord</code> aktivieren.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v262" class="common-anchor-header">2.3 Upgrade auf v2.6.2</h4><p>Sobald v2.5.16 erfolgreich mit <code translate="no">mixCoord</code> läuft, führen Sie ein Upgrade auf v2.6.2 durch:</p>
