...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Milvus-Cluster mit Helm-Chart aktualisieren<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>In dieser Anleitung wird beschrieben, wie Sie Ihren Milvus-Cluster mithilfe eines Helm-Charts von Version 2.5.x auf Version 2.6.24 aktualisieren.</p>
...
<p>Dieser Upgrade-Prozess gewährleistet eine ordnungsgemäße Migration zur neuen Architektur. Weitere Informationen zu den Änderungen an der Architektur finden Sie in <a href="/docs/de/v2.6.x/architecture_overview.md">der Milvus-Architekturübersicht</a>.</p>
...
<li>Sie <strong>müssen</strong> zunächst auf Version 2.5.16 oder höher aktualisieren und dabei „ <code translate="no">mixCoordinator</code> “ aktivieren, bevor Sie auf Version 2.6.24 aktualisieren können.</li>
</ul>
...
<p>So überprüfen Sie die Kompatibilität der Helm-Chart-Version mit Milvus-Versionen:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v2624" class="common-anchor-header">Schritt 3: Aktualisieren Sie auf Version 2.6.24<button data-href="#Step-3-Upgrade-to-v2624" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sobald v2.5.16 erfolgreich mit <code translate="no">mixCoordinator</code> läuft, führen Sie ein Upgrade auf v2.6.24 durch:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
