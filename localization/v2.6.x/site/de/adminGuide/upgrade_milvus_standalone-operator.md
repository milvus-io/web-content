...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Upgrade von Milvus Standalone mit Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Dieser Leitfaden beschreibt, wie Sie Ihre Milvus Standalone-Installation mit Milvus Operator von v2.5.x auf v2.6.17 aktualisieren.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2617" class="common-anchor-header">2.2 Upgrade auf v2.6.17</h4><p>Sobald v2.5.16 erfolgreich läuft, aktualisieren Sie auf v2.6.17:</p>
