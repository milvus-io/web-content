...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Upgrade von Milvus Standalone mit Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Diese Anleitung beschreibt, wie Sie Ihr Milvus Standalone Deployment von v2.5.x auf v2.6.0 mit Milvus Operator aktualisieren.</p>
...
<li>Vor dem Upgrade auf v2.6.0 <strong>müssen</strong> Sie auf v2.5.16 oder höher aktualisieren.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Upgrade-your-Milvus-standalone" class="common-anchor-header">Schritt 2: Upgrade Ihres Milvus Standalone</h3><h4 id="21-Upgrade-to-v2516" class="common-anchor-header">2.1 Upgrade auf v2.5.16</h4><div class="alert-note">
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v260" class="common-anchor-header">2.2 Upgrade auf v2.6.0</h4><p>Sobald v2.5.16 erfolgreich läuft, aktualisieren Sie auf v2.6.0:</p>
