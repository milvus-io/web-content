...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Upgrade von Milvus Standalone mit Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Dieser Leitfaden beschreibt, wie Sie Ihre Milvus Standalone-Installation mit Milvus Operator von v2.5.x auf v2.6.13 aktualisieren.</p>
<h2 id="Before-you-start" class="common-anchor-header">Bevor Sie beginnen<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Das Upgrade von Milvus 2.5.x auf 2.6.13 bringt erhebliche Änderungen in der Architektur mit sich:</p>
<ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2613" class="common-anchor-header">2.2 Upgrade auf v2.6.13</h4><p>Sobald v2.5.16 erfolgreich läuft, aktualisieren Sie auf v2.6.13:</p>
