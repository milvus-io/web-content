...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Aktualisierung von Milvus Standalone mit Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>In dieser Anleitung wird beschrieben, wie Sie Ihre Milvus-Standalone-Bereitstellung mithilfe von Milvus Operator von Version 2.5.x auf Version 2.6.21 aktualisieren können.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2621" class="common-anchor-header">2.2 Upgrade auf Version 2.6.21</h4><p>Sobald Version 2.5.16 erfolgreich läuft, führen Sie ein Upgrade auf Version 2.6.21 durch:</p>
