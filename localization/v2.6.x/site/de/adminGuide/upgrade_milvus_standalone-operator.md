...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Aktualisierung von Milvus Standalone mit Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>In dieser Anleitung wird beschrieben, wie Sie Ihre Milvus-Standalone-Bereitstellung mithilfe von Milvus Operator von Version 2.5.x auf Version 2.6.17 aktualisieren.</p>
...
<li>Wenn Sie derzeit v2.6.0-rc1 verwenden und Ihre Daten behalten möchten, lesen Sie bitte <a href="https://github.com/milvus-io/milvus/issues/43538#issuecomment-3112808997">diese Community-Anleitung</a> zur Unterstützung bei der Migration.</li>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2617" class="common-anchor-header">2.2 Upgrade auf Version 2.6.17</h4><p>Sobald Version 2.5.16 erfolgreich läuft, führen Sie ein Upgrade auf Version 2.6.17 durch:</p>
