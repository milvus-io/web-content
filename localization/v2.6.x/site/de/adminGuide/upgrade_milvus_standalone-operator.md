...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Upgrade von Milvus Standalone mit Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Diese Anleitung beschreibt, wie Sie Ihr Milvus Standalone Deployment von v2.5.x auf v2.6.3 mit Milvus Operator aktualisieren.</p>
<h2 id="Before-you-start" class="common-anchor-header">Bevor Sie beginnen<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Das Upgrade von Milvus 2.5.x auf 2.6.3 bringt erhebliche Änderungen in der Architektur mit sich:</p>
<ul>
...
<ul>
<li>Milvus v2.6.0-rc1 ist <strong>nicht kompatibel</strong> mit v2.6.3. Direkte Upgrades von Release Candidates werden nicht unterstützt.</li>
...
<li>Vor dem Upgrade auf v2.6.3 <strong>müssen</strong> Sie auf v2.5.16 oder höher aktualisieren.</li>
</ul>
<p><strong>Einschränkungen bei der Nachrichtenwarteschlange</strong>: Wenn Sie auf Milvus v2.6.3 aktualisieren, müssen Sie Ihre aktuelle Auswahl an Nachrichtenwarteschlangen beibehalten. Ein Wechsel zwischen verschiedenen Message-Queue-Systemen während des Upgrades wird nicht unterstützt. Unterstützung für den Wechsel von Message Queue Systemen wird in zukünftigen Versionen verfügbar sein.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v263" class="common-anchor-header">2.2 Upgrade auf v2.6.3</h4><p>Sobald v2.5.16 erfolgreich läuft, aktualisieren Sie auf v2.6.3:</p>
