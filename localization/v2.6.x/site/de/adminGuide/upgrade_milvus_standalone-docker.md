...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Upgrade von Milvus Standalone mit Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Diese Anleitung beschreibt, wie Sie Ihr Milvus Standalone Deployment von v2.5.x auf v2.6.0 mit Docker Compose aktualisieren.</p>
<h2 id="Before-you-start" class="common-anchor-header">Bevor Sie beginnen<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v260" class="common-anchor-header">Was ist neu in v2.6.0<button data-href="#Whats-new-in-v260" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Das Upgrade von Milvus 2.5.x auf 2.6.0 bringt erhebliche Änderungen in der Architektur mit sich:</p>
<ul>
...
<ul>
<li>Milvus v2.6.0-rc1 ist <strong>nicht kompatibel</strong> mit v2.6.0. Direkte Upgrades von Release Candidates werden nicht unterstützt.</li>
...
<li>Sie <strong>müssen</strong> auf v2.5.16 oder höher aktualisieren, bevor Sie auf v2.6.0 aktualisieren können.</li>
</ul>
<div class="alter note">
<p>Aufgrund von Sicherheitsbedenken aktualisiert Milvus seine MinIO mit der Veröffentlichung von v2.6.0 auf RELEASE.2024-12-18T13-15-44Z. Vor einem Upgrade von früheren Milvus Standalone-Releases, die mit Docker Compose installiert wurden, sollten Sie eine Single-Node Single-Drive MinIO-Bereitstellung erstellen und die vorhandenen MinIO-Einstellungen und -Inhalte in die neue Bereitstellung migrieren. Einzelheiten finden Sie in <a href="https://min.io/docs/minio/linux/operations/install-deploy-manage/migrate-fs-gateway.html#id2">diesem Leitfaden</a>.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v260" class="common-anchor-header">Schritt 2: Upgrade auf v2.6.0<button data-href="#Step-2-Upgrade-to-v260" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sobald v2.5.16 erfolgreich läuft, aktualisieren Sie auf v2.6.0:</p>
<ol>
