...
---
<h1 id="Build-RAG-with-Milvus-and-SiliconFlow" class="common-anchor-header">RAG mit Milvus und SiliconFlow aufbauen<button data-href="#Build-RAG-with-Milvus-and-SiliconFlow" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Prepare-the-Embedding-Model" class="common-anchor-header">Vorbereiten des Einbettungsmodells<button data-href="#Prepare-the-Embedding-Model" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Wir initialisieren einen Client, um das Einbettungsmodell vorzubereiten. SiliconFlow ermöglicht die API im OpenAI-Stil, und Sie können dieselbe API mit geringfügigen Anpassungen verwenden, um das Einbettungsmodell und den LLM aufzurufen.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Definieren Sie eine Funktion zur Erzeugung von Texteinbettungen mithilfe des Clients. Wir verwenden das Modell <code translate="no">BAAI/bge-large-en-v1.5</code> als Beispiel.</p>
...
&quot;&quot;&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>Verwenden Sie das von SiliconCloud bereitgestellte <code translate="no">deepseek-ai/DeepSeek-V2.5</code> Modell, um eine Antwort auf der Grundlage der Prompts zu generieren.</p>
...
<p>Großartig! Wir haben erfolgreich eine RAG-Pipeline mit Milvus und SiliconFlow erstellt.</p>
