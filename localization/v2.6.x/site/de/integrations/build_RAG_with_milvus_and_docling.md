...
<h3 id="Setting-Up-API-Keys" class="common-anchor-header">Einrichten von API-Schlüsseln<button data-href="#Setting-Up-API-Keys" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
