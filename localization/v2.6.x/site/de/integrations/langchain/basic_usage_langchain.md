...
<h2 id="Setup" class="common-anchor-header">Einrichtung von<button data-href="#Setup" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Compartmentalize-the-data-with-Milvus-Collections" class="common-anchor-header">Kompartimentierung der Daten mit Milvus Collections<button data-href="#Compartmentalize-the-data-with-Milvus-Collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sie können verschiedene, nicht zusammenhängende Dokumente in verschiedenen Sammlungen innerhalb derselben Milvus-Instanz speichern, um den Kontext zu erhalten</p>
...
<h3 id="Add-items-to-vector-store" class="common-anchor-header">Elemente zum Vektorspeicher hinzufügen<button data-href="#Add-items-to-vector-store" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Mit der Funktion <code translate="no">add_documents</code> können wir Elemente zu unserem Vektorspeicher hinzufügen.</p>
...
<h3 id="Delete-items-from-vector-store" class="common-anchor-header">Elemente aus dem Vektorspeicher löschen<button data-href="#Delete-items-from-vector-store" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Query-directly" class="common-anchor-header">Direkt abfragen<button data-href="#Query-directly" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><h4 id="Similarity-search" class="common-anchor-header">Ähnlichkeitssuche</h4><p>Eine einfache Ähnlichkeitssuche mit Filterung nach Metadaten kann wie folgt durchgeführt werden:</p>
...
<h3 id="Query-by-turning-into-retriever" class="common-anchor-header">Abfrage durch Umwandlung in Retriever<button data-href="#Query-by-turning-into-retriever" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Sie können den Vektorspeicher auch in einen Retriever umwandeln, um ihn einfacher in Ihren Ketten zu verwenden.</p>
...
<h3 id="Per-User-Retrieval" class="common-anchor-header">Pro-Benutzer-Abruf<button data-href="#Per-User-Retrieval" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="API-reference" class="common-anchor-header">API-Referenz<button data-href="#API-reference" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Eine ausführliche Dokumentation finden Sie in der API-Referenz: https://reference.langchain.com/python/integrations/langchain_milvus/</p>
