...
<h3 id="Prepare-the-LLM-and-Embedding-Model" class="common-anchor-header">Vorbereiten des LLM und des Einbettungsmodells<button data-href="#Prepare-the-LLM-and-Embedding-Model" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Ollama unterstützt mehrere Modelle sowohl für LLM-basierte Aufgaben als auch für die Erzeugung von Einbettungen, was die Entwicklung von RAG-Anwendungen (Retrieval-Augmented Generation) erleichtert. Für dieses Setup:</p>
<ul>
