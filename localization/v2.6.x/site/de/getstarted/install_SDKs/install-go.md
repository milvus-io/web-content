...
<h1 id="Install-Milvus-Go-SDK" class="common-anchor-header">Milvus Go SDK installieren<button data-href="#Install-Milvus-Go-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Dieses Thema beschreibt, wie man das Milvus Go SDK für Milvus installiert.</p>
...
<h2 id="Requirement" class="common-anchor-header">Voraussetzung<button data-href="#Requirement" class="anchor-icon" translate="no">
    ...
    </button></h2><p>GO (1.17 oder höher) ist erforderlich.</p>
<h2 id="Install-Milvus-GO-SDK" class="common-anchor-header">Milvus GO SDK installieren<button data-href="#Install-Milvus-GO-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Installieren Sie das Milvus GO SDK und die Abhängigkeiten über <code translate="no">go get</code>.</p>
