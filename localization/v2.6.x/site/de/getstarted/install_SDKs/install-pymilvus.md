...
<h1 id="Install-Milvus-Python-SDK" class="common-anchor-header">Milvus Python SDK installieren<button data-href="#Install-Milvus-Python-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>In diesem Abschnitt wird beschrieben, wie Sie das Milvus-Python-SDK „pymilvus“ für Milvus installieren.</p>
<p>Die aktuelle Version von Milvus unterstützt SDKs in Python, Node.js, Go und Java.</p>
<h2 id="Requirements" class="common-anchor-header">Voraussetzungen<button data-href="#Requirements" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
Es wird empfohlen, eine PyMilvus-Version zu installieren, die mit der Version des von Ihnen installierten Milvus-Servers übereinstimmt. Weitere Informationen finden Sie in <a href="/docs/de/v2.6.x/release_notes.md">den Release Notes</a>.
</div>
...
<h2 id="Verify-installation" class="common-anchor-header">Überprüfen Sie die Installation<button data-href="#Verify-installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Wenn PyMilvus korrekt installiert ist, wird beim Ausführen des folgenden Befehls keine Ausnahme ausgelöst.</p>
...
<li><p><a href="/api-reference/pymilvus/v2.6.x/About.md">PyMilvus-API-Referenz</a> erkunden</p></li>
</ul>
