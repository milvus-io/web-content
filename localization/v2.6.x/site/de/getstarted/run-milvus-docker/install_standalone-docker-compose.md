...
<h2 id="Install-Milvus" class="common-anchor-header">Milvus installieren<button data-href="#Install-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus stellt im Milvus-Repository eine Docker-Compose-Konfigurationsdatei zur Verfügung. Um Milvus mit Docker Compose zu installieren, führen Sie einfach folgenden Befehl aus</p>
...
<p><strong>Neuerungen in Version 2.6.23:</strong></p>
<ul>
...
<p>Laden Sie stets die aktuellste Docker-Compose-Konfiguration herunter, um die Kompatibilität mit den Funktionen von v2.6.23 sicherzustellen.</p>
<ul>
...
<p>Mit dem folgenden Befehl können Sie überprüfen, ob die Container aktiv und in Betrieb sind:</p>
...
Im Folgenden wird davon ausgegangen, dass Sie die Standardkonfiguration von ` <code translate="no">proxy.healthCheckTimeout</code>` überschreiben müssen. Informationen zu den entsprechenden Konfigurationselementen finden Sie unter <a href="/docs/de/v2.6.x/system_configuration.md">„Systemkonfiguration</a>“.</p>
...
<ul>
<li><p>Schauen Sie sich <a href="/docs/de/v2.6.x/quickstart.md">die Schnellstartanleitung</a> an, um zu erfahren, was Milvus leisten kann.</p></li>
...
<li><p>Entdecken Sie <a href="/docs/de/v2.6.x/birdwatcher_overview.md">Birdwatcher</a>, ein Open-Source-Tool für das Debugging von Milvus und dynamische Konfigurationsaktualisierungen.</p></li>
