...
<p><strong>Neue Funktionen in Version 2.6.14:</strong></p>
<ul>
...
<p>Laden Sie immer die neueste Konfiguration von Docker Compose herunter, um die Kompatibilität mit den Funktionen von v2.6.14 zu gewährleisten.</p>
<ul>
