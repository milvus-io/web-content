...
<p>Laden Sie stets die neueste Docker-Compose-Konfiguration herunter, um die Kompatibilität mit den Funktionen von v2.6.24 sicherzustellen.</p>
<ul>
...
Im Folgenden wird davon ausgegangen, dass Sie die Standardkonfiguration in der Datei „ <code translate="no">proxy.healthCheckTimeout</code> “ überschreiben müssen. Informationen zu den entsprechenden Konfigurationselementen finden Sie unter <a href="/docs/de/v2.6.x/system_configuration.md">„Systemkonfiguration</a>“.</p>
