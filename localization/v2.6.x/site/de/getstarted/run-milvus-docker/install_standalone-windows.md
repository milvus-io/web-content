...
<h1 id="Run-Milvus-in-Docker-Windows" class="common-anchor-header">Milvus in Docker ausführen (Windows)<button data-href="#Run-Milvus-in-Docker-Windows" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Auf dieser Seite wird gezeigt, wie man Milvus unter Windows mit Docker Desktop für Windows ausführt.​</p>
...
<li><p>Der Container <strong>„milvus-standalone“</strong> stellt die Ports <strong>19530</strong> lokal mit den Standardeinstellungen bereit und ordnet seine Daten dem Verzeichnis <strong>„volumes/milvus“</strong> im aktuellen Ordner zu.​</p></li>
</ul></li>
</ol>
