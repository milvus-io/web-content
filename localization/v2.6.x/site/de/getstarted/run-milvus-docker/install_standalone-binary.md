...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Herunterladen des RPM/DEB-Pakets<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Sie können das RPM/DEB-Paket entsprechend Ihrer Systemarchitektur von der [Milvus Releases-Seite](https://github.com/milvus-io/milvus/releases/tag/v{{ var.milvus_release_version }}) herunterladen.</p>
<ul>
<li>Für x86_64/amd64, laden Sie das <strong>{{ var.milvus_deb_amd64 }}</strong> oder <strong>{{ var.milvus_rpm_amd64 }}</strong> Paket herunter.</li>
<li>Für ARM64, laden Sie das Paket <strong>{{ var.milvus_deb_arm64 }}</strong> oder <strong>{{ var.milvus_rpm_arm64 }}</strong> herunter.</li>
</ul>
