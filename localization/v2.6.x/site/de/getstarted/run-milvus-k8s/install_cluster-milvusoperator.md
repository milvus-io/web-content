...
<button class="copy-code-btn"></button></code></pre>
<p>Mit dem obigen Befehl wird ein Milvus-Cluster mit <strong>Woodpecker</strong> als Nachrichtenwarteschlange (empfohlen für v2.6.16) und allen neuen Architekturkomponenten einschließlich des Streaming Node bereitgestellt.</p>
