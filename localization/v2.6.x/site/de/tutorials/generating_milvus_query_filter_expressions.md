...
<h2 id="Set-up-environment-variables" class="common-anchor-header">Einrichten von Umgebungsvariablen<button data-href="#Set-up-environment-variables" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Konfigurieren Sie Ihre OpenAI-API-Anmeldedaten, um die Erzeugung von Einbettungen und LLM-basierten Filterausdrücken zu ermöglichen. Ersetzen Sie <code translate="no">'your_openai_api_key'</code> durch Ihren tatsächlichen OpenAI-API-Schlüssel.</p>
