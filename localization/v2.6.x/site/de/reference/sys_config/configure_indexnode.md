...
summary: 'Erfahren Sie, wie Sie indexNode für Milvus konfigurieren.'
---
<h1 id="indexNode-related-Configurations" class="common-anchor-header">indexNode-bezogene Konfigurationen<button data-href="#indexNode-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>        Indexknoten zum Erstellen eines Plattenvektorindexes aktivieren      </td>
      <td>true</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodeip" class="common-anchor-header"><code translate="no">indexNode.ip</code><button data-href="#indexNodeip" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        TCP/IP-Adresse von indexNode. Wenn nicht angegeben, wird die erste unicastbare Adresse verwendet.      </td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<h2 id="indexNodegrpcserverMaxSendSize" class="common-anchor-header"><code translate="no">indexNode.grpc.serverMaxSendSize</code><button data-href="#indexNodegrpcserverMaxSendSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Die maximale Größe jeder RPC-Anfrage, die der indexNode senden kann, Einheit: Byte    </td>
      <td>536870912</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcserverMaxRecvSize" class="common-anchor-header"><code translate="no">indexNode.grpc.serverMaxRecvSize</code><button data-href="#indexNodegrpcserverMaxRecvSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Die maximale Größe jeder RPC-Anfrage, die der indexNode empfangen kann, Einheit: Byte    </td>
      <td>268435456</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcclientMaxSendSize" class="common-anchor-header"><code translate="no">indexNode.grpc.clientMaxSendSize</code><button data-href="#indexNodegrpcclientMaxSendSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Die maximale Größe jeder RPC-Anfrage, die die Clients auf indexNode senden können, Einheit: Byte    </td>
      <td>268435456</td>
    </tr>
  </tbody>
</table>
