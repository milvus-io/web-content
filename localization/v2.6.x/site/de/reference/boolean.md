...
<h2 id="Operators" class="common-anchor-header">Operatoren<button data-href="#Operators" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Logical-operators" class="common-anchor-header">Logische Operatoren<button data-href="#Logical-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Logische Operatoren führen einen Vergleich zwischen zwei Ausdrücken durch.</p>
<table>
<thead>
...
<h3 id="Binary-arithmetic-operators" class="common-anchor-header">Binäre arithmetische Operatoren<button data-href="#Binary-arithmetic-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Binäre arithmetische Operatoren enthalten zwei Operanden und können grundlegende arithmetische Operationen durchführen und das entsprechende Ergebnis zurückgeben.</p>
<table>
<thead>
<tr><th>Symbol</th><th>Operation</th><th>Beispiel</th><th>Beschreibung</th></tr>
</thead>
...
<h3 id="Relational-operators" class="common-anchor-header">Relationale Operatoren<button data-href="#Relational-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Relationale Operatoren verwenden Symbole, um die Gleichheit, Ungleichheit oder relative Reihenfolge zwischen zwei Ausdrücken zu prüfen.</p>
<table>
<thead>
<tr><th>Symbol</th><th>Operation</th><th>Beispiel</th><th>Beschreibung</th></tr>
</thead>
...
<h2 id="Operator-precedence-and-associativity" class="common-anchor-header">Vorrangigkeit und Assoziativität von Operatoren<button data-href="#Operator-precedence-and-associativity" class="anchor-icon" translate="no">
    ...
    </button></h2><p>In der folgenden Tabelle sind die Rangfolge und die Assoziativität der Operatoren aufgeführt. Die Operatoren sind von oben nach unten in absteigender Rangfolge aufgeführt.</p>
<table>
<thead>
...
<p>Der JSON-Ausdruck in einer <code translate="no">JSON_CONTAINS_ANY</code> -Anweisung sollte immer eine Liste sein. Andernfalls verhält er sich wie <code translate="no">JSON_CONTAINS</code>.</p>
<pre><code translate="no" class="language-python"><span class="hljs-comment"># {&quot;x&quot;: [1,2,3,4,5,7,8]}</span>
