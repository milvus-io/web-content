...
<li><p><strong>Liste von Iterablen von Tupeln</strong>: Ähnlich wie eine Liste von Wörterbüchern, aber Verwendung einer Iterablen von Tupeln, <code translate="no">[(dimension_index, value)]</code>, um nur die Nicht-Null-Dimensionen und ihre Werte anzugeben.</p>
<p>Beispiel:</p>
<pre><code translate="no" class="language-python">[(<span class="hljs-number">2</span>, <span class="hljs-number">0.33</span>), (<span class="hljs-number">98</span>, <span class="hljs-number">0.72</span>), ...]
<button class="copy-code-btn"></button></code></pre></li>
</ul>
