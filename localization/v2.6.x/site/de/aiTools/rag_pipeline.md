---
id: rag_pipeline.md
title: 'Aufforderung: Milvus RAG Pipeline'
summary: Regeln für KI-Codierassistenten zum Aufbau von RAG-Pipelines mit Milvus.
---
...
<p>End-to-End-Regeln für den Aufbau von RAG-Pipelines mit Milvus, einschließlich Ingestion, Chunking, Embedding, Hybrid Retrieval mit BM25 und Dokumenten-Updates mit Upsert. Kopieren Sie die vollständige Aufforderung unten in Ihr AI-Tool, um diese Regeln automatisch anzuwenden. Einen Überblick über alle Prompts finden Sie unter <a href="/docs/de/ai_prompts_landing.md">AI Prompts</a>.</p>
