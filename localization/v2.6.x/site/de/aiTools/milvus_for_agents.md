...
<div class="start_card_container">
  <a href="/docs/de/integrations_overview.md" style="text-decoration: none; color: inherit;">
    <p class="link-btn" style="font-size: 1rem; white-space: nowrap;">Agenten-Frameworks</p>
    <p style="font-size: 0.875rem; font-weight: 400; color: #555;">Integration mit LangChain, LlamaIndex, OpenAI Agents und anderen Agenten-Orchestrierungs-Frameworks.</p>
  </a>
</div>
</div>
...
<p>Für Agenten-Workloads wird <strong>Zilliz Cloud</strong> für den Produktionseinsatz empfohlen. Agenten verwalten in der Regel keine Infrastruktur, sodass eine serverlose Bereitstellung den betrieblichen Overhead eliminiert und eine automatische Skalierung ermöglicht.</p>
</div>
<h2 id="Quick-connection-examples" class="common-anchor-header">Beispiele für schnelle Verbindungen<button data-href="#Quick-connection-examples" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Verbinden Sie sich mit Milvus über Ihren Agentencode:</p>
...
<li><a href="/docs/de/quickstart.md">Schnellstart</a> - Führen Sie Ihre erste Milvus-Suche in wenigen Minuten aus.</li>
<li><a href="/docs/de/integrations_overview.md">Agent-Framework-Integrationen</a> - Verbinden Sie Milvus mit LangChain, LlamaIndex, OpenAI-Agenten und mehr.</li>
</ul>
