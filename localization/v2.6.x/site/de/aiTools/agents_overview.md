...
title: AGENTS.md für Milvus
summary: >-
  Regeln und Muster für KI-Codieragenten, die mit PyMilvus
  Milvus-Vektordatenbankcode generieren, überprüfen oder debuggen.
---
<h1 id="AGENTSmd--Milvus" class="common-anchor-header">AGENTS.md - Milvus<button data-href="#AGENTSmd--Milvus" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus ist eine Open-Source-Vektordatenbank für Ähnlichkeitssuche, hybride Suche und RAG. Sie interagieren mit ihr über das PyMilvus SDK's <code translate="no">MilvusClient</code> Interface. Kopieren Sie die vollständige Aufforderung unten in Ihr KI-Tool, um diese Regeln automatisch anzuwenden. Detaillierte aufgabenspezifische Eingabeaufforderungen finden Sie unter <a href="/docs/de/milvus_for_agents.md">KI-Eingabeaufforderungen</a>.</p>
