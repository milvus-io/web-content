...
title: 'Aufforderung: Milvus-Index-Auswahl'
summary: >-
  Regeln für KI-Codierassistenten zur Auswahl und Konfiguration von
  Milvus-Indizes.
---
...
<p>Entscheidungshilfen und Konfigurationsregeln für die Auswahl und Abstimmung von Milvus-Indizes, einschließlich AUTOINDEX, HNSW, DiskANN, IVF und Sparse-Indizes. Kopieren Sie die vollständige Aufforderung unten in Ihr AI-Tool, um diese Regeln automatisch anzuwenden. Einen Überblick über alle Prompts finden Sie unter <a href="/docs/de/ai_prompts_landing.md">AI Prompts</a>.</p>
