...
<h1 id="mGTE" class="common-anchor-header">mGTE<button data-href="#mGTE" class="anchor-icon" translate="no">
    ...
    </button></h1><p>mGTE ist ein mehrsprachiges Textrepräsentationsmodell und ein Reranking-Modell für Textretrievalaufgaben.</p>
<p>Milvus ist über die Klasse MGTEEmbeddingFunction mit dem mGTE-Einbettungsmodell integriert. Diese Klasse bietet Methoden zur Kodierung von Dokumenten und Abfragen unter Verwendung des mGTE-Einbettungsmodells und gibt die Einbettungen als dichte und spärliche Vektoren zurück, die mit der Milvus-Indizierung kompatibel sind.</p>
