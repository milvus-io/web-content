...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Actualizar Milvus Standalone con Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Esta guía describe cómo actualizar tu implementación de Milvus Standalone de la versión v2.5.x a la v2.6.20 utilizando Milvus Operator.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2620" class="common-anchor-header">2.2 Actualización a la versión 2.6.20</h4><p>Una vez que la versión 2.5.16 se esté ejecutando correctamente, actualiza a la versión 2.6.20:</p>
