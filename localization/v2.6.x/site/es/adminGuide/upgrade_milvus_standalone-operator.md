...
---
<div class="tab-wrapper"><a href="/docs/es/v2.6.x/upgrade_milvus_standalone-operator.md" class='active '>Milvus</a><a href="/docs/es/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>Operator</a>, Helm y Docker<a href="/docs/es/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>Compose</a></div>
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Actualizar Milvus Standalone con Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Esta guía describe cómo actualizar tu implementación de Milvus independiente de la versión v2.5.x a la v2.6.24 utilizando Milvus Operator.</p>
...
<li><strong>Nuevos componentes</strong>: se ha introducido el nodo de streaming para mejorar el procesamiento de datos</li>
...
<ul>
<li>Clúster de Kubernetes con Milvus Standalone desplegado a través de Milvus Operator</li>
...
<li><strong>Debe</strong> actualizar a la versión v2.5.16 o posterior antes de actualizar a la v2.6.24.</li>
</ul>
...
<h2 id="Upgrade-process" class="common-anchor-header">Proceso de actualización<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h3><p>En primer lugar, actualice su Milvus Operator a la versión 1.3.7:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Upgrade-your-Milvus-standalone" class="common-anchor-header">Paso 2: Actualizar Milvus independiente<button data-href="#Step-2-Upgrade-your-Milvus-standalone" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2624" class="common-anchor-header">2.2 Actualización a la versión 2.6.24</h4><p>Una vez que la versión 2.5.16 se ejecute correctamente, actualiza a la versión 2.6.24:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<p>Si necesitas más ayuda, consulta la <a href="https://milvus.io/docs">documentación de Milvus</a> o <a href="https://github.com/milvus-io/milvus/discussions">el foro de la comunidad</a>.</p>
