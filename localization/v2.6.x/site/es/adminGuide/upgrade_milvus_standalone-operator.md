...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Actualizar Milvus Standalone con Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Esta guía describe cómo actualizar tu implementación de Milvus Standalone de la versión v2.5.x a la v2.6.18 utilizando Milvus Operator.</p>
...
<li><strong>Debes</strong> actualizar a la versión v2.5.16 o posterior antes de actualizar a la v2.6.18.</li>
</ul>
<p><strong>Limitaciones de la cola de mensajes</strong>: Al actualizar a Milvus v2.6.18, debe mantener su elección actual de cola de mensajes. No se admite el cambio entre diferentes sistemas de colas de mensajes durante la actualización. La compatibilidad con el cambio de sistemas de colas de mensajes estará disponible en futuras versiones.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2618" class="common-anchor-header">2.2 Actualización a la versión 2.6.18</h4><p>Una vez que la versión 2.5.16 se ejecute correctamente, actualiza a la versión 2.6.18:</p>
...
<h2 id="Verify-the-upgrade" class="common-anchor-header">Comprueba la actualización<button data-href="#Verify-the-upgrade" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Comprueba que tu implementación independiente está ejecutando la nueva versión:</p>
