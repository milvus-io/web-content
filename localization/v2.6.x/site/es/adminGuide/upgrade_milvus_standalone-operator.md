...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Actualizar Milvus Standalone con Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Esta guía describe cómo actualizar su despliegue independiente Milvus de v2.5.x a v2.6.16 utilizando Milvus Operator.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2616" class="common-anchor-header">2.2 Actualización a la versión 2.6.16</h4><p>Una vez que la versión 2.5.16 esté funcionando correctamente, actualice a la versión 2.6.16:</p>
