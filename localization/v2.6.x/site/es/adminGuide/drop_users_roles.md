...
<h1 id="Drop-Users--Roles" class="common-anchor-header">Eliminar usuarios y funciones<button data-href="#Drop-Users--Roles" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Para garantizar la seguridad de los datos, se recomienda eliminar los usuarios y funciones que ya no se utilicen. En esta guía se explica cómo eliminar usuarios y funciones.</p>
...
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#plaintext">texto plano</a> <a href="#javascript">NodeJS</a> <a href="#bash">cURL</a></div>
