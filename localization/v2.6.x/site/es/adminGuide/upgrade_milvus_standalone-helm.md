...
<p>La actualización de Milvus 2.5.x (o versiones anteriores) a 2.6.0-rc1 implica cambios arquitectónicos significativos que hacen que esta actualización <strong>sea irreversible</strong>. Debido a la introducción de nuevos componentes (como Woodpecker y Streaming Node) y a la eliminación de ciertos componentes, <strong>no podrá volver a una versión anterior una vez completada la actualización</strong>. Para más detalles sobre los cambios arquitectónicos introducidos en 2.6.0-rc1, consulte <a href="/docs/es/v2.6.x/architecture_overview.md">Visión general de la arquitectura de Milvus</a>.</p>
</div>
...
<div style="display: none;">- Realice una actualización continua](#conduct-a-rolling-upgrade) de Milvus v2.2.3 y versiones posteriores a v2.6.0-rc1.</div>
<ul>
<li><p><a href="#Upgrade-Milvus-using-Helm">Actualice Milvus utilizando Helm</a> para una actualización desde una versión menor anterior a v2.2.3 a v2.6.0-rc1.</p></li>
<li><p><a href="#Migrate-the-metadata">Migre los metadatos</a> antes de la actualización de Milvus v2.1.x a v2.6.0-rc1.</p></li>
</ul>
...
<p>Una vez que se haya asegurado de que todos los despliegues en su instancia de Milvus están en su estado normal. Puede ejecutar el siguiente comando para actualizar la instancia de Milvus a 2.6.0-rc1.</p>
...
<h4 id="2-Upgrade-Milvus-from-v21x-to-260-rc1" class="common-anchor-header">2. Actualice Milvus de v2.1.x a 2.6.0-rc1</h4><p>Los siguientes comandos asumen que usted actualiza Milvus de v2.1.4 a 2.6.0-rc1. Cámbielos por las versiones que se ajusten a sus necesidades.</p>
<ol>
