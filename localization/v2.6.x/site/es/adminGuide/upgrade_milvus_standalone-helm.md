...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Actualizar Milvus Standalone con Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Esta guía describe cómo actualizar tu implementación de Milvus Standalone de la versión v2.5.x a la v2.6.23 utilizando Helm Chart.</p>
<h2 id="Before-you-start" class="common-anchor-header">Antes de empezar<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>La actualización de Milvus 2.5.x a 2.6.23 implica cambios arquitectónicos significativos:</p>
<ul>
...
<p><strong>Limitaciones de la cola de mensajes</strong>: Al actualizar a Milvus v2.6.23, debes mantener tu opción actual de cola de mensajes. No se admite el cambio entre diferentes sistemas de colas de mensajes durante la actualización. El soporte para cambiar de sistema de colas de mensajes estará disponible en futuras versiones.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Esta guía da por hecho que está instalando la última versión. Si necesita instalar una versión específica, especifique el parámetro <code translate="no">--version</code> según corresponda.</p>
...
<p>Actualiza tu Milvus autónomo a la v2.5.16:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v2623" class="common-anchor-header">Paso 3: Actualiza a la versión 2.6.23<button data-href="#Step-3-Upgrade-to-v2623" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una vez que la versión 2.5.16 se ejecute correctamente, actualiza a la versión 2.6.23:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
...
<h2 id="Verify-the-upgrade" class="common-anchor-header">Comprueba la actualización<button data-href="#Verify-the-upgrade" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Confirma que tu instalación independiente está ejecutando la nueva versión:</p>
