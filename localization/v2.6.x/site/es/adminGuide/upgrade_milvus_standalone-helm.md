...
<p>La actualización de Milvus 2.5.x (o versiones anteriores) a 2.6.0 implica cambios arquitectónicos significativos que hacen que esta actualización <strong>sea irreversible</strong>. Debido a la introducción de nuevos componentes (como Woodpecker y Streaming Node) y a la eliminación de ciertos componentes, <strong>no podrá volver a una versión anterior una vez completada la actualización</strong>. Para más detalles sobre los cambios arquitectónicos introducidos en 2.6.0, consulte <a href="/docs/es/architecture_overview.md">Visión general de la arquitectura de Milvus</a>.</p>
</div>
...
<div class="alert note">
<p>Desde la versión 4.2.21 de la carta Milvus-Helm, hemos introducido la carta pulsar-v3.x como dependencia. Por compatibilidad con versiones anteriores, actualice su helm a la versión 3.14 o posterior, y asegúrese de añadir la opción <code translate="no">--reset-then-reuse-values</code> siempre que utilice <code translate="no">helm upgrade</code>.</p>
</div>
...
<div style="display: none;">- Realice una actualización continua (#conduct-a-rolling-upgrade) de Milvus v2.2.3 y versiones posteriores a v2.6.0.</div>
<ul>
<li><p><a href="#Upgrade-Milvus-using-Helm">Actualice Milvus utilizando Helm</a> para una actualización desde una versión menor anterior a v2.2.3 a v2.6.0.</p></li>
<li><p><a href="#Migrate-the-metadata">Migre los metadatos</a> antes de la actualización de Milvus v2.1.x a v2.6.0.</p></li>
</ul>
...
<p>Una vez que se haya asegurado de que todos los despliegues de su instancia de Milvus están en su estado normal. Puede ejecutar el siguiente comando para actualizar la instancia de Milvus a 2.6.0.</p>
...
<h4 id="2-Upgrade-Milvus-from-v21x-to-260" class="common-anchor-header">2. Actualizar Milvus de v2.1.x a 2.6.0</h4><p>Los siguientes comandos asumen que usted actualiza Milvus de v2.1.4 a 2.6.0. Cámbielos por las versiones que se ajusten a sus necesidades.</p>
<ol>
