...
<h3 id="Step-2-Upgrade-to-v2516" class="common-anchor-header">Paso 2: Actualice a v2.5.16</h3><div class="alert-note">
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v260" class="common-anchor-header">Paso 3: Actualizar a v2.6.0</h3><p>Una vez que la versión 2.5.16 se ejecute correctamente, actualice a la versión 2.6.0:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
