...
<p><strong>Limitaciones de la cola de mensajes</strong>: Al actualizar a Milvus v2.6.6, debe mantener su elección actual de cola de mensajes. No se admite el cambio entre diferentes sistemas de colas de mensajes durante la actualización. El soporte para el cambio de sistemas de colas de mensajes estará disponible en futuras versiones.</p>
</div>
