...
title: Actualizar el clúster de Milvus con Docker Compose
---
...
<h1 id="Upgrade-Milvus-Cluster-with-Docker-Compose" class="common-anchor-header">Actualizar el clúster de Milvus con Docker Compose<button data-href="#Upgrade-Milvus-Cluster-with-Docker-Compose" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>En condiciones normales, puede <a href="#Upgrade-Milvus-by-changing-its-image">actualizar Milvus cambiando su imagen</a>. Sin embargo, es necesario <a href="#Migrate-the-metadata">migrar los metadatos</a> antes de cualquier actualización de la versión v2.1.x a la v2.6.23.</p>
