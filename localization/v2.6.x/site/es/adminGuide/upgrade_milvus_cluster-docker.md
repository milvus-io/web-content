...
summary: Descubre cómo actualizar un clúster de Milvus con Docker Compose.
title: Actualización del clúster de Milvus con Docker Compose
---
<div class="tab-wrapper"><a href="/docs/es/v2.6.x/upgrade_milvus_standalone-operator.md" class=''>Milvus</a><a href="/docs/es/v2.6.x/upgrade_milvus_cluster-operator.md" class=''>OperatorMilvus</a><a href="/docs/es/v2.6.x/configure_operator.md" class=''>OperatorMilvus</a><a href="/docs/es/v2.6.x/configure-docker.md" class=''>OperatorHelmDocker</a><a href="/docs/es/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>ComposeHelmDocker</a><a href="/docs/es/v2.6.x/upgrade_milvus_cluster-helm.md" class=''>ComposeHelm</a></div>
<h1 id="Upgrade-Milvus-Cluster-with-Docker-Compose" class="common-anchor-header">Actualización del clúster de Milvus con Docker Compose<button data-href="#Upgrade-Milvus-Cluster-with-Docker-Compose" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>En este tema se describe cómo actualizar Milvus utilizando Docker Compose.</p>
<p>En condiciones normales, puede <a href="#Upgrade-Milvus-by-changing-its-image">actualizar Milvus cambiando su imagen</a>. Sin embargo, es necesario <a href="#Migrate-the-metadata">migrar los metadatos</a> antes de cualquier actualización de la versión v2.1.x a la v2.6.24.</p>
