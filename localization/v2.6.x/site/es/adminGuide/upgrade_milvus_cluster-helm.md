...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Actualizar el clúster de Milvus con Helm Chart<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Esta guía describe cómo actualizar tu clúster de Milvus de la versión 2.5.x a la 2.6.23 utilizando Helm Chart.</p>
<h2 id="Before-you-start" class="common-anchor-header">Antes de empezar<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>La actualización de Milvus 2.5.x a 2.6.23 conlleva cambios arquitectónicos significativos:</p>
<ul>
...
<li><strong>Eliminación de componentes</strong>: se ha eliminado y consolidado el <code translate="no">indexNode</code> </li>
</ul>
...
<li><strong>Debes</strong> actualizar a la v2.5.16 o posterior con la opción « <code translate="no">mixCoordinator</code> » habilitada antes de actualizar a la v2.6.23.</li>
</ul>
<p><strong>Limitaciones de la cola de mensajes</strong>: al actualizar a Milvus v2.6.23, debe mantener su elección actual de cola de mensajes. No se admite el cambio entre diferentes sistemas de colas de mensajes durante la actualización. La compatibilidad con el cambio de sistemas de colas de mensajes estará disponible en futuras versiones.</p>
...
<div class="alert note">
El repositorio de gráficos Helm de Milvus en <code translate="no">https://milvus-io.github.io/milvus-helm/</code> ha sido archivado. Utiliza el nuevo repositorio <code translate="no">https://zilliztech.github.io/milvus-helm/</code> para las versiones 4.0.31 y posteriores.
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Esta guía da por hecho que vas a instalar la última versión. Si necesitas instalar una versión específica, especifica el parámetro <code translate="no">--version</code> en consecuencia.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v2623" class="common-anchor-header">Paso 3: Actualizar a la versión 2.6.23<button data-href="#Step-3-Upgrade-to-v2623" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una vez que la versión 2.5.16 funcione correctamente con <code translate="no">mixCoordinator</code>, actualiza a la versión 2.6.23:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
