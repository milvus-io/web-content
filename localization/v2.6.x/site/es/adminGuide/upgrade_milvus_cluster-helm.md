...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Actualizar Milvus Cluster con Helm Chart<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Esta guía describe cómo actualizar su cluster Milvus de v2.5.x a v2.6.18 utilizando Helm Chart.</p>
...
<li><strong>Debe</strong> actualizar a la versión 2.5.16 o posterior con <code translate="no">mixCoordinator</code> activado antes de actualizar a la versión 2.6.18.</li>
</ul>
...
<h3 id="Step-3-Upgrade-to-v2618" class="common-anchor-header">Paso 3: Actualizar a v2.6.18<button data-href="#Step-3-Upgrade-to-v2618" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Una vez que la versión 2.5.16 funcione correctamente con <code translate="no">mixCoordinator</code>, actualice a la versión 2.6.18:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
