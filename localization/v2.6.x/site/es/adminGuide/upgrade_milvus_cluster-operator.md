...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Actualizar Milvus Cluster con Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Esta guía describe cómo actualizar su cluster Milvus de v2.5.x a v2.6.15 utilizando Milvus Operator.</p>
...
<li><strong>Debe</strong> actualizar a la versión 2.5.16 o posterior con <code translate="no">mixCoord</code> activado antes de actualizar a la versión 2.6.15.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2615" class="common-anchor-header">2.3 Actualización a la versión 2.6.15</h4><p>Una vez que la versión 2.5.16 funcione correctamente con <code translate="no">mixCoord</code>, actualice a la versión 2.6.15:</p>
