...
---
<div class="tab-wrapper"><a href="/docs/es/v2.6.x/upgrade_milvus_cluster-operator.md" class='active '>Milvus</a><a href="/docs/es/v2.6.x/upgrade_milvus_cluster-helm.md" class=''>OperatorHelm</a></div>
...
<h2 id="Before-you-start" class="common-anchor-header">Antes de empezar<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><p>A partir de Milvus 2.6.0, los coordinadores separados heredados (<code translate="no">dataCoord</code>, <code translate="no">queryCoord</code>, <code translate="no">indexCoord</code>) se han consolidado en un único <code translate="no">mixCoord</code>. Antes de actualizar, asegúrese de que su especificación CRD utiliza <code translate="no">mixCoord</code> en lugar de componentes de coordinador individuales.</p>
<p>Si utiliza los coordinadores separados, modifique su especificación:</p>
...
<h2 id="Upgrade-your-Milvus-operator" class="common-anchor-header">Actualice su operador Milvus<button data-href="#Upgrade-your-Milvus-operator" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ejecute el siguiente comando para actualizar la versión de su Operador Milvus a v1.3.0-rc1-hotfix.</p>
...
<ul>
<li>Para actualizar Milvus desde v2.2.3, puede <a href="#Conduct-a-rolling-upgrade">realizar una actualización continua</a>.</li>
<li>Para actualizar Milvus desde una versión menor anterior a v2.2.3 a 2.6.0-rc1, se recomienda <a href="#Upgrade-Milvus-by-changing-its-image">actualizar Milvus cambiando su versión de imagen</a>.</li>
<li>Para actualizar Milvus de v2.1.x a 2.6.0-rc1, debe <a href="#Migrate-the-metadata">migrar los metadatos</a> antes de la actualización.</li>
</ul>
<blockquote>
<p><strong>Nota</strong>: Se recomienda encarecidamente actualizar una versión menor cada vez y utilizar la última versión estable de esa versión menor. Por ejemplo, si está actualizando de v2.4.x a v2.6.x, primero debería actualizar a la última v2.4.x, después a la última v2.5.x y, por último, a v2.6.x. De este modo se asegura de que está utilizando la última versión estable de cada versión menor, que es más probable que sea compatible con sus datos y configuraciones existentes.</p>
</blockquote>
<h2 id="Conduct-a-rolling-upgrade" class="common-anchor-header">Realice una actualización continua<button data-href="#Conduct-a-rolling-upgrade" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
