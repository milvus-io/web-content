...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Actualizar el clúster de Milvus con Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Esta guía describe cómo actualizar tu clúster de Milvus de la versión 2.5.x a la 2.6.23 utilizando Milvus Operator.</p>
...
<ul>
<li>Clúster de Kubernetes con Milvus desplegado a través de Milvus Operator</li>
...
<li><strong>Debe</strong> actualizar a la versión v2.5.16 o posterior con la función « <code translate="no">mixCoord</code> » habilitada antes de actualizar a la versión v2.6.23.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Upgrade-your-Milvus-cluster" class="common-anchor-header">Paso 2: Actualiza tu clúster de Milvus<button data-href="#Step-2-Upgrade-your-Milvus-cluster" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Crea un archivo de configuración llamado « <code translate="no">milvusupgrade.yaml</code> » para habilitar « <code translate="no">mixCoord</code> » y actualizar a la versión v2.5.16:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2623" class="common-anchor-header">2.3 Actualización a la versión 2.6.23</h4><p>Una vez que la versión 2.5.16 se ejecute correctamente con <code translate="no">mixCoord</code>, actualiza a la versión 2.6.23:</p>
