...
<p>Por motivos de seguridad, Milvus actualiza su MinIO a RELEASE.2024-12-18T13-15-44Z con el lanzamiento de la versión v2.6.17.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v2617" class="common-anchor-header">Paso 2: Actualizar a la versión 2.6.17<button data-href="#Step-2-Upgrade-to-v2617" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Una vez que la versión v2.5.16 se ejecute correctamente, actualiza a la versión v2.6.17:</p>
<ol>
