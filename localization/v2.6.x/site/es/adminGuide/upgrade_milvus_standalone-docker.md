...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Actualizar Milvus Standalone con Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Esta guía describe cómo actualizar su despliegue independiente Milvus de v2.5.x a v2.6.8 utilizando Docker Compose.</p>
...
<p>Por motivos de seguridad, Milvus actualiza su MinIO a RELEASE.2024-12-18T13-15-44Z con el lanzamiento de v2.6.8.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v268" class="common-anchor-header">Paso 2: Actualizar a v2.6.8<button data-href="#Step-2-Upgrade-to-v268" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una vez que la versión 2.5.16 funcione correctamente, actualice a la versión 2.6.8:</p>
<ol>
