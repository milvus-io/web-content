...
<p>Milvus también admite la recuperación híbrida combinando la búsqueda de texto completo con la búsqueda semántica basada en vectores densos. Suele mejorar la calidad de la búsqueda y ofrece mejores resultados a los usuarios al equilibrar la coincidencia de palabras clave y la comprensión semántica.</p>
