...
<h3 id="Run-search" class="common-anchor-header">Ejecutar la búsqueda<button data-href="#Run-search" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Ahora estamos listos para realizar la búsqueda avanzada de imágenes con datos de consulta compuestos tanto por imágenes como por instrucciones de texto.</p>
