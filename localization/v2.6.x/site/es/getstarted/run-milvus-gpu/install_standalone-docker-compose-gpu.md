...
<li><a href="/docs/es/v2.6.x/prerequisite-gpu.md">Compruebe los requisitos de hardware y software</a> antes de la instalación.</li>
</ul>
...
<h3 id="1-Download-and-configure-the-YAML-file" class="common-anchor-header">1. Descargue y configure el archivo YAML<button data-href="#1-Download-and-configure-the-YAML-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Descarga <a href="https://github.com/milvus-io/milvus/releases/download/v2.6.18/milvus-standalone-docker-compose-gpu.yml"><code translate="no">milvus-standalone-docker-compose-gpu.yml</code></a> y guárdelo como docker-compose.yml manualmente, o con el siguiente comando.</p>
...
<span class="hljs-string">...</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Start-Milvus" class="common-anchor-header">2. Inicie Milvus<button data-href="#2-Start-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>En el directorio que contiene docker-compose.yml, inicie Milvus ejecutando:</p>
...
<ul>
<li><p>Comprobar <a href="/docs/es/v2.6.x/quickstart.md">Quickstart</a> para ver qué puede hacer Milvus.</p></li>
<li><p>Consultar <a href="/docs/es/v2.6.x/milvus-webui.md">Milvus WebUI</a> para saber más sobre la instancia de Milvus.</p></li>
