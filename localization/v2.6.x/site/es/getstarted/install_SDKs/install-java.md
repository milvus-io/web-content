...
related_key: SDK
summary: Descubre cómo instalar el SDK de Java de Milvus.
title: Instalar el SDK de Java de Milvus
---
<h1 id="Install-Milvus-Java-SDK" class="common-anchor-header">Instalar el SDK de Java de Milvus<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Java (versión 8 o posterior)</li>
<li>Apache Maven o Gradle/Grails</li>
</ul>
<h2 id="Install-Milvus-Java-SDK" class="common-anchor-header">Instalación del SDK de Java de Milvus<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Ejecuta el siguiente comando para instalar el SDK de Java de Milvus.</p>
<ul>
<li>Apache Maven</li>
</ul>
...
<h2 id="Whats-next" class="common-anchor-header">Próximos pasos<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una vez instalado el SDK de Milvus para Java, podrás:</p>
<ul>
...
<li><a href="/docs/es/v2.6.x/single-vector-search.md">Realizar búsquedas de un único vector</a></li>
<li><a href="/docs/es/v2.6.x/multi-vector-search.md">Búsqueda híbrida</a></li>
</ul></li>
<li><p>Explora <a href="/api-reference/java/v2.6.x/About.md">la referencia de la API de Java de Milvus</a></p></li>
</ul>
