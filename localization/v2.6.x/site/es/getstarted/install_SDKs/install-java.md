...
<h2 id="Whats-next" class="common-anchor-header">Próximos pasos<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una vez instalado el SDK de Java de Milvus, podrás:</p>
<ul>
...
<li><p>Explora <a href="/api-reference/java/v2.4.x/About.md">la referencia de la API de Java de Milvus</a></p></li>
</ul>
