...
related_key: SDK
summary: Descubre cómo instalar el SDK de Node.js de Milvus.
title: Instalar el SDK de Milvus para Node.js
---
<h1 id="Install-Milvus-Nodejs-SDK" class="common-anchor-header">Instalar el SDK de Milvus para Node.js<button data-href="#Install-Milvus-Nodejs-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>En este tema se describe cómo instalar el SDK de Milvus para Node.js.</p>
<h2 id="Compatibility" class="common-anchor-header">Compatibilidad<button data-href="#Compatibility" class="anchor-icon" translate="no">
    ...
    </button></h2><p>La siguiente tabla muestra las versiones de Milvus y las versiones recomendadas de @zilliz/milvus2-sdk-node:</p>
<table>
<thead>
...
<tbody>
<tr><td style="text-align:center">2.5.x</td><td style="text-align:center">la más reciente</td></tr>
...
<h2 id="Installation" class="common-anchor-header">Instalación<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>La forma recomendada de empezar a utilizar el cliente de Node.js de Milvus es mediante npm (gestor de paquetes de Node) para instalar la dependencia en tu proyecto.</p>
<pre><code translate="no" class="language-javascript">npm install @zilliz/milvus2-sdk-node
# or ...
yarn add @zilliz/milvus2-sdk-node
<button class="copy-code-btn"></button></code></pre>
<p>Esto descargará el SDK de Milvus para Node.js y añadirá una entrada de dependencia en tu archivo package.json.</p>
<h2 id="Whats-next" class="common-anchor-header">Próximos pasos<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una vez instalado el SDK de Milvus para Node.js, puedes:</p>
<ul>
<li><p>Consultar la guía <a href="https://github.com/milvus-io/milvus-sdk-node">de inicio rápido del SDK de Milvus para Node.js</a></p></li>
...
<li><p>Explora <a href="/api-reference/node/v2.4.x/About.md">la referencia de la API de Milvus para Node.js</a></p></li>
</ul>
