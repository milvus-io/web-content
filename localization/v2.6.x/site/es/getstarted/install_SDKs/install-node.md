...
<h2 id="Installation" class="common-anchor-header">Instalación<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>La forma recomendada de empezar a utilizar el cliente Milvus para Node.js es mediante npm (gestor de paquetes de Node) para instalar la dependencia en tu proyecto.</p>
...
<li><p>Explora <a href="/api-reference/node/v2.6.x/About.md">la referencia de la API de Milvus para Node.js</a></p></li>
</ul>
