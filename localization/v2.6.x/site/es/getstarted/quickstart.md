...
<h2 id="Learn-More" class="common-anchor-header">Más información<button data-href="#Learn-More" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Lite es ideal para comenzar con un programa python local. Si tiene datos a gran escala o le gustaría usar Milvus en producción, puede aprender sobre el despliegue de Milvus en <a href="https://milvus.io/docs/install_standalone-docker.md">Docker</a> y <a href="https://milvus.io/docs/install_cluster-milvusoperator.md">Kubernetes</a>. Todos los modos de despliegue de Milvus comparten la misma API, por lo que su código del lado del cliente no necesita cambiar mucho si se mueve a otro modo de despliegue. Simplemente especifique el <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Client/MilvusClient.md">URI y el Token</a> de un servidor Milvus desplegado en cualquier lugar:</p>
