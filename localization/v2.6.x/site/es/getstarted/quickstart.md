...
<h2 id="Install-Milvus" class="common-anchor-header">Instalar Milvus<button data-href="#Install-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>En esta guía utilizamos Milvus Lite, una biblioteca python incluida en <code translate="no">pymilvus</code> que puede incrustarse en la aplicación cliente. Milvus también admite el despliegue en <a href="/docs/es/install_standalone-docker.md">Docker</a> y <a href="/docs/es/install_cluster-milvusoperator.md">Kubernetes</a> para casos de uso de producción.</p>
...
<li>El tipo de métrica (definición de distancia vectorial) se establece en su valor por defecto<a href="/docs/es/metric.md#Cosine-Similarity">(COSINE</a>).</li>
<li>El campo de clave primaria acepta enteros y no se incrementa automáticamente (es decir, no utiliza <a href="/docs/es/schema.md">la función auto-id</a>) Alternativamente, puede definir formalmente el esquema de la colección siguiendo esta <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_schema.md">instrucción</a>.</li>
</ul>
...
<h3 id="Query" class="common-anchor-header">Consulta<button data-href="#Query" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Una consulta() es una operación que recupera todas las entidades que coinciden con un criterio, como una <a href="/docs/es/boolean.md">expresión de filtro</a> o la coincidencia con algunos ids.</p>
...
<h2 id="Learn-More" class="common-anchor-header">Más información<button data-href="#Learn-More" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Lite es ideal para comenzar con un programa python local. Si tiene datos a gran escala o le gustaría usar Milvus en producción, puede aprender sobre el despliegue de Milvus en <a href="/docs/es/install_standalone-docker.md">Docker</a> y <a href="/docs/es/install_cluster-milvusoperator.md">Kubernetes</a>. Todos los modos de despliegue de Milvus comparten la misma API, por lo que su código del lado del cliente no necesita cambiar mucho si se mueve a otro modo de despliegue. Simplemente especifique el <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Client/MilvusClient.md">URI y Token</a> de un servidor Milvus desplegado en cualquier lugar:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Milvus proporciona API REST y gRPC, con librerías cliente en lenguajes como <a href="/docs/es/install-pymilvus.md">Python</a>, <a href="/docs/es/install-java.md">Java</a>, <a href="/docs/es/install-go.md">Go</a>, C# y <a href="/docs/es/install-node.md">Node.js</a>.</p>
