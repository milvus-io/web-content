...
<ul>
<li><strong>Cola de mensajes</strong>: Utiliza WoodPecker (reduce el mantenimiento de la infraestructura)</li>
...
<h3 id="2-Check-Milvus-cluster-status" class="common-anchor-header">2. Comprobar el estado del cluster Milvus</h3><p>Ejecute el siguiente comando para comprobar el estado del cluster Milvus</p>
