...
<button class="copy-code-btn"></button></code></pre>
<p>El comando anterior implementa un clúster de Milvus con <strong>Woodpecker</strong> como cola de mensajes (recomendado para la versión 2.6.20) y todos los nuevos componentes arquitectónicos, incluido el nodo de streaming.</p>
