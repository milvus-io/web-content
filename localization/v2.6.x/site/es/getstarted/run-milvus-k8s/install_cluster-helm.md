...
<p>Para más detalles, consulte la <a href="/docs/es/v2.6.x/architecture_overview.md">Descripción general de la arquitectura</a>.</p>
  </div>
</li>
...
<button class="copy-code-btn"></button></code></pre>
  <div class="alert note">
<p>A partir de Milvus 2.6.x, se han realizado los siguientes cambios en la arquitectura en modo clúster:</p>
<ul>
...
<p>Para obtener más información, consulte la <a href="/docs/es/v2.6.x/architecture_overview.md">Descripción general de la arquitectura</a>.</p>
  </div>
</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<p>También puede acceder a Milvus WebUI en <code translate="no">http://127.0.0.1:9091/webui/</code> para obtener más información sobre su instancia de Milvus. Para más detalles, consulte <a href="/docs/es/v2.6.x/milvus-webui.md">Milvus WebUI</a>.</p>
