...
<li><strong>Woodpecker MQ</strong>: cola de mensajes mejorada con menor carga de mantenimiento; consulta <a href="/docs/es/v2.6.x/use-woodpecker.md">«Usar Woodpecker</a> » para más detalles</li>
...
<ul>
<li>Se ha iniciado un contenedor Docker denominado «milvus» en el puerto <strong>19530</strong>.</li>
...
<li>Recupera la imagen de Docker de Milvus más reciente</li>
