...
summary: >-
  Descubre cómo instalar Milvus en modo autónomo con un paquete RPM/DEB ya
  compilado.
...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Descargar el paquete RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Puede descargar el paquete RPM/DEB adecuado a la arquitectura de su sistema desde la <a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.23">página de versiones de Milvus</a>.</p>
<ul>
<li>Para x86_64/amd64, descarga el paquete <strong>milvus_2.6.23-1_amd64.deb</strong> o <strong>milvus_2.6.23-1_amd64.rpm</strong>.</li>
<li>Para ARM64, descargue el paquete <strong>milvus_2.6.23-1_arm64.deb</strong> o <strong>milvus_2.6.23-1_arm64.rpm</strong>.</li>
</ul>
