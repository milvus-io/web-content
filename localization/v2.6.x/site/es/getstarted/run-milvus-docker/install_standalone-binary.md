...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Descarga del paquete RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Puede descargar el paquete RPM/DEB según la arquitectura de su sistema desde la <a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.4">página Milvus Releases</a>.</p>
<ul>
