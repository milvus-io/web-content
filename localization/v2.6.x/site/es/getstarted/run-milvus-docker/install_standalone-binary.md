...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Descarga del paquete RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Puede descargar el paquete RPM/DEB según la arquitectura de su sistema desde la página [Milvus Releases](https://github.com/milvus-io/milvus/releases/tag/v{{ var.milvus_release_version }}).</p>
<ul>
<li>Para x86_64/amd64, descargue el paquete <strong>{{ var.milvus_deb_amd64 }}</strong> o <strong>{{ var.milvus_rpm_amd64 }}</strong>.</li>
<li>Para ARM64, descargue el paquete <strong>{{ var.milvus_deb_arm64 }}</strong> o <strong>{{ var.milvus_rpm_arm64 }}</strong>.</li>
</ul>
