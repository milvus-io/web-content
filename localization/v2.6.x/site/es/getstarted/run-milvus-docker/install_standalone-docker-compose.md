...
<button class="copy-code-btn"></button></code></pre>
<p>También puede acceder a Milvus WebUI en <code translate="no">http://127.0.0.1:9091/webui/</code> para obtener más información sobre su instancia de Milvus. Para más detalles, consulte <a href="/docs/es/v2.6.x/milvus-webui.md">Milvus Web</a>UI.</p>
...
<ul>
<li><p>Consultar <a href="/docs/es/v2.6.x/quickstart.md">Inicio rápido</a> para ver qué puede hacer Milvus.</p></li>
