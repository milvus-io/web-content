...
<p><strong>Novedades en v2.6.8:</strong></p>
<ul>
...
<p>Descargue siempre la última configuración de Docker Compose para garantizar la compatibilidad con las funciones de la versión 2.6.8.</p>
<ul>
