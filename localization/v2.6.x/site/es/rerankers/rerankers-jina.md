...
order: 6
summary: >-
  Milvus soporta el modelo Jina reranker a través de la clase
  `JinaRerankFunction`. Esta funcionalidad permite puntuar la relevancia de los
  pares consulta-documento de forma eficaz.
...
<h1 id="Jina-AI" class="common-anchor-header">Jina AI<button data-href="#Jina-AI" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus es compatible con <a href="https://jina.ai/reranker/">los modelos reranker</a> de Jina <a href="https://jina.ai/reranker/">AI</a> a través de la clase JinaRerankFunction. Esta funcionalidad le permite puntuar la relevancia de los pares consulta-documento de forma eficaz.</p>
<p>Para utilizar esta función, instale las dependencias necesarias:</p>
<pre><code translate="no" class="language-bash">pip install --upgrade pymilvus
pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>A continuación, instancie la clase <code translate="no">JinaRerankFunction</code>:</p>
...
<p>Nombre del modelo de reranker de Jina AI que se utilizará para la codificación. Si deja este parámetro sin especificar, se utilizará <code translate="no">jina-reranker-v2-base-multilingual</code>. Para obtener una lista de los modelos disponibles, consulte <a href="https://jina.ai/reranker/#apiform">Jina AI Rerankers</a>.</p></li>
