...
<div class="start_card_container">
  <a href="/docs/es/integrations_overview.md" style="text-decoration: none; color: inherit;">
    <p class="link-btn" style="font-size: 1rem; white-space: nowrap;">Marcos de agentes</p>
    <p style="font-size: 0.875rem; font-weight: 400; color: #555;">Integraciones con LangChain, LlamaIndex, OpenAI Agents y otros marcos de orquestación de agentes.</p>
  </a>
</div>
</div>
<h2 id="AI-prompts" class="common-anchor-header">Indicaciones de IA<button data-href="#AI-prompts" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Indicaciones seleccionadas que ayudan a los asistentes de codificación de IA a escribir código Milvus correcto. Cada instrucción codifica las reglas y patrones que evitan los errores más comunes.</p>
...
<h2 id="Quick-connection-examples" class="common-anchor-header">Ejemplos de conexión rápida<button data-href="#Quick-connection-examples" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Conéctese a Milvus desde su código de agente:</p>
...
<li><a href="/docs/es/quickstart.md">Inicio rápido</a> - Ejecute su primera búsqueda Milvus en minutos.</li>
<li><a href="/docs/es/integrations_overview.md">Integraciones de marcos de agentes</a> - Conecte Milvus con LangChain, LlamaIndex, Agentes OpenAI y más.</li>
</ul>
