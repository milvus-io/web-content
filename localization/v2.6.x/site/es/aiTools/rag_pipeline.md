...
summary: >-
  Reglas para que los asistentes de codificación de IA construyan canalizaciones
  RAG con Milvus.
---
<h1 id="RAG-Pipeline" class="common-anchor-header">Canalización RAG<button data-href="#RAG-Pipeline" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Reglas de extremo a extremo para crear canalizaciones RAG con Milvus, incluyendo ingestión, fragmentación, incrustación, recuperación híbrida con BM25 y actualizaciones de documentos con upsert. Copie el mensaje completo que aparece a continuación en su herramienta de IA para aplicar estas reglas automáticamente. Para obtener una visión general de todas las instrucciones, consulte <a href="/docs/es/milvus_for_agents.md">Instrucciones de AI</a>.</p>
