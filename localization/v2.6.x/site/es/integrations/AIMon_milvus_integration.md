...
<li><p>Regístrate para obtener una <a href="https://docs.aimon.ai/quickstart">cuenta AIMon aquí</a>.</p>
<p>Añade este secreto a los Secretos de Colab (el símbolo de la "llave" en el panel izquierdo) Si estás en otro entorno de colab que no sea Google, sustituye tú mismo el código relacionado con google colab</p>
<ul>
<li>AIMON_API_KEY</li>
</ul></li>
<li><p>Regístrate para obtener una <a href="https://platform.openai.com/docs/overview">cuenta OpenAI aquí</a> y añade la siguiente clave en Colab secrets:</p>
<ul>
<li>OPENAI_API_KEY</li>
</ul></li>
</ol>
<h3 id="Required-API-keys" class="common-anchor-header">Claves API necesarias</h3><pre><code translate="no" class="language-python"><span class="hljs-keyword">import</span> os
...
<h3 id="Analysis" class="common-anchor-header">Análisis</h3><p>Tenemos 258 transcripciones con un total de aproximadamente 1 millón de tokens. Tenemos una media de 3.864 tokens por transcripción.</p>
<table>
<thead>
...
<h3 id="Queries" class="common-anchor-header">Consultas</h3><p>A continuación se muestran las 12 consultas que realizaremos en la transcripción anterior</p>
...
<table border="1" class="dataframe">
  <thead>
    <tr style="text-align: right;">
      ...
      <th>Puntuación de relevancia de recuperación</th>
...
<p>La tabla anterior resume nuestros resultados. Sus cifras reales variarán en función de diversos factores, como las variaciones en la calidad de las respuestas LLM, el rendimiento de la búsqueda del vecino más próximo en VectorDB, etc.</p>
