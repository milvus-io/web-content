...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Prepare-the-LLM-and-Embedding-Model" class="common-anchor-header">Preparar el LLM y el modelo de incrustación</h3><p>Lepton habilita la API estilo OpenAI, y puedes usar la misma API con pequeños ajustes para llamar al LLM.</p>
