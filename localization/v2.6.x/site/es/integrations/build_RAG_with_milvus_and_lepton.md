...
summary: >-
  ...
  (Retrieval-Augmented Generation) con Milvus y Lepton AI.
title: Construir RAG con Milvus y Lepton AIAbout to Deprecate
---
<h1 id="Build-RAG-with-Milvus-and-Lepton-AI" class="common-anchor-header">Construir RAG con Milvus y Lepton AI<span class="beta-tag" style="background-color:#FF7F47;color:white" translate="no">About to Deprecate</span><button data-href="#Build-RAG-with-Milvus-and-Lepton-AI" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>En este tutorial, le mostraremos cómo construir un pipeline RAG (Retrieval-Augmented Generation) con Milvus y Lepton AI.</p>
...
<h3 id="Prepare-the-LLM-and-Embedding-Model" class="common-anchor-header">Preparar el LLM y el modelo de incrustación<button data-href="#Prepare-the-LLM-and-Embedding-Model" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Lepton habilita la API estilo OpenAI, y puedes utilizar la misma API con pequeños ajustes para llamar al LLM.</p>
...
&quot;&quot;&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>Utilice el modelo <code translate="no">mistral-7b</code> proporcionado por Lepton AI para generar una respuesta basada en las instrucciones.</p>
...
<p>Muy bien. Hemos construido con éxito una canalización RAG con Milvus y Lepton AI.</p>
