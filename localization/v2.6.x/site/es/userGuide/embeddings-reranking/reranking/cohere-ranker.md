...
<table>
   ...
   <tr>
     ...
     <td><p>Sí</p></td>
     <td><p>El modelo Cohere rerank a utilizar de entre los modelos soportados en la plataforma Cohere. Para obtener una lista de los modelos rerank disponibles, consulte <a href="https://docs.cohere.com/docs/rerank">la documentación de Cohere</a>.</p></td>
