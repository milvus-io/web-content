...
<li><p><code translate="no">decay</code> (0.5): La puntuación a la distancia de escala: este parámetro controla la velocidad de disminución de la relevancia.</p></li>
