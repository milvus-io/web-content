...
<ul>
<li><p>Para cada uno de los subvectores de <code translate="no">m</code>, recupere la distancia precalculada de la tabla de búsqueda correspondiente utilizando el índice centroide almacenado.</p></li>
