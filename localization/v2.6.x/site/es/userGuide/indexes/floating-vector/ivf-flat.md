...
<li><p><strong>Plano:</strong> Indica que dentro de cada cluster, los vectores se almacenan en su forma original (estructura plana), sin ningún tipo de compresión o cuantificación, para cálculos de distancia precisos.</p></li>
</ul>
