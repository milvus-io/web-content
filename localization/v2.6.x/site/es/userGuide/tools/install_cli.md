...
<h3 id="Install-via-pip" class="common-anchor-header">Instalar mediante pip<button data-href="#Install-via-pip" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Ejecute el siguiente comando para instalar Milvus_CLI.</p>
...
<h3 id="Prerequisites" class="common-anchor-header">Requisitos previos<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Se requiere Docker 19.03 o posterior.</p>
<h3 id="Install-based-on-Docker-image" class="common-anchor-header">Instalación basada en imagen Docker<button data-href="#Install-based-on-Docker-image" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Install-from-an-exe-file" class="common-anchor-header">Instalar desde un archivo .exe<button data-href="#Install-from-an-exe-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><div class="alert note"> Este método de instalación sólo se aplica a Windows. </div>
