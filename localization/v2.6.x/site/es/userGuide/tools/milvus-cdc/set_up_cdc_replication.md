...
<p>Antes de comenzar, lea <a href="/docs/es/v2.6.x/milvus_cdc_overview.md">Milvus CDC</a> para comprender el modelo primario-standby y las opciones de conmutación por error.</p>
...
<li>Si el lag es alto, la conmutación por error puede perder más datos.</li>
</ul>
