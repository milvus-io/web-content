...
<h1 id="Range-Search" class="common-anchor-header">Búsqueda por rango<button data-href="#Range-Search" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Una búsqueda por rango mejora la relevancia de los resultados de la búsqueda restringiendo la distancia o puntuación de las entidades devueltas dentro de un rango específico. Esta página le ayuda a entender qué es la búsqueda por rango y los procedimientos para realizar una búsqueda por rango.</p>
...
<p>Si los vectores de consulta ya existen en la colección de destino, considere la posibilidad de utilizar <code translate="no">ids</code> en lugar de recuperarlos antes de las búsquedas. Para obtener más información, consulte <a href="/docs/es/v2.6.x/primary-key-search.md">Primary-Key Search</a>.</p>
</div>
