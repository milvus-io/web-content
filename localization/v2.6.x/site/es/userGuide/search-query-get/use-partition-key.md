...
<ul>
<li><p><a href="/docs/es/v2.6.x/use-partition-key.md#Set-Partition-Key">Establecer la Clave de Partición</a>,</p></li>
<li><p><a href="/docs/es/v2.6.x/use-partition-key.md#Set-Partition-Numbers">Establecer el número de particiones a crear</a> (Opcional), y</p></li>
<li><p><a href="/docs/es/v2.6.x/use-partition-key.md#Create-Filtering-Condition">Crear una condición de filtrado basada en la Clave de Partición</a>.</p></li>
</ul>
