...
summary: >-
  Milvus ofrece potentes operadores para consultar campos de matriz, lo que te
  permite filtrar y recuperar entidades en función del contenido de las
  matrices.
---
<h1 id="ARRAY-Operators" class="common-anchor-header">Operadores de matrices<button data-href="#ARRAY-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Available-ARRAY-Operators" class="common-anchor-header">Operadores ARRAY disponibles<button data-href="#Available-ARRAY-Operators" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Los operadores ARRAY permiten realizar consultas detalladas de campos de matriz en Milvus. Estos operadores son:</p>
<ul>
<li><p><a href="/docs/es/v2.6.x/array-operators.md#ARRAYCONTAINS"><code translate="no">ARRAY_CONTAINS(identifier, expr)</code></a>: comprueba si un elemento específico existe en un campo de tipo ARRAY.</p></li>
<li><p><a href="/docs/es/v2.6.x/array-operators.md#ARRAYCONTAINSALL"><code translate="no">ARRAY_CONTAINS_ALL(identifier, expr)</code></a>: garantiza que todos los elementos de la lista especificada estén presentes en el campo de matriz.</p></li>
<li><p><a href="/docs/es/v2.6.x/array-operators.md#ARRAYCONTAINSANY"><code translate="no">ARRAY_CONTAINS_ANY(identifier, expr)</code></a>: comprueba si alguno de los elementos de la lista especificada está presente en el campo de matriz.</p></li>
<li><p><a href="/docs/es/v2.6.x/array-operators.md#ARRAYLENGTH"><code translate="no">ARRAY_LENGTH(identifier)</code></a>: devuelve el número de elementos de un campo de matriz y puede combinarse con operadores de comparación para filtrar.</p></li>
</ul>
<h2 id="ARRAYCONTAINS" class="common-anchor-header">ARRAY_CONTAINS<button data-href="#ARRAYCONTAINS" class="anchor-icon" translate="no">
    ...
    </button></h2><p>El operador « <code translate="no">ARRAY_CONTAINS</code> » comprueba si un elemento específico existe en un campo de matriz. Resulta útil cuando se desea encontrar entidades en las que un elemento determinado esté presente en la matriz.</p>
