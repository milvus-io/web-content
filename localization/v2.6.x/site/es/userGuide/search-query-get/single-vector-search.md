...
<p>La siguiente tabla muestra cómo establecer los parámetros <strong>Límite</strong> y <strong>Desplazamiento</strong> para consultas paginadas cuando se devuelven 100 entidades a la vez.</p>
<table>
   <tr>
     <th><p>Consultas</p></th>
