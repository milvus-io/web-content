...
<h3 id="Quick-setup" class="common-anchor-header">Configuración rápida<button data-href="#Quick-setup" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Con el gran salto en la industria de la IA como telón de fondo, la mayoría de los desarrolladores sólo necesitan una colección sencilla pero dinámica para empezar. Milvus permite una configuración rápida de dicha colección con sólo tres argumentos:</p>
<ul>
...
<h3 id="Customized-setup" class="common-anchor-header">Configuración personalizada<button data-href="#Customized-setup" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>En lugar de dejar que Milvus decida casi todo para su colección, puede determinar el <strong>esquema</strong> y los <strong>parámetros de indexación</strong> de la colección por su cuenta.</p>
...
<div class="language-go">
<p>Para comprobar los detalles de una colección existente, utilice <a href="https://milvus.io/api-reference/go/v2.4.x/Collection/DescribeCollection.md">describe_coleccion()</a>.</p>
</div>
<div class="language-shell">
...
<h3 id="Load-a-collection" class="common-anchor-header">Cargar una colección<button data-href="#Load-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<div class="language-go">
<p>Para cargar una colección, utilice el método <a href="https://milvus.io/api-reference/go/v2.4.x/Collection/LoadCollection.md"><code translate="no">LoadCollection()</code></a> especificando el nombre de la colección.</p>
</div>
<div class="language-shell">
...
<span class="hljs-meta prompt_"># </span><span class="language-bash">}</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Load-a-collection-partially-Public-Preview" class="common-anchor-header">Cargar una colección parcialmente (Vista previa pública)<button data-href="#Load-a-collection-partially-Public-Preview" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Release-a-collection" class="common-anchor-header">Liberar una colección<button data-href="#Release-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<div class="language-go">
<p>Para liberar una colección, utilice el método <a href="https://milvus.io/api-reference/go/v2.4.x/Collection/ReleaseCollection.md"><code translate="no">ReleaseCollection()</code></a> especificando el nombre de la colección.</p>
</div>
<div class="language-shell">
...
<h3 id="Create-aliases" class="common-anchor-header">Crear alias<button data-href="#Create-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="List-aliases" class="common-anchor-header">Lista de alias<button data-href="#List-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash"><span class="hljs-string">}</span></span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Describe-aliases" class="common-anchor-header">Describir alias<button data-href="#Describe-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash"><span class="hljs-string">}</span></span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Reassign-aliases" class="common-anchor-header">Reasignar alias<button data-href="#Reassign-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash"><span class="hljs-string">}</span></span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Drop-aliases" class="common-anchor-header">Eliminar alias<button data-href="#Drop-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Set-TTL" class="common-anchor-header">Establecer TTL<button data-href="#Set-TTL" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Establece el tiempo de vida (TTL) para los datos de la colección, que especifica cuánto tiempo deben conservarse los datos antes de que se eliminen automáticamente.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Set-MMAP" class="common-anchor-header">Establecer MMAP<button data-href="#Set-MMAP" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<div class="language-go">
<p>Para eliminar una colección, utilice el método <a href="https://milvus.io/api-reference/go/v2.4.x/Collection/DropCollection.md"><code translate="no">DropCollection()</code></a> especificando el nombre de la colección.</p>
</div>
<div class="language-shell">
