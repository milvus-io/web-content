...
<button class="copy-code-btn"></button></code></pre>
<p>También puede indexar sólo una parte de la estructura JSON, como toda la información de <code translate="no">supplier</code>:</p>
