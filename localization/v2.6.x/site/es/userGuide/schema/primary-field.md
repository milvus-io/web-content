...
<p>Si no está seguro de qué modo elegir, <a href="/docs/es/primary-field.md#Quickstart-Use-AutoID">empiece con AutoID</a> para una ingestión más sencilla y una unicidad garantizada.</p>
</div>
...
<h3 id="Step-1-Create-a-collection-with-AutoID" class="common-anchor-header">Paso 1: Crear una colección con AutoID<button data-href="#Step-1-Create-a-collection-with-AutoID" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Habilite <code translate="no">auto_id=True</code> en la definición de su campo primario. Milvus manejará la generación de ID automáticamente.</p>
...
<h3 id="Ensure-global-AutoID-uniqueness-across-clusters" class="common-anchor-header">Asegurar la unicidad global de AutoID entre clusters<button data-href="#Ensure-global-AutoID-uniqueness-across-clusters" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Cuando ejecute múltiples clusters de Milvus, configure un ID de cluster único para cada uno para asegurar que los AutoIDs nunca se superpongan.</p>
