...
summary: >-
  ...
  misma estructura de datos con su colección principal, pero contiene sólo un
...
<p>Esta característica no será discutida en esta página. Para más información, consulte <a href="/docs/es/v2.6.x/use-partition-key.md">Utilizar clave de partición</a>.</p>
</div>
<h2 id="List-Partitions" class="common-anchor-header">Listar Particiones<button data-href="#List-Partitions" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Cuando se crea una colección, Milvus también crea una partición llamada <strong>_default</strong> en la colección. Puede listar las particiones en una colección de la siguiente manera.</p>
...
<h3 id="Load-Partitions" class="common-anchor-header">Cargar Particiones<button data-href="#Load-Partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Puedes cargar por separado particiones específicas en una colección. Cabe destacar que el estado de carga de una colección permanece sin cargar si hay una partición sin cargar en la colección.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<span class="hljs-comment"># }</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Release-Partitions" class="common-anchor-header">Liberar particiones<button data-href="#Release-Partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>También puedes liberar particiones específicas.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<h2 id="Data-Operations-Within-Partitions" class="common-anchor-header">Operaciones de Datos dentro de Particiones<button data-href="#Data-Operations-Within-Partitions" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Insert-and-Delete-Entities" class="common-anchor-header">Insertar y Borrar Entidades<button data-href="#Insert-and-Delete-Entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Puede realizar operaciones de inserción, inserción ascendente y eliminación en operaciones específicas. Para más detalles, consulte</p>
<ul>
<li><p><a href="/docs/es/v2.6.x/insert-update-delete.md#Insert-Entities-into-a-Partition">Insertar Entidades en una Partición</a></p></li>
<li><p><a href="/docs/es/v2.6.x/upsert-entities.md#Upsert-Entities-in-a-Partition">Insertar Entidades en la Partición</a></p></li>
<li><p><a href="/docs/es/v2.6.x/delete-entities.md#Delete-Entities-from-Partitions">Borrar Entidades de la Partición</a></p></li>
</ul>
<h3 id="Search-and-Query" class="common-anchor-header">Búsqueda y Consulta<button data-href="#Search-and-Query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Puede realizar búsquedas y consultas dentro de particiones específicas. Para más detalles, consulte</p>
<ul>
<li><p><a href="/docs/es/v2.6.x/single-vector-search.md#ANN-Search-in-Partition">Realizar Búsquedas RNA dentro de Particiones</a></p></li>
<li><p><a href="/docs/es/v2.6.x/get-and-scalar-query.md#Queries-in-Partitions">Filtrado de metadatos en particiones</a></p></li>
</ul>
