...
<p>كمرجع، سيتم إهمال <a href="https://grafana.com/docs/loki/latest/send-data/promtail/#promtail-agent">برومتيل،</a> لذا سنقدم لك سبيكة، التي اقترحتها مختبرات Grafana رسميًا كعامل جديد لجمع سجلات Kubernetes وإعادة توجيهها إلى Loki.</p>
