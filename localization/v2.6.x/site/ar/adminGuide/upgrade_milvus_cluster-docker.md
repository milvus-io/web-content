...
<p>في الحالات العادية، يمكنك <a href="#Upgrade-Milvus-by-changing-its-image">ترقية Milvus عن طريق تغيير صورته</a>. ومع ذلك، تحتاج إلى <a href="#Migrate-the-metadata">ترحيل البيانات الوصفية</a> قبل أي ترقية من الإصدار v2.1.x إلى الإصدار v2.6.22.</p>
