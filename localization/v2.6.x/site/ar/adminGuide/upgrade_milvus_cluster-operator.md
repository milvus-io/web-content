...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">ترقية مجموعة Milvus باستخدام Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>يصف هذا الدليل كيفية ترقية مجموعة Milvus الخاصة بك من الإصدار v2.5.x إلى الإصدار v2.6.17 باستخدام Milvus Operator.</p>
<h2 id="Before-you-start" class="common-anchor-header">قبل البدء<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>تتضمن الترقية من Milvus 2.5.x إلى 2.6.17 تغييرات هيكلية كبيرة:</p>
<ul>
...
<p>تضمن عملية الترقية هذه الترحيل السليم إلى البنية الجديدة. لمزيد من المعلومات حول تغييرات البنية، يرجى الرجوع إلى <a href="/docs/ar/v2.6.x/architecture_overview.md">«نظرة عامة على بنية Milvus</a>».</p>
...
<li><strong>يجب</strong> عليك الترقية إلى الإصدار v2.5.16 أو أحدث مع تمكين ميزة " <code translate="no">mixCoord</code> " قبل الترقية إلى الإصدار v2.6.17.</li>
</ul>
...
<p>قم بإنشاء ملف تكوين <code translate="no">milvusupgrade.yaml</code> لتمكين <code translate="no">mixCoord</code> والترقية إلى الإصدار v2.5.16:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2617" class="common-anchor-header">2.3 الترقية إلى الإصدار v2.6.17</h4><p>بمجرد تشغيل الإصدار v2.5.16 بنجاح مع ميزة " <code translate="no">mixCoord</code>" ، قم بالترقية إلى الإصدار v2.6.17:</p>
