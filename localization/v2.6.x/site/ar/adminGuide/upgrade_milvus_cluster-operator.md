...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Upgrade-your-Milvus-cluster" class="common-anchor-header">الخطوة 2: ترقية مجموعة ميلفوس الخاصة بك</h3><h4 id="21-Check-current-coordinator-configuration" class="common-anchor-header">2.1 تحقق من تكوين المنسق الحالي</h4><p>تحقق مما إذا كانت مجموعتك تستخدم بالفعل <code translate="no">mixCoord</code>:</p>
