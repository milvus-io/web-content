...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">ترقية مجموعة Milvus العنقودية باستخدام مشغل Milvus<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>يصف هذا الدليل كيفية ترقية مجموعة Milvus العنقودية من الإصدار 2.5.x إلى الإصدار 2.6.10 باستخدام مشغل Milvus.</p>
<h2 id="Before-you-start" class="common-anchor-header">قبل البدء<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v2610" class="common-anchor-header">ما الجديد في الإصدار 2.6.10<button data-href="#Whats-new-in-v2610" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><strong>يجب</strong> الترقية إلى الإصدار 2.5.16 أو أحدث مع تمكين <code translate="no">mixCoord</code> قبل الترقية إلى الإصدار 2.6.10.</li>
</ul>
<p><strong>قيود قائمة انتظار الرسائل</strong>: عند الترقية إلى الإصدار 2.6.9 من Milvus، يجب أن تحافظ على اختيار قائمة انتظار الرسائل الحالية. لا يتم دعم التبديل بين أنظمة طابور الرسائل المختلفة أثناء الترقية. سيتوفر دعم تغيير أنظمة قائمة انتظار الرسائل في الإصدارات المستقبلية.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2610" class="common-anchor-header">2.3 الترقية إلى الإصدار 2.6.10</h4><p>بمجرد تشغيل الإصدار 2.5.16 بنجاح مع <code translate="no">mixCoord</code> ، قم بالترقية إلى الإصدار 2.6.10:</p>
