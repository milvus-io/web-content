...
<h2 id="Before-you-start" class="common-anchor-header">قبل البدء<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>تتضمن الترقية من الإصدار 2.5.x من Milvus 2.5.x إلى الإصدار 2.6.0 تغييرات معمارية كبيرة:</p>
<ul>
...
<h3 id="Step-2-Upgrade-to-v260" class="common-anchor-header">الخطوة 2: الترقية إلى الإصدار 2.6.0<button data-href="#Step-2-Upgrade-to-v260" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>بمجرد تشغيل الإصدار 2.5.16 بنجاح، قم بالترقية إلى الإصدار 2.6.0:</p>
<ol>
