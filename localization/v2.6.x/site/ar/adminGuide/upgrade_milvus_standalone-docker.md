...
summary: تعرف على كيفية ترقية إصدار Milvus المستقل باستخدام Docker Compose.
...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">ترقية Milvus Standalone باستخدام Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>يصف هذا الدليل كيفية ترقية النشر المستقل لـ Milvus من الإصدار v2.5.x إلى الإصدار v2.6.24 باستخدام Docker Compose.</p>
...
<p>نظرًا لمخاوف أمنية، يقوم Milvus بترقية MinIO إلى الإصدار RELEASE.2024-12-18T13-15-44Z مع إصدار الإصدار v2.6.24.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v2624" class="common-anchor-header">الخطوة 2: الترقية إلى الإصدار v2.6.24<button data-href="#Step-2-Upgrade-to-v2624" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>بمجرد تشغيل الإصدار v2.5.16 بنجاح، قم بالترقية إلى الإصدار v2.6.24:</p>
<ol>
