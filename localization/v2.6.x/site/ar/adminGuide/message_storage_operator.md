...
<h2 id="Configure-Kafka" class="common-anchor-header">تكوين Kafka<button data-href="#Configure-Kafka" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يُعد Pulsar مخزن الرسائل الافتراضي في مجموعة Milvus. إذا كنت ترغب في استخدام Kafka، فقم بإضافة الحقل الاختياري <code translate="no">msgStreamType</code> لتكوين Kafka.</p>
