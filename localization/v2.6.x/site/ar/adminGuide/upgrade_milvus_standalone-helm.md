...
<h2 id="Before-you-start" class="common-anchor-header">قبل البدء<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>تتضمن عملية الترقية من Milvus 2.5.x إلى 2.6.17 تغييرات كبيرة في البنية:</p>
<ul>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>غير متوافق</strong> مع الإصدار v2.6.17. لا يتم دعم الترقيات المباشرة من الإصدارات المرشحة.</li>
<li>إذا كنت تستخدم الإصدار v2.6.0-rc1 حاليًا وتحتاج إلى الاحتفاظ ببياناتك، فيُرجى الرجوع إلى <a href="https://github.com/milvus-io/milvus/issues/43538#issuecomment-3112808997">دليل المجتمع هذا</a> للحصول على المساعدة في عملية الترحيل.</li>
<li><strong>يجب</strong> الترقية إلى الإصدار v2.5.16 أو أحدث قبل الترقية إلى الإصدار v2.6.17.</li>
</ul>
...
بدءًا من الإصدار 4.2.21 من مخطط Helm الخاص بـ Milvus، أدخلنا مخطط pulsar-v3.x كاعتمادية. من أجل التوافق مع الإصدارات السابقة، يرجى ترقية Helm إلى الإصدار v3.14 أو أحدث، وتأكد من إضافة الخيار <code translate="no">--reset-then-reuse-values</code> كلما استخدمت <code translate="no">helm upgrade</code>.
</div>
...
<p>تخطّ هذه الخطوة إذا كان نشر Milvus المستقل الخاص بك يعمل بالفعل بالإصدار v2.5.16 أو أعلى.</p>
</div>
