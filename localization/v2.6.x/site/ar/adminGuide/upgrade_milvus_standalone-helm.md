...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">ترقية Milvus Standalone باستخدام مخطط Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>يصف هذا الدليل كيفية ترقية النشر المستقل لـ Milvus من الإصدار 2.5.x إلى الإصدار 2.6.18 باستخدام مخطط Helm Chart.</p>
...
<ul>
<li>الإصدار Milvus v2.6.0-rc1 <strong>غير متوافق</strong> مع الإصدار 2.6.18. الترقيات المباشرة من الإصدارات المرشحة غير مدعومة.</li>
