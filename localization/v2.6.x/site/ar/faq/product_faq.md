...
<p>بالنسبة للأنظمة الأساسية x86، يجب أن تدعم وحدة المعالجة المركزية الخاصة بك إحدى مجموعات التعليمات التالية للحصول على الأداء الأمثل: sse4.2، avx، avx2، avx512. بالنسبة لمنصات ARM، يمكن تشغيل Milvus على المعالجات القائمة على ARM64 بما في ذلك رقائق Apple M1/M2 وأنظمة ARM64 الأخرى.</p>
