...
title: استخدام حقول المصفوفات
---
<h1 id="Use-Array-Fields" class="common-anchor-header">استخدام حقول المصفوفات<button data-href="#Use-Array-Fields" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>يشرح هذا الدليل كيفية استخدام حقول المصفوفات، مثل إدراج قيم المصفوفات، وإنشاء فهارس على حقول المصفوفات والمتجهات، بالإضافة إلى البحث والاستعلام في حقول المصفوفات باستخدام عوامل التشغيل الأساسية والمتقدمة.</p>
<h2 id="Prerequisites" class="common-anchor-header">المتطلبات الأساسية<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p>تأكد من أن لديك ما يلي:</p>
<ul>
<li>ميلفوس مثبتاً ومشغلاً. للحصول على معلومات حول كيفية تثبيت Milvus، راجع <a href="/docs/ar/install-overview.md">تثبيت Milvus</a>.</li>
<li>تثبيت أحد حزم Milvus SDKs في بيئتك. للحصول على التفاصيل، راجع <a href="/docs/ar/install-pymilvus.md">تثبيت حزم SDKs</a>.</li>
</ul>
<h2 id="Prepare-data-with-an-array-field" class="common-anchor-header">إعداد البيانات مع حقل مصفوفة<button data-href="#Prepare-data-with-an-array-field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>يدعم Milvus المصفوفات كأحد أنواع بيانات الحقل. يجب أن تحتوي المصفوفة في مجموعة Milvus دائمًا على عناصر من نفس نوع البيانات، ويمكن أن يكون نوع البيانات لعناصر المصفوفة أيًا من أنواع البيانات المدعومة في Milvus. للحصول على قائمة بأنواع البيانات المدعومة، راجع <a href="https://milvus.io/docs/schema.md#Supported-data-types">أنواع البيانات المدعومة</a>.</p>
<p>يقوم مقتطف التعليمات البرمجية التالية بإنشاء مجموعة بيانات عشوائية تحتوي على حقل مصفوفة باسم <code translate="no">color_coord</code> ، مع جميع عناصر نوع بيانات interger.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>يقوم هذا المقتطف البرمجي بإعداد قائمة من الألوان العشوائية وإنشاء مجموعة بيانات تحتوي على 1000 كيان. يحتوي كل كيان على معرّف، ومتجه من خمسة أرقام ذات فاصلة عائمة، ولون، وعلامة لون، وحقل صفيف <code translate="no">color_coord</code> يحتوي على ما بين 3 إلى 5 قيم صحيحة. تتم طباعة بيانات العينة للتحقق من بنيتها.</p>
<p>هيكل الإخراج:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Set-up-MilvusClient" class="common-anchor-header">إعداد MilvusClient<button data-href="#Set-up-MilvusClient" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>للتفاعل مع Milvus، قم بإعداد عميل Milvus من خلال تحديد عنوان الخادم.</p>
<div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا</a> <a href="#javascript">Node.js</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Create-a-collection-with-an-array-field" class="common-anchor-header">إنشاء مجموعة مع حقل مصفوفة<button data-href="#Create-a-collection-with-an-array-field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><h3 id="Define-collection-schema" class="common-anchor-header">تعريف مخطط المجموعة<button data-href="#Define-collection-schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>يحدد المخطط بنية المجموعة، بما في ذلك الحقول وأنواع بياناتها. يُعرّف المثال أدناه مخطط مجموعة يطابق نموذج البيانات التي تم إنشاؤها في <a href="#prepare-data-with-an-array-field">القسم السابق</a>.</p>
<p>لتكوين حقل مصفوفة في مجموعة:</p>
<div class="language-python">
<ol>
<li>قم بتعيين <code translate="no">datatype</code>: قم بتكوينه على أنه <code translate="no">DataType.ARRAY</code>.</li>
<li>حدد <code translate="no">element_type</code>: اختر نوع البيانات للعناصر في المصفوفة. يجب أن يكون لجميع العناصر في حقل الصفيف نفس نوع البيانات. في هذا المثال، يتم تعيين <code translate="no">element_type</code> على <code translate="no">DataType.INT64</code>.</li>
<li>قم بتعيين <code translate="no">max_capacity</code>: قم بتعيين هذه المعلمة لتحديد الحد الأقصى لعدد العناصر التي يمكن أن يحتفظ بها حقل المصفوفة.</li>
</ol>
</div>
<div class="language-java">
<ol>
<li>قم بتعيين <code translate="no">dataType</code>: قم بتكوينه على أنه <code translate="no">DataType.Array</code>.</li>
<li>حدد <code translate="no">elementType</code>: اختر نوع البيانات للعناصر في المصفوفة. يجب أن يكون لجميع العناصر في حقل الصفيف نفس نوع البيانات. في هذا المثال، يتم تعيين <code translate="no">elementType</code> على <code translate="no">DataType.Int64</code>.</li>
<li>قم بتعيين <code translate="no">maxCapacity</code>: قم بتعيين هذه المعلمة لتحديد الحد الأقصى لعدد العناصر التي يمكن أن يحتفظ بها حقل المصفوفة.</li>
</ol>
</div>
<div class="language-javascript">
<ol>
<li>قم بتعيين <code translate="no">data_type</code>: قم بتكوينه على أنه <code translate="no">DataType.Array</code>.</li>
<li>حدد <code translate="no">element_type</code>: اختر نوع البيانات للعناصر في المصفوفة. يجب أن يكون لجميع العناصر في حقل الصفيف نفس نوع البيانات. في هذا المثال، يتم تعيين <code translate="no">element_type</code> على <code translate="no">DataType.Int64</code>.</li>
<li>تحديد <code translate="no">max_capacity</code>: قم بتعيين هذه المعلمة لتحديد الحد الأقصى لعدد العناصر التي يمكن أن يحتفظ بها حقل المصفوفة.</li>
</ol>
</div>
<p>يعرّف المثال البرمجي أدناه مخطط المجموعة مع حقل مصفوفة <code translate="no">color_coord</code> ، بحد أقصى 5 عناصر وكل عنصر من نوع البيانات الصحيحة.</p>
<div class="multipleCode">
...
<button class="copy-code-btn"></button></code></pre>
<div class="language-python">
<p>لمزيد من المعلومات حول الأساليب والمعلمات راجع <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_schema.md">إنشاء_شيما</a> <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/CollectionSchema/add_field.md">وإضافة_حقل</a>.</p>
</div>
<div class="language-java">
<p>لمزيد من المعلومات حول الأساليب والمعلمات ارجع إلى <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createSchema.md">createSchema</a> و <a href="https://milvus.io/api-reference/java/v2.4.x/v2/CollectionSchema/addField.md">addField</a>.</p>
</div>
<div class="language-javascript">
<p>لمزيد من المعلومات حول الأساليب والمعلمات راجع <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md">createCollection (إنشاء مجموعة</a>).</p>
</div>
<h3 id="Create-the-collection" class="common-anchor-header">إنشاء المجموعة<button data-href="#Create-the-collection" class="anchor-icon" translate="no">
    ...
    </button></h3><p>بعد ذلك، قم بإنشاء المجموعة باستخدام المخطط المحدد.</p>
<div class="multipleCode">
...
<button class="copy-code-btn"></button></code></pre>
<div class="language-python">
<p>للمزيد من المعلومات حول الأساليب والمعلمات ارجع إلى <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_collection.md">create_collection</a> و <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/list_collections.md">list_collections</a>.</p>
</div>
<div class="language-java">
<p>لمزيد من المعلومات حول الأساليب والمعلمات ارجع إلى <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createCollection.md">createCollection</a>.</p>
</div>
<div class="language-javascript">
<p>لمزيد من المعلومات حول الأساليب والمعلمات ارجع إلى <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md">createCollection</a> و <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/listCollections.md">listCollections</a>.</p>
</div>
<h2 id="Create-indexes" class="common-anchor-header">إنشاء فهارس<button data-href="#Create-indexes" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>تعمل الفهارس على تحسين أداء عمليات البحث والاستعلام. في ميلفوس، يمكنك إنشاء فهارس على كل من الحقول المتجهة والحقول القياسية. في هذا المثال، سنقوم بإنشاء فهرس <code translate="no">IVF_FLAT</code> على الحقل المتجه <code translate="no">vector</code> وفهرس <code translate="no">INVERTED</code> على الحقل الصفيف <code translate="no">color_coord</code>. لمزيد من المعلومات حول الفهارس، راجع <a href="https://milvus.io/docs/index-vector-fields.md?tab=floating">فهرس الحقول المتجهة</a> <a href="https://milvus.io/docs/index-scalar-fields.md">وفهرس الحقول القياسية</a>.</p>
<h3 id="Index-vector-field" class="common-anchor-header">فهرس الحقل المتجه<button data-href="#Index-vector-field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>يمكن أن يؤدي إنشاء فهرس على حقل متجه إلى تحسين أداء البحث عن تشابه المتجهات، وهو أمر ضروري لكل عملية بحث.</p>
<p>يقوم المثال أدناه بإنشاء فهرس من النوع <code translate="no">IVF_FLAT</code> على الحقل المتجه <code translate="no">vector</code>.</p>
<div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا جافا</a> <a href="#javascript">Node.js</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<div class="language-python">
<p>لمزيد من المعلومات حول الأساليب والمعلمات ارجع إلى <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/prepare_index_params.md">Prep_index_params</a> <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/create_index.md">وCreat_index</a> <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/describe_index.md">وSow_index</a>.</p>
</div>
<div class="language-java">
<p>لمزيد من المعلومات حول الطرق والمعلمات راجع <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Management/IndexParam.md">فهرس_بارام</a> و <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Management/createIndex.md">إنشاء_الفهرس</a>.</p>
</div>
<div class="language-javascript">
<p>لمزيد من المعلومات حول الأساليب والمعلمات ارجع إلى <a href="https://milvus.io/api-reference/node/v2.4.x/Management/createIndex.md">إنشاء_الفهرس</a> <a href="https://milvus.io/api-reference/node/v2.4.x/Management/describeIndex.md">ووصف_الفهرس</a>.</p>
</div>
<h3 id="Index-array-field" class="common-anchor-header">حقل صفيف الفهرس<button data-href="#Index-array-field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>يمكن أن يؤدي إنشاء فهرس على حقل قياسي إلى تحسين أداء استرجاع الاستعلامات على ذلك الحقل، وهو أمر اختياري لكن يوصى به لمجموعات البيانات الكبيرة.</p>
<p>في هذا المثال، سننشئ فهرسًا مقلوبًا على حقل الصفيف <code translate="no">color_coord</code>. سيسمح لنا ذلك بتسريع عملية التصفية بناءً على هذا الحقل. يُظهر الفهرس المقلوب أداءً إجماليًا ممتازًا، حيث يتفوق بشكل كبير على التصفية باستخدام القوة الغاشمة باستخدام البيانات الأولية عندما لا يتم استرجاع البيانات بشكل متكرر، ويحافظ على أداء مماثل مع عمليات الاسترجاع المتكررة. لمزيد من المعلومات حول الفهارس المقلوبة، راجع <a href="/docs/ar/scalar_index.md#Inverted-indexing">الفهرس المقلوب، راجع فهرس Scalar Index</a>.</p>
<div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا</a> <a href="#javascript">Node.js</a></div>
<pre><code translate="no" class="language-python">index_params = client.prepare_index_params()
...
<button class="copy-code-btn"></button></code></pre>
<div class="language-python">
<p>لمزيد من المعلومات حول الأساليب والمعلمات ارجع إلى <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/prepare_index_params.md">Prep_index_params</a> و <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/create_index.md">create_index</a> و <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/describe_index.md">describe_index</a>.</p>
</div>
<div class="language-java">
<p>لمزيد من المعلومات حول الطرق والمعلمات راجع <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Management/IndexParam.md">فهرس_بارام</a> و <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Management/createIndex.md">إنشاء_الفهرس</a>.</p>
</div>
...
<h2 id="Insert-data" class="common-anchor-header">إدراج البيانات<button data-href="#Insert-data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>بمجرد إنشاء المجموعة والفهارس، يمكننا إدراج البيانات في المجموعة. تقوم هذه الخطوة بإدراج 1000 كيان في <code translate="no">test_collection</code>.</p>
<div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا جافا</a> <a href="#javascript">Node.js</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Load-the-collection" class="common-anchor-header">تحميل المجموعة<button data-href="#Load-the-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>بعد إدراج البيانات، نحتاج إلى تحميل المجموعة لجعلها متاحة لعمليات البحث والاستعلام.</p>
<div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا جافا</a> <a href="#javascript">Node.js</a></div>
...
<h2 id="Basic-scalar-filtering" class="common-anchor-header">التصفية العددية الأساسية<button data-href="#Basic-scalar-filtering" class="anchor-icon" translate="no">
    ...
    </button></h2><p>بمجرد إضافة جميع بياناتك، يمكنك إجراء عمليات بحث واستعلامات باستخدام العناصر الموجودة في حقل الصفيف بنفس الطريقة التي تستخدمها مع الحقل القياسي القياسي.</p>
<div class="language-python">
...
<div class="language-java">
<p>لمزيد من المعلومات حول المعلمات، راجع <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/search.md"><code translate="no">search()</code></a> في مرجع SDK.</p>
</div>
<div class="language-javascript">
...
<span class="hljs-comment">// ]</span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Advanced-filtering" class="common-anchor-header">التصفية المتقدمة<button data-href="#Advanced-filtering" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>على غرار ما لدينا في حقل JSON، يوفر ميلفوس أيضًا عوامل تصفية متقدمة للمصفوفات، وهي <code translate="no">ARRAY_CONTAINS</code> ، <code translate="no">ARRAY_CONTAINS_ALL</code> ، ، <code translate="no">ARRAY_CONTAINS_ANY</code> ، و <code translate="no">ARRAY_LENGTH</code>. لمزيد من المعلومات عن المشغلات، راجع <a href="#reference-on-array-filters">مرجع عن مرشحات المصفوفات</a>.</p>
<ul>
<li><p>تصفية جميع الكيانات التي تحتوي على <code translate="no">10</code> في قيمها <code translate="no">color_coord</code>.</p>
...
<li><p>تصفية جميع الكيانات التي تحتوي على <code translate="no">7</code> و <code translate="no">8</code> في قيم <code translate="no">color_coord</code> الخاصة بها.</p>
<p><div class="multipleCode">
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>تصفية جميع الكيانات التي تحتوي على 7 أو 8 أو 9 في قيمها <code translate="no">color_coord</code>.</p>
<p><div class="multipleCode">
<a href="#python">بايثون </a><a href="#java">جافا</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;test_collection&quot;</span>,
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>تصفية الكيانات التي تحتوي على أربعة عناصر بالضبط.</p>
<p><div class="multipleCode">
<a href="#python">بايثون </a><a href="#java">جافا جافا</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;test_collection&quot;</span>,
...
<li><p>يجب أن تكون العناصر الموجودة في حقل ARRAY من نفس نوع البيانات، المحدد بواسطة <code translate="no">element_type</code>. يمكن استخدام أي نوع بيانات صالح متاح للحقول القياسية في ميلفوس <code translate="no">element_type</code>. للحصول على قائمة بأنواع البيانات المدعومة، راجع <a href="https://milvus.io/docs/schema.md#Supported-data-types">أنواع البيانات المدعومة</a>.</p></li>
<li><p>يجب أن يكون عدد العناصر في حقل ARRAY أقل من أو يساوي السعة القصوى لحقل المصفوفة، المحددة بواسطة <code translate="no">max_capacity</code>.</p></li>
</ul>
<h2 id="Reference-on-array-filters" class="common-anchor-header">مرجع عن مرشحات الصفيف<button data-href="#Reference-on-array-filters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>عند العمل مع حقول المصفوفات، يمكنك إحاطة قيمة السلسلة إما بعلامات اقتباس مزدوجة ("") أو علامات اقتباس مفردة (''). من المهم ملاحظة أن ميلفوس يخزن قيم السلسلة في حقل المصفوفة كما هي دون إجراء الهروب الدلالي أو التحويل. على سبيل المثال، سيتم حفظ <strong>"a'b" و</strong> <strong>"a'b" و"a'b"</strong> و" <strong>a'b</strong>" و <strong>"a</strong> <strong>'</strong> <strong>b</strong> " كما هي، بينما سيتم التعامل مع <strong>"a'b"</strong> و <strong>"a'b"</strong> كقيم غير صالحة.</p>
<p>افترض أنه تم تعريف حقلي مصفوفة <code translate="no">int_array</code> و <code translate="no">var_array</code>. يصف الجدول التالي التعبيرات المنطقية المدعومة التي يمكنك استخدامها في <code translate="no">expr</code> عند البحث باستخدام حقول الصفيف.</p>
<table>
<thead>
<tr><th>المشغل</th><th>أمثلة</th><th>ملاحظات</th></tr>
</thead>
<tbody>
<tr><td>&lt;</td><td><code translate="no">‘int_array[0] < 3’</code></td><td>يتم تقييم هذا التعبير إلى صواب إذا كانت قيمة <code translate="no">int_array[0]</code> أقل من 3.</td></tr>
<tr><td>&gt;</td><td><code translate="no">‘int_array[0] > 5’</code></td><td>يتم تقييم هذا التعبير إلى صواب إذا كانت قيمة <code translate="no">int_array[0]</code> أكبر من 5.</td></tr>
<tr><td>==</td><td><code translate="no">‘int_array[0] == 0’</code></td><td>يتم تقييم هذا التعبير إلى صواب إذا كانت قيمة <code translate="no">int_array[0]</code> تساوي 0.</td></tr>
<tr><td>!=</td><td><code translate="no">‘var_array[0] != "a"’</code></td><td>يتم تقييم هذا التعبير إلى صواب إذا كانت قيمة <code translate="no">var_array[0]</code> لا تساوي <code translate="no">“a”</code>.</td></tr>
<tr><td>&lt;=</td><td><code translate="no">‘int_array[0] <= 3’</code></td><td>يتم تقييم هذا التعبير إلى صواب إذا كانت قيمة <code translate="no">int_array[0]</code> أصغر من أو تساوي 3.</td></tr>
<tr><td>&gt;=</td><td><code translate="no">‘int_array[0] >= 10’</code></td><td>يتم تقييم هذا التعبير إلى صواب إذا كانت قيمة <code translate="no">int_array[0]</code> أكبر من أو تساوي 10.</td></tr>
<tr><td>في</td><td><code translate="no">'var_array[0] in ["str1", “str2”]'</code></td><td>يتم تقييم هذا التعبير إلى صواب إذا كانت قيمة <code translate="no">var_array[0]</code> هي <code translate="no">“str1”</code> أو <code translate="no">“str2”</code>.</td></tr>
<tr><td>ليس في</td><td><code translate="no">'int_array[0] not in [1, 2, 3]'</code></td><td>يتم تقييم هذا التعبير إلى صواب إذا كانت قيمة <code translate="no">int_array[0]</code> ليست 1 أو 2 أو 3.</td></tr>
<tr><td>+, -, *, /, %, **</td><td><code translate="no">‘int_array[0] + 100 > 200’</code></td><td>يتم تقييم هذا التعبير إلى صواب إذا كانت قيمة <code translate="no">int_array[0] + 100</code> أكبر من 200.</td></tr>
<tr><td>مثل (LIKE)</td><td><code translate="no">‘var_array[0] like "prefix%"’</code></td><td>يتم تقييم هذا التعبير على أنه صحيح إذا كانت قيمة <code translate="no">var_array[0]</code> مسبوقة ب <code translate="no">“prefix”</code>.</td></tr>
<tr><td>و (&amp;&amp;)</td><td><code translate="no">‘var_array[0] like “prefix%” && int_array[0] <= 100’</code></td><td>يتم تقييم هذا التعبير على أنه صواب إذا كانت قيمة <code translate="no">var_array[0]</code> مسبوقة بـ <code translate="no">“prefix”</code> ، وقيمة <code translate="no">int_array[0]</code> أصغر من أو تساوي 100.</td></tr>
<tr><td>أو (||)</td><td><code translate="no">‘var_array[0] like “prefix%” || int_array[0] <= 100’</code></td><td>يُقيّم هذا التعبير على أنه صواب إذا كانت قيمة <code translate="no">var_array[0]</code> مسبوقة ب <code translate="no">“prefix”</code> ، أو كانت قيمة <code translate="no">int_array[0]</code> أصغر من أو تساوي 100.</td></tr>
<tr><td>array_contains (ARRAY_CONTAINS)</td><td><code translate="no">'array_contains(int_array, 100)'</code></td><td>يتم تقييم هذا التعبير إلى صواب إذا كان <code translate="no">int_array</code> يحتوي على العنصر <code translate="no">100</code>.</td></tr>
<tr><td>array_contains_all (ARRAY_CONTAINS_ALL)</td><td><code translate="no">'array_contains_all(int_array, [1, 2, 3])'</code></td><td>يتم تقييم هذا التعبير إلى صواب إذا كان <code translate="no">int_array</code> يحتوي على جميع العناصر <code translate="no">1</code> و <code translate="no">2</code> و <code translate="no">3</code>.</td></tr>
<tr><td>array_contains_any (ARRAY_CONTAINS_ANY)</td><td><code translate="no">'array_contains_any(var_array, ["a", "b", “c”])'</code></td><td>يتم تقييم هذا التعبير على أنه صواب إذا كان <code translate="no">var_array</code> يحتوي على أي عنصر من <code translate="no">“a”</code> و <code translate="no">“b”</code> و <code translate="no">“c”</code>.</td></tr>
<tr><td>طول_المصفوفة</td><td><code translate="no">‘array_length(int_array) == 10’</code></td><td>يتم تقييم هذا التعبير إلى صواب إذا كان <code translate="no">int_array</code> يحتوي على 10 عناصر بالضبط.</td></tr>
</tbody>
</table>
