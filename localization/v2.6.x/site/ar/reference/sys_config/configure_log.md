...
summary: تعرف على كيفية تكوين السجل لـ Milvus.
---
<h1 id="log-related-Configurations" class="common-anchor-header">التكوينات المتعلقة بالسجل<button data-href="#log-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>تكوين إخراج سجل النظام.</p>
<h2 id="loglevel" class="common-anchor-header"><code translate="no">log.level</code><button data-href="#loglevel" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>مستوى سجل ميلفوس. الخيار: تصحيح، ومعلومات، وتحذير، وخطأ، وذعر، وقاتل. </li>      
        <li>يوصى باستخدام مستوى التصحيح في بيئات الاختبار والتطوير، ومستوى المعلومات في بيئة الإنتاج.</li>      </td>
      <td>معلومات</td>
    </tr>
  </tbody>
</table>
<h2 id="logfilerootPath" class="common-anchor-header"><code translate="no">log.file.rootPath</code><button data-href="#logfilerootPath" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>المسار الجذر لملفات السجل.</li>      
        <li>يتم تعيين القيمة الافتراضية فارغة، مما يشير إلى إخراج ملفات السجل إلى الإخراج القياسي (stdout) والخطأ القياسي (stderr).</li>      
        <li>إذا تم تعيين هذه المعلمة على مسار محلي صالح، يقوم ميلفوس بكتابة ملفات السجل وتخزينها في هذا المسار.</li>      
        <li>قم بتعيين هذه المعلمة على المسار الذي لديك الإذن بكتابته.</li>      </td>
      <td></td>
    </tr>
  </tbody>
</table>
<h2 id="logfilemaxSize" class="common-anchor-header"><code translate="no">log.file.maxSize</code><button data-href="#logfilemaxSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        الحد الأقصى لحجم ملف السجل، الوحدة: ميغابايت.      </td>
      <td>300</td>
    </tr>
  </tbody>
</table>
<h2 id="logfilemaxAge" class="common-anchor-header"><code translate="no">log.file.maxAge</code><button data-href="#logfilemaxAge" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        الحد الأقصى لوقت الاحتفاظ قبل مسح ملف السجل تلقائياً، الوحدة: يوم. القيمة الدنيا هي 1.  </td>
      <td>10</td>
    </tr>
  </tbody>
</table>
<h2 id="logfilemaxBackups" class="common-anchor-header"><code translate="no">log.file.maxBackups</code><button data-href="#logfilemaxBackups" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        الحد الأقصى لعدد ملفات السجل المطلوب نسخها احتياطياً، الوحدة: يوم. القيمة الدنيا هي 1.  </td>
      <td>20</td>
    </tr>
  </tbody>
</table>
<h2 id="logformat" class="common-anchor-header"><code translate="no">log.format</code><button data-href="#logformat" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        تنسيق سجل ميلفوس. الخيار: نص و JSON    </td>
      <td>نص</td>
    </tr>
  </tbody>
</table>
