...
<h3 id="Architecture-Changes" class="common-anchor-header">تغييرات البنية</h3><p>منذ الإصدار 2.6، أدخلت Milvus تغييرات معمارية مهمة تهدف إلى تحسين الأداء وقابلية التوسع وسهولة الاستخدام. لمزيد من المعلومات، راجع <a href="/docs/ar/v2.6.x/architecture_overview.md">نظرة عامة</a> على <a href="/docs/ar/v2.6.x/architecture_overview.md">نظرة عامة على بنية Milvus</a>.</p>
...
<p>لمزيد من المعلومات، راجع <a href="/docs/ar/v2.6.x/ivf-rabitq.md">IVF_RABITQ</a>.</p>
...
<ul>
<li>تتوفر صيغة جديدة <a href="/docs/ar/v2.6.x/analyzer-overview.md#Example-use">لمحلل التشغيل</a> للتحقق من صحة تكوينات أداة الترميز.</li>
<li>تم دمج <a href="/docs/ar/v2.6.x/lindera-tokenizer.md">أداة ترميز لينديرا</a> لتحسين دعم اللغات الآسيوية مثل اليابانية والكورية.</li>
<li>يتم الآن دعم اختيار أداة الترميز على مستوى الصف، مع توفر <a href="/docs/ar/v2.6.x/icu-tokenizer.md">أداة الترميز</a> للأغراض العامة <a href="/docs/ar/v2.6.x/icu-tokenizer.md">لوحدة الترميز ICU</a> كخيار احتياطي لسيناريوهات متعددة اللغات.</li>
</ul>
...
<p>لمزيد من المعلومات، راجع <a href="/docs/ar/v2.6.x/embedding-function-overview.md">نظرة عامة</a> على <a href="/docs/ar/v2.6.x/embedding-function-overview.md">وظيفة التضمين</a>.</p>
...
<p>لمزيد من المعلومات، راجع <a href="/docs/ar/v2.6.x/phrase-match.md">مطابقة العبارة</a>.</p>
...
<p>لمزيد من المعلومات، راجع <a href="/docs/ar/v2.6.x/decay-ranker-overview.md">نظرة عامة</a> على <a href="/docs/ar/v2.6.x/decay-ranker-overview.md">نظرة عامة على مصنف الاضمحلال</a>.</p>
...
<p>لمزيد من المعلومات، راجع <a href="/docs/ar/v2.6.x/add-fields-to-an-existing-collection.md">إضافة حقول إلى مجموعة موجودة</a>.</p>
...
<p>لمزيد من المعلومات، راجع <a href="/docs/ar/v2.6.x/dense-vector.md">المتجهات الكثيفة</a>.</p>
