...
title: AGENTS.md لـ Milvus
summary: >-
  القواعد والأنماط الخاصة بعوامل ترميز الذكاء الاصطناعي التي تنشئ أو تراجع أو
  تصحح كود قاعدة بيانات Milvus vector باستخدام PyMilvus.
---
...
<h1 id="AGENTSmd--Milvus" class="common-anchor-header">AGENTS.md - Milvus<button data-href="#AGENTSmd--Milvus" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus هي قاعدة بيانات متجهة مفتوحة المصدر للبحث عن التشابه والبحث الهجين و RAG. يمكنك التفاعل معها من خلال واجهة PyMilvus SDK الخاصة بـ PyMilvus <code translate="no">MilvusClient</code>. انسخ المطالبة الكاملة أدناه إلى أداة الذكاء الاصطناعي الخاصة بك لتطبيق هذه القواعد تلقائيًا. للحصول على مطالبات مفصلة خاصة بالمهام، راجع <a href="/docs/ar/milvus_for_agents.md">مطالبات الذكاء الاصطناعي</a>.</p>
