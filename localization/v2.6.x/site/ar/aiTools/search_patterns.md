...
title: 'موجه: أنماط بحث ميلفوس'
summary: >-
  قواعد لمساعدي ترميز الذكاء الاصطناعي لتنفيذ البحث، والبحث المختلط، والبحث في
  النص الكامل في Milvus.
---
...
<li><strong>احفظه</strong> في الموقع الذي تتوقعه أداة الذكاء الاصطناعي لديك - راجع <a href="/docs/ar/ai_prompts_landing.md">جدول البيئة</a> للحصول على تفاصيل الموضع.</li>
...
<p>قواعد تنفيذ البحث عن التشابه، والبحث المختلط، والبحث المصفى، والبحث في النص الكامل في Milvus، بما في ذلك قيود AnnSearchRequest واستخدام المصنف. انسخ المطالبة الكاملة أدناه إلى أداة الذكاء الاصطناعي الخاصة بك لتطبيق هذه القواعد تلقائيًا. للحصول على نظرة عامة على جميع المطالبات، راجع <a href="/docs/ar/ai_prompts_landing.md">مطالبات الذكاء الاصطناعي</a>.</p>
