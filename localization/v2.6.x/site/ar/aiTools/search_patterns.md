...
<p>قواعد تنفيذ البحث عن التشابه، والبحث المختلط، والبحث المصفى، والبحث في النص الكامل في Milvus، بما في ذلك قيود AnnSearchRequest واستخدام المصنف. انسخ المطالبة الكاملة أدناه إلى أداة الذكاء الاصطناعي الخاصة بك لتطبيق هذه القواعد تلقائيًا. للحصول على نظرة عامة على جميع المطالبات، راجع <a href="/docs/ar/milvus_for_agents.md">مطالبات الذكاء الاصطناعي</a>.</p>
