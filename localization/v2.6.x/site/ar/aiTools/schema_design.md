---
id: schema_design.md
title: 'موجه: تصميم مخطط ميلفوس'
summary: قواعد لمساعدي ترميز الذكاء الاصطناعي لتصميم مخططات مجموعة ميلفوس الصحيحة.
---
<h1 id="Schema-Design" class="common-anchor-header">تصميم المخطط<button data-href="#Schema-Design" class="anchor-icon" translate="no">
    ...
    </button></h1><p>القواعد وأدلة القرار لتصميم مخططات مجموعة ميلفوس الصحيحة، بما في ذلك أنواع الحقول والمفاتيح الأساسية وتكوين BM25 وقيود ثبات المخطط. انسخ المطالبة الكاملة أدناه إلى أداة الذكاء الاصطناعي لتطبيق هذه القواعد تلقائيًا. للحصول على نظرة عامة على جميع المطالبات، راجع <a href="/docs/ar/milvus_for_agents.md">مطالبات الذكاء الاصطناعي</a>.</p>
