...
<p>بالنسبة لأحمال عمل الوكلاء، يوصى باستخدام <strong><a href="https://zilliz.com/cloud">Zilliz Cloud</a></strong> للاستخدام في الإنتاج. لا يدير الوكلاء عادةً البنية التحتية، لذا فإن النشر بدون خادم يلغي النفقات التشغيلية ويوفر التوسع التلقائي.</p>
</div>
