...
<h2 id="Load-data-from-Unstructured" class="common-anchor-header">تحميل البيانات من Unstructured<button data-href="#Load-data-from-Unstructured" class="anchor-icon" translate="no">
    ...
    </button></h2><p>توفر Unstructured خط أنابيب استيعاب مرن وقوي لمعالجة أنواع مختلفة من الملفات، بما في ذلك PDF و HTML وغيرها. سنقوم بتقسيم ملف PDF محلي وتقطيعه. ثم نقوم بتحميل البيانات إلى ملف Milvus.</p>
