...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Prepare-the-LLM-and-Embedding-Model" class="common-anchor-header">إعداد نموذج LLM ونموذج التضمين<button data-href="#Prepare-the-LLM-and-Embedding-Model" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>يدعم أولاما نماذج متعددة لكل من المهام القائمة على LLM وتوليد التضمينات، مما يسهل تطوير تطبيقات التوليد المعزز للاسترجاع (RAG). لهذا الإعداد:</p>
<ul>
