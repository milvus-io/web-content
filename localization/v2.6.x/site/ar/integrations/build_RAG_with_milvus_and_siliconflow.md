...
summary: >-
  ...
  أنابيب RAG (استرجاع-جيل معزز) باستخدام Milvus و SiliconFlow.
title: بناء RAG مع Milvus و SiliconFlow
---
<h1 id="Build-RAG-with-Milvus-and-SiliconFlow" class="common-anchor-header">بناء RAG مع Milvus و SiliconFlow<button data-href="#Build-RAG-with-Milvus-and-SiliconFlow" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Prepare-the-Embedding-Model" class="common-anchor-header">إعداد نموذج التضمين<button data-href="#Prepare-the-Embedding-Model" class="anchor-icon" translate="no">
    ...
    </button></h3><p>نقوم بتهيئة العميل لإعداد نموذج التضمين. يُمكِّن SiliconFlow واجهة برمجة التطبيقات على غرار OpenAI، ويمكنك استخدام واجهة برمجة التطبيقات نفسها مع تعديلات طفيفة لاستدعاء نموذج التضمين و LLM.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>حدد دالة لإنشاء تضمينات نصية باستخدام العميل. نستخدم نموذج <code translate="no">BAAI/bge-large-en-v1.5</code> كمثال.</p>
...
&quot;&quot;&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>استخدم النموذج <code translate="no">deepseek-ai/DeepSeek-V2.5</code> المقدم من سيليكون كلاود لإنشاء استجابة بناءً على المطالبات.</p>
...
<p>عظيم! لقد نجحنا في بناء خط أنابيب RAG مع Milvus وSiliconFlow.</p>
