...
<p><strong>الجديد في الإصدار 2.6.17:</strong></p>
<ul>
...
<p>قم دائمًا بتنزيل أحدث تكوين Docker Compose لضمان التوافق مع ميزات الإصدار 2.6.17.</p>
<ul>
...
<li><p>إذا واجهتك أي مشاكل في سحب الصورة، اتصل بنا على <a href="mailto:community@zilliz.com">community@zilliz.com</a> مع تفاصيل حول المشكلة، وسنقدم لك الدعم اللازم.</p></li>
</ul>
</div>
...
<li><p>أضف تكوينات إضافية لتجاوز التكوينات الافتراضية. يفترض ما يلي أنك بحاجة إلى تجاوز التكوين الافتراضي <code translate="no">proxy.healthCheckTimeout</code>. للحصول على عناصر التكوين القابلة للتطبيق، راجع <a href="/docs/ar/v2.6.x/system_configuration.md">تكوين النظام</a>.</p>
