...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">تنزيل حزمة RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يمكنك تنزيل حزمة RPM/DEB وفقًا لهيكل نظامك من <a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.19">صفحة إصدارات Milvus</a>.</p>
<ul>
<li>بالنسبة لـ x86_64/amd64، قم بتنزيل حزمة <strong>milvus_2.6.19-1_amd64.deb</strong> أو <strong>milvus_2.6.19-1_amd64.rpm</strong>.</li>
<li>بالنسبة لـ ARM64، قم بتنزيل حزمة <strong>milvus_2.6.19-1_arm64.deb</strong> أو <strong>milvus_2.6.19-1_arm64.rpm</strong>.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<p>يمكنك العثور على الملف الثنائي لـ Milvus على الرابط <code translate="no">/usr/bin/milvus</code> ، وملف خدمة systemd على الرابط <code translate="no">/lib/systemd/system/milvus.service</code> ، والتبعيات على الرابط <code translate="no">/usr/lib/milvus/</code>.</p>
