...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">تنزيل حزمة RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يمكنك تنزيل حزمة RPM/DEB وفقًا لبنية نظامك من [صفحة إصدارات Milvus] (https://github.com/milvus-io/milvus/releases/tag/v{ var.milvus_release_release_version }}).</p>
<ul>
<li>بالنسبة إلى x86_64/amd64، قم بتنزيل حزمة <strong>{{ var.milvus_deb_amd64 }}}</strong> أو <strong>{{ var.milvus_rpm_amd64 }}</strong>.</li>
<li>بالنسبة ل ARM64، قم بتنزيل حزمة <strong>{{ var{.milvus_dfus_deb_arm64 }}}</strong> أو <strong>{{ var.milvus_rpm_rpm_arm64 }}}</strong>.</li>
</ul>
