...
<ul>
<li><strong>عقدة البث (Streaming Node</strong>): قدرات معالجة بيانات محسّنة</li>
<li><strong>Woodpecker MQ</strong>: قائمة انتظار الرسائل المحسّنة مع تقليل أعباء الصيانة، انظر <a href="/docs/ar/v2.6.x/use-woodpecker.md">استخدام Woodpecker</a> لمزيد من التفاصيل</li>
...
<li>تم تثبيت etcd مدمج مع Milvus في نفس الحاوية ويعمل على المنفذ <strong>2379</strong>. يتم تعيين ملف التكوين الخاص به إلى <strong>embedEtcd.yaml</strong> في المجلد الحالي.</li>
<li>لتغيير التكوين الافتراضي لـ Milvus، أضف إعداداتك إلى ملف <strong>user.yaml</strong> في المجلد الحالي، ثم أعد تشغيل الخدمة.</li>
