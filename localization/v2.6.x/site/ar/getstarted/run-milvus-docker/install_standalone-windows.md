...
<h2 id="Run-Milvus-in-Docker​" class="common-anchor-header">تشغيل Milvus في Docker​<button data-href="#Run-Milvus-in-Docker​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يوفر Milvus برنامج نصي للتثبيت لتثبيته كحاوية Docker. بمجرد تثبيت Docker Desktop على Microsoft Windows، يمكنك الوصول إلى واجهة سطر الأوامر (CLI) لـ Docker من PowerShell أو موجه أوامر Windows في وضع <strong>المسؤول</strong> ومن WSL 2. ​</p>
