...
<li><p><a href="https://learn.microsoft.com/en-us/windows/wsl/install#install-wsl-command">تثبيت نظام Windows Subsystem for Linux 2 (WSL 2)</a>.​</p></li>
<li><p>تثبيت Python 3.8 أو أحدث.​</p></li>
</ul>
...
<li><p>تم تثبيت etcd مدمج مع Milvus في نفس الحاوية ويعمل على المنفذ <strong>2379</strong>. ويتم تعيين ملف التكوين الخاص به إلى <strong>embedEtcd.yaml</strong> في المجلد الحالي.​</p></li>
...
<li><p>تقدم حاوية <strong>milvus-minio</strong> المنفذين <strong>9090</strong> <strong>و9091</strong> محليًّا باستخدام بيانات اعتماد المصادقة الافتراضية وتقوم بتعيين بياناتها إلى <strong>volumes/minio</strong> في المجلد الحالي.</p></li>
...
<p>يمكنك التحقق مما إذا كانت المحاكاة الافتراضية ممكّنة من خلال الاطلاع على علامة التبويب <strong>«الأداء» (Performance</strong> ) في <strong>«مدير</strong> المهام» ( <strong>Task Manager</strong>).​</p>
<p><span class="img-wrapper">
   ...
   <span>المحاكاة الافتراضية في "إدارة المهام</span> </span>" <span class="img-wrapper">
...
<p>بعد ذلك، تحتاج إلى إعادة تشغيل جهاز الكمبيوتر الخاص بك وتمكين Hyper-V. للحصول على التفاصيل، راجع هذه <a href="https://learn.microsoft.com/en-us/virtualization/hyper-v-on-windows/quick-start/enable-hyper-v#enable-the-hyper-v-role-through-settings">المقالة</a> من <a href="https://learn.microsoft.com/en-us/virtualization/hyper-v-on-windows/quick-start/enable-hyper-v#enable-the-hyper-v-role-through-settings">Microsoft</a>.​</p></li>
...
<h3 id="How-can-I-deal-with-WSL-related-issues-while-deploying-Milvus​" class="common-anchor-header">كيف يمكنني التعامل مع المشكلات المتعلقة بـ WSL أثناء نشر Milvus؟​<button data-href="#How-can-I-deal-with-WSL-related-issues-while-deploying-Milvus​" class="anchor-icon" translate="no">
    ...
    </button></h3><p>إذا واجهت مشكلات متعلقة بـ WSL أثناء تشغيل Milvus من WSL 2، فقد تحتاج إلى التحقق مما إذا كنت قد قمت بتكوين Docker Desktop لاستخدام المحرك القائم على WSL 2 على النحو التالي:​</p>
<ol>
...
<p><span class="img-wrapper">
   ...
   <span>استخدام المحرك القائم على WSL 2 في إعدادات Docker Desktop</span>
...
<p><span class="img-wrapper">
   ...
   <span>عرض ملفات التكوين الخاصة بـ Milvus</span>
