...
<h3 id="From-WSL-2​" class="common-anchor-header">من WSL 2​<button data-href="#From-WSL-2​" class="anchor-icon" translate="no">
    ...
    </button></h3><p>إذا كنت تفضل تشغيل Milvus باستخدام أوامر Linux ونصوص شل على نظام Windows، فتأكد من تثبيت WSL 2 مسبقًا. للحصول على تفاصيل حول كيفية تثبيت WSL 2، يمكنك الرجوع إلى <a href="https://learn.microsoft.com/en-us/windows/wsl/install#install-wsl-command">مقالة Microsoft</a> هذه.​</p>
<ol>
...
<li><p>تقدم حاوية <strong>milvus-minio</strong> المنافذ <strong>9090</strong> <strong>و9091</strong> محليًا باستخدام بيانات اعتماد المصادقة الافتراضية وتقوم بتعيين بياناتها إلى <strong>volumes/minio</strong> في المجلد الحالي.</p></li>
...
<li><p>اختر من بين توزيعات WSL 2 المثبتة لديك تلك التي تريد تمكين تكامل Docker عليها بالانتقال إلى: <strong>الإعدادات</strong> &gt; <strong>الموارد</strong> &gt; <strong>تكامل WSL</strong>.</p>
<p><span class="img-wrapper">
