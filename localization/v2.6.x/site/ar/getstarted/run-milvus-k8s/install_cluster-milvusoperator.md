...
<li><p>قبل تثبيت Milvus، يوصى باستخدام <a href="https://milvus.io/tools/sizing">أداة تحديد حجم Milvus</a> لتقدير متطلبات الأجهزة بناءً على حجم بياناتك. يساعد ذلك في ضمان الأداء الأمثل وتخصيص الموارد بشكل مثالي لتثبيت Milvus الخاص بك.</p></li>
</ul>
<div class="alert note">
<p>إذا واجهت أي مشكلات في سحب الصورة، فاتصل بنا على <a href="mailto:community@zilliz.com">community@zilliz.com</a> مع تفاصيل عن المشكلة، وسنقدم لك الدعم اللازم.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>يمكنك التحقق مما إذا كانت وحدة Milvus Operator قيد التشغيل على النحو التالي:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>يقوم الأمر أعلاه بنشر مجموعة Milvus باستخدام <strong>Woodpecker</strong> كقائمة انتظار الرسائل (موصى به للإصدار v2.6.17) وجميع المكونات المعمارية الجديدة بما في ذلك Streaming Node.</p>
...
<h2 id="Access-Milvus-WebUI" class="common-anchor-header">الوصول إلى واجهة المستخدم على الويب لـ Milvus<button data-href="#Access-Milvus-WebUI" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يأتي Milvus مزودًا بأداة واجهة مستخدم رسومية مدمجة تُسمى Milvus WebUI يمكنك الوصول إليها عبر متصفحك. تعزز واجهة المستخدم على الويب لـ Milvus إمكانية مراقبة النظام بفضل واجهة بسيطة وبديهية. يمكنك استخدام واجهة المستخدم على الويب لـ Milvus لمراقبة الإحصائيات والمقاييس الخاصة بمكونات Milvus وتبعياته، والتحقق من تفاصيل قاعدة البيانات والمجموعات، وسرد تكوينات Milvus التفصيلية. للحصول على تفاصيل حول واجهة المستخدم على الويب لـ Milvus، راجع <a href="/docs/ar/v2.6.x/milvus-webui.md">واجهة المستخدم على الويب لـ Milvus</a></p>
<p>لتمكين الوصول إلى Milvus Web UI، تحتاج إلى إعادة توجيه منفذ pod الوكيل إلى منفذ محلي.</p>
