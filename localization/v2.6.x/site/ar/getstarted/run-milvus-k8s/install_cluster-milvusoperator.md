...
<h3 id="Install-with-Helm" class="common-anchor-header">التثبيت باستخدام Helm<button data-href="#Install-with-Helm" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>قم بتشغيل الأمر التالي لتثبيت مشغل Milvus مع Helm.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Install-with-kubectl" class="common-anchor-header">التثبيت باستخدام kubectl<button data-href="#Install-with-kubectl" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>قم بتشغيل الأمر التالي لتثبيت مشغل Milvus مع <code translate="no">kubectl</code>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>بمجرد أن تصبح مجموعة Milvus جاهزة، يجب أن تكون مخرجات الأمر أعلاه مشابهة لما يلي. إذا بقي الحقل <code translate="no">status.status</code> <code translate="no">Unhealthy</code> ، فإن مجموعة Milvus العنقودية الخاصة بك لا تزال قيد الإنشاء.</p>
