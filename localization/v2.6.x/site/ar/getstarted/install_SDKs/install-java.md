...
related_key: SDK
summary: تعرف على كيفية تثبيت حزمة تطوير البرامج (SDK) لـ Java الخاصة بـ Milvus.
...
<li><p>استكشاف <a href="/api-reference/java/v2.6.x/About.md">مرجع واجهة برمجة تطبيقات Milvus لـ Java</a></p></li>
</ul>
