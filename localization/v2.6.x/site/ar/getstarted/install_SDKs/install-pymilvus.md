...
يوصى بتثبيت إصدار PyMilvus الذي يطابق إصدار خادم Milvus الذي قمت بتثبيته. لمزيد من المعلومات، راجع <a href="/docs/ar/v2.6.x/release_notes.md">ملاحظات الإصدار</a>.</div>
...
<li><a href="/docs/ar/v2.6.x/insert-update-delete.md">الإدراج، الإضافة والحذف</a></li>
