...
related_key: SDK
summary: تعرف على كيفية تثبيت حزمة تطوير التطبيقات (SDK) الخاصة بـ Node.js من Milvus.
title: تثبيت حزمة تطوير التطبيقات (SDK) لـ Milvus Node.js
---
<h1 id="Install-Milvus-Nodejs-SDK" class="common-anchor-header">تثبيت حزمة تطوير التطبيقات (SDK) لـ Milvus Node.js<button data-href="#Install-Milvus-Nodejs-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>يصف هذا الموضوع كيفية تثبيت Milvus Node.js SDK لـ Milvus.</p>
<h2 id="Compatibility" class="common-anchor-header">التوافق<button data-href="#Compatibility" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>توضح المجموعة التالية إصدارات Milvus وإصدارات @zilliz/milvus2-sdk-node الموصى بها:</p>
<table>
<thead>
<tr><th style="text-align:center">إصدار Milvus</th><th style="text-align:center">إصدار @zilliz/milvus2-sdk-node الموصى به</th></tr>
</thead>
<tbody>
...
<h2 id="Requirement" class="common-anchor-header">المتطلبات<button data-href="#Requirement" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Node.js الإصدار 18 أو أعلى</p>
<h2 id="Installation" class="common-anchor-header">التثبيت<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>الطريقة الموصى بها لبدء استخدام عميل Milvus node.js هي استخدام npm (مدير حزم Node) لتثبيت التبعية في مشروعك.</p>
<pre><code translate="no" class="language-javascript">npm install @zilliz/milvus2-sdk-node
# or ...
yarn add @zilliz/milvus2-sdk-node
<button class="copy-code-btn"></button></code></pre>
<p>سيؤدي ذلك إلى تنزيل حزمة تطوير البرامج (SDK) الخاصة بـ Milvus لـ Node.js وإضافة إدخال التبعية إلى ملف package.json الخاص بك.</p>
<h2 id="Whats-next" class="common-anchor-header">الخطوة التالية<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>بعد تثبيت حزمة تطوير التطبيقات (SDK) لـ Milvus Node.js، يمكنك:</p>
<ul>
<li><p>عرض <a href="https://github.com/milvus-io/milvus-sdk-node">دليل البدء السريع لـ Milvus Node.js SDK</a></p></li>
...
<li><p>استكشاف <a href="/api-reference/node/v2.6.x/About.md">مرجع واجهة برمجة تطبيقات Milvus Node.js</a></p></li>
</ul>
