...
related_key: SDK
summary: >-
  تعرف على كيفية تثبيت حزمة أدوات تطوير التطبيقات (SDK) الخاصة بـ Node.js من
  Milvus.
title: تثبيت حزمة أدوات تطوير التطبيقات (SDK) لـ Milvus Node.js
---
<h1 id="Install-Milvus-Nodejs-SDK" class="common-anchor-header">تثبيت حزمة أدوات تطوير التطبيقات (SDK) لـ Milvus Node.js<button data-href="#Install-Milvus-Nodejs-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Requirement" class="common-anchor-header">المتطلبات<button data-href="#Requirement" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Node.js الإصدار 18 أو أحدث</p>
