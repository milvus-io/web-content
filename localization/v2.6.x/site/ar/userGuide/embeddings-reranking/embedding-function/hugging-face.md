...
<p>يستخدم هذا التكامل جهاز التوجيه المستضاف من Hugging Face. لربط Milvus بخدمة استدلال تضمين النص (TEI) التي تم نشرها بشكل منفصل، راجع <a href="/docs/ar/v2.6.x/hugging-face-tei.md">Hugging Face TEI</a>.</p>
...
<ul>
<li>Milvus 2.6.20 أو أحدث من سلسلة الإصدارات 2.6.</li>
...
<button class="copy-code-btn"></button></code></pre>
<p>للحصول على تفاصيل حول تطبيق إعدادات Docker Compose، راجع <a href="/docs/ar/v2.6.x/configure-docker.md">تكوين Milvus باستخدام Docker Compose</a>.</p>
...
<h3 id="The-returned-vector-dimension-does-not-match-the-field" class="common-anchor-header">أبعاد المتجه المرتجعة لا تتطابق مع الحقل<button data-href="#The-returned-vector-dimension-does-not-match-the-field" class="anchor-icon" translate="no">
    ...
    </button></h3><p>تحقق من بُعد مخرجات النموذج وقارنه مع <code translate="no">dim</code> في حقل «مخرجات الدالة» (Function output). يرفض Milvus أي استجابة يختلف بُعد متجهها عن بُعد حقل <code translate="no">FLOAT_VECTOR</code>.</p>
...
<li>للاطلاع على المفاهيم العامة لـ Function وسلوك الإدراج/البحث، راجع <a href="/docs/ar/v2.6.x/embedding-function-overview.md">نظرة عامة على Embedding Function</a>.</li>
<li>لإعادة ترتيب المرشحين في البحث المتجه باستخدام درجات تشابه الجمل المستضافة من Hugging Face، راجع <a href="/docs/ar/v2.6.x/hugging-face-ranker.md">Hugging Face Ranker</a>.</li>
</ul>
