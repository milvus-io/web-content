...
<h2 id="How-it-works" class="common-anchor-header">كيف يعمل الحقل الديناميكي<button data-href="#How-it-works" class="anchor-icon" translate="no">
    ...
    </button></h2><p>عند تمكين الحقل الديناميكي، يضيف ميلفوس حقلاً مخفياً <code translate="no">$meta</code> إلى كل كيان. يكون هذا الحقل من نوع JSON، مما يعني أنه يمكن تخزين أي بنية بيانات متوافقة مع JSON ويمكن فهرستها باستخدام بناء جملة مسار JSON.</p>
