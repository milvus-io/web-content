...
<h2 id="Applicable-rules" class="common-anchor-header">القواعد المطبقة<button data-href="#Applicable-rules" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يلخّص الجدول التالي سلوك الأعمدة القابلة للإلغاء والقيم الافتراضية تحت مجموعات تكوين مختلفة. تحدد هذه القواعد كيفية تعامل Milvus مع البيانات عند محاولة إدراج قيم فارغة أو إذا لم يتم توفير قيم الحقل.</p>
<table>
   <tr>
