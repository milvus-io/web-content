...
<h2 id="Next-steps" class="common-anchor-header">الخطوات التالية<button data-href="#Next-steps" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يمثل تطوير صفيف أصلي من نوع بيانات Structs تقدمًا كبيرًا في قدرة ميلفوس على التعامل مع بنيات البيانات المعقدة. لفهم حالات الاستخدام بشكل أفضل وتعظيم هذه الميزة الجديدة، ننصحك بقراءة <a href="https://zilliverse.feishu.cn/wiki/VOkIwd5adiziGQkoDO1cRoRFnre">تصميم المخطط باستخدام مصفوفة الهياكل</a>.</p>
