...
<li><p>يوجد حد أقصى لإجمالي الحقول لكل مجموعة. لمزيد من التفاصيل، راجع <a href="/docs/ar/v2.6.x/limitations.md#Number-of-resources-in-a-collection">حدود ميلفوس</a>.</p></li>
...
<p>ارجع إلى <a href="/docs/ar/v2.6.x/create-collection.md">إنشاء مجموعة لإنشاء مجموعة</a> والعمليات الأساسية.</p>
</div>
...
<ul>
<li><p><strong>مجموعة جديدة</strong>: اضبط <code translate="no">enable_dynamic_field</code> على True عند إنشاء المجموعة. لمزيد من التفاصيل، راجع <a href="/docs/ar/v2.6.x/create-collection.md#Create-Schema">إنشاء مجموعة</a></p></li>
<li><p><strong>المجموعة الحالية</strong>: قم بتعيين الخاصية على مستوى المجموعة <code translate="no">dynamicfield.enabled</code> إلى صواب. لمزيد من التفاصيل، راجع <a href="/docs/ar/v2.6.x/modify-collection.md#Example-4-Enable-dynamic-field">تعديل المجموعة</a>.</p></li>
</ul>
