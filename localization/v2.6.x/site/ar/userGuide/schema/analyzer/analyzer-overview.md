...
<li><p><strong>محلل مخصص</strong>: بالنسبة للمتطلبات الأكثر تقدمًا، تسمح لك المحللات المخصصة بتحديد التكوين الخاص بك عن طريق تحديد كل من أداة الترميز وصفر أو أكثر من المرشحات. هذا المستوى من التخصيص مفيد بشكل خاص لحالات الاستخدام المتخصصة التي تتطلب تحكمًا دقيقًا في معالجة النص.</p></li>
</ul>
<div class="alert note">
<ul>
...
<h2 id="Whats-next" class="common-anchor-header">الخطوة التالية<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>بعد تكوين المحلّل، يمكنك التكامل مع ميزات استرجاع النصوص التي يوفرها Milvus. لمزيد من التفاصيل:</p>
<ul>
