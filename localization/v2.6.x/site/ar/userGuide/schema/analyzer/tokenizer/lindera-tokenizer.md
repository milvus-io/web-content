...
<p>يحافظ أداة الترميز <code translate="no">lindera</code> على علامات الترقيم كرموز منفصلة في المخرجات. على سبيل المثال، <code translate="no">&quot;こんにちは！&quot;</code> تصبح <code translate="no">[&quot;こんにちは&quot;, &quot;！&quot;]</code>. لإزالة علامات الترقيم المنفصلة هذه، استخدم عامل التصفية <a href="/docs/ar/removepunct-filter.md"><code translate="no">removepunct</code></a> الفلتر.</p>
</div>
<h2 id="Prerequisites" class="common-anchor-header">المتطلبات الأساسية<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p>لاستخدام أداة ترميز <code translate="no">lindera</code> ، تحتاج إلى استخدام إصدار مجمّع خصيصًا من Milvus. يجب تمكين جميع القواميس بشكل صريح أثناء التجميع لاستخدامها.</p>
