...
<li><p>أعباء العمل المختلطة التي يمكن أن تتسامح مع حالات فقدان ذاكرة التخزين المؤقت العرضية للبيانات التي يتم الوصول إليها بشكل أقل تكرارًا</p></li>
</ul>
...
<p>لا يتم تنزيل بيانات الحقل أو ملفات الفهرس في هذه المرحلة. وهذا يجعل المجموعات قابلة للاستعلام بسرعة ويقلل من استخدام موارد بدء التشغيل.</p>
