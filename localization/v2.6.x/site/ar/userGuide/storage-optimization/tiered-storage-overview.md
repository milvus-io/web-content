...
<h4 id="Phase-1-Lazy-load" class="common-anchor-header">المرحلة 1: التحميل البطيء</h4><p>عند التهيئة، يقوم Milvus بتحميل كسول، حيث يتم تخزين البيانات الوصفية على مستوى المقطع فقط مثل تعريفات المخطط ومعلومات الفهرس وتعيينات القطع.</p>
...
<p><strong>التكوين</strong></p>
<p>يتم تحديد إعدادات الإحماء في قسم التخزين المتدرج في <code translate="no">milvus.yaml</code>. يمكنك تمكين أو تعطيل التحميل المسبق لكل حقل أو نوع فهرس وتحديد الاستراتيجية المفضلة. راجع <a href="/docs/ar/warm-up.md">الإحماء</a> للحصول على تكوينات مفصلة.</p>
<h4 id="Phase-3-Partial-load" class="common-anchor-header">المرحلة 3: التحميل الجزئي</h4><p>بمجرد بدء الاستعلامات أو عمليات البحث، تقوم QueryNode بإجراء <em>تحميل جز</em>ئي، حيث تقوم بجلب أجزاء البيانات أو ملفات الفهرس المطلوبة فقط من مخزن الكائنات.</p>
<ul>
