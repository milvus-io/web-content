...
<p>يخضع الإخلاء للعناصر التالية القابلة للتكوين:</p>
<ul>
...
<p><strong>التكوين</strong></p>
<p>تمكين معلمات الإخلاء وضبطها في <strong>milvus.yaml.</strong> انظر <a href="/docs/ar/eviction.md">الإخلاء</a> للحصول على تكوين مفصل.</p>
...
<h3 id="Does-Tiered-Storage-affect-data-durability" class="common-anchor-header">هل يؤثر التخزين المتدرج على متانة البيانات؟<button data-href="#Does-Tiered-Storage-affect-data-durability" class="anchor-icon" translate="no">
    ...
    </button></h3><p>لا، لا. لا يزال يتم التعامل مع استمرارية البيانات عن طريق تخزين الكائنات عن بُعد. التخزين المتدرج يدير التخزين المؤقت فقط على عقد الاستعلام.</p>
