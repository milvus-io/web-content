...
<h3 id="Basic-Operators-in-JSON-Fields" class="common-anchor-header">المعاملات الأساسية في حقول JSON<button data-href="#Basic-Operators-in-JSON-Fields" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>يفترض الجدول التالي أن قيمة حقل JSON المسمى <code translate="no">json_key</code> لها مفتاح اسمه <code translate="no">A</code>. استخدمه كمرجع عند إنشاء تعبيرات منطقية باستخدام مفاتيح حقل JSON.</p>
<table>
<thead>
...
<h3 id="Advanced-Operators" class="common-anchor-header">المعاملات المتقدمة<button data-href="#Advanced-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>المعاملات التالية خاصة بحقول JSON:</p>
<ul>
...
<p>يقوم هذا العامل بتصفية الكيانات التي يحتوي معرّفها على جميع أعضاء تعبير JSON.</p>
