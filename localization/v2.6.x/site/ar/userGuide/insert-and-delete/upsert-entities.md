...
summary: >-
  ...
  مختلفة.
---
<h1 id="Upsert-Entities" class="common-anchor-header">كيانات Upsert<button data-href="#Upsert-Entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>تجمع عملية Upsert بين إجراءات تحديث وإدراج البيانات. يحدد ميلفوس ما إذا كان سيتم إجراء عملية تحديث أو إدراج عن طريق التحقق من وجود المفتاح الأساسي. سيقدم هذا القسم كيفية إدراج كيان والسلوكيات المحددة لعملية Upsert في سيناريوهات مختلفة.</p>
<div class="alert note">
<p>إذا قمت بإضافة حقول جديدة ديناميكيًا بعد إنشاء المجموعة، ولم تحدد قيمًا لهذه الحقول عند رفع إدراج الكيانات، فإن Milvus يقوم تلقائيًا بتعبئتها إما بقيمها الافتراضية المحددة أو بقيمها الافتراضية NULL إذا لم يتم تعيين القيم الافتراضية. لمزيد من التفاصيل، راجع <a href="/docs/ar/add-fields-to-an-existing-collection.md">إضافة حقول إلى مجموعة موجودة</a>.</p>
</div>
