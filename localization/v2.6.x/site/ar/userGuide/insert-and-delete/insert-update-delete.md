...
<h2 id="Overview" class="common-anchor-header">نظرة عامة<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>في Milvus، يشير <strong>الكيان</strong> في Milvus إلى سجلات البيانات في <strong>مجموعة</strong> تشترك في نفس <strong>المخطط،</strong> حيث تشكل البيانات الموجودة في كل حقل من حقول الصف كيانًا. لذلك، فإن الكيانات داخل نفس المجموعة لها نفس السمات (مثل أسماء الحقول وأنواع البيانات والقيود الأخرى).</p>
