...
<h2 id="Overview" class="common-anchor-header">نظرة عامة<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يمكنك تعيين حقل معين في المجموعة كمفتاح التقسيم بحيث يوزع Milvus الكيانات الواردة إلى أقسام مختلفة وفقًا لقيم التقسيم الخاصة بكل منها في هذا الحقل. يسمح ذلك بتجميع الكيانات التي لها نفس قيمة المفتاح في قسم، مما يسرع من أداء البحث عن طريق تجنب الحاجة إلى مسح الأقسام غير ذات الصلة عند التصفية حسب حقل المفتاح. بالمقارنة مع طرق التصفية التقليدية، يمكن لمفتاح التقسيم تحسين أداء الاستعلام بشكل كبير.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Insert-data" class="common-anchor-header">أدخل البيانات<button data-href="#Insert-data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
