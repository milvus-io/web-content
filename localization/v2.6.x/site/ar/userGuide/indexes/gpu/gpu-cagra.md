...
<li><p>إذا تم حذفه أو تم تعيينه على "false"، يبقى الفهرس على وحدة معالجة الرسومات (GPU) ويتم تشغيل عمليات البحث على وحدة معالجة الرسومات (GPU).</p></li>
</ul>
...
<table>
   ...
   <tr>
     ...
     <td><p>يؤثر على أداء البحث ومعدل الاسترجاع من خلال تعيين درجة الرسم البياني بعد عملية التقليم. ويؤدي الفرق الكبير بين هاتين الدرجتين إلى زيادة وقت الإنشاء. ويجب أن تكون قيمته أصغر من قيمة <code translate="no">intermediate_graph_degree</code>.</p></td>
