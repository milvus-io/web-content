...
title: عرض المجموعات
summary: >-
  يمكنك الحصول على قائمة أسماء جميع المجموعات في قاعدة البيانات المتصلة حاليًا،
  والتحقق من تفاصيل مجموعة معينة.
---
<h1 id="View-Collections" class="common-anchor-header">عرض المجموعات<button data-href="#View-Collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>يمكنك الحصول على قائمة أسماء جميع المجموعات في قاعدة البيانات المتصلة حاليًا، والتحقق من تفاصيل مجموعة معينة.</p>
<h2 id="List-Collections" class="common-anchor-header">قائمة المجموعات<button data-href="#List-Collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>يوضح المثال التالي كيفية الحصول على قائمة أسماء جميع المجموعات في قاعدة البيانات المتصلة حاليًا.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>إذا كنت قد أنشأت بالفعل مجموعة باسم <code translate="no">quick_setup</code> ، يجب أن تكون نتيجة المثال أعلاه مشابهة لما يلي.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Describe-Collection" class="common-anchor-header">وصف المجموعة<button data-href="#Describe-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>يمكنك أيضًا الحصول على تفاصيل مجموعة معينة. يفترض المثال التالي أنك أنشأت بالفعل مجموعة باسم quick_setup.</p>
<div class="multipleCode">
...
<button class="copy-code-btn"></button></code></pre>
<p>يجب أن تكون نتيجة المثال أعلاه مشابهة لما يلي.</p>
