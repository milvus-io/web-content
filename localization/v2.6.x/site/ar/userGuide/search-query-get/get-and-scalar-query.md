...
order: 3
summary: يوضح هذا الدليل كيفية الحصول على الكيانات حسب المعرف وإجراء التصفية العددية.
title: الحصول على واستعلام قياسي
---
<h1 id="Get--Scalar-Query" class="common-anchor-header">الحصول على واستعلام قياسي<button data-href="#Get--Scalar-Query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>يوضح هذا الدليل كيفية الحصول على الكيانات حسب المعرف وإجراء التصفية العددية. تسترجع التصفية العددية الكيانات التي تطابق شروط التصفية المحددة.</p>
<h2 id="Overview" class="common-anchor-header">نظرة عامة<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يقوم الاستعلام العددي بتصفية الكيانات في مجموعة بناءً على شرط محدد باستخدام تعبيرات منطقية. نتيجة الاستعلام هي مجموعة من الكيانات التي تطابق الشرط المحدد. على عكس البحث المتجه، الذي يحدد أقرب متجه إلى متجه معين في مجموعة، تقوم الاستعلامات بتصفية الكيانات بناءً على معايير محددة.</p>
<p>في ميلفوس، <strong>يكون عامل التصفية دائمًا عبارة عن سلسلة تضم أسماء الحقول موصولة بعوامل</strong>. في هذا الدليل، ستجد في هذا الدليل أمثلة تصفية مختلفة. لمعرفة المزيد حول تفاصيل المشغل، انتقل إلى قسم <a href="https://milvus.io/docs/get-and-scalar-query.md#Reference-on-scalar-filters">المراجع</a>.</p>
<h2 id="Preparations" class="common-anchor-header">التحضيرات<button data-href="#Preparations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>تقوم الخطوات التالية بإعادة استخدام الشيفرة للاتصال بميلفوس، وإعداد مجموعة بسرعة، وإدراج أكثر من 1000 كيان تم إنشاؤها عشوائيًا في المجموعة.</p>
<h3 id="Step-1-Create-a-collection" class="common-anchor-header">الخطوة 1: إنشاء مجموعة<button data-href="#Step-1-Create-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>استخدم <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a> للاتصال بخادم ميلفوس و <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_collection.md"><code translate="no">create_collection()</code></a> لإنشاء مجموعة.</p>
</div>
...
<p>استخدم <a href="https://milvus.io/api-reference/node/v2.4.x/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a> للاتصال بخادم Milvus و <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a> لإنشاء مجموعة.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Insert-randomly-generated-entities" class="common-anchor-header">الخطوة 2: إدراج الكيانات التي تم إنشاؤها عشوائيًا<button data-href="#Step-2-Insert-randomly-generated-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<div class="language-javascript">
<p>استخدم لإدراج كيانات <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/insert.md"><code translate="no">insert()</code></a> لإدراج كيانات في المجموعة.</p>
</div>
<div class="multipleCode">
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Create-partitions-and-insert-more-entities" class="common-anchor-header">الخطوة 3: إنشاء أقسام وإدراج المزيد من الكيانات<button data-href="#Step-3-Create-partitions-and-insert-more-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>استخدم <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Partitions/create_partition.md"><code translate="no">create_partition()</code></a> لإنشاء أقسام و <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/insert.md"><code translate="no">insert()</code></a> لإدراج المزيد من الكيانات في المجموعة.</p>
</div>
<div class="language-java">
<p>استخدم <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Partitions/createPartition.md"><code translate="no">createPartition()</code></a> لإنشاء أقسام و <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/insert.md"><code translate="no">insert()</code></a> لإدراج المزيد من الكيانات في المجموعة.</p>
</div>
<div class="language-javascript">
<p>استخدام <a href="https://milvus.io/api-reference/node/v2.4.x/Partitions/createPartition.md"><code translate="no">createPartition()</code></a> لإنشاء أقسام و <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/insert.md"><code translate="no">insert()</code></a> لإدراج المزيد من الكيانات في المجموعة.</p>
</div>
<div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا جافا</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Get-Entities-by-ID" class="common-anchor-header">الحصول على الكيانات حسب المعرف<button data-href="#Get-Entities-by-ID" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>إذا كنتَ تعرف معرّفات الكيانات التي تهمك، يمكنك استخدام طريقة <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/get.md"><code translate="no">get()</code></a> الطريقة.</p>
</div>
<div class="language-java">
<p>إذا كنت تعرف معرّفات الكيانات الخاصة باهتماماتك، يمكنك استخدام طريقة <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/get.md"><code translate="no">get()</code></a> الطريقة.</p>
</div>
<div class="language-javascript">
<p>إذا كنت تعرف معرّفات كيانات اهتماماتك، يمكنك استخدام الأسلوب <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/get.md"><code translate="no">get()</code></a> الطريقة.</p>
</div>
<div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا جافا</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Get-entities-from-partitions" class="common-anchor-header">الحصول على الكيانات من الأقسام<button data-href="#Get-entities-from-partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>يمكنك أيضًا الحصول على كيانات من أقسام محددة.</p>
<div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Use-Basic-Operators" class="common-anchor-header">استخدام المشغلات الأساسية<button data-href="#Use-Basic-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>في هذا القسم، ستجد أمثلة على كيفية استخدام العوامل الأساسية في التصفية العددية. يمكنك تطبيق هذه المرشحات على <a href="https://milvus.io/docs/single-vector-search.md#Filtered-search">عمليات البحث عن المتجهات</a> <a href="https://milvus.io/docs/insert-update-delete.md#Delete-entities">وحذف البيانات</a> أيضًا.</p>
<div class="language-python">
<p>لمزيد من المعلومات، ارجع إلى <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/query.md"><code translate="no">query()</code></a> في مرجع SDK.</p>
</div>
<div class="language-java">
<p>لمزيد من المعلومات، ارجع إلى <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/query.md"><code translate="no">query()</code></a> في مرجع SDK.</p>
</div>
<div class="language-javascript">
<p>لمزيد من المعلومات، ارجع إلى <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/query.md"><code translate="no">query()</code></a> في مرجع SDK.</p>
</div>
<ul>
<li><p>تصفية الكيانات التي تقع قيم علاماتها بين 1,000 إلى 1,500.</p>
...
<li><p>تصفية الكيانات التي تم تعيين قيم <strong>ألوانها</strong> إلى <strong>اللون البني</strong>.</p>
<p><div class="multipleCode">
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>تصفية الكيانات التي لم يتم تعيين قيم <strong>ألوانها</strong> إلى اللون <strong>الأخضر</strong> <strong>والأرجواني</strong>.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;quick_setup&quot;</span>,
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>تصفية الكيانات التي تبدأ علامات ألوانها <strong>باللون الأحمر</strong>.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;quick_setup&quot;</span>,
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>تصفية الكيانات التي تم تعيين ألوانها إلى اللون الأحمر وقيم العلامات ضمن النطاق من 1,000 إلى 1,500.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;quick_setup&quot;</span>,
...
<h2 id="Use-Advanced-Operators" class="common-anchor-header">استخدام المشغلات المتقدمة<button data-href="#Use-Advanced-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>في هذا القسم، ستجد أمثلةً عن كيفية استخدام المشغلات المتقدمة في التصفية القياسية. يمكنك تطبيق هذه المرشحات على <a href="https://milvus.io/docs/single-vector-search.md#Filtered-search">عمليات البحث عن المتجهات</a> <a href="https://milvus.io/docs/insert-update-delete.md#Delete-entities">وحذف البيانات</a> أيضًا.</p>
<h3 id="Count-entities" class="common-anchor-header">عد الكيانات<button data-href="#Count-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><p>يحسب العدد الإجمالي للكيانات في مجموعة.</p>
<p><div class="multipleCode">
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>يحسب العدد الإجمالي للكيانات في أقسام محددة.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>يحسب عدد الكيانات التي تطابق شرط التصفية</p>
<p><div class="multipleCode">
...
<h2 id="Reference-on-scalar-filters" class="common-anchor-header">مرجع عن المرشحات العددية<button data-href="#Reference-on-scalar-filters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><h3 id="Basic-Operators" class="common-anchor-header">المعاملات الأساسية<button data-href="#Basic-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>دائمًا ما يكون <strong>التعبير المنطقي</strong> عبارة <strong>عن سلسلة تتألف من أسماء الحقول مرتبطة بعوامل</strong>. في هذا القسم، ستتعرف في هذا القسم على المزيد عن العوامل الأساسية.</p>
<table>
<thead>
<tr><th><strong>المشغّل</strong></th><th><strong>الوصف</strong></th></tr>
</thead>
<tbody>
<tr><td><strong>و (&amp;&amp;)</strong></td><td>صحيح إذا كان كلا المعاملين صحيحين</td></tr>
<tr><td><strong>أو (||)</strong></td><td>صحيح إذا كان أحد المعاملين صحيحًا</td></tr>
<tr><td><strong>+, -, *, /</strong></td><td>الجمع، والطرح، والضرب، والقسمة</td></tr>
<tr><td><strong>**</strong></td><td>الأس</td></tr>
<tr><td><strong>%</strong></td><td>المقياس</td></tr>
<tr><td><strong><, ></strong></td><td>أقل من، أكبر من</td></tr>
<tr><td><strong>==, !=</strong></td><td>يساوي، لا يساوي</td></tr>
<tr><td><strong><=, >=</strong></td><td>أقل من أو يساوي، أكبر من أو يساوي، أكبر من أو يساوي</td></tr>
<tr><td><strong>لا يساوي</strong></td><td>يعكس نتيجة شرط معيّن.</td></tr>
<tr><td><strong>مثل</strong></td><td>يقارن قيمة بقيم مشابهة باستخدام عوامل البدل.<br/> على سبيل المثال، مثل "البادئة٪" يطابق السلاسل التي تبدأ ب "بادئة".</td></tr>
<tr><td><strong>في</strong></td><td>يختبر ما إذا كان التعبير يطابق أي قيمة في قائمة من القيم.</td></tr>
</tbody>
</table>
<h3 id="Advanced-operators" class="common-anchor-header">العوامل المتقدمة<button data-href="#Advanced-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>يحسب العدد الدقيق للكيانات في المجموعة. استخدم هذا كحقل إخراج للحصول على العدد الدقيق للكيانات في مجموعة أو قسم.</p>
<p><div class="admonition note"></p>
<p><p><b>ملاحظات</b></p></p>
<p><p>ينطبق هذا على المجموعات المحملة. يجب استخدامه كحقل الإخراج الوحيد.</p></p>
<p></div></p></li>
</ul>
