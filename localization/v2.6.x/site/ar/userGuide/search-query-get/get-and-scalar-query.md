...
<h2 id="Use-Get" class="common-anchor-header">استخدام الحصول على<button data-href="#Use-Get" class="anchor-icon" translate="no">
    ...
    </button></h2><p>عندما تحتاج إلى البحث عن كيانات حسب مفاتيحها الأساسية، يمكنك استخدام الأسلوب <strong>Get</strong>. وتفترض الأمثلة البرمجية التالية وجود ثلاثة حقول باسم <code translate="no">id</code> و <code translate="no">vector</code> و <code translate="no">color</code> في مجموعتك وإرجاع الكيانات ذات المفاتيح الأساسية <code translate="no">1</code> و <code translate="no">2</code> و <code translate="no">3</code>.</p>
