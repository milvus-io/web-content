...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Aggiornamento del cluster Milvus con Helm Chart<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare il cluster Milvus dalla v2.5.x alla v2.6.9 utilizzando Helm Chart.</p>
...
<li>Prima di eseguire l'aggiornamento alla versione 2.5.16 o successiva con <code translate="no">mixCoordinator</code> abilitato, <strong>è necessario eseguire l</strong> 'aggiornamento alla versione 2.6.9.</li>
</ul>
...
<h3 id="Step-3-Upgrade-to-v269" class="common-anchor-header">Passo 3: Aggiornamento alla v2.6.9<button data-href="#Step-3-Upgrade-to-v269" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Una volta che la v2.5.16 è in esecuzione con successo con <code translate="no">mixCoordinator</code>, aggiornare alla v2.6.9:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
