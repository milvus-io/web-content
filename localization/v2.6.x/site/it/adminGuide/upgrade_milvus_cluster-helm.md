...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Aggiornamento del cluster Milvus con Helm Chart<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare il cluster Milvus dalla v2.5.x alla v2.6.14 utilizzando Helm Chart.</p>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>non è compatibile</strong> con la versione v2.6.14. Gli aggiornamenti diretti dalle release candidate non sono supportati.</li>
...
<li>Prima di eseguire l'aggiornamento alla v2.5.16 o a una versione successiva con <code translate="no">mixCoordinator</code> abilitato, <strong>è necessario eseguire l</strong> 'aggiornamento alla v2.6.14.</li>
</ul>
...
<h3 id="Step-3-Upgrade-to-v2614" class="common-anchor-header">Passo 3: Aggiornamento alla v2.6.14<button data-href="#Step-3-Upgrade-to-v2614" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Una volta che la v2.5.16 è in esecuzione con successo con <code translate="no">mixCoordinator</code>, aggiornare alla v2.6.14:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
