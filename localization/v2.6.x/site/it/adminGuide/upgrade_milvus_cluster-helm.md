...
<li>Prima di eseguire l'aggiornamento alla v2.5.16 o a una versione successiva con <code translate="no">mixCoordinator</code> abilitato, <strong>è necessario eseguire l</strong> 'aggiornamento alla v2.6.4.</li>
</ul>
...
<h3 id="Step-3-Upgrade-to-v264" class="common-anchor-header">Passo 3: Aggiornamento alla v2.6.4<button data-href="#Step-3-Upgrade-to-v264" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Una volta che la v2.5.16 è in esecuzione con successo con <code translate="no">mixCoordinator</code>, aggiornare alla v2.6.4:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
