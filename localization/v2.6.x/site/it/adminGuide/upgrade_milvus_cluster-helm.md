...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Aggiornamento del cluster Milvus con Helm Chart<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare il cluster Milvus dalla versione 2.5.x alla versione 2.6.3 utilizzando Helm Chart.</p>
...
<li>Prima di eseguire l'aggiornamento alla versione 2.5.16 o successiva con <code translate="no">mixCoordinator</code> abilitato, <strong>è necessario eseguire l</strong> 'aggiornamento alla versione 2.6.3.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v263" class="common-anchor-header">Passo 3: Aggiornamento alla v2.6.3<button data-href="#Step-3-Upgrade-to-v263" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una volta che la v2.5.16 è in esecuzione con successo con <code translate="no">mixCoordinator</code>, eseguire l'aggiornamento alla v2.6.3:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
