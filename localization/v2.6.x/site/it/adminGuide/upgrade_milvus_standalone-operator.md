...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Aggiornamento di Milvus Standalone con Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la distribuzione Milvus standalone dalla v2.5.x alla v2.6.2 utilizzando Milvus Operator.</p>
...
<li>Prima di passare alla versione 2.6.2 <strong>è necessario eseguire</strong> l'aggiornamento alla versione 2.5.16 o successiva.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v262" class="common-anchor-header">2.2 Aggiornamento alla v2.6.2</h4><p>Una volta che la v2.5.16 è in esecuzione con successo, aggiornare alla v2.6.2:</p>
