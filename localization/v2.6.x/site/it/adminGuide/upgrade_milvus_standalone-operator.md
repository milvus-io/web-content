...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Aggiornamento di Milvus Standalone con Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la distribuzione Milvus standalone dalla v2.5.x alla v2.6.7 usando Milvus Operator.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v267" class="common-anchor-header">2.2 Aggiornamento alla v2.6.7</h4><p>Una volta che la v2.5.16 è in esecuzione con successo, aggiornare alla v2.6.7:</p>
