...
<li>Prima di passare alla versione 2.6.0 <strong>è necessario eseguire l</strong> 'aggiornamento alla versione 2.5.16 o successiva.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v260" class="common-anchor-header">2.2 Aggiornamento alla v2.6.0</h4><p>Una volta che la v2.5.16 è in funzione con successo, aggiornare alla v2.6.0:</p>
