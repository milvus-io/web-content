...
summary: >-
  Scopri come aggiornare Milvus in modalità standalone utilizzando Milvus
  Operator.
...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Aggiornamento di Milvus Standalone con Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la propria distribuzione standalone di Milvus dalla versione v2.5.x alla v2.6.23 utilizzando Milvus Operator.</p>
...
<p><strong>Limiti della coda dei messaggi</strong>: durante l’aggiornamento a Milvus v2.6.23, è necessario mantenere l’attuale scelta della coda dei messaggi. Il passaggio da un sistema di coda dei messaggi a un altro durante l’aggiornamento non è supportato. Il supporto per la modifica dei sistemi di coda dei messaggi sarà disponibile nelle versioni future.</p>
...
<p>Crea un file di configurazione denominato " <code translate="no">milvusupgrade.yaml</code> " per eseguire l'aggiornamento alla versione v2.5.16:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2623" class="common-anchor-header">2.2 Aggiornamento alla versione v2.6.23</h4><p>Una volta che la versione v2.5.16 è in esecuzione senza problemi, esegui l'aggiornamento alla versione v2.6.23:</p>
