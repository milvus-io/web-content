...
summary: Scopri come eseguire l'aggiornamento di Milvus standalone con Milvus Operator.
...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Aggiornamento di Milvus Standalone con Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la propria distribuzione standalone di Milvus dalla versione v2.5.x alla versione v2.6.24 utilizzando Milvus Operator.</p>
<h2 id="Before-you-start" class="common-anchor-header">Prima di iniziare<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>L’aggiornamento da Milvus 2.5.x alla versione 2.6.24 comporta modifiche architetturali significative:</p>
<ul>
...
<li><strong>Nuovi componenti</strong>: introduzione dello Streaming Node per un’elaborazione dei dati migliorata</li>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>non</strong> è <strong>compatibile</strong> con la versione v2.6.24. Non sono supportati gli aggiornamenti diretti dalle versioni release candidate.</li>
<li>Se attualmente si sta utilizzando la versione v2.6.0-rc1 e si desidera conservare i propri dati, consultare <a href="https://github.com/milvus-io/milvus/issues/43538#issuecomment-3112808997">questa guida della community</a> per assistenza nella migrazione.</li>
...
<p><strong>Limiti della coda dei messaggi</strong>: durante l’aggiornamento a Milvus v2.6.24, è necessario mantenere la coda dei messaggi attualmente in uso. Il passaggio da un sistema di code dei messaggi a un altro durante l’aggiornamento non è supportato. Il supporto per la modifica dei sistemi di code dei messaggi sarà disponibile nelle versioni future.</p>
<h2 id="Upgrade-process" class="common-anchor-header">Procedura di aggiornamento<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Per prima cosa, aggiorna il tuo Milvus Operator alla versione v1.3.7:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Upgrade-your-Milvus-standalone" class="common-anchor-header">Passaggio 2: aggiornare Milvus standalone<button data-href="#Step-2-Upgrade-your-Milvus-standalone" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Crea un file di configurazione denomin <code translate="no">milvusupgrade.yaml</code> per effettuare l'aggiornamento alla versione v2.5.16:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2624" class="common-anchor-header">2.2 Aggiornamento alla versione 2.6.24</h4><p>Una volta che la versione 2.5.16 è in esecuzione corretta, esegui l'aggiornamento alla versione 2.6.24:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Applica l'aggiornamento finale:</p>
<pre><code translate="no" class="language-bash">kubectl patch -f milvusupgrade.yaml --patch-file milvusupgrade.yaml --<span class="hljs-built_in">type</span> merge
<button class="copy-code-btn"></button></code></pre>
<h2 id="Verify-the-upgrade" class="common-anchor-header">Verifica l’aggiornamento<button data-href="#Verify-the-upgrade" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Verifica che la tua installazione standalone utilizzi la nuova versione:</p>
