...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2617" class="common-anchor-header">2.2 Aggiornamento alla versione 2.6.17</h4><p>Una volta che la versione v2.5.16 è in esecuzione senza problemi, esegui l'aggiornamento alla versione v2.6.17:</p>
