...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Aggiornamento di Milvus Standalone con Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la propria distribuzione standalone di Milvus dalla versione v2.5.x alla v2.6.19 utilizzando Milvus Operator.</p>
...
<p>Crea un file di configurazione <code translate="no">milvusupgrade.yaml</code> per eseguire l'aggiornamento alla versione v2.5.16:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2619" class="common-anchor-header">2.2 Aggiornamento alla versione 2.6.19</h4><p>Una volta che la versione v2.5.16 è in esecuzione corretta, esegui l'aggiornamento alla versione v2.6.19:</p>
