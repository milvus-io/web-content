...
<h2 id="Configure-RocksMQ" class="common-anchor-header">Configurazione di RocksMQ<button data-href="#Configure-RocksMQ" class="anchor-icon" translate="no">
    ...
    </button></h2><p>RocksMQ è l’archivio messaggi predefinito in Milvus standalone.</p>
...
<h2 id="Configure-Woodpecker" class="common-anchor-header">Configurazione di Woodpecker<button data-href="#Configure-Woodpecker" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Woodpecker è un Write-Ahead Log (WAL) cloud-native progettato per lo storage a oggetti. Offre un throughput elevato, un basso overhead operativo e una scalabilità senza soluzione di continuità. Per ulteriori dettagli, consultare <a href="/docs/it/v2.6.x/use-woodpecker.md">Utilizzo di Woodpecker</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<blockquote>
<p>Le configurazioni SASL sono supportate a partire dalla versione v0.8.5 dell’operatore o successive.</p>
</blockquote>
...
<ul>
<li><a href="/docs/it/v2.6.x/object_storage_operator.md">Configurare l’Object Storage con Milvus Operator</a></li>
<li><a href="/docs/it/v2.6.x/meta_storage_operator.md">Configurare Meta Storage con Milvus Operator</a></li>
</ul>
