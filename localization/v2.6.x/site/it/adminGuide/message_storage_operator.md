...
<p>È necessario specificare un file di configurazione per l’utilizzo di Milvus Operator al fine di avviare un cluster Milvus.</p>
...
<ul>
<li>modalità standalone:  RocksMQ (impostazione predefinita) &gt; Pulsar &gt; Kafka</li>
...
<li><code translate="no">persistence.pvcDeletion</code>: Se impostato su true, il PVC verrà eliminato all’eliminazione dell’istanza Milvus</li>
...
<span class="hljs-attr">spec:</span> 
  ...
  <span class="hljs-attr">config:</span> {}
<button class="copy-code-btn"></button></code></pre>
<p><a href="https://artifacthub.io/packages/helm/bitnami/kafka">Qui</a> è possibile trovare tutte le voci di configurazione necessarie per configurare un servizio Kafka interno. Aggiungere le voci di configurazione necessarie in <code translate="no">kafka.inCluster.values</code>.</p>
