...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Aggiornamento di Milvus Standalone con Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la distribuzione Milvus standalone dalla v2.5.x alla v2.6.4 utilizzando Helm Chart.</p>
<h2 id="Before-you-start" class="common-anchor-header">Prima di iniziare<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v264" class="common-anchor-header">Novità della v2.6.4<button data-href="#Whats-new-in-v264" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>L'aggiornamento da Milvus 2.5.x a 2.6.4 comporta cambiamenti architetturali significativi:</p>
<ul>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>non è compatibile</strong> con la v2.6.4. Gli aggiornamenti diretti dalle release candidate non sono supportati.</li>
<li>Se attualmente si sta eseguendo la v2.6.0-rc1 e si desidera preservare i dati, si prega di fare riferimento a <a href="https://github.com/milvus-io/milvus/issues/43538#issuecomment-3112808997">questa guida della comunità</a> per l'assistenza alla migrazione.</li>
<li><strong>È necessario eseguire l</strong> 'aggiornamento alla versione 2.5.16 o successiva prima di eseguire l'aggiornamento alla versione 2.6.4.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v264" class="common-anchor-header">Passo 3: Aggiornamento alla v2.6.4<button data-href="#Step-3-Upgrade-to-v264" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una volta che la v2.5.16 è in esecuzione con successo, aggiornare alla v2.6.4:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
