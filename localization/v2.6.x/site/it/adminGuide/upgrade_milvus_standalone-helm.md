...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Aggiornamento di Milvus Standalone con Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la distribuzione standalone di Milvus dalla versione v2.5.x alla v2.6.19 utilizzando Helm Chart.</p>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>non</strong> è <strong>compatibile</strong> con la versione v2.6.19. Gli aggiornamenti diretti dalle versioni release candidate non sono supportati.</li>
...
<li><strong>È necessario</strong> eseguire l’aggiornamento alla versione v2.5.16 o successive prima di passare alla v2.6.19.</li>
</ul>
<p><strong>Limiti della coda dei messaggi</strong>: durante l'aggiornamento a Milvus v2.6.19, è necessario mantenere la coda dei messaggi attualmente in uso. Il passaggio a sistemi di code dei messaggi diversi durante l'aggiornamento non è supportato. Il supporto per la modifica dei sistemi di code dei messaggi sarà disponibile nelle versioni future.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v2619" class="common-anchor-header">Passaggio 3: Aggiornamento alla versione v2.6.19<button data-href="#Step-3-Upgrade-to-v2619" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una volta che la versione 2.5.16 è in esecuzione corretta, esegui l'aggiornamento alla versione 2.6.19:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
