...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Aggiornamento di Milvus standalone con Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la distribuzione Milvus standalone dalla v2.5.x alla v2.6.2 utilizzando Helm Chart.</p>
<h2 id="Before-you-start" class="common-anchor-header">Prima di iniziare<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v262" class="common-anchor-header">Cosa c'è di nuovo nella v2.6.2<button data-href="#Whats-new-in-v262" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>L'aggiornamento da Milvus 2.5.x a 2.6.2 comporta cambiamenti architetturali significativi:</p>
<ul>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>non è compatibile</strong> con v2.6.2. Gli aggiornamenti diretti dalle release candidate non sono supportati.</li>
...
<li>Prima di passare alla versione 2.6.2 <strong>è necessario</strong> aggiornare alla versione 2.5.16 o successiva.</li>
</ul>
<div class="alert note">
Dalla versione 4.2.21 della carta Milvus Helm, abbiamo introdotto la carta pulsar-v3.x come dipendenza. Per la retrocompatibilità, aggiornare Helm alla versione 3.14 o successiva e assicurarsi di aggiungere l'opzione <code translate="no">--reset-then-reuse-values</code> ogni volta che si usa <code translate="no">helm upgrade</code>.</div>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v262" class="common-anchor-header">Passo 3: Aggiornamento alla v2.6.2<button data-href="#Step-3-Upgrade-to-v262" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una volta che la v2.5.16 è in esecuzione con successo, eseguire l'aggiornamento alla v2.6.2:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
