...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Aggiornamento di Milvus Standalone con Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la distribuzione Milvus standalone dalla v2.5.x alla v2.6.6 utilizzando Helm Chart.</p>
<h2 id="Before-you-start" class="common-anchor-header">Prima di iniziare<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v266" class="common-anchor-header">Novità della versione 2.6.6<button data-href="#Whats-new-in-v266" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>L'aggiornamento da Milvus 2.5.x a 2.6.6 comporta cambiamenti architetturali significativi:</p>
<ul>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>non è compatibile</strong> con la versione v2.6.6. Gli aggiornamenti diretti dalle release candidate non sono supportati.</li>
...
<li><strong>È necessario eseguire l</strong> 'aggiornamento alla versione 2.5.16 o successiva prima di eseguire l'aggiornamento alla versione 2.6.6.</li>
</ul>
<p><strong>Limitazioni della coda di messaggi</strong>: Quando si esegue l'aggiornamento a Milvus v2.6.6, è necessario mantenere l'attuale scelta della coda di messaggi. Il passaggio da un sistema di code di messaggi all'altro durante l'aggiornamento non è supportato. Il supporto per il cambio di sistemi di code di messaggi sarà disponibile nelle versioni future.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v266" class="common-anchor-header">Fase 3: Aggiornamento alla v2.6.6<button data-href="#Step-3-Upgrade-to-v266" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una volta che la v2.5.16 è in esecuzione con successo, eseguire l'aggiornamento alla v2.6.6:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
