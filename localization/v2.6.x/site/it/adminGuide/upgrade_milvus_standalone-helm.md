...
---
<div class="tab-wrapper"><a href="/docs/it/v2.6.x/upgrade_milvus_standalone-operator.md" class=''>Milvus</a><a href="/docs/it/v2.6.x/upgrade_milvus_standalone-helm.md" class='active '>OperatorHelmDocker</a><a href="/docs/it/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>Compose</a></div>
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Aggiornamento di Milvus standalone con i grafici Helm<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare Milvus standalone con i diagrammi di Milvus Helm.</p>
<div class="alert note">
<p>L'aggiornamento da Milvus 2.5.x (o versioni precedenti) a 2.6.0-rc1 comporta cambiamenti architettonici significativi che rendono questo aggiornamento <strong>irreversibile</strong>. A causa dell'introduzione di nuovi componenti (come Woodpecker e Streaming Node) e della rimozione di alcuni componenti, <strong>non è possibile tornare a una versione precedente una volta completato l'aggiornamento</strong>. Per maggiori dettagli sulle modifiche architettoniche introdotte nella versione 2.6.0-rc1, consultare la <a href="/docs/it/v2.6.x/architecture_overview.md">Panoramica dell'architettura Milvus</a>.</p>
</div>
...
<div style="display: none;">- Eseguire un aggiornamento continuo](#conduct-a-rolling-upgrade) da Milvus v2.2.3 e versioni successive a v2.6.0-rc1.</div>
<ul>
<li><p><a href="#Upgrade-Milvus-using-Helm">Aggiornare Milvus utilizzando Helm</a> per un aggiornamento da una release minore precedente alla v2.2.3 alla v2.6.0-rc1.</p></li>
<li><p><a href="#Migrate-the-metadata">Migrare i metadati</a> prima dell'aggiornamento da Milvus v2.1.x a v2.6.0-rc1.</p></li>
</ul>
...
<p>Dopo essersi assicurati che tutte le distribuzioni nella vostra istanza Milvus siano nello stato normale. Potete eseguire il seguente comando per aggiornare l'istanza Milvus alla versione 2.6.0-rc1.</p>
...
<h4 id="2-Upgrade-Milvus-from-v21x-to-260-rc1" class="common-anchor-header">2. Aggiornare Milvus da v2.1.x a 2.6.0-rc1</h4><p>I comandi seguenti presuppongono l'aggiornamento di Milvus dalla v2.1.4 alla 2.6.0-rc1. Modificateli in base alle vostre esigenze.</p>
<ol>
<li><p>Specificare il nome dell'istanza di Milvus, la versione di Milvus di partenza e la versione di Milvus di arrivo.</p>
