...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Aggiornamento di Milvus Standalone con Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la propria distribuzione standalone di Milvus dalla versione v2.5.x alla v2.6.19 utilizzando Docker Compose.</p>
...
<p>Per motivi di sicurezza, con il rilascio della v2.6.19 Milvus aggiorna MinIO alla versione RELEASE.2024-12-18T13-15-44Z.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v2619" class="common-anchor-header">Passaggio 2: Aggiornamento alla versione 2.6.19<button data-href="#Step-2-Upgrade-to-v2619" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una volta che la versione v2.5.16 è in esecuzione corretta, esegui l'aggiornamento alla versione v2.6.19:</p>
<ol>
