...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Aggiornamento di Milvus standalone con Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la distribuzione standalone di Milvus dalla v2.5.x alla v2.6.7 usando Docker Compose.</p>
<h2 id="Before-you-start" class="common-anchor-header">Prima di iniziare<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v267" class="common-anchor-header">Cosa c'è di nuovo nella v2.6.7<button data-href="#Whats-new-in-v267" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>non è compatibile</strong> con la versione v2.6.7. Gli aggiornamenti diretti dalle release candidate non sono supportati.</li>
<li>Se attualmente si sta eseguendo la v2.6.0-rc1 e si desidera preservare i propri dati, consultare la <a href="https://github.com/milvus-io/milvus/issues/43538#issuecomment-3112808997">guida della comunità</a> per l'assistenza alla migrazione.</li>
<li><strong>È necessario eseguire l</strong> 'aggiornamento alla versione v2.5.16 o successiva prima di passare alla versione v2.6.7.</li>
</ul>
...
<p>A causa di problemi di sicurezza, Milvus aggiorna il suo MinIO a RELEASE.2024-12-18T13-15-44Z con il rilascio della v2.6.7.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v267" class="common-anchor-header">Passo 2: Aggiornamento alla v2.6.7<button data-href="#Step-2-Upgrade-to-v267" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
