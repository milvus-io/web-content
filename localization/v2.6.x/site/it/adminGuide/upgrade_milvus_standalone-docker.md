...
<h2 id="Upgrade-process" class="common-anchor-header">Processo di aggiornamento<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Upgrade-to-v2516" class="common-anchor-header">Passo 1: aggiornamento alla versione 2.5.16</h3><div class="alert note">
...
<h3 id="Step-2-Upgrade-to-v260" class="common-anchor-header">Passo 2: Aggiornamento alla v2.6.0</h3><p>Una volta che la v2.5.16 è stata eseguita con successo, aggiornare alla v2.6.0:</p>
<ol>
