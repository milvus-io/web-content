...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Aggiornamento di Milvus standalone con Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la distribuzione standalone di Milvus dalla v2.5.x alla v2.6.14 utilizzando Docker Compose.</p>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>non è compatibile</strong> con v2.6.14. Gli aggiornamenti diretti dalle release candidate non sono supportati.</li>
...
<p>A causa di problemi di sicurezza, Milvus aggiorna il suo MinIO a RELEASE.2024-12-18T13-15-44Z con il rilascio della v2.6.14.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v2614" class="common-anchor-header">Passo 2: Aggiornamento alla v2.6.14<button data-href="#Step-2-Upgrade-to-v2614" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una volta che la v2.5.16 è stata eseguita correttamente, aggiornare alla v2.6.14:</p>
<ol>
