...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Aggiornamento di Milvus standalone con Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la distribuzione standalone di Milvus dalla v2.5.x alla v2.6.6 usando Docker Compose.</p>
...
<p>A causa di problemi di sicurezza, Milvus aggiorna il suo MinIO a RELEASE.2024-12-18T13-15-44Z con il rilascio della v2.6.6.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v266" class="common-anchor-header">Passo 2: Aggiornamento alla v2.6.6<button data-href="#Step-2-Upgrade-to-v266" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una volta che la v2.5.16 è stata eseguita con successo, aggiornare alla v2.6.6:</p>
<ol>
