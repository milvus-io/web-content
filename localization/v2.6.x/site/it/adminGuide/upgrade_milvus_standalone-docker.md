...
---
<div class="tab-wrapper"><a href="/docs/it/v2.6.x/upgrade_milvus_standalone-operator.md" class=''>Milvus</a><a href="/docs/it/v2.6.x/upgrade_milvus_standalone-docker.md" class='active '>Operator</a>, Helm, Docker<a href="/docs/it/v2.6.x/upgrade_milvus_standalone-docker.md" class='active '>Compose</a></div>
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Aggiornamento di Milvus Standalone con Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare la propria distribuzione standalone di Milvus dalla versione v2.5.x alla v2.6.21 utilizzando Docker Compose.</p>
<h2 id="Before-you-start" class="common-anchor-header">Prima di iniziare<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v2621" class="common-anchor-header">Novità della versione v2.6.21<button data-href="#Whats-new-in-v2621" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>L'aggiornamento da Milvus 2.5.x alla versione 2.6.21 comporta modifiche architetturali significative:</p>
<ul>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>non</strong> è <strong>compatibile</strong> con la versione v2.6.21. Gli aggiornamenti diretti dalle versioni candidate al rilascio non sono supportati.</li>
...
<li><strong>È necessario</strong> eseguire l'aggiornamento alla versione v2.5.16 o successive prima di passare alla v2.6.21.</li>
</ul>
<p><strong>Limiti della coda dei messaggi</strong>: durante l'aggiornamento a Milvus v2.6.21, è necessario mantenere l'attuale scelta della coda dei messaggi. Il passaggio tra diversi sistemi di code dei messaggi durante l'aggiornamento non è supportato. Il supporto per la modifica dei sistemi di code dei messaggi sarà disponibile nelle versioni future.</p>
<div class="alter note">
<p>Per motivi di sicurezza, con il rilascio della v2.6.21 Milvus aggiorna MinIO alla versione RELEASE.2024-12-18T13-15-44Z.</p>
</div>
<h2 id="Upgrade-process" class="common-anchor-header">Procedura di aggiornamento<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Upgrade-to-v2516" class="common-anchor-header">Passaggio 1: Aggiornamento alla versione v2.5.16<button data-href="#Step-1-Upgrade-to-v2516" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Step-2-Upgrade-to-v2621" class="common-anchor-header">Passaggio 2: Aggiornamento alla versione 2.6.21<button data-href="#Step-2-Upgrade-to-v2621" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una volta che la versione v2.5.16 è in esecuzione corretta, esegui l'aggiornamento alla versione v2.6.21:</p>
<ol>
...
<h2 id="Verify-the-upgrade" class="common-anchor-header">Verifica l'aggiornamento<button data-href="#Verify-the-upgrade" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Verifica che la tua distribuzione standalone stia utilizzando la nuova versione:</p>
...
<li>Potresti anche voler imparare come:
<ul>
<li><a href="/docs/it/v2.6.x/scaleout.md">Scalare un cluster Milvus</a></li>
</ul></li>
<li>Se sei pronto a distribuire il tuo cluster su cloud:
<ul>
<li>Scopri come <a href="/docs/it/v2.6.x/eks.md">distribuire Milvus su Amazon EKS con Terraform</a></li>
<li>Scopri come <a href="/docs/it/v2.6.x/gcp.md">distribuire un cluster Milvus su GCP con Kubernetes</a></li>
<li>Scopri come <a href="/docs/it/v2.6.x/azure.md">distribuire Milvus su Microsoft Azure con Kubernetes</a></li>
</ul></li>
</ul>
