...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Aggiornamento del cluster Milvus con Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare il cluster Milvus dalla versione 2.5.x alla versione 2.6.13 utilizzando Milvus Operator.</p>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>non è compatibile</strong> con la versione 2.6.13. Gli aggiornamenti diretti dalle release candidate non sono supportati.</li>
...
<li>Prima di eseguire l'aggiornamento alla versione 2.5.16 o successiva con <code translate="no">mixCoord</code> abilitato, <strong>è necessario eseguire l</strong> 'aggiornamento alla versione 2.6.13.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2613" class="common-anchor-header">2.3 Aggiornamento alla v2.6.13</h4><p>Una volta che la v2.5.16 è in esecuzione con successo con <code translate="no">mixCoord</code>, aggiornare alla v2.6.13:</p>
