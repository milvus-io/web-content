...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Aggiornamento del cluster Milvus con Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare il cluster Milvus dalla versione 2.5.x alla versione 2.6.17 utilizzando Milvus Operator.</p>
<h2 id="Before-you-start" class="common-anchor-header">Prima di iniziare<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v2617" class="common-anchor-header">Novità della versione 2.6.17<button data-href="#Whats-new-in-v2617" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>L'aggiornamento da Milvus 2.5.x a 2.6.17 comporta cambiamenti architettonici significativi:</p>
<ul>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>non è compatibile</strong> con v2.6.17. Gli aggiornamenti diretti da release candidate non sono supportati.</li>
...
<li>Prima di eseguire l'aggiornamento alla versione 2.5.16 o successiva con <code translate="no">mixCoord</code> abilitato, <strong>è necessario eseguire l</strong> 'aggiornamento alla versione 2.6.17.</li>
</ul>
<p><strong>Limitazioni della coda di messaggi</strong>: Quando si esegue l'aggiornamento a Milvus v2.6.17, è necessario mantenere l'attuale scelta della coda di messaggi. Il passaggio da un sistema di code di messaggi all'altro durante l'aggiornamento non è supportato. Il supporto per il cambio di sistemi di code di messaggi sarà disponibile nelle versioni future.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2617" class="common-anchor-header">2.3 Aggiornamento alla v2.6.17</h4><p>Una volta che la v2.5.16 è in esecuzione con successo con <code translate="no">mixCoord</code>, aggiornare alla v2.6.17:</p>
