...
<h2 id="Before-you-start" class="common-anchor-header">Prima di iniziare<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><p>A partire da Milvus 2.6.0, i coordinatori separati preesistenti (<code translate="no">dataCoord</code>, <code translate="no">queryCoord</code>, <code translate="no">indexCoord</code>) sono stati consolidati in un unico <code translate="no">mixCoord</code>. Prima di effettuare l'aggiornamento, assicuratevi che la vostra specifica CRD utilizzi <code translate="no">mixCoord</code> piuttosto che i singoli componenti del coordinatore.</p>
<p>Se si utilizzano i coordinatori separati, modificare le specifiche:</p>
...
<h2 id="Upgrade-your-Milvus-operator" class="common-anchor-header">Aggiornare l'operatore Milvus<button data-href="#Upgrade-your-Milvus-operator" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Eseguite il seguente comando per aggiornare la versione del vostro Milvus Operator a v1.3.0-rc1-hotfix.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Una volta aggiornato l'operatore Milvus all'ultima versione, si può scegliere tra le seguenti opzioni:</p>
<ul>
<li>Per aggiornare Milvus dalla versione 2.2.3, potete <a href="#Conduct-a-rolling-upgrade">eseguire un aggiornamento continuo</a>.</li>
<li>Per aggiornare Milvus da una versione minore precedente alla v2.2.3 alla 2.6.0-rc1, si consiglia di <a href="#Upgrade-Milvus-by-changing-its-image">aggiornare Milvus cambiando la versione dell'immagine</a>.</li>
<li>Per aggiornare Milvus dalla v2.1.x alla 2.6.0-rc1, è necessario <a href="#Migrate-the-metadata">migrare i metadati</a> prima dell'aggiornamento effettivo.</li>
</ul>
<blockquote>
<p><strong>Nota</strong>: si consiglia di aggiornare una versione minore alla volta e di utilizzare l'ultima versione stabile di quella versione minore. Ad esempio, se si sta effettuando l'aggiornamento dalla v2.4.x alla v2.6.x, si dovrebbe prima effettuare l'aggiornamento alla v2.4.x più recente, poi alla v2.5.x più recente e infine alla v2.6.x. In questo modo si garantisce l'utilizzo dell'ultima release stabile di ogni versione minore, che è più probabile sia compatibile con i dati e le configurazioni esistenti.</p>
</blockquote>
