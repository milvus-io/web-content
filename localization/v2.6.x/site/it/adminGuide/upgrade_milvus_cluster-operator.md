...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Aggiornamento del cluster Milvus con Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare il cluster Milvus dalla versione 2.5.x alla versione 2.6.7 utilizzando Milvus Operator.</p>
<h2 id="Before-you-start" class="common-anchor-header">Prima di iniziare<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>L'aggiornamento da Milvus 2.5.x a 2.6.7 comporta cambiamenti architettonici significativi:</p>
<ul>
...
<ul>
<li>Milvus v2.6.0-rc1 <strong>non è compatibile</strong> con la versione 2.6.7. Gli aggiornamenti diretti da release candidate non sono supportati.</li>
...
<li>Prima di eseguire l'aggiornamento alla versione 2.5.16 o successiva con <code translate="no">mixCoord</code> abilitato, <strong>è necessario eseguire l</strong> 'aggiornamento alla versione 2.6.7.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v267" class="common-anchor-header">2.3 Aggiornamento alla v2.6.7</h4><p>Una volta che la v2.5.16 è in esecuzione con successo con <code translate="no">mixCoord</code>, aggiornate alla v2.6.7:</p>
