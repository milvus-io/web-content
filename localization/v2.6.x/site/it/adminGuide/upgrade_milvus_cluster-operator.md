...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Aggiornamento del cluster Milvus con Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come aggiornare il cluster Milvus dalla versione v2.5.x alla v2.6.21 utilizzando Milvus Operator.</p>
...
<li><strong>È necessario</strong> eseguire l'aggiornamento alla versione v2.5.16 o successive con l'opzione " <code translate="no">mixCoord</code> " abilitata prima di passare alla versione v2.6.21.</li>
</ul>
<p><strong>Limitazioni relative alle code dei messaggi</strong>: durante l’aggiornamento a Milvus v2.6.21, è necessario mantenere l’attuale scelta relativa alla coda dei messaggi. Il passaggio da un sistema di code dei messaggi a un altro durante l’aggiornamento non è supportato. Il supporto per la modifica dei sistemi di code dei messaggi sarà disponibile nelle versioni future.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2621" class="common-anchor-header">2.3 Aggiornamento alla versione v2.6.21</h4><p>Una volta che la versione 2.5.16 è in esecuzione con successo con l'opzione " <code translate="no">mixCoord</code>", eseguire l'aggiornamento alla versione 2.6.21:</p>
