...
title: Costruire RAG con Milvus e Lepton AIAbout to Deprecate
---
<h1 id="Build-RAG-with-Milvus-and-Lepton-AI" class="common-anchor-header">Costruire RAG con Milvus e Lepton AI<span class="beta-tag" style="background-color:#FF7F47;color:white" translate="no">About to Deprecate</span><button data-href="#Build-RAG-with-Milvus-and-Lepton-AI" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Prepare-the-LLM-and-Embedding-Model" class="common-anchor-header">Preparare l'LLM e il modello di incorporamento<button data-href="#Prepare-the-LLM-and-Embedding-Model" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Lepton abilita l'API in stile OpenAI e si può usare la stessa API con piccoli aggiustamenti per chiamare l'LLM.</p>
