...
summary: >-
  ...
  risultati migliori.
title: RAG agenziale con Milvus e LangGraph
---
...
<h1 id="Agentic-RAG-with-Milvus-and-LangGraph" class="common-anchor-header">RAG agenziale con Milvus e LangGraph<button data-href="#Agentic-RAG-with-Milvus-and-LangGraph" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>valutare la rilevanza dei documenti recuperati</li>
<li>riscrivere le domande quando i documenti recuperati non sono rilevanti</li>
<li>Generare risposte di alta qualità basate su un contesto rilevante</li>
</ul>
...
<h2 id="Prepare-the-data" class="common-anchor-header">Preparare i dati<button data-href="#Prepare-the-data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Utilizziamo Langchain <a href="https://python.langchain.com/docs/integrations/document_loaders/web_base/">WebBaseLoader</a> per caricare i documenti dei <a href="https://lilianweng.github.io/">post del blog di Lilian Weng</a> e dividerli in parti utilizzando <a href="https://python.langchain.com/docs/how_to/recursive_text_splitter/">RecursiveCharacterTextSplitter</a>.</p>
...
<h2 id="Create-a-retriever-tool-with-Milvus" class="common-anchor-header">Creare uno strumento retriever con Milvus<button data-href="#Create-a-retriever-tool-with-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ora creeremo un archivio vettoriale con Milvus per indicizzare i pezzi di documento e creare uno strumento di recupero che il nostro agente possa utilizzare.</p>
...
<blockquote>
<p>Per il file <code translate="no">connection_args</code>:</p>
<ul>
<li>L'impostazione di <code translate="no">uri</code> come file locale, ad esempio<code translate="no">./milvus_agentic_rag.db</code>, è il metodo più conveniente, poiché utilizza automaticamente <a href="https://milvus.io/docs/milvus_lite.md">Milvus Lite</a> per memorizzare tutti i dati in questo file.</li>
...
<h2 id="Build-the-agentic-RAG-graph" class="common-anchor-header">Costruire il grafo agenziale RAG<button data-href="#Build-the-agentic-RAG-graph" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><h3 id="Define-the-graph-state" class="common-anchor-header">Definire lo stato del grafo<button data-href="#Define-the-graph-state" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Utilizzeremo <code translate="no">MessagesState</code> di LangGraph, che mantiene un elenco di messaggi nella conversazione.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Node-1-Generate-query-or-respond" class="common-anchor-header">Nodo 1: Generare una domanda o rispondere<button data-href="#Node-1-Generate-query-or-respond" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Questo nodo decide se utilizzare lo strumento retriever per cercare informazioni o rispondere direttamente all'utente.</p>
...
<h3 id="Node-2-Grade-documents" class="common-anchor-header">Nodo 2: Valutazione dei documenti<button data-href="#Node-2-Grade-documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Questo nodo valuta se i documenti recuperati sono pertinenti alla domanda dell'utente.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Node-3-Rewrite-question" class="common-anchor-header">Nodo 3: Riscrivere la domanda<button data-href="#Node-3-Rewrite-question" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Se i documenti non sono pertinenti, questo nodo riscrive la domanda per migliorare i risultati del recupero.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Node-4-Generate-answer" class="common-anchor-header">Nodo 4: Generare la risposta<button data-href="#Node-4-Generate-answer" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Questo nodo genera la risposta finale sulla base dei documenti rilevanti recuperati.</p>
<pre><code translate="no" class="language-python"><span class="hljs-keyword">def</span> <span class="hljs-title function_">generate</span>(<span class="hljs-params">state: MessagesState</span>):
    ...
    <span class="hljs-keyword">return</span> {<span class="hljs-string">&quot;messages&quot;</span>: [response]}
<button class="copy-code-btn"></button></code></pre>
<h3 id="Assemble-the-graph" class="common-anchor-header">Assemblare il grafo<button data-href="#Assemble-the-graph" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Ora colleghiamo tutti i nodi per creare il nostro flusso di lavoro agenziale RAG.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Visualizziamo la struttura del grafo per comprendere il flusso di lavoro:</p>
...
<h2 id="Run-the-agentic-RAG-system" class="common-anchor-header">Eseguire il sistema agentico RAG<button data-href="#Run-the-agentic-RAG-system" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Ora testiamo il nostro sistema agentic RAG con diversi tipi di query.</p>
<h3 id="Test-1-Simple-greeting-no-retrieval-needed" class="common-anchor-header">Test 1: Saluto semplice (nessun recupero necessario)<button data-href="#Test-1-Simple-greeting-no-retrieval-needed" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Test-2-Question-requiring-retrieval" class="common-anchor-header">Test 2: Domanda che richiede il recupero<button data-href="#Test-2-Question-requiring-retrieval" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Test-3-Question-that-might-trigger-rewrite" class="common-anchor-header">Test 3: Domanda che potrebbe innescare una riscrittura<button data-href="#Test-3-Question-that-might-trigger-rewrite" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
