...
<h2 id="Configuration-and-Setup" class="common-anchor-header">Configurazione e impostazione<button data-href="#Configuration-and-Setup" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Configuriamo i parametri globali per l'integrazione. Utilizzeremo il modello di embedding di Gemini per generare rappresentazioni vettoriali dei nostri documenti.</p>
