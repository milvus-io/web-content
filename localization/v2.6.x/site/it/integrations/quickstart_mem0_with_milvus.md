...
<p>In questo tutorial, verranno illustrate le operazioni essenziali di gestione della memoria di Mem0: inserimento, recupero, aggiornamento, ricerca, cancellazione e tracciamento della cronologia della memoria, utilizzando <a href="https://milvus.io/">Milvus</a>, un database vettoriale open source ad alte prestazioni che consente di memorizzare e recuperare in modo efficiente. Questa introduzione pratica vi guiderà attraverso le operazioni di memoria fondamentali per aiutarvi a costruire interazioni AI personalizzate con Mem0 e Milvus.</p>
<h2 id="Preparation" class="common-anchor-header">Preparazione<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Download-required-libraries" class="common-anchor-header">Scaricare le librerie necessarie<button data-href="#Download-required-libraries" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Configure-Mem0-with-Milvus" class="common-anchor-header">Configurare Mem0 con Milvus<button data-href="#Configure-Mem0-with-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>In questo esempio utilizzeremo OpenAI come LLM. È necessario preparare la <a href="https://platform.openai.com/docs/quickstart">chiave api</a> <code translate="no">OPENAI_API_KEY</code> come variabile d'ambiente.</p>
...
<h2 id="Managing-User-Memories-with-Mem0-and-Milvus" class="common-anchor-header">Gestione delle memorie utente con Mem0 e Milvus<button data-href="#Managing-User-Memories-with-Mem0-and-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Adding-a-Memory" class="common-anchor-header">Aggiunta di una memoria<button data-href="#Adding-a-Memory" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>La funzione <code translate="no">add</code> memorizza un testo non strutturato in Milvus come memoria, associandolo a un utente specifico e a metadati opzionali.</p>
...
<h3 id="Update-a-Memory" class="common-anchor-header">Aggiornare una memoria<button data-href="#Update-a-Memory" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Possiamo usare il valore di ritorno della funzione <code translate="no">add</code> per recuperare l'ID della memoria, in modo da aggiornare questa memoria con nuove informazioni tramite <code translate="no">update</code>.</p>
...
<h3 id="Get-All-Memory-For-a-User" class="common-anchor-header">Ottenere tutte le memorie di un utente<button data-href="#Get-All-Memory-For-a-User" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>È possibile utilizzare la funzione <code translate="no">get_all</code> per visualizzare tutte le memorie inserite o per filtrare <code translate="no">user_id</code> in Milvus.</p>
...
<h3 id="View-Memory-Update-History" class="common-anchor-header">Visualizzazione della cronologia degli aggiornamenti della memoria<button data-href="#View-Memory-Update-History" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>È possibile visualizzare la cronologia degli aggiornamenti della memoria specificando l'ID memoria che ci interessa tramite la funzione <code translate="no">history</code>.</p>
...
<h3 id="Search-Memory" class="common-anchor-header">Ricerca nella memoria<button data-href="#Search-Memory" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Possiamo usare la funzione <code translate="no">search</code> per cercare la memoria più correlata all'utente.</p>
...
<h3 id="Delete-Memory" class="common-anchor-header">Cancellare la memoria<button data-href="#Delete-Memory" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Possiamo anche <code translate="no">delete</code> una memoria fornendo il corrispondente <code translate="no">memory_id</code>.</p>
