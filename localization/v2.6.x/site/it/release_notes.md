...
<h3 id="Core-260-features-recall" class="common-anchor-header">Richiamo delle caratteristiche del Core 2.6.0</h3><div class="alert note">
...
<li>RaBitQ Quantizzazione a 1 bit con elevato richiamo</li>
...
<h3 id="Architecture-Changes" class="common-anchor-header">Modifiche all'architettura</h3><p>Dalla versione 2.6, Milvus introduce significative modifiche architettoniche volte a migliorare le prestazioni, la scalabilità e la facilità d'uso. Per ulteriori informazioni, consultare la <a href="/docs/it/architecture_overview.md">Panoramica dell'architettura di Milvus</a>.</p>
