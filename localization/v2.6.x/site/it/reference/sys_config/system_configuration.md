...
<h3 id="indexCoord" class="common-anchor-header"><code translate="no">indexCoord</code></h3><p>Vedere <a href="/docs/it/configure_indexcoord.md">Configurazioni relative a indexCoord</a> per una descrizione dettagliata di ogni parametro di questa sezione.</p>
