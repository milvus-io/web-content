  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>fino a quando l'NQ nella coda non supera più la soglia nqInQueueThreshold. Il QN della richiesta di query viene considerato pari a 1.</li>      
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>Se la latenza dql dell'accodamento è maggiore di queueLatencyThreshold, i tassi di ricerca e di interrogazione si raffreddano gradualmente.</li>      
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>Se la velocità dei risultati dql è superiore a maxReadResultRate, la velocità di ricerca e interrogazione si raffredda gradualmente fino a quando la velocità dei risultati di lettura non supera più maxReadResultRate.</li>      
        <li>fino a quando la velocità dei risultati di lettura non supera più maxReadResultRate.</li>      
