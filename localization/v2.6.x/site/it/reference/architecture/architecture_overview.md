...
<p>Milvus adotta un'architettura di storage condiviso con livelli di storage e di calcolo completamente disaggregati, consentendo la scalabilità orizzontale dei nodi di calcolo. Implementando Woodpecker come livello WAL (write-ahead-log) a zero dischi, Milvus diventa sempre più elastico e cloud-native, riducendo al contempo i costi operativi. Seguendo il principio della disaggregazione del piano dati e del piano di controllo, Milvus comprende <a href="/docs/it/four_layers.md">quattro livelli</a>: il livello di accesso, il servizio di coordinamento, il nodo lavoratore e lo storage, ognuno dei quali può essere scalato o ripristinato senza impattare sugli altri.</p>
<p>
