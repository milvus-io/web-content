...
<h2 id="Installation" class="common-anchor-header">Installazione<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Il modo consigliato per iniziare a utilizzare il client Milvus per Node.js è utilizzare npm (Node Package Manager) per installare la dipendenza nel proprio progetto.</p>
...
<li><p>Esplora <a href="/api-reference/node/v2.4.x/About.md">la documentazione di riferimento dell'API Milvus per Node.js</a></p></li>
</ul>
