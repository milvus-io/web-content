...
<p><strong>Novità della versione 2.6.8:</strong></p>
<ul>
...
<p>Scaricare sempre l'ultima configurazione di Docker Compose per garantire la compatibilità con le funzioni della versione 2.6.8.</p>
<ul>
