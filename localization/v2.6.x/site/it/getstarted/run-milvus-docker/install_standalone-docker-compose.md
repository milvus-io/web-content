...
<p><strong>Novità della versione 2.6.7:</strong></p>
<ul>
...
<p>Scaricare sempre la configurazione più recente di Docker Compose per garantire la compatibilità con le funzioni della versione 2.6.7.</p>
<ul>
