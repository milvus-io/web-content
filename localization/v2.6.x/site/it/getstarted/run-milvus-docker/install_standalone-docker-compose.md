...
<p><strong>Novità della versione 2.6.6:</strong></p>
<ul>
...
<p>Scaricare sempre l'ultima configurazione di Docker Compose per garantire la compatibilità con le funzionalità della versione 2.6.6.</p>
<ul>
