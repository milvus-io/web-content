...
<p><strong>Novità della versione 2.6.23:</strong></p>
<ul>
...
<li>Per modificare la configurazione predefinita di Milvus, aggiungete le vostre impostazioni al file <strong>user.yaml</strong> nella cartella corrente e poi riavviate il servizio.</li>
...
<h2 id="Optional-Update-Milvus-configurations" class="common-anchor-header">(Facoltativo) Aggiornamento delle configurazioni di Milvus<button data-href="#Optional-Update-Milvus-configurations" class="anchor-icon" translate="no">
    ...
    </button></h2><p>È possibile modificare le configurazioni di Milvus nel file <strong>user.yaml</strong> nella cartella corrente. Ad esempio, per modificare l'indirizzo <code translate="no">proxy.healthCheckTimeout</code> in <code translate="no">1000</code> ms, è possibile modificare il file come segue:</p>
...
<li>Recupera l’immagine Docker di Milvus più recente</li>
