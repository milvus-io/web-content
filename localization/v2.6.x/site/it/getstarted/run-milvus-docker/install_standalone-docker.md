...
<p><strong>Novità della versione 2.6.18:</strong></p>
<ul>
<li><strong>Nodo di streaming</strong>: Migliori capacità di elaborazione dei dati</li>
<li><strong>Woodpecker MQ</strong>: migliorata la coda di messaggi con un ridotto overhead di manutenzione; per maggiori dettagli, vedere <a href="/docs/it/v2.6.x/use-woodpecker.md">Utilizzo di Woodpecker</a>.</li>
