...
<h2 id="Online-install" class="common-anchor-header">Installazione online<button data-href="#Online-install" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Una volta installato il grafico Helm, è possibile avviare Milvus su Kubernetes. Questa sezione vi guiderà attraverso le fasi di avvio di Milvus.</p>
...
<h3 id="2-Check-Milvus-cluster-status" class="common-anchor-header">2. Controllare lo stato del cluster Milvus<button data-href="#2-Check-Milvus-cluster-status" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Eseguite il seguente comando per verificare lo stato di tutti i pod nel vostro cluster Milvus.</p>
...
<h3 id="3-Forward-a-local-port-to-Milvus" class="common-anchor-header">3. Inoltrare una porta locale a Milvus<button data-href="#3-Forward-a-local-port-to-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Eseguite il seguente comando per ottenere la porta su cui il vostro cluster Milvus serve.</p>
...
<h3 id="1-Get-Milvus-manifest" class="common-anchor-header">1. Ottenere il manifesto di Milvus<button data-href="#1-Get-Milvus-manifest" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Eseguite il seguente comando per ottenere il manifest di Milvus.</p>
