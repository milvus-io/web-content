...
summary: >-
  ...
  Operator
title: Installare Milvus Cluster con Milvus Operator
---
...
<button class="copy-code-btn"></button></code></pre>
<p>Il comando sopra riportato distribuisce un cluster Milvus con <strong>Woodpecker</strong> come coda di messaggi (consigliato per la versione 2.6.17) e tutti i nuovi componenti architetturali, incluso lo Streaming Node.</p>
<p><strong>Caratteristiche salienti dell'architettura in questa distribuzione:</strong></p>
<ul>
...
<button class="copy-code-btn"></button></code></pre>
<p>Facoltativamente, è possibile utilizzare <code translate="no">:19530</code> al posto di <code translate="no">27017:19530</code> nel comando sopra riportato per consentire a <code translate="no">kubectl</code> di allocare una porta locale, in modo da non dover gestire eventuali conflitti di porta.</p>
