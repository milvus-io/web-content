...
<button class="copy-code-btn"></button></code></pre>
<p>Il comando precedente distribuisce un cluster Milvus con <strong>Woodpecker</strong> come coda di messaggi (consigliato per la versione 2.6.16) e tutti i nuovi componenti architettonici, compreso lo Streaming Node.</p>
