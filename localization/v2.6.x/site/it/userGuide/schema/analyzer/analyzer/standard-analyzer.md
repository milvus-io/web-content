...
<ul>
<li><p><strong>Tokenizzatore</strong>: Utilizza il tokenizer di <code translate="no">standard</code> per suddividere il testo in unità di parole discrete basate su regole grammaticali. Per ulteriori informazioni, fare riferimento a <a href="/docs/it/standard-tokenizer.md">Tokenizer standard</a>.</p></li>
