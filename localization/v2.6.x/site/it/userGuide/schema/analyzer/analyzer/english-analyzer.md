...
<ul>
<li><p><strong>Tokenizzatore</strong>: Utilizza il<a href="/docs/it/standard-tokenizer.md"> tokenizer</a> di <code translate="no">standard</code> per suddividere il testo in unità di parole discrete.</p></li>
