...
<li><p>C'è un limite massimo di campi per collezione. Per maggiori dettagli, consultare <a href="/docs/it/v2.6.x/limitations.md#Number-of-resources-in-a-collection">Limiti di Milvus</a>.</p></li>
...
<p>Per la creazione della collezione e le operazioni di base, consultare la sezione <a href="/docs/it/v2.6.x/create-collection.md">Crea collezione</a>.</p>
</div>
...
<ul>
<li><p><strong>Nuova collezione</strong>: Impostare <code translate="no">enable_dynamic_field</code> su True quando si crea la collezione. Per i dettagli, fare riferimento a <a href="/docs/it/v2.6.x/create-collection.md#Create-Schema">Creare una raccolta</a></p></li>
<li><p><strong>Raccolta esistente</strong>: Impostare la proprietà a livello di raccolta <code translate="no">dynamicfield.enabled</code> su True. Per i dettagli, vedere <a href="/docs/it/v2.6.x/modify-collection.md#Example-4-Enable-dynamic-field">Modifica della raccolta</a>.</p></li>
</ul>
