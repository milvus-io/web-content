...
<p>Inoltre, Milvus supporta altre metriche di similarità per vettori binari. Per ulteriori informazioni, consultare la sezione <a href="/docs/it/v2.6.x/metric.md">Tipi di metriche</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Per ulteriori informazioni sui parametri di ricerca della somiglianza, consultare la sezione <a href="/docs/it/v2.6.x/single-vector-search.md">Ricerca di base di RNA</a>.</p>
