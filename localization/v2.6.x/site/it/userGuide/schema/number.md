...
<h1 id="Number-Field" class="common-anchor-header">Campo numerico<button data-href="#Number-Field" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Un campo numero è un campo scalare che memorizza valori numerici. Questi valori possono essere numeri interi o decimali<strong>(numeri a virgola mobile</strong>). Vengono tipicamente utilizzati per rappresentare quantità, misure o qualsiasi dato che debba essere elaborato matematicamente.</p>
...
<p>Per recuperare le entità in cui <code translate="no">age</code> è maggiore di 30:</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
