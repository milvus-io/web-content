...
<h2 id="Data-Formats" class="common-anchor-header">Formati dei dati<button data-href="#Data-Formats" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Nelle sezioni seguenti viene illustrato come memorizzare i vettori provenienti da modelli di incorporazione rada appresi come SPLADE. Se state cercando qualcosa che integri la ricerca semantica basata su vettori densi, vi consigliamo di preferire <a href="/docs/it/v2.6.x/full-text-search.md">Full Text Search</a> con BM25 a SPLADE per semplicità. Se avete eseguito la valutazione della qualità e avete deciso di usare SPLADE, potete fare riferimento a <a href="/docs/it/v2.6.x/embeddings.md#Embedding-Overview">Embeddings</a> su come generare vettori sparsi con SPLADE.</p>
...
<div class="alert note">
<p>Per abilitare Milvus o per generare incorporazioni di vettori sparsi da un campo di testo specificato durante l'inserimento dei dati, è necessario eseguire un passaggio aggiuntivo con una funzione. Per ulteriori informazioni, consultare la sezione <a href="/docs/it/v2.6.x/full-text-search.md">Ricerca di testo completo</a>.</p>
</div>
<h2 id="Set-Index-Parameters" class="common-anchor-header">Impostazione dei parametri dell'indice<button data-href="#Set-Index-Parameters" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Il processo di creazione di un indice per i vettori sparsi è simile a quello dei <a href="/docs/it/v2.6.x/dense-vector.md">vettori densi</a>, ma con differenze nel tipo di indice specificato (<code translate="no">index_type</code>), nella metrica della distanza (<code translate="no">metric_type</code>) e nei parametri dell'indice (<code translate="no">params</code>).</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<ul>
<li><p><a href="/docs/it/v2.6.x/sparse-inverted-index.md">SPARSE_INVERTED_INDEX</a>: spiegazione dell'indice e dei suoi parametri</p></li>
<li><p><a href="/docs/it/v2.6.x/metric.md">Tipi di metrica</a>: Tipi di metrica supportati per diversi tipi di campo</p></li>
<li><p><a href="/docs/it/v2.6.x/full-text-search.md">Ricerca full-text</a>: Un tutorial dettagliato sulla ricerca full-text</p></li>
</ul>
<h2 id="Create-Collection" class="common-anchor-header">Creare la raccolta<button data-href="#Create-Collection" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una volta completate le impostazioni dei vettori sparsi e degli indici, è possibile creare una raccolta che contenga vettori sparsi. L'esempio seguente utilizza il metodo <a href="/docs/it/v2.6.x/create-collection.md"><code translate="no">create_collection</code></a> per creare un insieme chiamato <code translate="no">my_collection</code>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Per ulteriori informazioni sui parametri di ricerca per similarità, consultare la sezione <a href="/docs/it/v2.6.x/single-vector-search.md">Ricerca vettoriale di base</a>.</p>
