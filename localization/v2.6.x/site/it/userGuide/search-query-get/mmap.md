...
<p>Per applicare le impostazioni di cui sopra al vostro cluster Milvus, seguite i passaggi di <a href="/docs/it/v2.6.x/configure-helm.md#Configure-Milvus-via-configuration-file">Configurazione di Milvus con Helm</a> e <a href="/docs/it/v2.6.x/configure_operator.md">Configurazione di Milvus con Milvus Operators</a>.</p>
