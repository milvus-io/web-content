...
<p>Se i vettori di query esistono già nella collezione di destinazione, si può usare <code translate="no">ids</code> invece di recuperarli prima della ricerca. Per maggiori dettagli, consultare la sezione <a href="/docs/it/v2.6.x/primary-key-search.md">Ricerca con chiave primaria</a>.</p>
</div>
