...
<p>Un elenco di richieste di ricerca, dove ogni richiesta è un oggetto <code translate="no">ANNSearchRequest</code>. Ogni richiesta può corrispondere a un campo vettoriale diverso e a un diverso insieme di parametri di ricerca.</p></li>
