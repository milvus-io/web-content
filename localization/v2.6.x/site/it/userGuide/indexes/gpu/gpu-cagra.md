...
summary: >-
  ...
  può risultare più conveniente rispetto all'uso di costose GPU di tipo
  "training".
---
...
<h3 id="Index-specific-search-params" class="common-anchor-header">Parametri di ricerca specifici dell’indice<button data-href="#Index-specific-search-params" class="anchor-icon" translate="no">
    ...
    </button></h3><p>La tabella seguente elenca i parametri configurabili in <code translate="no">search_params.params</code> durante <a href="/docs/it/v2.6.x/gpu-cagra.md#Search-on-index">la ricerca sull’indice</a>.</p>
<table>
   <tr>
     <th><p>Parametro</p></th>
     <th><p>Descrizione</p></th>
