...
<p>Dopo la fase PQ, RQ quantizza il residuo - la differenza tra il vettore originale e la sua approssimazione basata su PQ - utilizzando codebook aggiuntivi. Poiché questo residuo è tipicamente molto più piccolo, può essere codificato in modo più preciso senza un grande aumento di memoria.</p>
...
<p>In questa configurazione:</p>
<ul>
<li><code translate="no">params</code>: Opzioni di configurazione aggiuntive per la ricerca sull'indice. Per i dettagli, fare riferimento a <a href="/docs/it/hnsw-prq.md#Index-specific-search-params">Parametri di ricerca specifici dell'indice</a>.</li>
</ul>
