...
<h3 id="Install-via-pip" class="common-anchor-header">Installazione tramite pip<button data-href="#Install-via-pip" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Eseguire il seguente comando per installare Milvus_CLI.</p>
...
<h3 id="Prerequisites" class="common-anchor-header">Prerequisiti<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h3><p>È necessario Docker 19.03 o successivo.</p>
<h3 id="Install-based-on-Docker-image" class="common-anchor-header">Installazione basata sull'immagine Docker<button data-href="#Install-based-on-Docker-image" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Install-from-an-exe-file" class="common-anchor-header">Installazione da un file .exe<button data-href="#Install-from-an-exe-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><div class="alert note"> Questo metodo di installazione si applica solo a Windows. </div>
