...
<table>
   ...
   <tr>
     ...
     <td><p>L'esecuzione della query si ferma mentre la cache viene recuperata. Lo svuotamento continua finché l'utilizzo non scende al di sotto della soglia minima.</p></td>
