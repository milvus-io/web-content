...
<table>
   ...
   <tr>
     ...
     <td><p>Utilizzare un TTL breve (ore) per dati altamente dinamici; utilizzare un TTL lungo (giorni) per insiemi di dati stabili. Impostare 0 per disabilitare la scadenza basata sul tempo.</p></td>
   </tr>
</table>
