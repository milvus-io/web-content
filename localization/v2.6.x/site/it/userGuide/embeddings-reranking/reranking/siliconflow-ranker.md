...
<table>
   ...
   <tr>
     ...
     <td><p>No</p></td>
     <td><p>Credenziale di autenticazione per l'accesso ai servizi SiliconFlow API. Se non viene specificata, il sistema cerca la variabile d'ambiente <code translate="no">SILICONFLOW_API_KEY</code>.</p></td>
