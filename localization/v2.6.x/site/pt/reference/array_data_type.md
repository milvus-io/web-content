...
<h2 id="Prerequisites" class="common-anchor-header">Pré-requisitos<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Certifique-se de ter o seguinte:</p>
<ul>
...
<h2 id="Create-a-collection-with-an-array-field" class="common-anchor-header">Criar uma coleção com um campo de matriz<button data-href="#Create-a-collection-with-an-array-field" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Define-collection-schema" class="common-anchor-header">Definir o esquema da coleção<button data-href="#Define-collection-schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Um esquema define a estrutura da coleção, incluindo os campos e os respectivos tipos de dados. O exemplo abaixo define um esquema de coleção que corresponde aos dados de amostra gerados na <a href="#prepare-data-with-an-array-field">secção anterior</a>.</p>
...
<h3 id="Create-the-collection" class="common-anchor-header">Criar a coleção<button data-href="#Create-the-collection" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Em seguida, crie a coleção utilizando o esquema definido.</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<div class="language-python">
<p>Para mais informações sobre métodos e parâmetros, consultar <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_collection.md">create_collection</a> e <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/list_collections.md">list_collections</a>.</p>
</div>
<div class="language-java">
...
<h3 id="Index-vector-field" class="common-anchor-header">Indexar campo vetorial<button data-href="#Index-vector-field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>A criação de um índice num campo de vetor pode melhorar o desempenho da pesquisa de similaridade de vectores, que é necessária para cada operação de pesquisa.</p>
...
<h3 id="Index-array-field" class="common-anchor-header">Campo de matriz de índices<button data-href="#Index-array-field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>A criação de um índice num campo escalar pode melhorar o desempenho da recuperação de consultas nesse campo, o que é opcional mas recomendado para grandes conjuntos de dados.</p>
