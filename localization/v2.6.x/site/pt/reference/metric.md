...
<h3 id="Hamming-distance" class="common-anchor-header">Distância de Hamming<button data-href="#Hamming-distance" class="anchor-icon" translate="no">
    ...
    </button></h3><p>A distância de Hamming mede cadeias de dados binárias. A distância entre duas cadeias de igual comprimento é o número de posições de bits em que os bits são diferentes.</p>
