...
summary: Saiba como configurar o streaming para o Milvus.
---
<h1 id="streaming-related-Configurations" class="common-anchor-header">Configurações relacionadas com o streaming<button data-href="#streaming-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Qualquer configuração relacionada com o serviço de streaming.</p>
...
<h2 id="streamingwalBalancerbackoffInitialInterval" class="common-anchor-header"><code translate="no">streaming.walBalancer.backoffInitialInterval</code><button data-href="#streamingwalBalancerbackoffInitialInterval" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>O intervalo inicial do backoff do acionamento da tarefa de equilíbrio, 50 ms por predefinição. </li>      
        <li>Pode ser definido como uma cadeia de duração, como 30s ou 1m30s, ver time.ParseDuration</li>      </td>
      <td>50ms</td>
    </tr>
  </tbody>
</table>
<h2 id="streamingwalBalancerbackoffMultiplier" class="common-anchor-header"><code translate="no">streaming.walBalancer.backoffMultiplier</code><button data-href="#streamingwalBalancerbackoffMultiplier" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        O multiplicador do backoff do acionamento da tarefa de equilíbrio, 2 por predefinição      </td>
      <td>2</td>
    </tr>
  </tbody>
</table>
<h2 id="streamingwalBroadcasterconcurrencyRatio" class="common-anchor-header"><code translate="no">streaming.walBroadcaster.concurrencyRatio</code><button data-href="#streamingwalBroadcasterconcurrencyRatio" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        O rácio de simultaneidade baseado no número de CPU para o emissor de carteira, 1 por defeito.      </td>
      <td>1</td>
    </tr>
  </tbody>
</table>
<h2 id="streamingtxndefaultKeepaliveTimeout" class="common-anchor-header"><code translate="no">streaming.txn.defaultKeepaliveTimeout</code><button data-href="#streamingtxndefaultKeepaliveTimeout" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        O tempo limite predefinido do keepalive para wal txn, 10s por predefinição      </td>
      <td>10s</td>
    </tr>
  </tbody>
</table>
