...
<h2 id="Operators" class="common-anchor-header">Operadores<button data-href="#Operators" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Logical-operators" class="common-anchor-header">Operadores lógicos<button data-href="#Logical-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Os operadores lógicos efectuam uma comparação entre duas expressões.</p>
<table>
<thead>
...
<h3 id="Binary-arithmetic-operators" class="common-anchor-header">Operadores aritméticos binários<button data-href="#Binary-arithmetic-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Os operadores aritméticos binários contêm dois operandos e podem efetuar operações aritméticas básicas e devolver o resultado correspondente.</p>
<table>
<thead>
<tr><th>Símbolo</th><th>Operação</th><th>Exemplo de operação</th><th>Descrição</th></tr>
</thead>
...
<h3 id="Relational-operators" class="common-anchor-header">Operadores relacionais<button data-href="#Relational-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Os operadores relacionais utilizam símbolos para verificar a igualdade, desigualdade ou ordem relativa entre duas expressões.</p>
<table>
<thead>
...
<tr><td>4</td><td>* / %</td><td>BinaryArithOp</td><td>Da esquerda para a direita</td></tr>
<tr><td>5</td><td>+ -</td><td>BinaryArithOp</td><td>Da esquerda para a direita</td></tr>
