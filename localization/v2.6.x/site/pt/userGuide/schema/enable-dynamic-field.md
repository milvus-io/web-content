...
<h2 id="How-it-works" class="common-anchor-header">Como funciona<button data-href="#How-it-works" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Quando o campo dinâmico está ativado, o Milvus adiciona um campo oculto <code translate="no">$meta</code> a cada entidade. Durante a inserção de dados, qualquer campo não declarado no esquema é automaticamente armazenado como um par chave-valor dentro deste campo dinâmico.</p>
...
<h3 id="Index-non-JSON-keys-in-the-dynamic-field" class="common-anchor-header">Indexar chaves não JSON no campo dinâmico</h3><p>Você pode indexar qualquer chave não JSON (por exemplo, <code translate="no">overview</code>, <code translate="no">words</code>) referenciando seu nome de chave diretamente em <code translate="no">json_path</code>:</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<pre><code translate="no" class="language-bash"><span class="hljs-comment"># restful</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Index-JSON-keys-in-the-dynamic-field" class="common-anchor-header">Indexar chaves JSON no campo dinâmico</h3><p>Quando uma chave no campo dinâmico (<code translate="no">$meta</code>) armazena um objeto JSON, pode indexar as suas chaves internas utilizando a notação entre parênteses em <code translate="no">json_path</code>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<h3 id="Apply-indexes-to-the-collection" class="common-anchor-header">Aplicar índices à coleção</h3><p>Depois de definir os parâmetros do índice, pode aplicá-los à coleção utilizando <code translate="no">create_index()</code>:</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<pre><code translate="no" class="language-bash"><span class="hljs-comment"># restful</span>
<button class="copy-code-btn"></button></code></pre>
<p>Para obter uma lista completa de operadores e expressões de filtro suportados, consulte <a href="/docs/pt/filtered-search.md">Pesquisa filtrada</a>.</p>
<h2 id="Put-it-all-together" class="common-anchor-header">Colocar tudo junto<button data-href="#Put-it-all-together" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Até agora, já aprendeu a utilizar o campo dinâmico para armazenar e indexar de forma flexível chaves que não estão definidas no esquema. Uma vez inserida uma chave de campo dinâmico, pode utilizá-la como qualquer outro campo em expressões de filtro, sem necessidade de sintaxe especial.</p>
