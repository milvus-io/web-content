...
<table>
   ...
   <tr>
     ...
     <td><p>Sim</p></td>
     <td><p>O modelo de classificação hierárquica Cohere a ser usado entre os modelos compatíveis na plataforma Cohere. Para obter uma lista dos modelos de classificação hierárquica disponíveis, consulte <a href="https://docs.cohere.com/docs/rerank">a documentação do Cohere</a>.</p></td>
