...
<table>
   ...
   <tr>
     ...
     <td><p>Não</p></td>
     <td><p>Número de sobreposições de tokens entre pedaços adjacentes quando os documentos são divididos em pedaços. Isto assegura a continuidade entre os limites dos pedaços para uma melhor compreensão semântica. Apenas suportado por modelos específicos: <code translate="no">BAAI/bge-reranker-v2-m3</code>, <code translate="no">Pro/BAAI/bge-reranker-v2-m3</code>, e <code translate="no">netease-youdao/bce-reranker-base_v1</code>.</p></td>
...
<h2 id="Apply-to-hybrid-search" class="common-anchor-header">Aplicar à pesquisa híbrida<button data-href="#Apply-to-hybrid-search" class="anchor-icon" translate="no">
    ...
    </button></h2><p>O SiliconFlow Ranker também pode ser utilizado com a pesquisa híbrida para combinar métodos de recuperação densos e esparsos:</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
