...
<table>
   ...
   <tr>
     ...
     <td><p>Não</p></td>
     <td><p>Se deve truncar as entradas que excedam o comprimento máximo da sequência. Se <code translate="no">False</code>, as entradas longas dão origem a erros.</p></td>
