...
<table>
   ...
   <tr>
     ...
     <td><p>Sim</p></td>
     <td><p>Um dicionário que contém a configuração para a função de reclassificação baseada em modelos. Os parâmetros disponíveis (chaves) variam consoante o fornecedor de serviços.</p></td>
