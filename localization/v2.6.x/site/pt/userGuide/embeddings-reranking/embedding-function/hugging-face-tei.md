...
<table>
   ...
   <tr>
     ...
     <td><p>Não</p></td>
     <td><p>(Avançado) Especifica o comando a utilizar durante a fase de inserção (ingestão) de dados. Depende do modelo TEI utilizado; o modelo tem de suportar prompts.</p></td>
     <td><p>"passage: "</p></td>
   </tr>
   <tr>
     <td><p><code translate="no">search_prompt</code></p></td>
     <td><p>Não</p></td>
     <td><p>(Avançado) Especifica o comando a utilizar durante a fase de pesquisa. Depende do modelo TEI utilizado; o modelo deve suportar prompts.</p></td>
     <td><p>"query: "</p></td>
   </tr>
</table>
