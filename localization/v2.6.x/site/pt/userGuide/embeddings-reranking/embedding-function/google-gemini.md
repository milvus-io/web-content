...
<button class="copy-code-btn"></button></code></pre>
<p>Isso vincula uma chave específica a cada solicitação que o Milvus envia ao ponto de extremidade dos embeddings do Gemini.</p></li>
</ol>
...
<table>
   ...
   <tr>
     ...
     <td><p>Sim</p></td>
     <td><p>Torna a chave Gemini disponível dentro de cada contêiner Milvus (ignorado quando uma chave para Gemini existe em milvus.yaml)</p></td>
   </tr>
</table>
...
<h2 id="Step-3-Search-with-text" class="common-anchor-header">Etapa 3: Pesquisar com texto<button data-href="#Step-3-Search-with-text" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Após a inserção dos dados, efectue uma pesquisa semântica utilizando o texto de consulta em bruto. Milvus converte automaticamente a sua consulta num vetor de incorporação, recupera documentos relevantes com base na semelhança e devolve os melhores resultados correspondentes.</p>
