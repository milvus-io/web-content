...
<ul>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Single-Vector-Search">Pesquisa de vetor único</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Bulk-Vector-Search">Pesquisa de vetor em massa</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#ANN-Search-in-Partition">Pesquisa ANN em partição</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Use-Output-Fields">Usar campos de saída</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Use-Limit-and-Offset">Utilizar limite e offset</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Use-Level">Usar nível</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Get-Recall-Rate">Obter taxa de recuperação</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/single-vector-search.md#Enhancing-ANN-Search">Melhorar a pesquisa ANN</a></p></li>
</ul>
...
<span class="hljs-comment"># }</span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Primary-Key-Search--Milvus-269+" class="common-anchor-header">Pesquisa de chave primária<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.6.9+</span><button data-href="#Primary-Key-Search--Milvus-269+" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Em vez de definir vectores de consulta, pode utilizar chaves primárias se os vectores de consulta já existirem na coleção de destino.</p>
<div class="multipleCode">
...
<p>Para mais informações sobre filtragem de metadados e condições de filtragem, consulte <a href="/docs/pt/v2.6.x/filtered-search.md">Filtered Search</a>, <a href="/docs/pt/v2.6.x/boolean.md">Filtering Explained</a>, e tópicos relacionados.</p></li>
...
<p>Para obter mais informações sobre a pesquisa de intervalo, consulte <a href="/docs/pt/v2.6.x/range-search.md">Pesquisa de intervalo</a>.</p></li>
...
<p>Para saber mais sobre a pesquisa de agrupamento, consulte <a href="/docs/pt/v2.6.x/grouping-search.md">Pesquisa de agrupamento</a>,</p></li>
<li><p>Pesquisa híbrida</p>
<p>Uma coleção pode incluir vários campos vectoriais para guardar as incorporações vectoriais geradas utilizando diferentes modelos de incorporação. Ao fazer isso, é possível usar uma pesquisa híbrida para ranquear novamente os resultados da pesquisa desses campos vetoriais, melhorando a taxa de recuperação.</p>
<p>Para saber mais sobre a pesquisa híbrida, consulte <a href="/docs/pt/v2.6.x/multi-vector-search.md">Pesquisa híbrida</a>.</p></li>
...
<p>Para obter detalhes sobre iteradores de pesquisa, consulte <a href="/docs/pt/v2.6.x/with-iterators.md">Iterador de pesquisa</a>.</p></li>
...
<p>Para obter detalhes sobre a pesquisa de texto integral, consulte <a href="/docs/pt/v2.6.x/full-text-search.md">Pesquisa de texto integral</a>.</p></li>
...
<p>Para obter detalhes sobre a correspondência de palavras-chave, consulte <a href="/docs/pt/v2.6.x/keyword-match.md">Correspondência de palavras-chave</a>.</p></li>
...
<p>Para obter detalhes sobre a chave de partição, consulte <a href="/docs/pt/v2.6.x/use-partition-key.md">Usar chave de partição</a>.</p></li>
<li><p>Usar mmap</p>
<p>Para obter detalhes sobre as configurações de mmap, consulte <a href="/docs/pt/v2.6.x/mmap.md">Usar mmap</a>.</p></li>
<li><p>Compactação de clustering</p>
<p>Para obter detalhes sobre compactações de clustering, consulte <a href="/docs/pt/v2.6.x/clustering-compaction.md">Compactação de clustering</a>.</p></li>
<li><p>Usar reranking</p>
<p>Para obter detalhes sobre o uso de classificadores para aumentar a relevância dos resultados de pesquisa, consulte <a href="/docs/pt/v2.6.x/decay-ranker-overview.md">Visão geral do classificador de decaimento</a> e <a href="/docs/pt/v2.6.x/model-ranker-overview.md">Visão geral do classificador de modelo</a>.</p></li>
</ul>
