...
<li><p>Se os vectores de consulta já existirem na coleção de destino, considere a utilização de <code translate="no">ids</code> em vez de os recuperar antes das pesquisas. Para obter detalhes, consulte <a href="/docs/pt/v2.6.x/primary-key-search.md">Pesquisa de chave primária</a>.</p></li>
</ul>
