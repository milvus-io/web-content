...
<ul>
<li><p><a href="/docs/pt/v2.6.x/set-collection-ttl.md#Set-TTL-when-creating-a-collection">Cria uma coleção.</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/set-collection-ttl.md#Set-TTL-for-an-existing-collection">Altera a propriedade TTL de uma coleção existente.</a></p></li>
</ul>
<h3 id="Set-TTL-when-creating-a-collection" class="common-anchor-header">Definir TTL ao criar uma coleção<button data-href="#Set-TTL-when-creating-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>O seguinte trecho de código demonstra como definir a propriedade TTL quando você cria uma coleção.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Set-TTL-for-an-existing-collection" class="common-anchor-header">Definir TTL para uma coleção existente<button data-href="#Set-TTL-for-an-existing-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>O seguinte trecho de código demonstra como alterar a propriedade TTL em uma coleção existente.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
