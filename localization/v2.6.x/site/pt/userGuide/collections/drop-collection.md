...
title: Abandonar a recolha
summary: Pode abandonar uma coleção se esta já não for necessária.
---
<h1 id="Drop-Collection" class="common-anchor-header">Abandonar a recolha<button data-href="#Drop-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Pode abandonar uma coleção se esta já não for necessária.</p>
<h2 id="Examples" class="common-anchor-header">Exemplos<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Os seguintes trechos de código assumem que você tem uma coleção chamada <strong>my_collection</strong>.</p>
