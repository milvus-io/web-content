...
title: Criar coleção
summary: >-
  Pode criar uma coleção definindo o esquema, os parâmetros de índice, o tipo de
...
<h1 id="Create-Collection" class="common-anchor-header">Criar coleção<button data-href="#Create-Collection" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Pode criar uma coleção definindo o seu esquema, parâmetros de índice, tipo de métrica e se a deve carregar aquando da criação. Esta página apresenta a forma de criar uma coleção a partir do zero.</p>
...
<ul>
<li><p><a href="/docs/pt/v2.6.x/create-collection.md#Create-Schema">Criar um esquema</a></p></li>
<li><p><a href="/docs/pt/v2.6.x/create-collection.md#Optional-Set-Index-Parameters">Definir parâmetros de índice</a> (opcional)</p></li>
<li><p><a href="/docs/pt/v2.6.x/create-collection.md#Create-a-Collection">Criar coleção</a></p></li>
</ul>
<h2 id="Create-Schema" class="common-anchor-header">Criar esquema<button data-href="#Create-Schema" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Um esquema define a estrutura de dados de uma coleção. Ao criar uma coleção, é necessário conceber o esquema com base nas suas necessidades. Para mais pormenores, consulte <a href="/docs/pt/v2.6.x/schema.md">Esquema explicado</a>.</p>
...
<p>Pode definir valores predefinidos para qualquer campo escalar e torná-lo anulável. Para obter detalhes, consulte <a href="/docs/pt/v2.6.x/nullable-and-default.md">Nullable &amp; Default</a>.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Optional-Set-Index-Parameters" class="common-anchor-header">(Opcional) Definir parâmetros de índice<button data-href="#Optional-Set-Index-Parameters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Para obter detalhes, consulte <a href="/docs/pt/v2.6.x/index-vector-fields.md">Indexar campos vetoriais</a> e <a href="/docs/pt/v2.6.x/index-scalar-fields.md">Indexar campos escalares</a>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<h2 id="Create-a-Collection" class="common-anchor-header">Criar uma coleção<button data-href="#Create-a-Collection" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Se tiver criado uma coleção com parâmetros de índice, o Milvus carrega automaticamente a coleção aquando da sua criação. Neste caso, todos os campos mencionados nos parâmetros de índice são indexados.</p>
<p>Os trechos de código a seguir demonstram como criar a coleção com parâmetros de índice e verificar seu status de carregamento.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Também é possível criar uma coleção sem quaisquer parâmetros de indexação e adicioná-los posteriormente. Neste caso, o Milvus não carrega a coleção aquando da sua criação. .</p>
<p>O trecho de código a seguir demonstra como criar uma coleção sem um índice, e o status de carregamento da coleção permanece descarregado após a criação.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<li><strong>Utilização do nó de fluxo:</strong> Se a instância do Milvus tiver vários nós de fluxo, recomenda-se o uso de vários fragmentos. Isso garante que a carga de trabalho de inserção de dados seja distribuída entre todos os nós de fluxo disponíveis, evitando que alguns fiquem ociosos enquanto outros estão sobrecarregados.</li>
</ul>
...
<h3 id="Enable-mmap" class="common-anchor-header">Habilitar mmap<button data-href="#Enable-mmap" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Milvus habilita o mmap em todas as coleções por padrão, permitindo que o Milvus mapeie dados de campo brutos na memória em vez de carregá-los completamente. Isto reduz o consumo de memória e aumenta a capacidade da coleção. Para obter detalhes sobre o mmap, consulte <a href="/docs/pt/v2.6.x/mmap.md">Usar mmap</a>.</p>
<div class="multipleCode">
...
<h3 id="Set-Consistency-Level" class="common-anchor-header">Definir o nível de consistência<button data-href="#Set-Consistency-Level" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Ao criar uma coleção, pode definir o nível de consistência para pesquisas e consultas na coleção. Também é possível alterar o nível de consistência da coleção durante uma pesquisa ou consulta específica.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Para saber mais sobre os níveis de consistência, consulte <a href="/docs/pt/v2.6.x/tune_consistency.md">Nível de consistência</a>.</p>
...
<p>Para obter detalhes sobre como usar o campo dinâmico, consulte <a href="/docs/pt/v2.6.x/enable-dynamic-field.md">Campo dinâmico</a>.</p>
