...
<li><p>Defina <code translate="no">max_gram</code> próximo do comprimento típico das substrings significativas; um <code translate="no">max_gram</code> maior melhora a filtragem, mas aumenta o espaço.</p></li>
</ul></li>
