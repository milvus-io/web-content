...
<li><p>Somar estas distâncias <code translate="no">m</code> para obter a distância aproximada com base num tipo de métrica específico (por exemplo, distância euclidiana).</p></li>
</ul></li>
</ol>
<p>
