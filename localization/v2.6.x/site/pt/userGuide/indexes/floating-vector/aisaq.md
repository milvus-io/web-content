...
<p>Modo de escala: optimizado para aplicações com restrições de latência mais relaxadas, tais como RAG e pesquisa semântica offline, ao mesmo tempo que permite a expansão rentável de conjuntos de dados para uma escala ultra-alta.</p>
...
<table>
   ...
   <tr>
     ...
     <td><p>Valores elevados podem reduzir o tempo de pesquisa, iniciando a pesquisa a partir de um ponto de entrada mais próximo.</p><p>Defina valores mais elevados para segmentos grandes (por exemplo, para vectores de 10M e acima do valor de utilização de 1000).</p></td>
   </tr>
   <tr>
