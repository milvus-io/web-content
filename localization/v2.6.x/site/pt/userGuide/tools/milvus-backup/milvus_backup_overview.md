...
<h2 id="Compatibility-matrix" class="common-anchor-header">Matriz de compatibilidade<button data-href="#Compatibility-matrix" class="anchor-icon" translate="no">
    ...
    </button></h2><p>A tabela a seguir lista as compatibilidades de backup e restauração entre diferentes versões do Milvus desde o Milvus Backup v0.5.7.</p>
<table>
<thead>
<tr><th>Cópia de segurança de ↓ / Restaurar para →</th><th>Milvus v2.2.x</th><th>Milvus v2.3.x</th><th>Milvus v2.4.x</th><th>Milvus v2.5.x</th><th>Milvus v2.6.x</th></tr>
</thead>
<tbody>
