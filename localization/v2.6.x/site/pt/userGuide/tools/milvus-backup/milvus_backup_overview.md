...
<h1 id="Milvus-Backup" class="common-anchor-header">Cópia de segurança do Milvus<button data-href="#Milvus-Backup" class="anchor-icon" translate="no">
    ...
    </button></h1><p>O Milvus Backup é uma ferramenta que permite aos utilizadores fazer cópias de segurança e restaurar dados Milvus. Ele fornece tanto CLI e API para se encaixar em diferentes cenários de aplicação.</p>
