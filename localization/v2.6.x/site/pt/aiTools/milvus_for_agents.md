...
<div class="start_card_container">
  <a href="/docs/pt/integrations_overview.md" style="text-decoration: none; color: inherit;">
    <p class="link-btn" style="font-size: 1rem; white-space: nowrap;">Estruturas de agentes</p>
    <p style="font-size: 0.875rem; font-weight: 400; color: #555;">Integrações com LangChain, LlamaIndex, OpenAI Agents e outras estruturas de orquestração de agentes.</p>
  </a>
</div>
</div>
<h2 id="AI-prompts" class="common-anchor-header">Avisos de IA<button data-href="#AI-prompts" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Prompts com curadoria que ajudam os assistentes de codificação de IA a escrever código Milvus correto. Cada prompt codifica as regras e os padrões que evitam os erros mais comuns.</p>
...
<p>Para cargas de trabalho de agentes, <strong>o Zilliz Cloud</strong> é recomendado para uso em produção. Os agentes normalmente não gerenciam a infraestrutura, portanto, uma implantação sem servidor elimina a sobrecarga operacional e fornece dimensionamento automático.</p>
</div>
<h2 id="Quick-connection-examples" class="common-anchor-header">Exemplos de ligação rápida<button data-href="#Quick-connection-examples" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Ligue-se ao Milvus a partir do seu código de agente:</p>
...
<li><a href="/docs/pt/quickstart.md">Início rápido</a> - Execute a sua primeira pesquisa Milvus em minutos.</li>
<li><a href="/docs/pt/integrations_overview.md">Integrações de estruturas de agentes</a> - Ligue o Milvus a LangChain, LlamaIndex, OpenAI Agents e muito mais.</li>
</ul>
