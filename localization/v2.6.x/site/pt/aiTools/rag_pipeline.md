...
<p>Para os utilizadores <strong>do Cursor</strong>: copie a mensagem da secção <a href="#full-prompt">de mensagens completas</a> e guarde-a em <code translate="no">.cursor/rules/</code> no seu projeto.</p>
<p>Regras completas para a criação de pipelines RAG com o Milvus, incluindo a ingestão, a fragmentação, a incorporação, a recuperação híbrida com o BM25 e as actualizações de documentos com o upsert. Copie o prompt completo abaixo na sua ferramenta de IA para aplicar estas regras automaticamente. Para obter uma visão geral de todos os prompts, consulte <a href="/docs/pt/milvus_for_agents.md">Prompts de IA</a>.</p>
