...
summary: >-
  ...
  Milvus corretos.
---
<h1 id="Schema-Design" class="common-anchor-header">Conceção do esquema<button data-href="#Schema-Design" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Regras e guias de decisão para a conceção de esquemas de coleção Milvus corretos, incluindo tipos de campo, chaves primárias, configuração BM25 e restrições de imutabilidade do esquema. Copie o prompt completo abaixo na sua ferramenta de IA para aplicar essas regras automaticamente. Para obter uma visão geral de todos os prompts, consulte <a href="/docs/pt/milvus_for_agents.md">Prompts de IA</a>.</p>
