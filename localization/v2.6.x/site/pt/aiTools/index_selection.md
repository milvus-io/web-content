...
summary: >-
  ...
  índices Milvus.
---
<h1 id="Index-Selection" class="common-anchor-header">Seleção de índices<button data-href="#Index-Selection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
