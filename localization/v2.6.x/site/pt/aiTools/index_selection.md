...
title: 'Prompt: Seleção do Índice Milvus'
summary: >-
  Regras para os assistentes de codificação de IA escolherem e configurarem os
  índices Milvus.
---
...
<p>Guias de decisão e regras de configuração para escolher e ajustar os índices do Milvus, incluindo AUTOINDEX, HNSW, DiskANN, IVF e índices esparsos. Copie o prompt completo abaixo na sua ferramenta de IA para aplicar essas regras automaticamente. Para obter uma visão geral de todos os prompts, consulte <a href="/docs/pt/ai_prompts_landing.md">Prompts de IA</a>.</p>
