...
summary: >-
  Regras para os assistentes de codificação de IA escreverem código Python
  Milvus correto utilizando o MilvusClient.
---
...
<p>Para os utilizadores <strong>do Cursor</strong>: copie a mensagem da secção <a href="#full-prompt">Mensagem completa</a> e guarde-a em <code translate="no">.cursor/rules/</code> no seu projeto.</p>
<p>Regras para escrever código Milvus Python correto utilizando a interface MilvusClient, incluindo migração ORM, padrões de ligação e operações comuns. Copie o prompt completo abaixo na sua ferramenta de IA para aplicar estas regras automaticamente. Para obter uma visão geral de todos os prompts, consulte <a href="/docs/pt/ai_prompts_landing.md">Prompts de IA</a>.</p>
