...
<h2 id="v269" class="common-anchor-header">v2.6.9<button data-href="#v269" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Data de lançamento: January 16, 2026</p>
<table>
<thead>
...
<p>Temos o prazer de anunciar o lançamento do Milvus 2.6.9! Esta atualização introduz pontuações de destaque para resultados de pesquisa, melhora a gestão de segmentos com suporte para reabrir segmentos quando ocorrem alterações de dados ou de esquema e melhora o tratamento de versões de armazenamento. As principais melhorias incluem um melhor desempenho do registo, controlos de segurança melhorados para pontos finais de expressão e optimizações para analisadores de texto e criação de índices. Esta versão também resolve problemas críticos, incluindo a precisão da estimativa de memória, conversões de dados de geometria e várias correcções de estabilidade. Recomendamos que todos os utilizadores do ramo 2.6 actualizem para esta versão para melhorar a fiabilidade e o desempenho do sistema.</p>
<h3 id="Features" class="common-anchor-header">Caraterísticas<button data-href="#Features" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Pesquisa suportada por chaves primárias<a href="https://github.com/milvus-io/milvus/pull/46528">(#46528</a>)</li>
</ul>
...
<li>Adicionada uma métrica de etiqueta de versão de armazenamento para melhor observabilidade<a href="https://github.com/milvus-io/milvus/pull/47014">(#47014</a>)</li>
<li>O QueryCoord suporta agora a reabertura de segmentos quando o caminho do manifesto muda<a href="https://github.com/milvus-io/milvus/pull/46921">(#46921</a>)</li>
<li>Adicionado suporte para reabertura de segmentos quando ocorrem alterações nos dados ou no esquema<a href="https://github.com/milvus-io/milvus/pull/46412">(#46412</a>)</li>
<li>Melhoria do desempenho e da eficiência do registo lento<a href="https://github.com/milvus-io/milvus/pull/47086">(#47086</a>)</li>
<li>Adicionada política de compactação de atualização de versão de armazenamento para facilitar as migrações de versão<a href="https://github.com/milvus-io/milvus/pull/47011">(#47011</a>)</li>
<li>Eliminadas as operações de cópia de memória extra para o registo C++ para melhorar o desempenho<a href="https://github.com/milvus-io/milvus/pull/46992">(#46992</a>)</li>
<li>Adicionados controlos de segurança para o ponto final /expr para evitar o acesso não autorizado<a href="https://github.com/milvus-io/milvus/pull/46978">(#46978</a>)</li>
<li>O serviço de streaming permanece agora ativado até que a contagem necessária de nós de streaming seja atingida<a href="https://github.com/milvus-io/milvus/pull/46982">(#46982</a>)</li>
<li>Removidas as operações redundantes de colocação de etcd ao atualizar a informação do segmento<a href="https://github.com/milvus-io/milvus/pull/46794">(#46794</a>)</li>
<li>Validação de contagem de linhas melhorada e redução de registos de aviso enganadores para compactação de ordenação<a href="https://github.com/milvus-io/milvus/pull/46824">(#46824</a>)</li>
<li>Limpadas e organizadas as mensagens de registo do índice de construção<a href="https://github.com/milvus-io/milvus/pull/46769">(#46769</a>)</li>
<li>Limitado o número de construções de índices vectoriais simultâneas por trabalhador para evitar a exaustão de recursos<a href="https://github.com/milvus-io/milvus/pull/46877">(#46877</a>)</li>
<li>Optimizadas as operações de clonagem dos analisadores jieba e lindera para um melhor desempenho<a href="https://github.com/milvus-io/milvus/pull/46757">(#46757</a>)</li>
<li>Adicionado o glog sink para transferir os registos CGO para o zap logger para um registo unificado<a href="https://github.com/milvus-io/milvus/pull/46741">(#46741</a>)</li>
<li>Uso forçado do formato de armazenamento V2 e escrita V1 obsoleta<a href="https://github.com/milvus-io/milvus/pull/46889">(#46889</a>)</li>
<li>Implementado processamento em lote para operações de ngramas para melhorar a eficiência<a href="https://github.com/milvus-io/milvus/pull/46703">(#46703</a>)</li>
<li>Adicionado mecanismo de repetição automática para operações de escrita binlog para melhorar a fiabilidade<a href="https://github.com/milvus-io/milvus/pull/46854">(#46854</a>)</li>
<li>Filtradas mensagens timetick vazias do lado do consumidor para reduzir o processamento desnecessário<a href="https://github.com/milvus-io/milvus/pull/46730">(#46730</a>)</li>
<li>Melhorada a pesquisa por chave primária com verificação de duplicados e inferência automática de anns_field<a href="https://github.com/milvus-io/milvus/pull/46745">(#46745</a>)</li>
<li>Adicionado suporte a parâmetros de dimensão para fornecedores de incorporação siliconflow e cohere<a href="https://github.com/milvus-io/milvus/pull/47081">(#47081</a>)</li>
</ul>
...
<li>Corrigida a contagem dupla de memória de índice na estimativa de carregamento de segmentos<a href="https://github.com/milvus-io/milvus/pull/47046">(#47046</a>)</li>
<li>Corrigidos problemas de compilação no macOS 14<a href="https://github.com/milvus-io/milvus/pull/47048">(#47048</a>)</li>
<li>Usada revisão como versão global de descoberta de serviço de streaming para melhor consistência<a href="https://github.com/milvus-io/milvus/pull/47023">(#47023</a>)</li>
<li>Assegurado que todos os futuros completam na exceção para prevenir crashes use-after-free<a href="https://github.com/milvus-io/milvus/pull/46960">(#46960</a>)</li>
<li>Corrigido o intercetor de fragmentos que saltava incorretamente as operações <code translate="no">FlushAllMsg</code> <a href="https://github.com/milvus-io/milvus/pull/47004">(#47004</a>)</li>
<li>Adicionada validação de intervalo válido para coleção TTL para evitar configurações inválidas<a href="https://github.com/milvus-io/milvus/pull/47010">(#47010</a>)</li>
<li>Corrigido <code translate="no">GetCredentialInfo</code> não armazenando em cache as respostas RPC<a href="https://github.com/milvus-io/milvus/pull/46945">(#46945</a>)</li>
<li>Corrigido o problema em que <code translate="no">AlterFunction</code> não podia ser invocado quando várias funções se tornavam inválidas<a href="https://github.com/milvus-io/milvus/pull/46986">(#46986</a>)</li>
<li>Corrigido o índice invertido do ficheiro de deslocamento nulo não ser compactado<a href="https://github.com/milvus-io/milvus/pull/46950">(#46950</a>)</li>
<li>Corrigida a falha ao usar is_null_expr em campos JSON indexados<a href="https://github.com/milvus-io/milvus/pull/46894">(#46894</a>)</li>
<li>Adicionada a verificação da bandeira allow_insert_auto_id na API de inserção RESTful v2<a href="https://github.com/milvus-io/milvus/pull/46931">(#46931</a>)</li>
<li>Adicionada verificação de existência de campo em grupos de colunas antes de ler o manifesto do loon<a href="https://github.com/milvus-io/milvus/pull/46924">(#46924</a>)</li>
<li>Corrigido o erro em que o parâmetro highlight não estava a funcionar corretamente<a href="https://github.com/milvus-io/milvus/pull/46876">(#46876</a>)</li>
<li>O centro de quotas agora ignora o delegador quando este está em estado de recuperação<a href="https://github.com/milvus-io/milvus/pull/46858">(#46858</a>)</li>
<li>Alinhadas as opções de conversão WKT/WKB para garantir um comportamento consistente entre operações<a href="https://github.com/milvus-io/milvus/pull/46874">(#46874</a>)</li>
<li>Corrigido o erro int8 do modelo voyageai<a href="https://github.com/milvus-io/milvus/pull/46821">(#46821</a>)</li>
<li>Corrigida a falta de manuseamento de <code translate="no">FlushAllMsg</code> em operações de armazenamento de recuperação<a href="https://github.com/milvus-io/milvus/pull/46803">(#46803</a>)</li>
<li>Corrigido o campo shardclientmgr em falta na querytask para prevenir panic<a href="https://github.com/milvus-io/milvus/pull/46838">(#46838</a>)</li>
<li>Usado leaderid para verificação de leaderaction stale no scheduler para melhorar a precisão<a href="https://github.com/milvus-io/milvus/pull/46788">(#46788</a>)</li>
<li>Restaurado o suporte tenant/namespace para o Pulsar que foi perdido no 2.6<a href="https://github.com/milvus-io/milvus/pull/46759">(#46759</a>)</li>
<li>Adicionado observador de configuração de carga para evitar que as modificações de configuração de carga sejam perdidas<a href="https://github.com/milvus-io/milvus/pull/46786">(#46786</a>)</li>
<li>Corrigido o bug da interface de edição de funções<a href="https://github.com/milvus-io/milvus/pull/46782">(#46782</a>)</li>
<li>Adicionada a validação da propriedade TTL da coleção para evitar que a compactação fique bloqueada<a href="https://github.com/milvus-io/milvus/pull/46736">(#46736</a>)</li>
</ul>
<h2 id="v268" class="common-anchor-header">v2.6.8<button data-href="#v268" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Data de lançamento: 4 de janeiro de 2026</p>
<table>
<thead>
<tr><th style="text-align:left">Versão Milvus</th><th style="text-align:left">Versão do SDK do Python</th><th style="text-align:left">Versão do SDK do Node.js</th><th style="text-align:left">Versão do SDK Java</th><th style="text-align:left">Versão do SDK Go</th></tr>
</thead>
<tbody>
...
<p>Temos o prazer de anunciar o lançamento do Milvus 2.6.8! Esta versão introduz o destaque de resultados de pesquisa, melhorando significativamente a experiência de recuperação. Por trás disso, otimizamos o processamento de consultas, o agendamento de recursos e os mecanismos de cache para oferecer desempenho e estabilidade superiores. Além disso, esta versão aborda erros críticos relacionados com a segurança dos dados, o tratamento do armazenamento e a concorrência. Recomendamos vivamente que todos os utilizadores actualizem para esta versão para obterem um ambiente de produção mais eficiente e fiável.</p>
<h3 id="Features" class="common-anchor-header">Caraterísticas<button data-href="#Features" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
...
<li>Pesquisa suportada com marcador de texto. Para obter detalhes, consulte <a href="/docs/pt/text-highlighter.md">Marcador de texto</a>. <a href="https://github.com/milvus-io/milvus/pull/46052">(#46052</a>)</li>
</ul>
<h3 id="Improvements" class="common-anchor-header">Melhorias<button data-href="#Improvements" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<li>Movida a lógica de otimização da consulta para o Proxy para melhorar o desempenho<a href="https://github.com/milvus-io/milvus/pull/46549">(#46549</a>)</li>
<li>Optimizado o desempenho do operador <code translate="no">LIKE</code> utilizando a ordenação STL<a href="https://github.com/milvus-io/milvus/pull/46535">(#46535</a>)</li>
<li>Permitiu a execução simultânea de tarefas de índice de texto para vários campos<a href="https://github.com/milvus-io/milvus/pull/46306">(#46306</a>)</li>
<li>Suportada a pausa do GC ao nível da coleção<a href="https://github.com/milvus-io/milvus/pull/46201">(#46201</a>)</li>
<li>Implementada uma política de penalização para QueryNodes para lidar com a exaustão de recursos<a href="https://github.com/milvus-io/milvus/pull/46086">(#46086</a>)</li>
<li>Otimização da cache de dados através do mapeamento de vários grupos de linhas para uma única célula de cache<a href="https://github.com/milvus-io/milvus/pull/46542">(#46542</a>)</li>
<li>Reduzida a utilização da CPU no QuotaCenter<a href="https://github.com/milvus-io/milvus/pull/46615">(#46615</a>)</li>
<li>Melhorado o desempenho da comparação de dados <code translate="no">TIMESTAMPTZ</code> <a href="https://github.com/milvus-io/milvus/pull/46655">(#46655</a>)</li>
<li>Suporte para campos dinâmicos anuláveis com um objeto JSON vazio como valor predefinido<a href="https://github.com/milvus-io/milvus/pull/46445">(#46445</a>)</li>
<li>Evitada a selagem desnecessária de segmentos quando apenas se alteram as propriedades da coleção<a href="https://github.com/milvus-io/milvus/pull/46489">(#46489</a>)</li>
<li>Suporte para encaminhamento de DML e DQL no Proxy para RESTful v2<a href="https://github.com/milvus-io/milvus/pull/46021">(#46021</a>, <a href="https://github.com/milvus-io/milvus/pull/46037">#46037</a>)</li>
<li>Adicionado mecanismo de repetição para leituras de armazenamento de objectos em erros de limite de taxa<a href="https://github.com/milvus-io/milvus/pull/46464">(#46464</a>)</li>
<li>Registo melhorado para meta-tabelas Proxy e RootCoord<a href="https://github.com/milvus-io/milvus/pull/46701">(#46701</a>)</li>
<li>Adicionada validação para modelos de incorporação e tipos de campo de esquema<a href="https://github.com/milvus-io/milvus/pull/46422">(#46422</a>)</li>
<li>Introduzida uma duração de tolerância para atrasar as operações de recolha de gotas<a href="https://github.com/milvus-io/milvus/pull/46252">(#46252</a>)</li>
<li>Melhoria do agendamento de tarefas de índice através da estimativa de slots com base no tamanho e tipo de campo<a href="https://github.com/milvus-io/milvus/pull/46276">(#46276</a>, <a href="https://github.com/milvus-io/milvus/pull/45851">#45851</a>)</li>
<li>Adicionado mecanismo de fallback para caminhos de escrita quando se acede ao armazenamento de objectos sem suporte de escrita condicional<a href="https://github.com/milvus-io/milvus/pull/46022">(#46022</a>)</li>
<li>Optimizada a lógica de sincronização do oráculo IDF<a href="https://github.com/milvus-io/milvus/pull/46079">(#46079</a>)</li>
<li>Alterada a porta predefinida do RootCoord para uma porta não efémera<a href="https://github.com/milvus-io/milvus/pull/46268">(#46268</a>)</li>
<li>Adicionadas métricas para monitorizar a memória em cache do Jemalloc<a href="https://github.com/milvus-io/milvus/pull/45973">(#45973</a>)</li>
<li>Melhorada a precisão da métrica da quota do disco quando a quota do cluster muda<a href="https://github.com/milvus-io/milvus/pull/46304">(#46304</a>)</li>
<li>Melhorada a observabilidade de rastreio para expressões escalares<a href="https://github.com/milvus-io/milvus/pull/45823">(#45823</a>)</li>
<li>Rejeitada a duplicação de chaves primárias em pedidos de upsert batch<a href="https://github.com/milvus-io/milvus/pull/46035">(#46035</a>)</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">Correcções de erros<button data-href="#Bug-fixes" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<li>Corrigida a correspondência de prefixo RBAC ETCD para evitar potenciais fugas de dados<a href="https://github.com/milvus-io/milvus/pull/46708">(#46708</a>)</li>
<li>Corrigido o tratamento incorreto do caminho da raiz para o modo de armazenamento local<a href="https://github.com/milvus-io/milvus/pull/46693">(#46693</a>)</li>
<li>Corrigido o tratamento de tipos mistos <code translate="no">int64</code>/<code translate="no">float</code> em campos JSON<a href="https://github.com/milvus-io/milvus/pull/46682">(#46682</a>)</li>
<li>Corrigidas as falhas de carregamento do registo de texto durante a atualização do cluster<a href="https://github.com/milvus-io/milvus/pull/46698">(#46698</a>)</li>
<li>Evitada a eliminação de outros campos durante a limpeza de dados em bruto<a href="https://github.com/milvus-io/milvus/pull/46689">(#46689</a>)</li>
<li>Corrigida a falha ao utilizar o realce com vários analisadores<a href="https://github.com/milvus-io/milvus/pull/46664">(#46664</a>)</li>
<li>Assegurado que os registos são descarregados quando o SO sai<a href="https://github.com/milvus-io/milvus/pull/46609">(#46609</a>)</li>
<li>Corrigido o erro de limite de tamanho ETCD RPC excedido ao eliminar colecções<a href="https://github.com/milvus-io/milvus/pull/46645">(#46645</a>)</li>
<li>Corrigidos os problemas de atraso de replicação quando o servidor está inativo<a href="https://github.com/milvus-io/milvus/pull/46612">(#46612</a>)</li>
<li>Corrigida a validação para valores inválidos de <code translate="no">TIMESTAMPTZ</code> <a href="https://github.com/milvus-io/milvus/pull/46556">(#46556</a>)</li>
<li>Corrigido o restauro de tarefas de compactação para garantir uma limpeza adequada<a href="https://github.com/milvus-io/milvus/pull/46578">(#46578</a>)</li>
<li>Manuseamento unificado de nós só de leitura para evitar tarefas de canal de equilíbrio bloqueadas<a href="https://github.com/milvus-io/milvus/pull/46513">(#46513</a>)</li>
<li>Evitadas quedas de dados de campo para grupos de colunas multi-campo<a href="https://github.com/milvus-io/milvus/pull/46425">(#46425</a>)</li>
<li>Removidos os clientes proxy obsoletos quando se volta a ver o ETCD<a href="https://github.com/milvus-io/milvus/pull/46490">(#46490</a>)</li>
<li>Corrigida a ordem de fusão do iterador de pedaços<a href="https://github.com/milvus-io/milvus/pull/46462">(#46462</a>)</li>
<li>Impedida a criação de grupos de consumidores Kafka ao desativar o auto-commit<a href="https://github.com/milvus-io/milvus/pull/46509">(#46509</a>)</li>
<li>Proibido o carregamento a quente de parâmetros de armazenamento em camadas<a href="https://github.com/milvus-io/milvus/pull/46438">(#46438</a>)</li>
<li>Ativado o iterador de pesquisa para vectores binários<a href="https://github.com/milvus-io/milvus/pull/46334">(#46334</a>)</li>
<li>Corrigida a condição de corrida na inicialização do armazenamento<a href="https://github.com/milvus-io/milvus/pull/46338">(#46338</a>)</li>
<li>Corrigido o facto de as consultas de destaque não funcionarem para pesquisas não-BM25<a href="https://github.com/milvus-io/milvus/pull/46295">(#46295</a>)</li>
<li>Corrigido o estouro de pilha durante a recolha de lixo JSON<a href="https://github.com/milvus-io/milvus/pull/46318">(#46318</a>)</li>
<li>Garantidas novas tentativas ao escrever binlogs<a href="https://github.com/milvus-io/milvus/pull/46310">(#46310</a>)</li>
<li>Corrigida a verificação de utilização de índices para campos JSON<a href="https://github.com/milvus-io/milvus/pull/46281">(#46281</a>)</li>
<li>Evitado o bloqueio da atualização do alvo quando as réplicas não têm nós durante o escalonamento<a href="https://github.com/milvus-io/milvus/pull/46291">(#46291</a>)</li>
<li>Restringido o tokenizador <code translate="no">char_group</code> para suportar apenas delimitadores de um byte<a href="https://github.com/milvus-io/milvus/pull/46196">(#46196</a>)</li>
<li>Saltou a utilização do índice do caminho JSON se o caminho da consulta incluir números<a href="https://github.com/milvus-io/milvus/pull/46247">(#46247</a>)</li>
<li>Corrigidos erros de concatenação de caminhos no MinIO quando o caminho raiz é "."<a href="https://github.com/milvus-io/milvus/pull/46221">(#46221</a>)</li>
<li>Corrigidas as verificações de saúde falso-positivas através da correção do cálculo da métrica de atraso da réplica<a href="https://github.com/milvus-io/milvus/pull/46122">(#46122</a>)</li>
<li>Corrigida a análise RESTful v2 e as predefinições de esquema com <code translate="no">TIMESTAMPTZ</code> <a href="https://github.com/milvus-io/milvus/pull/46239">(#46239</a>)</li>
<li>Corrigido o pânico ao procurar resultados vazios com campos de geometria de saída<a href="https://github.com/milvus-io/milvus/pull/46231">(#46231</a>)</li>
<li>Adicionada validação de alinhamento de dados de campo para evitar pânicos durante actualizações parciais<a href="https://github.com/milvus-io/milvus/pull/46180">(#46180</a>)</li>
<li>Corrigido o problema de perda de base de dados em RESTful v2<a href="https://github.com/milvus-io/milvus/pull/46172">(#46172</a>)</li>
<li>Corrigida a utilização incorrecta do contexto nas sessões do cliente gRPC<a href="https://github.com/milvus-io/milvus/pull/46184">(#46184</a>)</li>
<li>Corrigido o encaminhamento incorreto da autorização em RESTful v2 durante as actualizações<a href="https://github.com/milvus-io/milvus/pull/46140">(#46140</a>)</li>
<li>Corrigida a lógica de redução de struct incorrecta<a href="https://github.com/milvus-io/milvus/pull/46151">(#46151</a>)</li>
<li>Corrigido o erro de retorno do marcador quando os resultados da pesquisa estão vazios<a href="https://github.com/milvus-io/milvus/pull/46111">(#46111</a>)</li>
<li>Correção da lógica de carregamento de dados em bruto para campos<a href="https://github.com/milvus-io/milvus/pull/46155">(#46155</a>)</li>
<li>Corrigido o problema do movimento do cursor após saltar pedaços no índice<a href="https://github.com/milvus-io/milvus/pull/46055">(#46055</a>)</li>
<li>Correção da lógica do ciclo para <code translate="no">TIMESTAMPTZ</code> saída do índice escalar<a href="https://github.com/milvus-io/milvus/pull/46110">(#46110</a>)</li>
<li>Corrigida a definição de valores predefinidos para campos de geometria através da API RESTful<a href="https://github.com/milvus-io/milvus/pull/46064">(#46064</a>)</li>
<li>Implementada falha rápida se algum componente não estiver pronto no arranque<a href="https://github.com/milvus-io/milvus/pull/46070">(#46070</a>)</li>
</ul>
<h2 id="v267" class="common-anchor-header">v2.6.7<button data-href="#v267" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Data de lançamento: 4 de dezembro de 2025</p>
<table>
<thead>
<tr><th style="text-align:left">Versão do Milvus</th><th style="text-align:left">Versão do SDK do Python</th><th style="text-align:left">Versão do SDK do Node.js</th><th style="text-align:left">Versão do SDK Java</th><th style="text-align:left">Versão do SDK Go</th></tr>
</thead>
...
<p>Milvus 2.6.7 é uma atualização crítica de estabilização para a série 2.6.x. Esta versão concentra-se em fortalecer o sistema contra falhas distribuídas e otimizar a utilização de recursos sob alta carga. Com melhorias significativas no manuseio de E/S, gerenciamento de memória e integração do Kubernetes, recomendamos fortemente que todos os usuários de produção atualizem para esta versão para garantir maior confiabilidade e operação mais suave em escala.</p>
...
<li>Adicionado <code translate="no">/livez</code> endpoint para suportar sondas de vivacidade nativas do Kubernetes, melhorando a estabilidade da orquestração de contentores<a href="https://github.com/milvus-io/milvus/pull/45481">(#45481</a>).</li>
<li>Adicionado suporte para operações <strong>GroupBy</strong> em <code translate="no">TIMESTAMPTZ</code> campos, melhorando as capacidades de análise de séries temporais<a href="https://github.com/milvus-io/milvus/pull/45763">(#45763</a>)</li>
<li>Suportado <code translate="no">mmap</code> para índices de chave partilhada do JSON shredding para reduzir o consumo de RAM<a href="https://github.com/milvus-io/milvus/pull/45861">(#45861</a>)</li>
</ul>
<h3 id="Improvements" class="common-anchor-header">Melhorias<button data-href="#Improvements" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<li>Suporte para encaminhamento de pedidos DML no Proxy para melhorar a disponibilidade de escrita e a resiliência de encaminhamento<a href="https://github.com/milvus-io/milvus/pull/45922">(#45922</a>).</li>
<li>Atualização do etcd para a versão 3.5.23 para resolver regressões de estabilidade e desempenho consensuais<a href="https://github.com/milvus-io/milvus/pull/45953">(#45953</a>).</li>
<li>Adicionado um tratamento de erros robusto para falhas do servidor Etcd para evitar falhas de componentes em cascata<a href="https://github.com/milvus-io/milvus/pull/45633">(#45633</a>).</li>
<li>Reduzida a carga do Etcd removendo observadores dispendiosos para verificações simples da vivacidade da sessão<a href="https://github.com/milvus-io/milvus/pull/45974">(#45974</a>).</li>
<li>Melhorada a estratégia de retenção WAL para equilibrar melhor o uso do disco com a segurança de recuperação de dados<a href="https://github.com/milvus-io/milvus/pull/45784">(#45784</a>).</li>
<li>Sincronização de escrita assíncrona suportada para logs para evitar que o bloqueio de E/S do disco afecte o caminho de execução principal<a href="https://github.com/milvus-io/milvus/pull/45806">(#45806</a>).</li>
<li>Utilização forçada de E/S com buffer para tarefas de carga de alta prioridade para otimizar a utilização da cache de páginas do SO e o rendimento<a href="https://github.com/milvus-io/milvus/pull/45958">(#45958</a>).</li>
<li>Optimizada a estratégia <code translate="no">mmap</code> para mapear pedaços de grupo numa única chamada de sistema, reduzindo a sobrecarga do kernel durante o carregamento do segmento<a href="https://github.com/milvus-io/milvus/pull/45893">(#45893</a>).</li>
<li>Melhorou a precisão da estimativa de memória para trituração JSON para evitar mortes OOM ou subutilização<a href="https://github.com/milvus-io/milvus/pull/45876">(#45876</a>).</li>
<li>Estimativa de carga de segmento refinada para considerar ambos os estados de despejo e aquecimento<a href="https://github.com/milvus-io/milvus/pull/45891">(#45891</a>).</li>
<li>Adicionadas verificações de cancelamento granular em operadores de consulta para permitir uma terminação mais rápida de consultas abortadas ou com tempo limite<a href="https://github.com/milvus-io/milvus/pull/45894">(#45894</a>).</li>
<li>Removidas as verificações redundantes de tipo de recurso na configuração de recursos de ficheiros<a href="https://github.com/milvus-io/milvus/pull/45727">(#45727</a>).</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">Correcções de erros<button data-href="#Bug-fixes" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<li>Registos Go e C++ intercalados num fluxo unificado para fornecer uma vista cronológica correta para depuração<a href="https://github.com/milvus-io/milvus/pull/46005">(#46005</a>).</li>
<li>Resolvida uma condição de corrida em que <code translate="no">LastConfirmedMessageID</code> podia estar incorreto sob escritas de alta concorrência<a href="https://github.com/milvus-io/milvus/pull/45874">(#45874</a>).</li>
<li>Corrigido um erro de cálculo na agregação de <code translate="no">allsearchcount</code> a partir de vários resultados de pesquisa<a href="https://github.com/milvus-io/milvus/pull/45904">(#45904</a>).</li>
<li>Corrigidas as expressões de termo para lidar corretamente com a lógica de contenção de cadeias de caracteres nas matrizes JSON<a href="https://github.com/milvus-io/milvus/pull/45956">(#45956</a>).</li>
<li>Substituído <code translate="no">json.doc()</code> por <code translate="no">json.dom_doc()</code> em <code translate="no">JSONContainsExpr</code> para corrigir comportamentos de análise e melhorar o desempenho<a href="https://github.com/milvus-io/milvus/pull/45786">(#45786</a>).</li>
<li>Corrigido um pânico nos componentes do Standby MixCoord durante a sequência de encerramento<a href="https://github.com/milvus-io/milvus/pull/45898">(#45898</a>).</li>
<li>Corrigido o verificador de líderes para assegurar que a distribuição de segmentos é corretamente sincronizada para nós Read-Only<a href="https://github.com/milvus-io/milvus/pull/45991">(#45991</a>).</li>
<li>Assegurado que o <code translate="no">HandleNodeUp</code> é acionado durante a nova observação de nós para manter a topologia correta de equilíbrio de carga<a href="https://github.com/milvus-io/milvus/pull/45963">(#45963</a>).</li>
<li>Implementado fallback para armazenamento WAL remoto se o armazenamento WAL local ficar indisponível<a href="https://github.com/milvus-io/milvus/pull/45754">(#45754</a>).</li>
<li>Adicionado <code translate="no">EmptySessionWatcher</code> para prevenir panics quando a correr no modo de ligação IndexNode<a href="https://github.com/milvus-io/milvus/pull/45912">(#45912</a>).</li>
<li>Assegurada a consistência do estado da memória quando se recuperam tarefas de difusão a partir de buffers de protocolo<a href="https://github.com/milvus-io/milvus/pull/45788">(#45788</a>).</li>
<li>Resolvidos problemas de thread-safety nas actualizações do esquema de coleção SegCore<a href="https://github.com/milvus-io/milvus/pull/45618">(#45618</a>).</li>
<li>Verificações de controlo de acesso reforçado (RBAC) para <code translate="no">ListImport</code> e <code translate="no">GetImportProgress</code> APIs<a href="https://github.com/milvus-io/milvus/pull/45862">(#45862</a>).</li>
<li>Corrigido um erro em que BulkImport falhava se a entrada contivesse uma lista struct vazia<a href="https://github.com/milvus-io/milvus/pull/45692">(#45692</a>).</li>
</ul>
...
<li>Actualizados vários locais onde o expr copiava os valores de entrada em cada ciclo<a href="https://github.com/milvus-io/milvus/pull/45712">(#45712</a>)</li>
...
<li>Prevenido o pânico ao adicionar a verificação de ponteiro nulo ao limpar insertrecord pk2offset<a href="https://github.com/milvus-io/milvus/pull/45442">(#45442</a>)</li>
...
<li>Desativado o jsonshredding para a configuração predefinida<a href="https://github.com/milvus-io/milvus/pull/45349">(#45349</a>)</li>
...
<li>Tornou a geometrycache uma configuração opcional<a href="https://github.com/milvus-io/milvus/pull/45196">(#45196</a>)</li>
...
<li>Usado 2.6.6 para atualização do ddl do milvus<a href="https://github.com/milvus-io/milvus/pull/45739">(#45739</a>)</li>
...
<li>Evitado o deadlock no runcomponent quando o prepare falhava<a href="https://github.com/milvus-io/milvus/pull/45647">(#45647</a>)</li>
<li>Evitado o pânico quando se fechava duas vezes o canal de transmissão ack<a href="https://github.com/milvus-io/milvus/pull/45662">(#45662</a>)</li>
...
<li>Corrigido o segmento de destino marcado como abandonado para guardar resultados de estatísticas duas vezes<a href="https://github.com/milvus-io/milvus/pull/45479">(#45479</a>)</li>
...
<li>Nextfieldid não considerava struct<a href="https://github.com/milvus-io/milvus/pull/45438">(#45438</a>)</li>
...
<li>Manuseamento de dados de campos vazios na redução/classificação para o cenário de requery<a href="https://github.com/milvus-io/milvus/pull/45137">(#45137</a>)</li>
...
<li>Manuseamento de dados totalmente nulos no stringindexsort para prevenir timeout de carregamento<a href="https://github.com/milvus-io/milvus/pull/45104">(#45104</a>)</li>
...
<li>Corrigida a falha na recolha de alterações para sub-campos de struct<a href="https://github.com/milvus-io/milvus/pull/45042">(#45042</a>)</li>
...
<li>Segmentos selados acidentalmente ignorados na compactação l0<a href="https://github.com/milvus-io/milvus/pull/45351">(#45351</a>)</li>
...
<li>Suporte para o índice AISAQ - um índice de armazenamento completo<a href="https://github.com/zilliztech/knowhere/pull/1282">(#1282</a>)</li>
</ul>
<h3 id="Improvements" class="common-anchor-header">Melhorias<button data-href="#Improvements" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<li><strong>Atualizada a versão Go para 1.24.6</strong> com construtor de imagens<a href="https://github.com/milvus-io/milvus/pull/44763">(#44763</a>)</li>
<li>Activada a fragmentação JSON predefinida<a href="https://github.com/milvus-io/milvus/pull/44811">(#44811</a>)</li>
<li>Adicionada quota de disco para o tamanho do binlog carregado para evitar falhas de carga do nó de consulta<a href="https://github.com/milvus-io/milvus/pull/44932">(#44932</a>)</li>
...
<li>Corrigido o pânico ao estender o intervalo de proteção de bloqueio<a href="https://github.com/milvus-io/milvus/pull/44130">(#44130</a>)</li>
...
<li>RaBitQ Quantização de 1 bit com elevada recuperação</li>
