...
<li><a href="/docs/pt/v2.6.x/prerequisite-gpu.md">Verifique os requisitos de hardware e software</a> antes da instalação.</li>
</ul>
...
<h3 id="1-Download-and-configure-the-YAML-file" class="common-anchor-header">1. Descarregar e configurar o ficheiro YAML<button data-href="#1-Download-and-configure-the-YAML-file" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Faça o download <a href="https://github.com/milvus-io/milvus/releases/download/v2.6.18/milvus-standalone-docker-compose-gpu.yml"><code translate="no">milvus-standalone-docker-compose-gpu.yml</code></a> e salve-o como docker-compose.yml manualmente ou com o seguinte comando.</p>
<pre><code translate="no" class="language-shell"><span class="hljs-meta prompt_">$ </span><span class="language-bash">wget https://github.com/milvus-io/milvus/releases/download/v2.6.18/milvus-standalone-docker-compose-gpu.yml -O docker-compose.yml</span>
...
<button class="copy-code-btn"></button></code></pre>
<p>Também pode aceder à WebUI do Milvus em <code translate="no">http://127.0.0.1:9091/webui/</code> para saber mais sobre a sua instância do Milvus. Para obter detalhes, consulte <a href="/docs/pt/v2.6.x/milvus-webui.md">Milvus WebUI</a>.</p>
...
<li><p>Consultar a Milvus <a href="/docs/pt/v2.6.x/milvus-webui.md">WebUI</a> para saber mais sobre a instância do Milvus.</p></li>
...
<li><p><a href="/docs/pt/v2.6.x/scaleout.md">Escalar o cluster do Milvus</a>.</p></li>
