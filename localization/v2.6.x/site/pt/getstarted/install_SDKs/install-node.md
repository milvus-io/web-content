...
related_key: SDK
summary: Saiba como instalar o SDK do Milvus para o Node.js.
title: Instalar o SDK do Milvus para Node.js
---
<h1 id="Install-Milvus-Nodejs-SDK" class="common-anchor-header">Instalar o SDK do Milvus para Node.js<button data-href="#Install-Milvus-Nodejs-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Este tópico descreve como instalar o SDK do Milvus para Node.js.</p>
<h2 id="Compatibility" class="common-anchor-header">Compatibilidade<button data-href="#Compatibility" class="anchor-icon" translate="no">
    ...
    </button></h2><p>A tabela seguinte apresenta as versões do Milvus e as versões recomendadas do @zilliz/milvus2-sdk-node:</p>
<table>
<thead>
...
<h2 id="Installation" class="common-anchor-header">Instalação<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>A forma recomendada de começar a utilizar o cliente Node.js do Milvus é através do npm (gestor de pacotes do Node) para instalar a dependência no seu projeto.</p>
<pre><code translate="no" class="language-javascript">npm install @zilliz/milvus2-sdk-node
# or ...
yarn add @zilliz/milvus2-sdk-node
<button class="copy-code-btn"></button></code></pre>
<p>Isto irá descarregar o SDK do Milvus para Node.js e adicionar uma entrada de dependência ao seu ficheiro package.json.</p>
<h2 id="Whats-next" class="common-anchor-header">Próximos passos<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Depois de instalar o SDK do Milvus para Node.js, pode:</p>
<ul>
<li><p>Consultar o guia <a href="https://github.com/milvus-io/milvus-sdk-node">de início rápido do SDK do Milvus para Node.js</a></p></li>
...
<li><p>Explorar <a href="/api-reference/node/v2.4.x/About.md">a referência da API do Milvus para Node.js</a></p></li>
</ul>
