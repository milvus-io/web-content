...
related_key: SDK
summary: Saiba como instalar o SDK Java do Milvus.
title: Instalar o SDK Java do Milvus
---
<h1 id="Install-Milvus-Java-SDK" class="common-anchor-header">Instalar o SDK Java do Milvus<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Este tópico descreve como instalar o SDK Java do Milvus para o Milvus.</p>
...
<h2 id="Install-Milvus-Java-SDK" class="common-anchor-header">Instalar o SDK Java do Milvus<button data-href="#Install-Milvus-Java-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Execute o comando seguinte para instalar o SDK Java do Milvus.</p>
<ul>
<li>Apache Maven</li>
</ul>
...
<li><p>Explorar <a href="/api-reference/java/v2.6.x/About.md">a referência da API Java do Milvus</a></p></li>
</ul>
