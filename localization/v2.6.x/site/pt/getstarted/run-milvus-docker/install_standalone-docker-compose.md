...
<p><strong>Novidades na versão 2.6.21:</strong></p>
<ul>
...
<p>Descarregue sempre a configuração mais recente do Docker Compose para garantir a compatibilidade com as funcionalidades da v2.6.21.</p>
<ul>
