...
<p><strong>O que há de novo na v2.6.2:</strong></p>
<ul>
...
<p>Sempre baixe a configuração mais recente do Docker Compose para garantir a compatibilidade com os recursos da v2.6.2.</p>
<ul>
