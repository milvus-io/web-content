...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Descarregue o pacote RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pode descarregar o pacote RPM/DEB de acordo com a arquitetura do seu sistema na <a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.19">página de versões do Milvus</a>.</p>
<ul>
<li>Para x86_64/amd64, descarregue o pacote <strong>milvus_2.6.19-1_amd64.deb</strong> ou <strong>milvus_2.6.19-1_amd64.rpm</strong>.</li>
<li>Para ARM64, descarregue o pacote <strong>milvus_2.6.19-1_arm64.deb</strong> ou <strong>milvus_2.6.19-1_arm64.rpm</strong>.</li>
</ul>
