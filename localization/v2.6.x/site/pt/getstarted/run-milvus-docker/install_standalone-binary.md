...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Baixar o pacote RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pode descarregar o pacote RPM/DEB de acordo com a arquitetura do seu sistema a partir da <a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.4">página Milvus Releases</a>.</p>
<ul>
