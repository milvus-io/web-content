...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Baixar o pacote RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pode descarregar o pacote RPM/DEB de acordo com a arquitetura do seu sistema a partir da <a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.18">página Milvus Releases</a>.</p>
<ul>
...
<h2 id="Optional-Update-Milvus-configurations" class="common-anchor-header">(Opcional) Atualizar as configurações do Milvus<button data-href="#Optional-Update-Milvus-configurations" class="anchor-icon" translate="no">
    ...
    </button></h2><p>É possível modificar as configurações do Milvus no arquivo <code translate="no">/etc/milvus/configs/milvus.yaml</code>. Por exemplo, para alterar o <code translate="no">proxy.healthCheckTimeout</code> para <code translate="no">1000</code> ms, pode procurar o parâmetro de destino e modificar em conformidade. Para os itens de configuração aplicáveis, consulte <a href="/docs/pt/v2.6.x/system_configuration.md">Configuração do sistema</a>.</p>
