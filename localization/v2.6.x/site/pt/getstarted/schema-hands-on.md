...
<p>Para mais pormenores, consulte <a href="/docs/pt/analyzer-overview.md">Descrição geral do analisador</a>.</p>
<h3 id="Function" class="common-anchor-header">Funções<button data-href="#Function" class="anchor-icon" translate="no">
    ...
    </button></h3><p>O Milvus permite-lhe definir funções incorporadas como parte do esquema para derivar automaticamente determinados campos. Por exemplo, pode adicionar uma função BM25 incorporada que gera um vetor esparso a partir de um campo <code translate="no">VARCHAR</code> para suportar a pesquisa de texto integral. Estes campos derivados de funções simplificam o pré-processamento e asseguram que a coleção permanece autónoma e pronta a ser consultada.</p>
