...
<button class="copy-code-btn"></button></code></pre>
<p>Pode executar este comando a qualquer momento para obter os gráficos Helm mais recentes do Milvus.</p>
...
<p><strong>Implantar o cluster Milvus:</strong></p>
<p>O comando seguinte implementa um cluster do Milvus com definições otimizadas para a versão 2.6.19, utilizando o Woodpecker como fila de mensagens recomendada:</p>
<pre><code translate="no" class="language-bash">helm install my-release zilliztech/milvus \
  --<span class="hljs-built_in">set</span> image.all.tag=v2.6.19 \
  --<span class="hljs-built_in">set</span> pulsarv3.enabled=<span class="hljs-literal">false</span> \
  --<span class="hljs-built_in">set</span> woodpecker.enabled=<span class="hljs-literal">true</span> \
...
<p>Para mais informações, consulte <a href="https://artifacthub.io/packages/helm/milvus/milvus">o Milvus Helm Chart</a> e <a href="https://helm.sh/docs/">a documentação do Helm</a>.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p><strong>Aguarde até que todos os pods apresentem o estado «Running».</strong> Com a configuração v2.6.19, deverá ver pods semelhantes a:</p>
...
<p>Também pode aceder à <strong>interface Web do Milvus</strong> em <code translate="no">http://127.0.0.1:9091/webui/</code> assim que o reencaminhamento de portas estiver configurado (ver o passo seguinte). Para mais detalhes, consulte <a href="/docs/pt/v2.6.x/milvus-webui.md">a interface Web do Milvus</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Até agora, pode seguir os passos <a href="#2-Check-Milvus-cluster-status">2</a> e <a href="#3-Forward-a-local-port-to-Milvus">3</a> da instalação online para verificar o estado do cluster e reencaminhar uma porta local para o Milvus.</p>
