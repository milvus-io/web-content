...
summary: construir um pano com milvus
title: Construir RAG com Milvus
---
<h1 id="Build-RAG-with-Milvus" class="common-anchor-header">Construir RAG com Milvus<button data-href="#Build-RAG-with-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Neste tutorial, vamos mostrar-lhe como construir um pipeline RAG (Retrieval-Augmented Generation) com o Milvus.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Defina uma função para gerar texto incorporado utilizando o cliente OpenAI. Usamos o modelo <a href="https://platform.openai.com/docs/guides/embeddings">text-embedding-3-small</a> como exemplo.</p>
...
<h2 id="Quick-Deploy" class="common-anchor-header">Implementação rápida<button data-href="#Quick-Deploy" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Para saber como iniciar uma demonstração online com este tutorial, consulte <a href="https://github.com/milvus-io/bootcamp/tree/master/tutorials/quickstart/apps/rag_search_with_milvus">a aplicação de exemplo</a>.</p>
