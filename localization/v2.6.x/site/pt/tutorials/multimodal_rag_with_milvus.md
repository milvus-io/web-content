...
title: RAG multimodal com Milvus
---
<h1 id="Multimodal-RAG-with-Milvus" class="common-anchor-header">RAG multimodal com Milvus<button data-href="#Multimodal-RAG-with-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Se quiser experimentar o efeito final deste tutorial, pode ir diretamente para a <a href="https://demos.milvus.io/multimodal-image-search/">demonstração online</a>.</p>
...
<h3 id="Download-Data" class="common-anchor-header">Descarregar dados<button data-href="#Download-Data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>O comando a seguir descarregará os dados do exemplo e os extrairá para uma pasta local "./images_folder", incluindo:</p>
<ul>
<li><strong>imagens</strong>: Um subconjunto de <a href="https://github.com/hyp1231/AmazonReviews2023">Amazon Reviews 2023</a> que contém aproximadamente 900 imagens das categorias "Appliance", "Cell_Phones_and_Accessories" e "Electronics".</li>
<li><strong>leopard.jpg</strong>: Um exemplo de imagem de consulta.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Load-Embedding-Model" class="common-anchor-header">Modelo de incorporação de carga<button data-href="#Load-Embedding-Model" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Utilizaremos o modelo Visualized BGE "bge-visualized-base-en-v1.5" para gerar embeddings tanto para imagens como para texto.</p>
<p><strong>1. Descarregar peso</strong></p>
...
<button class="copy-code-btn"></button></code></pre>
<p><strong>2. Construir codificador</strong></p>
...
<h2 id="Load-Data" class="common-anchor-header">Carregar dados<button data-href="#Load-Data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Esta secção irá carregar imagens de exemplo para a base de dados com os respectivos embeddings.</p>
<h3 id="Generate-embeddings" class="common-anchor-header">Gerar embeddings<button data-href="#Generate-embeddings" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Carregue todas as imagens jpeg do diretório de dados e aplique o codificador para converter as imagens em embeddings.</p>
...
<h3 id="Insert-into-Milvus" class="common-anchor-header">Inserir no Milvus<button data-href="#Insert-into-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Insere as imagens com os caminhos e os embeddings correspondentes na coleção Milvus.</p>
<div class="alert note">
...
<h2 id="Multimodal-Search-with-Generative-Reranker" class="common-anchor-header">Pesquisa multimodal com o Generative Reranker<button data-href="#Multimodal-Search-with-Generative-Reranker" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Nesta secção, começamos por procurar imagens relevantes através de uma consulta multimodal e, em seguida, utilizamos o serviço LLM para classificar os resultados e encontrar o melhor com uma explicação.</p>
<h3 id="Run-search" class="common-anchor-header">Executar pesquisa<button data-href="#Run-search" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Agora estamos prontos para efetuar a pesquisa avançada de imagens com dados de consulta compostos por instruções de imagem e de texto.</p>
...
<h3 id="Rerank-with-GPT-4o" class="common-anchor-header">Classificar novamente com GPT-4o<button data-href="#Rerank-with-GPT-4o" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Vamos utilizar um LLM para classificar as imagens e gerar uma explicação para o melhor resultado com base na consulta do utilizador e nos resultados obtidos.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Combinar a imagem de consulta e as imagens recuperadas com índices numa vista panorâmica.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Obter os índices de imagem após a classificação e o motivo do melhor resultado:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p><strong>3. Apresentar o melhor resultado com uma explicação</strong></p>
