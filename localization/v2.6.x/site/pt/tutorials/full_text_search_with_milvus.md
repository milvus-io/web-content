...
<ul>
<li>A pesquisa de texto integral está atualmente disponível no Milvus Standalone, Milvus Distributed e Zilliz Cloud, embora ainda não seja suportada no Milvus Lite (que tem esta funcionalidade planeada para implementação futura). Para mais informações, contactar support@zilliz.com.</li>
</ul>
</div>
...
<p>A pesquisa híbrida é especialmente valiosa em aplicações RAG (Retrieval-Augmented Generation), em que tanto a compreensão semântica como a correspondência exacta de palavras-chave contribuem para melhores resultados de recuperação.</p>
