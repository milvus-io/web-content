...
<h1 id="Full-Text-Search-with-Milvus" class="common-anchor-header">Pesquisa de texto completo com Milvus<button data-href="#Full-Text-Search-with-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Preparation" class="common-anchor-header">Preparação<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Download-the-dataset" class="common-anchor-header">Descarregar o conjunto de dados<button data-href="#Download-the-dataset" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>O seguinte comando irá descarregar os dados de exemplo utilizados na <a href="https://github.com/anthropics/anthropic-cookbook/blob/main/skills/contextual-embeddings/guide.ipynb">demonstração</a> original do Anthropic.</p>
...
<h3 id="Install-Milvus-25" class="common-anchor-header">Instalar o Milvus 2.5<button data-href="#Install-Milvus-25" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Consulte o <a href="https://milvus.io/docs/install_standalone-docker-compose.md">guia de instalação oficial</a> para mais pormenores.</p>
<h3 id="Install-PyMilvus" class="common-anchor-header">Instalar o PyMilvus<button data-href="#Install-PyMilvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Execute o seguinte comando para instalar o PyMilvus:</p>
<pre><code translate="no" class="language-python">pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span> -U 
<button class="copy-code-btn"></button></code></pre>
<h3 id="Define-the-Retriever" class="common-anchor-header">Definir o Retriever<button data-href="#Define-the-Retriever" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Insert-the-data" class="common-anchor-header">Inserir os dados<button data-href="#Insert-the-data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Test-Sparse-Search" class="common-anchor-header">Testar a pesquisa esparsa<button data-href="#Test-Sparse-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Evaluation" class="common-anchor-header">Avaliação<button data-href="#Evaluation" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Agora que inserimos o conjunto de dados no Milvus, podemos usar a pesquisa densa, esparsa ou híbrida para obter os 5 principais resultados. Pode alterar o endereço <code translate="no">mode</code> e avaliar cada um deles. Apresentamos a métrica Pass@5, que consiste em obter os 5 melhores resultados para cada consulta e calcular o Recall.</p>
