...
<h3 id="Start-the-Docker-Containers" class="common-anchor-header">Iniciar os contêineres Docker</h3><p>Inicie os contentores com o perfil <code translate="no">milvus</code> para incluir os serviços Milvus:</p>
