...
<h4 id="2-examplerepopy" class="common-anchor-header">2. example_repo.py</h4><p>Contém as definições de caraterísticas para os dados da nossa cidade, incluindo</p>
<ul>
