...
<h4 id="Compare-with-synchronous-add" class="common-anchor-header">Comparar com a adição síncrona</h4><p>Defina uma função de adição síncrona. Em seguida, meça o tempo de execução sob a mesma condição.</p>
