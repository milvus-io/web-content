...
<h3 id="Prepare-data" class="common-anchor-header">Preparar dados<button data-href="#Prepare-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Você pode baixar dados de amostra com os seguintes comandos:</p>
...
<h3 id="Async-search" class="common-anchor-header">Pesquisa assíncrona<button data-href="#Async-search" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Reinicialize o armazenamento de vectores e adicione alguns documentos antes de executar a pesquisa.</p>
<pre><code translate="no" class="language-python">vector_store = init_vector_store()
