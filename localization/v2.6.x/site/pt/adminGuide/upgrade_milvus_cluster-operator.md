...
<ul>
<li>O Milvus v2.6.0-rc1 <strong>não</strong> é <strong>compatível</strong> com a versão v2.6.17. Não são suportadas atualizações diretas a partir de versões candidatas.</li>
...
<h2 id="Upgrade-process" class="common-anchor-header">Processo de atualização<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Primeiro, atualize o seu Milvus Operator para a versão v1.3.0:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2617" class="common-anchor-header">2.3 Atualização para a versão 2.6.17</h4><p>Assim que a versão 2.5.16 estiver a funcionar corretamente com o <code translate="no">mixCoord</code>, atualize para a versão 2.6.17:</p>
