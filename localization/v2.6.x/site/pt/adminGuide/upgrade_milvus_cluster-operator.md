...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Atualizar o cluster Milvus com o Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar o seu cluster Milvus da versão v2.5.x para a v2.6.20 utilizando o Milvus Operator.</p>
<h2 id="Before-you-start" class="common-anchor-header">Antes de começar<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v2620" class="common-anchor-header">Novidades na versão 2.6.20<button data-href="#Whats-new-in-v2620" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><strong>Deve</strong> atualizar para a v2.5.16 ou posterior com a funcionalidade « <code translate="no">mixCoord</code> » ativada antes de atualizar para a v2.6.20.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2620" class="common-anchor-header">2.3 Atualização para a versão 2.6.20</h4><p>Assim que a versão 2.5.16 estiver a funcionar corretamente com o <code translate="no">mixCoord</code>, atualize para a versão 2.6.20:</p>
