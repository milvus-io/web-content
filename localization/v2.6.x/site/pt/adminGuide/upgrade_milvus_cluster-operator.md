...
<p><strong>Limitações da fila de mensagens</strong>: Ao atualizar para o Milvus v2.6.3, deve manter a sua escolha atual de filas de mensagens. Não é possível alternar entre diferentes sistemas de filas de mensagens durante a atualização. O suporte para a mudança de sistemas de filas de mensagens estará disponível em versões futuras.</p>
