...
<h2 id="Upgrade-your-Milvus-operator" class="common-anchor-header">Atualize seu operador Milvus<button data-href="#Upgrade-your-Milvus-operator" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Execute o seguinte comando para atualizar a versão do seu Milvus Operator para a v1.1.9.</p>
...
<ul>
<li>Para atualizar o Milvus da versão 2.2.3 ou de versões posteriores para a versão 2.4.23, pode <a href="#Conduct-a-rolling-upgrade">efetuar uma atualização contínua</a>.</li>
...
<h2 id="Migrate-the-metadata" class="common-anchor-header">Migrar os metadados<button data-href="#Migrate-the-metadata" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Desde o Milvus 2.2.0, os metadados são incompatíveis com os das versões anteriores. Os seguintes exemplos pressupõem uma atualização do Milvus 2.1.4 para o Milvus 2.4.23.</p>
