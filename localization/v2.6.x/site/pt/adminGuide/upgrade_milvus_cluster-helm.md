...
<h3 id="Step-2-Upgrade-to-v2516-with-mixCoordinator" class="common-anchor-header">Etapa 2: Atualizar para a versão 2.5.16 com o mixCoordinator</h3><p>Verifique se o cluster usa atualmente coordenadores separados:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v260" class="common-anchor-header">Passo 3: Atualização para a v2.6.0</h3><p>Quando a v2.5.16 estiver a funcionar com êxito com <code translate="no">mixCoordinator</code>, actualize para a v2.6.0:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
