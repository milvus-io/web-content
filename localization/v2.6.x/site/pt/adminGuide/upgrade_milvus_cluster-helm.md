...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Atualizar o Cluster Milvus com o Gráfico Helm<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como fazer o upgrade do seu cluster Milvus com Milvus Helm charts.</p>
<div class="alert note">
<p>A atualização do Milvus 2.5.x (ou versões anteriores) para o 2.6.0 envolve mudanças significativas na arquitetura que tornam essa atualização <strong>irreversível</strong>. Devido à introdução de novos componentes (como o Woodpecker e o Streaming Node) e à remoção de determinados componentes, <strong>não é possível reverter para uma versão anterior após a conclusão da atualização</strong>. Para obter detalhes sobre as alterações arquitetônicas introduzidas na versão 2.6.0, consulte <a href="/docs/pt/architecture_overview.md">Visão geral da arquitetura do Milvus</a>.</p>
</div>
...
<p>Depois de se ter assegurado que todas as implementações na sua instância Milvus estão no seu estado normal. Pode executar o seguinte comando para atualizar a instância do Milvus para a versão 2.6.0.</p>
