...
<h2 id="Before-you-start" class="common-anchor-header">Antes de começar<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>A atualização do Milvus 2.5.x para a 2.6.3 envolve mudanças significativas na arquitetura:</p>
<ul>
...
<p><strong>Limitações da fila de mensagens</strong>: Ao atualizar para a versão 2.6.3 do Milvus, é necessário manter a escolha atual da fila de mensagens. Não é possível alternar entre diferentes sistemas de filas de mensagens durante a atualização. O suporte para a mudança de sistemas de filas de mensagens estará disponível em versões futuras.</p>
