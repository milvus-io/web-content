...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Atualizar o cluster Milvus com o Helm Chart<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar o seu cluster Milvus da versão v2.5.x para a v2.6.17 utilizando o Helm Chart.</p>
...
<ul>
<li>O Milvus v2.6.0-rc1 <strong>não</strong> é <strong>compatível</strong> com a v2.6.17. Não são suportadas atualizações diretas a partir de versões candidatas.</li>
...
<li><strong>Deve</strong> atualizar para a v2.5.16 ou posterior, com a funcionalidade « <code translate="no">mixCoordinator</code> » ativada, antes de atualizar para a v2.6.17.</li>
</ul>
...
A partir da versão 4.2.21 do gráfico Helm do Milvus, introduzimos o gráfico pulsar-v3.x como dependência. Por motivos de compatibilidade retroativa, atualize o seu Helm para a versão 3.14 ou posterior e certifique-se de que adiciona a opção « <code translate="no">--reset-then-reuse-values</code> » sempre que utilizar « <code translate="no">helm upgrade</code> ».
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Se observar pods de coordenador separados (<code translate="no">datacoord</code>, <code translate="no">querycoord</code>, <code translate="no">indexcoord</code>), atualize para a v2.5.16 e ative a opção « <code translate="no">mixCoordinator</code> »:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v2617" class="common-anchor-header">Passo 3: Atualize para a versão 2.6.17<button data-href="#Step-3-Upgrade-to-v2617" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Assim que a v2.5.16 estiver a funcionar corretamente com <code translate="no">mixCoordinator</code>, atualize para a v2.6.17:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
