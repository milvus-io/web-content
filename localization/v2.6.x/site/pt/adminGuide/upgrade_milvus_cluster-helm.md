...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Atualização do Cluster Milvus com Helm Chart<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar seu cluster Milvus da v2.5.x para a v2.6.7 usando o Helm Chart.</p>
<h2 id="Before-you-start" class="common-anchor-header">Antes de começar<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v267" class="common-anchor-header">O que há de novo na versão 2.6.7<button data-href="#Whats-new-in-v267" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>A atualização do Milvus 2.5.x para o 2.6.7 envolve mudanças significativas na arquitetura:</p>
<ul>
...
<li>É <strong>necessário</strong> atualizar para a versão 2.5.16 ou posterior com <code translate="no">mixCoordinator</code> ativado antes de atualizar para a versão 2.6.7.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v267" class="common-anchor-header">Passo 3: Atualização para a v2.6.7<button data-href="#Step-3-Upgrade-to-v267" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Quando a versão 2.5.16 estiver a funcionar com êxito com <code translate="no">mixCoordinator</code>, actualize para a versão 2.6.7:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
