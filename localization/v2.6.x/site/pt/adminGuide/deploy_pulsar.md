...
<h2 id="Configure-Pulsar-with-Docker-Compose" class="common-anchor-header">Configurar o Pulsar com o Docker Compose<button data-href="#Configure-Pulsar-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Para configurar o Pulsar com o Docker Compose, indique os seus valores na secção « <code translate="no">pulsar</code> » do ficheiro « <code translate="no">milvus.yaml</code> », no caminho «milvus/configs».</p>
...
<p>Para obter detalhes sobre como configurar o Milvus utilizando o Helm, consulte <a href="/docs/pt/v2.6.x/configure-helm.md">«Configurar o Milvus com Helm Charts</a>». Para obter detalhes sobre itens de configuração relacionados com o Pulsar, consulte <a href="/docs/pt/v2.6.x/configure_pulsar.md">«Configurações relacionadas com o Pulsar</a>».
|</p>
...
<ol start="2">
<li>Após configurar as secções anteriores e guardar o ficheiro ` <code translate="no">values.yaml</code> `, execute o comando seguinte para instalar o Milvus, que utiliza as configurações do Pulsar.</li>
</ol>
...
<h2 id="Configure-Woodpecker-with-Helm" class="common-anchor-header">Configurar o Woodpecker com o Helm<button data-href="#Configure-Woodpecker-with-Helm" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Para clusters Milvus no K8s, pode configurar o Woodpecker no mesmo comando que inicia o Milvus. Em alternativa, pode configurar o Woodpecker utilizando o ficheiro <code translate="no">values.yml</code> no caminho /charts/milvus no repositório <a href="https://github.com/milvus-io/milvus-helm">milvus-helm</a> antes de iniciar o Milvus.</p>
...
<p>Para mais detalhes sobre como configurar o Milvus utilizando o Helm, consulte <a href="/docs/pt/v2.6.x/configure-helm.md">«Configurar o Milvus com os Charts do Helm</a>». Para mais detalhes sobre os itens de configuração relacionados com o Pulsar, consulte <a href="/docs/pt/v2.6.x/configure_pulsar.md">«Configurações relacionadas com o Pulsar</a>».</p>
<h3 id="Using-the-YAML-file" class="common-anchor-header">Utilizar o ficheiro YAML<button data-href="#Using-the-YAML-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
