...
summary: Saiba como atualizar o Milvus autônomo com o Milvus Operator.
title: Atualizar o Milvus Standalone com o Milvus Operator
---
<div class="tab-wrapper"><a href="/docs/pt/v2.6.x/upgrade_milvus_standalone-operator.md" class='active '>Milvus</a><a href="/docs/pt/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>Operator</a>, Helm, Docker<a href="/docs/pt/v2.6.x/upgrade_milvus_standalone-docker.md" class=''>Compose</a></div>
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Atualizar o Milvus Standalone com o Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar a sua implementação do Milvus Standalone da versão v2.5.x para a v2.6.24 utilizando o Milvus Operator.</p>
...
<ul>
<li><strong>Consolidação do coordenador</strong>: os coordenadores separados herdados (<code translate="no">dataCoord</code>, <code translate="no">queryCoord</code>, <code translate="no">indexCoord</code>) foram consolidados num único <code translate="no">mixCoord</code></li>
...
<ul>
<li>Cluster Kubernetes com o Milvus standalone implementado através do Milvus Operator</li>
...
<h3 id="Step-2-Upgrade-your-Milvus-standalone" class="common-anchor-header">Passo 2: Atualizar o seu Milvus autónomo<button data-href="#Step-2-Upgrade-your-Milvus-standalone" class="anchor-icon" translate="no">
    ...
    </button></h3><h4 id="21-Upgrade-to-v2516" class="common-anchor-header">2.1 Atualizar para a versão v2.5.16</h4><div class="alert-note">
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2624" class="common-anchor-header">2.2 Atualização para a versão 2.6.24</h4><p>Assim que a versão 2.5.16 estiver a funcionar corretamente, atualize para a versão 2.6.24:</p>
