...
<p>Normalmente, pode <a href="#Upgrade-Milvus-by-changing-its-image">atualizar o Milvus alterando a sua imagem</a>. No entanto, é necessário <a href="#Migrate-the-metadata">migrar os metadados</a> antes de qualquer atualização da versão v2.1.x para a v2.6.21.</p>
...
<p>Tenha em atenção que é necessário alterar as etiquetas da imagem para o Proxy, todos os coordenadores e todos os nós de trabalho.</p>
