...
<li><strong>Limitações de atualização</strong>: <strong>Limitações da fila de mensagens</strong>: Ao atualizar para o Milvus v2.6.24, deve manter a sua escolha atual de fila de mensagens. Não é suportada a alternância entre diferentes sistemas de filas de mensagens durante a atualização. O suporte à alteração de sistemas de filas de mensagens estará disponível em versões futuras.</li>
</ul>
...
<h2 id="Configure-Woodpecker" class="common-anchor-header">Configurar o Woodpecker<button data-href="#Configure-Woodpecker" class="anchor-icon" translate="no">
    ...
    </button></h2><p>O Woodpecker é um Write-Ahead Log (WAL) nativo da nuvem, concebido para armazenamento de objetos. Oferece elevado débito, baixo custo operacional e escalabilidade contínua. Para mais detalhes, consulte <a href="/docs/pt/v2.6.x/use-woodpecker.md">Utilizar o Woodpecker</a>.</p>
