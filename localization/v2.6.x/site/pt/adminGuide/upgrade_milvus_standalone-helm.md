...
summary: Saiba como atualizar o Milvus em modo autónomo com o Helm Chart.
...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Atualizar o Milvus Standalone com o Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar a sua implementação do Milvus Standalone da versão v2.5.x para a v2.6.17 utilizando o Helm Chart.</p>
...
<h3 id="Step-3-Upgrade-to-v2617" class="common-anchor-header">Passo 3: Atualize para a versão 2.6.17<button data-href="#Step-3-Upgrade-to-v2617" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Assim que a versão 2.5.16 estiver a funcionar corretamente, atualize para a versão 2.6.17:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
