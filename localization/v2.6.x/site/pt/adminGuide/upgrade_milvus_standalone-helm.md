...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Atualização do Milvus Standalone com Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar a implantação autônoma do Milvus da v2.5.x para a v2.6.15 usando o Helm Chart.</p>
...
<li>É <strong>necessário</strong> atualizar para a versão 2.5.16 ou posterior antes de atualizar para a versão 2.6.15.</li>
</ul>
...
<h3 id="Step-3-Upgrade-to-v2615" class="common-anchor-header">Passo 3: Atualização para a v2.6.15<button data-href="#Step-3-Upgrade-to-v2615" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Quando a versão 2.5.16 estiver a ser executada com êxito, actualize para a versão 2.6.15:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
