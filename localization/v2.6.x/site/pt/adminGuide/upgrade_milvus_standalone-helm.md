...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Atualização do Milvus Standalone com Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar a implantação autônoma do Milvus da versão 2.5.x para a versão 2.6.2 usando o Helm Chart.</p>
<h2 id="Before-you-start" class="common-anchor-header">Antes de começar<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h3><p>A atualização do Milvus 2.5.x para a versão 2.6.2 envolve mudanças significativas na arquitetura:</p>
<ul>
...
<li><strong>É necessário</strong> atualizar para a versão 2.5.16 ou posterior antes de atualizar para a versão 2.6.2.</li>
</ul>
...
<h3 id="Step-3-Upgrade-to-v262" class="common-anchor-header">Passo 3: Atualização para a v2.6.2<button data-href="#Step-3-Upgrade-to-v262" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Quando a v2.5.16 estiver a ser executada com êxito, actualize para a v2.6.2:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
