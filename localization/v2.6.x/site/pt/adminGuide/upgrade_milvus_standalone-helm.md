...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Atualização do Milvus Standalone com Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar a implantação autônoma do Milvus da v2.5.x para a v2.6.6 usando o Helm Chart.</p>
...
<li>É <strong>necessário</strong> atualizar para a versão 2.5.16 ou posterior antes de atualizar para a versão 2.6.6.</li>
</ul>
<p><strong>Limitações da fila de mensagens</strong>: Ao atualizar para o Milvus v2.6.6, tem de manter a sua escolha atual de filas de mensagens. Não é possível alternar entre diferentes sistemas de filas de mensagens durante a atualização. O suporte para a mudança de sistemas de filas de mensagens estará disponível em versões futuras.</p>
...
<h3 id="Step-3-Upgrade-to-v266" class="common-anchor-header">Passo 3: Atualização para a v2.6.6<button data-href="#Step-3-Upgrade-to-v266" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Quando a v2.5.16 estiver a ser executada com êxito, actualize para a v2.6.6:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
