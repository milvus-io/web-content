...
<h3 id="Step-2-Upgrade-to-v260" class="common-anchor-header">Passo 2: Atualização para a v2.6.0<button data-href="#Step-2-Upgrade-to-v260" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
