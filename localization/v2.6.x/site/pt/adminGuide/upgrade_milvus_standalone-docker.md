...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Atualizar o Milvus Standalone com o Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar a implantação autônoma do Milvus da v2.5.x para a v2.6.4 usando o Docker Compose.</p>
...
<p>Devido a questões de segurança, o Milvus actualiza o seu MinIO para RELEASE.2024-12-18T13-15-44Z com o lançamento da versão 2.6.4.</p>
</div>
...
<ol>
<li><p>Edite o ficheiro <code translate="no">docker-compose.yaml</code> existente e actualize a etiqueta de imagem Milvus para a versão 2.5.16:</p>
...
<h3 id="Step-2-Upgrade-to-v264" class="common-anchor-header">Passo 2: Atualização para a v2.6.4<button data-href="#Step-2-Upgrade-to-v264" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
