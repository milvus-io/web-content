...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Atualizar o Milvus Standalone com o Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar a sua implementação do Milvus Standalone da versão v2.5.x para a v2.6.23 utilizando o Docker Compose.</p>
...
<li><strong>Novos componentes</strong>: Introdução do Nódulo de Transmissão para um processamento de dados melhorado</li>
...
<ul>
<li>O Milvus v2.6.0-rc1 <strong>não</strong> é <strong>compatível</strong> com a versão v2.6.23. Não são suportadas atualizações diretas a partir de versões candidatas.</li>
...
<p>Por motivos de segurança, o Milvus atualiza o seu MinIO para a versão RELEASE.2024-12-18T13-15-44Z com o lançamento da v2.6.23.</p>
</div>
...
<p>Ignore este passo se a sua implantação autónoma já estiver a executar a v2.5.16 ou superior.</p>
</div>
<ol>
<li><p>Edite o seu ficheiro « <code translate="no">docker-compose.yaml</code> » existente e atualize a etiqueta da imagem do Milvus para a versão v2.5.16:</p>
...
docker compose up -d
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Verifique a atualização para a v2.5.16:</p>
<pre><code translate="no" class="language-bash">docker compose ps
<button class="copy-code-btn"></button></code></pre></li>
</ol>
<h3 id="Step-2-Upgrade-to-v2623" class="common-anchor-header">Passo 2: Atualização para a versão 2.6.23<button data-href="#Step-2-Upgrade-to-v2623" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Assim que a versão v2.5.16 estiver a funcionar corretamente, atualize para a versão v2.6.23:</p>
<ol>
...
<li>Se estiver pronto para implementar o seu cluster na nuvem:
<ul>
