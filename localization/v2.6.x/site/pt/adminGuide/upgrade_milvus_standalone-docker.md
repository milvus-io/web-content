...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Atualizar o Milvus Standalone com o Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar a sua implementação do Milvus Standalone da versão v2.5.x para a v2.6.17 utilizando o Docker Compose.</p>
...
<h3 id="Step-2-Upgrade-to-v2617" class="common-anchor-header">Passo 2: Atualização para a versão 2.6.17<button data-href="#Step-2-Upgrade-to-v2617" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<ol>
<li><p>Edite o ficheiro <code translate="no">docker-compose.yaml</code> existente e atualize as tags de imagem do Milvus e do MinIO:</p>
<pre><code translate="no" class="language-yaml"><span class="hljs-string">...</span>
