...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Atualizar o Milvus Standalone com o Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar a sua implementação do Milvus Standalone da versão v2.5.x para a v2.6.21 utilizando o Docker Compose.</p>
...
<p>Por motivos de segurança, o Milvus atualiza o seu MinIO para a versão RELEASE.2024-12-18T13-15-44Z com o lançamento da v2.6.21.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v2621" class="common-anchor-header">Passo 2: Atualizar para a versão 2.6.21<button data-href="#Step-2-Upgrade-to-v2621" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Assim que a versão v2.5.16 estiver a funcionar corretamente, atualize para a versão v2.6.21:</p>
<ol>
