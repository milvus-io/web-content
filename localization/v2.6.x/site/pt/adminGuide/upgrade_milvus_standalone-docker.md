...
<h3 id="Step-2-Upgrade-to-v2617" class="common-anchor-header">Passo 2: Atualizar para a versão 2.6.17<button data-href="#Step-2-Upgrade-to-v2617" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Pode também querer aprender a:
<ul>
