...
title: 提示：Milvus 指数选择
summary: 人工智能编码助手选择和配置 Milvus 索引的规则。
---
<h1 id="Index-Selection" class="common-anchor-header">索引选择<button data-href="#Index-Selection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>用于选择和调整 Milvus 索引的决策指南和配置规则，包括 AUTOINDEX、HNSW、DiskANN、IVF 和稀疏索引。将下面的完整提示复制到你的 AI 工具中，以自动应用这些规则。有关所有提示的概述，请参阅<a href="/docs/zh/milvus_for_agents.md">AI 提示</a>。</p>
