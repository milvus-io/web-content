...
<p>用于选择和调整 Milvus 索引的决策指南和配置规则，包括 AUTOINDEX、HNSW、DiskANN、IVF 和稀疏索引。将下面的完整提示复制到人工智能工具中，即可自动应用这些规则。有关所有提示的概述，请参阅<a href="/docs/zh/ai_prompts_landing.md">AI 提示</a>。</p>
