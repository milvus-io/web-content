...
<p>使用 MilvusClient 接口编写正确的 Milvus Python 代码的规则，包括 ORM 迁移、连接模式和常用操作。将下面的完整提示复制到你的人工智能工具中，以自动应用这些规则。有关所有提示的概述，请参阅<a href="/docs/zh/milvus_for_agents.md">AI 提示</a>。</p>
