...
<p>设计正确的 Milvus Collections 模式的规则和决策指南，包括字段类型、主键、BM25 配置和模式不变性约束。将下面的完整提示复制到您的人工智能工具中，以自动应用这些规则。有关所有提示的概述，请参阅<a href="/docs/zh/milvus_for_agents.md">AI 提示</a>。</p>
