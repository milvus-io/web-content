...
<h1 id="Milvus-for-AI-Agents" class="common-anchor-header">用于人工智能代理的 Milvus<button data-href="#Milvus-for-AI-Agents" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus 提供友好的代理接口，允许人工智能编码代理和自主代理系统以编程方式与向量数据库进行交互。无论您是要构建 RAG 管道、语义搜索还是代理记忆系统，Milvus 都能为代理提供多种连接和操作方法。</p>
...
<div class="start_card_container">
  <a href="/docs/zh/integrations_overview.md" style="text-decoration: none; color: inherit;">
    <p class="link-btn" style="font-size: 1rem; white-space: nowrap;">代理框架</p>
    <p style="font-size: 0.875rem; font-weight: 400; color: #555;">与 LangChain、LlamaIndex、OpenAI Agents 和其他代理协调框架集成。</p>
  </a>
</div>
</div>
<h2 id="AI-prompts" class="common-anchor-header">人工智能提示<button data-href="#AI-prompts" class="anchor-icon" translate="no">
    ...
    </button></h2><p>精心策划的提示，帮助人工智能编码助手编写正确的 Milvus 代码。每个提示都包含防止最常见错误的规则和模式。</p>
...
<p>对于代理工作负载，建议在生产中使用<strong>Zilliz Cloud</strong>。Agents 通常不管理基础设施，因此无服务器部署可消除操作开销，并提供自动扩展功能。</p>
</div>
<h2 id="Quick-connection-examples" class="common-anchor-header">快速连接示例<button data-href="#Quick-connection-examples" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>从你的 Agents 代码连接到 Milvus：</p>
...
<li><a href="/docs/zh/quickstart.md">快速入门</a>--在几分钟内运行你的第一个 Milvus 搜索。</li>
<li><a href="/docs/zh/integrations_overview.md">Agents 框架集成</a>- 将 Milvus 与 LangChain、LlamaIndex、OpenAI Agents 等连接起来。</li>
</ul>
