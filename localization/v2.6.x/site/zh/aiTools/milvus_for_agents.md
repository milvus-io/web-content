...
<div class="start_card_container">
  <a href="https://github.com/zilliztech/claude-context" style="text-decoration: none; color: inherit;">
    ...
    <p style="font-size: 0.875rem; font-weight: 400; color: #555;">为Claude Code设计的 MCP 服务器，提供上下文感知的 Milvus 文档访问。</p>
  </a>
</div>
</div>
...
<tbody>
<tr><td>Cursor</td><td><code translate="no">.cursor/rules/*.md</code></td><td><a href="https://docs.cursor.com/en/context/rules">配置项目规则</a></td></tr>
...
<tr><td>Claude Code</td><td><code translate="no">CLAUDE.md</code></td><td><a href="https://docs.anthropic.com/en/docs/claude-code/overview">Claude Code文档</a></td></tr>
