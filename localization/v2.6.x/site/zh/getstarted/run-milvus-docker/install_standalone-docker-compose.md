...
<li>安装前<a href="/docs/zh/v2.6.x/prerequisite-docker.md">请检查硬件和软件的要求</a>。</li>
</ul>
...
<p><strong>v2.6.24 版本更新内容：</strong></p>
<ul>
...
<p>请务必下载最新的 Docker Compose 配置文件，以确保与 v2.6.24 版本的功能兼容。</p>
<ul>
<li><p>若上述命令执行失败，请检查您的系统是否安装了 Docker Compose V1。如果是这种情况，鉴于<a href="https://docs.docker.com/compose/">本页</a>的说明，建议您迁移至 Docker Compose V2。</p></li>
...
<h2 id="Optional-Update-Milvus-configurations" class="common-anchor-header">（可选）更新 Milvus 配置<button data-href="#Optional-Update-Milvus-configurations" class="anchor-icon" translate="no">
    ...
    </button></h2><p>若要根据您的需求更新 Milvus 配置，您需要修改<code translate="no">milvus-standalone</code> 容器内的<code translate="no">/milvus/configs/user.yaml</code> 文件。</p>
<ol>
...
<li><p>添加额外配置以覆盖默认配置。
下文假设您需要覆盖默认的<code translate="no">proxy.healthCheckTimeout</code> 。有关适用的配置项，请参阅《<a href="/docs/zh/v2.6.x/system_configuration.md">系统配置》</a>。</p>
