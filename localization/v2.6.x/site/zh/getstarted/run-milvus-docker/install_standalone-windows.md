...
<li><p>检查您是否以<strong>管理员</strong>模式启动了 Docker Desktop。​</p>
...
<li><p><strong>通过“设置</strong>&gt;<strong>资源</strong>&gt;<strong>WSL 集成</strong>”路径，从已安装的 WSL 2 发行版中选择您希望启用 Docker 集成的发行版。​</p>
<p><span class="img-wrapper">
