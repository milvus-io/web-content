...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">下载 RPM/DEB 软件包<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>您可以从<a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.22">Milvus 发布页面</a>根据您的系统架构下载相应的 RPM/DEB 软件包。</p>
<ul>
<li>对于 x86_64/amd64 架构，请下载<strong>milvus_2.6.22-1_amd64.deb</strong>或<strong>milvus_2.6.22-1_amd64.rpm</strong>软件包。</li>
<li>对于 ARM64，请下载<strong>milvus_2.6.22-1_arm64.deb</strong>或<strong>milvus_2.6.22-1_arm64.rpm</strong>软件包。</li>
</ul>
