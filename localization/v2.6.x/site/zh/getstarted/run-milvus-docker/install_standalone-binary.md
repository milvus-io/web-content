...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">下载 RPM/DEB 软件包<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>你可以从 [Milvus Releases 页面](https://github.com/milvus-io/milvus/releases/tag/v{{ var.milvus_release_version }})下载与你的系统架构相符的 RPM/DEB 包。</p>
<ul>
<li>对于 x86_64/amd64，请下载<strong>{{ var.milvus_deb_amd64 }}</strong>或<strong>{{ var.milvus_rpm_amd64 }}</strong>软件包。</li>
<li>对于 ARM64，请下载<strong>{{ var.milvus_deb_arm64 }}</strong>或<strong>{{ var.milvus_rpm_arm64 }}</strong>软件包。</li>
</ul>
