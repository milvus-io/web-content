...
<p><strong>v2.6.17 版本新增功能：</strong></p>
<ul>
...
<li><strong>架构优化</strong>：整合组件以提升性能</li>
</ul>
<p>请务必下载最新脚本，以确保您获得最新的配置和架构改进。</p>
...
<li><p>探索<a href="/docs/zh/v2.6.x/milvus-webui.md">Milvus WebUI，</a>这是一个用于 Milvus 可观测性和管理的直观 Web 界面。</p></li>
