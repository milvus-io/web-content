...
<h2 id="Overview" class="common-anchor-header">概述<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Operator 是一套解决方案，可帮助您在目标 Kubernetes（K8s）集群中部署和管理完整的 Milvus 服务栈。该服务栈包含所有 Milvus 组件以及 etcd、Pulsar 和 MinIO 等相关依赖项。</p>
...
<p>若在拉取镜像时遇到任何问题，请发送邮件至<a href="mailto:community@zilliz.com">community@zilliz.com</a>并附上详细问题描述，我们将为您提供必要的支持。</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Milvus Operator 会先创建 Milvus 的依赖项（如 etcd、Pulsar 和 MinIO），然后创建 Milvus 的组件（如代理、协调器和节点）。</p>
<p>一旦您的 Milvus 集群就绪，该集群中所有 Pod 的状态应与以下内容类似。</p>
...
<h2 id="Access-Milvus-WebUI" class="common-anchor-header">访问 Milvus WebUI<button data-href="#Access-Milvus-WebUI" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus 随附了一个名为 Milvus WebUI 的内置 GUI 工具，您可以通过浏览器访问它。Milvus WebUI 通过简单直观的界面增强了系统可观测性。您可以使用 Milvus WebUI 观察 Milvus 组件和依赖项的统计数据及指标，查看数据库和 Collection 详情，并列出详细的 Milvus 配置。 有关 Milvus WebUI 的详细信息，请参阅<a href="/docs/zh/v2.6.x/milvus-webui.md">Milvus WebUI</a></p>
...
<li>若要随 Milvus 集群一并删除依赖项和持久卷申领 (PVC)，请参阅<a href="https://github.com/zilliztech/milvus-operator/blob/main/config/samples/milvus_deletion.yaml">配置文件</a>。</li>
</ul>
</div>
...
<ul>
<li><p>查看<a href="/docs/zh/v2.6.x/quickstart.md">“Hello Milvus</a>”示例，了解 Milvus 的功能。</p></li>
...
<li><p>了解<a href="/docs/zh/v2.6.x/birdwatcher_overview.md">Birdwatcher</a>——一款用于调试 Milvus 并实现动态配置更新的开源工具。</p></li>
