...
<h2 id="Installation" class="common-anchor-header">安装<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>开始使用 Milvus Node.js 客户端的推荐方法是通过 npm（Node 包管理器）在您的项目中安装该依赖项。</p>
...
<li><p>探索<a href="/api-reference/node/v2.6.x/About.md">Milvus Node.js API 参考文档</a></p></li>
</ul>
