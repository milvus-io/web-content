...
---
<h1 id="Install-Milvus-Nodejs-SDK" class="common-anchor-header">安装 Milvus Node.js SDK<button data-href="#Install-Milvus-Nodejs-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>本主题介绍了如何为 Milvus 安装 Milvus Node.js SDK。</p>
<h2 id="Compatibility" class="common-anchor-header">兼容性<button data-href="#Compatibility" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>下表列出了 Milvus 版本及其推荐的 @zilliz/milvus2-sdk-node 版本：</p>
<table>
<thead>
<tr><th style="text-align:center">Milvus 版本</th><th style="text-align:center">推荐的 @zilliz/milvus2-sdk-node 版本</th></tr>
</thead>
<tbody>
...
<h2 id="Installation" class="common-anchor-header">安装<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>开始使用 Milvus Node.js 客户端的推荐方法是使用 npm（Node 包管理器）在您的项目中安装该依赖项。</p>
<pre><code translate="no" class="language-javascript">npm install @zilliz/milvus2-sdk-node
# or ...
yarn add @zilliz/milvus2-sdk-node
<button class="copy-code-btn"></button></code></pre>
<p>这将下载 Milvus Node.js SDK，并在您的 package.json 文件中添加一个依赖项条目。</p>
<h2 id="Whats-next" class="common-anchor-header">下一步<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>安装 Milvus Node.js SDK 后，您可以：</p>
<ul>
<li><p>查看<a href="https://github.com/milvus-io/milvus-sdk-node">Milvus Node.js SDK 的快速入门指南</a></p></li>
...
<li><p>探索<a href="/api-reference/node/v2.4.x/About.md">Milvus Node.js API 参考文档</a></p></li>
</ul>
