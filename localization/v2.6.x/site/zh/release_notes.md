...
<h2 id="v269" class="common-anchor-header">v2.6.9<button data-href="#v269" class="anchor-icon" translate="no">
    ...
    </button></h2><p>发布日期：2026 年 1 月 16 日</p>
<table>
<thead>
...
<p>我们很高兴地宣布 Milvus 2.6.9 版本发布！本次更新为搜索结果引入了高亮评分，通过支持在数据或 Schema 发生变化时重新打开段来增强段管理，并改进了存储版本处理。主要改进包括提高日志记录性能、增强表达式端点的安全控制，以及优化文本分析器和索引构建。该版本还解决了一些关键问题，包括内存估计精度、几何数据转换和各种稳定性修复。我们建议 2.6 分支的所有用户升级到该版本，以提高系统可靠性和性能。</p>
<h3 id="Features" class="common-anchor-header">功能特性<button data-href="#Features" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>支持主键搜索<a href="https://github.com/milvus-io/milvus/pull/46528">(#46528</a>)</li>
</ul>
...
<li>添加了存储版本标签度量，以提高可观察性<a href="https://github.com/milvus-io/milvus/pull/47014">(#47014</a>)</li>
<li>QueryCoord 现在支持在清单路径发生变化时重新打开分段<a href="https://github.com/milvus-io/milvus/pull/46921">(#46921</a>)</li>
<li>添加了在数据或 Schema 发生变化时重新打开段的支持<a href="https://github.com/milvus-io/milvus/pull/46412">(#46412</a>)</li>
<li>提高了慢速日志的性能和效率<a href="https://github.com/milvus-io/milvus/pull/47086">（#47086）</a></li>
<li>添加了存储版本升级压缩策略，以促进版本迁移<a href="https://github.com/milvus-io/milvus/pull/47011">（＃47011）</a></li>
<li>消除了 C++ 日志的额外内存复制操作，以提高性能<a href="https://github.com/milvus-io/milvus/pull/46992">(#46992</a>)</li>
<li>为 /expr 端点添加了安全控制，以防止未经授权的访问<a href="https://github.com/milvus-io/milvus/pull/46978">(#46978</a>)</li>
<li>流服务现在保持启用状态，直到达到所需的流节点数<a href="https://github.com/milvus-io/milvus/pull/46982">（#46982）</a></li>
<li>删除了更新段信息时多余的 etcd put 操作符<a href="https://github.com/milvus-io/milvus/pull/46794">(#46794</a>)</li>
<li>改进了行计数验证，并减少了排序压缩的误导性警告日志<a href="https://github.com/milvus-io/milvus/pull/46824">（#46824）</a></li>
<li>清理并整理了构建索引日志信息<a href="https://github.com/milvus-io/milvus/pull/46769">（#46769）</a></li>
<li>限制每个工作员并发建立向量索引的次数，以防止资源耗尽<a href="https://github.com/milvus-io/milvus/pull/46877">（#46877）</a></li>
<li>优化了 jieba 和 lindera 分析器克隆操作，以提高性能<a href="https://github.com/milvus-io/milvus/pull/46757">(#46757</a>)</li>
<li>添加了 glog sink，以便将 CGO 日志转移到 zap 日志记录器，从而实现统一日志记录<a href="https://github.com/milvus-io/milvus/pull/46741">（#46741）</a></li>
<li>加强存储 V2 格式的使用并废除 V1 写入<a href="https://github.com/milvus-io/milvus/pull/46889">（#46889）</a></li>
<li>对 ngram 操作进行批处理以提高效率<a href="https://github.com/milvus-io/milvus/pull/46703">(#46703</a>)</li>
<li>为 binlog 写操作添加了自动重试机制，以提高可靠性<a href="https://github.com/milvus-io/milvus/pull/46854">（#46854）</a></li>
<li>过滤了消费端的空时间戳信息，以减少不必要的处理<a href="https://github.com/milvus-io/milvus/pull/46730">（#46730）</a></li>
<li>通过重复检查和自动 anns_field 推断改进了主键搜索<a href="https://github.com/milvus-io/milvus/pull/46745">（#46745）</a></li>
<li>为 siliconflow 和 cohere 嵌入提供程序添加了维度参数支持<a href="https://github.com/milvus-io/milvus/pull/47081">（#47081）</a></li>
</ul>
...
<li>修正了在段加载估算中重复计算索引内存的问题<a href="https://github.com/milvus-io/milvus/pull/47046">(#47046</a>)</li>
<li>修复了 macOS 14 上的编译问题<a href="https://github.com/milvus-io/milvus/pull/47048">(#47048</a>)</li>
<li>将修订版用作流服务发现的全局版本，以提高一致性<a href="https://github.com/milvus-io/milvus/pull/47023">(#47023</a>)</li>
<li>确保所有期货在异常情况下完成，以防止免用后崩溃<a href="https://github.com/milvus-io/milvus/pull/46960">（#46960）</a></li>
<li>修正了碎片拦截器错误地跳过<code translate="no">FlushAllMsg</code> 操作符的问题<a href="https://github.com/milvus-io/milvus/pull/47004">（#47004）</a></li>
<li>为 Collections TTL 添加了有效范围验证，以防止无效配置<a href="https://github.com/milvus-io/milvus/pull/47010">（#47010）</a></li>
<li>修正了<code translate="no">GetCredentialInfo</code> 未缓存 RPC 响应的问题<a href="https://github.com/milvus-io/milvus/pull/46945">（＃46945）</a></li>
<li>修复了当多个函数失效时无法调用<code translate="no">AlterFunction</code> 的问题<a href="https://github.com/milvus-io/milvus/pull/46986">（＃46986）</a></li>
<li>修正了反转索引空偏移文件未压缩的问题<a href="https://github.com/milvus-io/milvus/pull/46950">（＃46950）</a></li>
<li>修复了在索引的 JSON 字段上使用 is_null_expr 时崩溃的问题<a href="https://github.com/milvus-io/milvus/pull/46894">（#46894）</a></li>
<li>在 RESTful v2 插入 API 中添加了对 allow_insert_auto_id 标志的检查<a href="https://github.com/milvus-io/milvus/pull/46931">（#46931）</a></li>
<li>从 loon 清单读取之前，在列组中添加了字段存在性检查<a href="https://github.com/milvus-io/milvus/pull/46924">（#46924）</a></li>
<li>修复了高亮参数无法正常工作的错误<a href="https://github.com/milvus-io/milvus/pull/46876">（#46876）</a></li>
<li>配额中心现在会忽略处于恢复状态的委托人<a href="https://github.com/milvus-io/milvus/pull/46858">(#46858</a>)</li>
<li>对齐了 WKT/WKB 转换选项，以确保各操作符的行为一致<a href="https://github.com/milvus-io/milvus/pull/46874">(#46874</a>)</li>
<li>修正了 voyageai 模型 int8 的错误<a href="https://github.com/milvus-io/milvus/pull/46821">(#46821</a>)</li>
<li>修正了恢复存储操作中缺少对<code translate="no">FlushAllMsg</code> 的处理<a href="https://github.com/milvus-io/milvus/pull/46803">(#46803</a>)</li>
<li>修复了 querytask 中缺失的 shardclientmgr 字段，以防止出现恐慌<a href="https://github.com/milvus-io/milvus/pull/46838">（#46838）</a></li>
<li>在调度程序中使用 leaderid 进行 leaderaction 陈旧检查，以提高准确性<a href="https://github.com/milvus-io/milvus/pull/46788">（#46788）</a></li>
<li>恢复了在 2.6 中丢失的对 Pulsar 的租户/命名空间支持<a href="https://github.com/milvus-io/milvus/pull/46759">（＃46759）</a></li>
<li>添加了加载配置监视器以防止加载配置修改丢失<a href="https://github.com/milvus-io/milvus/pull/46786">（#46786）</a></li>
<li>修复了函数编辑界面错误<a href="https://github.com/milvus-io/milvus/pull/46782">（#46782）</a></li>
<li>增加了 Collections TTL 属性验证，以防止压缩卡住<a href="https://github.com/milvus-io/milvus/pull/46736">(#46736</a>)</li>
</ul>
<h2 id="v268" class="common-anchor-header">v2.6.8<button data-href="#v268" class="anchor-icon" translate="no">
    ...
    </button></h2><p>发布日期： 2026 年 1 月 4 日</p>
<table>
<thead>
<tr><th style="text-align:left">Milvus 版本</th><th style="text-align:left">Python SDK 版本</th><th style="text-align:left">Node.js SDK 版本</th><th style="text-align:left">Java SDK 版本</th><th style="text-align:left">Go SDK 版本</th></tr>
</thead>
...
<p>我们很高兴地宣布 Milvus 2.6.8 正式发布！该版本引入了搜索结果高亮功能，极大地增强了检索体验。在引擎盖下，我们优化了查询处理、资源调度和缓存机制，以提供卓越的性能和稳定性。此外，该版本还解决了与数据安全、存储处理和并发性相关的关键错误。我们强烈建议所有用户升级到该版本，以获得更高效、更可靠的生产环境。</p>
<h3 id="Features" class="common-anchor-header">功能特点<button data-href="#Features" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>支持使用荧光笔搜索。有关详细信息，请参阅<a href="/docs/zh/text-highlighter.md">文本高亮显示器</a>。 <a href="https://github.com/milvus-io/milvus/pull/46052">(#46052</a>)</li>
</ul>
<h3 id="Improvements" class="common-anchor-header">改进<button data-href="#Improvements" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<li>将查询优化逻辑移至代理，以提高性能<a href="https://github.com/milvus-io/milvus/pull/46549">(#46549</a>)</li>
<li>使用 STL 排序优化了<code translate="no">LIKE</code> 操作符的性能<a href="https://github.com/milvus-io/milvus/pull/46535">(#46535</a>)</li>
<li>支持并发执行多个字段的文本索引任务<a href="https://github.com/milvus-io/milvus/pull/46306">（#46306）</a></li>
<li>支持在 Collections 级别暂停 GC<a href="https://github.com/milvus-io/milvus/pull/46201">（#46201）</a></li>
<li>为查询节点实施惩罚策略，以处理资源耗尽问题<a href="https://github.com/milvus-io/milvus/pull/46086">（#46086）</a></li>
<li>通过将多个行组映射到单个缓存单元，优化了数据缓存<a href="https://github.com/milvus-io/milvus/pull/46542">（#46542）</a></li>
<li>降低了配额中心的 CPU 占用率<a href="https://github.com/milvus-io/milvus/pull/46615">(#46615</a>)</li>
<li>改进了<code translate="no">TIMESTAMPTZ</code> 数据比较性能<a href="https://github.com/milvus-io/milvus/pull/46655">(#46655</a>)</li>
<li>支持以空 JSON 对象作为默认值的可空动态字段<a href="https://github.com/milvus-io/milvus/pull/46445">(#46445</a>)</li>
<li>仅更改 Collections 属性时，防止了不必要的段密封<a href="https://github.com/milvus-io/milvus/pull/46489">(#46489</a>)</li>
<li>在 RESTful v2 代理中支持 DML 和 DQL 转发<a href="https://github.com/milvus-io/milvus/pull/46021">（＃46021</a>、<a href="https://github.com/milvus-io/milvus/pull/46037">＃46037）</a></li>
<li>在速率限制错误时为对象存储读取添加了重试机制<a href="https://github.com/milvus-io/milvus/pull/46464">(#46464</a>)</li>
<li>增强了代理和 RootCoord 元表的日志记录<a href="https://github.com/milvus-io/milvus/pull/46701">（#46701）</a></li>
<li>为嵌入模型和 Schema 字段类型添加了验证<a href="https://github.com/milvus-io/milvus/pull/46422">（＃46422）</a></li>
<li>引入了延迟删除 Collections 操作符的容差持续时间<a href="https://github.com/milvus-io/milvus/pull/46252">(#46252</a>)</li>
<li>通过根据字段大小和类型估算空闲时间，改进了索引任务调度<a href="https://github.com/milvus-io/milvus/pull/46276">（＃46276</a>、<a href="https://github.com/milvus-io/milvus/pull/45851">＃45851）</a></li>
<li>在访问不支持条件写入的对象存储时，为写入路径添加了后备机制<a href="https://github.com/milvus-io/milvus/pull/46022">（#46022）</a></li>
<li>优化了 IDF 甲骨文同步逻辑<a href="https://github.com/milvus-io/milvus/pull/46079">(#46079</a>)</li>
<li>将 RootCoord 默认端口改为非短暂端口<a href="https://github.com/milvus-io/milvus/pull/46268">（＃46268）</a></li>
<li>添加了监控 Jemalloc 缓存内存的指标<a href="https://github.com/milvus-io/milvus/pull/45973">（#45973）</a></li>
<li>当群集配额发生变化时，提高了磁盘配额指标的准确性<a href="https://github.com/milvus-io/milvus/pull/46304">(#46304</a>)</li>
<li>改进了标量表达式的跟踪可观察性<a href="https://github.com/milvus-io/milvus/pull/45823">（#45823）</a></li>
<li>拒绝 upsert 批次请求中的重复主键<a href="https://github.com/milvus-io/milvus/pull/46035">(#46035</a>)</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">错误修复<button data-href="#Bug-fixes" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<li>修复了 RBAC ETCD 前缀匹配，以防止潜在的数据泄漏<a href="https://github.com/milvus-io/milvus/pull/46708">(#46708</a>)</li>
<li>修正了本地存储模式下不正确的根路径处理<a href="https://github.com/milvus-io/milvus/pull/46693">（#46693）</a></li>
<li>修正了在 JSON 字段中处理<code translate="no">int64</code>/<code translate="no">float</code> 混合类型的问题<a href="https://github.com/milvus-io/milvus/pull/46682">(#46682</a>)</li>
<li>修正了群集升级期间文本日志加载失败的问题<a href="https://github.com/milvus-io/milvus/pull/46698">(#46698</a>)</li>
<li>防止在原始数据清理过程中删除其他字段<a href="https://github.com/milvus-io/milvus/pull/46689">(#46689</a>)</li>
<li>修复了在多个分析器中使用高亮显示时的故障<a href="https://github.com/milvus-io/milvus/pull/46664">(#46664</a>)</li>
<li>确保在操作系统退出时刷新日志<a href="https://github.com/milvus-io/milvus/pull/46609">(#46609</a>)</li>
<li>删除 Collections 时，修复了超出 ETCD RPC 大小限制的错误<a href="https://github.com/milvus-io/milvus/pull/46645">(#46645</a>)</li>
<li>修复了服务器空闲时的复制滞后问题<a href="https://github.com/milvus-io/milvus/pull/46612">(#46612</a>)</li>
<li>修正了<code translate="no">TIMESTAMPTZ</code> 默认值无效的验证问题<a href="https://github.com/milvus-io/milvus/pull/46556">（＃46556）</a></li>
<li>修复了恢复压缩任务以确保正确清理的问题<a href="https://github.com/milvus-io/milvus/pull/46578">(#46578</a>)</li>
<li>统一只读节点处理，避免平衡通道任务卡住<a href="https://github.com/milvus-io/milvus/pull/46513">(#46513</a>)</li>
<li>防止多字段列组中的字段数据丢失<a href="https://github.com/milvus-io/milvus/pull/46425">(#46425</a>)</li>
<li>在重新观看 ETCD 时移除过期的代理客户端<a href="https://github.com/milvus-io/milvus/pull/46490">（＃46490）</a></li>
<li>修正了块迭代器合并顺序<a href="https://github.com/milvus-io/milvus/pull/46462">（#46462）</a></li>
<li>通过禁用自动提交防止创建 Kafka 消费者组<a href="https://github.com/milvus-io/milvus/pull/46509">（#46509）</a></li>
<li>禁止热加载分层存储参数<a href="https://github.com/milvus-io/milvus/pull/46438">（#46438）</a></li>
<li>启用了二进制向量的搜索迭代器<a href="https://github.com/milvus-io/milvus/pull/46334">（#46334）</a></li>
<li>修复了存储初始化中的竞赛条件<a href="https://github.com/milvus-io/milvus/pull/46338">（#46338）</a></li>
<li>修复了高亮查询无法用于非BM25搜索的问题<a href="https://github.com/milvus-io/milvus/pull/46295">（#46295）</a></li>
<li>修复了 JSON 垃圾收集期间的堆栈溢出问题<a href="https://github.com/milvus-io/milvus/pull/46318">（#46318）</a></li>
<li>确保在写入 binlog 时重试<a href="https://github.com/milvus-io/milvus/pull/46310">（#46310）</a></li>
<li>修复了 JSON 字段的索引使用检查<a href="https://github.com/milvus-io/milvus/pull/46281">（#46281）</a></li>
<li>在扩展过程中，当副本缺少节点时，防止目标更新阻塞<a href="https://github.com/milvus-io/milvus/pull/46291">（#46291）</a></li>
<li>限制<code translate="no">char_group</code> 标记化器仅支持单字节分隔符<a href="https://github.com/milvus-io/milvus/pull/46196">（#46196）</a></li>
<li>如果查询路径包含数字，则跳过 JSON 路径索引的使用<a href="https://github.com/milvus-io/milvus/pull/46247">（#46247）</a></li>
<li>当根路径为". "时，修正了 MinIO 中的路径连接错误<a href="https://github.com/milvus-io/milvus/pull/46221">(#46221</a>)</li>
<li>通过纠正复制滞后度量计算，修正了假阳性健康检查<a href="https://github.com/milvus-io/milvus/pull/46122">（#46122）</a></li>
<li>通过<code translate="no">TIMESTAMPTZ</code> 修正了 RESTful v2 解析和 Schema 默认值<a href="https://github.com/milvus-io/milvus/pull/46239">（#46239）</a></li>
<li>修复了使用输出几何字段搜索空结果时的恐慌<a href="https://github.com/milvus-io/milvus/pull/46231">（#46231）</a></li>
<li>添加了字段数据对齐验证，以防止部分更新时出现恐慌<a href="https://github.com/milvus-io/milvus/pull/46180">(#46180</a>)</li>
<li>修复了 RESTful v2 中的数据库丢失问题<a href="https://github.com/milvus-io/milvus/pull/46172">(#46172</a>)</li>
<li>修复了 gRPC 客户端会话中不正确的上下文用法<a href="https://github.com/milvus-io/milvus/pull/46184">(#46184</a>)</li>
<li>修正了升级期间 RESTful v2 中不正确的授权转发问题<a href="https://github.com/milvus-io/milvus/pull/46140">（#46140）</a></li>
<li>修正了错误的结构缩减逻辑<a href="https://github.com/milvus-io/milvus/pull/46151">（#46151）</a></li>
<li>修正了搜索结果为空时荧光笔返回的错误<a href="https://github.com/milvus-io/milvus/pull/46111">(#46111</a>)</li>
<li>修正了为字段加载原始数据的逻辑<a href="https://github.com/milvus-io/milvus/pull/46155">(#46155</a>)</li>
<li>修正了跳过索引中的块后光标移动的问题<a href="https://github.com/milvus-io/milvus/pull/46055">(#46055</a>)</li>
<li>修正了<code translate="no">TIMESTAMPTZ</code> 标量索引输出的循环逻辑<a href="https://github.com/milvus-io/milvus/pull/46110">（#46110）</a></li>
<li>修复了通过 RESTful API 为几何图形字段设置默认值的问题<a href="https://github.com/milvus-io/milvus/pull/46064">（＃46064）</a></li>
<li>如果任何组件在启动时尚未准备就绪，则实现快速失效<a href="https://github.com/milvus-io/milvus/pull/46070">(#46070</a>)</li>
</ul>
<h2 id="v267" class="common-anchor-header">v2.6.7<button data-href="#v267" class="anchor-icon" translate="no">
    ...
    </button></h2><p>发布日期：2025 年 12 月 4 日</p>
<table>
<thead>
<tr><th style="text-align:left">Milvus 版本</th><th style="text-align:left">Python SDK 版本</th><th style="text-align:left">Node.js SDK 版本</th><th style="text-align:left">Java SDK 版本</th><th style="text-align:left">Go SDK 版本</th></tr>
</thead>
...
<p>Milvus 2.6.7 是 2.6.x 系列的重要稳定更新。该版本主要针对分布式故障加固系统，并优化高负载下的资源利用率。该版本在 I/O 处理、内存管理和 Kubernetes 集成方面做了重大改进，我们强烈建议所有生产用户升级到该版本，以确保更高的可靠性和更流畅的大规模操作。</p>
...
<li>添加了<code translate="no">/livez</code> 端点，以支持 Kubernetes 本机有效性探针，从而提高容器协调的稳定性<a href="https://github.com/milvus-io/milvus/pull/45481">（#45481</a>）。</li>
<li>添加了对<code translate="no">TIMESTAMPTZ</code> 字段的<strong>GroupBy</strong>操作符的支持，从而增强了时间序列分析功能<a href="https://github.com/milvus-io/milvus/pull/45763">（#45763）</a></li>
<li>支持<code translate="no">mmap</code> 用于 JSON 切碎的共享键索引，以减少 RAM 占用<a href="https://github.com/milvus-io/milvus/pull/45861">（#45861）</a></li>
</ul>
<h3 id="Improvements" class="common-anchor-header">改进<button data-href="#Improvements" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<li>在代理中支持 DML 请求转发，以提高写入可用性和路由弹性<a href="https://github.com/milvus-io/milvus/pull/45922">（#45922</a>）。</li>
<li>将 etcd 升级至 v3.5.23，以解决共识稳定性和性能回归问题<a href="https://github.com/milvus-io/milvus/pull/45953">（#45953</a>）。</li>
<li>为 Etcd 服务器崩溃添加了稳健的错误处理，以防止级联组件故障<a href="https://github.com/milvus-io/milvus/pull/45633">（#45633</a>）。</li>
<li>通过移除用于简单会话有效性检查的昂贵监视器，减少了 Etcd 负载<a href="https://github.com/milvus-io/milvus/pull/45974">（#45974</a>）。</li>
<li>增强了 WAL 保留策略，以更好地平衡磁盘使用和数据恢复安全<a href="https://github.com/milvus-io/milvus/pull/45784">（#45784</a>）。</li>
<li>支持日志的异步同步写入，防止磁盘 I/O 阻塞影响主执行路径<a href="https://github.com/milvus-io/milvus/pull/45806">（#45806</a>）。</li>
<li>强制高优先级负载任务使用缓冲 I/O，以优化操作系统页面缓存利用率和吞吐量<a href="https://github.com/milvus-io/milvus/pull/45958">（#45958</a>）。</li>
<li>优化了<code translate="no">mmap</code> 策略，以便在单个系统调用中映射组块，从而减少段加载过程中的内核开销<a href="https://github.com/milvus-io/milvus/pull/45893">（#45893</a>）。</li>
<li>提高了 JSON 切碎的内存估算精度，以防止 OOM kills 或利用不足<a href="https://github.com/milvus-io/milvus/pull/45876">（#45876</a>）。</li>
<li>改进了段加载估算，以考虑到驱逐和预热状态<a href="https://github.com/milvus-io/milvus/pull/45891">（#45891</a>）。</li>
<li>在查询操作符中添加了细粒度取消检查，以便更快地终止中止或超时的查询<a href="https://github.com/milvus-io/milvus/pull/45894">（#45894</a>）。</li>
<li>删除了文件资源配置中多余的资源类型检查<a href="https://github.com/milvus-io/milvus/pull/45727">（#45727</a>）。</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">错误修复<button data-href="#Bug-fixes" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<li>将 Go 和 C++ 日志交错成统一流，以便为调试提供正确的时间顺序视图<a href="https://github.com/milvus-io/milvus/pull/46005">（#46005</a>）。</li>
<li>解决了<code translate="no">LastConfirmedMessageID</code> 在高并发写入时可能出现错误的竞赛条件问题<a href="https://github.com/milvus-io/milvus/pull/45874">（#45874</a>）。</li>
<li>修正了从多个搜索结果中汇总<code translate="no">allsearchcount</code> 时的计算错误<a href="https://github.com/milvus-io/milvus/pull/45904">（#45904</a>）。</li>
<li>修正了术语表达式，以正确处理 JSON 数组中的字符串包含逻辑<a href="https://github.com/milvus-io/milvus/pull/45956">（#45956</a>）。</li>
<li>在<code translate="no">JSONContainsExpr</code> 中将<code translate="no">json.doc()</code> 替换为<code translate="no">json.dom_doc()</code> ，以修复解析行为并提高性能<a href="https://github.com/milvus-io/milvus/pull/45786">（#45786</a>）。</li>
<li>修正了待机 MixCoord 组件在关闭序列中出现的恐慌<a href="https://github.com/milvus-io/milvus/pull/45898">(#45898</a>)。</li>
<li>修正了领导者检查器，以确保段分布正确同步到只读节点<a href="https://github.com/milvus-io/milvus/pull/45991">（#45991</a>）。</li>
<li>确保在节点重新观察期间触发<code translate="no">HandleNodeUp</code> ，以保持正确的负载平衡拓扑<a href="https://github.com/milvus-io/milvus/pull/45963">（#45963</a>）。</li>
<li>在本地 WAL 存储不可用的情况下，实现了对远程 WAL 存储的回退<a href="https://github.com/milvus-io/milvus/pull/45754">（#45754</a>）。</li>
<li>添加了<code translate="no">EmptySessionWatcher</code> ，以防止在 IndexNode 绑定模式下运行时出现恐慌<a href="https://github.com/milvus-io/milvus/pull/45912">（#45912</a>）。</li>
<li>确保从协议缓冲区恢复广播任务时的内存状态一致性<a href="https://github.com/milvus-io/milvus/pull/45788">（#45788</a>）。</li>
<li>解决了 SegCore Collections Schema 更新中的线程安全问题<a href="https://github.com/milvus-io/milvus/pull/45618">（#45618</a>）。</li>
<li>对<code translate="no">ListImport</code> 和<code translate="no">GetImportProgress</code> API 执行访问控制（RBAC）检查<a href="https://github.com/milvus-io/milvus/pull/45862">（#45862</a>）。</li>
<li>修正了一个 Bug，即如果输入包含一个空结构列表，BulkImport 将失败<a href="https://github.com/milvus-io/milvus/pull/45692">（#45692</a>）。</li>
</ul>
...
<li>提升排名器：Boost Ranker 不再仅仅依赖基于向量距离计算的语义相似性，而是允许 Milvus 在函数中使用可选的过滤条件来查找搜索结果候选项中的匹配项，并通过应用指定的权重来提高这些匹配项的得分，从而帮助提升或降低匹配实体在最终结果中的排名。</li>
...
<li>使流节点在初始化失败时退出<a href="https://github.com/milvus-io/milvus/pull/45732">（#45732）</a></li>
...
<li>支持 AISAQ 索引--全存储索引<a href="https://github.com/zilliztech/knowhere/pull/1282">(#1282</a>)</li>
</ul>
<h3 id="Improvements" class="common-anchor-header">改进<button data-href="#Improvements" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
...
<li>为删除/upsert/restful 添加存储使用<a href="https://github.com/milvus-io/milvus/pull/44512">（#44512）</a></li>
...
<li>[StorageV2] 增加了对基于 Schema 和基于大小的拆分策略的支持<a href="https://github.com/milvus-io/milvus/pull/44282">(#44282</a>)</li>
...
<h4 id="Add-Field-for-Online-Schema-Evolution" class="common-anchor-header">为在线 Schema 演进添加字段</h4><p>为了提供更大的模式灵活性，Milvus 2.6 现在支持向现有 Collections 的模式在线添加新的标量字段。这就避免了在应用需求发生变化时创建新的 Collections 和执行破坏性数据迁移的需要。</p>
