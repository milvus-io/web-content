...
<h3 id="Prepare-the-LLM-and-Embedding-Model" class="common-anchor-header">准备 LLM 和嵌入模型<button data-href="#Prepare-the-LLM-and-Embedding-Model" class="anchor-icon" translate="no">
    ...
    </button></h3><p>我们使用<code translate="no">gemini-2.0-flash</code> 作为 LLM，使用<code translate="no">text-embedding-004</code> 作为 Embeddings 模型。</p>
<p>让我们尝试从 LLM 生成一个测试响应：</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>为 Lanage 模型定义系统和用户提示。该提示与从 Milvus 检索到的文件组装在一起。</p>
...
<p>好极了！我们利用 Milvus 和 Gemini 成功构建了一个 RAG 管道。</p>
