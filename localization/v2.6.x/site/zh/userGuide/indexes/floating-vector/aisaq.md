...
<table>
   ...
   <tr>
     ...
     <td><p>高值可以从更近的入口点开始搜索，从而缩短搜索时间。</p><p>对于大的数据段，请设置较高的值（例如，对于 10M 及以上的向量，请使用 1000 的值）。</p></td>
   </tr>
   <tr>
...
<table>
   ...
   <tr>
     ...
     <td><p>在搜索操作过程中，该参数决定算法在遍历图时所维护的候选池的大小。数值越大，找到真正近邻的几率越大（召回率更高），但也会增加搜索延迟。</p></td>
