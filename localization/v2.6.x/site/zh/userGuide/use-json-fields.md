...
<h3 id="Basic-Operators-in-JSON-Fields" class="common-anchor-header">JSON 字段中的基本操作符<button data-href="#Basic-Operators-in-JSON-Fields" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Advanced-Operators" class="common-anchor-header">高级操作符<button data-href="#Advanced-Operators" class="anchor-icon" translate="no">
    ...
    </button></h3><p>以下操作符专门针对 JSON 字段：</p>
<ul>
