...
<li><p><strong>生成嵌入向量</strong>：Milvus 中的函数模块会自动调用已配置的模型提供商，将原始数据转换为向量嵌入。</p></li>
...
<table>
   ...
   <tr>
     ...
     <td><p>包含待嵌入原始数据的标量字段。目前，此参数仅接受一个字段名称。</p></td>
   ...
   <tr>
     ...
     <td><p>包含嵌入配置的字典。注意：<code translate="no">params</code> 中的参数会因嵌入模型提供程序的不同而有所差异。</p></td>
...
<h2 id="FAQ" class="common-anchor-header">常见问题<button data-href="#FAQ" class="anchor-icon" translate="no">
    ...
    </button></h3><p>两种方法均可使用，但建议采用<code translate="no">milvus.yaml</code> ，因为它提供了集中化的凭证管理，并在所有服务提供商中保持凭证命名的统一性。使用环境变量时，变量名称会因嵌入服务提供商而异，因此请参考各提供商的专用页面以了解所需的具体环境变量名称（例如，<a href="/docs/zh/v2.6.x/openai.md">OpenAI</a>或<a href="/docs/zh/v2.6.x/azure-openai.md">Azure OpenAI</a>）。</p>
