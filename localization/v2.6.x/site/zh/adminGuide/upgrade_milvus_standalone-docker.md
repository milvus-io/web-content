...
---
<div class="tab-wrapper"><a href="/docs/zh/v2.6.x/upgrade_milvus_standalone-operator.md" class=''>Milvus</a><a href="/docs/zh/v2.6.x/upgrade_milvus_standalone-docker.md" class='active '>Operator</a>、Helm、Docker<a href="/docs/zh/v2.6.x/upgrade_milvus_standalone-docker.md" class='active '>Compose</a></div>
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">使用 Docker Compose 升级 Milvus Standalone<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本指南介绍了如何使用 Docker Compose 将您的 Milvus Standalone 部署从 v2.5.x 升级到 v2.6.23。</p>
<h2 id="Before-you-start" class="common-anchor-header">开始之前<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v2623" class="common-anchor-header">v2.6.23 版本的新功能<button data-href="#Whats-new-in-v2623" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>从 Milvus 2.5.x 升级至 2.6.23 涉及重大的架构变更：</p>
<ul>
<li><strong>协调器整合</strong>：旧版中独立的协调器（<code translate="no">dataCoord</code> 、<code translate="no">queryCoord</code> 、<code translate="no">indexCoord</code> ）已整合为单一的<code translate="no">mixCoord</code></li>
...
<li>通过 Docker Compose 部署的 Milvus Standalone 实例</li>
</ul>
<p><strong>兼容性要求：</strong></p>
<ul>
<li>Milvus v2.6.0-rc1 与 v2.6.23<strong>不兼容</strong>。不支持直接从候选版本（release candidates）进行升级。</li>
...
<li>在升级至 v2.6.23 之前，您<strong>必须先</strong>升级至 v2.5.16 或更高版本。</li>
</ul>
<p><strong>消息队列限制</strong>：在升级至 Milvus v2.6.23 时，您必须保留当前的消息队列选择。升级过程中不支持在不同的消息队列系统之间切换。未来版本将支持更改消息队列系统。</p>
<div class="alter note">
<p>出于安全考虑，Milvus 将在 v2.6.23 版本发布时将其 MinIO 升级至 RELEASE.2024-12-18T13-15-44Z。</p>
</div>
<h2 id="Upgrade-process" class="common-anchor-header">升级流程<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Upgrade-to-v2516" class="common-anchor-header">步骤 1：升级至 v2.5.16<button data-href="#Step-1-Upgrade-to-v2516" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>如果您的独立部署环境已运行 v2.5.16 或更高版本，请跳过此步骤。</p>
</div>
<ol>
<li><p>编辑现有的<code translate="no">docker-compose.yaml</code> 文件，并将Milvus镜像标签更新为v2.5.16：</p>
...
<h3 id="Step-2-Upgrade-to-v2623" class="common-anchor-header">步骤 2：升级至 v2.6.23<button data-href="#Step-2-Upgrade-to-v2623" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>当 v2.5.16 运行成功后，请升级至 v2.6.23：</p>
<ol>
<li><p>编辑现有的<code translate="no">docker-compose.yaml</code> 文件，并将 Milvus 和 MinIO 的镜像标签均更新为相应版本：</p>
<pre><code translate="no" class="language-yaml"><span class="hljs-string">...</span>
