...
<ul>
<li><strong>请求</strong>属性指定了资源组必须满足的条件。</li>
...
<p>本页面上的所有代码示例都在 PyMilvus 2.6.15 中。运行这些示例之前，请升级您的 PyMilvus 安装。</p>
</div>
<ol>
<li><p>创建资源组。</p>
...
<li><p>在资源组之间传输副本。</p>
<p>Milvus 使用<a href="/docs/zh/v2.6.x/replica.md">副本</a>来实现分布在多个查询节点上的<a href="/docs/zh/v2.6.x/glossary.md#Segment">网段</a>之间的负载平衡。您可以按以下方式将某个 Collection 的某些副本从一个资源组转移到另一个资源组：</p>
<pre><code translate="no" class="language-python">source = <span class="hljs-string">&#x27;__default_resource_group&#x27;</span>
target = <span class="hljs-string">&#x27;rg&#x27;</span>
