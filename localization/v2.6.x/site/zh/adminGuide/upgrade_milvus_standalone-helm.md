...
<p>确保 Milvus 实例中的所有部署都处于正常状态后。你可以运行以下命令将 Milvus 实例升级到 2.4.23。</p>
...
<h4 id="2-Upgrade-Milvus-from-v21x-to-2423" class="common-anchor-header">2.将 Milvus 从 2.1.x 版升级到 2.4.23 版</h4><p>以下命令假定你将 Milvus 从 v2.1.4 升级到 2.4.23。请将它们更改为适合你需要的版本。</p>
<ol>
