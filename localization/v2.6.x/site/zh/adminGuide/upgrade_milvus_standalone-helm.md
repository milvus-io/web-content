...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">使用 Helm 图表升级 Milvus Standalone<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本指南介绍了如何使用 Helm 图将您的 Milvus Standalone 部署从 v2.5.x 升级到 v2.6.24。</p>
...
<li><strong>新组件</strong>：引入流式处理节点以增强数据处理能力</li>
...
<div class="alert note">
位于<code translate="no">https://milvus-io.github.io/milvus-helm/</code> 的 Milvus Helm 图库已存档。请使用新图库<code translate="no">https://zilliztech.github.io/milvus-helm/</code> 获取 4.0.31 及更高版本的图。
</div>
...
<h3 id="Step-3-Upgrade-to-v2624" class="common-anchor-header">步骤 3：升级至 v2.6.24<button data-href="#Step-3-Upgrade-to-v2624" class="anchor-icon" translate="no">
    ...
    </button></h3><p>当 v2.5.16 成功运行后，请升级至 v2.6.24：</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
