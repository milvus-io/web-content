...
<p>通常情况下，您<a href="#Upgrade-Milvus-by-changing-its-image">可以通过更换镜像来升级 Milvus</a>。但在从 v2.1.x 升级至 v2.6.19 之前，您需要<a href="#Migrate-the-metadata">先迁移元数据</a>。</p>
<div class="alert note">
<p><strong>消息队列限制</strong>：升级至 Milvus v2.6.19 时，必须保留当前的消息队列选择。升级过程中不支持在不同的消息队列系统之间切换。未来版本将支持更改消息队列系统。</p>
</div>
