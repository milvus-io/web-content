...
<h3 id="Field-schema-properties" class="common-anchor-header">字段模式属性<button data-href="#Field-schema-properties" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Create-a-field-schema" class="common-anchor-header">创建字段 Schema<button data-href="#Create-a-field-schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>为了降低数据插入时的复杂性，Milvus 允许你在创建字段模式时为每个标量字段指定一个默认值，主键字段除外。这表明，如果在插入数据时某个字段为空，则您为该字段指定的默认值将适用。</p>
<p>创建常规字段模式 Schema：</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Supported-data-types" class="common-anchor-header">支持的数据类型<button data-href="#Supported-data-types" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><code translate="no">DataType</code> 定义字段包含的数据类型。不同的字段支持不同的数据类型。</p>
<ul>
<li><p>主键字段支持</p>
<ul>
...
<h3 id="Collection-schema-properties" class="common-anchor-header">集合模式属性<button data-href="#Collection-schema-properties" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Create-a-collection-schema" class="common-anchor-header">创建 Collections 模式<button data-href="#Create-a-collection-schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
