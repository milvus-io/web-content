...
---
<div class="tab-wrapper"><a href="/docs/it/install_standalone-docker.md" class='active '>Docker</a><a href="/docs/it/install_standalone-operator.md" class=''>Milvus Operator</a><a href="/docs/it/install_standalone-helm.md" class=''>Helm</a><a href="/docs/it/install_standalone-aptyum.md" class=''>DEB/RPM</a><a href="/docs/it/install_standalone-docker-compose.md" class=''>Docker Compose</a></div>
...
<li><p><a href="/docs/it/prerequisite-helm.md">Check the requirements for hardware and software</a> prior to your installation.</p></li>
</ul>
...
<li><p>Check <a href="/docs/it/index.md">In-memory Index</a> for more about CPU-compatible index types.</p></li>
