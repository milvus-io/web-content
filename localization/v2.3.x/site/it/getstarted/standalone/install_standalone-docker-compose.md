...
---
<div class="tab-wrapper"><a href="/docs/it/install_standalone-docker.md" class=''>Docker</a><a href="/docs/it/install_standalone-operator.md" class=''>Milvus Operator</a><a href="/docs/it/install_standalone-helm.md" class=''>Helm</a><a href="/docs/it/install_standalone-aptyum.md" class=''>DEB/RPM</a><a href="/docs/it/install_standalone-docker-compose.md" class='active '>Docker Compose</a></div>
...
<li><p>Check <a href="/docs/it/prerequisite-docker.md">the requirements</a> for hardware and software requirements before installing Milvus.</p>
<ul>
...
<li>Check <a href="/docs/it/index.md">In-memory Index</a> for more about CPU-compatible index types.</li>
