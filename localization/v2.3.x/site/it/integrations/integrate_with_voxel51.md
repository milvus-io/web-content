...
<ul>
<li>A running <a href="/docs/it/install_standalone-docker.md">Milvus server</a>.</li>
...
<p>For detailed information on these parameters, see the <a href="/docs/it/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/it/consistency.md">Milvus consistency levels documentation</a>.</p>
