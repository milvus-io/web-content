...
---
<div class="tab-wrapper"><a href="/docs/v2.3.x/install_cluster-milvusoperator.md" class='active '>Milvus Operator</a><a href="/docs/v2.3.x/install_cluster-helm.md" class=''>Helm</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>When the Milvus cluster is installed, you can learn how to <a href="/docs/v2.3.x/manage_connection.md">Connect to Milvus server</a>.</p>
...
<li><a href="/docs/v2.3.x/upgrade_milvus_cluster-operator.md">Upgrade Milvus Using Milvus Operator</a></li>
<li><a href="/docs/v2.3.x/scaleout.md">Scale your Milvus cluster</a></li>
