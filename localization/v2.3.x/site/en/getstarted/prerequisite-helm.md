...
<ul>
<li><a href="/docs/v2.3.x/install_standalone-helm.md">Install Milvus standalone on Kubernetes</a></li>
<li><a href="/docs/v2.3.x/install_cluster-helm.md">Install Milvus cluster on Kubernetes</a></li>
</ul></li>
