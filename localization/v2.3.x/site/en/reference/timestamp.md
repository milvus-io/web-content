...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/Guarantee_Timestamp.png" alt="Guarantee_Timestamp" class="doc-image" id="guarantee_timestamp" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/Service_Timestamp.png" alt="Service_Timestamp" class="doc-image" id="service_timestamp" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/Graceful_Time.png" alt="Graceful_Time" class="doc-image" id="graceful_time" />
...
<li>Learn how <a href="/docs/v2.3.x/consistency.md">guarantee timestamp enables tunable consistency in Milvus</a></li>
</ul>
