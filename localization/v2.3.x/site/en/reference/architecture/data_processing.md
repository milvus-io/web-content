...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/channels_1.jpg" alt="Channels 1" class="doc-image" id="channels-1" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/channels_2.jpg" alt="Channels 2" class="doc-image" id="channels-2" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/write_log_sequence.jpg" alt="Write log sequence" class="doc-image" id="write-log-sequence" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/index_building.jpg" alt="Index building" class="doc-image" id="index-building" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/data_query.jpg" alt="Data query" class="doc-image" id="data-query" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/handoff.jpg" alt="Handoff" class="doc-image" id="handoff" />
    <span>Handoff</span>
  </span>
</p>
