...
<div class="start_card_container">
  <a href="/docs/v2.3.x/install_standalone-docker.md">
...
<div class="start_card_container">
  <a href="/docs/v2.3.x/example_code.md">
...
<li><a href="/docs/v2.3.x/build_index.md">Build an Index</a></li>
<li><a href="/docs/v2.3.x/search.md">Search</a></li>
<li><a href="/docs/v2.3.x/query.md">Query</a></li>
</ul>
</div>
<div class="recomment-item">
  <p>Deploy</p>
<ul>
<li><a href="/docs/v2.3.x/configure-docker.md">Configure Milvus</a></li>
<li><a href="/docs/v2.3.x/deploy_s3.md">Manage Dependencies</a></li>
<li><a href="/docs/v2.3.x/aws.md">Deploy on Clouds</a></li>
<li><a href="/docs/v2.3.x/scaleout.md">Scale a Milvus Cluster</a></li>
<li><a href="/docs/v2.3.x/monitor_overview.md">Monitor and Alert</a></li>
</ul>
</div>
<div class="recomment-item">
  <p>Learn</p>
<ul>
<li><a href="/docs/v2.3.x/system_configuration.md">System Configuration</a></li>
<li><a href="/docs/v2.3.x/architecture_overview.md">Architecture Overview</a></li>
<li><a href="/docs/v2.3.x/index.md">Vector Index</a></li>
<li><a href="/docs/v2.3.x/metric.md">Similarity Metrics</a></li>
<li><a href="/docs/v2.3.x/glossary.md">Glossary</a></li>
</ul>
</div>
</div>
...
<ul>
<li>Added guidance on how to <a href="/docs/v2.3.x/bulk_insert.md">bulk insert entities from files</a>.</li>
<li>Added description of <a href="/docs/v2.3.x/disk_index.md">disk-based ANN index</a>.</li>
<li>Added guidance on how to configure <a href="/docs/v2.3.x/configure_quota_limits.md">quotas_and_limits</a>.</li>
<li>Added guidance on how to <a href="/docs/v2.3.x/rbac.md">enable RBAC</a> with Milvus Operator.</li>
<li>Added guidance on how to <a href="/docs/v2.3.x/upgrade_milvus_cluster-helm.md">migrate metadata</a> from 2.1.x to 2.2.0</li>
</ul>
</div>
