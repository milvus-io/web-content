...
<ul>
<li>Release a loaded collection.</li>
<li>Release a specific partition from a loaded collection.</li>
<li>Release a loaded partition.</li>
<li>Release a collection that has part of partitions loaded.</li>
</ul>
