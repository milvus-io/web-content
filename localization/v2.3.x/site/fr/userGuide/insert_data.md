...
<p>You can also migrate data to Milvus with <a href="/docs/fr/migrate_overview.md">MilvusDM</a>, an open-source tool designed specifically for importing and exporting data with Milvus.</p>
...
<p>Milvus supports default values for scalar fields, excluding a primary key field. This indicates that some fields can be left empty during data inserts or upserts. For more information, refer to <a href="/docs/fr/create_collection.md#prepare-schema">Create a Collection</a>.</p>
<p>Once you enable dynamic schema, you can append dynamic fields in the data. For details, refer to <a href="/docs/fr/dynamic_schema.md">Dynamic Schema</a>.</p>
