...
<ul>
<li>A running <a href="/docs/fr/install_standalone-docker.md">Milvus server</a>.</li>
...
<p>For detailed information on these parameters, see the <a href="/docs/fr/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/fr/consistency.md">Milvus consistency levels documentation</a>.</p>
