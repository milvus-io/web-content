...
---
<div class="tab-wrapper"><a href="/docs/fr/install_cluster-milvusoperator.md" class=''>Milvus Operator</a><a href="/docs/fr/install_cluster-helm.md" class='active '>Helm</a></div>
...
<h2 id="Prerequisites" class="common-anchor-header">Prerequisites<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Check <a href="/docs/fr/prerequisite-helm.md">the requirements</a> for hardware and software prior to your installation.</p>
