...
<ul>
<li><a href="/docs/de/deploy_s3.md">Configure object storage with Docker Compose/Helm</a></li>
...
<ul>
<li><a href="/docs/de/deploy_etcd.md">Configure meta storage with Docker Compose/Helm</a></li>
...
<ul>
<li><a href="/docs/de/deploy_pulsar.md">Configure message storage with Docker Compose/Helm</a></li>
