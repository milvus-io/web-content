...
---
<div class="tab-wrapper"><a href="/docs/de/install_standalone-docker.md" class=''>Docker</a><a href="/docs/de/install_standalone-operator.md" class=''>Milvus Operator</a><a href="/docs/de/install_standalone-helm.md" class=''>Helm</a><a href="/docs/de/install_standalone-aptyum.md" class=''>DEB/RPM</a><a href="/docs/de/install_standalone-docker-compose.md" class='active '>Docker Compose</a></div>
...
<li><p>Check <a href="/docs/de/prerequisite-docker.md">the requirements</a> for hardware and software requirements before installing Milvus.</p>
<ul>
...
<li>Check <a href="/docs/de/index.md">In-memory Index</a> for more about CPU-compatible index types.</li>
...
<li>Explore <a href="/docs/de/milvus_backup_overview.md">Milvus Backup</a>, an open-source tool for Milvus data backups.</li>
<li>Explore <a href="/docs/de/birdwatcher_overview.md">Birdwatcher</a>, an open-source tool for debugging Milvus and dynamic configuration updates.</li>
