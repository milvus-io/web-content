...
<ul>
<li>A running <a href="/docs/de/install_standalone-docker.md">Milvus server</a>.</li>
...
<p>For detailed information on these parameters, see the <a href="/docs/de/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/de/consistency.md">Milvus consistency levels documentation</a>.</p>
