...
---
<h1 id="Root-Coordinator-related-Configurations" class="common-anchor-header">Root Coordinator-related Configurations<button data-href="#Root-Coordinator-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>This topic introduces the root coordinator-related configurations of Milvus.</p>
<p>Root coordinator (root coord) handles data definition language (DDL) and data control language (DCL) requests, manages TSO (timestamp Oracle), and publishes time tick messages.</p>
<p>Under this section, you can configure root coord address, index building threshold, etc.</p>
<h2 id="rootCoordaddress" class="common-anchor-header"><code translate="no">rootCoord.address</code><button data-href="#rootCoordaddress" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><table id="rootCoord.address">
  <thead>
    <tr>
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>Root coordinator monitors all IPv4 addresses if this parameter is set as <code translate="no">0.0.0.0</code>.</li>
      </td>
      <td>localhost</td>
    </tr>
  </tbody>
...
<h2 id="rootCoordactiveStandbyenabled" class="common-anchor-header"><code translate="no">rootCoord.activeStandby.enabled</code><button data-href="#rootCoordactiveStandbyenabled" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="rootCoordreplicas" class="common-anchor-header"><code translate="no">rootCoord.replicas</code><button data-href="#rootCoordreplicas" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>New partitions cannot be created if this parameter is set as <code translate="no">0</code> or <code translate="no">1</code>.</li>
...
<h2 id="rootCoordimportTaskExpiration" class="common-anchor-header"><code translate="no">rootCoord.importTaskExpiration</code><button data-href="#rootCoordimportTaskExpiration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><table id="rootCoord.importTaskExpiration">
  <thead>
    <tr>
      <th class="width80">Description</th>
      <th class="width20">Default Value</th> 
  ...
  <tbody>
    <tr>
      <td>
        <li>A file import task expires after <code translate="no">importTaskExpiration</code> seconds.</li>
        <li>Unit: second</li>
        <li>You should also change the value of the parameter in the <code translate="no">internal/util/paramtable/component_param.go</code> file.</li>
      </td>
      <td>900</td>
    </tr>
  </tbody>
</table>
<h2 id="rootCoordimportTaskRetention" class="common-anchor-header"><code translate="no">rootCoord.importTaskRetention</code><button data-href="#rootCoordimportTaskRetention" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><table id="rootCoord.importTaskRetention">
  <thead>
    <tr>
      <th class="width80">Description</th>
      <th class="width20">Default Value</th> 
  ...
  <tbody>
    <tr>
      <td>
        <li>Milvus keeps the record of import tasks for at least <code translate="no">importTaskRetention</code> seconds.</li>
        <li>You should also change the value of the parameter in the <code translate="no">internal/util/paramtable/component_param.go</code> file.</li>
      </td>
      <td>86400</td>
    </tr>
