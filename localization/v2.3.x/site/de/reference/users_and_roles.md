...
<p>The following table lists the values you can choose when <a href="/docs/de/rbac.md">enabling RBAC</a>.</p>
<table>
<thead>
...
<li>Learn how to <a href="/docs/de/rbac.md">enable RBAC</a>.</li>
</ul>
