...
<ul>
<li>Learn how to conduct a  <a href="/docs/de/hybridsearch.md">Hybrid Search</a>.</li>
...
<li>Learn how to <a href="/docs/de/dynamic_schema.md">use dynamic fields in building boolean expressions</a>.</li>
</ul>
