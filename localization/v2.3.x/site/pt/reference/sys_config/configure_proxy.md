...
<h2 id="proxyaccessLogbaseformat" class="common-anchor-header"><code translate="no">proxy.accessLog.base.format</code><button data-href="#proxyaccessLogbaseformat" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>The log format with dynamic metrics. This format applies to all methods by default. For more information about metrics, see <a href="/docs/pt/configure_access_logs.md">Configure Access Logs</a>.</td>
      <td>Empty string</td>
    </tr>
  </tbody>
</table>
