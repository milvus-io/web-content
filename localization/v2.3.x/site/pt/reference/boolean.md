...
<ul>
<li>Learn how to conduct a  <a href="/docs/pt/hybridsearch.md">Hybrid Search</a>.</li>
...
<li>Learn how to <a href="/docs/pt/dynamic_schema.md">use dynamic fields in building boolean expressions</a>.</li>
</ul>
