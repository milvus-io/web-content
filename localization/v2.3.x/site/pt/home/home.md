...
<div class="start_card_container">
  <a href="/docs/pt/example_code.md">
...
<li><a href="/docs/pt/build_index.md">Build an Index</a></li>
<li><a href="/docs/pt/search.md">Search</a></li>
<li><a href="/docs/pt/query.md">Query</a></li>
</ul>
</div>
<div class="recomment-item">
  <p>Deploy</p>
...
<li><a href="/docs/pt/aws.md">Deploy on Clouds</a></li>
...
<ul>
<li>Added guidance on how to <a href="/docs/pt/bulk_insert.md">bulk insert entities from files</a>.</li>
<li>Added description of <a href="/docs/pt/disk_index.md">disk-based ANN index</a>.</li>
<li>Added guidance on how to configure <a href="/docs/pt/configure_quota_limits.md">quotas_and_limits</a>.</li>
<li>Added guidance on how to <a href="/docs/pt/rbac.md">enable RBAC</a> with Milvus Operator.</li>
<li>Added guidance on how to <a href="/docs/pt/upgrade_milvus_cluster-helm.md">migrate metadata</a> from 2.1.x to 2.2.0</li>
</ul>
</div>
