...
---
<div class="tab-wrapper"><a href="/docs/pt/install_standalone-helm-gpu.md" class=''>Standalone (Helm)</a><a href="/docs/pt/install_standalone-docker-compose-gpu.md" class='active '>Standalone (Docker Compose)</a><a href="/docs/pt/install_cluster-helm-gpu.md" class=''>Cluster (Helm)</a></div>
...
<li><p>Check <a href="/docs/pt/prerequisite-docker.md">the requirements</a> for hardware and software requirements before installing Milvus.</p>
<ul>
...
<li>Check <a href="/docs/pt/index.md">In-memory Index</a> for more about CPU-compatible index types.</li>
