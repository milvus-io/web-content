...
---
<div class="tab-wrapper"><a href="/docs/pt/install_standalone-docker.md" class=''>Docker</a><a href="/docs/pt/install_standalone-operator.md" class='active '>Milvus Operator</a><a href="/docs/pt/install_standalone-helm.md" class=''>Helm</a><a href="/docs/pt/install_standalone-aptyum.md" class=''>DEB/RPM</a><a href="/docs/pt/install_standalone-docker-compose.md" class=''>Docker Compose</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>When the Milvus is successfully installed, you can learn how to <a href="/docs/pt/manage_connection.md">Connect to Milvus server</a>.</p>
...
<li><a href="/docs/pt/upgrade_milvus_standalone-operator.md">Upgrade Milvus Using Milvus Operator</a></li>
<li>Explore <a href="/docs/pt/milvus_backup_overview.md">Milvus Backup</a>, an open-source tool for Milvus data backups.</li>
<li>Explore <a href="/docs/pt/birdwatcher_overview.md">Birdwatcher</a>, an open-source tool for debugging Milvus and dynamic configuration updates.</li>
