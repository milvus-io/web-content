...
<ul>
<li>Learn <a href="/docs/pt/monitor.md">Monitor Milvus with Prometheus Operator on Kubernetes</a></li>
<li>Learn <a href="/docs/pt/visualize.md">Visualize Milvus Metrics in Grafana</a>.</li>
</ul></li>
