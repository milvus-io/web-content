...
<ul>
<li><a href="/docs/pt/visualize.md">Visualize Milvus metrics in Grafana</a></li>
<li><a href="/docs/pt/alert.md">Create an Alert for Milvus Services</a></li>
...
<ul>
<li>Read the <a href="/docs/pt/upgrade_milvus_cluster-operator.md">guide for upgrading Milvus cluster</a> and <a href="/docs/pt/upgrade_milvus_standalone-operator.md">that for upgrade Milvus standalone</a>.</li>
</ul></li>
</ul>
