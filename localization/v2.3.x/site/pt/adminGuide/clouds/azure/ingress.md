...
<h3 id="Configure-ingress-nginx" class="common-anchor-header">Configure ingress nginx</h3><ul>
<li>Set env.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Install-cert-manager" class="common-anchor-header">Install cert-manager</h3><pre><code translate="no" class="language-bash">helm repo add jetstack https://charts.jetstack.io
helm repo update
helm install cert-manager jetstack/cert-manager \
    --namespace <span class="hljs-variable">$NAMESPACE</span> \
    --<span class="hljs-built_in">set</span> installCRDs=<span class="hljs-literal">true</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Create-a-CA-cluster-issuer" class="common-anchor-header">Create a CA cluster issuer</h3><ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Deploy-Milvus" class="common-anchor-header">Deploy Milvus</h3><p>refer to <a href="https://milvus.io/docs/azure.md">Azure</a>, notice the config <code translate="no">service.type</code> value, you need change to <code translate="no">ClusterIP</code>.</p>
<h3 id="Create-Milvus-ingress-route" class="common-anchor-header">Create Milvus ingress route</h3><pre><code translate="no" class="language-bash">kubectl apply -f ingress.yaml
<button class="copy-code-btn"></button></code></pre>
            ...
            backend:
              service:
                ...
                port:
                  number: 19530
<button class="copy-code-btn"></button></code></pre>
<h3 id="Verify" class="common-anchor-header">Verify</h3><pre><code translate="no" class="language-bash">kubectl <span class="hljs-keyword">get</span> certificate 
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Hello-Milvus" class="common-anchor-header">Hello Milvus</h3><p>Please refer to <a href="https://milvus.io/docs/example_code.md">Hello Milvus</a>, change uri args, then run the code.</p>
