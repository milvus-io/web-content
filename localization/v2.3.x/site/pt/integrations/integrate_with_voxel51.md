...
<ul>
<li>A running <a href="/docs/pt/install_standalone-docker.md">Milvus server</a>.</li>
...
<p>For detailed information on these parameters, see the <a href="/docs/pt/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/pt/consistency.md">Milvus consistency levels documentation</a>.</p>
