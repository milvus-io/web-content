...
<li><p>Check <a href="/docs/ja/prerequisite-docker.md">the requirements</a> for hardware and software requirements before installing Milvus.</p>
<ul>
...
<li>Check <a href="/docs/ja/index.md">In-memory Index</a> for more about CPU-compatible index types.</li>
