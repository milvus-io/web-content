...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/TSO_Timestamp.png" alt="TSO_Timestamp" class="doc-image" id="tso_timestamp" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/timesync_proxy_insert_msg.png" alt="timesync_proxy_insert_msg" class="doc-image" id="timesync_proxy_insert_msg" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/msgstream.png" alt="msgstream" class="doc-image" id="msgstream" />
    <span>msgstream</span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/time_synchronization.png" alt="time_synchronization" class="doc-image" id="time_synchronization" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.3.x/assets/timetick.png" alt="timetick" class="doc-image" id="timetick" />
    <span>timetick</span>
  </span>
</p>
...
<li>Learn about the concept of <a href="/docs/ja/timestamp.md">timestamp</a>.</li>
<li>Learn about the <a href="/docs/ja/data_processing.md">data processing workflow</a> in Milvus.</li>
</ul>
