...
<p>For other possible options for <code translate="no">metric_type</code> and <code translate="no">index_type</code>, please refer to <a href="/docs/ja/metric.md">Similarity Metrics</a>, <a href="/docs/ja/index.md">In-memory Index</a> and <a href="/docs/ja/disk_index.md">On-disk Index</a>.</p>
...
<p>To learn more about multi-tenancy strategies, read <a href="/docs/ja/multi_tenancy.md">Multi-tenancy</a> for details.</p>
