...
---
<h1 id="NATS-related-Configurations" class="common-anchor-header">NATS-related Configurations<button data-href="#NATS-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="natsmqserverport" class="common-anchor-header"><code translate="no">natsmq.server.port</code><button data-href="#natsmqserverport" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      ...
      <td><code translate="no">4222</code></td>
    </tr>
  </tbody>
</table>
<h2 id="natsmqserverstoreDir" class="common-anchor-header"><code translate="no">natsmq.server.storeDir</code><button data-href="#natsmqserverstoreDir" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      ...
      <td><code translate="no">/var/lib/milvus/nats</code></td>
    </tr>
  </tbody>
</table>
<h2 id="natsmqservermaxFileStore" class="common-anchor-header"><code translate="no">natsmq.server.maxFileStore</code><button data-href="#natsmqservermaxFileStore" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      ...
      <td><code translate="no">17179869184</code> (16 GB)</td>
    </tr>
  </tbody>
</table>
<h2 id="natsmqservermaxPayload" class="common-anchor-header"><code translate="no">natsmq.server.maxPayload</code><button data-href="#natsmqservermaxPayload" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      ...
      <td><code translate="no">8388608</code> (8 MB)</td>
    </tr>
  </tbody>
</table>
<h2 id="natsmqservermaxPending" class="common-anchor-header"><code translate="no">natsmq.server.maxPending</code><button data-href="#natsmqservermaxPending" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      ...
      <td><code translate="no">67108864</code> (64 MB)</td>
    </tr>
  </tbody>
</table>
<h2 id="natsmqserverinitializeTimeout" class="common-anchor-header"><code translate="no">natsmq.server.initializeTimeout</code><button data-href="#natsmqserverinitializeTimeout" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      ...
      <td><code translate="no">4000</code> (4 seconds)</td>
    </tr>
  </tbody>
</table>
<h2 id="natsmqmonitordebug" class="common-anchor-header"><code translate="no">natsmq.monitor.debug</code><button data-href="#natsmqmonitordebug" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="natsmqmonitorlogTime" class="common-anchor-header"><code translate="no">natsmq.monitor.logTime</code><button data-href="#natsmqmonitorlogTime" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="natsmqmonitorlogFile" class="common-anchor-header"><code translate="no">natsmq.monitor.logFile</code><button data-href="#natsmqmonitorlogFile" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="natsmqmonitorlogSizeLimit" class="common-anchor-header"><code translate="no">natsmq.monitor.logSizeLimit</code><button data-href="#natsmqmonitorlogSizeLimit" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>If it is set to <code translate="no">0</code>, no limit applies.</li>
      </td>
      <td><code translate="no">0</code></td>
    </tr>
  </tbody>
</table>
<h2 id="natsmqrententionmaxAge" class="common-anchor-header"><code translate="no">natsmq.rentention.maxAge</code><button data-href="#natsmqrententionmaxAge" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      ...
      <td><code translate="no">4320</code> (3 days)</td>
    </tr>
  </tbody>
</table>
<h2 id="natsmqrententionmaxBytes" class="common-anchor-header"><code translate="no">natsmq.rentention.maxBytes</code><button data-href="#natsmqrententionmaxBytes" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="natsmqrententionmaxMsgs" class="common-anchor-header"><code translate="no">natsmq.rentention.maxMsgs</code><button data-href="#natsmqrententionmaxMsgs" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
