...
<ul>
<li><a href="/docs/ja/visualize.md">Visualize Milvus metrics in Grafana</a></li>
<li><a href="/docs/ja/alert.md">Create an Alert for Milvus Services</a></li>
...
<ul>
<li>Read the <a href="/docs/ja/upgrade_milvus_cluster-operator.md">guide for upgrading Milvus cluster</a> and <a href="/docs/ja/upgrade_milvus_standalone-operator.md">that for upgrade Milvus standalone</a>.</li>
</ul></li>
</ul>
