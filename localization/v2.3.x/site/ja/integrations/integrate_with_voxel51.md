...
<ul>
<li>A running <a href="/docs/ja/install_standalone-docker.md">Milvus server</a>.</li>
...
<p>For detailed information on these parameters, see the <a href="/docs/ja/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/ja/consistency.md">Milvus consistency levels documentation</a>.</p>
