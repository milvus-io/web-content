...
<div class="start_card_container">
  <a href="/docs/ko/example_code.md">
...
<li><a href="/docs/ko/build_index.md">Build an Index</a></li>
<li><a href="/docs/ko/search.md">Search</a></li>
<li><a href="/docs/ko/query.md">Query</a></li>
</ul>
</div>
<div class="recomment-item">
  <p>Deploy</p>
...
<li><a href="/docs/ko/aws.md">Deploy on Clouds</a></li>
...
<ul>
<li>Added guidance on how to <a href="/docs/ko/bulk_insert.md">bulk insert entities from files</a>.</li>
<li>Added description of <a href="/docs/ko/disk_index.md">disk-based ANN index</a>.</li>
<li>Added guidance on how to configure <a href="/docs/ko/configure_quota_limits.md">quotas_and_limits</a>.</li>
<li>Added guidance on how to <a href="/docs/ko/rbac.md">enable RBAC</a> with Milvus Operator.</li>
<li>Added guidance on how to <a href="/docs/ko/upgrade_milvus_cluster-helm.md">migrate metadata</a> from 2.1.x to 2.2.0</li>
</ul>
</div>
