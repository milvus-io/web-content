...
To share an etcd instance among multiple Milvus instances, you need to change <code translate="no">etcd.rootPath</code> to a unique value for each of the Milvus instances. For details, refer to <a href="/docs/ko/operational_faq.md#Can-I-share-an-etcd-instance-among-multiple-Milvus-instances">Operation FAQs</a>.
</div>
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>To share an etcd instance among multiple Milvus instances, consider changing this to a different value for each Milvus instance before you start them. For details, see <a href="/docs/ko/operational_faq.md#Can-I-share-an-etcd-instance-among-multiple-Milvus-instances">Operation FAQs</a>.</li>
