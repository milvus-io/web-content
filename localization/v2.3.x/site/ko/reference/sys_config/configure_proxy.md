...
<h2 id="proxyaccessLoglocalPath" class="common-anchor-header"><code translate="no">proxy.accessLog.localPath</code><button data-href="#proxyaccessLoglocalPath" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>The local folder path where the access log file is stored. This parameter can be specified when <code translate="no">proxy.accessLog.filename</code> is not empty.</td>
...
<h2 id="proxyaccessLogmaxBackups" class="common-anchor-header"><code translate="no">proxy.accessLog.maxBackups</code><button data-href="#proxyaccessLogmaxBackups" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="proxyaccessLogminioEnable" class="common-anchor-header"><code translate="no">proxy.accessLog.minioEnable</code><button data-href="#proxyaccessLogminioEnable" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>Whether to upload local access log files to MinIO. This parameter can be specified when <code translate="no">proxy.accessLog.filename</code> is not empty.</td>
      <td>False</td>
    </tr>
  </tbody>
</table>
...
<h2 id="proxyaccessLogremoteMaxTime" class="common-anchor-header"><code translate="no">proxy.accessLog.remoteMaxTime</code><button data-href="#proxyaccessLogremoteMaxTime" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>The time interval allowed for uploading access log files. If the upload time of a log file exceeds this interval, the file will be deleted. Setting the value to <code translate="no">0</code> disables this feature.</td>
      <td>0</td>
    </tr>
  </tbody>
</table>
<h2 id="proxyaccessLogbaseformat" class="common-anchor-header"><code translate="no">proxy.accessLog.base.format</code><button data-href="#proxyaccessLogbaseformat" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>The log format with dynamic metrics. This format applies to all methods by default. For more information about metrics, see <a href="/docs/ko/configure_access_logs.md">Configure Access Logs</a>.</td>
      <td>Empty string</td>
    </tr>
  </tbody>
</table>
<h2 id="proxyaccessLogcustomformatternameformat" class="common-anchor-header"><code translate="no">proxy.accessLog.&lt;custom_formatter_name&gt;.format</code><button data-href="#proxyaccessLogcustomformatternameformat" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>The custom log format that you configure for specific methods. This parameter works together with <code translate="no">proxy.accessLog.&lt;custom_formatter_name&gt;.methods</code>.</td>
      <td>Empty string</td>
    </tr>
  </tbody>
</table>
<h2 id="proxyaccessLogcustomformatternamemethods" class="common-anchor-header"><code translate="no">proxy.accessLog.&lt;custom_formatter_name&gt;.methods</code><button data-href="#proxyaccessLogcustomformatternamemethods" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>The methods to which the custom formatter applies. This parameter works together with <code translate="no">proxy.accessLog.&lt;custom_formatter_name&gt;.format</code>.</td>
      <td>Empty string</td>
    </tr>
  </tbody>
</table>
