...
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-sessions" class="common-anchor-header">List sessions</h3><p>You can list all etcd sessions as follows:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>In the command output, you can find sessions from all Milvus components to etcd.</p>
