...
---
<div class="tab-wrapper"><a href="/docs/ko/search.md" class=''>Vector Similarity Search</a><a href="/docs/ko/hybridsearch.md" class=''>Hybrid Search</a><a href="/docs/ko/within_range.md" class='active '>Range Search</a></div>
...
<h2 id="Step-2-Configure-range-filtering" class="common-anchor-header">Step 2: Configure range filtering<button data-href="#Step-2-Configure-range-filtering" class="anchor-icon" translate="no">
    ...
    </button></h2><p>With Milvus, a range search is differentiated from a standard <a href="/docs/ko/search.md">vector search</a> by two key parameters:</p>
<ul>
