...
---
<div class="tab-wrapper"><a href="/docs/es/install_cluster-milvusoperator.md" class='active '>Milvus Operator</a><a href="/docs/es/install_cluster-helm.md" class=''>Helm</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>When the Milvus cluster is installed, you can learn how to <a href="/docs/es/manage_connection.md">Connect to Milvus server</a>.</p>
...
<ul>
<li>Check <a href="/docs/es/example_code.md">Hello Milvus</a> to run an example code with different SDKs to see what Milvus can do.</li>
...
<li><a href="/docs/es/upgrade_milvus_cluster-operator.md">Upgrade Milvus Using Milvus Operator</a></li>
<li><a href="/docs/es/scaleout.md">Scale your Milvus cluster</a></li>
...
<li><a href="/docs/es/gcs.md">Google Cloud Storage</a></li>
<li><a href="/docs/es/azure.md">Microsoft Azure</a></li>
<li><a href="/docs/es/abs.md">Microsoft Azure Blob Storage</a></li>
</ul></li>
<li>Explore <a href="/docs/es/milvus_backup_overview.md">Milvus Backup</a>, an open-source tool for Milvus data backups.</li>
<li>Explore <a href="/docs/es/birdwatcher_overview.md">Birdwatcher</a>, an open-source tool for debugging Milvus and dynamic configuration updates.</li>
<li>Explore <a href="https://milvus.io/docs/attu.md">Attu</a>, an open-source GUI tool for intuitive Milvus management.</li>
<li><a href="/docs/es/monitor.md">Monitor Milvus with Prometheus</a></li>
</ul>
