...
<li><p>Check <a href="/docs/es/prerequisite-docker.md">the requirements</a> for hardware and software requirements before installing Milvus.</p>
<ul>
...
<li>Check <a href="/docs/es/index.md">In-memory Index</a> for more about CPU-compatible index types.</li>
