...
<p>Milvus supports default values for scalar fields, excluding a primary key field. This indicates that some fields can be left empty during data inserts or upserts. For more information, refer to <a href="/docs/es/create_collection.md#prepare-schema">Create a Collection</a>.</p>
<p>Once you enable dynamic schema, you can append dynamic fields in the data. For details, refer to <a href="/docs/es/dynamic_schema.md">Dynamic Schema</a>.</p>
