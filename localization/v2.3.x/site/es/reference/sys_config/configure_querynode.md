...
---
<h1 id="Query-Node-related-Configurations" class="common-anchor-header">Query Node-related Configurations<button data-href="#Query-Node-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="queryNodegracefulTime" class="common-anchor-header"><code translate="no">queryNode.gracefulTime</code><button data-href="#queryNodegracefulTime" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="queryNodesegcoreInterimIndex" class="common-anchor-header"><code translate="no">queryNode.segcore.InterimIndex</code><button data-href="#queryNodesegcoreInterimIndex" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
