...
<ul>
<li>A running <a href="/docs/es/install_standalone-docker.md">Milvus server</a>.</li>
...
<p>For detailed information on these parameters, see the <a href="/docs/es/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/es/consistency.md">Milvus consistency levels documentation</a>.</p>
