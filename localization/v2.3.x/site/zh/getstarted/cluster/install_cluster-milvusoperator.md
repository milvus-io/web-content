...
---
<div class="tab-wrapper"><a href="/docs/zh/install_cluster-milvusoperator.md" class='active '>Milvus Operator</a><a href="/docs/zh/install_cluster-helm.md" class=''>Helm</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>When the Milvus cluster is installed, you can learn how to <a href="/docs/zh/manage_connection.md">Connect to Milvus server</a>.</p>
...
<ul>
<li>Check <a href="/docs/zh/example_code.md">Hello Milvus</a> to run an example code with different SDKs to see what Milvus can do.</li>
...
<li><a href="/docs/zh/upgrade_milvus_cluster-operator.md">Upgrade Milvus Using Milvus Operator</a></li>
<li><a href="/docs/zh/scaleout.md">Scale your Milvus cluster</a></li>
...
<li><a href="/docs/zh/gcs.md">Google Cloud Storage</a></li>
<li><a href="/docs/zh/azure.md">Microsoft Azure</a></li>
<li><a href="/docs/zh/abs.md">Microsoft Azure Blob Storage</a></li>
</ul></li>
<li>Explore <a href="/docs/zh/milvus_backup_overview.md">Milvus Backup</a>, an open-source tool for Milvus data backups.</li>
<li>Explore <a href="/docs/zh/birdwatcher_overview.md">Birdwatcher</a>, an open-source tool for debugging Milvus and dynamic configuration updates.</li>
<li>Explore <a href="https://milvus.io/docs/attu.md">Attu</a>, an open-source GUI tool for intuitive Milvus management.</li>
<li><a href="/docs/zh/monitor.md">Monitor Milvus with Prometheus</a></li>
</ul>
