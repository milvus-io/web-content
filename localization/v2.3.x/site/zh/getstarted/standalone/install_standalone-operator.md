...
---
<div class="tab-wrapper"><a href="/docs/zh/install_standalone-docker.md" class=''>Docker</a><a href="/docs/zh/install_standalone-operator.md" class='active '>Milvus Operator</a><a href="/docs/zh/install_standalone-helm.md" class=''>Helm</a><a href="/docs/zh/install_standalone-aptyum.md" class=''>DEB/RPM</a><a href="/docs/zh/install_standalone-docker-compose.md" class=''>Docker Compose</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>When the Milvus is successfully installed, you can learn how to <a href="/docs/zh/manage_connection.md">Connect to Milvus server</a>.</p>
...
<li><a href="/docs/zh/upgrade_milvus_standalone-operator.md">Upgrade Milvus Using Milvus Operator</a></li>
