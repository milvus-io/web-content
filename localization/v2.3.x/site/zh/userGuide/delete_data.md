...
<div class="alert caution">
    <ul>
          ...
          <li>Deleting entities by complex boolean expressions is supported only when the consistency is set to <b>Bounded</b>. For details, see <a href="/docs/zh/consistency.md#Consistency-levels">Consistency</a>.</li>
    </ul>
</div>
...
<p>Milvus supports deleting entities by primary key or complex boolean expressions. For more information on expression rules and supported operators, see <a href="/docs/zh/boolean.md">Boolean Expression Rules</a>.</p>
