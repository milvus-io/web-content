...
<li>Learn how to <a href="/docs/es/load_collection.md">load a collection</a> as multiple replicas.</li>
<li>Learn how to <a href="/docs/es/load_partition.md">load a partition</a> as multiple replicas.</li>
</ul>
