...
<ul>
<li><a href="/docs/es/install_standalone-docker.md">Install Milvus standalone with Docker Compose</a></li>
<li><a href="/docs/es/install_cluster-docker.md">Install Milvus cluster with Docker Compose</a></li>
</ul></li>
