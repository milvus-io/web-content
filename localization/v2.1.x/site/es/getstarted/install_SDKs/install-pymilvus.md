...
<li>Python 3.6 or later is required.</li>
...
<pre><code translate="no">$ python3 -m pip install pymilvus==2.1.x
...
<li><p>Explore <a href="/api-reference/pymilvus/v2.1.x/About.md">PyMilvus API reference</a></p></li>
</ul>
