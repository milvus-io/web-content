...
<div class="tab-wrapper"><a href="/docs/pt/attu_install-docker.md" class='active '>Install with Docker Compose</a><a href="/docs/pt/attu_install-helm.md" class=''>Install with Helm Chart</a><a href="/docs/pt/attu_install-package.md" class=''>Install with Package</a></div>
...
<li>Milvus installed on <a href="/docs/pt/install_standalone-docker.md">your local device</a> or <a href="/docs/pt/install_cluster-docker.md">cluster</a>.</li>
