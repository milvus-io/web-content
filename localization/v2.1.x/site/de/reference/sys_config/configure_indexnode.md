...
title: ''
---
<h1 id="Index-Node-related-Configurations" class="common-anchor-header">Index Node-related Configurations<button data-href="#Index-Node-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>This topic introduces the index node-related configurations of Milvus.</p>
<p>Index node builds indexes for vectors.</p>
