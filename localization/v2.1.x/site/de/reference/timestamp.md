...
<li><p>Learn how <a href="/docs/de/consistency.md">guarantee timestamp enables tunable consistency in Milvus</a></p></li>
<li><p>Learn how to <a href="/docs/de/timetravel.md">search with Time Travel</a></p></li>
</ul>
