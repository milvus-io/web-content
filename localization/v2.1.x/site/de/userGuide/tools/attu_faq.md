...
<h4 id="How-do-I-use-Attu-with-K8s" class="common-anchor-header">How do I use Attu with K8s?</h4><p>A: You can <a href="/docs/de/attu_install-helm.md">install Attu while deploying Milvus with Helm</a>.</p>
