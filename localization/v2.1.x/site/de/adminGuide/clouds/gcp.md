...
<br>
If you already have a VPC that you want to use, proceed to <a href="/docs/de/gcp.md#Create-a-firewall-rule-for-Milvus">Create a firewall rule for Milvus </a>.</p>
...
<li><a href="/docs/de/azure.md">Deploy a Milvus Cluster on Azure</a></li>
</ul>
