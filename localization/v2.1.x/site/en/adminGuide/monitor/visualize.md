...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.1.x/assets/import_dashboard.png" alt="Download_and_import" class="doc-image" id="download_and_import" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.1.x/assets/grafana_select.png" alt="Select_instance" class="doc-image" id="select_instance" />
    <span>Select_instance</span>
  </span>
</p>
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.1.x/assets/grafana_panel.png" alt="Grafana_panel" class="doc-image" id="grafana_panel" />
...
<ul>
<li>Learn how to <a href="/docs/v2.1.x/alert.md">create an alert for Milvus services</a></li>
<li>Adjust your <a href="/docs/v2.1.x/allocate.md">resource allocation</a></li>
<li><a href="/docs/v2.1.x/scaleout.md">Scale out or scale in a Milvus cluster</a></li>
</ul></li>
<li>If you are interested in upgrading the Milvus version,
<ul>
<li>Read the <a href="/docs/v2.1.x/upgrade.md">upgrading guide</a></li>
</ul></li>
</ul>
