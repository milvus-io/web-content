...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.1.x/assets/prometheus_architecture.png" alt="Prometheus_architecture" class="doc-image" id="prometheus_architecture" />
...
<ul>
<li><a href="/docs/v2.1.x/visualize.md">Visualize Milvus metrics in Grafana</a></li>
<li><a href="/docs/v2.1.x/alert.md">Create an Alert for Milvus Services</a></li>
