...
<h1 id="Version-Migration" class="common-anchor-header">Version Migration<button data-href="#Version-Migration" class="anchor-icon" translate="no">
    ...
    </button></h1><p>This topic describes how to migrate data from Milvus 1.x to Milvus 2.0 using <a href="/docs/v2.1.x/migrate_overview.md">MilvusDM</a>, an open-source tool specifically designed for Milvus data migration.</p>
...
<li>Learn how to <a href="/docs/v2.1.x/h2m.md">Migrate from HDF5 to Milvus</a>.</li>
</ul></li>
