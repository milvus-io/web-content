...
<ul>
<li><a href="/docs/v2.1.x/allocate.md#Allocate-resources-with-commands">Use the commands</a></li>
<li><a href="/docs/v2.1.x/allocate.md#Allocate-resources-by-setting-configuration-file">Set the parameters in the <code translate="no">YAML</code> file</a></li>
</ul>
...
<li><a href="/docs/v2.1.x/upgrade.md">Upgrade</a> your Milvus instance</li>
</ul></li>
