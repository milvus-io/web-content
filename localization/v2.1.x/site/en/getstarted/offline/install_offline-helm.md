...
title: ''
---
<div class="tab-wrapper"><a href="/docs/v2.1.x/install_offline-helm.md" class='active '>Install on Kubernetes</a><a href="/docs/v2.1.x/install_offline-docker.md" class=''>Install with Docker Compose</a></div>
