...
title: ''
---
<div class="tab-wrapper"><a href="/docs/v2.1.x/install_offline-helm.md" class=''>Install on Kubernetes</a><a href="/docs/v2.1.x/install_offline-docker.md" class='active '>Install with Docker Compose</a></div>
