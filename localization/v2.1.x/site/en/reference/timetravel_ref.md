...
<h1 id="Time-Travel" class="common-anchor-header">Time Travel<button data-href="#Time-Travel" class="anchor-icon" translate="no">
    ...
    </button></h1><p>This topic introduces the Time Travel feature in detail. See <a href="/docs/timetravel.md">Search with Time Travel</a> for more information about how to use this feature.</p>
