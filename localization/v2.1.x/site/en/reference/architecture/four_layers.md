...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.1.x/assets/log_mechanism.png" alt="Log_mechanism" class="doc-image" id="log_mechanism" />
...
<li>Read <a href="/docs/v2.1.x/main_components.md">Main Components</a> for more details about the Milvus architecture.</li>
</ul>
