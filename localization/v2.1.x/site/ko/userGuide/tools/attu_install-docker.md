...
<div class="tab-wrapper"><a href="/docs/ko/attu_install-docker.md" class='active '>Install with Docker Compose</a><a href="/docs/ko/attu_install-helm.md" class=''>Install with Helm Chart</a><a href="/docs/ko/attu_install-package.md" class=''>Install with Package</a></div>
...
<li>Milvus installed on <a href="/docs/ko/install_standalone-docker.md">your local device</a> or <a href="/docs/ko/install_cluster-docker.md">cluster</a>.</li>
