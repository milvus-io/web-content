...
<li>On the <strong>Overview</strong> page that appears, click <strong>Connect</strong> to view the resource group and subscription.
  ...
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.1.x/assets/azure.png" alt="Azure" class="doc-image" id="azure" />
    <span>Azure</span>
  </span>
</li>
</ol>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.1.x/assets/azure_results.png" alt="Results" class="doc-image" id="results" />
    <span>Results</span>
  </span>
</p>
<div class="alert note">
...
<ul>
<li><a href="/docs/ko/aws.md">Deploy a Milvus Cluster on EC2</a></li>
<li><a href="/docs/ko/eks.md">Deploy a Milvus Cluster on EKS</a></li>
<li><a href="/docs/ko/gcp.md">Deploy a Milvus Cluster on GCP</a></li>
</ul>
