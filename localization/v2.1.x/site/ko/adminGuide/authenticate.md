...
<p>Set <code translate="no">common.security.authorizationEnabled</code> in <code translate="no">milvus.yaml</code> as <code translate="no">true</code> when <a href="/docs/ko/configure-docker.md">configuring Milvus</a> to enable authentication.</p>
</div>
