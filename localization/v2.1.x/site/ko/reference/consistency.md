...
<p>Milvus supports four consistency levels:  strong, bounded staleness, session, and eventually. The default consistency level in Milvus is bounded staleness.  You can easily tune the consistency level when conducting a <a href="/docs/ko/search.md">vector similarity search</a> or <a href="/docs/ko/query.md">query</a> to make it best suit your application.</p>
...
<ul>
<li><a href="/docs/ko/search.md">conducting a vector similarity search</a></li>
<li><a href="/docs/ko/query.md">conducting a vector query</a></li>
</ul></li>
</ul>
