...
---
<h1 id="Esegui-Milvus-usando-Python" class="common-anchor-header">Esegui Milvus usando Python<button data-href="#Esegui-Milvus-usando-Python" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Questa sezione descrive come eseguire Milvus usando Python.</p>
<h2 id="1-Installa-PyMilvus" class="common-anchor-header">1. Installa PyMilvus<button data-href="#1-Installa-PyMilvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="2-Scarica-il-codice-di-esempio" class="common-anchor-header">2. Scarica il codice di esempio<button data-href="#2-Scarica-il-codice-di-esempio" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="3-Scannerizza-il-campione" class="common-anchor-header">3. Scannerizza il campione<button data-href="#3-Scannerizza-il-campione" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Il codice di esempio esegue i seguenti passaggi.</p>
<ul>
<li>Importa il pacchetto PyMilvus:</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Si connette ad un server:</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Inserisce dei vettori nella collezione:</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Crea degli indici e carica la collezione:</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Esegue una ricerca di somiglianza vettoriale:</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<p>Per stampare i risultati della ricerca per ID e per distanza, esegui il seguente comando.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Vedi <a href="/api-reference/pymilvus/v2.1.x/results.html">API Reference</a> per maggiori informazioni.</p>
<ul>
<li>Esegue una ricerca ibrida：</li>
</ul>
<div class="alert note">
    Il seguente esempio esegue una ricerca approssimata nelle entità con <code translate="no">film_id</code> che spazia tra [2,4,6,8].
    </div>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="4-Esegui-il-campione" class="common-anchor-header">4. Esegui il campione<button data-href="#4-Esegui-il-campione" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<p><em>I risultati ritornati e la latenza della query vengono mostrati come segue:</em></p>
...
<p><br/></p>
<p><em>Congratulazioni! Sei riuscito ad avviare Milvus indipendentemente e hai eseguito la tua prima ricerca di somiglianza vettoriale.</em></p>
