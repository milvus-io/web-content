...
<ul>
<li><a href="/docs/ja/install_standalone-docker.md">Install Milvus standalone with Docker Compose</a></li>
<li><a href="/docs/ja/install_cluster-docker.md">Install Milvus cluster with Docker Compose</a></li>
</ul></li>
<li><p>See <a href="/docs/ja/system_configuration.md">System Configuration</a> for parameters you can set while installing Milvus.</p></li>
</ul>
