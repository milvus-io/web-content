...
title: ''
---
<div class="tab-wrapper"><a href="/docs/ja/install_cluster-milvusoperator.md" class=''>Milvus Operator</a><a href="/docs/ja/install_cluster-helm.md" class='active '>Helm</a><a href="/docs/ja/install_cluster-docker.md" class=''>Docker Compose</a><a href="/docs/ja/install_cluster-ansible.md" class=''>Ansible</a></div>
...
<h2 id="Prerequisites" class="common-anchor-header">Prerequisites<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Check <a href="/docs/ja/prerequisite-helm.md">the requirements</a> for hardware and software prior to your installation.</p>
...
<pre><code translate="no" class="language-bash">$ kubectl <span class="hljs-keyword">get</span> pod my-release-milvus-standalone<span class="hljs-number">-54</span>c4f88cb9-f84pf --template
