...
<ul>
<li>Learn how to <a href="/docs/ja/alert.md">create an alert for Milvus services</a></li>
<li>Adjust your <a href="/docs/ja/allocate.md">resource allocation</a></li>
<li><a href="/docs/ja/scaleout.md">Scale out or scale in a Milvus cluster</a></li>
</ul></li>
<li>If you are interested in upgrading the Milvus version,
<ul>
<li>Read the <a href="/docs/ja/upgrade.md">upgrading guide</a></li>
</ul></li>
</ul>
