...
<ul>
<li><a href="/docs/it/install_standalone-helm.md">Install Milvus standalone on Kubernetes</a></li>
<li><a href="/docs/it/install_cluster-helm.md">Install Milvus cluster on Kubernetes</a></li>
</ul></li>
