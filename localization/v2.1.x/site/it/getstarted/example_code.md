...
title: ''
---
<div class="tab-wrapper"><a href="/docs/it/example_code.md" class='active '>Python</a><a href="/docs/it/example_code_node.md" class=''>Node.js</a></div>
...
<li><a href="/docs/it/install_standalone-docker.md">Milvus 2.1.3</a></li>
<li>Python 3 (3.71 or later)</li>
<li><a href="/docs/it/install-pymilvus.md">PyMilvus 2.1.3</a></li>
</ul>
