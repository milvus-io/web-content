...
<li><strong>Loaded For Search</strong> card: an interactive shortcut panel that allows you to perform a <a href="/docs/fr/attu_search.md">vector search</a> on or <a href="/docs/fr/attu_collection.md">release the collection</a>.</li>
</ol>
<p>
