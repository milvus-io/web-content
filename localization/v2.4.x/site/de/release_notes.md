...
<ul>
<li><p><strong>New GPU Index - CAGRA</strong>: Thanks to NVIDIA’s contribution, this new GPU index offers a 10x performance boost, especially for batch searches. For details, refer to <a href="/docs/de/v2.4.x/gpu_index.md">GPU Index</a>.</p></li>
<li><p><strong>Multi-vector</strong> and <strong>Hybrid Search</strong>: This feature enables storing vector embeddings from multiple models and conducting hybrid searches. For details, refer to <a href="/docs/de/v2.4.x/multi-vector-search.md">Hybrid Search</a>.</p></li>
<li><p><strong>Sparse Vectors</strong>: Ideal for keyword interpretation and analysis, sparse vectors are now supported for processing in your collection. For details, refer to <a href="/docs/de/v2.4.x/sparse_vector.md">Sparse Vectors</a>.</p></li>
...
<li><p><strong>Inverted Index</strong> and <strong>Fuzzy Matching</strong>: These capabilities improve keyword retrieval for scalar fields. For details, refer to <a href="/docs/de/v2.4.x/index-scalar-fields.md">Index Scalar Fields</a> and <a href="/docs/de/v2.4.x/single-vector-search.md#filtered-search">Filtered Search</a>.</p></li>
</ul>
...
<p>For details, refer to <a href="/docs/de/v2.4.x/mmap.md">MMap Storage</a>.</p>
...
<p>To learn more about Milvus-CDC, refer to <a href="https://github.com/zilliztech/milvus-cdc">GitHub repository</a> and <a href="/docs/de/v2.4.x/milvus-cdc-overview.md">Milvus-CDC Overview</a>.</p>
