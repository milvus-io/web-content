...
<p>Milvus ist mit den Einbettungsmodellen von Mistral AI über die Klasse MistralAIEmbeddingFunction integriert. Diese Klasse bietet Methoden zur Kodierung von Dokumenten und Abfragen unter Verwendung der Mistral AI Einbettungsmodelle und gibt die Einbettungen als dichte Vektoren zurück, die mit der Milvus-Indizierung kompatibel sind. Um diese Funktionalität nutzen zu können, muss ein API-Schlüssel von <a href="https://console.mistral.ai/">Mistral AI</a> erworben werden.</p>
