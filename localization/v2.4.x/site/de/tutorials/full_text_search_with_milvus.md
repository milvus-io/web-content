...
summary: >-
  ...
  diesem Notizbuch zeigen wir die grundlegende Verwendung der Volltextsuche in
  Milvus.
...
<h3 id="Install-Milvus-25" class="common-anchor-header">Milvus 2.5 installieren</h3><p>Lesen Sie die <a href="https://milvus.io/docs/install_standalone-docker-compose.md">offizielle Installationsanleitung</a> für weitere Details.</p>
<h3 id="Install-PyMilvus" class="common-anchor-header">PyMilvus installieren</h3><p>Führen Sie den folgenden Befehl aus, um PyMilvus zu installieren:</p>
<pre><code translate="no" class="language-python">pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span> -U 
<button class="copy-code-btn"></button></code></pre>
<h3 id="Define-the-Retriever" class="common-anchor-header">Definieren Sie den Retriever</h3><pre><code translate="no" class="language-python"><span class="hljs-keyword">import</span> json
...
<h3 id="Insert-the-data" class="common-anchor-header">Einfügen der Daten</h3><pre><code translate="no" class="language-python">path = <span class="hljs-string">&quot;codebase_chunks.json&quot;</span>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Test-Sparse-Search" class="common-anchor-header">Sparse Search testen</h3><pre><code translate="no" class="language-python">results = standard_retriever.search(<span class="hljs-string">&quot;create a logger?&quot;</span>, mode=<span class="hljs-string">&quot;sparse&quot;</span>, k=<span class="hljs-number">3</span>)
