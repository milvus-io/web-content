...
<li>Hier konstruieren wir das Konzept der Beziehung, indem wir das Subjekt, das Prädikat und das Objekt mit einem Leerzeichen dazwischen direkt aneinanderreihen.</li>
</ul>
...
<h2 id="Online-Querying" class="common-anchor-header">Online-Abfrage<button data-href="#Online-Querying" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Similarity-Retrieval" class="common-anchor-header">Ähnlichkeitsabfrage</h3><p>Wir rufen die TopK ähnlichen Entitäten und Relationen basierend auf der Eingabeabfrage von Milvus ab.</p>
