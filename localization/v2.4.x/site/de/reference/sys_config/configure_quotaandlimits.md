  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>Wenn dieser Wert auf 100 gesetzt wird, erlaubt Milvus nur die Suche nach 100 Vektoren pro Sekunde und Sammlung, unabhängig davon, ob diese 100 Vektoren alle in einer Suche oder über mehrere Suchen verteilt sind.</li>      
        <li>Um diese Einstellung zu verwenden, setzen Sie gleichzeitig quotaAndLimits.dql.enabled auf true.</li>      </td>
      <td>-1</td>
    </tr>
  </tbody>
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>Die Latenz bezieht sich hier auf die über einen bestimmten Zeitraum gemittelte Latenz.</li>      
