...
summary: 'Erfahren Sie, wie Sie die Grafikkarte für Milvus konfigurieren.'
title: ''
---
<h1 id="gpu-related-Configurations" class="common-anchor-header">gpu-bezogene Konfigurationen<button data-href="#gpu-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>#Wenn Sie die GPU-Indizierung verwenden, verwendet Milvus einen Speicherpool, um häufige Speicherzuweisungen und -freigaben zu vermeiden.</p>
...
<h2 id="gpuinitMemSize" class="common-anchor-header"><code translate="no">gpu.initMemSize</code><button data-href="#gpuinitMemSize" class="anchor-icon" translate="no">
  ...
  <thead>
    <tr>
      ...
      <th class="width20">Standard-Wert</th> 
    </tr>
  </thead>
  <tbody>
    <tr>
...
<h2 id="gpumaxMemSize" class="common-anchor-header"><code translate="no">gpu.maxMemSize</code><button data-href="#gpumaxMemSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Gpu-Speicherpool maximale Größe      </td>
      <td></td>
    </tr>
  </tbody>
</table>
