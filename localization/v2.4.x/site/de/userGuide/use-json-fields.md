...
<h2 id="Basic-scalar-filtering" class="common-anchor-header">Grundlegende skalare Filterung<button data-href="#Basic-scalar-filtering" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Sobald alle Daten hinzugefügt wurden, können Sie Suchvorgänge und Abfragen mit den Schlüsseln im JSON-Feld auf dieselbe Weise durchführen, wie Sie es mit einem Standard-Skalarfeld tun würden.</p>
<div class="language-python">
