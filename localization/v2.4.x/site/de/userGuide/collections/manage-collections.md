...
<p>Sie können auch Metadatenfilterung in Suchanfragen und Abfragen integrieren, um die Relevanz der Ergebnisse zu verbessern. Beachten Sie, dass die Bedingungen für die Metadatenfilterung in Abfragen obligatorisch, in Suchen jedoch optional sind.</p>
...
<p>Darüber hinaus bietet Zilliz Cloud auch Erweiterungen zur Verbesserung der Suchleistung und -effizienz. Diese sind standardmäßig deaktiviert und Sie können sie je nach Ihren Serviceanforderungen aktivieren und nutzen. Sie sind</p>
<ul>
...
<h2 id="Limits​" class="common-anchor-header">Beschränkungen<button data-href="#Limits​" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
