...
<h3 id="Partition-search" class="common-anchor-header">Partitionierte Suche</h3><p>Die Partitionssuche grenzt den Umfang Ihrer Suche auf eine bestimmte Teilmenge oder Partition Ihrer Sammlung ein. Dies ist besonders nützlich für organisierte Datensätze, bei denen die Daten in logische oder kategorische Unterteilungen segmentiert sind, was schnellere Suchvorgänge ermöglicht, da die zu durchsuchende Datenmenge reduziert wird.</p>
...
<p>Weitere Informationen über die Arten von Abstandsmetriken finden Sie unter <a href="/docs/de/metric.md">Ähnlichkeitsmetriken</a>.</p>
