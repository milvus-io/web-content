...
<ul>
<li><p>Um Bilder über Text zu suchen, können wir Bilder über ein multimodales Einbettungsmodell in Vektoren einbetten, das Text- und Bilddaten im selben latenten Raum abbilden kann.</p></li>
...
<h1 id="How-to-Implement-the-Example-Schema​" class="common-anchor-header">So implementieren Sie das Beispielschema<button data-href="#How-to-Implement-the-Example-Schema​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Zunächst erstellen wir eine Milvus-Client-Instanz, die für die Verbindung mit dem Milvus-Server und die Verwaltung von Sammlungen und Daten verwendet werden kann. </p>
...
<h2 id="Define-Index​" class="common-anchor-header">Index definieren<button data-href="#Define-Index​" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
