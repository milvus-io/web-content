...
<h1 id="Standard​" class="common-anchor-header">Standard<button data-href="#Standard​" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Der <code translate="no">standard</code> Tokenizer in Milvus teilt Text auf der Basis von Leerzeichen und Satzzeichen auf und ist daher für die meisten Sprachen geeignet.</p>
...
<p>Für eine einfachere Einrichtung können Sie den Filter <a href="/docs/de/standard-analyzer.md"><code translate="no">standard analyzer</code></a>verwenden, der den <code translate="no">standard</code> tokenizer mit dem <a href="/docs/de/lowercase-filter.md"><code translate="no">lowercase filter</code></a>.</p>
</div>
<p>Nachdem Sie <code translate="no">analyzer_params</code> definiert haben, können Sie diese auf ein <code translate="no">VARCHAR</code> Feld anwenden, wenn Sie ein Sammelschema definieren. Dadurch kann Milvus den Text in diesem Feld unter Verwendung des angegebenen Analysators für eine effiziente Tokenisierung und Filterung verarbeiten. Einzelheiten finden Sie unter <a href="/docs/de/analyzer-overview.md#Example-use">Beispielanwendung</a>.</p>
