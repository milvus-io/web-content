...
<div class="tab-wrapper"><a href="/docs/de/install_standalone-operator.md" class='active '>Milvus Operator</a><a href="/docs/de/install_standalone-helm.md" class=''>Helm</a><a href="/docs/de/install_standalone-aptyum.md" class=''>DEB/RPM</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>When the Milvus is successfully installed, you can learn how to <a href="/docs/de/manage-collections.md">manage collections</a>.</p>
...
<ul>
<li>Check <a href="/docs/de/quickstart.md">Hello Milvus</a> to run an example code with different SDKs to see what Milvus can do.</li>
