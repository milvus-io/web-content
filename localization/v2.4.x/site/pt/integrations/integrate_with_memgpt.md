...
<p>Para descarregar o documento de investigação do MemGPT, vamos utilizar <code translate="no">curl</code> (também pode simplesmente descarregar o PDF a partir do seu browser):</p>
