...
<h2 id="Benefits-of-using-DSPy" class="common-anchor-header">Benefícios da utilização de DSPy<button data-href="#Benefits-of-using-DSPy" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
