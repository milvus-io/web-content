...
<div class="tab-wrapper"><a href="/docs/pt/install_standalone-operator.md" class=''>Milvus Operator</a><a href="/docs/pt/install_standalone-helm.md" class='active '>Helm</a><a href="/docs/pt/install_standalone-aptyum.md" class=''>DEB/RPM</a></div>
...
<h2 id="Prerequisites" class="common-anchor-header">Prerequisites<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Check <a href="/docs/pt/prerequisite-helm.md">the requirements</a> for hardware and software prior to your installation.</p>
...
<ul>
<li><p>Check <a href="/docs/pt/quickstart.md">Hello Milvus</a> to run an example code with different SDKs to see what Milvus can do.</p></li>
...
<li><p><a href="/docs/pt/upgrade_milvus_standalone-helm.md">Upgrade Milvus Using Helm Chart</a>.</p></li>
