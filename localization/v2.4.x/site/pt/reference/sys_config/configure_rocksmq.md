...
<h2 id="rocksmqretentionTimeInMinutes" class="common-anchor-header"><code translate="no">rocksmq.retentionTimeInMinutes</code><button data-href="#rocksmqretentionTimeInMinutes" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        O tempo máximo de retenção das mensagens acked no RocksMQ. As mensagens acked no RocksMQ são retidas pelo período de tempo especificado e depois apagadas. Unidade: Minuto.      </td>
      <td>4320</td>
    </tr>
  </tbody>
</table>
