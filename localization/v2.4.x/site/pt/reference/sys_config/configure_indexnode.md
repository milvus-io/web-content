...
summary: Saiba como configurar o indexNode para o Milvus.
title: ''
---
<h1 id="indexNode-related-Configurations" class="common-anchor-header">Configurações relacionadas com o indexNode<button data-href="#indexNode-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>        ativar índice de vetor de construção de nó de índice de disco     </td>
      <td>verdadeiro</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodeip" class="common-anchor-header"><code translate="no">indexNode.ip</code><button data-href="#indexNodeip" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Endereço TCP/IP do nó de índice. Se não for especificado, utiliza o primeiro endereço unicastable      </td>
      <td></td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodeport" class="common-anchor-header"><code translate="no">indexNode.port</code><button data-href="#indexNodeport" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Porta TCP do nó de índice      </td>
      <td>21121</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcserverMaxSendSize" class="common-anchor-header"><code translate="no">indexNode.grpc.serverMaxSendSize</code><button data-href="#indexNodegrpcserverMaxSendSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        O tamanho máximo de cada pedido RPC que o nó de índice pode enviar, unidade: byte    </td>
      <td>536870912</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcserverMaxRecvSize" class="common-anchor-header"><code translate="no">indexNode.grpc.serverMaxRecvSize</code><button data-href="#indexNodegrpcserverMaxRecvSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        O tamanho máximo de cada pedido RPC que o nó de índice pode receber, unidade: byte    </td>
      <td>268435456</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcclientMaxSendSize" class="common-anchor-header"><code translate="no">indexNode.grpc.clientMaxSendSize</code><button data-href="#indexNodegrpcclientMaxSendSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        O tamanho máximo de cada pedido RPC que os clientes no indexNode podem enviar, unidade: byte    </td>
      <td>268435456</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcclientMaxRecvSize" class="common-anchor-header"><code translate="no">indexNode.grpc.clientMaxRecvSize</code><button data-href="#indexNodegrpcclientMaxRecvSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        O tamanho máximo de cada pedido RPC que os clientes no indexNode podem receber, unidade: byte    </td>
      <td>536870912</td>
    </tr>
  </tbody>
</table>
