...
<h1 id="Standard​" class="common-anchor-header">Padrão<button data-href="#Standard​" class="anchor-icon" translate="no">
    ...
    </button></h1><p>O analisador <code translate="no">standard</code> é o analisador padrão do Milvus, que é aplicado automaticamente aos campos de texto se não for especificado nenhum analisador. Utiliza a tokenização baseada na gramática, o que o torna eficaz para a maioria das línguas.</p>
