...
<h3 id="Install-based-on-Docker-image" class="common-anchor-header">Instalar com base na imagem do Docker</h3><pre><code translate="no" class="language-shell">$ docker run -it zilliz/milvus_cli:latest
<button class="copy-code-btn"></button></code></pre>
...
<h3 id="Install-from-an-exe-file" class="common-anchor-header">Instalar a partir de um ficheiro .exe</h3><div class="alert note"> Este método de instalação só se aplica ao Windows. </div>
