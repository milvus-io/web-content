...
<h2 id="Data-Operations-Within-Partitions​" class="common-anchor-header">Operações de dados em partições<button data-href="#Data-Operations-Within-Partitions​" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Insert-and-Delete-Entities​" class="common-anchor-header">Inserir e excluir entidades</h3><p>É possível executar operações de inserção, upsert e exclusão em operações específicas. Para obter detalhes, consulte</p>
<ul>
