...
<ul>
<li>Para atualizar o Milvus da versão 2.2.3 ou versões posteriores para a versão 2.4.17, pode <a href="#Conduct-a-rolling-upgrade">efetuar uma atualização contínua</a>.</li>
