...
<h1 id="BGE-M3" class="common-anchor-header">BGE M3<button data-href="#BGE-M3" class="anchor-icon" translate="no">
    ...
    </button></h1><p><a href="https://arxiv.org/abs/2402.03216">O</a> nome<a href="https://arxiv.org/abs/2402.03216">BGE-M3</a> deve-se às suas capacidades de multilinguismo, multifuncionalidade e multigranularidade. Capaz de suportar mais de 100 línguas, a BGE-M3 estabelece novos padrões de referência em tarefas de recuperação multilingue e multilíngue. A sua capacidade única de efetuar a recuperação densa, a recuperação multi-vetorial e a recuperação esparsa numa única estrutura torna-a a escolha ideal para uma vasta gama de aplicações de recuperação de informação (RI).</p>
