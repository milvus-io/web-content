...
---
<div class="tab-wrapper"><a href="/docs/zh/upgrade_milvus_cluster-operator.md" class=''>Milvus</a><a href="/docs/zh/upgrade_milvus_cluster-helm.md" class='active '>操作员</a><a href="/docs/zh/upgrade_milvus_cluster-operator.md" class=''>舵手</a></div>
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">使用 Helm 图表升级 Milvus 群集<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本指南介绍如何使用 Milvus Helm 图表升级 Milvus 群集。</p>
...
<p><code translate="no">https://milvus-io.github.io/milvus-helm/</code> 上的 Milvus Helm 图表 repo 已归档，您可以从<code translate="no">https://zilliztech.github.io/milvus-helm/</code> 获取进一步更新，具体如下：</p>
...
<p>确保 Milvus 实例中的所有部署都处于正常状态后。可以运行以下命令将 Milvus 实例升级到 2.4.9。</p>
