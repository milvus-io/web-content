...
<div style="display: none;">- 进行滚动升级](#conduct-a-rolling-upgrade) 从 Milvus v2.2.3 及以后的版本升级到 v2.4.20。</div>
<ul>
<li><p><a href="#Upgrade-Milvus-using-Helm">使用 Helm 升级 Milvus</a>，从 v2.2.3 之前的次版本升级到 v2.4.20。</p></li>
<li><p>在从 Milvus v2.1.x 升级到 v2.4.20 之前<a href="#Migrate-the-metadata">迁移元数据</a>。</p></li>
</ul>
...
<p>确保 Milvus 实例中的所有部署都处于正常状态后。你可以运行以下命令将 Milvus 实例升级到 2.4.20。</p>
...
<h4 id="2-Upgrade-Milvus-from-v21x-to-2420" class="common-anchor-header">2.将 Milvus 从 2.1.x 版升级到 2.4.20 版</h4><p>以下命令假定你将 Milvus 从 v2.1.4 升级到 2.4.20。请将它们更改为适合你需要的版本。</p>
<ol>
