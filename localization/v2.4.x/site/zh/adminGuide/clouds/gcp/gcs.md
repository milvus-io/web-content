...
<h1 id="Configure-GCS-Access-by-Workload-Identity" class="common-anchor-header">按工作负载身份配置 GCS 访问<button data-href="#Configure-GCS-Access-by-Workload-Identity" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本主题介绍如何在使用 helm 安装 Milvus 时通过工作负载身份配置 gcs 访问。 更多详情，请参阅<a href="https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity">工作负载身份</a>。</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>如果结果是<code translate="no">milvus-gcs-access-sa@milvus-testing-nonprod.iam.gserviceaccount.com</code> ，则没问题。</p>
