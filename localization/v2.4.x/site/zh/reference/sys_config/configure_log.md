...
summary: 了解如何为 Milvus 配置日志。
title: ''
---
<h1 id="log-related-Configurations" class="common-anchor-header">日志相关配置<button data-href="#log-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="loglevel" class="common-anchor-header"><code translate="no">log.level</code><button data-href="#loglevel" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Milvus 日志级别。选项：debug、info、warn、error、panal 和 fatal。 </li>      
        <li>建议在测试和开发环境下使用 debug 级别，在生产环境下使用 info 级别。</li>      </td>
      <td>信息</td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>如果该参数设置为有效的本地路径，Milvus 将在该路径下写入并存储日志文件。</li>      
        <li>将此参数设置为您有权限写入的路径。</li>      </td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<h2 id="logfilemaxAge" class="common-anchor-header"><code translate="no">log.file.maxAge</code><button data-href="#logfilemaxAge" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        日志文件自动清除前的最长保留时间，单位：天。最小值为 1。    </td>
      <td>10</td>
    </tr>
  </tbody>
</table>
<h2 id="logfilemaxBackups" class="common-anchor-header"><code translate="no">log.file.maxBackups</code><button data-href="#logfilemaxBackups" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        要备份的日志文件的最大数量，单位：天。最小值为 1。    </td>
      <td>20</td>
    </tr>
  </tbody>
</table>
