...
<h2 id="Configuration​" class="common-anchor-header">配置<button data-href="#Configuration​" class="anchor-icon" translate="no">
    ...
    </button></h2><p><code translate="no">stemmer</code> 过滤器是 Milvus 的自定义过滤器。要使用该过滤器，请在过滤器配置中指定<code translate="no">&quot;type&quot;: &quot;stemmer&quot;</code> ，并使用<code translate="no">language</code> 参数选择所需的词干语言。</p>
