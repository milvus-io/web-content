...
<h1 id="ASCII-folding​" class="common-anchor-header">ASCII 折叠<button data-href="#ASCII-folding​" class="anchor-icon" translate="no">
    ...
    </button></h1><p><code translate="no">asciifolding</code>** **过滤器可将<a href="https://en.wikipedia.org/wiki/Basic_Latin_(Unicode_block)">基本拉丁统一码块</a>（前 127 个 ASCII 字符）以外的字符转换为其 ASCII 对应字符。例如，它可将<code translate="no">í</code> 等字符转换为<code translate="no">i</code> ，使文本处理更简单、更一致，尤其是对于多语言内容。</p>
