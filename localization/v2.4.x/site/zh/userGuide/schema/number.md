...
<p>如果在定义 Schema 时设置了<code translate="no">enable_dynamic_fields=True</code> ，Milvus 允许插入事先未定义的数字字段。但请注意，这可能会增加查询和管理的复杂性，并可能影响性能。更多信息，请参阅<a href="/docs/zh/enable_dynamic_field.md">动态字段</a>。</p>
