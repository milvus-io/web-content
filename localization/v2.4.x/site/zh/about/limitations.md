...
<h2 id="Number-of-resources-in-a-collection" class="common-anchor-header">集合中的资源数量<button data-href="#Number-of-resources-in-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
