...
<p>例如，<a href="https://apify.com/apify/website-content-crawler">网站内容</a>抓取<a href="https://apify.com/apify/website-content-crawler">器</a>Actor 可以深入抓取网站，通过删除 cookie 模态、页脚或导航来清理 HTML，然后将 HTML 转换为 Markdown。</p>
