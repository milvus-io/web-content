...
<h2 id="Connect-to-Milvus-Lite" class="common-anchor-header">连接到 Milvus Lite<button data-href="#Connect-to-Milvus-Lite" class="anchor-icon" translate="no">
    ...
    </button></h2><p>在<code translate="no">pymilvus</code> 中，指定一个本地文件名作为 MilvusClient 的 uri 参数，将使用 Milvus Lite。</p>
...
<h3 id="Collection" class="common-anchor-header">集合</h3><table>
<thead>
...
<tr><td><a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/get_collection_stats.md">get_collection_stats()</a></td><td>支持获取集合统计数据。</td></tr>
<tr><td><code translate="no">collection_name</code></td><td>Y</td></tr>
...
<tr><td><code translate="no">collection_name</code></td><td>Y</td></tr>
<tr><td><code translate="no">timeout</code></td><td>Y</td></tr>
<tr><td><a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/list_collections.md">list_collections()</a></td><td>支持列出所有收藏集。</td></tr>
<tr><td><a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/drop_collection.md">drop_collection()</a></td><td>支持删除一个收藏集。</td></tr>
<tr><td><code translate="no">collection_name</code></td><td>Y</td></tr>
<tr><td><code translate="no">timeout</code></td><td>Y</td></tr>
<tr><td><a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/rename_collection.md">rename_collection()</a></td><td>不支持重命名集合。</td></tr>
</tbody>
</table>
<h3 id="Field--Schema" class="common-anchor-header">字段和模式</h3><table>
<thead>
<tr><th>方法/参数</th><th>Milvus Lite 支持</th></tr>
</thead>
<tbody>
...
<h2 id="Migrating-data-from-Milvus-Lite" class="common-anchor-header">从 Milvus Lite 迁移数据<button data-href="#Migrating-data-from-Milvus-Lite" class="anchor-icon" translate="no">
    ...
    </button></h2><p>存储在 Milvus Lite 中的所有数据都可以轻松导出并加载到其他类型的 Milvus 部署中，例如 Docker 上的独立 Milvus、K8s 上的分布式 Milvus 或<a href="https://zilliz.com/cloud">Zilliz Cloud</a> 上的完全托管 Milvus。</p>
<p>Milvus Lite 提供了一个命令行工具，可以将数据转储到一个 json 文件，该文件可以导入到<a href="https://github.com/milvus-io/milvus">milvus</a>和<a href="https://zilliz.com/cloud">Zilliz Cloud</a>（Milvus 的完全托管云服务）。milvus-lite 命令将与 milvus-lite python 软件包一起安装。</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>有了转储文件，你可以通过<a href="https://docs.zilliz.com/docs/data-import">数据导入（Data Import</a>）将数据上传到 Zilliz Cloud，或通过<a href="https://milvus.io/docs/import-data.md">批量插入（Bulk Insert</a>）将数据上传到 Milvus 服务器。</p>
<h2 id="Whats-next" class="common-anchor-header">下一步<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>连接到 Milvus Lite 后，你可以</p>
<ul>
