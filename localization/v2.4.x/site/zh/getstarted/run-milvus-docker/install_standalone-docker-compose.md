...
<ul>
<li><p>如果运行上述命令失败，请检查系统是否安装了 Docker Compose V1。如果是这种情况，建议根据<a href="https://docs.docker.com/compose/">本页</a>的说明迁移到 Docker Compose V2。</p></li>
...
<li><strong>milvus-etcd</strong>容器不向主机暴露任何端口，并将数据映射到当前文件夹中的<strong>volumes/etcd</strong>。</li>
...
<li><p>探索用于直观管理 Milvus 的开源 GUI 工具<a href="https://github.com/zilliztech/attu">Attu</a>。</p></li>
