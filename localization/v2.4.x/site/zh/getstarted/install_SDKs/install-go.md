...
<h1 id="Install-Milvus-Go-SDK" class="common-anchor-header">安装 Milvus Go SDK<button data-href="#Install-Milvus-Go-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本主题介绍如何为 Milvus 安装 Milvus Go SDK。</p>
...
<h2 id="Requirement" class="common-anchor-header">要求<button data-href="#Requirement" class="anchor-icon" translate="no">
    ...
    </button></h2><p>需要使用 GO（1.17 或更高版本）。</p>
<h2 id="Install-Milvus-GO-SDK" class="common-anchor-header">安装 Milvus GO SDK<button data-href="#Install-Milvus-GO-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>通过<code translate="no">go get</code> 安装 Milvus GO SDK 和依赖项。</p>
