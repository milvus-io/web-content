...
---
<div class="tab-wrapper"><a href="/docs/zh-hant/v2.4.x/upgrade_milvus_standalone-operator.md" class='active '>Milvus</a><a href="/docs/zh-hant/v2.4.x/upgrade_milvus_standalone-helm.md" class=''>OperatorHelmDocker</a><a href="/docs/zh-hant/v2.4.x/upgrade_milvus_standalone-docker.md" class=''>Compose</a></div>
...
<h2 id="Migrate-the-metadata" class="common-anchor-header">遷移元資料<button data-href="#Migrate-the-metadata" class="anchor-icon" translate="no">
    ...
    </button></h2><p>自 Milvus 2.2.0 起，元資料與先前版本不相容。下面的示例片段假設從 Milvus 2.1.4 升級到 Milvus v2.4.23。</p>
