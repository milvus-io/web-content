...
<h2 id="Overview" class="common-anchor-header">概述<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>標量查詢使用布林表達式，根據定義的條件篩選集合中的實體。查詢結果是符合定義條件的實體集合。向量搜尋會找出集合中最接近指定向量的向量，查詢則不同，它是根據特定條件篩選實體。</p>
...
<p>使用 <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Client/MilvusClientV2.md"><code translate="no">MilvusClientV2</code></a>連接至 Milvus 伺服器並 <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createCollection.md"><code translate="no">createCollection()</code></a>來建立資料夾。</p>
</div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Create-partitions-and-insert-more-entities" class="common-anchor-header">步驟 3：建立分區並插入更多實體</h3><div class="language-python">
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Get-entities-from-partitions" class="common-anchor-header">從分區取得實體</h3><p>您也可以從特定的分區取得實體。</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<h3 id="Count-entities" class="common-anchor-header">計算實體</h3><ul>
<li><p>計算集合中實體的總數。</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<h2 id="Reference-on-scalar-filters" class="common-anchor-header">標量篩選器參考<button data-href="#Reference-on-scalar-filters" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Basic-Operators" class="common-anchor-header">基本運算符號</h3><p><strong>布林表達式</strong>總是<strong>由字段名稱與運算符號組成的字串</strong>。在本節中，您將學習更多關於基本運算符的資訊。</p>
<table>
<thead>
...
<tr><td><strong>類似</strong></td><td>使用通配符將一個值與相似的值比較。<br/> 例如，like &quot;prefix%「 會比較以 」prefix&quot; 開頭的字串。</td></tr>
<tr><td><strong>中</strong></td><td>測試表達式是否匹配值清單中的任何值。</td></tr>
</tbody>
</table>
<h3 id="Advanced-operators" class="common-anchor-header">進階運算符</h3><ul>
<li><p><code translate="no">count(*)</code></p>
<p>計算集合中實體的確切數目。使用此作為輸出欄位，可取得集合或分割區中的精確實體數目。</p>
