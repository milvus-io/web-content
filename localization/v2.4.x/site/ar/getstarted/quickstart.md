...
<h2 id="Install-Milvus" class="common-anchor-header">تثبيت ميلفوس<button data-href="#Install-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>في هذا الدليل نستخدم Milvus Lite، وهي مكتبة بايثون مضمنة في <code translate="no">pymilvus</code> والتي يمكن تضمينها في تطبيق العميل. يدعم Milvus أيضًا النشر على <a href="/docs/ar/v2.4.x/install_standalone-docker.md">Docker</a> و <a href="/docs/ar/v2.4.x/install_cluster-milvusoperator.md">Kubernetes</a> لحالات استخدام الإنتاج.</p>
...
<li>يتم تعيين نوع القياس (تعريف مسافة المتجه) إلى قيمته الافتراضية<a href="/docs/ar/v2.4.x/metric.md#Cosine-Similarity">(COSINE</a>).</li>
<li>يقبل حقل المفتاح الأساسي الأعداد الصحيحة ولا يزيد تلقائيًا (أي لا يستخدم <a href="/docs/ar/v2.4.x/schema.md">ميزة المعرف التلقائي</a>) بدلاً من ذلك، يمكنك تحديد مخطط المجموعة رسميًا باتباع هذه <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_schema.md">التعليمات</a>.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<p>بشكل افتراضي، لا تتم فهرسة الحقول العددية. إذا كنت بحاجة إلى إجراء بحث مفهرس للبيانات الوصفية في مجموعة بيانات كبيرة، يمكنك التفكير في استخدام مخطط ثابت وتشغيل <a href="/docs/ar/v2.4.x/scalar_index.md">الفهرس</a> أيضًا لتحسين أداء البحث.</p>
<p>بالإضافة إلى البحث المتجه، يمكنك أيضًا إجراء أنواع أخرى من عمليات البحث:</p>
<h3 id="Query" class="common-anchor-header">الاستعلام</h3><p>الاستعلام() هو عملية تسترجع جميع الكيانات المطابقة لمعيار ما، مثل <a href="/docs/ar/v2.4.x/boolean.md">تعبير مرشح</a> أو مطابقة بعض المعرفات.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>يوفر Milvus واجهة برمجة تطبيقات REST و gRPC، مع مكتبات العميل بلغات مثل <a href="/docs/ar/v2.4.x/install-pymilvus.md">Python</a> و <a href="/docs/ar/v2.4.x/install-java.md">Java</a> و <a href="/docs/ar/v2.4.x/install-go.md">Go</a> و C# و <a href="/docs/ar/v2.4.x/install-node.md">Node.js.</a></p>
