...
<h1 id="Use-Partition-Key" class="common-anchor-header">استخدام مفتاح التقسيم<button data-href="#Use-Partition-Key" class="anchor-icon" translate="no">
    ...
    </button></h1><p>يرشدك هذا الدليل إلى كيفية استخدام مفتاح التقسيم لتسريع استرجاع البيانات من مجموعتك.</p>
<h2 id="Overview" class="common-anchor-header">نظرة عامة<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يمكنك تعيين حقل معين في المجموعة كمفتاح التقسيم بحيث يوزع Milvus الكيانات الواردة إلى أقسام مختلفة وفقًا لقيم التقسيم الخاصة بكل منها في هذا الحقل. يسمح هذا بتجميع الكيانات التي لها نفس قيمة المفتاح في قسم، مما يسرع من أداء البحث عن طريق تجنب الحاجة إلى مسح الأقسام غير ذات الصلة عند التصفية حسب حقل المفتاح. بالمقارنة مع طرق التصفية التقليدية، يمكن لمفتاح التقسيم تحسين أداء الاستعلام بشكل كبير.</p>
<p>يمكنك استخدام مفتاح التقسيم لتنفيذ الاستئجار المتعدد. للمزيد من التفاصيل حول تعدد الاستئجار، اقرأ مفتاح التقسيم <a href="https://milvus.io/docs/multi_tenancy.md">المتعدد</a>.</p>
<h2 id="Enable-partition-key" class="common-anchor-header">تمكين مفتاح التقسيم<button data-href="#Enable-partition-key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>لتعيين حقل كمفتاح التقسيم، حدد <code translate="no">partition_key_field</code> عند إنشاء مخطط مجموعة.</p>
<p>في رمز المثال أدناه، يحدد <code translate="no">num_partitions</code> عدد الأقسام التي سيتم إنشاؤها. بشكل افتراضي، يتم تعيينه على <code translate="no">64</code>. نوصي بالاحتفاظ بالقيمة الافتراضية.</p>
...
<p>لمزيد من المعلومات حول المعلمات، ارجع إلى <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Client/MilvusClientV2.md"><code translate="no">MilvusClientV2</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createSchema.md"><code translate="no">createSchema()</code></a>، و <a href="https://milvus.io/api-reference/java/v2.4.x/v2/CollectionSchema/addField.md"><code translate="no">addField()</code></a> في مرجع SDK.</p>
</div>
<div class="language-javascript">
<p>لمزيد من المعلومات حول المعلمات، ارجع إلى <a href="https://milvus.io/api-reference/node/v2.4.x/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a> و <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a> في مرجع SDK.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>بعد الانتهاء من تحديد الحقول، قم بإعداد معلمات الفهرس.</p>
<div class="multipleCode">
...
<h2 id="Insert-data" class="common-anchor-header">إدراج البيانات<button data-href="#Insert-data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>بمجرد أن تصبح المجموعة جاهزة، ابدأ بإدراج البيانات على النحو التالي:</p>
<h3 id="Prepare-data" class="common-anchor-header">إعداد البيانات</h3><div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا</a> <a href="#javascript">Node.js</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Insert-data" class="common-anchor-header">أدخل البيانات</h3><div class="language-python">
...
<div class="language-java">
<p>استخدم طريقة <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/insert.md"><code translate="no">insert()</code></a> لإدراج البيانات في المجموعة.</p>
</div>
<div class="language-javascript">
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Use-partition-key" class="common-anchor-header">استخدم مفتاح التقسيم<button data-href="#Use-partition-key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>بمجرد الانتهاء من فهرسة المجموعة وتحميلها وكذلك إدراج البيانات، يمكنك إجراء بحث تشابه باستخدام مفتاح التقسيم.</p>
<div class="language-python">
...
<div class="language-java">
<p>لمزيد من المعلومات عن المعلمات، ارجع إلى <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/search.md"><code translate="no">search()</code></a> في مرجع SDK.</p>
</div>
<div class="language-javascript">
...
<p><b>الملاحظات</b></p>
<p>لإجراء بحث تشابه باستخدام مفتاح التقسيم، يجب عليك تضمين أي مما يلي في التعبير المنطقي لطلب البحث:</p>
<ul>
<li><p><code translate="no">expr='&lt;partition_key&gt;=="xxxx"'</code></p></li>
<li><p><code translate="no">expr='&lt;partition_key&gt; in ["xxx", "xxx"]'</code></p></li>
</ul>
<p>استبدل <code translate="no">&lt;partition_key&gt;</code> باسم الحقل الذي تم تعيينه كمفتاح التقسيم.</p>
</div>
<div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Typical-use-cases" class="common-anchor-header">حالات الاستخدام النموذجية<button data-href="#Typical-use-cases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>يمكنك الاستفادة من ميزة مفتاح التقسيم لتحقيق أداء بحث أفضل وتمكين تعدد الإيجار. يمكن القيام بذلك عن طريق تعيين قيمة خاصة بالمستأجر كحقل مفتاح التقسيم لكل كيان. عند البحث أو الاستعلام عن المجموعة، يمكنك تصفية الكيانات حسب القيمة الخاصة بالمستأجر من خلال تضمين حقل مفتاح التقسيم في التعبير المنطقي. يضمن هذا النهج عزل البيانات حسب المستأجرين ويتجنب مسح الأقسام غير الضرورية.</p>
