...
<p>لمعرفة المزيد حول أنواع مقاييس المسافة، راجع <a href="/docs/ar/v2.4.x/metric.md">مقاييس التشابه</a>.</p>
...
<tr><td><code translate="no">params.radius</code></td><td>يحدد الحد الخارجي لمساحة البحث الخاصة بك. تعتبر المتجهات التي تقع ضمن هذه المسافة من متجه الاستعلام فقط هي التي تعتبر مطابقات محتملة.<br/>يتم تحديد نطاق القيمة بواسطة المعلمة <code translate="no">metric_type</code>. على سبيل المثال، إذا تم تعيين <code translate="no">metric_type</code> على <code translate="no">L2</code> ، فإن نطاق القيمة الصالح هو <code translate="no">[0, ∞]</code>. إذا تم تعيين <code translate="no">metric_type</code> على <code translate="no">COSINE</code> ، فإن نطاق القيمة الصالح هو <code translate="no">[-1, 1]</code>. لمزيد من المعلومات، راجع <a href="/docs/ar/v2.4.x/metric.md">مقاييس التشابه</a>.</td></tr>
