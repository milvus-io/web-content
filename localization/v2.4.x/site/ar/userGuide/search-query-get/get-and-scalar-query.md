...
<h2 id="Preparations" class="common-anchor-header">التحضيرات<button data-href="#Preparations" class="anchor-icon" translate="no">
    ...
    </button></h2><p>تقوم الخطوات التالية بإعادة استخدام الشيفرة للاتصال بميلفوس، وإعداد مجموعة بسرعة، وإدراج أكثر من 1000 كيان تم إنشاؤه عشوائيًا في المجموعة.</p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Create-partitions-and-insert-more-entities" class="common-anchor-header">الخطوة 3: إنشاء أقسام وإدراج المزيد من الكيانات</h3><div class="language-python">
...
<div class="language-javascript">
<p>إذا كنت تعرف معرِّفات الكيانات الخاصة باهتماماتك، يمكنك استخدام الطريقة <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/get.md"><code translate="no">get()</code></a> الطريقة.</p>
</div>
<div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا جافا</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Get-entities-from-partitions" class="common-anchor-header">الحصول على الكيانات من الأقسام</h3><p>يمكنك أيضًا الحصول على كيانات من أقسام محددة.</p>
<div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا</a> <a href="#javascript">Node.js</a></div>
...
<h3 id="Count-entities" class="common-anchor-header">عد الكيانات</h3><ul>
...
<h2 id="Reference-on-scalar-filters" class="common-anchor-header">مرجع عن المرشحات العددية<button data-href="#Reference-on-scalar-filters" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Basic-Operators" class="common-anchor-header">المعاملات الأساسية</h3><p>دائمًا ما يكون <strong>التعبير المنطقي</strong> عبارة <strong>عن سلسلة تتألف من أسماء الحقول مرتبطة بعوامل</strong>. في هذا القسم، ستتعرف في هذا القسم على المزيد عن العوامل الأساسية.</p>
<table>
<thead>
...
<tr><td><strong>&lt;=, &gt;=</strong></td><td>أقل من أو يساوي، أكبر من أو يساوي إلى، أكبر من أو يساوي</td></tr>
<tr><td><strong>ليس</strong></td><td>يعكس نتيجة شرط معيّن.</td></tr>
...
<h3 id="Advanced-operators" class="common-anchor-header">العوامل المتقدمة</h3><ul>
