...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Insert-into-partitions" class="common-anchor-header">الإدراج في الأقسام</h3><p>لإدراج بيانات في قسم معين، يمكنك تحديد اسم القسم في طلب الإدراج كما يلي:</p>
<div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا جافا</a> <a href="#javascript">Node.js</a></div>
...
// 
<button class="copy-code-btn"></button></code></pre>
<h3 id="Upsert-data-in-partitions" class="common-anchor-header">رفع البيانات في الأقسام</h3><p>لإعادة إدراج البيانات في قسم معين، يمكنك تحديد اسم القسم في طلب الإدراج كما يلي:</p>
<div class="multipleCode">
