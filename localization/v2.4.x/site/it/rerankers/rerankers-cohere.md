...
<h1 id="Cohere" class="common-anchor-header">Cohere<button data-href="#Cohere" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus supporta i<a href="https://docs.cohere.com/docs/rerank-2"> modelli di reranker</a> <a href="https://docs.cohere.com/docs/rerank-2">Cohere</a> tramite la classe <code translate="no">CohereRerankFunction</code>. Questa funzionalità consente di attribuire un punteggio alla rilevanza delle coppie query-documento in modo efficace.</p>
