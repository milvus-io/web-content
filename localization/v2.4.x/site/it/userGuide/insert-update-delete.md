...
<div class="language-javascript">
<p>Se un'entità non è più necessaria, è possibile eliminarla dall'insieme utilizzando <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/delete.md"><code translate="no">delete()</code></a>.</p>
</div>
