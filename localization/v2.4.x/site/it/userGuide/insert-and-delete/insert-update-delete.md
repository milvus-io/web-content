...
<h1 id="Insert-Entities​" class="common-anchor-header">Inserire entità<button data-href="#Insert-Entities​" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Le entità di una raccolta sono record di dati che condividono lo stesso insieme di campi. I valori dei campi in ogni record di dati formano un'entità. Questa pagina spiega come inserire entità in una collezione.</p>
