...
<h2 id="Overview​" class="common-anchor-header">Panoramica<button data-href="#Overview​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>In Zilliz Cloud, lo schema di una collezione assembla una tabella in un database relazionale, che definisce come Zilliz Cloud organizza i dati nella collezione. </p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Add-JSON-fields​" class="common-anchor-header">Aggiungere campi JSON</h3><p>Un campo JSON di solito memorizza dati JSON semistrutturati. Per ulteriori informazioni sui campi JSON, consultare <a href="/docs/it/use-json-field.md">Campo JSON</a>.</p>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
<pre><code translate="no" class="language-python">schema.<span class="hljs-title function_">add_field</span>(​
