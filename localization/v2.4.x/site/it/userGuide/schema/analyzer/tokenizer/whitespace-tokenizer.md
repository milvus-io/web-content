...
title: Tokenizzatore di spazi bianchi
summary: >-
  Il tokenizer `whitespace` divide il testo in termini ogni volta che c'è uno
...
<h2 id="Example-output​" class="common-anchor-header">Esempio di output<button data-href="#Example-output​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ecco un esempio di come il tokenizer <code translate="no">whitespace</code> elabora il testo.</p>
