...
<h2 id="Load-Collection​" class="common-anchor-header">Caricare una raccolta<button data-href="#Load-Collection​" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Quando si carica una collezione, Zilliz Cloud carica i file di indice e i dati grezzi di tutti i campi in memoria per rispondere rapidamente alle ricerche e alle query. Le entità inserite dopo il caricamento di una collezione vengono automaticamente indicizzate e caricate.</p>
...
<h2 id="Load-Specific-Fields​" class="common-anchor-header">Caricare campi specifici<button data-href="#Load-Specific-Fields​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Zilliz Cloud può caricare solo i campi coinvolti nelle ricerche e nelle query, riducendo l'utilizzo della memoria e migliorando le prestazioni della ricerca.</p>
<p>Il seguente frammento di codice presuppone che sia stata creata una collezione denominata <strong>customized_setup_2</strong> e che nella collezione siano presenti due campi denominati <strong>my_id</strong> e <strong>my_vector</strong>.</p>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#go">Go</a> <a href="#curl">cURL</a></div>
