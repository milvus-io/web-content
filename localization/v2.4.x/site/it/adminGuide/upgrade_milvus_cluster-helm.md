...
---
<div class="tab-wrapper"><a href="/docs/it/v2.4.x/upgrade_milvus_cluster-operator.md" class=''>Milvus</a><a href="/docs/it/v2.4.x/upgrade_milvus_cluster-helm.md" class='active '>OperatorHelm</a></div>
...
<p>Dopo essersi assicurati che tutte le installazioni nella vostra istanza Milvus siano nello stato normale. È possibile eseguire il comando seguente per aggiornare l'istanza Milvus alla versione 2.4.23.</p>
