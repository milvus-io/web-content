...
<p>Dopo essersi assicurati che tutte le installazioni nella vostra istanza Milvus siano nello stato normale. Potete eseguire il seguente comando per aggiornare l'istanza Milvus alla versione 2.4.17.</p>
...
<h4 id="2-Upgrade-Milvus-from-v21x-to-2417" class="common-anchor-header">2. Aggiornamento di Milvus dalla v2.1.x alla 2.4.17</h4><p>I comandi seguenti presuppongono l'aggiornamento di Milvus dalla versione 2.1.4 alla 2.4.17. Modificateli in base alle vostre esigenze.</p>
<ol>
