...
<p>Dopo essersi assicurati che tutte le installazioni nella vostra istanza Milvus siano nello stato normale. Si può eseguire il seguente comando per aggiornare l'istanza Milvus alla versione 2.4.20.</p>
...
<h4 id="2-Upgrade-Milvus-from-v21x-to-2420" class="common-anchor-header">2. Aggiornare Milvus dalla v2.1.x alla 2.4.20</h4><p>I comandi seguenti presuppongono l'aggiornamento di Milvus dalla v2.1.4 alla 2.4.20. Modificateli in base alle vostre esigenze.</p>
<ol>
