...
<p>Questa guida illustra come <a href="https://docs.voyageai.com/docs/embeddings">l'API di embedding di VoyageAI</a> possa essere utilizzata con il database vettoriale Milvus per condurre una ricerca semantica sul testo.</p>
...
<h2 id="Searching-book-titles-with-VoyageAI--Milvus" class="common-anchor-header">Ricerca di titoli di libri con VoyageAI e Milvus<button data-href="#Searching-book-titles-with-VoyageAI--Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Nell'esempio seguente, carichiamo i dati dei titoli dei libri dal file CSV scaricato, utilizziamo il modello di embedding di Voyage AI per generare rappresentazioni vettoriali e le memorizziamo nel database vettoriale di Milvus per la ricerca semantica.</p>
