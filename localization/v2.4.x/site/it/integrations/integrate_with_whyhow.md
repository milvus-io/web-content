...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Create-index" class="common-anchor-header">Creare un indice</h3><p>Per ogni schema è meglio avere un indice, in modo che l'interrogazione sia molto più efficiente. Per creare un indice, occorre innanzitutto un oggetto <code translate="no">index_params</code> e successivamente aggiungere altri dati dell'indice a questo oggetto <code translate="no">IndexParams</code>.</p>
