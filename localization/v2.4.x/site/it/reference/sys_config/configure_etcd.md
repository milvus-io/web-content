...
summary: Imparare a configurare etcd per Milvus.
title: ''
---
<h1 id="etcd-related-Configurations" class="common-anchor-header">Configurazioni relative a etcd<button data-href="#etcd-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Configurazione relativa a etcd, utilizzata per memorizzare i metadati di Milvus e la scoperta dei servizi.</p>
<h2 id="etcdendpoints" class="common-anchor-header"><code translate="no">etcd.endpoints</code><button data-href="#etcdendpoints" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Endpoint utilizzati per accedere al servizio etcd. È possibile modificare questo parametro in base agli endpoint del proprio cluster etcd.</li>      
        <li>Variabile d'ambiente: ETCD_ENDPOINTS</li>      
        <li>All'avvio di Milvus, etcd acquisisce preferibilmente gli indirizzi validi dalla variabile d'ambiente ETCD_ENDPOINTS.</li>      </td>
...
<h2 id="etcdrootPath" class="common-anchor-header"><code translate="no">etcd.rootPath</code><button data-href="#etcdrootPath" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Prefisso della chiave in cui Milvus memorizza i dati in etcd.</li>      
        <li>Si consiglia di modificare questo parametro prima di avviare Milvus per la prima volta.</li>      
        <li>Per condividere un'istanza etcd tra più istanze Milvus, si consiglia di modificare questo valore per ogni istanza Milvus prima di avviarle.</li>      
        <li>Impostare un percorso di root facile da identificare per Milvus se il servizio etcd esiste già.</li>      
...
<h2 id="etcdmetaSubPath" class="common-anchor-header"><code translate="no">etcd.metaSubPath</code><button data-href="#etcdmetaSubPath" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Sottoprefisso della chiave in cui Milvus memorizza le informazioni relative ai metadati in etcd.</li>      
...
<h2 id="etcdkvSubPath" class="common-anchor-header"><code translate="no">etcd.kvSubPath</code><button data-href="#etcdkvSubPath" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Sottoprefisso della chiave in cui Milvus memorizza i timestamp in etcd.</li>      
        <li>Attenzione: La modifica di questo parametro dopo aver utilizzato Milvus per un certo periodo di tempo influisce sull'accesso ai vecchi dati.</li>      
        <li>Si raccomanda di non modificare questo parametro se non c'è un motivo specifico.</li>      </td>
      <td>kv</td>
    </tr>
  </tbody>
</table>
<h2 id="etcdloglevel" class="common-anchor-header"><code translate="no">etcd.log.level</code><button data-href="#etcdloglevel" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Supporta solo debug, info, warn, error, panic o fatal. Valore predefinito "info".      </td>
      <td>info</td>
    </tr>
  </tbody>
</table>
<h2 id="etcdlogpath" class="common-anchor-header"><code translate="no">etcd.log.path</code><button data-href="#etcdlogpath" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>il percorso è uno dei seguenti:</li>      
        <li> - "default" come os.Stderr,</li>      
        <li> - "stderr" come os.Stderr,</li>      
        <li> - "stdout" come os.Stdout,</li>      
        <li> - percorso del file in cui aggiungere i log del server.</li>      
        <li>Si prega di regolare in Milvus incorporato: /tmp/milvus/logs/etcd.log</li>      </td>
      <td>stdout</td>
    </tr>
  </tbody>
</table>
<h2 id="etcdsslenabled" class="common-anchor-header"><code translate="no">etcd.ssl.enabled</code><button data-href="#etcdsslenabled" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Se supportare la modalità di connessione sicura ETCD    </td>
      <td>falso</td>
    </tr>
  </tbody>
</table>
<h2 id="etcdssltlsCert" class="common-anchor-header"><code translate="no">etcd.ssl.tlsCert</code><button data-href="#etcdssltlsCert" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        percorso del file di certificazione      </td>
      <td>/percorso/to/etcd-client.pem</td>
    </tr>
  </tbody>
</table>
<h2 id="etcdssltlsKey" class="common-anchor-header"><code translate="no">etcd.ssl.tlsKey</code><button data-href="#etcdssltlsKey" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      ...
      <td>/percorso/da/etcd-client-key.pem</td>
    </tr>
  </tbody>
</table>
...
<h2 id="etcdssltlsMinVersion" class="common-anchor-header"><code translate="no">etcd.ssl.tlsMinVersion</code><button data-href="#etcdssltlsMinVersion" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Versione min di TLS</li>      
        <li>Valori opzionali: 1.0, 1.1, 1.2, 1.3。</li>      
        <li>Si consiglia di utilizzare la versione 1.2 o superiore.</li>      </td>
      <td>1.3</td>
    </tr>
  </tbody>
</table>
<h2 id="etcdrequestTimeout" class="common-anchor-header"><code translate="no">etcd.requestTimeout</code><button data-href="#etcdrequestTimeout" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Timeout operazione Etcd in millisecondi      </td>
      <td>10000</td>
    </tr>
  </tbody>
</table>
<h2 id="etcduseembed" class="common-anchor-header"><code translate="no">etcd.use.embed</code><button data-href="#etcduseembed" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Abilita o meno l'Etcd incorporato (un EtcdServer in corso).      </td>
      <td>falso</td>
    </tr>
  </tbody>
</table>
<h2 id="etcddatadir" class="common-anchor-header"><code translate="no">etcd.data.dir</code><button data-href="#etcddatadir" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Solo Etcd incorporato. regolare in Milvus incorporato: /tmp/milvus/etcdData/      </td>
      <td>default.etcd</td>
    </tr>
  </tbody>
</table>
<h2 id="etcdauthenabled" class="common-anchor-header"><code translate="no">etcd.auth.enabled</code><button data-href="#etcdauthenabled" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Se abilitare l'autenticazione      </td>
      <td>falso</td>
    </tr>
  </tbody>
</table>
<h2 id="etcdauthuserName" class="common-anchor-header"><code translate="no">etcd.auth.userName</code><button data-href="#etcdauthuserName" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Nome utente per l'autenticazione di etcd    </td>
      <td></td>
    </tr>
  </tbody>
</table>
<h2 id="etcdauthpassword" class="common-anchor-header"><code translate="no">etcd.auth.password</code><button data-href="#etcdauthpassword" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        password per l'autenticazione eccd    </td>
      <td></td>
    </tr>
  </tbody>
</table>
