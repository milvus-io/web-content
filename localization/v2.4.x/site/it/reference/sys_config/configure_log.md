...
summary: Scoprite come configurare il log per Milvus.
title: ''
---
<h1 id="log-related-Configurations" class="common-anchor-header">Configurazioni relative al log<button data-href="#log-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Configura l'output del registro di sistema.</p>
<h2 id="loglevel" class="common-anchor-header"><code translate="no">log.level</code><button data-href="#loglevel" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Livello di log di Milvus. Opzioni: debug, info, warn, error, panic e fatal. </li>      
        <li>Si consiglia di usare il livello debug negli ambienti di test e sviluppo e il livello info negli ambienti di produzione.</li>      </td>
      <td>info</td>
    </tr>
  </tbody>
</table>
<h2 id="logfilerootPath" class="common-anchor-header"><code translate="no">log.file.rootPath</code><button data-href="#logfilerootPath" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Percorso principale dei file di log.</li>      
        <li>Il valore predefinito è vuoto e indica l'uscita dei file di log su standard output (stdout) e standard error (stderr).</li>      
        <li>Se questo parametro è impostato su un percorso locale valido, Milvus scrive e memorizza i file di log in questo percorso.</li>      
        <li>Impostare questo parametro come il percorso per il quale si ha il permesso di scrivere.</li>      </td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<h2 id="logfilemaxAge" class="common-anchor-header"><code translate="no">log.file.maxAge</code><button data-href="#logfilemaxAge" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Il tempo massimo di conservazione prima che un file di registro venga cancellato automaticamente, unità: giorno. Il valore minimo è 1.  </td>
      <td>10</td>
    </tr>
  </tbody>
</table>
<h2 id="logfilemaxBackups" class="common-anchor-header"><code translate="no">log.file.maxBackups</code><button data-href="#logfilemaxBackups" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Numero massimo di file di registro di cui eseguire il backup, unità: giorno. Il valore minimo è 1.  </td>
      <td>20</td>
    </tr>
  </tbody>
</table>
<h2 id="logformat" class="common-anchor-header"><code translate="no">log.format</code><button data-href="#logformat" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Formato del log Milvus. Opzioni: testo e JSON    </td>
      <td>testo</td>
    </tr>
  </tbody>
</table>
