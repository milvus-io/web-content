...
summary: Imparare a configurare indexCoord per Milvus.
title: ''
---
<h1 id="indexCoord-related-Configurations" class="common-anchor-header">Configurazioni relative a indexCoord<button data-href="#indexCoord-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>        È una soglia. Quando il numero di righe del segmento è inferiore a questo valore, il segmento non viene indicizzato.      </td>
      <td>1024</td>
    </tr>
  </tbody>
</table>
