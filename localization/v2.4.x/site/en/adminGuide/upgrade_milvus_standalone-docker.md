...
<p>In normal cases, you can <a href="#Upgrade-Milvus-by-changing-its-image">upgrade Milvus by changing its image</a>. However, you need to <a href="#Migrate-the-metadata">migrate the metadata</a> before any upgrade from v2.1.x to v2.4.11.</p>
...
config:
  ...
  targetVersion: <span class="hljs-number">2.4</span><span class="hljs-number">.11</span>
