...
<ul>
<li><a href="/docs/v2.4.x/monitor.md">Deploy monitoring services</a></li>
<li><a href="/docs/v2.4.x/visualize.md">Visualize Milvus metrics</a></li>
<li><a href="/docs/v2.4.x/alert.md">Create an alert</a></li>
</ul>
