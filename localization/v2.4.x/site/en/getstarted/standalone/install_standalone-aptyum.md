...
<div class="tab-wrapper"><a href="/docs/install_standalone-operator.md/v2.4.x" class=''>Milvus Operator</a><a href="/docs/install_standalone-helm.md/v2.4.x" class=''>Helm</a><a href="/docs/install_standalone-aptyum.md/v2.4.x" class='active '>DEB/RPM</a></div>
...
<h2 id="Prerequisites" class="common-anchor-header">Prerequisites<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Check <a href="/docs/prerequisite-docker.md/v2.4.x">the requirements</a> for hardware and software prior to your installation.</p>
...
<li><p>Check <a href="/docs/index.md/v2.4.x">In-memory Index</a> for more about CPU-compatible index types.</p></li>
