...
<div class="tab-wrapper"><a href="/docs/fr/v2.4.x/install_standalone-operator.md" class=''>Milvus Operator</a><a href="/docs/fr/v2.4.x/install_standalone-helm.md" class=''>Helm</a><a href="/docs/fr/v2.4.x/install_standalone-aptyum.md" class='active '>DEB/RPM</a></div>
...
<h2 id="Prerequisites" class="common-anchor-header">Prerequisites<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Check <a href="/docs/fr/v2.4.x/prerequisite-docker.md">the requirements</a> for hardware and software prior to your installation.</p>
...
<li><p>Check <a href="/docs/fr/v2.4.x/index.md">In-memory Index</a> for more about CPU-compatible index types.</p></li>
