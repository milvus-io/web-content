...
summary: Découvrez comment configurer indexNode pour Milvus.
title: ''
---
<h1 id="indexNode-related-Configurations" class="common-anchor-header">Configurations relatives à indexNode<button data-href="#indexNode-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><h2 id="indexNodeenableDisk" class="common-anchor-header"><code translate="no">indexNode.enableDisk</code><button data-href="#indexNodeenableDisk" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>        activer la construction d'un index vectoriel de disque par le nœud d'index      </td>
      <td>vrai</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodeip" class="common-anchor-header"><code translate="no">indexNode.ip</code><button data-href="#indexNodeip" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>        Adresse TCP/IP de l'indexNode. Si elle n'est pas spécifiée, la première adresse non diffusable est utilisée.      </td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<h2 id="indexNodegrpcserverMaxSendSize" class="common-anchor-header"><code translate="no">indexNode.grpc.serverMaxSendSize</code><button data-href="#indexNodegrpcserverMaxSendSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Taille maximale de chaque requête RPC que l'indexNode peut envoyer, unité : octet     </td>
      <td>536870912</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcserverMaxRecvSize" class="common-anchor-header"><code translate="no">indexNode.grpc.serverMaxRecvSize</code><button data-href="#indexNodegrpcserverMaxRecvSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        La taille maximale de chaque requête RPC que l'indexNode peut recevoir, unité : octet     </td>
      <td>268435456</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcclientMaxSendSize" class="common-anchor-header"><code translate="no">indexNode.grpc.clientMaxSendSize</code><button data-href="#indexNodegrpcclientMaxSendSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        La taille maximale de chaque requête RPC que les clients de l'indexNode peuvent envoyer, unité : byte    </td>
      <td>268435456</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcclientMaxRecvSize" class="common-anchor-header"><code translate="no">indexNode.grpc.clientMaxRecvSize</code><button data-href="#indexNodegrpcclientMaxRecvSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Taille maximale de chaque requête RPC que les clients de l'indexNode peuvent recevoir, unité : octet     </td>
      <td>536870912</td>
    </tr>
  </tbody>
</table>
