...
<h2 id="rocksmqcompressionTypes" class="common-anchor-header"><code translate="no">rocksmq.compressionTypes</code><button data-href="#rocksmqcompressionTypes" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Type de compression du compactage, seul l'usage de 0,7 est supporté. 0 signifie qu'il n'y a pas de compression, 7 utilisera zstd. La longueur des types correspond au nombre de niveaux de rocksdb.      </td>
      <td>0,0,7,7,7</td>
    </tr>
  </tbody>
</table>
