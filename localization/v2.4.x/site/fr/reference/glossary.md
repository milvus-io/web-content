...
<h2 id="Milvus-Migration" class="common-anchor-header">Milvus Migration<button data-href="#Milvus-Migration" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://github.com/zilliztech/milvus-migration/">Milvus Migration</a> est un outil open-source conçu pour faciliter la migration des données à partir de diverses sources de données vers Milvus 2.x.</p>
