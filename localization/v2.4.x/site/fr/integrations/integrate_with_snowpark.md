...
summary: >-
  ...
  conteneurs Snowpark.
title: Milvus sur Snowpark Container Services
---
...
<p>Après avoir établi la connexion, continuez à cliquer sur <strong>Exécuter</strong>. Le code transformera un morceau de texte en données vectorielles après le traitement d'incorporation, puis l'insérera dans Milvus.</p>
...
<p>Pour plus d'informations sur l'utilisation du client Milvus, vous pouvez vous référer à la section <a href="/docs/fr/v2.4.x/quickstart.md">Milvus Doc.</a> </p>
...
<h2 id="About-Milvus" class="common-anchor-header">A propos de Milvus<button data-href="#About-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pour plus d'informations sur Milvus, vous pouvez commencer par l'<a href="/docs/fr/v2.4.x/overview.md">introduction</a> et le <a href="/docs/fr/v2.4.x/quickstart.md">démarrage rapide de</a> <a href="/docs/fr/v2.4.x/overview.md">Milvus</a>. Bien entendu, il existe une introduction plus détaillée à l'API, une référence aux versions <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/About.md">Python</a> et <a href="https://milvus.io/api-reference/java/v2.3.x/About.md">Java</a>, ainsi que des informations sur <a href="https://milvus.io/docs/embeddings.md">Embeddings</a> et <a href="https://milvus.io/docs/integrate_with_openai.md">Integrations</a> à titre de référence.</p>
