...
summary: Apprenez à configurer s3 avec le rôle IAM.
---
...
<li><p>Ce guide suppose que vous avez déjà <a href="/docs/fr/v2.4.x/eks.md">déployé un cluster Milvus sur AWS avec Kubernetes</a>.</p></li>
</ul>
