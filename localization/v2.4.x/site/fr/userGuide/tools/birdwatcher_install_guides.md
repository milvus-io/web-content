...
<h2 id="Install-as-a-Kubernetes-pod" class="common-anchor-header">Installer en tant que pod Kubernetes<button data-href="#Install-as-a-Kubernetes-pod" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Si vous avez installé Milvus Standalone <a href="/docs/fr/install_standalone-helm.md">à l'aide des tableaux Helm</a> ou de <a href="/docs/fr/install_standalone-operator.md">Milvus Operator</a> ou Milvus Cluster <a href="/docs/fr/install_cluster-helm.md">à l'aide des tableaux Helm</a> ou de <a href="/docs/fr/install_cluster-milvusoperator.md">Milvus Operator</a>, il est conseillé d'installer Birdwatcher en tant que pod Kubernetes.</p>
