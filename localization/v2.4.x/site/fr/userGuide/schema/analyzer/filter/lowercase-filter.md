...
title: Filtre pour minuscules
summary: >-
  Le filtre `lowercase` convertit les termes générés par un tokenizer en
  minuscules, ce qui rend les recherches insensibles à la casse.
---
...
<h2 id="Example-output​" class="common-anchor-header">Exemple de sortie<button data-href="#Example-output​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Voici un exemple de traitement du texte par le filtre <code translate="no">lowercase</code>.</p>
