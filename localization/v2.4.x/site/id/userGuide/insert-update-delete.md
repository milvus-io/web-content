...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Insert-into-partitions" class="common-anchor-header">Menyisipkan ke dalam partisi</h3><p>Untuk menyisipkan data ke dalam partisi tertentu, Anda dapat menentukan nama partisi dalam permintaan sisipkan sebagai berikut:</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
// 
<button class="copy-code-btn"></button></code></pre>
<h3 id="Upsert-data-in-partitions" class="common-anchor-header">Memasukkan data ke dalam partisi</h3><p>Untuk memasukkan data ke dalam partisi tertentu, Anda dapat menentukan nama partisi dalam permintaan penyisipan sebagai berikut:</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
