...
title: Menggunakan Kunci Partisi
---
<h1 id="Use-Partition-Key" class="common-anchor-header">Menggunakan Kunci Partisi<button data-href="#Use-Partition-Key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Panduan ini memandu Anda dalam menggunakan kunci partisi untuk mempercepat pengambilan data dari koleksi Anda.</p>
<h2 id="Overview" class="common-anchor-header">Ikhtisar<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Anda dapat menetapkan bidang tertentu dalam koleksi sebagai kunci partisi sehingga Milvus mendistribusikan entitas yang masuk ke dalam partisi yang berbeda sesuai dengan nilai partisi masing-masing dalam bidang ini. Hal ini memungkinkan entitas dengan nilai kunci yang sama untuk dikelompokkan dalam sebuah partisi, sehingga mempercepat kinerja pencarian dengan menghindari kebutuhan untuk memindai partisi yang tidak relevan ketika memfilter berdasarkan bidang kunci. Jika dibandingkan dengan metode pemfilteran tradisional, kunci partisi dapat sangat meningkatkan kinerja kueri.</p>
<p>Anda dapat menggunakan kunci partisi untuk mengimplementasikan multi-penyewaan. Untuk detail tentang multi-penyewaan, baca <a href="https://milvus.io/docs/multi_tenancy.md">Multi-penyewaan</a> untuk informasi lebih lanjut.</p>
<h2 id="Enable-partition-key" class="common-anchor-header">Mengaktifkan kunci partisi<button data-href="#Enable-partition-key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Untuk menetapkan bidang sebagai kunci partisi, tentukan <code translate="no">partition_key_field</code> saat membuat skema koleksi.</p>
<p>Pada contoh kode di bawah ini, <code translate="no">num_partitions</code> menentukan jumlah partisi yang akan dibuat. Secara default, ini diatur ke <code translate="no">64</code>. Kami sarankan Anda mempertahankan nilai default.</p>
<div class="language-python">
<p>Untuk informasi lebih lanjut tentang parameter, lihat <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_schema.md"><code translate="no">create_schema()</code></a>, dan <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/CollectionSchema/add_field.md"><code translate="no">add_field()</code></a> di referensi SDK.</p>
</div>
<div class="language-java">
<p>Untuk informasi lebih lanjut tentang parameter, lihat <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Client/MilvusClientV2.md"><code translate="no">MilvusClientV2</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createSchema.md"><code translate="no">createSchema()</code></a>, dan <a href="https://milvus.io/api-reference/java/v2.4.x/v2/CollectionSchema/addField.md"><code translate="no">addField()</code></a> dalam referensi SDK.</p>
</div>
<div class="language-javascript">
<p>Untuk informasi lebih lanjut tentang parameter, lihat <a href="https://milvus.io/api-reference/node/v2.4.x/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a> dan <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a> dalam referensi SDK.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Setelah Anda mendefinisikan field, siapkan parameter indeks.</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Terakhir, Anda dapat membuat koleksi.</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<h2 id="List-partitions" class="common-anchor-header">Membuat daftar partisi<button data-href="#List-partitions" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Setelah sebuah field pada koleksi digunakan sebagai kunci partisi, Milvus akan membuat sejumlah partisi yang ditentukan dan mengelolanya atas nama Anda. Oleh karena itu, Anda tidak dapat memanipulasi partisi-partisi di dalam koleksi ini lagi.</p>
<p>Cuplikan berikut ini menunjukkan 64 partisi dalam koleksi setelah salah satu field-nya digunakan sebagai kunci partisi.</p>
<h2 id="Insert-data" class="common-anchor-header">Menyisipkan data<button data-href="#Insert-data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Setelah koleksi siap, mulailah menyisipkan data sebagai berikut:</p>
<h3 id="Prepare-data" class="common-anchor-header">Menyiapkan data</h3><div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Insert-data" class="common-anchor-header">Memasukkan data</h3><div class="language-python">
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Use-partition-key" class="common-anchor-header">Gunakan kunci partisi<button data-href="#Use-partition-key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Setelah Anda mengindeks dan memuat koleksi serta menyisipkan data, Anda dapat melakukan pencarian kemiripan menggunakan kunci partisi.</p>
<div class="language-python">
...
<p><b>Catatan</b></p>
<p>Untuk melakukan pencarian kemiripan menggunakan kunci partisi, Anda harus menyertakan salah satu dari yang berikut ini dalam ekspresi boolean permintaan pencarian:</p>
<ul>
<li><p><code translate="no">expr='&lt;partition_key&gt;=="xxxx"'</code></p></li>
<li><p><code translate="no">expr='&lt;partition_key&gt; in ["xxx", "xxx"]'</code></p></li>
</ul>
<p>Ganti <code translate="no">&lt;partition_key&gt;</code> dengan nama bidang yang ditetapkan sebagai kunci partisi.</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Typical-use-cases" class="common-anchor-header">Kasus penggunaan umum<button data-href="#Typical-use-cases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Anda dapat memanfaatkan fitur kunci partisi untuk mencapai kinerja pencarian yang lebih baik dan mengaktifkan multi-penyewaan. Hal ini dapat dilakukan dengan menetapkan nilai khusus penyewa sebagai bidang kunci partisi untuk setiap entitas. Ketika mencari atau menanyakan koleksi, Anda dapat memfilter entitas berdasarkan nilai khusus penyewa dengan menyertakan bidang kunci partisi dalam ekspresi boolean. Pendekatan ini memastikan isolasi data oleh penyewa dan menghindari pemindaian partisi yang tidak perlu.</p>
