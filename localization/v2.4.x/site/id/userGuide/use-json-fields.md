...
<h3 id="Basic-Operators-in-JSON-Fields" class="common-anchor-header">Operator Dasar dalam Bidang JSON</h3><p>Tabel berikut ini mengasumsikan bahwa nilai bidang JSON bernama <code translate="no">json_key</code> memiliki kunci bernama <code translate="no">A</code>. Gunakan ini sebagai referensi saat membuat ekspresi boolean menggunakan kunci bidang JSON.</p>
<table>
<thead>
...
<h3 id="Advanced-Operators" class="common-anchor-header">Operator Tingkat Lanjut</h3><p>Operator berikut ini khusus untuk bidang JSON:</p>
<ul>
