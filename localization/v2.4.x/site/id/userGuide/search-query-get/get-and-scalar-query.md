...
<h3 id="Step-1-Create-a-collection" class="common-anchor-header">Langkah 1: Membuat koleksi</h3><div class="language-python">
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Insert-randomly-generated-entities" class="common-anchor-header">Langkah 2: Memasukkan entitas yang dibuat secara acak</h3><div class="language-python">
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Create-partitions-and-insert-more-entities" class="common-anchor-header">Langkah 3: Membuat partisi dan menyisipkan lebih banyak entitas</h3><div class="language-python">
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Get-entities-from-partitions" class="common-anchor-header">Mendapatkan entitas dari partisi</h3><p>Anda juga bisa mendapatkan entitas dari partisi tertentu.</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<h3 id="Count-entities" class="common-anchor-header">Menghitung entitas</h3><ul>
...
<h2 id="Reference-on-scalar-filters" class="common-anchor-header">Referensi tentang filter skalar<button data-href="#Reference-on-scalar-filters" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Basic-Operators" class="common-anchor-header">Operator Dasar</h3><p><strong>Ekspresi boolean</strong> selalu <strong>berupa string yang terdiri dari nama field yang digabungkan dengan operator</strong>. Pada bagian ini, Anda akan mempelajari lebih lanjut tentang operator dasar.</p>
<table>
<thead>
...
<h3 id="Advanced-operators" class="common-anchor-header">Operator tingkat lanjut</h3><ul>
