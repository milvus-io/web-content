...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Milvus OperatorによるMilvusスタンドアロンのアップグレード<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>このガイドでは、Milvus OperatorでMilvusスタンドアロンをアップグレードする方法を説明します。</p>
...
<ul>
<li>Milvusをv2.2.3以降のリリースから2.4.13-hotfixにアップグレードするには、<a href="#Conduct-a-rolling-upgrade">ローリングアップグレードを行います</a>。</li>
<li>v2.2.3以前のマイナーリリースから2.4.13-hotfixへMilvusをアップグレードする場合、<a href="#Upgrade-Milvus-by-changing-its-image">Milvusのイメージバージョンを変更してアップグレードする</a>ことをお勧めします。</li>
<li>Milvusをv2.1.xから2.4.13-hotfixにアップグレードする場合、実際のアップグレード前に<a href="#Migrate-the-metadata">メタデータをmilvusに移行</a>する必要があります。</li>
</ul>
