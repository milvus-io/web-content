...
<h4 id="2-Upgrade-Milvus-from-v21x-to-2417" class="common-anchor-header">2.Milvusをv2.1.xから2.4.17にアップグレードする。</h4><p>以下のコマンドは、Milvusをv2.1.4から2.4.17にアップグレードすることを前提としています。必要なバージョンに変更してください。</p>
<ol>
