...
<li>Milvusをv2.1.xから2.4.13-hotfixにアップグレードするには、実際のアップグレードの前に<a href="#Migrate-the-metadata">メタデータをmilvusに移行</a>する必要があります。</li>
</ul>
