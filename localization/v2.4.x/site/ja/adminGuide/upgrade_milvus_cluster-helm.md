...
summary: Helm Chartを使用してMilvusクラスタをアップグレードする方法をご紹介します。
title: MilvusクラスターをHelmチャートでアップグレード
---
...
<h2 id="Check-Milvus-Helm-Chart" class="common-anchor-header">Milvus Helmチャートの確認<button data-href="#Check-Milvus-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h2><p>以下のコマンドを実行して、Milvusの新しいバージョンを確認します。</p>
...
<p>Milvusインスタンスのすべてのデプロイが正常な状態であることを確認したら、以下のコマンドを実行してMilvusインスタンスを2.4.9にアップグレードします。以下のコマンドを実行することで、Milvusインスタンスを2.4.9にアップグレードすることができます。</p>
