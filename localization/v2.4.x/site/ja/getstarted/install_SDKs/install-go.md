...
<h1 id="Install-Milvus-Go-SDK" class="common-anchor-header">Milvus Go SDKのインストール<button data-href="#Install-Milvus-Go-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>このトピックでは、Milvus用のGo SDKのインストール方法について説明します。</p>
<p>現在のバージョンでは、Python、Node.js、GO、JavaのSDKをサポートしています。</p>
<h2 id="Requirement" class="common-anchor-header">必要な環境<button data-href="#Requirement" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>GO (1.17以降) が必要です。</p>
<h2 id="Install-Milvus-GO-SDK" class="common-anchor-header">Milvus GO SDKのインストール<button data-href="#Install-Milvus-GO-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
