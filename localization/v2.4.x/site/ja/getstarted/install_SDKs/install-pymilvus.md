...
<h1 id="Install-Milvus-Python-SDK" class="common-anchor-header">Milvus Python SDKのインストール<button data-href="#Install-Milvus-Python-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本トピックでは、Milvus Python SDK pymilvusのインストール方法について説明します。</p>
...
インストールしたMilvusサーバのバージョンに合ったPyMilvusのバージョンをインストールすることを推奨します。詳細については、<a href="/docs/ja/release_notes.md">リリースノートを</a>参照してください。</div>
