  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>この項目を10に設定すると、Milvusはコレクション作成要求、コレクション削除要求、コレクションロード要求、およびコレクション解放要求を含む、1秒あたり10を超えるコレクション関連DDL要求を処理しないことを示します。</li>      
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>この項目を10に設定すると、Milvusはインデックス作成要求とインデックス削除要求を含め、1秒あたり10を超えるパーティション関連要求を処理しないことを示します。</li>      
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>この項目を10に設定すると、Milvusは毎秒10回を超える手動コンパクション要求を処理しません。</li>      
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>この項目を5に設定すると、Milvusは5MB/秒の速度でのみデータ挿入を許可します。</li>      
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>この項目を5に設定すると、Milvusは任意のコレクションに5 MB/秒のレートでのみデータ挿入を許可します。</li>      
...
<h2 id="quotaAndLimitsdmldeleteRatecollectionmax" class="common-anchor-header"><code translate="no">quotaAndLimits.dml.deleteRate.collection.max</code><button data-href="#quotaAndLimitsdmldeleteRatecollectionmax" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>1秒あたりの最高データ削除レート。</li>      
        <li>この項目を0.1に設定すると、Milvusはどのコレクションからも0.1 MB/秒の速度でのみデータ削除を許可します。</li>      
        <li>この設定を使用するには、同時にquotaAndLimits.dml.enabledをtrueに設定します。</li>      </td>
      <td>-1</td>
    </tr>
  </tbody>
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>この項目を 100 に設定すると、Milvus は、100 個のベクターがすべて 1 回の検索に含まれるか、複数の検索に分散されるかに関係なく、1 秒間に 100 個のベクターしか検索できなくなります。</li>      
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>この項目を 100 に設定すると、Milvus は、100 個のベクターがすべて 1 回の検索に含まれるか、複数の検索に分散されるかに関係なく、コレクションごとに 1 秒あたり 100 個のベクターしか検索できなくなります。</li>      
...
<h2 id="quotaAndLimitsdqlqueryRatemax" class="common-anchor-header"><code translate="no">quotaAndLimits.dql.queryRate.max</code><button data-href="#quotaAndLimitsdqlqueryRatemax" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>1秒あたりの最大クエリー数。</li>      
        <li>この項目を100に設定すると、Milvusは1秒あたり100クエリしか許可しません。</li>      
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>この項目を100に設定すると、Milvusは1秒あたりコレクションあたり100クエリしか許可しません。</li>      
        <li>この設定を使用するには、同時にquotaAndLimits.dql.enabledをtrueに設定してください。</li>      </td>
      <td>-1</td>
    </tr>
  </tbody>
