...
summary: Milvus用パルサーの設定方法をご覧ください。
title: ''
---
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>Pulsarは、Milvus起動時に環境変数PULSAR_ADDRESSから有効なIPアドレスを優先的に取得します。</li>      
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>デフォルトでは、Pulsarは1つのメッセージで最大5MBのデータを送信できます。挿入されたデータのサイズがこの値より大きい場合、プロキシはデータを複数のメッセージに断片化し、正しく送信できるようにします。</li>      
        <li>Pulsarの対応するパラメータが変更されていない場合、この設定を増やすとMilvusは失敗し、減らしても利点はありません。</li>      </td>
      <td>5242880</td>
    </tr>
  </tbody>
</table>
