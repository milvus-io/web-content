...
order: 6
summary: >-
  Milvusは `JinaRerankFunction`
  クラスを通してJinaリランカーモデルをサポートしている。この機能により、クエリとドキュメントのペアの関連性を効果的にスコアリングすることができる。
title: ジーナAI - リランカー
---
...
<p>エンコードに使用するJina AIリランカーモデルの名前。このパラメータを指定しない場合、<code translate="no">jina-reranker-v2-base-multilingual</code> 。利用可能なモデルのリストについては、<a href="https://jina.ai/reranker/#apiform">Jina AIリランカーを</a>参照のこと。</p></li>
<li><p><code translate="no">api_key</code> <em>(文字列</em>)</p>
<p>Jina AI APIにアクセスするためのAPIキー。</p></li>
</ul>
<p>次に、以下のコードを使用して、クエリに基づいて文書を再ランクする：</p>
