...
<p><a href="https://docs.unstructured.io/welcome">Unstructuredは</a>、RAG（Retrieval Augmented Generation）やモデルの微調整のために非構造化ドキュメントを取り込み、処理するためのプラットフォームとツールを提供します。ノーコードUIプラットフォームとサーバーレスAPIサービスの両方を提供し、ユーザーはUnstructuredがホストする計算リソース上でデータを処理できる。</p>
