...
<p><strong>パーティション・キー</strong>機能は、パーティションに基づく検索の最適化で、Zilliz Cloudが特定のスカラー・フィールドの値に基づいてエンティティを異なるパーティションに振り分けることを可能にします。この機能はパーティション指向のマルチテナントの実装に役立ち、検索パフォーマンスを向上させる。</p>
