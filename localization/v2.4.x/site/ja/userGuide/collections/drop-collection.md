...
title: コレクションの削除
---
<h1 id="Drop-Collection​" class="common-anchor-header">コレクションの削除<button data-href="#Drop-Collection​" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>不要になったコレクションを削除することができます。</p>
<h2 id="Examples" class="common-anchor-header">例<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>以下のコード・スニペットでは、<strong>customized_setup_2</strong> という名前のコレクションがあると仮定しています。</p>
