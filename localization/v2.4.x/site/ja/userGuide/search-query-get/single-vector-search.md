...
<p><code translate="no">radius</code> とオプションで<code translate="no">range_filter</code> を設定することで、クエリ・ベクトルにある程度似ているベクトルも含めるように検索の幅を調整することができ、マッチする可能性のあるベクトルをより包括的に表示することができます。</p>
<ul>
