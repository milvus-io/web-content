...
summary: Aprenda a configurar indexCoord para Milvus.
title: ''
---
<h1 id="indexCoord-related-Configurations" class="common-anchor-header">Configuraciones relacionadas con indexCoord<button data-href="#indexCoord-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>        Es un umbral. Cuando el número de filas del segmento es inferior a este valor, el segmento no se indexará      </td>
      <td>1024</td>
    </tr>
  </tbody>
</table>
