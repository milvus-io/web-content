...
summary: Aprenda a configurar el registro para Milvus.
title: ''
---
<h1 id="log-related-Configurations" class="common-anchor-header">Configuraciones relacionadas con el registro<button data-href="#log-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Configura la salida del registro del sistema.</p>
<h2 id="loglevel" class="common-anchor-header"><code translate="no">log.level</code><button data-href="#loglevel" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Nivel de registro de Milvus. Opción: debug, info, warn, error, panic y fatal. </li>      
        <li>Se recomienda utilizar el nivel debug en entornos de prueba y desarrollo, y el nivel info en entornos de producción.</li>      </td>
      <td>info</td>
    </tr>
  </tbody>
</table>
<h2 id="logfilerootPath" class="common-anchor-header"><code translate="no">log.file.rootPath</code><button data-href="#logfilerootPath" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Ruta raíz a los archivos de registro.</li>      
        <li>El valor por defecto está vacío, lo que indica que los archivos de registro se envían a la salida estándar (stdout) y al error estándar (stderr).</li>      
        <li>Si este parámetro se establece en una ruta local válida, Milvus escribe y almacena los archivos de registro en esta ruta.</li>      
        <li>Establezca este parámetro como la ruta en la que tiene permiso para escribir.</li>      </td>
      <td></td>
    </tr>
  </tbody>
</table>
<h2 id="logfilemaxSize" class="common-anchor-header"><code translate="no">log.file.maxSize</code><button data-href="#logfilemaxSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        El tamaño máximo de un archivo de registro, unidad: MB.      </td>
      <td>300</td>
    </tr>
  </tbody>
</table>
<h2 id="logfilemaxAge" class="common-anchor-header"><code translate="no">log.file.maxAge</code><button data-href="#logfilemaxAge" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        El tiempo máximo de retención antes de que un archivo de registro se borre automáticamente, unidad: día. El valor mínimo es 1.  </td>
      <td>10</td>
    </tr>
  </tbody>
</table>
<h2 id="logfilemaxBackups" class="common-anchor-header"><code translate="no">log.file.maxBackups</code><button data-href="#logfilemaxBackups" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        El número máximo de archivos de registro de los que hacer copia de seguridad, unidad: día. El valor mínimo es 1.  </td>
      <td>20</td>
    </tr>
  </tbody>
</table>
<h2 id="logformat" class="common-anchor-header"><code translate="no">log.format</code><button data-href="#logformat" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Formato de registro de Milvus. Opción: text y JSON    </td>
      <td>texto</td>
    </tr>
  </tbody>
</table>
