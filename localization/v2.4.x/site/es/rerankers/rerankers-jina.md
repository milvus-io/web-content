...
<h1 id="Jina-AI" class="common-anchor-header">Jina AI<button data-href="#Jina-AI" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus es compatible con <a href="https://jina.ai/reranker/">los modelos reranker de Jina AI</a> a través de la clase JinaRerankFunction. Esta funcionalidad le permite puntuar la relevancia de los pares consulta-documento de forma eficaz.</p>
