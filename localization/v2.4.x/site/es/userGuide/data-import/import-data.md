...
<h2 id="Import-data" class="common-anchor-header">Importar datos<button data-href="#Import-data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Para importar los datos preparados, debe crear un trabajo de importación como se indica a continuación:</p>
...
<p>Si el archivo <strong>preparado</strong> está en formato JSON, <strong>cada sublista debe contener la ruta a un único archivo JSON preparado</strong>.</p>
...
<h2 id="Check-import-progress" class="common-anchor-header">Comprobar el progreso de la importación<button data-href="#Check-import-progress" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una vez obtenido un ID de trabajo de importación, puede comprobar el progreso de la importación de la siguiente manera:</p>
<pre><code translate="no"><span class="hljs-built_in">export</span> MILVUS_URI=<span class="hljs-string">&quot;localhost:19530&quot;</span>
