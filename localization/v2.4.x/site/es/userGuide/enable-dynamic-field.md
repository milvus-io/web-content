...
<p>Si el nombre de un campo no definido por el esquema contiene caracteres distintos de dígitos, letras y guiones bajos, como signos más (+), asteriscos (*) o signos de dólar ($), tienes que incluir la clave dentro de <strong>$meta[]</strong> como se muestra en el siguiente fragmento de código cuando lo utilices en una expresión booleana o lo incluyas en los campos de salida.</p>
