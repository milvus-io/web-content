...
<h2 id="Configuration​" class="common-anchor-header">Configuración<button data-href="#Configuration​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Para configurar un analizador que utilice el tokenizador <code translate="no">jieba</code>, defina <code translate="no">tokenizer</code> como <code translate="no">jieba</code> en <code translate="no">analyzer_params</code>.</p>
