...
<h2 id="Search-and-query​" class="common-anchor-header">Búsqueda y consulta<button data-href="#Search-and-query​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Los campos array permiten el filtrado escalar durante las búsquedas, mejorando las capacidades de búsqueda vectorial de Milvus. Puede realizar consultas basadas en las propiedades de los campos de matriz junto con las búsquedas de similitud vectorial.</p>
