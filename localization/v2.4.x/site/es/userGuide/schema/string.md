...
<p>Si configura <code translate="no">enable_dynamic_fields=True</code> al definir el esquema, Milvus le permite insertar campos de cadena que no se hayan definido de antemano. Sin embargo, tenga en cuenta que esto puede aumentar la complejidad de las consultas y la gestión, afectando potencialmente al rendimiento. Para más información, consulte <a href="/docs/es/enable-dynammic-field.md">Campo dinámico</a>.</p>
