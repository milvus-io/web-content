...
<h3 id="Install-from-an-exe-file" class="common-anchor-header">Instalar desde un archivo .exe</h3><div class="alert note"> Este método de instalación sólo se aplica a Windows. </div>
