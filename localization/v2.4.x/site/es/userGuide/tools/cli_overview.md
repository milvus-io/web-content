...
<h2 id="Current-version" class="common-anchor-header">Versión actual<button data-href="#Current-version" class="anchor-icon" translate="no">
    ...
    </button></h2><p>La versión actual de Milvus_CLI es 1.0.0. Para encontrar su versión instalada y ver si necesita actualizarla, ejecute <code translate="no">milvus_cli --version</code>.</p>
