...
<button class="copy-code-btn"></button></code></pre>
<h2 id="delete-alias" class="common-anchor-header">borrar alias<button data-href="#delete-alias" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<p><h3 id="delete-index">Opciones</h3></p>
<table>
<thead>
<tr><th style="text-align:left">Opción</th><th style="text-align:left">Nombre completo</th><th style="text-align:left">Descripción</th></tr>
</thead>
...
<p><h3 id="delete-index">Ejemplo</h3></p>
...
<tr><td style="text-align:left">consultar</td><td style="text-align:left">Muestra los resultados de la consulta que coinciden con los criterios introducidos.</td></tr>
