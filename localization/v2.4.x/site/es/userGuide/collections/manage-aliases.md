...
---
<h1 id="Manage-Aliases​" class="common-anchor-header">Gestión de alias<button data-href="#Manage-Aliases​" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Milvus proporciona capacidades de gestión de alias. Esta página muestra los procedimientos para crear, listar, alterar y eliminar alias.</p>
...
<h2 id="Create-Alias​" class="common-anchor-header">Crear alias<button data-href="#Create-Alias​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>El siguiente fragmento de código demuestra cómo crear un alias para una colección.</p>
...
<h2 id="Describe-Alias​" class="common-anchor-header">Describir alias<button data-href="#Describe-Alias​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>El siguiente fragmento de código describe un alias específico en detalle, incluyendo el nombre de la colección a la que ha sido asignado.</p>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#go">Go</a> <a href="#curl">cURL</a></div>
