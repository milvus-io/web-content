...
<h2 id="Set-Collection-TTL​" class="common-anchor-header">Establecer TTL de colección<button data-href="#Set-Collection-TTL​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Si una colección necesita ser eliminada durante un período específico, considere establecer su tiempo de vida (TTL) en segundos. Una vez que el TTL se agota, Zilliz Cloud borra las entidades de la colección y la elimina. El borrado es asíncrono, lo que indica que las búsquedas y consultas siguen siendo posibles antes de que se complete el borrado.</p>
