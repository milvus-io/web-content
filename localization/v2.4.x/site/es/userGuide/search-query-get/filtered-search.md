...
summary: >-
  ...
  filtrado en una solicitud de búsqueda para que Zilliz Cloud lleve a cabo el
  filtrado de metadatos antes de realizar búsquedas RNA, reduciendo el alcance
  de la búsqueda de toda la colección a solo las entidades que coincidan con las
  condiciones de filtrado especificadas.
---
<h1 id="Filtered-Search​" class="common-anchor-header">Búsqueda filtrada<button data-href="#Filtered-Search​" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Una búsqueda RNA encuentra las incrustaciones vectoriales más similares a las incrustaciones vectoriales especificadas. Sin embargo, los resultados de la búsqueda pueden no ser siempre correctos. Puede incluir condiciones de filtrado en una solicitud de búsqueda para que Zilliz Cloud lleve a cabo el filtrado de metadatos antes de realizar las búsquedas RNA, reduciendo el alcance de la búsqueda de toda la colección a sólo las entidades que coincidan con las condiciones de filtrado especificadas.</p>
<h2 id="Overview" class="common-anchor-header">Resumen<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Si una colección contiene tanto incrustaciones vectoriales como sus metadatos, puede filtrar los metadatos antes de la búsqueda RNA para mejorar la relevancia del resultado de la búsqueda. Una vez que Zilliz Cloud recibe una solicitud de búsqueda con una condición de filtrado, restringe el ámbito de la búsqueda dentro de las entidades que coinciden con la condición de filtrado especificada.</p>
<p>
...
<p>Como se muestra en el diagrama anterior, la petición de búsqueda lleva <code translate="no">chunk like % red %</code> como condición de filtrado, indicando que Zilliz Cloud debe realizar la búsqueda RNA dentro de todas las entidades que tengan la palabra <code translate="no">red</code> en el campo <code translate="no">chunk</code>. En concreto, Zilliz Cloud hace lo siguiente</p>
<ul>
<li><p>Filtra las entidades que coinciden con las condiciones de filtrado llevadas en la petición de búsqueda.</p></li>
