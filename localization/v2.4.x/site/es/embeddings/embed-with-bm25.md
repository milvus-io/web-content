...
<p>Cuando utilice <strong>BM25EmbeddingFunction</strong>, tenga en cuenta que las operaciones <strong>encoding_queries()</strong> y <strong>encoding_documents()</strong> no pueden intercambiarse matemáticamente. Por lo tanto, no se dispone de <strong>bm25_ef(texts)</strong> implementado.</p>
