...
<h1 id="Install-Milvus-Go-SDK" class="common-anchor-header">Instalar Milvus Go SDK<button data-href="#Install-Milvus-Go-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este tema describe cómo instalar Milvus Go SDK para Milvus.</p>
<p>La versión actual de Milvus soporta SDKs en Python, Node.js, GO, y Java.</p>
<h2 id="Requirement" class="common-anchor-header">Requisito<button data-href="#Requirement" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Se requiere GO (1.17 o posterior).</p>
<h2 id="Install-Milvus-GO-SDK" class="common-anchor-header">Instalar Milvus GO SDK<button data-href="#Install-Milvus-GO-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Whats-next" class="common-anchor-header">A continuación<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una vez instalado Milvus GO SDK, puede:</p>
<ul>
<li>Aprender las operaciones básicas de Milvus:<ul>
...
<li><a href="/docs/es/v2.4.x/single-vector-search.md">Búsqueda de un solo vector</a></li>
