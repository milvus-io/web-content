...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Install-Milvus-Operator" class="common-anchor-header">2. Instale Milvus Operator</h3><p>Puede instalar Milvus Operator de cualquiera de las siguientes formas:</p>
<ul>
