...
<div class="tab-wrapper"><a href="/docs/es/install_standalone-operator.md" class=''>Milvus Operator</a><a href="/docs/es/install_standalone-helm.md" class='active '>Helm</a><a href="/docs/es/install_standalone-aptyum.md" class=''>DEB/RPM</a></div>
...
<ul>
<li><p>Check <a href="/docs/es/quickstart.md">Hello Milvus</a> to run an example code with different SDKs to see what Milvus can do.</p></li>
