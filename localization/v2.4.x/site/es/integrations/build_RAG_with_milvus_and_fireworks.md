...
<button class="copy-code-btn"></button></code></pre>
<p>Define una función para generar incrustaciones de texto utilizando el cliente. Usamos el modelo <code translate="no">nomic-ai/nomic-embed-text-v1.5</code> como ejemplo.</p>
