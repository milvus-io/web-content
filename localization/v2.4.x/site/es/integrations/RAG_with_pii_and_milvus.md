...
<p>En este tutorial, le mostraremos cómo construir una canalización RAG (Retrieval-Augmented Generation) con Milvus y PII Masker.</p>
<p>Esto protege eficazmente los datos PII.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Mask-the-data-with-PIIMasker" class="common-anchor-header">Enmascarar los datos con PIIMasker</h3><p>Inicialicemos el objeto PIIMasker y carguemos el modelo.</p>
