...
<li>Milvus Standalone es una implementación de servidor de una sola máquina, con todos los componentes agrupados en una sola imagen Docker para una implementación conveniente. <a href="/docs/es/install_standalone-docker.md">Obtenga más información</a>.</li>
