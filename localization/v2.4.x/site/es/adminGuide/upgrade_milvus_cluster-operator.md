...
<button class="copy-code-btn"></button></code></pre>
<p>Luego guarde su configuración como un archivo YAML (por ejemplo, <code translate="no">milvusupgrade.yml</code>) y aplique este archivo de configuración a su instancia de Milvus como sigue:</p>
