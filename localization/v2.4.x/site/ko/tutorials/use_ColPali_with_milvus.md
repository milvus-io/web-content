...
<p>마지막으로 원본 페이지 이름을 검색합니다. ColPali를 사용하면 문서에서 텍스트와 이미지를 추출하기 위한 복잡한 처리 기술 없이도 멀티모달 문서를 검색할 수 있습니다. 대규모 비전 모델을 활용하면 표나 그림과 같은 더 많은 정보를 큰 정보 손실 없이 분석할 수 있습니다.</p>
