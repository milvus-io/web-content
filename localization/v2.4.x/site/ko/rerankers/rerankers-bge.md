...
order: 2
summary: >-
  Milvus는 `BGERerankFunction` 클래스를 통해 BGE 재랭커 모델을 지원합니다. 이 기능을 사용하면 쿼리-문서 쌍의
...
<h1 id="BGE" class="common-anchor-header">BGE<button data-href="#BGE" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus는 <code translate="no">BGERerankFunction</code> 클래스를 통해 <a href="https://github.com/FlagOpen/FlagEmbedding/tree/master/FlagEmbedding/reranker">BGE 재랭커 모델을</a> 지원합니다. 이 기능을 사용하면 쿼리-문서 쌍의 관련성을 효과적으로 점수화할 수 있습니다.</p>
<p>이 기능을 사용하려면 필요한 종속성을 설치하세요:</p>
<pre><code translate="no" class="language-bash">pip install --upgrade pymilvus
pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>그런 다음 <code translate="no">BGERerankFunction</code> 을 인스턴스화합니다:</p>
