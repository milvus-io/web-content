...
<h1 id="Install-Milvus-Go-SDK" class="common-anchor-header">Milvus Go SDK 설치하기<button data-href="#Install-Milvus-Go-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>이 항목에서는 Milvus용 Milvus Go SDK를 설치하는 방법을 설명합니다.</p>
...
<h2 id="Requirement" class="common-anchor-header">요구 사항<button data-href="#Requirement" class="anchor-icon" translate="no">
    ...
    </button></h2><p>GO(1.17 이상)가 필요합니다.</p>
<h2 id="Install-Milvus-GO-SDK" class="common-anchor-header">Milvus GO SDK 설치<button data-href="#Install-Milvus-GO-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p><code translate="no">go get</code> 를 통해 Milvus GO SDK 및 종속 요소를 설치하세요.</p>
