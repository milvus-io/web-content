...
title: 컬렉션 드롭
---
<h1 id="Drop-Collection​" class="common-anchor-header">컬렉션 드롭<button data-href="#Drop-Collection​" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>컬렉션이 더 이상 필요하지 않은 경우 컬렉션을 삭제할 수 있습니다.</p>
<h2 id="Examples" class="common-anchor-header">예제<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>다음 코드 스니펫은 <strong>customized_setup_2라는</strong> 컬렉션이 있다고 가정합니다.</p>
