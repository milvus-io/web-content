...
<h3 id="Install-based-on-Docker-image" class="common-anchor-header">Docker 이미지를 기반으로 설치</h3><pre><code translate="no" class="language-shell">$ docker run -it zilliz/milvus_cli:latest
<button class="copy-code-btn"></button></code></pre>
