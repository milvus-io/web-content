...
<h3 id="Prepare-data" class="common-anchor-header">Подготовка данных</h3><p>В этом разделе вам нужно подготовить несколько случайно сгенерированных данных для последующей вставки.</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Insert-data" class="common-anchor-header">Вставить данные</h3><p>После этого вы можете смело вставлять данные в коллекцию.</p>
<div class="language-python">
...
<p>Если имя не определяемого схемой поля содержит символы, отличные от цифр, букв и знаков подчеркивания, такие как знаки плюс (+), звездочки (*) или доллары ($), то при использовании его в булевом выражении или включении в поля вывода необходимо включить ключ в <strong>$meta[]</strong>, как показано в следующем фрагменте кода.</p>
