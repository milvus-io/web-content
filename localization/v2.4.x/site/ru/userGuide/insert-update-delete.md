...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Insert-into-partitions" class="common-anchor-header">Вставка в разделы</h3><p>Чтобы вставить данные в определенный раздел, вы можете указать имя раздела в запросе на вставку следующим образом:</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
// 
<button class="copy-code-btn"></button></code></pre>
<h3 id="Upsert-data-in-partitions" class="common-anchor-header">Апсертирование данных в разделы</h3><p>Чтобы вставить данные в определенный раздел, вы можете указать имя раздела в запросе на вставку следующим образом:</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
