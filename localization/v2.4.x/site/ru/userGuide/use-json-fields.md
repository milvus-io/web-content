...
<h3 id="Basic-Operators-in-JSON-Fields" class="common-anchor-header">Основные операторы в полях JSON</h3><p>В следующей таблице предполагается, что значение поля JSON с именем <code translate="no">json_key</code> имеет ключ с именем <code translate="no">A</code>. Используйте ее как справочник при построении булевых выражений с использованием ключей полей JSON.</p>
<table>
<thead>
<tr><th><strong>Оператор</strong></th><th><strong>Примеры</strong></th><th><strong>Примечания</strong></th></tr>
</thead>
<tbody>
<tr><td><strong>&lt;</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &lt; 3'</code></td><td>Это выражение принимает значение true, если значение <code translate="no">json_field[&quot;A&quot;]</code> меньше, чем <code translate="no">3</code>.</td></tr>
...
<h3 id="Advanced-Operators" class="common-anchor-header">Расширенные операторы</h3><p>Следующие операторы специфичны для полей JSON:</p>
<ul>
