...
title: 'Подсказка: Узоры поиска Мильвуса'
summary: >-
  Правила для помощников по кодированию ИИ для реализации поиска, гибридного
  поиска и полнотекстового поиска в Milvus.
---
<h1 id="Search-Patterns" class="common-anchor-header">Шаблоны поиска<button data-href="#Search-Patterns" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Правила для реализации поиска по сходству, гибридного поиска, поиска с фильтрацией и полнотекстового поиска в Milvus, включая ограничения AnnSearchRequest и использование ранжировщика. Скопируйте приведенный ниже полный текст подсказки в свой инструмент ИИ, чтобы применять эти правила автоматически. Обзор всех подсказок см. в разделе <a href="/docs/ru/milvus_for_agents.md">Подсказки ИИ</a>.</p>
