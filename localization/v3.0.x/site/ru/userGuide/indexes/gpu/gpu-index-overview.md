...
<p>На следующем рисунке сравнивается производительность запросов (запросы в секунду) для различных конфигураций индексов, аппаратных установок, векторных наборов данных (Cohere и OpenAI) и размеров поисковых партий, и показано, что <code translate="no">GPU_CAGRA</code> постоянно превосходит другие методы.</p>
<p>
