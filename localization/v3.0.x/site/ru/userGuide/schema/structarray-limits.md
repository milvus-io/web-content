...
<tr><td>Сущности после динамического добавления</td><td>Существующие сущности возвращают значение « <code translate="no">null</code> » для добавленного поля StructArray во всех его подполях.</td></tr>
</tbody>
</table>
