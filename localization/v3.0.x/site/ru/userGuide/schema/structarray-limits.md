...
<tr><td><code translate="no">Array</code></td><td>Не поддерживается</td><td>По podpola «Timestamptz» и выражения, зависящие от времени, не поддерживаются в полях StructArray.</td></tr>
...
<tr><td>Поиск по диапазону</td><td>Поддерживается в зависимости от режима поиска и поддержки индексов/метрик целевой версией. Для получения информации о поведении гибридного поиска по диапазону при запросах StructArray на уровне элементов проверьте вашу целевую версию.</td></tr>
