...
<tr><td>Требование к допустимости нулевых значений при динамическом добавлении</td><td>Поле StructArray, добавляемое в существующую коллекцию, должно быть допускать значение null, поскольку у существующих сущностей нет значения для нового поля.</td></tr>
