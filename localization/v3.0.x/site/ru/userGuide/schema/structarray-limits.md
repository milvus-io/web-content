...
<h2 id="Supported-subfield-data-types" class="common-anchor-header">Поддерживаемые типы данных подполей<button data-href="#Supported-subfield-data-types" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Поле-подобра StructArray сопоставляются физическому хранению в виде массива. В следующей таблице приведены поддерживаемые и неподдерживаемые физические типы.</p>
<table>
<thead>
...
<tr><td>Размеры вектора</td><td>Значения вектора должны соответствовать параметру « <code translate="no">dim</code> », настроенному для их подполей вектора.</td></tr>
