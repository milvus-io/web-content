...
<h2 id="What-is-a-primary-field" class="common-anchor-header">Что такое первичное поле?<button data-href="#What-is-a-primary-field" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Первичное поле выступает в качестве уникального ключа для каждой сущности в коллекции, подобно первичному ключу в традиционной базе данных. Milvus использует первичное поле для управления сущностями во время операций вставки, апсерт, удаления и запросов.</p>
...
<h2 id="Quickstart-Use-AutoID" class="common-anchor-header">Быстрый старт: Использование AutoID<button data-href="#Quickstart-Use-AutoID" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Вы можете позволить Milvus генерировать идентификаторы автоматически.</p>
...
<h2 id="Reference-How-AutoID-works" class="common-anchor-header">Ссылка: Как работает AutoID<button data-href="#Reference-How-AutoID-works" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Понимание того, как AutoID генерирует уникальные идентификаторы, поможет вам правильно <a href="/docs/ru/primary-field.md#Ensure-global-AutoID-uniqueness-across-clusters">настроить ID кластера</a> и устранить неполадки, связанные с ID.</p>
