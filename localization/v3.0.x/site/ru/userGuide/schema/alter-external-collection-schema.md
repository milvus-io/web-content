...
<li><p>Можно добавлять только те поля, которые уже существуют во внешнем источнике данных. Эта операция сопоставляет существующее внешнее поле с полем Milvus. Она не создаёт новое поле во внешнем источнике данных и не заполняет исходные данные.</p></li>
