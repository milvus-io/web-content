...
<p>В следующем примере предполагается, что коллекция содержит поле типа массива с именем <code translate="no">array</code>, и задается значение его свойства <code translate="no">max_capacity</code>.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
