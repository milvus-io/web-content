...
<p>В следующей таблице приведены общие проблемы, возникающие из-за неправильного выбора анализатора, и предлагаются практические решения для диагностики проблем поиска.</p>
<table>
   <tr>
     <th><p>Проблема</p></th>
     <th><p>Симптом</p></th>
...
<table>
   ...
   <tr>
     <td><p>Языки, разделенные пробелами, такие как французский/испанский текст</p></td>
...
<div class="alert note">
<p>Для восточноазиатских языков (китайского, японского, корейского и т. д.) используйте <a href="/docs/ru/choose-the-right-analyzer-for-your-use-case.md#Language-specific-filters">фильтры, ориентированные на конкретный язык</a>. Эти языки обычно используют другие подходы к обработке текстов и не могут получить значительной пользы от стемминга.</p>
</div>
...
<table>
   ...
   <tr>
     ...
     <td><p>Очищает вывод токенизаторов <code translate="no">jieba</code>, <code translate="no">lindera</code>, <code translate="no">icu</code>, которые возвращают знаки препинания в виде отдельных лексем</p></td>
...
<p>Для лучшего контроля над поведением лексем в разных языках:</p>
<ul>
