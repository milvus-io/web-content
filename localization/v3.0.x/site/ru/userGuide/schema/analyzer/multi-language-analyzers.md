...
summary: >-
  ...
  «запутаться»: он может игнорировать акцент и не применять специфическую для
  испанского языка стеминг-обработку, из-за чего релевантные результаты будут
  упущены.
beta: Milvus 2.5.11+
---
...
<li><p><strong>Поле вектора</strong> (<code translate="no">sparse</code>): В этом поле будут храниться разреженные векторы, сгенерированные функцией BM25. Эти векторы представляют собой форму ваших текстовых данных, пригодную для анализа, и именно по ним Milvus фактически осуществляет поиск.</p></li>
</ul>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
...
<button class="copy-code-btn"></button></code></pre>
<p>Эта функция автоматически применяет соответствующий анализатор к каждой текстовой записи на основе идентификатора языка. Для получения дополнительной информации о поиске текста на основе BM25 см. раздел <a href="/docs/ru/full-text-search.md">«Полнотекстовый поиск</a>».</p>
...
<li><p><code translate="no">params={&quot;drop_ratio_search&quot;: &quot;0&quot;}</code> управляет поведением, специфичным для BM25; в данном случае он сохраняет все термины в поиске. Для получения дополнительной информации см. раздел <a href="/docs/ru/sparse_vector.md">«Редкий вектор</a>».</p></li>
</ul>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
