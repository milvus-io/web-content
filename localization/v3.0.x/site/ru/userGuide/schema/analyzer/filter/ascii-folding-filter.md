...
summary: >-
  Фильтр asciifolding преобразует символы за пределами блока Basic Latin Unicode
  (первые 127 символов ASCII) в их эквиваленты ASCII. Например, он преобразует
  символы типа í в i, что упрощает обработку текста и делает ее более
  последовательной, особенно для многоязычного контента.
---
...
<button class="copy-code-btn"></button></code></pre>
<p>Фильтр <code translate="no">asciifolding</code> работает с терминами, сгенерированными токенизатором, поэтому он должен использоваться в сочетании с токенизатором. Список токенизаторов, доступных в Milvus, см. на странице <a href="/docs/ru/standard-tokenizer.md">Standard Tokenizer</a> и других страницах.</p>
