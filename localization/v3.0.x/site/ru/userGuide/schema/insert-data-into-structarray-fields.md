...
<tr><td>Размеры векторов должны совпадать.</td><td>Значения векторов должны соответствовать параметрам « <code translate="no">dim</code> », настроенным для их векторных подполей.</td></tr>
...
<li><p>Чтобы выполнить поиск по векторным подполям StructArray, ознакомьтесь с разделом «Базовый поиск по векторам с использованием StructArray».</p></li>
