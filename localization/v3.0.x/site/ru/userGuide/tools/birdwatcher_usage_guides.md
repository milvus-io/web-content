...
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-sessions" class="common-anchor-header">Список сессий<button data-href="#List-sessions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Чтобы перечислить сессии, связанные с различными компонентами Milvus:</p>
...
<h3 id="Check-databases-and-collections" class="common-anchor-header">Проверка баз данных и коллекций<button data-href="#Check-databases-and-collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Вы можете перечислить все базы данных и коллекции.</p>
<ul>
...
<h3 id="Check-index-details" class="common-anchor-header">Проверка сведений об индексе<button data-href="#Check-index-details" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Выполните следующую команду, чтобы получить подробный список всех индексных файлов.</p>
...
==================================================================
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-partitions" class="common-anchor-header">Список разделов<button data-href="#List-partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Выполните следующую команду, чтобы перечислить все разделы в определенной коллекции.</p>
...
--- Total Database(s): 1
<button class="copy-code-btn"></button></code></pre>
<h3 id="Check-channel-status" class="common-anchor-header">Проверить состояние канала<button data-href="#Check-channel-status" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Выполните следующую команду, чтобы просмотреть состояние канала.</p>
...
--- Total Channels: 1
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-all-replicas-and-segments" class="common-anchor-header">Список всех реплик и сегментов<button data-href="#List-all-replicas-and-segments" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="List-configurations" class="common-anchor-header">Список конфигураций<button data-href="#List-configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Вы можете попросить Birdwatcher вывести список текущих конфигураций каждого компонента Milvus.</p>
...
<h3 id="Probe-collection-with-known-primary-key" class="common-anchor-header">Зондирование коллекции с известным первичным ключом<button data-href="#Probe-collection-with-known-primary-key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>В команде <code translate="no">probe</code> необходимо указать первичный ключ, используя флаг <code translate="no">pk</code>, и идентификатор коллекции, используя флаг <code translate="no">collection</code>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Probe-all-collections-with-mock-queries" class="common-anchor-header">Проверка всех коллекций с помощью имитационных запросов<button data-href="#Probe-all-collections-with-mock-queries" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Вы также можете попросить Birdwatcher исследовать все коллекции с помощью имитационных запросов.</p>
