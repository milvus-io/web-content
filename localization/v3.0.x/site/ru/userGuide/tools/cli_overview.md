...
<h2 id="Current-version" class="common-anchor-header">Текущая версия<button data-href="#Current-version" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Текущая версия Milvus_CLI - 1.2.1. Чтобы узнать, какая версия у вас установлена, и проверить, не требуется ли обновление, выполните команду <code translate="no">milvus_cli --version</code>.</p>
