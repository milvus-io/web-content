...
<h3 id="Install-via-pip" class="common-anchor-header">Установка через pip<button data-href="#Install-via-pip" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Выполните следующую команду для установки Milvus_CLI.</p>
...
<h3 id="Prerequisites" class="common-anchor-header">Необходимые условия .<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Требуется Docker 19.03 или более поздняя версия.</p>
<h3 id="Install-based-on-Docker-image" class="common-anchor-header">Установка на основе образа Docker<button data-href="#Install-based-on-Docker-image" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Install-from-an-exe-file" class="common-anchor-header">Установка из файла .exe<button data-href="#Install-from-an-exe-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><div class="alert note"> Этот способ установки применим только для Windows. </div>
