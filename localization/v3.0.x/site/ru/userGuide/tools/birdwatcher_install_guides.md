...
<h3 id="Prepare-deploymentyml" class="common-anchor-header">Подготовьте deployment.yml<button data-href="#Prepare-deploymentyml" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Apply-deploymentyml" class="common-anchor-header">Применить deployment.yml<button data-href="#Apply-deploymentyml" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Сохраните приведенный выше YAML в файле и назовите его <code translate="no">deployment.yml</code>, а затем выполните следующую команду</p>
