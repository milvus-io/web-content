...
<ul>
<li><p><a href="/docs/ru/set-collection-ttl.md#Set-TTL-when-creating-a-collection">Создании коллекции.</a></p></li>
<li><p><a href="/docs/ru/set-collection-ttl.md#Set-TTL-for-an-existing-collection">Изменить свойство TTL существующей коллекции.</a></p></li>
</ul>
