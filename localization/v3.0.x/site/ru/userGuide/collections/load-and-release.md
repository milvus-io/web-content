...
<h1 id="Load--Release" class="common-anchor-header">Загрузка и освобождение<button data-href="#Load--Release" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Загрузка коллекции является необходимым условием для проведения поиска и запросов по сходству в коллекциях. Эта страница посвящена процедурам загрузки и освобождения коллекции.</p>
