...
<p>В данной интеграции используется размещённый на хостинге маршрутизатор Hugging Face. Чтобы выполнить переранжирование с помощью отдельно развернутого сервиса Text Embeddings Inference (TEI), см. <a href="/docs/ru/tei-ranker.md">TEI Ranker</a>.</p>
