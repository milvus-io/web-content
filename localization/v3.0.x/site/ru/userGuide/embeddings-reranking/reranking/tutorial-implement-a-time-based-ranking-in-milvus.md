...
summary: >-
  ...
  руководстве показано, как реализовать ранжирование на основе времени в Milvus
  с помощью ранжировщиков распада.
beta: Milvus 2.6.x
---
...
<li><p><strong>Экспоненциальный</strong> (<code translate="no">exp</code>): Создает более резкий начальный спад для сильного акцентирования недавнего контента</p></li>
...
<h2 id="Step-6-Visualize-the-decay-rankers" class="common-anchor-header">Шаг 6: Визуализация ранжировщиков распада<button data-href="#Step-6-Visualize-the-decay-rankers" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Прежде чем выполнять поиск, давайте создадим визуальное сравнение того, как ведут себя эти по-разному настроенные ранжировщики распада:</p>
