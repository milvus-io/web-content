...
<h2 id="Choose-an-embedding-model" class="common-anchor-header">Выберите модель встраивания<button data-href="#Choose-an-embedding-model" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus поддерживает модели встраивания, предоставляемые Google Gemini. Ниже приведены доступные в настоящее время модели встраивания Gemini для быстрого ознакомления:</p>
<table>
   <tr>
