...
<tr><td>Типичное использование</td><td>ColBERT, ColPali и другие шаблоны поиска с поздним взаимодействием.</td><td>Поиск на уровне фрагментов, абзацев, клипов, участков или фактов.</td></tr>
</tbody>
</table>
