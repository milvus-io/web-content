...
<tr><td>Является ли пространство вложений малоразличающим?</td><td>Кандидаты ANN на уровне токенов содержат много шума, а метод случайной проекции не сохраняет достаточно сигнала.</td><td><code translate="no">lemur</code></td></tr>
