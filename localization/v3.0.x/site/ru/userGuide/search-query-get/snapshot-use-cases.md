...
<button class="copy-code-btn"></button></code></pre>
<p>После завершения обновления можно создать индексы, загрузить внешнюю коллекцию и выполнить операции поиска или запроса по представлению, основанному на моментальном снимке.</p>
