...
<p>ColBERT (arXiv: <a href="https://arxiv.org/abs/2004.12832">2004.12832</a>) - это система текстового поиска, которая предлагает эффективный и результативный поиск отрывков с помощью контекстуализированного позднего взаимодействия через BERT. Она позволяет независимо кодировать запросы и документы с помощью токенов и вычислять их сходство.</p>
...
<h3 id="Step-3-Group-paragraphs-by-title" class="common-anchor-header">Шаг 3: Группировка абзацев по названию<button data-href="#Step-3-Group-paragraphs-by-title" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Чтобы искать документы, а не абзацы, нам следует сгруппировать абзацы по заголовку.</p>
