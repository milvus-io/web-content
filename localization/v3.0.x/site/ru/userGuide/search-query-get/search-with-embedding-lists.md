...
<h3 id="Step-6-Search-within-the-Cohere-dataset" class="common-anchor-header">Шаг 6: Поиск в наборе данных Cohere<button data-href="#Step-6-Search-within-the-Cohere-dataset" class="anchor-icon" translate="no">
    ...
    </button></h3><p>В соответствии с дизайном ColBERT, текст запроса должен быть токенизирован, а затем встроен в EmbeddingList. На этом шаге мы используем ту же модель, которую Cohere использовал для генерации вкраплений для абзацев в наборе данных Wikipedia.</p>
