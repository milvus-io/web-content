...
summary: >-
  ...
  для каждой корзины, отсортировать корзины и вернуть репрезентативные
  результаты.
beta: Milvus 3.0.x
---
...
<p>If your goal is only to improve result diversity by returning one or more entities per field value, use <a href="/docs/ru/grouping-search.md">Grouping Search</a> instead.</p>
...
<tbody>
<tr><td>Return a standard ranked entity list with fewer repeated values in a grouping field</td><td><a href="/docs/ru/grouping-search.md">Grouping Search</a></td><td>Flat search hits for each query vector</td></tr>
