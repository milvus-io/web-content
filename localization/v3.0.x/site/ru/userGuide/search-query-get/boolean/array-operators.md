...
<tr><td><a href="/docs/ru/array-operators.md#ARRAYREMOVE">ARRAY_REMOVE</a></td><td><code translate="no">upsert</code> с <code translate="no">field_ops</code></td><td>Удаляет из существующего поля ARRAY все элементы, которые соответствуют значению в полезных данных запроса. Доступно в Milvus версии 2.6.17 и выше.</td></tr>
</tbody>
</table>
