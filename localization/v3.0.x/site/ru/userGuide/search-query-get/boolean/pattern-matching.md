...
summary: >-
  ...
  кодов, доменов электронной почты, путей URL и других шаблонов строк в полях
  типа VARCHAR, путях строк JSON или элементах массива ARRAY.
---
...
<tr><td>Сопоставление шаблонов без учета регистра</td><td><code translate="no">=~</code> с <code translate="no">(?i)</code></td><td><code translate="no">message =~ &quot;(?i)error&quot;</code></td><td>Находит <code translate="no">error</code>, <code translate="no">ERROR</code> или другие варианты с разным регистром.</td></tr>
