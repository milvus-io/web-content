...
<li><code translate="no">&quot;binary&quot;</code>: Используйте это значение, если вы хотите получить подписанные бинарные вложения. Действительно только для моделей v3.</li>
