...
<p>Milvus интегрируется с моделью встраивания mGTE через класс MGTEEmbeddingFunction. Этот класс предоставляет методы для кодирования документов и запросов с помощью модели встраивания mGTE и возвращает вложения в виде плотных и разреженных векторов, совместимых с индексацией Milvus.</p>
