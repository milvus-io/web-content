...
<p><strong>Что нового в v3.0-beta:</strong></p>
<ul>
...
<p>Всегда загружайте последнюю версию конфигурации Docker Compose, чтобы обеспечить совместимость с функциями v3.0-beta.</p>
<ul>
