...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Загрузите пакет RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Вы можете скачать пакет RPM/DEB, соответствующий архитектуре вашей системы, со <a href="https://github.com/milvus-io/milvus/releases/tag/v3.0.2">страницы «Выпуски Milvus</a>».</p>
<ul>
<li>Для x86_64/amd64 скачайте пакет <strong>milvus_3.0.2-1_amd64.deb</strong> или <strong>milvus_3.0.2-1_amd64.rpm</strong>.</li>
<li>Для ARM64 загрузите пакет <strong>milvus_3.0.2-1_arm64.deb</strong> или <strong>milvus_3.0.2-1_arm64.rpm</strong>.</li>
</ul>
...
<p>По умолчанию автономная версия Milvus использует <strong>Woodpecker</strong> (локальную файловую систему) в качестве очереди сообщений со встроенным etcd, поэтому никаких внешних служб обмена сообщениями или метаданными не требуется. См. раздел <a href="/docs/ru/woodpecker.md">«Woodpecker</a>».</p>
</div>
...
<h2 id="Uninstall-Milvus-Standalone" class="common-anchor-header">Удаление Milvus Standalone<button data-href="#Uninstall-Milvus-Standalone" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Для удаления Milvus Standalone можно использовать следующую команду:</p>
