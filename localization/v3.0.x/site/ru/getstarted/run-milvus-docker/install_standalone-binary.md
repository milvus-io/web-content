...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Загрузите пакет RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Вы можете скачать пакет RPM/DEB, соответствующий архитектуре вашей системы, со <a href="https://github.com/milvus-io/milvus/releases/tag/v3.0.1">страницы «Выпуски Milvus</a>».</p>
<ul>
<li>Для x86_64/amd64 загрузите пакет <strong>milvus_3.0.1-1_amd64.deb</strong> или <strong>milvus_3.0.1-1_amd64.rpm</strong>.</li>
<li>Для ARM64 загрузите пакет <strong>milvus_3.0.1-1_arm64.deb</strong> или <strong>milvus_3.0.1-1_arm64.rpm</strong>.</li>
</ul>
...
<h2 id="Install-the-RPMDEB-Package" class="common-anchor-header">Установка пакета RPM/DEB<button data-href="#Install-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Для установки пакета RPM/DEB можно использовать менеджер пакетов вашей системы.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Если Milvus работает корректно, вы должны увидеть следующий вывод:</p>
