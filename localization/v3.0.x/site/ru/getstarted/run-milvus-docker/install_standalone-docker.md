...
<p><strong>Что нового в версии 3.0.1:</strong></p>
<ul>
...
<p>Всегда загружайте последнюю версию скрипта, чтобы получить самые свежие настройки и архитектурные улучшения.</p>
...
<ul>
<li>Загружает последний сценарий установки с обновленными настройками</li>
...
<h2 id="Optional-dependencies" class="common-anchor-header">Необязательные зависимости<button data-href="#Optional-dependencies" class="anchor-icon" translate="no">
    ...
    </button></h2><p>По умолчанию в этом развёртывании в качестве очереди сообщений используется <strong>Woodpecker</strong> (WAL в локальной файловой системе), а для метаданных — <strong>встроенный etcd</strong> — ничего больше устанавливать не нужно. Чтобы использовать другую очередь сообщений или подключить внешнее хранилище объектов / метаданных, см.:</p>
<ul>
...
<li><a href="/docs/ru/insert-update-delete.md">Вставка, обновление с условием и удаление</a></li>
