...
<ul>
<li><strong>Очередь сообщений</strong>: <a href="/docs/ru/use-woodpecker.md">используется Woodpecker</a> (упрощает обслуживание инфраструктуры)</li>
...
<p>Как только кластер Milvus будет готов, статус всех под в кластере Milvus должен выглядеть примерно так.</p>
