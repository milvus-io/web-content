...
<p>В идеале ваш диск должен обеспечивать более 500 IOPS и задержку fsync в 99-м процентиле не более 10 мс. Более подробные требования см. в <a href="https://etcd.io/docs/v3.5/op-guide/hardware/#disks">документации</a> etcd.</p>
