...
<ul>
<li><strong>Очередь сообщений</strong>: теперь рекомендуется использовать <strong>Woodpecker</strong> (снижает затраты на обслуживание инфраструктуры по сравнению с Pulsar)</li>
