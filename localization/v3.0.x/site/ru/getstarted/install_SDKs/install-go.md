...
<h1 id="Install-Milvus-Go-SDK" class="common-anchor-header">Установка Milvus Go SDK<button data-href="#Install-Milvus-Go-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>В этой теме описывается, как установить Milvus Go SDK для Milvus.</p>
...
<h2 id="Requirement" class="common-anchor-header">Требование<button data-href="#Requirement" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Требуется GO (1.17 или более поздняя версия).</p>
<h2 id="Install-Milvus-GO-SDK" class="common-anchor-header">Установите Milvus GO SDK<button data-href="#Install-Milvus-GO-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
