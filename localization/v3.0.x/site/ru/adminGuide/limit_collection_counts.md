...
title: Установите ограничения на количество коллекций
---
...
<button class="copy-code-btn"></button></code></pre>
<p>Чтобы избежать этой ошибки, вы можете либо уменьшить количество осколков или разделов в существующих или новых коллекциях, либо удалить некоторые коллекции, либо увеличить лимит коллекций, изменив вместе <code translate="no">maxGeneralCapacity</code>, <code translate="no">maxCollectionNum</code> и <code translate="no">maxCollectionNumPerDB</code>.</p>
