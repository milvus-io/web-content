...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Обновление Milvus Standalone с помощью Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>В этом руководстве описано, как обновить автономное развертывание Milvus с версии 2.5.x до версии 2.6.15 с помощью Milvus Operator.</p>
...
<li>Перед переходом на v2.6.15 <strong>необходимо</strong> обновить версию до v2.5.16 или более поздней.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2615" class="common-anchor-header">2.2 Обновление до v2.6.15</h4><p>После успешной работы v2.5.16 перейдите на v2.6.15:</p>
