...
<h2 id="Upgrade-process" class="common-anchor-header">Процесс обновления<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Back-up-the-current-Milvus-CR" class="common-anchor-header">Шаг 1: Создайте резервную копию текущего CR Milvus<button data-href="#Step-1-Back-up-the-current-Milvus-CR" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Step-3-Update-the-Milvus-image" class="common-anchor-header">Шаг 3: Обновите образ Milvus<button data-href="#Step-3-Update-the-Milvus-image" class="anchor-icon" translate="no">
    ...
    </button></h3><p>В полном манифесте CR Milvus изменяйте только <code translate="no">spec.components.image</code>. Сохраните существующие настройки режима, компонентов, очереди сообщений, etcd, хранилища и других зависимостей. В следующем фрагменте показано поле, которое необходимо изменить; не заменяйте весь ваш CR этим фрагментом.</p>
