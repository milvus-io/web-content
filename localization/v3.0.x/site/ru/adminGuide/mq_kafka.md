...
title: Кафка
---
<h1 id="Use-Kafka-as-the-Milvus-Message-Queue" class="common-anchor-header">Использование Kafka в качестве очереди сообщений для Milvus<button data-href="#Use-Kafka-as-the-Milvus-Message-Queue" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
Если вы используете Kafka и хотите сохранить его, не меняйте систему очередей сообщений во время обновления.</li>
