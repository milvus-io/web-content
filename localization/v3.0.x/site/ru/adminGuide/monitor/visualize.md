...
<h2 id="Visualize-metrics-using-Grafana" class="common-anchor-header">Визуализация метрик с помощью Grafana<button data-href="#Visualize-metrics-using-Grafana" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Download-and-import-dashboard" class="common-anchor-header">1. Скачайте и импортируйте дашборд<button data-href="#1-Download-and-import-dashboard" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Загрузите и импортируйте дашборд Milvus из файла JSON.</p>
...
<h3 id="2-View-metrics" class="common-anchor-header">2. Просмотр метрик<button data-href="#2-View-metrics" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Выберите экземпляр Milvus, который вы хотите отслеживать. После этого вы увидите панель компонентов Milvus.</p>
<p>
