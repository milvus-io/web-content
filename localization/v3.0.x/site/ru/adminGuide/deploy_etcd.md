...
<h2 id="Configure-etcd-with-Docker-Compose" class="common-anchor-header">Настройка etcd с помощью Docker Compose<button data-href="#Configure-etcd-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Configure-etcd" class="common-anchor-header">1. Настройка etcd<button data-href="#1-Configure-etcd" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Чтобы настроить etcd с помощью Docker Compose, укажите значения для секции <code translate="no">etcd</code> в файле <code translate="no">milvus.yaml</code> по пути milvus/configs.</p>
...
<h3 id="2-Run-Milvus" class="common-anchor-header">2. Запустите Milvus<button data-href="#2-Run-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Выполните следующую команду, чтобы запустить Milvus, который использует конфигурации etcd.</p>
...
<tr><td><code translate="no">externalEtcd.enabled</code></td><td>Включает или выключает внешние etcd.</td><td><code translate="no">true</code>/<code translate="no">false</code></td></tr>
...
<h3 id="Using-a-command" class="common-anchor-header">Использование команды<button data-href="#Using-a-command" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Чтобы установить Milvus и настроить etcd, выполните следующую команду, используя ваши значения.</p>
