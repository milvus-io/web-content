...
<h3 id="Internal-object-storage" class="common-anchor-header">Внутреннее хранилище объектов<button data-href="#Internal-object-storage" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>По умолчанию Milvus Operator развертывает внутрикластерное MinIO для Milvus. Ниже приведен пример конфигурации, демонстрирующий использование этого MinIO в качестве внутреннего хранилища объектов.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>После применения вышеуказанной конфигурации внутрикластерное MinIO будет работать в автономном режиме с ограничением по памяти до 100Mi. Обратите внимание, что</p>
<ul>
...
<h3 id="External-object-storage" class="common-anchor-header">Внешнее хранилище объектов<button data-href="#External-object-storage" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
