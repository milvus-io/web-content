...
<h2 id="Switch-from-RocksMQ-to-Woodpecker" class="common-anchor-header">Переключение с RocksMQ на Woodpecker<button data-href="#Switch-from-RocksMQ-to-Woodpecker" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
