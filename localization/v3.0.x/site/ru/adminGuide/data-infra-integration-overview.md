...
summary: >-
  Обзор систем хранения метаданных, объектного хранилища и очередей сообщений,
...
<li><strong><a href="/docs/ru/object-storage.md">Объектное хранилище</a></strong> — Milvus хранит файлы индексов и двоичные журналы в MinIO, AWS S3 или других S3-совместимых облачных объектных хранилищах.</li>
