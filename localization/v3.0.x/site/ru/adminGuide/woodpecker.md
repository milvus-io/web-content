...
summary: >-
  ...
  (WAL) в Milvus, а также как запустить его в встроенном режиме или в режиме
  службы.
---
...
<ul>
<li><strong>Записи с кворумом за один RTT</strong> — репликация, управляемая клиентом, завершает запись с кворумом за один цикл обмена данными, при этом меж-AZ трафик фиксирован на уровне объема данных двух реплик (по сравнению с дополнительным ~1/3 меж-AZ трафика, типичным для репликации на основе брокера/лидера).</li>
