...
<ul>
<li><strong>Записи с кворумом за один RTT</strong> — репликация, управляемая клиентом, завершает запись с кворумом за один цикл обмена данными, при этом трафик между зонами ограничивается объемом данных, соответствующим двум репликам (в отличие от дополнительного трафика между зонами, составляющего примерно 1/3, характерного для репликации на основе брокера или лидера).</li>
