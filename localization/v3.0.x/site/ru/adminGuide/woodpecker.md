...
<li>Он поддерживает три режима хранения данных ( <code translate="no">storage.type</code> ): объектное хранилище (<code translate="no">minio</code>, по умолчанию), локальная файловая система (<code translate="no">local</code>) и выделенное хранилище ( <code translate="no">service</code>). См. раз <a href="#Deployment-modes">дел «Режимы развертывания</a>».</li>
</ul>
