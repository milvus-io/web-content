...
<li><p>Чтобы изменить очередь сообщений для запущенного экземпляра, см. раздел «Смена типа MQ» (поддерживается начиная с версии v2.6.14).</p></li>
</ul>
</div>
...
<li><strong>Существующие пользователи Pulsar или Kafka:</strong> Pulsar и Kafka по-прежнему полностью поддерживаются. Можно оставить их или перейти на Woodpecker.</li>
<li><strong>RocksMQ:</strong> только для автономного режима; в Milvus 3.x его заменил встроенный Woodpecker.</li>
</ul>
