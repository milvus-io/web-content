...
<h1 id="queryCoord-related-Configurations" class="common-anchor-header">Конфигурации, связанные с queryCoord<button data-href="#queryCoord-related-Configurations" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Связанная конфигурация queryCoord, используемая для управления топологией и балансировкой нагрузки для узлов запроса, а также для передачи от растущих сегментов к закрытым сегментам.</p>
