...
<p>Любое событие, независимо от того, DDL это или DML, помечается временной меткой, которая может указать, когда это событие произошло.</p>
...
<li>Познакомьтесь с концепцией <a href="/docs/ru/timestamp.md">временной метки</a>.</li>
