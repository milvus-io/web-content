...
<li><a href="https://milvus.io/blog/why-we-built-loon-a-storage-engine-for-ai-data-that-never-stops-changing.md">Почему мы создали Loon: механизм хранения данных для ИИ, которые постоянно меняются</a> — техническое обоснование мотивов проектирования Storage V3.</li>
</ul>
