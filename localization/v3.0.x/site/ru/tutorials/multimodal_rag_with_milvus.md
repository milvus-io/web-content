...
<p>Если вы хотите увидеть конечный результат этого руководства, можете сразу перейти к <a href="https://demos.milvus.io/multimodal-image-search/">онлайн-демо</a>.</p>
...
<p>В этом руководстве представлена мультимодальная система RAG, работающая на базе Milvus, <a href="https://github.com/FlagOpen/FlagEmbedding/tree/master/FlagEmbedding/visual">визуализированной модели BGE</a> и <a href="https://openai.com/index/hello-gpt-4o/">GPT-4o</a>. С помощью этой системы пользователи могут загружать изображения и редактировать текстовые инструкции, которые обрабатываются составной моделью поиска BGE для подбора подходящих изображений. Затем GPT-4o выступает в роли реранкера, выбирая наиболее подходящее изображение и предоставляя обоснование своего выбора. Эта мощная комбинация обеспечивает плавный и интуитивный поиск изображений, используя Milvus для эффективного поиска, модель BGE для точной обработки и сопоставления изображений, а также GPT-4o для расширенного переранжирования.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p><strong>2. Построить энкодер</strong></p>
...
<h2 id="Load-Data" class="common-anchor-header">Загрузка данных<button data-href="#Load-Data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>В этом разделе мы загрузим примеры изображений в базу данных с соответствующими вложениями.</p>
...
<h2 id="Multimodal-Search-with-Generative-Reranker" class="common-anchor-header">Мультимодальный поиск с генеративным реранкером<button data-href="#Multimodal-Search-with-Generative-Reranker" class="anchor-icon" translate="no">
    ...
    </button></h2><p>В этом разделе мы сначала выполним поиск релевантных изображений по мультимодальному запросу, а затем воспользуемся сервисом LLM для переранжирования результатов и выбора лучшего из них с объяснением.</p>
...
<p>Мы отправим объединенное изображение в мультимодальный сервис LLM вместе с соответствующими подсказками для ранжирования найденных результатов с объяснением. Чтобы использовать GPT-4o в качестве LLM, вам необходимо подготовить <a href="https://platform.openai.com/docs/quickstart">ключ API OpenAI</a>.</p>
