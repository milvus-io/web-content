...
<h2 id="Prerequisites" class="common-anchor-header">Необходимые условия<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Clone-the-Repository" class="common-anchor-header">Клонировать репозиторий<button data-href="#Clone-the-Repository" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Клонируйте исходный код Dify на свою локальную машину:</p>
<pre><code translate="no" class="language-shell">git clone https://github.com/langgenius/dify.git
<button class="copy-code-btn"></button></code></pre>
<h3 id="Prepare-Environment-Configuration" class="common-anchor-header">Подготовьте конфигурацию среды<button data-href="#Prepare-Environment-Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Перейдите в каталог Docker в исходном коде Dify.</p>
...
<h2 id="Deployment-Options" class="common-anchor-header">Варианты развертывания<button data-href="#Deployment-Options" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Вы можете развернуть Dify с помощью Milvus, используя два разных подхода. Выберите тот, который лучше всего соответствует вашим потребностям:</p>
...
<h3 id="Configure-Environment-Variables" class="common-anchor-header">Настройте переменные окружения<button data-href="#Configure-Environment-Variables" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Отредактируйте файл <code translate="no">.env</code> со следующей конфигурацией Milvus:</p>
...
<h3 id="Start-the-Docker-Containers" class="common-anchor-header">Запуск контейнеров Docker<button data-href="#Start-the-Docker-Containers" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Запустите контейнеры с профилем <code translate="no">milvus</code>, чтобы включить службы Milvus:</p>
...
<h3 id="Configure-Environment-Variables" class="common-anchor-header">Настройте переменные окружения<button data-href="#Configure-Environment-Variables" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Отредактируйте файл <code translate="no">.env</code>, указав данные подключения к Zilliz Cloud:</p>
...
<h3 id="Start-the-Docker-Containers" class="common-anchor-header">Запуск контейнеров Docker<button data-href="#Start-the-Docker-Containers" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Запустите только контейнеры Dify без профиля Milvus:</p>
...
<h2 id="Accessing-Dify" class="common-anchor-header">Доступ к Dify<button data-href="#Accessing-Dify" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Log-in-to-Dify" class="common-anchor-header">Войдите в Dify<button data-href="#Log-in-to-Dify" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Откройте браузер и перейдите на страницу установки Dify, здесь вы можете установить учетную запись администратора:<code translate="no">http://localhost/install</code>, а затем войти на главную страницу Dify для дальнейшего использования.</p>
