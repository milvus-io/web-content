...
<h3 id="Support" class="common-anchor-header">Поддержка<button data-href="#Support" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Если вам нужна помощь или у вас есть вопросы по коннектору Kafka Connect Milvus Connector, пожалуйста, обращайтесь к сопровождающему коннектора: <strong>Email:</strong> <a href="mailto:support@zilliz.com">support@zilliz.com</a></p>
