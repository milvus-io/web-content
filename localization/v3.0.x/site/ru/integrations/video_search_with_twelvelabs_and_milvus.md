...
<button class="copy-code-btn"></button></code></pre>
<p>В этом коде мы сначала проверим, существует ли уже коллекция, и удалим ее, если она существует. Это гарантирует, что мы начнем с чистого листа. Мы создаем коллекцию с размером 1024, что соответствует размеру выходных данных эмбеддингов Twelve Labs.</p>
