...
<h3 id="Installation" class="common-anchor-header">Установка<button data-href="#Installation" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Клонируйте репо и настройте ваше окружение:</p>
...
<h3 id="Configuring-Milvus" class="common-anchor-header">Настройка Milvus<button data-href="#Configuring-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Чтобы использовать <strong>Milvus</strong>, обновите конфигурацию.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Loading-Data" class="common-anchor-header">Загрузка данных<button data-href="#Loading-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>После настройки загрузите контент с помощью RSS-каналов.</p>
...
<h3 id="Running-the-Server" class="common-anchor-header">Запуск сервера<button data-href="#Running-the-Server" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Чтобы запустить NLWeb, из каталога <code translate="no">code</code> выполните команду run:</p>
