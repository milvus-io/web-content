...
<li><p>Milvus Capture Data Change (CDC) Milvus CDC может реплицировать изменения данных с одного кластера Milvus на другой для аварийного восстановления первичных и резервных систем. Подробную информацию см. в разделе <a href="/docs/ru/milvus_cdc_overview.md">Milvus CDC</a>.</p></li>
