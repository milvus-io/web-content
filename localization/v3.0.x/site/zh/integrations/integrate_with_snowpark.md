...
<h3 id="1-Obtain-account-information" class="common-anchor-header">1.获取账户信息<button data-href="#1-Obtain-account-information" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>下载 SPCS 客户端：<a href="https://docs.snowflake.com/en/user-guide/snowsql-install-config">SnowSQL</a>，然后登录您的账户。</p>
...
<h3 id="2-Configure-Role-and-privileges" class="common-anchor-header">2.配置角色和权限<button data-href="#2-Configure-Role-and-privileges" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="3-Create-data-storage-configuration" class="common-anchor-header">3.创建数据存储配置<button data-href="#3-Create-data-storage-configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="4-Create-images" class="common-anchor-header">4.创建镜像<button data-href="#4-Create-images" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Milvus 使用的镜像需要在本地构建，然后由用户上传。关于镜像的相关配置，请参考<a href="https://github.com/dald001/milvus_on_spcs">此 repo</a>。克隆代码后，进入项目根目录，准备构建镜像。</p>
<ul>
<li><p>本地构建镜像</p>
...
<h3 id="5-Create-and-start-services" class="common-anchor-header">5.创建并启动服务<button data-href="#5-Create-and-start-services" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>让我们回到 SnowSQL shell。</p>
<ul>
<li>创建计算池</li>
</ul>
<pre><code translate="no" class="language-sql">USE ROLE SYSADMIN;
