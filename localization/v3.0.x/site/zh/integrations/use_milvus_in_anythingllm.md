...
<p>本指南将指导您将 Milvus 配置为 AnythingLLM 中的向量数据库，使您能够嵌入、存储和搜索您的文档，进行智能检索和聊天。</p>
<blockquote>
...
<blockquote>
<p>如果使用 Zilliz Cloud，请输入您的集群端点和 API 令牌：<br>
   ...
   </span> <span class="img-wrapper"> <span>Zilliz Cloud 连接</span> </span></p>
</blockquote></li>
