...
<p>欢迎阅读 Milvus 路线图！</p>
<p>我们正在将 Milvus 带入一个新时代--下一代多模态数据库--涵盖<strong>结构化数据到非结构化数据</strong>、<strong>实时检索到离线分析</strong>、<strong>单集群性能到全球数据湖架构</strong>。</p>
...
<h2 id="🌠-Milvus-v30-Targeted-for-Early-2026" class="common-anchor-header">🌠 Milvus v3.0（目标日期：2026 年初）<button data-href="#🌠-Milvus-v30-Targeted-for-Early-2026" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p><strong>时间表：2025 年末 - 2026 年初</strong></p>
