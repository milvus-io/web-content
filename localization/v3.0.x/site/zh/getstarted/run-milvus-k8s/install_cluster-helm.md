...
<h2 id="Overview" class="common-anchor-header">概述<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Helm 使用一种称为“图表”（charts）的打包格式。图表是一组文件的 Collection，用于描述一组相关的 Kubernetes 资源。Milvus 提供了一组图表，以帮助您部署 Milvus 的依赖项和组件。</p>
...
<div class="alert note">
<p>对于 Woodpecker 服务模式，我们建议使用即将发布的 Milvus 3.0.1 或更高版本，并搭配 Woodpecker v0.1.37 或更高版本，以获得紧凑化清理和组提交优化。</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p><strong>等待所有 Pod 显示“Running”状态。</strong>采用 v3.0.0 配置时，您应看到类似以下的 Pod：</p>
