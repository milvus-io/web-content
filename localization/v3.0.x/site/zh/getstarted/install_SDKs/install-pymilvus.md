...
<li>已安装 grpcio-tools。您可以通过命令<code translate="no">pip3 install grpcio-tools</code> 进行安装。</li>
</ul>
...
建议安装与您已安装的 Milvus 服务器版本相匹配的 PyMilvus 版本。有关更多信息，请参阅《<a href="/docs/zh/release_notes.md">发布说明》</a>。
</div>
...
<li><p>探索<a href="/api-reference/pymilvus/v3.0.x/About.md">PyMilvus API 参考文档</a></p></li>
</ul>
