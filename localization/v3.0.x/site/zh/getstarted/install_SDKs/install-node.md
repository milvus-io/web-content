...
<h1 id="Install-Milvus-Nodejs-SDK" class="common-anchor-header">安装 Milvus Nodejs SDK<button data-href="#Install-Milvus-Nodejs-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本主题介绍如何为 Milvus 安装 Milvus Node.js SDK。</p>
<h2 id="Compatibility" class="common-anchor-header">兼容性<button data-href="#Compatibility" class="anchor-icon" translate="no">
    ...
    </button></h2><p>以下 Collections 显示了 Milvus 版本和推荐的 @zilliz/milvus2-sdk-node 版本：</p>
<table>
<thead>
...
<h2 id="Installation" class="common-anchor-header">安装<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>开始使用 Milvus node.js 客户端的推荐方法是使用 npm（Node 软件包管理器）在项目中安装依赖项。</p>
<pre><code translate="no" class="language-javascript">npm install @zilliz/milvus2-sdk-node
# or ...
yarn add @zilliz/milvus2-sdk-node
<button class="copy-code-btn"></button></code></pre>
<p>这将下载 Milvus node.js sdk，并在 package.json 文件中添加依赖项。</p>
...
<ul>
<li><p>查看<a href="https://github.com/milvus-io/milvus-sdk-node">Milvus node.js SDK 快速入门</a></p></li>
...
<li><p>探索<a href="/api-reference/node/v3.0.x/About.md">Milvus Node.js 应用程序接口参考</a></p></li>
</ul>
