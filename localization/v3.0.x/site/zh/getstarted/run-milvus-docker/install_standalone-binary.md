...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">下载 RPM/DEB 软件包<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>您可以从<a href="https://github.com/milvus-io/milvus/releases/tag/v3.0.0">Milvus 发行版页面</a>根据您的系统架构下载 RPM/DEB 软件包。</p>
<ul>
<li>对于 x86_64/amd64 架构，请下载<strong>milvus_3.0.0-1_amd64.deb</strong>或<strong>milvus_3.0.0-1_amd64.rpm</strong>软件包。</li>
<li>对于 ARM64，请下载<strong>milvus_3.0.0-1_arm64.deb</strong>或<strong>milvus_3.0.0-1_arm64.rpm</strong>软件包。</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>Storage V3 默认处于禁用状态。在使用依赖于它的功能之前，请先启用它。有关系统要求和兼容性注意事项，请参阅<a href="/docs/zh/storage-v3.md">Storage V3</a>。</p>
</div>
