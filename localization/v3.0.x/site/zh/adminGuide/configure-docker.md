...
<h2 id="Download-a-configuration-file" class="common-anchor-header">下载配置文件<button data-href="#Download-a-configuration-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p>可直接<a href="https://raw.githubusercontent.com/milvus-io/milvus/v3.0.2/configs/milvus.yaml">下载</a> <code translate="no">milvus.yaml</code> ，或使用以下命令<a href="https://raw.githubusercontent.com/milvus-io/milvus/v3.0.2/configs/milvus.yaml">进行下载</a>。</p>
  ...
  <tr>
    ...
    <td>
        <ul>
            ...
            <li><a href="/docs/zh/configure_metastore.md">元数据存储库</a></li>
...
<h2 id="Download-an-installation-file" class="common-anchor-header">下载安装文件<button data-href="#Download-an-installation-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p>下载 Milvus<a href="https://github.com/milvus-io/milvus/releases/download/v3.0.2/milvus-standalone-docker-compose.yml">Standalone</a> 安装文件，并将其保存为<code translate="no">docker-compose.yml</code> 。</p>
<p>您也可以直接运行以下命令。</p>
...
<p>将<code translate="no">milvus.yaml</code> 文件的本地路径映射到所有<code translate="no">volumes</code> 部分下的<code translate="no">/milvus/configs/milvus.yaml</code> 配置文件所在的相应Docker容器路径上。</p>
