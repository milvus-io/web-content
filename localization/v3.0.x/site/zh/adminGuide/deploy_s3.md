...
<h2 id="Configure-S3-with-Docker-Compose" class="common-anchor-header">使用 Docker Compose 配置 S3<button data-href="#Configure-S3-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Configure-S3" class="common-anchor-header">1.配置 S3<button data-href="#1-Configure-S3" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><a href="https://min.io/product/overview">MinIO</a>与 S3 兼容。要使用 Docker Compose 配置 S3，请在 Milvus/configs 路径上的<code translate="no">milvus.yaml</code> 文件中提供<code translate="no">minio</code> 部分的值。</p>
...
<h3 id="2-Refine-docker-composeyaml" class="common-anchor-header">2.完善 docker-compose.yaml<button data-href="#2-Refine-docker-composeyaml" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>你还会删除<code translate="no">MINIO_ADDRESS</code> 环境变量，用于 Milvus 服务，地址是<code translate="no">docker-compose.yaml</code> 。默认情况下，milvus 会使用本地 minio 而不是外部 S3。</p>
<h3 id="3-Run-Milvus" class="common-anchor-header">3.运行 Milvus<button data-href="#3-Run-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>运行以下命令启动使用 S3 配置的 Milvus。</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Using-a-command" class="common-anchor-header">使用命令<button data-href="#Using-a-command" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>要安装 Milvus 并配置 S3，请使用你的值运行以下命令。</p>
