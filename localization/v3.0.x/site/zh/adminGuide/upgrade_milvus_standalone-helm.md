...
---
<div class="tab-wrapper"><a href="/docs/zh/upgrade_milvus_standalone-operator.md" class=''>Milvus</a><a href="/docs/zh/upgrade_milvus_standalone-docker.md" class=''>运维人员</a><a href="/docs/zh/upgrade_milvus_standalone-operator.md" class=''>Helm Docker</a><a href="/docs/zh/upgrade_milvus_standalone-docker.md" class=''>Compose</a></div>
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">使用 Helm Chart 升级 Milvus Standalone<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本指南介绍了如何使用 Helm 图将您的 Milvus Standalone 部署从 v2.5.x 升级到 v3.0-beta。</p>
...
<li>在升级至 v3.0-beta 之前，您<strong>必须先</strong>升级至 v2.5.16 或更高版本。</li>
</ul>
...
<h3 id="Step-3-Upgrade-to-v30-beta" class="common-anchor-header">步骤 3：升级至 v3.0-beta<button data-href="#Step-3-Upgrade-to-v30-beta" class="anchor-icon" translate="no">
    ...
    </button></h3><p>待 v2.5.16 成功运行后，请升级至 v3.0-beta：</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
