...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">使用 Helm 图表升级 Milvus Standalone<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本指南介绍了如何使用 Helm 将 Milvus 2.6.x Standalone 部署升级至 v3.0.0。</p>
<div class="alert note">
<p>本流程已通过 Milvus 2.6.20 至 Milvus v3.0.0 版本的验证，所用 Milvus Helm 图表版本为 5.0.22。如果您使用的是其他 Milvus 2.6.x 补丁版本或 Helm 图表版本，请先在非生产环境中验证升级操作。</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>请确认所有必需的工作负载均已就绪，Milvus 正在使用<code translate="no">v3.0.0</code> ，且现有 Collections 仍可进行查询和搜索。在启用任何 v3.0.0 专属功能之前，请完成这些检查。</p>
<div class="alert note">
