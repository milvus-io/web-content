...
<h3 id="Before-your-start" class="common-anchor-header">开始之前<button data-href="#Before-your-start" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Tweak-Milvus-configurations" class="common-anchor-header">调整 Milvus 配置<button data-href="#Tweak-Milvus-configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>本指南假定您已<a href="/docs/zh/gcp.md">在 GCP 的第 4 层负载平衡器后面部署了 Milvus 群集</a>。</p>
...
<h3 id="Set-up-a-health-check-endpoint" class="common-anchor-header">设置健康检查端点<button data-href="#Set-up-a-health-check-endpoint" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>为确保服务可用性，GCP 上的 Layer-7 负载均衡需要探测后端服务的健康状况。因此，我们需要设置一个 BackendConfig 来封装健康检查端点，并通过注解将 BackendConfig 与 Milvus 服务关联起来。</p>
...
<h3 id="Prepare-TLS-certificates" class="common-anchor-header">准备 TLS 证书<button data-href="#Prepare-TLS-certificates" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>TLS 需要证书才能工作。<strong>创建证书有两种方法，即自我管理和 Google 管理。</strong></p>
...
<h3 id="Create-an-Ingress-to-generate-a-Layer-7-Load-Balancer" class="common-anchor-header">创建入口以生成 Layer-7 负载平衡器<button data-href="#Create-an-Ingress-to-generate-a-Layer-7-Load-Balancer" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>用以下代码段之一创建一个 YAML 文件。</p>
<ul>
<li><p>使用自我管理证书</p>
...
<div class="alert note">
<ul>
<li><strong>host</strong>和<strong>port</strong>中的 IP 地址和<strong>端口号</strong>应与<a href="#create-an-ingress-to-generate-a-layer-7-load-balancer">Create an Ingress to generate a Layer-7 Load Balancer</a> 末尾列出的相匹配。</li>
