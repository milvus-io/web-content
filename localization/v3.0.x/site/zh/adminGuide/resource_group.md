...
<p>当然，如果集群中的 QueryNodes 数量发生变化，Milvus 会持续尝试调整以满足最终条件。因此，您可以先应用资源组配置变更，然后执行 QueryNode 扩缩容。</p>
...
<p>本页面上的所有代码示例均基于 PyMilvus 3.0.1。在运行这些代码之前，请先升级您的 PyMilvus 安装版本。</p>
</div>
<ol>
<li><p>创建资源组。</p>
