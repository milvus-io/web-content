...
title: 提示：Milvus 搜索模式
summary: 人工智能编码助手在 Milvus 中实现搜索、混合搜索和全文搜索的规则。
---
<h1 id="Search-Patterns" class="common-anchor-header">搜索模式<button data-href="#Search-Patterns" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>在 Milvus 中实现相似性搜索、混合搜索、过滤搜索和全文搜索的规则，包括 AnnSearchRequest 约束和排名器的使用。将下面的完整提示复制到您的人工智能工具中，即可自动应用这些规则。有关所有提示的概述，请参阅<a href="/docs/zh/milvus_for_agents.md">人工智能提示</a>。</p>
