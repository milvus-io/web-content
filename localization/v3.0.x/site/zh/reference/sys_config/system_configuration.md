...
---
<h1 id="Milvus-System-Configurations-Checklist" class="common-anchor-header">Milvus 系统配置检查清单<button data-href="#Milvus-System-Configurations-Checklist" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>本节介绍了 Milvus 系统配置的一般内容。</p>
<p>Milvus 维护着大量用于配置系统的参数。每个配置项都有一个默认值，可直接使用。您可以灵活修改这些参数，以便 Milvus 更好地满足您的应用需求。有关更多信息，请参阅<a href="/docs/zh/configure-docker.md">《配置 Milvus</a>》。</p>
<div class="alert note">
在当前版本中，所有参数仅在 Milvus 启动时完成配置后才会生效。
</div>
<h2 id="Sections" class="common-anchor-header">部分<button data-href="#Sections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>为便于维护，Milvus 根据其组件、依赖关系和通用用法，将配置划分为 %s 个部分。</p>
<h3 id="etcd" class="common-anchor-header"><code translate="no">etcd</code><button data-href="#etcd" class="anchor-icon" translate="no">
    ...
    </button></h3><p>与 etcd 相关的配置，用于存储 Milvus 元数据和服务发现信息。</p>
<p><a href="/docs/zh/configure_etcd.md">有关</a>本部分下各参数的详细说明，请参阅<a href="/docs/zh/configure_etcd.md">“etcd 相关配置”</a>。</p>
<h3 id="metastore" class="common-anchor-header"><code translate="no">metastore</code><button data-href="#metastore" class="anchor-icon" translate="no">
    ...
    </button></h3><p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_metastore.md">与 metastore 相关的配置</a>。</p>
<h3 id="tikv" class="common-anchor-header"><code translate="no">tikv</code><button data-href="#tikv" class="anchor-icon" translate="no">
    ...
    </button></h3><p>与 tikv 相关的配置，用于存储 Milvus 元数据。</p>
<p>请注意，当为元数据存储启用 TiKV 时，您仍需使用 etcd 进行服务发现。</p>
<p>当元数据大小需要更好的水平可扩展性时，TiKV 是一个不错的选择。</p>
<p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_tikv.md">与 tikv 相关的配置</a>。</p>
<h3 id="localStorage" class="common-anchor-header"><code translate="no">localStorage</code><button data-href="#localStorage" class="anchor-icon" translate="no">
    ...
    </button></h3><p>有关本节中每个参数的详细说明，请参阅<a href="/docs/zh/configure_localstorage.md">与 localStorage 相关的配置</a>。</p>
<h3 id="minio" class="common-anchor-header"><code translate="no">minio</code><button data-href="#minio" class="anchor-icon" translate="no">
    ...
    </button></h3><p>MinIO/S3/GCS 或任何其他支持 S3 API 的服务的相关配置，负责 Milvus 的数据持久化。</p>
<p>为简便起见，下文将该存储服务统称为 MinIO/S3。</p>
<p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_minio.md">与 minio 相关的配置</a>。</p>
<h3 id="mq" class="common-anchor-header"><code translate="no">mq</code><button data-href="#mq" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Milvus 支持四种消息队列（MQ）：rocksmq（基于 RockDB）、Pulsar、Kafka 和 Woodpecker。</p>
<p>您可以通过设置 mq.type 字段来更改消息队列。</p>
<p>如果您未将 mq.type 字段设置为默认值，则当在此文件中配置多个消息队列时，请注意启用优先级。</p>
<ol>
...
<p>有关本节下各参数的详细说明，请参阅<a href="/docs/zh/configure_mq.md">“与消息队列相关的配置”</a>。</p>
<h3 id="pulsar" class="common-anchor-header"><code translate="no">pulsar</code><button data-href="#pulsar" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Pulsar 的相关配置，用于管理 Milvus 最近的变异操作日志、输出流日志，并提供日志发布-订阅服务。</p>
<p>有关本节下各参数的详细说明，请参阅<a href="/docs/zh/configure_pulsar.md">Pulsar 相关配置</a>。</p>
<h3 id="rocksmq" class="common-anchor-header"><code translate="no">rocksmq</code><button data-href="#rocksmq" class="anchor-icon" translate="no">
    ...
    </button></h3><p>若需启用 Kafka，需注释掉 Pulsar 的相关配置</p>
<p>kafka:</p>
...
<p>读取超时: 10</p>
<p>有关本节中各参数的详细说明，请参阅<a href="/docs/zh/configure_rocksmq.md">与 rocksmq 相关的配置</a>。</p>
...
<p>有关本节下各参数的详细说明，请参阅<a href="/docs/zh/configure_rootcoord.md">与 rootCoord 相关的配置</a>。</p>
<h3 id="proxy" class="common-anchor-header"><code translate="no">proxy</code><button data-href="#proxy" class="anchor-icon" translate="no">
    ...
    </button></h3><p>proxy 的相关配置，用于验证客户端请求并缩减返回结果。</p>
<p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_proxy.md">与 proxy 相关的配置</a>。</p>
<h3 id="queryCoord" class="common-anchor-header"><code translate="no">queryCoord</code><button data-href="#queryCoord" class="anchor-icon" translate="no">
    ...
    </button></h3><p>queryCoord 的相关配置，用于管理查询节点的拓扑和负载均衡，以及将增长段交接给已封装段。</p>
<p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_querycoord.md">queryCoord 相关的配置</a>。</p>
<h3 id="queryNode" class="common-anchor-header"><code translate="no">queryNode</code><button data-href="#queryNode" class="anchor-icon" translate="no">
    ...
    </button></h3><p>queryNode 的相关配置，用于在向量和标量数据之间执行混合搜索。</p>
<p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_querynode.md">queryNode 相关的配置</a>。</p>
<h3 id="indexCoord" class="common-anchor-header"><code translate="no">indexCoord</code><button data-href="#indexCoord" class="anchor-icon" translate="no">
    ...
    </button></h3><p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_indexcoord.md">与 indexCoord 相关的配置</a>。</p>
<h3 id="indexNode" class="common-anchor-header"><code translate="no">indexNode</code><button data-href="#indexNode" class="anchor-icon" translate="no">
    ...
    </button></h3><p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_indexnode.md">与 indexNode 相关的配置</a>。</p>
<h3 id="dataCoord" class="common-anchor-header"><code translate="no">dataCoord</code><button data-href="#dataCoord" class="anchor-icon" translate="no">
    ...
    </button></h3><p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_datacoord.md">与 dataCoord 相关的配置</a>。</p>
<h3 id="dataNode" class="common-anchor-header"><code translate="no">dataNode</code><button data-href="#dataNode" class="anchor-icon" translate="no">
    ...
    </button></h3><p>有关本节下各参数的详细说明，请参阅<a href="/docs/zh/configure_datanode.md">dataNode 相关配置</a>。</p>
<h3 id="msgChannel" class="common-anchor-header"><code translate="no">msgChannel</code><button data-href="#msgChannel" class="anchor-icon" translate="no">
    ...
    </button></h3><p>本主题介绍了 Milvus 与消息通道相关的配置。</p>
<p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_msgchannel.md">与 msgChannel 相关的配置</a>。</p>
<h3 id="log" class="common-anchor-header"><code translate="no">log</code><button data-href="#log" class="anchor-icon" translate="no">
    ...
    </button></h3><p>配置系统日志输出。</p>
<p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_log.md">与 log 相关的配置</a>。</p>
<h3 id="grpc" class="common-anchor-header"><code translate="no">grpc</code><button data-href="#grpc" class="anchor-icon" translate="no">
    ...
    </button></h3><p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_grpc.md">与 grpc 相关的配置</a>。</p>
...
<p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_tls.md">与 tls 相关的配置</a>。</p>
...
<p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_internaltls.md">与 internaltls 相关的配置</a>。</p>
<h3 id="common" class="common-anchor-header"><code translate="no">common</code><button data-href="#common" class="anchor-icon" translate="no">
    ...
    </button></h3><p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_common.md">“common”相关的配置</a>。</p>
<h3 id="quotaAndLimits" class="common-anchor-header"><code translate="no">quotaAndLimits</code><button data-href="#quotaAndLimits" class="anchor-icon" translate="no">
    ...
    </button></h3><p>QuotaConfig，Milvus 配额和限制的配置。</p>
<p>默认情况下，我们启用：</p>
<ol>
<li><p>TT 保护；</p></li>
<li><p>内存保护；</p></li>
...
<p>如有必要，您还可以手动强制拒绝读写 (RW) 请求。</p>
<p>有关本节下各参数的详细说明，请参阅<a href="/docs/zh/configure_quotaandlimits.md">与 quotaAndLimits 相关的配置</a>。</p>
<h3 id="trace" class="common-anchor-header"><code translate="no">trace</code><button data-href="#trace" class="anchor-icon" translate="no">
    ...
    </button></h3><p>有关本节下各参数的详细说明，请参阅<a href="/docs/zh/configure_trace.md">与 trace 相关的配置</a>。</p>
<h3 id="gpu" class="common-anchor-header"><code translate="no">gpu</code><button data-href="#gpu" class="anchor-icon" translate="no">
    ...
    </button></h3><p>#在使用 GPU 索引时，Milvus 将利用内存池来避免频繁的内存分配和释放。</p>
<p>#此处可设置内存池占用的内存大小，单位为 MB。</p>
<p>#请注意，当实际内存需求超过 maxMemSize 设置的值时，Milvus 可能会崩溃。</p>
<p>#如果 initMemSize 和 MaxMemSize 均设为零，</p>
<p>#Milvus 将自动初始化可用 GPU 内存的一半，</p>
<p>#maxMemSize 将占用全部可用 GPU 内存。</p>
<p>有关本节中各参数的详细说明，请参阅<a href="/docs/zh/configure_gpu.md">与 GPU 相关的配置</a>。</p>
<h3 id="streamingNode" class="common-anchor-header"><code translate="no">streamingNode</code><button data-href="#streamingNode" class="anchor-icon" translate="no">
    ...
    </button></h3><p>与流式传输节点服务器相关的任何配置。</p>
<p>有关本节下各参数的详细说明，请参阅<a href="/docs/zh/configure_streamingnode.md">“流式节点相关配置”</a>。</p>
...
<p>有关本节下每个参数的详细说明，请参阅<a href="/docs/zh/configure_streaming.md">“流媒体相关配置”</a>。</p>
...
<p>有关本节下各参数的详细说明，请参阅<a href="/docs/zh/configure_knowhere.md">“与 knowhere 相关的配置</a>”。</p>
