...
<tr><td>存储行为</td><td>将每个值存储在字段配置的<code translate="no">max_length</code> 内。</td><td>对于较大的文本值，将使用自动存储选择机制。详情请参阅《<a href="#how-milvus-stores-large-text-values">Milvus 如何存储大型 TEXT 值</a>》。</td></tr>
