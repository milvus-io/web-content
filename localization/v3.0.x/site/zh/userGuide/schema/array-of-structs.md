...
<tr><td>搜索</td><td>结合 StructArray 进行混合搜索</td><td>将 StructArray 元素级搜索与其他向量搜索相结合。</td></tr>
...
<li><p>某些搜索组合受版本限制或具有模式特异性。在依赖范围搜索、分组搜索、混合搜索、可空字段或动态添加的字段之前，请查阅<a href="/docs/zh/structarray-limits.md">StructArray 限制</a>。</p></li>
</ul>
