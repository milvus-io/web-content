...
<p>Milvus 提供的<code translate="no">EmbeddingList</code> 可以帮助你更整齐地组织针对 StructArray 中的 Embedding 列表进行搜索的查询向量。每个<code translate="no">EmbeddingList</code> 至少包含一个向量嵌入，并期望返回一定数量的 topK 实体。</p>
