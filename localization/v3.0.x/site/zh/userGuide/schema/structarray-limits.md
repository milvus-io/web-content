...
<tr><td>现有的子字段是固定的。</td><td>您无法将新子字段追加到现有的 StructArray 字段中。要更改子字段 Schema，请删除 StructArray 字段，然后使用更新的 Schema 将其重新添加。</td></tr>
...
<tr><td>动态添加的空值要求</td><td>添加到现有 Collection 中 StructArray 字段必须为可为空的，因为现有实体对于该新字段尚无值。</td></tr>
