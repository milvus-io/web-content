...
<tr><td>动态添加 StructArray 字段</td><td>仅在支持动态 StructArray 字段的版本中，才支持将 StructArray 字段添加到现有 Collection 中。</td></tr>
...
<tr><td>混合搜索</td><td>混合搜索请求仅在目标版本支持该搜索组合时，才可包含 StructArray 向量子场请求。每个请求仍遵循已索引向量子场所属的度量家族。</td></tr>
