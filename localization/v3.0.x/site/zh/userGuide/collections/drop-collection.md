...
title: 删除 Collections
summary: 如果不再需要某个 Collection，您可以将其删除。
---
<h1 id="Drop-Collection" class="common-anchor-header">删除 Collections<button data-href="#Drop-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>如果不再需要某个 Collection，您可以删除该 Collection。</p>
<h2 id="Examples" class="common-anchor-header">示例<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>以下代码片段假定您有一个名为<strong>my_collection</strong> 的 Collection。</p>
