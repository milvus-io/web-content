...
<ul>
<li><p><a href="/docs/zh/vllm-ranker.md">vLLM Ranker</a></p></li>
<li><p><a href="/docs/zh/tei-ranker.md">TEI Ranker</a></p></li>
...
<p>模型排序器可与标准向量搜索和混合搜索操作无缝集成。实现过程包括创建一个 Function 对象来定义您的重新排序配置，并将其传递给搜索操作。</p>
