...
<h3 id="Option-2-Environment-variable" class="common-anchor-header">选项 2：环境变量<button data-href="#Option-2-Environment-variable" class="anchor-icon" translate="no">
    ...
    </button></h3><p>当您使用 Docker Compose 运行 Milvus 并希望不对文件和映像保密时，请使用此方法。</p>
...
<h2 id="Next-steps" class="common-anchor-header">下一步<button data-href="#Next-steps" class="anchor-icon" translate="no">
    ...
    </button></h2><p>配置好嵌入函数后，请参阅 "<a href="/docs/zh/embedding-function-overview.md">函数概述</a>"，了解有关索引配置、数据插入示例和语义搜索操作的其他指导。</p>
