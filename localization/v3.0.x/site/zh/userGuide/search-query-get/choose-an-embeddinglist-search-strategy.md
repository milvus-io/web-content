...
<tr><td>文档长度是否存在严重偏斜？</td><td>某些行包含的向量远多于其他行。</td><td>请先从<code translate="no">muvera</code> 开始；并仔细验证<code translate="no">lemur</code> 。</td></tr>
</tbody>
</table>
...
<li><p>当嵌入列表较大、嵌入空间存在噪声，或工作负载属于视觉或多模态类型时，请尝试使用<code translate="no">lemur</code> 。</p></li>
