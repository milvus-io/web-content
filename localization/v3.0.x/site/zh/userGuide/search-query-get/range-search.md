...
<h2 id="Examples" class="common-anchor-header">示例<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>本节演示如何进行范围搜索。以下代码片段中的搜索请求没有度量类型，表示默认度量类型为<strong>COSINE</strong>。在这种情况下，请确保<strong>半径</strong>值小于<strong>range_filter</strong>值。</p>
...
<p>如果查询向量已经存在于目标 Collections 中，可考虑使用<code translate="no">ids</code> 代替在搜索前检索它们。有关详情，请参阅<a href="/docs/zh/primary-key-search.md">主键搜索</a>。</p>
</div>
