...
<h3 id="Install-via-pip" class="common-anchor-header">通过 pip 安装<button data-href="#Install-via-pip" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>运行以下命令安装 Milvus_CLI。</p>
...
<h3 id="Prerequisites" class="common-anchor-header">前提条件<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h3><p>需要 Docker 19.03 或更高版本。</p>
<h3 id="Install-based-on-Docker-image" class="common-anchor-header">根据 Docker 映像安装<button data-href="#Install-based-on-Docker-image" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Install-from-an-exe-file" class="common-anchor-header">从 .exe 文件安装<button data-href="#Install-from-an-exe-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><div class="alert note">此安装方法仅适用于 Windows。 </div>
<p>从<a href="https://github.com/zilliztech/milvus_cli/releases">GitHub</a>下载 .exe 文件并运行，安装 Milvus_CLI。如果安装成功，<code translate="no">milvus_cli-&lt;version&gt;.exe</code> ，如下图所示。</p>
<p>
