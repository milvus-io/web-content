...
<h2 id="Hybrid-Search​" class="common-anchor-header">Pencarian Hibrida<button data-href="#Hybrid-Search​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pencarian hibrida menggabungkan hasil dari beberapa pencarian dan memberi peringkat ulang untuk mendapatkan penarikan yang lebih baik. Pada bagian ini, Anda akan melakukan pencarian hibrida menggunakan bidang vektor padat dan jarang.</p>
