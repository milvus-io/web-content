...
<h3 id="Expand-Subgraph" class="common-anchor-header">Memperluas Subgraf<button data-href="#Expand-Subgraph" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Kita menggunakan entitas dan relasi yang diambil untuk memperluas subgraf dan mendapatkan relasi kandidat, dan kemudian menggabungkannya dari dua cara. Berikut adalah diagram alir dari proses perluasan subgraf:  <span class="img-wrapper">
