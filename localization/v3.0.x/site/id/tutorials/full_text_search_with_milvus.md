...
<h2 id="Initialization-with-BM25-Function" class="common-anchor-header">Inisialisasi dengan Fungsi BM25<button data-href="#Initialization-with-BM25-Function" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Hybrid-Search" class="common-anchor-header">Pencarian Hibrida<button data-href="#Hybrid-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="BM25-search-without-embedding" class="common-anchor-header">Pencarian BM25 tanpa penyematan<button data-href="#BM25-search-without-embedding" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Customize-analyzer" class="common-anchor-header">Menyesuaikan penganalisis<button data-href="#Customize-analyzer" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Penganalisis sangat penting dalam pencarian teks lengkap dengan memecah kalimat menjadi token dan melakukan analisis leksikal seperti stemming dan penghilangan kata. Penganalisis biasanya bersifat spesifik untuk bahasa tertentu. Anda dapat merujuk ke <a href="https://milvus.io/docs/analyzer-overview.md#Analyzer-Overview">panduan ini</a> untuk mempelajari lebih lanjut tentang penganalisis di Milvus.</p>
...
<p>Untuk detail konsep lebih lanjut, misalnya, <code translate="no">analyzer</code>, <code translate="no">tokenizer</code>, <code translate="no">filter</code>, <code translate="no">enable_match</code>, <code translate="no">analyzer_params</code>, silakan lihat <a href="https://milvus.io/docs/analyzer-overview.md">dokumentasi penganalisis</a>.</p>
<h3 id="Multi-language-Analyzer" class="common-anchor-header">Penganalisis Multi-bahasa<button data-href="#Multi-language-Analyzer" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Milvus mendukung penganalisis multi-bahasa untuk dokumen dalam berbagai bahasa. Gunakan <code translate="no">multi_analyzer_params</code> di <code translate="no">BM25BuiltInFunction</code>:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Untuk lebih jelasnya, lihat <a href="https://milvus.io/docs/multi-language-analyzers.md">dokumentasi penganalisis multi-bahasa</a>.</p>
<h2 id="Using-Hybrid-Search-and-Reranking-in-RAG" class="common-anchor-header">Menggunakan Pencarian Hibrida dan Perangkingan Ulang di RAG<button data-href="#Using-Hybrid-Search-and-Reranking-in-RAG" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Kita telah mempelajari cara menggunakan fungsi bawaan dasar BM25 di LangChain dan Milvus. Mari kita perkenalkan implementasi RAG yang dioptimalkan dengan pencarian hibrida dan pemeringkatan ulang.</p>
<p>
...
<p>Pencarian hybrid menyeimbangkan ketepatan dan pemahaman semantik, meningkatkan akurasi dan ketahanan untuk beragam pertanyaan. Metode ini mengambil kandidat dengan pencarian teks lengkap BM25 dan pencarian vektor, memastikan pencarian yang semantik, memahami konteks, dan akurat.</p>
