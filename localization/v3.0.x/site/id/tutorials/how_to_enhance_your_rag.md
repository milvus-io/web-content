...
<h1 id="How-to-Enhance-the-Performance-of-Your-RAG-Pipeline" class="common-anchor-header">Cara Meningkatkan Kinerja Pipeline RAG Anda<button data-href="#How-to-Enhance-the-Performance-of-Your-RAG-Pipeline" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Dengan meningkatnya popularitas aplikasi Retrieval Augmented Generation<a href="https://zilliz.com/learn/Retrieval-Augmented-Generation">(RAG)</a>, ada perhatian yang semakin besar untuk meningkatkan kinerjanya. Artikel ini menyajikan semua cara yang mungkin untuk mengoptimalkan pipeline RAG dan memberikan ilustrasi yang sesuai untuk membantu Anda memahami dengan cepat strategi pengoptimalan RAG yang umum.</p>
...
<h3 id="Creating-Hypothetical-Questions" class="common-anchor-header">Membuat Pertanyaan Hipotetis<button data-href="#Creating-Hypothetical-Questions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="HyDE-Hypothetical-Document-Embeddings" class="common-anchor-header">HyDE (Penyematan Dokumen Hipotetis)<button data-href="#HyDE-Hypothetical-Document-Embeddings" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Creating-Sub-Queries" class="common-anchor-header">Membuat Sub-Kueri<button data-href="#Creating-Sub-Queries" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Ketika kueri pengguna terlalu rumit, kita dapat menggunakan LLM untuk memecahnya menjadi sub-kueri yang lebih sederhana sebelum meneruskannya ke basis data vektor dan LLM. Mari kita lihat sebuah contoh.</p>
...
<h3 id="Creating-Stepback-Prompts" class="common-anchor-header">Membuat Petunjuk Mundur<button data-href="#Creating-Stepback-Prompts" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Merging-Document-Chunks-Automatically" class="common-anchor-header">Menggabungkan Potongan Dokumen Secara Otomatis<button data-href="#Merging-Document-Chunks-Automatically" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Constructing-Hierarchical-Indices" class="common-anchor-header">Membangun Indeks Hirarkis<button data-href="#Constructing-Hierarchical-Indices" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Hybrid-Retrieval-and-Reranking" class="common-anchor-header">Temu Kembali Hibrida dan Pemeringkatan Ulang<button data-href="#Hybrid-Retrieval-and-Reranking" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Sentence-Window-Retrieval" class="common-anchor-header">Pengambilan Jendela Kalimat<button data-href="#Sentence-Window-Retrieval" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Meta-data-Filtering" class="common-anchor-header">Pemfilteran Meta-data<button data-href="#Meta-data-Filtering" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk memastikan jawaban yang lebih tepat, kita dapat menyaring dokumen yang diambil dengan menyaring metadata seperti waktu dan kategori sebelum meneruskannya ke LLM. Misalnya, jika laporan keuangan yang mencakup beberapa tahun diambil, pemfilteran berdasarkan tahun yang diinginkan akan menyaring informasi untuk memenuhi persyaratan tertentu. Metode ini terbukti efektif dalam situasi dengan data yang luas dan metadata yang terperinci, seperti pengambilan konten dalam koleksi perpustakaan.</p>
<p>
  <span class="img-wrapper">
...
<h3 id="Compressing-the-LLM-prompt" class="common-anchor-header">Mengompresi prompt LLM<button data-href="#Compressing-the-LLM-prompt" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Adjusting-the-chunk-order-in-the-prompt" class="common-anchor-header">Menyesuaikan urutan potongan dalam prompt<button data-href="#Adjusting-the-chunk-order-in-the-prompt" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Self-reflection" class="common-anchor-header">Refleksi diri<button data-href="#Self-reflection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Pendekatan ini menggabungkan konsep refleksi diri dalam agen AI. Lalu, bagaimana cara kerja teknik ini?</p>
...
<h3 id="Query-Routing-with-an-Agent" class="common-anchor-header">Perutean Kueri dengan Agen<button data-href="#Query-Routing-with-an-Agent" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Terkadang, kita tidak perlu menggunakan sistem RAG untuk menjawab pertanyaan sederhana karena dapat mengakibatkan lebih banyak kesalahpahaman dan kesimpulan dari informasi yang menyesatkan. Dalam kasus seperti itu, kita dapat menggunakan agen sebagai perute pada tahap kueri. Agen ini menilai apakah kueri perlu melalui pipa RAG. Jika ya, pipa RAG berikutnya dimulai; jika tidak, LLM secara langsung menangani kueri tersebut.</p>
<p>
  <span class="img-wrapper">
