...
<h3 id="Note-for-macOS-M-series-chip" class="common-anchor-header">Catatan untuk macOS (chip seri M):<button data-href="#Note-for-macOS-M-series-chip" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Jika Anda mengalami kesalahan:</p>
...
<h2 id="4-Prepare-Data-Create-Collection-and-Insert-Data" class="common-anchor-header">4. Menyiapkan Data, Membuat Koleksi, dan Menyisipkan Data<button data-href="#4-Prepare-Data-Create-Collection-and-Insert-Data" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="41-Prepare-the-Data" class="common-anchor-header">4.1 Menyiapkan Data<button data-href="#41-Prepare-the-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Kami menggunakan halaman FAQ dari <a href="https://github.com/milvus-io/milvus-docs/releases/download/v2.4.6-preview/milvus_docs_2.4.x_en.zip">Dokumentasi Milvus 2.4.x</a> sebagai kumpulan data untuk contoh ini.</p>
...
<button class="copy-code-btn"></button></code></pre>
<hr>
<h3 id="42-Generate-Embeddings" class="common-anchor-header">4.2 Hasilkan Penyematan<button data-href="#42-Generate-Embeddings" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Tentukan model penyematan untuk menghasilkan penyematan teks menggunakan <code translate="no">milvus_model</code>. Kami menggunakan model <code translate="no">DefaultEmbeddingFunction</code> sebagai contoh, yang merupakan model penyematan yang sudah terlatih dan ringan.</p>
...
<button class="copy-code-btn"></button></code></pre>
<hr>
<h3 id="43-Create-Collection" class="common-anchor-header">4.3 Membuat Koleksi<button data-href="#43-Create-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Hubungkan ke Milvus dan buat koleksi:</p>
...
<button class="copy-code-btn"></button></code></pre>
<hr>
<h3 id="44-Insert-Data" class="common-anchor-header">4.4 Menyisipkan Data<button data-href="#44-Insert-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Lakukan iterasi melalui baris teks, buat penyematan, dan masukkan data ke dalam Milvus:</p>
...
<button class="copy-code-btn"></button></code></pre>
<hr>
<h3 id="45-Visualize-Data-and-Schema" class="common-anchor-header">4.5 Memvisualisasikan Data dan Skema<button data-href="#45-Visualize-Data-and-Schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="51-Perform-a-Search" class="common-anchor-header">5.1 <strong>Melakukan Pencarian</strong><button data-href="#51-Perform-a-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Buka tab <strong>Pencarian Vektor</strong> di Attu.</p>
<ol>
...
<hr>
<h3 id="52-Explore-Data-Relationships" class="common-anchor-header">5.2 <strong>Jelajahi Hubungan Data</strong><button data-href="#52-Explore-Data-Relationships" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Klik tombol <strong>Jelajahi</strong> di panel hasil untuk memvisualisasikan hubungan antara vektor kueri dan hasil pencarian dalam <strong>struktur seperti grafik pengetahuan</strong>.</p>
<ul>
...
<hr>
<h3 id="53-Expand-the-Graph" class="common-anchor-header">5.3 <strong>Memperluas Grafik</strong><button data-href="#53-Expand-the-Graph" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Klik dua kali pada simpul hasil mana pun untuk memperluas koneksinya. Tindakan ini akan memperlihatkan hubungan tambahan antara simpul yang dipilih dengan titik data lain dalam koleksi, sehingga menciptakan <strong>grafik pengetahuan yang lebih besar dan saling terhubung</strong>.</p>
