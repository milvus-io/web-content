...
<h3 id="Dependencies-and-Environment" class="common-anchor-header">Ketergantungan dan Lingkungan<button data-href="#Dependencies-and-Environment" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Download-Dataset" class="common-anchor-header">Unduh Dataset<button data-href="#Download-Dataset" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk mendemonstrasikan pencarian, kita memerlukan korpus dokumen. Mari kita gunakan dataset Pertanyaan Duplikat Quora dan letakkan di direktori lokal.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Load-and-Prepare-Data" class="common-anchor-header">Memuat dan Menyiapkan Data<button data-href="#Load-and-Prepare-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Kami akan memuat set data dan menyiapkan korpus kecil untuk pencarian.</p>
...
<h3 id="Use-BGE-M3-Model-for-Embeddings" class="common-anchor-header">Gunakan Model BGE-M3 untuk Penyematan<button data-href="#Use-BGE-M3-Model-for-Embeddings" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Model BGE-M3 dapat menyematkan teks sebagai vektor padat dan jarang.</p>
...
<h3 id="Setup-Milvus-Collection-and-Index" class="common-anchor-header">Menyiapkan Koleksi dan Indeks Milvus<button data-href="#Setup-Milvus-Collection-and-Index" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Kita akan menyiapkan koleksi Milvus dan membuat indeks untuk bidang vektor.</p>
...
col.load()
<button class="copy-code-btn"></button></code></pre>
<h3 id="Insert-Data-into-Milvus-Collection" class="common-anchor-header">Memasukkan Data ke dalam Koleksi Milvus<button data-href="#Insert-Data-into-Milvus-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Masukkan dokumen dan penyematannya ke dalam koleksi.</p>
...
<h3 id="Enter-Your-Search-Query" class="common-anchor-header">Masukkan Kueri Pencarian Anda<button data-href="#Enter-Your-Search-Query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Run-the-Search" class="common-anchor-header">Jalankan Pencarian<button data-href="#Run-the-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Pertama-tama kami akan menyiapkan beberapa fungsi yang berguna untuk menjalankan pencarian:</p>
<ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Display-Search-Results" class="common-anchor-header">Menampilkan Hasil Pencarian<button data-href="#Display-Search-Results" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk menampilkan hasil pencarian Padat, Jarang, dan Hibrida, kita memerlukan beberapa utilitas untuk memformat hasilnya.</p>
...
<h3 id="Quick-Deploy" class="common-anchor-header">Penerapan Cepat<button data-href="#Quick-Deploy" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Untuk mempelajari tentang cara memulai demo online dengan tutorial ini, silakan lihat <a href="https://github.com/milvus-io/bootcamp/tree/master/tutorials/quickstart/apps/hybrid_demo_with_milvus">contoh aplikasi</a>.</p>
