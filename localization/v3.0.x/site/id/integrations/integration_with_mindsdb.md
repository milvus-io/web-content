...
<h3 id="Creating-connection" class="common-anchor-header">Membuat koneksi<button data-href="#Creating-connection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk menggunakan handler ini dan menyambungkan ke server Milvus di MindsDB, sintaks berikut ini dapat digunakan:</p>
...
<h3 id="Dropping-connection" class="common-anchor-header">Memutuskan koneksi<button data-href="#Dropping-connection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk memutuskan koneksi, gunakan perintah ini</p>
<pre><code translate="no" class="language-sql"><span class="hljs-keyword">DROP</span> DATABASE milvus_datasource;
<button class="copy-code-btn"></button></code></pre>
<h3 id="Creating-tables" class="common-anchor-header">Membuat tabel<button data-href="#Creating-tables" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk menyisipkan data dari tabel yang sudah ada sebelumnya, gunakan <code translate="no">CREATE</code></p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Dropping-collections" class="common-anchor-header">Menghapus koleksi<button data-href="#Dropping-collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Menghapus koleksi tidak didukung</p>
<h3 id="Querying-and-selecting" class="common-anchor-header">Membuat kueri dan memilih<button data-href="#Querying-and-selecting" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk melakukan kueri basis data menggunakan vektor pencarian, Anda dapat menggunakan <code translate="no">search_vector</code> dalam klausa <code translate="no">WHERE</code> </p>
<p>Peringatan:</p>
<ul>
...
<li>Kolom metadata tidak didukung, tetapi jika koleksi memiliki skema dinamis yang diaktifkan, Anda dapat melakukan kueri seperti biasa, lihat contoh di bawah ini</li>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Deleting-records" class="common-anchor-header">Menghapus rekaman<button data-href="#Deleting-records" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Anda dapat menghapus entri menggunakan <code translate="no">DELETE</code> seperti halnya dalam SQL.</p>
<p>Peringatan:</p>
<ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Inserting-records" class="common-anchor-header">Memasukkan catatan<button data-href="#Inserting-records" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Anda juga dapat menyisipkan baris individu seperti ini:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Updating" class="common-anchor-header">Memperbarui<button data-href="#Updating" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Memperbarui record tidak didukung oleh Milvus API. Anda dapat mencoba menggunakan kombinasi <code translate="no">DELETE</code> dan <code translate="no">INSERT</code></p>
<hr>
