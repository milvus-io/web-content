...
<li><p>membuat dan mengonfigurasi berkas <code translate="no">milvus-sink-connector.properties</code> di direktori <code translate="no">config</code> pada instalasi Kafka Anda.</p>
...
<h3 id="Support" class="common-anchor-header">Dukungan<button data-href="#Support" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Jika Anda memerlukan bantuan atau memiliki pertanyaan tentang Kafka Connect Milvus Connector, jangan ragu untuk menghubungi pengelola konektor: <strong>Email:</strong> <a href="mailto:support@zilliz.com">support@zilliz.com</a></p>
