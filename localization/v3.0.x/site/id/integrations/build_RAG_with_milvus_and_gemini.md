...
<p>Dalam tutorial ini, kami akan menunjukkan kepada Anda cara membangun pipa RAG (Retrieval-Augmented Generation) dengan Milvus dan Gemini. Kami akan menggunakan model Gemini untuk menghasilkan respons berdasarkan kueri yang diberikan, yang diperkaya dengan informasi relevan yang diambil dari Milvus.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Kami memuat semua berkas markdown dari folder <code translate="no">milvus_docs/en/faq</code>. Untuk setiap dokumen, kami cukup menggunakan "# " untuk memisahkan konten dalam berkas, yang secara kasar dapat memisahkan isi setiap bagian utama berkas markdown.</p>
...
<h2 id="Load-data-into-Milvus" class="common-anchor-header">Muat data ke dalam Milvus<button data-href="#Load-data-into-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Mari inisialisasi klien Milvus dan atur koleksi kita:</p>
...
<li>Jika Anda memiliki data berskala besar, Anda dapat menyiapkan server Milvus yang lebih berperforma di <a href="https://milvus.io/docs/quickstart.md">Docker atau Kubernetes</a>. Dalam pengaturan ini, harap gunakan URI server, misalnya<code translate="no">http://localhost:19530</code>, sebagai <code translate="no">uri</code> Anda.</li>
...
<p>Berikut adalah bidang baru <code translate="no">text</code>, yang merupakan bidang yang tidak didefinisikan dalam skema koleksi. Bidang ini akan secara otomatis ditambahkan ke bidang dinamis JSON yang disediakan, yang dapat diperlakukan sebagai bidang biasa pada tingkat tinggi.</p>
