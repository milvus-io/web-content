...
<h2 id="Preparation" class="common-anchor-header">Persiapan<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Dependency-and-Environment" class="common-anchor-header">Ketergantungan dan Lingkungan<button data-href="#Dependency-and-Environment" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Workflow" class="common-anchor-header">Alur kerja<button data-href="#Workflow" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Defining-the-Data-Source-Amazon-S3" class="common-anchor-header">Menentukan Sumber Data (Amazon S3)<button data-href="#Defining-the-Data-Source-Amazon-S3" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Dalam kasus ini, kita mengekstrak dokumen dari bucket Amazon S3. VectorETL memungkinkan kita untuk menentukan nama bucket, jalur ke file, dan jenis data yang sedang kita kerjakan.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Configuring-the-Embedding-Model-OpenAI" class="common-anchor-header">Mengonfigurasi Model Penyematan (OpenAI)<button data-href="#Configuring-the-Embedding-Model-OpenAI" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Setelah kita menyiapkan sumber data, kita perlu menentukan model penyematan yang akan mengubah data tekstual kita menjadi penyematan vektor. Di sini, kita menggunakan <code translate="no">text-embedding-ada-002</code> dari OpenAI dalam contoh ini.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Setting-Up-Milvus-as-the-Target-Database" class="common-anchor-header">Menyiapkan Milvus sebagai Basis Data Target<button data-href="#Setting-Up-Milvus-as-the-Target-Database" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Kita perlu menyimpan embedding yang dihasilkan di Milvus. Di sini, kita mendefinisikan parameter koneksi Milvus menggunakan Milvus Lite.</p>
...
<h3 id="Specifying-Columns-for-Embedding" class="common-anchor-header">Menentukan Kolom untuk Penyematan<button data-href="#Specifying-Columns-for-Embedding" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sekarang, kita perlu menentukan kolom mana dari file CSV kita yang akan dikonversi menjadi embedding. Hal ini memastikan bahwa hanya kolom teks yang relevan yang diproses, mengoptimalkan efisiensi dan penyimpanan.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Creating-and-Executing-the-VectorETL-Pipeline" class="common-anchor-header">Membuat dan Menjalankan Pipeline VectorETL<button data-href="#Creating-and-Executing-the-VectorETL-Pipeline" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Dengan semua konfigurasi yang ada, kita sekarang menginisialisasi pipeline ETL, mengatur aliran data, dan menjalankannya.</p>
