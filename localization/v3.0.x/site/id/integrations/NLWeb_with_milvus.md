...
<h3 id="Installation" class="common-anchor-header">Instalasi<button data-href="#Installation" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Kloning repo dan siapkan lingkungan Anda:</p>
...
<h3 id="Configuring-Milvus" class="common-anchor-header">Mengkonfigurasi Milvus<button data-href="#Configuring-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk menggunakan <strong>Milvus</strong>, perbarui konfigurasi Anda.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Loading-Data" class="common-anchor-header">Memuat Data<button data-href="#Loading-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Setelah dikonfigurasi, muat konten Anda menggunakan umpan RSS.</p>
...
<h3 id="Running-the-Server" class="common-anchor-header">Menjalankan Server<button data-href="#Running-the-Server" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk memulai NLWeb, dari direktori <code translate="no">code</code>, jalankan:</p>
