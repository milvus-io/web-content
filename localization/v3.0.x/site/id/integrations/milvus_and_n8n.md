...
<h3 id="Use-as-a-regular-node-to-insert-and-retrieve-documents" class="common-anchor-header">Gunakan sebagai simpul biasa untuk menyisipkan dan mengambil dokumen<button data-href="#Use-as-a-regular-node-to-insert-and-retrieve-documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Anda dapat menggunakan Milvus Vector Store sebagai simpul biasa untuk menyisipkan, atau mendapatkan dokumen. Pola ini menempatkan Milvus Vector Store dalam alur koneksi biasa tanpa menggunakan agen.</p>
...
<h3 id="Connect-directly-to-an-AI-agent-as-a-tool" class="common-anchor-header">Menghubungkan langsung ke agen AI sebagai alat bantu<button data-href="#Connect-directly-to-an-AI-agent-as-a-tool" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Anda dapat menghubungkan simpul Penyimpanan Vektor Milvus secara langsung ke konektor alat <a href="https://docs.n8n.io/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent/">agen AI</a> untuk menggunakan penyimpanan vektor sebagai sumber daya saat menjawab pertanyaan.</p>
...
<h3 id="Use-a-retriever-to-fetch-documents" class="common-anchor-header">Gunakan retriever untuk mengambil dokumen<button data-href="#Use-a-retriever-to-fetch-documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Use-the-Vector-Store-Question-Answer-Tool-to-answer-questions" class="common-anchor-header">Gunakan Alat Bantu Jawaban Pertanyaan Penyimpanan Vektor untuk menjawab pertanyaan<button data-href="#Use-the-Vector-Store-Question-Answer-Tool-to-answer-questions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<hr>
<h3 id="Operation-Modes-Overview" class="common-anchor-header">Gambaran Umum Mode Operasi<button data-href="#Operation-Modes-Overview" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Node Milvus Vector Store mendukung empat mode yang berbeda:</p>
<ul>
...
<h3 id="Additional-Node-Options" class="common-anchor-header">Opsi Node Tambahan<button data-href="#Additional-Node-Options" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Related-Resources" class="common-anchor-header">Sumber Daya Terkait<button data-href="#Related-Resources" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
