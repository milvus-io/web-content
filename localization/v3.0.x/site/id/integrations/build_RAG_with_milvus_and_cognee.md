...
<h3 id="Build-RAG-with-Milvus-and-Cognee" class="common-anchor-header">Membangun RAG dengan Milvus dan Cognee<button data-href="#Build-RAG-with-Milvus-and-Cognee" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Build-RAG" class="common-anchor-header">Membangun RAG<button data-href="#Build-RAG" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Resetting-Cognee-Data" class="common-anchor-header">Mengatur Ulang Data Cognee<button data-href="#Resetting-Cognee-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Adding-Data-and-Cognifying" class="common-anchor-header">Menambahkan Data dan Mengenali<button data-href="#Adding-Data-and-Cognifying" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Querying-for-Summaries" class="common-anchor-header">Mengajukan Pertanyaan untuk Rangkuman<button data-href="#Querying-for-Summaries" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Setelah data diproses, mari kita melakukan kueri pada grafik pengetahuan.</p>
...
<h3 id="Querying-for-Chunks" class="common-anchor-header">Mengajukan Kueri untuk Potongan<button data-href="#Querying-for-Chunks" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Ringkasan menawarkan wawasan tingkat tinggi, tetapi untuk detail yang lebih terperinci, kita dapat melakukan kueri untuk potongan data tertentu secara langsung dari kumpulan data yang telah diproses. Potongan-potongan ini berasal dari data asli yang ditambahkan dan dianalisis selama pembuatan grafik pengetahuan.</p>
<pre><code translate="no" class="language-python"><span class="hljs-keyword">from</span> cognee.api.v1.search <span class="hljs-keyword">import</span> SearchType
...
<p>Pada langkah sebelumnya, kami menanyakan dataset FAQ Milvus untuk ringkasan dan potongan data tertentu. Meskipun ini memberikan wawasan yang rinci dan informasi granular, datasetnya besar, sehingga sulit untuk memvisualisasikan ketergantungan dengan jelas di dalam grafik pengetahuan.</p>
...
<h3 id="Reset-Cognee" class="common-anchor-header">Mengatur Ulang Cognee<button data-href="#Reset-Cognee" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-keyword">await</span> cognee.prune.prune_system(metadata=<span class="hljs-literal">True</span>)
<button class="copy-code-btn"></button></code></pre>
<h3 id="Adding-the-Focused-Dataset" class="common-anchor-header">Menambahkan Dataset Terfokus<button data-href="#Adding-the-Focused-Dataset" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Di sini, kumpulan data yang lebih kecil dengan hanya satu baris teks ditambahkan dan diproses untuk memastikan grafik pengetahuan yang terfokus dan mudah diinterpretasikan.</p>
...
<span class="hljs-keyword">await</span> cognee.cognify()
<button class="copy-code-btn"></button></code></pre>
<h3 id="Querying-for-Insights" class="common-anchor-header">Mengajukan Pertanyaan untuk Wawasan<button data-href="#Querying-for-Insights" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Dengan berfokus pada kumpulan data yang lebih kecil ini, kita sekarang dapat dengan jelas menganalisis hubungan dan struktur di dalam knowledge graph.</p>
