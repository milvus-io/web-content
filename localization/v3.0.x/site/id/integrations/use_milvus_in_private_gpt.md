...
<h2 id="Base-requirements-to-run-PrivateGPT" class="common-anchor-header">Persyaratan dasar untuk menjalankan PrivateGPT<button data-href="#Base-requirements-to-run-PrivateGPT" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Clone-the-PrivateGPT-Repository" class="common-anchor-header">1. Kloning Repositori PrivateGPT<button data-href="#1-Clone-the-PrivateGPT-Repository" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Kloning repositori dan arahkan ke sana:</p>
...
<h3 id="2-Install-Poetry" class="common-anchor-header">2. Instal Puisi<button data-href="#2-Install-Poetry" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Instal <a href="https://python-poetry.org/docs/#installing-with-the-official-installer">Puisi</a> untuk manajemen ketergantungan: Ikuti petunjuk di situs web resmi Poetry untuk menginstalnya.</p>
<h3 id="3-Optional-Install-make" class="common-anchor-header">3. (Opsional) Instal make<button data-href="#3-Optional-Install-make" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk menjalankan berbagai skrip, Anda perlu menginstal make.</p>
