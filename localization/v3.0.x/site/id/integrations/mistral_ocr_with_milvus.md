...
summary: >-
  Tutorial ini mendemonstrasikan cara membangun sistem pemahaman dokumen
  menggunakan Milvus dan Mistral OCR.
title: Pemahaman Dokumen dengan Mistral OCR dan Milvus
---
...
<h1 id="Document-Understanding-with-Mistral-OCR-and-Milvus" class="common-anchor-header">Pemahaman Dokumen dengan Mistral OCR dan Milvus<button data-href="#Document-Understanding-with-Mistral-OCR-and-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Tutorial ini mendemonstrasikan cara membangun sistem pemahaman dokumen dengan menggunakan:</p>
<h2 id="Mistral-OCR" class="common-anchor-header">Mistral OCR<button data-href="#Mistral-OCR" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Layanan pengenalan karakter optik yang kuat yang:</p>
<ul>
<li>Memproses PDF, gambar, dan format dokumen lainnya</li>
<li>Mempertahankan struktur dan format dokumen</li>
<li>Menangani dokumen multi-halaman</li>
<li>Mengenali tabel, daftar, dan elemen kompleks lainnya</li>
</ul>
<h2 id="Mistral-Embeddings" class="common-anchor-header">Penyematan Mistral<button data-href="#Mistral-Embeddings" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Mengubah teks menjadi representasi numerik:</li>
<li>Mengubah teks menjadi vektor 1024 dimensi</li>
<li>Menangkap hubungan semantik antar konsep</li>
<li>Memungkinkan pencocokan kemiripan berdasarkan makna</li>
<li>Memberikan dasar untuk pencarian semantik</li>
</ul>
<h2 id="Milvus-Vector-Database" class="common-anchor-header">Basis Data Vektor Milvus<button data-href="#Milvus-Vector-Database" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Basis data khusus untuk pencarian kemiripan vektor:</p>
<ul>
<li>Sumber Terbuka</li>
<li>Melakukan Pencarian Vektor yang efisien</li>
<li>Berskala untuk koleksi dokumen yang besar</li>
<li>Mendukung pencarian hibrida (kemiripan vektor + pemfilteran metadata)</li>
<li>Dioptimalkan untuk aplikasi AI</li>
</ul>
<p>Di akhir tutorial ini, Anda akan memiliki sistem yang dapat:</p>
<ol>
<li>Memproses dokumen (PDF/gambar) melalui URL</li>
<li>Mengekstrak teks menggunakan OCR</li>
<li>Menyimpan teks dan penyematan vektor di Milvus</li>
<li>Melakukan pencarian semantik di seluruh koleksi dokumen Anda</li>
</ol>
<hr>
<h2 id="Setup-and-Dependencies" class="common-anchor-header">Pengaturan dan Ketergantungan<button data-href="#Setup-and-Dependencies" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pertama, mari kita instal paket-paket yang diperlukan:</p>
...
<ol>
<li>Kunci API Mistral (dapatkan di https://console.mistral.ai/)</li>
<li>Milvus berjalan secara lokal melalui <a href="https://milvus.io/docs/install_standalone-docker.md">Docker</a> atau dengan <a href="https://zilliz.com">Zilliz Cloud</a></li>
</ol>
<p>Mari kita siapkan lingkungan kita:</p>
...
<h2 id="Setting-Up-Milvus-Collection" class="common-anchor-header">Menyiapkan Koleksi Milvus<button data-href="#Setting-Up-Milvus-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Sekarang, mari kita buat koleksi Milvus untuk menyimpan data dokumen kita. Koleksi ini akan memiliki bidang-bidang berikut:</p>
<ul>
<li><code translate="no">id</code>: Kunci utama (dibuat secara otomatis)</li>
<li><code translate="no">url</code>: URL sumber dokumen</li>
<li><code translate="no">page_num</code>: Nomor halaman dalam dokumen</li>
<li><code translate="no">content</code>: Konten teks yang diekstrak</li>
<li><code translate="no">embedding</code>: Representasi vektor konten (1024 dimensi)</li>
</ul>
...
<h2 id="Core-Functionality" class="common-anchor-header">Fungsionalitas Inti<button data-href="#Core-Functionality" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Mari kita mengimplementasikan fungsi-fungsi inti untuk sistem pemahaman dokumen kita:</p>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">process_document</span>(<span class="hljs-params">url</span>):
    ...
    <span class="hljs-keyword">return</span> ocr_result
<button class="copy-code-btn"></button></code></pre>
<h2 id="Search-Functionality" class="common-anchor-header">Fungsionalitas Pencarian<button data-href="#Search-Functionality" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Sekarang, mari kita mengimplementasikan fungsi pencarian untuk mengambil konten dokumen yang relevan:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Demo-Processing-Documents" class="common-anchor-header">Demo: Memproses Dokumen<button data-href="#Demo-Processing-Documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Mari kita memproses beberapa contoh dokumen. Anda dapat mengganti URL ini dengan dokumen Anda sendiri.</p>
...
<p>Mari kita memproses gambar juga:</p>
...
<h2 id="Demo-Searching-Documents" class="common-anchor-header">Demo: Mencari Dokumen<button data-href="#Demo-Searching-Documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Sekarang setelah kita memproses beberapa dokumen, mari kita cari dokumen-dokumen tersebut:</p>
...
<p>Coba permintaan pencarian yang lain:</p>
...
<h2 id="Conclusion" class="common-anchor-header">Kesimpulan<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Dalam tutorial ini, kita telah membuat sistem pemahaman dokumen yang lengkap menggunakan Mistral OCR dan Milvus. Sistem ini dapat:</p>
<ol>
<li>Memproses dokumen dari URL</li>
<li>Mengekstrak teks menggunakan kemampuan OCR Mistral</li>
<li>Menghasilkan penyematan vektor untuk konten</li>
<li>Menyimpan teks dan vektor di Milvus</li>
<li>Melakukan pencarian semantik di semua dokumen yang diproses</li>
</ol>
<p>Pendekatan ini memungkinkan kemampuan pemahaman dokumen yang kuat yang melampaui pencocokan kata kunci sederhana, sehingga pengguna dapat menemukan informasi berdasarkan makna, bukan pencocokan teks yang sama persis.</p>
