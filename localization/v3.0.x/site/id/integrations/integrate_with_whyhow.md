...
<h2 id="Create-Collection" class="common-anchor-header">Membuat Koleksi<button data-href="#Create-Collection" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Defining-necessary-variables" class="common-anchor-header">Mendefinisikan variabel yang diperlukan<button data-href="#Defining-necessary-variables" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Add-schema" class="common-anchor-header">Menambahkan skema<button data-href="#Add-schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sebelum memasukkan data ke dalam database Milvus Lite, kita perlu mendefinisikan field data terlebih dahulu, yang disebut schema di sini. Dengan membuat objek <code translate="no">CollectionSchema</code> dan menambahkan data field melalui <code translate="no">add_field()</code>, kita dapat mengatur tipe data dan karakteristiknya. Langkah ini wajib dilakukan sebelum memasukkan data apapun ke dalam Milvus.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Rules" class="common-anchor-header">Aturan<button data-href="#Rules" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Pada contoh sebelumnya, setiap dokumen di dalam indeks kita telah dipertimbangkan. Namun, kadang-kadang mungkin bermanfaat untuk hanya mengambil dokumen yang memenuhi beberapa kondisi yang telah ditentukan (misalnya <code translate="no">filename=harry-potter.pdf</code>). Di <code translate="no">whyhow_rbr</code> melalui Milvus Lite, hal ini dapat dilakukan dengan menyesuaikan parameter pencarian.</p>
...
<h3 id="Clean-up" class="common-anchor-header">Bersihkan<button data-href="#Clean-up" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Akhirnya, setelah menerapkan semua instruksi, Anda dapat membersihkan basis data dengan menghubungi <code translate="no">drop_collection()</code>.</p>
