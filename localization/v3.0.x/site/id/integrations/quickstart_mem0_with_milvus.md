...
<p>Di sini, kita menambahkan memori Alice, "bekerja untuk meningkatkan kemampuan tenis saya," bersama dengan metadata yang relevan untuk konteks ke Milvus.</p>
...
<h3 id="Update-a-Memory" class="common-anchor-header">Memperbarui Memori<button data-href="#Update-a-Memory" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Kita dapat menggunakan nilai balik fungsi <code translate="no">add</code> untuk mengambil ID memori, sehingga kita dapat memperbarui memori ini dengan informasi baru melalui <code translate="no">update</code>.</p>
...
<h3 id="Get-All-Memory-For-a-User" class="common-anchor-header">Mendapatkan Semua Memori Untuk Seorang Pengguna<button data-href="#Get-All-Memory-For-a-User" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Kita dapat menggunakan fungsi <code translate="no">get_all</code> untuk melihat semua memori yang disisipkan atau memfilter dengan <code translate="no">user_id</code> di Milvus.</p>
