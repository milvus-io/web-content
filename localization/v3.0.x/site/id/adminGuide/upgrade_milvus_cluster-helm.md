...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Meningkatkan Kluster Milvus dengan Helm Chart<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini menjelaskan cara memperbarui kluster Milvus 2.6.x Anda ke versi 3.0.2 menggunakan Helm.</p>
...
<li>Deploy Milvus 2.6.x yang sudah ada dan dikelola oleh Helm</li>
...
<p>Prosedur ini tidak memvalidasi penurunan versi atau rollback dengan mengubah gambar Milvus kembali ke 2.6.x. Setelah v3.0.2 menulis data, pengembalian ke versi sebelumnya yang hanya melibatkan gambar mungkin gagal membaca status yang telah diperbarui. Jika peningkatan gagal, hentikan penulisan dan gunakan rencana pemulihan yang memulihkan metadata sebelum peningkatan serta cadangan data persisten. Validasi rencana pemulihan di lingkungan non-produksi terlebih dahulu.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Pastikan semua beban kerja yang diperlukan sudah siap, semua komponen Milvus menggunakan ` <code translate="no">v3.0.2</code>`, dan koleksi yang ada tetap dapat di-query dan dicari. Selesaikan pemeriksaan ini sebelum mengaktifkan fitur apa pun yang spesifik untuk v3.0.2.</p>
<div class="alert note">
