...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Meningkatkan Kluster Milvus dengan Helm Chart<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini menjelaskan cara memperbarui kluster Milvus 2.6.x Anda ke v3.0.0 menggunakan Helm.</p>
<div class="alert note">
<p>Prosedur ini telah diverifikasi dari Milvus 2.6.20 hingga Milvus v3.0.0 dengan Milvus Helm Chart 5.0.22. Jika Anda menggunakan rilis patch Milvus 2.6.x atau versi Helm Chart lainnya, lakukan verifikasi peningkatan versi terlebih dahulu di lingkungan non-produksi.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Pastikan semua beban kerja yang diperlukan sudah siap, semua komponen Milvus menggunakan ` <code translate="no">v3.0.0</code>`, dan koleksi yang ada tetap dapat di-query dan dicari. Selesaikan pemeriksaan ini sebelum mengaktifkan fitur apa pun yang spesifik untuk v3.0.0.</p>
<div class="alert note">
