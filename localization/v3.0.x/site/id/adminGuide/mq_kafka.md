...
<li><strong>Peningkatan versi dari 2.5.x ke 2.6.x:</strong> <strong>Batasan antrian pesan</strong>: Saat melakukan peningkatan ke Milvus v3.0-beta, Anda harus mempertahankan pilihan antrian pesan saat ini. Pergantian sistem antrian pesan selama proses peningkatan tidak didukung. Dukungan untuk mengganti sistem antrian pesan akan tersedia pada versi mendatang.
