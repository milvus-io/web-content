...
<h2 id="Deploy-a-Milvus-cluster-with-Kafka-using-Helm" class="common-anchor-header">Deploy kluster Milvus dengan Kafka menggunakan Helm<button data-href="#Deploy-a-Milvus-cluster-with-Kafka-using-Helm" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Untuk menggunakan layanan Kafka eksternal, nonaktifkan Pulsar yang disertakan dan aktifkan opsi " <code translate="no">externalKafka</code> " dalam file override ` <code translate="no">values.yaml</code> `, lalu instal Milvus dengan layanan tersebut:</p>
