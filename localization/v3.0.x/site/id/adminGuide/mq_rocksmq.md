...
Peralihan <code translate="no">mq.type</code> dengan cara ini ditujukan untuk instance yang <b>benar-benar baru</b> (belum memiliki koleksi apa pun). Untuk mengubah antrian pesan pada instance yang sudah menyimpan data, ikuti <a href="/docs/id/switch-rocksmq-woodpecker.md">prosedur peralihan</a> sebagai gantinya.
</div>
