...
<h1 id="Object-Storage" class="common-anchor-header">Penyimpanan Objek<button data-href="#Object-Storage" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus menyimpan berkas indeks dan log biner — sebagian besar datanya — di penyimpanan objek. Milvus mendukung MinIO serta berbagai penyimpanan objek yang kompatibel dengan S3 dan berbasis cloud.</p>
