...
<h1 id="Message-Queue-Overview" class="common-anchor-header">Gambaran Umum Antrian Pesan<button data-href="#Message-Queue-Overview" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus mengandalkan antrian pesan (write-ahead log, WAL) untuk mengelola log perubahan terbaru, log aliran keluaran, dan menyediakan langganan log. Pada Milvus 3.x, <strong>Woodpecker</strong> adalah antrian pesan default dan tidak memerlukan infrastruktur pesan terpisah. Pulsar, Kafka, dan RocksMQ tetap didukung untuk skenario tertentu.</p>
...
<li><strong>Penerapan baru (Milvus 3.x):</strong> gunakan <strong>Woodpecker</strong> (pengaturan default). Pada lingkungan standalone, Woodpecker dijalankan secara tertanam; untuk lingkungan terdistribusi (kluster), pengaturan default yang direkomendasikan adalah <a href="/docs/id/woodpecker.md#Deployment-modes">layanan</a> khusus yang diterapkan menggunakan Helm, dan mode tertanam juga didukung.</li>
