...
<h2 id="Configure-etcd-with-Docker-Compose" class="common-anchor-header">Mengonfigurasi etcd dengan Docker Compose<button data-href="#Configure-etcd-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Configure-etcd" class="common-anchor-header">1. Mengkonfigurasi etcd<button data-href="#1-Configure-etcd" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk mengonfigurasi etcd dengan Docker Compose, berikan nilai Anda untuk bagian <code translate="no">etcd</code> di berkas <code translate="no">milvus.yaml</code> pada jalur milvus/configs.</p>
...
<h3 id="2-Run-Milvus" class="common-anchor-header">2. Menjalankan Milvus<button data-href="#2-Run-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Jalankan perintah berikut untuk menjalankan Milvus yang menggunakan konfigurasi etcd.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Using-a-command" class="common-anchor-header">Menggunakan sebuah perintah<button data-href="#Using-a-command" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk menginstall Milvus dan mengkonfigurasi etcd, jalankan perintah berikut ini dengan menggunakan nilai-nilai Anda.</p>
