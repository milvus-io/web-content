...
<button class="copy-code-btn"></button></code></pre>
<p>Pastikan bahwa CR Milvus melaporkan ` <code translate="no">Healthy</code>`, semua komponen Milvus menggunakan ` <code translate="no">milvusdb/milvus:v3.0-beta</code>`, tidak ada Pod IndexNode yang berjalan, dan koleksi yang ada tetap dapat di-query dan dicari. Selesaikan pemeriksaan ini sebelum Anda mengaktifkan fitur apa pun yang spesifik untuk v3.0-beta.</p>
