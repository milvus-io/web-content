...
<h3 id="External-etcd" class="common-anchor-header">etcd eksternal<button data-href="#External-etcd" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><h4 id="Example" class="common-anchor-header">Contoh</h4><p>Contoh berikut ini mengonfigurasi layanan etcd eksternal.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Internal-etcd" class="common-anchor-header">Internal etcd<button data-href="#Internal-etcd" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><code translate="no">inCluster</code> menunjukkan ketika kluster Milvus dimulai, layanan etcd dimulai secara otomatis di dalam kluster.</p>
...
<li><a href="/docs/id/message_storage_operator.md">Mengkonfigurasi Penyimpanan Pesan dengan Milvus Operator</a></li>
</ul>
