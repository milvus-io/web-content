...
<p>Dalam panduan ini, Anda akan mempelajari cara:</p>
<ul>
<li>Menerapkan <a href="https://grafana.com/docs/loki/latest/get-started/overview/">Loki</a> dan <a href="https://grafana.com/docs/alloy/latest/">Alloy</a> pada cluster Milvus menggunakan Helm.</li>
<li>Mengonfigurasi penyimpanan objek untuk Loki.</li>
<li>Melakukan kueri log menggunakan Grafana.</li>
</ul>
<p>Sebagai referensi, <a href="https://grafana.com/docs/loki/latest/send-data/promtail/#promtail-agent">Promtail</a> akan ditinggalkan. Jadi, kami memperkenalkan Alloy, yang secara resmi disarankan oleh Grafana Labs sebagai agen baru untuk mengumpulkan log Kubernetes dan meneruskannya ke Loki.</p>
...
<li>Anda telah <a href="/docs/id/install_cluster-helm.md">menginstal klaster Milvus pada K8.</a></li>
...
<h3 id="1-Add-Grafanas-Helm-Chart-Repository" class="common-anchor-header">1. Menambahkan Repositori Bagan Helm Grafana<button data-href="#1-Add-Grafanas-Helm-Chart-Repository" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Tambahkan repositori bagan Grafana ke Helm dan perbarui:</p>
...
<h3 id="2-Configure-Object-Storage-for-Loki" class="common-anchor-header">2. Mengonfigurasi Penyimpanan Objek untuk Loki<button data-href="#2-Configure-Object-Storage-for-Loki" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Pilih salah satu opsi penyimpanan berikut dan buat file konfigurasi <code translate="no">loki.yaml</code>:</p>
<ul>
...
<h3 id="3-Install-Loki" class="common-anchor-header">3. Menginstal Loki<button data-href="#3-Install-Loki" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Jalankan perintah berikut untuk menginstal Loki:</p>
<pre><code translate="no" class="language-shell">kubectl create ns loki
helm install --values loki.yaml loki grafana/loki -n loki
<button class="copy-code-btn"></button></code></pre>
<h2 id="Deploy-Alloy" class="common-anchor-header">Menyebarkan Paduan<button data-href="#Deploy-Alloy" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Kami akan menunjukkan kepada Anda <a href="https://grafana.com/docs/alloy/latest/configure/">Konfigurasi</a> Paduan.</p>
<h3 id="1-Create-Alloy-Configuration" class="common-anchor-header">1. Membuat Konfigurasi Paduan<button data-href="#1-Create-Alloy-Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Kita akan menggunakan <code translate="no">alloy.yaml</code> berikut ini untuk mengumpulkan log dari semua pod Kubernetes &amp; mengirimkannya ke Loki melalui loki-gateway:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Install-Alloy" class="common-anchor-header">2. Instal Alloy<button data-href="#2-Install-Alloy" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Query-Logs-with-Grafana" class="common-anchor-header">Menanyakan Log dengan Grafana<button data-href="#Query-Logs-with-Grafana" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Terapkan Grafana dan konfigurasikan agar terhubung ke Loki untuk log kueri.</p>
<h3 id="1-Deploy-Grafana" class="common-anchor-header">1. Menyebarkan Grafana<button data-href="#1-Deploy-Grafana" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Instal Grafana menggunakan perintah berikut:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Add-Loki-as-a-Data-Source-in-Grafana" class="common-anchor-header">2. Menambahkan Loki sebagai Sumber Data di Grafana<button data-href="#2-Add-Loki-as-a-Data-Source-in-Grafana" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="3-Query-Milvus-Logs" class="common-anchor-header">3. Menanyakan Log Milvus<button data-href="#3-Query-Milvus-Logs" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Setelah menambahkan Loki sebagai sumber data, lakukan kueri log Milvus di Grafana:</p>
<ol>
