...
<h2 id="Visualize-metrics-using-Grafana" class="common-anchor-header">Memvisualisasikan metrik menggunakan Grafana<button data-href="#Visualize-metrics-using-Grafana" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Download-and-import-dashboard" class="common-anchor-header">1. Unduh dan impor dasbor<button data-href="#1-Download-and-import-dashboard" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Unduh dan impor dasbor Milvus dari file JSON.</p>
...
<h3 id="2-View-metrics" class="common-anchor-header">2. Melihat metrik<button data-href="#2-View-metrics" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Pilih instance Milvus yang ingin Anda pantau. Kemudian Anda dapat melihat panel komponen Milvus.</p>
<p>
