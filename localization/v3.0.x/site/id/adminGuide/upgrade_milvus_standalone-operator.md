...
<p>Prosedur ini telah diverifikasi dari Milvus 2.6.20 ke Milvus v3.0-beta dengan Milvus Operator 1.3.0, Woodpecker, etcd dalam klaster, dan MinIO dalam klaster. Jika Anda menggunakan rilis patch Milvus 2.6.x, versi Operator, antrian pesan, atau konfigurasi dependensi lainnya, validasi pembaruan tersebut terlebih dahulu di lingkungan non-produksi.</p>
</div>
...
<h3 id="Step-3-Update-the-Milvus-image" class="common-anchor-header">Langkah 3: Perbarui gambar Milvus<button data-href="#Step-3-Update-the-Milvus-image" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Dalam manifest CR Milvus yang lengkap, ubah hanya <code translate="no">spec.components.image</code>. Pertahankan mode yang ada, pengaturan komponen, antrian pesan, etcd, penyimpanan, dan pengaturan dependensi lainnya. Kutipan berikut menunjukkan bidang yang perlu diubah; jangan mengganti CR lengkap Anda dengan kutipan ini.</p>
