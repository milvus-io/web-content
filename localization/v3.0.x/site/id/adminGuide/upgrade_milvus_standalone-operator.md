...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Memperbarui Milvus Standalone dengan Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini menjelaskan cara memutakhirkan deployment Milvus 2.6.x standalone ke v3.0.1 menggunakan Milvus Operator.</p>
<div class="alert note">
<p>Prosedur ini telah diuji coba dari Milvus 2.6.20 hingga Milvus v3.0.1 dengan Milvus Operator 1.3.0, Woodpecker, etcd dalam kluster, dan MinIO dalam kluster. Jika Anda menggunakan rilis patch Milvus 2.6.x, versi Operator, antrian pesan, atau konfigurasi dependensi lain, validasi pembaruan tersebut terlebih dahulu di lingkungan non-produksi.</p>
</div>
...
<li>Sebuah kluster Kubernetes dengan penyebaran Milvus 2.6.x standalone yang dikelola oleh Milvus Operator</li>
...
<li>Metode instalasi dan manifest yang digunakan untuk Milvus Operator yang ada</li>
...
<button class="copy-code-btn"></button></code></pre>
<p>Pastikan bahwa CR Milvus melaporkan ` <code translate="no">Healthy</code>`, gambar saat ini adalah ` <code translate="no">milvusdb/milvus:v3.0.1</code>`, dan koleksi yang ada tetap dapat di-query dan dicari. Selesaikan pemeriksaan ini sebelum Anda mengaktifkan fitur apa pun yang spesifik untuk v3.0.1.</p>
