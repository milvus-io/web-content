...
<h1 id="Encryption-in-Transit" class="common-anchor-header">Enkripsi dalam Perjalanan<button data-href="#Encryption-in-Transit" class="anchor-icon" translate="no">
    ...
    </button></h1><p>TLS (Transport Layer Security) adalah protokol enkripsi untuk memastikan keamanan komunikasi. Milvus proxy menggunakan autentikasi TLS satu arah dan dua arah.</p>
...
<p>Pada log Milvus, Anda akan melihat pesan berikut ini jika TLS internal telah diaktifkan:</p>
