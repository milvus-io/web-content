...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>Pada pesan log di atas, <code translate="no">&lt;MQ1&gt;</code> adalah jenis MQ sumber (<code translate="no">woodpecker</code>), dan <code translate="no">&lt;MQ2&gt;</code> adalah jenis MQ target (misal, <code translate="no">pulsar</code> atau <code translate="no">kafka</code>).</p>
<ul>
<li>Pesan pertama menunjukkan bahwa peralihan WAL dari sumber ke target telah selesai.</li>
<li>Pesan kedua menunjukkan bahwa semua saluran fisik telah dialihkan.</li>
