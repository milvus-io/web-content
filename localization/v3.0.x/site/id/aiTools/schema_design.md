...
<h1 id="Schema-Design" class="common-anchor-header">Desain Skema<button data-href="#Schema-Design" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Aturan dan panduan pengambilan keputusan untuk merancang skema koleksi Milvus yang benar, termasuk jenis bidang, kunci utama, konfigurasi BM25, dan batasan ketidakberubahannya skema. Salin prompt lengkap di bawah ini ke alat AI Anda untuk menerapkan aturan-aturan ini secara otomatis. Untuk gambaran umum semua prompt, lihat <a href="/docs/id/milvus_for_agents.md">AI Prompts</a>.</p>
