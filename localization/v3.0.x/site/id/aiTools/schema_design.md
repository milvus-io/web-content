---
id: schema_design.md
title: 'Perintah: Desain Skema Milvus'
summary: >-
  Aturan bagi asisten pemrograman AI untuk merancang skema koleksi Milvus yang
  benar.
---
<h1 id="Schema-Design" class="common-anchor-header">Desain Skema<button data-href="#Schema-Design" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Aturan dan panduan pengambilan keputusan untuk merancang skema koleksi Milvus yang benar, termasuk jenis bidang, kunci utama, konfigurasi BM25, dan batasan ketidakberubahan skema. Salin prompt lengkap di bawah ini ke alat AI Anda untuk menerapkan aturan-aturan ini secara otomatis. Untuk gambaran umum semua prompt, lihat <a href="/docs/id/milvus_for_agents.md">Prompt AI</a>.</p>
...
<li><strong>Salin</strong> prompt lengkap dari bagian " <a href="#full-prompt">Prompt Lengkap</a> " di bawah ini.</li>
<li><strong>Simpan</strong> di lokasi yang diharapkan oleh alat AI Anda — lihat <a href="/docs/id/milvus_for_agents.md">tabel lingkungan</a> untuk detail penempatannya.</li>
<li>Asisten AI Anda akan secara otomatis menerapkan aturan-aturan ini saat menghasilkan atau meninjau kode Milvus.</li>
</ol>
<p>Untuk pengguna <strong>Cursor</strong>: salin prompt dari bagian " <a href="#full-prompt">Full prompt</a> " dan simpan di bawah " <code translate="no">.cursor/rules/</code> " dalam proyek Anda.</p>
<h2 id="Full-prompt" class="common-anchor-header">Prompt lengkap<button data-href="#Full-prompt" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
