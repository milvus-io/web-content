...
title: 'Cepat: Pemilihan Indeks Milvus'
summary: >-
  Aturan untuk asisten pengkodean AI untuk memilih dan mengonfigurasi indeks
  Milvus.
---
<h1 id="Index-Selection" class="common-anchor-header">Pemilihan Indeks<button data-href="#Index-Selection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Panduan keputusan dan aturan konfigurasi untuk memilih dan menyetel indeks Milvus, termasuk AUTOINDEX, HNSW, DiskANN, IVF, dan indeks jarang. Salin perintah lengkap di bawah ini ke dalam alat AI Anda untuk menerapkan aturan-aturan ini secara otomatis. Untuk ikhtisar semua petunjuk, lihat <a href="/docs/id/milvus_for_agents.md">Petunjuk AI</a>.</p>
