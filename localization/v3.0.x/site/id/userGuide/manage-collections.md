...
<h3 id="Quick-setup" class="common-anchor-header">Penyiapan cepat<button data-href="#Quick-setup" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Dengan latar belakang lompatan besar dalam industri AI, sebagian besar pengembang hanya membutuhkan koleksi yang sederhana namun dinamis untuk memulai. Milvus memungkinkan penyiapan cepat untuk koleksi semacam itu hanya dengan tiga argumen:</p>
<ul>
...
<h3 id="Customized-setup" class="common-anchor-header">Penyiapan yang disesuaikan<button data-href="#Customized-setup" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Daripada membiarkan Milvus memutuskan hampir semua hal untuk koleksi Anda, Anda dapat menentukan <strong>skema</strong> dan <strong>parameter indeks</strong> koleksi sendiri.</p>
...
<table class="language-python">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Nama algoritme yang digunakan untuk mengatur data dalam bidang tertentu. Untuk algoritme yang dapat diterapkan, lihat <a href="https://milvus.io/docs/index.md">Indeks Dalam Memori</a> dan <a href="https://milvus.io/docs/disk_index.md">Indeks Pada Disk</a>.</td>
    </tr>
    <tr>
...
<h3 id="Load-a-collection" class="common-anchor-header">Memuat koleksi<button data-href="#Load-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash">}</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Load-a-collection-partially-Public-Preview" class="common-anchor-header">Memuat koleksi sebagian (Pratinjau Publik)<button data-href="#Load-a-collection-partially-Public-Preview" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Release-a-collection" class="common-anchor-header">Melepaskan koleksi<button data-href="#Release-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Create-aliases" class="common-anchor-header">Membuat nama alias<button data-href="#Create-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="List-aliases" class="common-anchor-header">Membuat daftar alias<button data-href="#List-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash"><span class="hljs-string">}</span></span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Describe-aliases" class="common-anchor-header">Menjelaskan alias<button data-href="#Describe-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash"><span class="hljs-string">}</span></span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Reassign-aliases" class="common-anchor-header">Menetapkan ulang alias<button data-href="#Reassign-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash"><span class="hljs-string">}</span></span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Drop-aliases" class="common-anchor-header">Menghapus alias<button data-href="#Drop-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Set-TTL" class="common-anchor-header">Mengatur TTL<button data-href="#Set-TTL" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Mengatur Time-To-Live (TTL) untuk data dalam koleksi, yang menentukan berapa lama data harus disimpan sebelum dihapus secara otomatis.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Set-MMAP" class="common-anchor-header">Mengatur MMAP<button data-href="#Set-MMAP" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Konfigurasikan properti pemetaan memori (MMAP) untuk koleksi, yang menentukan apakah data dipetakan ke dalam memori untuk meningkatkan kinerja kueri. Untuk informasi lebih lanjut, lihat <a href="https://milvus.io/docs/mmap.md#Configure-memory-mapping">Mengonfigurasi pemetaan memori</a>.</p>
<div class="alert note">
