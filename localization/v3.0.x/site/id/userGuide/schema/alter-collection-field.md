...
title: Mengubah Properti Bidang Koleksi
summary: >-
...
---
<h1 id="Alter-Collection-Field" class="common-anchor-header">Mengubah Properti Bidang Koleksi<button data-href="#Alter-Collection-Field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Halaman ini membahas perubahan properti bidang, bukan perubahan bentuk skema seperti menambahkan atau menghapus bidang. Untuk menambahkan bidang skalar atau menghapus bidang dari koleksi yang sudah ada, lihat <a href="/docs/id/add-fields-to-an-existing-collection.md">Mengubah Skema Koleksi</a>.</p>
<div class="alert note">
<ul>
<li><p>Setiap koleksi hanya terdiri dari satu bidang utama. Setelah ditetapkan saat pembuatan koleksi, Anda tidak dapat mengubah bidang utama atau mengubah propertinya.</p></li>
<li><p>Setiap koleksi hanya dapat memiliki satu kunci partisi. Setelah ditetapkan saat pembuatan koleksi, Anda tidak dapat mengubah kunci partisi tersebut.</p></li>
</ul>
</div>
<h2 id="Alter-VarChar-field" class="common-anchor-header">Mengubah Bidang VarChar<button data-href="#Alter-VarChar-field" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Sebuah bidang VarChar memiliki properti bernama ` <code translate="no">max_length</code>`, yang membatasi jumlah karakter maksimum yang dapat ditampung oleh nilai bidang tersebut. Anda dapat mengubah properti ` <code translate="no">max_length</code> `.</p>
<p>Contoh berikut mengasumsikan koleksi memiliki bidang VarChar bernama ` <code translate="no">varchar</code> ` dan mengatur properti ` <code translate="no">max_length</code> `-nya.</p>
...
<h2 id="Alter-ARRAY-field" class="common-anchor-header">Mengubah bidang ARRAY<button data-href="#Alter-ARRAY-field" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Sebuah bidang array memiliki dua properti, yaitu ` <code translate="no">element_type</code> ` dan ` <code translate="no">max_capacity</code>`. Properti pertama menentukan tipe data elemen-elemen dalam array, sedangkan properti kedua membatasi jumlah maksimum elemen dalam array. Anda hanya dapat mengubah properti ` <code translate="no">max_capacity</code> `.</p>
<p>Contoh berikut mengasumsikan koleksi memiliki bidang array bernama ` <code translate="no">array</code> ` dan mengatur properti ` <code translate="no">max_capacity</code> `-nya.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
...
<h2 id="Alter-field-level-mmap-settings" class="common-anchor-header">Mengubah pengaturan mmap tingkat bidang<button data-href="#Alter-field-level-mmap-settings" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pemetaan memori (Mmap) memungkinkan akses memori langsung ke file besar di disk, sehingga Milvus dapat menyimpan indeks dan data baik di memori maupun di hard drive. Pendekatan ini membantu mengoptimalkan kebijakan penempatan data berdasarkan frekuensi akses, memperluas kapasitas penyimpanan untuk koleksi tanpa memengaruhi kinerja pencarian.</p>
<p>Contoh berikut mengasumsikan koleksi memiliki bidang bernama ` <code translate="no">doc_chunk</code> ` dan mengatur properti ` <code translate="no">mmap_enabled</code> `-nya.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
