...
summary: >-
  Penganalisis bahasa Thailand bawaan ini membagi teks bahasa Thailand menjadi
  kata-kata, menstandarkan angka desimal Unicode, dan menghapus kata-kata
  pengisi dalam bahasa Thailand.
beta: Milvus 3.0.0+
---
...
<p>Untuk menggunakan penganalisis bahasa Thailand bawaan, atur ` <code translate="no">type</code> ` ke ` <code translate="no">thai</code>`:</p>
<pre><code translate="no" class="language-python">analyzer_params = {
    <span class="hljs-string">&quot;type&quot;</span>: <span class="hljs-string">&quot;thai&quot;</span>,
}
<button class="copy-code-btn"></button></code></pre>
<p>Penganalisis <code translate="no">thai</code> menerima parameter opsional berikut:</p>
<table>
   <tr>
     <th><p>Parameter</p></th>
     <th><p>Tipe</p></th>
...
<p>Setelah mendefinisikan <code translate="no">analyzer_params</code>, Anda dapat menerapkan penganalisis tersebut ke bidang <code translate="no">VARCHAR</code> saat mendefinisikan skema koleksi. Untuk detailnya, lihat <a href="/docs/id/analyzer-overview.md#Example-use">Contoh penggunaan</a>.</p>
