...
<ul>
<li><p><strong>Tokenizer</strong>: Menggunakan tokenizer <code translate="no">standard</code> untuk membagi teks menjadi unit kata terpisah berdasarkan aturan tata bahasa. Untuk informasi lebih lanjut, lihat <a href="/docs/id/standard-tokenizer.md">Tokenizer Standar</a>.</p></li>
<li><p><strong>Filter</strong>: Menggunakan filter <code translate="no">lowercase</code> untuk mengubah semua token menjadi huruf kecil, sehingga memungkinkan pencarian yang tidak peka huruf besar/kecil. Untuk informasi lebih lanjut, lihat <a href="/docs/id/lowercase-filter.md">Huruf Kecil</a>.</p></li>
</ul>
