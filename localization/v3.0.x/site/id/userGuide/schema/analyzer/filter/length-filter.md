...
title: Panjang
summary: >-
  Filter panjang menghapus token yang tidak memenuhi persyaratan panjang yang
...
<p>Filter <code translate="no">length</code> beroperasi berdasarkan ketentuan yang dibuat oleh tokenizer, sehingga harus digunakan bersama dengan tokenizer. Untuk daftar tokenizer yang tersedia di Milvus, lihat <a href="/docs/id/standard-tokenizer.md">Tokenizer Standar</a> dan halaman-halaman terkait.</p>
