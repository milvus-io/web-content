...
beta: Milvus 3.0.0+
---
<h1 id="Arabic-Normalization" class="common-anchor-header">Normalisasi Bahasa Arab<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 3.0.0+</span><button data-href="#Arabic-Normalization" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Filter ` <code translate="no">arabic_normalization</code> ` tidak memiliki parameter yang dapat dikonfigurasi.</p>
<p>Filter ini menerapkan transformasi berikut:</p>
<table>
   <tr>
     <th><p>Transformasi</p></th>
     <th><p>Dari</p></th>
     <th><p>Ke</p></th>
   </tr>
   <tr>
     <td><p>Varian Hamza + Alef</p></td>
   ...
   <tr>
     <td><p>Harakat</p></td>
     <td><p><code translate="no">U+064B</code> melalui <code translate="no">U+065F</code></p></td>
     <td><p>Dihapus</p></td>
   </tr>
   <tr>
...
<p>Filter ini bekerja pada token yang dihasilkan oleh tokenizer. Konfigurasi di atas sengaja dibuat sebagai contoh penganalisis khusus dan tidak mencakup seluruh alur pemrosesan bahasa Arab.</p>
