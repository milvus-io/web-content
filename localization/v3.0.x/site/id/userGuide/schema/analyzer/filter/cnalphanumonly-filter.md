...
<button class="copy-code-btn"></button></code></pre>
<p>Filter <code translate="no">cnalphanumonly</code> beroperasi berdasarkan ketentuan yang dibuat oleh tokenizer, jadi filter ini harus digunakan bersama dengan tokenizer. Untuk daftar tokenizer yang tersedia di Milvus, lihat halaman <a href="/docs/id/jieba-tokenizer.md">Jieba</a> dan halaman saudaranya.</p>
