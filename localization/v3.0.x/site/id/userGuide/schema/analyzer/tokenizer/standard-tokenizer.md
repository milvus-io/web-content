...
<p>Untuk penyiapan yang lebih sederhana, Anda dapat memilih untuk menggunakan <a href="/docs/id/standard-analyzer.md"><code translate="no">standard</code></a> <a href="/docs/id/standard-analyzer.md">analyzer</a>, yang menggabungkan tokenizer <code translate="no">standard</code> dengan <a href="/docs/id/lowercase-filter.md"><code translate="no">lowercase</code></a><a href="/docs/id/lowercase-filter.md"> filter</a>.</p>
</div>
