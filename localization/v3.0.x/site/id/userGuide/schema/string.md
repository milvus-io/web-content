...
<p>Untuk teks sumber yang lebih panjang, bagian dokumen, isi artikel, tiket, atau log yang harus disimpan dan dikembalikan bersama entitas, gunakan bidang ` <code translate="no">TEXT</code> `. Gunakan ` <code translate="no">TEXT</code> ` jika nilai mungkin melebihi ` <code translate="no">65,535</code> ` byte atau jika Anda tidak ingin menetapkan ` <code translate="no">max_length</code> ` tetap dalam skema koleksi. Untuk detailnya, lihat <a href="/docs/id/text.md">Bidang Teks</a>.</p>
...
<ul>
<li><p><code translate="no">varchar_field1</code>: menyimpan hingga 100 byte, mengizinkan nilai null, dan memiliki nilai default berupa " <code translate="no">&quot;Unknown&quot;</code>".</p></li>
...
<button class="copy-code-btn"></button></code></pre>
<p>Untuk mengambil entitas di mana <code translate="no">varchar_field1</code> memiliki nilai <code translate="no">&quot;Unknown&quot;</code>, gunakan ekspresi berikut. Karena nilai default <code translate="no">varchar_field1</code> adalah <code translate="no">&quot;Unknown&quot;</code>, hasil yang diharapkan harus mencakup entitas dengan <code translate="no">varchar_field1</code> yang secara eksplisit ditetapkan ke <code translate="no">&quot;Unknown&quot;</code> atau dengan <code translate="no">varchar_field1</code> yang ditetapkan ke null.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
