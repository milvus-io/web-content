...
title: Menggunakan Bidang JSON
---
<h1 id="Use-JSON-Fields" class="common-anchor-header">Menggunakan Bidang JSON<button data-href="#Use-JSON-Fields" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Panduan ini menjelaskan cara menggunakan bidang JSON, seperti menyisipkan nilai JSON serta mencari dan melakukan kueri di bidang JSON dengan operator dasar dan lanjutan.</p>
<h2 id="Overview" class="common-anchor-header">Ikhtisar<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>JSON adalah singkatan dari Javascript Object Notation, yang merupakan format data berbasis teks yang ringan dan sederhana. Data dalam JSON terstruktur dalam pasangan kunci-nilai, di mana setiap kunci adalah string yang memetakan ke nilai angka, string, boolean, daftar, atau larik. Dengan cluster Milvus, Anda dapat menyimpan kamus sebagai nilai field dalam koleksi.</p>
<p>Sebagai contoh, kode berikut ini secara acak menghasilkan pasangan nilai-kunci, masing-masing berisi bidang JSON dengan <strong>warna</strong> kunci.</p>
...
<p><b>Catatan</b></p>
<ul>
<li><p>Pastikan semua nilai dalam daftar atau larik memiliki tipe data yang sama.</p></li>
<li><p>Semua kamus bersarang dalam nilai bidang JSON akan dianggap sebagai string.</p></li>
<li><p>Gunakan hanya karakter alfanumerik dan garis bawah untuk menamai kunci JSON, karena karakter lain dapat menyebabkan masalah pada pemfilteran atau pencarian.</p></li>
<li>Saat ini, pengindeksan bidang JSON tidak tersedia, yang dapat membuat pemfilteran memakan waktu. Namun, keterbatasan ini akan diatasi dalam rilis mendatang.</li>
</ul>
</div>
<h2 id="Define-JSON-field" class="common-anchor-header">Menentukan bidang JSON<button data-href="#Define-JSON-field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Untuk mendefinisikan bidang JSON, cukup ikuti prosedur yang sama dengan mendefinisikan bidang jenis lain.</p>
<div class="language-python">
<p>Untuk informasi lebih lanjut tentang parameter, lihat <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_schema.md"><code translate="no">create_schema()</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/CollectionSchema/add_field.md"><code translate="no">add_field()</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/add_index.md"><code translate="no">add_index()</code></a>, <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_collection.md"><code translate="no">create_collection()</code></a>, dan <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Management/get_load_state.md"><code translate="no">get_load_state()</code></a> dalam referensi SDK.</p>
</div>
<div class="language-java">
<p>Untuk informasi lebih lanjut tentang parameter, lihat <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Client/MilvusClientV2.md"><code translate="no">MilvusClientV2</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createSchema.md"><code translate="no">createSchema()</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/CollectionSchema/addField.md"><code translate="no">addField()</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Management/IndexParam.md"><code translate="no">IndexParam</code></a>, <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createCollection.md"><code translate="no">createCollection()</code></a>, dan <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Management/getLoadState.md"><code translate="no">getLoadState()</code></a> dalam referensi SDK.</p>
</div>
<div class="language-javascript">
<p>Untuk informasi lebih lanjut tentang parameter, lihat <a href="https://milvus.io/api-reference/node/v2.4.x/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a> dan <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a> dan <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a> dalam referensi SDK.</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<div class="language-javascript">
<p>Untuk informasi lebih lanjut tentang parameter, lihat <a href="https://milvus.io/api-reference/node/v2.4.x/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a>, <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a>, dan <a href="https://milvus.io/api-reference/node/v2.4.x/Management/getLoadState.md"><code translate="no">getLoadState()</code></a> dalam referensi SDK.</p>
</div>
<h2 id="Insert-field-values" class="common-anchor-header">Menyisipkan nilai bidang<button data-href="#Insert-field-values" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Setelah membuat koleksi dari objek <code translate="no">CollectionSchema</code>, kamus seperti di atas dapat dimasukkan ke dalamnya.</p>
<div class="language-python">
<p>Gunakan metode <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/insert.md"><code translate="no">insert()</code></a> untuk memasukkan data ke dalam koleksi.</p>
</div>
<div class="language-java">
<p>Gunakan metode <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/insert.md"><code translate="no">insert()</code></a> untuk memasukkan data ke dalam koleksi.</p>
</div>
<div class="language-javascript">
<p>Gunakan metode <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/insert.md"><code translate="no">insert()</code></a> untuk memasukkan data ke dalam koleksi.</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<h2 id="Basic-scalar-filtering" class="common-anchor-header">Pemfilteran skalar dasar<button data-href="#Basic-scalar-filtering" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Setelah semua data Anda ditambahkan, Anda dapat melakukan pencarian dan kueri menggunakan kunci di bidang JSON dengan cara yang sama seperti yang Anda lakukan dengan bidang skalar standar.</p>
<div class="language-python">
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Advanced-scalar-filtering" class="common-anchor-header">Pemfilteran skalar tingkat lanjut<button data-href="#Advanced-scalar-filtering" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Milvus menyediakan satu set filter tingkat lanjut untuk pemfilteran skalar dalam bidang JSON. Filter-filter ini adalah <code translate="no">JSON_CONTAINS</code>, <code translate="no">JSON_CONTAINS_ALL</code>, dan <code translate="no">JSON_CONTAINS_ANY</code>.</p>
<ul>
<li><p>Memfilter semua entitas yang memiliki <code translate="no">[&quot;blue&quot;, &quot;brown&quot;, &quot;grey&quot;]</code> sebagai set warna referensi.</p>
...
<li><p>Menyaring entitas yang memiliki koordinator <code translate="no">[4, 5]</code>.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Menyaring entitas yang memiliki koordinator yang berisi <code translate="no">4</code> atau <code translate="no">5</code>.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;test_collection&quot;</span>,
...
<h2 id="Reference-on-JSON-filters" class="common-anchor-header">Referensi tentang filter JSON<button data-href="#Reference-on-JSON-filters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Ketika bekerja dengan bidang JSON, Anda dapat menggunakan bidang JSON sebagai filter atau beberapa kunci spesifiknya.</p>
<div class="admonition note">
<p><b>Catatan</b></p>
<ul>
<li>Milvus menyimpan nilai string dalam bidang JSON sebagaimana adanya tanpa melakukan pelarian atau konversi semantik. </li>
</ul>
<p>Sebagai contoh, <code translate="no">'a"b'</code>, <code translate="no">"a'b"</code>, <code translate="no">'a\\\\'b'</code>, dan <code translate="no">"a\\\\"b"</code> akan disimpan apa adanya, sementara <code translate="no">'a'b'</code> dan <code translate="no">"a"b"</code> akan diperlakukan sebagai nilai yang tidak valid.</p>
<ul>
<li><p>Untuk membuat ekspresi filter menggunakan bidang JSON, Anda dapat menggunakan kunci di dalam bidang tersebut. </p></li>
<li><p>Jika nilai kunci berupa bilangan bulat atau float, Anda dapat membandingkannya dengan kunci bilangan bulat atau float lain atau bidang INT32/64 atau FLOAT32/64.</p></li>
<li><p>Jika nilai kunci adalah string, Anda hanya dapat membandingkannya dengan kunci string lain atau bidang VARCHAR.</p></li>
</ul>
</div>
<h3 id="Basic-Operators-in-JSON-Fields" class="common-anchor-header">Operator Dasar dalam Bidang JSON<button data-href="#Basic-Operators-in-JSON-Fields" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Tabel berikut ini mengasumsikan bahwa nilai bidang JSON bernama <code translate="no">json_key</code> memiliki kunci bernama <code translate="no">A</code>. Gunakan ini sebagai referensi saat membuat ekspresi boolean menggunakan kunci bidang JSON.</p>
<table>
<thead>
<tr><th><strong>Operator</strong></th><th><strong>Contoh</strong></th><th><strong>Keterangan</strong></th></tr>
</thead>
<tbody>
<tr><td><strong>&lt;</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &lt; 3'</code></td><td>Ekspresi ini bernilai benar jika nilai <code translate="no">json_field[&quot;A&quot;]</code> kurang dari <code translate="no">3</code>.</td></tr>
<tr><td><strong>&gt;</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &gt; 1'</code></td><td>Ekspresi ini bernilai benar jika nilai <code translate="no">json_field[&quot;A&quot;]</code> lebih besar dari <code translate="no">1</code>.</td></tr>
<tr><td><strong>==</strong></td><td><code translate="no">'json_field[&quot;A&quot;] == 1'</code></td><td>Ekspresi ini bernilai benar jika nilai <code translate="no">json_field[&quot;A&quot;]</code> sama dengan <code translate="no">1</code>.</td></tr>
<tr><td><strong>!=</strong></td><td><code translate="no">'json_field[&quot;A&quot;][0]' != &quot;abc&quot;'</code></td><td>Ekspresi ini bernilai benar jika<br/> - <code translate="no">json_field</code> tidak memiliki kunci bernama <code translate="no">A</code>.<br/> - <code translate="no">json_field</code> memiliki sebuah kunci bernama <code translate="no">A</code> tetapi <code translate="no">json_field[&quot;A&quot;]</code> bukan sebuah larik.<br/> - <code translate="no">json_field[&quot;A&quot;]</code> adalah larik kosong.<br/> - <code translate="no">json_field[&quot;A&quot;]</code> adalah sebuah larik tetapi elemen pertamanya bukan <code translate="no">abc</code>.<br/></td></tr>
<tr><td><strong>&lt;=</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &lt;= 5'</code></td><td>Ekspresi ini bernilai benar jika nilai <code translate="no">json_field[&quot;A&quot;]</code> kurang dari atau sama dengan <code translate="no">5</code>.</td></tr>
<tr><td><strong>&gt;=</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &gt;= 1'</code></td><td>Ekspresi ini bernilai benar jika nilai <code translate="no">json_field[&quot;A&quot;]</code> lebih besar dari atau sama dengan <code translate="no">1</code>.</td></tr>
<tr><td><strong>tidak</strong></td><td><code translate="no">'not json_field[&quot;A&quot;] == 1'</code></td><td>Ekspresi ini bernilai benar jika<br/> - <code translate="no">json_field</code> tidak memiliki kunci bernama <code translate="no">A</code>.<br/> - <code translate="no">json_field[&quot;A&quot;]</code> tidak sama dengan <code translate="no">1</code>.<br/></td></tr>
<tr><td><strong>dalam</strong></td><td><code translate="no">'json_field[&quot;A&quot;] in [1, 2, 3]'</code></td><td>Ekspresi ini bernilai benar jika nilai dari <code translate="no">json_field[&quot;A&quot;]</code> adalah <code translate="no">1</code>, <code translate="no">2</code>, atau <code translate="no">3</code>.</td></tr>
<tr><td><strong>dan (&amp;&amp;)</strong></td><td><code translate="no">'json_field[&quot;A&quot;] &gt; 1 &amp;&amp; json_field[&quot;A&quot;] &lt; 3'</code></td><td>Ekspresi ini bernilai benar jika nilai dari <code translate="no">json_field[&quot;A&quot;]</code> lebih besar dari 1 dan kurang dari <code translate="no">3</code>.</td></tr>
<tr><td><strong>atau (||)</strong></td><td><code translate="no">‘json_field[“A”] > 1 || json_field[“A”] < 3’</code></td><td>Ekspresi ini bernilai benar jika nilai <code translate="no">json_field[&quot;A&quot;]</code> lebih besar dari <code translate="no">1</code> atau kurang dari <code translate="no">3</code>.</td></tr>
<tr><td><strong>ada</strong></td><td><code translate="no">'exists json_field[&quot;A&quot;]'</code></td><td>Ekspresi ini bernilai benar jika <code translate="no">json_field</code> memiliki kunci bernama <code translate="no">A</code>.</td></tr>
</tbody>
</table>
<h3 id="Advanced-Operators" class="common-anchor-header">Operator Tingkat Lanjut<button data-href="#Advanced-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Operator berikut ini khusus untuk bidang JSON:</p>
<ul>
<li><p><code translate="no">json_contains(identifier, jsonExpr)</code></p>
<p>Operator ini memfilter entitas yang pengenalnya berisi ekspresi JSON yang ditentukan.</p>
<ul>
<li><p>Contoh 1: <code translate="no">{&quot;x&quot;: [1,2,3]}</code></p>
...
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Contoh 2: <code translate="no">{&quot;x&quot;, [[1,2,3], [4,5,6], [7,8,9]]}</code></p>
...
<p>Operator ini menyaring entitas yang pengenalnya berisi semua anggota ekspresi JSON.</p>
<p>Contoh: <code translate="no">{&quot;x&quot;: [1,2,3,4,5,7,8]}</code></p>
...
<p>Operator ini menyaring entitas yang pengenalnya berisi anggota ekspresi JSON.</p>
<p>Contoh: <code translate="no">{&quot;x&quot;: [1,2,3,4,5,7,8]}</code></p>
