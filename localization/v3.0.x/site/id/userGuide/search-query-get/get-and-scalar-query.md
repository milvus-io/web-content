...
order: 3
summary: >-
  Panduan ini mendemonstrasikan cara mendapatkan entitas berdasarkan ID dan
  melakukan pemfilteran skalar.
title: Dapatkan & Kueri Skalar
---
<h1 id="Get--Scalar-Query" class="common-anchor-header">Dapatkan &amp; Kueri Skalar<button data-href="#Get--Scalar-Query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Panduan ini mendemonstrasikan cara mendapatkan entitas berdasarkan ID dan melakukan pemfilteran skalar. Pemfilteran skalar mengambil entitas yang sesuai dengan kondisi pemfilteran yang ditentukan.</p>
<h2 id="Overview" class="common-anchor-header">Ikhtisar<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Kueri skalar memfilter entitas dalam koleksi berdasarkan kondisi yang ditentukan menggunakan ekspresi boolean. Hasil kueri adalah sekumpulan entitas yang cocok dengan kondisi yang ditentukan. Tidak seperti pencarian vektor, yang mengidentifikasi vektor terdekat dengan vektor yang diberikan dalam koleksi, kueri menyaring entitas berdasarkan kriteria tertentu.</p>
<p>Di Milvus, <strong>filter selalu berupa string yang terdiri dari nama-nama field yang digabungkan dengan operator</strong>. Dalam panduan ini, Anda akan menemukan berbagai contoh filter. Untuk mempelajari lebih lanjut tentang detail operator, buka bagian <a href="https://milvus.io/docs/get-and-scalar-query.md#Reference-on-scalar-filters">Referensi</a>.</p>
<h2 id="Preparations" class="common-anchor-header">Persiapan<button data-href="#Preparations" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Langkah-langkah berikut ini menggunakan kembali kode untuk terhubung ke Milvus, menyiapkan koleksi dengan cepat, dan memasukkan lebih dari 1.000 entitas yang dibuat secara acak ke dalam koleksi.</p>
<h3 id="Step-1-Create-a-collection" class="common-anchor-header">Langkah 1: Membuat koleksi<button data-href="#Step-1-Create-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Gunakan <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a> untuk terhubung ke server Milvus dan <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Collections/create_collection.md"><code translate="no">create_collection()</code></a> untuk membuat koleksi.</p>
</div>
<div class="language-java">
<p>Gunakan <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Client/MilvusClientV2.md"><code translate="no">MilvusClientV2</code></a> untuk menyambung ke server Milvus dan <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Collections/createCollection.md"><code translate="no">createCollection()</code></a> untuk membuat koleksi.</p>
</div>
<div class="language-javascript">
<p>Gunakan <a href="https://milvus.io/api-reference/node/v2.4.x/Client/MilvusClient.md"><code translate="no">MilvusClient</code></a> untuk menyambung ke server Milvus dan <a href="https://milvus.io/api-reference/node/v2.4.x/Collections/createCollection.md"><code translate="no">createCollection()</code></a> untuk membuat koleksi.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Insert-randomly-generated-entities" class="common-anchor-header">Langkah 2: Memasukkan entitas yang dibuat secara acak<button data-href="#Step-2-Insert-randomly-generated-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Gunakan <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/insert.md"><code translate="no">insert()</code></a> untuk memasukkan entitas ke dalam koleksi.</p>
</div>
<div class="language-java">
<p>Gunakan <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/insert.md"><code translate="no">insert()</code></a> untuk memasukkan entitas ke dalam koleksi.</p>
</div>
<div class="language-javascript">
<p>Gunakan <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/insert.md"><code translate="no">insert()</code></a> untuk memasukkan entitas ke dalam koleksi.</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Create-partitions-and-insert-more-entities" class="common-anchor-header">Langkah 3: Membuat partisi dan menyisipkan lebih banyak entitas<button data-href="#Step-3-Create-partitions-and-insert-more-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Gunakan <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Partitions/create_partition.md"><code translate="no">create_partition()</code></a> untuk membuat partisi dan <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/insert.md"><code translate="no">insert()</code></a> untuk menyisipkan lebih banyak entitas ke dalam koleksi.</p>
</div>
<div class="language-java">
<p>Gunakan <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Partitions/createPartition.md"><code translate="no">createPartition()</code></a> untuk membuat partisi dan <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/insert.md"><code translate="no">insert()</code></a> untuk menyisipkan lebih banyak entitas ke dalam koleksi.</p>
</div>
<div class="language-javascript">
<p>Gunakan <a href="https://milvus.io/api-reference/node/v2.4.x/Partitions/createPartition.md"><code translate="no">createPartition()</code></a> untuk membuat partisi dan <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/insert.md"><code translate="no">insert()</code></a> untuk menyisipkan lebih banyak entitas ke dalam koleksi.</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Get-Entities-by-ID" class="common-anchor-header">Mendapatkan Entitas berdasarkan ID<button data-href="#Get-Entities-by-ID" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Jika Anda mengetahui ID dari entitas yang Anda minati, Anda dapat menggunakan metode <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/get.md"><code translate="no">get()</code></a> .</p>
</div>
<div class="language-java">
<p>Jika Anda mengetahui ID dari entitas yang Anda minati, Anda dapat menggunakan metode <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/get.md"><code translate="no">get()</code></a> metode.</p>
</div>
<div class="language-javascript">
<p>Jika Anda mengetahui ID entitas yang Anda minati, Anda dapat menggunakan metode <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/get.md"><code translate="no">get()</code></a> metode.</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Get-entities-from-partitions" class="common-anchor-header">Mendapatkan entitas dari partisi<button data-href="#Get-entities-from-partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Anda juga bisa mendapatkan entitas dari partisi tertentu.</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Use-Basic-Operators" class="common-anchor-header">Menggunakan Operator Dasar<button data-href="#Use-Basic-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Pada bagian ini, Anda akan menemukan contoh cara menggunakan operator dasar dalam pemfilteran skalar. Anda juga dapat menerapkan penyaringan ini pada <a href="https://milvus.io/docs/single-vector-search.md#Filtered-search">pencarian vektor</a> dan <a href="https://milvus.io/docs/insert-update-delete.md#Delete-entities">penghapusan data</a>.</p>
<div class="language-python">
<p>Untuk informasi lebih lanjut, lihat <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/query.md"><code translate="no">query()</code></a> dalam referensi SDK.</p>
</div>
<div class="language-java">
<p>Untuk informasi lebih lanjut, lihat <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/query.md"><code translate="no">query()</code></a> dalam referensi SDK.</p>
</div>
<div class="language-javascript">
<p>Untuk informasi lebih lanjut, lihat <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/query.md"><code translate="no">query()</code></a> dalam referensi SDK.</p>
</div>
<ul>
<li><p>Menyaring entitas dengan nilai tag yang berada di antara 1.000 hingga 1.500.</p>
...
<li><p>Menyaring entitas dengan nilai <strong>warna</strong> yang disetel ke <strong>cokelat</strong>.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Menyaring entitas dengan nilai <strong>warna</strong> yang tidak disetel ke <strong>hijau</strong> dan <strong>ungu</strong>.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;quick_setup&quot;</span>,
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Menyaring artikel yang tag warnanya dimulai dengan warna <strong>merah</strong>.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;quick_setup&quot;</span>,
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Menyaring entitas dengan warna yang disetel ke merah dan nilai tag dalam rentang 1.000 hingga 1.500.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;quick_setup&quot;</span>,
...
<h2 id="Use-Advanced-Operators" class="common-anchor-header">Menggunakan Operator Tingkat Lanjut<button data-href="#Use-Advanced-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Pada bagian ini, Anda akan menemukan contoh cara menggunakan operator tingkat lanjut dalam pemfilteran skalar. Anda juga dapat menerapkan filter ini pada <a href="https://milvus.io/docs/single-vector-search.md#Filtered-search">pencarian vektor</a> dan <a href="https://milvus.io/docs/insert-update-delete.md#Delete-entities">penghapusan data</a>.</p>
<h3 id="Count-entities" class="common-anchor-header">Menghitung entitas<button data-href="#Count-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><p>Menghitung jumlah total entitas dalam koleksi.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Menghitung jumlah total entitas dalam partisi tertentu.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Menghitung jumlah entitas yang cocok dengan kondisi pemfilteran</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<h2 id="Reference-on-scalar-filters" class="common-anchor-header">Referensi tentang filter skalar<button data-href="#Reference-on-scalar-filters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><h3 id="Basic-Operators" class="common-anchor-header">Operator Dasar<button data-href="#Basic-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><strong>Ekspresi boolean</strong> selalu <strong>berupa string yang terdiri dari nama field yang digabungkan dengan operator</strong>. Pada bagian ini, Anda akan mempelajari lebih lanjut tentang operator dasar.</p>
<table>
<thead>
<tr><th><strong>Operator</strong></th><th><strong>Deskripsi</strong></th></tr>
</thead>
<tbody>
<tr><td><strong>dan (&amp;&amp;)</strong></td><td>Benar jika kedua operand bernilai benar</td></tr>
<tr><td><strong>atau (||)</strong></td><td>Benar jika salah satu operand bernilai benar</td></tr>
<tr><td><strong>+, -, *, /</strong></td><td>Penjumlahan, pengurangan, perkalian, dan pembagian</td></tr>
<tr><td><strong>**</strong></td><td>Eksponen</td></tr>
<tr><td><strong>%</strong></td><td>Modulus</td></tr>
<tr><td><strong><, ></strong></td><td>Kurang dari, lebih besar dari</td></tr>
<tr><td><strong>==, !=</strong></td><td>Sama dengan, tidak sama dengan</td></tr>
<tr><td><strong><=, >=</strong></td><td>Kurang dari atau sama dengan, lebih besar dari atau sama dengan</td></tr>
<tr><td><strong>tidak</strong></td><td>Membalikkan hasil dari kondisi tertentu.</td></tr>
<tr><td><strong>like</strong></td><td>Membandingkan nilai dengan nilai yang serupa menggunakan operator wildcard.<br/> Misalnya, like "awalan%" mencocokkan string yang dimulai dengan "awalan".</td></tr>
<tr><td><strong>in</strong></td><td>Menguji apakah sebuah ekspresi cocok dengan nilai apa pun dalam daftar nilai.</td></tr>
</tbody>
</table>
...
<p>Menghitung jumlah entitas yang tepat dalam koleksi. Gunakan ini sebagai bidang keluaran untuk mendapatkan jumlah entitas yang tepat dalam koleksi atau partisi.</p>
<p><div class="admonition note"></p>
<p><p><b>Catatan</b></p></p>
<p><p>Ini berlaku untuk koleksi yang dimuat. Anda harus menggunakannya sebagai satu-satunya bidang keluaran.</p></p>
<p></div></p></li>
</ul>
