...
<h1 id="ARRAY-Operators" class="common-anchor-header">Operator ARRAY<button data-href="#ARRAY-Operators" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus menyediakan operator yang kuat untuk melakukan kueri terhadap bidang array, memungkinkan Anda untuk memfilter dan mengambil entitas berdasarkan isi array.</p>
