...
<p>Ekspresi pencocokan pola ditulis dalam parameter <code translate="no">filter</code>. Misalnya, kueri berikut mencocokkan pesan log yang mengandung kode kesalahan seperti <code translate="no">E1001</code>:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Saat mencocokkan karakter meta regex secara harfiah, gunakan karakter pelarian (escape) dalam pola regex. Misalnya, untuk mencocokkan titik (<code translate="no">\.</code> ) secara harfiah dalam regex, tulis <code translate="no">\\.</code> dalam string filter Python:</p>
