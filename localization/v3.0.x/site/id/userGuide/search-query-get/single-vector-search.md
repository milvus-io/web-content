...
<span class="hljs-comment"># }</span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Primary-Key-Search--Milvus-269+" class="common-anchor-header">Pencarian Kunci Utama<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.6.9+</span><button data-href="#Primary-Key-Search--Milvus-269+" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Sebuah koleksi dapat mencakup beberapa bidang vektor untuk menyimpan embedding vektor yang dihasilkan menggunakan model embedding yang berbeda. Dengan demikian, Anda dapat menggunakan pencarian hibrida untuk menyusun ulang peringkat hasil pencarian dari bidang-bidang vektor tersebut, sehingga meningkatkan tingkat recall.</p>
