...
<h2 id="Use-Partition-Key-Isolation" class="common-anchor-header">Menggunakan Isolasi Kunci Partisi<button data-href="#Use-Partition-Key-Isolation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Dalam skenario multi-penyewaan, Anda dapat menetapkan bidang skalar yang terkait dengan identitas penyewa sebagai kunci partisi dan membuat filter berdasarkan nilai tertentu dalam bidang skalar ini. Untuk lebih meningkatkan performa pencarian dalam skenario yang sama, Milvus memperkenalkan fitur Partition Key Isolation.</p>
<p>
