...
title: Memodifikasi Koleksi
summary: >-
  Anda dapat mengganti nama koleksi atau mengubah pengaturannya. Halaman ini
  berfokus pada cara mengubah koleksi.
---
<h1 id="Modify-Collection" class="common-anchor-header">Memodifikasi Koleksi<button data-href="#Modify-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Anda dapat mengganti nama koleksi atau mengubah pengaturannya. Halaman ini berfokus pada cara mengubah koleksi.</p>
<h2 id="Rename-Collection" class="common-anchor-header">Mengganti Nama Koleksi<button data-href="#Rename-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Anda dapat mengganti nama koleksi sebagai berikut.</p>
...
<p>Semua properti yang tercantum di bagian ini hanya berlaku untuk koleksi yang dikelola.</p>
</div>
...
<h3 id="Example-1-Set-collection-level-TTL" class="common-anchor-header">Contoh 1: Mengatur TTL tingkat koleksi<button data-href="#Example-1-Set-collection-level-TTL" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Example-2-Set-entity-level-TTL--Milvus-30x" class="common-anchor-header">Contoh 2: Tetapkan TTL tingkat entitas<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 3.0.x</span><button data-href="#Example-2-Set-entity-level-TTL--Milvus-30x" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Cuplikan kode berikut ini menunjuk bidang <code translate="no">TIMESTAMPTZ</code> yang sudah ada (<code translate="no">expire_at</code>) sebagai bidang TTL untuk TTL tingkat entitas. Koleksi harus sudah berisi bidang <code translate="no">TIMESTAMPTZ</code> dengan nama tersebut, dan <code translate="no">collection.ttl.seconds</code> tidak boleh disetel - kedua mode TTL tersebut saling terpisah.</p>
<p>Untuk alur kerja TTL tingkat entitas secara lengkap (penyiapan skema, penyisipan, kueri, penyegaran, pelepasan), lihat Mengatur TTL <a href="/docs/id/set-collection-ttl.md">tingkat entitas</a>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
<pre><code translate="no" class="language-python"><span class="hljs-keyword">from</span> pymilvus <span class="hljs-keyword">import</span> MilvusClient
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Example-3-Enable-mmap" class="common-anchor-header">Contoh 3: Mengaktifkan mmap<button data-href="#Example-3-Enable-mmap" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Cuplikan kode berikut ini menunjukkan cara mengaktifkan mmap.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
<pre><code translate="no" class="language-python"><span class="hljs-keyword">from</span> pymilvus <span class="hljs-keyword">import</span> MilvusClient
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Example-4-Enable-partition-key" class="common-anchor-header">Contoh 4: Mengaktifkan kunci partisi<button data-href="#Example-4-Enable-partition-key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Example-5-Enable-dynamic-field" class="common-anchor-header">Contoh 5: Mengaktifkan bidang dinamis<button data-href="#Example-5-Enable-dynamic-field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Cuplikan kode berikut ini menunjukkan cara mengaktifkan bidang dinamis.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
<pre><code translate="no" class="language-python"><span class="hljs-keyword">from</span> pymilvus <span class="hljs-keyword">import</span> MilvusClient
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Example-6-Enable-allowinsertautoid" class="common-anchor-header">Contoh 6: Mengaktifkan allow_insert_auto_id<button data-href="#Example-6-Enable-allowinsertautoid" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Example-7-Set-collection-time-zone" class="common-anchor-header">Contoh 7: Mengatur zona waktu pengumpulan<button data-href="#Example-7-Set-collection-time-zone" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
