...
<p>Jangan gunakan peralihan jika primary benar-benar tidak tersedia. Dalam hal ini, gunakan <a href="/docs/id/cdc_failover.md">Failover</a>.</p>
...
<li>Jalankan pencarian yang representatif pada primary yang baru dan yang lama.</li>
