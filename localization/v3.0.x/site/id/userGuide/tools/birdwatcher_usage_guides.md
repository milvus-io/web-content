...
<h1 id="Use-Birdwatcher" class="common-anchor-header">Menggunakan Birdwatcher<button data-href="#Use-Birdwatcher" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Panduan ini memandu Anda tentang cara menggunakan Birdwatcher untuk memeriksa status Milvus dan mengkonfigurasinya dengan cepat.</p>
...
<p>Jika jalur root Milvus Anda berbeda dari <code translate="no">by-dev</code> dan Anda diminta untuk melaporkan kesalahan tentang jalur root yang salah, Anda dapat menyambung ke etcd sebagai berikut:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-sessions" class="common-anchor-header">Membuat daftar sesi<button data-href="#List-sessions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Untuk membuat daftar sesi yang terkait dengan berbagai komponen di Milvus:</p>
...
<h3 id="Check-databases-and-collections" class="common-anchor-header">Memeriksa basis data dan koleksi<button data-href="#Check-databases-and-collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Anda dapat membuat daftar semua basis data dan koleksi.</p>
<ul>
...
<h3 id="Check-index-details" class="common-anchor-header">Memeriksa detail indeks<button data-href="#Check-index-details" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Jalankan perintah berikut untuk membuat daftar semua file indeks secara detail.</p>
...
==================================================================
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-partitions" class="common-anchor-header">Membuat daftar partisi<button data-href="#List-partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Jalankan perintah berikut untuk membuat daftar semua partisi dalam koleksi tertentu.</p>
...
--- Total Database(s): 1
<button class="copy-code-btn"></button></code></pre>
<h3 id="Check-channel-status" class="common-anchor-header">Memeriksa status saluran<button data-href="#Check-channel-status" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Jalankan perintah berikut untuk melihat status saluran</p>
...
--- Total Channels: 1
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-all-replicas-and-segments" class="common-anchor-header">Buat daftar semua replika dan segmen<button data-href="#List-all-replicas-and-segments" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="List-configurations" class="common-anchor-header">Konfigurasi daftar<button data-href="#List-configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Anda dapat meminta Birdwatcher membuat daftar konfigurasi saat ini dari setiap komponen Milvus.</p>
...
<h3 id="Probe-collection-with-known-primary-key" class="common-anchor-header">Memeriksa koleksi dengan kunci utama yang diketahui<button data-href="#Probe-collection-with-known-primary-key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Pada perintah <code translate="no">probe</code>, Anda harus menentukan kunci utama menggunakan bendera <code translate="no">pk</code>, dan ID koleksi menggunakan bendera <code translate="no">collection</code>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Probe-all-collections-with-mock-queries" class="common-anchor-header">Memeriksa semua koleksi dengan kueri tiruan<button data-href="#Probe-all-collections-with-mock-queries" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Anda juga dapat meminta Birdwatcher menelusuri semua koleksi dengan kueri tiruan.</p>
