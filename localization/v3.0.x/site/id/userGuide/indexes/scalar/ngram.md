...
<li><p><strong>Regex yang tidak peka huruf besar-kecil</strong>: Pola regex dengan <code translate="no">(?i)</code> didukung, tetapi mungkin melewatkan optimasi <code translate="no">NGRAM</code> karena indeks mempertahankan huruf besar-kecil aslinya.</p></li>
