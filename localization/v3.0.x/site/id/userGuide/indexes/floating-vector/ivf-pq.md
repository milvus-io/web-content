...
<li><p><strong>Penugasan:</strong> Setiap vektor ditugaskan ke klaster yang memiliki centroid paling dekat dengannya.</p></li>
...
<h3 id="PQ" class="common-anchor-header">PQ<button data-href="#PQ" class="anchor-icon" translate="no">
    ...
    </button></h3><p><strong>Product Quantization (PQ</strong> ) adalah metode kompresi untuk vektor berdimensi tinggi yang secara signifikan mengurangi kebutuhan penyimpanan sekaligus memungkinkan operasi pencarian kemiripan yang cepat.</p>
...
<p>Pertimbangkan sebuah vektor dengan dimensi <em>D = 128</em> menggunakan angka floating-point 32-bit. Dengan parameter PQ <em>m = 64</em> (sub-vektor) dan <em>nbits = 8</em> (dengan demikian <em>k =</em><sup>28</sup> <em>= 256</em> centroid per subruang), kita dapat membandingkan kebutuhan penyimpanan:</p>
<ul>
...
<p>Ketika melakukan pencarian kemiripan dengan vektor kueri, PQ memungkinkan penghitungan jarak yang efisien melalui langkah-langkah berikut:</p>
<ol>
...
<li><p>Untuk setiap sub-vektor kueri dan buku kode yang sesuai (berisi centroid <sup>2nbit</sup> ), hitung dan simpan jarak ke semua centroid.</p></li>
<li><p>Hal ini menghasilkan tabel pencarian <code translate="no">m</code>, di mana setiap tabel berisi jarak <sup>2nbit</sup>.</p></li>
</ul></li>
...
<h3 id="IVF-+-PQ" class="common-anchor-header">IVF + PQ<button data-href="#IVF-+-PQ" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Indeks <strong>IVF_PQ</strong> menggabungkan kekuatan <strong>IVF</strong> dan <strong>PQ</strong> untuk mempercepat pencarian. Prosesnya bekerja dalam dua langkah:</p>
<ol>
...
<h3 id="Index-building-params" class="common-anchor-header">Parameter pembangunan indeks<button data-href="#Index-building-params" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Tabel berikut mencantumkan parameter yang dapat dikonfigurasi di <code translate="no">params</code> saat <a href="/docs/id/ivf-pq.md#Build-index">membangun indeks.</a></p>
<table>
   <tr>
     <th></th>
     <th><p>Parameter</p></th>
   ...
   <tr>
     ...
     <td><p><strong>Jenis</strong>: <strong>Rentang</strong> Bilangan Bulat: [1, 24]</p><p><strong>Nilai default</strong>: <code translate="no">8</code></p></td>
...
<h3 id="Index-specific-search-params" class="common-anchor-header">Parameter pencarian khusus indeks<button data-href="#Index-specific-search-params" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Tabel berikut mencantumkan parameter yang dapat dikonfigurasi di <code translate="no">search_params.params</code> saat <a href="/docs/id/ivf-pq.md#Search-on-index">mencari di indeks</a>.</p>
<table>
   <tr>
     <th></th>
     <th><p>Parameter</p></th>
