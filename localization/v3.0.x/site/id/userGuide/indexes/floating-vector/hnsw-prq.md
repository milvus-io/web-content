...
<p><strong>Nilai default</strong>: <code translate="no">2</code></p></td>
     <td><p>Nilai <code translate="no">nrq</code> yang lebih tinggi memungkinkan langkah subkuantisasi sisa tambahan, yang berpotensi menghasilkan rekonstruksi yang lebih tepat dari vektor asli. Namun, ini juga berarti menyimpan dan menghitung lebih banyak subkuantisasi, sehingga menghasilkan ukuran indeks yang lebih besar dan overhead komputasi yang lebih besar.</p></td>
   </tr>
   <tr>
     <td></td>
