...
<h2 id="Configure-warmup-at-cluster-level" class="common-anchor-header">Mengonfigurasi pemanasan di tingkat klaster<button data-href="#Configure-warmup-at-cluster-level" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pemanasan tingkat klaster dikonfigurasi di file konfigurasi Milvus <code translate="no">milvus.yaml</code> dan berlaku untuk semua koleksi di klaster. Ini berfungsi sebagai default dasar.</p>
...
<table>
   <tr>
     ...
     <th><p><strong>Fase Pencarian/Permintaan</strong></p></th>
