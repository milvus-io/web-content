...
<li><p>Kolom yang digunakan untuk penataan ulang peringkat model harus berjenis teks (<code translate="no">VARCHAR</code>).</p></li>
...
<table>
   ...
   <tr>
     ...
     <td><p>Aplikasi pencarian semantik yang ingin menyusun ulang urutan teks kandidat menggunakan model Hugging Face tanpa perlu mengoperasikan layanan inferensi terpisah</p></td>
   </tr>
</table>
...
<li><p><a href="/docs/id/tei-ranker.md">TEI Ranker</a></p></li>
