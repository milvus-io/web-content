...
<h2 id="Supported-embedding-service-providers" class="common-anchor-header">Penyedia layanan penyematan yang didukung<button data-href="#Supported-embedding-service-providers" class="anchor-icon" translate="no">
   ...
   <tr>
     <td><p><a href="/docs/id/bedrock.md">Bedrock</a></p></td>
   ...
   <tr>
     <td><p><a href="/docs/id/hugging-face-tei.md">Hugging Face TEI</a></p></td>
     <td><p>Model apa pun yang disajikan melalui TEI</p></td>
     <td><p><code translate="no">FLOAT_VECTOR</code></p></td>
     <td><p>Kunci API opsional</p></td>
   </tr>
   <tr>
     <td><p><a href="/docs/id/hugging-face.md">Hugging Face</a></p></td>
     <td><p>Model yang disajikan melalui <code translate="no">hf-inference</code> untuk ekstraksi fitur</p></td>
     <td><p><code translate="no">FLOAT_VECTOR</code></p></td>
     <td><p>Kunci API</p></td>
   </tr>
</table>
...
<li><p><strong>Menghasilkan embedding</strong>: Modul Fungsi di dalam Milvus secara otomatis memanggil penyedia model yang telah dikonfigurasi untuk mengubah data mentah menjadi embedding vektor.</p></li>
...
<p>Untuk detail tentang mengonfigurasi kredensial melalui variabel lingkungan, lihat dokumentasi penyedia layanan embedding (misalnya, <a href="/docs/id/openai.md">OpenAI</a> atau <a href="/docs/id/azure-openai.md">Azure OpenAI</a>).</p></li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<p>Untuk informasi lebih lanjut tentang cara menerapkan konfigurasi Milvus, lihat <a href="/docs/id/dynamic_config.md">Konfigurasi Milvus secara Langsung</a>.</p>
...
<table>
   ...
   <tr>
     ...
     <td><p>Jenis fungsi yang digunakan. Untuk embedding teks, atur nilainya menjadi <code translate="no">FunctionType.TEXTEMBEDDING</code>.</p><p><strong>Catatan</strong>: Milvus menerima <code translate="no">FunctionType.BM25</code> (untuk transformasi embedding sparsitas) dan <code translate="no">FunctionType.RERANK</code> (untuk reranking) untuk parameter ini. Lihat <a href="/docs/id/decay-ranker-overview.md">Ikhtisar</a> <a href="/docs/id/full-text-search.md">Pencarian Teks Lengkap</a> dan <a href="/docs/id/decay-ranker-overview.md">Decay Ranker</a> untuk detailnya.</p></td>
   ...
   <tr>
     ...
     <td><p>Kamus yang berisi konfigurasi embedding. Catatan: Parameter dalam " <code translate="no">params</code> " bervariasi tergantung pada penyedia model embedding.</p></td>
...
<h3 id="Step-5-Insert-data" class="common-anchor-header">Langkah 5: Masukkan data<button data-href="#Step-5-Insert-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Setelah menyiapkan koleksi dan indeks Anda, Anda siap untuk memasukkan data mentah Anda. Dalam proses ini, Anda hanya perlu menyediakan teks mentah. Modul Fungsi yang telah kita tentukan sebelumnya secara otomatis menghasilkan vektor langka yang sesuai untuk setiap entri teks.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
...
<pre><code translate="no" class="language-bash"><span class="hljs-comment"># restful</span>
<button class="copy-code-btn"></button></code></pre>
<p>Untuk informasi lebih lanjut tentang operasi pencarian dan kueri, lihat <a href="/docs/id/single-vector-search.md">Pencarian Vektor Dasar</a> dan <a href="/docs/id/get-and-scalar-query.md">Kueri</a>.</p>
...
<li>Memastikan panjang bidang vektor sesuai dengan dimensi yang Anda harapkan</li>
