...
<h3 id="Prepare-data" class="common-anchor-header">Menyiapkan data<button data-href="#Prepare-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Pada bagian ini, Anda perlu menyiapkan beberapa data yang dibuat secara acak untuk penyisipan nanti.</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<h3 id="Insert-data" class="common-anchor-header">Memasukkan data<button data-href="#Insert-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Kemudian Anda dapat dengan aman memasukkan data ke dalam koleksi.</p>
<div class="language-python">
...
<p>Jika nama bidang yang tidak ditentukan skema berisi karakter selain angka, huruf, dan garis bawah, seperti tanda tambah (+), tanda bintang (*), atau tanda dolar (<span class="katex-error" title="ParseError: KaTeX parse error: Expected group after &#x27;_&#x27; at position 39: …the key within _̲_" style="color:#cc0000">), Anda harus menyertakan kunci di dalam __meta</span>[]__ seperti yang ditunjukkan pada cuplikan kode berikut ini ketika menggunakannya dalam ekspresi boolean atau menyertakannya di dalam bidang keluaran.</p>
