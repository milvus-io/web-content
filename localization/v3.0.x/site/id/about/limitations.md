...
summary: Pelajari batasan-batasan saat menggunakan Milvus.
---
<h1 id="Milvus-Limits" class="common-anchor-header">Batasan Milvus<button data-href="#Milvus-Limits" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus berkomitmen untuk menyediakan basis data vektor terbaik guna mendukung aplikasi AI dan pencarian kesamaan vektor. Namun, tim kami terus berupaya menghadirkan lebih banyak fitur dan utilitas terbaik untuk meningkatkan pengalaman pengguna. Halaman ini mencantumkan beberapa batasan yang diketahui yang mungkin dihadapi pengguna saat menggunakan Milvus.</p>
...
<thead>
<tr><th>Sumber</th><th>Batasan</th></tr>
</thead>
<tbody>
<tr><td>Basis Data</td><td>255 karakter</td></tr>
<tr><td>Koleksi</td><td>255 karakter</td></tr>
<tr><td>Kolom</td><td>255 karakter</td></tr>
...
<h2 id="Number-of-resources-in-a-collection" class="common-anchor-header">Jumlah sumber daya dalam sebuah koleksi<button data-href="#Number-of-resources-in-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<tr><td>Kolom</td><td>64</td></tr>
<tr><td>Indeks</td><td>1</td></tr>
<tr><td>Entitas</td><td>tak terbatas</td></tr>
</tbody>
</table>
<h2 id="Length-of-a-string" class="common-anchor-header">Panjang string<button data-href="#Length-of-a-string" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Dimensions-of-a-vector" class="common-anchor-header">Dimensi vektor<button data-href="#Dimensions-of-a-vector" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Input-and-Output-per-RPC" class="common-anchor-header">Input dan Output per RPC<button data-href="#Input-and-Output-per-RPC" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<tbody>
<tr><td>Sisipkan</td><td>64 MB</td></tr>
<tr><td>Pencarian</td><td>64 MB</td></tr>
<tr><td>Kueri</td><td>64 MB</td></tr>
</tbody>
</table>
<h2 id="Load-limits" class="common-anchor-header">Batas pemuatan<button data-href="#Load-limits" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pada rilis saat ini, data yang akan dimuat harus kurang dari 90% dari total sumber daya memori semua node kueri untuk menyisakan sumber daya memori bagi mesin eksekusi.</p>
...
<tbody>
<tr><td><code translate="no">topk</code> (jumlah hasil paling mirip yang akan dikembalikan)</td><td>16.384</td></tr>
<tr><td><code translate="no">nq</code> (jumlah permintaan pencarian)</td><td>16.384</td></tr>
</tbody>
</table>
<h2 id="Index-limits-on-different-search-types" class="common-anchor-header">Batasan indeks pada berbagai jenis pencarian<button data-href="#Index-limits-on-different-search-types" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Tabel berikut memberikan gambaran umum tentang dukungan untuk berbagai perilaku pencarian di berbagai jenis indeks.</p>
<table>
<thead>
...
<tr><td>Pencarian dasar dengan paginasi</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td></tr>
...
<tr><td>Pencarian berdasarkan kelompok</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Tidak</td><td>Ya</td><td>Tidak</td><td>Tidak</td><td>Tidak</td><td>Tidak</td><td>Ya</td><td>Tidak</td><td>Tidak</td></tr>
<tr><td>Cari dengan iterator</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Tidak</td><td>Tidak</td><td>Tidak</td><td>Tidak</td><td>Ya</td><td>Ya</td><td>Ya</td></tr>
...
<tr><td>Permintaan/Ambil</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td><td>Ya</td></tr>
