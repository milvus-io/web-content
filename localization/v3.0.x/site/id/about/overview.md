...
<li><p>Milvus Capture Data Change (CDC) Milvus CDC dapat mereplikasi perubahan data dari satu cluster Milvus ke cluster lainnya untuk pemulihan bencana siaga utama. Untuk detailnya, lihat <a href="/docs/id/milvus_cdc_overview.md">Milvus CDC</a>.</p></li>
