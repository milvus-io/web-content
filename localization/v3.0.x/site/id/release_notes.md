...
<h1 id="Release-Notes" class="common-anchor-header">Catatan Rilis<button data-href="#Release-Notes" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Temukan apa saja yang baru di Milvus! Halaman ini merangkum fitur-fitur baru, peningkatan, masalah yang diketahui, dan perbaikan bug pada setiap rilis. Kami menyarankan Anda untuk mengunjungi halaman ini secara rutin untuk mengetahui informasi terbaru.</p>
<h2 id="v302" class="common-anchor-header">v3.0.2<button data-href="#v302" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Tanggal rilis: 20 September 2026</p>
<table>
<thead>
...
<p>Dengan gembira kami mengumumkan peluncuran Milvus v3.0.2! Rilis ini berfokus pada kinerja pencarian dan kueri — menghilangkan kontensi jalur panas dalam pencarian yang difilter, pengelompokan, dan pembuatan indeks — bersama dengan dukungan koleksi eksternal dan Storage V2 yang lebih kuat, serta serangkaian perbaikan stabilitas yang luas di seluruh streaming, pemadatan, dan pengelolaan indeks.</p>
...
<li>Penyaringan ARRAY dioptimalkan dengan menggabungkan predikat contains yang dirantai menjadi satu ekspresi <code translate="no">ContainsAny</code>/<code translate="no">ContainsAll</code> dalam perencana kueri (<a href="https://github.com/milvus-io/milvus/pull/52365">#52365</a>)</li>
<li>Menambahkan dukungan untuk titik akhir khusus yang kompatibel dengan S3 dalam koleksi eksternal melalui opsi <code translate="no">extfs.endpoint_url</code>, dengan validasi pengaturan titik akhir yang tidak aman atau bertentangan (<a href="https://github.com/milvus-io/milvus/pull/52814">#52814</a>)</li>
<li>Menyatukan filter keanggotaan Bloom dan Roaring di balik satu ekspresi <code translate="no">membership_match</code>, dengan dukungan klien Go yang sesuai untuk membangun dan menanyakan kedua jenis filter tersebut (<a href="https://github.com/milvus-io/milvus/pull/53019">#53019</a>)</li>
<li>Mengurangi amplifikasi penulisan selama pembuatan indeks berbasis Tantivy, sehingga menurunkan I/O disk untuk pencocokan teks, NGRAM, dan indeks statistik kunci JSON (<a href="https://github.com/milvus-io/milvus/pull/53057">#53057</a>)</li>
<li>Menambahkan kontrol penerimaan pada titik akhir DQL RESTful v2 yang mengembalikan HTTP 429 dengan <code translate="no">Retry-After</code> sebelum decoding permintaan ketika antrian kueri proxy penuh (<a href="https://github.com/milvus-io/milvus/pull/53111">#53111</a>)</li>
<li>Mengurangi hotspot refcount atomik di jalur evaluasi filter skalar yang menyumbang ~48% dari waktu CPU daun dalam pencarian, sehingga meningkatkan throughput pencarian yang difilter (<a href="https://github.com/milvus-io/milvus/pull/53167">#53167</a>)</li>
<li>Meningkatkan skalabilitas kumpulan utas penyimpanan dengan mengganti implementasi buatan sendiri dengan <code translate="no">folly::CPUThreadPoolExecutor</code> dan memulihkan penskalaan pekerja elastis (<a href="https://github.com/milvus-io/milvus/pull/53184">#53184</a>)</li>
<li>Meningkatkan pencocokan log akses REST sehingga formatter dicocokkan dengan jalur URL yang diparsing, dan metode yang dikonfigurasi kini berlaku untuk permintaan yang membawa parameter kueri (<a href="https://github.com/milvus-io/milvus/pull/53147">#53147</a>)</li>
<li>Menambahkan dukungan siaran idempoten sehingga permintaan yang diulang tidak lagi membuat tugas duplikat, dengan <code translate="no">BulkImport</code> sebagai pengguna pertama (<a href="https://github.com/milvus-io/milvus/pull/53228">#53228</a>)</li>
<li>Menambahkan karakter pemisah kalimat yang dapat dikonfigurasi untuk tokenizer Lindera, sehingga entri kamus pengguna yang mengandung tanda baca dapat dicocokkan sebagai satu token (<a href="https://github.com/milvus-io/milvus/pull/53287">#53287</a>)</li>
<li>Menambahkan gerbang versi kluster yang secara otomatis mengaktifkan materialisasi fungsi sebelum penulisan hanya setelah semua node menyelesaikan pembaruan, sehingga menghindari ketidakkonsistenan versi campuran selama pembaruan bertahap (<a href="https://github.com/milvus-io/milvus/pull/53261">#53261</a>)</li>
<li>Meningkatkan Woodpecker ke v0.1.42, memperbaiki kegagalan pemulihan WAL pada segmen kosong yang telah difinalisasi dan meningkatkan stabilitas serta metrik jalur penambahan (<a href="https://github.com/milvus-io/milvus/pull/53295">#53295</a>)</li>
<li>Mengurangi overhead atomik dan hitungan referensi per-chunk di jalur panas pencarian dan kueri dengan mengunci snapshot segmen yang disegel sekali per permintaan (<a href="https://github.com/milvus-io/milvus/pull/53301">#53301</a>)</li>
<li>Meningkatkan latensi pembaruan parsial dengan mengganti penundaan TimeTick dengan penguncian optimis berbasis snapshot, serta menyempurnakan penanganan AutoID sehingga kunci utama yang ada tetap terjaga dan ID yang dikembalikan mempertahankan urutan input (<a href="https://github.com/milvus-io/milvus/pull/53337">#53337</a>)</li>
<li>Mengurangi konstruksi tampilan baris yang berlebihan saat mengelompokkan hasil pencarian berdasarkan bidang VARCHAR atau JSON pada segmen yang disegel, sehingga menurunkan beban kerja pencarian group-by (<a href="https://github.com/milvus-io/milvus/pull/53500">#53500</a>)</li>
<li>Menambahkan API kepatuhan yang melaporkan konvergensi konfigurasi beban secara global dan per grup sumber daya, mencakup ketersediaan replika, visibilitas kueri, sumber daya sisa, dan penempatan WAL (<a href="https://github.com/milvus-io/milvus/pull/53517">#53517</a>)</li>
</ul>
...
<li>Memperbaiki masalah di mana kueri dapat mengembalikan hasil yang salah setelah bidang array struct dihapus dan ditambahkan kembali (<a href="https://github.com/milvus-io/milvus/pull/52921">#52921</a>)</li>
<li>Memperbaiki kegagalan otentikasi SASL/SCRAM-SHA-256 saat menghubungkan ke broker Apache Kafka 4.x dengan memutakhirkan librdkafka ke 2.6.1 (<a href="https://github.com/milvus-io/milvus/pull/53086">#53086</a>)</li>
<li>Memperbaiki masalah di mana semua saluran replika ditugaskan ke satu node kueri, yang menyebabkan pembunuhan berulang karena kehabisan memori dan membuat replika tidak dapat beroperasi (<a href="https://github.com/milvus-io/milvus/pull/53094">#53094</a>)</li>
<li>Memperbaiki fencing WAL berulang yang menghentikan penulisan pada PChannel selama 45-60 detik setiap beberapa menit saat terjadi pengambilan data yang berkelanjutan (<a href="https://github.com/milvus-io/milvus/pull/53118">#53118</a>)</li>
<li>Memperbaiki pemadatan Storage V2 yang menghapus jalur grup fisik yang valid, yang dapat menyebabkan ketidaksejajaran indeks kolom yang dikemas dalam segmen yang dipadatkan (<a href="https://github.com/milvus-io/milvus/pull/53202">#53202</a>)</li>
<li>Telah diperbaiki log pemadatan yang mencantumkan kunci enkripsi koleksi dan kredensial penyimpanan objek (<a href="https://github.com/milvus-io/milvus/pull/53226">#53226</a>)</li>
<li>Memperbaiki alias offset array struktur yang kedaluwarsa yang dapat menampilkan data yang salah setelah segmen yang disegel dibuka kembali (<a href="https://github.com/milvus-io/milvus/pull/53154">#53154</a>)</li>
<li>Memperbaiki sinkronisasi sumber daya file yang berjalan sebelum sumber daya apa pun ditambahkan, yang dapat menghapus file lokal node saat startup atau pendaftaran node (<a href="https://github.com/milvus-io/milvus/pull/53170">#53170</a>)</li>
<li>Memperbaiki masalah di mana potongan binlog yang tidak lengkap dapat diam-diam diperlakukan sebagai telah dibaca sepenuhnya, sehingga berisiko kehilangan data dalam hasil kueri dan pemadatan (<a href="https://github.com/milvus-io/milvus/pull/53263">#53263</a>)</li>
<li>Memperbaiki masalah di mana penyimpanan segmen yang dihapus tidak pernah direklamasi untuk koleksi tanpa indeks aktif (<a href="https://github.com/milvus-io/milvus/pull/53252">#53252</a>)</li>
<li>Memperbaiki estimasi sumber daya yang tidak akurat saat memuat indeks vektor jarang, yang dapat menyebabkan penanganan data mentah yang salah dan peringatan berulang pada QueryNode (<a href="https://github.com/milvus-io/milvus/pull/53249">#53249</a>)</li>
<li>Memperbaiki masalah di mana node streaming yang dibekukan di luar grup sumber daya utama dapat dicairkan secara tak terduga selama proses penyeimbangan ulang (<a href="https://github.com/milvus-io/milvus/pull/53229">#53229</a>)</li>
<li>Memperbaiki kegagalan koneksi ke Google Cloud Storage di mana kredensial GCP (IAM dan HMAC) tidak terdaftar sebelum pemeriksaan awal pengelola potongan (<a href="https://github.com/milvus-io/milvus/pull/53288">#53288</a>)</li>
<li>Memperbaiki masalah di mana log C++ secara tak terduga ditulis ke direktori <code translate="no">/tmp</code> alih-alih diteruskan ke output log terpadu (<a href="https://github.com/milvus-io/milvus/pull/53293">#53293</a>)</li>
<li>Memperbaiki kegagalan backfill commit dengan kesalahan HTTP 500 ketika hasil Spark mencakup beberapa partisi (<a href="https://github.com/milvus-io/milvus/pull/53346">#53346</a>)</li>
<li>Memperbaiki kebocoran memori di DataNode di mana tugas pembuatan indeks atau analisis yang dibatalkan tidak pernah melepaskan memori native dari objek yang telah dibuatnya (<a href="https://github.com/milvus-io/milvus/pull/53348">#53348</a>)</li>
<li>Memperbaiki masalah di mana impor binlog gagal ketika bidang vektor yang dapat bernilai null tidak memiliki file binlog (<a href="https://github.com/milvus-io/milvus/pull/53363">#53363</a>)</li>
<li>Memperbaiki bidang keluaran yang tidak lengkap atau salah saat permintaan pencarian dan kueri membaca data tabel eksternal (<a href="https://github.com/milvus-io/milvus/pull/53372">#53372</a>, <a href="https://github.com/milvus-io/milvus/pull/53385">#53385</a>)</li>
<li>Memperbaiki baris vektor sparse dan ID partisi yang terduplikasi dalam permintaan REST, serta masalah kepemilikan memori dan pembersihan yang dapat menyebabkan crash atau kebocoran saat kueri berakhir lebih awal (<a href="https://github.com/milvus-io/milvus/pull/53402">#53402</a>)</li>
<li>Memperbaiki masalah di mana pemadatan yang melaporkan penyelesaian tanpa muatan hasil dapat menyebabkan DataCoord crash atau membuat tugas pemadatan macet alih-alih dicoba ulang dengan benar (<a href="https://github.com/milvus-io/milvus/pull/53443">#53443</a>)</li>
<li>Memperbaiki masalah di mana properti file data eksternal terhapus saat membuat manifest segmen, yang menyebabkan koleksi eksternal kehilangan metadata file sumber (<a href="https://github.com/milvus-io/milvus/pull/53444">#53444</a>)</li>
<li>Memperbaiki crash QueryNode yang dapat terjadi saat menangani perminta <code translate="no">count(*)</code> pada tingkat log debug, terutama selama peningkatan bertahap (<a href="https://github.com/milvus-io/milvus/pull/53474">#53474</a>)</li>
<li>Memperbaiki masalah di mana tugas pembuatan indeks dan statistik terus menghabiskan sumber daya pekerja setelah segmen, indeks, atau koleksi mereka dihapus, serta meningkatkan pembersihan file indeks yang terlantar (<a href="https://github.com/milvus-io/milvus/pull/53515">#53515</a>)</li>
<li>Memperbaiki penanganan jalur penyimpanan lokal sehingga data yang ditulis oleh komponen yang berbeda selalu berada di tempat yang diharapkan oleh pembaca dan pengumpulan sampah, dengan peningkatan otomatis untuk penerapan lokal yang ada (<a href="https://github.com/milvus-io/milvus/pull/53530">#53530</a>)</li>
<li>Memperbaiki tugas pembuatan indeks yang terus mencoba ulang tanpa henti ketika sebuah segmen berisi dokumen JSON yang tidak valid; pembuatan indeks semacam itu kini akan segera gagal alih-alih menghabiskan sumber daya pekerja tanpa batas waktu (<a href="https://github.com/milvus-io/milvus/pull/53531">#53531</a>)</li>
<li>Memperbaiki pemulihan snapshot bersamaan yang menargetkan koleksi yang sama: pemulihan kini diserialisasikan dan pemulihan ke target yang sudah ada ditolak dengan pesan kesalahan yang jelas “sudah ada di database” alih-alih bersaing atau menyebabkan kebocoran sumber daya (<a href="https://github.com/milvus-io/milvus/pull/53586">#53586</a>)</li>
<li>Memperbaiki kunci enkripsi biner yang rusak di seluruh antarmuka penyimpanan dan kursor yang tidak sejajar dalam pembaca terkemas Storage V2 yang diproyeksikan dengan meningkatkan milvus-storage (<a href="https://github.com/milvus-io/milvus/pull/53569">#53569</a>)</li>
</ul>
...
<li>Menambahkan API REST v2 untuk pengelolaan snapshot asli dalam lingkup koleksi dan pemulihan asinkron (<a href="https://github.com/milvus-io/milvus/pull/52118">#52118</a>, <a href="https://github.com/milvus-io/milvus/pull/52172">#52172</a>)</li>
...
<li>Meningkatkan keamanan memori pada indeks dan cache geometri RTree, serta penanganan WKB yang tidak dapat diuraikan dan kueri geometri kosong (<a href="https://github.com/milvus-io/milvus/pull/51312">#51312</a>)</li>
...
<li>Mengurangi kemacetan unduhan dan penggunaan memori selama pembuatan indeks koleksi eksternal dengan melakukan paralelisasi pembacaan dan mengalirkan data vektor mentah ke disk (<a href="https://github.com/milvus-io/milvus/pull/51651">#51651</a>)</li>
...
<li>Meningkatkan efisiensi pengelompokan hash-probe dengan pipa empat arah yang diselingi serta pengamanan terhadap tabrakan dan batas rehash (<a href="https://github.com/milvus-io/milvus/pull/51977">#51977</a>)</li>
<li>Mengurangi overhead pemrosesan penyisipan dengan melewatkan penguraian badan penyisipan WAL untuk koleksi tanpa bidang keluaran BM25 atau MinHash (<a href="https://github.com/milvus-io/milvus/pull/51986">#51986</a>)</li>
...
<li>Peningkatan penjadwalan tugas pengindeksan teks dan pemecahan JSON dengan kontrol penerimaan berbasis antrian bersama dan prioritas pengiriman bergantian (<a href="https://github.com/milvus-io/milvus/pull/52010">#52010</a>)</li>
...
<li>Mengurangi beban laporan distribusi QueryNode melalui pelaporan bertahap dengan cadangan laporan lengkap, serta mengurangi alokasi memori selama pengumpulan metrik (<a href="https://github.com/milvus-io/milvus/pull/52111">#52111</a>, <a href="https://github.com/milvus-io/milvus/pull/52119">#52119</a>)</li>
...
<li>Mengurangi dekoding berlebihan selama impor Parquet dengan hanya membaca kolom daun yang diperlukan untuk subbidang array struct (<a href="https://github.com/milvus-io/milvus/pull/52224">#52224</a>)</li>
<li>Meningkatkan pengelompokan penggabungan paksa dengan perencanaan berbasis ukuran multi-putaran dan menghapus pengaturan ambang batas perencanaan lama (<a href="https://github.com/milvus-io/milvus/pull/52242">#52242</a>)</li>
...
<li>Koordinasi siklus hidup segmen yang ditingkatkan dengan menunggu pelepasan segmen setelah batas waktu penguncian (<a href="https://github.com/milvus-io/milvus/pull/52422">#52422</a>)</li>
...
<li>Meningkatkan waktu build C++ dengan kompilasi unity berskala, meningkatkan caching kompiler, dan mengurangi pekerjaan kompilasi yang berlebihan (<a href="https://github.com/milvus-io/milvus/pull/52995">#52995</a>)</li>
...
<li>Memperbaiki Milvus mandiri yang macet saat dimatikan dengan menambahkan batas waktu migrasi yang dapat dikonfigurasi dengan default 10 detik (<a href="https://github.com/milvus-io/milvus/pull/52027">#52027</a>)</li>
<li>Memperbaiki permintaan embedding tabel eksternal yang menggunakan identitas cluster yang salah saat pekerja DataNode dibagikan di seluruh cluster yang melayani (<a href="https://github.com/milvus-io/milvus/pull/52042">#52042</a>)</li>
...
<li>Memperbaiki penyeimbangan segmen antar QueryNodes yang macet saat Layanan Streaming diaktifkan (<a href="https://github.com/milvus-io/milvus/pull/52147">#52147</a>, <a href="https://github.com/milvus-io/milvus/pull/52169">#52169</a>)</li>
...
<li>Memperbaiki hak akses yang dicabut yang tetap berlaku setelah dihapus dari grup hak akses (<a href="https://github.com/milvus-io/milvus/pull/52554">#52554</a>)</li>
...
<li>Memperbaiki kegagalan pemuatan segmen untuk indeks HYBRID pada subbidang struct-array dengan file STLSORT warisan dari 3.0.0, tanpa memerlukan pengindeksan ulang (<a href="https://github.com/milvus-io/milvus/pull/52643">#52643</a>)</li>
...
<li>Memperbaiki kegagalan kueri saat filter elemen ARRAY menemukan batch penuh NULL atau array kosong sebelum elemen selanjutnya (<a href="https://github.com/milvus-io/milvus/pull/52720">#52720</a>)</li>
...
<li>Memperbaiki data yang kehilangan cap waktu komit aslinya setelah pemadatan kluster (<a href="https://github.com/milvus-io/milvus/pull/52859">#52859</a>)</li>
...
<li>Memperbaiki baris yang kedaluwarsa di segmen Storage V3 yang gagal memicu pemadatan berbasis bidang TTL dan tetap tersimpan hingga kondisi pemadatan lain terpenuhi (<a href="https://github.com/milvus-io/milvus/pull/52931">#52931</a>)</li>
<li>Memperbaiki ketidakkonsistenan kunci utama yang dibuat secara otomatis antara koleksi sumber dan target selama impor yang direplikasi CDC (<a href="https://github.com/milvus-io/milvus/pull/52941">#52941</a>)</li>
...
<li>Memperbaiki indeks HYBRID bersarang yang dibangun ulang atau dikompresi dengan data kardinalitas tinggi yang menjadi tidak dapat dibaca setelah rollback ke versi yang lebih lama (<a href="https://github.com/milvus-io/milvus/pull/52959">#52959</a>)</li>
...
<li>Memperbaiki masalah di mana penambahan bidang TEXT setelah mengaktifkan Storage V3 mencegah pemuatan segmen Storage V2 yang sedang berkembang, sehingga mengganggu operasi flush, penyortiran, dan pengindeksan (<a href="https://github.com/milvus-io/milvus/pull/53002">#53002</a>)</li>
<li>Memperbaiki snapshot yang menyertakan segmen Storage V3 yang belum dikomit, yang menyebabkan pemulihan dilaporkan berhasil padahal segmen yang dipulihkan tidak dapat dimuat (<a href="https://github.com/milvus-io/milvus/pull/53022">#53022</a>, <a href="https://github.com/milvus-io/milvus/pull/53039">#53039</a>)</li>
<li>Telah diperbaiki indeks teks Storage V3 yang gagal dimuat ketika file-file tersebut disimpan dalam direktori tugas atau versi bersarang (<a href="https://github.com/milvus-io/milvus/pull/53062">#53062</a>)</li>
</ul>
...
<h4 id="Sparse-index-overhaul-SINDI-Block-Max-WAND-and-Block-Max-MaxScore" class="common-anchor-header">Perombakan indeks spars: SINDI, Block-Max WAND, dan Block-Max MaxScore</h4><p>Milvus 3.0 meningkatkan indeks vektor spars di seluruh sistem. Versi ini memperkenalkan algoritma pencarian baru — <a href="https://arxiv.org/abs/2509.08395">SINDI</a>, Block-Max WAND, dan Block-Max MaxScore — bersama dengan kompresi daftar terbalik, kuantisasi yang dapat dikonfigurasi, dan pemilihan algoritma pencarian per beban kerja. Pemuatan mmap, serialisasi, dan penilaian BM25 juga dioptimalkan, sehingga mengurangi penyimpanan indeks dan beban pemuatan untuk pencarian vektor spars dan teks lengkap berskala besar. Dalam pengujian internal, indeks BM25 yang dikompresi ukurannya kira-kira 3x lebih kecil daripada indeks langka 2.6 dengan tingkat recall yang sebanding, dan SINDI mencapai hingga sekitar 10x QPS MaxScore pada embedding langka yang dipelajari. Setelah versi indeks baru diaktifkan (lihat Catatan kompatibilitas dan perilaku), SINDI menjadi default untuk pencarian IP sparce, dan MaxScore menjadi default untuk BM25.</p>
<h4 id="StructArray-coverage" class="common-anchor-header">Cakupan StructArray</h4><p>StructArray kini mendukung nilai null, indeks bitmap, penambahan bidang dinamis pada koleksi aktif, dan pembaruan parsial bidang struktur melalui upsert, dengan dukungan REST dan impor massal yang sesuai.</p>
...
<h4 id="Function-Chain-reranking" class="common-anchor-header">Penilaian ulang Rantai Fungsi</h4><p>Penilaian ulang kini dapat digabungkan melalui API Rantai Fungsi, yang menjalankan pipa berurutan dan bertipe sebagai bagian dari satu permintaan pencarian. Sebuah rantai dapat menggabungkan penilaian ulang L0 awal pada QueryNode dengan penataan ulang peringkat pasca-reduksi L2 pada Proxy, yang mendukung transformasi dan kombinasi skor, penataan ulang peringkat berbasis model, penyortiran, dan pemangkasan kandidat tanpa orkestrasi di sisi klien. Rilis ini juga menambahkan penilaian XGBoost bawaan untuk penataan ulang peringkat L0 menggunakan model UBJ yang terdaftar sebagai FileResources, bersama dengan Penyedia Inferensi Hugging Face untuk embedding teks yang dikelola server dan penataan ulang peringkat kesamaan kalimat.</p>
...
<h4 id="Woodpecker-standalone-deployment" class="common-anchor-header">Penerapan Woodpecker secara mandiri</h4><p>Woodpecker, WAL yang menjadi inti jalur penulisan streaming, kini dapat diimplementasikan sebagai layanan mandiri alih-alih tertanam di node lain — penskalaan mandiri, isolasi kegagalan, dan observabilitas, layaknya mikroservis lainnya. Hal ini sangat penting bagi kluster besar dan beban kerja dengan volume penulisan tinggi.</p>
<h3 id="Core-30-features-recall" class="common-anchor-header">Ringkasan fitur Core 3.0<button data-href="#Core-30-features-recall" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Fitur-fitur di bawah ini telah diperkenalkan dalam <a href="https://milvus.io/docs/release_notes.md#v30-beta">3.0-beta</a> dan merupakan bagian dari 3.0.0; lihat catatan beta untuk uraian lengkapnya.</p>
<ul>
...
<li><strong>Agregasi Kueri</strong> — COUNT / SUM / AVG / MIN / MAX dengan pengelompokan (group-by), dievaluasi di sisi server.</li>
<li><strong>EmbList + DiskANN</strong> — pengindeksan multi-vektor di disk untuk daftar embedding StructArray, dengan jalur akselerasi seperti Muvera dan Lemur.</li>
...
<p>Snapshot menciptakan tampilan Koleksi pada titik waktu tertentu yang hanya dapat dibaca dengan merujuk pada segmen yang sudah ada, bukan dengan menyalin data, sehingga biaya penyimpanan marjinalnya mendekati nol. Pekerjaan batch dapat membaca dari Snapshot di bawah isolasi bergaya MVCC sementara Koleksi yang aktif tetap menerima penulisan.</p>
...
<h4 id="Query--Search-Order-By" class="common-anchor-header">Urutan Kueri / Pencarian</h4><p>Pencarian dan Kueri kini mendukung pengurutan multi-kolom, dengan proses pengurutan ditangani langsung oleh kernel Milvus dan opsi " <code translate="no">ASC</code> " serta " <code translate="no">DESC</code> " dapat diatur per kolom. Hal ini mengatasi celah umum dalam produksi: pengurutan Top-K berdasarkan jarak saja seringkali tidak sesuai dengan kebutuhan bisnis ketika item yang paling mirip bukanlah yang termurah, terbaru, atau paling populer.</p>
...
<h4 id="Null-Vector" class="common-anchor-header">Vektor Null</h4><p>Embedding sering dihasilkan secara asinkron, sehingga suatu entitas dapat tiba sebelum vektornya siap. Data multimodal juga memiliki celah alami, seperti video tanpa teks atau produk tanpa gambar. Versi sebelumnya tidak memiliki solusi yang memadai: aplikasi menunda penulisan hingga vektor siap atau mengisi dengan vektor tempatholder, dan kedua pilihan tersebut merugikan kualitas pencarian.</p>
...
<h4 id="Entity-TTL" class="common-anchor-header">TTL Entitas</h4><p>TTL tingkat Koleksi dan tingkat partisi terlalu kasar untuk banyak skenario siklus hidup dan kepatuhan. Penyewa yang berbeda di dalam Koleksi yang sama sering kali memiliki aturan penyimpanan yang berbeda, dan entitas individual mungkin perlu kedaluwarsa sesuai jadwal yang tidak sesuai dengan bagian Koleksi lainnya.</p>
...
<p>Milvus 3.0 menambahkan fungsi MinHash di sisi server. Deklarasikan bidang masukan ` <code translate="no">VARCHAR</code> ` dan bidang keluaran ` <code translate="no">BINARY_VECTOR</code> ` dalam skema, lampirkan fungsi ` <code translate="no">FunctionType.MINHASH</code> `, dan Milvus akan menghitung tanda tangan tersebut selama proses penyisipan, penyisipan massal, dan pencarian. Bersama dengan ` <code translate="no">MINHASH_LSH</code>`, fitur ini mendukung alur kerja deduplikasi untuk kumpulan data besar, pembuatan sidik jari, dan deteksi plagiarisme di dalam Milvus.</p>
<p>Untuk informasi lebih lanjut, lihat <a href="/docs/id/minhash-function.md">Fungsi MinHash</a>.</p>
<h4 id="EmbList-+-DISKANN" class="common-anchor-header">EmbList + DISKANN</h4><p>Asumsi “satu entitas = satu vektor” tidak lagi sesuai dengan pencarian modern. Dokumen panjang dipecah menjadi banyak bagian, model interaksi terlambat seperti ColBERT menghasilkan satu vektor per token, dan entitas multimodal dapat memiliki beberapa tampilan.</p>
<p>EmbList menyimpan daftar vektor berpanjang variabel per entitas, dengan " <code translate="no">DISKANN</code> " sebagai indeks di disk. Jalur disk ini menjaga penggunaan RAM tetap terkendali saat korpus melebihi batas memori. EmbList + " <code translate="no">DISKANN</code> " merupakan varian pertama dari keluarga StructList yang lebih luas dalam rilis kandidat (RC) ini. Sisa keluarga ini, termasuk penyaringan StructList dan akselerasi multi-vektor Muvera / Lemur, direncanakan akan dirilis pada versi resmi 3.0.</p>
...
<h4 id="Storage-V3" class="common-anchor-header">Penyimpanan V3</h4><p>Milvus 3.0 memperkenalkan Storage V3, mesin penyimpanan kolom berbasis manifest di mana data dan metadata disimpan pada penyimpanan objek yang kompatibel dengan S3. Setiap versi dataset direkam sebagai snapshot manifest yang tidak dapat diubah, yaitu berkas yang dienkode dalam format Avro yang mencatat kelompok kolom, delta log, dan statistik yang membentuk dataset tersebut.</p>
<p>Manifest adalah berkas Avro yang ringkas, sedangkan log delta mencatat penghapusan entitas tanpa perlu menulis ulang berkas data. Hal ini menjaga beban metadata tetap kecil seiring pertumbuhan dataset. Manifest juga memisahkan pelacakan metadata dari jalur kueri, sehingga sebuah Koleksi dapat mengelola lebih banyak segmen tanpa mengorbankan kinerja kueri.</p>
<p>Karena status disimpan di penyimpanan objek, kumpulan data bersifat deskriptif sendiri: pembaca mana pun yang memiliki akses ke jalur penyimpanan dapat menemukannya dan menafsirkannya tanpa katalog pusat. Sifat ini menjadi dasar bagi External Collection, Snapshot, dan integrasi lake di masa mendatang.</p>
