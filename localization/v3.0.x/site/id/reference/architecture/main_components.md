...
<h3 id="Standalone" class="common-anchor-header">Mandiri<button data-href="#Standalone" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Cluster" class="common-anchor-header">Cluster<button data-href="#Cluster" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Mode penyebaran terdistribusi Milvus di mana setiap komponen berjalan secara independen dan dapat ditingkatkan untuk elastisitas. Pengaturan ini cocok untuk dataset besar dan skenario beban tinggi.</p>
<p>
