...
<h3 id="Servicetimestamp" class="common-anchor-header"><code translate="no">Service_timestamp</code><button data-href="#Servicetimestamp" class="anchor-icon" translate="no">
    ...
    </button></h3><p><code translate="no">Service_timestamp</code> adalah jenis stempel waktu yang secara otomatis dibuat dan dikelola oleh node kueri di Milvus. Ini digunakan untuk menunjukkan operasi DML mana yang dijalankan oleh node kueri.</p>
...
<li>Pelajari bagaimana <a href="/docs/id/tune_consistency.md">cap waktu jaminan memungkinkan konsistensi yang dapat disetel di Milvus</a></li>
</ul>
