...
<h3 id="Database-level-multi-tenancy" class="common-anchor-header">Penyewaan multi-tenant tingkat basis data<button data-href="#Database-level-multi-tenancy" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Dengan multi-tenancy tingkat basis data, setiap penyewa menerima <a href="/docs/id/manage_databases.md">basis data</a> yang sesuai yang berisi satu atau beberapa koleksi.</p>
<p>
...
<h3 id="Collection-level-multi-tenancy" class="common-anchor-header">Multi-penyewaan tingkat koleksi<button data-href="#Collection-level-multi-tenancy" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Dengan multi-tenancy tingkat koleksi, setiap penyewa diberi <a href="/docs/id/manage-collections.md">koleksi</a>, menawarkan isolasi data yang kuat.</p>
<p>
...
<li><p><strong>Lainnya</strong>: Strategi ini juga mendukung RBAC, yang memungkinkan kontrol akses granular atas penyewa. Selain itu, Anda dapat secara fleksibel memuat atau melepaskan data untuk penyewa tertentu untuk mengelola data panas dan dingin secara efektif.</p></li>
</ul>
<h3 id="Partition-level-multi-tenancy" class="common-anchor-header">Multi-penyewaan tingkat partisi<button data-href="#Partition-level-multi-tenancy" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Dalam multi-penyewaan tingkat partisi, setiap penyewa ditugaskan ke <a href="/docs/id/manage-partitions.md">partisi</a> yang dibuat secara manual dalam koleksi bersama.</p>
<p>
...
<h3 id="Partition-key-level-multi-tenancy" class="common-anchor-header">Mempartisi multi-penyewaan tingkat kunci<button data-href="#Partition-key-level-multi-tenancy" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<ol>
<li><p><strong>Skalabilitas:</strong> Kunci Partisi &gt; Partisi &gt; Koleksi &gt; Database</p>
