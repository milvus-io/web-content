...
<p><strong>Novedades en v3.0-beta:</strong></p>
<ul>
...
<p>Descargue siempre la última configuración de Docker Compose para garantizar la compatibilidad con las características de v3.0-beta.</p>
<ul>
