...
<p>De forma predeterminada, esta implementación utiliza <strong>Woodpecker</strong> (sistema de archivos local) como cola de mensajes, por lo que no se necesita ningún servicio externo de colas de mensajes. Consulta <a href="/docs/es/woodpecker.md">Woodpecker</a>.</p>
</blockquote>
...
<h3 id="From-WSL-2​" class="common-anchor-header">Desde WSL 2​<button data-href="#From-WSL-2​" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Si prefieres iniciar Milvus utilizando comandos de Linux y scripts de shell en Windows, asegúrate de que ya tienes instalado WSL 2. Para obtener más información sobre cómo instalar WSL 2, puedes consultar este <a href="https://learn.microsoft.com/en-us/windows/wsl/install#install-wsl-command">artículo de Microsoft</a>.​</p>
<ol>
<li><p>Inicia WSL 2.</p>
...
<h3 id="How-can-I-deal-with-WSL-related-issues-while-deploying-Milvus​" class="common-anchor-header">¿Cómo puedo solucionar los problemas relacionados con WSL al implementar Milvus?​<button data-href="#How-can-I-deal-with-WSL-related-issues-while-deploying-Milvus​" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Si ha encontrado problemas relacionados con WSL al ejecutar Milvus desde WSL 2, es posible que deba comprobar si ha configurado Docker Desktop para utilizar el motor basado en WSL 2 de la siguiente manera:​</p>
<ol>
...
<li><p>Selecciona, entre las distribuciones de WSL 2 que tengas instaladas, aquellas en las que quieras habilitar la integración con Docker yendo a: <strong>Configuración</strong> &gt; <strong>Recursos</strong> &gt; <strong>Integración con WSL</strong>.</p>
<p><span class="img-wrapper">
...
<p>Para solucionar el error que aparece durante el inicio de Milvus y que dice «Read config failed», debes comprobar si el volumen montado en el contenedor de Milvus es el correcto. Si el volumen está montado correctamente en el contenedor, puedes utilizar el comando <code translate="no">docker exec</code> para acceder al contenedor y listar el contenido de la carpeta <strong>/milvus/configs</strong> de la siguiente manera:​</p>
<p><span class="img-wrapper">
...
<li><p><a href="/docs/es/upgrade_milvus_cluster-helm.md">Actualiza Milvus utilizando Helm Chart</a>.</p></li>
