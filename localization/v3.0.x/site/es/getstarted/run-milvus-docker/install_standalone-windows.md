...
<p>De forma predeterminada, esta implementación ejecuta <strong>Woodpecker</strong> (sistema de archivos local) como cola de mensajes, por lo que no se necesita ningún servicio externo de cola de mensajes. Consulta <a href="/docs/es/woodpecker.md">Woodpecker</a>.</p>
</blockquote>
...
<p>A continuación, debes reiniciar el ordenador y habilitar Hyper-V. Para obtener más detalles, consulta este <a href="https://learn.microsoft.com/en-us/virtualization/hyper-v-on-windows/quick-start/enable-hyper-v#enable-the-hyper-v-role-through-settings">artículo de Microsoft</a>.​</p></li>
