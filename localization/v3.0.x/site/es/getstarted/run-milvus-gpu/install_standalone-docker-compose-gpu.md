...
<li><a href="/docs/es/prerequisite-gpu.md">Comprueba los requisitos de hardware y software</a> antes de la instalación.</li>
</ul>
<div class="alert note">
<p>Si tienes algún problema al descargar la imagen, ponte en contacto con nosotros en <a href="mailto:community@zilliz.com">community@zilliz.com</a> con los detalles del problema y te proporcionaremos la ayuda necesaria.</p>
</div>
...
<h3 id="1-Download-and-configure-the-YAML-file" class="common-anchor-header">1. Descarga y configura el archivo YAML<button data-href="#1-Download-and-configure-the-YAML-file" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Descárgalo <a href="https://github.com/milvus-io/milvus/releases/download/v3.0.2/milvus-standalone-docker-compose-gpu.yml"><code translate="no">milvus-standalone-docker-compose-gpu.yml</code></a> y guárdalo como docker-compose.yml manualmente o con el siguiente comando.</p>
...
<li>El contenedor <strong>«milvus-minio»</strong> atiende los puertos <strong>9090</strong> y <strong>9091</strong> de forma local con las credenciales de autenticación predeterminadas y asigna sus datos a <strong>«volumes/minio»</strong> en la carpeta actual.</li>
...
<p>Puedes comprobar si los contenedores están en funcionamiento utilizando el siguiente comando:</p>
...
<p>Para configurar el grupo de memoria, modifica los ajustes <code translate="no">initMemSize</code> y <code translate="no">maxMemSize</code> del archivo <code translate="no">milvus.yaml</code> de la siguiente manera.</p>
<ol>
...
<li><p>Abre el archivo « <code translate="no">milvus.yaml</code> » copiado con tu editor de texto preferido. Por ejemplo, si utilizas vim:</p>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li><code translate="no">initMemSize</code>: Tamaño inicial del grupo de memoria. El valor por defecto es 1024.</li>
<li><code translate="no">maxMemSize</code>: Tamaño máximo del pool de memoria. El valor predeterminado es 2048.</li>
</ul></li>
...
<div class="alert note">
<p>Storage V3 está desactivado de forma predeterminada. Actívelo antes de utilizar funciones que dependan de él. Para conocer los requisitos y las consideraciones de compatibilidad, consulte <a href="/docs/es/storage-v3.md">Storage V3</a>.</p>
</div>
...
<li><p>Consulta <a href="/docs/es/milvus-webui.md">la interfaz web de Milvus</a> para obtener más información sobre la instancia de Milvus.</p></li>
