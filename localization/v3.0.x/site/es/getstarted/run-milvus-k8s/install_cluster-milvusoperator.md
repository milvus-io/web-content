...
<li><p>Antes de instalar Milvus, se recomienda utilizar la <a href="https://milvus.io/tools/sizing">herramienta Milvus Sizing Tool</a> para estimar los requisitos de hardware en función del tamaño de tus datos. Esto te ayudará a garantizar un rendimiento óptimo y una asignación adecuada de recursos para tu instalación de Milvus.</p></li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<p>El comando anterior implementa un clúster de Milvus con <strong>Woodpecker</strong> como cola de mensajes (recomendado para la versión 3.0.1) y todos los nuevos componentes arquitectónicos, incluido el nodo de streaming.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Una vez que tu clúster de Milvus esté listo, la salida del comando anterior debería ser similar a la siguiente. Si el campo « <code translate="no">status.status</code> » sigue indicando « <code translate="no">Unhealthy</code> », tu clúster de Milvus aún se está creando.</p>
