...
<li><p><a href="/docs/es/prerequisite-helm.md#How-can-I-start-a-K8s-cluster-locally-for-test-purposes">Crear un clúster K8s</a>.</p></li>
...
<button class="copy-code-btn"></button></code></pre>
<p>El comando anterior despliega un cluster Milvus con <strong>Woodpecker</strong> como cola de mensajes (recomendado para v3.0-beta) y todos los componentes arquitectónicos nuevos, incluido el Nodo de Streaming.</p>
...
<li><strong>Nodo de flujo</strong>: Habilitado para un procesamiento de datos mejorado</li>
...
<ul>
<li><p>Comprobar <a href="/docs/es/quickstart.md">Hello Milvus</a> para ver lo que Milvus puede hacer.</p></li>
