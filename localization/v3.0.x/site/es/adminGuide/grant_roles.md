...
<h2 id="Describe-user" class="common-anchor-header">Describir usuario<button data-href="#Describe-user" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una vez que hayas concedido un rol a un usuario, puedes comprobar si la operación de concesión se ha realizado correctamente a través del método <code translate="no">describe_user()</code>.</p>
