...
El cambio de <code translate="no">mq.type</code> de esta forma está pensado para una instancia <b>totalmente nueva</b> (que aún no contenga colecciones). Para cambiar la cola de mensajes de una instancia que ya contiene datos, sigue en su lugar el procedimiento de cambio.
</div>
...
<li>Para cambiar la cola de mensajes de una instancia en ejecución, consulta Cambiar de RocksMQ a Woodpecker.</li>
</ul>
