...
<h2 id="Visualize-metrics-using-Grafana" class="common-anchor-header">Visualización de métricas con Grafana<button data-href="#Visualize-metrics-using-Grafana" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Download-and-import-dashboard" class="common-anchor-header">1. Descargue e importe el panel de control<button data-href="#1-Download-and-import-dashboard" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Descargue e importe el cuadro de mandos de Milvus desde el archivo JSON.</p>
...
<h3 id="2-View-metrics" class="common-anchor-header">2. Ver métricas<button data-href="#2-View-metrics" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Seleccione la instancia de Milvus que desea supervisar. Entonces podrá ver el panel de componentes de Milvus.</p>
<p>
