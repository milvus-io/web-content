...
<h3 id="Prerequisites" class="common-anchor-header">Requisitos previos<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Este tutorial asume que usted tiene Grafana instalado y configurado. Si no es así, recomendamos leer la <a href="/docs/es/monitor.md">guía de monitorización</a>.</p>
<h3 id="1-Add-a-new-query" class="common-anchor-header">1. Añadir una nueva consulta<button data-href="#1-Add-a-new-query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="2-Save-the-dashboard" class="common-anchor-header">2. Guarde el panel<button data-href="#2-Save-the-dashboard" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Guarde el panel y espere unos minutos para ver la alerta.</p>
<p>
...
<h3 id="3-Add-alert-notifications" class="common-anchor-header">3. Añadir notificaciones de alerta<button data-href="#3-Add-alert-notifications" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para recibir notificaciones de alerta, añada un "canal de notificación". A continuación, especifique el canal en el campo "Enviar a".</p>
<p>
...
<li>Si ha creado alertas para el uso de memoria por parte de los componentes de Milvus:<ul>
