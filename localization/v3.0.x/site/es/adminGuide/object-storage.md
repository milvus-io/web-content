...
<h1 id="Object-Storage" class="common-anchor-header">Almacenamiento de objetos<button data-href="#Object-Storage" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus almacena los archivos de índice y los registros binarios —la mayor parte de sus datos— en un almacenamiento de objetos. Milvus es compatible con MinIO y con una amplia gama de almacenes de objetos en la nube y compatibles con S3.</p>
