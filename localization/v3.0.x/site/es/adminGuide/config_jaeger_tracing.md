...
<h3 id="1-Installing-the-Jaeger-Operator-on-Kubernetes" class="common-anchor-header">1. Instalación del operador Jaeger en Kubernetes<button data-href="#1-Installing-the-Jaeger-Operator-on-Kubernetes" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para instalar el operador, ejecute:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Deploy-Jaeger" class="common-anchor-header">2. Despliegue de Jaeger<button data-href="#2-Deploy-Jaeger" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="View-Traces" class="common-anchor-header">Ver rastros<button data-href="#View-Traces" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una vez que haya desplegado Jaeger y Milvus con Helm Chart, un ingress ha sido habilitado por dfault. Puede ver la entrada ejecutando el siguiente comando:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Una vez que la entrada está disponible, puede acceder a la interfaz de usuario de Jaeger navegando a <code translate="no">http://${ADDRESS}</code>. Reemplace <code translate="no">${ADDRESS}</code> con la dirección IP real del ingress.</p>
