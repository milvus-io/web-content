...
<thead>
<tr><th>Versión de Milvus</th><th>Versión de Pulsar compatible</th><th>Predeterminada</th></tr>
</thead>
<tbody>
<tr><td>2.5.x y posteriores</td><td>Pulsar v3 (recomendada) o Pulsar v2</td><td>Pulsar v3 (a través de Helm / Milvus Operator)</td></tr>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Deploy-a-Milvus-cluster-with-Pulsar-using-Milvus-Operator" class="common-anchor-header">Implementar un clúster de Milvus con Pulsar utilizando Milvus Operator<button data-href="#Deploy-a-Milvus-cluster-with-Pulsar-using-Milvus-Operator" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Internal-in-cluster-Pulsar" class="common-anchor-header">Pulsar interno (dentro del clúster)<button data-href="#Internal-in-cluster-Pulsar" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><a href="/docs/es/switch-pulsar-woodpecker.md">Cambiar entre Pulsar y Woodpecker</a></li>
</ul>
