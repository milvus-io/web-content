...
<h3 id="Before-your-start" class="common-anchor-header">Antes de empezar<button data-href="#Before-your-start" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Tweak-Milvus-configurations" class="common-anchor-header">Ajustar las configuraciones de Milvus<button data-href="#Tweak-Milvus-configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Esta guía asume que ya ha <a href="/docs/es/gcp.md">desplegado un clúster Milvus detrás de un equilibrador de carga de Capa 4 en GCP</a>.</p>
...
<h3 id="Set-up-a-health-check-endpoint" class="common-anchor-header">Configurar un punto final de comprobación de estado<button data-href="#Set-up-a-health-check-endpoint" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Prepare-TLS-certificates" class="common-anchor-header">Preparar certificados TLS<button data-href="#Prepare-TLS-certificates" class="anchor-icon" translate="no">
    ...
    </button></h3><p>TLS requiere certificados para funcionar. <strong>Existen dos formas de crear certificados: autogestionados y gestionados por Google.</strong></p>
...
<h3 id="Create-an-Ingress-to-generate-a-Layer-7-Load-Balancer" class="common-anchor-header">Crear un Ingress para generar un equilibrador de carga de capa 7<button data-href="#Create-an-Ingress-to-generate-a-Layer-7-Load-Balancer" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Cree un archivo YAML con uno de los siguientes fragmentos.</p>
<ul>
