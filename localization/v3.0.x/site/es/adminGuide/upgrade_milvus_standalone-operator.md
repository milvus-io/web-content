...
<h3 id="Step-3-Update-the-Milvus-image" class="common-anchor-header">Paso 3: Actualizar la imagen de Milvus<button data-href="#Step-3-Update-the-Milvus-image" class="anchor-icon" translate="no">
    ...
    </button></h3><p>En el manifiesto completo de la CR de Milvus, cambia únicamente <code translate="no">spec.components.image</code>. Mantén el modo existente, la configuración de los componentes, la cola de mensajes, etcd, el almacenamiento y demás ajustes de dependencias. El siguiente fragmento muestra el campo que debes modificar; no sustituyas tu CR completa por este fragmento.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Comprueba que la CR de Milvus indique « <code translate="no">Healthy</code> », que la imagen actual sea « <code translate="no">milvusdb/milvus:v3.0-beta</code> » y que las colecciones existentes sigan siendo consultables y buscables. Realiza estas comprobaciones antes de habilitar cualquier función específica de la versión v3.0-beta.</p>
