...
summary: >-
  Descripción general del almacenamiento de metadatos, el almacenamiento de
  objetos y las colas de mensajes que utiliza Milvus.
---
<h1 id="Data-Infrastructure" class="common-anchor-header">Infraestructura de datos<button data-href="#Data-Infrastructure" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Milvus se basa en el almacenamiento de metadatos, el almacenamiento de objetos y una cola de mensajes para su infraestructura de datos principal. En este capítulo se describen los componentes que se pueden configurar:</p>
<ul>
