...
<li><strong><a href="/docs/es/object-storage.md">Almacenamiento de objetos</a></strong>: Milvus almacena archivos de índice y registros binarios en MinIO, AWS S3 u otros sistemas de almacenamiento de objetos en la nube compatibles con S3.</li>
