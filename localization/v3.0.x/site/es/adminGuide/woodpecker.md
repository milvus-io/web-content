...
<ul>
<li>Controla el comportamiento de anexión, rotación y auditoría de segmentos en el lado del cliente para equilibrar el rendimiento y la latencia de extremo a extremo.</li>
</ul></li>
...
<p>A continuación, realiza la implementación siguiendo uno de los siguientes ejemplos:</p>
...
<p>Para el modo de servicio de Woodpecker, recomendamos utilizar la próxima versión de Milvus 3.0.1 o una posterior, junto con Woodpecker v0.1.37 o posterior, para obtener optimizaciones en la limpieza de compactación y la confirmación por grupos.</p>
</div>
...
<ul>
<li><strong>Almacenamiento de objetos (compatible con MinIO/S3)</strong>: Aumenta la concurrencia y el tamaño de los objetos (evita los objetos muy pequeños). Presta atención a los límites de ancho de banda de la red y de los buckets. Un único nodo MinIO en SSD suele tener un límite de unos 100 MB/s a nivel local; un único EC2 conectado a S3 puede alcanzar GB/s.</li>
...
<ul>
<li>Utilice lotes de mayor tamaño y un mayor número de escritores o clientes simultáneos.</li>
