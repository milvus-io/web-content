...
<tr><td>Ruta del subcampo</td><td>Utilice rutas de tipo « <code translate="no">structArray[subfield]</code> », como <code translate="no">chunks[emb]</code>, para índices, objetivos de búsqueda, campos de salida y filtros. No utilice <code translate="no">chunks.emb</code>.</td></tr>
...
<h2 id="Supported-subfield-data-types" class="common-anchor-header">Tipos de datos de subcampos admitidos<button data-href="#Supported-subfield-data-types" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<tbody>
<tr><td>Forma de la carga útil</td><td>Inserte el campo StructArray como una matriz de objetos Struct, como por ejemp <code translate="no">chunks: [{&quot;text&quot;: &quot;...&quot;, &quot;emb&quot;: [...]}]</code>.</td></tr>
...
<h2 id="Index-and-metric-limits" class="common-anchor-header">Límites de índice y métrica<button data-href="#Index-and-metric-limits" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
