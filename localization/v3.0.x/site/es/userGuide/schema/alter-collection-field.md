...
<ul>
<li><p>Cada colección consta de un único campo principal. Una vez establecido durante la creación de la colección, no se puede cambiar el campo principal ni modificar sus propiedades.</p></li>
