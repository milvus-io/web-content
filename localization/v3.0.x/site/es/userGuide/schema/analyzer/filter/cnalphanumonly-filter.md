...
<button class="copy-code-btn"></button></code></pre>
<p>El filtro <code translate="no">cnalphanumonly</code> funciona con los términos generados por el tokenizador, por lo que debe utilizarse en combinación con un tokenizador. Para obtener una lista de los tokenizadores disponibles en Milvus, consulte <a href="/docs/es/jieba-tokenizer.md">Jieba</a> y sus páginas hermanas.</p>
