...
title: Dígito decimalCompatible with Milvus 3.0.0+
summary: >-
  El filtro «decimaldigit» convierte los dígitos decimales Unicode en dígitos
  ASCII.
beta: Milvus 3.0.0+
---
<h1 id="Decimal-Digit" class="common-anchor-header">Dígito decimal<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 3.0.0+</span><button data-href="#Decimal-Digit" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>El filtro « <code translate="no">decimaldigit</code> » es un filtro de tokens integrado que convierte los dígitos decimales Unicode de los alfabetos compatibles en dígitos ASCII. Esto garantiza la coherencia de los tokens numéricos en todos los idiomas y sistemas de escritura.</p>
