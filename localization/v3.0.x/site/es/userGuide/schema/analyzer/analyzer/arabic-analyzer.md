...
<h2 id="Configuration" class="common-anchor-header">Configuración<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Los analizadores integrados son plantillas de analizadores proporcionadas por Milvus. Para utilizar un analizador integrado, establece <code translate="no">type</code> en un nombre de analizador predefinido en <code translate="no">analyzer_params</code>.</p>
