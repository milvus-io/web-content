...
<p>También puede configurar las propiedades « <code translate="no">autoId</code> » en <code translate="no">True</code> para que Milvus asigne automáticamente los valores del campo primario al insertar datos.​</p>
