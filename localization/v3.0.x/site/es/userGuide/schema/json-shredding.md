...
<table>
   ...
   <tr>
     ...
     <td><p>1024</p></td>
     <td><p>Esto es suficiente para la mayoría de los escenarios. Para JSON con miles de claves que aparecen con frecuencia, puede que necesite aumentar este valor, pero controle el uso del almacenamiento.</p></td>
   </tr>
   <tr>
