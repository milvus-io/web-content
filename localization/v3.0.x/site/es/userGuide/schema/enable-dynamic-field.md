...
<li><p>Para ver una lista completa, consulta <a href="/docs/es/use-json-fields.md#Supported-JSON-cast-types">Tipos de conversión JSON admitidos</a>.</p></li>
</ul></li>
</ul>
...
<div class="alert note">
<ul>
<li><p>Si la conversión de tipos falla (por ejemplo, el valor <code translate="no">&quot;not_a_number&quot;</code> no se puede convertir a un número), el valor se omite y no se indexa.</p></li>
