...
<h2 id="Validate-inserted-data" class="common-anchor-header">Validar los datos insertados<button data-href="#Validate-inserted-data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Puedes consultar la colección y obtener el campo StructArray o los subcampos seleccionados.</p>
...
<li><p>Para crear índices para <code translate="no">chunks[emb_list_vector]</code>, <code translate="no">chunks[emb]</code> y subcampos escalares, consulta <a href="/docs/es/index-structarray-fields.md">«Indexar campos de StructArray</a>».</p></li>
