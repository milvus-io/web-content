...
<tr><td><code translate="no">hf_provider</code></td><td>No</td><td>La ruta del proveedor de inferencia de Hugging Face. El valor predeterminado y el único admitido en Milvus 2.6.20 es <code translate="no">hf-inference</code>.</td></tr>
