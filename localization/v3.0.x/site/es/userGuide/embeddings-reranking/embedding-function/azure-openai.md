...
<h2 id="Choose-an-embedding-model" class="common-anchor-header">Elija un modelo de incrustación<button data-href="#Choose-an-embedding-model" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus soporta todos los modelos de incrustación proporcionados por Azure OpenAI. A continuación se muestran los modelos de incrustación de Azure OpenAI disponibles actualmente para una referencia rápida:</p>
<table>
   <tr>
     <th><p>Modelo</p></th>
...
<h3 id="Step-2-Add-embedding-function-to-schema" class="common-anchor-header">Paso 2: Añadir la función de incrustación al esquema<button data-href="#Step-2-Add-embedding-function-to-schema" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Una vez que haya definido su función de incrustación, añádala al esquema de su colección. Esto indica a Milvus que utilice la función de incrustación especificada para procesar y almacenar las incrustaciones de sus datos de texto.</p>
