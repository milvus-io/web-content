...
<h3 id="Index-building-params" class="common-anchor-header">Parámetros de creación de índices<button data-href="#Index-building-params" class="anchor-icon" translate="no">
    ...
    </button></h3><p>En la siguiente tabla se enumeran los parámetros que se pueden configurar en <code translate="no">params</code> al <a href="/docs/es/hnsw-sq.md#share-PRYPd4xBJonkoZxPpNWcdnebnNh">crear un índice</a>.</p>
<table>
   <tr>
     <th></th>
     <th><p>Parámetro</p></th>
