...
<li><p><code translate="no">max_gram</code>: El n-gram más largo que se va a generar. En el momento de la consulta, también se utiliza como tamaño máximo de ventana al dividir cadenas de consulta largas.</p></li>
</ul>
...
<li><p>Si <code translate="no">L &gt; max_gram</code>, el término de la consulta se divide en gramos superpuestos utilizando un tamaño de ventana igual a <code translate="no">max_gram</code>.</p></li>
</ul>
...
<li><p><strong>Verificar y devolver los resultados:</strong> A continuación, se aplica el filtro original « <code translate="no">LIKE</code> » o de expresiones regulares como comprobación final únicamente al pequeño conjunto de candidatos para encontrar las coincidencias exactas.</p></li>
</ol>
...
<em>(Por ejemplo, si el término de consulta más corto que se espera es de 2 caracteres, establece min_gram=2 al crear el índice).</em></p></li>
</ul>
