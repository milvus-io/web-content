...
<h2 id="How-INVERTED-indexes-work" class="common-anchor-header">Cómo funcionan los índices INVERTIDOS<button data-href="#How-INVERTED-indexes-work" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Un <strong>índice INVERTIDO</strong> en Milvus asigna cada valor de campo único (término) al conjunto de ID de documentos en los que aparece ese valor. Esta estructura permite búsquedas rápidas de campos con valores repetidos o categóricos.</p>
