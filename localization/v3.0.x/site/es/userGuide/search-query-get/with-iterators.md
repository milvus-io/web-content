...
summary: >-
  La búsqueda ANN tiene un límite máximo en el número de entidades que se pueden
  recuperar en una sola consulta, y es posible que el simple uso de la búsqueda
  ANN básica no satisfaga las necesidades de una recuperación a gran escala.
  Para las solicitudes de búsqueda ANN en las que el valor de topK supere los 16
  384, es recomendable considerar el uso del SearchIterator. En esta sección se
  explica cómo utilizar el SearchIterator y se exponen las consideraciones
  relacionadas.
---
<h1 id="Search-Iterator" class="common-anchor-header">Iterador de búsqueda<button data-href="#Search-Iterator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>La búsqueda ANN tiene un límite máximo en el número de entidades que se pueden recuperar en una sola consulta, y es posible que el simple uso de la búsqueda ANN básica no satisfaga las necesidades de una recuperación a gran escala. Para las solicitudes de búsqueda ANN en las que el valor de topK supere los 16 384, es recomendable plantearse el uso del SearchIterator. En esta sección se explica cómo utilizar el SearchIterator y se exponen las consideraciones relacionadas.</p>
<h2 id="Overview" class="common-anchor-header">Descripción general<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una solicitud de búsqueda devuelve resultados de búsqueda, mientras que un SearchIterator devuelve un iterador. Se puede llamar al método <strong>next()</strong> de este iterador para obtener los resultados de la búsqueda.</p>
<p>En concreto, se pueden utilizar los SearchIterators de la siguiente manera:</p>
<ol>
<li><p>Crea un SearchIterator y establece <strong>el número de entidades que se deben devolver por solicitud de búsqueda</strong> y <strong>el número total de entidades que se deben devolver</strong>.</p></li>
<li><p>Llama al método <strong>next()</strong> del SearchIterator en un bucle para obtener los resultados de la búsqueda de forma paginada.</p></li>
<li><p>Llama al método <strong>close()</strong> del iterador para finalizar el bucle si el método <strong>next()</strong> devuelve un resultado vacío.</p></li>
</ol>
...
<button class="copy-code-btn"></button></code></pre>
<p>En los ejemplos anteriores, has establecido el número de entidades que se deben devolver por búsqueda (<strong>batch_size/batchSize</strong>) en 50, y el número total de entidades que se deben devolver (<strong>topK</strong>) en 20 000.</p>
<h2 id="Use-SearchIterator" class="common-anchor-header">Usar SearchIterator<button data-href="#Use-SearchIterator" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Una vez que el SearchIterator esté listo, puedes llamar a su método next() para obtener los resultados de la búsqueda de forma paginada.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
...
<button class="copy-code-btn"></button></code></pre>
<p>En los ejemplos de código anteriores, has creado un bucle infinito y has llamado al método <strong>next()</strong> dentro del bucle para almacenar los resultados de la búsqueda en una variable, y has cerrado el iterador cuando <strong>next()</strong> no devuelve nada.</p>
