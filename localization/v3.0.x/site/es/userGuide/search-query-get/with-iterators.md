...
summary: >-
  ...
  ANN básica no satisfaga las exigencias de una recuperación a gran escala. Para
  las solicitudes de búsqueda ANN en las que el valor de topK supere los 16 384,
  es recomendable plantearse el uso del SearchIterator. En esta sección se
...
<h1 id="Search-Iterator" class="common-anchor-header">Iterador de búsqueda<button data-href="#Search-Iterator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>La búsqueda ANN tiene un límite máximo en el número de entidades que se pueden recuperar en una sola consulta, y es posible que el simple uso de la búsqueda ANN básica no satisfaga las exigencias de una recuperación a gran escala. Para las solicitudes de búsqueda ANN en las que el valor de topK supere los 16 384, es recomendable considerar el uso del SearchIterator. En esta sección se explica cómo utilizar el SearchIterator y se exponen las consideraciones relacionadas.</p>
<h2 id="Overview" class="common-anchor-header">Descripción general<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una solicitud de búsqueda devuelve resultados de búsqueda, mientras que un SearchIterator devuelve un iterador. Puedes llamar al método <strong>next()</strong> de este iterador para obtener los resultados de la búsqueda.</p>
