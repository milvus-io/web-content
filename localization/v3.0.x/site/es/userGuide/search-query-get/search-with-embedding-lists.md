...
<h3 id="Late-interaction" class="common-anchor-header">Interacción tardía<button data-href="#Late-interaction" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Una vez finalizada la vectorización, la lista de incrustación de la consulta se compara con cada lista de incrustación del documento, símbolo a símbolo, para determinar la puntuación final de similitud.</p>
<p>
