...
order: 3
summary: >-
  Esta guía muestra cómo obtener entidades por ID y realizar un filtrado
  escalar.
title: Obtención y consulta escalar
---
<h1 id="Get--Scalar-Query" class="common-anchor-header">Obtención y consulta escalar<button data-href="#Get--Scalar-Query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Esta guía muestra cómo obtener entidades por ID y realizar un filtrado escalar. Un filtrado escalar recupera entidades que coinciden con las condiciones de filtrado especificadas.</p>
<h2 id="Overview" class="common-anchor-header">Visión general<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una consulta escalar filtra las entidades de una colección basándose en una condición definida mediante expresiones booleanas. El resultado de la consulta es un conjunto de entidades que coinciden con la condición definida. A diferencia de una búsqueda vectorial, que identifica el vector más cercano a un vector dado en una colección, las consultas filtran entidades basándose en criterios específicos.</p>
<p>En Milvus, <strong>un filtro es siempre una cadena que compone nombres de campo unidos por operadores</strong>. En esta guía, encontrará varios ejemplos de filtros. Para conocer más detalles sobre los operadores, vaya a la sección <a href="https://milvus.io/docs/get-and-scalar-query.md#Reference-on-scalar-filters">Referencia</a>.</p>
<h2 id="Preparations" class="common-anchor-header">Preparativos<button data-href="#Preparations" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Los siguientes pasos repiten el código para conectarse a Milvus, crear rápidamente una colección e insertar más de 1.000 entidades generadas aleatoriamente en la colección.</p>
<h3 id="Step-1-Create-a-collection" class="common-anchor-header">Paso 1: Crear una colección<button data-href="#Step-1-Create-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Insert-randomly-generated-entities" class="common-anchor-header">Paso 2: Insertar entidades generadas aleatoriamente<button data-href="#Step-2-Insert-randomly-generated-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<div class="language-javascript">
<p>Utilice <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/insert.md"><code translate="no">insert()</code></a> para insertar entidades en la colección.</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Create-partitions-and-insert-more-entities" class="common-anchor-header">Paso 3: Crear particiones e insertar más entidades<button data-href="#Step-3-Create-partitions-and-insert-more-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Utiliza <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Partitions/create_partition.md"><code translate="no">create_partition()</code></a> para crear particiones y <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/insert.md"><code translate="no">insert()</code></a> para insertar más entidades en la colección.</p>
</div>
<div class="language-java">
<p>Utilice <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Partitions/createPartition.md"><code translate="no">createPartition()</code></a> para crear particiones e <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/insert.md"><code translate="no">insert()</code></a> para insertar más entidades en la colección.</p>
</div>
<div class="language-javascript">
<p>Utilice <a href="https://milvus.io/api-reference/node/v2.4.x/Partitions/createPartition.md"><code translate="no">createPartition()</code></a> para crear particiones e <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/insert.md"><code translate="no">insert()</code></a> para insertar más entidades en la colección.</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h2 id="Get-Entities-by-ID" class="common-anchor-header">Obtener entidades por ID<button data-href="#Get-Entities-by-ID" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Si conoces los IDs de las entidades que te interesan, puedes utilizar el método <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/get.md"><code translate="no">get()</code></a> método</p>
</div>
<div class="language-java">
<p>Si conoces los IDs de las entidades de tu interés, puedes usar el método <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/get.md"><code translate="no">get()</code></a> método.</p>
</div>
<div class="language-javascript">
<p>Si conoce los ID de las entidades de su interés, puede utilizar el método <a href="https://milvus.io/api-reference/node/v2.4.x/Vector/get.md"><code translate="no">get()</code></a> método.</p>
</div>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Get-entities-from-partitions" class="common-anchor-header">Obtener entidades de particiones<button data-href="#Get-entities-from-partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>También puedes obtener entidades de particiones específicas.</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<h2 id="Use-Basic-Operators" class="common-anchor-header">Utilizar operadores básicos<button data-href="#Use-Basic-Operators" class="anchor-icon" translate="no">
    ...
    </button></h2><p>En esta sección encontrarás ejemplos de cómo utilizar operadores básicos en el filtrado escalar. También puedes aplicar estos filtros a <a href="https://milvus.io/docs/single-vector-search.md#Filtered-search">búsquedas vectoriales</a> y a la <a href="https://milvus.io/docs/insert-update-delete.md#Delete-entities">eliminación de datos</a>.</p>
<div class="language-python">
<p>Para obtener más información, consulte <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/query.md"><code translate="no">query()</code></a> en la referencia del SDK.</p>
</div>
<div class="language-java">
<p>Para más información, consulte <a href="https://milvus.io/api-reference/java/v2.4.x/v2/Vector/query.md"><code translate="no">query()</code></a> en la referencia del SDK.</p>
</div>
<div class="language-javascript">
...
<li><p>Filtrar entidades con sus valores de <strong>color</strong> establecidos en <strong>marrón</strong>.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Filtrar entidades cuyos valores de <strong>color</strong> no sean <strong>verde</strong> ni <strong>morado</strong>.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;quick_setup&quot;</span>,
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Filtrar artículos cuyas etiquetas de color empiecen por <strong>rojo</strong>.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;quick_setup&quot;</span>,
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Filtrar entidades con sus colores establecidos en rojo y valores de etiqueta dentro del rango de 1.000 a 1.500.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
<pre><code translate="no" class="language-python">res = client.query(
    collection_name=<span class="hljs-string">&quot;quick_setup&quot;</span>,
...
<h2 id="Use-Advanced-Operators" class="common-anchor-header">Uso de operadores avanzados<button data-href="#Use-Advanced-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>En esta sección encontrará ejemplos de cómo utilizar operadores avanzados en el filtrado escalar. También puede aplicar estos filtros a las <a href="https://milvus.io/docs/single-vector-search.md#Filtered-search">búsquedas vectoriales</a> y a la <a href="https://milvus.io/docs/insert-update-delete.md#Delete-entities">eliminación de datos</a>.</p>
<h3 id="Count-entities" class="common-anchor-header">Contar entidades<button data-href="#Count-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><p>Cuenta el número total de entidades en una colección.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Cuenta el número total de entidades en particiones específicas.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Cuenta el número de entidades que coinciden con una condición de filtrado.</p>
<p><div class="multipleCode">
<a href="#python">Python </a><a href="#java">Java</a><a href="#javascript">Node.js</a></div></p>
...
<h2 id="Reference-on-scalar-filters" class="common-anchor-header">Referencia sobre filtros escalares<button data-href="#Reference-on-scalar-filters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><h3 id="Basic-Operators" class="common-anchor-header">Operadores básicos<button data-href="#Basic-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una <strong>expresión booleana</strong> es siempre <strong>una cadena compuesta por nombres de campo unidos por operadores</strong>. En esta sección, aprenderás más sobre los operadores básicos.</p>
<table>
<thead>
<tr><th><strong>Operador</strong></th><th><strong>Descripción</strong></th></tr>
</thead>
<tbody>
<tr><td><strong>y (&amp;&amp;)</strong></td><td>Verdadero si ambos operandos son verdaderos</td></tr>
<tr><td><strong>o (||)</strong></td><td>Verdadero si cualquiera de los operandos es verdadero</td></tr>
<tr><td><strong>+, -, *, /</strong></td><td>Suma, resta, multiplicación y división</td></tr>
<tr><td><strong>**</strong></td><td>Exponente</td></tr>
<tr><td><strong>%</strong></td><td>Módulo</td></tr>
<tr><td><strong><, ></strong></td><td>Menor que, mayor que</td></tr>
<tr><td><strong>==, !=</strong></td><td>Igual a, no igual a</td></tr>
<tr><td><strong><=, >=</strong></td><td>Menor o igual que, mayor o igual que</td></tr>
<tr><td><strong>no</strong></td><td>Invierte el resultado de una condición dada.</td></tr>
<tr><td><strong>como</strong></td><td>Compara un valor con valores similares utilizando operadores comodín.<br/> Por ejemplo, like "prefijo%" coincide con cadenas que empiecen por "prefijo".</td></tr>
<tr><td><strong>en</strong></td><td>Comprueba si una expresión coincide con cualquier valor de una lista de valores.</td></tr>
</tbody>
</table>
<h3 id="Advanced-operators" class="common-anchor-header">Operadores avanzados<button data-href="#Advanced-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Cuenta el número exacto de entidades de la colección. Utilícelo como campo de salida para obtener el número exacto de entidades de una colección o partición.</p>
<p><div class="admonition note"></p>
<p><p><b>notas</b></p></p>
<p><p>Se aplica a las colecciones cargadas. Debería utilizarlo como único campo de salida.</p></p>
<p></div></p></li>
</ul>
