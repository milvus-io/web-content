...
<h2 id="Overview" class="common-anchor-header">Descripción general<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una colección puede almacenar diversos tipos de campos escalares. Puede hacer que Milvus filtre entidades en función de uno o más campos escalares. Milvus ofrece tres tipos de consultas: «Query», «Get» y «QueryIterator». La tabla siguiente compara estos tres tipos de consultas.</p>
<table>
   <tr>
     <th></th>
     <th><p>Get</p></th>
...
<h3 id="Sort-Query-Results--Milvus-30x" class="common-anchor-header">Ordenar los resultados de la consulta<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 3.0.x</span><button data-href="#Sort-Query-Results--Milvus-30x" class="anchor-icon" translate="no">
    ...
    </button></h3><p>De forma predeterminada, Query devuelve los resultados en un orden no especificado. Utilice el parámetro <code translate="no">order_by</code> para ordenar los resultados por uno o varios campos escalares. Al utilizar <code translate="no">order_by</code>, tenga en cuenta que:</p>
<ul>
