...
<tr><td>Restringe la búsqueda vectorial a nivel de elemento a los elementos de Struct que cumplan las condiciones escalares.</td><td><code translate="no">element_filter</code>.</td><td>Busca únicamente los elementos Struct que coincidan y puede devolver las coordenadas de los elementos coincidentes.</td></tr>
