...
<tr><td>Restringe la búsqueda vectorial a nivel de elemento a los elementos Struct que cumplan las condiciones escalares.</td><td><code translate="no">element_filter</code>.</td><td>Busca únicamente los elementos Struct que coincidan y puede devolver las posiciones de los elementos coincidentes.</td></tr>
...
<li><p>Esperar que ` <code translate="no">MATCH_*</code> ` devuelva las posiciones de los elementos. Estos operadores seleccionan entidades y no identifican por sí mismos un elemento coincidente.</p></li>
