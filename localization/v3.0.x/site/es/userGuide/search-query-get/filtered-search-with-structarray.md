...
<tbody>
<tr><td>Filtrar por un campo escalar de primer nivel, como <code translate="no">category</code>.</td><td>Expresión de filtro habitual.</td><td>Selecciona las entidades padre antes o durante la búsqueda.</td></tr>
