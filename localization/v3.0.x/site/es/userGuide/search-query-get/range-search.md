...
<h1 id="Range-Search" class="common-anchor-header">Búsqueda por rango<button data-href="#Range-Search" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Una búsqueda por rango mejora la relevancia de los resultados de la búsqueda restringiendo la distancia o puntuación de las entidades devueltas dentro de un rango específico. Esta página le ayudará a entender qué es una búsqueda por rango y los procedimientos para llevarla a cabo.</p>
