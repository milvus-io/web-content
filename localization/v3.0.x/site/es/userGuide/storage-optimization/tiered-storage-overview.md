...
<ul>
<li><p><strong>Nivel de cluster</strong>: Define los valores predeterminados en <code translate="no">milvus.yaml</code> que se aplican a todas las colecciones.</p></li>
