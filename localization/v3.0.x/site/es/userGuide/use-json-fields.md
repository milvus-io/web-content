...
<h3 id="Basic-Operators-in-JSON-Fields" class="common-anchor-header">Operadores básicos en campos JSON<button data-href="#Basic-Operators-in-JSON-Fields" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>La siguiente tabla asume que el valor de un campo JSON llamado <code translate="no">json_key</code> tiene una clave llamada <code translate="no">A</code>. Utilícela como referencia cuando construya expresiones booleanas utilizando claves de campo JSON.</p>
<table>
<thead>
...
<h3 id="Advanced-Operators" class="common-anchor-header">Operadores avanzados<button data-href="#Advanced-Operators" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Los siguientes operadores son específicos de los campos JSON:</p>
<ul>
