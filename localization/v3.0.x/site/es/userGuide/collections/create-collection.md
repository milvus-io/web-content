...
<li><strong>Utilización del nodo de flujo:</strong> Si su instancia Milvus tiene múltiples nodos de flujo, se recomienda utilizar múltiples fragmentos. Esto asegura que la carga de trabajo de inserción de datos se distribuya entre todos los nodos de flujo disponibles, evitando que algunos estén inactivos mientras otros están sobrecargados.</li>
</ul>
<p>El siguiente fragmento de código muestra cómo establecer el número de shard al crear una colección.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
