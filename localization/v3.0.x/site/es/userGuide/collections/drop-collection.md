...
summary: Puede abandonar una colección si ya no la necesita.
---
...
<h2 id="Examples" class="common-anchor-header">Ejemplos<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Los siguientes fragmentos de código asumen que tienes una colección llamada <strong>mi_colección</strong>.</p>
