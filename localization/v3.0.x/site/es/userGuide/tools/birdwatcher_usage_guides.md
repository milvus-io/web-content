...
summary: Aprenda a utilizar Birdwatch para depurar Milvus.
title: Utilizar Birdwatcher
---
<h1 id="Use-Birdwatcher" class="common-anchor-header">Utilizar Birdwatcher<button data-href="#Use-Birdwatcher" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Esta guía le explica cómo utilizar Birdwatcher para comprobar el estado de su Milvus y configurarlo sobre la marcha.</p>
<h2 id="Start-Birdwatcher" class="common-anchor-header">Iniciar Birdwatcher<button data-href="#Start-Birdwatcher" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Birdwatcher es una herramienta de línea de comandos, puede iniciarla de la siguiente manera:</p>
<pre><code translate="no" class="language-shell">./birdwatcher
<button class="copy-code-btn"></button></code></pre>
<p>Entonces aparecerá el siguiente mensaje:</p>
<pre><code translate="no" class="language-shell">Offline &gt;
<button class="copy-code-btn"></button></code></pre>
<h2 id="Connect-to-etcd" class="common-anchor-header">Conectarse a etcd<button data-href="#Connect-to-etcd" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Necesita usar Birdwatcher para conectarse a etcd antes de cualquier otra operación.</p>
<ul>
<li><p>Conectar con la configuración por defecto</p>
<pre><code translate="no" class="language-shell">Offline &gt; connect
Milvus(by-dev) &gt;
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Conectar desde Birdwatcher en un pod</p>
<p>Si elige ejecutar Birdwatcher en un pod de Kubernetes, primero necesita obtener la dirección IP de etcd como se indica a continuación:</p>
<pre><code translate="no" class="language-shell">kubectl get pod my-release-etcd-0 -o &#x27;jsonpath={.status.podIP}&#x27;
<button class="copy-code-btn"></button></code></pre>
<p>A continuación, acceda al shell del pod.</p>
<pre><code translate="no" class="language-shell">kubectl exec --stdin --tty birdwatcher-7f48547ddc-zcbxj -- /bin/sh
<button class="copy-code-btn"></button></code></pre>
<p>Por último, utilice la dirección IP devuelta para conectarse a etcd de la siguiente manera:</p>
<pre><code translate="no" class="language-shell">Offline &gt; connect --etcd ${ETCD_IP_ADDR}:2379
Milvus(by-dev)
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Conectar con una ruta raíz diferente</p>
<p>Si la ruta raíz de su Milvus es diferente de <code translate="no">by-dev</code> y aparece un error informando de una ruta raíz incorrecta, puede conectarse a etcd de la siguiente manera:</p>
<pre><code translate="no" class="language-shell">Offline &gt; connect --rootPath my-release
Milvus(my-release) &gt;
<button class="copy-code-btn"></button></code></pre>
<p>Si no conoce la ruta raíz de su Milvus, conéctese a etcd de la siguiente manera:</p>
...
<h2 id="Check-Milvus-status" class="common-anchor-header">Comprobar el estado de Milvus<button data-href="#Check-Milvus-status" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Puede utilizar los comandos <code translate="no">show</code> para comprobar el estado de Milvus.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-sessions" class="common-anchor-header">Listar sesiones<button data-href="#List-sessions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para listar sesiones asociadas con diferentes componentes en Milvus:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>En la salida del comando, cada entrada de sesión listada por <code translate="no">show session</code> corresponde a un nodo o servicio que está actualmente activo y registrado en <strong>etcd</strong>.</p>
<h3 id="Check-databases-and-collections" class="common-anchor-header">Comprobar bases de datos y colecciones<button data-href="#Check-databases-and-collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Puede listar todas las bases de datos y colecciones.</p>
<ul>
<li><p>Lista de bases de datos</p>
<p>En la salida del comando, puede encontrar información sobre cada base de datos.</p>
...
================================================================================
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Ver una colección concreta</p>
<p>Puede ver una colección específica especificando su ID.</p>
...
Start position for channel by-dev-rootcoord-dml_0(by-dev-rootcoord-dml_0_443407225551410746v0): [1 0 28 175 133 76 39 6]
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Ver todas las colecciones cargadas</p>
<p>Puede hacer que Birdwatcher filtre todas las colecciones cargadas.</p>
...
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Listar todos los puntos de control de canal de una colección</p>
<p>Puede hacer que Birdwatcher liste todos los puntos de control de una colección específica.</p>
...
<h3 id="Check-index-details" class="common-anchor-header">Comprobar detalles de índice<button data-href="#Check-index-details" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Ejecute el siguiente comando para listar todos los archivos de índice en detalle.</p>
...
==================================================================
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-partitions" class="common-anchor-header">Listar particiones<button data-href="#List-partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Ejecute el siguiente comando para listar todas las particiones de una colección específica.</p>
...
--- Total Database(s): 1
<button class="copy-code-btn"></button></code></pre>
<h3 id="Check-channel-status" class="common-anchor-header">Comprobar el estado del canal<button data-href="#Check-channel-status" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Ejecute el siguiente comando para ver el estado del canal</p>
...
--- Total Channels: 1
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-all-replicas-and-segments" class="common-anchor-header">Listar todas las réplicas y segmentos<button data-href="#List-all-replicas-and-segments" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><p>Listar todas las réplicas</p>
<p>Ejecute el siguiente comando para listar todas las réplicas y sus correspondientes colecciones.</p>
...
All Nodes:[2]
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Listar todos los segmentos</p>
<p>Ejecute el siguiente comando para listar todos los segmentos y su estado</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Ejecute el siguiente comando para listar todos los segmentos cargados en detalle. Para Milvus 2.1.x, utilice <code translate="no">show segment-loaded</code> en su lugar.</p>
...
<h3 id="List-configurations" class="common-anchor-header">Listar configuraciones<button data-href="#List-configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Puede hacer que Birdwatcher liste las configuraciones actuales de cada componente Milvus.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Como alternativa, puede visitar cada componente Milvus para encontrar su configuración. A continuación se muestra cómo listar la configuración del QueryCoord con ID 7.</p>
<pre><code translate="no" class="language-shell">Milvus(by-dev) &gt; show session
Session:datacoord, ServerID: 3, Version: 2.2.11, Address: 10.244.0.8:13333
Session:datanode, ServerID: 6, Version: 2.2.11, Address: 10.244.0.8:21124
Session:indexcoord, ServerID: 4, Version: 2.2.11, Address: 10.244.0.8:31000
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Backup-metrics" class="common-anchor-header">Copia de seguridad de métricas<button data-href="#Backup-metrics" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Puede hacer que Birdwatcher haga una copia de seguridad de las métricas de todos los componentes</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>A continuación, puede comprobar el archivo en el directorio donde se inicia Birdwatcher.</p>
<h2 id="Probe-collections" class="common-anchor-header">Probar colecciones<button data-href="#Probe-collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Puede hacer que Birdwatcher sondee el estado de las colecciones cargadas con claves primarias especificadas o consultas simuladas.</p>
<h3 id="Probe-collection-with-known-primary-key" class="common-anchor-header">Sondear colecciones con clave primaria conocida<button data-href="#Probe-collection-with-known-primary-key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>En el comando <code translate="no">probe</code>, debe especificar la clave primaria utilizando la bandera <code translate="no">pk</code>, y el ID de la colección utilizando la bandera <code translate="no">collection</code>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Probe-all-collections-with-mock-queries" class="common-anchor-header">Examinar todas las colecciones con consultas simuladas<button data-href="#Probe-all-collections-with-mock-queries" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>También puede hacer que Birdwatcher sondee todas las colecciones con consultas simuladas.</p>
