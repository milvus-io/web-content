...
<h2 id="Step-2-Run-a-2PC-import" class="common-anchor-header">Paso 2: Ejecutar una importación 2PC<button data-href="#Step-2-Run-a-2PC-import" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ejecuta todas las llamadas de importación en el clúster primario. Los datos importados y la decisión de confirmación se replican automáticamente en el clúster de reserva, por lo que no es necesario que envíes ni confirmes la importación en el clúster de reserva.</p>
