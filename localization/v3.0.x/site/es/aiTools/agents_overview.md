...
summary: >-
  Reglas y patrones para agentes de codificación de IA que generan, revisan o
  depuran código de base de datos vectorial Milvus utilizando PyMilvus.
---
<h1 id="AGENTSmd--Milvus" class="common-anchor-header">AGENTES.md - Milvus<button data-href="#AGENTSmd--Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Milvus es una base de datos vectorial de código abierto para búsqueda por similitud, búsqueda híbrida y RAG. Se interactúa con ella a través de la interfaz <code translate="no">MilvusClient</code> del SDK de PyMilvus. Copie el mensaje completo que aparece a continuación en su herramienta de IA para aplicar estas reglas automáticamente. Para ver instrucciones detalladas para tareas específicas, consulte <a href="/docs/es/milvus_for_agents.md">Instrucciones de IA</a>.</p>
<h2 id="How-to-use-this-prompt" class="common-anchor-header">Cómo utilizar esta instrucción<button data-href="#How-to-use-this-prompt" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><strong>Guárdela</strong> en la ubicación prevista por su herramienta de IA (consulte la <a href="/docs/es/milvus_for_agents.md">tabla de entornos</a> para obtener información detallada sobre la ubicación).</li>
