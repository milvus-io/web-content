...
<h1 id="Search-Patterns" class="common-anchor-header">Patrones de búsqueda<button data-href="#Search-Patterns" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Reglas para implementar la búsqueda por similitud, la búsqueda híbrida, la búsqueda filtrada y la búsqueda de texto completo en Milvus, incluidas las restricciones de AnnSearchRequest y el uso del clasificador. Copie la solicitud completa que aparece a continuación en su herramienta de IA para aplicar estas reglas automáticamente. Para obtener una visión general de todas las instrucciones, consulte <a href="/docs/es/milvus_for_agents.md">Instrucciones de IA</a>.</p>
