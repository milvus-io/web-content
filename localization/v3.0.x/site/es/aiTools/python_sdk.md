---
id: python_sdk.md
title: 'Preguntar: Milvus Python SDK'
summary: >-
  Reglas para que los asistentes de codificación de IA escriban código Milvus
  Python correcto utilizando MilvusClient.
---
<h1 id="Python-SDK" class="common-anchor-header">SDK de Python<button data-href="#Python-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Reglas para escribir código Milvus Python correcto usando la interfaz MilvusClient, incluyendo migración ORM, patrones de conexión y operaciones comunes. Copie el mensaje completo a continuación en su herramienta AI para aplicar estas reglas automáticamente. Para una visión general de todas las instrucciones, vea <a href="/docs/es/milvus_for_agents.md">Instrucciones AI</a>.</p>
<h2 id="How-to-use-this-prompt" class="common-anchor-header">Cómo utilizar este aviso<button data-href="#How-to-use-this-prompt" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
