...
<p>Para usuarios <strong>de Cursor</strong>: copia la indicación de la sección <a href="#full-prompt">«Indicación completa»</a> y guárdala en « <code translate="no">.cursor/rules/</code> » dentro de tu proyecto.</p>
