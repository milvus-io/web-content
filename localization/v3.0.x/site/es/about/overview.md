...
<p>Milvus es, en sí mismo, un sistema totalmente sin estado, por lo que puede escalarse fácilmente con la ayuda de Kubernetes o de nubes públicas. Además, los componentes de Milvus están bien desacoplados, y las tres tareas más críticas —búsqueda, inserción de datos e indexación/compactación— se han diseñado como procesos fácilmente paralelizables, con la lógica compleja separada. Esto garantiza que los correspondientes nodos de consulta, de datos y de índice puedan escalar tanto vertical como horizontalmente de forma independiente, optimizando el rendimiento y la rentabilidad.</p>
...
<li><a href="/docs/es/weighted-ranker.md">Reordenación</a>: Ajusta el orden de los resultados de búsqueda basándose en criterios adicionales o en un algoritmo secundario, refinando los resultados iniciales de la búsqueda ANN.</li>
...
Prometheus es un conjunto de herramientas de código abierto para la monitorización y las alertas de sistemas en Kubernetes. Grafana es una pila de visualización de código abierto que puede conectarse con todas las fuentes de datos. Puedes utilizar Prometheus y Grafana como proveedores de servicios de monitorización para supervisar visualmente el rendimiento de Milvus distribuido. Para más detalles, consulta <a href="/docs/es/monitor.md">«Implementación de servicios de monitorización</a>».</p></li>
<li><p>Milvus Backup
Milvus Backup es una herramienta que permite a los usuarios realizar copias de seguridad y restaurar datos de Milvus. Proporciona tanto una interfaz de línea de comandos (CLI) como una API para adaptarse a diferentes escenarios de aplicación. Para obtener más información, consulte <a href="/docs/es/milvus_backup_overview.md">«Milvus Backup</a>».</p></li>
<li><p>Milvus Capture Data Change (CDC)
Milvus-CDC puede capturar y sincronizar datos incrementales en instancias de Milvus y garantiza la fiabilidad de los datos empresariales mediante su transferencia fluida entre instancias de origen y destino, lo que facilita la realización de copias de seguridad incrementales y la recuperación ante desastres. Para más detalles, consulta <a href="/docs/es/milvus-cdc-overview.md">«Milvus CDC</a>».</p></li>
<li><p>Conectores de Milvus
Milvus ha diseñado un conjunto de conectores para que puedas integrar Milvus a la perfección con herramientas de terceros, como Apache Spark. Actualmente, puedes utilizar nuestro conector Spark para enviar tus datos de Milvus a Apache Spark con el fin de procesarlos mediante aprendizaje automático. Para más detalles, consulta <a href="/docs/es/integrate_with_spark.md">el conector Spark-Milvus</a>.</p></li>
