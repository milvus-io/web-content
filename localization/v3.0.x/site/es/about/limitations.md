...
<h2 id="Load-limits" class="common-anchor-header">Límites de carga<button data-href="#Load-limits" class="anchor-icon" translate="no">
    ...
    </button></h2><p>En la versión actual, los datos que se vayan a cargar deben ser inferiores al 90 % de los recursos de memoria totales de todos los nodos de consulta, a fin de reservar recursos de memoria para el motor de ejecución.</p>
...
<table>
<thead>
<tr><th></th><th>HNSW</th><th>DISKANN</th><th>FLAT</th><th>IVF_FLAT</th><th>IVF_SQ8</th><th>IVF_PQ</th><th>SCANN</th><th>GPU_IFV_FLAT</th><th>GPU_IVF_PQ</th><th>GPU_CAGRA</th><th>GPU_FUERZA BRUTA</th><th>ÍNDICE_INVERTIDO_DISPARSE</th><th>BIN_FLAT</th><th>BIN_IVF_PLANO</th></tr>
</thead>
<tbody>
