---
id: limitations.md
title: Limitaciones de Milvus
related_key: Limitations
summary: Infórmate sobre las limitaciones a la hora de utilizar Milvus.
---
<h1 id="Milvus-Limits" class="common-anchor-header">Limitaciones de Milvus<button data-href="#Milvus-Limits" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Milvus se compromete a proporcionar las mejores bases de datos vectoriales para potenciar las aplicaciones de IA y la búsqueda de similitudes vectoriales. No obstante, el equipo trabaja continuamente para incorporar más funciones y las mejores herramientas con el fin de mejorar la experiencia del usuario. En esta página se enumeran algunas limitaciones conocidas con las que los usuarios pueden encontrarse al utilizar Milvus.</p>
...
<tbody>
<tr><td>Base de datos</td><td>255 caracteres</td></tr>
...
<h2 id="Naming-rules" class="common-anchor-header">Reglas de nomenclatura<button data-href="#Naming-rules" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>El nombre de un recurso, como el nombre de una colección, el nombre de una partición o el nombre de un índice, puede contener números, letras y guiones bajos (_). El nombre de un recurso debe comenzar con una letra o un guión bajo (_).</p>
...
<tr><td>Entidad</td><td>ilimitado</td></tr>
</tbody>
</table>
...
<tbody>
<tr><td>Inserción</td><td>64 MB</td></tr>
<tr><td>Búsqueda</td><td>64 MB</td></tr>
...
<h2 id="Load-limits" class="common-anchor-header">Límites de carga<button data-href="#Load-limits" class="anchor-icon" translate="no">
    ...
    </button></h2><p>En la versión actual, los datos que se vayan a cargar deben ser inferiores al 90 % de los recursos de memoria totales de todos los nodos de consulta, con el fin de reservar recursos de memoria para el motor de ejecución.</p>
...
<tbody>
<tr><td><code translate="no">topk</code> (número de resultados más similares que se van a devolver)</td><td>16 384</td></tr>
<tr><td><code translate="no">nq</code> (número de consultas de búsqueda)</td><td>16 384</td></tr>
</tbody>
</table>
<h2 id="Index-limits-on-different-search-types" class="common-anchor-header">Límites de los índices en los distintos tipos de búsqueda<button data-href="#Index-limits-on-different-search-types" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>La siguiente tabla ofrece una visión general de la compatibilidad con diversos comportamientos de búsqueda en los distintos tipos de índices.</p>
<table>
<thead>
<tr><th></th><th>HNSW</th><th>DISKANN</th><th>FLAT</th><th>IVF_FLAT</th><th>IVF_SQ8</th><th>IVF_PQ</th><th>SCANN</th><th>GPU_IFV_FLAT</th><th>GPU_IVF_PQ</th><th>GPU_CAGRA</th><th>GPU_FUERZA BRUTA</th><th>ÍNDICE_INVERTIDO_DISPARSE</th><th>BIN_FLAT</th><th>BIN_IVF_FLAT</th></tr>
</thead>
<tbody>
...
<tr><td>Búsqueda básica con datos sin procesar recuperados</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td></tr>
...
<tr><td>Búsqueda por rango</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>No</td><td>No</td><td>No</td><td>No</td><td>Sí</td><td>Sí</td><td>Sí</td></tr>
...
<tr><td>Búsqueda híbrida</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí</td><td>Sí (solo RRFRanker)</td><td>Sí</td><td>Sí</td></tr>
