...
<p>Esta página está obsoleta. Para ver el último ejemplo del uso de CoPali con Milvus, consulte <a href="/docs/es/search-with-embedding-lists.md">Sesarch with Embedding Lists</a>.</p>
</div>
<p>
