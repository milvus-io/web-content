...
<p>Este tutorial muestra el RAG multimodal impulsado por Milvus, <a href="https://github.com/FlagOpen/FlagEmbedding/tree/master/FlagEmbedding/visual">el modelo BGE visualizado</a> y <a href="https://openai.com/index/hello-gpt-4o/">GPT-4o</a>. Con este sistema, los usuarios pueden subir una imagen y editar instrucciones de texto, que son procesadas por el modelo de recuperación compuesta de BGE para buscar imágenes candidatas. A continuación, GPT-4o actúa como un sistema de reclasificación, seleccionando la imagen más adecuada y proporcionando la justificación de dicha elección. Esta potente combinación permite una experiencia de búsqueda de imágenes fluida e intuitiva, aprovechando Milvus para una recuperación eficiente, el modelo de BGE para un procesamiento y emparejamiento precisos de imágenes, y GPT-4o para una reclasificación avanzada.</p>
...
<p>Si utilizas Google Colab, para que las dependencias recién instaladas estén disponibles, es posible que tengas que <strong>reiniciar el entorno de ejecución</strong> (haz clic en el menú «Runtime» en la parte superior de la pantalla y selecciona «Restart session» en el menú desplegable).</p>
</div>
...
<h3 id="Load-Embedding-Model" class="common-anchor-header">Cargar el modelo de incrustación<button data-href="#Load-Embedding-Model" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Utilizaremos el modelo BGE visualizado «bge-visualized-base-en-v1.5» para generar representaciones tanto de imágenes como de texto.</p>
...
<h2 id="Multimodal-Search-with-Generative-Reranker" class="common-anchor-header">Búsqueda multimodal con reordenador generativo<button data-href="#Multimodal-Search-with-Generative-Reranker" class="anchor-icon" translate="no">
    ...
    </button></h2><p>En esta sección, primero buscaremos imágenes relevantes mediante una consulta multimodal y, a continuación, utilizaremos el servicio LLM para reordenar los resultados y encontrar el mejor, con una explicación.</p>
...
<h3 id="Rerank-with-GPT-4o" class="common-anchor-header">Reordenar con GPT-4o<button data-href="#Rerank-with-GPT-4o" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Enviaremos la imagen combinada al servicio LLM multimodal junto con las indicaciones adecuadas para clasificar los resultados obtenidos con una explicación. Para habilitar GPT-4o como LLM, debes preparar tu <a href="https://platform.openai.com/docs/quickstart">clave de API de OpenAI</a>.</p>
