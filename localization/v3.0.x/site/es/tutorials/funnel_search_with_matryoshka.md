...
<button class="copy-code-btn"></button></code></pre>
<p>Ahora, para realizar la búsqueda en embudo, iteramos sobre subconjuntos cada vez mayores de las incrustaciones. En cada iteración, volvemos a clasificar los candidatos en función de las nuevas similitudes y eliminamos una fracción de los peor clasificados.</p>
