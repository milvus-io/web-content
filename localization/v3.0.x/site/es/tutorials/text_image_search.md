...
<h3 id="Install-dependencies" class="common-anchor-header">Instale las dependencias<button data-href="#Install-dependencies" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Download-example-data" class="common-anchor-header">Descargar datos de ejemplo<button data-href="#Download-example-data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Utilizaremos un subconjunto del conjunto de datos <a href="https://www.image-net.org">ImageNet</a> (100 clases, 10 imágenes para cada clase) como imágenes de ejemplo. El siguiente comando descargará los datos de ejemplo y los extraerá a la carpeta local <code translate="no">./images_folder</code>:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Set-up-Milvus" class="common-anchor-header">Configurar Milvus<button data-href="#Set-up-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Antes de continuar, configure su servidor Milvus y conéctese utilizando su URI (y opcionalmente, un token):</p>
<ul>
...
<h3 id="Define-feature-extractors" class="common-anchor-header">Definir extractores de características<button data-href="#Define-feature-extractors" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Utilizaremos un modelo CLIP preentrenado para generar incrustaciones de imagen y texto. En esta sección, cargaremos la variante <strong>ViT-B/32</strong> preentrenada de CLIP y definiremos funciones de ayuda para la codificación de imágenes y texto:</p>
<ul>
<li><code translate="no">encode_image(image_path)</code>: Procesa y codifica imágenes en vectores de características.</li>
<li><code translate="no">encode_text(text)</code>: Codifica las consultas de texto en vectores de características</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Data-Ingestion" class="common-anchor-header">Ingestión de datos<button data-href="#Data-Ingestion" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Peform-a-Search" class="common-anchor-header">Realizar una búsqueda<button data-href="#Peform-a-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Ahora vamos a realizar una búsqueda utilizando una consulta de texto de ejemplo. Esto recuperará las imágenes más relevantes basándose en su similitud semántica con la descripción de texto dada.</p>
