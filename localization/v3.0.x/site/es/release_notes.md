...
<h3 id="Features-improvements" class="common-anchor-header">Mejoras en las funciones<button data-href="#Features-improvements" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Se ha añadido una opción activable para que las tareas de actualización de colecciones externas esperen hasta que todos los segmentos estén indexados antes de notificar la finalización, sin retrasar la publicación de datos (<a href="https://github.com/milvus-io/milvus/pull/52712">#52712</a>)</li>
...
<li>Se ha añadido la reordenación ponderada de RRF con pesos opcionales por solicitud ANN en FunctionScore, REST, la búsqueda híbrida heredada y el cliente Go (<a href="https://github.com/milvus-io/milvus/pull/52891">#52891</a>, <a href="https://github.com/milvus-io/milvus/pull/52926">#52926</a>)</li>
</ul>
...
<li>Se ha mejorado la eficiencia de la sonda de hash de agrupación mediante un canal entrelazado de cuatro vías y medidas de protección contra colisiones y límites de rehashing (<a href="https://github.com/milvus-io/milvus/pull/51977">#51977</a>)</li>
...
<li>Se han reducido las cargas útiles de los informes de distribución de QueryNode mediante la generación incremental de informes con un informe completo como alternativa, y se han reducido las asignaciones de memoria durante la recopilación de métricas (n.<a href="https://github.com/milvus-io/milvus/pull/52111">º 52111</a>, n. <a href="https://github.com/milvus-io/milvus/pull/52119">º 52119</a>).</li>
...
<li>Se ha mejorado la agrupación de fusiones forzadas mediante una planificación en varias rondas basada en el tamaño y se ha dejado de utilizar la configuración heredada del umbral de planificación (<a href="https://github.com/milvus-io/milvus/pull/52242">#52242</a>)</li>
...
<li>Se ha mejorado el control de reintentos de importación con un tiempo de espera configurable para los reintentos de escritura (<a href="https://github.com/milvus-io/milvus/pull/52414">#52414</a>, <a href="https://github.com/milvus-io/milvus/pull/52415">#52415</a>, <a href="https://github.com/milvus-io/milvus/pull/52427">#52427</a>)</li>
<li>Se ha mejorado la gestión del ciclo de vida de las tareas de análisis mediante la recuperación de versiones obsoletas de estadísticas y la persistencia de los estados finales (<a href="https://github.com/milvus-io/milvus/pull/52416">#52416</a>, <a href="https://github.com/milvus-io/milvus/pull/52417">#52417</a>).</li>
<li>Se ha mejorado la coordinación del ciclo de vida de los segmentos esperando a que se liberen tras los tiempos de espera de bloqueo (<a href="https://github.com/milvus-io/milvus/pull/52422">#52422</a>)</li>
...
<li>Se ha mejorado la asignación de identificadores de vectores nulos trasladándola a la capa de índices, unificando la gestión de identificadores lógicos y admitiendo asignaciones respaldadas por mmap para índices sellados (<a href="https://github.com/milvus-io/milvus/pull/52657">#52657</a>)</li>
...
<li>Se han mejorado los índices escalares híbridos en subcampos de estructuras anidadas mediante el uso de STL_SORT cuando el número de elementos distintos alcanza el límite de cardinalidad del mapa de bits (<a href="https://github.com/milvus-io/milvus/pull/52849">#52849</a>)</li>
...
<li>Se ha añadido el parámetro «growingBuildThreadRate», que se puede actualizar, para configurar el número de subprocesos por segmento de crecimiento durante la compilación del índice provisional, conservando al mismo tiempo el valor por defecto de un solo subproceso (<a href="https://github.com/milvus-io/milvus/pull/53033">#53033</a>)</li>
...
<li>Se han corregido resultados incorrectos y una validación inconsistente de predicados en consultas JSON, ARRAY y TIMESTAMPTZ, incluidos predicados de tipos mixtos, comparaciones de números grandes y filtrado entre varios lotes (<a href="https://github.com/milvus-io/milvus/pull/51775">#51775</a>)</li>
<li>Se ha corregido la inconsistencia en la actualización de datos durante las actualizaciones paralelas de colecciones externas cuando los archivos de origen de un segmento abarcaban varias tareas (n.<a href="https://github.com/milvus-io/milvus/pull/51893">º 51893</a>)</li>
<li>Se ha corregido que las expresiones MATCH aceptaran predicados que no operaban a nivel de elemento (<a href="https://github.com/milvus-io/milvus/pull/51940">#51940</a>)</li>
...
<li>Se ha corregido el hecho de que las respuestas HTTP JSON omitieran el estado explícito «ok=false» para los segmentos de relleno fallidos (<a href="https://github.com/milvus-io/milvus/pull/52082">#52082</a>)</li>
<li>Se ha corregido el error por el que las subidas de objetos a MinIO fallaban con el código HTTP 400 «XAmzContentChecksumMismatch» al reintentarlas tras tiempos de espera por transporte o por baja velocidad (<a href="https://github.com/milvus-io/milvus/pull/52128">#52128</a>, <a href="https://github.com/milvus-io/milvus/pull/52194">#52194</a>)</li>
...
<li>Se ha corregido el uso de valores predeterminados de geometría incorrectos durante la compactación y la reconstrucción de registros, así como las marcas nulas incorrectas para los valores de geometría rellenados por defecto en las importaciones de Parquet (<a href="https://github.com/milvus-io/milvus/pull/52350">#52350</a>)</li>
...
<li>Se ha corregido el fallo en la actualización de las columnas externas al volver a abrir un manifiesto actualizado (<a href="https://github.com/milvus-io/milvus/pull/52397">#52397</a>)</li>
<li>Se ha corregido el tratamiento incorrecto de las zonas horarias en búsquedas con condiciones dependientes del tiempo (<a href="https://github.com/milvus-io/milvus/pull/52407">#52407</a>)</li>
...
<li>Se ha corregido un error por el que las inserciones no rechazaban las filas que superaban el límite de tamaño admitido (<a href="https://github.com/milvus-io/milvus/pull/52426">#52426</a>)</li>
...
<li>Se ha corregido un error por el que las consultas que utilizaban «order_by» no devolvían campos de salida de vector denso (<a href="https://github.com/milvus-io/milvus/pull/52504">#52504</a>, <a href="https://github.com/milvus-io/milvus/pull/52606">#52606</a>)</li>
...
<li>Se ha corregido el recuento incorrecto de archivos binlog y las etiquetas de formato de almacenamiento para los segmentos de Storage V3 tras los reinicios de DataCoord (<a href="https://github.com/milvus-io/milvus/pull/52571">#52571</a>, <a href="https://github.com/milvus-io/milvus/pull/52578">#52578</a>)</li>
<li>Se ha corregido el bloqueo de las restauraciones de instantáneas externas debido a comprobaciones poco fiables de la versión de los trabajadores o a reintentos repetidos con trabajadores no compatibles hasta que se agotaba el tiempo de espera (<a href="https://github.com/milvus-io/milvus/pull/52639">#52639</a>)</li>
<li>Se han corregido los errores de carga de segmentos para índices HYBRID en subcampos de matrices de estructuras con archivos STLSORT heredados de la versión 3.0.0, sin necesidad de reindexar (<a href="https://github.com/milvus-io/milvus/pull/52643">#52643</a>)</li>
...
<li>Se ha corregido el tratamiento incorrecto de los errores al cargar o reabrir segmentos de Storage V3 tras errores en el manifiesto, conservando el estado actual del segmento para reintentos seguros (<a href="https://github.com/milvus-io/milvus/pull/52678">#52678</a>)</li>
...
<li>Se han corregido los bloqueos de los nodos de streaming causados por fallos repetidos de vaciado tras añadir un campo TEXT a colecciones con segmentos existentes de Storage V2 (n.<a href="https://github.com/milvus-io/milvus/pull/52897">º 52897</a>).</li>
<li>Se ha corregido el error por el que las filas caducadas en segmentos de Storage V3 no activaban la compactación basada en el campo TTL y permanecían almacenadas hasta que se cumplía otra condición de compactación (<a href="https://github.com/milvus-io/milvus/pull/52931">#52931</a>)</li>
<li>Se ha corregido la inconsistencia en las claves primarias generadas automáticamente entre las colecciones de origen y destino durante las importaciones replicadas mediante CDC (<a href="https://github.com/milvus-io/milvus/pull/52941">#52941</a>)</li>
...
<li>Se ha corregido el tratamiento de los elementos nulos en filas de vectores densos externos, aceptando filas nulas en las que todos los valores son nulos y añadiendo un tratamiento configurable para las filas parcialmente nulas (<a href="https://github.com/milvus-io/milvus/pull/52968">#52968</a>)</li>
<li>Se ha corregido el recuento incorrecto de filas en segmentos V3 y los fallos repetidos de compactación por ordenación tras la conmutación por error de un nodo de streaming (<a href="https://github.com/milvus-io/milvus/pull/52970">#52970</a>)</li>
...
<li>Se ha corregido un error en las búsquedas por clave primaria que no conservaban el orden de ID solicitado (<a href="https://github.com/milvus-io/milvus/pull/52999">#52999</a>)</li>
...
<h3 id="Whats-new-in-300-since-30-beta" class="common-anchor-header">Novedades de la versión 3.0.0 (desde la 3.0-beta)<button data-href="#Whats-new-in-300-since-30-beta" class="anchor-icon" translate="no">
    ...
    </button></h3><h4 id="External-Collection-more-complete-lakehouse-workflows" class="common-anchor-header">Colección externa: flujos de trabajo de «lakehouse» más completos</h4><p>La versión 3.0-beta introdujo la «Colección externa»: permite hacer referencia a archivos de «lake» en su ubicación original, crear índices y realizar búsquedas en ellos sin necesidad de copiar los datos a Milvus. Esta versión amplía esta funcionalidad para ofrecer flujos de trabajo completos de recuperación en un «lakehouse». Los campos externos ahora pueden alimentar campos de salida de funciones, como vectores dispersos BM25, firmas MinHash e incrustaciones de texto, de modo que los campos de recuperación de texto y derivados de modelos se crean dentro de Milvus sin copiar la tabla de origen. Refresh también admite la evolución aditiva del esquema: cuando la tabla externa incorpora nuevas columnas, Milvus actualiza los segmentos afectados en lugar de reconstruir la colección.</p>
...
<h4 id="Woodpecker-standalone-deployment" class="common-anchor-header">Implementación independiente de Woodpecker</h4><p>Woodpecker, el WAL que constituye el núcleo de la ruta de escritura en streaming, ahora puede implementarse como un servicio independiente en lugar de estar integrado en otros nodos —escalabilidad independiente, aislamiento de fallos y observabilidad, como cualquier otro microservicio—. Esto es especialmente importante para clústeres grandes y cargas de trabajo con un alto volumen de escritura.</p>
...
<li><strong>Almacenamiento V3 (Loon)</strong>: almacenamiento columnar basado en manifiestos en almacenamiento de objetos; la base para Instantánea y Colección externa.</li>
...
<li><strong>EmbList + DiskANN</strong>: indexación multivectorial en disco para listas de incrustación de StructArray, con vías de aceleración como Muvera y Lemur.</li>
<li><strong>Función MinHash (doc-in, doc-out)</strong>: firmas MinHash del lado del servidor más « <code translate="no">MINHASH_LSH</code> » para la detección de casi duplicados.</li>
...
<li><strong>TTL de entidad</strong> — caducidad por fila determinada por un campo TIMESTAMPTZ.</li>
...
<li><strong>Se garantiza la compatibilidad y la reversión de la versión 2.6 a la 3.0</strong>: una implementación de la versión 3.0 se puede revertir a la 2.6. Sin embargo, una vez que se habiliten o utilicen funciones que modifiquen el formato de datos serializados (por ejemplo, Storage V3), la reversión ya no será posible.</li>
<li><strong>Las nuevas versiones de índice son opcionales por el momento.</strong> Los algoritmos de índice recién introducidos requieren aumentar manualmente la versión de índice de destino (<code translate="no">dataCoord.targetVecIndexVersion</code> a 10, <code translate="no">dataCoord.targetScalarIndexVersion</code> a 4) antes de que surtan efecto; en una versión posterior se activarán de forma predeterminada.</li>
...
<h4 id="Snapshot" class="common-anchor-header">Instantánea</h4><p>La entrega de datos y el descubrimiento por lotes suelen necesitar la misma colección al mismo tiempo. La evaluación de modelos A/B, la deduplicación a gran escala, la validación de datos retrospectivos y la reversión de versiones requieren una visión estable de la colección mientras siguen produciéndose escrituras.</p>
...
<p>Milvus 3.0 incorpora un mecanismo FileResource para registrar diccionarios personalizados de tokenizadores, listas de sinónimos, listas de palabras vacías y reglas de descomposición de compuestos. Una vez registrado, se puede hacer referencia a un recurso desde cualquier tokenizador o filtro, y surtirá efecto en BM25, los analizadores y Text Match. Ahora es posible gestionar los diccionarios y sinónimos de forma centralizada y con control de versiones, en lugar de tenerlos dispersos por el código de la aplicación.</p>
<p>Para obtener más información, consulta <a href="/docs/es/manage-file-resources.md">«Gestionar recursos de archivo</a>».</p>
<h4 id="Entity-TTL" class="common-anchor-header">TTL de entidades</h4><p>El TTL a nivel de colección y de partición resulta demasiado impreciso para muchos escenarios de ciclo de vida y cumplimiento normativo. Los distintos inquilinos dentro de una misma colección suelen tener reglas de retención diferentes, y es posible que algunas entidades deban caducar según un calendario que no coincida con el del resto de la colección.</p>
...
<h4 id="Storage-V3" class="common-anchor-header">Almacenamiento V3</h4><p>Milvus 3.0 presenta Almacenamiento V3, un motor de almacenamiento columnar basado en manifiestos en el que los datos y los metadatos residen en un almacenamiento de objetos compatible con S3. Cada versión del conjunto de datos se captura como una instantánea de manifiesto inmutable, un archivo codificado en Avro que registra qué grupos de columnas, registros delta y estadísticas componen el conjunto de datos.</p>
