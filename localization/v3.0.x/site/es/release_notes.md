...
<p>Si eres nuevo en la línea 3.0, la sección «Resumen de las características de Core 3.0» que aparece a continuación resume las capacidades introducidas en la versión 3.0-beta; las <a href="https://milvus.io/docs/release_notes.md#v30-beta">notas de la versión 3.0-beta</a> contienen la información completa.</p>
...
<p>Para obtener más información, consulta <a href="https://milvus.io/docs/v3.0.x/create-an-external-collection.md">«Crear una colección externa</a> y <a href="https://milvus.io/docs/v3.0.x/snapshots.md">instantáneas</a>».</p>
...
<p>Para obtener más información, consulta <a href="https://milvus.io/docs/v3.0.x/add-fields-to-an-existing-collection.md">«Añadir campos a una colección existente</a>».</p>
...
<p>Para obtener más información, consulta <a href="https://milvus.io/docs/v3.0.x/array-of-structs.md">«StructArray</a> » y <a href="https://milvus.io/docs/v3.0.x/struct-array-operators.md">«Operadores</a> de <a href="https://milvus.io/docs/v3.0.x/struct-array-operators.md">StructArray</a>».</p>
...
<h3 id="Function-Chain-reranking" class="common-anchor-header">Reordenación mediante la cadena de funciones<button data-href="#Function-Chain-reranking" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Core-30-features-recall" class="common-anchor-header">Resumen de las características principales de la versión 3.0<button data-href="#Core-30-features-recall" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Las características que se indican a continuación se introdujeron en <a href="https://milvus.io/docs/release_notes.md#v30-beta">la versión 3.0-beta</a> y forman parte de la 3.0.0; consulta las notas de la beta para obtener la información completa.</p>
<ul>
