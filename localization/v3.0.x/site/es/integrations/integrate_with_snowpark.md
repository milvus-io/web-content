...
<h3 id="1-Obtain-account-information" class="common-anchor-header">1. Obtener la información de la cuenta<button data-href="#1-Obtain-account-information" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Descargue el cliente SPCS <a href="https://docs.snowflake.com/en/user-guide/snowsql-install-config">SnowSQL</a>, y a continuación inicie sesión en su cuenta.</p>
...
<h3 id="2-Configure-Role-and-privileges" class="common-anchor-header">2. Configurar rol y privilegios<button data-href="#2-Configure-Role-and-privileges" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Configure la integración OAUTH.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="3-Create-data-storage-configuration" class="common-anchor-header">3. Crear configuración de almacenamiento de datos<button data-href="#3-Create-data-storage-configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="4-Create-images" class="common-anchor-header">4. Crear imágenes<button data-href="#4-Create-images" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>La imagen utilizada por Milvus necesita ser construida localmente y luego cargada por el usuario. Para la configuración pertinente de la imagen, consulte <a href="https://github.com/dald001/milvus_on_spcs">este repositorio</a>. Después de clonar el código, vaya al directorio raíz del proyecto y prepárese para construir la imagen.</p>
<ul>
...
<h3 id="5-Create-and-start-services" class="common-anchor-header">5. Crear e iniciar servicios<button data-href="#5-Create-and-start-services" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Volvamos al shell SnowSQL.</p>
<ul>
