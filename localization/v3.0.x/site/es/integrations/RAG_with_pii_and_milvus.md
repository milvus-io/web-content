...
<h1 id="Build-RAG-with-Milvus-+-PII-Masker" class="common-anchor-header">Construir RAG con Milvus + PII Masker<button data-href="#Build-RAG-with-Milvus-+-PII-Masker" class="anchor-icon" translate="no">
    ...
    </button></h1><p>PII (Personally Identifiable Information) es un tipo de datos sensibles que pueden ser utilizados para identificar individuos.</p>
...
<h2 id="Preparation" class="common-anchor-header">Preparación<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Get-started-with-PII-Masker" class="common-anchor-header">Introducción a PII Masker<button data-href="#Get-started-with-PII-Masker" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Siga la <a href="https://github.com/HydroXai/pii-masker-v1/tree/main?tab=readme-ov-file#-installation">guía de instalación</a> de PII Masker para instalar las dependencias necesarias y descargar el modelo. He aquí una guía sencilla:</p>
...
<h3 id="Prepare-the-data" class="common-anchor-header">Preparar los datos<button data-href="#Prepare-the-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Vamos a generar algunas líneas falsas que contengan información PII con fines de prueba o demostración.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Mask-the-data-with-PIIMasker" class="common-anchor-header">Enmascarar los datos con PIIMasker<button data-href="#Mask-the-data-with-PIIMasker" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Inicializamos el objeto PIIMasker y cargamos el modelo.</p>
...
<h3 id="Prepare-the-Embedding-Model" class="common-anchor-header">Preparar el modelo de incrustación<button data-href="#Prepare-the-Embedding-Model" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Insert-data" class="common-anchor-header">Insertar datos<button data-href="#Insert-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Itere a través de las líneas de texto enmascaradas, cree incrustaciones y luego inserte los datos en Milvus.</p>
...
<h2 id="Build-RAG" class="common-anchor-header">Construir RAG<button data-href="#Build-RAG" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Especifiquemos una pregunta sobre los documentos.</p>
...
<p>Aquí podemos ver, como hemos reemplazado el PII con máscaras, el LLM no puede obtener la información PII en contexto. Así que responde: "No lo sé". De esta manera, podemos proteger eficazmente la privacidad de los usuarios.</p>
