...
<h2 id="Preparation" class="common-anchor-header">Preparación<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Dependency-and-Environment" class="common-anchor-header">Dependencia y entorno<button data-href="#Dependency-and-Environment" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Workflow" class="common-anchor-header">Flujo de trabajo<button data-href="#Workflow" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Defining-the-Data-Source-Amazon-S3" class="common-anchor-header">Definición de la fuente de datos (Amazon S3)<button data-href="#Defining-the-Data-Source-Amazon-S3" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>En este caso, estamos extrayendo documentos de un bucket de Amazon S3. VectorETL nos permite especificar el nombre del bucket, la ruta a los archivos y el tipo de datos con los que estamos trabajando.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Configuring-the-Embedding-Model-OpenAI" class="common-anchor-header">Configuración del modelo de incrustación (OpenAI)<button data-href="#Configuring-the-Embedding-Model-OpenAI" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Una vez que tenemos nuestra fuente de datos configurada, necesitamos definir el modelo de incrustación que transformará nuestros datos textuales en incrustaciones vectoriales. En este ejemplo, utilizaremos <code translate="no">text-embedding-ada-002</code> de OpenAI.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Setting-Up-Milvus-as-the-Target-Database" class="common-anchor-header">Configuración de Milvus como base de datos de destino<button data-href="#Setting-Up-Milvus-as-the-Target-Database" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Necesitamos almacenar las incrustaciones generadas en Milvus. Aquí, definimos nuestros parámetros de conexión Milvus utilizando Milvus Lite.</p>
...
<h3 id="Specifying-Columns-for-Embedding" class="common-anchor-header">Especificación de columnas para incrustación<button data-href="#Specifying-Columns-for-Embedding" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Ahora tenemos que especificar qué columnas de nuestros archivos CSV deben convertirse en incrustaciones. Esto asegura que sólo se procesen los campos de texto relevantes, optimizando tanto la eficiencia como el almacenamiento.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Creating-and-Executing-the-VectorETL-Pipeline" class="common-anchor-header">Creación y ejecución de la canalización VectorETL<button data-href="#Creating-and-Executing-the-VectorETL-Pipeline" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Con todas las configuraciones en su lugar, ahora inicializamos el ETL pipeline, establecemos el flujo de datos y lo ejecutamos.</p>
