...
<h3 id="Use-as-a-regular-node-to-insert-and-retrieve-documents" class="common-anchor-header">Uso como nodo normal para insertar y recuperar documentos<button data-href="#Use-as-a-regular-node-to-insert-and-retrieve-documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Puede utilizar Milvus Vector Store como un nodo normal para insertar u obtener documentos. Este patrón coloca el Milvus Vector Store en el flujo de conexión regular sin utilizar un agente.</p>
...
<h3 id="Connect-directly-to-an-AI-agent-as-a-tool" class="common-anchor-header">Conectarse directamente a un agente de IA como herramienta<button data-href="#Connect-directly-to-an-AI-agent-as-a-tool" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Puede conectar el nodo Milvus Vector Store directamente al conector de herramientas de un <a href="https://docs.n8n.io/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent/">agente de IA</a> para utilizar un almacén de vectores como recurso al responder consultas.</p>
...
<h3 id="Use-a-retriever-to-fetch-documents" class="common-anchor-header">Utilizar un recuperador para obtener documentos<button data-href="#Use-a-retriever-to-fetch-documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Use-the-Vector-Store-Question-Answer-Tool-to-answer-questions" class="common-anchor-header">Utilice la herramienta de respuesta a preguntas de Vector Store para responder preguntas<button data-href="#Use-the-Vector-Store-Question-Answer-Tool-to-answer-questions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<hr>
<h3 id="Operation-Modes-Overview" class="common-anchor-header">Descripción general de los modos de funcionamiento<button data-href="#Operation-Modes-Overview" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>El nodo Milvus Vector Store admite cuatro modos distintos:</p>
<ul>
...
<h3 id="Additional-Node-Options" class="common-anchor-header">Opciones adicionales del nodo<button data-href="#Additional-Node-Options" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
