...
<h3 id="Multiple-Metdata-Filters" class="common-anchor-header">Múltiples filtros de metadatos<button data-href="#Multiple-Metdata-Filters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
