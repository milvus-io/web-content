...
<h3 id="Milvus-config-parameters" class="common-anchor-header">Parámetros de configuración de Milvus<button data-href="#Milvus-config-parameters" class="anchor-icon" translate="no">
    ...
    </button></h3><p>El backend de Milvus admite una variedad de parámetros de consulta que pueden utilizarse para personalizar sus consultas de similitud. Estos parámetros incluyen:</p>
<ul>
