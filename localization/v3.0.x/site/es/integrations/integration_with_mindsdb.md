...
<h3 id="Creating-connection" class="common-anchor-header">Creación de la conexión<button data-href="#Creating-connection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para hacer uso de este manejador y conectarse a un servidor Milvus en MindsDB, se puede utilizar la siguiente sintaxis:</p>
...
<h3 id="Dropping-connection" class="common-anchor-header">Desconexión<button data-href="#Dropping-connection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para eliminar la conexión, utilice este comando</p>
<pre><code translate="no" class="language-sql"><span class="hljs-keyword">DROP</span> DATABASE milvus_datasource;
<button class="copy-code-btn"></button></code></pre>
<h3 id="Creating-tables" class="common-anchor-header">Creación de tablas<button data-href="#Creating-tables" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para insertar datos de una tabla preexistente, utilice <code translate="no">CREATE</code></p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Dropping-collections" class="common-anchor-header">Eliminación de colecciones<button data-href="#Dropping-collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>No es posible eliminar una colección</p>
<h3 id="Querying-and-selecting" class="common-anchor-header">Consulta y selección<button data-href="#Querying-and-selecting" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para consultar la base de datos mediante un vector de búsqueda, puede utilizar <code translate="no">search_vector</code> en la cláusula <code translate="no">WHERE</code> </p>
<p>Advertencia:</p>
<ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Deleting-records" class="common-anchor-header">Eliminación de registros<button data-href="#Deleting-records" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Puede borrar entradas utilizando <code translate="no">DELETE</code> como en SQL.</p>
<p>Advertencias:</p>
<ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Inserting-records" class="common-anchor-header">Inserción de registros<button data-href="#Inserting-records" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>También puede insertar filas individuales de esta forma:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Updating" class="common-anchor-header">Actualización<button data-href="#Updating" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>La API de Milvus no admite la actualización de registros. Puede intentar usar una combinación de <code translate="no">DELETE</code> y <code translate="no">INSERT</code></p>
<hr>
