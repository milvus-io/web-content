...
<h3 id="Hybrid-Search-with-Reranker" class="common-anchor-header">Búsqueda híbrida con Reranker<button data-href="#Hybrid-Search-with-Reranker" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Un sistema de búsqueda híbrido combina la búsqueda semántica y la búsqueda de texto completo, optimizando el rendimiento de la recuperación en un sistema RAG.</p>
