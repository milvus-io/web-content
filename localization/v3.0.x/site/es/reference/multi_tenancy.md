...
<h3 id="Database-level-multi-tenancy" class="common-anchor-header">Arrendamiento múltiple a nivel de base de datos<button data-href="#Database-level-multi-tenancy" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Con la multitenencia a nivel de base de datos, cada arrendatario recibe una <a href="/docs/es/manage_databases.md">base de datos</a> correspondiente que contiene una o más colecciones.</p>
<p>
...
<h3 id="Collection-level-multi-tenancy" class="common-anchor-header">Arrendamiento múltiple a nivel de colección<button data-href="#Collection-level-multi-tenancy" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Con la tenencia múltiple a nivel de colecciones, a cada inquilino se le asigna una <a href="/docs/es/manage-collections.md">colección</a>, lo que ofrece un fuerte aislamiento de los datos.</p>
<p>
...
<h3 id="Partition-level-multi-tenancy" class="common-anchor-header">Arrendamiento múltiple a nivel de partición<button data-href="#Partition-level-multi-tenancy" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>En la multitenencia a nivel de partición, cada inquilino se asigna a una <a href="/docs/es/manage-partitions.md">partición</a> creada manualmente dentro de una colección compartida.</p>
<p>
...
<h3 id="Partition-key-level-multi-tenancy" class="common-anchor-header">Arrendamiento múltiple a nivel de clave de partición<button data-href="#Partition-key-level-multi-tenancy" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<ul>
<li><p><strong>Escalabilidad</strong>: La estrategia a nivel de clave de partición ofrece el enfoque más escalable, ya que admite millones de inquilinos.</p></li>
