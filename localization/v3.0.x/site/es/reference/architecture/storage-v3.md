...
<p>El almacenamiento V3 proporciona este modelo en Milvus 3.0. Utiliza una estructura de almacenamiento con versiones para incorporar los datos añadidos o reescritos con el tiempo, mientras que las aplicaciones siguen accediendo a las colecciones a través de las mismas API de Milvus.</p>
...
<p>Una vez que Milvus escribe datos en Storage V3, no se admite la vuelta a una versión de Milvus que no pueda leer Storage V3. Desactivar Storage V3 posteriormente no convierte inmediatamente todos los datos existentes de Storage V3 ni restaura la compatibilidad con la versión anterior.</p>
</div>
