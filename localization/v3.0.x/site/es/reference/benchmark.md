...
<h3 id="Hardware-environment" class="common-anchor-header">Entorno de hardware<button data-href="#Hardware-environment" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Software-environment" class="common-anchor-header">Entorno de software<button data-href="#Software-environment" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Deployment-scheme" class="common-anchor-header">Esquema de despliegue<button data-href="#Deployment-scheme" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Data-sets" class="common-anchor-header">Conjuntos de datos<button data-href="#Data-sets" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>La prueba utiliza el conjunto de datos de código abierto SIFT (128 dimensiones) de <a href="https://github.com/erikbern/ann-benchmarks/#data-sets">ANN-Benchmarks</a>.</p>
...
<h2 id="Test-results" class="common-anchor-header">Resultados de la prueba<button data-href="#Test-results" class="anchor-icon" translate="no">
    ...
    </button></h3><h4 id="Cluster" class="common-anchor-header">Clúster</h4><p><details>
...
<h3 id="Milvus-220-Scale-up" class="common-anchor-header">Milvus 2.2.0 Ampliación<button data-href="#Milvus-220-Scale-up" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Amplíe los núcleos de CPU en un Querynode para comprobar la capacidad de ampliación.</p>
<p><details>
...
<h3 id="Milvus-220-Scale-out" class="common-anchor-header">Milvus 2.2.0 Ampliación<button data-href="#Milvus-220-Scale-out" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Expanda más réplicas con más Querynodes para comprobar la capacidad de escalado.</p>
<div class="alert note">
