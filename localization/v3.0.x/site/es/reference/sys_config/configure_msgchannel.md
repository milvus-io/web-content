  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>Para compartir una instancia Pulsar entre múltiples instancias Milvus, considere cambiar esto a un nombre en lugar del predeterminado para cada instancia Milvus antes de iniciarlas.</li>      </td>
      <td>by-dev</td>
    </tr>
  </tbody>
</table>
...
<h2 id="msgChannelchanNamePrefixdataCoordSegmentInfo" class="common-anchor-header"><code translate="no">msgChannel.chanNamePrefix.dataCoordSegmentInfo</code><button data-href="#msgChannelchanNamePrefixdataCoordSegmentInfo" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Prefijo del subnombre del canal de mensajes donde el data coord publica los mensajes de información del segmento.</li>      
