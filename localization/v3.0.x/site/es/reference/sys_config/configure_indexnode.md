...
summary: Aprenda a configurar indexNode para Milvus.
---
<h1 id="indexNode-related-Configurations" class="common-anchor-header">Configuraciones relacionadas con indexNode<button data-href="#indexNode-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>        habilitar nodo índice construir índice vectorial de disco     </td>
      <td>true</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodeip" class="common-anchor-header"><code translate="no">indexNode.ip</code><button data-href="#indexNodeip" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Dirección TCP/IP de indexNode. Si no se especifica, utiliza la primera dirección unicastable      </td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<h2 id="indexNodegrpcserverMaxSendSize" class="common-anchor-header"><code translate="no">indexNode.grpc.serverMaxSendSize</code><button data-href="#indexNodegrpcserverMaxSendSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        El tamaño máximo de cada petición RPC que el indexNode puede enviar, unidad: byte    </td>
      <td>536870912</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcserverMaxRecvSize" class="common-anchor-header"><code translate="no">indexNode.grpc.serverMaxRecvSize</code><button data-href="#indexNodegrpcserverMaxRecvSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        El tamaño máximo de cada petición RPC que el indexNode puede recibir, unidad: byte    </td>
      <td>268435456</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcclientMaxSendSize" class="common-anchor-header"><code translate="no">indexNode.grpc.clientMaxSendSize</code><button data-href="#indexNodegrpcclientMaxSendSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        El tamaño máximo de cada petición RPC que los clientes en indexNode pueden enviar, unidad: byte    </td>
      <td>268435456</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcclientMaxRecvSize" class="common-anchor-header"><code translate="no">indexNode.grpc.clientMaxRecvSize</code><button data-href="#indexNodegrpcclientMaxRecvSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        El tamaño máximo de cada petición RPC que los clientes en indexNode pueden recibir, unidad: byte    </td>
      <td>536870912</td>
    </tr>
  </tbody>
</table>
