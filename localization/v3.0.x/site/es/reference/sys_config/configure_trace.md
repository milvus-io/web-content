...
summary: Aprenda a configurar el rastreo para Milvus.
---
<h1 id="trace-related-Configurations" class="common-anchor-header">Configuraciones relacionadas con el rastreo<button data-href="#trace-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>
        <li>tipo de exportador de trazas, por defecto es stdout,</li>      
        <li>valores opcionales: ['noop','stdout', 'jaeger', 'otlp']</li>      </td>
      <td>noop</td>
    </tr>
  </tbody>
</table>
<h2 id="tracesampleFraction" class="common-anchor-header"><code translate="no">trace.sampleFraction</code><button data-href="#tracesampleFraction" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>fracción del muestreador basado en traceID,</li>      
        <li>valores opcionales: [0, 1]</li>      
        <li>Las fracciones &gt;= 1 siempre muestrearán. Las fracciones &lt; 0 se tratan como cero.</li>      </td>
      <td>0</td>
    </tr>
  </tbody>
</table>
<h2 id="tracejaegerurl" class="common-anchor-header"><code translate="no">trace.jaeger.url</code><button data-href="#tracejaegerurl" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        cuando el exportador es jaeger debe establecer la URL de jaeger      </td>
      <td></td>
    </tr>
  </tbody>
</table>
<h2 id="traceotlpendpoint" class="common-anchor-header"><code translate="no">trace.otlp.endpoint</code><button data-href="#traceotlpendpoint" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        ejemplo: "127.0.0.1:4317" para grpc, "127.0.0.1:4318" para http    </td>
      <td></td>
    </tr>
  </tbody>
</table>
<h2 id="traceotlpmethod" class="common-anchor-header"><code translate="no">trace.otlp.method</code><button data-href="#traceotlpmethod" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        método de exportación otlp, valores aceptables: ["grpc", "http"], usando "grpc" por defecto      </td>
      <td></td>
    </tr>
  </tbody>
</table>
<h2 id="traceinitTimeoutSeconds" class="common-anchor-header"><code translate="no">trace.initTimeoutSeconds</code><button data-href="#traceinitTimeoutSeconds" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        tiempo de espera de inicialización de segcore en segundos, para evitar que otlp grpc se cuelgue para siempre      </td>
      <td>10</td>
    </tr>
  </tbody>
</table>
