...
<h2 id="Create-Collection" class="common-anchor-header">Créer une collection<button data-href="#Create-Collection" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Defining-necessary-variables" class="common-anchor-header">Définir les variables nécessaires<button data-href="#Defining-necessary-variables" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Add-schema" class="common-anchor-header">Ajouter un schéma<button data-href="#Add-schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Avant d'insérer des données dans la base de données Milvus Lite, nous devons d'abord définir le champ de données, appelé ici schéma. En créant l'objet <code translate="no">CollectionSchema</code> et en ajoutant le champ de données via <code translate="no">add_field()</code>, nous pouvons contrôler notre type de données et leurs caractéristiques. Cette étape est obligatoire avant d'insérer des données dans Milvus.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Create-index" class="common-anchor-header">Création d'un index<button data-href="#Create-index" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Pour chaque schéma, il est préférable d'avoir un index afin que l'interrogation soit beaucoup plus efficace. Pour créer un index, nous avons d'abord besoin d'un objet <code translate="no">index_params</code> et nous ajoutons ensuite des données d'index sur cet objet <code translate="no">IndexParams</code>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Rules" class="common-anchor-header">Règles<button data-href="#Rules" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Clean-up" class="common-anchor-header">Nettoyage<button data-href="#Clean-up" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Enfin, après avoir mis en œuvre toutes les instructions, vous pouvez nettoyer la base de données en appelant <code translate="no">drop_collection()</code>.</p>
