...
<h3 id="Installation" class="common-anchor-header">Installation<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Clonez le repo et configurez votre environnement :</p>
...
<h3 id="Configuring-Milvus" class="common-anchor-header">Configuration de Milvus<button data-href="#Configuring-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Pour utiliser <strong>Milvus</strong>, mettez à jour votre configuration.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Loading-Data" class="common-anchor-header">Chargement des données<button data-href="#Loading-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Une fois configuré, chargez votre contenu à l'aide de flux RSS.</p>
...
<h3 id="Running-the-Server" class="common-anchor-header">Exécution du serveur<button data-href="#Running-the-Server" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Pour démarrer NLWeb, à partir du répertoire <code translate="no">code</code>, exécutez :</p>
