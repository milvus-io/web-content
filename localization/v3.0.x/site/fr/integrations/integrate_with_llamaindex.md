...
<h2 id="Before-you-begin" class="common-anchor-header">Avant de commencer<button data-href="#Before-you-begin" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Les extraits de code de cette page nécessitent les dépendances pymilvus et llamaindex. Vous pouvez les installer à l'aide des commandes suivantes :</p>
...
<h3 id="Setup-OpenAI" class="common-anchor-header">Configuration d'OpenAI<button data-href="#Setup-OpenAI" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Commençons par ajouter la clé api openai. Cela nous permettra d'accéder à chatgpt.</p>
...
<h2 id="Getting-Started" class="common-anchor-header">Démarrage<button data-href="#Getting-Started" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Generate-our-data" class="common-anchor-header">Générer nos données<button data-href="#Generate-our-data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Comme premier exemple, générons un document à partir du fichier <code translate="no">paul_graham_essay.txt</code>. Il s'agit d'un seul essai de Paul Graham intitulé <code translate="no">What I Worked On</code>. Pour générer les documents, nous utiliserons le SimpleDirectoryReader.</p>
...
<h3 id="Create-an-index-across-the-data" class="common-anchor-header">Créer un index sur les données<button data-href="#Create-an-index-across-the-data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Maintenant que nous avons un document, nous pouvons créer un index et insérer le document. Pour l'index, nous utiliserons un MilvusVectorStore. MilvusVectorStore prend en compte quelques arguments :</p>
...
<h3 id="Query-the-data" class="common-anchor-header">Interroger les données<button data-href="#Query-the-data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Maintenant que notre document est stocké dans l'index, nous pouvons poser des questions à l'index. L'index utilisera les données stockées en lui-même comme base de connaissances pour chatgpt.</p>
