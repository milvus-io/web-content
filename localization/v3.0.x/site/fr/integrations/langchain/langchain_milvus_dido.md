...
<li>Les clés API sont gérées de manière centralisée côté serveur.</li>
...
<tr><td><strong>Gestion des clés API</strong></td><td>Nécessité de gérer côté client</td><td>Gestion centralisée côté serveur, plus sûre</td></tr>
...
<h2 id="Using-Text-Embedding-Function" class="common-anchor-header">Utilisation de la fonction d'incorporation de texte<button data-href="#Using-Text-Embedding-Function" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Example-1-Server-side-Embedding-Only" class="common-anchor-header">Exemple 1 : Intégration côté serveur uniquement<button data-href="#Example-1-Server-side-Embedding-Only" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
