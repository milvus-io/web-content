...
order: 13
summary: >-
  Cet article décrit comment utiliser la fonction MGTEEmbeddingFunction pour
  encoder des documents et des requêtes à l'aide du modèle d'encodage mGTE.
title: mGTE
---
<h1 id="mGTE" class="common-anchor-header">mGTE<button data-href="#mGTE" class="anchor-icon" translate="no">
    ...
    </button></h1><p>mGTE est un modèle de représentation de texte multilingue et un modèle de reclassement pour les tâches de recherche de texte.</p>
<p>Milvus s'intègre au modèle d'intégration mGTE via la classe MGTEEmbeddingFunction. Cette classe fournit des méthodes pour encoder les documents et les requêtes à l'aide du modèle d'intégration mGTE et pour renvoyer les intégrations sous forme de vecteurs denses et épars compatibles avec l'indexation Milvus.</p>
<p>Pour utiliser cette fonctionnalité, installez les dépendances nécessaires :</p>
<pre><code translate="no" class="language-python">pip install --upgrade pymilvus
pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>Ensuite, instanciez la MGTEEmbeddingFunction :</p>
...
<p>Le nom du modèle d'intégration mGTE à utiliser pour l'encodage. La valeur par défaut est <code translate="no">Alibaba-NLP/gte-multilingual-base</code>.</p></li>
</ul>
