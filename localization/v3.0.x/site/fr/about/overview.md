...
<li><p>Milvus Capture Data Change (CDC) Milvus CDC peut répliquer les modifications de données d'un cluster Milvus à un autre pour la reprise après sinistre primaire et de secours. Pour plus de détails, voir <a href="/docs/fr/milvus_cdc_overview.md">Milvus CDC</a>.</p></li>
