...
<h3 id="Note-for-macOS-M-series-chip" class="common-anchor-header">Note pour macOS (puce de la série M) :<button data-href="#Note-for-macOS-M-series-chip" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Si vous rencontrez l'erreur :</p>
...
<h2 id="4-Prepare-Data-Create-Collection-and-Insert-Data" class="common-anchor-header">4. Préparer les données, créer une collection et insérer des données<button data-href="#4-Prepare-Data-Create-Collection-and-Insert-Data" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="41-Prepare-the-Data" class="common-anchor-header">4.1 Préparer les données<button data-href="#41-Prepare-the-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Nous utilisons les pages FAQ de la <a href="https://github.com/milvus-io/milvus-docs/releases/download/v2.4.6-preview/milvus_docs_2.4.x_en.zip">documentation Milvus 2.4.x</a> comme ensemble de données pour cet exemple.</p>
...
<button class="copy-code-btn"></button></code></pre>
<hr>
<h3 id="42-Generate-Embeddings" class="common-anchor-header">4.2 Générer des embeddings<button data-href="#42-Generate-Embeddings" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Définir un modèle d'incorporation pour générer des incorporations de texte à l'aide du modèle <code translate="no">milvus_model</code>. Nous utilisons le modèle <code translate="no">DefaultEmbeddingFunction</code> comme exemple, qui est un modèle d'incorporation pré-entraîné et léger.</p>
...
<button class="copy-code-btn"></button></code></pre>
<hr>
<h3 id="43-Create-Collection" class="common-anchor-header">4.3 Créer une collection<button data-href="#43-Create-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Connectez-vous à Milvus et créez une collection :</p>
...
<button class="copy-code-btn"></button></code></pre>
<hr>
<h3 id="44-Insert-Data" class="common-anchor-header">4.4 Insérer des données<button data-href="#44-Insert-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Interroger les lignes de texte, créer des enchâssements et insérer les données dans Milvus :</p>
...
<button class="copy-code-btn"></button></code></pre>
<hr>
<h3 id="45-Visualize-Data-and-Schema" class="common-anchor-header">4.5 Visualiser les données et le schéma<button data-href="#45-Visualize-Data-and-Schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="51-Perform-a-Search" class="common-anchor-header">5.1 <strong>Effectuer une recherche</strong><button data-href="#51-Perform-a-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Naviguez jusqu'à l'onglet <strong>Recherche vectorielle</strong> dans Attu.</p>
<ol>
...
<hr>
<h3 id="52-Explore-Data-Relationships" class="common-anchor-header">5.2 <strong>Explorer les relations entre les données</strong><button data-href="#52-Explore-Data-Relationships" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Cliquez sur le bouton <strong>Explorer</strong> dans le panneau des résultats pour visualiser les relations entre le vecteur de la requête et les résultats de la recherche dans une <strong>structure de type graphe de connaissances</strong>.</p>
<ul>
...
<hr>
<h3 id="53-Expand-the-Graph" class="common-anchor-header">5.3 <strong>Développer le graphe</strong><button data-href="#53-Expand-the-Graph" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Double-cliquez sur n'importe quel nœud de résultat pour développer ses connexions. Cette action révèle des relations supplémentaires entre le nœud sélectionné et d'autres points de données de la collection, créant ainsi un <strong>graphique de connaissances plus large et interconnecté</strong>.</p>
