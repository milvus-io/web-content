...
<h2 id="Preparation" class="common-anchor-header">Préparation<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Download-the-dataset" class="common-anchor-header">Télécharger l'ensemble de données<button data-href="#Download-the-dataset" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>La commande suivante permet de télécharger les données d'exemple utilisées dans la <a href="https://github.com/anthropics/anthropic-cookbook/blob/main/skills/contextual-embeddings/guide.ipynb">démo</a> Anthropic originale.</p>
...
<h3 id="Install-Milvus-25" class="common-anchor-header">Installer Milvus 2.5<button data-href="#Install-Milvus-25" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Consultez le <a href="https://milvus.io/docs/install_standalone-docker-compose.md">guide d'installation officiel</a> pour plus de détails.</p>
<h3 id="Install-PyMilvus" class="common-anchor-header">Installer PyMilvus<button data-href="#Install-PyMilvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Exécutez la commande suivante pour installer PyMilvus :</p>
<pre><code translate="no" class="language-python">pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span> -U 
<button class="copy-code-btn"></button></code></pre>
<h3 id="Define-the-Retriever" class="common-anchor-header">Définir le récupérateur<button data-href="#Define-the-Retriever" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Insert-the-data" class="common-anchor-header">Insérer les données<button data-href="#Insert-the-data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Test-Sparse-Search" class="common-anchor-header">Tester la recherche éparse<button data-href="#Test-Sparse-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
