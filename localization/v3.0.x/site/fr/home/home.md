...
<div class="start_card_container">
   ...
   <a href="/docs/fr/install_standalone-docker.md"> <img translate="no" src="https://milvus-docs.s3.us-west-2.amazonaws.com/assets/home_install.svg" alt="icon" />
...
<div class="start_card_container">
   ...
   <a href="/docs/fr/quickstart.md"> <img translate="no" src="https://milvus-docs.s3.us-west-2.amazonaws.com/assets/home_quick_start.svg" alt="icon" />
...
<h2 id="Whats-new-in-docs" class="common-anchor-header">Quoi de neuf dans la documentation<button data-href="#Whats-new-in-docs" class="anchor-icon" translate="no">
    ...
    </button></h2><p><em>Mai 2026 - Mises à jour de Milvus 3.0.x</em></p>
<ul>
<li>Ajout des points forts de Milvus 3.0.x aux <a href="/docs/fr/release_notes.md">notes de mise à jour</a>, y compris la collecte externe, les instantanés, le stockage V3 et les intégrations à l'écosystème du lac.</li>
<li>Ajout d'indications sur la manière de <a href="/docs/fr/single-vector-search.md#Sort-Search-Results-by-Scalar-Fields--Milvus-30x">trier les résultats de recherche par champs scalaires</a> et d'<a href="/docs/fr/get-and-scalar-query.md#Aggregate-Query-Results--Milvus-30x">agréger les résultats des requêtes</a>.</li>
<li>Ajout de conseils sur l'utilisation des <a href="/docs/fr/nullable-and-default.md">champs vectoriels nullables</a> et du <a href="/docs/fr/set-collection-ttl.md#Set-entity-level-TTL--Milvus-30x">TTL au niveau de l'entité</a>.</li>
<li>Ajout de conseils sur l'utilisation de la <a href="/docs/fr/minhash-function.md">fonction MinHash</a> pour les signatures MinHash côté serveur.</li>
<li>Ajout d'indications sur la manière de <a href="/docs/fr/search-with-embedding-lists.md">rechercher avec des listes d'intégration</a> et de déclencher un <a href="/docs/fr/force-merge.md">compactage par fusion forcée</a>.</li>
</ul>
</div>
