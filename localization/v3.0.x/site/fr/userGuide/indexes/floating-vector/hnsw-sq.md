...
<li><p><strong>Efficacité de la mémoire cache :</strong> Des vecteurs de plus petite taille signifient que plus de données sont stockées dans le cache du processeur, ce qui réduit la latence causée par l'accès à la mémoire.</p></li>
</ul>
<div class="alert note">
<p>En raison du partage global des paramètres, SQ4U est plus performant sur des données normalisées ou des ensembles de données dont la distribution des valeurs est cohérente entre les dimensions.</p>
</div>
...
<table>
   ...
   <tr>
     ...
     <td><p><strong>Type</strong>: Entier</p><p><strong>Portée</strong>: [2, 2048]</p><p><strong>Valeur par défaut</strong>: <code translate="no">30</code> (jusqu'à 30 arêtes sortantes et 30 arêtes entrantes par nœud)</p></td>
