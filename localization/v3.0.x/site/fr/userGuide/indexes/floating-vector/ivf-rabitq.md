...
<table>
   ...
   <tr>
     ...
     <td><p>Le processus d'affinage utilise une quantification de meilleure qualité pour sélectionner le nombre nécessaire de plus proches voisins à partir d'un ensemble de candidats <code translate="no">refine_k</code> fois plus important choisi à l'aide de IVF_RABITQ.</p></td>
