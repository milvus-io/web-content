...
<h2 id="Choose-a-factory-string" class="common-anchor-header">Choisissez une chaîne de fabrique<button data-href="#Choose-a-factory-string" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Une chaîne de fabrication décrit un index Faiss sous la forme d’une séquence de composants. Les exemples suivants ont été testés avec la version Milvus 3.0.0. Cette liste n’est pas exhaustive.</p>
<table>
<thead>
