...
<p>Pour les champs sur lesquels l’ <code translate="no">nullable</code> est activée, vous pouvez les omettre dans la requête d’ <code translate="no">upsert</code> ion s’ils ne nécessitent aucune mise à jour.</p>
