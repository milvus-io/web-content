...
title: Charger et libérer
summary: >-
  Le chargement d'une collection est la condition préalable à l'exécution de
  recherches de similarités et de requêtes dans les collections. Cette page se
  concentre sur les procédures de chargement et de libération d'une collection.
---
...
<h2 id="Load-Specific-Fields" class="common-anchor-header">Chargement de champs spécifiques<button data-href="#Load-Specific-Fields" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus peut charger uniquement les champs impliqués dans les recherches et les requêtes, ce qui permet de réduire l'utilisation de la mémoire et d'améliorer les performances de recherche.</p>
