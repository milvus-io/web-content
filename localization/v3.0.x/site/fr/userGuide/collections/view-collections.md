...
summary: >-
  Vous pouvez obtenir la liste des noms de toutes les collections de la base de
  données actuellement connectée et vérifier les détails d'une collection
  spécifique.
---
...
<button class="copy-code-btn"></button></code></pre>
<p>Le résultat de l'exemple ci-dessus devrait être similaire à ce qui suit.</p>
