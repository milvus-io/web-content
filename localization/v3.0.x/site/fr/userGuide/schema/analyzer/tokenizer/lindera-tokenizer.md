...
<p>Ce processus en deux étapes - segmentation suivie d'un filtrage basé sur le POS - permet de contrôler avec précision les mots indexés pour la recherche.</p>
