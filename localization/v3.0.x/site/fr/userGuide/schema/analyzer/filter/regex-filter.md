...
summary: >-
  Le filtre regex est un filtre d'expressions régulières : tout jeton produit
  par le tokenizer n'est conservé que s'il correspond à l'expression que vous
  avez fournie ; tout le reste est rejeté.
beta: Milvus 2.5.11+
---
<h1 id="Regex" class="common-anchor-header">Expression régulière<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.5.11+</span><button data-href="#Regex" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Le filtre <code translate="no">regex</code> est un filtre d'expression régulière : tout jeton produit par le tokenizer n'est conservé que s'il correspond à l'expression que vous avez fournie ; tout le reste est rejeté.</p>
<h2 id="Configuration" class="common-anchor-header">Configuration<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Le filtre <code translate="no">regex</code> est un filtre personnalisé dans Milvus. Pour l'utiliser, spécifiez <code translate="no">&quot;type&quot;: &quot;regex&quot;</code> dans la configuration du filtre, ainsi qu'un paramètre <code translate="no">expr</code> pour spécifier les expressions régulières souhaitées.</p>
...
<table>
   ...
   <tr>
     ...
     <td><p>Un motif d'expression régulière appliqué à chaque jeton. Les jetons qui correspondent sont conservés ; les jetons qui ne correspondent pas sont supprimés. Pour plus de détails sur la syntaxe des expressions régulières, voir <a href="https://docs.rs/regex/latest/regex/#syntax">Syntaxe</a>.</p></td>
   </tr>
</table>
