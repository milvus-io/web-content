...
<p>Le filtre s'applique aux tokens générés par le tokeniseur. Pour le texte chinois, utilisez-le avec un tokeniseur tel que <code translate="no">jieba</code>.</p>
