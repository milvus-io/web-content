...
<tr><td><code translate="no">keep_separate_first_letter</code></td><td>Booléen</td><td><code translate="no">false</code></td><td>Génère un token d'initiales en pinyin pour chaque token source. Par exemple, <code translate="no">中文</code> génère <code translate="no">zw</code>.</td></tr>
</tbody>
</table>
