...
title: Pliage ASCII
summary: >-
  Le filtre asciifolding convertit les caractères qui ne font pas partie du bloc
  Unicode latin de base (les 127 premiers caractères ASCII) en leurs équivalents
  ASCII. Par exemple, il transforme des caractères comme í en i, ce qui rend le
...
<h1 id="ASCII-folding" class="common-anchor-header">Pliage ASCII<button data-href="#ASCII-folding" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Le filtre <code translate="no">asciifolding</code> convertit les caractères situés en dehors du <a href="https://en.wikipedia.org/wiki/Basic_Latin_(Unicode_block)">bloc Unicode latin de base</a> (les 127 premiers caractères ASCII) en leurs équivalents ASCII. Par exemple, il transforme des caractères comme <code translate="no">í</code> en <code translate="no">i</code>, ce qui rend le traitement de texte plus simple et plus cohérent, en particulier pour les contenus multilingues.</p>
