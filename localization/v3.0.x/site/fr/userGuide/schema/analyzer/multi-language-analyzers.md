...
<ul>
<li><p>Configurez plusieurs analyseurs spécifiques à chaque langue en utilisant le format : <code translate="no">&lt;analyzer_name&gt;: &lt;analyzer_config&gt;</code>, où chaque <code translate="no">analyzer_config</code> suit la configuration standard d’ <code translate="no">analyzer_params</code>, telle que décrite dans <a href="/docs/fr/analyzer-overview.md#Analyzer-types">la section Présentation des analyseurs</a>.</p></li>
...
<ul>
<li><p>Ajoutez des documents contenant du texte dans différentes langues, chaque document comportant une valeur d’identifiant précisant l’analyseur à utiliser.</p></li>
...
<h3 id="Use-Chinese-analyzer" class="common-anchor-header">Utilisation de l’analyseur chinois<button data-href="#Use-Chinese-analyzer" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Cet exemple montre comment passer à l’analyseur chinois (en utilisant son alias <code translate="no">&quot;cn&quot;</code>) pour un texte de requête différent. Tous les autres paramètres restent inchangés, mais le texte de la requête est désormais traité selon les règles de tokenisation spécifiques au chinois.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
