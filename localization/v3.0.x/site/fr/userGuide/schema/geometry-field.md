...
<p>Pour utiliser le champ GEOMETRY, mettez à jour votre SDK avec la dernière version.</p>
</div>
...
<h4 id="Define-filter-expressions" class="common-anchor-header">Définir les expressions de filtrage</h4><p>Pour filtrer sur un champ <code translate="no">GEOMETRY</code>, utilisez un opérateur géométrique dans une expression :</p>
<ul>
...
<p>Les exemples suivants montrent comment utiliser différents opérateurs spécifiques à la géométrie dans une expression de filtre :</p>
