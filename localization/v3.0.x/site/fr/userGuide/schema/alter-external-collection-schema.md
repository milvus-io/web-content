...
<h2 id="Refresh-the-external-collection" class="common-anchor-header">Actualiser la collection externe<button data-href="#Refresh-the-external-collection" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Après avoir modifié le schéma d’une collection externe, actualisez cette dernière afin que Milvus mette à jour ses métadonnées et que la modification du schéma soit prise en compte dans les résultats des requêtes, des recherches et des filtres.</p>
