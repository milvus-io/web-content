...
<p>Les classeurs de modèles s'intègrent parfaitement aux opérations de recherche vectorielle standard et de recherche hybride. La mise en œuvre implique la création d'un objet Function qui définit votre configuration de reclassement et le transmet aux opérations de recherche.</p>
...
<table>
   ...
   <tr>
     ...
     <td><p>Oui</p></td>
     <td><p>Spécifie le type de fonction créée.</p><p>Doit être défini sur <code translate="no">RERANK</code> pour tous les classeurs de modèles.</p></td>
