...
<h2 id="Choose-an-embedding-model" class="common-anchor-header">Choisir un modèle d'intégration<button data-href="#Choose-an-embedding-model" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus prend en charge les modèles d'intégration fournis par Voyage AI. Les modèles d'intégration actuellement disponibles sont présentés ci-dessous à titre de référence rapide :</p>
<table>
   <tr>
