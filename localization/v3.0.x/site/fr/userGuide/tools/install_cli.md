...
<h3 id="Install-from-an-exe-file" class="common-anchor-header">Installation à partir d'un fichier .exe<button data-href="#Install-from-an-exe-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><div class="alert note"> Cette méthode d'installation ne s'applique qu'à Windows. </div>
