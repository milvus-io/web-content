...
<li>Installer <a href="https://www.python.org/downloads/release/python-390/">Python 3.9</a> ou une version ultérieure</li>
<li>Installer <a href="https://pip.pypa.io/en/stable/installation/">pip</a></li>
</ul>
<h3 id="Install-via-pip" class="common-anchor-header">Installation via pip<button data-href="#Install-via-pip" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Exécutez la commande suivante pour installer Milvus_CLI.</p>
...
<h3 id="Prerequisites" class="common-anchor-header">Conditions préalables<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Docker 19.03 ou plus récent est requis.</p>
<h3 id="Install-based-on-Docker-image" class="common-anchor-header">Installation basée sur l'image Docker<button data-href="#Install-based-on-Docker-image" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<p>Vous pouvez également installer Milvus_CLI à partir d'une archive compressée (fichier<code translate="no">.tar.gz</code> ). Téléchargez une <a href="https://github.com/zilliztech/milvus_cli/releases">archive</a> et exécutez <code translate="no">python -m pip install milvus_cli-&lt;version&gt;.tar.gz</code>.</p>
