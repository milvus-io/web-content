...
<h3 id="Prepare-deploymentyml" class="common-anchor-header">Préparer le fichier deployment.yml<button data-href="#Prepare-deploymentyml" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Apply-deploymentyml" class="common-anchor-header">Appliquer deployment.yml<button data-href="#Apply-deploymentyml" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Enregistrez le YAML ci-dessus dans un fichier et nommez-le <code translate="no">deployment.yml</code>, et exécutez la commande suivante</p>
