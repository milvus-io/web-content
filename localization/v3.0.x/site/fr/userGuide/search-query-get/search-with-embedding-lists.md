...
<h1 id="Search-with-Embedding-Lists" class="common-anchor-header">Recherche à l'aide de listes d'incorporation<button data-href="#Search-with-Embedding-Lists" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Cette page explique comment mettre en place un système de recherche de texte ColBERT et un système de recherche de texte ColPali à l'aide du tableau de structures de Milvus, qui permet de stocker un document avec ses morceaux vectorisés dans des listes d'intégration.</p>
...
<h3 id="Step-2-Load-the-Cohere-dataset" class="common-anchor-header">Étape 2 : Charger l'ensemble de données Cohere<button data-href="#Step-2-Load-the-Cohere-dataset" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
