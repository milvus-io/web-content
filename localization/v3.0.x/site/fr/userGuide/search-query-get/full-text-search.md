...
<table>
   ...
   <tr>
     ...
     <td><p>Type d’index à créer. Pour la recherche en texte intégral BM25 dans Milvus, définissez cette valeur sur <code translate="no">SPARSE_INVERTED_INDEX</code>. Pour plus d’informations, consultez la section <a href="/docs/fr/sparse-inverted-index.md">SPARSE_INVERTED_INDEX</a>.</p></td>
   </tr>
   <tr>
