...
<tr><td>Filtres de chaînes de caractères de type préfixe, exacts ou d’égalité, en particulier sur les champs présentant une cardinalité faible à modérée</td><td><code translate="no">STL_SORT</code>, <code translate="no">INVERTED</code> ou <code translate="no">BITMAP</code></td><td>Peut s’avérer plus efficace lorsque le champ comporte des valeurs répétées ou lorsque le filtre s’apparente à une correspondance exacte. Pour plus de détails, voir <a href="/docs/fr/stl-sort.md">STL_SORT</a>, <a href="/docs/fr/inverted.md">INVERTED</a> et <a href="/docs/fr/bitmap.md">BITMAP</a>.</td></tr>
