...
<h2 id="Data-backup-and-restoration" class="common-anchor-header">Sauvegarde et restauration des données<button data-href="#Data-backup-and-restoration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Les instantanés sont des images rapides des données à un moment donné, adaptées aux retours en arrière rapides ou aux tests (de quelques jours à quelques semaines). Les sauvegardes, quant à elles, sont des copies indépendantes et complètes stockées séparément à des fins de reprise après sinistre à long terme (de quelques semaines à plusieurs années) et pour une meilleure protection contre une panne totale du stockage.</p>
...
<table>
   ...
   <tr>
     ...
     <td><p>Copie tous les fichiers de données (opération chronophage)</p></td>
