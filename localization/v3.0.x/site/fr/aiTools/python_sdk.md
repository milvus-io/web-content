...
summary: >-
  Règles permettant aux assistants de codage IA d'écrire un code Python Milvus
  correct à l'aide de MilvusClient.
---
<h1 id="Python-SDK" class="common-anchor-header">SDK Python<button data-href="#Python-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Règles pour l'écriture d'un code Milvus Python correct à l'aide de l'interface MilvusClient, y compris la migration ORM, les modèles de connexion et les opérations courantes. Copiez l'invite complète ci-dessous dans votre outil d'IA pour appliquer ces règles automatiquement. Pour une vue d'ensemble de toutes les invites, voir <a href="/docs/fr/milvus_for_agents.md">Invites AI</a>.</p>
