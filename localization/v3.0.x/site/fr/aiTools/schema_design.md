---
id: schema_design.md
title: 'Prompt : Conception du schéma de Milvus'
summary: >-
  Règles permettant aux assistants de codage de l'IA de concevoir des schémas de
  collection Milvus corrects.
---
<h1 id="Schema-Design" class="common-anchor-header">Conception des schémas<button data-href="#Schema-Design" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Règles et guides de décision pour la conception de schémas de collecte Milvus corrects, y compris les types de champs, les clés primaires, la configuration BM25 et les contraintes d'immuabilité des schémas. Copiez l'invite complète ci-dessous dans votre outil d'IA pour appliquer ces règles automatiquement. Pour obtenir une vue d'ensemble de toutes les invites, voir <a href="/docs/fr/milvus_for_agents.md">Invites AI</a>.</p>
