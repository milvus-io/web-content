---
id: schema_design.md
title: 'Consigne : Conception du schéma Milvus'
summary: >-
  Règles à respecter par les assistants de codage basés sur l'IA pour concevoir
  des schémas de collection Milvus corrects.
---
<h1 id="Schema-Design" class="common-anchor-header">Conception de schémas<button data-href="#Schema-Design" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Règles et guides décisionnels pour la conception de schémas de collection Milvus corrects, notamment les types de champs, les clés primaires, la configuration BM25 et les contraintes d'immuabilité des schémas. Copiez l'invite complète ci-dessous dans votre outil d'IA pour appliquer automatiquement ces règles. Pour un aperçu de toutes les invites, consultez <a href="/docs/fr/milvus_for_agents.md">la section</a> « <a href="/docs/fr/milvus_for_agents.md">Invites IA</a> ».</p>
<h2 id="How-to-use-this-prompt" class="common-anchor-header">Comment utiliser cette instruction<button data-href="#How-to-use-this-prompt" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><strong>Copiez</strong> l'invite complète dans la section « <a href="#full-prompt">Invite complète</a> » ci-dessous.</li>
<li><strong>Enregistrez</strong> -la à l'emplacement prévu par votre outil d'IA — consultez le <a href="/docs/fr/milvus_for_agents.md">tableau des environnements</a> pour plus de détails sur l'emplacement.</li>
<li>Votre assistant IA appliquera automatiquement ces règles lors de la génération ou de la révision du code Milvus.</li>
</ol>
<p>Pour les utilisateurs <strong>de Cursor</strong>: copiez la commande depuis la section « <a href="#full-prompt">Commande complète</a> » et enregistrez-la dans le dossier « <code translate="no">.cursor/rules/</code> » de votre projet.</p>
<h2 id="Full-prompt" class="common-anchor-header">Prompt complet<button data-href="#Full-prompt" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
