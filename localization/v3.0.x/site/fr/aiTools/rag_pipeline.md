...
summary: >-
  Règles pour les assistants de codage IA pour construire des pipelines RAG avec
  Milvus.
---
<h1 id="RAG-Pipeline" class="common-anchor-header">Pipeline RAG<button data-href="#RAG-Pipeline" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Règles de bout en bout pour construire des pipelines RAG avec Milvus, y compris l'ingestion, le regroupement, l'intégration, la récupération hybride avec BM25 et les mises à jour de documents avec upsert. Copiez l'invite complète ci-dessous dans votre outil d'IA pour appliquer ces règles automatiquement. Pour une vue d'ensemble de toutes les invites, voir <a href="/docs/fr/milvus_for_agents.md">Invites AI</a>.</p>
