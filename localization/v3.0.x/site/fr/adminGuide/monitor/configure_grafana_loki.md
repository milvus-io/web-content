...
<ul>
<li>Déployer <a href="https://grafana.com/docs/loki/latest/get-started/overview/">Loki</a> et <a href="https://grafana.com/docs/alloy/latest/">Alloy</a> sur un cluster Milvus à l'aide de Helm.</li>
<li>Configurer le stockage d'objets pour Loki.</li>
<li>Interroger les journaux à l'aide de Grafana.</li>
</ul>
<p>Pour référence, <a href="https://grafana.com/docs/loki/latest/send-data/promtail/#promtail-agent">Promtail</a> sera déprécié. Nous présentons donc Alloy, qui a été officiellement suggéré par Grafana Labs comme le nouvel agent pour collecter les journaux Kubernetes et les transmettre à Loki.</p>
