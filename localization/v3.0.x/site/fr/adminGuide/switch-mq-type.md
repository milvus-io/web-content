...
title: Changement de file d'attente de messages
summary: >-
  Basculer un déploiement Milvus existant entre Woodpecker et une autre file
  d'attente de messages sans interruption de service.
---
<h1 id="Switch-Message-Queue" class="common-anchor-header">Changement de file d'attente de messages<button data-href="#Switch-Message-Queue" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><strong>La fonctionnalité de changement de file d’attente de messages est disponible dans Milvus 3.0 et les versions ultérieures.</strong> Mettez à niveau votre instance Milvus vers la version 3.0 ou une version ultérieure avant de l’utiliser — cette fonctionnalité n’est pas disponible dans les versions antérieures.</li>
...
<tr><td>Woodpecker (MinIO)</td><td>Pulsar (externe)</td><td>Cluster (Helm / Operator)</td><td><strong>Pris en charge</strong></td></tr>
