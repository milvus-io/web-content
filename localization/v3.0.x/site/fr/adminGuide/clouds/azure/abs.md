---
id: abs.md
title: Configuration de l'accès au stockage Blob par identité de charge de travail
related_key: 'blob storage, workload identity, iam'
summary: Découvrez comment configurer le stockage Blob avec Workload Identity.
---
<h1 id="Configure-Blob-Storage-Access-by-Workload-Identity" class="common-anchor-header">Configuration de l'accès au stockage Blob par identité de charge de travail<button data-href="#Configure-Blob-Storage-Access-by-Workload-Identity" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Cette rubrique explique comment configurer l'accès au stockage Azure Blob par identité de charge de travail lorsque vous installez Milvus avec helm. Pour plus de détails, reportez-vous à <a href="https://azure.github.io/azure-workload-identity/docs/introduction.html">Identité de charge de travail</a>.</p>
...
<ul>
<li>Mettre à jour un cluster AKS avec OIDC Issuer et Workload Identity.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Obtenir l'URL de l'émetteur OIDC.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Créer une identité gérée attribuée à l'utilisateur et attribuer un rôle.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Établir un justificatif d'identité fédéré entre l'identité et l'émetteur et le sujet du compte de service.</li>
</ul>
