...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Mise à niveau de Milvus Standalone avec Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Ce guide décrit comment mettre à niveau votre déploiement Milvus autonome de la version 2.5.x à la version 3.0-beta à l'aide de Docker Compose.</p>
...
<p>Pour des raisons de sécurité, Milvus met à niveau son MinIO vers RELEASE.2024-12-18T13-15-44Z avec la sortie de la v3.0-beta.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v30-beta" class="common-anchor-header">Étape 2 : Mise à niveau vers la version 3.0-beta<button data-href="#Step-2-Upgrade-to-v30-beta" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Une fois que la version 2.5.16 fonctionne correctement, passez à la version 3.0-beta :</p>
<ol>
