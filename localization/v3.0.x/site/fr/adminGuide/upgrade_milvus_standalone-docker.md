...
summary: >-
  Découvrez comment mettre à niveau la version autonome de Milvus à l'aide de
  Docker Compose.
...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Mise à niveau de Milvus en mode autonome avec Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Ce guide décrit comment mettre à niveau un déploiement autonome de Milvus 2.6.x vers la version 3.0.1 à l'aide de Docker Compose.</p>
<div class="alert note">
<p>Cette procédure a été validée avec la configuration officielle de Docker Compose pour Milvus 2.6.20 en mode autonome. La mise à niveau a conservé etcd, MinIO, Woodpecker et les répertoires de données existants, et n’a modifié que l’image Milvus pour passer à <code translate="no">milvusdb/milvus:v3.0.1</code>.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Vérifiez que le service <code translate="no">standalone</code> fonctionne correctement, que son image est <code translate="no">milvusdb/milvus:v3.0.1</code> et que les collections existantes restent consultables et recherchables. Effectuez ces vérifications avant d’activer toute fonctionnalité spécifique à la version 3.0.1.</p>
