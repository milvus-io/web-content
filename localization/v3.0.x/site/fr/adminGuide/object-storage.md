...
<h1 id="Object-Storage" class="common-anchor-header">Stockage d'objets<button data-href="#Object-Storage" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus stocke les fichiers d’index et les journaux binaires — qui constituent l’essentiel de ses données — dans un système de stockage objet. Milvus prend en charge MinIO ainsi qu’une gamme de systèmes de stockage objet compatibles S3 et cloud.</p>
