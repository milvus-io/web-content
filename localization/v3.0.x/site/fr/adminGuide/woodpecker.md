...
<ul>
<li>Contrôle les politiques de synchronisation, de vidage, de compaction et de lecture des segments de journal. Il s'agit des principaux paramètres permettant d'ajuster le débit et la latence.</li>
</ul></li>
