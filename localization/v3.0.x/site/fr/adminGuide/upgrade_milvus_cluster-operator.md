...
<h2 id="Before-you-start" class="common-anchor-header">Avant de commencer<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v30-beta" class="common-anchor-header">Nouveautés de la version 3.0-beta<button data-href="#Whats-new-in-v30-beta" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Ce processus de mise à niveau garantit une migration correcte vers la nouvelle architecture. Pour plus d’informations sur les changements d’architecture, consultez <a href="/docs/fr/architecture_overview.md">la présentation de l’architecture de Milvus</a>.</p>
...
<li>Vous <strong>devez</strong> effectuer une mise à niveau vers la version v2.5.16 ou ultérieure avec l'option « <code translate="no">mixCoord</code> » activée avant de passer à la version v3.0-beta.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v30-beta" class="common-anchor-header">2.3 Mise à niveau vers la version v3.0-beta</h4><p>Une fois que la version 2.5.16 fonctionne correctement avec l’option « <code translate="no">mixCoord</code> », effectuez la mise à niveau vers la version 3.0-beta :</p>
...
<h2 id="Verify-the-upgrade" class="common-anchor-header">Vérifiez la mise à niveau<button data-href="#Verify-the-upgrade" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Vérifiez que votre cluster exécute bien la nouvelle version :</p>
