...
<ul>
<li><a href="/docs/fr/manage-collections.md">Gérer des collections</a></li>
...
<li><p>Découvrez la documentation <a href="/api-reference/java/v3.0.x/About.md">de référence de l'API Java de Milvus</a></p></li>
</ul>
