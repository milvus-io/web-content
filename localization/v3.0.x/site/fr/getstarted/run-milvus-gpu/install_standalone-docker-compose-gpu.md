...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>Si vous ne parvenez pas à exécuter la commande ci-dessus, vérifiez si Docker Compose V1 est installé sur votre système. Si c’est le cas, il est recommandé de migrer vers Docker Compose V2, conformément aux remarques figurant sur <a href="https://docs.docker.com/compose/">cette page</a>.</p>
</div>
