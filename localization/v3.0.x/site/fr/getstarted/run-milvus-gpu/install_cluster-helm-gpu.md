...
<div class="alert note">
<p>Le référentiel Helm Charts de Milvus disponible à l'adresse <code translate="no">https://milvus-io.github.io/milvus-helm/</code> a été archivé. Vous pouvez désormais obtenir les mises à jour sur <code translate="no">https://zilliztech.github.io/milvus-helm/</code> comme suit :</p>
...
<h3 id="2-Assign-multiple-GPU-devices" class="common-anchor-header">2. Attribuer plusieurs cartes GPU<button data-href="#2-Assign-multiple-GPU-devices" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <div class="alert note">
    <ul>
     ...
     <code translate="no">helm install my-release milvus/milvus --set pulsar.bookkeeper.pdb.usePolicy=false,pulsar.broker.pdb.usePolicy=false,pulsar.proxy.pdb.usePolicy=false,pulsar.zookeeper.pdb.usePolicy=false</code></li> 
      <li>Pour plus d’informations, consultez les sections « <a href="https://artifacthub.io/packages/helm/milvus/milvus">Milvus Helm Chart</a> » et « <a href="https://helm.sh/docs/">Helm</a> ».</li>
    </ul>
  </div>
</li>
