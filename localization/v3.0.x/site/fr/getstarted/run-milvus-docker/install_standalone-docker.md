...
<p><strong>Nouveautés de la version 3.0.2 :</strong></p>
<ul>
...
<h2 id="Upgrade-Milvus" class="common-anchor-header">Mise à niveau de Milvus<button data-href="#Upgrade-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Vous pouvez effectuer la mise à niveau vers la dernière version de Milvus à l’aide de la commande de mise à niveau intégrée. Cela permet de télécharger automatiquement la dernière configuration et l’image Milvus :</p>
