...
<h1 id="Install-Milvus-Standalone-with-RPMDEB-Package" class="common-anchor-header">Installation de Milvus en mode autonome à l'aide d'un paquet RPM/DEB<button data-href="#Install-Milvus-Standalone-with-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Cette page explique comment installer Milvus Standalone à l'aide d'un paquet RPM/DEB précompilé.</p>
...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Télécharger le paquet RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Vous pouvez télécharger le paquet RPM/DEB correspondant à l'architecture de votre système depuis la <a href="https://github.com/milvus-io/milvus/releases/tag/v3.0.1">page « Milvus Releases</a> ».</p>
<ul>
<li>Pour x86_64/amd64, téléchargez le paquet <strong>milvus_3.0.1-1_amd64.deb</strong> ou <strong>milvus_3.0.1-1_amd64.rpm</strong>.</li>
<li>Pour ARM64, téléchargez le paquet <strong>milvus_3.0.1-1_arm64.deb</strong> ou <strong>milvus_3.0.1-1_arm64.rpm</strong>.</li>
</ul>
...
<p>Par défaut, Milvus Standalone utilise <strong>Woodpecker</strong> (système de fichiers local) comme file d'attente de messages avec etcd intégré ; aucun service externe de messagerie ou de métadonnées n'est donc nécessaire. Voir <a href="/docs/fr/woodpecker.md">Woodpecker</a>.</p>
</div>
