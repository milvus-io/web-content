...
<p>Avant d’activer Storage V3, tenez compte du comportement suivant des données :</p>
<ul>
...
<li><a href="/docs/fr/upgrade_milvus_standalone-helm.md">Mise à niveau de Milvus Standalone avec Helm Chart</a></li>
