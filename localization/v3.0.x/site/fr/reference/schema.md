...
<p>Pour plus de détails, consultez les sections « <a href="/docs/fr/primary-field.md">Champ primaire » et « AutoId</a> ».</p>
...
<p>Un champ vectoriel de ce type contient une liste de 0 et de 1. Ces valeurs servent de caractéristiques compactes pour représenter les données dans des scénarios de traitement d’images et de recherche d’informations.</p></li>
