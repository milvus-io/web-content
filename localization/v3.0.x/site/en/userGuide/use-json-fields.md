...
<h3 id="Basic-Operators-in-JSON-Fields" class="common-anchor-header">Basic Operators in JSON Fields<button data-href="#Basic-Operators-in-JSON-Fields" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>The following table assumes that the value of a JSON field named <code translate="no">json_key</code> has a key named <code translate="no">A</code>. Use it as a reference when constructing boolean expressions using JSON field keys.</p>
<table>
<thead>
...
<h3 id="Advanced-Operators" class="common-anchor-header">Advanced Operators<button data-href="#Advanced-Operators" class="anchor-icon" translate="no">
    ...
    </button></h3><p>The following operators are specific to JSON fields:</p>
<ul>
