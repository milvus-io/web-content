...
<h2 id="Create-Partitions" class="common-anchor-header">Create Partitions<button data-href="#Create-Partitions" class="anchor-icon" translate="no">
    ...
    </button></h2><p>You can add more partitions to the collection. A collection can have up to 4,096 partitions.</p>
<div class="language-python">
...
<h3 id="Get-Load-Status" class="common-anchor-header">Get Load Status<button data-href="#Get-Load-Status" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
