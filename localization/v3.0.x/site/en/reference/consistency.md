...
<h3 id="Strong" class="common-anchor-header">Strong<button data-href="#Strong" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Strong is the highest and the most strict level of consistency. It ensures that users can read the latest version of data.</p>
<p>
...
<h3 id="Bounded-staleness" class="common-anchor-header">Bounded staleness<button data-href="#Bounded-staleness" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Bounded staleness, as its name suggests, allows data inconsistency during a certain period of time. However, generally, the data are always globally consistent out of that period of time.</p>
<p>
  <span class="img-wrapper">
...
<h3 id="Session" class="common-anchor-header">Session<button data-href="#Session" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Session ensures that all data writes can be immediately perceived in reads during the same session. In other words, when you write data via one client, the newly inserted data instantaneously become searchable.</p>
<p>
  <span class="img-wrapper">
...
<h3 id="Eventually" class="common-anchor-header">Eventually<button data-href="#Eventually" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
