...
Milvus CDC replicates data changes from one Milvus cluster to another for primary-standby disaster recovery. For details, refer to <a href="/docs/milvus_cdc_overview.md">Milvus CDC</a>.</p></li>
