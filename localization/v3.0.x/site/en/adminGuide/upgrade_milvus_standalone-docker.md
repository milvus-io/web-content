...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Upgrade Milvus Standalone with Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>This guide describes how to upgrade your Milvus standalone deployment from v2.5.x to v3.0-beta using Docker Compose.</p>
...
<p>Due to security concerns, Milvus upgrades its MinIO to RELEASE.2024-12-18T13-15-44Z with the release of v3.0-beta.</p>
</div>
...
<h3 id="Step-2-Upgrade-to-v30-beta" class="common-anchor-header">Step 2: Upgrade to v3.0-beta<button data-href="#Step-2-Upgrade-to-v30-beta" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Once v2.5.16 is running successfully, upgrade to v3.0-beta:</p>
<ol>
