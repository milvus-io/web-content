...
<h1 id="Upgrade-Milvus-Standalone-with-Docker-Compose" class="common-anchor-header">Upgrade Milvus Standalone with Docker Compose<button data-href="#Upgrade-Milvus-Standalone-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h1><p>This guide describes how to upgrade a Milvus 2.6.x standalone deployment to v3.0.1 with Docker Compose.</p>
<div class="alert note">
<p>This procedure has been validated with the official Milvus 2.6.20 standalone Docker Compose configuration. The upgrade retained etcd, MinIO, Woodpecker, and the existing data directories, and changed only the Milvus image to <code translate="no">milvusdb/milvus:v3.0.1</code>.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Verify that the <code translate="no">standalone</code> service is healthy, its image is <code translate="no">milvusdb/milvus:v3.0.1</code>, and the existing collections remain queryable and searchable. Complete these checks before you enable any v3.0.1-specific feature.</p>
