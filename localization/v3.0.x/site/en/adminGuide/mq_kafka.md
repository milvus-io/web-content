...
<button class="copy-code-btn"></button></code></pre>
<p>For SASL/SSL authentication details, see <a href="/docs/connect_kafka_ssl.md">Connect to Kafka with SASL/SSL</a>.</p>
