...
<h3 id="Option-1-Using-Cursor-Settings-UI" class="common-anchor-header">Option 1: Using Cursor Settings UI<button data-href="#Option-1-Using-Cursor-Settings-UI" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Option-2-Using-Project-specific-Configuration-Recommended" class="common-anchor-header">Option 2: Using Project-specific Configuration (Recommended)<button data-href="#Option-2-Using-Project-specific-Configuration-Recommended" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="For-Cursor" class="common-anchor-header">For Cursor<button data-href="#For-Cursor" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="🔍-Search-and-Query-Tools" class="common-anchor-header">🔍 Search and Query Tools<button data-href="#🔍-Search-and-Query-Tools" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="📁-Collection-Management" class="common-anchor-header">📁 Collection Management<button data-href="#📁-Collection-Management" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="📊-Data-Operations" class="common-anchor-header">📊 Data Operations<button data-href="#📊-Data-Operations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="⚙️-Index-Management" class="common-anchor-header">⚙️ Index Management<button data-href="#⚙️-Index-Management" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Examples" class="common-anchor-header">Examples<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Using-Claude-Desktop" class="common-anchor-header">Using Claude Desktop<button data-href="#Using-Claude-Desktop" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><h4 id="Example-1-Listing-Collections" class="common-anchor-header">Example 1: Listing Collections</h4><pre><code translate="no">What are the collections <span class="hljs-selector-tag">I</span> have in my Milvus DB?
<button class="copy-code-btn"></button></code></pre>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Using-Cursor" class="common-anchor-header">Using Cursor<button data-href="#Using-Cursor" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><h4 id="Example-Creating-a-Collection" class="common-anchor-header">Example: Creating a Collection</h4><p>In Cursor’s Composer, you can ask:</p>
...
<h2 id="Troubleshooting" class="common-anchor-header">Troubleshooting<button data-href="#Troubleshooting" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Common-Issues" class="common-anchor-header">Common Issues<button data-href="#Common-Issues" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><h4 id="Connection-Errors" class="common-anchor-header">Connection Errors</h4><p>If you see errors like "Failed to connect to Milvus server":</p>
<ol>
...
<h3 id="Getting-Help" class="common-anchor-header">Getting Help<button data-href="#Getting-Help" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>If you continue to experience issues:</p>
<ol>
