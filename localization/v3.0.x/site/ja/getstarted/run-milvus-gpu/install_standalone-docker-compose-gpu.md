...
<h3 id="1-Download-and-configure-the-YAML-file" class="common-anchor-header">1. YAML ファイルをダウンロードして設定する<button data-href="#1-Download-and-configure-the-YAML-file" class="anchor-icon" translate="no">
    ...
    </button></h3><p>ダウンロード <a href="https://github.com/milvus-io/milvus/releases/download/v3.0.2/milvus-standalone-docker-compose-gpu.yml"><code translate="no">milvus-standalone-docker-compose-gpu.yml</code></a> 手動で、または以下のコマンドを使用してダウンロードし、docker-compose.ymlという名前で保存してください。</p>
...
<ol>
<li><p>次のコマンドを使用して、Milvus コンテナからローカルマシンに `<code translate="no">milvus.yaml</code> ` をコピーします。<code translate="no">&lt;milvus_container_id&gt;</code> を実際の Milvus コンテナ ID に置き換えてください。</p>
...
<li><p><a href="/docs/ja/milvus-webui.md">Milvus WebUI</a>を確認して、Milvusインスタンスについてさらに詳しく学びましょう。</p></li>
...
<li><p>Milvusデータのバックアップに役立つオープンソースツール「<a href="/docs/ja/milvus_backup_overview.md">Milvus Backup</a>」をご覧ください。</p></li>
