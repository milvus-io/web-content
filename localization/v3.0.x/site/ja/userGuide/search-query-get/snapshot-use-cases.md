...
<h2 id="Data-backup-and-restoration" class="common-anchor-header">データのバックアップと復元<button data-href="#Data-backup-and-restoration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>スナップショットは、データの特定の時点の状態を素早く取得したイメージであり、迅速なロールバックやテスト（数日から数週間）に適しています。一方、バックアップは独立した完全なコピーであり、長期的な災害復旧（数週間から数年）や、ストレージ全体の障害に対するより強力な保護を目的として、別途保存されます。</p>
