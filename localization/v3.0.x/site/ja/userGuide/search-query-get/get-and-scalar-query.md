...
<h3 id="Step-1-Create-a-collection" class="common-anchor-header">ステップ1: コレクションの作成<button data-href="#Step-1-Create-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Insert-randomly-generated-entities" class="common-anchor-header">ステップ2：ランダムに生成されたエンティティを挿入する<button data-href="#Step-2-Insert-randomly-generated-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Create-partitions-and-insert-more-entities" class="common-anchor-header">ステップ3：パーティションの作成とエンティティの挿入<button data-href="#Step-3-Create-partitions-and-insert-more-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Get-entities-from-partitions" class="common-anchor-header">パーティションからエンティティを取得する<button data-href="#Get-entities-from-partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>特定のパーティションからエンティティを取得することもできます。</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<h3 id="Count-entities" class="common-anchor-header">エンティティのカウント<button data-href="#Count-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Reference-on-scalar-filters" class="common-anchor-header">スカラー・フィルタのリファレンス<button data-href="#Reference-on-scalar-filters" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Basic-Operators" class="common-anchor-header">基本演算子<button data-href="#Basic-Operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><strong>ブール式は</strong>常に<strong>、フィールド名を演算子で結合した文字列</strong>です。このセクションでは、基本的な演算子について学びます。</p>
<table>
<thead>
...
<h3 id="Advanced-operators" class="common-anchor-header">高度な演算子<button data-href="#Advanced-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
