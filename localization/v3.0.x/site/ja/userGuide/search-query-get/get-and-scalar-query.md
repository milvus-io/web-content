...
title: クエリー
summary: Query、Get、QueryIteratorを使用して、Milvusのエンティティを取得し、メタデータをフィルタリングします。
---
...
<table>
   ...
   <tr>
     ...
     <td><p>カスタム・フィルタリング条件を満たすすべてのエンティティまたは指定された数のエンティティを検索する。</p></td>
...
<p>以下の例では、クエリー操作にタイムゾーンを一時的に設定する方法を示します：</p>
<div class="multipleCode">
