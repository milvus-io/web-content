...
<tbody>
<tr><td><code translate="no">tokenann</code></td><td>各行内の個々のベクトル</td><td>元のベクトルを保持し、圧縮による損失を回避できる。</td><td>品質を優先した検索、短・中程度の埋め込みリスト、識別力の高い埋め込み。</td><td>インデックスが大きくなり、候補の検索コストが高くなる。</td></tr>
