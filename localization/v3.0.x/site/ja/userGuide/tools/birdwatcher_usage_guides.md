...
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-sessions" class="common-anchor-header">セッションの一覧表示<button data-href="#List-sessions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Milvusの様々なコンポーネントに関連するセッションをリストアップする：</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>コマンド出力では、<code translate="no">show session</code> によってリストされた各セッションエントリが、現在アクティブで<strong>etcd</strong> に登録されているノードまたはサービスに対応します。</p>
<h3 id="Check-databases-and-collections" class="common-anchor-header">データベースとコレクションの確認<button data-href="#Check-databases-and-collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>すべてのデータベースとコレクションをリストアップできます。</p>
<ul>
<li><p>データベースのリスト</p>
...
<h3 id="Check-index-details" class="common-anchor-header">インデックスの詳細をチェック<button data-href="#Check-index-details" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>以下のコマンドを実行すると、全てのインデックスファイルの詳細がリストアップされます。</p>
...
==================================================================
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-partitions" class="common-anchor-header">パーティションのリスト<button data-href="#List-partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>以下のコマンドを実行すると、特定のコレクション内のすべてのパーティションをリストアップします。</p>
...
--- Total Database(s): 1
<button class="copy-code-btn"></button></code></pre>
<h3 id="Check-channel-status" class="common-anchor-header">チャネルステータスの確認<button data-href="#Check-channel-status" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>以下のコマンドを実行して、チャネルのステータスを表示します。</p>
...
--- Total Channels: 1
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-all-replicas-and-segments" class="common-anchor-header">すべてのレプリカとセグメントをリストする<button data-href="#List-all-replicas-and-segments" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="List-configurations" class="common-anchor-header">設定の一覧表示<button data-href="#List-configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>BirdwatcherにMilvusの各コンポーネントの現在の設定を一覧表示させることができます。</p>
...
<h3 id="Probe-collection-with-known-primary-key" class="common-anchor-header">既知の主キーを持つコレクションのプローブ<button data-href="#Probe-collection-with-known-primary-key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><code translate="no">probe</code> コマンドでは、<code translate="no">pk</code> フラグで主キーを指定し、<code translate="no">collection</code> フラグでコレクション ID を指定します。</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Probe-all-collections-with-mock-queries" class="common-anchor-header">モッククエリですべてのコレクションをプローブする<button data-href="#Probe-all-collections-with-mock-queries" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Birdwatcherにモッククエリで全てのコレクションをプローブさせることもできます。</p>
