...
<p>始める前に、<a href="/docs/ja/milvus_cdc_overview.md">Milvus CDCを</a>読んで、プライマリ-スタンバイ・モデルとフェイルオーバー・オプションを理解してください。</p>
...
<button class="copy-code-btn"></button></code></pre>
<p><code translate="no">source-cluster-milvus-cdc-...</code> などのCDCポッドが<code translate="no">Running</code> の状態になっていることを確認します。</p>
...
<h3 id="Can-I-change-pchannels-after-replication-is-configured" class="common-anchor-header">レプリケーション設定後にpchannelを変更できますか?<button data-href="#Can-I-change-pchannels-after-replication-is-configured" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
