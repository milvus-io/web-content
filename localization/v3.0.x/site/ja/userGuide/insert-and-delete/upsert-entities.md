...
<p>マージモードでupsertを実行する場合は、要求に関係するエンティティが同じフィールドセットを持つことを確 認してください。次のコード・スニペットに示すように、upsert するエンティティが 2 つ以上あるとすると、エラーを防いでデータの整合性を維持するために、それらのエンティティに同じフィールドが含まれていることが重要です。</p>
</div>
<div class="multipleCode">
