...
<tr><td><code translate="no">keep_separate_first_letter</code></td><td>ブール値ソーストークンごとに、結合されたピンイントークンを出力します。たとえば、xml-ph-0000@deepl.internal は xml-ph-0001@deepl.internal を出力します。</td><td><code translate="no">false</code></td><td>各ソーストークンに対して、ピンインの頭文字からなるトークンを出力します。たとえば、<code translate="no">中文</code> は<code translate="no">zw</code> を生成します。</td></tr>
</tbody>
</table>
