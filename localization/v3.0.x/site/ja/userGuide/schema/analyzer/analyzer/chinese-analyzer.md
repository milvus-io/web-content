...
<h3 id="Configuration" class="common-anchor-header">設定<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h3><p><code translate="no">chinese</code> アナライザーをフィールドに適用するには、<code translate="no">analyzer_params</code> 内で<code translate="no">type</code> を<code translate="no">chinese</code> に設定するだけです。</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
