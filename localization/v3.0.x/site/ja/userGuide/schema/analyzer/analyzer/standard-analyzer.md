...
<h2 id="Configuration" class="common-anchor-header">設定<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p><code translate="no">standard</code> アナライザーをフィールドに適用するには、<code translate="no">analyzer_params</code> 内で<code translate="no">type</code> を<code translate="no">standard</code> に設定し、必要に応じてオプションパラメータを含めるだけです。</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
...
<h3 id="Analyzer-configuration" class="common-anchor-header">アナライザ設定<button data-href="#Analyzer-configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
