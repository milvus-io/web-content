...
<li><strong>MQ切り替え機能は、Milvus 3.0以降で利用可能です。この機能</strong>を使用する前に、MilvusインスタンスをMilvus 3.0以降にアップグレードしてください<strong>。</strong>以前のバージョンではこの機能は利用できません。</li>
...
<tbody>
<tr><td>RocksMQ</td><td>Woodpecker (ローカル/MinIO)</td><td>スタンドアロン (Docker Compose)</td><td><strong>対応</strong></td></tr>
