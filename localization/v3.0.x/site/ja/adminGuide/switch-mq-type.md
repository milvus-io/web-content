...
<p>この機能はリリース予定であり、変更される可能性があります。試用をご希望の場合やご質問がある場合は、Milvusサポートまでお問い合わせください。</p>
</div>
...
<p>切り替えを行う前に、ターゲット MQ に、現在の Milvus インスタンスで使用されているものと同じ名前のトピックが含まれていないことを確認してください。ターゲット MQ が別の Milvus インスタンスで使用されていた場合は、トピック名の競合により予期しない動作を引き起こす可能性があるため、この確認が特に重要です。</p>
</div>
