...
<li>AIアシスタントは、Milvusコードの生成またはレビュー時に、これらのルールを自動的に適用します。</li>
</ol>
<p><strong>Cursor</strong>ユーザーの場合：「<a href="#full-prompt">完全なプロンプト</a>」セクションからプロンプトをコピーし、プロジェクト内の `<code translate="no">.cursor/rules/</code> ` に保存してください。</p>
