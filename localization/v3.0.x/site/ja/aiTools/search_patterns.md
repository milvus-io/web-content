...
title: プロンプトmilvus検索パターン
summary: Milvusで検索、ハイブリッド検索、全文検索を実装するためのAIコーディングアシスタントのルール。
---
<h1 id="Search-Patterns" class="common-anchor-header">検索パターン<button data-href="#Search-Patterns" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Milvusで類似検索、ハイブリッド検索、フィルター検索、全文検索を実装するためのルールです。AnnSearchRequestの制約やランカーの使い方も含みます。以下のプロンプトをAIツールにコピーすると、これらのルールが自動的に適用されます。すべてのプロンプトの概要については、<a href="/docs/ja/milvus_for_agents.md">AIプロンプトを</a>参照してください。</p>
