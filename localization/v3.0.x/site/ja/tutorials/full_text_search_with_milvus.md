...
summary: >-
  Milvus2.5のリリースにより、全文検索はキーワードやフレーズに基づいて効率的にテキストを検索することができるようになり、強力なテキスト検索機能を提供します。この機能は検索精度を向上させ、埋め込みベースの検索とシームレスに組み合わせてハイブリッド検索を行うことができ、1つのクエリでセマンティック検索とキーワードベースの検索結果の両方を得ることができます。このノートでは、milvusの全文検索の基本的な使い方を紹介します。
title: Milvusによる全文検索
---
...
<h1 id="Full-Text-Search-with-Milvus" class="common-anchor-header">Milvusによる全文検索<button data-href="#Full-Text-Search-with-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus2.5のリリースにより、全文検索はキーワードやフレーズに基づいた効率的なテキスト検索を可能にし、強力なテキスト検索機能を提供します。この機能は検索精度を向上させ、埋め込みベースの検索とシームレスに組み合わせてハイブリッド検索を行うことができ、1つのクエリでセマンティック検索とキーワードベースの検索結果の両方を得ることができます。このノートでは、milvusの全文検索の基本的な使い方を紹介します。</p>
<h2 id="Preparation" class="common-anchor-header">準備<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Download-the-dataset" class="common-anchor-header">データセットのダウンロード<button data-href="#Download-the-dataset" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>以下のコマンドでAnthropic<a href="https://github.com/anthropics/anthropic-cookbook/blob/main/skills/contextual-embeddings/guide.ipynb">デモで</a>使用したサンプルデータをダウンロードします。</p>
...
<h3 id="Install-Milvus-25" class="common-anchor-header">Milvus2.5のインストール<button data-href="#Install-Milvus-25" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>詳細は<a href="https://milvus.io/docs/install_standalone-docker-compose.md">公式のインストールガイドを</a>参照してください。</p>
<h3 id="Install-PyMilvus" class="common-anchor-header">PyMilvusのインストール<button data-href="#Install-PyMilvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>以下のコマンドを実行し、PyMilvusをインストールする：</p>
<pre><code translate="no" class="language-python">pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span> -U 
<button class="copy-code-btn"></button></code></pre>
<h3 id="Define-the-Retriever" class="common-anchor-header">Retrieverの定義<button data-href="#Define-the-Retriever" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Insert-the-data" class="common-anchor-header">データの挿入<button data-href="#Insert-the-data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Test-Sparse-Search" class="common-anchor-header">スパース探索のテスト<button data-href="#Test-Sparse-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
