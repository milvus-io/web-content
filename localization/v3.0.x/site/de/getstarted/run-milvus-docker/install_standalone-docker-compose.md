...
<p><strong>Was ist neu in v3.0-beta:</strong></p>
<ul>
...
<p>Laden Sie immer die neueste Konfiguration von Docker Compose herunter, um die Kompatibilität mit den Funktionen von v3.0-beta zu gewährleisten.</p>
<ul>
