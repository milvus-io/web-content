...
<p>Snapshots sind schnelle Momentaufnahmen von Daten, die sich für schnelle Rollbacks oder Tests eignen (<strong>Tage bis Wochen</strong>). Im Gegensatz dazu sind Backups eigenständige, vollständige Kopien, die separat für die langfristige Notfallwiederherstellung (<strong>Wochen bis Jahre</strong>) und zum besseren Schutz vor einem totalen Speicherausfall gespeichert werden.</p>
...
<li>Snapshots sind nach ihrer Erstellung unveränderlich.</li>
...
<li><a href="/docs/de/snapshot-use-cases.md">Anwendungsfälle für Snapshots</a> – gängige Muster und Workflows.</li>
