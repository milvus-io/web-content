...
<p>Wenn Ihre Anwendung einen bestimmten Analyzer benötigt, konfigurieren Sie ihn mit dem Parameter <code translate="no">analyzer_params</code>. So konfigurieren Sie z. B. den Analysator <code translate="no">english</code> für den Phrasenabgleich in englischem Text:</p>
