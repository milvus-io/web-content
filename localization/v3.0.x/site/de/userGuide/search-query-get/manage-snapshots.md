...
<p>Die folgenden Code-Beispiele gehen davon aus, dass Sie bereits über eine Sammlung mit dem Namen „ <code translate="no">my_collection</code> “ verfügen.</p>
...
<h2 id="Restore-snapshot" class="common-anchor-header">Snapshot wiederherstellen<button data-href="#Restore-snapshot" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Sie können einen Snapshot in einer neuen Sammlung wiederherstellen. Dieser Vorgang läuft asynchron ab und gibt eine Job-ID zurück, mit der Sie den Fortschritt der Wiederherstellung verfolgen können.</p>
...
<li>Feld-IDs und Index-IDs beibehält, um die Kompatibilität mit bestehenden Datendateien sicherzustellen</li>
