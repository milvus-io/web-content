...
title: Suche nach PrimärschlüsselCompatible with Milvus 2.6.9+
summary: >-
  Bei der Durchführung von Ähnlichkeitssuchen werden Sie stets aufgefordert,
  einen oder mehrere Abfragevektoren anzugeben, selbst wenn diese bereits in der
  Zielsammlung vorhanden sind. Um das Abrufen von Vektoren vor der Suche zu
  vermeiden, können Sie stattdessen Primärschlüssel verwenden.
beta: Milvus 2.6.9+
---
<h1 id="Primary-Key-Search" class="common-anchor-header">Suche nach Primärschlüssel<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.6.9+</span><button data-href="#Primary-Key-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Bei der Durchführung von Ähnlichkeitssuchen werden Sie stets aufgefordert, einen oder mehrere Abfragevektoren anzugeben, selbst wenn diese bereits in der Zielsammlung vorhanden sind. Um das Abrufen von Vektoren vor der Suche zu vermeiden, können Sie stattdessen Primärschlüssel verwenden.</p>
<h2 id="Overview" class="common-anchor-header">Übersicht<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Auf E-Commerce-Plattformen können Nutzer ein Stichwort eingeben, um passende Produkte zu finden. Sobald der Nutzer eine Produktdetailseite aufruft, zeigt die Plattform am unteren Rand der Seite zusätzlich eine Liste ähnlicher Produkte an, damit Nutzer diese vergleichen können.</p>
<p>Die Empfehlungen werden nach ihrer Ähnlichkeit mit dem Suchbegriff oder dem aktuellen Produkt sortiert. Um dies zu erreichen, müssen Plattformentwickler vor der eigentlichen Ähnlichkeitssuche die Vektordarstellung des Suchbegriffs oder des aktuellen Produkts aus Milvus abrufen, was den Datenverkehr zwischen der Plattform und Milvus erhöht und dazu führt, dass eine große Anzahl hochdimensionaler Fließkommazahlen über das Netzwerk übertragen wird.</p>
<p>Um die Interaktionslogik zwischen Ihren Anwendungen und Milvus zu vereinfachen, die Anzahl der Round-Trips zu reduzieren und die Übertragung großer Mengen hochdimensionaler Gleitkommawerte über das Netzwerk zu vermeiden, sollten Sie die Verwendung von Primärschlüsselsuchen in Betracht ziehen.</p>
<p>Bei einer Primärschlüsselsuche müssen Sie keine Abfragevektoren angeben. Stattdessen werden Sie aufgefordert, die Primärschlüssel (<code translate="no">ids</code>) der Entitäten anzugeben, die die Abfragevektoren enthalten.</p>
...
<li><p>Suchen mit Primärschlüsseln gelten für alle Vektordatentypen, mit Ausnahme von spärlichen Vektorfeldern, die von VarChar-Feldern abgeleitet sind, wie beispielsweise in BM25-Funktionen.</p></li>
<li><p>Sie können Primärschlüssel anstelle von Abfragevektoren bei gefilterten Suchvorgängen, Bereichssuchen und Gruppierungssuchen verwenden, optional mit aktivierter Paginierung. Diese Funktion gilt jedoch nicht für hybride Suchvorgänge und Suchiteratoren.</p></li>
<li><p>Für Ähnlichkeitssuchen mit Einbettungslisten müssen Sie weiterhin die Abfragevektoren abrufen, diese in Einbettungslisten anordnen und die Suchen ausführen.</p></li>
<li><p>In RESTful-APIs können Sie keine Primärschlüssel anstelle von Abfragevektoren verwenden.</p></li>
<li><p>Bei nicht vorhandenen Primärschlüsseln oder solchen mit falschem Format gibt Milvus Fehlermeldungen aus.</p></li>
<li><p>Primärschlüssel und Abfragevektoren schließen sich gegenseitig aus. Die Angabe beider führt ebenfalls zu Fehlern.</p></li>
</ul>
...
<p>Die Primärschlüssel werden nicht zum Filtern verwendet, sondern dienen ausschließlich dem Abruf von Vektoren.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Example-2-Filtered-search-using-primary-keys" class="common-anchor-header">Beispiel 2: Gefilterte Suche mithilfe von Primärschlüsseln<button data-href="#Example-2-Filtered-search-using-primary-keys" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Das folgende Beispiel geht davon aus, dass „color“ und „likes“ zwei im Schema definierte Felder in der Zielsammlung sind.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Example-3-Range-search-using-primary-keys" class="common-anchor-header">Beispiel 3: Bereichssuche anhand von Primärschlüsseln<button data-href="#Example-3-Range-search-using-primary-keys" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Example-4-Grouping-search-using-primary-keys" class="common-anchor-header">Beispiel 4: Gruppierte Suche mithilfe von Primärschlüsseln<button data-href="#Example-4-Grouping-search-using-primary-keys" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Das folgende Beispiel geht davon aus, dass „ <code translate="no">docId</code> “ ein im Schema definiertes Feld in der Zielsammlung ist.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
