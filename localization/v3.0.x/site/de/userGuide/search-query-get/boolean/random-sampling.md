...
<ul>
<li><code translate="no">sampling_factor</code>: Ein Stichprobenfaktor im Bereich (0, 1), ohne Berücksichtigung der Grenzen. Zum Beispiel wählt <code translate="no">RANDOM_SAMPLE(0.001)</code> etwa 0,1 % der Ergebnisse aus.</li>
</ul>
...
<li><p>Der Stichprobenfaktor muss im Bereich (0, 1) liegen, wobei Grenzen ausgeschlossen sind.</p></li>
</ul>
<h2 id="Combine-with-other-filters" class="common-anchor-header">Kombinieren mit anderen Filtern<button data-href="#Combine-with-other-filters" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Der Zufallsstichproben-Operator muss mit anderen Filterausdrücken über die logische <code translate="no">AND</code> kombiniert werden. Bei der Kombination von Filtern wendet Milvus zunächst die anderen Bedingungen an und führt dann eine Zufallsstichprobe auf die Ergebnismenge durch.</p>
...
<h2 id="Examples" class="common-anchor-header">Beispiele<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Example-1-Data-exploration" class="common-anchor-header">Beispiel 1: Datenexploration<button data-href="#Example-1-Data-exploration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Schnelle Vorschau auf die Struktur Ihrer Sammlung:</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#go">Go</a> <a href="#javascript">NodeJS</a> <a href="#bash">cURL</a></div>
...
<pre><code translate="no" class="language-bash"><span class="hljs-comment"># restful</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Example-2-Combined-filtering-with-random-sampling" class="common-anchor-header">Beispiel 2: Kombinierte Filterung mit Stichproben<button data-href="#Example-2-Combined-filtering-with-random-sampling" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Testen Sie die Filterlogik an einer überschaubaren Teilmenge:</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#go">Go</a> <a href="#javascript">NodeJS</a> <a href="#bash">cURL</a></div>
...
<pre><code translate="no" class="language-bash"><span class="hljs-comment"># restful</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Example-3-Quick-analytics" class="common-anchor-header">Beispiel 3: Schnelle Analysen<button data-href="#Example-3-Quick-analytics" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Schnelle statistische Analysen auf gefilterten Daten durchführen:</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#go">Go</a> <a href="#javascript">NodeJS</a> <a href="#bash">cURL</a></div>
...
<pre><code translate="no" class="language-bash"><span class="hljs-comment"># restful</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Example-4-Combined-with-vector-search" class="common-anchor-header">Beispiel 4: Kombiniert mit Vektorsuche<button data-href="#Example-4-Combined-with-vector-search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Verwenden Sie Zufallsstichproben in gefilterten Suchszenarien:</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#go">Go</a> <a href="#javascript">NodeJS</a> <a href="#bash">cURL</a></div>
