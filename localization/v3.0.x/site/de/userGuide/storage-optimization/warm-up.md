...
summary: >-
  ...
  Cluster-, Sammlungs- oder individueller Feld-/Indexebene konfigurieren und so
  die Latenz bei der ersten Abfrage und die Ressourcennutzung genau steuern.
beta: Milvus 2.6.4+
---
...
<h3 id="Alter-warmup-settings-on-an-existing-collection" class="common-anchor-header">Ändern der Aufwärmeinstellungen für eine vorhandene Sammlung<button data-href="#Alter-warmup-settings-on-an-existing-collection" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Sie müssen die Eigenschaften einer Sammlung ändern, bevor Sie <code translate="no">load()</code> aufrufen. Das Ändern einer geladenen Sammlung gibt einen Fehler zurück. Änderungen an den Aufwärmeinstellungen werden beim nächsten Laden der Sammlung wirksam.</p>
...
<table>
   ...
   <tr>
     ...
     <td><p>Die Daten werden bei Bedarf aus dem Objektspeicher geholt und dann auf der Grundlage der mmap-Einstellung lokal zwischengespeichert.</p></td>
