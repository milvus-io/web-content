...
<li>Die Funktion muss genau ein nicht-nullfähiges Feld „ <code translate="no">VARCHAR</code> “ in „ <code translate="no">input_field_names</code> “ referenzieren.</li>
...
<h3 id="Option-1-Configuration-file" class="common-anchor-header">Option 1: Konfigurationsdatei<button data-href="#Option-1-Configuration-file" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Definieren Sie das Token im obersten Abschnitt „ <code translate="no">credential</code> “ und verweisen Sie den Hugging Face-Ranker-Anbieter auf das Anmeldeinformationen-Label:</p>
