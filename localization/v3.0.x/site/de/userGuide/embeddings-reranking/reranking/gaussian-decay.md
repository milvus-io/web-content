...
<p>Wenn Ihre Anwendung ein natürliches Gefühl der abnehmenden Relevanz ohne harte Strafen oder strenge Grenzwerte erfordert, ist der Gaußsche Zerfall wahrscheinlich die beste Wahl.</p>
...
<h3 id="Create-a-decay-ranker" class="common-anchor-header">Erstellen Sie einen Decay Ranker<button data-href="#Create-a-decay-ranker" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Nachdem Sie Ihre Sammlung mit einem numerischen Feld (in diesem Beispiel <code translate="no">distance</code> in Metern vom Benutzer) eingerichtet haben, erstellen Sie einen Gauß'schen Decay Ranker:</p>
