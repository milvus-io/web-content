...
<button class="copy-code-btn"></button></code></pre>
<p>Der Filter <code translate="no">cnalphanumonly</code> arbeitet mit den vom Tokenizer generierten Begriffen, muss also in Kombination mit einem Tokenizer verwendet werden. Eine Liste der in Milvus verfügbaren Tokenizer finden Sie auf <a href="/docs/de/jieba-tokenizer.md">Jieba</a> und den zugehörigen Seiten.</p>
