...
<h1 id="Stop" class="common-anchor-header">Stopp<button data-href="#Stop" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Der Filter „ <code translate="no">stop</code> “ entfernt angegebene Stoppwörter aus dem tokenisierten Text und hilft so dabei, häufig vorkommende, weniger aussagekräftige Wörter zu eliminieren. Sie können die Liste der Stoppwörter mithilfe des Parameters „ <code translate="no">stop_words</code> “ konfigurieren.</p>
