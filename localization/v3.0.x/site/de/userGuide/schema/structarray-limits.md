...
summary: >-
  Die Unterstützung für StructArray umfasst Schemadefinitionen, Einfügedaten,
...
<tr><td>Form einfügen</td><td>Fügen Sie ein StructArray-Feld als Array von Objekten ein. Verwenden Sie keine Pfadsyntax innerhalb von Einfüge-Payloads.</td></tr>
...
<tr><td><code translate="no">Array</code></td><td>Nicht unterstützt</td><td>Verwenden Sie „ <code translate="no">VARCHAR</code> “ anstelle von „ <code translate="no">String</code> “.</td></tr>
...
<tr><td>Nullbarkeitsanforderung für dynamisches Hinzufügen</td><td>Ein StructArray-Feld, das einer bestehenden Sammlung hinzugefügt wird, muss nullfähig sein, da bestehende Entitäten keinen Wert für das neue Feld haben.</td></tr>
<tr><td>Vorhandene Entitäten nach dem dynamischen Hinzufügen</td><td>Bestehende Entitäten geben für das hinzugefügte StructArray-Feld in allen seinen Unterfeldern „ <code translate="no">null</code> “ zurück.</td></tr>
</tbody>
</table>
...
<p>Beispiele für das Einfügen von nullfähigen „StructArray“-Feldern finden Sie unter <a href="/docs/de/insert-data-into-structarray-fields.md">„Daten in StructArray-Felder einfügen</a>“.</p>
...
<tr><td>Namen der Unterfelder</td><td>Verwenden Sie innerhalb jedes Struct-Objekts Unterfeldnamen wie <code translate="no">text</code> und <code translate="no">emb</code>, keine Pfade wie <code translate="no">chunks[text]</code>.</td></tr>
...
<p>StructArray-Vektor-Unterfelder zählen bei der Planung Ihres Sammlungsschemas als Vektor-Unterfelder. Halten Sie die Gesamtzahl der Vektorfelder und Vektor-Unterfelder innerhalb der Grenzen Ihrer Zielversion und Ihrer Service-Stufe ein.</p>
...
<tr><td>Bereichssuche</td><td>Wird entsprechend dem Suchmodus und der Index-/Metrikunterstützung der Zielversion unterstützt. Für das Verhalten bei der hybriden Bereichssuche bei StructArray-Anfragen auf Elementebene überprüfen Sie bitte Ihre Zielversion.</td></tr>
<tr><td>Gruppierte Suche</td><td>Die Gruppierungssuche auf Elementebene kann Offsets zurückgeben. Das Verhalten bei der hybriden Gruppierungssuche für StructArray-Anfragen auf Elementebene ist versionsabhängig.</td></tr>
...
<p>Auf einer übergeordneten Ebene gilt:</p>
<ul>
...
<li><p>Verwenden Sie keine Vektor-Teilfelder als Eingaben für skalare „ <code translate="no">$[...]</code> “-Prädikate.</p></li>
