...
<h1 id="StructArray" class="common-anchor-header">StructArray<button data-href="#StructArray" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Ein Feld Array of Structs oder ein StructArray-Feld in einer Entität speichert eine geordnete Menge von Struct-Elementen. Jede Struct im Array hat dasselbe vordefinierte Schema, das mehrere Vektoren und skalare Felder umfasst.</p>
...
<p>Für Details darüber, wie Milvus die Ähnlichkeit zwischen der Abfrage und einer Einbettungsliste berechnet, siehe <a href="/docs/de/metric.md#Maximum-similarity">Maximale Ähnlichkeit</a>.</p>
<p>Die skalaren Felder im Feld StructArray unterstützen die folgenden Indextypen:</p>
<ul>
<li><p><code translate="no">INVERTED</code></p>
<p>Dies gilt in der Regel für string-ähnliche oder kategoriale Filter, wie <code translate="no">structA[color]</code> oder <code translate="no">structA[str_val]</code>. Für Details, siehe <a href="/docs/de/inverted.md">INVERTED</a>.</p></li>
<li><p><code translate="no">STL_SORT</code></p>
<p>Dies gilt in der Regel für bereichs- oder ordnungsähnliche Beschleunigung auf numerische Werte, wie <code translate="no">strctA[num_val]</code>. Einzelheiten finden Sie unter <a href="/docs/de/stl-sort.md">STL_SORT</a>.</p></li>
</ul></li>
<li><p><strong>Upsert-Daten</strong></p>
<p>Strukturen unterstützen kein Upsert im Merge-Modus. Sie können jedoch Upserts im Override-Modus durchführen, um Daten in Structs zu aktualisieren. Einzelheiten zu den Unterschieden zwischen Upsert im Merge-Modus und im Override-Modus finden Sie unter <a href="/docs/de/upsert-entities.md#Overview">Upsert-Entitäten</a>.</p></li>
<li><p><strong>Skalare Filterung</strong></p>
<p>Sie können <strong>Elementfilter</strong> und <strong>Operatoren der Match-Familie</strong> verwenden, um eine skalare Filterung gegen ein skalares Unterfeld in einem StructArray-Feld durchzuführen. Details dazu finden Sie unter <a href="/docs/de/array-of-structs.md#Scalar-filtering-in-a-StructArray-field">Skalare Filterung in einem StructArray-Feld</a>.</p></li>
</ul>
...
<p>Die anwendbaren Index Parameter variieren je nach Index Typ. Einzelheiten zu den anwendbaren Indexparametern finden Sie unter <a href="/docs/de/index-explained.md">Index erklärt</a> und in der Dokumentation für den von Ihnen gewählten Indextyp.</p>
...
<h2 id="Scalar-filtering-in-a-StructArray-field" class="common-anchor-header">Skalare Filterung in einem StructArray-Feld<button data-href="#Scalar-filtering-in-a-StructArray-field" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Sie können <strong>Elementfilter</strong> und <strong>Operatoren der Match-Familie</strong> verwenden, um eine skalare Filterung gegen ein skalares Unterfeld in einem StructArray durchzuführen. Weitere Details und Beispiele zu den beiden obigen Operatortypen finden Sie unter <a href="/docs/de/struct-array-operators.md">Array of Structs Operatoren</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Sie können fast alle Vergleichs-, Bereichs- und arithmetischen Operatoren in dem Prädikat verwenden, das pro Element ausgewertet wird, und die logischen Operatoren können verwendet werden, um mehrere Bedingungen für dasselbe Element zu kombinieren. Einzelheiten finden Sie unter <a href="/docs/de/basic-operators.md">Grundlegende Operatoren</a>.</p>
