...
<h2 id="Basic-operations" class="common-anchor-header">Grundlegende Operationen<button data-href="#Basic-operations" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Der Arbeitsablauf für die Verwendung eines <code translate="no">GEOMETRY</code> Feldes umfasst die Definition des Feldes in Ihrem Sammlungsschema, das Einfügen geometrischer Daten und die anschließende Abfrage der Daten mit spezifischen Filterausdrücken.</p>
