...
<p>Auf dieser Seite erfahren Sie, wie Sie ein Struct-Schema definieren, es als StructArray-Feld hinzufügen, Unterfelder für spätere Such- und Filtervorgänge auswählen und die geltenden Schemaregeln verstehen, bevor Sie Daten einfügen oder indizieren.</p>
...
<tr><td><code translate="no">quality_score</code></td><td><code translate="no">FLOAT</code></td><td>Bewertung auf Chunk-Ebene, die in Beispielen zur skalaren Filterung und zum Bereich verwendet wird.</td></tr>
...
<p>Ein Vektorfeld oder Vektor-Teilfeld akzeptiert nur einen Index. Wenn Sie sowohl die EmbeddingList-Suche als auch die Suche auf Elementebene benötigen, definieren Sie zwei separate Vektor-Teilfelder. In diesem Beispiel dient „ <code translate="no">chunks[emb_list_vector]</code> “ der EmbeddingList-Suche und „ <code translate="no">chunks[emb]</code> “ der Suche auf Elementebene.</p>
</div>
...
<li><p>Erstellen Sie ein „Struct“-Schema für Elemente, die im „StructArray“-Feld gespeichert sind.</p></li>
...
<h2 id="Understand-StructArray-field-paths" class="common-anchor-header">StructArray-Feldpfade verstehen<button data-href="#Understand-StructArray-field-paths" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Nachdem Sie ein „StructArray“-Feld erstellt haben, verweisen Sie mit der „ <code translate="no">structArray[subfield]</code> “-Pfadsyntax auf dessen Unterfelder. Verwenden Sie diese Syntax, wenn Sie Indizes erstellen, Vektorunterfelder durchsuchen, Unterfelder ausgeben oder skalare Filter erstellen.</p>
<table>
<thead>
...
<tr><td>Ein Vektor-Unterfeld verfügt über einen Index.</td><td>Wenn Sie sowohl eine „EmbeddingList“-Suche als auch eine Suche auf Elementebene benötigen, erstellen Sie zwei separate Vektor-Unterfelder.</td></tr>
<tr><td>Vorhandene „StructArray“-Unterfelder sind fest vorgegeben.</td><td>Nachdem Sie ein StructArray-Feld erstellt haben, können Sie diesem StructArray-Feld keine weiteren Unterfelder hinzufügen.</td></tr>
...
<li><p>Verwendung eines einzigen Vektor-Unterfelds sowohl für die Suche in der „EmbeddingList“ als auch für die Suche auf Elementebene.</p></li>
<li><p>Hinzufügen nur von Vektor-Teilfeldern und Auslassen von für die Filterung benötigten skalaren Teilfeldern wie „ <code translate="no">section</code> “, „ <code translate="no">quality_score</code> “ oder „ <code translate="no">has_code</code> “.</p></li>
