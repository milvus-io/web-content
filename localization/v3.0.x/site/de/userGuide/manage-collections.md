...
<h3 id="Quick-setup" class="common-anchor-header">Schnelle Einrichtung<button data-href="#Quick-setup" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Vor dem Hintergrund des großen Sprungs in der KI-Industrie brauchen die meisten Entwickler nur eine einfache, aber dynamische Sammlung, um damit zu beginnen. Milvus ermöglicht eine schnelle Einrichtung einer solchen Sammlung mit nur drei Argumenten:</p>
<ul>
...
<h3 id="Customized-setup" class="common-anchor-header">Benutzerdefinierte Einrichtung<button data-href="#Customized-setup" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Anstatt Milvus fast alles für Ihre Sammlung entscheiden zu lassen, können Sie das <strong>Schema</strong> und die <strong>Indexparameter</strong> der Sammlung selbst bestimmen.</p>
...
<h3 id="Load-a-collection" class="common-anchor-header">Laden einer Sammlung<button data-href="#Load-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash">}</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Load-a-collection-partially-Public-Preview" class="common-anchor-header">Eine Sammlung teilweise laden (öffentliche Vorschau)<button data-href="#Load-a-collection-partially-Public-Preview" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Release-a-collection" class="common-anchor-header">Eine Sammlung freigeben<button data-href="#Release-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Create-aliases" class="common-anchor-header">Aliasnamen erstellen<button data-href="#Create-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="List-aliases" class="common-anchor-header">Aliasnamen auflisten<button data-href="#List-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash"><span class="hljs-string">}</span></span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Describe-aliases" class="common-anchor-header">Aliasnamen beschreiben<button data-href="#Describe-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash"><span class="hljs-string">}</span></span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Reassign-aliases" class="common-anchor-header">Aliasnamen neu zuweisen<button data-href="#Reassign-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-meta prompt_"># </span><span class="language-bash"><span class="hljs-string">}</span></span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Drop-aliases" class="common-anchor-header">Aliasnamen löschen<button data-href="#Drop-aliases" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Set-TTL" class="common-anchor-header">TTL setzen<button data-href="#Set-TTL" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Setzen Sie die Time-To-Live (TTL) für die Daten in der Sammlung, die angibt, wie lange die Daten aufbewahrt werden sollen, bevor sie automatisch gelöscht werden.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Set-MMAP" class="common-anchor-header">MMAP einstellen<button data-href="#Set-MMAP" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Konfigurieren Sie die Eigenschaft Speicherzuordnung (MMAP) für die Sammlung, die festlegt, ob Daten im Speicher abgebildet werden, um die Abfrageleistung zu verbessern. Weitere Informationen finden Sie unter <a href="https://milvus.io/docs/mmap.md#Configure-memory-mapping">Konfigurieren der Speicherzuordnung</a>.</p>
<div class="alert note">
