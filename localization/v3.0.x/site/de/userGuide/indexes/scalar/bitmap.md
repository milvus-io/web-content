...
<li><p>Ab <strong>v2.6.4</strong> können Sie einen skalaren Index direkt löschen, sobald er nicht mehr benötigt wird - die Sammlung muss nicht erst freigegeben werden.</p></li>
</ul>
</div>
