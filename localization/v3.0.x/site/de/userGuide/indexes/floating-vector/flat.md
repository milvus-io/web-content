...
<h2 id="Build-index" class="common-anchor-header">Index erstellen<button data-href="#Build-index" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Um einen <code translate="no">FLAT</code> -Index auf einem Vektorfeld in Milvus zu erstellen, verwenden Sie die Methode <code translate="no">add_index()</code> und geben Sie die Parameter <code translate="no">index_type</code> und <code translate="no">metric_type</code> für den Index an.</p>
...
<h2 id="Index-params" class="common-anchor-header">Index-Parameter<button data-href="#Index-params" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Für den FLAT-Index werden keine zusätzlichen Parameter benötigt, weder bei der Indexerstellung noch beim Suchprozess.</p>
