...
<h2 id="Local-install" class="common-anchor-header">Lokale Installation<button data-href="#Local-install" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Wenn Sie Milvus Standalone <a href="/docs/de/install_standalone-docker.md">mit Hilfe von Docker</a> installiert haben, sollten Sie Birdwatcher als gewöhnliches Go-Modul installieren, oder Birdwatcher aus dem Quellcode bauen.</p>
<ul>
...
<p>Öffnen Sie zunächst die <a href="https://github.com/milvus-io/birdwatcher/releases/latest">aktuelle Release-Seite</a> und suchen Sie die vorbereiteten Binärdateien.</p>
...
<h2 id="Install-as-a-Kubernetes-pod" class="common-anchor-header">Installation als Kubernetes-Pod<button data-href="#Install-as-a-Kubernetes-pod" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Wenn Sie entweder Milvus Standalone <a href="/docs/de/install_standalone-helm.md">über die Helm-Charts</a> oder <a href="/docs/de/install_standalone-operator.md">den Milvus Operator</a> oder Milvus Cluster <a href="/docs/de/install_cluster-helm.md">über die Helm-Charts</a> oder <a href="/docs/de/install_cluster-milvusoperator.md">den Milvus Operator</a> installiert haben, sollten Sie Birdwatcher als Kubernetes-Pod installieren.</p>
<h3 id="Prepare-deploymentyml" class="common-anchor-header">deployment.yml vorbereiten<button data-href="#Prepare-deploymentyml" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Apply-deploymentyml" class="common-anchor-header">deployment.yml anwenden<button data-href="#Apply-deploymentyml" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Speichern Sie die obige YAML in einer Datei mit dem Namen <code translate="no">deployment.yml</code> und führen Sie folgenden Befehl aus</p>
