...
<h2 id="Current-version" class="common-anchor-header">Aktuelle Version<button data-href="#Current-version" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Die aktuelle Version von Milvus_CLI ist 1.2.1. Um Ihre installierte Version zu ermitteln und festzustellen, ob Sie eine Aktualisierung benötigen, führen Sie <code translate="no">milvus_cli --version</code> aus.</p>
