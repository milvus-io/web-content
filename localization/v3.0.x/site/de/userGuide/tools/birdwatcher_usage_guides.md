...
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-sessions" class="common-anchor-header">Sitzungen auflisten<button data-href="#List-sessions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Zum Auflisten von Sitzungen, die mit verschiedenen Komponenten in Milvus verbunden sind:</p>
...
<h3 id="Check-databases-and-collections" class="common-anchor-header">Datenbanken und Sammlungen überprüfen<button data-href="#Check-databases-and-collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sie können alle Datenbanken und Sammlungen auflisten.</p>
<ul>
...
<h3 id="Check-index-details" class="common-anchor-header">Index-Details prüfen<button data-href="#Check-index-details" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Führen Sie den folgenden Befehl aus, um alle Indexdateien im Detail aufzulisten.</p>
...
==================================================================
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-partitions" class="common-anchor-header">Partitionen auflisten<button data-href="#List-partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Führen Sie den folgenden Befehl aus, um alle Partitionen in einer bestimmten Sammlung aufzulisten.</p>
...
--- Total Database(s): 1
<button class="copy-code-btn"></button></code></pre>
<h3 id="Check-channel-status" class="common-anchor-header">Channel-Status prüfen<button data-href="#Check-channel-status" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Führen Sie den folgenden Befehl aus, um den Channel-Status anzuzeigen</p>
...
--- Total Channels: 1
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-all-replicas-and-segments" class="common-anchor-header">Alle Replikate und Segmente auflisten<button data-href="#List-all-replicas-and-segments" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="List-configurations" class="common-anchor-header">Konfigurationen auflisten<button data-href="#List-configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sie können sich von Birdwatcher die aktuellen Konfigurationen der einzelnen Milvus-Komponenten auflisten lassen.</p>
...
<h3 id="Probe-collection-with-known-primary-key" class="common-anchor-header">Sammlungen mit bekanntem Primärschlüssel prüfen<button data-href="#Probe-collection-with-known-primary-key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Im Befehl <code translate="no">probe</code> sollten Sie den Primärschlüssel mit dem Flag <code translate="no">pk</code> und die Sammlungs-ID mit dem Flag <code translate="no">collection</code> angeben.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Probe-all-collections-with-mock-queries" class="common-anchor-header">Alle Sammlungen mit Mock-Queries prüfen<button data-href="#Probe-all-collections-with-mock-queries" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sie können Birdwatcher auch veranlassen, alle Sammlungen mit Scheinabfragen zu untersuchen.</p>
