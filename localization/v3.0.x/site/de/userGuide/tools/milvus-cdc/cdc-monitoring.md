...
<h3 id="Metrics-for-CDC-tasks" class="common-anchor-header">Metriken für CDC-Aufgaben<button data-href="#Metrics-for-CDC-tasks" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Um zu beginnen, importieren Sie die Datei <a href="https://github.com/zilliztech/milvus-cdc/blob/main/server/configs/cdc-grafana.json">cdc-grafana.json</a> in Grafana. Dadurch wird ein Dashboard hinzugefügt, das speziell für die Überwachung des Status von CDC-Aufgaben entwickelt wurde.</p>
