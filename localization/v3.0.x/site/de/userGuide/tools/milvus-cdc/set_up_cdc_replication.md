...
<p>Bevor Sie beginnen, lesen Sie <a href="/docs/de/milvus_cdc_overview.md">Milvus CDC</a>, um das Primary-Standby-Modell und die Failover-Optionen zu verstehen.</p>
...
<li>Laden Sie die Sammlung und führen Sie eine Abfrage oder Suche auf <code translate="no">source-cluster</code> aus.</li>
