...
title: Sammlung ablegen
summary: 'Sie können eine Sammlung aufgeben, wenn sie nicht mehr benötigt wird.'
---
<h1 id="Drop-Collection" class="common-anchor-header">Sammlung ablegen<button data-href="#Drop-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Sie können eine Sammlung löschen, wenn sie nicht mehr benötigt wird.</p>
<h2 id="Examples" class="common-anchor-header">Beispiele<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Die folgenden Codeschnipsel gehen davon aus, dass Sie eine Sammlung namens <strong>my_collection</strong> haben.</p>
