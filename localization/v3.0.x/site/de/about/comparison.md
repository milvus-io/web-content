...
<h3 id="Key-insights" class="common-anchor-header">Wichtige Erkenntnisse<button data-href="#Key-insights" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
