...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Milvus-Cluster mit Milvus Operator aktualisieren<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>In dieser Anleitung wird beschrieben, wie Sie Ihren Milvus-Cluster mithilfe des Milvus Operator von Version 2.5.x auf Version 3.0-beta aktualisieren können.</p>
...
<li>Sie <strong>müssen</strong> vor dem Upgrade auf v3.0-beta ein Upgrade auf v2.5.16 oder höher durchführen, wobei „ <code translate="no">mixCoord</code> “ aktiviert sein muss.</li>
</ul>
<p><strong>Einschränkungen bei den Nachrichtenwarteschlangen</strong>: Beim Upgrade auf Milvus v3.0-beta müssen Sie Ihre aktuelle Auswahl der Nachrichtenwarteschlange beibehalten. Ein Wechsel zwischen verschiedenen Nachrichtenwarteschlangensystemen während des Upgrades wird nicht unterstützt. Die Unterstützung für den Wechsel des Nachrichtenwarteschlangensystems wird in zukünftigen Versionen verfügbar sein.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v30-beta" class="common-anchor-header">2.3 Upgrade auf v3.0-beta</h4><p>Sobald Version 2.5.16 erfolgreich mit „ <code translate="no">mixCoord</code> “ läuft, führen Sie ein Upgrade auf Version 3.0-beta durch:</p>
