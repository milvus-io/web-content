...
<h3 id="Configure" class="common-anchor-header">Konfigurieren<button data-href="#Configure" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Um RocksMQ anzupassen, fügen Sie den Abschnitt „ <code translate="no">rocksmq</code> “ in die Datei „ <code translate="no">user.yaml</code> “ ein und starten Sie den Dienst neu:</p>
