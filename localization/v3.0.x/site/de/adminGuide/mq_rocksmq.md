...
<li>In früheren Milvus-Versionen war es die Standard-Standalone-Nachrichtenwarteschlange; in Milvus 3.x wird es durch den eingebetteten Woodpecker abgelöst.</li>
</ul>
