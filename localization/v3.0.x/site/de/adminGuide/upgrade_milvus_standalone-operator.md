...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Upgrade von Milvus Standalone mit Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Diese Anleitung beschreibt, wie Sie eine Milvus 2.6.x-Standalone-Bereitstellung mit Milvus Operator auf Version 3.0.2 aktualisieren können.</p>
<div class="alert note">
<p>Dieses Verfahren wurde von Milvus 2.6.20 auf Milvus v3.0.2 mit Milvus Operator 1.3.0, Woodpecker, einem clusterinternen etcd und einem clusterinternen MinIO getestet. Wenn Sie eine andere Milvus 2.6.x-Patch-Version, Operator-Version, Nachrichtenwarteschlange oder Abhängigkeitskonfiguration verwenden, testen Sie das Upgrade zunächst in einer Nicht-Produktionsumgebung.</p>
</div>
...
<h3 id="Step-3-Update-the-Milvus-image" class="common-anchor-header">Schritt 3: Aktualisieren Sie das Milvus-Image<button data-href="#Step-3-Update-the-Milvus-image" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Ändern Sie im vollständigen Milvus-CR-Manifest nur „ <code translate="no">spec.components.image</code> “. Behalten Sie die bestehenden Einstellungen für Modus, Komponenten, Nachrichtenwarteschlange, etcd, Speicher und andere Abhängigkeiten bei. Der folgende Auszug zeigt das zu ändernde Feld; ersetzen Sie nicht Ihre gesamte CR durch diesen Auszug.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Stellen Sie sicher, dass das Milvus-CR „ <code translate="no">Healthy</code> “ meldet, das aktuelle Image „ <code translate="no">milvusdb/milvus:v3.0.2</code> “ lautet und die vorhandenen Sammlungen weiterhin abfragbar und durchsuchbar sind. Führen Sie diese Überprüfungen durch, bevor Sie v3.0.2-spezifische Funktionen aktivieren.</p>
