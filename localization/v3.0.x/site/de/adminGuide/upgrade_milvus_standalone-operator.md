...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Upgrade von Milvus Standalone mit Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>In dieser Anleitung wird beschrieben, wie Sie eine Milvus 2.6.x-Standalone-Bereitstellung mit Milvus Operator auf Version 3.0.0 aktualisieren.</p>
<div class="alert note">
<p>Dieses Verfahren wurde von Milvus 2.6.20 auf Milvus v3.0.0 mit Milvus Operator 1.3.0, Woodpecker, einem clusterinternen etcd und einem clusterinternen MinIO getestet. Wenn Sie eine andere Milvus 2.6.x-Patch-Version, Operator-Version, Nachrichtenwarteschlange oder Abhängigkeitskonfiguration verwenden, testen Sie das Upgrade zunächst in einer Nicht-Produktionsumgebung.</p>
</div>
...
<p><strong>Einschränkungen bei den Nachrichtenwarteschlangen</strong>: Beim Upgrade auf Milvus v3.0.0 müssen Sie Ihre derzeitige Wahl der Nachrichtenwarteschlange beibehalten. Ein Wechsel zwischen verschiedenen Nachrichtenwarteschlangensystemen während des Upgrades wird nicht unterstützt. Die Unterstützung für den Wechsel von Nachrichtenwarteschlangensystemen wird in zukünftigen Versionen verfügbar sein.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Stellen Sie sicher, dass das Milvus-CR „ <code translate="no">Healthy</code> “ meldet, das aktuelle Image „ <code translate="no">milvusdb/milvus:v3.0.0</code> “ lautet und die vorhandenen Sammlungen weiterhin abfragbar und durchsuchbar sind. Führen Sie diese Überprüfungen durch, bevor Sie v3.0.0-spezifische Funktionen aktivieren.</p>
