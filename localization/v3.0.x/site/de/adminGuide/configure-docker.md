...
<h2 id="Download-a-configuration-file" class="common-anchor-header">Konfigurationsdatei herunterladen<button data-href="#Download-a-configuration-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://raw.githubusercontent.com/milvus-io/milvus/v3.0.0/configs/milvus.yaml">Laden Sie</a> „ <code translate="no">milvus.yaml</code> “ direkt oder mit dem folgenden Befehl<a href="https://raw.githubusercontent.com/milvus-io/milvus/v3.0.0/configs/milvus.yaml">herunter</a>.</p>
  ...
  <tr>
    ...
    <td>
        <ul>
            ...
            <li><a href="/docs/de/configure_datacoord.md">Datenkoordinate</a></li>
            <li><a href="/docs/de/configure_datanode.md">Datenknoten</a></li>
            ...
            <li><a href="/docs/de/configure_quotaandlimits.md">Kontingente und Grenzwerte</a></li>
        </ul>
    </td>
  </tr>
</tbody>
...
<h2 id="Download-an-installation-file" class="common-anchor-header">Installationsdatei herunterladen<button data-href="#Download-an-installation-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Laden Sie die Installationsdatei für Milvus <a href="https://github.com/milvus-io/milvus/releases/download/v3.0.0/milvus-standalone-docker-compose.yml">Standalone</a> herunter und speichern Sie sie unter „ <code translate="no">docker-compose.yml</code> “.</p>
...
<li><a href="/docs/de/deploy_pulsar.md">Konfigurieren des Nachrichtenspeichers mit Docker Compose oder Helm</a></li>
</ul></li>
</ul>
