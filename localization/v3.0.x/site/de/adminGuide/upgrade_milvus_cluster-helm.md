...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Milvus-Cluster mit Helm-Chart aktualisieren<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>In dieser Anleitung wird beschrieben, wie Sie Ihren Milvus 2.6.x-Cluster mithilfe von Helm auf Version 3.0.0 aktualisieren können.</p>
<div class="alert note">
<p>Dieses Verfahren wurde für das Upgrade von Milvus 2.6.20 auf Milvus v3.0.0 mit dem Milvus-Helm-Chart 5.0.22 getestet. Wenn Sie eine andere Milvus 2.6.x-Patch-Version oder eine andere Helm-Chart-Version verwenden, testen Sie das Upgrade zunächst in einer Nicht-Produktionsumgebung.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Stellen Sie sicher, dass alle erforderlichen Workloads bereit sind, alle Milvus-Komponenten „ <code translate="no">v3.0.0</code> “ verwenden und Ihre bestehenden Sammlungen weiterhin abfragbar und durchsuchbar sind. Führen Sie diese Überprüfungen durch, bevor Sie v3.0.0-spezifische Funktionen aktivieren.</p>
<div class="alert note">
