...
<h2 id="Hello-Milvus" class="common-anchor-header">Hallo Milvus<button data-href="#Hello-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Bitte beziehen Sie sich auf <a href="https://milvus.io/docs/v2.3.x/example_code.md">Hello Milvus</a>, ändern Sie den Host-Wert in eine externe IP-Adresse und führen Sie dann den Code aus.</p>
