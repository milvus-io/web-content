...
<h3 id="Configuration-options" class="common-anchor-header">Konfigurationsoptionen<button data-href="#Configuration-options" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><code translate="no">disable</code>: Milvus lädt die Daten nicht vorab in den Memory Cache.</li>
</ul>
<p>Beachten Sie, dass die Einstellungen für den Chunk-Cache auch gelten, wenn neue Daten in Sammlungen eingefügt oder die Sammlungsindizes neu erstellt werden.</p>
