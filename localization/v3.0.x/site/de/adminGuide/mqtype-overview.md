...
<li><p><strong>Einschränkungen bei der Nachrichtenwarteschlange</strong>: Beim Upgrade auf Milvus v3.0.2 müssen Sie Ihre aktuelle Auswahl der Nachrichtenwarteschlange beibehalten. Ein Wechsel zwischen verschiedenen Nachrichtenwarteschlangensystemen während des Upgrades wird nicht unterstützt. Die Unterstützung für den Wechsel des Nachrichtenwarteschlangensystems wird in zukünftigen Versionen verfügbar sein.</p></li>
...
<li><strong>Neue Bereitstellungen (Milvus 3.x):</strong> Verwenden Sie <strong>Woodpecker</strong> (Standard). Bei Standalone-Instanzen wird es eingebettet ausgeführt; bei verteilten (Cluster-)Instanzen ist der empfohlene Standard ein mit Helm bereitgestellter dedizierter <a href="/docs/de/woodpecker.md#Deployment-modes">Dienst</a>, wobei auch die eingebettete Ausführung unterstützt wird.</li>
