...
<h2 id="Detailed-Layer-Architecture" class="common-anchor-header">Detaillierte Schichtenarchitektur<button data-href="#Detailed-Layer-Architecture" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Layer-1-Access-Layer" class="common-anchor-header">Schicht 1: Zugriffsschicht<button data-href="#Layer-1-Access-Layer" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Die Zugriffsschicht besteht aus einer Gruppe von zustandslosen Proxys und ist die vorderste Schicht des Systems und der Endpunkt für die Benutzer. Sie validiert Client-Anfragen und reduziert die zurückgegebenen Ergebnisse:</p>
<ul>
...
<h3 id="Layer-2-Coordinator" class="common-anchor-header">Schicht 2: Koordinator<button data-href="#Layer-2-Coordinator" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Der Coordinator dient als das Gehirn von Milvus. Zu jedem Zeitpunkt ist genau ein Coordinator im gesamten Cluster aktiv, der für die Aufrechterhaltung der Clustertopologie, die Planung aller Aufgabentypen und die Gewährleistung der Konsistenz auf Clusterebene verantwortlich ist.</p>
...
<h3 id="Layer-3-Worker-Nodes" class="common-anchor-header">Schicht 3: Arbeiterknoten<button data-href="#Layer-3-Worker-Nodes" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Query-node" class="common-anchor-header">Abfrageknoten<button data-href="#Query-node" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Der Abfrageknoten lädt die historischen Daten aus dem Objektspeicher und ermöglicht die Abfrage der historischen Daten.</p>
<h3 id="Data-node" class="common-anchor-header">Datenknoten<button data-href="#Data-node" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Der Datenknoten ist für die Offline-Verarbeitung historischer Daten zuständig, z. B. für die Verdichtung und den Aufbau von Indizes.</p>
<h3 id="Layer-4-Storage" class="common-anchor-header">Schicht 4: Speicherung<button data-href="#Layer-4-Storage" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Die Speicherung ist das Herzstück des Systems und für die Datenpersistenz verantwortlich. Er umfasst Metaspeicher, Log-Broker und Objektspeicher.</p>
<h3 id="Meta-storage" class="common-anchor-header">Metaspeicher<button data-href="#Meta-storage" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Der Metaspeicher speichert Schnappschüsse von Metadaten wie Sammelschemata und Prüfpunkte für den Nachrichtenverbrauch. Die Speicherung von Metadaten erfordert extrem hohe Verfügbarkeit, starke Konsistenz und Transaktionsunterstützung, weshalb Milvus etcd als Metaspeicher gewählt hat. Milvus verwendet etcd auch für die Serviceregistrierung und Zustandsüberprüfung.</p>
<h3 id="Object-storage" class="common-anchor-header">Objektspeicher<button data-href="#Object-storage" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Example-Data-Flow-Search-Operation" class="common-anchor-header">Beispiel Datenfluss: Suchvorgang<button data-href="#Example-Data-Flow-Search-Operation" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Example-Data-Flow-Data-Insertion" class="common-anchor-header">Beispiel Datenfluss: Dateneinfügung<button data-href="#Example-Data-Flow-Data-Insertion" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Wenn Segmente die Kapazität erreichen, löst der Streaming Node die Umwandlung in versiegelte Segmente aus.</li>
...
<li>Verstehen Sie das <a href="/docs/de/tune_consistency.md">Konsistenzmodell</a> und die Transaktionsgarantien in Milvus</li>
</ul>
