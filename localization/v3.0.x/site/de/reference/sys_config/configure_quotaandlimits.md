  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>Wenn Sie diesen Wert auf 5 setzen, bedeutet dies, dass Milvus nur eine Dateneinfügung mit einer Geschwindigkeit von 5 MB/s zulässt.</li>      
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>Wenn Sie diesen Wert auf 5 setzen, bedeutet dies, dass Milvus nur Daten mit einer Geschwindigkeit von 5 MB/s in eine Sammlung einfügen kann.</li>      
        <li>Um diese Einstellung zu verwenden, setzen Sie gleichzeitig quotaAndLimits.dml.enabled auf true.</li>      </td>
      <td>-1</td>
    </tr>
  </tbody>
