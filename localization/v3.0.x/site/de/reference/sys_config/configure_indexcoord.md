...
summary: 'Erfahren Sie, wie Sie indexCoord für Milvus konfigurieren.'
---
<h1 id="indexCoord-related-Configurations" class="common-anchor-header">indexCoord-bezogene Konfigurationen<button data-href="#indexCoord-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>        Es ist ein Schwellenwert. Wenn die Anzahl der Zeilen des Segments kleiner als dieser Wert ist, wird das Segment nicht indiziert      </td>
      <td>1024</td>
    </tr>
  </tbody>
</table>
