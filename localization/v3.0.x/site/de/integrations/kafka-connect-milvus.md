...
<h3 id="Support" class="common-anchor-header">Unterstützung<button data-href="#Support" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Wenn Sie Unterstützung benötigen oder Fragen zum Kafka Connect Milvus Connector haben, wenden Sie sich bitte an den Maintainer des Connectors: <strong>E-Mail:</strong> <a href="mailto:support@zilliz.com">support@zilliz.com</a></p>
