...
<h2 id="Create-Collection" class="common-anchor-header">Sammlung erstellen<button data-href="#Create-Collection" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Defining-necessary-variables" class="common-anchor-header">Definieren der notwendigen Variablen<button data-href="#Defining-necessary-variables" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Add-schema" class="common-anchor-header">Schema hinzufügen<button data-href="#Add-schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Create-index" class="common-anchor-header">Index erstellen<button data-href="#Create-index" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Für jedes Schema ist es besser, einen Index zu haben, damit die Abfrage viel effizienter wird. Um einen Index zu erstellen, benötigen wir zunächst ein <code translate="no">index_params</code> und fügen später weitere Indexdaten zu diesem <code translate="no">IndexParams</code> Objekt hinzu.</p>
...
<h2 id="Question-answering" class="common-anchor-header">Beantwortung von Fragen<button data-href="#Question-answering" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Nun können wir endlich zur Retrieval-Augmented-Generierung übergehen.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Rules" class="common-anchor-header">Regeln<button data-href="#Rules" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Clean-up" class="common-anchor-header">Aufräumen<button data-href="#Clean-up" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Nachdem Sie alle Anweisungen ausgeführt haben, können Sie die Datenbank durch den Aufruf von <code translate="no">drop_collection()</code> bereinigen.</p>
