...
<h2 id="Arguments-Introduction" class="common-anchor-header">Einführung in die Argumente<button data-href="#Arguments-Introduction" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Die erforderlichen Argumente zum Aufbau einer Verbindung sind:</p>
<ul>
...
<li><code translate="no">create_id_max_len</code>Maximale Länge des Feldes id bei der Erstellung einer Tabelle (default=64)</li>
...
<h3 id="Creating-connection" class="common-anchor-header">Verbindung erstellen<button data-href="#Creating-connection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Um diesen Handler zu nutzen und eine Verbindung zu einem Milvus-Server in MindsDB herzustellen, kann die folgende Syntax verwendet werden:</p>
...
<h3 id="Dropping-connection" class="common-anchor-header">Trennen der Verbindung<button data-href="#Dropping-connection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Um die Verbindung zu trennen, verwenden Sie diesen Befehl</p>
<pre><code translate="no" class="language-sql"><span class="hljs-keyword">DROP</span> DATABASE milvus_datasource;
<button class="copy-code-btn"></button></code></pre>
<h3 id="Creating-tables" class="common-anchor-header">Tabellen erstellen<button data-href="#Creating-tables" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Um Daten aus einer bereits existierenden Tabelle einzufügen, verwenden Sie <code translate="no">CREATE</code></p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Dropping-collections" class="common-anchor-header">Sammlungen löschen<button data-href="#Dropping-collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Das Verwerfen einer Sammlung wird nicht unterstützt.</p>
<h3 id="Querying-and-selecting" class="common-anchor-header">Abfragen und Auswählen<button data-href="#Querying-and-selecting" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Um eine Datenbank mit einem Suchvektor abzufragen, können Sie <code translate="no">search_vector</code> in der <code translate="no">WHERE</code> Klausel verwenden.</p>
<p>Warnungen:</p>
<ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Deleting-records" class="common-anchor-header">Löschen von Einträgen<button data-href="#Deleting-records" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sie können Einträge mit <code translate="no">DELETE</code> genau wie in SQL löschen.</p>
<p>Warnungen:</p>
<ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Inserting-records" class="common-anchor-header">Einfügen von Datensätzen<button data-href="#Inserting-records" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sie können auch einzelne Zeilen wie folgt einfügen:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Updating" class="common-anchor-header">Aktualisieren<button data-href="#Updating" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Das Aktualisieren von Datensätzen wird von der Milvus-API nicht unterstützt. Sie können versuchen, eine Kombination aus <code translate="no">DELETE</code> und <code translate="no">INSERT</code></p>
<hr>
