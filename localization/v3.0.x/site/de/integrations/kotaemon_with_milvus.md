...
<h2 id="Prerequisites" class="common-anchor-header">Voraussetzungen<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Wir empfehlen, kotaemon auf diese Weise zu installieren:</p>
...
<h3 id="Set-Milvus-as-the-default-vector-storage" class="common-anchor-header">Milvus als Standard-Vektorspeicher einstellen<button data-href="#Set-Milvus-as-the-default-vector-storage" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Um den Standard-Vektorspeicher auf Milvus umzustellen, müssen Sie die Datei <code translate="no">flowsettings.py</code> durch Umschalten auf <code translate="no">KH_VECTORSTORE</code> ändern:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Set-Environment-Variables" class="common-anchor-header">Umgebungsvariablen setzen<button data-href="#Set-Environment-Variables" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>können Sie die Modelle über die Datei <code translate="no">.env</code> mit den Informationen konfigurieren, die für die Verbindung zu den LLMs und den Einbettungsmodellen benötigt werden. z.B. OpenAI, Azure, Ollama, etc.</p>
<h3 id="Run-Kotaemon" class="common-anchor-header">Kotaemon ausführen<button data-href="#Run-Kotaemon" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Nach dem Einrichten der Umgebungsvariablen und dem Ändern des Vektorspeichers können Sie kotaemon mit folgendem Befehl starten:</p>
...
<h2 id="Start-RAG-with-kotaemon" class="common-anchor-header">RAG mit kotaemon starten<button data-href="#Start-RAG-with-kotaemon" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Add-your-AI-models" class="common-anchor-header">1. Fügen Sie Ihre KI-Modelle hinzu<button data-href="#1-Add-your-AI-models" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="2-Upload-your-documents" class="common-anchor-header">2. Hochladen Ihrer Dokumente<button data-href="#2-Upload-your-documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="3-Chat-with-your-documents" class="common-anchor-header">3. Chatten Sie mit Ihren Dokumenten<button data-href="#3-Chat-with-your-documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
