...
<h3 id="Use-as-a-regular-node-to-insert-and-retrieve-documents" class="common-anchor-header">Verwendung als regulärer Knoten zum Einfügen und Abrufen von Dokumenten<button data-href="#Use-as-a-regular-node-to-insert-and-retrieve-documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sie können den Milvus-Vektor-Speicher als regulären Knoten verwenden, um Dokumente einzufügen oder abzurufen. Bei diesem Muster wird der Milvus-Vektorspeicher in den regulären Verbindungsfluss eingebunden, ohne dass ein Agent verwendet wird.</p>
...
<h3 id="Connect-directly-to-an-AI-agent-as-a-tool" class="common-anchor-header">Direkte Verbindung mit einem KI-Agenten als Werkzeug<button data-href="#Connect-directly-to-an-AI-agent-as-a-tool" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Sie können den Milvus-Vektorspeicher-Knoten direkt mit dem Tool-Connector eines <a href="https://docs.n8n.io/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent/">KI-Agenten</a> verbinden, um einen Vektorspeicher als Ressource bei der Beantwortung von Anfragen zu verwenden.</p>
...
<h3 id="Use-a-retriever-to-fetch-documents" class="common-anchor-header">Verwenden Sie einen Retriever zum Abrufen von Dokumenten<button data-href="#Use-a-retriever-to-fetch-documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Use-the-Vector-Store-Question-Answer-Tool-to-answer-questions" class="common-anchor-header">Verwenden Sie das Vector Store Question Answer Tool, um Fragen zu beantworten<button data-href="#Use-the-Vector-Store-Question-Answer-Tool-to-answer-questions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<hr>
<h3 id="Operation-Modes-Overview" class="common-anchor-header">Überblick über die Betriebsmodi<button data-href="#Operation-Modes-Overview" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Der Milvus-Vektorspeicher-Knoten unterstützt vier verschiedene Modi:</p>
<ul>
...
<h3 id="Additional-Node-Options" class="common-anchor-header">Zusätzliche Knotenoptionen<button data-href="#Additional-Node-Options" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Related-Resources" class="common-anchor-header">Verwandte Ressourcen<button data-href="#Related-Resources" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
