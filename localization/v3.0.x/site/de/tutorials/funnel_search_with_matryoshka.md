...
<h2 id="Performing-Funnel-Search" class="common-anchor-header">Durchführen der Trichtersuche<button data-href="#Performing-Funnel-Search" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Nun wollen wir eine "Trichtersuche" mit den ersten 1/6 der Matryoshka-Einbettungsdimensionen durchführen. Ich habe drei Filme im Sinn, die abgerufen werden sollen, und habe meine eigene Zusammenfassung für die Abfrage der Datenbank erstellt. Wir betten die Abfragen ein, führen dann eine Vektorsuche auf dem Feld <code translate="no">head_embedding</code> durch und erhalten 128 Ergebniskandidaten.</p>
