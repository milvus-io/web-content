...
<h3 id="Download-Dataset" class="common-anchor-header">Datensatz herunterladen<button data-href="#Download-Dataset" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Um die Suche zu demonstrieren, benötigen wir einen Korpus von Dokumenten. Wir verwenden das Quora Duplicate Questions Dataset und legen es im lokalen Verzeichnis ab.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Load-and-Prepare-Data" class="common-anchor-header">Laden und Aufbereiten der Daten<button data-href="#Load-and-Prepare-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Wir werden den Datensatz laden und einen kleinen Korpus für die Suche vorbereiten.</p>
...
<h3 id="Use-BGE-M3-Model-for-Embeddings" class="common-anchor-header">BGE-M3 Modell für Einbettungen verwenden<button data-href="#Use-BGE-M3-Model-for-Embeddings" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Das BGE-M3-Modell kann Texte als dichte und spärliche Vektoren einbetten.</p>
...
<h3 id="Setup-Milvus-Collection-and-Index" class="common-anchor-header">Milvus-Sammlung und -Index einrichten<button data-href="#Setup-Milvus-Collection-and-Index" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Wir werden die Milvus-Sammlung einrichten und Indizes für die Vektorfelder erstellen.</p>
...
col.load()
<button class="copy-code-btn"></button></code></pre>
<h3 id="Insert-Data-into-Milvus-Collection" class="common-anchor-header">Daten in die Milvus-Sammlung einfügen<button data-href="#Insert-Data-into-Milvus-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Fügen Sie Dokumente und ihre Einbettungen in die Sammlung ein.</p>
...
<h3 id="Enter-Your-Search-Query" class="common-anchor-header">Geben Sie Ihre Suchabfrage ein<button data-href="#Enter-Your-Search-Query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Run-the-Search" class="common-anchor-header">Starten Sie die Suche<button data-href="#Run-the-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Wir werden zunächst einige hilfreiche Funktionen vorbereiten, um die Suche auszuführen:</p>
<ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Display-Search-Results" class="common-anchor-header">Suchergebnisse anzeigen<button data-href="#Display-Search-Results" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Um die Ergebnisse der Dense-, Sparse- und Hybrid-Suche anzuzeigen, benötigen wir einige Hilfsmittel, um die Ergebnisse zu formatieren.</p>
...
<p>Welche Mathematik braucht ein absoluter Neuling<span style='color:red'>, um</span> Algorithmen für die<span style='color:red'> Computerprogrammierung</span> zu verstehen<span style='color:red'>?</span> Welche Bücher über Algorithmen sind für einen absoluten Anfänger geeignet<span style='color:red'>?</span></p>
<p><span style='color:red'>Wie</span> kann man das Leben so gestalten, dass es zu einem passt, und wie kann man verhindern, dass das Leben einen geistig und emotional <span style='color:red'>missbraucht</span><span style='color:red'>?</span></p>
<h3 id="Quick-Deploy" class="common-anchor-header">Schnell einsatzbereit<button data-href="#Quick-Deploy" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Um zu erfahren, wie man mit diesem Tutorial eine Online-Demo startet, sehen Sie sich bitte <a href="https://github.com/milvus-io/bootcamp/tree/master/tutorials/quickstart/apps/hybrid_demo_with_milvus">die Beispielanwendung</a> an.</p>
