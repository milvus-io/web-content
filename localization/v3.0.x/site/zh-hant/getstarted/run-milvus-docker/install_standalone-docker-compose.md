...
<p>請務必下載最新的 Docker Compose 配置，以確保與 v3.0-beta 功能相容。</p>
<ul>
<li><p>如果您執行上述指令失敗，請檢查您的系統是否已安裝 Docker Compose V1。如果是這樣的情況，建議您根據<a href="https://docs.docker.com/compose/">本頁面</a>的注意事項遷移至 Docker Compose V2。</p></li>
