...
<h1 id="Install-Milvus-Standalone-with-RPMDEB-Package" class="common-anchor-header">使用 RPM/DEB 套件安裝 Milvus 獨立版<button data-href="#Install-Milvus-Standalone-with-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本頁面說明如何使用預先建置的 RPM/DEB 套件安裝 Milvus 獨立版本。</p>
...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">下載 RPM/DEB 套件<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>您可以從<a href="https://github.com/milvus-io/milvus/releases/tag/v3.0.1">Milvus 發行版頁面</a>，根據您的系統架構下載 RPM/DEB 套件。</p>
<ul>
<li>若為 x86_64/amd64 架構，請下載<strong>milvus_3.0.1-1_amd64.deb</strong>或<strong>milvus_3.0.1-1_amd64.rpm</strong>套件。</li>
<li>若為 ARM64，請下載<strong>milvus_3.0.1-1_arm64.deb</strong>或<strong>milvus_3.0.1-1_arm64.rpm</strong>套件。</li>
</ul>
...
<p>預設情況下，Milvus Standalone 會使用內嵌 etcd 的<strong>Woodpecker</strong>（本地檔案系統）作為訊息佇列，因此無需外部訊息傳遞或元資料服務。請參閱<a href="/docs/zh-hant/woodpecker.md">Woodpecker</a>。</p>
</div>
<h2 id="Optional-Update-Milvus-configurations" class="common-anchor-header">（可選）更新 Milvus 設定<button data-href="#Optional-Update-Milvus-configurations" class="anchor-icon" translate="no">
    ...
    </button></h2><p>您可修改<code translate="no">/etc/milvus/configs/milvus.yaml</code> 檔案中的 Milvus 設定。例如，若要將<code translate="no">proxy.healthCheckTimeout</code> 變更為<code translate="no">1000</code> 訊息伺服器，可搜尋 target 參數並據此修改。有關適用的設定項目，請參閱<a href="/docs/zh-hant/system_configuration.md">「系統設定」</a>。</p>
...
<ul>
<li><p>請參閱<a href="/docs/zh-hant/quickstart.md">《快速入門》</a>，了解 Milvus 的功能。</p></li>
