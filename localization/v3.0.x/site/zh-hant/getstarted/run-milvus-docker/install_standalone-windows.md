...
<p>預設情況下，此部署會使用<strong>Woodpecker</strong>（本機檔案系統）作為訊息佇列，因此無需外部訊息佇列服務。請參閱<a href="/docs/zh-hant/woodpecker.md">Woodpecker</a>。</p>
</blockquote>
...
<li><p><strong>milvus-minio</strong>容器在本地端提供<strong>9000</strong>和<strong>9001</strong>埠，並使用預設的驗證憑證，其資料會映射至當前資料夾中的<strong>volumes/minio​</strong>。​</p></li>
