...
<li>您亦可將 Milvus 實例以獨立模式部署，此時所有元件均包含於單一 Pod 之中。若要執行此操作，請將上述指令中的配置檔案 URL 變更為<code translate="no">https://raw.githubusercontent.com/zilliztech/milvus-operator/main/config/samples/milvus_default.yaml</code></li>
</ul>
</div>
