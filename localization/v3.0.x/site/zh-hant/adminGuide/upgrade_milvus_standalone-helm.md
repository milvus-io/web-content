...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">使用 Helm 圖表升級 Milvus 獨立部署<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本指南說明如何使用 Helm 將您的 Milvus 2.6.x 獨立部署升級至 v3.0.0。</p>
<div class="alert note">
<p>此程序已針對從 Milvus 2.6.20 升級至 Milvus v3.0.0（搭配 Milvus Helm Chart 5.0.22）進行驗證。若您使用其他 Milvus 2.6.x 修補版本或 Helm Chart 版本，請先在非生產環境中驗證升級程序。</p>
</div>
...
<p><strong>訊息佇列限制</strong>：升級至 Milvus v3.0.0 時，您必須維持當前的訊息佇列選項。升級過程中不支援在不同的訊息佇列系統之間切換。未來版本將支援變更訊息佇列系統。</p>
<div class="alert warning">
<p>請勿在此程序中變更或降級 Helm Chart。請保留您 Helm 發佈版本中已安裝的 Chart 版本。經測試的基準配置保留了 Helm Chart 5.0.22，僅將 Milvus 映像標籤變更為<code translate="no">v3.0.0</code> 。</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>確認所有必要的工作負載均已就緒、Milvus 已採用<code translate="no">v3.0.0</code> ，且現有集合仍可進行查詢與搜尋。在啟用任何 v3.0.0 專屬功能之前，請先完成這些檢查。</p>
<div class="alert note">
