...
<h2 id="Visualize-metrics-using-Grafana" class="common-anchor-header">使用 Grafana 可視化度量指標<button data-href="#Visualize-metrics-using-Grafana" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Download-and-import-dashboard" class="common-anchor-header">1.下載並匯入儀表板<button data-href="#1-Download-and-import-dashboard" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>從 JSON 檔案下載並匯入 Milvus 的儀表板。</p>
...
<h3 id="2-View-metrics" class="common-anchor-header">2.檢視指標<button data-href="#2-View-metrics" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>選擇要監控的 Milvus 實例。然後您可以看到 Milvus 元件面板。</p>
<p>
