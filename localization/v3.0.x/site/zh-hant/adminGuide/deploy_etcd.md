...
<h2 id="Configure-etcd-with-Docker-Compose" class="common-anchor-header">使用 Docker Compose 配置 etcd<button data-href="#Configure-etcd-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h3><p>要使用 Docker Compose 配置 etcd，請在 milvus/configs 路徑上的<code translate="no">milvus.yaml</code> 檔案中的<code translate="no">etcd</code> 部分提供您的值。</p>
...
<h3 id="2-Run-Milvus" class="common-anchor-header">2.執行 Milvus<button data-href="#2-Run-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h3><p>執行下列指令啟動使用 etcd 設定的 Milvus。</p>
...
<h3 id="Using-a-command" class="common-anchor-header">使用命令<button data-href="#Using-a-command" class="anchor-icon" translate="no">
    ...
    </button></h3><p>要安裝 Milvus 並配置 etcd，請使用您的值執行下列命令。</p>
