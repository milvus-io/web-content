...
<p>若要使用外部 etcd，或了解 Docker Compose / Helm / Milvus Operator 的詳細設定，請參閱<a href="/docs/zh-hant/deploy_etcd.md">《使用 Docker Compose 或 Helm 設定元資料儲存》</a>以及<a href="/docs/zh-hant/meta_storage_operator.md">《使用 Milvus Operator 設定元資料儲存</a>》。</p>
