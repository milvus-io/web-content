...
<h3 id="External-etcd" class="common-anchor-header">外部 etcd<button data-href="#External-etcd" class="anchor-icon" translate="no">
    ...
    </button></h3><h4 id="Example" class="common-anchor-header">範例</h4><p>下面的示例配置了外部 etcd 服務。</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Internal-etcd" class="common-anchor-header">內部 etcd<button data-href="#Internal-etcd" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><code translate="no">inCluster</code> 表示當 Milvus 集群啟動時，etcd 服務會在集群中自動啟動。</p>
