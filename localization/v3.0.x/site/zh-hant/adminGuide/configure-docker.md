...
<h2 id="Download-a-configuration-file" class="common-anchor-header">下載設定檔<button data-href="#Download-a-configuration-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p>可直接<a href="https://raw.githubusercontent.com/milvus-io/milvus/v3.0-beta/configs/milvus.yaml">下載</a>`<code translate="no">milvus.yaml</code> `，或使用以下指令<a href="https://raw.githubusercontent.com/milvus-io/milvus/v3.0-beta/configs/milvus.yaml">進行下載</a>。</p>
...
<tbody>
  <tr>
    ...
    <td>
        <ul>
            <li><a href="/docs/zh-hant/configure_rootcoord.md">根協調器</a></li>
            <li><a href="/docs/zh-hant/configure_proxy.md">代理</a></li>
            <li><a href="/docs/zh-hant/configure_querycoord.md">查詢節點</a></li>
            <li><a href="/docs/zh-hant/configure_querynode.md">查詢節點</a></li>
            <li><a href="/docs/zh-hant/configure_indexnode.md">索引節點</a></li>
            <li><a href="/docs/zh-hant/configure_datacoord.md">資料座標</a></li>
            ...
            <li><a href="/docs/zh-hant/configure_common.md">通用</a></li>
            <li><a href="/docs/zh-hant/configure_gpu.md">GPU</a></li>
            <li><a href="/docs/zh-hant/configure_grpc.md">GRPC</a></li>
            <li><a href="/docs/zh-hant/configure_indexcoord.md">索引座標</a></li>
            <li><a href="/docs/zh-hant/configure_metastore.md">元數據儲存庫</a></li>
...
<h2 id="Download-an-installation-file" class="common-anchor-header">下載安裝檔案<button data-href="#Download-an-installation-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p>下載 Milvus<a href="https://github.com/milvus-io/milvus/releases/download/v3.0-beta/milvus-standalone-docker-compose.yml">獨立版本</a>的安裝檔案，並將其儲存為<code translate="no">docker-compose.yml</code> 。</p>
<p>您也可以直接執行以下指令。</p>
...
<ul>
<li><a href="/docs/zh-hant/deploy_s3.md">使用 Docker Compose 或 Helm 設定物件儲存</a></li>
<li><a href="/docs/zh-hant/deploy_etcd.md">使用 Docker Compose 或 Helm 設定元資料儲存</a></li>
<li><a href="/docs/zh-hant/deploy_pulsar.md">使用 Docker Compose 或 Helm 設定訊息儲存</a></li>
</ul></li>
</ul>
