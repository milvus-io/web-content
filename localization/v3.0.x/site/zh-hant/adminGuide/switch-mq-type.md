...
<h1 id="Switch-MQ-Type" class="common-anchor-header">切換訊息佇列 (MQ) 類型<button data-href="#Switch-MQ-Type" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本指南說明如何將現有 Milvus 部署中的訊息佇列 (MQ)<strong>在 Woodpecker 與其他訊息佇列之間</strong>切換，且能在線上進行並無需停機。</p>
...
<tr><td>Woodpecker（本機／MinIO）</td><td>RocksMQ</td><td>獨立模式（Docker Compose）</td><td><strong>受支援</strong></td></tr>
