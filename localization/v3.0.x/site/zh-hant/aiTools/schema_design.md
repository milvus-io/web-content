...
summary: AI 程式設計助理用於設計正確 Milvus 集合結構的規則。
---
<h1 id="Schema-Design" class="common-anchor-header">模式設計<button data-href="#Schema-Design" class="anchor-icon" translate="no">
    ...
    </button></h1><p>用於設計正確 Milvus 集合資料結構的規則與決策指南，包含欄位類型、主鍵、BM25 配置，以及資料結構不可變性限制。請將下方的完整提示複製到您的 AI 工具中，以自動套用這些規則。如需所有提示的概覽，請參閱「<a href="/docs/zh-hant/milvus_for_agents.md">AI 提示」</a>。</p>
...
<li><strong>將</strong>其<strong>儲存</strong>至您的 AI 工具所預期的位置 — 請參閱<a href="/docs/zh-hant/milvus_for_agents.md">環境表</a>以了解放置詳情。</li>
