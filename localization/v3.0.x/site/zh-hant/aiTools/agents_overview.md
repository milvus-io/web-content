...
<h1 id="AGENTSmd--Milvus" class="common-anchor-header">AGENTS.md - Milvus<button data-href="#AGENTSmd--Milvus" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus 是一個開放原始碼的向量資料庫，用於相似性搜尋、混合搜尋和 RAG。您可以透過 PyMilvus SDK 的<code translate="no">MilvusClient</code> 介面與它互動。將以下完整的提示複製到您的 AI 工具中，即可自動套用這些規則。如需詳細的特定任務提示，請參閱<a href="/docs/zh-hant/milvus_for_agents.md">AI Prompts</a>。</p>
