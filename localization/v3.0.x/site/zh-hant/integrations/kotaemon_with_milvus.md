...
<h2 id="Prerequisites" class="common-anchor-header">先決條件<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Installation" class="common-anchor-header">安裝<button data-href="#Installation" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>我們建議使用此方式安裝 kotaemon：</p>
...
<h3 id="Set-Milvus-as-the-default-vector-storage" class="common-anchor-header">設定 Milvus 為預設向量儲存空間<button data-href="#Set-Milvus-as-the-default-vector-storage" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>若要變更預設向量儲存為 Milvus，您必須修改<code translate="no">flowsettings.py</code> 檔案，將<code translate="no">KH_VECTORSTORE</code> 切換為：</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Set-Environment-Variables" class="common-anchor-header">設定環境變數<button data-href="#Set-Environment-Variables" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>您可以透過<code translate="no">.env</code> 檔案，設定連接 LLM 和嵌入模型所需的資訊。例如：OpenAI、Azure、Ollama 等。</p>
<h3 id="Run-Kotaemon" class="common-anchor-header">執行 Kotaemon<button data-href="#Run-Kotaemon" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>設定環境變數並變更向量儲存後，您可以執行以下指令來執行 kotaemon：</p>
...
<h2 id="Start-RAG-with-kotaemon" class="common-anchor-header">使用 kotaemon 啟動 RAG<button data-href="#Start-RAG-with-kotaemon" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Add-your-AI-models" class="common-anchor-header">1.新增您的 AI 模型<button data-href="#1-Add-your-AI-models" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="2-Upload-your-documents" class="common-anchor-header">2.上傳您的文件<button data-href="#2-Upload-your-documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="3-Chat-with-your-documents" class="common-anchor-header">3.與您的文件聊天<button data-href="#3-Chat-with-your-documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
