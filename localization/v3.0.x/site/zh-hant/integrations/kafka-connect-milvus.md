...
<ul>
<li>詳情請查看 Kafka 官方快速入門指南：https://kafka.apache.org/quickstart。</li>
</ul>
...
<h3 id="Support" class="common-anchor-header">支援<button data-href="#Support" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>如果您需要任何協助或有任何關於 Kafka Connect Milvus Connector 的問題，請隨時聯繫 Connector 的維護者：<strong>電子郵件:</strong> <a href="mailto:support@zilliz.com">support@zilliz.com</a></p>
