...
<p>在本教學中，我們將向您展示如何使用 Milvus 和 Gemini 建置 RAG（檢索增強生成）管道。我們將利用 Gemini 模型根據給定的查詢生成回應，並結合從 Milvus 檢索到的相關資訊進行增強。</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>為語言模型定義系統提示與使用者提示。此提示是根據從 Milvus 檢索到的文件所組成的。</p>
...
<p>太棒了！我們已成功利用 Milvus 和 Gemini 建置了一條 RAG 處理流程，並展示了透過文字查詢檢索相關圖片的跨模態搜尋功能——這一切皆由<code translate="no">gemini-embedding-2-preview</code> 的統一嵌入空間所驅動。</p>
