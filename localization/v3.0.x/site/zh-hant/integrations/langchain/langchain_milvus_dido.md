...
<h2 id="Summary" class="common-anchor-header">總結<button data-href="#Summary" class="anchor-icon" translate="no">
    ...
    </button></h2><p>恭喜您！您已學會如何在 LangChain 中使用 Milvus 的文字嵌入功能 (Data In Data Out)。透過將嵌入產生移至伺服器端，您可以簡化客戶端程式碼，集中管理 API 金鑰，並輕鬆實現混合搜尋。結合Text Embedding Function和BM25，Milvus為您提供強大的向量搜尋功能。</p>
