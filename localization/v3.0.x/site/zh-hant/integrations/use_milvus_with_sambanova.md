...
<p>本教學利用 SambaNova AI Starter Kits 中的 Milvus 整合，建立企業知識檢索系統，類似 RAG (Retrieval-Augmented Generation)，可基於企業私有文件進行檢索與回答。</p>
<div class="alert note">
<p>本教學主要參考<a href="https://github.com/sambanova/ai-starter-kit/tree/main">SambaNova AI Starter Kits</a>官方指南。如果您發現本教學有過時的部分，您可以優先依照官方指南，並向我們提出問題。</p>
</div>
