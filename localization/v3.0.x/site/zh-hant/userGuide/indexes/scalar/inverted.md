...
<p><strong>效能優勢</strong>：INVERTED 索引不需要全集掃描，可將大型資料集的查詢時間從幾秒縮短至幾毫秒。</p>
<h2 id="How-INVERTED-indexes-work" class="common-anchor-header">INVERTED 索引如何工作<button data-href="#How-INVERTED-indexes-work" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus 中的<strong>INVERTED 索引</strong>將每個唯一欄位值（術語）對應到出現該值的文件 ID 集。這種結構可以快速查詢具有重複或分類值的欄位。</p>
<p>如圖所示，此過程分為兩個步驟：</p>
<ol>
