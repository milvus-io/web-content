...
<h2 id="Configure-GPU-memory-pool-for-Milvus" class="common-anchor-header">為 Milvus 設定 GPU 記憶池<button data-href="#Configure-GPU-memory-pool-for-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus 支援全局 GPU 記憶體池並在<a href="https://github.com/milvus-io/milvus/blob/master/configs/milvus.yaml#L767-L769">Milvus 配置檔中</a>提供兩個配置參數<code translate="no">initMemSize</code> 和<code translate="no">maxMemSize</code> 。</p>
