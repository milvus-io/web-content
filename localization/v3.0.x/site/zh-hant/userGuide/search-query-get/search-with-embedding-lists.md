...
<p>此方法可保留非文字資訊，例如文件版面、影像和表格結構，這些資訊在使用純文字檢索系統時都會遺失。</p>
<p>
...
<button class="copy-code-btn"></button></code></pre>
<p>在上面的程式碼中，ColPali 模型會將影像的大小調整為 448 x 448 像素，然後將其分割成各個尺寸為 14 x 14 像素的修補碼。最後，這些斑塊會嵌入到 1,031 個嵌入式中，每個嵌入式有 128 個尺寸。</p>
