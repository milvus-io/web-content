...
summary: >-
  ...
  的篩選分為兩個層級：列級篩選用於選取父實體，而元素級篩選則用於限制哪些 Struct 元素會參與元素級向量搜尋。
---
...
<button class="copy-code-btn"></button></code></pre>
<p>此處使用<code translate="no">MATCH_ANY</code> ，是因為 EmbeddingList 的搜尋結果屬於實體層級。此篩選條件要求該實體中至少有一個片段為高品質的<code translate="no">&quot;index&quot;</code> 片段，但搜尋結果本身仍代表父實體。</p>
