...
<p>呼叫 `<code translate="no">flush()</code> ` 並非強制要求，但強烈建議執行此步驟以避免資料遺失。若跳過此步驟，快照將僅包含已排入緩衝區的資料。</p>
</div>
...
<p>您亦可為固定操作設定有效期限 (TTL)，使固定資料在期限屆滿時自動釋放。</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
...
<p>還原過程採用「<strong>複製分段</strong>」機制而非資料匯入，此方式更為高效，因為它</p>
<ul>
