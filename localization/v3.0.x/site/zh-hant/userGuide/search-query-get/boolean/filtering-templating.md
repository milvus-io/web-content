...
summary: >-
  ...
  引入了篩選表達式範本機制，旨在透過減少解析複雜表達式所需的時間來提升效率。本頁說明如何在搜尋、查詢及刪除操作中使用篩選表達式範本。
---
...
<p>假設您有一個涉及兩個欄位的篩選表達式：<code translate="no">age</code> 和<code translate="no">city</code> ，且您希望找出所有年齡大於 25 歲，並居住於「北京」或「上海」的人。與其直接將數值嵌入篩選表達式中，您可改用模板：</p>
...
<ul>
<li><p><strong>減少解析時間</strong>：透過將龐大或複雜的篩選表達式替換為佔位符，系統在解析和處理篩選條件上所花費的時間便會減少。</p></li>
<li><p><strong>提升查詢效能</strong>：隨著解析開銷降低，查詢效能隨之提升，從而帶來更高的每秒查詢數（QPS）與更快的回應時間。</p></li>
