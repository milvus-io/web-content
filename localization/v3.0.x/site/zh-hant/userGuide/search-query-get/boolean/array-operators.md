...
<tr><td><a href="/docs/zh-hant/array-operators.md#ARRAYLENGTH">ARRAY_LENGTH(識別碼)</a></td><td>篩選表達式</td><td>返回 ARRAY 欄位中的元素數量，並可與比較運算子結合進行篩選。</td></tr>
...
<tr><td><a href="/docs/zh-hant/array-operators.md#ARRAYREMOVE">ARRAY_REMOVE</a></td><td><code translate="no">upsert</code> 與<code translate="no">field_ops</code></td><td>從現有的 ARRAY 欄位中移除所有與請求有效載荷中某個值相符的元素。此功能自 Milvus v2.6.17 及後續版本起提供。</td></tr>
</tbody>
</table>
<h2 id="ARRAYCONTAINS" class="common-anchor-header">ARRAY_CONTAINS<button data-href="#ARRAYCONTAINS" class="anchor-icon" translate="no">
    ...
    </button></h2><p><code translate="no">ARRAY_CONTAINS</code> 運算子用於檢查陣列欄位中是否存在特定元素。當您需要查找陣列中包含指定元素的實體時，此功能非常實用。</p>
