...
title: 查詢
summary: 在 Milvus 中使用 Query、Get 和 QueryIterator 來擷取實體、篩選元資料、排序查詢結果和匯集標量值。
---
...
<li><p>按可空欄位排序時，NULL 值會放在升序 (NULLS LAST) 的最後，放在降序 (NULLS FIRST) 的最先。</p></li>
</ul>
