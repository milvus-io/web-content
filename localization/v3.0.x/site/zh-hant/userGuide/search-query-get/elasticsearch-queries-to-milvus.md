...
<table>
   ...
   <tr>
     ...
     <td><p><code translate="no">like</code> 操作員</p></td>
   </tr>
   <tr>
...
<button class="copy-code-btn"></button></code></pre>
<p>Milvus 並沒有完全等同的這個。然而，您可以尋找在指定欄位中值為指定詞彙之一的實體，如下所示：</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Milvus 作為專門的向量資料庫，使用索引類型來最佳化向量搜尋。通常，它會優先對高維向量資料進行近似最近鄰 (ANN) 搜尋。雖然使用 FLAT 索引類型的暴力 kNN 搜尋能提供精確的結果，但卻既耗時又耗資源。相比之下，使用 AUTOINDEX 或其他索引類型的 ANN 搜尋能平衡速度與精確度，提供比 kNN 更快、更節省資源的效能。</p>
