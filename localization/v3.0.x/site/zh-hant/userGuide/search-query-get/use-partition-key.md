...
<button class="copy-code-btn"></button></code></pre>
<p>啟用磁碟分割區金鑰隔離後，您仍可以依照<a href="/docs/zh-hant/use-partition-key.md#Set-Partition-Numbers">Set Partition Numbers（設定磁碟分割區號碼</a>）中的說明設定磁碟分割區金鑰和磁碟分割<a href="/docs/zh-hant/use-partition-key.md#Set-Partition-Numbers">區號碼</a>。請注意，基於分割區金鑰的篩選程式應該只包含特定的分割區金鑰值。</p>
