...
<li><p><a href="/docs/zh-hant/full-text-search.md#Perform-full-text-search">執行搜尋</a>：使用自然語言查詢文字，擷取根據 BM25 相關性排序的結果。</p></li>
</ol>
...
<h3 id="Define-the-BM25-function" class="common-anchor-header">定義 BM25 函式<button data-href="#Define-the-BM25-function" class="anchor-icon" translate="no">
    ...
    </button></h3><p>BM25 函式會將標記化的文字轉換成支援 BM25 計分的稀疏向量。</p>
<p>定義函數並將其加入您的模式：</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#go">Go</a> <a href="#javascript">NodeJS</a> <a href="#bash">cURL</a></div>
