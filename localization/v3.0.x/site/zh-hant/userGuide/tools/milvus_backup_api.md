...
<p>現在，您可以將備份檔案儲存到安全的地方，以便將來還原，或上傳到<a href="https://cloud.zilliz.com">Zilliz Cloud</a>，以您的資料建立一個受管理的向量資料庫。詳情請參閱<a href="https://zilliz.com/doc/migrate_from_milvus-2x">從 Milvus 遷移到 Zilliz Cloud</a>。</p>
