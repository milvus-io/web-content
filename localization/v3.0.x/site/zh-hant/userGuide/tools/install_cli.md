...
<h3 id="Install-via-pip" class="common-anchor-header">透過 pip 安裝<button data-href="#Install-via-pip" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>執行下列指令來安裝 Milvus_CLI。</p>
...
<h3 id="Prerequisites" class="common-anchor-header">先決條件<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h3><p>需要 Docker 19.03 或更新版本。</p>
<h3 id="Install-based-on-Docker-image" class="common-anchor-header">根據 Docker 映像檔安裝<button data-href="#Install-based-on-Docker-image" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Install-from-an-exe-file" class="common-anchor-header">從 .exe 檔案安裝<button data-href="#Install-from-an-exe-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><div class="alert note">此安裝方法僅適用於 Windows。 </div>
