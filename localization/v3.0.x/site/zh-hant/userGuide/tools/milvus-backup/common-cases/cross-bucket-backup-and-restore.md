...
<h2 id="Back-up-a-collection-from-milvusA" class="common-anchor-header">從 milvus_A 備份資料集<button data-href="#Back-up-a-collection-from-milvusA" class="anchor-icon" translate="no">
    ...
    </button></h3><p>到 milvus-backup 專案的目錄，建立一個名為 configs 的目錄：</p>
...
└── README.md
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Edit-configuration-file" class="common-anchor-header">步驟 2：編輯組態檔<button data-href="#Step-2-Edit-configuration-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>修改 backup.yaml 檔案，為<code translate="no">milvus_A</code> 設定適當的配置：</p>
<ul>
<li><p>連線 configs</p>
...
<li><p><code translate="no">minio.bucketName</code>:<code translate="no">milvus_A</code> 中用於儲存資料的儲存桶名稱。在本範例中，設定為<code translate="no">bucket_A</code> 。</p></li>
...
<h2 id="Restore-the-backup-to-milvusB" class="common-anchor-header">還原備份到 milvus_B<button data-href="#Restore-the-backup-to-milvusB" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Configure-restoration-settings" class="common-anchor-header">步驟 1：設定還原設定<button data-href="#Step-1-Configure-restoration-settings" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>重複步驟 2，修改還原至<code translate="no">milvus_B</code> 的設定，確保<code translate="no">minio.bucketName</code> 設定為<code translate="no">bucket_B</code> 。</p>
<p>以下是配置範例：</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Restore-backup" class="common-anchor-header">步驟 2：還原備份<button data-href="#Step-2-Restore-backup" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>還原備份到<code translate="no">milvus_B</code> ：</p>
