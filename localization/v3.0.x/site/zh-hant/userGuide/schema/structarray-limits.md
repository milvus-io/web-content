...
<tr><td>子欄位變更</td><td>StructArray 欄位建立後，您無法向該現有 StructArray 欄位新增子欄位。</td></tr>
...
<tbody>
<tr><td>Struct 並非頂層欄位類型。</td><td>建立一個 StructArray 欄位，其結構為<code translate="no">datatype=DataType.ARRAY</code> ，並設定<code translate="no">element_type=DataType.STRUCT</code> 及<code translate="no">struct_schema</code> 。</td></tr>
...
<tr><td>混合搜尋</td><td>混合搜尋請求僅在目標版本支援該搜尋組合時，方可包含 StructArray 向量子欄位請求。每個請求仍遵循已建立索引之向量子欄位的指標家族。</td></tr>
