...
<h1 id="ASCII-folding" class="common-anchor-header">ASCII 折疊<button data-href="#ASCII-folding" class="anchor-icon" translate="no">
    ...
    </button></h1><p><code translate="no">asciifolding</code> 過濾器可將<a href="https://en.wikipedia.org/wiki/Basic_Latin_(Unicode_block)">Basic Latin Unicode 區塊</a>(前 127 個 ASCII 字元) 以外的字元轉換為其 ASCII 對應字元。例如，它將<code translate="no">í</code> 等字元轉換為<code translate="no">i</code> ，使文字處理更簡單、更一致，特別是對於多語言內容。</p>
