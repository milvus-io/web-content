...
<h3 id="Prepare-data" class="common-anchor-header">準備資料<button data-href="#Prepare-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>在本節中，您需要準備一些隨機產生的資料，以便稍後插入。</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a></div>
...
<h3 id="Insert-data" class="common-anchor-header">插入資料<button data-href="#Insert-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>然後您就可以安全地將資料插入集合中。</p>
<div class="language-python">
...
<p>如果非模式定義欄位的名稱包含數位、字母和下劃線以外的字元，如加號 (+)、星號 (*) 或美元符號 (<span class="katex-error" title="ParseError: KaTeX parse error: Expected group after &#x27;_&#x27; at position 39: …the key within _̲_" style="color:#cc0000">) 等，當您在</span>布林表達式中使用它或在輸出欄位中包含它時<span class="katex-error" title="ParseError: KaTeX parse error: Expected group after &#x27;_&#x27; at position 39: …the key within _̲_" style="color:#cc0000">，您必須在 __meta</span>[]__ 中包含該<span class="katex-error" title="ParseError: KaTeX parse error: Expected group after &#x27;_&#x27; at position 39: …the key within _̲_" style="color:#cc0000">關鍵</span>字，如以下程式碼片段所示。</p>
