...
<li><p>使用 WeightedRanker 為圖片和文字搜尋結果指定權重。假設影像 ANN 搜尋的權重為 0.6，文字搜尋的權重為 0.4。</p>
<p><table>
<tr>
<th><p><strong>ID</strong></p></th>
<th><p><strong>得分 (影像)</strong></p></th>
...
<h3 id="Create-a-Weighted-Ranker" class="common-anchor-header">建立加權排名器<button data-href="#Create-a-Weighted-Ranker" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<table>
   ...
   <tr>
     ...
     <td><p>是</p></td>
     <td><p>指定要使用的排序方法。</p><p>必須設定為<code translate="no">weighted</code> 才能使用 Weighted Ranker。</p></td>
     <td><p><code translate="no">"weighted"</code></p></td>
   </tr>
   <tr>
     <td><p><code translate="no">params.weights</code></p></td>
     <td><p>是</p></td>
     <td><p>每個搜尋路徑對應的權重陣列；值∈ [0,1]。</p><p>如需詳細資訊，請參閱<a href="/docs/zh-hant/weighted-ranker.md#Mechanism-of-Weighted-Ranker">Weighted Ranker 的機制</a>。</p></td>
     <td><p><code translate="no">[0.1, 0.9]</code></p></td>
   </tr>
   <tr>
     <td><p><code translate="no">params.norm_score</code></p></td>
     <td><p>否</p></td>
     <td><p>是否在加權之前對原始分數進行規範化（使用 arctan）。</p><p>詳情請參閱<a href="/docs/zh-hant/weighted-ranker.md#Mechanism-of-Weighted-Ranker">加權排名機制</a>。</p></td>
...
<h3 id="Apply-to-hybrid-search" class="common-anchor-header">應用於混合搜尋<button data-href="#Apply-to-hybrid-search" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Weighted Ranker 專為結合多向量領域的混合搜尋作業而設計。執行混合搜尋時，您必須指定每條搜尋路徑的權重：</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
