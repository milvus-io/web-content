...
<h2 id="Sharp-drop-off-principle" class="common-anchor-header">陡峭下降原則<button data-href="#Sharp-drop-off-principle" class="anchor-icon" translate="no">
    ...
    </button></h2><p>指數衰減創造了一條曲線，一開始快速下降，然後逐漸平坦，形成接近但永遠不會到零的長尾。這種數學模式經常出現在自然現象中，如放射性衰減、人口下降、資訊隨時間的相關性等。</p>
...
<li><p><code translate="no">scale</code> (24 小時)：相關度降至衰減值的時間段 - 24 小時前的新聞，其相關度分數會減半 (0.5)。</p></li>
</ul>
