...
<h2 id="Create-a-Voyage-AI-ranker-function" class="common-anchor-header">建立 Voyage AI 排行榜功能<button data-href="#Create-a-Voyage-AI-ranker-function" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
