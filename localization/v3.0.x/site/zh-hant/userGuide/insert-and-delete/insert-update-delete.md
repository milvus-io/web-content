...
<ul>
<li><p><strong>集合建立後新增的欄位</strong>：如果您在建立資料集後才新增欄位，並且在插入時沒有指定值，Milvus 會自動以定義的預設值填入，如果沒有設定預設值，則以 NULL 填入。詳情請參閱<a href="/docs/zh-hant/add-fields-to-an-existing-collection.md">新增欄位到現有的集合</a>。</p></li>
