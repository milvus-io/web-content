...
<h3 id="Hardware-environment" class="common-anchor-header">하드웨어 환경<button data-href="#Hardware-environment" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Software-environment" class="common-anchor-header">소프트웨어 환경<button data-href="#Software-environment" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Deployment-scheme" class="common-anchor-header">배포 체계<button data-href="#Deployment-scheme" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>다른 테스트는 단지 CPU 코어 수, 메모리 크기 및 복제본(워커 노드) 수에 차이가 있을 뿐이며, 이는 Milvus 클러스터에만 적용됩니다.</li>
...
<h3 id="Data-sets" class="common-anchor-header">데이터 세트<button data-href="#Data-sets" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>이 테스트는 <a href="https://github.com/erikbern/ann-benchmarks/#data-sets">ANN-Benchmarks의</a> 오픈 소스 데이터 세트 SIFT(128개 차원)를 사용합니다.</p>
...
<h2 id="Test-results" class="common-anchor-header">테스트 결과<button data-href="#Test-results" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Milvus-220-vs-Milvus-210" class="common-anchor-header">Milvus 2.2.0 대 Milvus 2.1.0<button data-href="#Milvus-220-vs-Milvus-210" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><h4 id="Cluster" class="common-anchor-header">클러스터</h4><p><details>
...
<h3 id="Milvus-220-Scale-up" class="common-anchor-header">Milvus 2.2.0 스케일업<button data-href="#Milvus-220-Scale-up" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>하나의 쿼리노드에서 CPU 코어를 확장하여 확장 기능을 확인합니다.</p>
<p><details>
...
<h3 id="Milvus-220-Scale-out" class="common-anchor-header">Milvus 2.2.0 스케일 아웃<button data-href="#Milvus-220-Scale-out" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>더 많은 쿼리노드로 더 많은 복제본을 확장하여 스케일아웃 기능을 확인합니다.</p>
<div class="alert note">
