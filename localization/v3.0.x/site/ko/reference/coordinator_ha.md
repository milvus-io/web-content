...
<h2 id="Enable-coordinator-HA" class="common-anchor-header">코디네이터 HA 사용<button data-href="#Enable-coordinator-HA" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="With-Helm" class="common-anchor-header">헬름 사용<button data-href="#With-Helm" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>여러 코디네이터를 시작하고 활성-대기 모드에서 작동하도록 하려면 <code translate="no">values.yaml</code> 파일을 다음과 같이 변경해야 한다.</p>
<ul>
...
<h3 id="With-Docker" class="common-anchor-header">Docker 사용<button data-href="#With-Docker" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>여러 코디네이터를 시작하고 활성-대기 모드에서 작동하도록 하려면 Milvus 클러스터를 시작하는 데 사용하는 <code translate="no">docker-compose</code> 파일에 몇 가지 정의를 추가하면 됩니다.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="With-MacLinux-shell" class="common-anchor-header">Mac/Linux 셸 사용<button data-href="#With-MacLinux-shell" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>여러 코디네이터를 시작하고 활성-대기 모드에서 작동하도록 하려면 다음과 같이 하세요.</p>
<ol>
