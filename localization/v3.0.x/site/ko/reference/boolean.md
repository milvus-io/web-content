...
<h2 id="Operators" class="common-anchor-header">연산자<button data-href="#Operators" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Logical-operators" class="common-anchor-header">논리 연산자<button data-href="#Logical-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>논리 연산자는 두 표현식 간의 비교를 수행합니다.</p>
<table>
<thead>
...
<h3 id="Binary-arithmetic-operators" class="common-anchor-header">이진 산술 연산자<button data-href="#Binary-arithmetic-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>이진 산술 연산자는 두 개의 피연산자를 포함하며 기본적인 산술 연산을 수행하고 해당 결과를 반환할 수 있습니다.</p>
<table>
<thead>
<tr><th>기호</th><th>연산자</th><th>예제</th><th>설명</th></tr>
</thead>
...
<h3 id="Relational-operators" class="common-anchor-header">관계형 연산자<button data-href="#Relational-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>관계형 연산자는 기호를 사용하여 두 표현식 간의 같음, 같지 않음 또는 상대적 순서를 확인합니다.</p>
<table>
<thead>
<tr><th>기호</th><th>연산자</th><th>예제</th><th>설명</th></tr>
</thead>
