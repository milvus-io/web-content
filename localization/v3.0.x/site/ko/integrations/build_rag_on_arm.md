...
<h2 id="Prerequisite" class="common-anchor-header">전제 조건<button data-href="#Prerequisite" class="anchor-icon" translate="no">
    ...
    </button></h2><p>이 예제를 실행하려면 Arm 기반 서버에서 ML 워크로드를 비용 효율적으로 실행할 수 있는 방법을 제공하는 <a href="https://aws.amazon.com/ec2/graviton/">AWS Graviton을</a> 사용하는 것이 좋습니다. 이 노트북은 Ubuntu 22.04 LTS 시스템에서 AWS Graviton3 <code translate="no">c7g.2xlarge</code> 인스턴스에서 테스트되었습니다.</p>
...
<h3 id="Download-and-build-llamacpp" class="common-anchor-header">llama.cpp 다운로드 및 빌드<button data-href="#Download-and-build-llamacpp" class="anchor-icon" translate="no">
    ...
    </button></h3><p>다음 명령을 실행하여 소스로부터 llama.cpp를 빌드하는 데 필요한 make, cmake, gcc, g++ 및 기타 필수 도구를 설치합니다:</p>
...
<div class="alert note">
<p>이 양자화는 특히 Graviton3에 최적입니다. Graviton2의 경우 <code translate="no">Q4_0_4_4</code> 형식의 리퀀타이제이션을 수행해야 하며, Graviton4의 경우 <code translate="no">Q4_0_4_8</code> 형식이 리퀀타이제이션에 가장 적합합니다.</p>
</div>
