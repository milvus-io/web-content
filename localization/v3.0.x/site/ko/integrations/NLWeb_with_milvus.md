...
<h3 id="Installation" class="common-anchor-header">설치<button data-href="#Installation" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>리포지토리를 복제하고 환경을 설정합니다:</p>
...
<h3 id="Configuring-Milvus" class="common-anchor-header">Milvus 구성하기<button data-href="#Configuring-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><strong>Milvus를</strong> 사용하려면 구성을 업데이트하세요.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Loading-Data" class="common-anchor-header">데이터 로드<button data-href="#Loading-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>구성이 완료되면 RSS 피드를 사용하여 콘텐츠를 로드합니다.</p>
...
<h3 id="Running-the-Server" class="common-anchor-header">서버 실행하기<button data-href="#Running-the-Server" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>NLWeb을 시작하려면 <code translate="no">code</code> 디렉토리에서 실행합니다:</p>
