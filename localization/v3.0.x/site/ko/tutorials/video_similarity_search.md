...
<p>
   ...
   </span> <span class="img-wrapper"> <span>동영상_검색</span> </span> <span class="img-wrapper"> <img translate="no" src="https://milvus-docs.s3.us-west-2.amazonaws.com/assets/video_search_demo.gif" alt="video_search_demo" class="doc-image" id="video_search_demo" /><span>동영상_검색_데모</span> </span></p>
