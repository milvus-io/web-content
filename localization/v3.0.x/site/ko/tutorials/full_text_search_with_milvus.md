...
<h2 id="Preparation" class="common-anchor-header">준비하기<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Download-the-dataset" class="common-anchor-header">데이터 세트 다운로드<button data-href="#Download-the-dataset" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>다음 명령은 원래의 Anthropic <a href="https://github.com/anthropics/anthropic-cookbook/blob/main/skills/contextual-embeddings/guide.ipynb">데모에</a> 사용된 예제 데이터를 다운로드합니다.</p>
...
<h3 id="Install-Milvus-25" class="common-anchor-header">Milvus 2.5 설치<button data-href="#Install-Milvus-25" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>자세한 내용은 <a href="https://milvus.io/docs/install_standalone-docker-compose.md">공식 설치 가이드를</a> 참조하세요.</p>
<h3 id="Install-PyMilvus" class="common-anchor-header">파이밀버스 설치<button data-href="#Install-PyMilvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>다음 명령어를 실행하여 PyMilvus를 설치합니다:</p>
<pre><code translate="no" class="language-python">pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span> -U 
<button class="copy-code-btn"></button></code></pre>
<h3 id="Define-the-Retriever" class="common-anchor-header">리트리버 정의<button data-href="#Define-the-Retriever" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Insert-the-data" class="common-anchor-header">데이터 삽입<button data-href="#Insert-the-data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Test-Sparse-Search" class="common-anchor-header">스파스 검색 테스트<button data-href="#Test-Sparse-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
