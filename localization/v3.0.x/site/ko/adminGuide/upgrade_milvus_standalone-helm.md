...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Helm 차트를 사용하여 Milvus 독립형 버전 업그레이드<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>이 가이드에서는 Helm 차트를 사용하여 Milvus 독립형 배포를 v2.5.x에서 v3.0-beta로 업그레이드하는 방법을 설명합니다.</p>
...
<li>v3.0-beta로 업그레이드하기 전에 <strong>반드시</strong> v2.5.16 이상으로 업그레이드해야 <strong>합니다</strong>.</li>
</ul>
...
<h3 id="Step-3-Upgrade-to-v30-beta" class="common-anchor-header">3단계: v3.0-beta로 업그레이드<button data-href="#Step-3-Upgrade-to-v30-beta" class="anchor-icon" translate="no">
    ...
    </button></h3><p>v2.5.16이 정상적으로 실행되면 v3.0-beta로 업그레이드하십시오:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
