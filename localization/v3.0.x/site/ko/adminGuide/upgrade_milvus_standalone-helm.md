...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">Helm 차트를 사용하여 Milvus 독립형 버전 업그레이드<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>이 가이드에서는 Helm을 사용하여 Milvus 2.6.x 독립형 배포 환경을 v3.0.0으로 업그레이드하는 방법을 설명합니다.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>모든 필수 워크로드가 준비되었는지, Milvus가 ` <code translate="no">v3.0.0</code>`를 사용하는지, 기존 컬렉션에 대한 쿼리 및 검색이 가능한지 확인하십시오. v3.0.0 전용 기능을 활성화하기 전에 이러한 확인 작업을 완료하십시오.</p>
<div class="alert note">
