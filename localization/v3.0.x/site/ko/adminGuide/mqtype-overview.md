...
<tbody>
<tr><td><a href="/docs/ko/woodpecker.md">Woodpecker</a></td><td style="text-align:center">✔️ (임베디드)</td><td style="text-align:center">✔️ (내장형 또는 서비스)</td><td><strong>Milvus 3.x</strong> (두 모드 모두)</td><td>기본값이며 권장 설정입니다. 오브젝트 스토리지에 저장되는 클라우드 네이티브 WAL; 외부 서비스가 필요하지 않습니다.</td></tr>
