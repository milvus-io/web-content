...
<li><p>실행 중인 인스턴스의 메시지 큐를 변경하려면 <a href="/docs/ko/switch-mq-type.md">‘MQ 유형 변경’을</a> 참조하십시오. MQ 변경 기능은 <strong>Milvus 3.0 이상에서</strong> 사용할 수 있으므로, 먼저 Milvus 3.0 이상으로 업그레이드해야 합니다.</p></li>
</ul>
</div>
...
<li><strong>새 배포(Milvus 3.x):</strong> <strong>Woodpecker</strong> (기본값) <strong>를</strong> 사용하십시오. 독립 실행형(Standalone)의 경우 내장형으로 실행되며, 분산형(클러스터)의 경우 Helm으로 배포된 전용 <a href="/docs/ko/woodpecker.md#Deployment-modes">서비스를</a> 권장하는 기본값으로 사용하며, 내장형도 지원됩니다.</li>
...
<li><strong>RocksMQ:</strong> 독립형(standalone) 환경에서만 사용 가능하며, Milvus 3.x에서는 내장형 Woodpecker로 대체되었습니다.</li>
</ul>
