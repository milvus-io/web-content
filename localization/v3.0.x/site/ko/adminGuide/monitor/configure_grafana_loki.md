...
<ul>
<li>헬름을 사용하여 Milvus 클러스터에 <a href="https://grafana.com/docs/loki/latest/get-started/overview/">Loki</a> 및 <a href="https://grafana.com/docs/alloy/latest/">Alloy</a> 배포하기.</li>
<li>Loki용 오브젝트 스토리지 구성하기.</li>
<li>Grafana를 사용하여 로그 쿼리하기.</li>
</ul>
<p>참고로 <a href="https://grafana.com/docs/loki/latest/send-data/promtail/#promtail-agent">Promtail은</a> 더 이상 사용되지 않습니다. 따라서 Grafana Labs에서 공식적으로 제안한 새로운 에이전트로서 Kubernetes 로그를 수집하여 Loki로 전달할 수 있는 Alloy를 소개합니다.</p>
