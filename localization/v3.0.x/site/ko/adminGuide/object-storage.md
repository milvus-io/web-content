...
<thead>
<tr><th>제공업체/서비스</th><th style="text-align:center">Milvus 오브젝트 스토리지로 지원됨</th></tr>
</thead>
<tbody>
<tr><td>MinIO</td><td style="text-align:center">✔️ (자체 호스팅 배포 시 기본값)</td></tr>
<tr><td>AWS S3</td><td style="text-align:center">✔️</td></tr>
<tr><td>Azure Blob 스토리지</td><td style="text-align:center">✔️</td></tr>
...
<p>구성에 대한 자세한 내용은 <a href="/docs/ko/deploy_s3.md">‘Docker Compose 또는 Helm을 사용한 오브젝트 스토리지 구성’</a> 및 <a href="/docs/ko/object_storage_operator.md">‘Milvus Operator를 사용한 오브젝트 스토리지 구성’을</a> 참조하십시오.</p>
