...
order: 13
summary: >-
  이 문서에서는 mGTE 임베딩 모델을 사용하여 문서와 쿼리를 인코딩하기 위해 MGTEEmbeddingFunction을 사용하는 방법에 대해
  설명합니다.
title: mGTE
---
...
<p>그런 다음 MGTEEmbeddingFunction을 인스턴스화합니다:</p>
...
<p>인코딩에 사용할 mGTE 임베딩 모델의 이름입니다. 기본값은 <code translate="no">Alibaba-NLP/gte-multilingual-base</code> 입니다.</p></li>
</ul>
