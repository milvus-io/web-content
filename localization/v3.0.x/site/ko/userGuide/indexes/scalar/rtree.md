...
<ul>
<li><p><strong>v2.6.3</strong> 이하에서는 스칼라 인덱스를 삭제하기 전에 컬렉션을 해제해야 합니다.</p></li>
<li><p><strong>v2.6.4</strong> 이상에서는 더 이상 필요하지 않은 스칼라 인덱스는 컬렉션을 먼저 해제할 필요 없이 바로 삭제할 수 있습니다.</p></li>
</ul>
</div>
