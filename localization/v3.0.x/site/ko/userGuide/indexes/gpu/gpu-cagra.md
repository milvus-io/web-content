...
title: GPU_CAGRA
summary: >-
  GPU_CAGRA 인덱스는 GPU에 최적화된 그래프 기반 인덱스입니다. 고가의 훈련용 GPU를 사용하는 것보다 추론용 GPU를 활용해
...
<table>
   ...
   <tr>
     ...
     <td><p>정리(pruning) 전 그래프의 차수를 결정하여 리콜률과 생성 시간에 영향을 줍니다. 권장 값은 <code translate="no">32</code> 또는 <code translate="no">64</code> 입니다.</p></td>
