...
<tr><td><code translate="no">JSON</code> <code translate="no">VARCHAR</code> 로 형 변환된 경로</td><td>예</td><td>예</td><td>정확한 일치를 위해서는 JSON 경로 값이 문자열이어야 합니다. 성능 향상을 위해 JSON 경로에 인덱스를 생성하는 경우, ` <code translate="no">json_cast_type=&quot;varchar&quot;</code>`을 설정하십시오.</td></tr>
...
<p>여러 단어 중 하나와 일치시키려면 <code translate="no">|</code> 를 사용하여 선택지를 지정합니다:</p>
