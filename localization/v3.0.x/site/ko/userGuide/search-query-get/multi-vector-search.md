...
<ul>
<li><p>가중 점수 사용</p>
<p><code translate="no">WeightedRanker</code> 은 지정된 가중치로 각 벡터 필드 검색 결과에 중요성을 할당하는 데 사용됩니다. 일부 벡터 필드를 다른 필드보다 우선순위를 지정하는 경우 <code translate="no">WeightedRanker(value1, value2, ..., valueN)</code> 에서 이를 결합된 검색 결과에 반영할 수 있습니다.</p>
