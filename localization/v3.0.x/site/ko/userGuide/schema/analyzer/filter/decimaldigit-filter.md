...
title: 십진수 자릿수Compatible with Milvus 3.0.0+
summary: 십진수 자릿수 필터는 유니코드 십진수 자릿수를 ASCII 자릿수로 변환합니다.
beta: Milvus 3.0.0+
---
<h1 id="Decimal-Digit" class="common-anchor-header">십진수 자릿수<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 3.0.0+</span><button data-href="#Decimal-Digit" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p><code translate="no">decimaldigit</code> 필터는 지원되는 문자 집합의 유니코드 십진수 자릿수를 ASCII 자릿수로 변환하는 내장 토큰 필터입니다. 이를 통해 다양한 언어와 문자 체계에 걸쳐 숫자 토큰의 일관성을 유지할 수 있습니다.</p>
