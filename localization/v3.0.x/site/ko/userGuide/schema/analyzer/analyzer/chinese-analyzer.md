...
title: 중국어
summary: '이 중국어 분석기는 중국어 텍스트 처리를 위해 특별히 설계되어, 효과적인 분절 및 토큰화를 제공합니다.'
---
<h1 id="Chinese" class="common-anchor-header">중국어<button data-href="#Chinese" class="anchor-icon" translate="no">
    ...
    </button></h1><p><code translate="no">chinese</code> 분석기는 중국어 텍스트 처리를 위해 특별히 설계되었으며, 효과적인 구분 및 토큰화를 제공합니다.</p>
<h3 id="Definition" class="common-anchor-header">정의<button data-href="#Definition" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><code translate="no">chinese</code> 분석기는 다음으로 구성됩니다.</p>
<ul>
<li><p><strong>토큰화기</strong>: <code translate="no">jieba</code> 토큰화기를 사용하여 어휘와 문맥을 기반으로 중국어 텍스트를 토큰으로 분할합니다. 자세한 내용은 <a href="/docs/ko/jieba-tokenizer.md">Jieba를</a> 참조하십시오.</p></li>
<li><p><strong>필터</strong>: <code translate="no">cnalphanumonly</code> 필터를 사용하여 비중국어 문자가 포함된 토큰을 제거합니다. 자세한 내용은 <a href="/docs/ko/cnalphanumonly-filter.md">Cnalphanumonly를</a> 참조하십시오.</p></li>
</ul>
<p><code translate="no">chinese</code> 분석기의 기능은 다음 사용자 정의 분석기 구성과 동일합니다:</p>
<div class="alert note">
<p>내장된 <code translate="no">chinese</code> 분석기는 병음(Pinyin) 토큰을 생성하지 않습니다. 중국어 텍스트를 병음 쿼리어와 매칭하려면, <code translate="no">jieba</code> 토큰화기를 사용하고 <a href="/docs/ko/pinyin-filter.md"><code translate="no">pinyin</code></a> 필터를 적용한 사용자 정의 분석기를 사용하십시오.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Configuration" class="common-anchor-header">구성<button data-href="#Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><code translate="no">chinese</code> 분석기를 필드에 적용하려면, <code translate="no">analyzer_params</code> 에서 <code translate="no">type</code> 를 <code translate="no">chinese</code> 로 설정하기만 하면 됩니다.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
