...
title: 중국어
summary: '이 중국어 분석기는 중국어 텍스트 처리를 위해 특별히 설계되어, 효과적인 구분 및 토큰화를 제공합니다.'
---
...
<h3 id="Configuration" class="common-anchor-header">구성<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h3><p><code translate="no">chinese</code> 분석기를 필드에 적용하려면, <code translate="no">analyzer_params</code> 에서 <code translate="no">type</code> 을 <code translate="no">chinese</code> 로 설정하기만 하면 됩니다.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
