...
<button class="copy-code-btn"></button></code></pre>
<p>또한 Milvus는 <code translate="no">ARRAY_CONTAINS</code>, <code translate="no">ARRAY_CONTAINS_ALL</code>, <code translate="no">ARRAY_CONTAINS_ANY</code>, <code translate="no">ARRAY_LENGTH</code> 와 같은 고급 배열 필터링 연산자를 지원하여 쿼리 기능을 한층 더 강화합니다. 자세한 내용은 <a href="/docs/ko/array-operators.md">ARRAY 연산자를</a> 참조하십시오.</p>
