...
<tbody>
<tr><td>Struct는 최상위 필드 유형이 아닙니다.</td><td><code translate="no">datatype=DataType.ARRAY</code> 로 StructArray 필드를 생성하고, <code translate="no">element_type=DataType.STRUCT</code> 및 <code translate="no">struct_schema</code> 를 지정합니다.</td></tr>
