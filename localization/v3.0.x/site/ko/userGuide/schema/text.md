...
<p><code translate="no">TEXT</code> 필드는 null 값을 지원합니다. 이 기능을 사용하려면 <code translate="no">nullable</code> 을 <code translate="no">True</code> 로 설정하십시오. 자세한 내용은 <a href="/docs/ko/nullable-and-default.md">‘Nullable Field’를</a> 참조하십시오.</p>
</div>
