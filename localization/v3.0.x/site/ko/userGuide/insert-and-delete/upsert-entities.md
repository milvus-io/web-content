...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p><code translate="no">field_ops</code> 를 통해 필드에 두 연산자 중 하나를 적용하면 부분 업데이트 세미언틱스가 암시적으로 활성화됩니다. 따라서 <code translate="no">field_ops</code> 와 함께 <code translate="no">partial_update=True</code> 를 전달할 필요가 <strong>없습니다</strong>.</p>
</div>
