...
<li><code translate="no">hf-inference</code> 에서 현재 <a href="https://huggingface.co/tasks/sentence-similarity"><code translate="no">sentence-similarity</code></a> 해당 태스크용입니다.</li>
...
<h2 id="Use-Hugging-Face-Ranker" class="common-anchor-header">Hugging Face Ranker 사용<button data-href="#Use-Hugging-Face-Ranker" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Hugging Face Ranker는 검색 시점에 정의 및 적용됩니다. 컬렉션 스키마를 변경하지 않고도 각 검색마다 랭커를 변경하거나 생략할 수 있습니다.</p>
...
<li>모델 랭커의 동작 및 제한 사항에 대해서는 <a href="/docs/ko/model-ranker-overview.md">‘모델 랭커 개요’를</a> 참조하십시오.</li>
<li>호스팅된 Hugging Face 추론 제공자를 통해 임베딩을 생성하려면 <a href="/docs/ko/hugging-face.md">Hugging Face를</a> 참조하십시오.</li>
<li>랭커를 하이브리드 검색에 적용하려면 <a href="/docs/ko/multi-vector-search.md">‘다중 벡터 하이브리드 검색’을</a> 참조하십시오.</li>
</ul>
