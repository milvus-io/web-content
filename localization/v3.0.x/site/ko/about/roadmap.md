...
<li><p>포인트, 지역, 공간 인덱싱( <em>라이브러리</em> 공간 기반)을 포함한 <strong>지리 데이터</strong> 지원을 추가하여 LBS 및 GIS에서 사용 사례를 확장합니다.</p></li>
...
<li><p>멀티클러스터 배포에서 <strong>액티브-스탠바이 고가용성(HA)을</strong> 구현하세요.</p></li>
</ul>
<h4 id="🔹-Vector-Lake-v02" class="common-anchor-header">🔹 <strong>Vector Lake(v0.2)</strong></h4><ul>
<li><p><strong>텍스트/블롭 스토리지와</strong> <strong>다중 버전 스냅샷 관리를</strong> 지원합니다.</p></li>
...
<p>👉 <strong>깃허브:</strong> <a href="https://github.com/milvus-io/milvus">milvus-io/milvus</a></p>
