...
summary: >-
  ...
  처리하는 대규모 쿠버네티스 클러스터에 이르기까지, 다양한 규모의 사용 사례를 지원합니다. 현재 Milvus에는 Milvus Lite,
...
<tr><td>일관성 수준</td><td>강력</td><td>강력<br/>제한된 지연<br/>세션<br/>최종</td><td>강력<br/>제한된 비신선도<br/>세션<br/>최종</td></tr>
