...
<h2 id="Overview" class="common-anchor-header">개요<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Operator는 대상 Kubernetes(K8s) 클러스터에 전체 Milvus 서비스 스택을 배포하고 관리할 수 있도록 지원하는 솔루션입니다. 이 스택에는 모든 Milvus 구성 요소와 etcd, MinIO와 같은 관련 종속성이 포함되어 있으며, 내장 메시지 큐로는 Woodpecker가 사용됩니다.</p>
...
<p>Milvus 클러스터가 준비되면, Milvus 클러스터 내 모든 파드의 상태는 다음과 유사해야 합니다.</p>
