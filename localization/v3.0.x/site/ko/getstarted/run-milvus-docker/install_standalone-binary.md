...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">RPM/DEB 패키지 다운로드<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://github.com/milvus-io/milvus/releases/tag/v2.6.9">Milvus 릴리스 페이지에서</a> 시스템 아키텍처에 맞는 RPM/DEB 패키지를 다운로드할 수 있습니다.</p>
<ul>
<li>x86_64/amd64의 경우, <strong>milvus_2.6.9-1_amd64.deb</strong> 또는 <strong>milvus_2.6.9-1_amd64.rpm</strong> 패키지를 다운로드하십시오.</li>
<li>ARM64의 경우, <strong>milvus_2.6.9-1_arm64.deb</strong> 또는 <strong>milvus_2.6.9-1_arm64.rpm</strong> 패키지를 다운로드하십시오.</li>
</ul>
...
rpm -qa| grep milvus
<button class="copy-code-btn"></button></code></pre>
<p>DEB 기반 시스템(Ubuntu 및 Debian 등)의 경우, ` <code translate="no">apt</code> ` 명령을 사용하여 패키지를 설치하십시오.</p>
...
<ul>
<li><p><a href="/docs/ko/quickstart.md">'빠른 시작'을</a> 확인하여 Milvus의 기능을 알아보세요.</p></li>
