...
<li><a href="/docs/it/single-vector-search.md#Range-search">Ricerca per intervallo</a>: Trova i vettori entro un raggio specificato dal vettore di interrogazione.</li>
<li><a href="/docs/it/multi-vector-search.md">Ricerca ibrida</a>: Esegue una ricerca RNA basata su più campi vettoriali.</li>
...
<h3 id="Advanced-Data-Types" class="common-anchor-header">Tipi di dati avanzati<button data-href="#Advanced-Data-Types" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Oltre ai tipi di dati primitivi, Milvus supporta diversi tipi di dati avanzati e le rispettive metriche di distanza applicabili.</p>
<ul>
...
<h3 id="Acceleration" class="common-anchor-header">Accelerazione<button data-href="#Acceleration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Security-and-Authorization" class="common-anchor-header">Sicurezza e autorizzazione<button data-href="#Security-and-Authorization" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
