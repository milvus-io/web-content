...
<li><p>Milvus Capture Data Change (CDC) Milvus CDC può replicare le modifiche dei dati da un cluster Milvus a un altro per il disaster recovery primario-standby. Per maggiori informazioni, consultare <a href="/docs/it/milvus_cdc_overview.md">Milvus CDC</a>.</p></li>
