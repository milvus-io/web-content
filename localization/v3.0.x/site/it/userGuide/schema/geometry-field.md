...
<h2 id="Next-Accelerate-queries" class="common-anchor-header">Avanti: Accelerare le query<button data-href="#Next-Accelerate-queries" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Per impostazione predefinita, le query sui campi di <code translate="no">GEOMETRY</code> senza indice eseguono una scansione completa di tutte le righe, che può essere lenta su grandi insiemi di dati. Per accelerare le query geometriche, creare un indice <code translate="no">RTREE</code> sul campo GEOMETRIA.</p>
