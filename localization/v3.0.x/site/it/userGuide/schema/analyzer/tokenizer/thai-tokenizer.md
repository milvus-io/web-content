...
<button class="copy-code-btn"></button></code></pre>
<p>Questa pipeline personalizzata non è equivalente all’analizzatore <code translate="no">thai</code> integrato, poiché non include il dizionario delle parole vuote <code translate="no">_thai_</code> integrato. Per la pipeline predefinita completa, utilizzare <code translate="no">{&quot;type&quot;: &quot;thai&quot;}</code>.</p>
<p>Il tokenizzatore applica il seguente comportamento:</p>
<ul>
<li><strong>Segmentazione in tailandese</strong>: segmenta il testo in tailandese in token di parole senza fare affidamento sugli spazi.</li>
