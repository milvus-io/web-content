...
<h2 id="Configuration" class="common-anchor-header">Configurazione<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Il filtro <code translate="no">asciifolding</code> è integrato in Milvus. Per utilizzarlo, basta specificare il suo nome nella sezione <code translate="no">filter</code> all'interno di <code translate="no">analyzer_params</code>.</p>
