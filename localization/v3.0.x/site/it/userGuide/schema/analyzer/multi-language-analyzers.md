...
<ul>
<li><p>Fornire il testo della query specificando il nome di un analizzatore e Milvus elaborerà la query utilizzando l'analizzatore specificato.</p></li>
...
<li><p><strong>Campo vettoriale</strong> (<code translate="no">sparse</code>): Questo campo memorizzerà i vettori sparsi generati dalla funzione BM25. Questi vettori rappresentano la forma analizzabile dei dati di testo e costituiscono l’oggetto effettivo della ricerca effettuata da Milvus.</p></li>
</ul>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
...
<button class="copy-code-btn"></button></code></pre>
<p>Questa funzione applica automaticamente l’analizzatore appropriato a ciascuna voce di testo in base al suo identificatore di lingua. Per ulteriori informazioni sul recupero di testo basato su BM25, consultare <a href="/docs/it/full-text-search.md">Ricerca full-text</a>.</p>
...
<ul>
<li><p><code translate="no">collection_name=&quot;multilang_demo&quot;</code> assegnare un nome alla collezione per riferimento futuro.</p></li>
<li><p><code translate="no">schema=schema</code> applica la struttura dei campi e la funzione che hai definito.</p></li>
...
<h2 id="Step-4-Perform-search-operations" class="common-anchor-header">Passaggio 4: Eseguire le operazioni di ricerca<button data-href="#Step-4-Perform-search-operations" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Quando si effettuano ricerche con analizzatori multilingue, il file ` <code translate="no">search_params</code> ` contiene una configurazione fondamentale:</p>
<ul>
