...
<h1 id="Default-Values" class="common-anchor-header">Valori predefiniti<button data-href="#Default-Values" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus consente di impostare valori predefiniti per i campi scalari (escluso il campo primario). Quando un campo ha un valore predefinito configurato, Milvus lo applica automaticamente se non vengono forniti dati durante l'inserimento.</p>
