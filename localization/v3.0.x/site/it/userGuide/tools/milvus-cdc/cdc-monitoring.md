...
<h3 id="Metrics-for-CDC-tasks" class="common-anchor-header">Metriche per le attività CDC<button data-href="#Metrics-for-CDC-tasks" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Per iniziare, importate il file <a href="https://github.com/zilliztech/milvus-cdc/blob/main/server/configs/cdc-grafana.json">cdc-grafana.json</a> in Grafana. Questo aggiungerà una dashboard specificamente progettata per monitorare lo stato delle attività CDC.</p>
