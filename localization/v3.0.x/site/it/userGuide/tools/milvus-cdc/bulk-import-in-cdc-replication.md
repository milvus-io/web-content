...
<ol>
<li><p><strong>Fase di importazione</strong>: Milvus carica i dati sul cluster primario e replica l’importazione sul cluster di standby, ma i dati importati rimangono invisibili. Il processo di importazione si ferma allo stato “ <code translate="no">Uncommitted</code> ” e rimane in attesa.</p></li>
...
<h2 id="Step-1-Enable-import-in-a-replicating-cluster" class="common-anchor-header">Passaggio 1: Abilitare l’importazione in un cluster in replica<button data-href="#Step-1-Enable-import-in-a-replicating-cluster" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<pre><code translate="no" class="language-yaml"><span class="hljs-attr">dataCoord:</span>
  <span class="hljs-attr">import:</span>
    <span class="hljs-attr">enableInReplicatingCluster:</span> <span class="hljs-literal">true</span>
<button class="copy-code-btn"></button></code></pre>
<p>Questa impostazione è aggiornabile, quindi può diventare effettiva senza un riavvio completo.</p>
...
<p>Ciascun cluster legge i file di importazione dal proprio object storage. Assicurati che i file da importare siano presenti sia nell’object storage primario che in quello di standby. Puoi caricare i file su entrambi i cluster oppure utilizzare un object storage leggibile da entrambi i cluster. Se i file mancano sul cluster di standby, l’importazione replicata fallirà su tale cluster con un errore “oggetto non trovato”.</p>
