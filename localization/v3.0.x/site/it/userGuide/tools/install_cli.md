...
<li>Installare <a href="https://www.python.org/downloads/release/python-390/">Python 3.9</a> o successivo</li>
...
<h3 id="Install-via-pip" class="common-anchor-header">Installazione tramite pip<button data-href="#Install-via-pip" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Eseguite il seguente comando per installare Milvus_CLI.</p>
