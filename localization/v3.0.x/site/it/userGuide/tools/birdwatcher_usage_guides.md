...
<h1 id="Use-Birdwatcher" class="common-anchor-header">Utilizzare Birdwatcher<button data-href="#Use-Birdwatcher" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida spiega come usare Birdwatcher per controllare lo stato di Milvus e configurarlo al volo.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-sessions" class="common-anchor-header">Elenco delle sessioni<button data-href="#List-sessions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Per elencare le sessioni associate a diversi componenti di Milvus:</p>
...
<h3 id="Check-databases-and-collections" class="common-anchor-header">Controllare i database e le raccolte<button data-href="#Check-databases-and-collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>È possibile elencare tutti i database e le raccolte.</p>
<ul>
...
<h3 id="Check-index-details" class="common-anchor-header">Controllare i dettagli degli indici<button data-href="#Check-index-details" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Eseguite il seguente comando per elencare in dettaglio tutti i file indice.</p>
...
==================================================================
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-partitions" class="common-anchor-header">Elenco delle partizioni<button data-href="#List-partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Eseguire il seguente comando per elencare tutte le partizioni di una raccolta specifica.</p>
...
--- Total Database(s): 1
<button class="copy-code-btn"></button></code></pre>
<h3 id="Check-channel-status" class="common-anchor-header">Controllare lo stato del canale<button data-href="#Check-channel-status" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Eseguire il seguente comando per visualizzare lo stato del canale</p>
...
--- Total Channels: 1
<button class="copy-code-btn"></button></code></pre>
<h3 id="List-all-replicas-and-segments" class="common-anchor-header">Elenco di tutte le repliche e dei segmenti<button data-href="#List-all-replicas-and-segments" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="List-configurations" class="common-anchor-header">Elenco delle configurazioni<button data-href="#List-configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>È possibile far elencare a Birdwatcher le configurazioni attuali di ogni componente di Milvus.</p>
...
<h3 id="Probe-collection-with-known-primary-key" class="common-anchor-header">Sondare le raccolte con una chiave primaria nota<button data-href="#Probe-collection-with-known-primary-key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Nel comando <code translate="no">probe</code>, si deve specificare la chiave primaria usando il flag <code translate="no">pk</code> e l'ID della collezione usando il flag <code translate="no">collection</code>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Probe-all-collections-with-mock-queries" class="common-anchor-header">Sondare tutte le raccolte con le finte query<button data-href="#Probe-all-collections-with-mock-queries" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>È anche possibile far sondare a Birdwatcher tutte le raccolte con finte query.</p>
