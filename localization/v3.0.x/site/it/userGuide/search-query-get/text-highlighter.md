...
<p>Quando l'evidenziazione è abilitata, Milvus restituisce il testo evidenziato in un campo dedicato <code translate="no">highlight</code>. Per impostazione predefinita, l'output evidenziato viene restituito come frammento a partire dal primo termine corrispondente.</p>
...
<li><p>Viene restituito un solo frammento perché <code translate="no">num_of_fragments</code> è 1.</p></li>
...
<h3 id="Example-1-Highlight-search-terms-in-BM25-full-text-search" class="common-anchor-header">Esempio 1: Evidenziare i termini di ricerca nella ricerca full text BM25<button data-href="#Example-1-Highlight-search-terms-in-BM25-full-text-search" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Questo esempio mostra come evidenziare i termini di ricerca nella ricerca BM25 full text.</p>
<ul>
