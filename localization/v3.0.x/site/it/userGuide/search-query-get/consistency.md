...
<p>Gli utenti devono trovare un compromesso tra l'accuratezza della query e la sua latenza. Se gli utenti hanno requisiti di coerenza elevati e non sono sensibili alla latenza della query, possono impostare GuaranteeTs su un valore il più grande possibile; se gli utenti desiderano ricevere i risultati della ricerca rapidamente e sono più tolleranti nei confronti della precisione della query, allora GuaranteeTs può essere impostato su un valore più piccolo.</p>
<p>
