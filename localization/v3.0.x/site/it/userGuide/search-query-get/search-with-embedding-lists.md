...
<h3 id="Step-1-Install-the-dependencies" class="common-anchor-header">Passo 1: installare le dipendenze<button data-href="#Step-1-Install-the-dependencies" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Eseguite il seguente comando per installare le dipendenze.</p>
...
<h2 id="ColPali-text-retrieval-system" class="common-anchor-header">Sistema di recupero del testo ColPali<button data-href="#ColPali-text-retrieval-system" class="anchor-icon" translate="no">
    ...
    </button></h2><p>In questa sezione, verrà creato un sistema di recupero del testo basato su ColPali, utilizzando l'Array of Structs di Milvus. Prima di ciò, è necessario configurare un'istanza di Milvus v2.6.x e un cluster di Milvus Cloud compatibile con Milvus v2.6.x.</p>
<h3 id="Step-1-Install-the-dependencies" class="common-anchor-header">Passo 1: Installare le dipendenze<button data-href="#Step-1-Install-the-dependencies" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
