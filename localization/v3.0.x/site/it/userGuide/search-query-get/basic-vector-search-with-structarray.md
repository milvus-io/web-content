...
<tbody>
<tr><td>Creare un campo StructArray, ad esempio <code translate="no">chunks</code>.</td><td><a href="/docs/it/create-structarray-field.md">Creare un campo StructArray</a></td></tr>
...
<li><p>Per esaminare i tipi di dati, le metriche, i filtri e i limiti specifici per versione supportati, consultare <a href="/docs/it/structarray-limits.md">Limiti di StructArray</a>.</p></li>
</ol>
