...
<h3 id="Step-1-Get-the-snapshot-metadata-path" class="common-anchor-header">Passaggio 1: Ottenere il percorso dei metadati dello snapshot<button data-href="#Step-1-Get-the-snapshot-metadata-path" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Creare o selezionare uno snapshot da una normale raccolta Milvus, quindi descriverlo per ottenere la sua posizione nell’object storage.</p>
...
<h3 id="Step-2-Create-and-refresh-a-milvus-table-external-collection" class="common-anchor-header">Passaggio 2: creare e aggiornare una raccolta esterna " <code translate="no">milvus-table</code> "<button data-href="#Step-2-Create-and-refresh-a-milvus-table-external-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
