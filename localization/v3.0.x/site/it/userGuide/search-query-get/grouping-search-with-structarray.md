...
<li><p>Non utilizzare una query di tipo " <code translate="no">EmbeddingList</code> " o una metrica " <code translate="no">MAX_SIM*</code> " per la ricerca con raggruppamento.</p></li>
...
<li><p>Supporre che la ricerca raggruppata a livello di elemento ricalcoli un punteggio di tipo EmbeddingList ( <code translate="no">MAX_SIM*</code> ). Il raggruppamento comprime i risultati a livello di elemento; non modifica il modello di punteggio.</p></li>
