...
<h2 id="ARRAYCONTAINS" class="common-anchor-header">ARRAY_CONTAINS<button data-href="#ARRAYCONTAINS" class="anchor-icon" translate="no">
    ...
    </button></h2><p>L'operatore <code translate="no">ARRAY_CONTAINS</code> controlla se un elemento specifico esiste in un campo array. È utile quando si vogliono trovare entità in cui un dato elemento è presente nell'array.</p>
...
<p><strong>Esempio</strong></p>
<p>Per trovare tutte le entità in cui l'array <code translate="no">history_temperatures</code> contiene o <code translate="no">23</code> o <code translate="no">24</code>, si può usare:</p>
