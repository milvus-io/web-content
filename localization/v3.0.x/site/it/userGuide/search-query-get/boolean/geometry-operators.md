...
<h2 id="Supported-geometry-operators" class="common-anchor-header">Operatori geometrici supportati<button data-href="#Supported-geometry-operators" class="anchor-icon" translate="no">
    ...
    </button></h2><p>La tabella seguente elenca gli operatori geometrici disponibili in Milvus.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="STINTERSECTS--stintersects" class="common-anchor-header">ST_INTERESSI / st_intersetti<button data-href="#STINTERSECTS--stintersects" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
