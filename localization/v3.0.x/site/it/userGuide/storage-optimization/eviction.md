...
<table>
   ...
   <tr>
     ...
     <td><p>Carichi di lavoro che possono tollerare brevi picchi di latenza o pause temporanee durante i picchi di utilizzo. Utile quando lo svuotamento asincrono non può recuperare lo spazio abbastanza velocemente.</p></td>
     <td><p>Carichi di lavoro sensibili alla latenza che richiedono prestazioni di query fluide e prevedibili. Ideale per la gestione proattiva delle risorse.</p></td>
   </tr>
   <tr>
