...
<li><p><strong>TF_boost(..., k1)</strong> aumenta con la frequenza del termine, ma si satura con l'aumentare della frequenza</p></li>
...
<h2 id="Step-2-Insert-text-data-into-the-collection" class="common-anchor-header">Passo 2: Inserire i dati di testo nella collezione<button data-href="#Step-2-Insert-text-data-into-the-collection" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Dopo aver impostato la collezione e l'indice, si è pronti per inserire i dati di testo. In questo processo, è sufficiente fornire il testo grezzo. La funzione BM25, definita in precedenza, genera automaticamente il vettore sparse per ogni voce di testo.</p>
