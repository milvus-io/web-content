...
<h2 id="Delete-Entities-by-Filtering-Conditions" class="common-anchor-header">Eliminazione di entità in base a condizioni di filtro<button data-href="#Delete-Entities-by-Filtering-Conditions" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Per eliminare in blocco più entità che condividono alcuni attributi, è possibile utilizzare le espressioni di filtro. L'esempio di codice sottostante utilizza l'operatore <strong>in</strong> per eliminare in blocco tutte le entità con il campo <strong>colore</strong> impostato sui valori <strong>rosso</strong> e <strong>viola</strong>. È possibile utilizzare anche altri operatori per costruire espressioni di filtro che soddisfino le proprie esigenze. Per ulteriori informazioni sulle espressioni di filtro, si rimanda a <a href="/docs/it/boolean.md">Filtraggio spiegato</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Delete-Entities-by-Primary-Keys" class="common-anchor-header">Eliminare le entità in base alle chiavi primarie<button data-href="#Delete-Entities-by-Primary-Keys" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
