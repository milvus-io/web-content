---
id: rag_pipeline.md
title: 'Prompt: Condotto Milvus RAG'
summary: >-
  Regole per gli assistenti di codifica AI per costruire pipeline RAG con
  Milvus.
---
<h1 id="RAG-Pipeline" class="common-anchor-header">Pipeline RAG<button data-href="#RAG-Pipeline" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Regole end-to-end per la creazione di pipeline RAG con Milvus, tra cui ingestione, chunking, embedding, recupero ibrido con BM25 e aggiornamento dei documenti con upsert. Copiate il prompt completo qui sotto nel vostro strumento di IA per applicare queste regole automaticamente. Per una panoramica di tutti i prompt, vedere <a href="/docs/it/milvus_for_agents.md">Prompt AI</a>.</p>
