...
<p>
   ...
   </span> <span class="img-wrapper"> <span>Test di accuratezza</span> </span> <span class="img-wrapper"> <img translate="no" src="https://milvus-docs.s3.us-west-2.amazonaws.com/assets/performance_nlist_nprobe.png" alt="Performance test" class="doc-image" id="performance-test" /><span>Test di performance</span> </span></p>
...
<li>Unitevi al nostro <a href="https://discord.com/invite/8uyFbECzPX">canale Discord</a> per trovare supporto e partecipare alla nostra comunità open-source.</li>
</ul>
