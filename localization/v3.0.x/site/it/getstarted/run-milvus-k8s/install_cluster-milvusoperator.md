...
<li><p><a href="/docs/it/prerequisite-helm.md#How-can-I-start-a-K8s-cluster-locally-for-test-purposes">Crea un cluster K8s</a>.</p></li>
...
<button class="copy-code-btn"></button></code></pre>
<p>Il comando sopra riportato distribuisce un cluster Milvus con <strong>Woodpecker</strong> come coda dei messaggi (consigliato per la versione 3.0.0) e tutti i nuovi componenti architetturali, incluso lo Streaming Node.</p>
