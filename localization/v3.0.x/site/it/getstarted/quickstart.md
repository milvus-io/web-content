...
<h3 id="Vector-search" class="common-anchor-header">Ricerca vettoriale<button data-href="#Vector-search" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Milvus accetta una o più richieste di ricerca vettoriale allo stesso tempo. Il valore della variabile query_vectors è un elenco di vettori, dove ogni vettore è un array di numeri float.</p>
