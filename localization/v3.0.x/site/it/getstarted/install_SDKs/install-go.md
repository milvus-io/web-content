...
<h1 id="Install-Milvus-Go-SDK" class="common-anchor-header">Installare l'SDK Milvus Go<button data-href="#Install-Milvus-Go-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questo argomento descrive come installare l'SDK Milvus Go per Milvus.</p>
...
<h2 id="Requirement" class="common-anchor-header">Requisiti<button data-href="#Requirement" class="anchor-icon" translate="no">
    ...
    </button></h2><p>È necessario GO (1.17 o successivo).</p>
<h2 id="Install-Milvus-GO-SDK" class="common-anchor-header">Installare l'SDK di Milvus GO<button data-href="#Install-Milvus-GO-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Installare l'SDK Milvus GO e le dipendenze tramite <code translate="no">go get</code>.</p>
