...
<h3 id="1-Download-and-configure-the-YAML-file" class="common-anchor-header">1. Scarica e configura il file YAML<button data-href="#1-Download-and-configure-the-YAML-file" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Scarica <a href="https://github.com/milvus-io/milvus/releases/download/v3.0.2/milvus-standalone-docker-compose-gpu.yml"><code translate="no">milvus-standalone-docker-compose-gpu.yml</code></a> e salvalo come docker-compose.yml manualmente o con il seguente comando.</p>
...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>Se non si riesce a eseguire il comando sopra indicato, verificare se sul sistema è installato Docker Compose V1. In tal caso, si consiglia di migrare a Docker Compose V2 in base alle note riportate in <a href="https://docs.docker.com/compose/">questa pagina</a>.</p>
</div>
<p>Dopo l'avvio di Milvus,</p>
<ul>
<li>i container denominati <strong>milvus-standalone</strong>, <strong>milvus-minio</strong> e <strong>milvus-etcd</strong> saranno attivi.
<ul>
...
<li>Il container <strong>milvus-minio</strong> serve localmente le porte <strong>9090</strong> e <strong>9091</strong> con le credenziali di autenticazione predefinite e mappa i propri dati in <strong>volumes/minio</strong> nella cartella corrente.</li>
