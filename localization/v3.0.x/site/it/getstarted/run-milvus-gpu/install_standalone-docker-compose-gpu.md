...
<h3 id="1-Download-and-configure-the-YAML-file" class="common-anchor-header">1. Scarica e configura il file YAML<button data-href="#1-Download-and-configure-the-YAML-file" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Scarica <a href="https://github.com/milvus-io/milvus/releases/download/v3.0-beta/milvus-standalone-docker-compose-gpu.yml"><code translate="no">milvus-standalone-docker-compose-gpu.yml</code></a> e salvalo come docker-compose.yml manualmente o con il seguente comando.</p>
...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>Se non si riesce a eseguire il comando sopra riportato, verificare che sul sistema sia installato Docker Compose V1. In tal caso, si consiglia di migrare a Docker Compose V2 in base alle note riportate in <a href="https://docs.docker.com/compose/">questa pagina</a>.</p>
</div>
...
<p>Se sono stati assegnati più dispositivi GPU a Milvus nel file docker-compose.yml, è possibile specificare quale dispositivo GPU sia visibile o disponibile per l’uso.</p>
...
<ol>
<li><p>Utilizzare il seguente comando per copiare il file ` <code translate="no">milvus.yaml</code> ` dal contenitore Milvus alla propria macchina locale. Sostituire ` <code translate="no">&lt;milvus_container_id&gt;</code> ` con l’ID effettivo del proprio contenitore Milvus.</p>
...
<li><p>Consultare <a href="/docs/it/milvus-webui.md">l’interfaccia web di Milvus</a> per saperne di più sull’istanza di Milvus.</p></li>
