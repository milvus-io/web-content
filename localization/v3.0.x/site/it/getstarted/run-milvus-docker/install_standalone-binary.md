...
<h2 id="Download-the-RPMDEB-Package" class="common-anchor-header">Scaricare il pacchetto RPM/DEB<button data-href="#Download-the-RPMDEB-Package" class="anchor-icon" translate="no">
    ...
    </button></h2><p>È possibile scaricare il pacchetto RPM/DEB in base all'architettura del sistema dalla <a href="https://github.com/milvus-io/milvus/releases/tag/v3.0-beta">pagina Milvus Releases</a>.</p>
<ul>
