...
<p>Scarica sempre la configurazione Docker Compose più recente per garantire la compatibilità con le funzionalità della versione 3.0.0.</p>
<ul>
<li><p>Se non si è riusciti a eseguire il comando sopra indicato, verificare se sul proprio sistema è installato Docker Compose V1. In tal caso, si consiglia di migrare a Docker Compose V2 in base alle note riportate in <a href="https://docs.docker.com/compose/">questa pagina</a>.</p></li>
...
<button class="copy-code-btn"></button></code></pre>
<p>È inoltre possibile accedere all’interfaccia web di Milvus all’indirizzo <code translate="no">http://127.0.0.1:9091/webui/</code> per ulteriori informazioni sull’istanza di Milvus in uso. Per i dettagli, consultare la documentazione relativa <a href="/docs/it/milvus-webui.md">all’interfaccia web di Milvus</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Per cambiare la coda dei messaggi <em>dopo</em> l’aggiornamento, consultare la sezione " <a href="/docs/it/switch-mq-type.md">Cambiare il tipo di MQ</a>".</p>
