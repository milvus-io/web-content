...
<p>Indipendentemente dalla modalità di implementazione, ogni istanza di Milvus si basa su una coda di messaggi, un sistema di archiviazione oggetti e un archivio di metadati — per impostazione predefinita <strong>Woodpecker</strong>, <strong>MinIO</strong> ed <strong>etcd</strong>. Per saperne di più su queste dipendenze, ottimizzarle o collegare servizi esterni, consulta <a href="/docs/it/data-infra-integration-overview.md">la sezione Infrastruttura dati e integrazione</a>.</p>
<p><span class="img-wrapper">
   ...
   <span>Scegli l’opzione di implementazione più adatta al tuo caso d’uso</span>
