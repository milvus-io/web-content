...
<h2 id="Installation" class="common-anchor-header">Installazione<button data-href="#Installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Prima di iniziare, installare tutti i pacchetti Python necessari per l'utilizzo successivo.</p>
...
<h2 id="Create-Collection" class="common-anchor-header">Creare la raccolta<button data-href="#Create-Collection" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Defining-necessary-variables" class="common-anchor-header">Definire le variabili necessarie<button data-href="#Defining-necessary-variables" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Add-schema" class="common-anchor-header">Aggiungere lo schema<button data-href="#Add-schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Prima di inserire i dati nel database di Milvus Lite, è necessario definire il campo dati, che in questo caso si chiama schema. Attraverso la creazione di un oggetto <code translate="no">CollectionSchema</code> e l'aggiunta di un campo dati attraverso <code translate="no">add_field()</code>, possiamo controllare il tipo di dati e le loro caratteristiche. Questo passo è obbligatorio prima di inserire qualsiasi dato in Milvus.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Create-index" class="common-anchor-header">Creare un indice<button data-href="#Create-index" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Per ogni schema è meglio avere un indice, in modo che l'interrogazione sia molto più efficiente. Per creare un indice, abbiamo bisogno prima di tutto di un oggetto <code translate="no">index_params</code> e poi di aggiungere altri dati dell'indice a questo oggetto <code translate="no">IndexParams</code>.</p>
...
<h3 id="Create-collection" class="common-anchor-header">Creare la collezione<button data-href="#Create-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Upload-documents" class="common-anchor-header">Caricare i documenti<button data-href="#Upload-documents" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Dopo aver creato una raccolta, siamo pronti a popolarla con i documenti. In <code translate="no">whyhow_rbr</code> questo viene fatto usando il metodo <code translate="no">upload_documents</code> di <code translate="no">MilvusClient</code>. Esso esegue i seguenti passaggi:</p>
<ul>
...
<li><strong>Inserimento</strong>: Caricare sia le incorporazioni che i metadati su Milvus Lite.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Rules" class="common-anchor-header">Regole<button data-href="#Rules" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Clean-up" class="common-anchor-header">Pulire<button data-href="#Clean-up" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Infine, dopo aver implementato tutte le istruzioni, è possibile ripulire il database chiamando <code translate="no">drop_collection()</code>.</p>
