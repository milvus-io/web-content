...
<button class="copy-code-btn"></button></code></pre>
<p>In questo codice, per prima cosa controlliamo se la collezione esiste già e, in caso affermativo, la eliminiamo. Questo ci assicura di partire da zero. Creiamo l'insieme con una dimensione di 1024, che corrisponde alla dimensione di output degli embeddings di Twelve Labs.</p>
