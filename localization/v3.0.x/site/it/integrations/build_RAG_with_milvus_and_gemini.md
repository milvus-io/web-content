...
summary: >-
  ...
  Gemini per generare testo sulla base di una determinata query. Utilizzeremo
...
<p>Se state utilizzando Google Colab, per abilitare le dipendenze appena installate potrebbe essere necessario <strong>riavviare il runtime</strong> (fate clic sul menu “Runtime” nella parte superiore dello schermo e selezionate “Riavvia sessione” dal menu a tendina).</p>
</div>
...
<h3 id="Prepare-the-data" class="common-anchor-header">Preparazione dei dati<button data-href="#Prepare-the-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Utilizziamo le pagine delle FAQ della <a href="https://github.com/milvus-io/milvus-docs/releases/download/v2.4.6-preview/milvus_docs_2.4.x_en.zip">Documentazione Milvus 2.4.x</a> come conoscenza privata nel nostro RAG; si tratta di una buona fonte di dati per una semplice pipeline RAG.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Definiamo i prompt di sistema e utente per il modello linguistico. Questo prompt viene assemblato con i documenti recuperati da Milvus.</p>
