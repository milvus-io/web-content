...
<h3 id="Steps-to-replace-astraDB-with-Milvus" class="common-anchor-header">Passi per sostituire astraDB con Milvus:<button data-href="#Steps-to-replace-astraDB-with-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Embed-knowledge-into-the-RAG-system" class="common-anchor-header">Inserire le conoscenze nel sistema RAG<button data-href="#Embed-knowledge-into-the-RAG-system" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
