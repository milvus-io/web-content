...
<h3 id="Option-1-Using-Cursor-Settings-UI" class="common-anchor-header">Opzione 1: Utilizzando l'interfaccia utente delle impostazioni di Cursor.<button data-href="#Option-1-Using-Cursor-Settings-UI" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Option-2-Using-Project-specific-Configuration-Recommended" class="common-anchor-header">Opzione 2: Utilizzo della configurazione specifica del progetto (consigliata)<button data-href="#Option-2-Using-Project-specific-Configuration-Recommended" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="For-Cursor" class="common-anchor-header">Per il Cursore<button data-href="#For-Cursor" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="🔍-Search-and-Query-Tools" class="common-anchor-header">🔍 Strumenti di ricerca e interrogazione<button data-href="#🔍-Search-and-Query-Tools" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="📁-Collection-Management" class="common-anchor-header">📁 Gestione delle raccolte<button data-href="#📁-Collection-Management" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="📊-Data-Operations" class="common-anchor-header">Operazioni sui dati<button data-href="#📊-Data-Operations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="⚙️-Index-Management" class="common-anchor-header">⚙️ Gestione degli indici<button data-href="#⚙️-Index-Management" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Examples" class="common-anchor-header">Esempi<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Using-Claude-Desktop" class="common-anchor-header">Utilizzo di Claude Desktop<button data-href="#Using-Claude-Desktop" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><h4 id="Example-1-Listing-Collections" class="common-anchor-header">Esempio 1: Elenco delle collezioni</h4><pre><code translate="no">What are the collections <span class="hljs-selector-tag">I</span> have in my Milvus DB?
<button class="copy-code-btn"></button></code></pre>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Using-Cursor" class="common-anchor-header">Uso del cursore<button data-href="#Using-Cursor" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><h4 id="Example-Creating-a-Collection" class="common-anchor-header">Esempio: Creare una raccolta</h4><p>Nel Compositore di Cursor, è possibile chiedere:</p>
...
<h2 id="Troubleshooting" class="common-anchor-header">Risoluzione dei problemi<button data-href="#Troubleshooting" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Common-Issues" class="common-anchor-header">Problemi comuni<button data-href="#Common-Issues" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><h4 id="Connection-Errors" class="common-anchor-header">Errori di connessione</h4><p>Se si verificano errori come "Failed to connect to Milvus server":</p>
<ol>
...
<li>Verificare se l'istanza Milvus richiede l'autenticazione</li>
...
<h3 id="Getting-Help" class="common-anchor-header">Aiuto<button data-href="#Getting-Help" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Se si continuano a riscontrare problemi:</p>
<ol>
