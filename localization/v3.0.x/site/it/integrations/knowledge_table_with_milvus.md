...
<p>Per Milvus, si devono impostare le variabili d'ambiente <code translate="no">MILVUS_DB_URI</code> e <code translate="no">MILVUS_DB_TOKEN</code>. Ecco alcuni suggerimenti:</p>
<blockquote>
<ul>
