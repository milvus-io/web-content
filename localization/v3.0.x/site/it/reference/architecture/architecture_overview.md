...
<h2 id="Detailed-Layer-Architecture" class="common-anchor-header">Architettura dettagliata dei livelli<button data-href="#Detailed-Layer-Architecture" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Layer-1-Access-Layer" class="common-anchor-header">Livello 1: Livello di accesso<button data-href="#Layer-1-Access-Layer" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Composto da un gruppo di proxy stateless, il livello di accesso è il livello frontale del sistema e l'endpoint per gli utenti. Convalida le richieste dei client e riduce i risultati restituiti:</p>
<ul>
...
<h3 id="Layer-2-Coordinator" class="common-anchor-header">Livello 2: Coordinatore<button data-href="#Layer-2-Coordinator" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Il Coordinator è il cervello di Milvus. In qualsiasi momento, nell'intero cluster è attivo esattamente un Coordinatore, responsabile di mantenere la topologia del cluster, di programmare tutti i tipi di attività e di garantire la coerenza a livello di cluster.</p>
...
<h3 id="Layer-3-Worker-Nodes" class="common-anchor-header">Livello 3: Nodi lavoratori<button data-href="#Layer-3-Worker-Nodes" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Streaming-node" class="common-anchor-header">Nodo di streaming<button data-href="#Streaming-node" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Lo Streaming Node funge da "mini-cervello" a livello di shard, fornendo garanzie di coerenza a livello di shard e il ripristino degli errori basato sul WAL Storage sottostante. Nel frattempo, lo Streaming Node è anche responsabile dell'interrogazione dei dati in crescita e della generazione dei piani di query. Inoltre, gestisce anche la conversione dei dati in crescita in dati sigillati (storici).</p>
<h3 id="Query-node" class="common-anchor-header">Nodo di interrogazione<button data-href="#Query-node" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Layer-4-Storage" class="common-anchor-header">Livello 4: archiviazione<button data-href="#Layer-4-Storage" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Lo storage è l'ossatura del sistema, responsabile della persistenza dei dati. Comprende il meta storage, il log broker e l'object storage.</p>
...
<h3 id="Example-Data-Flow-Search-Operation" class="common-anchor-header">Esempio di flusso di dati: operazione di ricerca<button data-href="#Example-Data-Flow-Search-Operation" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Example-Data-Flow-Data-Insertion" class="common-anchor-header">Esempio di flusso di dati: inserimento di dati<button data-href="#Example-Data-Flow-Data-Insertion" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Comprendere il <a href="/docs/it/tune_consistency.md">modello di consistenza</a> e le garanzie di transazione in Milvus</li>
</ul>
