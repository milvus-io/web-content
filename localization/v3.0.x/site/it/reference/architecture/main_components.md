...
<li>Nella modalità woodpecker zero-disk, <strong>WAL</strong> utilizza direttamente lo storage di oggetti e il meta storage senza altre implementazioni, riducendo le dipendenze di terze parti.</li>
</ul></li>
</ul>
...
<h3 id="Cluster" class="common-anchor-header">Cluster<button data-href="#Cluster" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Una modalità di distribuzione distribuita di Milvus in cui ogni componente funziona in modo indipendente e può essere scalato per elasticità. Questa configurazione è adatta per grandi insiemi di dati e scenari ad alto carico.</p>
<p>
