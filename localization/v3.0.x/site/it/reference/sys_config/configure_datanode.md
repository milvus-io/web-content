...
<h2 id="dataNodedataSyncskipModecoldTime" class="common-anchor-header"><code translate="no">dataNode.dataSync.skipMode.coldTime</code><button data-href="#dataNodedataSyncskipModecoldTime" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Attiva la modalità di salto dopo che per x secondi sono presenti solo messaggi di timetick      </td>
      <td>60</td>
    </tr>
  </tbody>
</table>
...
<h2 id="dataNodememoryforceSyncWatermark" class="common-anchor-header"><code translate="no">dataNode.memory.forceSyncWatermark</code><button data-href="#dataNodememoryforceSyncWatermark" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        soglia di memoria per la versione standalone; al raggiungimento di tale soglia, i segmenti verranno sincronizzati.      </td>
      <td>0,5</td>
    </tr>
  </tbody>
</table>
...
<h2 id="dataNodetextinlineThreshold" class="common-anchor-header"><code translate="no">dataNode.text.inlineThreshold</code><button data-href="#dataNodetextinlineThreshold" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        La soglia di dimensione, in byte, utilizzata per scegliere il percorso di archiviazione per il valore di un campo TEXT. I valori inferiori a questa soglia vengono memorizzati direttamente nei dati del campo. I valori superiori o uguali a questa soglia vengono memorizzati separatamente come payload LOB, mentre i dati del campo conservano un riferimento interno.      </td>
      <td>65536</td>
    </tr>
  </tbody>
</table>
