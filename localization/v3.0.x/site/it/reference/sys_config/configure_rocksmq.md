...
summary: Imparate a configurare rocksmq per Milvus.
---
<h1 id="rocksmq-related-Configurations" class="common-anchor-header">Configurazioni relative a rocksmq<button data-href="#rocksmq-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Se si vuole abilitare kafka, è necessario commentare le configurazioni di pulsar</p>
<p>kafka:</p>
...
<h2 id="rocksmqpath" class="common-anchor-header"><code translate="no">rocksmq.path</code><button data-href="#rocksmqpath" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Prefisso della chiave in cui Milvus memorizza i dati in RocksMQ.</li>      
        ...
        <li>Impostare un prefisso di chiave di root facile da identificare per Milvus se il servizio etcd esiste già.</li>      </td>
...
<h2 id="rocksmqlrucacheratio" class="common-anchor-header"><code translate="no">rocksmq.lrucacheratio</code><button data-href="#rocksmqlrucacheratio" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Rapporto memoria cache rocksdb      </td>
      <td>0.06</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqrocksmqPageSize" class="common-anchor-header"><code translate="no">rocksmq.rocksmqPageSize</code><button data-href="#rocksmqrocksmqPageSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        La dimensione massima dei messaggi in ogni pagina di RocksMQ. I messaggi in RocksMQ sono controllati e cancellati (se scaduti) in batch in base a questo parametro. Unità: Byte.      </td>
      <td>67108864</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqretentionTimeInMinutes" class="common-anchor-header"><code translate="no">rocksmq.retentionTimeInMinutes</code><button data-href="#rocksmqretentionTimeInMinutes" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Il tempo massimo di conservazione dei messaggi acked in RocksMQ. I messaggi acked in RocksMQ vengono conservati per il periodo di tempo specificato e poi cancellati. Unità: Minuto.      </td>
      <td>4320</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqretentionSizeInMB" class="common-anchor-header"><code translate="no">rocksmq.retentionSizeInMB</code><button data-href="#rocksmqretentionSizeInMB" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        La dimensione massima di conservazione dei messaggi acked di ogni argomento in RocksMQ. I messaggi acked di ogni argomento vengono cancellati se la loro dimensione supera questo parametro. Unità: MB.      </td>
      <td>8192</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqcompactionInterval" class="common-anchor-header"><code translate="no">rocksmq.compactionInterval</code><button data-href="#rocksmqcompactionInterval" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Intervallo di tempo per attivare la compattazione rocksdb per rimuovere i dati cancellati. Unità: Secondo      </td>
      <td>86400</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqcompressionTypes" class="common-anchor-header"><code translate="no">rocksmq.compressionTypes</code><button data-href="#rocksmqcompressionTypes" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Tipo di compressione della compattazione, supporta solo l'uso di 0,7. 0 significa non comprimere, 7 userà zstd. La lunghezza dei tipi indica il numero di livelli di rocksdb.      </td>
      <td>0,0,7,7,7</td>
    </tr>
  </tbody>
</table>
