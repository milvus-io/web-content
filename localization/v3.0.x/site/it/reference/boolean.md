...
<h2 id="Operators" class="common-anchor-header">Operatori<button data-href="#Operators" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Logical-operators" class="common-anchor-header">Operatori logici<button data-href="#Logical-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Gli operatori logici eseguono un confronto tra due espressioni.</p>
<table>
<thead>
...
<h3 id="Binary-arithmetic-operators" class="common-anchor-header">Operatori aritmetici binari<button data-href="#Binary-arithmetic-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Gli operatori aritmetici binari contengono due operandi e possono eseguire operazioni aritmetiche di base e restituire il risultato corrispondente.</p>
<table>
<thead>
<tr><th>Simbolo</th><th>Operazione</th><th>Esempio</th><th>Descrizione</th></tr>
</thead>
...
<h3 id="Relational-operators" class="common-anchor-header">Operatori relazionali<button data-href="#Relational-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Gli operatori relazionali utilizzano i simboli per verificare l'uguaglianza, la disuguaglianza o l'ordine relativo tra due espressioni.</p>
<table>
<thead>
<tr><th>Simbolo</th><th>Operazione</th><th>Esempio</th><th>Descrizione</th></tr>
</thead>
...
<h2 id="Operator-precedence-and-associativity" class="common-anchor-header">Precedenza e associatività degli operatori<button data-href="#Operator-precedence-and-associativity" class="anchor-icon" translate="no">
    ...
    </button></h2><p>La tabella seguente elenca la precedenza e l'associatività degli operatori. Gli operatori sono elencati dall'alto in basso, con precedenza decrescente.</p>
<table>
<thead>
