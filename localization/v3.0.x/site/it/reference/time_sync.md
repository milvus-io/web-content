...
<p><code translate="no">MsgStream</code> elabora i messaggi in lotti in base ai tick temporali per garantire che i messaggi in uscita soddisfino i requisiti del timestamp. Nell'esempio precedente, consumerà tutti i record, tranne <code translate="no">InsertMsgs</code>, da <code translate="no">Proxy2</code> a <code translate="no">Timestamp: 120</code>, poiché è successivo all'ultimo TimeTick.</p>
