...
<li><strong>Aggiornamento dalla versione 2.5.x alla 2.6.x:</strong> <strong>Limiti della coda dei messaggi</strong>: durante l'aggiornamento a Milvus v3.0.0, è necessario mantenere la coda dei messaggi attualmente in uso. Il passaggio a sistemi di coda dei messaggi diversi durante l'aggiornamento non è supportato. Il supporto per la modifica dei sistemi di coda dei messaggi sarà disponibile nelle versioni future.
