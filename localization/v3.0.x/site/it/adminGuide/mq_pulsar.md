...
<h3 id="Configure" class="common-anchor-header">Configurazione<button data-href="#Configure" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Per connettere Milvus a un servizio Pulsar <strong>esterno</strong>, disabilitare Pulsar integrato e abilitare l'<code translate="no">externalPulsar</code> e in un override dell'<code translate="no">values.yaml</code>:</p>
