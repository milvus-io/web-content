...
<li><strong>È necessario</strong> eseguire l’aggiornamento alla versione v2.5.16 o successive con l’opzione « <code translate="no">mixCoordinator</code> » abilitata prima di passare alla versione v3.0-beta.</li>
</ul>
