...
<h3 id="Before-your-start" class="common-anchor-header">Prima di iniziare<button data-href="#Before-your-start" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Tweak-Milvus-configurations" class="common-anchor-header">Modificare le configurazioni di Milvus<button data-href="#Tweak-Milvus-configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Questa guida presuppone che abbiate già <a href="/docs/it/gcp.md">implementato un cluster Milvus dietro un bilanciatore di carico Layer-4 su GCP</a>.</p>
...
<h3 id="Set-up-a-health-check-endpoint" class="common-anchor-header">Impostare un endpoint di controllo dello stato di salute<button data-href="#Set-up-a-health-check-endpoint" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Prepare-TLS-certificates" class="common-anchor-header">Preparare i certificati TLS<button data-href="#Prepare-TLS-certificates" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>TLS richiede certificati per funzionare. <strong>Esistono due modi per creare i certificati: quelli autogestiti e quelli gestiti da Google.</strong></p>
...
<h3 id="Create-an-Ingress-to-generate-a-Layer-7-Load-Balancer" class="common-anchor-header">Creare un Ingress per generare un bilanciatore di carico Layer-7<button data-href="#Create-an-Ingress-to-generate-a-Layer-7-Load-Balancer" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Creare un file YAML con uno dei seguenti snippet.</p>
<ul>
