...
<h1 id="Encryption-in-Transit" class="common-anchor-header">Crittografia in transito<button data-href="#Encryption-in-Transit" class="anchor-icon" translate="no">
    ...
    </button></h1><p>TLS (Transport Layer Security) è un protocollo di crittografia che garantisce la sicurezza delle comunicazioni. Milvus proxy utilizza l'autenticazione TLS a una e due vie.</p>
