...
<p>Fare clic sulla scheda <code translate="no">Graph</code> e inserire l'espressione <code translate="no">up{job=&quot;default/my-release&quot;}</code> nella casella di input dell'espressione. Si dovrebbero visualizzare le metriche dei componenti Milvus.</p>
<p>
