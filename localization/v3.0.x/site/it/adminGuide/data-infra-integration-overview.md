...
<h1 id="Data-Infrastructure" class="common-anchor-header">Infrastruttura dei dati<button data-href="#Data-Infrastructure" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus si avvale di un sistema di archiviazione dei metadati, di un sistema di archiviazione a oggetti e di una coda di messaggi come infrastruttura dati di base. Questo capitolo illustra i componenti che è possibile configurare:</p>
<ul>
