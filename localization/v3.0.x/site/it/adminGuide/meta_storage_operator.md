...
<h3 id="External-etcd" class="common-anchor-header">etcd esterno<button data-href="#External-etcd" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><h4 id="Example" class="common-anchor-header">Esempio</h4><p>L'esempio seguente configura un servizio etcd esterno.</p>
...
<h3 id="Internal-etcd" class="common-anchor-header">etcd interno<button data-href="#Internal-etcd" class="anchor-icon" translate="no">
    ...
    </button></h3><p><code translate="no">inCluster</code> indica che all'avvio di un cluster Milvus, un servizio etcd si avvia automaticamente nel cluster.</p>
