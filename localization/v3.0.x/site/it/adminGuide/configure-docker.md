...
<h2 id="Download-a-configuration-file" class="common-anchor-header">Scaricare un file di configurazione<button data-href="#Download-a-configuration-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://raw.githubusercontent.com/milvus-io/milvus/v3.0.2/configs/milvus.yaml">Scaricare</a> direttamente il file ` <code translate="no">milvus.yaml</code> ` oppure utilizzare il comando seguente.</p>
...
<tbody>
  <tr>
    ...
    <td>
        <ul>
            <li><a href="/docs/it/configure_rootcoord.md">Coordinata radice</a></li>
            <li><a href="/docs/it/configure_proxy.md">Proxy</a></li>
            <li><a href="/docs/it/configure_querycoord.md">Coordinamento delle query</a></li>
            <li><a href="/docs/it/configure_querynode.md">Nodo di query</a></li>
            <li><a href="/docs/it/configure_indexnode.md">Nodo indice</a></li>
            <li><a href="/docs/it/configure_datacoord.md">Coordinate dei dati</a></li>
            <li><a href="/docs/it/configure_datanode.md">Nodo dati</a></li>
            <li><a href="/docs/it/configure_localstorage.md">Archiviazione locale</a></li>
            ...
            <li><a href="/docs/it/configure_indexcoord.md">Coordinate indice</a></li>
            <li><a href="/docs/it/configure_metastore.md">Metastore</a></li>
            <li><a href="/docs/it/configure_mq.md">Coda dei messaggi</a></li>
...
<h2 id="Download-an-installation-file" class="common-anchor-header">Scarica il file di installazione<button data-href="#Download-an-installation-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Scarica il file di installazione per Milvus <a href="https://github.com/milvus-io/milvus/releases/download/v3.0.2/milvus-standalone-docker-compose.yml">standalone</a> e salvalo come <code translate="no">docker-compose.yml</code>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Modify-the-installation-file" class="common-anchor-header">Modifica del file di installazione<button data-href="#Modify-the-installation-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Mappa il percorso locale del tuo file <code translate="no">milvus.yaml</code> ai percorsi corrispondenti dei file di configurazione <code translate="no">/milvus/configs/milvus.yaml</code> all’interno di tutte le sezioni <code translate="no">volumes</code> nel container Docker.</p>
...
<h2 id="Start-Milvus" class="common-anchor-header">Avvio di Milvus<button data-href="#Start-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una volta completate le modifiche al file di configurazione e al file di installazione, è possibile avviare Milvus.</p>
