...
<h1 id="Switch-MQ-Type" class="common-anchor-header">Cambiare il tipo di coda dei messaggi (MQ)<button data-href="#Switch-MQ-Type" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Questa guida descrive come passare dalla coda dei messaggi (MQ) di un'istanza Milvus esistente <strong>da Woodpecker a un'altra coda dei messaggi</strong>, in modalità online e senza tempi di inattività.</p>
