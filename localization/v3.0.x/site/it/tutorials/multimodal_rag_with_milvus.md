...
<h2 id="Load-Data" class="common-anchor-header">Caricare i dati<button data-href="#Load-Data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>In questa sezione verranno caricate nel database delle immagini di esempio con i corrispondenti embedding.</p>
...
<h3 id="Insert-into-Milvus" class="common-anchor-header">Inserimento in Milvus<button data-href="#Insert-into-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Inserisce le immagini con i percorsi e le rappresentazioni corrispondenti nella collezione di Milvus.</p>
<div class="alert note">
<p>Per quanto riguarda l'argomento " <code translate="no">MilvusClient</code>":</p>
<ul>
<li>Impostare <code translate="no">uri</code> come file locale, ad esempio <code translate="no">./milvus_demo.db</code>, è il metodo più pratico, poiché utilizza automaticamente <a href="https://milvus.io/docs/milvus_lite.md">Milvus Lite</a> per archiviare tutti i dati in questo file.</li>
...
<h2 id="Multimodal-Search-with-Generative-Reranker" class="common-anchor-header">Ricerca multimodale con Generative Reranker<button data-href="#Multimodal-Search-with-Generative-Reranker" class="anchor-icon" translate="no">
    ...
    </button></h2><p>In questa sezione, cercheremo innanzitutto immagini pertinenti tramite una query multimodale, quindi utilizzeremo il servizio LLM per riorganizzare i risultati e individuare quello migliore con relativa spiegazione.</p>
...
<p><span class="img-wrapper">
   ...
   <span>Creare una vista panoramica</span>
...
<h3 id="Quick-Deploy" class="common-anchor-header">Implementazione rapida<button data-href="#Quick-Deploy" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Per scoprire come avviare una demo online con questo tutorial, fare riferimento <a href="https://github.com/milvus-io/bootcamp/tree/master/tutorials/quickstart/apps/multimodal_rag_with_milvus">all’applicazione di esempio</a>.</p>
