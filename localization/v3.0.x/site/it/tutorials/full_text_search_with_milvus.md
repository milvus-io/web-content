...
<h3 id="Multi-language-Analyzer" class="common-anchor-header">Analizzatore multilingue<button data-href="#Multi-language-Analyzer" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Milvus supporta analizzatori multilingue per documenti in più lingue. Utilizzare <code translate="no">multi_analyzer_params</code> in <code translate="no">BM25BuiltInFunction</code>:</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Per maggiori dettagli, consultare la <a href="https://milvus.io/docs/multi-language-analyzers.md">documentazione</a> dell'<a href="https://milvus.io/docs/multi-language-analyzers.md">analizzatore multilingue</a>.</p>
<h2 id="Using-Hybrid-Search-and-Reranking-in-RAG" class="common-anchor-header">Uso della ricerca ibrida e del reranking in RAG<button data-href="#Using-Hybrid-Search-and-Reranking-in-RAG" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
