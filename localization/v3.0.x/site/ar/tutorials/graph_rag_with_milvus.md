...
<h2 id="Offline-Data-Loading" class="common-anchor-header">تحميل البيانات دون اتصال بالإنترنت<button data-href="#Offline-Data-Loading" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Data-Preparation" class="common-anchor-header">إعداد البيانات<button data-href="#Data-Preparation" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>سوف نستخدم مجموعة بيانات النانو التي تقدم العلاقة بين عائلة برنولي وأويلر للتوضيح كمثال. تحتوي مجموعة البيانات النانو على 4 مقاطع ومجموعة من الثلاثيات المقابلة، حيث يحتوي كل ثلاثي على موضوع ومسند وكائن. عمليًا، يمكنك استخدام أي نهج لاستخراج الثلاثيات من مجموعة البيانات المخصصة الخاصة بك.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Data-Insertion" class="common-anchor-header">إدراج البيانات<button data-href="#Data-Insertion" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>إنشاء مجموعات ميلفوس للكيان والعلاقة والممر. يتم استخدام مجموعة الكيانات ومجموعة العلاقات كمجموعات رئيسية لبناء الرسم البياني في طريقتنا، بينما يتم استخدام مجموعة المقاطع كمقارنة استرجاع RAG الساذجة أو لغرض مساعد.</p>
...
<h2 id="Online-Querying" class="common-anchor-header">الاستعلام عبر الإنترنت<button data-href="#Online-Querying" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Similarity-Retrieval" class="common-anchor-header">استرجاع التشابه<button data-href="#Similarity-Retrieval" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>نقوم باسترجاع أعلى K كيانات وعلاقات متشابهة بناءً على استعلام الإدخال من Milvus.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Expand-Subgraph" class="common-anchor-header">توسيع الرسم البياني الفرعي<button data-href="#Expand-Subgraph" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>نحن نستخدم الكيانات والعلاقات المسترجعة لتوسيع المخطط الفرعي والحصول على العلاقات المرشحة، ثم دمجها من الطريقتين. فيما يلي مخطط انسيابي لعملية توسيع المخطط الفرعي:  <span class="img-wrapper">
...
<h3 id="LLM-reranking" class="common-anchor-header">إعادة ترتيب LLM<button data-href="#LLM-reranking" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Get-Final-Results" class="common-anchor-header">الحصول على النتائج النهائية<button data-href="#Get-Final-Results" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>يمكننا الحصول على المقاطع النهائية المسترجعة من العلاقات المعاد ترتيبها.</p>
