...
<button class="copy-code-btn"></button></code></pre>
<p>تحديد دالة لإنشاء تضمينات نصية باستخدام عميل OpenAI. نستخدم نموذج التضمين <a href="https://platform.openai.com/docs/guides/embeddings">النصي 3-نموذج التضمين الصغير</a> كمثال.</p>
