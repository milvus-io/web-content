...
<p><strong>ما الجديد في الإصدار v3.0.2:</strong></p>
<ul>
<li><strong>عقدة البث</strong>: قدرات معالجة بيانات محسّنة</li>
<li><strong>Woodpecker MQ (الافتراضي)</strong>: يعمل هذا النشر في Docker على تشغيل Woodpecker كقائمة انتظار الرسائل مع استخدام <strong>نظام الملفات المحلي</strong> كخلفية WAL، وبالتالي لا توجد حاجة لخدمة خارجية لقائمة انتظار الرسائل. انظر <a href="/docs/ar/woodpecker.md">Woodpecker</a>.</li>
...
<button class="copy-code-btn"></button></code></pre>
<p>للاطلاع على عناصر التكوين ذات الصلة، راجع <a href="/docs/ar/system_configuration.md">تكوين النظام</a>.</p>
...
<h2 id="Optional-dependencies" class="common-anchor-header">التبعيات الاختيارية<button data-href="#Optional-dependencies" class="anchor-icon" translate="no">
    ...
    </button></h2><p>بشكل افتراضي، يعمل هذا النشر على <strong>Woodpecker</strong> (WAL لنظام الملفات المحلي) كقائمة انتظار الرسائل و <strong>etcd مدمج</strong> للبيانات الوصفية — ولا يوجد شيء آخر لتثبيته. لاستخدام قائمة انتظار رسائل مختلفة أو توصيل تخزين كائنات خارجي / بيانات وصفية، انظر:</p>
<ul>
