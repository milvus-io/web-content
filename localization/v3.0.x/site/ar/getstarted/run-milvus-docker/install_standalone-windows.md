...
summary: >-
  ...
  Windows.
title: تشغيل Milvus في Docker (Windows)
---
...
<h2 id="Run-Milvus-with-Docker-Compose​" class="common-anchor-header">تشغيل Milvus باستخدام Docker Compose​<button data-href="#Run-Milvus-with-Docker-Compose​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>بمجرد تثبيت Docker Desktop على نظام Microsoft Windows، يمكنك الوصول إلى واجهة سطر الأوامر لـ Docker (Docker CLI) من PowerShell أو موجه أوامر Windows في وضع <strong>المسؤول</strong>. يمكنك تشغيل Docker Compose إما في PowerShell أو موجه أوامر Windows أو WSL 2 لبدء تشغيل Milvus​</p>
<h3 id="From-PowerShell-or-Windows-Command-Prompt​" class="common-anchor-header">من PowerShell أو موجه أوامر Windows<button data-href="#From-PowerShell-or-Windows-Command-Prompt​" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
...
<p>يمكنك التحقق مما إذا كانت المحاكاة الافتراضية ممكّنة من خلال الاطلاع على علامة التبويب <strong>"الأداء" (Performance</strong> ) في " <strong>مدير المهام</strong>" ( <strong>Task Manager</strong>).​</p>
...
<h3 id="How-can-I-deal-with-the-volume-related-errors-prompted-during-Milvus-startup-that-reads-Read-config-failed​" class="common-anchor-header">كيف يمكنني التعامل مع الأخطاء المتعلقة بحجم التخزين التي تظهر عند بدء تشغيل Milvus والتي تنص على « <code translate="no">Read config failed</code> »؟​<button data-href="#How-can-I-deal-with-the-volume-related-errors-prompted-during-Milvus-startup-that-reads-Read-config-failed​" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
