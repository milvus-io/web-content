...
title: تثبيت حزمة أدوات تطوير برمجيات (SDK) Milvus لـ Python
---
<h1 id="Install-Milvus-Python-SDK" class="common-anchor-header">تثبيت حزمة أدوات تطوير برمجيات (SDK) Milvus لـ Python<button data-href="#Install-Milvus-Python-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>يصف هذا الموضوع كيفية تثبيت حزمة تطوير البرامج (SDK) لـ Milvus بلغة Python، pymilvus، من أجل Milvus.</p>
...
<h2 id="Install-PyMilvus-via-pip" class="common-anchor-header">تثبيت PyMilvus عبر pip<button data-href="#Install-PyMilvus-via-pip" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يتوفر PyMilvus في <a href="https://pypi.org/project/pymilvus/">فهرس حزم Python</a>.</p>
<div class="alert note">
يُنصح بتثبيت إصدار PyMilvus الذي يتوافق مع إصدار خادم Milvus الذي قمت بتثبيته. لمزيد من المعلومات، راجع <a href="/docs/ar/release_notes.md">ملاحظات الإصدار</a>.
</div>
...
<li><p>استكشاف <a href="/api-reference/pymilvus/v3.0.x/About.md">مرجع واجهة برمجة تطبيقات PyMilvus</a></p></li>
</ul>
