...
<h3 id="Search-Features" class="common-anchor-header">ميزات البحث<button data-href="#Search-Features" class="anchor-icon" translate="no">
    ...
    </button></h3><p>يدعم Milvus Lite البحث الهجين في المتجهات المتفرقة والمتجهات المتعددة.</p>
...
<h2 id="Whats-next" class="common-anchor-header">الخطوة التالية<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>بعد اتصالك بـ Milvus Lite، يمكنك</p>
<ul>
