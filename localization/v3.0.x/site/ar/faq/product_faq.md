...
<h4 id="Does-Milvus-support-non-x86-architectures" class="common-anchor-header">هل يدعم ميلفوس البنى غير x86؟</h4><p>نعم، يدعم Milvus كلاً من بنيتي x86 و ARM. يتوفر دعم ARM64 من خلال خيارات نشر متعددة بما في ذلك صور Docker، وحزم RPM/DEB، و Milvus Lite.</p>
<p>بالنسبة للأنظمة الأساسية x86، يجب أن تدعم وحدة المعالجة المركزية الخاصة بك إحدى مجموعات التعليمات التالية للحصول على الأداء الأمثل: sse4.2، avx، avx2، avx512. بالنسبة للأنظمة الأساسية ARM، يمكن تشغيل Milvus على المعالجات القائمة على ARM64 بما في ذلك شرائح Apple M1/M2 وأنظمة ARM64 الأخرى.</p>
<h4 id="Where-does-Milvus-store-data" class="common-anchor-header">أين يخزن Milvus البيانات؟</h4><p>يتعامل Milvus مع نوعين من البيانات، البيانات المدرجة والبيانات الوصفية.</p>
...
<h4 id="What-is-the-maximum-vector-dimension-supported-in-Milvus" class="common-anchor-header">ما هو أقصى بُعد متجه مدعوم في ملفوس؟</h4><p>يمكن لـ Milvus إدارة متجهات ذات أبعاد تصل إلى 32,768 بُعداً افتراضياً. يمكنك زيادة قيمة <code translate="no">Proxy.maxDimension</code> للسماح بمتجهات ذات أبعاد أكبر.</p>
<h4 id="Does-Milvus-support-Apple-M1-CPU" class="common-anchor-header">هل يدعم Milvus وحدة المعالجة المركزية Apple M1؟</h4><p>نعم، يدعم Milvus وحدات المعالجة المركزية Apple M1/M2 وغيرها من معالجات Apple Silicon. يتوفر دعم ARM64 من خلال صور Docker، وحزم RPM/DEB، و Milvus Lite، مما يجعله متوافقًا مع شرائح Apple Silicon بما في ذلك معالجات M1 و M2 والمعالجات الأحدث.</p>
...
<h4 id="Why-does-the-data-in-MinIO-remain-after-the-corresponding-collection-is-dropped" class="common-anchor-header">لماذا تبقى البيانات في MinIO بعد إسقاط المجموعة المقابلة؟</h4><p>صُممت البيانات في MinIO لتبقى لفترة زمنية معينة من أجل راحة استرجاع البيانات.</p>
...
<li><strong>تجميع القمامة</strong>: تقوم عملية منفصلة تسمى تجميع القمامة (GC) بشكل دوري بإزالة هذه المقاطع "المسقطة"، مما يؤدي إلى تحرير مساحة التخزين التي كانت تشغلها. وهذا يضمن الاستخدام الفعال للتخزين ولكن يمكن أن يؤدي إلى تأخير بسيط بين الحذف واستصلاح المساحة.</li>
</ul>
...
<p>عند اختيار مستوى الاتساق، ضع في اعتبارك المفاضلة بين الاتساق والأداء. بالنسبة للعمليات التي تتطلب رؤية فورية، استخدم مستوى اتساق "قوي". لعمليات الكتابة الأسرع، قم بإعطاء الأولوية للاتساق الأضعف (قد لا تكون البيانات مرئية على الفور). لمزيد من المعلومات، راجع <a href="/docs/ar/tune_consistency.md">الاتساق</a>.</p>
