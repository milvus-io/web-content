...
<p>
   ...
   </span> <span class="img-wrapper"> <span>اختبار الدقة</span> </span> <span class="img-wrapper"> <img translate="no" src="https://milvus-docs.s3.us-west-2.amazonaws.com/assets/performance_nlist_nprobe.png" alt="Performance test" class="doc-image" id="performance-test" /><span>اختبار الأداء</span> <span>اختبار الأداء</span> </span></p>
