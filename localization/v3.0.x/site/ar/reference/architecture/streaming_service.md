...
<li><p><strong>مجموعة عقدة التدفق</strong>: مجموعة من عقد عامل التدفق المسؤولة عن جميع مهام معالجة البث، مثل إلحاق المحفظة واستعادة الحالة والاستعلام عن البيانات المتزايدة.</p></li>
...
<h2 id="Message" class="common-anchor-header">الرسائل<button data-href="#Message" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>خدمة التدفق هي نظام تدفق يعتمد على السجلات، لذلك يتم تجريد جميع عمليات الكتابة في ميلفوس (مثل DML وDDL) <strong>كرسائل</strong>.</p>
<ul>
...
<li><p><strong>دعم المعاملات الأساسية</strong>: نظرًا لأن كل رسالة لها حد للحجم، فإن مكون WAL يدعم مستوى المعاملات البسيطة للوعود بالكتابة الذرية على مستوى قناة VChannel.</p></li>
