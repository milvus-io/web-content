...
<h2 id="queryCoordautoHandoff" class="common-anchor-header"><code translate="no">queryCoord.autoHandoff</code><button data-href="#queryCoordautoHandoff" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>تبديل القيمة للتحكم في ما إذا كان سيتم استبدال المقطع المتنامي تلقائياً بالمقطع المختوم المفهرس المقابل عندما يصل المقطع المتنامي إلى حد الختم.</li>      
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>        تقلل القيمة الأعلى من احتمال تعيين قنوات من نفس المجموعة إلى نفس عقدة الاستعلام. اضبط على 1 لتعطيل هذه الميزة.</li>      </td>
      <td>10</td>
    </tr>
  </tbody>
</table>
