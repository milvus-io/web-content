...
summary: تعرف على كيفية تهيئة rocksmq لـ Milvus.
---
<h1 id="rocksmq-related-Configurations" class="common-anchor-header">التكوينات المتعلقة بـ روكسمك<button data-href="#rocksmq-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="rocksmqpath" class="common-anchor-header"><code translate="no">rocksmq.path</code><button data-href="#rocksmqpath" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>بادئة المفتاح إلى حيث يخزن ميلفوس البيانات في RocksMQ.</li>      
        <li>تحذير: تغيير هذه المعلمة بعد استخدام ملفوس لفترة من الزمن سيؤثر على وصولك إلى البيانات القديمة.</li>      
        <li>يوصى بتغيير هذه المعلمة قبل بدء تشغيل Milvus للمرة الأولى.</li>      
        <li>قم بتعيين بادئة مفتاح جذر يسهل تحديدها لـ Milvus إذا كانت خدمة إلخd موجودة بالفعل.</li>      </td>
...
<h2 id="rocksmqlrucacheratio" class="common-anchor-header"><code translate="no">rocksmq.lrucacheratio</code><button data-href="#rocksmqlrucacheratio" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        نسبة ذاكرة التخزين المؤقت للصخور      </td>
      <td>0.06</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqrocksmqPageSize" class="common-anchor-header"><code translate="no">rocksmq.rocksmqPageSize</code><button data-href="#rocksmqrocksmqPageSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        الحد الأقصى لحجم الرسائل في كل صفحة في RocksMQ. يتم فحص الرسائل في RocksMQ ومسحها (عند انتهاء صلاحيتها) دفعة واحدة بناءً على هذه المعلمة. الوحدة: بايت.      </td>
      <td>67108864</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqretentionTimeInMinutes" class="common-anchor-header"><code translate="no">rocksmq.retentionTimeInMinutes</code><button data-href="#rocksmqretentionTimeInMinutes" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        الحد الأقصى لوقت الاحتفاظ بالرسائل التي تم التحقق منها في RocksMQ. يتم الاحتفاظ بالرسائل التي تم التحقق منها في RocksMQ للفترة الزمنية المحددة ثم يتم مسحها. الوحدة: دقيقة.      </td>
      <td>4320</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqretentionSizeInMB" class="common-anchor-header"><code translate="no">rocksmq.retentionSizeInMB</code><button data-href="#rocksmqretentionSizeInMB" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        الحد الأقصى لحجم الاحتفاظ بالرسائل التي تم التحقق منها لكل موضوع في RocksMQ. يتم مسح الرسائل التي تم التحقق منها في كل موضوع إذا تجاوز حجمها هذه المعلمة. الوحدة: ميغابايت.      </td>
      <td>8192</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqcompactionInterval" class="common-anchor-header"><code translate="no">rocksmq.compactionInterval</code><button data-href="#rocksmqcompactionInterval" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        الفاصل الزمني لتشغيل ضغط rocksdb لإزالة البيانات المحذوفة. الوحدة: الثانية      </td>
      <td>86400</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqcompressionTypes" class="common-anchor-header"><code translate="no">rocksmq.compressionTypes</code><button data-href="#rocksmqcompressionTypes" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        نوع الضغط، تدعم فقط استخدام 0،7. 0 تعني عدم الضغط، 7 ستستخدم zstd. طول الأنواع يعني رقم مستوى الصخور.      </td>
      <td>0,0,7,7,7</td>
    </tr>
  </tbody>
</table>
