...
<h1 id="Nomic" class="common-anchor-header">Nomic<button data-href="#Nomic" class="anchor-icon" translate="no">
    ...
    </button></h1><p>نماذج<a href="https://atlas.nomic.ai/">Nomic</a> هي سلسلة من الحلول المتقدمة لتضمين النصوص والصور التي طورتها Nomic AI، وهي مصممة لتحويل أشكال مختلفة من البيانات إلى متجهات رقمية كثيفة تلتقط معانيها الدلالية.</p>
