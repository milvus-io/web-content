...
<li><a href="/docs/ar/single-vector-search.md#Filtered-search">بحث التصفية</a>: يقوم بإجراء بحث ANN تحت شروط تصفية محددة.</li>
...
<li><p>أداة Milvus لالتقاط تغيير البيانات (CDC) يمكن لـ Milvus CDC نسخ تغييرات البيانات من مجموعة Milvus إلى أخرى لاستعادة البيانات في حالة الكوارث الاحتياطية الأساسية. للحصول على التفاصيل، ارجع إلى <a href="/docs/ar/milvus_cdc_overview.md">Milvus CDC</a>.</p></li>
<li><p>موصلات ميلفوس خططت ميلفوس مجموعة من الموصلات لتتمكن من دمج ميلفوس بسلاسة مع أدوات الطرف الثالث، مثل Apache Spark. في الوقت الحالي، يمكنك استخدام موصل Spark Connector الخاص بنا لتغذية بيانات Milvus الخاصة بك إلى Apache Spark لمعالجة التعلم الآلي. للحصول على التفاصيل، راجع <a href="/docs/ar/integrate_with_spark.md">Spark-Milvus Connector</a>.</p></li>
