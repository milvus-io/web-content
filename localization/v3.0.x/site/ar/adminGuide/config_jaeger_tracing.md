...
<h3 id="1-Installing-the-Jaeger-Operator-on-Kubernetes" class="common-anchor-header">1. تثبيت مشغل Jaeger على Kubernetes<button data-href="#1-Installing-the-Jaeger-Operator-on-Kubernetes" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>لتثبيت المشغل، قم بتشغيل:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Deploy-Jaeger" class="common-anchor-header">2. نشر جايجر<button data-href="#2-Deploy-Jaeger" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>أبسط طريقة ممكنة لإنشاء مثيل Jaeger هي إنشاء ملف YAML مثل المثال التالي. سيؤدي ذلك إلى تثبيت إستراتيجية AllInOne الافتراضية التي تنشر صورة <strong>الكل في واحد</strong> (تجمع بين <strong>Jaeger-Aagent</strong> <strong>وJaeger- Collector</strong> <strong>وJaeger-</strong> <strong>Collector</strong> <strong>وJaeger-query</strong> وJaeger UI) في جراب واحد، باستخدام <strong>التخزين في الذاكرة</strong> افتراضيًا.</p>
