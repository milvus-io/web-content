...
<h2 id="Configure-S3-with-Docker-Compose" class="common-anchor-header">تكوين S3 باستخدام Docker Compose<button data-href="#Configure-S3-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Configure-S3" class="common-anchor-header">1. تكوين S3<button data-href="#1-Configure-S3" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><a href="https://min.io/product/overview">MinIO</a> متوافق مع S3. لتهيئة S3 مع Docker Compose، قم بتوفير القيم الخاصة بك للقسم <code translate="no">minio</code> في الملف <code translate="no">milvus.yaml</code> على مسار ميلفوس/كونفيغس.</p>
...
<h3 id="2-Refine-docker-composeyaml" class="common-anchor-header">2. صقل docker-compose.yaml<button data-href="#2-Refine-docker-composeyaml" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>يمكنك أيضًا إزالة متغير البيئة <code translate="no">MINIO_ADDRESS</code> لخدمة milvus في <code translate="no">docker-compose.yaml</code>. بشكل افتراضي سيستخدم ميلفوس المينيو المحلي بدلاً من S3 الخارجي.</p>
<h3 id="3-Run-Milvus" class="common-anchor-header">3. قم بتشغيل ميلفوس<button data-href="#3-Run-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>قم بتشغيل الأمر التالي لبدء تشغيل Milvus الذي يستخدم تكوينات S3.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Using-a-command" class="common-anchor-header">استخدام الأمر<button data-href="#Using-a-command" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>لتثبيت ملف Milvus وتكوين S3، قم بتشغيل الأمر التالي باستخدام قيمك.</p>
