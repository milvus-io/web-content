...
<h1 id="Upgrade-Milvus-Standalone-with-Helm-Chart" class="common-anchor-header">ترقية Milvus Standalone باستخدام Helm Chart<button data-href="#Upgrade-Milvus-Standalone-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>يصف هذا الدليل كيفية ترقية النشر المستقل لـ Milvus 2.6.x إلى الإصدار v3.0.0 باستخدام Helm.</p>
...
<h2 id="Upgrade-process" class="common-anchor-header">عملية الترقية<button data-href="#Upgrade-process" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Update-the-Helm-repository" class="common-anchor-header">الخطوة 1: تحديث مستودع Helm<button data-href="#Step-1-Update-the-Helm-repository" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>أضف مستودع Helm الخاص بـ Milvus أو قم بتحديثه:</p>
...
<h3 id="Step-2-Upgrade-Milvus" class="common-anchor-header">الخطوة 2: ترقية Milvus<button data-href="#Step-2-Upgrade-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<p>يحتفظ خيار <code translate="no">--reset-then-reuse-values</code> بالقيم من الإصدار السابق مع تطبيق تجاوز الصورة الصريح على الإعدادات الافتراضية المحددة لـ Chart.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>تأكد من أن جميع أحمال العمل المطلوبة جاهزة، وأن Milvus يستخدم <code translate="no">v3.0.0</code> ، وأن مجموعاتك الحالية لا تزال قابلة للاستعلام والبحث. أكمل هذه الفحوصات قبل تمكين أي ميزة خاصة بالإصدار v3.0.0.</p>
<div class="alert note">
