...
<ul>
<li>يتحكم في سلوك إضافة/تدوير/تدقيق المقاطع على جانب العميل لتحقيق التوازن بين معدل النقل وزمن الوصول من طرف إلى طرف.</li>
</ul></li>
...
<p>لاحظ أن الإدراج المجمّع لا يتم تشغيله بالفترات الزمنية فحسب، بل بحجم الدفعة أيضًا، والذي يبلغ 2 ميغابايت بشكل افتراضي.</p>
<h3 id="Service-mode-Milvus-30+" class="common-anchor-header">وضع الخدمة (Milvus 3.0+)<button data-href="#Service-mode-Milvus-30+" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
