...
<p>بالنسبة لـ etcd الخارجي، أو للحصول على تفاصيل حول تكوين Docker Compose / Helm / Milvus Operator، راجع <a href="/docs/ar/deploy_etcd.md">«تكوين التخزين التلوي باستخدام Docker Compose أو Helm</a> » <a href="/docs/ar/meta_storage_operator.md">و«تكوين التخزين التلوي باستخدام Milvus Operator</a>».</p>
