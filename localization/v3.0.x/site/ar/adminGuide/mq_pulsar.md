...
title: بولسار
---
<h1 id="Use-Pulsar-as-the-Milvus-Message-Queue" class="common-anchor-header">استخدام Pulsar كخلفية لطابور رسائل Milvus<button data-href="#Use-Pulsar-as-the-Milvus-Message-Queue" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>في Kubernetes الإصدار 1.25 والإصدارات الأحدث، إذا واجهت مشكلات في واجهة برمجة تطبيقات PodDisruptionBudget (PDB) من المخطط الفرعي المدمج لـ Pulsar، فقم بتعطيل سياسات PDB الخاصة بـ Pulsar:</p>
<pre><code translate="no" class="language-bash">helm install my-release zilliztech/milvus \
