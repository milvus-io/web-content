...
<h2 id="Download-a-configuration-file" class="common-anchor-header">تنزيل ملف التهيئة<button data-href="#Download-a-configuration-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://raw.githubusercontent.com/milvus-io/milvus/v3.0-beta/configs/milvus.yaml">قم بتنزيل</a> ملف « <code translate="no">milvus.yaml</code> » مباشرةً أو باستخدام الأمر التالي.</p>
...
<tbody>
  <tr>
    <td>
        <ul>
            <li><a href="/docs/ar/configure_etcd.md">etcd</a></li>
            <li><a href="/docs/ar/configure_minio.md">MinIO أو S3</a></li>
            <li><a href="/docs/ar/configure_pulsar.md">Pulsar</a></li>
            <li><a href="/docs/ar/configure_rocksmq.md">RocksMQ</a></li>
        </ul>
    </td>
    <td>
        <ul>
            <li><a href="/docs/ar/configure_rootcoord.md">Root coord</a></li>
            ...
            <li><a href="/docs/ar/configure_datacoord.md">إحداثيات البيانات</a></li>
            ...
            <li><a href="/docs/ar/configure_common.md">عام</a></li>
            <li><a href="/docs/ar/configure_gpu.md">وحدة معالجة الرسومات (GPU)</a></li>
            <li><a href="/docs/ar/configure_grpc.md">GRPC</a></li>
            <li><a href="/docs/ar/configure_indexcoord.md">إحداثيات الفهرس</a></li>
            <li><a href="/docs/ar/configure_metastore.md">المخزن الفرعي</a></li>
            <li><a href="/docs/ar/configure_mq.md">قائمة انتظار الرسائل</a></li>
            <li><a href="/docs/ar/configure_tikv.md">Tikv</a></li>
            <li><a href="/docs/ar/configure_trace.md">التتبع</a></li>
            <li><a href="/docs/ar/configure_quotaandlimits.md">الحصص والحدود</a></li>
        </ul>
    </td>
  </tr>
</tbody>
...
<h2 id="Download-an-installation-file" class="common-anchor-header">تنزيل ملف التثبيت<button data-href="#Download-an-installation-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p>قم بتنزيل ملف التثبيت الخاص بـ Milvus <a href="https://github.com/milvus-io/milvus/releases/download/v3.0-beta/milvus-standalone-docker-compose.yml">المستقل،</a> واحفظه باسم <code translate="no">docker-compose.yml</code>.</p>
...
<h2 id="Start-Milvus" class="common-anchor-header">تشغيل Milvus<button data-href="#Start-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>بعد الانتهاء من تعديل ملف التكوين وملف التثبيت، يمكنك عندئذٍ بدء تشغيل Milvus.</p>
...
<li><a href="/docs/ar/deploy_etcd.md">تكوين التخزين الوصفي باستخدام Docker Compose أو Helm</a></li>
