...
<h2 id="Create-your-own-certificate" class="common-anchor-header">إنشاء الشهادة الخاصة بك<button data-href="#Create-your-own-certificate" class="anchor-icon" translate="no">
    ...
    </button></h3><p>تأكد من تثبيت OpenSSL. إذا لم تكن قد قمت بتثبيته، قم <a href="https://github.com/openssl/openssl/blob/master/INSTALL.md">بإنشاء</a> OpenSSL <a href="https://github.com/openssl/openssl/blob/master/INSTALL.md">وتثبيته</a> أولاً.</p>
