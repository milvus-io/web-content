...
<ul>
<li><p>إذا قمت بتشغيل Milvus باستخدام RocksMQ وأردت تغيير إعداداته، فيمكنك تشغيل « <code translate="no">helm upgrade -f</code> » مع الإعدادات المعدلة في ملف YAML التالي.</p></li>
