...
<h1 id="Use-RocksMQ-as-the-Milvus-Message-Queue" class="common-anchor-header">استخدام RocksMQ كقائمة انتظار الرسائل في Milvus<button data-href="#Use-RocksMQ-as-the-Milvus-Message-Queue" class="anchor-icon" translate="no">
    ...
    </button></h1><p>RocksMQ هو قائمة انتظار رسائل مدمجة (WAL) مرفقة مع Milvus، وهي متاحة لإصدار <strong>Milvus Standalone فقط</strong>. كانت هذه هي قائمة انتظار الرسائل الافتراضية في الإصدارات السابقة من Milvus؛ أما في Milvus 3.x، فيستخدم Milvus Standalone <a href="/docs/ar/woodpecker.md">Woodpecker</a> المدمج بشكل افتراضي.</p>
