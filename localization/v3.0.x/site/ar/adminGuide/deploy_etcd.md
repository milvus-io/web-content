...
<h2 id="Configure-etcd-with-Docker-Compose" class="common-anchor-header">تكوين إلخ د مع Docker Compose<button data-href="#Configure-etcd-with-Docker-Compose" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Configure-etcd" class="common-anchor-header">1. تكوين إلخd<button data-href="#1-Configure-etcd" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>لتكوين etcd مع Docker Compose، قم بتوفير القيم الخاصة بك لقسم <code translate="no">etcd</code> في ملف <code translate="no">milvus.yaml</code> في مسار milvus/configs.</p>
...
<h3 id="2-Run-Milvus" class="common-anchor-header">2. تشغيل ميلفوس<button data-href="#2-Run-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h3><p>قم بتشغيل الأمر التالي لبدء تشغيل Milvus الذي يستخدم تكوينات إلخd.</p>
...
<h3 id="Using-a-command" class="common-anchor-header">استخدام الأمر<button data-href="#Using-a-command" class="anchor-icon" translate="no">
    ...
    </button></h3><p>لتثبيت ملف Milvus وتكوين etcd، قم بتشغيل الأمر التالي باستخدام قيمك.</p>
