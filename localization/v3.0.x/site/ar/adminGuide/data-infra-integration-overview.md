...
<h1 id="Data-Infrastructure" class="common-anchor-header">البنية التحتية للبيانات<button data-href="#Data-Infrastructure" class="anchor-icon" translate="no">
    ...
    </button></h1><p>يعتمد Milvus على تخزين البيانات الوصفية، وتخزين الكائنات، وقائمة انتظار الرسائل في البنية التحتية الأساسية للبيانات. يتناول هذا الفصل المكونات التي يمكنك تكوينها:</p>
<ul>
