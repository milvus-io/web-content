...
<h1 id="Switch-between-Pulsar-and-Woodpecker" class="common-anchor-header">التبديل بين Pulsar و Woodpecker<button data-href="#Switch-between-Pulsar-and-Woodpecker" class="anchor-icon" translate="no">
    ...
    </button></h1><p>توضح هذه الصفحة كيفية التبديل بين <strong>Pulsar</strong> (مدمج أو خارجي) و <strong>Woodpecker</strong> (خلفية MinIO) في قائمة انتظار الرسائل (MQ) <strong>لمجموعة Milvus،</strong> في كلا الاتجاهين. للاطلاع على سير العمل العام والمتطلبات الأساسية، راجع <a href="/docs/ar/switch-mq-type.md">"التبديل بين أنواع MQ</a>".</p>
...
<tr><td>Pulsar خارجي</td><td>Woodpecker (MinIO)</td><td><strong>مدعوم</strong></td><td><strong>مدعوم</strong></td></tr>
