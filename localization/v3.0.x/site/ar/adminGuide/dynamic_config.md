...
<li>تعرف على كيفية تهيئة Milvus المثبتة باستخدام <a href="/docs/ar/configure_operator.md">مشغل Milvus</a> <a href="/docs/ar/configure-helm.md">ومخططات Helm</a> <a href="/docs/ar/configure-docker.md">وDocker</a>.</li>
</ul>
