...
<h2 id="Visualize-metrics-using-Grafana" class="common-anchor-header">تصور المقاييس باستخدام Grafana<button data-href="#Visualize-metrics-using-Grafana" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Download-and-import-dashboard" class="common-anchor-header">1. تنزيل لوحة المعلومات واستيرادها<button data-href="#1-Download-and-import-dashboard" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>قم بتنزيل واستيراد لوحة معلومات Milvus من ملف JSON.</p>
...
<h3 id="2-View-metrics" class="common-anchor-header">2. عرض المقاييس<button data-href="#2-View-metrics" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>حدد مثيل Milvus الذي تريد مراقبته. ثم يمكنك رؤية لوحة مكونات Milvus.</p>
<p>
