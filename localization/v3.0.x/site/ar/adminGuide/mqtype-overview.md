...
<tbody>
<tr><td><a href="/docs/ar/woodpecker.md">Woodpecker</a></td><td style="text-align:center">✔️ (مدمج)</td><td style="text-align:center">✔️ (مُدمج أو خدمة)</td><td><strong>Milvus 3.x</strong> (كلا الوضعين)</td><td>الافتراضي والموصى به. WAL السحابي الأصلي على تخزين الكائنات؛ لا يلزم وجود خدمة خارجية.</td></tr>
...
<li><p>لتغيير قائمة انتظار الرسائل لمثيل قيد التشغيل، راجع "تبديل نوع قائمة انتظار الرسائل" (مدعوم بدءًا من الإصدار v2.6.14).</p></li>
</ul>
</div>
