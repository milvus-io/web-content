...
<h2 id="Prerequisites" class="common-anchor-header">المتطلبات الأساسية<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Clone-the-Repository" class="common-anchor-header">استنساخ المستودع<button data-href="#Clone-the-Repository" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>استنسخ الشيفرة المصدرية ل Dify إلى جهازك المحلي:</p>
<pre><code translate="no" class="language-shell">git clone https://github.com/langgenius/dify.git
<button class="copy-code-btn"></button></code></pre>
<h3 id="Prepare-Environment-Configuration" class="common-anchor-header">إعداد تهيئة البيئة<button data-href="#Prepare-Environment-Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>انتقل إلى دليل Docker في شيفرة Dify المصدرية</p>
...
<h3 id="Configure-Environment-Variables" class="common-anchor-header">تكوين متغيرات البيئة<button data-href="#Configure-Environment-Variables" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>قم بتحرير الملف <code translate="no">.env</code> باستخدام تكوين ميلفوس التالي:</p>
...
<h3 id="Start-the-Docker-Containers" class="common-anchor-header">بدء تشغيل حاويات Docker<button data-href="#Start-the-Docker-Containers" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>ابدأ تشغيل الحاويات باستخدام ملف التعريف <code translate="no">milvus</code> لتضمين خدمات Milvus:</p>
...
<h3 id="Configure-Environment-Variables" class="common-anchor-header">تكوين متغيرات البيئة<button data-href="#Configure-Environment-Variables" class="anchor-icon" translate="no">
    ...
    </button></h3><p>قم بتحرير الملف <code translate="no">.env</code> بتفاصيل اتصال Zilliz Cloud الخاص بك:</p>
...
<h3 id="Start-the-Docker-Containers" class="common-anchor-header">ابدأ تشغيل حاويات Docker<button data-href="#Start-the-Docker-Containers" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>ابدأ تشغيل حاويات Dify فقط بدون ملف تعريف Milvus:</p>
...
<h2 id="Accessing-Dify" class="common-anchor-header">الوصول إلى Dify<button data-href="#Accessing-Dify" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Log-in-to-Dify" class="common-anchor-header">سجّل الدخول إلى Dify<button data-href="#Log-in-to-Dify" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>افتح متصفحك وانتقل إلى صفحة تثبيت Dify، ويمكنك تعيين حساب المسؤول الخاص بك هنا:<code translate="no">http://localhost/install</code> ، ثم قم بتسجيل الدخول إلى صفحة Dify الرئيسية لمزيد من الاستخدام.</p>
