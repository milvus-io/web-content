...
<h3 id="Use-as-a-regular-node-to-insert-and-retrieve-documents" class="common-anchor-header">استخدام كعقدة عادية لإدراج المستندات واسترجاعها<button data-href="#Use-as-a-regular-node-to-insert-and-retrieve-documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>يمكنك استخدام مخزن Milvus Vector Store كعقدة عادية لإدراج المستندات أو استرجاعها. يضع هذا النمط مخزن Milvus Vector Store في تدفق الاتصال العادي دون استخدام وكيل.</p>
...
<h3 id="Connect-directly-to-an-AI-agent-as-a-tool" class="common-anchor-header">الاتصال مباشرة بوكيل ذكاء اصطناعي كأداة<button data-href="#Connect-directly-to-an-AI-agent-as-a-tool" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>يمكنك توصيل عقدة مخزن المتجهات Milvus Vector Store مباشرةً بموصل أداة <a href="https://docs.n8n.io/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent/">وكيل الذكاء</a> الاصطناعي لاستخدام مخزن المتجهات كمورد عند الإجابة على الاستفسارات.</p>
...
<h3 id="Use-a-retriever-to-fetch-documents" class="common-anchor-header">استخدام مسترجع لجلب المستندات<button data-href="#Use-a-retriever-to-fetch-documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Use-the-Vector-Store-Question-Answer-Tool-to-answer-questions" class="common-anchor-header">استخدم أداة الإجابة عن الأسئلة في مخزن المتجهات للإجابة عن الأسئلة<button data-href="#Use-the-Vector-Store-Question-Answer-Tool-to-answer-questions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Node-Operation-Modes" class="common-anchor-header">أوضاع تشغيل العقدة<button data-href="#Node-Operation-Modes" class="anchor-icon" translate="no">
    ...
    </button></h2><p>تدعم عقدة مخزن النواقل Milvus Vector Store أوضاع تشغيل متعددة، كل منها مصمم خصيصًا لحالات استخدام سير العمل المختلفة. يساعد فهم هذه الأوضاع في تصميم سير عمل أكثر فعالية.</p>
...
<hr>
<h3 id="Operation-Modes-Overview" class="common-anchor-header">نظرة عامة على أوضاع التشغيل<button data-href="#Operation-Modes-Overview" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>تدعم عقدة مخزن متجه ميلفوس المتجه أربعة أوضاع متميزة:</p>
<ul>
...
<h3 id="Additional-Node-Options" class="common-anchor-header">خيارات العقدة الإضافية<button data-href="#Additional-Node-Options" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Related-Resources" class="common-anchor-header">الموارد ذات الصلة<button data-href="#Related-Resources" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
