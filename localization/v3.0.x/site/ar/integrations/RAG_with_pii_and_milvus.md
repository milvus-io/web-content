...
<h2 id="Preparation" class="common-anchor-header">الإعداد<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Get-started-with-PII-Masker" class="common-anchor-header">ابدأ باستخدام PII Masker<button data-href="#Get-started-with-PII-Masker" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>اتبع <a href="https://github.com/HydroXai/pii-masker-v1/tree/main?tab=readme-ov-file#-installation">دليل تثبيت</a> PII Masker لتثبيت التبعيات المطلوبة وتنزيل النموذج. إليك دليل بسيط:</p>
...
<h3 id="Prepare-the-data" class="common-anchor-header">إعداد البيانات<button data-href="#Prepare-the-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>لنقم بإنشاء بعض الأسطر المزيفة التي تحتوي على معلومات PII لأغراض الاختبار أو العرض التوضيحي.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Mask-the-data-with-PIIMasker" class="common-anchor-header">قم بإخفاء البيانات باستخدام PIIMasker<button data-href="#Mask-the-data-with-PIIMasker" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>لنقم بتهيئة كائن PIIMasker وتحميل النموذج.</p>
...
<h3 id="Prepare-the-Embedding-Model" class="common-anchor-header">إعداد نموذج التضمين<button data-href="#Prepare-the-Embedding-Model" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Insert-data" class="common-anchor-header">إدراج البيانات<button data-href="#Insert-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>قم بالتكرار من خلال الأسطر النصية المقنعة، وأنشئ التضمينات، ثم أدخل البيانات في ملفوس.</p>
...
<h2 id="Build-RAG" class="common-anchor-header">بناء RAG<button data-href="#Build-RAG" class="anchor-icon" translate="no">
    ...
    </button></h3><p>دعنا نحدد سؤالاً عن المستندات.</p>
...
<p>هنا يمكننا أن نرى، بما أننا استبدلنا معلومات تحديد الهوية الشخصية بأقنعة، لا يمكن لـ LLM الحصول على معلومات تحديد الهوية الشخصية في السياق. لذا فإنه يجيب "لا أعرف". من خلال هذه الطريقة، يمكننا حماية خصوصية المستخدمين بشكل فعال.</p>
