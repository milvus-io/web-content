...
<h3 id="Installation" class="common-anchor-header">التثبيت<button data-href="#Installation" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>استنساخ الريبو وإعداد بيئتك:</p>
...
<h3 id="Configuring-Milvus" class="common-anchor-header">تهيئة ميلفوس<button data-href="#Configuring-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>لاستخدام <strong>ميلفوس،</strong> قم بتحديث التكوين الخاص بك.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Loading-Data" class="common-anchor-header">تحميل البيانات<button data-href="#Loading-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>بمجرد التهيئة، قم بتحميل المحتوى الخاص بك باستخدام موجز RSS.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>سيؤدي ذلك إلى استيعاب المحتوى في مجموعة ميلفوس الخاصة بك، وتخزين كل من البيانات النصية والتضمينات المتجهة.</p>
<h3 id="Running-the-Server" class="common-anchor-header">تشغيل الخادم<button data-href="#Running-the-Server" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>لبدء تشغيل NLWeb، من الدليل <code translate="no">code</code> ، قم بالتشغيل:</p>
