...
<button class="copy-code-btn"></button></code></pre>
<p>نستخدم مسافة الضرب الداخلي كنوع القياس الافتراضي. للمزيد من المعلومات حول أنواع المسافات، يمكنك الرجوع إلى <a href="https://milvus.io/docs/metric.md?tab=floating">صفحة مقاييس التشابه</a></p>
