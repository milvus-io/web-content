...
<h2 id="Add-scalar-filters" class="common-anchor-header">إضافة عوامل تصفية قياسية<button data-href="#Add-scalar-filters" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يمكنك الجمع بين البحث المجمّع وتصفية StructArray القياسية. استخدم <code translate="no">element_filter</code> عندما يجب أن يقيد الشرط القياسي عناصر Struct التي تشارك في البحث المتجهي على مستوى العناصر.</p>
