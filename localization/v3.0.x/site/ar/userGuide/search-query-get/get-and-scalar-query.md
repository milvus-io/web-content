...
title: الاستعلام
summary: >-
  استخدم كل من «Query» و«Get» و«QueryIterator» لاسترداد الكيانات وتصفية البيانات
  الوصفية في Milvus.
---
<h1 id="Query" class="common-anchor-header">الاستعلام<button data-href="#Query" class="anchor-icon" translate="no">
    ...
    </button></h1><p>بالإضافة إلى عمليات البحث باستخدام الشبكات العصبية الاصطناعية (ANN)، يدعم Milvus أيضًا تصفية البيانات الوصفية من خلال الاستعلامات. تشرح هذه الصفحة كيفية استخدام "الاستعلام" (Query) و"الحصول" (Get) و"مكررات الاستعلام" (QueryIterators) لإجراء تصفية البيانات الوصفية.</p>
<div class="alert note">
<p>إذا أضفت حقولًا جديدة بعد إنشاء المجموعة، فإن الاستعلامات التي تتضمن هذه الحقول ستُرجع القيم الافتراضية المحددة أو « <code translate="no">NULL</code> » (قيمة غير محددة) للكيانات التي لم تُحدد قيمها صراحةً. لمزيد من التفاصيل، راجع <a href="/docs/ar/add-fields-to-an-existing-collection.md">«تعديل مخطط المجموعة</a>».</p>
</div>
<h2 id="Overview" class="common-anchor-header">نظرة عامة<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يمكن للمجموعة تخزين أنواع مختلفة من الحقول القياسية. يمكنك جعل Milvus يقوم بتصفية الكيانات بناءً على حقل قياسي واحد أو أكثر. يوفر Milvus ثلاثة أنواع من الاستعلامات: Query و Get و QueryIterator. يقارن الجدول أدناه بين أنواع الاستعلامات الثلاثة هذه.</p>
<table>
   <tr>
     <th></th>
     <th><p>Get</p></th>
   ...
   <tr>
     <td><p>السيناريوهات القابلة للتطبيق</p></td>
     <td><p>للعثور على الكيانات التي تحتوي على المفاتيح الأساسية المحددة.</p></td>
     <td><p>للعثور على جميع الكيانات أو عدد محدد منها التي تستوفي شروط التصفية المخصصة</p></td>
     <td><p>للعثور على جميع الكيانات التي تستوفي شروط التصفية المخصصة في الاستعلامات المقسمة إلى صفحات.</p></td>
   </tr>
   <tr>
     <td><p>طريقة التصفية</p></td>
     <td><p>حسب المفاتيح الأولية</p></td>
     <td><p>حسب تعبيرات التصفية.</p></td>
     <td><p>حسب تعبيرات التصفية.</p></td>
   </tr>
   <tr>
     <td><p>المعلمات الإلزامية</p></td>
     <td><ul><li><p>اسم المجموعة</p></li><li><p>المفاتيح الأساسية</p></li></ul></td>
     <td><ul><li><p>اسم المجموعة</p></li><li><p>تعبيرات التصفية</p></li></ul></td>
     <td><ul><li><p>اسم المجموعة</p></li><li><p>تعبيرات التصفية</p></li><li><p>عدد الكيانات المطلوب إرجاعها لكل استعلام</p></li></ul></td>
   </tr>
   <tr>
     ...
     <td><ul><li><p>اسم القسم</p></li><li><p>إجمالي عدد الكيانات المطلوب إرجاعها</p></li><li><p>حقول الإخراج</p></li></ul></td>
   </tr>
   <tr>
     <td><p>تُرجع</p></td>
     <td><p>يعرض الكيانات التي تحتوي على المفاتيح الأساسية المحددة في المجموعة أو القسم المحدد.</p></td>
     <td><p>يعرض جميع الكيانات أو عددًا محددًا منها التي تستوفي شروط التصفية المخصصة في المجموعة أو القسم المحدد.</p></td>
     <td><p>يعرض جميع الكيانات التي تستوفي شروط التصفية المخصصة في المجموعة أو القسم المحدد من خلال استعلامات مقسمة إلى صفحات.</p></td>
   </tr>
</table>
<p>لمزيد من المعلومات حول تصفية البيانات الوصفية، راجع .</p>
<h2 id="Use-Get" class="common-anchor-header">استخدام Get<button data-href="#Use-Get" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>عندما تحتاج إلى العثور على الكيانات باستخدام مفاتيحها الأساسية، يمكنك استخدام طريقة <strong>Get</strong>. تفترض أمثلة الكود التالية وجود ثلاثة حقول باسم <code translate="no">id</code> و <code translate="no">vector</code> و <code translate="no">color</code> في مجموعتك.</p>
...
<p>يمكنك الحصول على الكيانات باستخدام معرّفاتها (ID) على النحو التالي.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Use-Query" class="common-anchor-header">استخدام الاستعلام<button data-href="#Use-Query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><h3 id="Basic-Query" class="common-anchor-header">الاستعلام الأساسي<button data-href="#Basic-Query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>عندما تحتاج إلى البحث عن الكيانات باستخدام شروط تصفية مخصصة، استخدم طريقة <strong>الاستعلام (Query)</strong>. تفترض أمثلة الكود التالية وجود ثلاثة حقول باسم <code translate="no">id</code> و <code translate="no">vector</code> و <code translate="no">color</code> ، وتُرجع العدد المحدد من الكيانات التي تحتوي على قيمة <code translate="no">color</code> تبدأ بـ <code translate="no">red</code>.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
...
<h3 id="Sort-Query-Results--Milvus-30x" class="common-anchor-header">فرز نتائج الاستعلام<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 3.0.x</span><button data-href="#Sort-Query-Results--Milvus-30x" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>بشكل افتراضي، تعرض "Query" النتائج بترتيب غير محدد. استخدم المعلمة <code translate="no">order_by</code> لترتيب النتائج حسب حقل أو أكثر من الحقول القياسية. عند استخدام <code translate="no">order_by</code> ، لاحظ ما يلي:</p>
<ul>
<li><p><code translate="no">order_by</code> يجب استخدامها مع <code translate="no">limit</code>.</p></li>
<li><p>أنواع الحقول المدعومة: <code translate="no">INT8</code> و <code translate="no">INT16</code> و <code translate="no">INT32</code> و <code translate="no">INT64</code> و <code translate="no">FLOAT</code> و <code translate="no">DOUBLE</code> و <code translate="no">VARCHAR</code>. لا يُدعم الترتيب حسب الحقول المتجهة أو <code translate="no">JSON</code> أو <code translate="no">ARRAY</code>.</p></li>
<li><p>عند الفرز حسب حقل قابل للقيمة الفارغة، توضع القيم NULL في النهاية في حالة الترتيب التصاعدي (NULLS LAST) وفي البداية في حالة الترتيب التنازلي (NULLS FIRST).</p></li>
</ul>
<h4 id="Basic-Sort" class="common-anchor-header">الفرز الأساسي</h4><p>قم بتمرير قائمة من سلاسل <code translate="no">&quot;field_name:direction&quot;</code> إلى المعلمة <code translate="no">order_by</code> ، حيث يكون <code translate="no">direction</code> إما <code translate="no">asc</code> (تصاعدي) أو <code translate="no">desc</code> (تنازلي). لاحظ أن <code translate="no">asc</code> و <code translate="no">desc</code> حساسة لحالة الأحرف.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Multi-field-Sort" class="common-anchor-header">الفرز متعدد الحقول</h4><p>يمكنك الفرز حسب حقول متعددة في آن واحد. يتم ترتيب النتائج أولاً حسب الحقل الأول في القائمة. وعندما يكون لصفين نفس القيمة في ذلك الحقل، يحدد الحقل الثاني ترتيبهما، وهكذا دواليك.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Pagination-with-Sort" class="common-anchor-header">ترقيم الصفحات مع الفرز</h4><p>استخدم <code translate="no">order_by</code> مع <code translate="no">limit</code> و <code translate="no">offset</code> لتقسيم النتائج المرتبة إلى صفحات. على سبيل المثال، لعرض قائمة منتجات مرتبة حسب السعر على عدة صفحات، تعرض كل صفحة المجموعة التالية من العناصر بالترتيب الصحيح حسب السعر دون تكرار أو فجوات.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
...
<h2 id="Use-QueryIterator" class="common-anchor-header">استخدام QueryIterator<button data-href="#Use-QueryIterator" class="anchor-icon" translate="no">
    ...
    </button></h2><p>عندما تحتاج إلى العثور على الكيانات وفقًا لشروط تصفية مخصصة من خلال استعلامات مقسمة إلى صفحات، قم بإنشاء <strong>QueryIterator</strong> واستخدم طريقة <strong>next()</strong> الخاصة به للتكرار عبر جميع الكيانات للعثور على تلك التي تستوفي شروط التصفية. تفترض أمثلة الكود التالية وجود ثلاثة حقول باسم <code translate="no">id</code> و <code translate="no">vector</code> و <code translate="no">color</code> ، وتُرجع جميع الكيانات التي تحتوي على قيمة <code translate="no">color</code> تبدأ بـ <code translate="no">red</code>.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Queries-in-Partitions" class="common-anchor-header">الاستعلامات في الأقسام<button data-href="#Queries-in-Partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>يمكنك أيضًا تنفيذ استعلامات داخل قسم واحد أو عدة أقسام عن طريق تضمين أسماء الأقسام في طلب Get أو Query أو QueryIterator. تفترض أمثلة الكود التالية وجود قسم باسم <strong>PartitionA</strong> في المجموعة.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Random-Sampling-with-Query" class="common-anchor-header">الأخذ العشوائي للعينات باستخدام Query<button data-href="#Random-Sampling-with-Query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>لاستخراج مجموعة فرعية تمثيلية من البيانات من مجموعتك لاستكشاف البيانات أو اختبار التطوير، استخدم التعبير <code translate="no">RANDOM_SAMPLE(sampling_factor)</code> ، حيث يمثل <code translate="no">sampling_factor</code> عددًا عائمًا بين 0 و1 يمثل النسبة المئوية للبيانات المراد أخذ عينات منها.</p>
<div class="alert note">
<p>للاطلاع على تفاصيل الاستخدام والأمثلة المتقدمة وأفضل الممارسات، راجع <a href="/docs/ar/random-sampling.md">«العينة العشوائية</a>».</p>
</div>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Temporarily-Set-a-Timezone-for-a-Query" class="common-anchor-header">تعيين منطقة زمنية مؤقتًا لاستعلام<button data-href="#Temporarily-Set-a-Timezone-for-a-Query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
