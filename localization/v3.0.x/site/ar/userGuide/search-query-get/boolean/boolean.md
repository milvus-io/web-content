...
summary: >-
  ...
  تعبيرات التصفية استهداف حقول قياسية محددة وتحديد نتائج البحث باستخدام شروط
...
<li><p><strong>المُشغِّلات البتية</strong>: في Milvus 3.0.0 والإصدارات الأحدث، تُستخدم <code translate="no">&amp;</code> و <code translate="no">|</code> و <code translate="no">^</code> لتصفية الحقول الصحيحة التي تشفر علامات متعددة، مثل أذونات أو بتات الحالة. لمزيد من التفاصيل، راجع <a href="/docs/ar/basic-operators.md#Bitwise-operators">«المُشغِّلات الأساسية</a>».</p></li>
...
<h4 id="TEXTMATCH-operator" class="common-anchor-header"><code translate="no">TEXT_MATCH</code> المُشغِّل</h4><p>يتيح عامل التشغيل « <code translate="no">TEXT_MATCH</code> » استرجاع المستندات بدقة استنادًا إلى مصطلحات استعلام محددة. وهو مفيد بشكل خاص لعمليات البحث المُصفاة التي تجمع بين عوامل التصفية القياسية وعمليات البحث عن التشابه المتجهي. وعلى عكس عمليات البحث الدلالي، يركز «Text Match» على التكرارات الدقيقة للمصطلحات.</p>
