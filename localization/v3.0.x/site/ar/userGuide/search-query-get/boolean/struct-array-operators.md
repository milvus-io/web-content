...
<li><p><a href="/docs/ar/struct-array-operators.md#MATCHEXACT"><code translate="no">MATCH_EXACT(identifier, predicate, k)</code></a>:: إرجاع الكيانات التي تحتوي على <code translate="no">k</code> قطع تبدأ ب "أحمر" في الحقل الفرعي <code translate="no">text</code>.</p></li>
</ul>
...
<h3 id="MATCHALL" class="common-anchor-header">MATCH_ALL<button data-href="#MATCHALL" class="anchor-icon" translate="no">
    ...
    </button></h3><p>لا يتم تقييم هذا العامل على أنه صواب إلا إذا كان <strong>كل</strong> عنصر في المصفوفة يستوفي المسند.</p>
...
<p>هذا مفيد بشكل خاص لتصفية الكيانات التي تفرط في استهداف كلمة أساسية معينة (تقليل الضوضاء).</p>
<p><strong>مثال:</strong></p>
