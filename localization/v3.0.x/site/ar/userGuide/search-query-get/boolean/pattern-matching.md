...
<p>استخدم <code translate="no">LIKE</code> لمطابقة بسيطة باستخدام أحرف البدل. استخدم regex عندما يحتاج النمط إلى فئات الأحرف، أو التكرار، أو التناوب مثل <code translate="no">error|failed</code> ، أو نقاط الربط، أو المطابقة غير الحساسة لحالة الأحرف.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>لمطابقة قيمة الحقل بالكامل، استخدم نقاط الربط <code translate="no">^</code> و <code translate="no">$</code>:</p>
