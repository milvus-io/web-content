...
<h2 id="ARRAYREMOVE--Milvus-2617+" class="common-anchor-header">ARRAY_REMOVE<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.6.17+</span><button data-href="#ARRAYREMOVE--Milvus-2617+" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يقوم عامل التشغيل <code translate="no">ARRAY_REMOVE</code> بإزالة كل عنصر من حقل ARRAY موجود يطابق قيمة في حمولة الطلب أثناء طلب <code translate="no">upsert</code>. وهو ليس تعبير تصفية. استخدمه عندما تريد إزالة القيم المطابقة من مصفوفة دون الاستعلام أولاً عن قيمة المصفوفة الحالية.</p>
