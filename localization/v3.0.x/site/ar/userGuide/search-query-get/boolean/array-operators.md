...
<tbody>
<tr><td><a href="/docs/ar/array-operators.md#ARRAYCONTAINS">ARRAY_CONTAINS(المعرف، التعبير)</a></td><td>تعبير التصفية</td><td>يتحقق من وجود عنصر معين في حقل ARRAY.</td></tr>
<tr><td><a href="/docs/ar/array-operators.md#ARRAYCONTAINSALL">ARRAY_CONTAINS_ALL(المعرف، التعبير)</a></td><td>تعبير التصفية</td><td>يتحقق مما إذا كانت جميع العناصر الموجودة في قائمة محددة موجودة في حقل ARRAY.</td></tr>
<tr><td><a href="/docs/ar/array-operators.md#ARRAYCONTAINSANY">ARRAY_CONTAINS_ANY(المعرف، التعبير)</a></td><td>تعبير التصفية</td><td>يتحقق مما إذا كان أي عنصر في قائمة محددة موجودًا في حقل ARRAY.</td></tr>
<tr><td><a href="/docs/ar/array-operators.md#ARRAYLENGTH">ARRAY_LENGTH(المعرف)</a></td><td>تعبير التصفية</td><td>تُرجع عدد العناصر الموجودة في حقل ARRAY ويمكن دمجها مع عوامل المقارنة لأغراض التصفية.</td></tr>
<tr><td><a href="/docs/ar/array-operators.md#ARRAYAPPEND">ARRAY_APPEND</a></td><td><code translate="no">upsert</code> مع <code translate="no">field_ops</code></td><td>يُضيف عناصر الحمولة إلى حقل ARRAY موجود. متوفر في Milvus الإصدار 2.6.17 والإصدارات الأحدث.</td></tr>
<tr><td><a href="/docs/ar/array-operators.md#ARRAYREMOVE">ARRAY_REMOVE</a></td><td><code translate="no">upsert</code> مع <code translate="no">field_ops</code></td><td>يزيل كل عنصر من حقل ARRAY موجود يتطابق مع قيمة في حمولة الطلب. متوفر في Milvus الإصدار 2.6.17 والإصدارات الأحدث.</td></tr>
</tbody>
</table>
...
<button class="copy-code-btn"></button></code></pre>
<p>يتيح إرفاق <code translate="no">ARRAY_APPEND</code> بحقل عبر <code translate="no">field_ops</code> إمكانية التحديث الجزئي لهذا الحقل. للاطلاع على سير العمل الكامل وأنواع العناصر المدعومة والحدود، راجع <a href="/docs/ar/upsert-entities.md#Upsert-ARRAY-fields-in-merge-mode">حقول ARRAY</a> الخاصة <a href="/docs/ar/upsert-entities.md#Upsert-ARRAY-fields-in-merge-mode">بـ Upsert في وضع الدمج</a>.</p>
<h2 id="ARRAYREMOVE--Milvus-2617+" class="common-anchor-header">ARRAY_REMOVE<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.6.17+</span><button data-href="#ARRAYREMOVE--Milvus-2617+" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يقوم عامل التشغيل <code translate="no">ARRAY_REMOVE</code> بإزالة كل عنصر من حقل ARRAY موجود يطابق قيمة في حمولة الطلب أثناء طلب <code translate="no">upsert</code>. وهو ليس تعبير تصفية. استخدمه عندما تريد إزالة القيم المطابقة من المصفوفة دون الاستعلام أولاً عن قيمة المصفوفة الحالية.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>يؤدي ربط <code translate="no">ARRAY_REMOVE</code> بحقل عبر <code translate="no">field_ops</code> إلى تمكين دلالات التحديث الجزئي لهذا الحقل. للاطلاع على سير العمل الكامل وأنواع العناصر المدعومة والحدود، راجع <a href="/docs/ar/upsert-entities.md#Upsert-ARRAY-fields-in-merge-mode">حقول ARRAY</a> الخاصة <a href="/docs/ar/upsert-entities.md#Upsert-ARRAY-fields-in-merge-mode">بـ Upsert في وضع الدمج</a>.</p>
