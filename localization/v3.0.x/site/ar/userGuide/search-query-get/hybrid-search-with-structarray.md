...
<tr><td>حقل متجه على مستوى المجموعة + حقل فرعي على مستوى عنصر StructArray</td><td>مستوى الكيان</td><td>يتم طي النتائج على مستوى العنصر إلى المرشحين على مستوى الكيان قبل إعادة الترتيب المختلط.</td><td>تكوين طي اختياري على مستوى عنصر StructArray <code translate="no">AnnSearchRequest</code>.</td></tr>
...
<tr><td>أداة إعادة الترتيب</td><td>اختر أداة إعادة الترتيب الهجينة مثل <code translate="no">RRFRanker</code> أو أي أداة إعادة ترتيب أخرى يدعمها تطبيقك.</td></tr>
</tbody>
</table>
...
<tbody>
<tr><td>مستوى الكيان</td><td>المفتاح الأساسي.</td><td>لا يوجد إزاحة للعنصر في النتيجة النهائية.</td><td>يتضمن الطلب الهجين حقل متجه على مستوى المجموعة، أو طلب EmbeddingList، أو طلبات على مستوى العنصر ضمن حقول StructArray مختلفة.</td></tr>
...
<li><p>لاستخدام حدود الدرجة أو المسافة في البحث الهجين، اقرأ " <a href="/docs/ar/range-search-with-structarray.md">البحث في النطاق باستخدام StructArray</a>".</p></li>
