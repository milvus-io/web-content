...
<h2 id="How-hybrid-search-applies-to-StructArray" class="common-anchor-header">كيف ينطبق البحث المختلط على StructArray<button data-href="#How-hybrid-search-applies-to-StructArray" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><p>استخدم <code translate="no">element_scope</code> فقط لكائنات <code translate="no">AnnSearchRequest</code> على مستوى عنصر StructArray التي يجب طيها إلى المرشحين على مستوى الكيان في البحث المختلط.</p></li>
