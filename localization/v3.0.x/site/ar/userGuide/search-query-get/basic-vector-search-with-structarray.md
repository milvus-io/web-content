...
<tr><td>ما يمثله كل نتيجة</td><td>كيان مطابق يكون حقل فرعي متجه StructArray الخاص به مشابهًا لقائمة التضمين الخاصة بالاستعلام.</td><td>عنصر Struct متطابق داخل حقل StructArray.</td></tr>
