...
<table>
   ...
   <tr>
     ...
     <td><p>تقدير مدى الصلة استنادًا إلى تكرار المصطلح وتكرار المستند المقلوب وتطبيع المستند.</p></td>
     <td><p>[0, ∞)</p></td>
   </tr>
</table>
<div class="alert note">
...
<p>افترض أن X' تم تطبيعه من التضمين X:</p>
<p>
