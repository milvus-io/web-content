...
<p>يمكنك أيضًا تعيين مدة صلاحية (TTL) لعملية التثبيت بحيث يتم تحرير البيانات المثبتة عند انتهاء المدة.</p>
<div class="multipleCode">
...
<li>تحافظ على معرّفات الحقول ومعرّفات الفهارس لضمان التوافق مع ملفات البيانات الموجودة</li>
