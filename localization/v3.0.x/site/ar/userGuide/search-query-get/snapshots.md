...
<p>اللقطات هي صور سريعة في الوقت المناسب للبيانات، وهي مناسبة للتراجع السريع أو الاختبار السريع<strong>(من أيام إلى أسابيع</strong>). وفي الوقت نفسه، فإن النسخ الاحتياطية هي نسخ مستقلة وكاملة مخزنة بشكل منفصل لاستعادة البيانات على المدى الطويل<strong>(من أسابيع إلى سنوات</strong>) ولحماية أفضل ضد فشل التخزين الكلي.</p>
...
<li>يمكنك استعادة لقطة فقط إلى مجموعة جديدة داخل نفس المجموعة الأصلية.</li>
