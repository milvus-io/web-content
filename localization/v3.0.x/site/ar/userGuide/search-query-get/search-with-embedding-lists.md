...
<p>عند تنفيذ نظام استرجاع النصوص الشبيه بـ ColBERT في ميلفوس، فإنك لا تقتصر على تقسيم المستندات إلى رموز.</p>
...
<h3 id="Step-2-Load-the-Cohere-dataset" class="common-anchor-header">الخطوة 2: قم بتحميل مجموعة بيانات Cohere<button data-href="#Step-2-Load-the-Cohere-dataset" class="anchor-icon" translate="no">
    ...
    </button></h3><p>في هذا المثال، سوف نستخدم في هذا المثال مجموعة بيانات كوهير الخاصة بويكيبيديا واسترجاع أول 10,000 سجل. يمكنك العثور على معلومات حول مجموعة البيانات هذه على <a href="https://huggingface.co/datasets/Cohere/wikipedia-2023-11-embed-multilingual-v3">هذه الصفحة</a>.</p>
