...
<p>يتم فرز التوصيات حسب مدى تشابهها مع الكلمة المفتاحية أو المنتج الحالي. ولتحقيق ذلك، يحتاج مطورو المنصات إلى استرداد التمثيل المتجهي للكلمة المفتاحية أو المنتج الحالي من Milvus قبل إجراء البحث الفعلي عن التشابه، مما يزيد من عدد رحلات الذهاب والإياب بين المنصة وMilvus ويؤدي إلى إرسال عدد كبير من القيم العائمة عالية الأبعاد عبر الشبكة.</p>
<p>لتبسيط منطق التفاعل بين تطبيقاتك وMilvus، وتقليل عدد عمليات الذهاب والإياب، وتجنب إرسال كميات كبيرة من قيم العدد العائم عالية الأبعاد عبر الشبكة، فكر في استخدام عمليات البحث بالمفتاح الأساسي.</p>
...
<li><p>يمكنك استخدام المفاتيح الأساسية بدلاً من متجهات الاستعلام في عمليات البحث المُصفاة، وعمليات البحث حسب النطاق، وعمليات البحث حسب التجميع، مع تمكين ترقيم الصفحات اختياريًا. ومع ذلك، لا تنطبق هذه الميزة على عمليات البحث المختلطة ومكررات البحث.</p></li>
...
<li><p>لا يمكنك استخدام المفاتيح الأساسية بدلاً من متجهات الاستعلام في واجهات برمجة التطبيقات (API) RESTful.</p></li>
...
<h3 id="Example-1-Basic-primary-key-search" class="common-anchor-header">المثال 1: البحث الأساسي باستخدام المفاتيح الأساسية<button data-href="#Example-1-Basic-primary-key-search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Example-2-Filtered-search-using-primary-keys" class="common-anchor-header">المثال 2: البحث المُصفاة باستخدام المفاتيح الأساسية<button data-href="#Example-2-Filtered-search-using-primary-keys" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>يفترض المثال التالي أن «color» و«likes» هما حقلان محددان في المخطط في المجموعة المستهدفة.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Example-4-Grouping-search-using-primary-keys" class="common-anchor-header">المثال 4: البحث المجمّع باستخدام المفاتيح الأساسية<button data-href="#Example-4-Grouping-search-using-primary-keys" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>يفترض المثال التالي أن « <code translate="no">docId</code> » هو حقل محدد في مخطط البيانات للمجموعة المستهدفة.</p>
<div class="multipleCode">
   <a href="#python">بايثون</a>
 <a href="#java">   جافا</a>
 <a href="#javascript">   NodeJS</a>
