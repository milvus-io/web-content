...
title: بحث المفتاح الأساسيCompatible with Milvus 2.6.9+
summary: >-
...
beta: Milvus 2.6.9+
---
<h1 id="Primary-Key-Search" class="common-anchor-header">بحث المفتاح الأساسي<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.6.9+</span><button data-href="#Primary-Key-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>في بحث المفتاح الأساسي، لا تحتاج إلى توفير أي متجهات استعلام. وبدلاً من ذلك، يُطلب منك تقديم المفاتيح الأساسية (<code translate="no">ids</code>) للكيانات التي تحتوي على ناقلات الاستعلام.</p>
...
<li><p>يمكنك استخدام المفاتيح الأساسية بدلًا من ناقلات الاستعلام في عمليات البحث التي تمت تصفيتها ونطاقها وتجميعها، مع تمكين ترقيم الصفحات اختياريًا. ومع ذلك، لا تنطبق هذه الميزة على عمليات البحث المختلطة ومكررات البحث.</p></li>
...
<h3 id="Example-1-Basic-primary-key-search" class="common-anchor-header">مثال 1: بحث المفتاح الأساسي الأساسي<button data-href="#Example-1-Basic-primary-key-search" class="anchor-icon" translate="no">
    ...
    </button></h3><p>لإجراء بحث أساسي بالمفتاح الأساسي، ما عليك سوى استبدال متجهات الاستعلام بالمفاتيح الأساسية.</p>
