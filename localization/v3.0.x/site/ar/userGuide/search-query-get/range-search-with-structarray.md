...
<h1 id="Range-Search-with-StructArray" class="common-anchor-header">البحث في نطاق مع StructArray<button data-href="#Range-Search-with-StructArray" class="anchor-icon" translate="no">
    ...
    </button></h1><p>استخدم هذه الصفحة لإجراء بحث النطاق على الحقول الفرعية المتجهة لـ StructArray. يُرجع بحث النطاق النتائج المتجهة التي تقع درجاتها أو مسافاتها ضمن حدود محددة. بالنسبة لحقول StructArray، استخدم بحث النطاق مع البحث المتجه على مستوى العناصر، حيث يتم البحث في كل عنصر من عناصر Struct بشكل مستقل.</p>
...
<p>إذا كنت بحاجة إلى عناصر Struct الأقرب فقط، فابدأ <a href="/docs/ar/basic-vector-search-with-structarray.md">بالبحث المتجه الأساسي باستخدام StructArray</a>. استخدم البحث في النطاق عندما يجب أن تستوفي النتيجة حدًا معينًا للدرجة أو المسافة بدلاً من مجرد ترتيب أفضل K.</p>
</div>
