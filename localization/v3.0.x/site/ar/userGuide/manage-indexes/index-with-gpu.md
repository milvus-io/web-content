...
<li><p><strong>درجة_الرسم البياني</strong><em>(int</em>): تؤثر على أداء البحث والاستدعاء من خلال تحديد درجة الرسم البياني بعد التقليم. عادةً ما تكون نصف <strong>درجة_درجة_الرسم البياني المتوسطة</strong>. يؤدي الفرق الأكبر بين هاتين الدرجتين إلى وقت بناء أطول. يجب أن تكون قيمته أصغر من قيمة <strong>intermediate_graph_degree</strong>.</p></li>
