...
<li><p><strong>القيم الافتراضية</strong>: لا تدعم حقول ARRAY القيم الافتراضية. ومع ذلك، يمكنك تعيين السمة <code translate="no">nullable</code> إلى <code translate="no">True</code> للسماح بالقيم الفارغة. لمزيد من التفاصيل، راجع " <a href="/docs/ar/nullable-and-default.md">القيم الفارغة والقيم الافتراضية</a>".</p></li>
...
<p>يُنشئ المثال التالي فهارس على الحقل المتجه <code translate="no">embedding</code> والحقل ARRAY <code translate="no">tags</code> ، وكلاهما يستخدم نوع الفهرس « <code translate="no">AUTOINDEX</code> ». باستخدام هذا النوع، يختار Milvus تلقائيًا الفهرس الأنسب بناءً على نوع البيانات. يمكنك أيضًا تخصيص نوع الفهرس والمعلمات لكل حقل. لمزيد من التفاصيل، راجع <a href="/docs/ar/index-explained.md">شرح الفهرس</a>.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>بالإضافة إلى إدراج المصفوفات الكاملة، تدعم حقول " <code translate="no">ARRAY</code> " أيضًا عوامل التحديث الجزئي " <code translate="no">ARRAY_APPEND</code> " و" <code translate="no">ARRAY_REMOVE</code> " في واجهة برمجة التطبيقات (API) " <code translate="no">upsert</code> " في Milvus الإصدار 2.6.17 والإصدارات الأحدث. تتيح لك هذه العوامل إضافة عناصر إلى مصفوفة موجودة أو إزالة العناصر المطابقة منها دون الحاجة إلى استرداد قيمتها الحالية أولاً، مما يتجنب نمط "القراءة-التعديل-الكتابة" من جانب العميل. للحصول على التفاصيل، راجع <a href="/docs/ar/upsert-entities.md#Upsert-ARRAY-fields-in-merge-mode">«إدراج أو تحديث حقول ARRAY في وضع الدمج</a>».</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>بالإضافة إلى ذلك، يدعم Milvus عوامل تصفية المصفوفات المتقدمة مثل <code translate="no">ARRAY_CONTAINS</code> و <code translate="no">ARRAY_CONTAINS_ALL</code> و <code translate="no">ARRAY_CONTAINS_ANY</code> و <code translate="no">ARRAY_LENGTH</code> لتعزيز قدرات الاستعلام بشكل أكبر. لمزيد من التفاصيل، راجع <a href="/docs/ar/array-operators.md">عوامل ARRAY</a>.</p>
