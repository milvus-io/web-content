...
<h3 id="Use-JSON-cast-functions-for-type-conversion--Milvus-2514+" class="common-anchor-header">استخدم دوال التحويل في JSON لتحويل الأنواع<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.5.14+</span><button data-href="#Use-JSON-cast-functions-for-type-conversion--Milvus-2514+" class="anchor-icon" translate="no">
    ...
    </button></h3><p>إذا كان مفتاح حقل ديناميكي يحتوي على قيم بتنسيق غير صحيح (مثل الأرقام المخزنة كسلاسل)، يمكنك استخدام دالة التحويل لتحويلها:</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
...
<p>راجع " <a href="/docs/ar/filtered-search.md">البحث المُصفى</a> <a href="/docs/ar/json-operators.md">وعوامل JSON</a>"</p></li>
</ul>
...
<li><p><strong>يتم الوصول إلى الحقل أو تصفيته بشكل متكرر</strong>: في حين أن فهرسة مفتاح حقل ديناميكي يمكن أن توفر أداء تصفية مشابهًا لحقول المخطط الثابتة، فإن الحقول المحددة صراحةً توفر بنية أوضح وقابلية صيانة أفضل.</p></li>
<li><p><strong>كنت بحاجة إلى تحكم كامل في سلوك الحقل</strong>: تدعم الحقول المحددة صراحةً القيود على مستوى المخطط والتحقق من الصحة والكتابة الأكثر وضوحًا، وهو ما قد يكون مفيدًا لإدارة تكامل البيانات واتساقها.</p></li>
