...
<p>يدعم Milvus القيم الفارغة والقيم الافتراضية لحقول <code translate="no">VARCHAR</code>. لتمكين هذه الميزات، قم بتعيين <code translate="no">nullable</code> إلى <code translate="no">True</code> و <code translate="no">default_value</code> إلى قيمة سلسلة. لمزيد من التفاصيل، راجع <a href="/docs/ar/nullable-and-default.md">Nullable &amp; Default</a>.</p>
</div>
...
<h2 id="Set-index-params" class="common-anchor-header">تعيين معلمات الفهرسة<button data-href="#Set-index-params" class="anchor-icon" translate="no">
    ...
    </button></h2><p>تساعد الفهرسة في تحسين أداء البحث والاستعلام. في Milvus، تعد الفهرسة إلزامية للحقول المتجهة، لكنها اختيارية للحقول القياسية.</p>
