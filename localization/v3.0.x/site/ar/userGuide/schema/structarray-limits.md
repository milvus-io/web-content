...
<tr><td>فهارس المتجهات</td><td>لا يقبل حقل المتجه أو الحقل الفرعي للمتجه سوى فهرس واحد. استخدم حقول فرعية منفصلة للمتجه للبحث في EmbeddingList والبحث على مستوى العناصر.</td></tr>
...
<h2 id="Index-and-metric-limits" class="common-anchor-header">حدود الفهرس والمقياس<button data-href="#Index-and-metric-limits" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يمكن فهرسة حقل فرعي متجه من نوع StructArray إما للبحث في EmbeddingList أو للبحث على مستوى العناصر. ولا يمكن لنفس الحقل الفرعي المتجه استخدام مجموعتي المقاييس معًا لأن كل حقل متجه أو حقل فرعي متجه لا يقبل سوى فهرس واحد فقط.</p>
<table>
<thead>
...
<h2 id="Filter-and-operator-limits" class="common-anchor-header">حدود التصفية والمشغلات<button data-href="#Filter-and-operator-limits" class="anchor-icon" translate="no">
    ...
    </button></h2><p>تتم معالجة التصفية القياسية لـ StructArray بواسطة عوامل StructArray، مثل <code translate="no">element_filter</code> وعائلة <code translate="no">MATCH_*</code>. توجد مصفوفة دعم المسندات التفصيلية في <a href="/docs/ar/struct-array-operators.md">StructArray Operators</a>.</p>
<p>على مستوى عام:</p>
<ul>
...
<li><p>لا يتم دعم صيغة مسار JSON، ووظائف JSON، ووظائف حاويات المصفوفات، ووظائف مطابقة النص، ووظائف الهندسة/نظم المعلومات الجغرافية (GIS)، وتعبيرات Timestamptz للمسافات على مستوى عناصر StructArray.</p></li>
