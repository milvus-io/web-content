...
summary: >-
  استخدم StructArray عندما تحتاج كيان ما إلى تخزين قائمة مرتبة من العناصر
  المنظمة، مثل مستند واحد يتألف من عدة أجزاء، أو صفحة واحدة تحتوي على عدة رقع
  مرئية، أو مقطع فيديو واحد يتألف من عدة مقاطع. ويحتفظ StructArray بهذه العناصر
  داخل الكيان الأصلي، مع السماح في الوقت نفسه بالبحث المتجه والتصفية القياسية
  على الحقول الموجودة داخل كل عنصر.
---
...
<p>على سبيل المثال، يمكن لمجموعة أن تخزن مقالًا واحدًا ككيان وتخزن أجزاءه في حقل StructArray يُسمى <code translate="no">chunks</code>. يمكن أن تتضمن كل جزء نصًا، وبيانات وصفية للقسم، ودرجات الجودة، وتضمينًا متجهًا واحدًا أو أكثر.</p>
...
<table>
<thead>
<tr><th>الهدف</th><th>المسار الموصى به</th><th>تفصيل النتائج</th><th>ابدأ من هنا</th></tr>
</thead>
<tbody>
...
<tr><td>أدخل السجلات الأصلية مع البيانات الفرعية المتداخلة.</td><td>أدخل كيانات يكون حقل StructArray الخاص بها عبارة عن قائمة من كائنات Struct.</td><td>الإدراج على مستوى الكيان.</td><td><a href="/docs/ar/insert-data-into-structarray-fields.md">إدراج البيانات في حقول StructArray</a></td></tr>
...
<tr><td>تقييد البحث المتجهي على مستوى العناصر ليقتصر على العناصر التي تتطابق مع الشروط القياسية.</td><td>استخدم <code translate="no">element_filter</code>.</td><td>التصفية على مستوى العناصر؛ يعتمد شكل النتيجة على نوع البحث.</td><td><a href="/docs/ar/filtered-search-with-structarray.md">البحث المُصفى باستخدام StructArray</a></td></tr>
<tr><td>تحديد الكيانات حسب عدد عناصر Struct التي تستوفي شرطًا ما.</td><td>استخدم <code translate="no">MATCH_ANY</code> أو <code translate="no">MATCH_ALL</code> أو <code translate="no">MATCH_LEAST</code> أو <code translate="no">MATCH_MOST</code> أو <code translate="no">MATCH_EXACT</code>.</td><td>مستوى الكيان.</td><td><a href="/docs/ar/struct-array-operators.md">عوامل StructArray</a></td></tr>
...
<h2 id="Understand-the-two-search-models" class="common-anchor-header">فهم نموذجي البحث<button data-href="#Understand-the-two-search-models" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <p>يعامل البحث على مستوى العنصر كل عنصر من عناصر Struct كمرشح مستقل للبحث المتجهي. يمثل كل نتيجة مطابقة عنصرًا متطابقًا داخل حقل StructArray، ويمكن للنتائج غير المجمعة أن تكشف عن إزاحة العنصر.</p>
        <ul>
          <li>بيانات الاستعلام: متجه عادي.</li>
          <li>مجموعة المقاييس: مقاييس المتجهات العادية.</li>
          <li>درجة تفصيل النتائج: مستوى عنصر Struct.</li>
          <li>الأفضل لـ: الاسترجاع على مستوى المقطع أو المقطع المصغر أو الرقعة.</li>
        </ul>
      </td>
    </tr>
  </tbody>
...
<tr><td>النمذجة</td><td><a href="/docs/ar/insert-data-into-structarray-fields.md">إدراج البيانات في حقول StructArray</a></td><td>تحضير وإدراج بيانات StructArray المتداخلة.</td></tr>
...
<tr><td>البحث</td><td><a href="/docs/ar/basic-vector-search-with-structarray.md">البحث المتجهي الأساسي باستخدام StructArray</a></td><td>قارن بين البحث باستخدام EmbeddingList والبحث المتجه على مستوى العناصر.</td></tr>
...
<tr><td>البحث</td><td><a href="/docs/ar/filtered-search-with-structarray.md">البحث المُصفاى باستخدام StructArray</a></td><td>استخدم عوامل تصفية StructArray في البحث والاستعلام والبحث المختلط.</td></tr>
...
<tr><td>التصفية</td><td><a href="/docs/ar/struct-array-operators.md">عوامل StructArray</a></td><td>بناء جملة مرجعية لمشغلات <code translate="no">element_filter</code> و <code translate="no">MATCH_*</code>.</td></tr>
</tbody>
</table>
...
<li><p>بعض تركيبات البحث مقيدة بالإصدار أو خاصة بوضع معين. تحقق من <a href="/docs/ar/structarray-limits.md">حدود StructArray</a> قبل الاعتماد على البحث عن النطاق، أو البحث عن التجميع، أو البحث الهجين، أو الحقول القابلة للقيمة الفارغة، أو الحقول المضافة ديناميكيًا.</p></li>
</ul>
...
<li><p>لتصفية الحقول الفرعية القياسية في StructArray، اقرأ " <a href="/docs/ar/struct-array-operators.md">عوامل StructArray</a> <a href="/docs/ar/filtered-search-with-structarray.md">والبحث المُصفى باستخدام StructArray</a>".</p></li>
</ol>
