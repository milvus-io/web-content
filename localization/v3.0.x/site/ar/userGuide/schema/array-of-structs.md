...
summary: >-
  ...
  المنظمة، مثل مستند واحد يتألف من عدة أجزاء، أو صفحة واحدة تتألف من عدة عناصر
...
<tr><td>دمج البحث عن عناصر StructArray مع حقل متجه آخر.</td><td>استخدم البحث الهجين باستخدام طلب AnnSearchRequest واحد يستهدف حقل فرعي متجه لـ StructArray.</td><td>بحث فرعي على مستوى العنصر، وإعادة ترتيب على مستوى الكيان.</td><td>البحث الهجين باستخدام StructArray</td></tr>
</tbody>
</table>
...
<tr><td>البحث</td><td>البحث المختلط باستخدام StructArray</td><td>دمج البحث على مستوى العناصر باستخدام StructArray مع عمليات البحث المتجهية الأخرى.</td></tr>
