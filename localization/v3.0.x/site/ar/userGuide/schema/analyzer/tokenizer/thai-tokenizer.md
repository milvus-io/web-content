...
<li><strong>دلالات الموضع</strong>: يستخدم مواضع الرموز القائمة على الأحرف والتي تشمل المسافات البيضاء وعلامات الترقيم التي تم تخطيها، مما يحافظ على اتساق سلوك مطابقة العبارات والقرب مع أدوات تجزئة الرموز الأخرى غير اللاتينية.</li>
</ul>
