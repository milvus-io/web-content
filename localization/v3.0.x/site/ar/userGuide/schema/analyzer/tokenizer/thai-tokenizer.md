...
<li><strong>أداة التقطيع فقط</strong>: لا تقوم بتحويل الرموز إلى أحرف صغيرة، ولا بتوحيد أرقام يونيكود، ولا بإزالة الكلمات الممنوعة. أضف مرشحات أو استخدم <a href="/docs/ar/thai-analyzer.md"><code translate="no">thai</code></a> لتلك الخطوات.</li>
