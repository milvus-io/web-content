...
summary: >-
  يقوم مُجزِّئ النص التايلاندي بتقسيم النص التايلاندي إلى وحدات كلمية، ويستبعد
...
<p>بالنسبة للنصوص التايلاندية، استخدم المحلل المدمج <a href="/docs/ar/thai-analyzer.md"><code translate="no">thai</code></a> في معظم الحالات. يتضمن المحلل المدمج أداة التقطيع هذه بالإضافة إلى تحويل الأحرف إلى صغرى، وتوحيد الأرقام العشرية، وإزالة الكلمات الممنوعة في اللغة التايلاندية. استخدم أداة التقطيع <code translate="no">thai</code> مباشرةً فقط عندما تحتاج إلى إنشاء مسار محلل مخصص.</p>
</div>
