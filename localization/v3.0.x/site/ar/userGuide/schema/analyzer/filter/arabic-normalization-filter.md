...
<h1 id="Arabic-Normalization" class="common-anchor-header">توحيد النص العربي<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 3.0.0+</span><button data-href="#Arabic-Normalization" class="anchor-icon" translate="no">
    ...
    </button></h1><p>يُعد مرشح " <code translate="no">arabic_normalization</code> " مرشحًا مدمجًا للرموز النصية الخاصة بالنصوص العربية. وهو يعمل على توحيد أشكال الحروف الخاصة باللغة العربية وإزالة العلامات الاختيارية التي قد تؤدي إلى ظهور المصطلحات العربية المتطابقة بشكل مختلف أثناء تحليل النص.</p>
