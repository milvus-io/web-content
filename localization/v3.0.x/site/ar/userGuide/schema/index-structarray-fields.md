...
<tr><td>التصفية حسب السلسلة أو الفئة</td><td><code translate="no">chunks[section]</code></td><td>فهرس قياسي مدعوم من قبل الهدف الخاص بك.</td></tr>
...
<tbody>
<tr><td>استخدم صيغة المسار لفهرسة الحقول الفرعية.</td><td>قم بفهرسة <code translate="no">chunks[emb]</code> ، وليس <code translate="no">emb</code> أو <code translate="no">chunks.emb</code>.</td></tr>
...
<li><p>فهرسة حقل فرعي من نوع StructArray غير موجود في مخطط Struct.</p></li>
</ul>
