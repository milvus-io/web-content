...
summary: >-
  ...
  الآلي وتحليل البيانات. وهي تتألف من مصفوفات تحتوي على أعداد حقيقية، حيث تكون
  معظم العناصر أو جميعها غير صفرية. وبالمقارنة مع المتجهات المتفرقة، تحتوي
  المتجهات الكثيفة على معلومات أكثر عند نفس مستوى الأبعاد، حيث يحتوي كل بُعد على
  قيم ذات مغزى. يمكن لهذا التمثيل التقاط الأنماط والعلاقات المعقدة بفعالية، مما
  يسهل تحليل البيانات ومعالجتها في الفضاءات عالية الأبعاد. عادةً ما يكون
...
<h2 id="Overview" class="common-anchor-header">نظرة عامة<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يُشار إلى المتجهات الكثيفة عادةً على شكل مصفوفات من الأرقام العائمة ذات الطول الثابت، مثل <code translate="no">[0.2, 0.7, 0.1, 0.8, 0.3, ..., 0.5]</code>. وتتراوح أبعاد هذه المتجهات عادةً بين المئات والآلاف، مثل 128 أو 256 أو 768 أو 1024. يستوعب كل بُعد سمات دلالية محددة لكيان ما، مما يجعله قابلاً للتطبيق في سيناريوهات متنوعة من خلال حسابات التشابه.</p>
...
<p>توضح الصورة أعلاه تمثيل المتجهات الكثيفة في فضاء ثنائي الأبعاد. وعلى الرغم من أن المتجهات الكثيفة في التطبيقات الواقعية غالبًا ما تكون ذات أبعاد أعلى بكثير، فإن هذا التوضيح ثنائي الأبعاد ينقل بفعالية عدة مفاهيم أساسية:</p>
<ul>
<li><p><strong>التمثيل متعدد الأبعاد:</strong> تمثل كل نقطة كائنًا مفاهيميًا (مثل <strong>Milvus</strong>، <strong>وقاعدة بيانات المتجهات</strong>، <strong>ونظام الاسترجاع</strong>، وما إلى ذلك)، ويتم تحديد موضعها من خلال قيم أبعادها.</p></li>
<li><p><strong>العلاقات الدلالية:</strong> تعكس المسافات بين النقاط التشابه الدلالي بين المفاهيم. تشير النقاط الأقرب إلى المفاهيم الأكثر ارتباطًا من الناحية الدلالية.</p></li>
<li><p><strong>تأثير التجميع:</strong> تُوضع المفاهيم ذات الصلة (مثل <strong>Milvus</strong> <strong>وقاعدة البيانات المتجهة</strong> <strong>ونظام الاسترجاع</strong>) قريبة من بعضها البعض في الفضاء، لتشكل مجموعة دلالية.</p></li>
</ul>
...
<p>إلى جانب المتجهات الكثيفة، يدعم Milvus أيضًا المتجهات المتفرقة والمتجهات الثنائية. تعد المتجهات المتفرقة مناسبة للمطابقات الدقيقة بناءً على مصطلحات محددة، مثل البحث عن الكلمات المفتاحية ومطابقة المصطلحات، بينما تُستخدم المتجهات الثنائية عادةً للتعامل بكفاءة مع البيانات الثنائية، مثل مطابقة أنماط الصور وتطبيقات التجزئة (هاشينغ) معينة. لمزيد من المعلومات، راجع <a href="/docs/ar/binary-vector.md">«المتجه الثنائي</a> » <a href="/docs/ar/sparse_vector.md">و«المتجه المتفرق</a>».</p>
</div>
...
<ol>
<li><p>تعيين « <code translate="no">datatype</code> » (أبعاد المتجه) إلى نوع بيانات متجه كثيف مدعوم. للاطلاع على أنواع بيانات المتجهات الكثيفة المدعومة، راجع «أنواع البيانات».</p></li>
<li><p>تحديد أبعاد المتجه الكثيف باستخدام المعلمة <code translate="no">dim</code>.</p></li>
</ol>
<p>في المثال أدناه، نضيف حقل متجهًا باسم <code translate="no">dense_vector</code> لتخزين المتجهات الكثيفة. نوع بيانات الحقل هو <code translate="no">FLOAT_VECTOR</code> ، مع بُعد <code translate="no">4</code>.</p>
...
<table>
   ...
   <tr>
     ...
     <td><p>يخزن أرقامًا عائمة بنصف دقة 16 بت، تُستخدم في التعلم العميق وحسابات وحدة معالجة الرسومات (GPU). يوفر مساحة تخزين في الحالات التي تكون فيها الدقة أقل أهمية، مثل مرحلة الاسترجاع منخفضة الدقة في أنظمة التوصيات.</p></td>
   </tr>
   <tr>
     <td><p><code translate="no">BFLOAT16_VECTOR</code></p></td>
     <td><p>يخزن أرقام Brain Floating Point (bfloat16) ذات 16 بت، ويوفر نفس نطاق الأسات مثل Float32 ولكن بدقة أقل. مناسب للسيناريوهات التي تحتاج إلى معالجة كميات كبيرة من المتجهات بسرعة، مثل استرجاع الصور على نطاق واسع.</p></td>
   </tr>
   <tr>
...
<p>يوفر Milvus أنواعًا متنوعة من الفهارس لتجربة بحث متجهية أفضل. AUTOINDEX هو نوع فهرس خاص مصمم لتسهيل عملية التعلم الخاصة بالبحث المتجهي. هناك العديد من أنواع الفهارس المتاحة لتختار من بينها. لمزيد من التفاصيل، راجع <a href="/docs/ar/index-explained.md">شرح الفهارس</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>لمزيد من المعلومات حول معلمات البحث عن التشابه، راجع <a href="/docs/ar/single-vector-search.md">البحث الأساسي</a> باستخدام الشبكات العصبية <a href="/docs/ar/single-vector-search.md">الاصطناعية (ANN)</a>.</p>
