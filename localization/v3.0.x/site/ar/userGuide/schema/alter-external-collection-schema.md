...
<p>بدلاً من إعادة إنشاء المجموعة الخارجية أو نسخ البيانات المصدرية إلى Milvus، أضف حقل Milvus يرتبط بالحقل الموجود في مصدر البيانات الخارجي. بعد إضافة الحقل، قم بتحديث المجموعة الخارجية حتى يمكن استخدام الحقل الجديد في الاستعلامات وعمليات البحث.</p>
