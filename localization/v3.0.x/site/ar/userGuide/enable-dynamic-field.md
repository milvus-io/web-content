...
<h2 id="Insert-dynamic-data" class="common-anchor-header">إدراج بيانات ديناميكية<button data-href="#Insert-dynamic-data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>بمجرد إنشاء المجموعة، يمكنك البدء في إدراج البيانات، بما في ذلك البيانات الديناميكية في المجموعة.</p>
<h3 id="Prepare-data" class="common-anchor-header">إعداد البيانات<button data-href="#Prepare-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>في هذا القسم، تحتاج إلى إعداد بعض البيانات التي تم إنشاؤها عشوائيًا لإدراجها لاحقًا.</p>
<div class="multipleCode">
   <a href="#python">بايثون </a> <a href="#java">جافا</a> <a href="#javascript">Node.js</a></div>
...
<h3 id="Insert-data" class="common-anchor-header">إدراج البيانات<button data-href="#Insert-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>بعد ذلك يمكنك إدراج البيانات بأمان في المجموعة.</p>
<div class="language-python">
...
<p>إذا كان اسم الحقل غير المعرف من قبل المخطط يحتوي على أحرف أخرى غير الأرقام والحروف والشرطات السفلية، مثل علامات الجمع (+) أو العلامات النجمية (*) أو علامات الدولار (<span class="katex-error" title="ParseError: KaTeX parse error: Expected group after &#x27;_&#x27; at position 39: …the key within _̲_" style="color:#cc0000">)، يجب عليك تضمين المفتاح داخل __meta</span>[]__ كما هو موضح في مقتطف الشيفرة التالي عند استخدامه في تعبير منطقي أو تضمينه في حقول الإخراج.</p>
