...
<h4 id="AISAQ-performance-mode" class="common-anchor-header">وضع AISAQ-أداء AISAQ</h4><p>يحقق<strong>وضع AISAQ-performance</strong> "بصمة DRAM تقترب من الصفر" من خلال نقل بيانات PQ من الذاكرة إلى القرص مع الحفاظ على معدل IOPS منخفض من خلال تجميع البيانات وتكرارها.</p>
<ul>
...
<table>
   ...
   <tr>
     ...
     <td><p>باستخدام القيمة الافتراضية 0.25، سيتم تكميم المتجهات إلى 25% من حجمها الأصلي (ضغط 4×4)، مما يقلل من بصمة القرص مع تأثير دقة ضئيل نسبيًا.</p><p>قم بتعيين القيمة 0 لتخزين متجهات الدقة الكاملة في فهرس القرص لإعادة الترتيب. توفر القيمة الأكبر معدل استدعاء أعلى ولكنها تزيد من استخدام القرص.</p></td>
   </tr>
   <tr>
...
<table>
   ...
   <tr>
     ...
     <td><p>تعمل ذاكرة التخزين المؤقت الأكبر على تحسين أداء الاستعلام ولكنها تزيد من استخدام DRAM.</p><p>تتراوح القيم الموصى بها من 2 ميغابايت للقطاعات الصغيرة (1 ميغابايت من المتجهات) و5 ميغابايت للقطاعات المتوسطة (50 ميغابايت من المتجهات) و10 ميغابايت للقطاعات الكبيرة (250 ميغابايت من المتجهات).</p></td>
   </tr>
</table>
