...
<table>
   ...
   <tr>
     ...
     <td><p>ما إذا كان سيتم تخزين بيانات المتجه الأصلية إلى جانب التمثيل الكمي. عند التمكين، يسمح ذلك بحسابات تشابه أكثر دقة أثناء مرحلة إعادة الترتيب باستخدام المتجهات الأصلية بدلاً من التقديرات التقريبية المكمّمة.</p></td>
