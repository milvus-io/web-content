...
<li><p>يؤدي هذا إلى إنشاء <code translate="no">m</code> جداول بحث، حيث يحتوي كل جدول على مسافات <sup>2nbits</sup>.</p></li>
</ul></li>
...
<table>
   ...
   <tr>
     ...
     <td><p>تسمح القيمة الأعلى <code translate="no">nbits</code> باستخدام دفاتر رموز أكبر، مما قد يؤدي إلى تمثيل أكثر دقة للمتجهات الأصلية. ومع ذلك، فهذا يعني أيضًا استخدام المزيد من البتات لتخزين كل فهرس، مما يؤدي إلى ضغط أقل. في معظم الحالات، نوصي بتعيين قيمة ضمن هذا النطاق: [1, 16].</p></td>
   </tr>
</table>
