...
summary: >-
  ...
  الفهرسة المقلوبة لإنشاء بنية بحث عالية الكفاءة للبيانات المتفرقة.
---
...
<h2 id="Build-index" class="common-anchor-header">إنشاء الفهرس<button data-href="#Build-index" class="anchor-icon" translate="no">
    ...
    </button></h2><p>لإنشاء فهرس " <code translate="no">SPARSE_INVERTED_INDEX</code> " على حقل متجهات متفرقة في Milvus، استخدم الطريقة <code translate="no">add_index()</code> وحدد المعلمات <code translate="no">index_type</code> و <code translate="no">metric_type</code> وindex.</p>
...
<ul>
<li><p><code translate="no">&quot;DAAT_MAXSCORE&quot;</code>: معالجة الاستعلامات بنظام «المستند الواحد في كل مرة» (Document-at-a-Time) باستخدام MaxScore. هذا هو الإعداد الافتراضي لـ «الاستعلامات المتكررة» ( <code translate="no">BM25</code>). لمزيد من المعلومات الأساسية، راجع <a href="https://dl.acm.org/doi/10.1016/0306-4573%2895%2900020-H">«تقييم الاستعلامات: الاستراتيجيات والتحسينات</a>».</p></li>
