...
summary: >-
  ...
  مدخلات الهدف مع جميع المتجهات في مجموعة البيانات - يضمن لك مؤشر FLAT_FLAT
  نتائج دقيقة. هذه الدقة تجعله معيارًا مثاليًا لتقييم أداء الفهارس الأخرى التي
  قد تقدم أقل من 100% استرجاع، على الرغم من أن منهجيته الشاملة تجعله أيضًا
  الخيار الأبطأ للبيانات واسعة النطاق.
---
