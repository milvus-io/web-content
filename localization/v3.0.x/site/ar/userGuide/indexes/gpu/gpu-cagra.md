...
<p>استخدم تكييف وحدة المعالجة المركزية في وقت التحميل في البيئات المختلطة أو البيئات الحساسة للتكلفة حيث يتم حجز موارد وحدة معالجة الرسومات لبناء الفهرس ولكن عمليات البحث تعمل على وحدة المعالجة المركزية.</p>
</div>
