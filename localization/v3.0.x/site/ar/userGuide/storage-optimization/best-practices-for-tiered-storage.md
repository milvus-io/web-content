...
<ul>
<li><p>مجموعة واحدة تخدم كلاً من أعباء العمل عبر الإنترنت والتحليلية</p></li>
<li><p>تتطلب بعض المجموعات زمن انتقال منخفض، بينما تعطي مجموعات أخرى الأولوية للسعة</p></li>
</ul>
