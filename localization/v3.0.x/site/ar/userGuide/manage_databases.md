...
<ul>
<li>إذا لم يحدد اتصال Milvus ولا استدعاء واجهة برمجة تطبيقات الأذونات <code translate="no">db_name</code> ، تشير <strong>قاعدة البيانات</strong> إلى قاعدة البيانات الافتراضية.</li>
...
<li>إذا تم إجراء استدعاء Permission API عند اتصال Milvus، مع تحديد <code translate="no">db_name</code> أو بدونه، تشير <strong>قاعدة البيانات</strong> إلى قاعدة البيانات التي تم تحديد اسمها في استدعاء واجهة برمجة التطبيقات الخاصة بالإذن.</li>
</ul>
