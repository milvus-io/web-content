...
<h3 id="Option-2-Environment-variable" class="common-anchor-header">الخيار 2: متغير البيئة<button data-href="#Option-2-Environment-variable" class="anchor-icon" translate="no">
    ...
    </button></h3><p>إذا لم تحدد إعدادات الوظيفة أو المزود تسمية بيانات الاعتماد، فإن Milvus يقرأ الرمز المميز من <code translate="no">MILVUS_HUGGINGFACE_API_KEY</code>.</p>
...
<tr><td><code translate="no">max_client_batch_size</code></td><td>لا</td><td>الحد الأقصى لعدد النصوص المدخلة المرسلة في طلب Hugging Face واحد. القيمة الافتراضية هي <code translate="no">128</code> ، ويجب أن تكون القيمة أكبر من <code translate="no">0</code>.</td></tr>
</tbody>
</table>
