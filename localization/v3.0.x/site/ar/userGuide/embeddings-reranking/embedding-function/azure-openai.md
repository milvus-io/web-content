...
<button class="copy-code-btn"></button></code></pre>
<p>هذا يربط مفتاحًا محددًا بكل طلب يرسله Milvus إلى نقطة نهاية تضمينات Azure OpenAI.</p></li>
</ol>
...
<h3 id="Step-2-Add-embedding-function-to-schema" class="common-anchor-header">الخطوة 2: إضافة دالة التضمين إلى المخطط<button data-href="#Step-2-Add-embedding-function-to-schema" class="anchor-icon" translate="no">
    ...
    </button></h3><p>بمجرد تحديد دالة التضمين الخاصة بك، أضفها إلى مخطط مجموعتك. هذا يوجه ميلفوس لاستخدام دالة التضمين المحددة لمعالجة التضمينات من بياناتك النصية وتخزينها.</p>
