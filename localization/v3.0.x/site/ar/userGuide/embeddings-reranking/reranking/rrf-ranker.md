...
<h2 id="Mechanism-of-RRF-Ranker" class="common-anchor-header">آلية مصنف RRF Ranker<button data-href="#Mechanism-of-RRF-Ranker" class="anchor-icon" translate="no">
    ...
    </button></h2><p>سير العمل الرئيسي لإستراتيجية RRFRanker على النحو التالي:</p>
<ol>
...
<h3 id="Create-an-RRF-Ranker" class="common-anchor-header">إنشاء مصنف RRRF<button data-href="#Create-an-RRF-Ranker" class="anchor-icon" translate="no">
    ...
    </button></h3><p>بعد إعداد مجموعتك باستخدام حقول متجهات متعددة، قم بإنشاء مصنف RRF Ranker باستخدام معلمة تنعيم مناسبة:</p>
