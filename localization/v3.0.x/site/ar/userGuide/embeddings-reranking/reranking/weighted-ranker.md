...
<h2 id="When-to-use-Weighted-Ranker" class="common-anchor-header">متى تستخدم أداة التصنيف المرجحة<button data-href="#When-to-use-Weighted-Ranker" class="anchor-icon" translate="no">
    ...
    </button></h2><p>تم تصميم التصنيف المرجح خصيصًا لسيناريوهات البحث المختلط حيث تحتاج إلى دمج النتائج من مسارات بحث متجهات متعددة. وهو فعال بشكل خاص لـ</p>
<table>
   <tr>
...
<h2 id="Usage-of-Weighted-Ranker" class="common-anchor-header">استخدام مصنف الرتب المرجحة<button data-href="#Usage-of-Weighted-Ranker" class="anchor-icon" translate="no">
    ...
    </button></h2><p>عند استخدام إستراتيجية المُرتّب المرجّح، من الضروري إدخال قيم الترجيح. يجب أن يتوافق عدد قيم الترجيح التي يجب إدخالها مع عدد طلبات البحث الأساسية للشبكة العصبية الاصطناعية في البحث الهجين. يجب أن تقع قيم الوزن الترجيحي للإدخال في نطاق [0،1]، حيث تشير القيم الأقرب إلى 1 إلى أهمية أكبر.</p>
<h3 id="Create-a-Weighted-Ranker" class="common-anchor-header">إنشاء مصنف مرجح<button data-href="#Create-a-Weighted-Ranker" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
