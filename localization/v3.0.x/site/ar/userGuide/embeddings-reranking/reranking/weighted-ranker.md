...
<li><p><strong>دمج الدرجات</strong>: يتم ترتيب الدرجات الموزونة (الدرجة_1_ المرجحة و الدرجة_2_ المرجحة) من الأعلى إلى الأقل لإنتاج مجموعة نهائية من الدرجات (الدرجة_ النهائية).</p></li>
</ol>
<p>
...
<table>
   ...
   <tr>
     ...
     <td><p>نعم</p></td>
     <td><p>تحديد طريقة إعادة الترتيب المراد استخدامها.</p><p>يجب ضبطها على <code translate="no">weighted</code> لاستخدام طريقة إعادة الترتيب المرجحة.</p></td>
