...
summary: >-
  ...
  لتحسين قواعد البيانات»: فقد تحصل على مستندات ذات تشابه متجهي عالٍ تذكر هذه
...
<table>
   ...
   <tr>
     ...
     <td><p>لا</p></td>
     <td><p>الحد الأقصى لعدد المستندات التي يمكن معالجتها في دفعة واحدة. تؤدي القيم الأكبر إلى زيادة معدل الإنتاجية، لكنها تتطلب ذاكرة أكبر.</p></td>
