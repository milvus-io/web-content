...
<li><p>إذا كانت مجموعتك تخزن الطوابع الزمنية <strong>بالمللي</strong> ثانية، فاستخدم المللي ثانية لجميع المعلمات</p></li>
...
<button class="copy-code-btn"></button></code></pre>
<p>في حالات البحث الهجين (الجمع بين حقول متجهات متعددة)، يأخذ Milvus أقصى درجة تشابه طبيعية بين طلبات البحث:</p>
...
<table>
   ...
   <tr>
     ...
     <td><p>تتناقص بسرعة في البداية ولكنها تحافظ على ذيل طويل</p></td>
