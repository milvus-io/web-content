...
<h3 id="Metrics-for-CDC-tasks" class="common-anchor-header">مقاييس مهام CDC<button data-href="#Metrics-for-CDC-tasks" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>للبدء، قم باستيراد ملف <a href="https://github.com/zilliztech/milvus-cdc/blob/main/server/configs/cdc-grafana.json">cdc-grafana.json</a> إلى Grafana. سيؤدي ذلك إلى إضافة لوحة معلومات مصممة خصيصًا لمراقبة حالة مهام CDC.</p>
