...
<li><code translate="no">milvus-operator</code> كمساحة أسماء لـ Milvus Operator.</li>
</ul>
<p>قبل أن تبدأ، اقرأ <a href="/docs/ar/milvus_cdc_overview.md">Milvus CDC</a> لفهم نموذج الاستعداد الأساسي وخيارات تجاوز الفشل.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>تحقق من أن كبسولات مجموعة المصدر قيد التشغيل:</p>
