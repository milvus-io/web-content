...
<h1 id="Milvus-Backup" class="common-anchor-header">Milvus Backup<button data-href="#Milvus-Backup" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus Backup هي أداة تتيح للمستخدمين إجراء النسخ الاحتياطي لبيانات Milvus واستعادتها. وهي توفر واجهة سطر الأوامر (CLI) وواجهة برمجة التطبيقات (API) لتتناسب مع سيناريوهات الاستخدام المختلفة.</p>
