...
<h3 id="Install-via-pip" class="common-anchor-header">التثبيت عبر pip<button data-href="#Install-via-pip" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>قم بتشغيل الأمر التالي لتثبيت Milvus_CLI.</p>
...
<h3 id="Prerequisites" class="common-anchor-header">المتطلبات الأساسية<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h3><p>مطلوب Docker 19.03 أو أحدث.</p>
<h3 id="Install-based-on-Docker-image" class="common-anchor-header">التثبيت بناءً على صورة Docker<button data-href="#Install-based-on-Docker-image" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<p>أو يمكنك بدلاً من ذلك، يمكنك تثبيت Milvus_CLI من ملف tarball مضغوط (<code translate="no">.tar.gz</code> ). قم بتنزيل ملف <a href="https://github.com/zilliztech/milvus_cli/releases">tarball</a> وتشغيل <code translate="no">python -m pip install milvus_cli-&lt;version&gt;.tar.gz</code>.</p>
<h3 id="Install-from-an-exe-file" class="common-anchor-header">التثبيت من ملف .exe<button data-href="#Install-from-an-exe-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><div class="alert note"> تنطبق طريقة التثبيت هذه على نظام ويندوز فقط. </div>
