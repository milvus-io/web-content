...
<h2 id="Cherry-Studio" class="common-anchor-header">تشيري ستوديو<button data-href="#Cherry-Studio" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يتيح Cherry Studio تكوين خادم MCP المرئي من خلال واجهة الإعدادات الخاصة به. في حين أنه لا يدعم مباشرةً تكوين JSON اليدوي، يمكنك إضافة خادم جديد عبر واجهة المستخدم الرسومية:</p>
<ol>
