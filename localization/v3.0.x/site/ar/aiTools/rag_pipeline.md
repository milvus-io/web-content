---
id: rag_pipeline.md
title: 'موجه: خط أنابيب ميلفوس راج'
summary: قواعد لمساعدي ترميز الذكاء الاصطناعي لبناء خطوط أنابيب RAG مع Milvus.
---
<h1 id="RAG-Pipeline" class="common-anchor-header">خط أنابيب RAG<button data-href="#RAG-Pipeline" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>قواعد شاملة لإنشاء خطوط أنابيب RAG مع Milvus، بما في ذلك الاستيعاب والتقطيع والتضمين والاسترجاع المختلط مع BM25 وتحديثات المستندات مع upsert. انسخ المطالبة الكاملة أدناه إلى أداة الذكاء الاصطناعي لتطبيق هذه القواعد تلقائيًا. للحصول على نظرة عامة على جميع المطالبات، راجع <a href="/docs/ar/milvus_for_agents.md">مطالبات الذكاء الاصطناعي</a>.</p>
