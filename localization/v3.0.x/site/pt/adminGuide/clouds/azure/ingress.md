---
id: ingress.md
title: Configurar o nginx de entrada com o Milvus
related_key: ingress nginx
summary: Saiba como configurar o ingress nginx com o Milvus.
---
<h1 id="Configure-ingress-nginx-with-Milvus" class="common-anchor-header">Configurar o nginx de entrada com o Milvus<button data-href="#Configure-ingress-nginx-with-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Este tópico apresenta como configurar o nginx de entrada com o Milvus. Para obter mais detalhes, consulte <a href="https://learn.microsoft.com/en-us/azure/aks/ingress-tls?tabs=azure-cli">ingress-nginx</a>.</p>
<h2 id="Configure-ingress-nginx" class="common-anchor-header">Configurar o nginx de entrada<button data-href="#Configure-ingress-nginx" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<ul>
<li>Instalar o nginx ingress</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Obter endereço IP externo.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Install-cert-manager" class="common-anchor-header">Instalar o cert-manager<button data-href="#Install-cert-manager" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Create-a-CA-cluster-issuer" class="common-anchor-header">Criar um emissor de cluster CA<button data-href="#Create-a-CA-cluster-issuer" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Crie um emissor de cluster, como cluster-issuer.yaml, usando o seguinte exemplo de manifesto. Substitua MY_EMAIL_ADDRESS por um endereço válido da sua organização.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Aplique o emissor usando o comando kubectl apply.</li>
</ul>
...
<h2 id="Deploy-Milvus" class="common-anchor-header">Implantar o Milvus<button data-href="#Deploy-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>consulte o <a href="https://milvus.io/docs/azure.md">Azure</a>, observe o valor config <code translate="no">service.type</code>, é necessário alterar para <code translate="no">ClusterIP</code>.</p>
<h2 id="Create-Milvus-ingress-route" class="common-anchor-header">Criar rota de entrada do Milvus<button data-href="#Create-Milvus-ingress-route" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<p>o conteúdo do ingress.yaml:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Verify" class="common-anchor-header">Verificar<button data-href="#Verify" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h2 id="Hello-Milvus" class="common-anchor-header">Olá Milvus<button data-href="#Hello-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Consulte <a href="https://milvus.io/docs/v2.3.x/example_code.md">Hello Milvus</a>, altere os argumentos uri e, em seguida, execute o código.</p>
