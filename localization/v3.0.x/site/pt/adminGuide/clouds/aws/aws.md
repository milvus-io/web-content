---
id: aws.md
title: Implementar um Cluster Milvus no EC2
related_key: cluster
...
<p>Adicionar os nomes dos anfitriões, definir o grupo <code translate="no">docker</code> e <code translate="no">vars</code>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Se o Docker for instalado com êxito nos três hosts, o terminal retornará o seguinte:</p>
