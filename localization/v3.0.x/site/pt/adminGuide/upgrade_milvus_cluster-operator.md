...
<h1 id="Upgrade-Milvus-Cluster-with-Milvus-Operator" class="common-anchor-header">Atualização do Cluster Milvus com o Milvus Operator<button data-href="#Upgrade-Milvus-Cluster-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar seu cluster Milvus da v2.5.x para a v2.6.15 usando o Milvus Operator.</p>
<h2 id="Before-you-start" class="common-anchor-header">Antes de começar<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Whats-new-in-v2615" class="common-anchor-header">O que há de novo na v2.6.15<button data-href="#Whats-new-in-v2615" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>A atualização do Milvus 2.5.x para a 2.6.15 envolve mudanças significativas na arquitetura:</p>
<ul>
...
<ul>
<li>O Milvus v2.6.0-rc1 <strong>não</strong> é <strong>compatível</strong> com a v2.6.15. Não são suportadas actualizações diretas a partir de versões candidatas.</li>
...
<li>É <strong>necessário</strong> atualizar para a versão 2.5.16 ou posterior com <code translate="no">mixCoord</code> ativado antes de atualizar para a versão 2.6.15.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="23-Upgrade-to-v2615" class="common-anchor-header">2.3 Atualização para a v2.6.15</h4><p>Quando a v2.5.16 estiver a funcionar com êxito com <code translate="no">mixCoord</code>, actualize para a v2.6.15:</p>
