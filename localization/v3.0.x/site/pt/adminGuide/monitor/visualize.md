...
<h2 id="Visualize-metrics-using-Grafana" class="common-anchor-header">Visualizar métricas usando o Grafana<button data-href="#Visualize-metrics-using-Grafana" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Download-and-import-dashboard" class="common-anchor-header">1. Descarregar e importar o painel de controlo<button data-href="#1-Download-and-import-dashboard" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Descarregue e importe o dashboard do Milvus a partir do ficheiro JSON.</p>
...
<h3 id="2-View-metrics" class="common-anchor-header">2. Ver métricas<button data-href="#2-View-metrics" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Selecione a instância do Milvus que pretende monitorizar. Em seguida, pode ver o painel de componentes do Milvus.</p>
<p>
...
<li>Leia o <a href="/docs/pt/upgrade_milvus_cluster-operator.md">guia de atualização do Milvus cluster</a> e o <a href="/docs/pt/upgrade_milvus_cluster-operator.md">guia</a> <a href="/docs/pt/upgrade_milvus_standalone-operator.md">de atualização do Milvus standalone</a>.</li>
</ul></li>
</ul>
