...
<h2 id="Download-an-installation-file" class="common-anchor-header">Descarregar um ficheiro de instalação<button data-href="#Download-an-installation-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Descarregue o ficheiro de instalação do Milvus <a href="https://github.com/milvus-io/milvus/releases/download/v3.0-beta/milvus-standalone-docker-compose.yml">standalone</a> e guarde-o com o nome « <code translate="no">docker-compose.yml</code> ».</p>
...
<p>Mapeie o caminho local para o seu ficheiro « <code translate="no">milvus.yaml</code> » para os caminhos correspondentes dos ficheiros de configuração no contentor Docker, em « <code translate="no">/milvus/configs/milvus.yaml</code> », em todas as secções « <code translate="no">volumes</code> ».</p>
