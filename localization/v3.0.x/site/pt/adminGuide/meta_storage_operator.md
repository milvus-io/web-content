...
title: Configurar o armazenamento de metadados com o Milvus Operator
...
<h3 id="External-etcd" class="common-anchor-header">etcd externo<button data-href="#External-etcd" class="anchor-icon" translate="no">
    ...
    </button></h3><h4 id="Example" class="common-anchor-header">externo</h4><p>O exemplo a seguir configura um serviço etcd externo.</p>
...
<h3 id="Internal-etcd" class="common-anchor-header">etcd interno<button data-href="#Internal-etcd" class="anchor-icon" translate="no">
    ...
    </button></h3><p><code translate="no">inCluster</code> indica que quando um cluster Milvus é iniciado, um serviço etcd é iniciado automaticamente no cluster.</p>
