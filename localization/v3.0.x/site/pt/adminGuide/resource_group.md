...
<p>Todos os exemplos de código nesta página estão em PyMilvus 3.0.0. Atualize a sua instalação do PyMilvus antes de os executar.</p>
</div>
<ol>
...
<p>Depois de criar um grupo de recursos, poderá visualizá-lo na lista de grupos de recursos.</p>
