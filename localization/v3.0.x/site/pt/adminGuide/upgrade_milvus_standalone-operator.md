...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Atualização do Milvus Standalone com o Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar a implementação autónoma do Milvus da versão 2.5.x para a versão 2.6.15 utilizando o Milvus Operator.</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v2615" class="common-anchor-header">2.2 Atualização para a v2.6.15</h4><p>Quando a v2.5.16 estiver a funcionar com êxito, actualize para a v2.6.15:</p>
