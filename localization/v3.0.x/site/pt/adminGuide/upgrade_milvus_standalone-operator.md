...
<h1 id="Upgrade-Milvus-Standalone-with-Milvus-Operator" class="common-anchor-header">Atualizar o Milvus Standalone com o Milvus Operator<button data-href="#Upgrade-Milvus-Standalone-with-Milvus-Operator" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar a sua implementação do Milvus Standalone da versão v2.5.x para a v3.0-beta utilizando o Milvus Operator.</p>
...
<ul>
<li>Cluster do Kubernetes com o Milvus standalone implementado através do Milvus Operator</li>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Upgrade-your-Milvus-standalone" class="common-anchor-header">Passo 2: Atualizar o seu Milvus autónomo<button data-href="#Step-2-Upgrade-your-Milvus-standalone" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><h4 id="21-Upgrade-to-v2516" class="common-anchor-header">2.1 Atualização para a versão 2.5.16</h4><div class="alert-note">
<p>Ignore este passo se a sua implementação autónoma já estiver a executar a versão v2.5.16 ou superior.</p>
</div>
<p>Crie um ficheiro de configuração <code translate="no">milvusupgrade.yaml</code> para atualizar para a versão 2.5.16:</p>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h4 id="22-Upgrade-to-v30-beta" class="common-anchor-header">2.2 Atualização para a versão v3.0-beta</h4><p>Assim que a versão 2.5.16 estiver a funcionar corretamente, atualize para a versão 3.0-beta:</p>
