...
<h1 id="Upgrade-Milvus-Cluster-with-Helm-Chart" class="common-anchor-header">Atualizar o cluster Milvus com o Helm Chart<button data-href="#Upgrade-Milvus-Cluster-with-Helm-Chart" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Este guia descreve como atualizar o seu cluster Milvus da versão v2.5.x para a v3.0-beta utilizando o Helm Chart.</p>
...
<li><strong>Deve</strong> atualizar para a v2.5.16 ou posterior, com a funcionalidade « <code translate="no">mixCoordinator</code> » ativada, antes de atualizar para a v3.0-beta.</li>
</ul>
...
kubectl get pods
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Upgrade-to-v30-beta" class="common-anchor-header">Passo 3: Atualize para a versão v3.0-beta<button data-href="#Step-3-Upgrade-to-v30-beta" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Assim que a v2.5.16 estiver a funcionar corretamente com <code translate="no">mixCoordinator</code>, atualize para a v3.0-beta:</p>
<pre><code translate="no" class="language-bash">helm upgrade my-release zilliztech/milvus \
