...
A alteração de <code translate="no">mq.type</code> desta forma destina-se a uma instância <b>totalmente nova</b> (sem coleções ainda). Para alterar a fila de mensagens de uma instância que já contém dados, siga, em vez disso, o procedimento de mudança.
</div>
