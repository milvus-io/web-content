...
<h3 id="Allocate-resources-by-setting-configuration-file" class="common-anchor-header">Atribuir recursos definindo o ficheiro de configuração<button data-href="#Allocate-resources-by-setting-configuration-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Também pode atribuir recursos de CPU e memória especificando os parâmetros <code translate="no">resources.requests</code> e <code translate="no">resources.limits</code> no ficheiro <code translate="no">resources.yaml</code>.</p>
