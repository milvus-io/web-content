...
<h2 id="Deploy-a-Milvus-cluster-with-Kafka-using-Helm" class="common-anchor-header">Implementar um cluster Milvus com o Kafka utilizando o Helm<button data-href="#Deploy-a-Milvus-cluster-with-Kafka-using-Helm" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Para utilizar um serviço Kafka externo, desative o Pulsar integrado e ative o <code translate="no">externalKafka</code> numa substituição do ficheiro « <code translate="no">values.yaml</code> », e, em seguida, instale o Milvus com essa configuração:</p>
...
<li>Para a conectividade SASL/SSL, consulte <a href="/docs/pt/connect_kafka_ssl.md">«Ligar-se ao Kafka com SASL/SSL</a>».</li>
</ul>
