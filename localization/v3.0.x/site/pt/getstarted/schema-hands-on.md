...
<h3 id="Analyzing-Business-Needs" class="common-anchor-header">Analisar as necessidades da empresa<button data-href="#Analyzing-Business-Needs" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>A resposta eficaz às necessidades da empresa começa com a análise dos tipos de consultas que os utilizadores irão efetuar e com a determinação dos métodos de pesquisa mais adequados.</p>
<ul>
...
<li><p>Filtrar itens com base em metadados estruturados (por exemplo, data de publicação, etiquetas, classificações)</p></li>
...
<h3 id="Translates-Business-Requirements-into-a-Search-Data-Model" class="common-anchor-header">Traduzir os requisitos comerciais num modelo de dados de pesquisa<button data-href="#Translates-Business-Requirements-into-a-Search-Data-Model" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>O próximo passo é traduzir os seus requisitos comerciais num modelo de dados concreto, identificando os principais componentes da sua informação e os respectivos métodos de pesquisa:</p>
<ul>
...
<p>Agora, pode mapear o seu modelo de dados para um esquema de campos, incluindo vectores e quaisquer campos escalares auxiliares. Certifique-se de que cada campo está correlacionado com os atributos do seu modelo de dados, prestando especial atenção ao seu tipo de vetor (denso ou espesso) e à sua dimensão.</p>
<h3 id="Vector-Field" class="common-anchor-header">Campo vetorial<button data-href="#Vector-Field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Primary-Key" class="common-anchor-header">Chave primária<button data-href="#Primary-Key" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Function" class="common-anchor-header">Funções<button data-href="#Function" class="anchor-icon" translate="no">
    ...
    </button></h3><p>O Milvus permite-lhe definir funções incorporadas como parte do esquema para derivar automaticamente determinados campos. Por exemplo, pode adicionar uma função BM25 integrada que gera um vetor esparso a partir de um campo <code translate="no">VARCHAR</code> para suportar a pesquisa de texto integral. Estes campos derivados de funções simplificam o pré-processamento e asseguram que a coleção permanece autónoma e pronta a ser consultada.</p>
...
<table>
   ...
   <tr>
     ...
     <td><p><a href="/docs/pt/single-vector-search.md">Pesquisa básica de vectores</a></p></td>
     <td><p>N</p></td>
     <td><p>N</p></td>
     <td><p>N</p></td>
     <td><p>N</p></td>
   ...
   <tr>
     ...
     <td><p><a href="/docs/pt/full-text-search.md">Pesquisa de texto completo</a></p></td>
     <td><p>N</p></td>
     <td><p>N</p></td>
     <td><p>N</p></td>
     <td><p>saída</p></td>
...
<h3 id="Initialize-schema" class="common-anchor-header">Inicializar o esquema<button data-href="#Initialize-schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para começar, precisamos de criar um esquema vazio. Esta etapa estabelece uma estrutura básica para definir o modelo de dados.</p>
...
<h3 id="Add-fields" class="common-anchor-header">Adicionar campos<button data-href="#Add-fields" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Depois que o esquema é criado, a próxima etapa é especificar os campos que incluirão seus dados. Cada campo está associado aos seus respectivos tipos de dados e atributos.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<h3 id="Optional-Add-functions" class="common-anchor-header">(Opcional) Adicionar funções<button data-href="#Optional-Add-functions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para melhorar as capacidades de consulta de dados, podem ser incorporadas funções no esquema. Por exemplo, pode ser criada uma função para processar dados relacionados com campos específicos.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
