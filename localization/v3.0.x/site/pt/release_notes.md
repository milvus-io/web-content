...
<p>A «Coleção Externa» e o «Snapshot» são as principais novidades no que diz respeito ao «data lake». O mesmo kernel também está na base do Zilliz Lakebase, uma plataforma de dados nativa semântica construída sobre o Milvus 3.0.</p>
