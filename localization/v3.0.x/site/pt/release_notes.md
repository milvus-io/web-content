...
<p>Clique abaixo para participar do nosso webinar para obter mais detalhes sobre o Milvus 3.0 e AMA com os mantenedores do núcleo:</p>
...
<h4 id="Snapshot" class="common-anchor-header">Instantâneo</h4><p>O serviço e a descoberta em lote geralmente precisam da mesma coleção ao mesmo tempo. A avaliação do modelo A/B, a desduplicação em larga escala, a validação de backfill e a reversão de versão precisam de uma visão estável da coleção enquanto as gravações ainda estão sendo feitas.</p>
