...
<h3 id="Multiple-Metdata-Filters" class="common-anchor-header">Múltiplos filtros de metadados<button data-href="#Multiple-Metdata-Filters" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
