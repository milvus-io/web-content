...
<ul>
<li>Um <a href="/docs/pt/install_standalone-docker.md">servidor Milvus</a> em execução.</li>
...
<h2 id="Basic-recipe" class="common-anchor-header">Receita básica<button data-href="#Basic-recipe" class="anchor-icon" translate="no">
    ...
    </button></h2><p>O fluxo de trabalho básico para usar o Milvus para criar um índice de similaridade nos seus conjuntos de dados do FiftyOne e usá-lo para consultar seus dados é o seguinte:</p>
<ol>
