...
<h3 id="Insert-data" class="common-anchor-header">Inserir dados<button data-href="#Insert-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Preparamos um modelo de incorporação simples mas eficiente, <a href="https://huggingface.co/sentence-transformers/all-MiniLM-L6-v2">o all-MiniLM-L6-v2</a>, que pode converter texto em vectores de incorporação.</p>
...
<h3 id="Llama-31-model--llamacpp" class="common-anchor-header">Modelo Llama 3.1 &amp; llama.cpp<button data-href="#Llama-31-model--llamacpp" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>O <a href="https://huggingface.co/cognitivecomputations/dolphin-2.9.4-llama3.1-8b-gguf">modelo Llama-3.1-8B</a> da Meta pertence à família de modelos Llama 3.1 e é de uso livre para fins comerciais e de pesquisa. Antes de utilizar o modelo, visite o sítio <a href="https://llama.meta.com/llama-downloads/">Web</a> da Llama e preencha o formulário para pedir acesso.</p>
...
<h3 id="Download-and-build-llamacpp" class="common-anchor-header">Baixe e construa llama.cpp<button data-href="#Download-and-build-llamacpp" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Execute os seguintes comandos para instalar make, cmake, gcc, g++ e outras ferramentas essenciais necessárias para compilar llama.cpp a partir da fonte:</p>
...
<h3 id="Re-quantize-the-model-weights" class="common-anchor-header">Re-quantificar os pesos do modelo<button data-href="#Re-quantize-the-model-weights" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para re-quantizar, execute</p>
...
<h3 id="Start-the-LLM-Service" class="common-anchor-header">Iniciar o serviço LLM<button data-href="#Start-the-LLM-Service" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Pode utilizar o programa servidor llama.cpp e enviar pedidos através de uma API compatível com OpenAI. Isto permite-lhe desenvolver aplicações que interagem com o LLM várias vezes sem ter de o iniciar e parar repetidamente. Adicionalmente, pode aceder ao servidor a partir de outra máquina onde o LLM está alojado através da rede.</p>
...
<h2 id="Online-RAG" class="common-anchor-header">RAG online<button data-href="#Online-RAG" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="LLM-Client-and-Embedding-Model" class="common-anchor-header">Cliente LLM e modelo de incorporação<button data-href="#LLM-Client-and-Embedding-Model" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Inicializamos o cliente LLM e preparamos o modelo de incorporação.</p>
...
<h3 id="Retrieve-data-for-a-query" class="common-anchor-header">Recuperar dados para uma consulta<button data-href="#Retrieve-data-for-a-query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Use-LLM-to-get-a-RAG-response" class="common-anchor-header">Utilizar o LLM para obter uma resposta RAG<button data-href="#Use-LLM-to-get-a-RAG-response" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Converta os documentos recuperados num formato de cadeia de caracteres.</p>
