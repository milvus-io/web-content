...
<h2 id="Load-data" class="common-anchor-header">Carregar dados<button data-href="#Load-data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Crie uma instância de base de conhecimento do url PDF e carregue os dados para a instância. Utilizamos os dados em PDF de uma receita pública como exemplo.</p>
