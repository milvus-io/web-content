...
<p>Estes são utilizados para <code translate="no">SELECT</code> consultas:</p>
<ul>
...
<h3 id="Creating-connection" class="common-anchor-header">Criar uma ligação<button data-href="#Creating-connection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para utilizar este manipulador e ligar-se a um servidor Milvus no MindsDB, pode ser utilizada a seguinte sintaxe:</p>
...
<h3 id="Dropping-connection" class="common-anchor-header">Abandonar a ligação<button data-href="#Dropping-connection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para abandonar a ligação, utilize este comando</p>
<pre><code translate="no" class="language-sql"><span class="hljs-keyword">DROP</span> DATABASE milvus_datasource;
<button class="copy-code-btn"></button></code></pre>
<h3 id="Creating-tables" class="common-anchor-header">Criar tabelas<button data-href="#Creating-tables" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para inserir dados de uma tabela pré-existente, utilize <code translate="no">CREATE</code></p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Dropping-collections" class="common-anchor-header">Eliminar colecções<button data-href="#Dropping-collections" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>A eliminação de uma coleção não é suportada</p>
<h3 id="Querying-and-selecting" class="common-anchor-header">Consultar e selecionar<button data-href="#Querying-and-selecting" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para consultar a base de dados utilizando um vetor de pesquisa, pode utilizar <code translate="no">search_vector</code> na cláusula <code translate="no">WHERE</code> </p>
<p>Advertências:</p>
<ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Deleting-records" class="common-anchor-header">Eliminar registos<button data-href="#Deleting-records" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Pode eliminar registos utilizando <code translate="no">DELETE</code> tal como em SQL.</p>
<p>Advertências:</p>
<ul>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Inserting-records" class="common-anchor-header">Inserir registos<button data-href="#Inserting-records" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Também pode inserir linhas individuais desta forma:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Updating" class="common-anchor-header">Atualização<button data-href="#Updating" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>A atualização de registos não é suportada pela API do Milvus. Pode tentar utilizar a combinação de <code translate="no">DELETE</code> e <code translate="no">INSERT</code></p>
<hr>
<p>Para mais detalhes e exemplos, consulte a <a href="https://docs.mindsdb.com/what-is-mindsdb">documentação oficial do MindsDB</a>.</p>
