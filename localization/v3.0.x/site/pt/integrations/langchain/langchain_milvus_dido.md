...
<p>Antes de usar a função de incorporação de texto, é necessário configurar credenciais para incorporar provedores de serviços no servidor Milvus.</p>
...
<tr><td><strong>Gestão da chave da API</strong></td><td>Necessidade de gerir no lado do cliente</td><td>Gestão centralizada no lado do servidor, mais segura</td></tr>
