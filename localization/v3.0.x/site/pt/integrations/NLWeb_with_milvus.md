...
<h3 id="Installation" class="common-anchor-header">Instalação<button data-href="#Installation" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Clone o repositório e configure o seu ambiente:</p>
...
<h3 id="Configuring-Milvus" class="common-anchor-header">Configurar o Milvus<button data-href="#Configuring-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para utilizar <strong>o Milvus</strong>, actualize a sua configuração.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Loading-Data" class="common-anchor-header">Carregando dados<button data-href="#Loading-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Uma vez configurado, carregue o seu conteúdo utilizando feeds RSS.</p>
...
<h3 id="Running-the-Server" class="common-anchor-header">Executar o servidor<button data-href="#Running-the-Server" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para iniciar o NLWeb, a partir do diretório <code translate="no">code</code>, execute:</p>
