...
<p>Neste tutorial, iremos mostrar-lhe como construir um pipeline RAG (Retrieval-Augmented Generation) com o Milvus e o Gemini. Iremos utilizar o modelo Gemini para gerar respostas com base numa determinada consulta, complementadas com informações relevantes recuperadas do Milvus.</p>
...
<p>Se não especificarmos qualquer informação de campo, o Milvus criará automaticamente um campo « <code translate="no">id</code> » predefinido para a chave primária e um campo « <code translate="no">vector</code> » para armazenar os dados vetoriais. Um campo JSON reservado é utilizado para armazenar campos não definidos no esquema e os seus valores.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Pesquise a pergunta na coleção e recupere as três melhores correspondências semânticas.</p>
