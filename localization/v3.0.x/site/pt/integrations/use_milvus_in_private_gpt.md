...
<p>Neste tutorial, vamos mostrar-lhe como utilizar o Milvus como base de dados de vectores backend para o PrivateGPT.</p>
...
<h2 id="Base-requirements-to-run-PrivateGPT" class="common-anchor-header">Requisitos básicos para executar o PrivateGPT<button data-href="#Base-requirements-to-run-PrivateGPT" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="1-Clone-the-PrivateGPT-Repository" class="common-anchor-header">1. Clonar o repositório do PrivateGPT<button data-href="#1-Clone-the-PrivateGPT-Repository" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Clone o repositório e navegue até ele:</p>
...
<h3 id="2-Install-Poetry" class="common-anchor-header">2. Instalar o Poetry<button data-href="#2-Install-Poetry" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Instale <a href="https://python-poetry.org/docs/#installing-with-the-official-installer">o Poetry</a> para gerenciamento de dependências: Siga as instruções no site oficial do Poetry para instalá-lo.</p>
<h3 id="3-Optional-Install-make" class="common-anchor-header">3. (Opcional) Instalar o make<button data-href="#3-Optional-Install-make" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para executar vários scripts, é necessário instalar o make.</p>
