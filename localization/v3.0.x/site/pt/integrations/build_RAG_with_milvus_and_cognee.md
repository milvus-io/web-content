...
<h3 id="Build-RAG-with-Milvus-and-Cognee" class="common-anchor-header">Criar RAG com Milvus e Cognee<button data-href="#Build-RAG-with-Milvus-and-Cognee" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><a href="https://www.cognee.ai">A Cognee</a> é uma plataforma que dá prioridade ao programador e que simplifica o desenvolvimento de aplicações de IA com pipelines ECL (Extract, Cognify, Load) modulares e dimensionáveis. Ao integrar-se perfeitamente com o Milvus, o Cognee permite a ligação e a recuperação eficientes de conversas, documentos e transcrições, reduzindo as alucinações e optimizando os custos operacionais.</p>
...
<p>Por defeito, neste exemplo, utiliza o OpenAI como LLM. Deve preparar a <a href="https://platform.openai.com/docs/quickstart">chave api</a> e defini-la na função config <code translate="no">set_llm_api_key()</code>.</p>
<p>Para configurar o Milvus como base de dados vetorial, defina <code translate="no">VECTOR_DB_PROVIDER</code> para <code translate="no">milvus</code> e especifique <code translate="no">VECTOR_DB_URL</code> e <code translate="no">VECTOR_DB_KEY</code>. Como estamos a utilizar o Milvus Lite para armazenar dados nesta demonstração, só é necessário fornecer <code translate="no">VECTOR_DB_URL</code>.</p>
...
<h3 id="Prepare-the-data" class="common-anchor-header">Preparar os dados<button data-href="#Prepare-the-data" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Utilizamos as páginas de FAQ da <a href="https://github.com/milvus-io/milvus-docs/releases/download/v2.4.6-preview/milvus_docs_2.4.x_en.zip">Documentação do Milvus 2.4.x</a> como conhecimento privado no nosso RAG, que é uma boa fonte de dados para um pipeline RAG simples.</p>
...
<h2 id="Build-RAG" class="common-anchor-header">Construir o RAG<button data-href="#Build-RAG" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Resetting-Cognee-Data" class="common-anchor-header">Repor os dados do Cognee<button data-href="#Resetting-Cognee-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Adding-Data-and-Cognifying" class="common-anchor-header">Adicionar dados e reconhecer<button data-href="#Adding-Data-and-Cognifying" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Querying-for-Summaries" class="common-anchor-header">Consulta de resumos<button data-href="#Querying-for-Summaries" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Agora que os dados foram processados, vamos consultar o gráfico de conhecimento.</p>
...
<h3 id="Querying-for-Chunks" class="common-anchor-header">Consultar por partes<button data-href="#Querying-for-Chunks" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Reset-Cognee" class="common-anchor-header">Redefinir o Cognee<button data-href="#Reset-Cognee" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-keyword">await</span> cognee.prune.prune_system(metadata=<span class="hljs-literal">True</span>)
<button class="copy-code-btn"></button></code></pre>
<h3 id="Adding-the-Focused-Dataset" class="common-anchor-header">Adicionando o conjunto de dados focado<button data-href="#Adding-the-Focused-Dataset" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Aqui, um conjunto de dados menor com apenas uma linha de texto é adicionado e processado para garantir um gráfico de conhecimento focado e facilmente interpretável.</p>
...
<span class="hljs-keyword">await</span> cognee.cognify()
<button class="copy-code-btn"></button></code></pre>
<h3 id="Querying-for-Insights" class="common-anchor-header">Consulta de informações<button data-href="#Querying-for-Insights" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Ao concentrarmo-nos neste conjunto de dados mais pequeno, podemos agora analisar claramente as relações e a estrutura do gráfico de conhecimento.</p>
