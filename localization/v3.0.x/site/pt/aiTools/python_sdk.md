...
<h1 id="Python-SDK" class="common-anchor-header">Python SDK<button data-href="#Python-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Regras para escrever código Milvus Python correto utilizando a interface MilvusClient, incluindo migração ORM, padrões de ligação e operações comuns. Copie o prompt completo abaixo na sua ferramenta de IA para aplicar estas regras automaticamente. Para obter uma visão geral de todos os prompts, consulte <a href="/docs/pt/milvus_for_agents.md">Prompts de IA</a>.</p>
