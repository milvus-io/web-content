...
title: 'Sugestão: Padrões de pesquisa de Milvus'
summary: >-
  Regras para os assistentes de codificação de IA implementarem a pesquisa, a
  pesquisa híbrida e a pesquisa de texto integral no Milvus.
---
<h1 id="Search-Patterns" class="common-anchor-header">Padrões de pesquisa<button data-href="#Search-Patterns" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Regras para implementar a pesquisa por semelhança, a pesquisa híbrida, a pesquisa filtrada e a pesquisa de texto integral no Milvus, incluindo as restrições AnnSearchRequest e a utilização do classificador. Copie o prompt completo abaixo na sua ferramenta de IA para aplicar essas regras automaticamente. Para obter uma visão geral de todos os avisos, consulte <a href="/docs/pt/milvus_for_agents.md">Avisos de IA</a>.</p>
