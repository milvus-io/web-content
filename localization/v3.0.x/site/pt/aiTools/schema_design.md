...
summary: >-
  Regras para os assistentes de programação de IA conceberem esquemas de coleção
  Milvus corretos.
---
<h1 id="Schema-Design" class="common-anchor-header">Conceção de esquemas<button data-href="#Schema-Design" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Regras e orientações para a conceção de esquemas de recolha Milvus corretos, incluindo tipos de campos, chaves primárias, configuração BM25 e restrições de imutabilidade do esquema. Copie o prompt completo abaixo para a sua ferramenta de IA para aplicar estas regras automaticamente. Para uma visão geral de todos os prompts, consulte <a href="/docs/pt/milvus_for_agents.md">Prompts de IA</a>.</p>
