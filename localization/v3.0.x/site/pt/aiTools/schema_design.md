---
id: schema_design.md
title: 'Tema: Concepção do esquema do Milvus'
summary: >-
  Regras para que os assistentes de programação de IA concebam esquemas de
  recolha corretos no Milvus.
---
<h1 id="Schema-Design" class="common-anchor-header">Conceção de esquemas<button data-href="#Schema-Design" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Regras e orientações para a conceção de esquemas de recolha Milvus corretos, incluindo tipos de campos, chaves primárias, configuração do BM25 e restrições de imutabilidade do esquema. Copie o prompt completo abaixo para a sua ferramenta de IA para aplicar estas regras automaticamente. Para uma visão geral de todos os prompts, consulte <a href="/docs/pt/milvus_for_agents.md">Prompts de IA</a>.</p>
<h2 id="How-to-use-this-prompt" class="common-anchor-header">Como utilizar este prompt<button data-href="#How-to-use-this-prompt" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><strong>Copie</strong> o prompt completo da secção <a href="#full-prompt">«Prompt completo</a> » abaixo.</li>
<li><strong>Guarde</strong> -o no local indicado pela sua ferramenta de IA — consulte a <a href="/docs/pt/milvus_for_agents.md">tabela de ambientes</a> para obter detalhes sobre a localização.</li>
<li>O seu assistente de IA aplicará automaticamente estas regras ao gerar ou rever código do Milvus.</li>
</ol>
<p>Para utilizadores <strong>do Cursor</strong>: copie o prompt da secção <a href="#full-prompt">«Prompt completo»</a> e guarde-o em « <code translate="no">.cursor/rules/</code> » no seu projeto.</p>
