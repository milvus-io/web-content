...
<li><strong>Guarde</strong> -o no local indicado pela sua ferramenta de IA — consulte a <a href="/docs/pt/milvus_for_agents.md">tabela de ambiente</a> para obter detalhes sobre a localização.</li>
