...
order: 5
summary: >-
  Milvus suporta o modelo de reranker Voyage através da classe
  `VoyageRerankFunction`. Esta funcionalidade permite-lhe classificar a
  relevância dos pares consulta-documento de forma eficaz.
title: Viagem de Rerankers
---
<h1 id="Voyage" class="common-anchor-header">Voyage<button data-href="#Voyage" class="anchor-icon" translate="no">
    ...
    </button></h1><p>O Milvus suporta <a href="https://github.com/FlagOpen/FlagEmbedding/tree/master/FlagEmbedding/reranker">o modelo de reranker Voyage</a> através da classe <code translate="no">VoyageRerankFunction</code>. Esta funcionalidade permite-lhe classificar a relevância dos pares consulta-documento de forma eficaz.</p>
<p>Para utilizar esta funcionalidade, instale as dependências necessárias:</p>
<pre><code translate="no" class="language-bash">pip install --upgrade pymilvus
pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>Em seguida, instancie a classe <code translate="no">VoyageRerankFunction</code>:</p>
...
<p>O nome do modelo Voyage a ser usado para codificação. Se deixar este parâmetro não especificado, será utilizado <code translate="no">rerank-lite-1</code>. Para obter uma lista dos modelos disponíveis, consulte <a href="https://docs.voyageai.com/docs/reranker">Rerankers</a>.</p></li>
