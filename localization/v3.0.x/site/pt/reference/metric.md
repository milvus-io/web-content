...
<h3 id="Euclidean-distance-L2" class="common-anchor-header">Distância euclidiana (L2)<button data-href="#Euclidean-distance-L2" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Essencialmente, a distância euclidiana mede o comprimento de um segmento que liga 2 pontos.</p>
...
<h3 id="Inner-product-IP" class="common-anchor-header">Produto interno (IP)<button data-href="#Inner-product-IP" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>A distância IP entre duas incorporações vectoriais é definida da seguinte forma</p>
<p>
...
<h3 id="Cosine-Similarity" class="common-anchor-header">Similaridade de cosseno<button data-href="#Cosine-Similarity" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>A semelhança de cosseno utiliza o cosseno do ângulo entre dois conjuntos de vectores para medir a sua semelhança. Pode pensar nos dois conjuntos de vectores como dois segmentos de linha que começam na mesma origem ([0,0,...]) mas apontam em direcções diferentes.</p>
...
<h3 id="Jaccard-distance" class="common-anchor-header">Distância de Jaccard<button data-href="#Jaccard-distance" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>O coeficiente de semelhança de Jaccard mede a semelhança entre dois conjuntos de amostras e é definido como a cardinalidade da intersecção dos conjuntos definidos dividida pela cardinalidade da união dos mesmos. Só pode ser aplicado a conjuntos de amostras finitos.</p>
<p>
...
<h3 id="Hamming-distance" class="common-anchor-header">Distância de Hamming<button data-href="#Hamming-distance" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>A distância de Hamming mede cadeias de dados binárias. A distância entre duas cadeias de dados de igual comprimento é o número de posições de bits em que os bits são diferentes.</p>
...
<h3 id="Structural-Similarity" class="common-anchor-header">Similaridade Estrutural<button data-href="#Structural-Similarity" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Quando uma estrutura química ocorre como parte de uma estrutura química maior, a primeira é chamada de subestrutura e a segunda é chamada de superestrutura. Por exemplo, o etanol é uma subestrutura do ácido acético, e o ácido acético é uma superestrutura do etanol.</p>
