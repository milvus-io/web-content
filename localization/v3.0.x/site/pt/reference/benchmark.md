...
<h3 id="Hardware-environment" class="common-anchor-header">Ambiente de hardware<button data-href="#Hardware-environment" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Software-environment" class="common-anchor-header">Ambiente de software<button data-href="#Software-environment" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Deployment-scheme" class="common-anchor-header">Esquema de implantação<button data-href="#Deployment-scheme" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Data-sets" class="common-anchor-header">Conjuntos de dados<button data-href="#Data-sets" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>O teste usa o conjunto de dados de código aberto SIFT (128 dimensões) do <a href="https://github.com/erikbern/ann-benchmarks/#data-sets">ANN-Benchmarks</a>.</p>
...
<h3 id="Milvus-220-Scale-up" class="common-anchor-header">Milvus 2.2.0 Aumento de escala<button data-href="#Milvus-220-Scale-up" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Expanda os núcleos de CPU num Querynode para verificar a capacidade de aumento de escala.</p>
<p><details>
...
<p>
   ...
   </span> <span class="img-wrapper"> <span>Desempenho da pesquisa por núcleos de CPU Querynode</span> </span></p>
<h3 id="Milvus-220-Scale-out" class="common-anchor-header">Milvus 2.2.0 Expansão<button data-href="#Milvus-220-Scale-out" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Expanda mais réplicas com mais Querynodes para verificar a capacidade de expansão.</p>
<div class="alert note">
