...
summary: Saiba como configurar o gpu para o Milvus.
---
<h1 id="gpu-related-Configurations" class="common-anchor-header">Configurações relacionadas à gpu<button data-href="#gpu-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
