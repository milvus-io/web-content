...
<li><p>Milvus Capture Data Change (CDC) O Milvus CDC pode replicar as alterações de dados de um cluster Milvus para outro para recuperação de desastres primário-standby. Para mais detalhes, consulte <a href="/docs/pt/milvus_cdc_overview.md">Milvus CDC</a>.</p></li>
