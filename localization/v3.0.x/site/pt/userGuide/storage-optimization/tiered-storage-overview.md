...
<div class="alert note">
<p>Esse modelo define os padrões no nível do cluster. É possível substituir as configurações de warmup para coleções específicas ou campos/índices individuais usando o SDK. Consulte <a href="/docs/pt/warm-up.md">Aquecimento</a> para obter detalhes.</p>
</div>
