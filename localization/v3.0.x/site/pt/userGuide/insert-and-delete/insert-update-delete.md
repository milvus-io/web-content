...
<p>Ao inserir uma Entidade numa Coleção, a Entidade a inserir só pode ser adicionada com sucesso se contiver todos os campos definidos no Esquema. A Entidade inserida entrará numa Partição denominada <strong>_default</strong> pela ordem de inserção. Desde que exista uma determinada Partição, também é possível inserir Entidades nessa Partição, especificando o nome da Partição no pedido de inserção.</p>
