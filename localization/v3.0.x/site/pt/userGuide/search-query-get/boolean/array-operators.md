...
<li><p><a href="/docs/pt/array-operators.md#ARRAYCONTAINSALL"><code translate="no">ARRAY_CONTAINS_ALL(identifier, expr)</code></a>Operador ARRAY: garante que todos os elementos da lista especificada estão presentes no campo da matriz.</p></li>
