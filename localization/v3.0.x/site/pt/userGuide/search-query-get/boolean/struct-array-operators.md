...
<tr><td><code translate="no">MATCH_*</code></td><td>Selecionar entidades com base no número de elementos da estrutura que satisfazem um predicado escalar.</td><td>Filtragem ao nível da linha. Estes operadores não devolvem, por si só, deslocamentos de elementos.</td></tr>
</tbody>
</table>
...
<tr><td>Retornar apenas entidades em que, no mínimo, no máximo ou exatamente <code translate="no">N</code> elementos Struct satisfaçam um predicado.</td><td><code translate="no">MATCH_LEAST</code>, <code translate="no">MATCH_MOST</code> ou <code translate="no">MATCH_EXACT</code></td></tr>
</tbody>
</table>
...
<tr><td><code translate="no">MATCH_MOST(field, predicate, threshold=N)</code></td><td>No máximo, <code translate="no">N</code> elementos da estrutura satisfazem o predicado.</td></tr>
