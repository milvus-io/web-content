...
title: Consulta
summary: >-
  Utilize Query, Get e QueryIterator para obter entidades e filtrar metadados em
  Milvus.
---
...
<h3 id="Sort-Query-Results--Milvus-30x" class="common-anchor-header">Ordenar resultados da consulta<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 3.0.x</span><button data-href="#Sort-Query-Results--Milvus-30x" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Por predefinição, a Consulta devolve os resultados numa ordem não especificada. Use o parâmetro <code translate="no">order_by</code> para ordenar os resultados por um ou mais campos escalares. Ao usar <code translate="no">order_by</code>, observe que:</p>
<ul>
...
<h2 id="Use-QueryIterator" class="common-anchor-header">Utilizar o QueryIterator<button data-href="#Use-QueryIterator" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Quando precisar de encontrar entidades por condições de filtragem personalizadas através de consultas paginadas, crie um <strong>QueryIterator</strong> e utilize o seu método <strong>next()</strong> para iterar sobre todas as entidades para encontrar as que satisfazem as condições de filtragem. Os exemplos de código a seguir assumem que há três campos denominados <code translate="no">id</code>, <code translate="no">vector</code> e <code translate="no">color</code> e retornam todas as entidades que possuem um valor <code translate="no">color</code> começando com <code translate="no">red</code>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#go">Go</a> <a href="#javascript">NodeJS</a> <a href="#bash">cURL</a></div>
