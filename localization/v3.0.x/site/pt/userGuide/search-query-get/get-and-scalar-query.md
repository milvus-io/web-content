...
<h2 id="Use-Query" class="common-anchor-header">Utilizar a consulta<button data-href="#Use-Query" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Quando precisar de encontrar entidades através de condições de filtragem personalizadas, utilize o método <strong>Query</strong>. Os exemplos de código seguintes partem do princípio de que existem três campos denominados <code translate="no">id</code>, <code translate="no">vector</code> e <code translate="no">color</code> e devolvem o número especificado de entidades que contêm um valor <code translate="no">color</code> que começa por <code translate="no">red</code>.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
...
<pre><code translate="no" class="language-bash"><span class="hljs-comment"># restful</span>
<button class="copy-code-btn"></button></code></pre>
<p>Pode solicitar várias expressões de agregação numa única chamada. O exemplo seguinte agrupa por « <code translate="no">color</code> » e devolve a contagem de entidades, o preço médio e a classificação máxima para cada grupo:</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
...
<pre><code translate="no" class="language-bash"><span class="hljs-comment"># restful</span>
<button class="copy-code-btn"></button></code></pre>
<p>Também pode combinar ` <code translate="no">group_by_fields</code> ` com ` <code translate="no">limit</code> ` para limitar o número de grupos devolvidos. Isto é útil quando um campo tem alta cardinalidade e apenas necessita de uma amostra de grupos:</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
...
<h2 id="Queries-in-Partitions" class="common-anchor-header">Consultas em partições<button data-href="#Queries-in-Partitions" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Também é possível efetuar consultas numa ou em várias partições, incluindo os nomes das partições na solicitação Get, Query ou QueryIterator. Os exemplos de código seguintes pressupõem que existe uma partição denominada <strong>PartitionA</strong> na coleção.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#go">   Go</a>
