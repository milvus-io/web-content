...
<h3 id="Step-1-Create-a-collection" class="common-anchor-header">Passo 1: Criar uma coleção<button data-href="#Step-1-Create-a-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Insert-randomly-generated-entities" class="common-anchor-header">Passo 2: Inserir entidades geradas aleatoriamente<button data-href="#Step-2-Insert-randomly-generated-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-3-Create-partitions-and-insert-more-entities" class="common-anchor-header">Passo 3: Criar partições e inserir mais entidades<button data-href="#Step-3-Create-partitions-and-insert-more-entities" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<span class="hljs-comment">// </span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Get-entities-from-partitions" class="common-anchor-header">Obter entidades de partições<button data-href="#Get-entities-from-partitions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Também pode obter entidades de partições específicas.</p>
<div class="multipleCode">
...
<h2 id="Reference-on-scalar-filters" class="common-anchor-header">Referência sobre filtros escalares<button data-href="#Reference-on-scalar-filters" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Uma <strong>expressão booleana</strong> é sempre <strong>uma string composta por nomes de campos unidos por operadores</strong>. Nesta secção, aprenderá mais sobre os operadores básicos.</p>
<table>
<thead>
...
<h3 id="Advanced-operators" class="common-anchor-header">Operadores avançados<button data-href="#Advanced-operators" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
