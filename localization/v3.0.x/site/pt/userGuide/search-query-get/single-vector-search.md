...
<h3 id="Single-vector-search" class="common-anchor-header">Pesquisa de vetor único<button data-href="#Single-vector-search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>A pesquisa de vetor único é a forma mais simples de <code translate="no">search</code> operações em Milvus, concebida para encontrar os vectores mais semelhantes a um determinado vetor de consulta.</p>
...
<h3 id="Bulk-vector-search" class="common-anchor-header">Pesquisa de vetor em massa<button data-href="#Bulk-vector-search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Partition-search" class="common-anchor-header">Pesquisa por partição<button data-href="#Partition-search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Search-with-output-fields" class="common-anchor-header">Pesquisa com campos de saída<button data-href="#Search-with-output-fields" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>A pesquisa com campos de saída permite-lhe especificar quais os atributos ou campos dos vectores correspondentes que devem ser incluídos nos resultados da pesquisa.</p>
...
<h3 id="Use-the-like-operator" class="common-anchor-header">Usar o operador <code translate="no">like</code> <button data-href="#Use-the-like-operator" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>O operador <code translate="no">like</code> melhora as pesquisas de cadeia de caracteres avaliando padrões, incluindo prefixos, infixos e sufixos:</p>
<ul>
...
<h3 id="Special-characters-in-search-strings" class="common-anchor-header">Caracteres especiais em cadeias de pesquisa<button data-href="#Special-characters-in-search-strings" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<tr><td><code translate="no">COSINE</code></td><td>Um valor de cosseno maior indica uma maior semelhança.</td><td>Para excluir os vectores mais próximos dos resultados, certifique-se de que:<br/> <code translate="no">radius</code> &lt; distância &lt;= <code translate="no">range_filter</code></td></tr>
<tr><td><code translate="no">JACCARD</code></td><td>As distâncias de Jaccard mais pequenas indicam uma maior semelhança.</td><td>Para excluir os vectores mais próximos dos resultados, certifique-se de que:<br/> <code translate="no">range_filter</code> &lt;= distância &lt; <code translate="no">radius</code></td></tr>
<tr><td><code translate="no">HAMMING</code></td><td>As distâncias de Hamming mais pequenas indicam uma maior semelhança.</td><td>Para excluir os vectores mais próximos dos resultados, certifique-se de que:<br/> <code translate="no">range_filter</code> &lt;= distância &lt; <code translate="no">radius</code></td></tr>
</tbody>
</table>
<p>Para saber mais sobre os tipos de métricas de distância, consulte <a href="/docs/pt/metric.md">Métricas de similaridade</a>.</p>
<h2 id="Grouping-search" class="common-anchor-header">Agrupamento de pesquisa<button data-href="#Grouping-search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
