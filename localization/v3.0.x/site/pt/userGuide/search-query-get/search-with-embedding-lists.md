...
title: 'Pesquisa com EmbeddingLists: ColBERT e ColPali'
summary: >-
  Este tutorial mostra como criar sistemas de recuperação ao estilo ColBERT e
  ColPali com pesquisa EmbeddingList em subcampos vetoriais StructArray no
  Milvus. Utilize-o quando a sua consulta e os dados armazenados forem ambos
  representados como listas de vetores e pretender uma recuperação com interação
  tardia ao nível da entidade, utilizando métricas MAX_SIM*.
---
<h1 id="Search-with-EmbeddingLists-ColBERT-and-ColPali" class="common-anchor-header">Pesquisa com EmbeddingLists: ColBERT e ColPali<button data-href="#Search-with-EmbeddingLists-ColBERT-and-ColPali" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Este tutorial mostra como criar sistemas de recuperação ao estilo ColBERT e ColPali com pesquisa EmbeddingList em subcampos vetoriais StructArray no Milvus. Utilize-o quando a sua consulta e os dados armazenados forem ambos representados como listas de vetores e pretender uma recuperação com interação tardia ao nível da entidade, com métricas de « <code translate="no">MAX_SIM*</code> ».</p>
<p>Para conhecer os conceitos básicos do StructArray subjacentes a este tutorial, consulte <a href="/docs/pt/create-structarray-field.md">«Criar um campo StructArray</a>», <a href="/docs/pt/index-structarray-fields.md">«Indexar campos StructArray</a>» e <a href="/docs/pt/basic-vector-search-with-structarray.md">«Pesquisa vetorial básica com StructArray</a>». Este tutorial centra-se nos fluxos de trabalho do ColBERT e do ColPali, em vez da sintaxe geral do StructArray.</p>
<h2 id="Overview" class="common-anchor-header">Visão geral<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Para criar um sistema de recuperação de texto, poderá ser necessário dividir os documentos em blocos e armazenar cada bloco, juntamente com as suas incorporações, como uma entidade numa base de dados de vetores, a fim de garantir precisão e exatidão, especialmente no caso de documentos longos, em que as incorporações de texto completo poderiam diluir a especificidade semântica ou exceder os limites de entrada do modelo.</p>
<p>No entanto, o armazenamento de dados em fragmentos conduz a resultados de pesquisa fragmentados, o que significa que a recuperação identifica inicialmente <em>segmentos</em> relevantes, em vez de <em>documentos</em> coesos. Para resolver esta questão, deve realizar um processamento adicional após a pesquisa.</p>
<p>O ColBERT (arXiv: <a href="https://arxiv.org/abs/2004.12832">2004.12832</a>) é um sistema de recuperação texto-texto que oferece uma pesquisa eficiente e eficaz de passagens através de interações contextuais tardias sobre o BERT. Permite a codificação independente, por token, de consultas e documentos e calcula a sua semelhança.</p>
...
<h3 id="Late-interaction" class="common-anchor-header">Interação tardia<button data-href="#Late-interaction" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Assim que a vetorização estiver concluída, a lista de incorporações da consulta é comparada com a lista de incorporações de cada documento, token a token, para determinar a pontuação final de similaridade.</p>
<p>Conforme ilustrado no diagrama acima, a consulta contém dois tokens, nomeadamente <code translate="no">machine</code> e <code translate="no">learning</code>, e o documento na janela tem quatro tokens: <code translate="no">neural</code>, <code translate="no">network</code>, <code translate="no">python</code> e <code translate="no">tutorial</code>. Assim que estes tokens são vetorizados, as representações vetoriais de cada token da consulta são comparadas com as do documento para obter uma lista de pontuações de similaridade. Em seguida, as pontuações mais elevadas de cada lista de pontuações são somadas para produzir a pontuação final. O processo de determinação da pontuação final de um documento é conhecido como «similaridade máxima» (<strong>MAX_SIM</strong>). Para mais detalhes sobre a similaridade máxima, consulte «Similaridade máxima».</p>
...
<p>Em vez disso, pode dividir os documentos em segmentos de qualquer tamanho adequado, incorporar cada segmento para criar uma lista de incorporações e armazenar o documento juntamente com os seus segmentos incorporados numa entidade.</p>
</div>
<h3 id="ColPali-extension" class="common-anchor-header">Extensão ColPali<button data-href="#ColPali-extension" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Baseado no ColBERT, o ColPali (arXiv: <a href="https://arxiv.org/abs/2407.01449?spm=a2ty_o01.29997173.0.0.31c4c9217HFv28&amp;file=2407.01449">2407.01449</a>) propõe uma abordagem inovadora para a recuperação de documentos visualmente ricos que tira partido dos Modelos de Visão-Linguagem (VLMs). Durante a ingestão de dados, cada página do documento é convertida numa imagem de alta resolução e, em seguida, dividida em fragmentos, em vez de ser tokenizada. Por exemplo, uma imagem de uma página de documento com 448 x 448 píxeis pode produzir 1 024 fragmentos, cada um com 14 x 14 píxeis.</p>
<p>Este método preserva informações não textuais, tais como o layout do documento, imagens e estruturas de tabelas, que se perdem quando se utilizam sistemas de recuperação apenas de texto.</p>
<p>O VLM utilizado no ColPali denomina-se PaliGemma (arXiv: <a href="https://arxiv.org/html/2407.07726v2#S1">2407.07726</a>), que compreende um codificador de imagens (<strong>SigLIP-400M</strong>), um modelo de linguagem exclusivamente descodificador (<strong>Gemma2-2B</strong>), e uma camada linear que projeta a saída do codificador de imagens para o espaço vetorial do modelo de linguagem, conforme ilustrado no diagrama acima.</p>
<p>Durante a ingestão de dados, uma página de documento, representada como uma imagem em bruto, é dividida em vários fragmentos visuais, cada um dos quais é incorporado para gerar uma lista de incorporações vetoriais. Em seguida, estas são projetadas no espaço vetorial do modelo de linguagem para obter a lista final de representações, como em <span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mo> d→Ed=</mo><mo stretchy="false">[</mo><msub><mrow><mn>ed1</mn></mrow></msub><mo separator="true">,</mo><msub><mrow><mn>ed2</mn></mrow></msub><mo separator="true">,</mo><mo>…</mo><mo separator="true">,</mo><msub><mrow><mi>edn</mi></mrow></msub><mo stretchy="false">]</mo></mrow><annotation encoding="application/x-tex">∈Rn×dd \rightarrow E_d = [e_{d1}, e_{d2}, \dots, e_{dn}] ∈ \R^{n×d}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6944em;"></span><span class="mrel"></span><span class="mord mathnormal">d</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">→</span></span></span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="base"><span class="mord"><span class="mord mathnormal" style="margin-right:0.05764em;"></span></span></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8333em;vertical-align:-0.15em;"></span><span class="mord"><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.3361em;"><span style="top:-2.55em;margin-left:-0.0576em;margin-right:0.05em;"><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight"> </span></span></span></span></span></span></span></span></span></span></span> E <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"></span></span></span><span class="pstrut" style="height:2.7em;"></span><span class="mrel"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mord"><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist-s">d​</span></span></span></span></span></span></span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span><span class="mrel"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel"> </span></span></span></span>= <span class="katex"><span class="katex-html" aria-hidden="true"></span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="base"><span class="mopen"></span></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mopen"> </span></span></span></span>[ <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mord"><span class="mord mathnormal">e</span></span></span></span></span><span class="pstrut" style="height:2.7em;"></span><span class="mpunct"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mord"><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist-s">d1​</span></span></span></span></span></span></span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span><span class="mpunct"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mpunct">,</span><span class="mspace" style="margin-right:0.1667em;"></span><span class="mord"><span class="mord mathnormal">e</span></span></span></span></span><span class="pstrut" style="height:2.7em;"></span><span class="mpunct"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mord"><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist-s">d2​</span></span></span></span></span></span></span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span><span class="mpunct"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mpunct">,</span><span class="mspace" style="margin-right:0.1667em;"></span><span class="mpunct"></span><span class="minner">…</span><span class="mspace" style="margin-right:0.1667em;"></span><span class="mpunct">,</span><span class="mspace" style="margin-right:0.1667em;"></span><span class="mord"><span class="mord mathnormal">e</span></span></span></span></span><span class="pstrut" style="height:2.7em;"></span><span class="mclose"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mord"><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist-s">dn​</span></span></span></span></span></span></span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span><span class="mclose"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mclose">]</span></span></span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="base"><span class="mord"><span class="mord mathbb"></span></span></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mrel">∈</span></span></span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="base"><span class="mord"><span class="mord mathbb"></span></span></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8491em;"></span><span class="mord"><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.8491em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mathnormal mtight"> </span></span></span></span></span></span></span></span></span></span></span></span> R <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mord"><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.8491em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mathnormal mtight"></span><span class="mord mathnormal mtight">n×d</span></span></span></span></span></span></span></span></span></span></span></span>. Quando chega uma consulta, esta é tokenizada e cada token é incorporado para gerar uma lista de incorporações vetoriais, como em <span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mo> q→E_q=</mo><mo stretchy="false">[</mo><msub><mrow><mn>e_{q1}</mn></mrow></msub><mo separator="true">,</mo><msub><mrow><mn>e_{q2</mn></mrow></msub><mo separator="true">},</mo><mo separator="true">…</mo><msub><mrow><mi>e_{qm}</mi></mrow></msub><mo stretchy="false">]</mo></mrow><annotation encoding="application/x-tex">∈R^{m×d} q \rightarrow E_q = [e_{q1}, e_{q2}, \dots, e_{qm}] ∈ \R^{m×d}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.625em;vertical-align:-0.1944em;"></span><span class="mord mathnormal" style="margin-right:0.03588em;">q</span></span></span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="base"><span class="mord"><span class="mord mathnormal" style="margin-right:0.05764em;"></span></span></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mrel">→</span></span></span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="base"><span class="mord"><span class="mord mathnormal" style="margin-right:0.05764em;"></span></span></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.9694em;vertical-align:-0.2861em;"></span><span class="mord"><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.1514em;"><span style="top:-2.55em;margin-left:-0.0576em;margin-right:0.05em;"><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight" style="margin-right:0.03588em;"> </span></span></span></span></span></span></span></span></span></span></span> E <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"></span></span></span><span class="pstrut" style="height:2.7em;"></span><span class="mrel"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mord"><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist-s">q​</span></span></span></span></span></span></span></span><span class="vlist-r"><span class="vlist" style="height:0.2861em;"><span></span></span></span><span class="mrel"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel"> =</span></span></span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="base"><span class="mopen"></span></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1.0361em;vertical-align:-0.2861em;"></span><span class="mopen"> </span></span> [<span class="base"><span class="mord"><span class="mord mathnormal">e</span></span></span></span></span><span class="pstrut" style="height:2.7em;"></span><span class="mpunct"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mord"><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist-s">q1​</span></span></span></span></span></span></span></span><span class="vlist-r"><span class="vlist" style="height:0.2861em;"><span></span></span></span><span class="mpunct"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mpunct">,</span><span class="mspace" style="margin-right:0.1667em;"></span><span class="mord"><span class="mord mathnormal">e</span></span></span></span></span><span class="pstrut" style="height:2.7em;"></span><span class="mpunct"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mord"><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist-s">q2​</span></span></span></span></span></span></span></span><span class="vlist-r"><span class="vlist" style="height:0.2861em;"><span></span></span></span><span class="mpunct"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mpunct">,</span><span class="mspace" style="margin-right:0.1667em;"></span><span class="mpunct"></span><span class="minner">…</span><span class="mspace" style="margin-right:0.1667em;"></span><span class="mpunct">,</span><span class="mspace" style="margin-right:0.1667em;"></span><span class="mord"><span class="mord mathnormal">e</span></span></span></span></span><span class="pstrut" style="height:2.7em;"></span><span class="mclose"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mord"><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist-s">qm​</span></span></span></span></span></span></span></span><span class="vlist-r"><span class="vlist" style="height:0.2861em;"><span></span></span></span><span class="mclose"></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mclose">]</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">∈</span></span></span></span><span class="mspace" style="margin-right:0.2778em;"></span><span class="base"><span class="mord"><span class="mord mathbb"></span></span></span> <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8491em;"></span><span class="mord"><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.8491em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mathnormal mtight"> </span></span></span></span></span></span></span></span></span></span></span></span> R <span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="mord"><span class="msupsub"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.8491em;"><span style="top:-3.063em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mathnormal mtight"></span><span class="mord mathnormal mtight">m×d</span></span></span></span></span></span></span></span></span></span></span></span>. Em seguida, aplicou-se <strong>o MAX_SIM</strong> para comparar as duas listas de embeddings e obter a pontuação final entre a consulta e a página do documento.</p>
<h2 id="ColBERT-text-retrieval-system" class="common-anchor-header">Sistema de recuperação de texto ColBERT<button data-href="#ColBERT-text-retrieval-system" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Nesta secção, vamos configurar um sistema de recuperação de texto ColBERT utilizando o StructArray. Antes disso, configure uma instância do Milvus v2.6.x e obtenha um token de acesso Cohere.</p>
...
<h3 id="Step-2-Load-the-Cohere-dataset" class="common-anchor-header">Passo 2: Carregar o conjunto de dados do Cohere<button data-href="#Step-2-Load-the-Cohere-dataset" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Neste exemplo, vamos utilizar o conjunto de dados da Wikipédia da Cohere e recuperar os primeiros 10 000 registos. Pode encontrar informações sobre este conjunto de dados <a href="https://huggingface.co/datasets/Cohere/wikipedia-2023-11-embed-multilingual-v3">nesta página</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>A execução dos scripts acima irá descarregar o conjunto de dados, caso este não esteja disponível localmente. Cada registo no conjunto de dados corresponde a um parágrafo de uma página da Wikipédia. A tabela seguinte mostra a estrutura deste conjunto de dados.</p>
<table>
<thead>
<tr><th>Nome da coluna</th><th>Descrição</th></tr>
</thead>
<tbody>
<tr><td><code translate="no">_id</code></td><td>ID do registo</td></tr>
<tr><td><code translate="no">url</code></td><td>O URL do registo atual.</td></tr>
<tr><td><code translate="no">title</code></td><td>O título do documento de origem.</td></tr>
<tr><td><code translate="no">text</code></td><td>Um parágrafo do documento de origem.</td></tr>
<tr><td><code translate="no">emb</code></td><td>Incorporações do texto do documento de origem.</td></tr>
</tbody>
</table>
...
<h3 id="Step-4-Create-a-collection-for-the-Cohere-dataset" class="common-anchor-header">Passo 4: Criar uma coleção para o conjunto de dados Cohere<button data-href="#Step-4-Create-a-collection-for-the-Cohere-dataset" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Assim que os dados estiverem prontos, iremos criar uma coleção. Na coleção, « <code translate="no">paragraphs</code> » é um campo StructArray. Para uma explicação geral sobre esquemas StructArray, consulte <a href="/docs/pt/create-structarray-field.md">«Criar um campo StructArray</a>».</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-5-Insert-Cohere-dataset-into-the-collection" class="common-anchor-header">Passo 5: Inserir o conjunto de dados Cohere na coleção<button data-href="#Step-5-Insert-Cohere-dataset-into-the-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-6-Search-within-the-Cohere-dataset" class="common-anchor-header">Passo 6: Pesquisar no conjunto de dados Cohere<button data-href="#Step-6-Search-within-the-Cohere-dataset" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>De acordo com a conceção do ColBERT, o texto da consulta deve ser tokenizado e, em seguida, incorporado numa EmbeddingList. Nesta etapa, iremos utilizar o mesmo modelo que o Cohere utilizou para gerar embeddings para os parágrafos do conjunto de dados da Wikipédia.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>No código, os textos de consulta são organizados em tokens num <code translate="no">query_inputs</code> e incorporados numa lista de vetores de tipo float. Em seguida, pode utilizar a EmbeddingList do Milvus para realizar uma pesquisa de similaridade da seguinte forma.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Cada pontuação de similaridade cosseno por pares varia entre <code translate="no">-1</code> e <code translate="no">1</code>. A pontuação final de « <code translate="no">MAX_SIM_COSINE</code> » pode ser superior a <code translate="no">1</code>, uma vez que agrega várias pontuações máximas de similaridade ao nível dos tokens.</p>
<h2 id="ColPali-document-retrieval-system" class="common-anchor-header">Sistema de recuperação de documentos ColPali<button data-href="#ColPali-document-retrieval-system" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Nesta secção, iremos configurar um sistema de recuperação de documentos baseado no ColPali utilizando o StructArray. Antes disso, configure uma instância do Milvus v2.6.x.</p>
<h3 id="Step-1-Install-the-dependencies" class="common-anchor-header">Passo 1: Instalar as dependências<button data-href="#Step-1-Install-the-dependencies" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
...
<h3 id="Step-2-Load-the-Vidore-dataset" class="common-anchor-header">Passo 2: Carregar o conjunto de dados Vidore<button data-href="#Step-2-Load-the-Vidore-dataset" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Nesta secção, iremos utilizar um conjunto de dados Vidore denominado <strong>vidore_v2_finance_en</strong>. Este conjunto de dados é um corpus de relatórios anuais do setor bancário, destinado a tarefas de compreensão de documentos longos. É um dos 10 corpora que compõem o ViDoRe v3 Benchmark. Pode encontrar detalhes sobre este conjunto de dados <a href="https://huggingface.co/datasets/vidore/vidore_v3_finance_en">nesta página</a>.</p>
<pre><code translate="no" class="language-python"><span class="hljs-keyword">from</span> datasets <span class="hljs-keyword">import</span> load_dataset
...
<button class="copy-code-btn"></button></code></pre>
<p>A execução dos scripts acima irá descarregar o conjunto de dados, caso este não esteja disponível localmente. Cada registo no conjunto de dados corresponde a uma página de um relatório financeiro. A tabela seguinte mostra a estrutura deste conjunto de dados.</p>
<table>
<thead>
<tr><th>Nome da coluna</th><th>Descrição</th></tr>
</thead>
<tbody>
<tr><td><code translate="no">corpus_id</code></td><td>Um registo no corpus</td></tr>
<tr><td><code translate="no">image</code></td><td>A imagem da página em bytes.</td></tr>
<tr><td><code translate="no">doc_id</code></td><td>O ID descritivo do documento.</td></tr>
<tr><td><code translate="no">page_number_in_doc</code></td><td>O número da página atual no documento.</td></tr>
</tbody>
</table>
<h3 id="Step-3-Generate-embeddings-for-the-page-images" class="common-anchor-header">Passo 3: Gerar representações vetoriais para as imagens das páginas<button data-href="#Step-3-Generate-embeddings-for-the-page-images" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Conforme ilustrado na secção <a href="/docs/pt/search-with-embedding-lists.md#overview">«Visão geral»</a>, o modelo ColPali é um VLM que projeta imagens no espaço vetorial de um modelo de texto. Nesta etapa, utilizaremos o modelo ColPali mais recente, <strong>o vidore/colpali-v1.3</strong>. Pode encontrar detalhes sobre este modelo <a href="https://huggingface.co/vidore/colpali-v1.3">nesta página</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Assim que o modelo estiver pronto, pode tentar gerar fragmentos para uma imagem específica da seguinte forma.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>No código acima, o modelo ColPali redimensiona a imagem para 448 x 448 píxeis e, em seguida, divide-a em fragmentos, cada um com 14 x 14 píxeis. Por fim, estes fragmentos são incorporados em 1 031 representações, cada uma com 128 dimensões.</p>
<p>Pode gerar representações para todas as imagens utilizando um ciclo da seguinte forma:</p>
...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>Este passo é relativamente demorado devido à grande quantidade de dados que precisa de ser incorporada.</p>
</div>
<h3 id="Step-4-Create-a-collection-for-the-financial-reports-dataset" class="common-anchor-header">Passo 4: Criar uma coleção para o conjunto de dados de relatórios financeiros<button data-href="#Step-4-Create-a-collection-for-the-financial-reports-dataset" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Assim que os dados estiverem prontos, iremos criar uma coleção. Nesta coleção, « <code translate="no">patches</code> » é um campo «StructArray». Cada elemento «Struct» armazena uma incorporação de fragmento. Para conhecer os requisitos de indexação dos subcampos do vetor «StructArray», consulte <a href="/docs/pt/index-structarray-fields.md">«Indexar campos StructArray</a>».</p>
<pre><code translate="no" class="language-python"><span class="hljs-keyword">from</span> pymilvus <span class="hljs-keyword">import</span> MilvusClient, DataType
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-5-Insert-the-financial-reports-into-the-collection" class="common-anchor-header">Passo 5: Inserir os relatórios financeiros na coleção<button data-href="#Step-5-Insert-the-financial-reports-into-the-collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>A inserção dos relatórios financeiros pode demorar algum tempo. Cada página pode conter mais de mil vetores de patch, e cada vetor é armazenado no campo StructArray « <code translate="no">patches</code> ». Para conjuntos de dados maiores, divida « <code translate="no">data</code> » em lotes mais pequenos e insira um lote de cada vez.</p>
</div>
<p>A partir do resultado, poderá verificar que todas as páginas do conjunto de dados Vidore foram inseridas.</p>
<h3 id="Step-6-Search-within-the-financial-reports" class="common-anchor-header">Passo 6: Pesquisar nos relatórios financeiros<button data-href="#Step-6-Search-within-the-financial-reports" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Assim que os dados estiverem prontos, podemos realizar pesquisas nos dados da coleção da seguinte forma:</p>
<pre><code translate="no" class="language-python"><span class="hljs-keyword">from</span> pymilvus.client.embedding_list <span class="hljs-keyword">import</span> EmbeddingList
