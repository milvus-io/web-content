...
<h2 id="MUVERA" class="common-anchor-header">O MUVERA<button data-href="#MUVERA" class="anchor-icon" translate="no">
    ...
    </button></h2><p><code translate="no">muvera</code> codifica cada lista de embeddings num vetor de dimensão fixa utilizando projeções aleatórias. Isto transforma a recuperação da primeira fase numa pesquisa vetorial padrão ao nível da linha. Os candidatos são então reclassificados com o MaxSim.</p>
<div class="alert note">
...
<tr><td><code translate="no">emb_list_rerank</code></td><td>Pesquisa</td><td><code translate="no">true</code></td><td>Determina se os candidatos recuperados devem ser reclassificados com o MaxSim.</td></tr>
</tbody>
</table>
<div class="alert note">
...
<li><p>Execute as mesmas consultas com <code translate="no">muvera</code> e compare o recall, o nDCG, a latência e o tamanho do índice.</p></li>
