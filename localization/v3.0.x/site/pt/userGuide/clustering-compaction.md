...
<h3 id="Global-Configuration" class="common-anchor-header">Configuração global<button data-href="#Global-Configuration" class="anchor-icon" translate="no">
    ...
    </button></h3><p>É necessário modificar o ficheiro de configuração do Milvus conforme indicado abaixo.</p>
...
<h3 id="Collection-Configuration" class="common-anchor-header">Configuração da coleção<button data-href="#Collection-Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Para compactar o cluster numa coleção específica, deve selecionar um campo escalar da coleção como chave de cluster.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Benchmark-Test" class="common-anchor-header">Teste de Benchmark<button data-href="#Benchmark-Test" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>O volume de dados e os padrões de consulta combinados determinam a melhoria de desempenho que a compactação de cluster pode trazer. Um teste de benchmark interno demonstra que a compactação de clustering produz uma melhoria de até 25 vezes nas consultas por segundo (QPS).</p>
