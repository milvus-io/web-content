...
<p>O desempenho do <code translate="no">SCANN</code> é controlado por dois parâmetros-chave que permitem ajustar o equilíbrio entre velocidade e precisão:</p>
<ul>
<li><p><code translate="no">with_raw_data</code>: Controla se os dados vectoriais originais são armazenados juntamente com representações quantizadas. A ativação deste parâmetro melhora a precisão durante a reclassificação, mas aumenta os requisitos de armazenamento.</p></li>
