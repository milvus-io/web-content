...
<ul>
<li><p>Se <code translate="no">L &lt; min_gram</code>, o índice não pode ser utilizado e a consulta recorre a uma pesquisa completa.</p></li>
...
<li><p><code translate="no">params.json_cast_type</code> – deve ser « <code translate="no">&quot;varchar&quot;</code> » (sem distinção entre maiúsculas e minúsculas), uma vez que a indexação NGRAM opera sobre cadeias de caracteres.</p></li>
</ul>
...
<em>(Por exemplo, se o termo de consulta mais curto esperado tiver 2 caracteres, defina min_gram=2 ao criar o índice.)</em></p></li>
</ul>
