...
<h3 id="Get-Load-Status" class="common-anchor-header">Obter o estado do carregamento<button data-href="#Get-Load-Status" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Uma coleção é marcada como Carregando se pelo menos uma das suas partições estiver em processo de carregamento.</p></li>
</ul>
