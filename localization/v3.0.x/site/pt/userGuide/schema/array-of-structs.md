...
summary: >-
  ...
  ordenada de elementos estruturados, como um documento com vários segmentos,
  uma página com vários blocos visuais ou um vídeo com vários clipes. O
...
<tr><td>Filtragem estruturada</td><td>Filtre por subcampos escalares dentro de elementos Struct, tais como secção, pontuação, página ou indicadores.</td><td><code translate="no">chunks[section]</code>, <code translate="no">chunks[quality_score]</code></td></tr>
...
<tr><td>Pesquise fragmentos, clipes ou partes individuais.</td><td>Utilize a pesquisa ao nível do elemento com uma métrica vetorial regular.</td><td>Nível de elemento Struct, com deslocamento, quando disponível.</td><td>Pesquisa vetorial básica com StructArray</td></tr>
<tr><td>Restringir a pesquisa vetorial ao nível do elemento aos elementos que correspondam a condições escalares.</td><td>Utilize ` <code translate="no">element_filter</code>`.</td><td>Filtragem ao nível do elemento; a forma do resultado depende do tipo de pesquisa.</td><td>Pesquisa filtrada com StructArray</td></tr>
...
<tr><td>Utilize limites de pontuação ou distância nos subcampos do vetor StructArray.</td><td>Utilize a pesquisa por intervalo ao nível do elemento.</td><td>Nível de elemento Struct.</td><td>Pesquisa por intervalo com StructArray</td></tr>
<tr><td>Retorne, no máximo, um resultado por entidade pai após a pesquisa ao nível do elemento.</td><td>Utilize a pesquisa agrupada por chave primária.</td><td>Nível de entidade após o agrupamento.</td><td>Pesquisa agrupada com StructArray</td></tr>
<tr><td>Combine a pesquisa de elementos do StructArray com outro campo vetorial.</td><td>Utilize uma pesquisa híbrida com um AnnSearchRequest direcionado para um subcampo vetorial do StructArray.</td><td>Subpesquisa ao nível do elemento, reclassificação ao nível da entidade.</td><td>Pesquisa híbrida com StructArray</td></tr>
</tbody>
</table>
...
<thead>
<tr><th>### Pesquisa EmbeddingList A pesquisa EmbeddingList trata os vetores dentro de um subcampo vetorial do StructArray como uma lista de embeddings para a entidade pai. A consulta é também uma lista de embeddings. O Milvus compara a lista de embeddings da consulta com a lista de embeddings armazenada, utilizando uma métrica de <code translate="no">MAX_SIM*</code>, e devolve as entidades correspondentes. - Dados da consulta: lista de embeddings. - Família de métricas: « <code translate="no">MAX_SIM*</code> ». - Granularidade do resultado: nível da entidade. - Ideal para: recuperação de interação tardia ao nível do documento ou da página.</th><th>### Pesquisa ao nível do elemento A pesquisa ao nível do elemento trata cada elemento Struct como um candidato independente à pesquisa vetorial. Cada resultado representa um elemento correspondente dentro do campo StructArray, e os resultados não agrupados podem revelar o deslocamento do elemento. - Dados da consulta: vetor regular. - Família de métricas: métricas de vetor regular. - Granularidade dos resultados: nível do elemento Struct. - Ideal para: recuperação ao nível de fragmento, clipe ou patch.</th></tr>
</thead>
<tbody>
</tbody>
</table>
<div class="alert note">
<p>Aviso</p>
<p>Se a sua coleção necessitar tanto da pesquisa EmbeddingList como da pesquisa ao nível do elemento, utilize dois subcampos vetoriais separados. Um campo vetorial ou subcampo vetorial aceita apenas um índice, e os dois modos de pesquisa requerem famílias de métricas diferentes.</p>
</div>
...
<tr><td>Pesquisa</td><td>Pesquisa vetorial básica com StructArray</td><td>Compare a pesquisa com EmbeddingList e a pesquisa vetorial ao nível dos elementos.</td></tr>
<tr><td>Pesquisa</td><td>Pesquisa por intervalo com StructArray</td><td>Utilize restrições de intervalo com subcampos vetoriais do StructArray.</td></tr>
<tr><td>Pesquisa</td><td>Pesquisa agrupada com StructArray</td><td>Agrupar os resultados da pesquisa ao nível dos elementos por chave primária.</td></tr>
<tr><td>Pesquisa</td><td>Pesquisa híbrida com StructArray</td><td>Combinar a pesquisa ao nível dos elementos do StructArray com outras pesquisas vetoriais.</td></tr>
<tr><td>Pesquisa</td><td>Pesquisa filtrada com StructArray</td><td>Utilize os filtros do StructArray na pesquisa, na consulta e na pesquisa híbrida.</td></tr>
...
<li><p>Para pesquisar subcampos vetoriais do StructArray, comece por «Pesquisa vetorial básica com StructArray».</p></li>
<li><p>Para filtrar subcampos escalares do StructArray, leia <a href="/docs/pt/struct-array-operators.md">«Operadores do StructArray</a> » e «Pesquisa filtrada com StructArray».</p></li>
</ol>
