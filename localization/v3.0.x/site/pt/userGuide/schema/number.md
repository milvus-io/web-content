---
id: number.md
title: Campo de números
summary: >-
  Um campo numérico é um campo escalar que armazena valores numéricos. Estes
  valores podem ser números inteiros (números inteiros) ou números decimais
  (números de vírgula flutuante). São normalmente utilizados para representar
  quantidades, medições ou quaisquer dados que necessitem de ser processados
  matematicamente.
---
<h1 id="Number-Field" class="common-anchor-header">Campo de números<button data-href="#Number-Field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Um campo numérico é um campo escalar que armazena valores numéricos. Estes valores podem ser números inteiros (números<strong>inteiros</strong>) ou números decimais<strong>(números de vírgula flutuante</strong>). São normalmente utilizados para representar quantidades, medições ou quaisquer dados que necessitem de ser processados matematicamente.</p>
<p>A tabela seguinte descreve os tipos de dados dos campos numéricos disponíveis no Milvus.</p>
<table>
   <tr>
   ...
   <tr>
     ...
     <td><p>Tipo booleano para armazenar <code translate="no">true</code> ou <code translate="no">false</code>, adequado para descrever estados binários.</p></td>
   </tr>
   <tr>
     <td><p><code translate="no">INT8</code></p></td>
     <td><p>Número inteiro de 8 bits, adequado para armazenar dados inteiros de pequena dimensão.</p></td>
   </tr>
   <tr>
     <td><p><code translate="no">INT16</code></p></td>
     <td><p>Inteiro de 16 bits, para dados inteiros de gama média.</p></td>
   </tr>
   <tr>
     <td><p><code translate="no">INT32</code></p></td>
     <td><p>Número inteiro de 32 bits, ideal para o armazenamento de dados inteiros gerais, como quantidades de produtos ou IDs de utilizadores.</p></td>
   </tr>
   <tr>
     <td><p><code translate="no">INT64</code></p></td>
     <td><p>Número inteiro de 64 bits, adequado para armazenar dados de grande alcance, como carimbos de data/hora ou identificadores.</p></td>
   </tr>
   <tr>
     <td><p><code translate="no">FLOAT</code></p></td>
     <td><p>Número de vírgula flutuante de 32 bits, para dados que requerem precisão geral, como classificações ou temperatura.</p></td>
   </tr>
   <tr>
     <td><p><code translate="no">DOUBLE</code></p></td>
     <td><p>Número de vírgula flutuante de dupla precisão de 64 bits, para dados de alta precisão, como informações financeiras ou cálculos científicos.</p></td>
   </tr>
</table>
<p>Para declarar um campo numérico, basta definir o endereço <code translate="no">datatype</code> como um dos tipos de dados numéricos disponíveis. Por exemplo, <code translate="no">DataType.INT64</code> para um campo de número inteiro ou <code translate="no">DataType.FLOAT</code> para um campo de vírgula flutuante.</p>
<div class="alert note">
<p>O Milvus suporta valores nulos e valores por defeito para campos numéricos. Para ativar estas funcionalidades, defina <code translate="no">nullable</code> para <code translate="no">True</code> e <code translate="no">default_value</code> para um valor numérico. Para mais informações, consulte <a href="/docs/pt/nullable-and-default.md">Nullable &amp; Default</a>.</p>
</div>
<h2 id="Add-number-field" class="common-anchor-header">Adicionar campo numérico<button data-href="#Add-number-field" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Para armazenar dados numéricos, defina um campo numérico no seu esquema de coleção. Abaixo encontra-se um exemplo de um esquema de coleção com dois campos numéricos:</p>
<ul>
<li><p><code translate="no">age</code>: armazena dados inteiros, permite valores nulos e tem um valor predefinido de <code translate="no">18</code>.</p></li>
<li><p><code translate="no">price</code>: armazena dados de float, permite valores nulos, mas não tem um valor predefinido.</p></li>
</ul>
<div class="alert note">
<p>Se definir <code translate="no">enable_dynamic_fields=True</code> ao definir o esquema, o Milvus permite-lhe inserir campos escalares que não foram previamente definidos. No entanto, isto pode aumentar a complexidade das consultas e da gestão, afectando potencialmente o desempenho. Para obter mais informações, consulte <a href="/docs/pt/enable-dynamic-field.md">Campo dinâmico</a>.</p>
</div>
...
<p>O exemplo seguinte cria índices no campo vetorial <code translate="no">embedding</code> e no campo escalar <code translate="no">age</code>, ambos utilizando o tipo de índice <code translate="no">AUTOINDEX</code>. Com este tipo, o Milvus seleciona automaticamente o índice mais adequado com base no tipo de dados. Também pode personalizar o tipo de índice e os parâmetros para cada campo. Para obter detalhes, consulte <a href="/docs/pt/index-explained.md">Índice explicado</a>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<h2 id="Create-collection" class="common-anchor-header">Criar coleção<button data-href="#Create-collection" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Depois que o esquema e os índices forem definidos, crie uma coleção que inclua campos de números.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<h2 id="Query-with-filter-expressions" class="common-anchor-header">Consultar com expressões de filtro<button data-href="#Query-with-filter-expressions" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Depois de inserir entidades, utilize o método <code translate="no">query</code> para obter entidades que correspondam às expressões de filtro especificadas.</p>
<p>Para recuperar entidades onde o <code translate="no">age</code> é maior que 30:</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Para recuperar entidades onde o <code translate="no">price</code> é nulo:</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Para recuperar entidades em que <code translate="no">age</code> tem o valor <code translate="no">18</code>, utilize a seguinte expressão. Como o valor padrão de <code translate="no">age</code> é <code translate="no">18</code>, o resultado esperado deve incluir entidades com <code translate="no">age</code> explicitamente definido como <code translate="no">18</code> ou com <code translate="no">age</code> definido como nulo.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Vector-search-with-filter-expressions" class="common-anchor-header">Pesquisa de vectores com expressões de filtro<button data-href="#Vector-search-with-filter-expressions" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Além da filtragem básica de campo numérico, é possível combinar pesquisas de similaridade de vetor com filtros de campo numérico. Por exemplo, o código a seguir mostra como adicionar um filtro de campo numérico a uma pesquisa de vetor:</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
