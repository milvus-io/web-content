...
title: Chinês
summary: >-
  O analisador chinês foi concebido especificamente para lidar com texto chinês,
  fornecendo segmentação e tokenização eficazes.
---
...
<h3 id="Configuration" class="common-anchor-header">Configuração<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Para aplicar o analisador <code translate="no">chinese</code> a um campo, basta definir <code translate="no">type</code> para <code translate="no">chinese</code> em <code translate="no">analyzer_params</code>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
<pre><code translate="no" class="language-python">analyzer_params = {
...
<h2 id="Examples" class="common-anchor-header">Exemplos<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Antes de aplicar a configuração do analisador ao seu esquema de coleção, verifique seu comportamento usando o método <code translate="no">run_analyzer</code>.</p>
