...
<p>Para uma configuração mais simples, você pode optar por usar o analisador <a href="/docs/pt/standard-analyzer.md"><code translate="no">standard</code></a> <a href="/docs/pt/standard-analyzer.md">analisador</a>, que combina o tokenizador <code translate="no">standard</code> com o filtro <a href="/docs/pt/lowercase-filter.md"><code translate="no">lowercase</code></a><a href="/docs/pt/lowercase-filter.md"> filtro</a>.</p>
</div>
