...
title: Lindera
summary: >-
  O tokenizador lindera efectua uma análise morfológica baseada no dicionário.
...
<p><strong>Para texto em chinês</strong>: Embora <code translate="no">lindera</code> suporte o chinês através do dicionário <code translate="no">cc-cedict</code>, recomendamos a utilização do <a href="/docs/pt/jieba-tokenizer.md"><code translate="no">jieba</code></a> em vez disso. O Jieba foi concebido especificamente para a segmentação de palavras chinesas e fornece melhores resultados.</p>
</div>
