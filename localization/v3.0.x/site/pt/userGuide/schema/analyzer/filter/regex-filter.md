...
<table>
   ...
   <tr>
     ...
     <td><p>Um padrão de expressão regular aplicado a cada token. Os tokens que correspondem são mantidos; os que não correspondem são descartados. Para obter detalhes sobre a sintaxe regex, consulte <a href="https://docs.rs/regex/latest/regex/#syntax">Sintaxe</a>.</p></td>
   </tr>
</table>
