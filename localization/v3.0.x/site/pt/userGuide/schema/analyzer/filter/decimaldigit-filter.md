...
summary: O filtro «decimaldigit» converte dígitos decimais Unicode em dígitos ASCII.
beta: Milvus 3.0.0+
---
<h1 id="Decimal-Digit" class="common-anchor-header">Dígito decimal<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 3.0.0+</span><button data-href="#Decimal-Digit" class="anchor-icon" translate="no">
    ...
    </button></h1><p>O filtro « <code translate="no">decimaldigit</code> » é um filtro de tokens integrado que converte dígitos decimais Unicode de sistemas de escrita suportados em dígitos ASCII. Isto garante a consistência dos tokens numéricos entre diferentes línguas e sistemas de escrita.</p>
