...
summary: >-
  ...
  valores significativos. Esta representação consegue captar eficazmente padrões
  e relações complexas, facilitando a análise e o processamento dos dados em
  ...
  milhares, dependendo da aplicação específica e dos requisitos.
---
...
<ul>
<li><p><strong>Representação multidimensional:</strong> Cada ponto representa um objeto conceptual (como <strong>o Milvus</strong>, <strong>uma base de dados vetorial</strong>, <strong>um sistema de recuperação</strong>, etc.), cuja posição é determinada pelos valores das suas dimensões.</p></li>
...
<li><p><strong>Efeito de agrupamento:</strong> Os conceitos relacionados (tais como <strong>Milvus</strong>, <strong>base de dados vetorial</strong> e <strong>sistema de recuperação</strong>) estão posicionados próximos uns dos outros no espaço, formando um agrupamento semântico.</p></li>
</ul>
...
<ol>
<li><p>Definir ` <code translate="no">datatype</code> ` para um tipo de dados de vetor denso suportado. Para conhecer os tipos de dados de vetores densos suportados, consulte Tipos de Dados.</p></li>
...
<table>
   ...
   <tr>
     ...
     <td><p>Armazena números de ponto flutuante de meia precisão de 16 bits, utilizados para aprendizagem profunda e cálculos em GPU. Poupa espaço de armazenamento em cenários em que a precisão é menos crítica, como na fase de recuperação de baixa precisão dos sistemas de recomendação.</p></td>
   </tr>
   <tr>
...
<h3 id="Create-collection" class="common-anchor-header">Criar coleção<button data-href="#Create-collection" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Assim que as configurações do vetor denso e dos parâmetros do índice estiverem concluídas, pode criar uma coleção que contenha vetores densos. O exemplo abaixo utiliza o método ` <code translate="no">create_collection</code> ` para criar uma coleção denominada ` <code translate="no">my_collection</code>`.</p>
<div class="multipleCode">
   <a href="#python">Python</a>
 <a href="#java">   Java</a>
 <a href="#javascript">   NodeJS</a>
...
<button class="copy-code-btn"></button></code></pre>
<p>Para mais informações sobre os parâmetros de pesquisa por semelhança, consulte <a href="/docs/pt/single-vector-search.md">Pesquisa ANN Básica</a>.</p>
