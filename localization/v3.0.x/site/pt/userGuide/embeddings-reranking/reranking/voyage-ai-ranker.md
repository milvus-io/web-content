...
<h2 id="Create-a-Voyage-AI-ranker-function" class="common-anchor-header">Criar uma função do classificador do Voyage AI<button data-href="#Create-a-Voyage-AI-ranker-function" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Para utilizar o Voyage AI Ranker na sua aplicação Milvus, crie um objeto Function que especifique como o reranking deve funcionar. Esta função será passada para as operações de pesquisa do Milvus para melhorar a classificação dos resultados.</p>
