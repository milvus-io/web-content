...
<p>O gráfico acima mostra como o decaimento exponencial afectaria as classificações dos artigos de notícias numa plataforma de notícias digitais:</p>
<ul>
...
<h3 id="Create-a-decay-ranker" class="common-anchor-header">Criar um classificador de decaimento<button data-href="#Create-a-decay-ranker" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Depois de a coleção estar configurada com um campo numérico (neste exemplo, <code translate="no">publish_time</code>), crie um classificador de decaimento exponencial:</p>
<div class="alert note">
