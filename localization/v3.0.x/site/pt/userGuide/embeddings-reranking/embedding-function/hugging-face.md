...
<button class="copy-code-btn"></button></code></pre>
<p>Para mais detalhes sobre como aplicar as definições do Docker Compose, consulte <a href="/docs/pt/configure-docker.md">«Configurar o Milvus com o Docker Compose</a>».</p>
