...
<p>Esta integração utiliza o router do Hugging Face alojado. Para ligar o Milvus a um serviço de Inferência de Embeddings de Texto (TEI) implementado separadamente, consulte <a href="/docs/pt/hugging-face-tei.md">o Hugging Face TEI</a>.</p>
