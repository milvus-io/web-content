...
<h2 id="Configure-credentials" class="common-anchor-header">Configurar credenciais<button data-href="#Configure-credentials" class="anchor-icon" translate="no">
    ...
    </button></h2><p>O Milvus precisa de conhecer a sua chave API do Yandex Cloud antes de poder solicitar embeddings. Pode configurar a chave API em <code translate="no">milvus.yaml</code> ou através de uma variável de ambiente.</p>
