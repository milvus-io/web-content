...
<h3 id="Prepare-deploymentyml" class="common-anchor-header">Preparar deployment.yml</h3><pre><code translate="no" class="language-yml"><span class="hljs-attr">apiVersion:</span> <span class="hljs-string">apps/v1</span>
