...
<h2 id="Local-install" class="common-anchor-header">Instalação local<button data-href="#Local-install" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Se instalou o Milvus Standalone <a href="/docs/pt/install_standalone-docker.md">usando o docker</a>, é melhor descarregar e instalar o binário construído, instalar o Birdwatcher como um módulo Go comum, ou construir o Birdwatcher a partir da fonte.</p>
<ul>
...
<h2 id="Install-as-a-Kubernetes-pod" class="common-anchor-header">Instalar como um pod do Kubernetes<button data-href="#Install-as-a-Kubernetes-pod" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Se você instalou o Milvus Standalone <a href="/docs/pt/install_standalone-helm.md">usando os gráficos do Helm</a> ou <a href="/docs/pt/install_standalone-operator.md">o Milvus Operator</a> ou o Milvus Cluster <a href="/docs/pt/install_cluster-helm.md">usando os gráficos do Helm</a> ou <a href="/docs/pt/install_cluster-milvusoperator.md">o Milvus Operator</a>, é aconselhável instalar o Birdwatcher como um pod do Kubernetes.</p>
<h3 id="Prepare-deploymentyml" class="common-anchor-header">Preparar deployment.yml<button data-href="#Prepare-deploymentyml" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Apply-deploymentyml" class="common-anchor-header">Aplicar deployment.yml<button data-href="#Apply-deploymentyml" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Salve o YAML acima em um arquivo e nomeie-o como <code translate="no">deployment.yml</code>, e execute o seguinte comando</p>
