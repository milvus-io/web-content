...
<h2 id="Back-up-a-collection-from-milvusA" class="common-anchor-header">Fazer backup de uma coleção do milvus_A<button data-href="#Back-up-a-collection-from-milvusA" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Vá para o diretório do projeto milvus-backup e crie um diretório chamado configs:</p>
...
<h3 id="Step-2-Edit-configuration-file" class="common-anchor-header">Passo 2: Editar o ficheiro de configuração<button data-href="#Step-2-Edit-configuration-file" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Modifique o ficheiro backup.yaml para definir as configurações apropriadas para<code translate="no">milvus_A</code>:</p>
<ul>
...
<li><p><code translate="no">minio.rootPath</code>: Caminho raiz dentro do bucket onde os dados de <code translate="no">milvus_A</code> são armazenados. Neste exemplo, defina para <code translate="no">files</code>.</p></li>
...
<h2 id="Restore-the-backup-to-milvusB" class="common-anchor-header">Restaurar a cópia de segurança para milvus_B<button data-href="#Restore-the-backup-to-milvusB" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Configure-restoration-settings" class="common-anchor-header">Passo 1: Configurar as definições de restauro<button data-href="#Step-1-Configure-restoration-settings" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Repita o passo 2 para modificar as configurações para o restauro para <code translate="no">milvus_B</code>, assegurando que <code translate="no">minio.bucketName</code> está definido para <code translate="no">bucket_B</code>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Restore-backup" class="common-anchor-header">Passo 2: Restaurar a cópia de segurança<button data-href="#Step-2-Restore-backup" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Restaure o backup para <code translate="no">milvus_B</code>:</p>
