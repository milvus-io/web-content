...
<h3 id="Install-via-pip" class="common-anchor-header">Instalar via pip<button data-href="#Install-via-pip" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Execute o seguinte comando para instalar o Milvus_CLI.</p>
...
<h3 id="Prerequisites" class="common-anchor-header">Pré-requisitos<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h3><p>É necessário o Docker 19.03 ou posterior.</p>
<h3 id="Install-based-on-Docker-image" class="common-anchor-header">Instalar com base na imagem do Docker<button data-href="#Install-based-on-Docker-image" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><pre><code translate="no" class="language-shell"><span class="hljs-meta prompt_">$ </span><span class="language-bash">docker run -it zilliz/milvus_cli:latest</span>
<button class="copy-code-btn"></button></code></pre>
...
<h3 id="Install-from-an-exe-file" class="common-anchor-header">Instalar a partir de um ficheiro .exe<button data-href="#Install-from-an-exe-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><div class="alert note"> Este método de instalação só se aplica ao Windows. </div>
<p>Descarregue um ficheiro .exe a partir do <a href="https://github.com/zilliztech/milvus_cli/releases">GitHub</a> e execute-o para instalar o Milvus_CLI. Se for bem sucedido, <code translate="no">milvus_cli-&lt;version&gt;.exe</code> aparece como mostra a figura seguinte.</p>
<p>
