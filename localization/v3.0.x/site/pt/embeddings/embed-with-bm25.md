...
order: 5
summary: >-
  A BM25 é uma função de classificação utilizada na recuperação de informação
  para estimar a relevância dos documentos para uma determinada consulta de
  pesquisa.
title: BM25
---
...
<p>Para criar facilmente um tokenizador, Milvus oferece um analisador padrão que requer apenas a especificação do idioma do texto.</p>
