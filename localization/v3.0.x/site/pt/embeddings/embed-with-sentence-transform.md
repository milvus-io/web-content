...
order: 3
summary: >-
  Este artigo demonstra como utilizar os Transformadores de frases no Milvus
  para codificar documentos e consultas em vectores densos.
...
<h1 id="Sentence-Transformers" class="common-anchor-header">Transformadores de frases<button data-href="#Sentence-Transformers" class="anchor-icon" translate="no">
    ...
    </button></h1><p>O Milvus integra-se com modelos pré-treinados do <a href="https://www.sbert.net/docs/pretrained_models.html#model-overview">Sentence</a> <strong>Transformer</strong> através da classe <strong>SentenceTransformerEmbeddingFunction</strong>. Esta classe fornece métodos para codificar documentos e consultas usando os modelos pré-treinados do Sentence Transformer e retornando os embeddings como vetores densos compatíveis com a indexação do Milvus.</p>
<p>Para usar esse recurso, instale as dependências necessárias:</p>
<pre><code translate="no" class="language-bash">pip install --upgrade pymilvus
pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>Em seguida, instancie a <strong>SentenceTransformerEmbeddingFunction</strong>:</p>
...
<p>O nome do modelo do Sentence Transformer a ser usado para codificação. O valor predefinido é <strong>all-MiniLM-L6-v2</strong>. Pode utilizar qualquer um dos modelos pré-treinados dos Transformadores de frases. Para obter uma lista dos modelos disponíveis, consulte <a href="https://www.sbert.net/docs/pretrained_models.html">Modelos pré-treinados</a>.</p></li>
