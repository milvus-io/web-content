...
<h3 id="Note-for-macOS-M-series-chip" class="common-anchor-header">Nota para o macOS (chip da série M):<button data-href="#Note-for-macOS-M-series-chip" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Se encontrar o erro:</p>
...
<h2 id="4-Prepare-Data-Create-Collection-and-Insert-Data" class="common-anchor-header">4. Preparar dados, criar coleção e inserir dados<button data-href="#4-Prepare-Data-Create-Collection-and-Insert-Data" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="41-Prepare-the-Data" class="common-anchor-header">4.1 Preparar os dados<button data-href="#41-Prepare-the-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Utilizamos as páginas de FAQ da <a href="https://github.com/milvus-io/milvus-docs/releases/download/v2.4.6-preview/milvus_docs_2.4.x_en.zip">Documentação do Milvus 2.4.x</a> como conjunto de dados para este exemplo.</p>
...
<button class="copy-code-btn"></button></code></pre>
<hr>
<h3 id="42-Generate-Embeddings" class="common-anchor-header">4.2 Gerar embeddings<button data-href="#42-Generate-Embeddings" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Defina um modelo de incorporação para gerar incorporação de texto usando o <code translate="no">milvus_model</code>. Usamos o modelo <code translate="no">DefaultEmbeddingFunction</code> como exemplo, que é um modelo de incorporação pré-treinado e leve.</p>
...
<button class="copy-code-btn"></button></code></pre>
<hr>
<h3 id="43-Create-Collection" class="common-anchor-header">4.3 Criar coleção<button data-href="#43-Create-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Ligue-se ao Milvus e crie uma coleção:</p>
...
<button class="copy-code-btn"></button></code></pre>
<hr>
<h3 id="44-Insert-Data" class="common-anchor-header">4.4 Inserir dados<button data-href="#44-Insert-Data" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Itere pelas linhas de texto, crie embeddings e insira os dados no Milvus:</p>
...
<button class="copy-code-btn"></button></code></pre>
<hr>
<h3 id="45-Visualize-Data-and-Schema" class="common-anchor-header">4.5 Visualizar dados e esquema<button data-href="#45-Visualize-Data-and-Schema" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="51-Perform-a-Search" class="common-anchor-header">5.1 <strong>Realizar uma pesquisa</strong><button data-href="#51-Perform-a-Search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<hr>
<h3 id="52-Explore-Data-Relationships" class="common-anchor-header">5.2 <strong>Explorar relações de dados</strong><button data-href="#52-Explore-Data-Relationships" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Clique no botão <strong>Explorar</strong> no painel de resultados para visualizar as relações entre o vetor de consulta e os resultados da pesquisa em uma <strong>estrutura semelhante a um gráfico de conhecimento</strong>.</p>
<ul>
...
<hr>
<h3 id="53-Expand-the-Graph" class="common-anchor-header">5.3 <strong>Expandir o gráfico</strong><button data-href="#53-Expand-the-Graph" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Faça duplo clique em qualquer nó de resultado para expandir as suas ligações. Esta ação revela relações adicionais entre o nó selecionado e outros pontos de dados na coleção, criando um <strong>gráfico de conhecimento maior e interligado</strong>.</p>
