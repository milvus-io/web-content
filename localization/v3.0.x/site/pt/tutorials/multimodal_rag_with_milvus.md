...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Load-Embedding-Model" class="common-anchor-header">Carregar o modelo de embedding<button data-href="#Load-Embedding-Model" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Iremos utilizar o modelo Visualized BGE «bge-visualized-base-en-v1.5» para gerar embeddings tanto para imagens como para texto.</p>
...
<h2 id="Load-Data" class="common-anchor-header">Carregar dados<button data-href="#Load-Data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Esta secção irá carregar imagens de exemplo na base de dados com as correspondentes representações.</p>
...
<h3 id="Run-search" class="common-anchor-header">Executar a pesquisa<button data-href="#Run-search" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Rerank-with-GPT-4o" class="common-anchor-header">Reorganização com o GPT-4o<button data-href="#Rerank-with-GPT-4o" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Enviaremos a imagem combinada para o serviço LLM multimodal, juntamente com prompts adequados, para classificar os resultados obtidos com uma explicação. Para ativar o GPT-4o como LLM, é necessário preparar <a href="https://platform.openai.com/docs/quickstart">a</a> sua <a href="https://platform.openai.com/docs/quickstart">chave API da OpenAI</a>.</p>
