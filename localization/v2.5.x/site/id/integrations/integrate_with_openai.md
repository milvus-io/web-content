...
title: Pencarian Semantik dengan Milvus dan OpenAI
summary: Halaman ini membahas integrasi basis data vektor dengan API penyematan OpenAI.
---
<h1 id="Semantic-Search-with-Milvus-and-OpenAI" class="common-anchor-header">Pencarian Semantik dengan Milvus dan OpenAI<button data-href="#Semantic-Search-with-Milvus-and-OpenAI" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>Panduan ini menunjukkan bagaimana <a href="https://platform.openai.com/docs/guides/embeddings">Embedding API OpenAI</a> dapat digunakan dengan basis data vektor Milvus untuk melakukan pencarian semantik pada teks.</p>
...
<h2 id="Searching-book-titles-with-OpenAI--Milvus" class="common-anchor-header">Mencari judul buku dengan OpenAI &amp; Milvus<button data-href="#Searching-book-titles-with-OpenAI--Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<p>Anda akan melihat hasil sebagai berikut:</p>
