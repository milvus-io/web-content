...
<p>Panduan ini mendemonstrasikan cara menggunakan Ragas untuk mengevaluasi pipeline Retrieval-Augmented Generation (RAG) yang dibangun di atas <a href="https://milvus.io/">Milvus</a>.</p>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Bahasa pemrograman yang digunakan untuk menulis kode program Kno...</td>
      <td>Bahasa pemrograman yang digunakan untuk menulis algoritma Knowher...</td>
    </tr>
    <tr>
      <th>2</th>
...
<h2 id="Evaluation-with-Ragas" class="common-anchor-header">Evaluasi dengan Ragas<button data-href="#Evaluation-with-Ragas" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Kami menggunakan Ragas untuk mengevaluasi performa hasil pipeline RAG kami.</p>
