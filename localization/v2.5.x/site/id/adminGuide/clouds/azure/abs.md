---
id: abs.md
title: Mengonfigurasi Akses Penyimpanan Blob dengan Identitas Beban Kerja
related_key: 'blob storage, workload identity, iam'
summary: Pelajari cara mengonfigurasi Blob Storage dengan Workload Identity.
---
<h1 id="Configure-Blob-Storage-Access-by-Workload-Identity" class="common-anchor-header">Mengonfigurasi Akses Penyimpanan Blob dengan Identitas Beban Kerja<button data-href="#Configure-Blob-Storage-Access-by-Workload-Identity" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Topik ini memperkenalkan cara mengonfigurasi akses Azure Blob Storage dengan Workload Identity ketika Anda menginstal Milvus dengan helm. Untuk detail lebih lanjut, lihat <a href="https://azure.github.io/azure-workload-identity/docs/introduction.html">Workload Identity</a>.</p>
...
<ul>
<li>Perbarui cluster AKS dengan OIDC Issuer dan Workload Identity.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Dapatkan URL penerbit OIDC.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Buat akun penyimpanan dan kontainer.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Buat identitas terkelola yang ditetapkan pengguna dan tetapkan peran.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>Buat kredensial identitas federasi antara identitas dan penerbit akun layanan &amp; subjek.</li>
</ul>
