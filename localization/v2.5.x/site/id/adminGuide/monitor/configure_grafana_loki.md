...
<h3 id="3-Install-Loki" class="common-anchor-header">3. Menginstal Loki<button data-href="#3-Install-Loki" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Jalankan perintah berikut ini untuk menginstal Loki:</p>
...
<h3 id="1-Create-Promtail-Configuration" class="common-anchor-header">1. Membuat Konfigurasi Promtail<button data-href="#1-Create-Promtail-Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Buat file konfigurasi <code translate="no">promtail.yaml</code>:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Install-Promtail" class="common-anchor-header">2. Instal Promtail<button data-href="#2-Install-Promtail" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Instal Promtail menggunakan Helm:</p>
