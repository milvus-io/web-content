...
<p>Jika Anda lebih suka menggunakan Pulsar V2 dengan Milvus v2.5.x, baca <a href="/docs/id/v2.5.x/use-pulsar-v2.md">Menggunakan Pulsar V2 dengan Milvus v2.5.x</a>.</p>
