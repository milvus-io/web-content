...
<div style="display: none;">- [Lakukan peningkatan bergilir] (#melakukan-peningkatan bergilir) dari Milvus v2.2.3 dan rilis yang lebih baru ke v2.5.16.</div>
<ul>
<li><p><a href="#Upgrade-Milvus-using-Helm">Tingkatkan Milvus menggunakan Helm</a> untuk peningkatan dari rilis minor sebelum v2.2.3 ke v2.5.16.</p></li>
<li><p><a href="#Migrate-the-metadata">Migrasi metadata</a> sebelum peningkatan dari Milvus v2.1.x ke v2.5.16.</p></li>
</ul>
...
<p>Setelah Anda memastikan bahwa semua deployment dalam instans Milvus Anda berada dalam status normal. Anda dapat menjalankan perintah berikut untuk memutakhirkan instans Milvus ke 2.5.16.</p>
...
<h4 id="2-Upgrade-Milvus-from-v21x-to-2516" class="common-anchor-header">2. Memutakhirkan Milvus dari v2.1.x ke 2.5.16</h4><p>Perintah berikut ini mengasumsikan bahwa Anda memutakhirkan Milvus dari v2.1.4 ke 2.5.16. Ubahlah ke versi yang sesuai dengan kebutuhan Anda.</p>
<ol>
