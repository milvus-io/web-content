...
summary: Pelajari cara mengonfigurasi streaming untuk Milvus.
---
<h1 id="streaming-related-Configurations" class="common-anchor-header">Konfigurasi terkait streaming<button data-href="#streaming-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Konfigurasi apa pun yang terkait dengan layanan streaming.</p>
<h2 id="streamingwalBalancertriggerInterval" class="common-anchor-header"><code translate="no">streaming.walBalancer.triggerInterval</code><button data-href="#streamingwalBalancertriggerInterval" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Interval pemicu tugas keseimbangan di latar belakang, 1 menit secara default. </li>      
        <li>Anda dapat mengaturnya ke dalam string durasi, seperti 30 detik atau 1m30 detik, lihat time.ParseDuration</li>      </td>
      <td>1m</td>
    </tr>
  </tbody>
</table>
<h2 id="streamingwalBalancerbackoffInitialInterval" class="common-anchor-header"><code translate="no">streaming.walBalancer.backoffInitialInterval</code><button data-href="#streamingwalBalancerbackoffInitialInterval" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Interval awal pemicu tugas keseimbangan mundur, 50 ms secara default. </li>      
        <li>Tidak masalah untuk mengaturnya ke dalam string durasi, seperti 30 detik atau 1m30 detik, lihat time.ParseDuration</li>      </td>
      <td>50ms</td>
    </tr>
  </tbody>
</table>
...
<h2 id="streamingwalBroadcasterconcurrencyRatio" class="common-anchor-header"><code translate="no">streaming.walBroadcaster.concurrencyRatio</code><button data-href="#streamingwalBroadcasterconcurrencyRatio" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Rasio konkurensi berdasarkan jumlah CPU untuk penyiar wal, 1 secara default.      </td>
      <td>1</td>
    </tr>
  </tbody>
</table>
<h2 id="streamingtxndefaultKeepaliveTimeout" class="common-anchor-header"><code translate="no">streaming.txn.defaultKeepaliveTimeout</code><button data-href="#streamingtxndefaultKeepaliveTimeout" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Batas waktu keepalive default untuk wal txn, 10 detik secara default      </td>
      <td>10s</td>
    </tr>
  </tbody>
</table>
