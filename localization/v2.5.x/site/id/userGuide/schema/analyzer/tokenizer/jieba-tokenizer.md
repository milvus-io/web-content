...
<h2 id="Configuration​" class="common-anchor-header">Konfigurasi<button data-href="#Configuration​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Untuk mengonfigurasi penganalisis menggunakan <code translate="no">jieba</code> tokenizer, setel <code translate="no">tokenizer</code> ke <code translate="no">jieba</code> di <code translate="no">analyzer_params</code>.</p>
