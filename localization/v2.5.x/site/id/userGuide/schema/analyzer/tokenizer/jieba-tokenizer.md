...
<table>
   ...
   <tr>
     ...
     <td><p>Daftar kamus yang digunakan untuk mendefinisikan kosakata. Anda dapat menyediakan kata-kata kamus Anda sendiri atau menggabungkannya dengan kamus default menggunakan <code translate="no">"_default_"</code>. Misalnya, <code translate="no">["_default_", "结巴分词器"]</code>.</p></td>
