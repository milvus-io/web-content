...
<h2 id="Configuration" class="common-anchor-header">Konfigurasi<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Untuk mengonfigurasi penganalisis menggunakan tokenizer <code translate="no">jieba</code>, setel <code translate="no">tokenizer</code> ke <code translate="no">jieba</code> di <code translate="no">analyzer_params</code>.</p>
...
<h2 id="Example-output" class="common-anchor-header">Contoh keluaran<button data-href="#Example-output" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Berikut adalah contoh bagaimana tokenizer <code translate="no">jieba</code> memproses teks:</p>
