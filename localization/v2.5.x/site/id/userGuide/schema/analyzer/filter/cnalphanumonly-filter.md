...
<p>Filter <code translate="no">cnalphanumonly</code> beroperasi berdasarkan ketentuan yang dihasilkan oleh tokenizer, sehingga harus digunakan bersama dengan tokenizer.</p>
...
<h2 id="Example-output​" class="common-anchor-header">Contoh keluaran<button data-href="#Example-output​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Berikut adalah contoh bagaimana penyaring <code translate="no">cnalphanumonly</code> memproses teks.</p>
