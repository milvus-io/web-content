...
title: Filter Khusus Alfanum
summary: >-
  Filter `alphanumonly` menghapus token yang berisi karakter non-ASCII, dan
...
<p>Filter <code translate="no">alphanumonly</code> beroperasi berdasarkan ketentuan yang dibuat oleh tokenizer, jadi filter ini harus digunakan bersama dengan tokenizer.</p>
...
<h2 id="Example-output​" class="common-anchor-header">Contoh keluaran<button data-href="#Example-output​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Berikut adalah contoh bagaimana penyaring <code translate="no">alphanumonly</code> memproses teks.</p>
