...
<h1 id="Dynamic-Field" class="common-anchor-header">Bidang Dinamis<button data-href="#Dynamic-Field" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Semua field yang didefinisikan dalam skema koleksi harus disertakan dalam entitas yang akan disisipkan. Jika Anda ingin beberapa field menjadi opsional, pertimbangkan untuk mengaktifkan field dinamis. Topik ini menjelaskan cara mengaktifkan dan menggunakan bidang dinamis.</p>
...
<h2 id="Enable-dynamic-field" class="common-anchor-header">Mengaktifkan bidang dinamis<button data-href="#Enable-dynamic-field" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Koleksi yang dibuat menggunakan metode yang dijelaskan di <a href="/docs/id/create-collection-instantly.md">Membuat Koleksi Seketika</a> memiliki bidang dinamis yang diaktifkan secara default. Anda juga dapat mengaktifkan bidang dinamis secara manual saat membuat koleksi dengan pengaturan khusus.</p>
