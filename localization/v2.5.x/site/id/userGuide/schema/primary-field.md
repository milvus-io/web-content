...
<h2 id="Use-VarChar-Primary-Keys" class="common-anchor-header">Menggunakan Kunci Primer VarChar<button data-href="#Use-VarChar-Primary-Keys" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Untuk menggunakan kunci primer VarChar, selain mengubah nilai parameter <code translate="no">data_type</code> menjadi <code translate="no">DataType.VARCHAR</code>, Anda juga perlu menyetel parameter <code translate="no">max_length</code> untuk field tersebut.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
