...
<p>Milvus mendukung nilai nol dan nilai default untuk field angka. Untuk mengaktifkan fitur-fitur ini, setel <code translate="no">nullable</code> ke <code translate="no">True</code> dan <code translate="no">default_value</code> ke nilai numerik. Untuk detailnya, lihat <a href="/docs/id/v2.5.x/nullable-and-default.md">Nullable &amp; Default</a>.</p>
</div>
