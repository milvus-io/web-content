...
title: Dapat dinolkan & Default
related_key: 'nullable, default'
summary: >-
  Milvus memungkinkan Anda untuk mengatur atribut `nullable` dan nilai default
  untuk field skalar, kecuali field utama. Untuk field yang ditandai sebagai
  ...
  memperlakukannya sebagai nol tanpa menyebabkan kesalahan.
---
<h1 id="Nullable--Default​" class="common-anchor-header">Dapat dinolkan &amp; Default<button data-href="#Nullable--Default​" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus memungkinkan Anda untuk mengatur atribut <code translate="no">nullable</code> dan nilai default untuk field skalar, kecuali field utama. Untuk field yang ditandai sebagai <code translate="no">nullable=True</code>, Anda dapat melewatkan field tersebut ketika memasukkan data, atau mengaturnya secara langsung ke nilai nol, dan sistem akan memperlakukannya sebagai nilai nol tanpa menyebabkan kesalahan. Ketika sebuah field memiliki nilai default, sistem akan secara otomatis menerapkan nilai ini jika tidak ada data yang ditentukan untuk field tersebut selama penyisipan.</p>
<p>Nilai default dan atribut yang dapat dinolkan menyederhanakan migrasi data dari sistem basis data lain ke Milvus dengan mengizinkan penanganan kumpulan data dengan nilai nol dan mempertahankan pengaturan nilai default. Ketika membuat koleksi, Anda juga dapat mengaktifkan nullable atau mengatur nilai default untuk field yang nilainya tidak pasti.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Search-and-query-with-null-values​" class="common-anchor-header">Penelusuran dan kueri dengan nilai null</h3><p>Saat menggunakan metode <code translate="no">search</code>, jika sebuah bidang berisi nilai <code translate="no">null</code>, hasil pencarian akan mengembalikan bidang tersebut sebagai null.</p>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Ketika Anda menggunakan metode <code translate="no">query</code> untuk pemfilteran skalar, hasil pemfilteran untuk nilai null akan bernilai salah, yang mengindikasikan bahwa nilai tersebut tidak akan dipilih.</p>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Untuk mengembalikan entitas dengan nilai nol, kueri tanpa kondisi pemfilteran skalar sebagai berikut:</p>
<div class="alert note">
<p>Metode <code translate="no">query</code>, ketika digunakan tanpa kondisi pemfilteran apa pun, akan mengambil semua entitas dalam koleksi, termasuk entitas dengan nilai nol. Untuk membatasi jumlah entitas yang dikembalikan, parameter <code translate="no">limit</code> harus ditentukan.</p>
</div>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
...
<h2 id="Default-values​" class="common-anchor-header">Nilai default<button data-href="#Default-values​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Nilai default adalah nilai yang telah ditetapkan sebelumnya yang ditetapkan ke bidang skalar. Jika Anda tidak memberikan nilai untuk bidang dengan nilai default selama penyisipan, sistem secara otomatis menggunakan nilai default.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Insert-entities" class="common-anchor-header">Menyisipkan entitas</h3><p>Saat memasukkan data, jika Anda menghilangkan bidang dengan nilai default atau mengatur nilainya menjadi nol, sistem akan menggunakan nilai default.</p>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
<pre><code translate="no" class="language-python">data = [​
...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>Untuk informasi lebih lanjut tentang bagaimana pengaturan nilai nol dan nilai default berlaku, lihat <a href="#applicable-rules">Aturan yang berlaku</a>.</p>
</div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Dalam operasi <code translate="no">query</code>, Anda dapat mencocokkan atau memfilter dengan nilai default secara langsung.</p>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
...
<tr><td>✅</td><td>❌</td><td>-</td><td>Tidak ada/null</td><td>Disimpan sebagai null</td><td><ul><li>Bidang:</li><li> <code translate="no">middle_name</code></li><li>Nilai default: -</li><li>Masukan</li><li>pengguna</li><li>: null</li><li>Hasil: disimpan sebagai null</td></tr>
<tr><td>❌</td><td>✅</td><td>Bukan null</td><td>Tidak ada/null</td><td>Menggunakan nilai default</td><td><ul><li>Bidang:</li><li> <code translate="no">status</code></li><li>Nilai default:</li><li> <code translate="no">&quot;active&quot;</code></li><li>Masukan pengguna: null</li><li>Hasil: disimpan sebagai <code translate="no">&quot;active&quot;</code></td></tr>
<tr><td>❌</td><td>❌</td><td>-</td><td>Tidak ada/null</td><td>Melemparkan kesalahan</td><td><ul><li>Bidang:</li><li> <code translate="no">email</code></li><li>Nilai default: -</li><li>Masukan</li><li>pengguna</li><li>: null</li><li>Hasil: Operasi ditolak, sistem melemparkan kesalahan</td></tr>
<tr><td>❌</td><td>✅</td><td>Null</td><td>Tidak ada/null</td><td>Melemparkan kesalahan</td><td><ul><li>Bidang:</li><li> <code translate="no">username</code></li><li>Nilai default: null</li><li>Masukan</li><li>pengguna</li><li>: null</li><li>Hasil: Operasi ditolak, sistem melemparkan kesalahan</td></tr>
</tbody>
</table>
