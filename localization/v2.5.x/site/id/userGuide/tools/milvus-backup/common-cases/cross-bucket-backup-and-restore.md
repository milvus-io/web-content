...
<h3 id="Step-3-Create-backup" class="common-anchor-header">Langkah 3: Buat cadangan</h3><p>Setelah backup.yaml disimpan, buat cadangan bernama <code translate="no">my_backup</code>:</p>
