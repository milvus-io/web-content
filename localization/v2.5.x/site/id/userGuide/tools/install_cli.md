...
<h3 id="Install-from-an-exe-file" class="common-anchor-header">Menginstal dari sebuah file .exe</h3><div class="alert note"> Metode instalasi ini hanya berlaku untuk Windows. </div>
