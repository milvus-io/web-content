...
<li><p>Untuk setiap sub-vektor kueri dan buku kode yang sesuai (berisi 2^{\textit{nbits}} centroid), hitung dan simpan jarak ke semua centroid.</p></li>
<li><p>Hal ini menghasilkan tabel pencarian <code translate="no">m</code>, di mana setiap tabel berisi jarak 2^{\textit{nbits}}.</p></li>
</ul></li>
