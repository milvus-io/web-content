...
<h2 id="List-Partitions​" class="common-anchor-header">Membuat Daftar Partisi<button data-href="#List-Partitions​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ketika membuat koleksi, Milvus juga membuat partisi bernama <strong>_default</strong> di dalam koleksi. Anda dapat membuat daftar partisi di dalam koleksi sebagai berikut.</p>
...
<h2 id="Check-for-a-Specific-Partition​" class="common-anchor-header">Memeriksa Partisi Tertentu<button data-href="#Check-for-a-Specific-Partition​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Cuplikan kode berikut ini menunjukkan bagaimana cara memeriksa apakah sebuah partisi ada di dalam koleksi tertentu.</p>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#go">Go</a> <a href="#curl">cURL</a></div>
