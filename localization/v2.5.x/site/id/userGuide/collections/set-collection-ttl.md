...
<ul>
<li><p><a href="/docs/id/v2.5.x/set-collection-ttl.md#Set-TTL-when-creating-a-collection">Membuat koleksi.</a></p></li>
<li><p><a href="/docs/id/v2.5.x/set-collection-ttl.md#Set-TTL-for-an-existing-collection">Mengubah properti TTL dari koleksi yang sudah ada.</a></p></li>
</ul>
