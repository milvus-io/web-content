...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Set-Collection-TTL​" class="common-anchor-header">Mengatur TTL Koleksi<button data-href="#Set-Collection-TTL​" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Untuk menghapus data kedaluwarsa secara otomatis dari koleksi Milvus, Anda dapat mengatur Time-To-Live (TTL) koleksi dalam hitungan detik. Setelah TTL berakhir, Milvus akan menandai data sebagai data kedaluwarsa dan menjadwalkannya untuk dihapus secara asinkron. Akibatnya, data mungkin masih muncul di hasil pencarian sampai proses penghapusan selesai sepenuhnya.</p>
<p>Cuplikan kode berikut ini menunjukkan cara mengubah TTL koleksi.</p>
<div class="multipleCode">
