...
<span class="hljs-punctuation">]</span>
<button class="copy-code-btn"></button></code></pre>
<p>Untuk informasi lebih lanjut tentang operator yang dapat Anda gunakan dalam pemfilteran metadata, lihat <a href="/docs/id/v2.5.x/filtering">Pemfilteran</a>.</p>
