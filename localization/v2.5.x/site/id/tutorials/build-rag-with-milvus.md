...
<h2 id="Preparation" class="common-anchor-header">Persiapan<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Dependencies-and-Environment" class="common-anchor-header">Ketergantungan dan Lingkungan</h3><pre><code translate="no" class="language-python">$ pip install --upgrade pymilvus openai requests tqdm
...
<h2 id="Quick-Deploy" class="common-anchor-header">Penerapan Cepat<button data-href="#Quick-Deploy" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Untuk mempelajari tentang cara memulai demo online dengan tutorial ini, silakan lihat <a href="https://github.com/milvus-io/bootcamp/tree/master/bootcamp/tutorials/quickstart/apps/rag_search_with_milvus">contoh aplikasi</a>.</p>
