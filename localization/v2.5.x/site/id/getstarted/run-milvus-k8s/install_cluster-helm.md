...
<li><p><a href="/docs/id/v2.5.x/prerequisite-helm.md#How-can-I-start-a-K8s-cluster-locally-for-test-purposes">Buat kluster K8s.</a></p></li>
...
<ul>
<li><p>Memeriksa <a href="/docs/id/v2.5.x/quickstart.md">Hello Milvus</a> untuk melihat apa yang dapat dilakukan Milvus.</p></li>
