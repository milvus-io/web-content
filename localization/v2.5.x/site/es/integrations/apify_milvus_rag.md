...
<h1 id="Retrieval-and-LLM-generative-pipeline" class="common-anchor-header">Recuperación y proceso generativo LLM<button data-href="#Retrieval-and-LLM-generative-pipeline" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
