...
<li><code translate="no">output_field_names</code> (str): El nombre del campo de salida, por defecto es <code translate="no">sparse</code>. Indica a qué campo da salida esta función el resultado calculado.</li>
</ul>
