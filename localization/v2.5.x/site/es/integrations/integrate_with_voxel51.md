...
<ul>
<li>Un <a href="/docs/es/v2.5.x/install_standalone-docker.md">servidor Milvus</a> en ejecución.</li>
...
<p>Para obtener información detallada sobre estos parámetros, consulte la <a href="/docs/es/v2.5.x/authenticate.md">documentación sobre autenticación</a> <a href="/docs/es/v2.5.x/consistency.md">de Milvus</a> y <a href="/docs/es/v2.5.x/consistency.md">la documentación sobre niveles de consistencia de Milvus</a>.</p>
