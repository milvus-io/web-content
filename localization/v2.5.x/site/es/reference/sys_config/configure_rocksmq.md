...
summary: Aprenda a configurar rocksmq para Milvus.
---
<h1 id="rocksmq-related-Configurations" class="common-anchor-header">Configuraciones relacionadas con rocksmq<button data-href="#rocksmq-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Si desea habilitar kafka, necesita comentar las configuraciones de pulsar</p>
<p>kafka:</p>
<p>brokerList:</p>
<p>saslUsername:</p>
<p>saslContraseña:</p>
...
<h2 id="rocksmqpath" class="common-anchor-header"><code translate="no">rocksmq.path</code><button data-href="#rocksmqpath" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>
        <li>Prefijo de la clave donde Milvus almacena los datos en RocksMQ.</li>      
        ...
        <li>Establezca un prefijo de clave raíz fácil de identificar para Milvus si el servicio etcd ya existe.</li>      </td>
...
<h2 id="rocksmqlrucacheratio" class="common-anchor-header"><code translate="no">rocksmq.lrucacheratio</code><button data-href="#rocksmqlrucacheratio" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Ratio de memoria caché rocksdb      </td>
      <td>0.06</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqrocksmqPageSize" class="common-anchor-header"><code translate="no">rocksmq.rocksmqPageSize</code><button data-href="#rocksmqrocksmqPageSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        El tamaño máximo de mensajes en cada página en RocksMQ. Los mensajes en RocksMQ se comprueban y borran (cuando caducan) por lotes basándose en este parámetro. Unidad: Byte.      </td>
      <td>67108864</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqretentionTimeInMinutes" class="common-anchor-header"><code translate="no">rocksmq.retentionTimeInMinutes</code><button data-href="#rocksmqretentionTimeInMinutes" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        El tiempo máximo de retención de mensajes acked en RocksMQ. Los mensajes acked en RocksMQ se retienen durante el período de tiempo especificado y luego se borran. Unidad: Minuto.      </td>
      <td>4320</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqretentionSizeInMB" class="common-anchor-header"><code translate="no">rocksmq.retentionSizeInMB</code><button data-href="#rocksmqretentionSizeInMB" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        El tamaño máximo de retención de mensajes acked de cada topic en RocksMQ. Los mensajes acked en cada topic son borrados si su tamaño excede este parámetro. Unidad: MB.      </td>
      <td>8192</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqcompactionInterval" class="common-anchor-header"><code translate="no">rocksmq.compactionInterval</code><button data-href="#rocksmqcompactionInterval" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Intervalo de tiempo para activar la compactación rocksdb para eliminar los datos borrados. Unidad: Segundo      </td>
      <td>86400</td>
    </tr>
  </tbody>
</table>
<h2 id="rocksmqcompressionTypes" class="common-anchor-header"><code translate="no">rocksmq.compressionTypes</code><button data-href="#rocksmqcompressionTypes" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Tipo de compresión de compactación, sólo admite el uso de 0,7. 0 significa no comprimir, 7 usará zstd. Longitud de tipos significa num de nivel rocksdb.      </td>
      <td>0,0,7,7,7</td>
    </tr>
  </tbody>
</table>
