...
<h2 id="Preparation" class="common-anchor-header">Preparación<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Download-the-dataset" class="common-anchor-header">Descargar el conjunto de datos</h3><p>El siguiente comando descargará los datos de ejemplo utilizados en <a href="https://github.com/anthropics/anthropic-cookbook/blob/main/skills/contextual-embeddings/guide.ipynb">la demostración</a> original de Anthropic.</p>
...
<h3 id="Install-Milvus-25" class="common-anchor-header">Instalar Milvus 2.5</h3><p>Consulte la <a href="https://milvus.io/docs/install_standalone-docker-compose.md">guía oficial de instalación</a> para más detalles.</p>
<h3 id="Install-PyMilvus" class="common-anchor-header">Instalar PyMilvus</h3><p>Ejecute el siguiente comando para instalar PyMilvus:</p>
<pre><code translate="no" class="language-python">pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span> -U 
<button class="copy-code-btn"></button></code></pre>
<h3 id="Define-the-Retriever" class="common-anchor-header">Definir el Recuperador</h3><pre><code translate="no" class="language-python"><span class="hljs-keyword">import</span> json
...
<h3 id="Insert-the-data" class="common-anchor-header">Inserte los datos</h3><pre><code translate="no" class="language-python">path = <span class="hljs-string">&quot;codebase_chunks.json&quot;</span>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Test-Sparse-Search" class="common-anchor-header">Probar la búsqueda dispersa</h3><pre><code translate="no" class="language-python">results = standard_retriever.search(<span class="hljs-string">&quot;create a logger?&quot;</span>, mode=<span class="hljs-string">&quot;sparse&quot;</span>, k=<span class="hljs-number">3</span>)
