...
title: Abandonar la recogida
---
<h1 id="Drop-Collection​" class="common-anchor-header">Abandonar la recogida<button data-href="#Drop-Collection​" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Puede abandonar una colección si ya no la necesita.</p>
<h2 id="Examples" class="common-anchor-header">Ejemplos<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Los siguientes fragmentos de código asumen que tienes una colección llamada <strong>customized_setup_2</strong>.</p>
