...
<ul>
<li><p><a href="/docs/es/v2.5.x/set-collection-ttl.md#Set-TTL-when-creating-a-collection">Crear una colección.</a></p></li>
<li><p><a href="/docs/es/v2.5.x/set-collection-ttl.md#Set-TTL-for-an-existing-collection">Modificar la propiedad TTL de una colección existente.</a></p></li>
</ul>
