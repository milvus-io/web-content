...
<h3 id="Match-query" class="common-anchor-header">Consulta de coincidencia<button data-href="#Match-query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>En Elasticsearch, una consulta de coincidencia devuelve documentos que coinciden con un texto, número, fecha o valor booleano proporcionado. El texto proporcionado se analiza antes de realizar la coincidencia.</p>
...
<h3 id="IDs" class="common-anchor-header">IDs<button data-href="#IDs" class="anchor-icon" translate="no">
    ...
    </button></h3><p>En Elasticsearch, puede encontrar documentos basándose en sus IDs en el contexto de filtrado como se indica a continuación:</p>
...
<h3 id="Prefix-query" class="common-anchor-header">Consulta de prefijo<button data-href="#Prefix-query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>En Elasticsearch, puede encontrar documentos que contengan un prefijo específico en un campo proporcionado en el contexto de filtrado de la siguiente manera:</p>
<pre><code translate="no" class="language-python">resp = client.search(
    query={
        <span class="hljs-string">&quot;bool&quot;</span>: {
            <span class="hljs-string">&quot;filter&quot;</span>: {
...
<h3 id="Range-query" class="common-anchor-header">Consulta de rango<button data-href="#Range-query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>En Elasticsearch, puede encontrar documentos que contengan términos dentro de un rango proporcionado como sigue:</p>
<pre><code translate="no" class="language-python">resp = client.search(
    query={
        <span class="hljs-string">&quot;bool&quot;</span>: {
            <span class="hljs-string">&quot;filter&quot;</span>: {
...
<h3 id="Term-query" class="common-anchor-header">Consulta de términos<button data-href="#Term-query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>En Elasticsearch, puede encontrar documentos que contengan un término <strong>exacto</strong> en un campo proporcionado como sigue:</p>
<pre><code translate="no" class="language-python">resp = client.search(
    query={
        <span class="hljs-string">&quot;bool&quot;</span>: {
            <span class="hljs-string">&quot;filter&quot;</span>: {
...
<h3 id="Terms-query" class="common-anchor-header">Consulta de términos<button data-href="#Terms-query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>En Elasticsearch, puede encontrar documentos que contengan uno o más términos <strong>exactos</strong> en un campo proporcionado de la siguiente manera:</p>
<pre><code translate="no" class="language-python">resp = client.search(
    query={
        <span class="hljs-string">&quot;bool&quot;</span>: {
            <span class="hljs-string">&quot;filter&quot;</span>: {
...
<h3 id="Wildcard-query" class="common-anchor-header">Consulta comodín<button data-href="#Wildcard-query" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>En Elasticsearch, puede encontrar documentos que contengan términos que coincidan con un patrón comodín de la siguiente manera:</p>
<pre><code translate="no" class="language-python">resp = client.search(
    query={
        <span class="hljs-string">&quot;bool&quot;</span>: {
            <span class="hljs-string">&quot;filter&quot;</span>: {
...
<h3 id="Knn-query" class="common-anchor-header">Consulta Knn<button data-href="#Knn-query" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Elasticsearch admite tanto consultas kNN aproximadas como consultas kNN exactas de fuerza bruta. Puede encontrar los <em>k</em> vectores más cercanos a un vector de consulta de cualquiera de las dos formas, medidos por una métrica de similitud, como se indica a continuación:</p>
<pre><code translate="no" class="language-python">resp = client.search(
...
<h3 id="Reciprocal-Rank-Fusion" class="common-anchor-header">Fusión de rango recíproco<button data-href="#Reciprocal-Rank-Fusion" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Elasticsearch proporciona la Fusión de Rango Recíproco (RRF) para combinar múltiples conjuntos de resultados con diferentes indicadores de relevancia en un único conjunto de resultados clasificados.</p>
...
<li><p><strong>Búsqueda de vectores dispersos</strong>: Utilización de la métrica de similitud BM25 en el campo <code translate="no">text_sparse</code>.</p></li>
</ol>
