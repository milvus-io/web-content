...
<p>Dado que utilizaremos el algoritmo integrado BM25 para realizar una búsqueda de texto completo en el campo de texto, es necesario añadir el Milvus <code translate="no">Function</code> al esquema. Para más detalles, consulte <a href="/docs/es/v2.5.x/full-text-search.md">Búsqueda de texto completo</a>.</p>
...
<p>Además, configurando el parámetro <code translate="no">expr</code> en un <code translate="no">AnnSearchRequest</code>, puede establecer las condiciones de filtrado para su búsqueda híbrida. Consulte <a href="/docs/es/v2.5.x/filtered-search.md">Búsqueda filtrada</a> y <a href="/docs/es/v2.5.x/boolean.md">filtrado</a>.</p>
...
<h3 id="Configure-a-reranking-strategy" class="common-anchor-header">Configurar una estrategia de reordenación<button data-href="#Configure-a-reranking-strategy" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Para combinar y reordenar los conjuntos de resultados de búsqueda de RNA, es esencial seleccionar una estrategia de reordenación adecuada. Milvus ofrece dos tipos de estrategias de reordenación:</p>
<ul>
...
<p>Para obtener más información sobre estos mecanismos de reordenación, consulte <a href="/docs/es/v2.5.x/reranking.md">Reordenación</a>.</p>
