...
<table>
   ...
   <tr>
     ...
     <td><p>Para ignorar las incrustaciones vectoriales más similares, asegúrese de que <code translate="no">range_filter</code> &lt;= distancia &lt; <code translate="no">radius</code></p></td>
   </tr>
   <tr>
     <td><p><code translate="no">IP</code></p></td>
     <td><p>Una distancia IP mayor indica una mayor similitud.</p></td>
     <td><p>Para ignorar las incrustaciones vectoriales más similares, asegúrese de que <code translate="no">radius</code> &lt; distancia &lt;= <code translate="no">range_filter</code></p></td>
   </tr>
   <tr>
