...
<table>
   ...
   <tr>
     ...
     <td><p>Proporción de términos de baja importancia que deben ignorarse durante la búsqueda. Para más detalles, consulte <a href="/docs/es/v2.5.x/sparse_vector.md">Vector disperso</a>.</p></td>
   </tr>
   <tr>
