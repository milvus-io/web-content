...
<table>
   ...
   <tr>
     ...
     <td><p>Proporción de términos de baja importancia que deben ignorarse durante la búsqueda. Para obtener más información, consulte <a href="/docs/es/v2.5.x/sparse_vector.md">Vector disperso</a>.</p></td>
   </tr>
   <tr>
     <td></td>
     <td></td>
   ...
   <tr>
     ...
     <td><p>El texto en bruto de la consulta.</p></td>
   </tr>
   <tr>
     <td><p><code translate="no">anns_field</code></p></td>
     <td><p>Nombre del campo que contiene los vectores dispersos generados internamente.</p></td>
   </tr>
   <tr>
