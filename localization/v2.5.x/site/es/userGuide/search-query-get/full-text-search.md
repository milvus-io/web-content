...
<h3 id="Configure-the-index" class="common-anchor-header">Configurar el índice</h3><p>Después de definir el esquema con los campos necesarios y la función incorporada, configure el índice para su colección. El ejemplo siguiente crea un <code translate="no">SPARSE_INVERTED_INDEX</code> con el tipo de métrica <code translate="no">BM25</code>.</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
