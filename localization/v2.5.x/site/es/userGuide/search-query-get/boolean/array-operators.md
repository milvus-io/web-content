...
<li><p><code translate="no">ARRAY_CONTAINS_ALL(identifier, expr)</code>: comprueba si todos los elementos de la lista especificada están presentes en el campo de matriz.</p></li>
