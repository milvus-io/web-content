...
<p>
   ...
   </span> <span class="img-wrapper"> <span>uso de vectores binarios</span> </span></p>
<div class="alert note">
<p>Aunque los vectores binarios destacan en escenarios específicos, tienen limitaciones en su capacidad expresiva, lo que dificulta la captura de relaciones semánticas complejas. Por lo tanto, en escenarios reales, los vectores binarios se utilizan a menudo junto con otros tipos de vectores para equilibrar eficiencia y expresividad. Para más información, consulte <a href="/docs/es/dense-vector.md">Vector denso</a> y <a href="/docs/es/sparse_vector.md">Vector disperso</a>.</p>
</div>
