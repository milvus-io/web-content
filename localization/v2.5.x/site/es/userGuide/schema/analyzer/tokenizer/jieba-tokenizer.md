...
<h2 id="Configuration" class="common-anchor-header">Configuración<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Para configurar un analizador que utilice el tokenizador <code translate="no">jieba</code>, establezca <code translate="no">tokenizer</code> en <code translate="no">jieba</code> en <code translate="no">analyzer_params</code>.</p>
...
<h2 id="Example-output" class="common-anchor-header">Ejemplo de salida<button data-href="#Example-output" class="anchor-icon" translate="no">
    ...
    </button></h2><p>A continuación se muestra un ejemplo de cómo procesa el texto el tokenizador <code translate="no">jieba</code>:</p>
