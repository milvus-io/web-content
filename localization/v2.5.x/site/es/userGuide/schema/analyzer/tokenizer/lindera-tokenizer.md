...
<table>
   ...
   <tr>
     ...
     <td><p>Una lista de diccionarios utilizados para definir el vocabulario. Valores posibles:</p>
<ul>
<li><p><code translate="no">ipadic</code>: Japonés</p></li>
<li><p><code translate="no">ko-dic</code>: Coreano</p></li>
<li><p><code translate="no">cc-cedict</code>: Chino mandarín (tradicional/simpl.)</p></li>
</ul></td>
   </tr>
</table>
