...
title: Tokenizador de espacios en blanco
summary: >-
  El tokenizador `whitespace` divide el texto en términos siempre que haya un
...
<p>El tokenizador de espacios en blanco puede funcionar junto con uno o más filtros. Por ejemplo, el siguiente código define un analizador que utiliza el tokenizador <code translate="no">whitespace</code> y los filtros <a href="/docs/es/lowercase-filter.md"><code translate="no">lowercase filter</code></a>:</p>
<pre><code translate="no" class="language-python">analyzer_params = {​
    <span class="hljs-string">&quot;tokenizer&quot;</span>: <span class="hljs-string">&quot;whitespace&quot;</span>,​
...
<h2 id="Example-output​" class="common-anchor-header">Ejemplo de salida<button data-href="#Example-output​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>A continuación se muestra un ejemplo de cómo procesa el texto el tokenizador <code translate="no">whitespace</code>.</p>
