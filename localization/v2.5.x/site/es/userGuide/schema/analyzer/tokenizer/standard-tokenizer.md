...
<p>For simpler setup, you may choose to use the <a href="/docs/standard-analyzer.md"><code translate="no">standard analyzer</code></a>, which combines the <code translate="no">standard</code> tokenizer with the <a href="/docs/lowercase-filter.md"><code translate="no">lowercase filter</code></a>.​</p>
</div>
