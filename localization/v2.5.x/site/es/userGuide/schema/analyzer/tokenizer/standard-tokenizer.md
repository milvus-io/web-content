...
summary: >-
  El tokenizador estándar de Milvus divide el texto en función de los espacios y
...
<h2 id="Configuration" class="common-anchor-header">Configuración<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Para configurar un analizador utilizando el tokenizador <code translate="no">standard</code>, establezca <code translate="no">tokenizer</code> en <code translate="no">standard</code> en <code translate="no">analyzer_params</code>.</p>
...
<p>Después de definir <code translate="no">analyzer_params</code>, puede aplicarlos a un campo <code translate="no">VARCHAR</code> al definir un esquema de colección. Esto permite a Milvus procesar el texto de ese campo utilizando el analizador especificado para una tokenización y filtrado eficientes. Para más detalles, consulte <a href="/docs/es/analyzer-overview.md#null">Ejemplo de uso</a>.</p>
