...
title: Detener
summary: >-
  El filtro de parada elimina las palabras de parada especificadas del texto
  tokenizado, lo que ayuda a eliminar las palabras comunes y menos
  significativas. Puede configurar la lista de palabras de parada mediante el
...
<h2 id="Configuration" class="common-anchor-header">Configuración<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>El filtro <code translate="no">stop</code> es un filtro personalizado de Milvus. Para usarlo, especifique <code translate="no">&quot;type&quot;: &quot;stop&quot;</code> en la configuración del filtro, junto con un parámetro <code translate="no">stop_words</code> que proporciona una lista de palabras de parada.</p>
