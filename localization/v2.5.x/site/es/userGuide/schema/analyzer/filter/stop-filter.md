...
<table>
   ...
   <tr>
     ...
     <td><p>Una lista de palabras que deben eliminarse de la tokenización. Por defecto, se utiliza la lista predefinida <code translate="no">_english_</code>, que contiene palabras de parada comunes en inglés. Los detalles de <code translate="no">_english_</code> pueden consultarse <a href="https://github.com/milvus-io/milvus/blob/master/internal/core/thirdparty/tantivy/tantivy-binding/src/stop_words.rs">aquí</a>.</p></td>
   </tr>
</table>
