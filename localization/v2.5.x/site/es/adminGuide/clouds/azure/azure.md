...
<h2 id="Hello-Milvus" class="common-anchor-header">Hola Milvus<button data-href="#Hello-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Consulte <a href="https://milvus.io/docs/v2.3.x/example_code.md">Hola</a> Milvus, cambie el valor de host a dirección IP externa y, a continuación, ejecute el código.</p>
...
<li><a href="/docs/es/v2.5.x/gcp.md">Despliegue Milvus Cluster en GCP con Kubernetes</a></li>
</ul>
