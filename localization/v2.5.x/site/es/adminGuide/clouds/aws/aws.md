...
<p>Este tema está obsoleto y se eliminará pronto. En su lugar, le recomendamos que consulte <a href="/docs/es/v2.5.x/eks.md">Despliegue de un clúster Milvus en EKS</a>.</p>
</div>
...
<ul>
<li><a href="/docs/es/v2.5.x/eks.md">Despliegue un Cluster Milvus en EKS</a></li>
<li><a href="/docs/es/v2.5.x/gcp.md">Despliegue un Cluster Milvus en GCP con Kubernetes</a></li>
<li><a href="/docs/es/v2.5.x/azure.md">Guía para implementar Milvus en Microsoft Azure con Kubernetes</a></li>
</ul>
