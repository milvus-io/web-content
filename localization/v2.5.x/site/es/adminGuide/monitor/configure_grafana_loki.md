...
<p>Como referencia, <a href="https://grafana.com/docs/loki/latest/send-data/promtail/#promtail-agent">Promtail</a> quedará obsoleto, por lo que introduciremos Alloy, que ha sido sugerido oficialmente por Grafana Labs como el nuevo agente para recopilar registros de Kubernetes y reenviarlos a Loki.</p>
