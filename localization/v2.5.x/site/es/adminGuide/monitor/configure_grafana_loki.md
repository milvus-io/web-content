...
<h3 id="1-Create-Promtail-Configuration" class="common-anchor-header">1. Crear la configuración de Promtail<button data-href="#1-Create-Promtail-Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Cree un archivo de configuración <code translate="no">promtail.yaml</code>:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Install-Promtail" class="common-anchor-header">2. Instalar Promtail<button data-href="#2-Install-Promtail" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Instalar Promtail usando Helm:</p>
...
<h3 id="1-Deploy-Grafana" class="common-anchor-header">1. Despliegue de Grafana<button data-href="#1-Deploy-Grafana" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
