...
<li>Aprender a <a href="/docs/es/v2.5.x/alert.md">crear una alerta para los servicios de Milvus</a></li>
<li>Ajustar su <a href="/docs/es/v2.5.x/allocate.md">asignación de recursos</a></li>
<li><a href="/docs/es/v2.5.x/scaleout.md">Reducir o ampliar un clúster Milvus</a></li>
</ul></li>
