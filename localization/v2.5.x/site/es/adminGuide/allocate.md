...
<ul>
<li><a href="/docs/es/v2.5.x/allocate.md#Allocate-resources-with-commands">Utilice los comandos</a></li>
<li><a href="/docs/es/v2.5.x/allocate.md#Allocate-resources-by-setting-configuration-file">Establezca los parámetros en el archivo <code translate="no">YAML</code> </a></li>
</ul>
...
<li><a href="/docs/es/v2.5.x/upgrade_milvus_cluster-operator.md">Actualizar Milvus Cluster</a></li>
<li><a href="/docs/es/v2.5.x/upgrade_milvus_standalone-operator.md">Actualizar Milvus Standalone</a></li>
</ul></li>
