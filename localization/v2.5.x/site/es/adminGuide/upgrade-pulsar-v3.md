...
<p>Si prefiere utilizar Pulsar V2 con <a href="/docs/es/v2.5.x/use-pulsar-v2.md">Milvus</a> v2.5.x, lea <a href="/docs/es/v2.5.x/use-pulsar-v2.md">Utilizar Pulsar V2 con Milvus v2.5.x</a>.</p>
