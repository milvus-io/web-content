...
<ul>
<li>Para actualizar Milvus desde v2.2.3 o versiones posteriores a 2.5.9, puede <a href="#Conduct-a-rolling-upgrade">realizar una actualización continua</a>.</li>
<li>Para actualizar Milvus desde una versión menor anterior a v2.2.3 a 2.5.9, se recomienda <a href="#Upgrade-Milvus-by-changing-its-image">actualizar Milvus cambiando su versión de imagen</a>.</li>
<li>Para actualizar Milvus de v2.1.x a 2.5.9, debe <a href="#Migrate-the-metadata">migrar los metadatos</a> antes de la actualización.</li>
</ul>
