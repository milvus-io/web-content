...
<p>Una vez que se haya asegurado de que todos los despliegues de su instancia de Milvus están en su estado normal. Puede ejecutar el siguiente comando para actualizar la instancia de Milvus a 2.5.1.</p>
...
<h4 id="2-Upgrade-Milvus-from-v21x-to-251" class="common-anchor-header">2. Actualizar Milvus de v2.1.x a 2.5.1</h4><p>Los siguientes comandos asumen que usted actualiza Milvus de v2.1.4 a 2.5.1. Cámbielos por las versiones que se ajusten a sus necesidades.</p>
<ol>
