...
<p>Todos los ejemplos de código de esta página están en PyMilvus 2.5.11. Actualiza tu instalación de PyMilvus antes de ejecutarlos.</p>
</div>
<ol>
...
<ul>
<li><a href="/docs/es/v2.5.x/rbac.md">Habilitar RBAC</a></li>
<li><a href="/docs/es/v2.5.x/users_and_roles.md">Usuarios y roles</a></li>
</ul>
