...
<p>El nombre del modelo de incrustación mGTE que se utilizará para la codificación. El valor por defecto es <code translate="no">Alibaba-NLP/gte-multilingual-base</code>.</p></li>
</ul>
