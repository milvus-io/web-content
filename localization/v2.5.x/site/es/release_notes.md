...
<p>¡Nos complace anunciar Milvus 2.5.16! Esta versión mejora su experiencia corrigiendo una serie de errores de funcionalidad y mejorando la experiencia del usuario. También ofrece una serie de mejoras generales de rendimiento y estabilidad, al tiempo que resuelve numerosos errores para garantizar un sistema más robusto. Le animamos a actualizar a la versión 2.5.16 y a explorar estas últimas actualizaciones.</p>
<h3 id="Improvements" class="common-anchor-header">Mejoras</h3><ul>
<li>Eliminada la validación del nombre de la colección de <code translate="no">DescribeCollection</code> <a href="https://github.com/milvus-io/milvus/pull/43300">(#43300</a>).</li>
<li>Archivo mmap desvinculado cuando se destruyen chunk e index<a href="https://github.com/milvus-io/milvus/pull/43546">(#43546</a>).</li>
<li>Utilizado el elemento set para el tipo de término string<a href="https://github.com/milvus-io/milvus/pull/43393">(#43393</a>).</li>
<li>Actualizada la versión Go a 1.24.4 para corregir CVEs<a href="https://github.com/milvus-io/milvus/pull/43467">(#43467</a>).</li>
<li>Sólo se descargan los campos necesarios durante la fase de análisis de clustering<a href="https://github.com/milvus-io/milvus/pull/43362">(#43362</a>).</li>
<li>Actualizada la versión de Lindera<a href="https://github.com/milvus-io/milvus/pull/43457">(#43457</a>).</li>
<li>Optimizado el balanceo de nodos de canal para una distribución desigual de QueryNode<a href="https://github.com/milvus-io/milvus/pull/43423">(#43423</a>).</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">Corrección de errores</h3><ul>
<li>Corregida la búsqueda híbrida para soportar offset param en RESTful API<a href="https://github.com/milvus-io/milvus/pull/43721">(#43721</a>).</li>
<li>Corregido el pánico del tokenizador Jieba cuando la palabra dict era una cadena vacía<a href="https://github.com/milvus-io/milvus/pull/43718">(#43718</a>).</li>
<li>Corregida la recuperación de datos span raw para tipos de datos de longitud variable<a href="https://github.com/milvus-io/milvus/pull/43703">(#43703</a>).</li>
<li>Incrementado el desplazamiento para filas de datos inválidos en el índice invertido de estadísticas de claves JSON<a href="https://github.com/milvus-io/milvus/pull/43688">(#43688</a>).</li>
<li>Corregido fallo de carga de cambios de configuración tras reinicio<a href="https://github.com/milvus-io/milvus/pull/43555">(#43555</a>).</li>
<li>Corregido pk en [...] omitir siguiente lote cuando se utiliza segmento multi-chunk<a href="https://github.com/milvus-io/milvus/pull/43619">(#43619</a>).</li>
<li>Se omite la carga de segmentos L0 inexistentes para evitar el bloqueo de la carga<a href="https://github.com/milvus-io/milvus/pull/43576">(#43576</a>).</li>
<li>Limpieza de la caché de privilegios después de cargar la política en <code translate="no">InitPolicyInfo</code> <a href="https://github.com/milvus-io/milvus/pull/43643">(#4643</a>).</li>
<li>Establecer estado cuando el error no está vacío<a href="https://github.com/milvus-io/milvus/pull/43404">(#43404</a>).</li>
<li>Devuelto ID por defecto<a href="https://github.com/milvus-io/milvus/pull/43596">(#43596</a>).</li>
<li>Arreglado fallo de recuperación de vistas de cadena debido a bucle vacío ligado a chunk<a href="https://github.com/milvus-io/milvus/pull/43482">(#43482</a>).</li>
<li>Ignorado proxy 2.6 para evitar timetick lag<a href="https://github.com/milvus-io/milvus/pull/43519">(#43519</a>).</li>
<li>Asegurado el orden de ejecución de tareas mediante el uso de una cola de prioridad<a href="https://github.com/milvus-io/milvus/pull/43272">(#43272</a>).</li>
<li>Refinado el juicio para las vistas por lotes<a href="https://github.com/milvus-io/milvus/pull/43479">(#43479</a>).</li>
</ul>
<h2 id="v2515" class="common-anchor-header">v2.5.15<button data-href="#v2515" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Fecha de lanzamiento: 23 de julio de 2025</p>
<table>
<thead>
<tr><th>Versión de Milvus</th><th>Versión del SDK de Python</th><th>Versión del SDK de Node.js</th><th>Versión del SDK de Java</th></tr>
</thead>
...
<p>¡Nos complace anunciar Milvus 2.5.15! Esta versión mejora su experiencia corrigiendo una serie de errores de funcionalidad, incluidos los que pueden dañar gravemente los metadatos causando la pérdida de datos cuando se cambia el nombre de la colección. También ofrece una serie de mejoras generales de rendimiento y estabilidad, al tiempo que resuelve numerosos errores para garantizar un sistema más robusto. <strong>Le animamos a actualizar a la versión 2.5.15, sobre todo si utiliza la 2.5.14, y a explorar estas últimas actualizaciones.</strong></p>
<h3 id="Improvements" class="common-anchor-header">Mejoras</h3><ul>
<li>Actualización de la versión Knowhere para corregir un error de fuerza bruta de vectores dispersos<a href="https://github.com/milvus-io/milvus/pull/43398">(#43398</a>).</li>
<li>Implementado meta ahorro con límites txn<a href="https://github.com/milvus-io/milvus/pull/43287">(#43287</a>).</li>
<li>Aplicado cambios de configuración de carga después de reiniciar QueryCoord<a href="https://github.com/milvus-io/milvus/pull/43236">(#43236</a>).</li>
<li>Refinado el uso de memoria de tipo variable-length<a href="https://github.com/milvus-io/milvus/pull/43093">(#43093</a>).</li>
<li>Reordenado el apagado de RootCoord para que sea el último en la secuencia de parada del coordinador<a href="https://github.com/milvus-io/milvus/pull/43024">(#43024</a>).</li>
<li>Actualizada la versión de CMake a 3.31.8<a href="https://github.com/milvus-io/milvus/pull/43004">(#43004</a>).</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">Corrección de errores</h3><ul>
<li>Se omitía la operación de eliminación si la clave existía en el conjunto guardado<a href="https://github.com/milvus-io/milvus/pull/43426">(#43426</a>).</li>
<li>Se ha corregido la alineación de mapas de bits nulos al cargar datos de varios trozos<a href="https://github.com/milvus-io/milvus/pull/43411">(#43411</a>, <a href="https://github.com/milvus-io/milvus/pull/43342">#43342</a>).</li>
<li>Se ha actualizado Tantivy para corregir la condición de carrera en la eliminación de directorios<a href="https://github.com/milvus-io/milvus/pull/43401">(#43401</a>).</li>
<li>Corregido un problema al llamar a <code translate="no">AlterCollection</code> sólo cuando se renombran colecciones<a href="https://github.com/milvus-io/milvus/pull/43421">(#43421</a>).</li>
<li><code translate="no">MultiSaveAndRemove</code> ejecuta primero las operaciones de eliminación<a href="https://github.com/milvus-io/milvus/pull/43409">(#43409</a>).</li>
<li>Utilización del tamaño máximo de segmento de disco para colecciones con vectores tanto dispersos como densos<a href="https://github.com/milvus-io/milvus/pull/43195">(#43195</a>).</li>
<li>Se ha corregido el error de coincidencia de texto adaptándolo al modelo de trozos múltiples<a href="https://github.com/milvus-io/milvus/pull/43297">(#43297</a>).</li>
<li>Corregido conjunto de bits incorrecto para la comparación de división cuando el operando derecho es negativo<a href="https://github.com/milvus-io/milvus/pull/43180">(#43180</a>).</li>
<li>Anulada la copia innecesaria al obtener trozos JSON<a href="https://github.com/milvus-io/milvus/pull/43183">(#43183</a>, <a href="https://github.com/milvus-io/milvus/pull/43202">#43202</a>).</li>
<li>Se ha evitado que el delegador quede inservible debido a cambios en el líder del fragmento<a href="https://github.com/milvus-io/milvus/pull/43309">(#43309</a>).</li>
<li>Arreglado el índice de coincidencia de texto y las fugas del índice de estadísticas clave JSON cuando se liberan segmentos<a href="https://github.com/milvus-io/milvus/pull/43308">(#43308</a>).</li>
<li>Corregido el fallo de <code translate="no">RegeneratePartitionStats</code> después de restaurar tareas de compactación de agrupaciones<a href="https://github.com/milvus-io/milvus/pull/43206">(#43206</a>).</li>
<li>Añadido tratamiento de errores para parámetros de función no válidos para evitar pánicos<a href="https://github.com/milvus-io/milvus/pull/43190">(#43190</a>).</li>
<li>Eliminada la lógica de recorte de espacios al validar nombres de colecciones<a href="https://github.com/milvus-io/milvus/pull/43138">(#43138</a>).</li>
<li>Añadida la comprobación de propiedades mmap de campo antes de aplicar ajustes a nivel de colección<a href="https://github.com/milvus-io/milvus/pull/43091">(#43091</a>).</li>
<li>Corregida la creación de índices bloqueada por estadísticas de ordenación fallidas<a href="https://github.com/milvus-io/milvus/pull/43061">(#43061</a>).</li>
<li>Corregida la lógica de exclusión de nodos en el mecanismo de reintento del balanceador de carga<a href="https://github.com/milvus-io/milvus/pull/43002">(#43002</a>).</li>
</ul>
<h2 id="v2514" class="common-anchor-header">v2.5.14<button data-href="#v2514" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Fecha de lanzamiento: 2 de julio de 2025</p>
<table>
<thead>
...
<p>¡Nos complace anunciar Milvus 2.5.14! Esta versión ofrece una serie de mejoras de rendimiento y estabilidad, incluido un grupo de caché de trozos independiente, autoindexación para campos JSON y caché local para estadísticas de segmentos BM25. Esta versión también resuelve varios errores críticos, como la explosión de un hilo en el vigilante de archivos y posibles ataques de pánico en QueryCoord, para garantizar un sistema más robusto y fiable. Le animamos a actualizar a la versión 2.5.14 para beneficiarse de estas últimas actualizaciones.</p>
<h3 id="Dependency-upgrade" class="common-anchor-header">Actualización de dependencias</h3><ul>
<li>Actualización de Minio a RELEASE.2024-05-28T17-19-04Z para corregir algunos CVE<a href="https://github.com/milvus-io/milvus/pull/43063">(#43063</a>).</li>
</ul>
<h3 id="Improvements" class="common-anchor-header">Mejoras</h3><ul>
<li>Añadido un grupo de caché de trozos independiente<a href="https://github.com/milvus-io/milvus/pull/42901">(#42901</a>).</li>
<li>Añadido soporte para <code translate="no">AUTOINDEX</code> en campos JSON<a href="https://github.com/milvus-io/milvus/pull/42161">(#42161</a>).</li>
<li>Utilización del nombre en inglés como identificador de idioma para todos los tipos de idioma<a href="https://github.com/milvus-io/milvus/pull/42601">(#42601</a>).</li>
<li>Habilitada la ejecución de un analizador por un campo de colección<a href="https://github.com/milvus-io/milvus/pull/42812">(#42812</a>).</li>
<li>Actualizada la versión de Knowhere<a href="https://github.com/milvus-io/milvus/pull/42939">(#42939</a>).</li>
<li>Añadida una interfaz de tamaño al lector de ficheros para eliminar las llamadas a <code translate="no">statobject</code> durante las lecturas<a href="https://github.com/milvus-io/milvus/pull/42911">(#42911</a>).</li>
<li>Introducida una caché local para las estadísticas de segmento BM25<a href="https://github.com/milvus-io/milvus/pull/42924">(#42924</a>, <a href="https://github.com/milvus-io/milvus/pull/42646">#42646</a>).</li>
<li>Rellenado de <code translate="no">dbname</code> para <code translate="no">operateprivilegev2request</code> en el interceptor<a href="https://github.com/milvus-io/milvus/pull/42904">(#42904</a>).</li>
<li>Se ha evitado modificar los metadatos de campo al renombrar una colección o base de datos<a href="https://github.com/milvus-io/milvus/pull/42876">(#42876</a>).</li>
<li>La interfaz de usuario web se puede activar y desactivar a través de la configuración<a href="https://github.com/milvus-io/milvus/pull/42815">(#42815</a>).</li>
<li>Evitar el uso del grupo de hilos cuando una columna está lista en la caché de trozos<a href="https://github.com/milvus-io/milvus/pull/42804">(#42804</a>).</li>
<li>Habilitado el colector Tantivy para establecer bitset directamente<a href="https://github.com/milvus-io/milvus/pull/39748">(#39748</a>, <a href="https://github.com/milvus-io/milvus/pull/42881">#42881</a>).</li>
<li>Sustitución de claves de mapa basadas en punteros por ID en el recolector de basura<a href="https://github.com/milvus-io/milvus/pull/42654">(#42654</a>).</li>
<li>Optimizado el uso de memoria durante la recolección de basura<a href="https://github.com/milvus-io/milvus/pull/42631">(#42631</a>).</li>
<li>Añadido soporte para imprimir NQ y parámetros para registros de búsqueda y consulta<a href="https://github.com/milvus-io/milvus/pull/42545">(#42545</a>).</li>
<li>Gestión correcta de los valores nulos y predeterminados durante la inserción masiva<a href="https://github.com/milvus-io/milvus/pull/42072">(#42072</a>).</li>
<li>Fijación de nombres de hilos para el grupo de hilos Segcore<a href="https://github.com/milvus-io/milvus/pull/42596">(#42596</a>).</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">Corrección de errores</h3><ul>
<li>Preasignación de suficientes IDs durante la importación de datos para evitar fallos<a href="https://github.com/milvus-io/milvus/pull/42935">(#42935</a>).</li>
<li>Actualización de Tantivy para corregir una explosión de hilos en el observador de archivos<a href="https://github.com/milvus-io/milvus/pull/42828">(#42828</a>, <a href="https://github.com/milvus-io/milvus/pull/42713">#42713</a>).</li>
<li>Solucionado un problema por el que los datos filtrados se volvían invisibles bajo TTL<a href="https://github.com/milvus-io/milvus/pull/42944">(#42944</a>).</li>
<li>Se han eliminado los resultados de expresiones nulas almacenados en caché para evitar un filtrado incorrecto<a href="https://github.com/milvus-io/milvus/pull/42783">(#42783</a>).</li>
<li>Rechazada la división o módulo por cero en expresiones aritméticas binarias<a href="https://github.com/milvus-io/milvus/pull/42887">(#42887</a>).</li>
<li>Se ha garantizado que el grafo de flujo libere los recursos de la función una vez cerrados todos los nodos<a href="https://github.com/milvus-io/milvus/pull/42775">(#42775</a>).</li>
<li>Se ha corregido un problema por el que DataCoord podía atascarse durante una actualización de v2.5 a v2.6<a href="https://github.com/milvus-io/milvus/pull/42669">(#42669</a>).</li>
<li>Se ha añadido una comprobación previa para evitar la conversión de tipos de datos no admitidos<a href="https://github.com/milvus-io/milvus/pull/42678">(#42678</a>).</li>
<li>Añadida protección de concurrencia y cierre para la función BM25<a href="https://github.com/milvus-io/milvus/pull/42599">(#42599</a>).</li>
<li>Filtrado de los nodos de consulta de streaming del grupo de recursos durante las actualizaciones<a href="https://github.com/milvus-io/milvus/pull/42594">(#42594</a>).</li>
<li>Solucionado un problema con las expresiones <code translate="no">is_not_in</code> para el índice Trie<a href="https://github.com/milvus-io/milvus/pull/42886">(#42886</a>).</li>
<li>Se ha corregido un problema que impedía que Rocksmq se detuviera correctamente<a href="https://github.com/milvus-io/milvus/pull/42843">(#42843</a>).</li>
<li>Se ha corregido la optimización de la poda de las expresiones lógicas de <code translate="no">OR</code> para que sólo se poden si los nodos hijos son podables<a href="https://github.com/milvus-io/milvus/pull/42915">(#42915</a>).</li>
<li>Se ha corregido una situación de pánico de QueryCoord provocada por el controlador que no esperaba a que finalizara el comprobador<a href="https://github.com/milvus-io/milvus/pull/42726">(#42726</a>).</li>
<li>Se ha corregido un problema por el que los segmentos pequeños perdían las tareas de ordenación de clave primaria debido a que se marcaban incorrectamente como indexados<a href="https://github.com/milvus-io/milvus/pull/42615">(nº 42615</a>).</li>
<li>Reducción de la concurrencia total de tareas DataNode en modo autónomo para evitar errores de OOM<a href="https://github.com/milvus-io/milvus/pull/42809">(#42809</a>).</li>
<li>Errores explícitos para operaciones aritméticas en tipos no soportados<a href="https://github.com/milvus-io/milvus/pull/42890">(#42890</a>).</li>
</ul>
...
<li>La interfaz <code translate="no">DescribeIndex</code> ahora muestra información sobre la versión del índice<a href="https://github.com/milvus-io/milvus/pull/41841">(#41841</a>).</li>
...
<li><code translate="no">GetValueFromConfig</code> ahora devuelve <code translate="no">nullopt</code> en lugar de lanzar una excepción<a href="https://github.com/milvus-io/milvus/pull/41711">(#41711</a>).</li>
...
<li>Se ha añadido un filtro <code translate="no">remove_punct</code> para eliminar los signos de puntuación. Para más información, consulte <a href="/docs/es/v2.5.x/removepunct-filter.md">Eliminar signos de puntuación</a>.</li>
...
<p>Para más detalles, consulte <a href="/docs/es/v2.5.x/milvus-webui.md">Milvus WebUI</a>.</p>
...
<p>Para obtener más información, consulte <a href="/docs/es/v2.5.x/analyzer-overview.md">Visión general del analizador</a> y <a href="/docs/es/v2.5.x/keyword-match.md">Coincidencia de texto</a>.</p>
...
<p>Para obtener más información, consulte <a href="/docs/es/v2.5.x/bitmap.md">Índice de mapa de bits</a>.</p>
...
<p>Para más detalles, consulte <a href="/docs/es/v2.5.x/nullable-and-default.md">Nullable &amp; Default Value</a>.</p>
...
<p>Para obtener más información, consulte <a href="/docs/es/v2.5.x/clustering-compaction.md">Compactación</a> de <a href="/docs/es/v2.5.x/clustering-compaction.md">agrupaciones</a>.</p>
...
<p>Para más detalles, consulte <a href="/docs/es/v2.5.x/filtering-templating.md">Plantillas de filtros</a>.</p>
...
<p>Los usuarios que ya dispongan de una implantación de Milvus en funcionamiento deberán actualizar los componentes ETCD y Pulsar antes de poder utilizar las nuevas características y funciones. Para más detalles, consulte <a href="/docs/es/v2.5.x/upgrade-pulsar-v3.md">Actualización de Pulsar de 2.x a 3.x</a></p>
...
<h4 id="Security--Configuration-Updates" class="common-anchor-header">Actualizaciones de seguridad y configuración</h4><p>Soporte de TLS para asegurar la comunicación entre nodos en entornos más complejos o empresariales. Para obtener más información, consulte <a href="/docs/es/v2.5.x/tls.md">Configuración de seguridad</a>.</p>
