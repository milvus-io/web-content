...
<li><p><a href="/docs/es/v2.5.x/prerequisite-helm.md#How-can-I-start-a-K8s-cluster-locally-for-test-purposes">Crear un cluster K8s</a>.</p></li>
...
<ul>
<li><p>Comprobar <a href="/docs/es/v2.5.x/quickstart.md">Hello Milvus</a> para ver qué puede hacer Milvus.</p></li>
