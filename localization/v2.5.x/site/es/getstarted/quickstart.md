...
<h3 id="Query" class="common-anchor-header">Consulta</h3><p>Una consulta() es una operación que recupera todas las entidades que coinciden con un criterio, como una <a href="https://milvus.io/docs/boolean.md">expresión de filtro</a> o la coincidencia con algunos ids.</p>
