...
<ul>
<li><a href="/docs/es/v2.5.x/install_standalone-docker.md">Ejecutar Milvus en Docker</a></li>
<li><a href="/docs/es/v2.5.x/install_standalone-docker-compose.md">Ejecutar Milvus con Docker Compose</a></li>
</ul>
