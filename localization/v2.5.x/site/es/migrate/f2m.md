...
<li>Herramienta de<a href="https://github.com/zilliztech/milvus-migration">migración de Milvus</a>. Para más detalles sobre la instalación, consulte <a href="/docs/es/v2.5.x/milvusdm_install.md">Instalar la herramienta de migración</a>.</li>
</ul></li>
</ul>
...
<tr><td><code translate="no">target.create.collection.shardsNums</code></td><td>Número de fragmentos que se crearán en la colección. Para más información sobre los fragmentos, consulte <a href="https://milvus.io/docs/glossary.md#Shard">Terminología</a>.</td></tr>
