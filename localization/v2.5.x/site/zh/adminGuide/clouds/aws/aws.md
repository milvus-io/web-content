...
<p>此主题已过时，即将删除。建议你参考<a href="/docs/zh/v2.5.x/eks.md">在 EKS 上部署 Milvus 群集</a>。</p>
</div>
...
<ul>
<li><a href="/docs/zh/v2.5.x/eks.md">在 EKS 上部署 Milvus 群集</a></li>
<li><a href="/docs/zh/v2.5.x/gcp.md">使用 Kubernetes 在 GCP 上部署 Milvus 群集</a></li>
<li><a href="/docs/zh/v2.5.x/azure.md">使用 Kubernetes 在 Microsoft Azure 上部署 Milvus 指南</a></li>
</ul>
