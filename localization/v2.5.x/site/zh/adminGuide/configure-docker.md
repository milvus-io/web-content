...
<h2 id="Download-a-configuration-file" class="common-anchor-header">下载配置文件<button data-href="#Download-a-configuration-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p>直接或使用以下命令<a href="https://raw.githubusercontent.com/milvus-io/milvus/v2.5.9/configs/milvus.yaml">下载</a> <code translate="no">milvus.yaml</code> 。</p>
...
<h2 id="Download-an-installation-file" class="common-anchor-header">下载安装文件<button data-href="#Download-an-installation-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p>下载 Milvus<a href="https://github.com/milvus-io/milvus/releases/download/v2.5.9/milvus-standalone-docker-compose.yml">Standalone</a> 的安装文件，并将其保存为<code translate="no">docker-compose.yml</code> 。</p>
<p>也可以直接运行以下命令。</p>
