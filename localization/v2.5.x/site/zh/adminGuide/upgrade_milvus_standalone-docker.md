...
---
<div class="tab-wrapper"><a href="/docs/zh/v2.5.x/upgrade_milvus_standalone-operator.md" class=''>Milvus</a><a href="/docs/zh/v2.5.x/upgrade_milvus_standalone-helm.md" class=''>OperatorHelmDocker</a><a href="/docs/zh/v2.5.x/upgrade_milvus_standalone-docker.md" class='active '>Compose</a></div>
...
<p>在正常情况下，你可以<a href="#Upgrade-Milvus-by-changing-its-image">通过更改映像来升级 Milvus</a>。不过，在从 v2.1.x 升级到 v2.5.24 之前，你需要<a href="#Migrate-the-metadata">迁移元数据</a>。</p>
