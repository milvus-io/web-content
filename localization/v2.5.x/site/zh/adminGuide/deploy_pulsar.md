...
<h2 id="Configure-NATS-with-Helm" class="common-anchor-header">使用 Helm 配置 NATS<button data-href="#Configure-NATS-with-Helm" class="anchor-icon" translate="no">
    ...
    </button></h2><p>NATS 是 RocksMQ 的实验性消息存储替代品。关于如何使用 Helm 配置 Milvus 的详细步骤，请参阅《<a href="/docs/zh/v2.5.x/configure-helm.md">使用 Helm 图表配置 Milvus》</a>。有关 RocksMQ 相关配置项的详情，请参阅<a href="/docs/zh/v2.5.x/configure_natsmq.md">NATS 相关配置</a>。</p>
<ul>
