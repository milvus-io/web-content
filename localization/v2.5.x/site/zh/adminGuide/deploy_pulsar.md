...
<p>更多信息，请参阅<a href="/docs/zh/v2.5.x/configure_pulsar.md">Pulsar 相关配置</a>。</p>
...
<p>有关如何使用 Helm 配置 Milvus 的详情，请参阅<a href="/docs/zh/v2.5.x/configure-helm.md">使用 Helm 图表配置 Milvus</a>。有关 Pulsar 相关配置项的详情，请参阅<a href="/docs/zh/v2.5.x/configure_pulsar.md">Pulsar 相关配置</a>。</p>
...
<p>有关如何使用 Helm<a href="/docs/zh/v2.5.x/configure-helm.md">配置</a> Milvus 的详情，请参阅《<a href="/docs/zh/v2.5.x/configure-helm.md">使用 Helm 图表配置 Milvus</a>》。有关 Pulsar 相关配置项的详情，请参阅<a href="/docs/zh/v2.5.x/configure_pulsar.md">Pulsar 相关配置</a>。</p>
<h3 id="Using-the-YAML-file" class="common-anchor-header">使用 YAML 文件<button data-href="#Using-the-YAML-file" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
...
<h2 id="Configure-RocksMQ-with-Helm" class="common-anchor-header">使用 Helm 配置 RocksMQ<button data-href="#Configure-RocksMQ-with-Helm" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus Standalone 使用 RocksMQ 作为默认消息存储。关于如何使用 Helm 配置 Milvus 的详细步骤，请参阅《<a href="/docs/zh/v2.5.x/configure-helm.md">使用 Helm 图表配置 Milvus》</a>。有关 RocksMQ 相关配置项的详情，请参阅<a href="/docs/zh/v2.5.x/configure_rocksmq.md">RocksMQ 相关配置</a>。</p>
<ul>
...
<blockquote>
<p><strong>已废弃</strong>：NATS (natsmq) 已被弃用，将在 Milvus v2.6 中移除。请使用 RocksMQ、Pulsar 或 Kafka 代替。</p>
</blockquote>
<h2 id="Configure-NATS-with-Helm" class="common-anchor-header">使用 Helm 配置 NATS<button data-href="#Configure-NATS-with-Helm" class="anchor-icon" translate="no">
    ...
    </button></h2><p>NATS 是 RocksMQ 的实验性消息存储替代品。有关如何使用 Helm 配置 Milvus 的详细步骤，请参阅《<a href="/docs/zh/v2.5.x/configure-helm.md">使用 Helm 图表配置 Milvus》</a>。有关 RocksMQ 相关配置项的详情，请参阅<a href="/docs/zh/v2.5.x/configure_natsmq.md">NATS 相关配置</a>。</p>
<ul>
