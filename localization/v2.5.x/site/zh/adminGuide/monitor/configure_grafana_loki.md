...
<li><a href="/docs/zh/v2.5.x/install_cluster-helm.md">在 K8s 上安装了 Milvus 集群</a>。</li>
...
<h3 id="1-Create-Promtail-Configuration" class="common-anchor-header">1.创建 Promtail 配置<button data-href="#1-Create-Promtail-Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>创建<code translate="no">promtail.yaml</code> 配置文件：</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Install-Promtail" class="common-anchor-header">2.安装 Promtail<button data-href="#2-Install-Promtail" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>使用 Helm 安装 Promtail：</p>
