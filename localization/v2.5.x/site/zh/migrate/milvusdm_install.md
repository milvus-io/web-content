...
<li>从<a href="https://github.com/zilliztech/milvus-migration/tags">Milvus-Migration GitHub仓库</a>下载最新版本。</li>
...
<h2 id="Compile-from-source" class="common-anchor-header">从源代码编译<button data-href="#Compile-from-source" class="anchor-icon" translate="no">
    ...
    </button></h2><p>或者，下载并编译源代码，获得可执行的二进制文件。</p>
<ol>
<li><p>克隆Milvus-Migration资源库：</p>
...
<ul>
<li><a href="/docs/zh/v2.5.x/es2m.md">从 Elasticsearch</a></li>
<li><a href="/docs/zh/v2.5.x/f2m.md">从 Faiss</a></li>
<li><a href="/docs/zh/v2.5.x/m2m.md">来自 Milvus 1.x</a></li>
</ul>
