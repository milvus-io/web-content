...
<li>如果要使用 Milvus 的全托管云服务<a href="https://zilliz.com/cloud">Zilliz Cloud</a>，请调整<code translate="no">MILVUS_DB_URI</code> 和<code translate="no">MILVUS_DB_TOKEN</code> ，它们与 Zilliz Cloud 中的<a href="https://docs.zilliz.com/docs/on-zilliz-cloud-console#free-cluster-details">公共端点和 Api 密钥</a>相对应。</li>
</ul>
</blockquote>
