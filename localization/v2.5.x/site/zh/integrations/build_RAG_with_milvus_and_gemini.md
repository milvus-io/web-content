...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Prepare-the-LLM-and-Embedding-Model" class="common-anchor-header">准备 LLM 和嵌入模型</h3><p>我们使用<code translate="no">gemini-1.5-flash</code> 作为 LLM，使用<code translate="no">text-embedding-004</code> 作为 Embeddings 模型。</p>
