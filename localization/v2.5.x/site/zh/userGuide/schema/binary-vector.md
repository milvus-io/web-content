...
<p>虽然二进制向量在特定场景中表现出色，但其表达能力存在局限性，难以捕捉复杂的语义关系。因此，在实际应用场景中，二进制向量通常与其他向量类型一起使用，以平衡效率和表达能力。更多信息，请参阅<a href="/docs/zh/v2.5.x/dense-vector.md">密集向量</a>和<a href="/docs/zh/v2.5.x/sparse_vector.md">稀疏向量</a>。</p>
</div>
...
<p>此外，Milvus 还支持二进制向量的其他相似度度量。更多信息，请参阅 "<a href="/docs/zh/v2.5.x/metric.md">度量类型</a>"。</p>
