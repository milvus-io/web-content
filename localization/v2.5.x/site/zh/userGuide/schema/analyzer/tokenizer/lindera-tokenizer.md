...
<table>
   ...
   <tr>
     ...
     <td><p>用于定义词汇的词典列表。可能的值：</p><ul><li><p><code translate="no">ipadic</code>:日语</p></li><li><p><code translate="no">ko-dic</code>:韩语</p></li><li><p><code translate="no">cc-cedict</code>:中文普通话（繁体/简体）</p></li></ul></td>
   </tr>
</table>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Verification-using-runanalyzer" class="common-anchor-header">验证使用<code translate="no">run_analyzer</code></h3><pre><code translate="no" class="language-python"><span class="hljs-comment"># Sample text to analyze</span>
