...
<p>要了解更多技术细节，请参阅<a href="/docs/zh/v2.5.x/ivf-flat.md">IVF_FLAT</a>。</p>
...
<p>有关参数调整和优化的更多详情，请参阅<a href="/docs/zh/v2.5.x/ivf-pq.md#Index-params">索引参数</a>。</p>
...
<p>控制<strong>IVF</strong>和 PQ 算法的参数对<strong>IVF_PQ</strong>索引的性能影响很大。调整这些参数对特定数据集和应用获得最佳结果至关重要。有关这些参数以及如何调整<a href="/docs/zh/v2.5.x/ivf-pq.md#Index-params">参数</a>的详细信息，请参阅<a href="/docs/zh/v2.5.x/ivf-pq.md#Index-params">索引参数</a>。</p>
...
<p>要了解<code translate="no">IVF_PQ</code> 索引可用的更多构建<a href="/docs/zh/v2.5.x/ivf-pq.md#Index-building-params">参数</a>，请参阅<a href="/docs/zh/v2.5.x/ivf-pq.md#Index-building-params">索引构建参数</a>。</p></li>
</ul>
...
<p>要了解<code translate="no">IVF_PQ</code> 索引可用的更多搜索<a href="/docs/zh/v2.5.x/ivf-pq.md#Index-specific-search-params">参数</a>，请参阅<a href="/docs/zh/v2.5.x/ivf-pq.md#Index-specific-search-params">特定于索引的搜索参数</a>。</p></li>
</ul>
...
<h3 id="Index-building-params" class="common-anchor-header">索引建立参数<button data-href="#Index-building-params" class="anchor-icon" translate="no">
    ...
    </button></h3><p>下表列出了<a href="/docs/zh/v2.5.x/ivf-pq.md#Build-index">建立索引</a>时可在<code translate="no">params</code> 中配置的参数。</p>
<table>
   <tr>
     <th></th>
     <th><p>参数</p></th>
...
<h3 id="Index-specific-search-params" class="common-anchor-header">特定于索引的搜索参数<button data-href="#Index-specific-search-params" class="anchor-icon" translate="no">
    ...
    </button></h3><p>下表列出了在<code translate="no">search_params.params</code> 中<a href="/docs/zh/v2.5.x/ivf-pq.md#Search-on-index">搜索索引</a>时可以配置的参数。</p>
<table>
   <tr>
     <th></th>
     <th><p>参数</p></th>
