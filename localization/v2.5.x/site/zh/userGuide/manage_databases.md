...
<h2 id="Manage-database-properties" class="common-anchor-header">管理数据库属性<button data-href="#Manage-database-properties" class="anchor-icon" translate="no">
    ...
    </button></h2><p>每个数据库都有自己的属性，您可以在<a href="/docs/zh/manage_databases.md#null">创建数据库</a>时设置数据库属性（如<a href="/docs/zh/manage_databases.md#null">创建数据库</a>中所述），也可以更改和删除任何现有数据库的属性。</p>
<p>下表列出了可能的数据库属性。</p>
<table>
   <tr>
     <th><p>属性名称</p></th>
