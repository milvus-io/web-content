...
<li><p><code translate="no">sparse</code>:该字段用于存储文本的稀疏向量。这个字段的数据类型是 SPARSE_FLOAT_VECTOR。 在这个示例中，我们使用函数生成稀疏向量。</p></li>
</ul>
...
<h4 id="Define-function-to-generate-sparse-vectors​" class="common-anchor-header">定义生成稀疏向量的函数</h4><p>要生成稀疏向量，可以使用 Milvus 中的 Function 功能。下面的示例使用 BM25 算法定义了一个生成稀疏向量的 Function。更多信息，请参阅<a href="/docs/zh/full-text-search.md">全文搜索</a>。</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Create-index​" class="common-anchor-header">创建索引</h4><p>定义完 Collections Schema 后，有必要设置向量索引和相似度度量。在本例中，为密集向量场<code translate="no">dense</code> 创建了 IVF_FLAT 索引，为稀疏向量场<code translate="no">sparse</code> 创建了 SPARSE_INVERTED_INDEX。要了解支持的索引类型，请参阅<a href="https://milvus.io/docs/index.md?tab=floating">Index Explained</a>。</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
