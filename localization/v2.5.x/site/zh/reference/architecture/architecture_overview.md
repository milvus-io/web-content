...
<h1 id="Milvus-Architecture-Overview" class="common-anchor-header">Milvus 架构概述<button data-href="#Milvus-Architecture-Overview" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus 构建在 Faiss、HNSW、DiskANN、SCANN 等流行的向量搜索库之上，专为在包含数百万、数十亿甚至数万亿向量的密集向量数据集上进行相似性搜索而设计。在继续之前，请先熟悉一下 Embeddings 检索的<a href="/docs/zh/v2.5.x/glossary.md">基本原理</a>。</p>
...
<p>Milvus 采用共享存储架构，其计算节点具有存储和计算分解及横向扩展能力。按照数据平面和控制平面分解的原则，Milvus 由<a href="/docs/zh/v2.5.x/four_layers.md">四层</a>组成：访问层、协调器服务、工作节点和存储。这些层在扩展或灾难恢复时相互独立。</p>
<p>
...
<li>了解更多有关 Milvus 中<a href="/docs/zh/v2.5.x/four_layers.md">计算/存储分解的</a>信息</li>
<li>了解 Milvus 中的<a href="/docs/zh/v2.5.x/main_components.md">主要组件</a>。</li>
</ul>
