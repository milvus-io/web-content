...
<h1 id="Cross-Encoder" class="common-anchor-header">交叉编码器<button data-href="#Cross-Encoder" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus 通过<code translate="no">CrossEncoderRerankFunction</code> 类支持<a href="https://github.com/FlagOpen/FlagEmbedding/tree/master/FlagEmbedding/reranker">交叉编码器</a>。该功能可让您有效地对查询-文档对的相关性进行评分。</p>
<p>要使用该功能，请安装必要的依赖项：</p>
<pre><code translate="no" class="language-bash">pip install --upgrade pymilvus
pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>然后，实例化<code translate="no">CrossEncoderRerankFunction</code> ：</p>
