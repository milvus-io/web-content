...
<p><code translate="no">stemmer</code> 필터는 토큰화 도구에서 생성된 용어에 대해 작동하므로 토큰화 도구와 함께 사용해야 합니다. Milvus에서 사용 가능한 토큰라이저 목록은 <a href="/docs/ko/tokenizers">토큰라이저 참조를</a> 참조하세요.</p>
