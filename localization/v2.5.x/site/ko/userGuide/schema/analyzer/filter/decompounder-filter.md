...
<p><code translate="no">decompounder</code> 필터는 토큰화기에 의해 생성된 용어에 대해 작동하므로 토큰화기와 함께 사용해야 합니다. Milvus에서 사용할 수 있는 토큰화기 목록은 <a href="/docs/ko/v2.5.x/standard-tokenizer.md">표준 토큰화기와</a> 그 형제 페이지를 참조하세요.</p>
