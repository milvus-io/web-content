...
<p>보다 간단한 설정을 위해 다음과 같이 <a href="/docs/ko/standard-analyzer.md"><code translate="no">standard analyzer</code></a>토큰라이저와 <code translate="no">standard</code> 토큰라이저를 결합하는 <a href="/docs/ko/lowercase-filter.md"><code translate="no">lowercase filter</code></a>.</p>
</div>
