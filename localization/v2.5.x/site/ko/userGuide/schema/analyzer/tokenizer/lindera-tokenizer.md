...
<h2 id="Configuration" class="common-anchor-header">구성<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p><code translate="no">lindera</code> 토큰화기를 사용하여 분석기를 구성하려면 <code translate="no">tokenizer.type</code> 을 <code translate="no">lindera</code> 으로 설정하고 <code translate="no">dict_kind</code> 으로 사전을 선택합니다.</p>
...
<table>
   ...
   <tr>
     ...
     <td><p>어휘를 정의하는 데 사용되는 사전 목록입니다. 가능한 값은</p><ul><li><p><code translate="no">ipadic</code>: 일본어</p></li><li><p><code translate="no">ko-dic</code>: 한국어</p></li><li><p><code translate="no">cc-cedict</code>: 중국어(번체/간체)</p></li></ul></td>
   </tr>
</table>
...
<h3 id="Analyzer-configuration" class="common-anchor-header">분석기 구성</h3><pre><code translate="no" class="language-python">analyzer_params = {
    <span class="hljs-string">&quot;tokenizer&quot;</span>: {
      <span class="hljs-string">&quot;type&quot;</span>: <span class="hljs-string">&quot;lindera&quot;</span>,
      <span class="hljs-string">&quot;dict_kind&quot;</span>: <span class="hljs-string">&quot;ipadic&quot;</span>
    }
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Verification-using-runanalyzer" class="common-anchor-header">다음을 사용하여 검증 <code translate="no">run_analyzer</code></h3><pre><code translate="no" class="language-python"><span class="hljs-comment"># Sample text to analyze</span>
