...
<table>
   ...
   <tr>
     ...
     <td><p>어휘를 정의하는 데 사용되는 사전 목록입니다. 가능한 값은</p>
<ul>
<li><p><code translate="no">ipadic</code>: 일본어</p></li>
<li><p><code translate="no">ko-dic</code>: 한국어</p></li>
<li><p><code translate="no">cc-cedict</code>: 중국어(번체/간체)</p></li>
</ul></td>
   </tr>
</table>
