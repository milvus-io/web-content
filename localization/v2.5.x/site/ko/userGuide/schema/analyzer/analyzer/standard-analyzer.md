...
<ul>
<li><p><strong>토큰화 도구</strong>: <code translate="no">standard</code> 토큰화기를 사용하여 문법 규칙에 따라 텍스트를 개별 단어 단위로 분할합니다. 자세한 내용은 <a href="/docs/ko/v2.5.x/standard-tokenizer.md">표준을</a> 참조하세요.</p></li>
