...
<p>헬름을 사용하여 Milvus를 구성하는 방법에 대한 자세한 내용은 <a href="/docs/ko/v2.5.x/configure-helm.md">헬름 차트로 Milvus 구성하기를</a> 참조하세요. 펄사 관련 구성 항목에 대한 자세한 내용은 <a href="/docs/ko/v2.5.x/configure_pulsar.md">펄사 관련 구성을</a> 참고한다.</p>
