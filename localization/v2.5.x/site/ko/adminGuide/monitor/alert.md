...
<h3 id="Prerequisites" class="common-anchor-header">전제 조건</h3><p>이 튜토리얼에서는 Grafana가 설치 및 구성되어 있다고 가정합니다. 그렇지 않은 경우 <a href="/docs/ko/v2.5.x/monitor.md">모니터링 가이드를</a> 읽어보시기 바랍니다.</p>
...
<li><a href="/docs/ko/v2.5.x/monitor.md">모니터링 가이드</a> 읽기</li>
<li><a href="/docs/ko/v2.5.x/visualize.md">모니터링 메트릭을 시각화하는</a> 방법 알아보기</li>
</ul></li>
<li>Milvus 컴포넌트별 메모리 사용량에 대한 알림을 생성한 경우:<ul>
<li><a href="/docs/ko/v2.5.x/allocate.md#standalone">리소스 할당</a> 방법 알아보기</li>
</ul></li>
<li>Milvus 클러스터를 확장하는 방법에 대한 정보를 찾고 계신 경우:<ul>
<li><a href="/docs/ko/v2.5.x/scaleout.md">Milvus 클러스터 확장하기</a> 알아보기</li>
</ul></li>
</ul>
