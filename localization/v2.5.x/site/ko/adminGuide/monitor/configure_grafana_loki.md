...
<h3 id="2-Configure-Object-Storage-for-Loki" class="common-anchor-header">2. 로키용 오브젝트 스토리지 구성<button data-href="#2-Configure-Object-Storage-for-Loki" class="anchor-icon" translate="no">
    ...
    </button></h3><p>다음 스토리지 옵션 중 하나를 선택하고 <code translate="no">loki.yaml</code> 구성 파일을 생성합니다:</p>
<ul>
...
<h3 id="1-Create-Promtail-Configuration" class="common-anchor-header">1. Promtail 구성 생성<button data-href="#1-Create-Promtail-Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><code translate="no">promtail.yaml</code> 구성 파일을 생성합니다:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Install-Promtail" class="common-anchor-header">2. 프롬테일 설치<button data-href="#2-Install-Promtail" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>헬름을 사용하여 프롬테일을 설치합니다:</p>
...
<h3 id="1-Deploy-Grafana" class="common-anchor-header">1. Grafana 배포하기<button data-href="#1-Deploy-Grafana" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>다음 명령어를 사용하여 Grafana를 설치합니다:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Add-Loki-as-a-Data-Source-in-Grafana" class="common-anchor-header">2. Grafana에서 Loki를 데이터 소스로 추가하기<button data-href="#2-Add-Loki-as-a-Data-Source-in-Grafana" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
