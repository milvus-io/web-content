...
<h4 id="2-Upgrade-Milvus-from-v21x-to-2518" class="common-anchor-header">2. Milvus를 v2.1.x에서 2.5.18로 업그레이드합니다.</h4><p>다음 명령은 Milvus를 v2.1.4에서 2.5.18로 업그레이드한다고 가정합니다. 필요에 맞는 버전으로 변경하세요.</p>
<ol>
