...
<ul>
<li><a href="/docs/ko/v2.5.x/monitor.md">Kubernetes에서 Prometheus Operator로 Milvus 모니터링하기</a> 배우기</li>
<li><a href="/docs/ko/v2.5.x/visualize.md">Grafana에서 Milvus 메트릭 시각화에</a> 대해 알아보세요.</li>
</ul></li>
