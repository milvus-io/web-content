...
<p>자세한 내용은 <a href="/docs/ko/v2.5.x/configure_minio.md">MinIO/S3 구성을</a> 참조하세요.</p>
...
<tr><td><code translate="no">externalS3.enabled</code></td><td>S3를 사용 또는 사용하지 않도록 설정합니다.</td><td><code translate="no">true</code>/<code translate="no">false</code></td></tr>
