...
<ul>
<li><a href="/docs/ko/v2.5.x/install_standalone-docker.md">Docker에서 Milvus 실행</a></li>
<li><a href="/docs/ko/v2.5.x/install_standalone-docker-compose.md">Docker Compose로 Milvus 실행하기</a></li>
</ul>
