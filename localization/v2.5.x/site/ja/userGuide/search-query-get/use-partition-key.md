...
<button class="copy-code-btn"></button></code></pre>
<p>パーティション・キー・アイソレーションを有効にした後も、パーティション・キーの<a href="#Set-Partition-Numbers">設定と</a>パーティション数の設定で説明するように、パーティション・キーとパーティション数を設定できます。パーティション・キー・ベース・フィルターには、特定のパーティション・キーの値だけを含める必要があることに注意してください。</p>
