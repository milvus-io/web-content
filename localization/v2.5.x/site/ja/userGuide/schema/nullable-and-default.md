...
<p><code translate="no">query</code> メソッドをフィルタリング条件なしで使用すると、NULL 値を含むコレクション内のすべてのエンティティが返されます。返されるエンティティの数を制限するには、<code translate="no">limit</code> パラメータを指定する必要があります。</p>
</div>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
