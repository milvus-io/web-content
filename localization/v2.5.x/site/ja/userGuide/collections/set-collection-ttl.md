...
<ul>
<li><p><a href="/docs/ja/v2.5.x/set-collection-ttl.md#Set-TTL-when-creating-a-collection">コレクションを作成する。</a></p></li>
<li><p><a href="/docs/ja/v2.5.x/set-collection-ttl.md#Set-TTL-for-an-existing-collection">既存のコレクションのTTLプロパティを変更する。</a></p></li>
</ul>
