...
<h4 id="2-Upgrade-Milvus-from-v21x-to-2513" class="common-anchor-header">2.Milvusをv2.1.xから2.5.13にアップグレードする。</h4><p>以下のコマンドは、Milvusをv2.1.4から2.5.13にアップグレードすることを想定しています。必要なバージョンに変更してください。</p>
<ol>
