...
<ul>
<li><a href="/docs/ja/v2.5.x/monitor.md">Kubernetes上のPrometheus OperatorでMilvusを監視するを</a>学ぶ</li>
<li><a href="/docs/ja/v2.5.x/visualize.md">GrafanaでMilvusのメトリクスを可視化するを</a>学ぶ。</li>
</ul></li>
