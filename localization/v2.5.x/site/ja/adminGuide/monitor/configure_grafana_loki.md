...
<h3 id="1-Create-Promtail-Configuration" class="common-anchor-header">1.Promtail設定の作成<button data-href="#1-Create-Promtail-Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p><code translate="no">promtail.yaml</code> 設定ファイルを作成します：</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Install-Promtail" class="common-anchor-header">2.Promtailのインストール<button data-href="#2-Install-Promtail" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Helmを使ってPromtailをインストールします：</p>
...
<h3 id="1-Deploy-Grafana" class="common-anchor-header">1.Grafanaのデプロイ<button data-href="#1-Deploy-Grafana" class="anchor-icon" translate="no">
    ...
    </button></h3><p>以下のコマンドを使用してGrafanaをインストールします：</p>
