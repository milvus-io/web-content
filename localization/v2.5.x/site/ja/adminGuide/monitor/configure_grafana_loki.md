...
<p>参考までに、<a href="https://grafana.com/docs/loki/latest/send-data/promtail/#promtail-agent">Promtailは</a>非推奨となる予定です。 そこで、Kubernetesのログを収集し、Lokiに転送する新しいエージェントとしてGrafana Labsが公式に提案しているAlloyを紹介します。</p>
