...
<ul>
<li>Milvusをv2.2.3またはそれ以降のリリースから2.5.8にアップグレードするには、<a href="#Conduct-a-rolling-upgrade">ローリングアップグレードを</a>行います。</li>
