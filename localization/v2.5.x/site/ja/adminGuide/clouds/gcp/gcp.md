...
<button class="copy-code-btn"></button></code></pre>
<p>先のコマンドでは、Milvus Helmチャートのリポジトリをローカルに追加し、最新のチャートを取得するようにリポジトリを更新します。そして、Milvusインスタンスをインストールし、<strong>my-releaseと</strong>名付ける。</p>
<p>コンフィグ<code translate="no">service.type</code> 。これはMilvusインスタンスをLayer-4ロードバランサー経由で公開することを示しています。</p>
<p>Milvusインスタンスをレイヤ7ロードバランサー経由で公開したい場合は、<a href="/docs/ja/v2.5.x/gcp_layer7.md">こちらをお読み</a>ください。</p>
...
<ul>
<li><a href="/docs/ja/v2.5.x/eks.md">Kubernetesを使ってAWS上にMilvusクラスタをデプロイする</a></li>
<li><a href="/docs/ja/v2.5.x/azure.md">KubernetesでAzureにMilvusクラスタをデプロイする</a></li>
</ul>
