  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>pulsar.addressとpulsar.portは、パルサーへの有効なアクセスを生成します。</li>      
  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>デフォルトでは、Pulsarは1つのメッセージで最大2MBのデータを送信できます。挿入されたデータのサイズがこの値より大きい場合、プロキシはデータを複数のメッセージに断片化し、正しく送信できるようにします。</li>      
        <li>Pulsarの対応するパラメータが変更されていない場合、この設定を増やすとmilvusは失敗し、減らすと何のメリットもありません。</li>      </td>
      <td>2097152</td>
    </tr>
  </tbody>
</table>
