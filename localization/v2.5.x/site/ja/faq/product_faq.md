...
<h4 id="Why-do-Euclidean-distance-L2-and-inner-product-IP-return-different-results" class="common-anchor-header">なぜユークリッド距離 (L2) と内積 (IP) は異なる結果を返すのですか？</h4><p>正規化されたベクトルでは、ユークリッド距離 (L2) は内積 (IP) と数学的に等価です。これらの類似性メトリクスが異なる結果を返す場合、ベクトルが正規化されているかどうかを確認してください。</p>
...
<li>私たちの<a href="https://slack.milvus.io/">Slackコミュニティに</a>参加して、サポートを見つけたり、オープンソースコミュニティに参加してください。</li>
</ul>
