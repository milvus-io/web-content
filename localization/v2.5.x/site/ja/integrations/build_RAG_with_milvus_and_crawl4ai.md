...
<h3 id="Setting-Up-OpenAI-API-Key" class="common-anchor-header">OpenAI APIキーの設定</h3><p>この例では、OpenAIをLLMとして使用します。<a href="https://platform.openai.com/docs/quickstart">OPENAI_API_KEYを</a>環境変数として用意してください。</p>
