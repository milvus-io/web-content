...
<ul>
<li><a href="/docs/ja/v2.5.x/install_standalone-docker.md">Milvusサーバが</a>動作していること。</li>
...
<p>これらのパラメータの詳細については、<a href="/docs/ja/v2.5.x/authenticate.md">Milvus認証のドキュメント</a>および<a href="/docs/ja/v2.5.x/consistency.md">Milvus一貫性レベルのドキュメントを</a>参照してください。</p>
