...
<li>تمت إضافة القدرة على تكوين عدة محللات (مُحلِّلات رمزية) واختيار المحلِّل المناسب بناءً على تعليمات بيانات الإدخال<a href="https://github.com/milvus-io/milvus/pull/41444">(#41444</a>).</li>
...
<li>إضافة دعم لتعبيرات النطاق الثنائي في فهارس مسار JSON<a href="https://github.com/milvus-io/milvus/pull/41317">(#41406</a>).</li>
...
<li>ترقية إصدار Go المطور إلى 1.21.4 لمعالجة نقاط الضعف القابلة للتغيير<a href="https://github.com/milvus-io/milvus/pull/41522">(#41522،</a> <a href="https://github.com/milvus-io/milvus/pull/41319">#41319</a>).<em>(ملاحظة: النص الأصلي ذكر "2.14"، تم تصحيح الخطأ المطبعي المفترض إلى الإصدار الأخير المعقول 1.21.4</em>).</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">إصلاحات الأخطاء</h3><ul>
<li>تم إصلاح مشكلة عدم إسقاط المقاطع بشكل صحيح عند إسقاط قسم<a href="https://github.com/milvus-io/milvus/pull/41543">(#41543</a>).</li>
...
<h4 id="Compaction-Performance-Enhancements" class="common-anchor-header">تحسينات أداء الضغط</h4><p>تمت إزالة القيود القصوى للمقطع في الضغط المختلط، والآن تعطي الأولوية للمقاطع الأصغر أولاً، مما يحسن الكفاءة ويسرّع الاستعلامات على مجموعات البيانات الكبيرة أو المجزأة.</p>
