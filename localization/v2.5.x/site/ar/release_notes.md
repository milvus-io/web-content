...
<p>نحن متحمسون للإعلان عن Milvus 2.5.16! يعمل هذا الإصدار على تحسين تجربتك من خلال إصلاح سلسلة من الأخطاء الوظيفية وتحسين تجارب المستخدم. كما أنه يقدم مجموعة من التحسينات العامة في الأداء والثبات، مع حل العديد من الأخطاء لضمان نظام أكثر قوة. نحن نشجعك على الترقية إلى 2.5.16 واستكشاف هذه التحديثات الأخيرة!</p>
<h3 id="Improvements" class="common-anchor-header">التحسينات</h3><ul>
<li>إزالة التحقق من صحة اسم المجموعة من <code translate="no">DescribeCollection</code> <a href="https://github.com/milvus-io/milvus/pull/43300">(#43300</a>).</li>
<li>إلغاء ربط ملف mmap غير المرتبط عند إتلاف القطعة والفهرس<a href="https://github.com/milvus-io/milvus/pull/43546">(43546 #43546</a>).</li>
<li>عنصر المجموعة المستخدمة لنوع مصطلح السلسلة<a href="https://github.com/milvus-io/milvus/pull/43393">(#43393</a>).</li>
<li>ترقية إصدار Go المطور إلى 1.24.4 لإصلاح نقاط الضعف<a href="https://github.com/milvus-io/milvus/pull/43467">(#43467</a>).</li>
<li>تنزيل الحقول الضرورية فقط أثناء مرحلة تحليل التجميع<a href="https://github.com/milvus-io/milvus/pull/43362">(#43362</a>).</li>
<li>تحديث إصدار لينديرا<a href="https://github.com/milvus-io/milvus/pull/43457">(#43457</a>).</li>
<li>تحسين موازنة عقدة القناة لتوزيع QueryNode غير المتكافئ<a href="https://github.com/milvus-io/milvus/pull/43423">(#43423</a>).</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">إصلاحات الأخطاء</h3><ul>
<li>تم إصلاح البحث الهجين لدعم معلمة الإزاحة في واجهة برمجة تطبيقات RESTful<a href="https://github.com/milvus-io/milvus/pull/43721">(#43721</a>).</li>
<li>إصلاح ذعر أداة ترميز جيبا عندما تكون كلمة الإملاء سلسلة فارغة<a href="https://github.com/milvus-io/milvus/pull/43718">(43718/4</a>).</li>
<li>إصلاح استرجاع البيانات الخام الممتدة لنوع بيانات متغير الطول<a href="https://github.com/milvus-io/milvus/pull/43703">(#43703</a>).</li>
<li>زيادة الإزاحة لصفوف البيانات غير الصالحة في فهرس إحصائيات مفاتيح JSON المقلوبة<a href="https://github.com/milvus-io/milvus/pull/43688">(#43688</a>).</li>
<li>تم إصلاح فشل تحميل تغييرات التكوين بعد إعادة التشغيل<a href="https://github.com/milvus-io/milvus/pull/43555">(#43555</a>).</li>
<li>تم إصلاح pk في [...] تخطي الدفعة التالية عند استخدام مقطع متعدد القطع<a href="https://github.com/milvus-io/milvus/pull/43619">(#43619</a>).</li>
<li>تم تخطي تحميل قطاعات L0 غير الموجودة لمنع حظر التحميل<a href="https://github.com/milvus-io/milvus/pull/43576">(#43576</a>).</li>
<li>تنظيف ذاكرة التخزين المؤقت للامتيازات بعد تحميل النهج في <code translate="no">InitPolicyInfo</code> <a href="https://github.com/milvus-io/milvus/pull/43643">(#43643</a>).</li>
<li>تعيين الحالة عندما لا يكون الخطأ فارغًا<a href="https://github.com/milvus-io/milvus/pull/43404">(#43404</a>).</li>
<li>إرجاع المعرف افتراضيًا<a href="https://github.com/milvus-io/milvus/pull/43596">(#43596</a>).</li>
<li>تم إصلاح فشل استرجاع طرق عرض السلسلة بسبب حلقة فارغة مرتبطة بالقطعة<a href="https://github.com/milvus-io/milvus/pull/43482">(#43482</a>).</li>
<li>تم تجاهل الوكيل 2.6 لتجنب التأخر في النقر الزمني<a href="https://github.com/milvus-io/milvus/pull/43519">(# 43519</a>).</li>
<li>ضمان ترتيب تنفيذ المهام باستخدام قائمة انتظار ذات أولوية<a href="https://github.com/milvus-io/milvus/pull/43272">(#43272</a>).</li>
<li>تحسين الحكم على طرق عرض الدفعات<a href="https://github.com/milvus-io/milvus/pull/43479">(#43479</a>).</li>
</ul>
<h2 id="v2515" class="common-anchor-header">v2.5.15<button data-href="#v2515" class="anchor-icon" translate="no">
    ...
    </button></h2><p>تاريخ الإصدار: 23 يوليو 2025</p>
<table>
<thead>
<tr><th>إصدار ميلفوس</th><th>إصدار Python SDK</th><th>إصدار Node.js SDK</th><th>إصدار Java SDK</th></tr>
</thead>
...
<p>نحن متحمسون للإعلان عن Milvus 2.5.15! يعمل هذا الإصدار على تحسين تجربتك من خلال إصلاح سلسلة من الأخطاء الوظيفية، بما في ذلك الأخطاء التي قد تؤدي إلى تلف البيانات الوصفية بشدة مما يتسبب في فقدان البيانات عند إعادة تسمية المجموعة. كما أنه يوفر أيضًا مجموعة من التحسينات العامة على الأداء والثبات، مع حل العديد من الأخطاء لضمان نظام أكثر قوة. <strong>نحن نشجعك على الترقية إلى الإصدار 2.5.15، خاصةً إذا كنت تستخدم حاليًا الإصدار 2.5.14، واستكشاف هذه التحديثات الأخيرة!</strong></p>
<h3 id="Improvements" class="common-anchor-header">التحسينات</h3><ul>
<li>تم تحديث إصدار Knowhere لإصلاح خطأ القوة الغاشمة للمتجهات المتفرقة<a href="https://github.com/milvus-io/milvus/pull/43398">(#43398</a>).</li>
<li>تنفيذ حفظ التعريف مع حدود txn<a href="https://github.com/milvus-io/milvus/pull/43287">(#43287</a>).</li>
<li>تطبيق تغييرات تكوين التحميل بعد إعادة تشغيل QueryCoord<a href="https://github.com/milvus-io/milvus/pull/43236">(#43236</a>).</li>
<li>تحسين استخدام الذاكرة من النوع المتغير الطول<a href="https://github.com/milvus-io/milvus/pull/43093">(#43093</a>).</li>
<li>إعادة ترتيب إيقاف تشغيل RootCoord ليكون الأخير في تسلسل إيقاف المنسق<a href="https://github.com/milvus-io/milvus/pull/43024">(#43024</a>).</li>
<li>تحديث إصدار CMake إلى 3.31.8<a href="https://github.com/milvus-io/milvus/pull/43004">(#43004</a>).</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">إصلاح الأخطاء</h3><ul>
<li>تم تخطي عملية الإزالة إذا كان المفتاح موجودًا في مجموعة الحفظ<a href="https://github.com/milvus-io/milvus/pull/43426">(#43426</a>).</li>
<li>تم إصلاح محاذاة إزاحة الصورة النقطية الفارغة عند تحميل بيانات متعددة القطع<a href="https://github.com/milvus-io/milvus/pull/43411">(43411 و43411</a> <a href="https://github.com/milvus-io/milvus/pull/43342"> و43342</a>).</li>
<li>تحديث Tantivy لإصلاح حالة سباق إزالة الدليل<a href="https://github.com/milvus-io/milvus/pull/43401">(#43401</a>).</li>
<li>إصلاح مشكلة استدعاء <code translate="no">AlterCollection</code> فقط عند إعادة تسمية المجموعات<a href="https://github.com/milvus-io/milvus/pull/43421">(# 43421</a>).</li>
<li>جعل <code translate="no">MultiSaveAndRemove</code> تنفيذ عمليات الإزالة أولاً<a href="https://github.com/milvus-io/milvus/pull/43409">(#43409</a>).</li>
<li>استخدام الحد الأقصى لحجم مقطع القرص للمجموعات ذات المتجهات المتفرقة والكثيفة<a href="https://github.com/milvus-io/milvus/pull/43195">(#43195</a>).</li>
<li>إصلاح خطأ مطابقة النص بالتكيف مع نموذج القطع المتعددة<a href="https://github.com/milvus-io/milvus/pull/43297">(#43297</a>).</li>
<li>إصلاح مجموعة البتات غير الصحيحة لمقارنة القسمة عندما يكون المعامل الأيمن سالبًا<a href="https://github.com/milvus-io/milvus/pull/43180">(# 43180</a>).</li>
<li>إلغاء النسخ غير الضروري عند الحصول على أجزاء JSON<a href="https://github.com/milvus-io/milvus/pull/43183">(#43183،</a> <a href="https://github.com/milvus-io/milvus/pull/43202">#43202</a>).</li>
<li>منع المفوض من أن يصبح غير قابل للخدمة بسبب تغييرات قائد القطعة<a href="https://github.com/milvus-io/milvus/pull/43309">(#43309</a>).</li>
<li>تم إصلاح تسرب فهرس مطابقة النص وفهرس إحصائيات مفاتيح JSON عند تحرير الأجزاء<a href="https://github.com/milvus-io/milvus/pull/43308">(#43308</a>).</li>
<li>تم إصلاح فشل <code translate="no">RegeneratePartitionStats</code> بعد استعادة مهام ضغط التجميع<a href="https://github.com/milvus-io/milvus/pull/43206">(#43206</a>).</li>
<li>تمت إضافة معالجة الأخطاء لمعلمات الدالة غير الصالحة لمنع حدوث حالات الذعر<a href="https://github.com/milvus-io/milvus/pull/43190">(#43190</a>).</li>
<li>إزالة منطق اقتطاع المسافات عند التحقق من صحة أسماء المجموعات<a href="https://github.com/milvus-io/milvus/pull/43138">(#43138</a>).</li>
<li>تمت إضافة خاصية التحقق من خاصية mmap للحقل قبل تطبيق الإعدادات على مستوى المجموعة<a href="https://github.com/milvus-io/milvus/pull/43091">(#43091</a>).</li>
<li>تم إصلاح حظر إنشاء الفهرس بسبب فشل إحصائيات الفرز<a href="https://github.com/milvus-io/milvus/pull/43061">(#43061</a>).</li>
<li>تم إصلاح استبعاد منطق مسح العقد المستبعدة في آلية إعادة محاولة موازن التحميل<a href="https://github.com/milvus-io/milvus/pull/43002">(#43002</a>).</li>
</ul>
<h2 id="v2514" class="common-anchor-header">v2.5.14<button data-href="#v2514" class="anchor-icon" translate="no">
    ...
    </button></h2><p>تاريخ الإصدار: 2 يوليو 2025</p>
<table>
<thead>
<tr><th>إصدار ميلفوس</th><th>إصدار Python SDK</th><th>إصدار Node.js SDK</th><th>إصدار Java SDK</th></tr>
</thead>
...
<p>نحن متحمسون للإعلان عن الإصدار Milvus 2.5.14! يقدّم هذا الإصدار مجموعة من التحسينات على الأداء والاستقرار، بما في ذلك مجموعة منفصلة من ذاكرة التخزين المؤقت للقطع، والفهرسة التلقائية لحقول JSON، والتخزين المؤقت المحلي لإحصائيات مقطع BM25. يعمل هذا الإصدار أيضًا على حل العديد من الأخطاء الحرجة، مثل انفجار مؤشر ترابط في مراقب الملفات وحالات الذعر المحتملة في QueryCoord، لضمان نظام أكثر قوة وموثوقية. نشجعك على الترقية إلى 2.5.14 للاستفادة من هذه التحديثات الأخيرة!</p>
<h3 id="Dependency-upgrade" class="common-anchor-header">ترقية التبعية</h3><ul>
<li>تمت ترقية Minio إلى الإصدار RELEASE.2024-05-28T17-19-04Z لإصلاح بعض نقاط الضعف<a href="https://github.com/milvus-io/milvus/pull/43063">(#43063</a>).</li>
</ul>
<h3 id="Improvements" class="common-anchor-header">التحسينات</h3><ul>
<li>إضافة تجمع منفصل لذاكرة التخزين المؤقت للقطع<a href="https://github.com/milvus-io/milvus/pull/42901">(#42901</a>).</li>
<li>إضافة دعم <code translate="no">AUTOINDEX</code> على حقول JSON<a href="https://github.com/milvus-io/milvus/pull/42161">(#42161</a>).</li>
<li>استخدام الاسم الإنجليزي كمعرفات لغة لجميع أنواع اللغات<a href="https://github.com/milvus-io/milvus/pull/42601">(#42601</a>).</li>
<li>تمكين تشغيل محلل حسب حقل المجموعة<a href="https://github.com/milvus-io/milvus/pull/42812">(# 42812</a>).</li>
<li>تحديث إصدار Knowhere<a href="https://github.com/milvus-io/milvus/pull/42939">(# 42939</a>).</li>
<li>تمت إضافة واجهة حجم إلى قارئ الملفات لإزالة <code translate="no">statobject</code> المكالمات أثناء القراءة<a href="https://github.com/milvus-io/milvus/pull/42911">(#42911</a>).</li>
<li>تقديم ذاكرة تخزين مؤقت محلية لإحصائيات مقطع BM25<a href="https://github.com/milvus-io/milvus/pull/42924">(#42924،</a> <a href="https://github.com/milvus-io/milvus/pull/42646">#42646</a>).</li>
<li>ملء <code translate="no">dbname</code> لـ <code translate="no">operateprivilegev2request</code> في المعترض<a href="https://github.com/milvus-io/milvus/pull/42904">(#42904</a>).</li>
<li>تجنب تعديل البيانات الوصفية للحقل عند إعادة تسمية مجموعة أو قاعدة بيانات<a href="https://github.com/milvus-io/milvus/pull/42876">(# 42876-42876</a>).</li>
<li>جعل واجهة مستخدم الويب قابلة للتبديل عبر التكوين<a href="https://github.com/milvus-io/milvus/pull/42815">(# 42815</a>).</li>
<li>تجنب استخدام تجمع مؤشرات الترابط عندما يكون العمود جاهزًا في ذاكرة التخزين المؤقت للقطع<a href="https://github.com/milvus-io/milvus/pull/42804">(#42804</a>).</li>
<li>تمكين مجمّع تانتيفي من تعيين مجموعة البتات مباشرةً<a href="https://github.com/milvus-io/milvus/pull/39748">(#39748،</a> <a href="https://github.com/milvus-io/milvus/pull/42881"> 42881-4281</a>).</li>
<li>استبدلت مفاتيح الخريطة المستندة إلى المؤشر بمعرفات في مُجمِّع المهملات<a href="https://github.com/milvus-io/milvus/pull/42654">(# 42654</a>).</li>
<li>تحسين استخدام الذاكرة أثناء تجميع المهملات<a href="https://github.com/milvus-io/milvus/pull/42631">(#42631</a>).</li>
<li>إضافة دعم لطباعة NQ والمعلمات لسجلات البحث والاستعلام<a href="https://github.com/milvus-io/milvus/pull/42545">(#42545</a>).</li>
<li>التعامل مع القيم القابلة للإلغاء والقيم الافتراضية بشكل صحيح أثناء الإدراج الجماعي<a href="https://github.com/milvus-io/milvus/pull/42072">(#42072</a>).</li>
<li>تعيين أسماء مؤشرات ترابط لتجمع مؤشرات ترابط Segcore<a href="https://github.com/milvus-io/milvus/pull/42596">(#42596</a>).</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">إصلاح الأخطاء</h3><ul>
<li>تخصيص معرّفات كافية مسبقًا أثناء استيراد البيانات لتجنب الفشل<a href="https://github.com/milvus-io/milvus/pull/42935">(#42935</a>).</li>
<li>تحديث Tantivy لإصلاح انفجار مؤشر ترابط في مراقب الملفات<a href="https://github.com/milvus-io/milvus/pull/42828">(#4282828،</a> <a href="https://github.com/milvus-io/milvus/pull/42713">#42713</a>).</li>
<li>إصلاح مشكلة حيث أصبحت البيانات التي تمت تصفيتها غير مرئية تحت TTL<a href="https://github.com/milvus-io/milvus/pull/42944">(42944</a>).</li>
<li>إزالة نتائج التعبيرات الفارغة المخزنة مؤقتًا لمنع التصفية غير الصحيحة<a href="https://github.com/milvus-io/milvus/pull/42783">(42783/4273</a>).</li>
<li>رفض القسمة أو التعديل على صفر في التعبيرات الحسابية الثنائية<a href="https://github.com/milvus-io/milvus/pull/42887">(42887/4</a>).</li>
<li>التأكد من أن الرسم البياني للتدفق يحرر موارد الدالة بعد إغلاق جميع العقد<a href="https://github.com/milvus-io/milvus/pull/42775">(#42775</a>).</li>
<li>تم إصلاح مشكلة حيث يمكن أن تتعطل DataCoord أثناء الترقية من الإصدار 2.5 إلى الإصدار 2.6<a href="https://github.com/milvus-io/milvus/pull/42669">(#42669</a>).</li>
<li>تمت إضافة فحص مسبق لمنع صب نوع البيانات غير المدعوم<a href="https://github.com/milvus-io/milvus/pull/42678">(#42678</a>).</li>
<li>تمت إضافة حماية التزامن والإغلاق لدالة BM25<a href="https://github.com/milvus-io/milvus/pull/42599">(#42599</a>).</li>
<li>تصفية عقد الاستعلام المتدفقة من مجموعة الموارد أثناء الترقيات<a href="https://github.com/milvus-io/milvus/pull/42594">(#42594</a>).</li>
<li>إصلاح مشكلة في تعبيرات <code translate="no">is_not_in</code> لفهرس Trie<a href="https://github.com/milvus-io/milvus/pull/42886">(42886/4</a>).</li>
<li>تم إصلاح مشكلة منع Rocksmq من التوقف بأمان<a href="https://github.com/milvus-io/milvus/pull/42843">(42843/4</a>).</li>
<li>تم تصحيح تحسين التقليم الأمثل للتعبيرات المنطقية <code translate="no">OR</code> بحيث لا يتم التقليم إلا إذا كانت العقد الفرعية قابلة للتقليم<a href="https://github.com/milvus-io/milvus/pull/42915">(#42915</a>).</li>
<li>إصلاح حالة ذعر QueryCoord الناجمة عن عدم انتظار وحدة التحكم انتهاء المدقق<a href="https://github.com/milvus-io/milvus/pull/42726">(#42726</a>).</li>
<li>تم إصلاح مشكلة عدم قيام المقاطع الصغيرة بمهام فرز المفتاح الأساسي بسبب وضع علامة غير صحيحة على أنها مفهرسة<a href="https://github.com/milvus-io/milvus/pull/42615">(#42615</a>).</li>
<li>تقليل إجمالي تزامن مهام DataNode في الوضع المستقل لمنع أخطاء OOM<a href="https://github.com/milvus-io/milvus/pull/42809">(#42809</a>).</li>
<li>توفير أخطاء صريحة للعمليات الحسابية على الأنواع غير المدعومة<a href="https://github.com/milvus-io/milvus/pull/42890">(#42890</a>).</li>
</ul>
...
<li>إضافة دعم لإسقاط الخصائص من حقل<a href="https://github.com/milvus-io/milvus/pull/41954">(#41954</a>).</li>
...
<li>استخدام القفل لضمان ذرية إسقاط فهارس المقاطع<a href="https://github.com/milvus-io/milvus/pull/42076">(#42076</a>).</li>
...
<li>تمت إضافة دعم لتغيير أوصاف المجموعة<a href="https://github.com/milvus-io/milvus/pull/41547">(#41547</a>).</li>
...
<li>تمكين دعم SVE لحساب مقياس L2 في دالات FP16 / نيويورك<a href="https://github.com/zilliztech/knowhere/pull/1134">(رقم 1134</a>)</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">إصلاحات الأخطاء</h3><ul>
...
<p>نحن متحمسون للإعلان عن إصدار الإصدار Milvus 2.5.8، الذي يتميز بتحسينات على تعبيرات JSON، والتحقق من صحة UTF-8، واستخدام الذاكرة، ومنطق الموازنة. يتضمن هذا الإصدار أيضًا العديد من إصلاحات الأخطاء المهمة لتحسين التزامن ومعالجة البيانات. نحن نشجعك على الترقية أو التجربة، وكما هو الحال دائمًا، تساعدنا ملاحظاتك على تحسين Milvus باستمرار!</p>
<h3 id="Features" class="common-anchor-header">الميزات</h3><ul>
...
<li>إدخال اشتراكات الدُفعات في <code translate="no">MsgDispatcher</code> <a href="https://github.com/milvus-io/milvus/pull/40596">(#40596</a>)</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">إصلاح الأخطاء</h3><ul>
...
<li>لا تحذف ملف السنترويدات عند فشل أخذ العينات؛ بدلاً من ذلك، انتظر حتى يتم التحكم في GC<a href="https://github.com/milvus-io/milvus/pull/40702">(#40702</a>)</li>
...
<li>[2.5] إصلاح ذعر الاستعلامات في حالة الزاوية<a href="https://github.com/milvus-io/milvus/pull/40058">(#40058</a>)</li>
...
<li>تقليل حد تفريغ اللقطة من 10 واط إلى 1 واط<a href="https://github.com/milvus-io/milvus/pull/40102">(#40102</a>)</li>
...
<li>[cp25] تمكين ملاحظة تضخيم الكتابة<a href="https://github.com/milvus-io/milvus/pull/39743">(#39743</a>)</li>
...
<p>للحصول على التفاصيل، راجع <a href="/docs/ar/v2.5.x/analyzer-overview.md">نظرة عامة على المحلل</a> <a href="/docs/ar/v2.5.x/full-text-search.md">والبحث في النص الكامل</a>.</p>
...
<p>لمزيد من التفاصيل، راجع <a href="/docs/ar/v2.5.x/milvus-webui.md">Milvus WebUI</a>.</p>
...
<p>للحصول على التفاصيل، راجع <a href="/docs/ar/v2.5.x/analyzer-overview.md">نظرة عامة على المحلل</a> <a href="/docs/ar/v2.5.x/keyword-match.md">ومطابقة النص</a>.</p>
...
<p>لمزيد من التفاصيل، راجع <a href="/docs/ar/v2.5.x/bitmap.md">فهرس الصور النقطية</a>.</p>
...
<p>للحصول على التفاصيل، راجع <a href="/docs/ar/v2.5.x/nullable-and-default.md">القيمة الفارغة والقيم الافتراضية</a>.</p>
...
<p>لمزيد من التفاصيل، راجع <a href="/docs/ar/v2.5.x/clustering-compaction.md">ضغط التجميع</a>.</p>
...
<p>للحصول على التفاصيل، راجع <a href="/docs/ar/v2.5.x/filtering-templating.md">تصفية القوالب</a>.</p>
...
<p>بالنسبة للمستخدمين الذين لديهم بالفعل نشر Milvus يعمل بالفعل، تحتاج إلى ترقية مكونات ETCD وPulsar قبل أن تتمكن من استخدام الميزات والوظائف الجديدة. للحصول على التفاصيل، راجع <a href="/docs/ar/v2.5.x/upgrade-pulsar-v3.md">ترقية بولسار من 2.x إلى 3.x</a></p>
...
<h4 id="Security--Configuration-Updates" class="common-anchor-header">تحديثات الأمان والتهيئة</h4><p>دعم TLS لتأمين الاتصال بين العقد في البيئات الأكثر تعقيدًا أو بيئات المؤسسات. لمزيد من التفاصيل، راجع <a href="/docs/ar/v2.5.x/tls.md">تكوين الأمان</a>.</p>
