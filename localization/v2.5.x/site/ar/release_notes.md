...
<p>نحن متحمسون للإعلان عن إصدار Milvus 2.5.4، الذي يقدم تحسينات رئيسية في الأداء وميزات جديدة مثل عزل مفتاح التقسيم والفهرس المتناثر مع DAAT MaxScore وآليات تأمين محسّنة. يعالج هذا الإصدار أيضًا العديد من الأخطاء التي تعمل على تحسين الاستقرار والموثوقية بشكل عام. نحن نشجعك على الترقية أو تجربة هذا الإصدار الأخير، ونتطلع إلى تلقي ملاحظاتك لمساعدتنا في تحسين Milvus باستمرار!</p>
...
<li>قراءة البيانات الوصفية بشكل متزامن على مستوى المجموعة لتسريع استرداد الفشل<a href="https://github.com/milvus-io/milvus/pull/38900">(#38900</a>)</li>
<li>تنقيح دقة القفل في QueryNode<a href="https://github.com/milvus-io/milvus/pull/39282">(#39282</a>)،<a href="https://github.com/milvus-io/milvus/pull/38907">(#38907</a>)</li>
...
<li>تحسين سرعة جلب معلومات التجميع من RootCoord من خلال تجنب النسخ غير الضرورية<a href="https://github.com/milvus-io/milvus/pull/38902">(#38902</a>)</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">إصلاحات الأخطاء</h3><ul>
<li>إصلاح مشاكل الاستعلام البطيئة الناجمة عن دقة القفل الخشنة أثناء تحميل أعمدة متعددة<a href="https://github.com/milvus-io/milvus/pull/39255">(#39255</a>)</li>
...
<li>تم إصلاح مشكلة متقطعة حيث تعذر على فهرس tantivy حذف ملفات الفهرس أثناء الإصدار<a href="https://github.com/milvus-io/milvus/pull/39434">(#39434</a>)</li>
...
<li>تم إصلاح مهلات الاستعلام الناتجة عن إعادة تشغيل MixCoord أثناء عمليات الدمج واسعة النطاق<a href="https://github.com/milvus-io/milvus/pull/38926">(#38926</a>)</li>
<li>تم إصلاح عدم توافق الفهرس المقلوب العددي عند الترقية من 2.4 إلى 2.5<a href="https://github.com/milvus-io/milvus/pull/39272">(#39272</a>)</li>
<li>تم إصلاح مشاكل عدم توازن القناة الناجمة عن تعطل العقدة<a href="https://github.com/milvus-io/milvus/pull/39200">(#39200</a>)</li>
<li>تم إصلاح مشكلة قد تتسبب في تعطل توازن القناة.<a href="https://github.com/milvus-io/milvus/pull/39160">(#39160</a>)</li>
<li>تم إصلاح مشكلة عدم فعالية عمليات التحقق من مستوى امتيازات المجموعة المخصصة RBAC<a href="https://github.com/milvus-io/milvus/pull/39224">(#39224</a>)</li>
...
<li>إنشاء ملف index_null_offset للفهرس فقط للحقول التي تدعم القيم الفارغة.<a href="https://github.com/milvus-io/milvus/pull/38834">(#38834</a>)</li>
