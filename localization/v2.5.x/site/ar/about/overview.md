...
<li><p>خدمات نقل المتجهات (VTS) توفر Milvus مجموعة من الأدوات لتتمكن من نقل بياناتك بين مثيل Milvus ومجموعة من مصادر البيانات، بما في ذلك مجموعات Zilliz وElasticsearch وPostgres (PgVector) ومثيل Milvus آخر. لمزيد من التفاصيل، راجع <a href="/docs/ar/migrate_overview.md">عمليات الترحيل</a>.</p></li>
</ul>
