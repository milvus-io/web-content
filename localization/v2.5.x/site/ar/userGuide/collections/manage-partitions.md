...
<h3 id="Load-Partitions​" class="common-anchor-header">تحميل الأقسام</h3><p>يمكنك تحميل أقسام معينة في مجموعة بشكل منفصل. من الجدير بالذكر أن حالة التحميل للمجموعة تظل غير محملة إذا كان هناك قسم غير محمل في المجموعة.</p>
<div class="multipleCode">
 <a href="#python">بايثون </a> <a href="#java">جافا جافا</a> <a href="#javascript">Node.js</a> <a href="#go">Go</a> <a href="#curl">cURL</a></div>
