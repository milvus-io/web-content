...
title: إسقاط مجموعة
---
<h1 id="Drop-Collection​" class="common-anchor-header">إسقاط مجموعة<button data-href="#Drop-Collection​" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>يمكنك إسقاط مجموعة إذا لم تعد هناك حاجة إليها.</p>
<h2 id="Examples" class="common-anchor-header">أمثلة<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>تفترض المقتطفات البرمجية التالية أن لديك مجموعة باسم <strong>Customized_setup_2</strong>.</p>
