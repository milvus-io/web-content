...
<p>a.  إذا كان كذلك، فسيقوم Milvus باستبدال المفتاح الأساسي في الكيان بمفتاح أساسي تم إنشاؤه تلقائيًا وإدراج البيانات.</p>
<p>b. إذا لم يكن كذلك، سيستخدم Milvus المفتاح الأساسي الذي يحمله الكيان لإدراج البيانات.</p></li>
<li><p>ج. تنفيذ عملية حذف استناداً إلى قيمة المفتاح الأساسي للكيان المضمن في طلب Upsert.</p></li>
</ol>
<p>
   ...
   </span> <span class="img-wrapper"> <span>كيانات Upsert Upsert</span> </span></p>
