...
<h2 id="Manage-database-properties" class="common-anchor-header">إدارة خصائص قاعدة البيانات<button data-href="#Manage-database-properties" class="anchor-icon" translate="no">
    ...
    </button></h2><p>كل قاعدة بيانات لها خصائصها الخاصة، يمكنك تعيين خصائص قاعدة البيانات عند إنشاء قاعدة البيانات كما هو موضح في <a href="/docs/ar/v2.5.x/manage_databases.md#Create-database">إنشاء قاعدة بيانات</a> أو يمكنك تغيير وإسقاط خصائص أي قاعدة بيانات موجودة.</p>
...
<h2 id="Use-database" class="common-anchor-header">استخدام قاعدة البيانات<button data-href="#Use-database" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يمكنك التبديل من قاعدة بيانات إلى أخرى دون قطع الاتصال بـ Milvus.</p>
<div class="alert note">
<p>واجهة برمجة تطبيقات RESTful لا تدعم هذه العملية.</p>
</div>
<div class="multipleCode">
   <a href="#python">بايثون</a> <a href="#java">جافا جافا</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<h2 id="Drop-database" class="common-anchor-header">إسقاط قاعدة البيانات<button data-href="#Drop-database" class="anchor-icon" translate="no">
    ...
    </button></h2><p>بمجرد انتفاء الحاجة إلى قاعدة البيانات، يمكنك إسقاط قاعدة البيانات. لاحظ أن:</p>
<ul>
