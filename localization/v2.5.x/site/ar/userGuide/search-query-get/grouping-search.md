...
summary: >-
  ...
  التجميع للعثور على فئات الكتب التي قد تتضمن الموضوعات التي تمت مناقشتها في ذلك
  الكتاب. يصف هذا الموضوع كيفية استخدام بحث التجميع إلى جانب الاعتبارات
  الرئيسية.
title: تجميع البحث عن المجموعات
---
...
<p>
   ...
   </span> <span class="img-wrapper"> <span>البحث في الشبكة النانوية</span> </span></p>
...
<p>في المثال أعلاه</p>
<ul>
<li><p><code translate="no">group_size</code>: يحدد عدد الكيانات المطلوب إرجاعها لكل مجموعة. على سبيل المثال، تعيين <code translate="no">group_size=2</code> يعني أن كل مجموعة (أو كل <code translate="no">docId</code>) يجب أن تُرجع بشكل مثالي فقرتين من أكثر الفقرات (أو <strong>القطع</strong>) تشابهًا. إذا لم يتم تعيين <code translate="no">group_size</code> ، يقوم النظام افتراضيًا بإرجاع نتيجة واحدة لكل مجموعة.</p></li>
...
<p>للحصول على تفاصيل المعلمة الإضافية، راجع <a href="https://milvus.io/api-reference/pymilvus/v2.4.x/MilvusClient/Vector/search.md">البحث ()</a>.</p>
