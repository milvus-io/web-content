...
<p><strong>اعتبارات حول فهرسة JSON</strong></p>
<ul>
...
<ul>
<li>داخليًا، يقوم ميلفوس بفهرسة جميع الحقول الرقمية كمضاعفات. إذا تجاوزت قيمة رقمية ، فإنها تفقد الدقة، وقد لا تتطابق الاستعلامات على تلك القيم خارج النطاق تمامًا.</li>
</ul></li>
