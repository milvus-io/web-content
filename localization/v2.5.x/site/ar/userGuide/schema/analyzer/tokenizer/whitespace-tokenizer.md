...
summary: >-
  تقوم أداة ترميز المسافات البيضاء بتقسيم النص إلى مصطلحات كلما كانت هناك مسافة
  بين الكلمات.
---

<h1 id="Whitespace" class="common-anchor-header">المسافات البيضاء<button data-href="#Whitespace" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>يقوم أداة الترميز <code translate="no">whitespace</code> بتقسيم النص إلى مصطلحات كلما كانت هناك مسافة بين الكلمات.</p>
<h2 id="Configuration" class="common-anchor-header">التكوين<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>لتكوين محلل باستخدام أداة الترميز <code translate="no">whitespace</code> ، اضبط <code translate="no">tokenizer</code> على <code translate="no">whitespace</code> في <code translate="no">analyzer_params</code>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>يمكن لأداة ترميز المسافات البيضاء أن تعمل بالاقتران مع واحد أو أكثر من عوامل التصفية. على سبيل المثال، يُعرّف الرمز التالي محللًا يستخدم أداة ترميز <code translate="no">whitespace</code> ومرشح <code translate="no">lowercase</code><a href="/docs/ar/v2.5.x/lowercase-filter.md">:</a></p>
<div class="multipleCode">
   <a href="#python">بايثون</a> <a href="#java">جافا جافا</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
<pre><code translate="no" class="language-python">analyzer_params = {
    <span class="hljs-string">&quot;tokenizer&quot;</span>: <span class="hljs-string">&quot;whitespace&quot;</span>,
...
<pre><code translate="no" class="language-bash"><span class="hljs-comment"># restful</span>
<button class="copy-code-btn"></button></code></pre>
<h3 id="Expected-output" class="common-anchor-header">المخرجات المتوقعة</h3><pre><code translate="no" class="language-plaintext">[&#x27;the&#x27;, &#x27;milvus&#x27;, &#x27;vector&#x27;, &#x27;database&#x27;, &#x27;is&#x27;, &#x27;built&#x27;, &#x27;for&#x27;, &#x27;scale!&#x27;]
<button class="copy-code-btn"></button></code></pre>
