...
<p>بالإضافة إلى ذلك، يدعم ميلفوس مقاييس تشابه أخرى للمتجهات الثنائية. لمزيد من المعلومات، راجع <a href="/docs/ar/v2.5.x/metric.md">أنواع المقاييس</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>لمزيد من المعلومات حول معلمات البحث عن التشابه، راجع <a href="/docs/ar/v2.5.x/single-vector-search.md">بحث ANN الأساسي</a>.</p>
