...
<h3 id="Set-the-nullable-attribute" class="common-anchor-header">تعيين السمة لاغية</h3><p>عند إنشاء مجموعة، استخدم <code translate="no">nullable=True</code> لتعريف الحقول القابلة للفراغ (الإعدادات الافتراضية إلى <code translate="no">False</code>). ينشئ المثال التالي مجموعة باسم <code translate="no">user_profiles_null</code> ويضبط الحقل <code translate="no">age</code> على أنه قابل للإلغاء:</p>
...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>لمزيد من المعلومات حول كيفية تفعيل إعدادات القيمة الفارغة والافتراضية، راجع <a href="/docs/ar/nullable-and-default.md#share-FciZdpB0zoXmGwxMxgecYuP6nHc">القواعد القابلة للتطبيق</a>.</p>
</div>
