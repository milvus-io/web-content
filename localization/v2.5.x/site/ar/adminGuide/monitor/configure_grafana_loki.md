...
<h3 id="1-Create-Promtail-Configuration" class="common-anchor-header">1. إنشاء تكوين برومتيل<button data-href="#1-Create-Promtail-Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>قم بإنشاء ملف تكوين <code translate="no">promtail.yaml</code>:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Install-Promtail" class="common-anchor-header">2. تثبيت برومتيل<button data-href="#2-Install-Promtail" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>تثبيت Promtail باستخدام Helm:</p>
...
<h3 id="1-Deploy-Grafana" class="common-anchor-header">1. نشر غرافانا<button data-href="#1-Deploy-Grafana" class="anchor-icon" translate="no">
    ...
    </button></h3><p>قم بتثبيت غرافانا باستخدام الأوامر التالية:</p>
