---
id: ingress.md
title: تكوين مدخل nginx مع ميلفوس
related_key: ingress nginx
summary: تعرّف على كيفية تهيئة دخول nginx مع ميلفوس.
---
<h1 id="Configure-ingress-nginx-with-Milvus" class="common-anchor-header">تكوين مدخل nginx مع ميلفوس<button data-href="#Configure-ingress-nginx-with-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>يقدم هذا الموضوع كيفية تكوين دخول nginx مع Milvus. لمزيد من التفاصيل، راجع <a href="https://learn.microsoft.com/en-us/azure/aks/ingress-tls?tabs=azure-cli">Ingress-nginx</a>.</p>
<h2 id="Configure-ingress-nginx" class="common-anchor-header">تكوين دخول nginx<button data-href="#Configure-ingress-nginx" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>قم بتكوين FQDN لوحدة تحكم الدخول.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Install-cert-manager" class="common-anchor-header">تثبيت مدير الشهادات<button data-href="#Install-cert-manager" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Create-a-CA-cluster-issuer" class="common-anchor-header">إنشاء مُصدر مجموعة CA<button data-href="#Create-a-CA-cluster-issuer" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>قم بإنشاء مُصدِر مجموعة كتلة، مثل cluster-issuer.yaml، باستخدام مثال البيان التالي. استبدل MY_EMAIL_ADDRESS بعنوان صالح من مؤسستك.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>قم بتطبيق المُصدر باستخدام الأمر kubectl apply.</li>
</ul>
...
<h2 id="Deploy-Milvus" class="common-anchor-header">نشر ميلفوس<button data-href="#Deploy-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>ارجع إلى <a href="https://milvus.io/docs/azure.md">أزور،</a> لاحظ قيمة التكوين <code translate="no">service.type</code> ، تحتاج إلى التغيير إلى <code translate="no">ClusterIP</code>.</p>
<h2 id="Create-Milvus-ingress-route" class="common-anchor-header">إنشاء مسار دخول ميلفوس<button data-href="#Create-Milvus-ingress-route" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
            ...
            backend:
              service:
                ...
                port:
                  number: 19530
<button class="copy-code-btn"></button></code></pre>
<h2 id="Verify" class="common-anchor-header">تحقق من<button data-href="#Verify" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Hello-Milvus" class="common-anchor-header">مرحبًا ميلفوس<button data-href="#Hello-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>يرجى الرجوع إلى <a href="https://milvus.io/docs/v2.3.x/example_code.md">مرحبًا</a> ميلفوس، قم بتغيير وسيطات uri، ثم قم بتشغيل الكود.</p>
