---
id: s3.md
title: تكوين وصول S3 حسب دور IAM
related_key: "s3, storage, iam"
summary: تعرف على كيفية تكوين s3 مع دور IAM.
---

<h1 id="Configure-S3-Access-by-IAM-Role" class="common-anchor-header">تكوين وصول S3 حسب دور IAM<button data-href="#Configure-S3-Access-by-IAM-Role" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>يقدم هذا الموضوع كيفية تكوين الوصول إلى S3 حسب دور IAM عند تثبيت Milvus مع Helm. لمزيد من التفاصيل، راجع <a href="https://docs.aws.amazon.com/eks/latest/userguide/associate-service-account-role.html">أدوار IAM</a>.</p>
...
<li><p>يرجى تمكين OIDC عند إنشاء مجموعة EKS باستخدام eksctl. لمزيد من التفاصيل، راجع <a href="https://docs.aws.amazon.com/eks/latest/userguide/enable-iam-roles-for-service-accounts.html">IAM OIDC</a>.</p></li>
<li><p>يفترض هذا الدليل أنك قمت بالفعل <a href="/docs/ar/v2.5.x/eks.md">بنشر مجموعة Milvus Cluster على AWS مع Kubernetes</a>.</p></li>
</ul>
<h2 id="Associate-an-IAM-role-with-a-Kubernetes-service-account" class="common-anchor-header">إقران دور IAM بحساب خدمة Kubernetes<button data-href="#Associate-an-IAM-role-with-a-Kubernetes-service-account" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<p>اقرأ <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.html">قواعد تسمية الدلو</a> وراقب قواعد التسمية عند تسمية دلو AWS S3 الخاص بك.</p>
...
<li><p>قم بإنشاء نهج IAM لقراءة وكتابة الكائنات داخل الدلو الذي تم إنشاؤه أعلاه. <strong>استبدل اسم الدلو باسم الدلو الخاص بك.</strong></p>
...
<li><p>أنشئ دور IAM واربطه بحساب خدمة Kubernetes. استبدل <code translate="no">your-account-id</code> بمعرف حسابك.</p></li>
</ul>
...
<h2 id="Verify-the-role-and-service-account-setup" class="common-anchor-header">تحقق من إعداد الدور وحساب الخدمة<button data-href="#Verify-the-role-and-service-account-setup" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>يرجى الرجوع إلى <a href="https://docs.aws.amazon.com/eks/latest/userguide/associate-service-account-role.html">أدوار IAM</a>.</p>
<ul>
<li>تأكد من تكوين سياسة الثقة الخاصة بدور IAM بشكل صحيح.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>تأكد من إرفاق النهج الذي أرفقته بالدور في الخطوة السابقة بالدور.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>اعرض الإصدار الافتراضي للنهج.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>اعرض محتويات النهج للتأكد من أن النهج يتضمن جميع الأذونات التي يحتاجها Pod الخاص بك. إذا لزم الأمر، استبدل 1 في الأمر التالي بالإصدار الذي تم إرجاعه في الإخراج السابق.</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>تأكّد من أن حساب خدمة Kubernetes مُرفق بالدور.</li>
</ul>
...
<ul>
<li>أضف ريبو Milvus Helm Chart.</li>
</ul>
<pre><code translate="no" class="language-bash">helm repo <span class="hljs-keyword">add</span> milvus https:<span class="hljs-comment">//zilliztech.github.io/milvus-helm/</span>
helm repo update
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>قم بإعداد ملف تكوين Milvus <code translate="no">milvus.yaml</code> ، واستبدل <code translate="no">&lt;bucket-name&gt;</code> باسم الدلو الذي تم إنشاؤه أعلاه.</li>
</ul>
...
<h2 id="Verify-the-installation" class="common-anchor-header">تحقق من التثبيت<button data-href="#Verify-the-installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>يرجى الرجوع إلى <a href="https://milvus.io/docs/eks.md#Verify-the-installation">التحقق من التثبيت</a>.</p>
