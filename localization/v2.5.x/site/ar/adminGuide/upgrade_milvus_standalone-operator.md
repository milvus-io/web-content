...
<li>لترقية Milvus من إصدار ثانوي قبل الإصدار 2.2.3 إلى 2.5.12، يُنصح بترقية Milvus <a href="#Upgrade-Milvus-by-changing-its-image">عن طريق تغيير إصدار الصورة الخاص به</a>.</li>
