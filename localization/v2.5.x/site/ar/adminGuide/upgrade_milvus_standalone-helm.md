...
<h4 id="2-Upgrade-Milvus-from-v21x-to-2519" class="common-anchor-header">2. ترقية ملفوس من الإصدار 2.1.x إلى 2.5.19</h4><p>تفترض الأوامر التالية أنك قمت بترقية ملفوس من الإصدار 2.1.4 إلى 2.5.19. قم بتغييرها إلى الإصدارات التي تناسب احتياجاتك.</p>
<ol>
