...
summary: >-
  يوضّح هذا الدليل كيفية استخدام راجاس لتقييم خط أنابيب توليد الاسترجاع المعزز
...
<h2 id="Evaluation-with-Ragas" class="common-anchor-header">التقييم باستخدام راجاس<button data-href="#Evaluation-with-Ragas" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
