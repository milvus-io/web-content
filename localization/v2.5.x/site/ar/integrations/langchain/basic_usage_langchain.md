...
<h3 id="Query-by-turning-into-retriever" class="common-anchor-header">الاستعلام عن طريق التحويل إلى مسترجع</h3><p>يمكنك أيضًا تحويل مخزن المتجهات إلى مسترجع لسهولة الاستخدام في سلاسل البيانات الخاصة بك.</p>
