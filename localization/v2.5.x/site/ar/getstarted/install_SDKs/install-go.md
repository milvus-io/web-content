...
<h1 id="Install-Milvus-Go-SDK" class="common-anchor-header">تثبيت Milvus Go SDK<button data-href="#Install-Milvus-Go-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>يصف هذا الموضوع كيفية تثبيت Milvus Go SDK لـ Milvus.</p>
...
<h2 id="Requirement" class="common-anchor-header">المتطلبات<button data-href="#Requirement" class="anchor-icon" translate="no">
    ...
    </button></h2><p>مطلوب GO (1.17 أو أحدث).</p>
<h2 id="Install-Milvus-GO-SDK" class="common-anchor-header">تثبيت Milvus GO SDK<button data-href="#Install-Milvus-GO-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
