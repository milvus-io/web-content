...
<p>انظر <a href="/docs/ar/v2.5.x/index.md">فهرس المتجهات</a> لمزيد من المعلومات.</p>
...
<p>راجع <a href="/docs/ar/v2.5.x/index.md">فهرس المتجهات</a> لمزيد من المعلومات.</p>
...
<h4 id="Is-Milvus-scalable" class="common-anchor-header">هل Milvus قابل للتطوير؟</h4><p>نعم، يمكنك نشر مجموعة Milvus مع عقد متعددة عبر مخطط Helm على Kubernetes. راجع <a href="/docs/ar/v2.5.x/scaleout.md">دليل التوسع</a> لمزيد من التعليمات.</p>
...
<p>عند اختيار مستوى الاتساق، ضع في اعتبارك المفاضلة بين الاتساق والأداء. بالنسبة للعمليات التي تتطلب رؤية فورية، استخدم مستوى اتساق "قوي". لعمليات الكتابة الأسرع، قم بإعطاء الأولوية للاتساق الأضعف (قد لا تكون البيانات مرئية على الفور). لمزيد من المعلومات، راجع <a href="/docs/ar/v2.5.x/consistency.md">الاتساق</a>.</p>
