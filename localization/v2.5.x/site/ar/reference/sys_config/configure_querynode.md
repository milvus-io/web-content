  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>2. إذا تم التعيين على "تعطيل" سيتم تحميل بيانات المتجه الأصلية في ذاكرة التخزين المؤقت للقطع فقط أثناء البحث/الاستعلام.</li>      </td>
      <td>تعطيل</td>
    </tr>
  </tbody>
</table>
...
<h2 id="queryNodedataSyncflowGraphmaxParallelism" class="common-anchor-header"><code translate="no">queryNode.dataSync.flowGraph.maxParallelism</code><button data-href="#queryNodedataSyncflowGraphmaxParallelism" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        العدد الأقصى للمهام المنفذة بالتوازي في الرسم البياني للتدفق      </td>
      <td>1024</td>
    </tr>
  </tbody>
</table>
