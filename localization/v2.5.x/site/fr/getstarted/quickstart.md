...
<h3 id="Query" class="common-anchor-header">Requête</h3><p>Une requête() est une opération qui permet de récupérer toutes les entités correspondant à un critère, tel qu'une <a href="https://milvus.io/docs/boolean.md">expression de filtre</a> ou la correspondance avec certains identifiants.</p>
