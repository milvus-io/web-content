...
summary: >-
  ...
  traitera comme tel sans provoquer d'erreur.
---
...
<button class="copy-code-btn"></button></code></pre>
<p>Pour renvoyer des entités avec des valeurs nulles, effectuez une requête sans condition de filtrage scalaire comme suit :</p>
<div class="alert note">
<p>La méthode <code translate="no">query</code>, lorsqu'elle est utilisée sans condition de filtrage, récupère toutes les entités de la collection, y compris celles qui ont des valeurs nulles. Pour limiter le nombre d'entités renvoyées, le paramètre <code translate="no">limit</code> doit être spécifié.</p>
</div>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>Pour plus d'informations sur la manière dont les paramètres de valeur nulle et de valeur par défaut prennent effet, voir <a href="#applicable-rules">Règles applicables.</a></p>
</div>
...
<table>
<thead>
<tr><th>Nulle</th><th>Valeur par défaut</th><th>Valeur par défaut Type</th><th>Entrée utilisateur</th><th>Résultat</th><th>Exemple</th></tr>
</thead>
<tbody>
<tr><td>✅</td><td>✅</td><td>Non nul</td><td>Non/nul</td><td>Utilise la valeur par défaut</td><td><ul><li>Champ : <code translate="no">age</code></li><li>Valeur par défaut : <code translate="no">18</code></li><li>Entrée utilisateur : null</li><li>Résultat : stocké en tant que <code translate="no">18</code></li></ul></td></tr>
