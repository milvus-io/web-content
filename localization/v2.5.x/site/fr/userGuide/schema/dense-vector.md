...
<table>
   ...
   <tr>
     ...
     <td><p>Stocke des nombres à virgule flottante Brain 16 bits (bfloat16), offrant la même gamme d'exposants que Float32 mais avec une précision réduite. Convient aux scénarios qui nécessitent le traitement rapide de grands volumes de vecteurs, tels que la recherche d'images à grande échelle.</p></td>
   </tr>
   <tr>
     <td></td>
     <td></td>
...
<p>Milvus prend en charge d'autres types métriques. Pour plus d'informations, voir <a href="/docs/fr/v2.5.x/metric.md">Types métriques</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Pour plus d'informations sur les paramètres de recherche de similarité, reportez-vous à la section <a href="/docs/fr/v2.5.x/single-vector-search.md">Recherche ANN de base</a>.</p>
