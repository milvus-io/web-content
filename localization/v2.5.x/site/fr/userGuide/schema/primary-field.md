...
<h2 id="Use-VarChar-Primary-Keys​" class="common-anchor-header">Utiliser des clés primaires VarChar<button data-href="#Use-VarChar-Primary-Keys​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pour utiliser les clés primaires VarChar, outre la modification de la valeur du paramètre <code translate="no">data_type</code> en <code translate="no">DataType.VARCHAR</code>, vous devez également définir le paramètre <code translate="no">max_length</code> pour le champ. </p>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
