...
summary: >-
  Le filtre cnalphanumonly supprime les jetons qui contiennent des caractères
  autres que des caractères chinois, des lettres anglaises ou des chiffres.
---
...
<h1 id="Cnalphanumonly" class="common-anchor-header">Cnalphanumonly<button data-href="#Cnalphanumonly" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Le filtre <code translate="no">cnalphanumonly</code> supprime les jetons qui contiennent des caractères autres que des caractères chinois, des lettres anglaises ou des chiffres.</p>
<h2 id="Configuration" class="common-anchor-header">Configuration<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Le filtre <code translate="no">cnalphanumonly</code> est intégré à Milvus. Pour l'utiliser, il suffit de spécifier son nom dans la section <code translate="no">filter</code> de <code translate="no">analyzer_params</code>.</p>
