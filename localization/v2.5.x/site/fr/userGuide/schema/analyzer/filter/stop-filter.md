...
<table>
   ...
   <tr>
     ...
     <td><p>Une liste de mots à supprimer de la tokenisation. Par défaut, le filtre utilise le dictionnaire intégré <code translate="no">_english_</code>. Vous pouvez le remplacer ou l'étendre de trois manières :</p><ul><li><p><strong>Dictionnaires intégrés</strong> - fournissez l'un de ces alias linguistiques pour utiliser un dictionnaire prédéfini :<code translate="no">"_english_"</code>, <code translate="no">"_danish_"</code>, <code translate="no">"_dutch_"</code>, <code translate="no">"_finnish_"</code>, <code translate="no">"_french_"</code>, <code translate="no">"_german_"</code>, <code translate="no">"_hungarian_"</code>, <code translate="no">"_italian_"</code>, <code translate="no">"_norwegian_"</code>, <code translate="no">"_portuguese_"</code>, <code translate="no">"_russian_"</code>, <code translate="no">"_spanish_"</code>, <code translate="no">"_swedish_"</code></p></li><li><p><strong>Liste personnalisée</strong> - transmettez un tableau de vos propres termes, par exemple <code translate="no">["foo", "bar", "baz"]</code>.</p></li><li><p><strong>Liste mixte</strong> - combine des alias et des termes personnalisés, par exemple <code translate="no">["of", "to", "_english_"]</code>.</p><p>Pour plus de détails sur le contenu exact de chaque dictionnaire prédéfini, reportez-vous à <a href="https://github.com/milvus-io/milvus/blob/master/internal/core/thirdparty/tantivy/tantivy-binding/src/analyzer/filter/stop_words.rs">stop_words</a>.</p></li></ul></td>
   </tr>
</table>
