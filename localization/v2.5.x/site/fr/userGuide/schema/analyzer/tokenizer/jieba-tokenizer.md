...
<h2 id="Configuration" class="common-anchor-header">Configuration<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pour configurer un analyseur utilisant le tokenizer <code translate="no">jieba</code>, définissez <code translate="no">tokenizer</code> à <code translate="no">jieba</code> dans <code translate="no">analyzer_params</code>.</p>
...
<h2 id="Example-output" class="common-anchor-header">Exemple de sortie<button data-href="#Example-output" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Voici un exemple de traitement de texte par le tokenizer <code translate="no">jieba</code>:</p>
