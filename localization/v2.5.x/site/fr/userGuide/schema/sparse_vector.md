...
<p>
   ...
   </span> <span class="img-wrapper"> <span>use-sparse-vector</span> </span></p>
...
<h3 id="Create-collection" class="common-anchor-header">Création de la collection</h3><p>Une fois que les paramètres relatifs aux vecteurs épars et à l'index sont terminés, vous pouvez créer une collection contenant des vecteurs épars. L'exemple ci-dessous utilise la méthode <code translate="no">create_collection</code> pour créer une collection nommée <code translate="no">my_sparse_collection</code>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
