...
<li><p>Pour chaque sous-vecteur d'interrogation et son livre de codes correspondant (contenant 2^{\textit{nbits}} centroïdes), les distances par rapport à tous les centroïdes sont calculées et stockées.</p></li>
<li><p>Cette opération génère <code translate="no">m</code> tables de recherche, chaque table contenant 2^{\textit{nbits}} distances.</p></li>
</ul></li>
