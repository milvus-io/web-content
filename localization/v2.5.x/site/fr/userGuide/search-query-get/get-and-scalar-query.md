...
<table>
   ...
   <tr>
     ...
     <td><ul><li>Nom de la collection</li><li>Clés primaires</li></ul></td>
     <td><ul><li>Nom de la collection</li><li>Expressions de filtrage</li></ul></td>
   ...
   <tr>
     ...
     <td><ul><li>Nom de la partition</li><li>Champs de sortie</li></ul></td>
...
<p>Pour en savoir plus sur le filtrage des métadonnées, reportez-vous à <a href="/docs/fr/filtering">Filtrage</a>.</p>
