...
<div class="alert note">
<p>Actuellement, la fonction d'isolation de la clé de partition ne s'applique qu'aux recherches dont le type d'index est défini sur HNSW.</p>
</div>
