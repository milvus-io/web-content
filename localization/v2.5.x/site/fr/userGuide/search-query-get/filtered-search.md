...
<span class="hljs-punctuation">]</span>
<button class="copy-code-btn"></button></code></pre>
<p>Pour plus d'informations sur les opérateurs que vous pouvez utiliser dans le filtrage des métadonnées, reportez-vous à <a href="/docs/fr/v2.5.x/filtering">Filtrage</a>.</p>
