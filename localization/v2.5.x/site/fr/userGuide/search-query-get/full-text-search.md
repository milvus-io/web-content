...
<table>
   ...
   <tr>
     ...
     <td><p>Proportion de termes de faible importance à ignorer lors de la recherche. Pour plus d'informations, reportez-vous à la section <a href="/docs/fr/v2.5.x/sparse_vector.md">Vecteur clairsemé</a>.</p></td>
   </tr>
   <tr>
     <td></td>
     <td></td>
