...
<li><code translate="no">IS NOT NULL</code>: Identifie les entités dont un champ spécifique contient une valeur autre que null, ce qui signifie que le champ a une valeur valide et définie.</li>
</ul>
