...
summary: >-
  ...
  d'insertion en vérifiant si la clé primaire existe. Cette section présente la
...
<ol>
<li><p>Vérifier si le champ primaire de la collection a la fonction AutoId activée.</p>
<ol>
<li><p>Si c'est le cas, Milvus remplace la clé primaire de l'entité par une clé primaire générée automatiquement et insère les données.</p></li>
<li><p>Si ce n'est pas le cas, Milvus utilise la clé primaire de l'entité pour insérer les données.</p></li>
</ol></li>
...
<p>
   ...
   </span> <span class="img-wrapper"> <span>Flux de travail de l'insertion d'entités</span> </span></p>
