...
<h3 id="Install-based-on-Docker-image" class="common-anchor-header">Installation basée sur l'image Docker</h3><pre><code translate="no" class="language-shell"><span class="hljs-meta prompt_">$ </span><span class="language-bash">docker run -it zilliz/milvus_cli:latest</span>
<button class="copy-code-btn"></button></code></pre>
