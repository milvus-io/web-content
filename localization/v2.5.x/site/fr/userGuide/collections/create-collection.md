...
<ul>
<li><p><a href="/docs/fr/v2.5.x/create-collection.md#Create-Schema">Créer un schéma</a></p></li>
<li><p><a href="/docs/fr/v2.5.x/create-collection.md#Optional-Set-Index-Parameters">Définir les paramètres d'index</a> (facultatif)</p></li>
<li><p><a href="/docs/fr/v2.5.x/create-collection.md#Create-a-Collection">Créer une collection</a></p></li>
</ul>
<h2 id="Create-Schema" class="common-anchor-header">Créer un schéma<button data-href="#Create-Schema" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Un schéma définit la structure des données d'une collection. Lors de la création d'une collection, vous devez concevoir le schéma en fonction de vos besoins. Pour plus d'informations, reportez-vous à la section <a href="/docs/fr/v2.5.x/schema.md">Schéma expliqué</a>.</p>
...
<p>Vous pouvez définir des valeurs par défaut pour tout champ scalaire et le rendre nullable. Pour plus d'informations, reportez-vous à <a href="/docs/fr/v2.5.x/nullable-and-default.md">Nullable &amp; Default</a>.</p>
</div>
...
<p>Pour plus de détails, voir <a href="/docs/fr/v2.5.x/index-vector-fields.md">Indexer les champs vectoriels</a> et <a href="/docs/fr/v2.5.x/index-scalar-fields.md">Indexer les champs scalaires</a>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Set-Collection-TTL" class="common-anchor-header">Définir le TTL de la collection</h3><p>Si les données d'une collection doivent être abandonnées pendant une période spécifique, envisagez de définir sa durée de vie (TTL) en secondes. Une fois le TTL dépassé, Milvus supprime les entités de la collection. La suppression est asynchrone, ce qui signifie que les recherches et les requêtes sont toujours possibles avant que la suppression ne soit terminée.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Set-Consistency-Level" class="common-anchor-header">Définir le niveau de cohérence</h3><p>Lors de la création d'une collection, vous pouvez définir le niveau de cohérence des recherches et des requêtes dans la collection. Vous pouvez également modifier le niveau de cohérence de la collection lors d'une recherche ou d'une requête spécifique.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>Pour en savoir plus sur les niveaux de cohérence, voir <a href="/docs/fr/v2.5.x/tune_consistency.md">Niveau de cohérence</a>.</p>
...
<p>Pour plus de détails sur l'utilisation du champ dynamique, voir <a href="/docs/fr/v2.5.x/enable-dynamic-field.md">Champ dynamique</a>.</p>
