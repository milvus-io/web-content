...
<div style="display: none;">- [Effectuer une mise à niveau continue](#conduct-a-rolling-upgrade) de Milvus v2.2.3 et versions ultérieures vers v2.5.18.</div>
<ul>
<li><p><a href="#Upgrade-Milvus-using-Helm">Mettre à niveau Milvus à l'aide de Helm</a> pour une mise à niveau d'une version mineure antérieure à v2.2.3 vers v2.5.18.</p></li>
<li><p><a href="#Migrate-the-metadata">Migrer les métadonnées</a> avant la mise à niveau de Milvus v2.1.x vers v2.5.18.</p></li>
</ul>
...
<p>Une fois que vous vous êtes assuré que tous les déploiements de votre instance Milvus sont dans leur état normal. Vous pouvez exécuter la commande suivante pour mettre à niveau l'instance Milvus vers la version 2.5.18.</p>
...
<h3 id="1-Check-the-Milvus-version" class="common-anchor-header">1. Vérifier la version de Milvus<button data-href="#1-Check-the-Milvus-version" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Exécutez <code translate="no">$ helm list</code> pour vérifier la version de votre application Milvus. Vous pouvez voir que <code translate="no">APP VERSION</code> est 2.1.4.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Check-the-running-pods" class="common-anchor-header">2. Vérifier les pods en cours d'exécution<button data-href="#2-Check-the-running-pods" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Exécutez <code translate="no">$ kubectl get pods</code> pour vérifier les pods en cours d'exécution. Vous pouvez voir la sortie suivante.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="3-Check-the-image-tag" class="common-anchor-header">3. Vérifier la balise image<button data-href="#3-Check-the-image-tag" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Vérifiez la balise d'image pour le pod <code translate="no">my-release-milvus-proxy-6c548f787f-scspp</code>. Vous pouvez voir que la version de votre cluster Milvus est v2.1.4.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="4-Migrate-the-metadata" class="common-anchor-header">4. Migrer les métadonnées<button data-href="#4-Migrate-the-metadata" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h4 id="2-Upgrade-Milvus-from-v21x-to-2518" class="common-anchor-header">2. Mise à niveau de Milvus de la version 2.1.x à la version 2.5.18</h4><p>Les commandes suivantes supposent que vous mettez à niveau Milvus de la version 2.1.4 à la version 2.5.18. Modifiez-les pour obtenir les versions qui répondent à vos besoins.</p>
<ol>
