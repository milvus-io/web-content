...
<h4 id="2-Upgrade-Milvus-from-v21x-to-259" class="common-anchor-header">2. Mise à niveau de Milvus de la version 2.1.x à la version 2.5.9</h4><p>Les commandes suivantes supposent que vous mettez à niveau Milvus de la version 2.1.4 à la version 2.5.9. Modifiez-les pour obtenir les versions qui répondent à vos besoins.</p>
<ol>
