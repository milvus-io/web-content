...
<h2 id="Getting-started" class="common-anchor-header">Pour commencer<button data-href="#Getting-started" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Avant de commencer, assurez-vous d'avoir la clé API OpenAI à portée de main ou d'en obtenir une sur le <a href="https://openai.com/index/openai-api/">site Web d'OpenAI</a>.</p>
