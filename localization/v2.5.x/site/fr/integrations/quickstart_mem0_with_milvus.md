...
<h2 id="Preparation" class="common-anchor-header">Préparation<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Download-required-libraries" class="common-anchor-header">Télécharger les bibliothèques nécessaires</h3><pre><code translate="no" class="language-shell">$ pip install mem0ai pymilvus
...
<h2 id="Managing-User-Memories-with-Mem0-and-Milvus" class="common-anchor-header">Gestion des mémoires d'utilisateurs avec Mem0 et Milvus<button data-href="#Managing-User-Memories-with-Mem0-and-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
