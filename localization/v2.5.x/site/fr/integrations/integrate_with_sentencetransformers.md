...
<h2 id="Required-Libraries" class="common-anchor-header">Bibliothèques requises<button data-href="#Required-Libraries" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Pour cet exemple, nous utiliserons <code translate="no">pymilvus</code> pour nous connecter afin d'utiliser Milvus, <code translate="no">sentence-transformers</code> pour générer des embeddings vectoriels et <code translate="no">datasets</code> pour télécharger le jeu de données de l'exemple.</p>
