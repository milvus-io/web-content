...
<tr><td><code translate="no">milvus.secure</code></td><td><code translate="no">false</code></td><td>Active les connexions TLS/SSL sécurisées.</td></tr>
<tr><td><code translate="no">milvus.secure.serverName</code></td><td><code translate="no">localhost</code></td><td>Nom d'hôte attendu pour la vérification TLS.</td></tr>
<tr><td><code translate="no">milvus.secure.serverPemPath</code></td><td><code translate="no">--</code></td><td>Chemin d'accès au fichier PEM du serveur pour TLS.</td></tr>
<tr><td><code translate="no">milvus.secure.caCert</code></td><td><code translate="no">--</code></td><td>Chemin d'accès au fichier du certificat de l'autorité de certification pour la vérification.</td></tr>
<tr><td><code translate="no">milvus.secure.clientCert</code></td><td><code translate="no">--</code></td><td>Chemin d'accès au certificat du client pour l'authentification.</td></tr>
<tr><td><code translate="no">milvus.secure.clientKey</code></td><td><code translate="no">--</code></td><td>Chemin d'accès à la clé privée du client pour l'authentification.</td></tr>
<tr><td><code translate="no">milvus.collection.primaryKeyField</code></td><td><code translate="no">None</code></td><td>Nom du champ de la clé primaire dans la collection. Requis si la collection n'existe pas.</td></tr>
<tr><td><code translate="no">milvus.collection.vectorField</code></td><td><code translate="no">None</code></td><td>Nom du champ du vecteur dans la collection. Obligatoire si la collection n'existe pas.</td></tr>
...
<h3 id="MilvusUtilsbulkInsertFromSpark" class="common-anchor-header">MilvusUtils.bulkInsertFromSpark<button data-href="#MilvusUtilsbulkInsertFromSpark" class="anchor-icon" translate="no">
    ...
    </button></h3><p><strong>MilvusUtils.bulkInsertFromSpark</strong> fournit un moyen pratique d'importer des fichiers de sortie Spark dans Milvus dans un grand lot. Il intègre l'API <strong>Bullkinsert</strong> du SDK Milvus.</p>
