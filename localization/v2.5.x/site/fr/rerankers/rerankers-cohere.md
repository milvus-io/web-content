...
order: 3
summary: >-
  Milvus prend en charge les modèles de reranking Cohere par le biais de la
  classe `CohereRerankFunction`. Cette fonctionnalité vous permet d'évaluer
  efficacement la pertinence des paires requête-document.
title: Rerankers Cohérence
---
<h1 id="Cohere" class="common-anchor-header">Cohere<button data-href="#Cohere" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus prend en charge les<a href="https://docs.cohere.com/docs/rerank-2"> modèles de reranker</a> <a href="https://docs.cohere.com/docs/rerank-2">Cohere</a> par le biais de la classe <code translate="no">CohereRerankFunction</code>. Cette fonctionnalité vous permet d'évaluer efficacement la pertinence des paires requête-document.</p>
<p>Pour utiliser cette fonctionnalité, installez les dépendances nécessaires :</p>
<pre><code translate="no" class="language-bash">pip install --upgrade pymilvus
pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>Ensuite, instanciez la classe <code translate="no">CohereRerankFunction</code>:</p>
...
<p>Le nom du modèle à utiliser. Vous pouvez spécifier n'importe quel nom de modèle Cohere reranker disponible, par exemple, <code translate="no">rerank-english-v3.0</code>, <code translate="no">rerank-multilingual-v3.0</code>, etc. Si ce paramètre n'est pas spécifié, <code translate="no">rerank-english-v2.0</code> sera utilisé. Pour obtenir la liste des modèles disponibles, reportez-vous à <a href="https://docs.cohere.com/docs/rerank-2">Rerank</a>.</p></li>
<li><p><code translate="no">api_key</code> <em>(chaîne</em>)</p>
<p>La clé d'API permettant d'accéder à l'API Cohere. Pour plus d'informations sur la création d'une clé API, reportez-vous à <a href="https://dashboard.cohere.com/api-keys">Cohere dashboard</a>.</p></li>
</ul>
