...
<h3 id="natsmq" class="common-anchor-header"><code translate="no">natsmq</code><button data-href="#natsmq" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Configuration de natsmq.</p>
<p>Plus de détails : https://docs.nats.io/running-a-nats-service/configuration</p>
<p>Voir <a href="/docs/fr/v2.5.x/configure_natsmq.md">Configurations liées à natsmq</a> pour une description détaillée de chaque paramètre de cette section.</p>
<h3 id="rootCoord" class="common-anchor-header"><code translate="no">rootCoord</code><button data-href="#rootCoord" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Configuration connexe de rootCoord, utilisée pour gérer les requêtes en langage de définition des données (DDL) et en langage de contrôle des données (DCL).</p>
