  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>Pour partager une instance etcd entre plusieurs instances Milvus, envisager de modifier ce paramètre à une valeur différente pour chaque instance Milvus avant de les démarrer.</li>      
