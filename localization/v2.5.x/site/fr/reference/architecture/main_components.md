...
<li>Lire <a href="/docs/fr/v2.5.x/four_layers.md">Computing/Storage Disaggregation</a> pour comprendre le mécanisme et le principe de conception de Milvus.</li>
</ul>
