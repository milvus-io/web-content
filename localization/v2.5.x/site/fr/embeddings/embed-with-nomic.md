...
order: 12
summary: >-
  Cet article décrit comment utiliser la fonction NomicEmbeddingFunction pour
  encoder des documents et des requêtes à l'aide du modèle d'encodage Nomic.
title: Nomic
---
<h1 id="Nomic" class="common-anchor-header">Nomic<button data-href="#Nomic" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Les modèles<a href="https://atlas.nomic.ai/">Nomic</a> sont une série de solutions avancées d'intégration de textes et d'images développées par Nomic AI, conçues pour convertir diverses formes de données en vecteurs numériques denses qui capturent leur signification sémantique.</p>
<p>Milvus s'intègre aux modèles d'intégration de Nomic via la classe NomicEmbeddingFunction. Cette classe fournit des méthodes pour coder les documents et les requêtes à l'aide des modèles d'intégration Nomic et pour renvoyer les intégrations sous forme de vecteurs denses compatibles avec l'indexation Milvus. Pour utiliser cette fonctionnalité, obtenez une clé API de <a href="https://atlas.nomic.ai/">Nomic Atlas</a>.</p>
<p>Pour utiliser cette fonctionnalité, installez les dépendances nécessaires :</p>
<pre><code translate="no" class="language-python">pip install --upgrade pymilvus
pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>Ensuite, instanciez la NomicEmbeddingFunction :</p>
