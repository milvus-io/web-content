...
<h3 id="1-Assign-a-single-GPU-device" class="common-anchor-header">1. Atribuir um único dispositivo GPU</h3><p>O Milvus com suporte para GPU permite-lhe atribuir um ou mais dispositivos GPU.</p>
<ul>
<li><p>Grupo Milvus</p>
