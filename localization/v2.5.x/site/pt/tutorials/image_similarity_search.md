...
<h2 id="Define-the-Feature-Extractor" class="common-anchor-header">Definir o Extrator de caraterísticas<button data-href="#Define-the-Feature-Extractor" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Em seguida, precisamos definir um extrator de caraterísticas que extrai a incorporação de uma imagem usando o modelo ResNet-34 do timm.</p>
...
<h2 id="Create-a-Milvus-Collection" class="common-anchor-header">Criar uma coleção Milvus<button data-href="#Create-a-Milvus-Collection" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Em seguida, temos de criar uma coleção Milvus para armazenar os embeddings da imagem</p>
...
<p>Podemos ver que a maioria das imagens são da mesma categoria que a imagem de pesquisa, que é o cão de caça afegão. Isto significa que encontrámos imagens semelhantes à imagem de pesquisa.</p>
