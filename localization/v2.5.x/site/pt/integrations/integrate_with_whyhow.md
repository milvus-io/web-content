...
<h2 id="Create-Collection" class="common-anchor-header">Criar coleção<button data-href="#Create-Collection" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Defining-necessary-variables" class="common-anchor-header">Definir as variáveis necessárias</h3><pre><code translate="no" class="language-python"><span class="hljs-comment"># Define collection name</span>
