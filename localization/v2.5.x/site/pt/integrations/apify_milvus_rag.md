...
<ul>
<li>Se você tiver um servidor Milvus auto-implantado no <a href="https://milvus.io/docs/quickstart.md">Docker ou Kubernetes</a>, use o endereço e a porta do servidor como seu uri, por exemplo,<code translate="no">http://localhost:19530</code>. Se você ativar o recurso de autenticação no Milvus, use "&lt;seu_nome_de_usuário&gt;:&lt;sua_senha&gt;" como o token, caso contrário, deixe o token como string vazia.</li>
