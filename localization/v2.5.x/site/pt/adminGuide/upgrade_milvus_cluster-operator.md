...
---
<div class="tab-wrapper"><a href="/docs/pt/v2.5.x/upgrade_milvus_cluster-operator.md" class='active '>Milvus</a><a href="/docs/pt/v2.5.x/upgrade_milvus_cluster-helm.md" class=''>OperatorHelm</a></div>
...
<h2 id="Upgrade-Milvus-by-changing-its-image" class="common-anchor-header">Atualizar o Milvus alterando sua imagem<button data-href="#Upgrade-Milvus-by-changing-its-image" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Em casos normais, pode simplesmente atualizar o seu Milvus para a versão mais recente alterando a sua imagem. No entanto, note que haverá um certo tempo de inatividade ao atualizar o Milvus desta forma.</p>
...
<h2 id="Migrate-the-metadata" class="common-anchor-header">Migrar os metadados<button data-href="#Migrate-the-metadata" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Desde o Milvus 2.2.0, os metadados são incompatíveis com os das versões anteriores. Os seguintes exemplos pressupõem uma atualização do Milvus 2.1.4 para o Milvus 2.5.24.</p>
...
<h3 id="2-Apply-the-new-configuration" class="common-anchor-header">2. Aplicar a nova configuração<button data-href="#2-Apply-the-new-configuration" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Execute o seguinte comando para criar a nova configuração.</p>
