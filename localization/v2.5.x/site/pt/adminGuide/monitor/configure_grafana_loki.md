...
<h3 id="1-Create-Promtail-Configuration" class="common-anchor-header">1. Criar a configuração do Promtail<button data-href="#1-Create-Promtail-Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Crie um arquivo de configuração <code translate="no">promtail.yaml</code>:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Install-Promtail" class="common-anchor-header">2. Instalar o Promtail<button data-href="#2-Install-Promtail" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Instalar o Promtail usando o Helm:</p>
