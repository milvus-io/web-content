---
id: s3.md
title: Configurar o acesso ao S3 por função de IAM
related_key: "s3, storage, iam"
summary: Saiba como configurar o s3 com a função IAM.
---

<h1 id="Configure-S3-Access-by-IAM-Role" class="common-anchor-header">Configurar o acesso ao S3 por função de IAM<button data-href="#Configure-S3-Access-by-IAM-Role" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><p>Este guia pressupõe que você já implantou <a href="/docs/pt/v2.5.x/eks.md">um Cluster Milvus no AWS com o Kubernetes</a>.</p></li>
</ul>
