...
<li><p>Implantou <a href="/docs/pt/v2.5.x/gcp.md">um cluster do Milvus atrás de um balanceador de carga de camada 4 no GCP</a>.</p></li>
</ul>
<h3 id="Tweak-Milvus-configurations" class="common-anchor-header">Ajustar as configurações do Milvus</h3><p>Este guia pressupõe que você já implantou <a href="/docs/pt/v2.5.x/gcp.md">um cluster do Milvus por trás de um balanceador de carga de Camada 4 no GCP</a>.</p>
