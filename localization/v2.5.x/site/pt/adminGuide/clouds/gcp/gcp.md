---
id: gcp.md
title: Implantar um cluster do Milvus no GKE
related_key: cluster
...
<h2 id="Before-you-start" class="common-anchor-header">Antes de começar<button data-href="#Before-you-start" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Para implementar o Milvus no GCP, certifique-se de que</p>
<ul>
...
<button class="copy-code-btn"></button></code></pre>
<p>Levará alguns minutos para que o cluster do Kubernetes seja ativado. Quando o cluster estiver pronto, use o seguinte comando para obter suas credenciais para que você possa executar <code translate="no">kubectl</code> comandos no seu terminal para se comunicar com o cluster remotamente.</p>
...
<p>Se quiser expor sua instância do Milvus por meio de um balanceador de carga de Camada 7, <a href="/docs/pt/v2.5.x/gcp_layer7.md">leia isto</a>.</p>
