...
<ul>
<li>Saiba como <a href="/docs/pt/v2.5.x/monitor.md">monitorar o Milvus com o Prometheus Operator no Kubernetes</a></li>
<li>Saiba <a href="/docs/pt/v2.5.x/visualize.md">como visualizar as métricas do Milvus no Grafana</a>.</li>
</ul></li>
