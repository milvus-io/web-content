...
---
<div class="tab-wrapper"><a href="/docs/pt/v2.5.x/upgrade_milvus_standalone-operator.md" class='active '>Milvus</a><a href="/docs/pt/v2.5.x/upgrade_milvus_standalone-helm.md" class=''>OperatorHelmDocker</a><a href="/docs/pt/v2.5.x/upgrade_milvus_standalone-docker.md" class=''>Compose</a></div>
...
<h2 id="Upgrade-your-Milvus-operator" class="common-anchor-header">Atualizar o seu Milvus Operator<button data-href="#Upgrade-your-Milvus-operator" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Execute o seguinte comando para atualizar a versão do seu operador Milvus para a v1.2.0.</p>
...
<ul>
<li>Para atualizar o Milvus da versão v2.2.3 ou versões posteriores para a versão 2.5.24, pode <a href="#Conduct-a-rolling-upgrade">efetuar uma atualização contínua</a>.</li>
<li>Para atualizar o Milvus de uma versão secundária anterior à v2.2.3 para a 2.5.24, é aconselhável <a href="#Upgrade-Milvus-by-changing-its-image">atualizar o Milvus alterando a sua versão de imagem</a>.</li>
<li>Para atualizar o Milvus da v2.1.x para a 2.5.24, é necessário <a href="#Migrate-the-metadata">migrar os metadados</a> antes da atualização efectiva.</li>
</ul>
...
<h2 id="Migrate-the-metadata" class="common-anchor-header">Migrar os metadados<button data-href="#Migrate-the-metadata" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Desde o Milvus 2.2.0, os metadados são incompatíveis com os das versões anteriores. Os seguintes exemplos pressupõem uma atualização do Milvus 2.1.4 para o Milvus v2.5.24.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Apply-the-new-configuration" class="common-anchor-header">2. Aplicar a nova configuração<button data-href="#2-Apply-the-new-configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Execute o seguinte comando para aplicar a nova configuração.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="3-Check-the-status-of-metadata-migration" class="common-anchor-header">3. Verificar o estado da migração de metadados<button data-href="#3-Check-the-status-of-metadata-migration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Execute o seguinte comando para verificar o estado da migração de metadados.</p>
...
<h3 id="4-Delete-my-release-upgrade" class="common-anchor-header">4. Eliminar <code translate="no">my-release-upgrade</code><button data-href="#4-Delete-my-release-upgrade" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Quando a atualização for bem sucedida, elimine <code translate="no">my-release-upgrade</code> no ficheiro YAML.</p>
