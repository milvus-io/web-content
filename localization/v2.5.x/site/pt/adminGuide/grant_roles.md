...
<h2 id="Describe-user​" class="common-anchor-header">Descrever o utilizador<button data-href="#Describe-user​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Depois de atribuir uma função a um utilizador, pode verificar se a operação de atribuição foi bem sucedida através do método <code translate="no">describe_user()</code>.</p>
