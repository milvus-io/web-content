...
<li><p><code translate="no">minio.backupBucketName</code>: Nome do compartimento utilizado para armazenamento de cópias de segurança em<code translate="no">milvus_B</code>. Neste exemplo, <code translate="no">milvus_A</code> e <code translate="no">milvus_B</code> usam compartimentos diferentes. Portanto, defina como <code translate="no">bucket_B</code>.</p></li>
