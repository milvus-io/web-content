...
<h3 id="Define-schema" class="common-anchor-header">Definir o esquema<button data-href="#Define-schema" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Para a pesquisa híbrida multi-vetorial, devemos definir vários campos vectoriais num esquema de coleção. Por defeito, cada coleção pode acomodar até 4 campos vectoriais. No entanto, se necessário, pode ajustar o <code translate="no">proxy.maxVectorFieldNum</code> para incluir até 10 campos vectoriais numa coleção, conforme necessário.</p>
