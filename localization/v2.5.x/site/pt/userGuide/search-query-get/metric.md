...
<li><p><code translate="no">​TF(qi​,D)</code>: Frequência do termo, que representa a frequência com que o termo <code translate="no">​qi</code> aparece no documento <code translate="no">​D</code>.</p></li>
