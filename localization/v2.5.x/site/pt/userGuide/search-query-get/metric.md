...
<ul>
<li><p>Para campos vectoriais do tipo <code translate="no">SPARSE\_FLOAT\_VECTOR</code>, utilize o tipo métrico <code translate="no">BM25</code> apenas quando efetuar a pesquisa de texto integral. Para mais informações, consulte <a href="/docs/pt/v2.5.x/full-text-search.md">Pesquisa de texto integral</a>.</p></li>
...
<h2 id="BM25-similarity" class="common-anchor-header">Similaridade BM25<button data-href="#BM25-similarity" class="anchor-icon" translate="no">
    ...
    </button></h2><p>O BM25 é um método de medição da relevância do texto amplamente utilizado, especificamente concebido para a <a href="/docs/pt/v2.5.x/full-text-search.md">pesquisa de textos completos</a>. Combina os três factores-chave seguintes:</p>
<ul>
