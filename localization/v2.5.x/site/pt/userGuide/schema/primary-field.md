...
<h2 id="Use-VarChar-Primary-Keys" class="common-anchor-header">Usar chaves primárias VarChar<button data-href="#Use-VarChar-Primary-Keys" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Para utilizar chaves primárias VarChar, para além de alterar o valor do parâmetro <code translate="no">data_type</code> para <code translate="no">DataType.VARCHAR</code>, também é necessário definir o parâmetro <code translate="no">max_length</code> para o campo.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
