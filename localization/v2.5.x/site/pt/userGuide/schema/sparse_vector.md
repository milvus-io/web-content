...
<ul>
<li><p><code translate="no">index_type</code>: O tipo de índice a ser criado para o campo de vetor esparso. Valores válidos:</p>
<ul>
...
<h3 id="Create-collection" class="common-anchor-header">Criar coleção</h3><p>Quando as configurações de vetor esparso e índice estiverem concluídas, você poderá criar uma coleção que contenha vetores esparsos. O exemplo abaixo usa o método <code translate="no">create_collection</code> para criar uma coleção chamada <code translate="no">my_sparse_collection</code>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
