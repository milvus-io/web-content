...
<button class="copy-code-btn"></button></code></pre>
<div class="alert note">
<p>Para obter mais informações sobre como as configurações de valor nulo e padrão entram em vigor, consulte <a href="/docs/pt/nullable-and-default.md#share-FciZdpB0zoXmGwxMxgecYuP6nHc">Regras aplicáveis</a>.</p>
</div>
...
<table>
   <tr>
     ...
     <th><p>Tipo de valor predefinido</p></th>
