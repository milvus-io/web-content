...
<button class="copy-code-btn"></button></code></pre>
<p>A configuração do analisador incorporado <code translate="no">standard</code> acima é equivalente à configuração de um analisador personalizado com os seguintes parâmetros, onde as opções <code translate="no">tokenizer</code> e <code translate="no">filter</code> são explicitamente definidas para alcançar a mesma funcionalidade:</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
<pre><code translate="no" class="language-python">analyzer_params = {​
