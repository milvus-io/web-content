...
<div class="alert note">
<p>Se omitir as configurações do analisador durante a criação da coleção, o Milvus utiliza por defeito o analisador <code translate="no">standard</code> para todo o processamento de texto. Para obter detalhes, consulte <a href="/docs/pt/v2.5.x/standard-analyzer.md">Padrão</a>.</p>
</div>
...
<ul>
<li><p><strong>Configuração:</strong> Definir os parâmetros do analisador para o analisador incorporado em inglês.</p></li>
