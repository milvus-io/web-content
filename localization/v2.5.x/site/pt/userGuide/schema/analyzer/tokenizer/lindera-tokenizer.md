...
<h1 id="Lindera" class="common-anchor-header">Lindera<button data-href="#Lindera" class="anchor-icon" translate="no">
    ...
    </button></h1><p>O tokenizador <code translate="no">lindera</code> executa análise morfológica baseada em dicionário. É uma boa escolha para idiomas - como o japonês, coreano e chinês - cujas palavras não são separadas por espaços.</p>
...
<table>
   ...
   <tr>
     ...
     <td><p>Uma lista de dicionários usados para definir o vocabulário. Valores possíveis:</p><ul><li><p><code translate="no">ipadic</code>: Japonês</p></li><li><p><code translate="no">ko-dic</code>: Coreano</p></li><li><p><code translate="no">cc-cedict</code>: Chinês mandarim (tradicional/simpl.)</p></li></ul></td>
   </tr>
</table>
...
<h3 id="Analyzer-configuration" class="common-anchor-header">Configuração do analisador</h3><pre><code translate="no" class="language-python">analyzer_params = {
    <span class="hljs-string">&quot;tokenizer&quot;</span>: {
      <span class="hljs-string">&quot;type&quot;</span>: <span class="hljs-string">&quot;lindera&quot;</span>,
      <span class="hljs-string">&quot;dict_kind&quot;</span>: <span class="hljs-string">&quot;ipadic&quot;</span>
    }
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Verification-using-runanalyzer" class="common-anchor-header">Verificação usando <code translate="no">run_analyzer</code></h3><pre><code translate="no" class="language-python"><span class="hljs-comment"># Sample text to analyze</span>
