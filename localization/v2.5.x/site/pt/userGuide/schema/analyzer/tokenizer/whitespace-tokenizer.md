...
title: Tokenizador de espaços em branco
summary: >-
  O tokenizador `whitespace` divide o texto em termos sempre que houver um
...
<p>O tokenizador de espaço em branco pode funcionar em conjunto com um ou mais filtros. Por exemplo, o código a seguir define um analisador que usa o tokenizador <code translate="no">whitespace</code> e <a href="/docs/pt/lowercase-filter.md"><code translate="no">lowercase filter</code></a>:</p>
<pre><code translate="no" class="language-python">analyzer_params = {​
    <span class="hljs-string">&quot;tokenizer&quot;</span>: <span class="hljs-string">&quot;whitespace&quot;</span>,​
