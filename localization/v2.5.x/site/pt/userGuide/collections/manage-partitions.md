...
<p>Esta funcionalidade não será abordada nesta página. Para saber mais, consulte <a href="/docs/pt/v2.5.x/use-partition-key.md">Usar chave de partição</a>.</p>
</div>
...
<h3 id="Load-Partitions" class="common-anchor-header">Carregar partições</h3><p>Você pode carregar separadamente partições específicas em uma coleção. É importante notar que o estado de carregamento de uma coleção permanece descarregado se existir uma partição descarregada na coleção.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
...
<h2 id="Data-Operations-Within-Partitions" class="common-anchor-header">Operações de dados em partições<button data-href="#Data-Operations-Within-Partitions" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Insert-and-Delete-Entities" class="common-anchor-header">Inserir e eliminar entidades</h3><p>É possível executar operações de inserção, upsert e exclusão em operações específicas. Para obter detalhes, consulte</p>
<ul>
<li><p><a href="/docs/pt/v2.5.x/insert-update-delete.md#Insert-Entities-into-a-Partition">Inserir entidades na partição</a></p></li>
<li><p><a href="/docs/pt/v2.5.x/upsert-entities.md#Upsert-Entities-in-a-Partition">Inserir entidades na partição</a></p></li>
<li><p><a href="/docs/pt/v2.5.x/delete-entities.md#Delete-Entities-from-Partitions">Excluir entidades da partição</a></p></li>
</ul>
...
<ul>
<li><p><a href="/docs/pt/v2.5.x/single-vector-search.md#ANN-Search-in-Partition">Realizar pesquisas ANN dentro de partições</a></p></li>
<li><p><a href="/docs/pt/v2.5.x/get-and-scalar-query.md#Queries-in-Partitions">Realizar filtragem de metadados em partições</a></p></li>
</ul>
