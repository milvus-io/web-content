...
<ul>
<li><p><a href="/docs/pt/v2.5.x/set-collection-ttl.md#Set-TTL-when-creating-a-collection">Cria uma coleção.</a></p></li>
<li><p><a href="/docs/pt/v2.5.x/set-collection-ttl.md#Set-TTL-for-an-existing-collection">Altera a propriedade TTL de uma coleção existente.</a></p></li>
</ul>
