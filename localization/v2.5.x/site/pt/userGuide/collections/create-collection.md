...
<ul>
<li><p><a href="#create-schema">Criar um esquema</a></p></li>
<li><p><a href="#optional-set-index-parameters">Definir parâmetros de índice</a> (opcional)</p></li>
<li><p><a href="#create-collection">Criar coleção</a></p></li>
</ul>
<h2 id="Create-Schema​" class="common-anchor-header">Criar esquema<button data-href="#Create-Schema​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Um esquema define a estrutura de dados de uma coleção. Ao criar uma coleção, é necessário conceber o esquema com base nas suas necessidades. Para mais pormenores, consulte <a href="/docs/pt/manage-collections.md">Esquema explicado</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Também é possível criar uma coleção sem quaisquer parâmetros de indexação e adicioná-los posteriormente. Neste caso, o Milvus não carrega a coleção aquando da sua criação. Para obter detalhes sobre como criar índices para uma coleção existente, consulte <a href="/docs/pt/index-vector-fields.md">Index Explained</a>.</p>
<p>O seguinte trecho de código demonstra como criar uma coleção sem uma coleção, e o status de carregamento da coleção permanece descarregado após a criação.</p>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#go">Go</a> <a href="#curl">cURL</a></div>
...
<button class="copy-code-btn"></button></code></pre>
<p>O Milvus também fornece uma forma de criar uma coleção instantaneamente. Para obter detalhes, consulte <a href="/docs/pt/create-collection-instantly.md">Criar coleção instantaneamente</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Set-Collection-TTL​" class="common-anchor-header">Definir TTL da coleção</h3><p>Se uma coleção precisar ser descartada por um período específico, considere definir seu Time-To-Live (TTL) em segundos. Uma vez que o TTL se esgota, o Milvus apaga as entidades da coleção e abandona a coleção. A eliminação é assíncrona, indicando que as pesquisas e consultas ainda são possíveis antes de a eliminação estar concluída.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Para saber mais sobre os níveis de consistência, consulte <a href="/docs/pt/consistency.md">Nível de consistência</a>.</p>
