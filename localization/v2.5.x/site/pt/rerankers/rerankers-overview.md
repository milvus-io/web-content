...
<h2 id="Example-1-Use-BGE-rerank-function-to-rerank-documents-according-to-a-query" class="common-anchor-header">Exemplo 1: Usar a função de classificação da BGE para classificar documentos de acordo com uma consulta<button data-href="#Example-1-Use-BGE-rerank-function-to-rerank-documents-according-to-a-query" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Neste exemplo, demonstramos como classificar os resultados de pesquisa usando o <a href="/docs/pt/v2.5.x/rerankers-bge.md">reranker do BGE</a> com base em uma consulta específica.</p>
...
<li><code translate="no">doc_vector</code>: Embeddings vectoriais que representam o documento. Para obter orientação sobre como gerar embeddings, consulte <a href="/docs/pt/v2.5.x/embeddings.md">Embeddings</a>.</li>
