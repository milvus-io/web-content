...
<p>Nachdem Sie sich in BentoCloud angemeldet haben, können Sie mit den bereitgestellten BentoCloud-Diensten in Deployments interagieren, und der entsprechende END_POINT und die API befinden sich in Playground -&gt; Python. Sie können die Stadtdaten <a href="https://github.com/ytang07/bento_octo_milvus_RAG/tree/main/data">hier</a> herunterladen.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Nun müssen wir die Einbettungen und die Textabschnitte zuordnen. Da die Liste der Einbettungen und die Liste der Sätze nach Index übereinstimmen sollten, können wir <code translate="no">enumerate</code> durch beide Listen gehen, um sie abzugleichen.</p>
