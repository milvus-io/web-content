...
summary: >-
  Dieses Tutorial zeigt, wie man mit Milvus und Mistral OCR ein System zum
  Verstehen von Dokumenten aufbaut.
title: Dokumentverstehen mit Mistral OCR und Milvus
---
...
<h1 id="Document-Understanding-with-Mistral-OCR-and-Milvus" class="common-anchor-header">Dokumentverstehen mit Mistral OCR und Milvus<button data-href="#Document-Understanding-with-Mistral-OCR-and-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Dieses Tutorial zeigt, wie man ein System zum Verstehen von Dokumenten aufbaut:</p>
<h2 id="Mistral-OCR" class="common-anchor-header">Mistral OCR<button data-href="#Mistral-OCR" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ein leistungsstarker optischer Zeichenerkennungsdienst, der:</p>
<ul>
<li>PDFs, Bilder und andere Dokumentformate verarbeitet</li>
<li>Struktur und Formatierung von Dokumenten beibehält</li>
<li>Mehrseitige Dokumente verarbeiten kann</li>
<li>Erkennung von Tabellen, Listen und anderen komplexen Elementen</li>
</ul>
<h2 id="Mistral-Embeddings" class="common-anchor-header">Mistral-Einbettungen<button data-href="#Mistral-Embeddings" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Wandelt Text in numerische Repräsentationen um:</li>
<li>Konvertiert Text in 1024-dimensionale Vektoren</li>
<li>Erfasst semantische Beziehungen zwischen Konzepten</li>
<li>Ermöglicht Ähnlichkeitsabgleich auf Basis der Bedeutung</li>
<li>Bietet eine Grundlage für die semantische Suche</li>
</ul>
<h2 id="Milvus-Vector-Database" class="common-anchor-header">Milvus Vektor-Datenbank<button data-href="#Milvus-Vector-Database" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Spezialisierte Datenbank für die vektorielle Ähnlichkeitssuche:</p>
<ul>
<li>Open-Source</li>
<li>Führt effiziente Vektorsuche durch</li>
<li>Skalierbar für große Dokumentensammlungen</li>
<li>Unterstützt hybride Suche (Vektorähnlichkeit + Filterung von Metadaten)</li>
<li>Optimiert für KI-Anwendungen</li>
</ul>
<p>Am Ende dieses Tutorials werden Sie ein System haben, das Folgendes kann</p>
<ol>
<li>Dokumente (PDFs/Bilder) über URLs verarbeiten kann</li>
<li>Text mit OCR extrahieren</li>
<li>den Text und die Vektoreinbettungen in Milvus speichern</li>
<li>eine semantische Suche über Ihre Dokumentensammlung durchführen</li>
</ol>
<hr>
<h2 id="Setup-and-Dependencies" class="common-anchor-header">Einrichtung und Abhängigkeiten<button data-href="#Setup-and-Dependencies" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Installieren wir zunächst die erforderlichen Pakete:</p>
...
<ol>
<li>Einen Mistral API Schlüssel (erhalten Sie unter https://console.mistral.ai/)</li>
<li>Milvus läuft lokal über <a href="https://milvus.io/docs/install_standalone-docker.md">Docker</a> oder mit <a href="https://zilliz.com">Zilliz Cloud</a></li>
</ol>
<p>Lassen Sie uns unsere Umgebung einrichten:</p>
...
<h2 id="Setting-Up-Milvus-Collection" class="common-anchor-header">Einrichten der Milvus-Sammlung<button data-href="#Setting-Up-Milvus-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Nun erstellen wir eine Milvus-Sammlung, um unsere Dokumentendaten zu speichern. Die Sammlung wird die folgenden Felder haben:</p>
<ul>
<li><code translate="no">id</code>: Primärschlüssel (automatisch generiert)</li>
<li><code translate="no">url</code>: Quell-URL des Dokuments</li>
<li><code translate="no">page_num</code>: Seitenzahl innerhalb des Dokuments</li>
<li><code translate="no">content</code>: Extrahierter Textinhalt</li>
<li><code translate="no">embedding</code>: Vektorielle Darstellung des Inhalts (1024 Dimensionen)</li>
</ul>
...
<h2 id="Core-Functionality" class="common-anchor-header">Kernfunktionalität<button data-href="#Core-Functionality" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Lassen Sie uns die Kernfunktionen für unser System zum Verstehen von Dokumenten implementieren:</p>
...
<span class="hljs-keyword">def</span> <span class="hljs-title function_">process_document</span>(<span class="hljs-params">url</span>):
    ...
    <span class="hljs-keyword">return</span> ocr_result
<button class="copy-code-btn"></button></code></pre>
<h2 id="Search-Functionality" class="common-anchor-header">Suchfunktionalität<button data-href="#Search-Functionality" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Nun wollen wir die Suchfunktionalität implementieren, um relevante Dokumentinhalte zu finden:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h2 id="Demo-Processing-Documents" class="common-anchor-header">Demo: Verarbeitung von Dokumenten<button data-href="#Demo-Processing-Documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Lassen Sie uns einige Beispieldokumente verarbeiten. Sie können diese URLs durch Ihre eigenen Dokumente ersetzen.</p>
...
<p>Verarbeiten wir auch ein Bild:</p>
...
<h2 id="Demo-Searching-Documents" class="common-anchor-header">Demo: Dokumente durchsuchen<button data-href="#Demo-Searching-Documents" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Jetzt, wo wir einige Dokumente verarbeitet haben, können wir sie durchsuchen:</p>
...
<h2 id="Conclusion" class="common-anchor-header">Schlussfolgerung<button data-href="#Conclusion" class="anchor-icon" translate="no">
    ...
    </button></h2><p>In diesem Tutorial haben wir ein komplettes System zum Verstehen von Dokumenten mit Mistral OCR und Milvus aufgebaut. Dieses System kann:</p>
<ol>
<li>Dokumente aus URLs verarbeiten</li>
<li>Text mit Mistrals OCR-Fähigkeiten extrahieren</li>
<li>Vektoreinbettungen für den Inhalt generieren</li>
<li>sowohl Text als auch Vektoren in Milvus speichern</li>
<li>eine semantische Suche über alle verarbeiteten Dokumente durchführen</li>
</ol>
<p>Dieser Ansatz ermöglicht leistungsstarke Funktionen zum Verstehen von Dokumenten, die über den einfachen Abgleich von Schlüsselwörtern hinausgehen und es den Benutzern ermöglichen, Informationen auf der Grundlage der Bedeutung und nicht anhand von exakten Textübereinstimmungen zu finden.</p>
