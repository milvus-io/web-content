...
<h3 id="1-Create-Promtail-Configuration" class="common-anchor-header">1. Promtail-Konfiguration erstellen<button data-href="#1-Create-Promtail-Configuration" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Erstellen Sie eine <code translate="no">promtail.yaml</code> Konfigurationsdatei:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="2-Install-Promtail" class="common-anchor-header">2. Promtail installieren<button data-href="#2-Install-Promtail" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Installieren Sie Promtail mit Helm:</p>
