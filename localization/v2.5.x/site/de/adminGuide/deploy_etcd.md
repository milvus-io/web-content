...
<p>Weitere Informationen finden Sie unter <a href="/docs/de/v2.5.x/configure_etcd.md">etcd-bezogene Konfigurationen</a>.</p>
...
<ul>
<li><a href="/docs/de/v2.5.x/deploy_s3.md">Konfigurieren Sie den Objektspeicher mit Docker Compose oder Helm</a></li>
