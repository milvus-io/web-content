...
<ul>
<li>Lernen Sie <a href="/docs/de/v2.5.x/monitor.md">Milvus mit Prometheus Operator auf Kubernetes zu überwachen</a></li>
<li>Lernen Sie <a href="/docs/de/v2.5.x/visualize.md">Milvus-Metriken in Grafana zu visualisieren</a>.</li>
</ul></li>
