...
<p>Siehe <a href="/docs/de/v2.5.x/configure_minio.md">MinIO/S3-Konfigurationen</a> für weitere Informationen.</p>
<h3 id="2-Refine-docker-composeyaml" class="common-anchor-header">2. Verfeinern Sie docker-compose.yaml</h3><p>Entfernen Sie auch die Umgebungsvariable <code translate="no">MINIO_ADDRESS</code> für den milvus-Dienst unter <code translate="no">docker-compose.yaml</code>. Standardmäßig verwendet milvus lokales Minio anstelle von externem S3.</p>
...
<ul>
<li><a href="/docs/de/v2.5.x/deploy_etcd.md">Konfigurieren von Metaspeicher mit Docker Compose oder Helm</a></li>
