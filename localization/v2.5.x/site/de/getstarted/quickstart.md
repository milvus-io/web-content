...
<h2 id="Set-Up-Vector-Database" class="common-anchor-header">Einrichten der Vektordatenbank<button data-href="#Set-Up-Vector-Database" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Um eine lokale Milvus-Vektordatenbank zu erstellen, richten Sie einfach eine <code translate="no">MilvusClient</code> ein, indem Sie einen Dateinamen angeben, unter dem alle Daten gespeichert werden, z. B. &quot;milvus_demo.db&quot;.</p>
