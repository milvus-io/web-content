...
<li><p><a href="/docs/de/v2.5.x/prerequisite-helm.md#How-can-I-start-a-K8s-cluster-locally-for-test-purposes">Erstellen Sie einen K8s-Cluster</a>.</p></li>
...
<li><p>Überprüfen Sie vor der Installation <a href="/docs/de/v2.5.x/prerequisite-helm.md">die Hardware- und Software-Anforderungen</a>.</p></li>
...
<ul>
<li><p>Überprüfen Sie <a href="/docs/de/v2.5.x/quickstart.md">Hello Milvus</a>, um zu sehen, was Milvus tun kann.</p></li>
