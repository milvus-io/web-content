...
<h1 id="Install-Milvus-Python-SDK" class="common-anchor-header">Milvus Python SDK installieren<button data-href="#Install-Milvus-Python-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Dieses Thema beschreibt, wie man das Milvus Python SDK pymilvus für Milvus installiert.</p>
...
<li>Python 3.7 oder höher ist erforderlich.</li>
<li>Google protobuf ist installiert. Sie können es mit dem Befehl <code translate="no">pip3 install protobuf==3.20.0</code> installieren.</li>
<li>grpcio-tools ist installiert. Sie können es mit dem Befehl <code translate="no">pip3 install grpcio-tools</code> installieren.</li>
</ul>
...
<h2 id="Verify-installation" class="common-anchor-header">Überprüfen Sie die Installation<button data-href="#Verify-installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Wenn PyMilvus korrekt installiert ist, wird keine Ausnahme ausgelöst, wenn Sie den folgenden Befehl ausführen.</p>
...
<h2 id="Whats-next" class="common-anchor-header">Wie geht es weiter?<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Nachdem Sie PyMilvus installiert haben, können Sie:</p>
<ul>
...
<li><a href="/docs/de/v2.5.x/insert-update-delete.md">Einfügen, Hochstellen und Löschen</a></li>
