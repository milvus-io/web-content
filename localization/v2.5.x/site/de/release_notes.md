...
<li>Es wurde ein Fehler behoben, der während der Validierung eine Beschädigung der Daten beim Schreiben verursachen konnte<a href="https://github.com/milvus-io/milvus/pull/42555">(#42555</a>).</li>
...
<li>Problem behoben, bei dem der Name des Analysators in hybriden Suchunteranfragen nicht gesetzt wurde<a href="https://github.com/milvus-io/milvus/pull/41897">(#41897</a>).</li>
...
<p>Wir freuen uns, die Veröffentlichung von Milvus 2.5.11 ankündigen zu können! Diese Version bietet leistungsstarke neue Funktionen wie die Multi-Analysator-Fähigkeit und erweiterte Tokenizer-Unterstützung (Jieba, Lindera, ICU, Language Identifier). Außerdem haben wir mehrere Verbesserungen vorgenommen, darunter die Aktualisierung des Threadpools für das dynamische Laden von Segmenten und die optimierte Filterung von Löschvorgängen während des binlog-Imports. Die wichtigsten Fehlerkorrekturen betreffen potenzielle Probleme mit dem Fallenlassen von Segmenten, Fehler bei der BM25-Suche und JSON-Statistik-Filterungsfehler.</p>
...
<li>Ein Bypass-Threadpool-Modus wurde hinzugefügt, um blockierende Einfüge-/Ladeoperationen durch wachsende Indizes zu vermeiden<a href="https://github.com/milvus-io/milvus/pull/41013">(#41013</a>)</li>
...
<li>Hinzufügen weiterer Konfigurationsoptionen für <code translate="no">interimindex</code>, um verfeinerte Modi zu unterstützen<a href="https://github.com/milvus-io/milvus/pull/40429">(#40429</a>)</li>
...
<li>Vermeidet Panik, wenn ein Feld im Schema in QueryNode nicht existiert<a href="https://github.com/milvus-io/milvus/pull/40542">(#40542</a>)</li>
...
<h3 id="Dependency-Upgrade" class="common-anchor-header">Upgrade der Abhängigkeiten<button data-href="#Dependency-Upgrade" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h3><p>Aktualisiert auf ETCD 3.5.18, um mehrere CVEs zu beheben.</p>
<ul>
...
<h3 id="Critical-Bugs" class="common-anchor-header">Kritische Bugs<button data-href="#Critical-Bugs" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Improvements" class="common-anchor-header">Verbesserungen<button data-href="#Improvements" class="anchor-icon" translate="no">
    ...
    </button></h3><h4 id="Observability" class="common-anchor-header">Beobachtbarkeit</h4><ul>
...
<h3 id="Critial-Bug-fixs" class="common-anchor-header">Kritische Fehlerbehebungen<button data-href="#Critial-Bug-fixs" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Improvement" class="common-anchor-header">Verbesserung<button data-href="#Improvement" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li>Der Balancer wurde korrigiert, um die wiederholte Überlastung desselben Abfrageknotens zu vermeiden.<a href="https://github.com/milvus-io/milvus/pull/38724">(#38724</a>)</li>
...
<h3 id="Other-Features" class="common-anchor-header">Andere Funktionen<button data-href="#Other-Features" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Improvements" class="common-anchor-header">Verbesserungen<button data-href="#Improvements" class="anchor-icon" translate="no">
    ...
    </button></h3><h4 id="Deletion-Optimization" class="common-anchor-header">Optimierung des Löschens</h4><p>Verbesserte Geschwindigkeit und verringerter Speicherverbrauch bei umfangreichen Löschvorgängen durch Optimierung der Sperrenverwendung und der Speicherverwaltung.</p>
