...
<h1 id="Cross-Encoder" class="common-anchor-header">Cross-Encoder<button data-href="#Cross-Encoder" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Milvus unterstützt <a href="https://github.com/FlagOpen/FlagEmbedding/tree/master/FlagEmbedding/reranker">Cross-Encoder</a> durch die Klasse <code translate="no">CrossEncoderRerankFunction</code>. Diese Funktionalität ermöglicht es Ihnen, die Relevanz von Abfrage-Dokumenten-Paaren effektiv zu bewerten.</p>
<p>Um diese Funktion zu nutzen, installieren Sie die notwendigen Abhängigkeiten:</p>
<pre><code translate="no" class="language-bash">pip install --upgrade pymilvus
pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span>
<button class="copy-code-btn"></button></code></pre>
<p>Dann instanziieren Sie die <code translate="no">CrossEncoderRerankFunction</code>:</p>
...
<p>Der Name des zu verwendenden Modells. Sie können jeden der verfügbaren Cross-Encoder-Modellnamen angeben, z. B. <code translate="no">cross-encoder/ms-marco-TinyBERT-L-2-v2</code>, <code translate="no">cross-encoder/ms-marco-MiniLM-L-2-v2</code>, usw. Wenn Sie diesen Parameter nicht angeben, wird ein leerer String verwendet. Eine Liste der verfügbaren Modelle finden Sie unter <a href="https://www.sbert.net/docs/pretrained_cross-encoders.html#">Pretrained Cross-Encoders</a>.</p></li>
<li><p><code translate="no">device</code> <em>(Zeichenfolge</em>)</p>
<p>Das für die Ausführung des Modells zu verwendende Gerät. Sie können <code translate="no">cpu</code> für die CPU und <code translate="no">cuda:n</code> für das n-te GPU-Gerät angeben.</p></li>
</ul>
