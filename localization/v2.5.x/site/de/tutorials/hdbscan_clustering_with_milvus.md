...
summary: >-
  ...
  verwenden, um HDBSCAN beim Clustering zu unterstützen, und die Ergebnisse dann
  zur Analyse mit der UMAP-Methode visualisieren. Dieses Notizbuch ist eine
  Milvus-Anpassung des Artikels von Dylan Castillo.
...
<h2 id="Download-Data" class="common-anchor-header">Daten herunterladen<button data-href="#Download-Data" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Laden Sie den Nachrichtendatensatz von https://www.kaggle.com/datasets/dylanjcastillo/news-headlines-2024/ herunter, extrahieren Sie <code translate="no">news_data_dedup.csv</code> und legen Sie ihn im aktuellen Verzeichnis ab.</p>
<h2 id="Extract-Embeddings-to-Milvus" class="common-anchor-header">Einbettungen in Milvus extrahieren<button data-href="#Extract-Embeddings-to-Milvus" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
