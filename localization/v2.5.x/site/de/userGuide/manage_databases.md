...
<h3 id="Alter-database-properties" class="common-anchor-header">Datenbankeigenschaften ändern<button data-href="#Alter-database-properties" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Sie können die Eigenschaften einer vorhandenen Datenbank wie folgt ändern. Das folgende Beispiel beschränkt die Anzahl der Sammlungen, die Sie in der Datenbank erstellen können.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
