...
<h2 id="Add-number-field" class="common-anchor-header">Zahlenfeld hinzufügen<button data-href="#Add-number-field" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Um numerische Daten zu speichern, definieren Sie ein Zahlenfeld in Ihrem Sammlungsschema. Im Folgenden finden Sie ein Beispiel für ein Auflistungsschema mit zwei Zahlenfeldern:</p>
<ul>
