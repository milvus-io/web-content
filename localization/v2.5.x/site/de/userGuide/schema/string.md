...
<p>Milvus unterstützt Nullwerte und Standardwerte für <code translate="no">VARCHAR</code> Felder. Um diese Funktionen zu aktivieren, setzen Sie <code translate="no">nullable</code> auf <code translate="no">True</code> und <code translate="no">default_value</code> auf einen String-Wert. Details finden Sie unter <a href="/docs/de/v2.5.x/nullable-and-default.md">Nullable &amp; Default</a>.</p>
</div>
