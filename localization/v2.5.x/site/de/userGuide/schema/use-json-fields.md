...
<div class="alert note">
<p>Für JSON-Felder, die Nullwerte zulassen, wird das Feld als Null behandelt, wenn das gesamte JSON-Objekt fehlt oder auf <code translate="no">None</code> gesetzt ist. Weitere Informationen finden Sie unter <a href="/docs/de/v2.5.x/basic-operators.md#JSON-Fields-with-Null-Values">JSON-Felder mit Nullwerten</a>.</p>
</div>
