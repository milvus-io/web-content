...
<ul>
<li><p><strong>Tokenisierer</strong>: Verwendet den <code translate="no">standard</code><a href="/docs/de/v2.5.x/standard-tokenizer.md"> Tokenizer</a>, um Text in diskrete Worteinheiten zu zerlegen.</p></li>
...
<p>Nachdem Sie <code translate="no">analyzer_params</code> definiert haben, können Sie diese auf ein <code translate="no">VARCHAR</code> Feld anwenden, wenn Sie ein Sammelschema definieren. Dadurch kann Milvus den Text in diesem Feld unter Verwendung des angegebenen Analysators für eine effiziente Tokenisierung und Filterung verarbeiten. Weitere Einzelheiten finden Sie unter <a href="/docs/de/v2.5.x/analyzer-overview.md#Example-use">Anwendungsbeispiele</a>.</p>
