...
<table>
   ...
   <tr>
     ...
     <td><p>Eine Liste von Wörterbüchern, die zur Definition des Vokabulars verwendet werden. Sie können Ihre eigenen Wörterbücher angeben oder sie mit dem Standardwörterbuch <code translate="no">"_default_"</code> kombinieren. Zum Beispiel: <code translate="no">["_default_", "结巴分词器"]</code>.</p></td>
