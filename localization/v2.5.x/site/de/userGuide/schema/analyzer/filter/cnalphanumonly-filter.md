...
<p>Der Filter <code translate="no">cnalphanumonly</code> arbeitet mit den vom Tokenizer erzeugten Begriffen, muss also in Kombination mit einem Tokenizer verwendet werden.</p>
...
<h2 id="Example-output​" class="common-anchor-header">Beispiel-Ausgabe<button data-href="#Example-output​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Hier ist ein Beispiel dafür, wie der <code translate="no">cnalphanumonly</code> Filter Text verarbeitet.</p>
