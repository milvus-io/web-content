...
<p>Der Filter <code translate="no">stemmer</code> arbeitet mit den vom Tokenizer erzeugten Begriffen und muss daher in Kombination mit einem Tokenizer verwendet werden. Eine Liste der in Milvus verfügbaren Tokenizer finden Sie in der <a href="/docs/de/tokenizers">Tokenizer-Referenz</a>.</p>
