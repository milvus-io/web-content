...
<button class="copy-code-btn"></button></code></pre>
<p>Der Filter <code translate="no">lowercase</code> arbeitet mit den Begriffen, die vom Tokenizer generiert werden, daher muss er in Kombination mit einem Tokenizer verwendet werden.</p>
