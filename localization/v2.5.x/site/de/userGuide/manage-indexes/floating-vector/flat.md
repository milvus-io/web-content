...
id: flat.md
order: 0
summary: In diesem Artikel wird der FLAT-Index in Milvus vorgestellt.
title: FLAT
---
...
<ul>
<li><code translate="no">index_type</code>: Der Typ des zu erstellenden Index. In diesem Beispiel setzen Sie den Wert auf <code translate="no">FLAT</code>.</li>
<li><code translate="no">metric_type</code>: Die Methode zur Berechnung des Abstands zwischen Vektoren. Unterstützte Werte sind <code translate="no">COSINE</code>, <code translate="no">L2</code> und <code translate="no">IP</code>. Einzelheiten finden Sie unter <a href="/docs/de/metric.md">Metrische Typen</a>.</li>
<li><code translate="no">params</code>: Für den FLAT-Index sind keine zusätzlichen Parameter erforderlich.</li>
</ul>
