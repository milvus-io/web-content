...
<h2 id="Set-Collection-TTL​" class="common-anchor-header">Sammlung TTL einstellen<button data-href="#Set-Collection-TTL​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Wenn eine Sammlung für einen bestimmten Zeitraum gelöscht werden soll, sollten Sie ihre Time-To-Live (TTL) in Sekunden festlegen. Sobald die TTL abläuft, löscht Milvus die Entitäten in der Sammlung. Die Löschung erfolgt asynchron, was bedeutet, dass Suchen und Abfragen noch möglich sind, bevor die Löschung abgeschlossen ist.</p>
