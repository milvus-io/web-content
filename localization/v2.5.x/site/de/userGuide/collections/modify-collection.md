...
<h2 id="Set-Collection-TTL​" class="common-anchor-header">Sammlung TTL einstellen<button data-href="#Set-Collection-TTL​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Um abgelaufene Daten automatisch aus einer Milvus-Sammlung zu entfernen, können Sie die Time-To-Live (TTL) der Sammlung in Sekunden festlegen. Sobald die TTL abläuft, markiert Milvus die Daten als abgelaufen und plant sie für eine asynchrone Löschung ein. Infolgedessen können die Daten noch in den Suchergebnissen erscheinen, bis der Löschvorgang vollständig abgeschlossen ist.</p>
