...
<h2 id="Describe-Collection​" class="common-anchor-header">Sammlung beschreiben<button data-href="#Describe-Collection​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Sie können auch die Details einer bestimmten Sammlung abrufen. Im folgenden Beispiel wird davon ausgegangen, dass Sie bereits eine Sammlung namens quick_setup erstellt haben.</p>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#go">Go</a> <a href="#curl">cURL</a></div>
