...
<p>[Nicht unterstützter Blocktyp]</p>
<ul>
<li><p><code translate="no">field_name</code><strong>:</strong> Der Name des <code translate="no">VARCHAR</code> Feldes, für das Sie Phrasenübereinstimmungen durchführen.</p></li>
