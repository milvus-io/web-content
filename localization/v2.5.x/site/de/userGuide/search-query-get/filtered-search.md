...
<h2 id="Standard-Filtering" class="common-anchor-header">Standard-Filterung<button data-href="#Standard-Filtering" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Search-with-Standard-Filtering" class="common-anchor-header">Suche mit Standard-Filterung</h3><p>Die folgenden Codeschnipsel demonstrieren eine Suche mit Standardfilterung. Die Anfrage im folgenden Codeschnipsel enthält eine Filterungsbedingung und mehrere Ausgabefelder.</p>
...
<h3 id="Search-with-iteraive-filtering" class="common-anchor-header">Suche mit iterativer Filterung</h3><p>Um eine gefilterte Suche mit iterativer Filterung durchzuführen, können Sie wie folgt vorgehen:</p>
<div class="multipleCode">
   <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
<pre><code translate="no" class="language-python"><span class="hljs-keyword">from</span> pymilvus <span class="hljs-keyword">import</span> MilvusClient​
​
