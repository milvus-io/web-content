...
<h2 id="Examples" class="common-anchor-header">Beispiele<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Dieser Abschnitt demonstriert, wie man eine gefilterte Suche durchführt. Die Codeschnipsel in diesem Abschnitt gehen davon aus, dass Sie bereits die folgenden Entitäten in Ihrer Sammlung haben. Jede Entität hat vier Felder, nämlich <strong>id</strong>, <strong>vector</strong>, <strong>color</strong> und <strong>likes</strong>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Weitere Informationen zu den Operatoren, die Sie beim Filtern von Metadaten verwenden können, finden Sie unter <a href="/docs/de/boolean.md">Metadatenfilterung</a>.</p>
