...
<span class="hljs-punctuation">]</span>
<button class="copy-code-btn"></button></code></pre>
<p>Weitere Informationen zu den Operatoren, die Sie beim Filtern von Metadaten verwenden können, finden Sie unter <a href="/docs/de/v2.5.x/filtering">Filtern</a>.</p>
