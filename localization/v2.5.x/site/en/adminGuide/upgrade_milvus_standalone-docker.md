...
---
<div class="tab-wrapper"><a href="/docs/v2.5.x/upgrade_milvus_standalone-operator.md" class=''>Milvus Operator</a><a href="/docs/v2.5.x/upgrade_milvus_standalone-helm.md" class=''>Helm</a><a href="/docs/v2.5.x/upgrade_milvus_standalone-docker.md" class='active '>Docker Compose</a></div>
...
<button class="copy-code-btn"></button></code></pre></li>
<li><p>Prepare the configuration file <code translate="no">migration.yaml</code> for meta migration.</p>
