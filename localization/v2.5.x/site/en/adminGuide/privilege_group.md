...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.5.x/assets/privilege-group-illustrated.png" alt="Privilege Group Illustrated" class="doc-image" id="privilege-group-illustrated" />
