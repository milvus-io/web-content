...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.5.x/assets/privilege_group_illustrated.png" alt="Privilege group illustrated" class="doc-image" id="privilege-group-illustrated" />
...
<li><p><strong>COLL_RO</strong>: includes privileges to read collection data​</p></li>
<li><p><strong>COLL_RW</strong>: includes privileges to read and write collection data​</p></li>
<li><p><strong>COLL_ADMIN</strong>: includes privileges to read and write collection data and manage collections.​</p></li>
</ul>
...
<li><p><strong>DB_RO</strong>: includes privileges to read database data​</p></li>
<li><p><strong>DB_RW</strong>: includes privileges to read and write database data​</p></li>
<li><p><strong>DB_Admin</strong>: includes privileges to read and write database data and manage databases.​</p></li>
</ul>
...
<li><p><strong>Cluster_RO</strong>: includes privileges to read instnace data​</p></li>
<li><p><strong>Cluster_RW</strong>: includes privileges to read and write instance data​</p></li>
<li><p><strong>Cluster_Admin</strong>: includes privileges to read and write instance data and manage instances.​</p></li>
</ul>
