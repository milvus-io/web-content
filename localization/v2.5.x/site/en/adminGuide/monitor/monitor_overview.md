...
<ul>
<li><a href="/docs/v2.5.x/monitor.md">Deploy monitoring services</a></li>
<li><a href="/docs/v2.5.x/visualize.md">Visualize Milvus metrics</a></li>
<li><a href="/docs/v2.5.x/alert.md">Create an alert</a></li>
</ul>
