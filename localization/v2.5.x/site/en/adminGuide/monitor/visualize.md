...
<ul>
<li>Learn how to <a href="/docs/v2.5.x/alert.md">create an alert for Milvus services</a></li>
<li>Adjust your <a href="/docs/v2.5.x/allocate.md">resource allocation</a></li>
<li><a href="/docs/v2.5.x/scaleout.md">Scale out or scale in a Milvus cluster</a></li>
</ul></li>
