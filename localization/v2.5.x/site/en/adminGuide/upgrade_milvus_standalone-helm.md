...
<h4 id="2-Upgrade-Milvus-from-v21x-to-250-beta" class="common-anchor-header">2. Upgrade Milvus from v2.1.x to 2.5.0-beta</h4><p>The following commands assume that you upgrade Milvus from v2.1.4 to 2.5.0-beta. Change them to the versions that fit your needs.</p>
<ol>
