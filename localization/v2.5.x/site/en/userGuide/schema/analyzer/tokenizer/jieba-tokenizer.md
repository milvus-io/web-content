...
<h2 id="Configuration" class="common-anchor-header">Configuration<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>To configure an analyzer using the <code translate="no">jieba</code> tokenizer, set <code translate="no">tokenizer</code> to <code translate="no">jieba</code> in <code translate="no">analyzer_params</code>.</p>
...
<h2 id="Example-output" class="common-anchor-header">Example output<button data-href="#Example-output" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Here’s an example of how the <code translate="no">jieba</code> tokenizer processes text:</p>
