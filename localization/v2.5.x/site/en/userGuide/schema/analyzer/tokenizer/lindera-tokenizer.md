...
<table>
   ...
   <tr>
     ...
     <td><p>A list of dictionaries used to define vocabulary. Possible values:</p><ul><li><p><code translate="no">ipadic</code>: Japanese</p></li><li><p><code translate="no">ko-dic</code>: Korean</p></li><li><p><code translate="no">cc-cedict</code>: Mandarin Chinese (traditional/simpl.)</p></li></ul></td>
   </tr>
</table>
...
<h3 id="Analyzer-configuration" class="common-anchor-header">Analyzer configuration</h3><pre><code translate="no" class="language-python">analyzer_params = {
    <span class="hljs-string">&quot;tokenizer&quot;</span>: {
      <span class="hljs-string">&quot;type&quot;</span>: <span class="hljs-string">&quot;lindera&quot;</span>,
      <span class="hljs-string">&quot;dict_kind&quot;</span>: <span class="hljs-string">&quot;ipadic&quot;</span>
    }
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Verification-using-runanalyzer" class="common-anchor-header">Verification using <code translate="no">run_analyzer</code></h3><pre><code translate="no" class="language-python"><span class="hljs-comment"># Sample text to analyze</span>
