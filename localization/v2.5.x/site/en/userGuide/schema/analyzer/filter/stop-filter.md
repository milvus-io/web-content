...
<table>
   ...
   <tr>
     ...
     <td><p>A list of words to be removed from tokenization. By default, the predefined <code translate="no">_english_</code> list, containing common English stop words, is used. The details of <code translate="no">_english_</code> can be found <a href="https://github.com/milvus-io/milvus/blob/master/internal/core/thirdparty/tantivy/tantivy-binding/src/stop_words.rs">here</a>.</p></td>
   </tr>
</table>
