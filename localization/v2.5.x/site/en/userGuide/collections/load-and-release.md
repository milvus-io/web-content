...
<h2 id="Load-Collection​" class="common-anchor-header">Load Collection​<button data-href="#Load-Collection​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>When you load a collection, Zilliz Cloud loads the index files and the raw data of all fields into memory for rapid response to searches and queries. Entities inserted after a collection load are automatically indexed and loaded.​</p>
...
<h2 id="Load-Specific-Fields​" class="common-anchor-header">Load Specific Fields​<button data-href="#Load-Specific-Fields​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Zilliz Cloud can load only the fields involved in searches and queries, reducing memory usage and improving search performance.​</p>
