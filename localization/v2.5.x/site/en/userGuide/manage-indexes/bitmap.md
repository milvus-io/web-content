...
<p>Once the bitmap index is created, you can use the <code translate="no">filter</code> parameter in query operations to perform scalar filtering based on the indexed field. This allows you to efficiently narrow down the search results using the bitmap index. For more information, refer to <ins>Filtering</ins>.​</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.5.x/assets/superstructure.png" alt="superstructure" class="doc-image" id="superstructure" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.5.x/assets/substructure.png" alt="substructure" class="doc-image" id="substructure" />
