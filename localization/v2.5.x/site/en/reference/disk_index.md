...
summary: Disk index mechanism in Milvus for disk-based vector search.
title: On-disk Index
---
<h1 id="On-disk-Index" class="common-anchor-header">On-disk Index<button data-href="#On-disk-Index" class="anchor-icon" translate="no">
    ...
    </button></h1><p>This article introduces an on-disk indexing algorithm named DiskANN. Based on Vamana graphs, DiskANN powers efficient disk-based vector searches within large datasets.</p>
