...
<h3 id="Support" class="common-anchor-header">Support<button data-href="#Support" class="anchor-icon" translate="no">
    ...
    </button></h3><p>If you require any assistance or have questions regarding the Kafka Connect Milvus Connector, please feel free to reach out to the maintainer of the connector: <strong>Email:</strong> <a href="mailto:support@zilliz.com">support@zilliz.com</a></p>
