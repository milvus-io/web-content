...
<ul>
<li>A running <a href="/docs/v2.5.x/install_standalone-docker.md">Milvus server</a>.</li>
...
<p>For detailed information on these parameters, see the <a href="/docs/v2.5.x/authenticate.md">Milvus authentication documentation</a> and <a href="/docs/v2.5.x/consistency.md">Milvus consistency levels documentation</a>.</p>
