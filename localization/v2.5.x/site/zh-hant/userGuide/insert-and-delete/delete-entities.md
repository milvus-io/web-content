...
<h2 id="Delete-Entities-by-Filtering-Conditions" class="common-anchor-header">透過篩選條件刪除實體<button data-href="#Delete-Entities-by-Filtering-Conditions" class="anchor-icon" translate="no">
    ...
    </button></h2><p>在批量刪除共享某些屬性的多個實體時，您可以使用篩選表達式。下面的示例代碼使用<strong>in</strong>運算符批量刪除所有<strong>顏色</strong>欄位設定為<strong>紅色</strong>和<strong>紫色</strong>值的實體。您也可以使用其他運算符來建構符合您需求的篩選表達式。有關過濾表達式的詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/filtering">過濾</a>。</p>
...
<h2 id="Delete-Entities-by-Primary-Keys" class="common-anchor-header">依據主鍵刪除實體<button data-href="#Delete-Entities-by-Primary-Keys" class="anchor-icon" translate="no">
    ...
    </button></h2><p>在大多數情況下，一個主鍵唯一地識別一個 Entity。您可以透過在刪除請求中設定 Entity 的 primary key 來刪除 Entity。下面的示例代碼演示了如何刪除兩個具有主鍵<strong>18</strong>和<strong>19</strong> 的實體。</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
