...
summary: 本主題將詳細介紹在同一個 Milvus 實例中備份資料集、並從備份中還原的過程。
title: 在同一個實例中備份和還原
---
<h1 id="Backup-and-Restore-in-One-Instance" class="common-anchor-header">在同一個實例中備份和還原<button data-href="#Backup-and-Restore-in-One-Instance" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本主題詳細說明在同一個 Milvus 實例中備份資料集並從備份還原的過程。</p>
...
<h2 id="Back-up-the-collection" class="common-anchor-header">備份資料夾<button data-href="#Back-up-the-collection" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Step-1-Prepare-configuration" class="common-anchor-header">步驟 1：準備配置</h3><p>到 milvus-backup 專案的目錄，建立一個名為<code translate="no">configs</code> 的目錄：</p>
...
└── README.md
<button class="copy-code-btn"></button></code></pre>
<h3 id="Step-2-Edit-configuration-file" class="common-anchor-header">步驟 2：編輯配置檔案</h3><p>修改 backup.yaml 檔案，為<code translate="no">milvus_A</code> 設定適當的配置。以下是儲存配置範例：</p>
