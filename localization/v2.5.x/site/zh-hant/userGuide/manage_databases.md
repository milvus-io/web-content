...
<h2 id="Manage-database-properties" class="common-anchor-header">管理資料庫屬性<button data-href="#Manage-database-properties" class="anchor-icon" translate="no">
    ...
    </button></h2><p>每個資料庫都有自己的屬性，您可以在<a href="/docs/zh-hant/v2.5.x/manage_databases.md#Create-database">建立資料</a>庫時設定資料庫的屬性，如建立資料庫所述，也可以更改和刪除任何現有資料庫的屬性。</p>
<p>下表列出了可能的資料庫屬性。</p>
<table>
   <tr>
     <th><p>屬性名稱</p></th>
   ...
   <tr>
     ...
     <td><p>字串</p></td>
     <td><p>與指定資料庫關聯的資源群組的名稱，以共同分隔的清單表示。</p></td>
   </tr>
   <tr>
