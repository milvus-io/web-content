...
<h2 id="Use-VarChar-Primary-Keys​" class="common-anchor-header">使用 VarChar 主鍵<button data-href="#Use-VarChar-Primary-Keys​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>要使用 VarChar 主鍵，除了將<code translate="no">data_type</code> 參數的值變更為<code translate="no">DataType.VARCHAR</code> 之外，還需要為欄位設定<code translate="no">max_length</code> 參數。</p>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#curl">cURL</a></div>
