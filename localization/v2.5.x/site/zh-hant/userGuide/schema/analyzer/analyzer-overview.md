...
<p>
   ...
   </span> <span class="img-wrapper"> <span>分析器-處理-工作流程</span> </span></p>
...
<button class="copy-code-btn"></button></code></pre>
<p>上述<code translate="no">standard</code> 內建分析器的配置等同於使用下列參數設定<a href="/docs/zh-hant/analyzer-overview.md#null">自訂分析器</a>，其中<code translate="no">tokenizer</code> 與<code translate="no">filter</code> 選項是明確定義，以達到類似功能：</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#bash">cURL</a></div>
<pre><code translate="no" class="language-python">analyzer_params = {
