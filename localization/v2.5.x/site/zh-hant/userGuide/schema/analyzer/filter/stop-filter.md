...
<table>
   ...
   <tr>
     ...
     <td><p>要從標記化中移除的字詞清單。預設使用預先定義的<code translate="no">_english_</code> 清單，包含常見的英文停止詞。有關<code translate="no">_english_</code> 的詳細資訊，請參閱<a href="https://github.com/milvus-io/milvus/blob/master/internal/core/thirdparty/tantivy/tantivy-binding/src/stop_words.rs">此處</a>。</p></td>
   </tr>
</table>
<p><code translate="no">stop</code> 過濾器會對標記器產生的詞彙進行操作，因此必須與標記器結合使用。如需 Milvus 中可用的 tokenizer 清單，請參考<a href="/docs/zh-hant/tokenizers">Tokenizer Reference</a>。</p>
