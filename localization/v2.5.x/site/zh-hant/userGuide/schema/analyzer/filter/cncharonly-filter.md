...
title: 濾波器
summary: '`cnalphanumonly` 過濾器會移除包含任何非中文字元、英文字母或數字以外的字元。'
---
...
<h2 id="Configuration​" class="common-anchor-header">設定<button data-href="#Configuration​" class="anchor-icon" translate="no">
    ...
    </button></h2><p><code translate="no">cncharonly</code> 過濾器內建於 Milvus。要使用它，只需在<code translate="no">analyzer_params</code> 中的<code translate="no">filter</code> 部分指定其名稱。</p>
<pre><code translate="no" class="language-python">analyzer_params = {​
    <span class="hljs-string">&quot;tokenizer&quot;</span>: <span class="hljs-string">&quot;standard&quot;</span>,​
    <span class="hljs-string">&quot;filter&quot;</span>: [<span class="hljs-string">&quot;cncharonly&quot;</span>],​
}​
<button class="copy-code-btn"></button></code></pre>
<p><code translate="no">cncharonly</code> 過濾器會對由 tokenizer 產生的詞彙進行操作，因此它必須與 tokenizer 結合使用。</p>
...
<h2 id="Example-output​" class="common-anchor-header">輸出範例<button data-href="#Example-output​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>以下是<code translate="no">cncharonly</code> 過濾器處理文字的範例。</p>
