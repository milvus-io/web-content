...
<h1 id="Standard-Analyzer" class="common-anchor-header">標準分析器<button data-href="#Standard-Analyzer" class="anchor-icon" translate="no">
    ...
    </button></h1><p><code translate="no">standard</code> 分析器是 Milvus 的預設分析器，如果沒有指定分析器，它會自動套用到文字欄位。它使用基於語法的標記化，對大多數語言都很有效。</p>
...
<ul>
<li><p><strong>標記器</strong>：使用<code translate="no">standard</code> tokenizer，根據文法規則將文字分割成離散的單字單位。如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/standard-tokenizer.md">Standard</a>。</p></li>
