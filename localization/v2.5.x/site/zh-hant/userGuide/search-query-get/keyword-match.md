...
<p>在本範例中，<code translate="no">filter</code> 表達式會過濾搜尋結果，使其僅包含符合指定詞彙<code translate="no">keyword1</code> 或<code translate="no">keyword2</code> 的文件。然後，向量類似性搜尋會在此經過過濾的文件子集上執行。</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#go">Go</a> <a href="#javascript">NodeJS</a> <a href="#bash">cURL</a></div>
