...
title: 整合 Milvus 與 Phidata
summary: 本頁討論向量資料庫與 Phidata 的整合，Phidata 是一個功能強大的架構，可用於建立智慧型代理程式和工作流程。
---
<h1 id="Integrate-Milvus-with-Phidata" class="common-anchor-header">整合 Milvus 與 Phidata<button data-href="#Integrate-Milvus-with-Phidata" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p><a href="https://github.com/phidatahq/phidata/tree/main">Phidata</a>是一個功能強大的框架，可用於建立智慧型代理程式和工作流程。它允許您建立能理解文字、圖像、音訊和視訊的多模式代理，並利用各種工具和知識來源來完成複雜的任務。Phidata 支援多代理協調，讓代理團隊能夠協同合作，共同解決問題。它還提供美觀的 Agent UI，讓您與您的代理進行互動。</p>
<p>Milvus 向量資料庫可有效儲存和檢索嵌入資訊。有了 Milvus 和 Phidata，您可以輕鬆地將知識整合到您的 Agent 工作流程中。本文件是如何使用 Milvus 與 Phidata 整合的基本指南。</p>
...
<ul>
<li><p>如果你只需要一個本機向量資料庫來進行小規模的資料或原型設計，將 uri 設定為一個本機檔案，例如<code translate="no">./milvus.db</code> ，是最方便的方法，因為它會自動利用<a href="https://milvus.io/docs/milvus_lite.md">Milvus Lite</a>將所有資料儲存到這個檔案中。</p></li>
<li><p>如果您有大規模的資料，例如超過一百萬個向量，您可以在<a href="https://milvus.io/docs/quickstart.md">Docker 或 Kubernetes</a> 上架設效能更高的 Milvus 伺服器。在此設定中，請使用伺服器位址和連接埠作為您的 uri，例如<code translate="no">http://localhost:19530</code> 。如果您在 Milvus 上啟用認證功能，請使用「&lt;your_username&gt;:&lt;your_password&gt;」作為令牌，否則請勿設定令牌。</p></li>
<li><p>如果您使用<a href="https://zilliz.com/cloud">Zilliz Cloud</a>（Milvus 的完全管理<a href="https://docs.zilliz.com/docs/on-zilliz-cloud-console#cluster-details">雲端</a>服務），請調整<code translate="no">uri</code> 和<code translate="no">token</code> ，與 Zilliz Cloud 中的<a href="https://docs.zilliz.com/docs/on-zilliz-cloud-console#cluster-details">Public Endpoint 和 API key</a>對應。</p></li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace"><span style="color: #000080; text-decoration-color: #000080">INFO </span>建立集合</pre>
<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace"><span style="color: #000080; text-decoration-color: #000080">INFO </span>載入知識庫</pre>
<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace"><span style="color: #000080; text-decoration-color: #000080">INFO </span>讀取<span style="color: #0000ff; text-decoration-color: #0000ff; text-decoration: underline">: https:</span>//phi-public.s3.amazonaws.com/recipes/ThaiRecipes.pdf</pre>
<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace"><span style="color: #000080; text-decoration-color: #000080">INFO </span>已將<span style="color: #008080; text-decoration-color: #008080; font-weight: bold">0 個</span>文件新增至知識庫</pre>
<h2 id="Use-agent-to-response-to-a-question" class="common-anchor-header">使用代理回應問題<button data-href="#Use-agent-to-response-to-a-question" class="anchor-icon" translate="no">
    ...
    </button></h2><p>將知識庫整合到一個代理中，然後我們可以向代理提問並獲得回應。</p>
...
<p>恭喜您，您已經了解了在 Phidata 中使用 Milvus 的基本知識。如果您想了解更多有關如何使用 Phidata 的資訊，請參閱<a href="https://docs.phidata.com/introduction">官方說明文件</a>。</p>
