...
<p><a href="https://vanna.ai/">Vanna</a>是一個開放原始碼的 Python RAG（Retrieval-Augmented Generation）框架，用於 SQL 生成和相關功能。<a href="https://milvus.io/">Milvus</a>是世界上最先進的開放原始碼向量資料庫，專門用於嵌入相似性搜尋與 AI 應用程式。</p>
...
<p>下面是一個比較複雜的問題。製造企業名稱資訊位於文件資料中，屬於背景資訊。產生的 SQL 查詢將根據特定的製造公司名稱擷取客戶資訊。</p>
