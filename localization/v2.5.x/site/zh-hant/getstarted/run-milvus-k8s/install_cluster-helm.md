...
<li><p><a href="/docs/zh-hant/v2.5.x/prerequisite-helm.md#How-can-I-start-a-K8s-cluster-locally-for-test-purposes">建立 K8s 集群</a>。</p></li>
...
<li><p>安裝前檢查<a href="/docs/zh-hant/v2.5.x/prerequisite-helm.md">硬體和軟體需求</a>。</p></li>
...
<ul>
<li><p>檢查<a href="/docs/zh-hant/v2.5.x/quickstart.md">Hello Milvus</a>，看看 Milvus 可以做什麼。</p></li>
