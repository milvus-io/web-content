...
<h1 id="Install-Milvus-Go-SDK" class="common-anchor-header">安裝 Milvus Go SDK<button data-href="#Install-Milvus-Go-SDK" class="anchor-icon" translate="no">
    ...
    </button></h1><p>本主題描述如何為 Milvus 安裝 Milvus Go SDK。</p>
<p>目前版本的 Milvus 支援 Python、Node.js、GO 及 Java 的 SDK。</p>
<h2 id="Requirement" class="common-anchor-header">需求<button data-href="#Requirement" class="anchor-icon" translate="no">
    ...
    </button></h2><p>需要使用 GO (1.17 或更新版本)。</p>
<h2 id="Install-Milvus-GO-SDK" class="common-anchor-header">安裝 Milvus GO SDK<button data-href="#Install-Milvus-GO-SDK" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
