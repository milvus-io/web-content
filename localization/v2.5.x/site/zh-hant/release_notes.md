...
<p>我們很高興宣佈 Milvus 2.5.16！這個版本修正了一系列的功能錯誤，並改善了使用者體驗。它還提供了一系列的一般性能和穩定性增強，同時解決了許多錯誤，以確保一個更強大的系統。我們鼓勵您升級至 2.5.16 並探索這些最新更新！</p>
<h3 id="Improvements" class="common-anchor-header">改進</h3><ul>
<li>從<code translate="no">DescribeCollection</code> 移除集合名稱驗證<a href="https://github.com/milvus-io/milvus/pull/43300">(#43300</a>)。</li>
<li>當 chunk 和 index 被析出時，取消連結 mmap 檔案<a href="https://github.com/milvus-io/milvus/pull/43546">(#43546</a>)。</li>
<li>字符串類型使用 set 元素<a href="https://github.com/milvus-io/milvus/pull/43393">(#43393</a>)。</li>
<li>將 Go 版本升級至 1.24.4，以修正 CVE<a href="https://github.com/milvus-io/milvus/pull/43467">(#43467</a>)。</li>
<li>在聚類分析階段只下載必要的欄位<a href="https://github.com/milvus-io/milvus/pull/43362">(#43362</a>)。</li>
<li>更新 Lindera 版本<a href="https://github.com/milvus-io/milvus/pull/43457">(#43457</a>)。</li>
<li>針對 QueryNode 分佈不均的情況，優化通道節點平衡<a href="https://github.com/milvus-io/milvus/pull/43423">(#43423</a>)。</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">錯誤修正</h3><ul>
<li>修正混合搜尋以支援 RESTful API 的偏移參數<a href="https://github.com/milvus-io/milvus/pull/43721">(#43721</a>)。</li>
<li>修正當 dict word 為空字串時 Jieba tokenizer 的恐慌<a href="https://github.com/milvus-io/milvus/pull/43718">(#43718</a>)。</li>
<li>修正可變長度資料類型的 span 原始資料檢索<a href="https://github.com/milvus-io/milvus/pull/43703">(#43703</a>)。</li>
<li>增加JSON關鍵統計反向索引中無效數據行的偏移量<a href="https://github.com/milvus-io/milvus/pull/43688">(#43688</a>)。</li>
<li>修正重新啟動後，載入配置變更失敗的問題<a href="https://github.com/milvus-io/milvus/pull/43555">(#43555</a>)。</li>
<li>當使用多區段時，修正了 [...] 跳過下一批的 pk<a href="https://github.com/milvus-io/milvus/pull/43619">(#43619</a>)。</li>
<li>跳過載入不存在的 L0 區段以防止載入阻塞<a href="https://github.com/milvus-io/milvus/pull/43576">(#43576</a>)。</li>
<li>在<code translate="no">InitPolicyInfo</code> 載入政策後清理特權快取<a href="https://github.com/milvus-io/milvus/pull/43643">(#43643</a>)。</li>
<li>錯誤不為空時設定狀態<a href="https://github.com/milvus-io/milvus/pull/43404">(#43404</a>)。</li>
<li>預設回傳 ID<a href="https://github.com/milvus-io/milvus/pull/43596">(#43596</a>)。</li>
<li>修正了由於 chunk bound empty 環路導致的字串檢索失敗<a href="https://github.com/milvus-io/milvus/pull/43482">(#43482</a>)。</li>
<li>忽略 2.6 代理以避免 Timetick 延遲<a href="https://github.com/milvus-io/milvus/pull/43519">(#43519</a>)。</li>
<li>使用優先順序佇列確保任務執行順序<a href="https://github.com/milvus-io/milvus/pull/43272">(#43272</a>)。</li>
<li>改進批次檢視的判斷<a href="https://github.com/milvus-io/milvus/pull/43479">（#43479</a>）。</li>
</ul>
...
<h2 id="v2514" class="common-anchor-header">v2.5.14<button data-href="#v2514" class="anchor-icon" translate="no">
    ...
    </button></h2><p>發行日期：2025 年 7 月 2 日</p>
<table>
<thead>
<tr><th>Milvus 版本</th><th>Python SDK 版本</th><th>Node.js SDK 版本</th><th>Java SDK 版本</th></tr>
</thead>
...
<p>我們很高興宣佈 Milvus 2.5.14！此版本提供了一系列效能與穩定性的強化，包括獨立的 chunk 快取池，JSON 欄位的自動索引，以及 BM25 segment 統計資料的本機快取。這個版本也解決了幾個關鍵的 bug，例如檔案觀察器中的線程爆炸和 QueryCoord 中的潛在恐慌，以確保系統更加穩健可靠。我們鼓勵您升級至 2.5.14，從這些最新更新中獲益！</p>
<h3 id="Dependency-upgrade" class="common-anchor-header">相依性升級</h3><ul>
<li>將 Minio 升級至 RELEASE.2024-05-28T17-19-04Z 以修正一些 CVE<a href="https://github.com/milvus-io/milvus/pull/43063">(#43063</a>)。</li>
</ul>
<h3 id="Improvements" class="common-anchor-header">改進</h3><ul>
<li>新增獨立的 chunk 快取池<a href="https://github.com/milvus-io/milvus/pull/42901">(#42901</a>)。</li>
<li>新增對 JSON 欄位<code translate="no">AUTOINDEX</code> 的支援<a href="https://github.com/milvus-io/milvus/pull/42161">(#42161</a>)。</li>
<li>使用英文名字作為所有語言類型的語言識別碼<a href="https://github.com/milvus-io/milvus/pull/42601">(#42601</a>)。</li>
<li>啟用透過集合欄位執行分析器<a href="https://github.com/milvus-io/milvus/pull/42812">(#42812</a>)。</li>
<li>更新 Knowhere 版本<a href="https://github.com/milvus-io/milvus/pull/42939">(#42939</a>)。</li>
<li>為檔案閱讀器新增大小介面，以消除讀取過程中的<code translate="no">statobject</code> 呼叫<a href="https://github.com/milvus-io/milvus/pull/42911">(#42911</a>)。</li>
<li>為 BM25 片段統計引入本機快取<a href="https://github.com/milvus-io/milvus/pull/42924">(#42924</a>,<a href="https://github.com/milvus-io/milvus/pull/42646">#42646</a>)。</li>
<li>在截取器中填入<code translate="no">dbname</code> for<code translate="no">operateprivilegev2request</code> <a href="https://github.com/milvus-io/milvus/pull/42904">(#42904</a>)。</li>
<li>避免在重新命名集合或資料庫時修改欄位元資料<a href="https://github.com/milvus-io/milvus/pull/42876">（#42876</a>）。</li>
<li>使 Web UI 可透過設定切換<a href="https://github.com/milvus-io/milvus/pull/42815">(#42815</a>)。</li>
<li>當列在大塊快取中準備好時，避免使用線程池<a href="https://github.com/milvus-io/milvus/pull/42804">（#42804</a>）。</li>
<li>啟用 Tantivy 收集器直接設定 bitset<a href="https://github.com/milvus-io/milvus/pull/39748">(#39748</a>,<a href="https://github.com/milvus-io/milvus/pull/42881">#42881</a>)。</li>
<li>在垃圾收集器中以 ID 取代基於指標的 map keys<a href="https://github.com/milvus-io/milvus/pull/42654">(#42654</a>)。</li>
<li>優化垃圾回收時的記憶體使用<a href="https://github.com/milvus-io/milvus/pull/42631">(#42631</a>)。</li>
<li>新增搜尋與查詢記錄的 NQ 與參數列印支援<a href="https://github.com/milvus-io/milvus/pull/42545">(#42545</a>)。</li>
<li>在批量插入時正確處理可空值和預設值<a href="https://github.com/milvus-io/milvus/pull/42072">（#42072</a>）。</li>
<li>設定 Segcore 線程池的線程名稱<a href="https://github.com/milvus-io/milvus/pull/42596">(#42596</a>)。</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">錯誤修正</h3><ul>
<li>在資料匯入時預先分配足夠的 ID 以避免失敗<a href="https://github.com/milvus-io/milvus/pull/42935">(#42935</a>)。</li>
<li>更新 Tantivy 以修正檔案觀察器的線程爆炸問題<a href="https://github.com/milvus-io/milvus/pull/42828">(#42828</a>,<a href="https://github.com/milvus-io/milvus/pull/42713">#42713</a>)。</li>
<li>修正過濾資料在 TTL 下變得不可見的問題<a href="https://github.com/milvus-io/milvus/pull/42944">(#42944</a>)。</li>
<li>移除緩存的 null 表達式結果，以防止錯誤篩選<a href="https://github.com/milvus-io/milvus/pull/42783">(#42783</a>)。</li>
<li>在二進位算術表達式中拒絕除法或模數為零<a href="https://github.com/milvus-io/milvus/pull/42887">(#42887</a>)。</li>
<li>確保流程圖在所有節點關閉之後釋放函數資源<a href="https://github.com/milvus-io/milvus/pull/42775">(#42775</a>)。</li>
<li>修正了 DataCoord 從 v2.5 升級到 v2.6 時可能卡住的問題<a href="https://github.com/milvus-io/milvus/pull/42669">(#42669</a>)。</li>
<li>新增預先檢查以防止不支援的資料類型轉換<a href="https://github.com/milvus-io/milvus/pull/42678">(#42678</a>)。</li>
<li>為 BM25 函式新增並發與關閉保護<a href="https://github.com/milvus-io/milvus/pull/42599">(#42599</a>)。</li>
<li>在升級期間篩選出資源群組的串流查詢節點<a href="https://github.com/milvus-io/milvus/pull/42594">(#42594</a>)。</li>
<li>修正了 Trie 索引<code translate="no">is_not_in</code> 表達式的問題<a href="https://github.com/milvus-io/milvus/pull/42886">(#42886</a>)。</li>
<li>修正了阻止 Rocksmq 從容停止的問題<a href="https://github.com/milvus-io/milvus/pull/42843">(#42843</a>)。</li>
<li>修正了<code translate="no">OR</code> 邏輯表達式的剪枝優化，僅在子節點是可剪枝的情況下進行剪枝<a href="https://github.com/milvus-io/milvus/pull/42915">(#42915</a>)。</li>
<li>修正了由於控制器沒有等待檢查器完成而導致的 QueryCoord 恐慌<a href="https://github.com/milvus-io/milvus/pull/42726">(#42726</a>)。</li>
<li>修正了因小區段被錯誤標示為索引而錯過主鍵排序任務的問題<a href="https://github.com/milvus-io/milvus/pull/42615">(#42615</a>)。</li>
<li>降低單機模式下 DataNode 總任務並發，以防止 OOM 錯誤<a href="https://github.com/milvus-io/milvus/pull/42809">(#42809</a>)。</li>
<li>為不支援類型的算術運算提供明確的錯誤<a href="https://github.com/milvus-io/milvus/pull/42890">(#42890</a>)。</li>
</ul>
<h2 id="v2513" class="common-anchor-header">v2.5.13<button data-href="#v2513" class="anchor-icon" translate="no">
    ...
    </button></h2><p>發行日期：2025 年 6 月 10 日</p>
<table>
<thead>
<tr><th>Milvus 版本</th><th>Python SDK 版本</th><th>Node.js SDK 版本</th><th>Java SDK 版本</th></tr>
</thead>
...
<p>我們很高興宣佈 Milvus 2.5.13！此版本透過新功能增強了您的使用體驗，例如下拉欄位屬性和使用<code translate="no">cast</code> 函式來處理 JSON 索引的能力。它也提供了一系列一般效能與穩定性的增強，同時解決了許多錯誤，以確保系統更為強大。我們鼓勵您升級至 2.5.13 並探索這些最新更新！</p>
<h3 id="Features" class="common-anchor-header">功能</h3><ul>
<li>新增支援從欄位中刪除屬性<a href="https://github.com/milvus-io/milvus/pull/41954">(#41954</a>)。</li>
<li>新增<code translate="no">cast</code> 函式與 JSON 索引一起使用<a href="https://github.com/milvus-io/milvus/pull/42504">(#42504</a>)。</li>
</ul>
<h3 id="Improvements" class="common-anchor-header">改進</h3><ul>
<li>增加預設匯入緩衝區大小<a href="https://github.com/milvus-io/milvus/pull/42542">(#42542</a>)。</li>
<li>加速派遣器建立程序<a href="https://github.com/milvus-io/milvus/pull/42544">(#42544</a>)。</li>
<li>移除通道與區段任務間的平衡限制<a href="https://github.com/milvus-io/milvus/pull/42410">(#42410</a>)。</li>
<li>將 CAGRA GPU 映像設定為預設值<a href="https://github.com/milvus-io/milvus/pull/42193">(#42193</a>)。</li>
<li><code translate="no">DescribeIndex</code> RESTful API 現在支援傳回索引參數<a href="https://github.com/milvus-io/milvus/pull/42080">(#42080</a>)。</li>
...
<li>確保統計任務只會被刷新的區段觸發<a href="https://github.com/milvus-io/milvus/pull/42425">(#42425</a>)。</li>
<li>當區段統計完成時，重設壓縮狀態<a href="https://github.com/milvus-io/milvus/pull/42005">(#42005</a>)。</li>
<li>更新 Tantivy 版本以修正 stemmer 恐慌<a href="https://github.com/milvus-io/milvus/pull/42172">(#42172</a>)。</li>
<li>修正當使用新的臨時索引時，無法擷取向量輸出欄位的問題<a href="https://github.com/milvus-io/milvus/pull/42183">(#42183</a>)。</li>
<li>在呼叫 Knowhere iterator 時避免依賴 Knowhere 來控制線程<a href="https://github.com/milvus-io/milvus/pull/42133">(#42133</a>).</li>
<li>修正了在平衡通道操作中可能過早釋放區段的問題<a href="https://github.com/milvus-io/milvus/pull/42043">(#42043</a>)。</li>
<li><code translate="no">DescribeIndex</code> RESTful 介面現在包含時間戳記<a href="https://github.com/milvus-io/milvus/pull/42105">(#42105</a>)。</li>
<li>使用鎖定來確保丟失區段索引的原子性<a href="https://github.com/milvus-io/milvus/pull/42076">(#42076</a>)。</li>
<li>修正了 Shard 客戶端管理員的代理恐慌<a href="https://github.com/milvus-io/milvus/pull/42026">(#42026</a>)。</li>
<li>修正了匯入槽分配邏輯<a href="https://github.com/milvus-io/milvus/pull/41982">(#41982</a>)。</li>
<li>修正了強制到期壓縮的時間點未能重設的錯誤<a href="https://github.com/milvus-io/milvus/pull/42000">(#42000</a>)。</li>
</ul>
...
<h3 id="Improvements" class="common-anchor-header">改進</h3><ul>
<li><code translate="no">DescribeCollection</code> API 現在在其結果中包含更新時間戳<a href="https://github.com/milvus-io/milvus/pull/41600">(#41600</a>)。</li>
...
<li>引入<code translate="no">run_analyzer</code> API 進行乾式運行，以幫助分析標記化結果。如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/analyzer-overview.md">Analyzer Overview</a>。</li>
<li>令牌化器<ul>
<li>新增自訂 Jieba 令牌化器參數的支援。</li>
<li>新增對 Lindera tokenizer 的支援。如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/lindera-tokenizer.md">Lindera</a>。</li>
<li>新增對 ICU tokenizer 的支援。如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/icu-tokenizer.md">ICU</a>。</li>
<li>新增語言識別碼標記器，用於語言偵測。</li>
</ul></li>
<li>篩選器<ul>
<li>擴大內建停止詞過濾器的語言支援。如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/stop-filter.md">Stop</a>。</li>
<li>新增<code translate="no">remove_punct</code> 篩選器以移除標點符號。如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/removepunct-filter.md">移除標點符號</a>。</li>
<li>新增<code translate="no">regex</code> 篩選器，用於基於模式的文字篩選。如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/regex-filter.md">Regex</a>。</li>
</ul></li>
</ul></li>
...
<p>Milvus 2.5.5 在單一叢集可支援的集合和分割區數量方面帶來了顯著的改進。現在，運行 Milvus 的 10K 集合和 100K 磁碟分割是完全可行的。此版本也解決了幾個重要的錯誤，包括遺失匹配統計資料和多階段查詢中的死鎖問題。此外，它還包含許多可觀察性與安全性的強化。我們強烈建議所有執行 Milvus 2.5.x 的使用者儘快升級。</p>
...
<h3 id="Features" class="common-anchor-header">功能特色</h3><ul>
<li>支援 PartitionKey 隔離，以改善多個分割區金鑰的效能<a href="https://github.com/milvus-io/milvus/pull/39245">(#39245</a>)。如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/use-partition-key.md">使用分割區金鑰</a>。</li>
<li>Sparse Index 現在支援 DAAT MaxScore<a href="https://github.com/milvus-io/knowhere/pull/1015">knowhere/#1015</a>。如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/sparse_vector.md">Sparse Vector</a>。</li>
...
<p>Milvus 2.5.3 提供了重要的錯誤修復和性能增強，以提高整體的穩定性、可靠性和可用性。此版本改進了並發處理、加強了資料索引和擷取，並更新了幾個關鍵元件，以提供更強大的使用者體驗。</p>
<h3 id="Bug-fixes" class="common-anchor-header">錯誤修正</h3><ul>
...
<p>如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/analyzer-overview.md">Analyzer 概觀</a>與<a href="/docs/zh-hant/v2.5.x/full-text-search.md">全文</a>檢索。</p>
...
<p>如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/milvus-webui.md">Milvus WebUI</a>。</p>
...
<p>如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/analyzer-overview.md">Analyzer 概觀</a>和<a href="/docs/zh-hant/v2.5.x/keyword-match.md">文字匹配</a>。</p>
...
<h4 id="Clustering-Compaction-Beta" class="common-anchor-header">聚類壓縮 (測試版)</h4><p>Milvus 2.5 引入了聚類壓縮 (Clustering Compaction)，以加速搜尋並降低大型資料庫的成本。透過指定標量欄位作為聚類關鍵，資料會依範圍重新分配，以最佳化儲存與擷取。此功能的作用類似全局索引，可讓 Milvus 在基於叢集元資料的查詢過程中有效地剪裁資料，在套用標量篩選器時提升搜尋效能。</p>
<p>如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/clustering-compaction.md">聚類壓縮</a>。</p>
...
<p>如需詳細資訊，請參閱<a href="/docs/zh-hant/v2.5.x/filtering-templating.md">篩選模板</a>。</p>
