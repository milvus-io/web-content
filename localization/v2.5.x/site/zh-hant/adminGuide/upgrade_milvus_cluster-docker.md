...
---
<div class="tab-wrapper"><a href="/docs/zh-hant/v2.5.x/upgrade_milvus_standalone-operator.md" class=''>Milvus OperatorMilvus</a><a href="/docs/zh-hant/v2.5.x/upgrade_milvus_cluster-operator.md" class=''>OperatorMilvus</a><a href="/docs/zh-hant/v2.5.x/configure-helm.md" class=''>OperatorHelmDocker</a><a href="/docs/zh-hant/v2.5.x/upgrade_milvus_standalone-helm.md" class=''>ComposeHelmDocker</a><a href="/docs/zh-hant/v2.5.x/upgrade_milvus_cluster-helm.md" class=''>ComposeHelm</a></div>
...
<p>在一般情況下，您可以<a href="#Upgrade-Milvus-by-changing-its-image">透過變更映像檔來升級 Milvus</a>。然而，在從 v2.1.x 升級到 v2.5.19 之前，您需要<a href="#Migrate-the-metadata">先遷移元資料</a>。</p>
