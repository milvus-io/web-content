...
<p>此主題已經過時，即將移除。建議您參考<a href="/docs/zh-hant/v2.5.x/eks.md">在 EKS 上部署 Milvus 叢集</a>。</p>
</div>
...
<ul>
<li><a href="/docs/zh-hant/v2.5.x/eks.md">在 EKS 上部署 Milvus 集群</a></li>
<li><a href="/docs/zh-hant/v2.5.x/gcp.md">使用 Kubernetes 在 GCP 上部署 Milvus 群集</a></li>
<li><a href="/docs/zh-hant/v2.5.x/azure.md">使用 Kubernetes 在 Microsoft Azure 上部署 Milvus 指南</a></li>
</ul>
