---
id: s3.md
title: 依 IAM 角色設定 S3 存取權限
related_key: "s3, storage, iam"
summary: 瞭解如何使用 IAM 角色設定 s3。
---

<h1 id="Configure-S3-Access-by-IAM-Role" class="common-anchor-header">依 IAM 角色設定 S3 存取權限<button data-href="#Configure-S3-Access-by-IAM-Role" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>本主題介紹當安裝 Milvus 與 helm 時，如何依 IAM 角色設定 s3 存取。 詳細資訊請參考<a href="https://docs.aws.amazon.com/eks/latest/userguide/associate-service-account-role.html">IAM 角色</a>。</p>
...
<li><p>請在使用 eksctl 建立 EKS 叢集時啟用 OIDC，詳細資訊請參考<a href="https://docs.aws.amazon.com/eks/latest/userguide/enable-iam-roles-for-service-accounts.html">IAM OIDC</a>。</p></li>
<li><p>本指南假設您已經<a href="/docs/zh-hant/v2.5.x/eks.md">在 AWS 上使用 Kubernetes 部署了 Milvus Cluster</a>。</p></li>
</ul>
<h2 id="Associate-an-IAM-role-with-a-Kubernetes-service-account" class="common-anchor-header">將 IAM 角色與 Kubernetes 服務帳戶關聯<button data-href="#Associate-an-IAM-role-with-a-Kubernetes-service-account" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><p>建立 IAM 角色，並將其與 Kubernetes 服務帳號相關聯。將<code translate="no">your-account-id</code> 改為您的帳號 ID。</p></li>
</ul>
...
<h2 id="Verify-the-role-and-service-account-setup" class="common-anchor-header">驗證角色和服務帳號的設定<button data-href="#Verify-the-role-and-service-account-setup" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>請參閱<a href="https://docs.aws.amazon.com/eks/latest/userguide/associate-service-account-role.html">IAM 角色</a>。</p>
<ul>
<li>確認 IAM 角色的信任政策已正確設定。</li>
</ul>
...
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>檢視政策內容，確認政策包含 Pod 所需的所有權限。如有必要，請將以下指令中的 1 改為之前輸出中返回的版本。</li>
</ul>
...
<h2 id="Deploy-Milvus" class="common-anchor-header">部署 Milvus<button data-href="#Deploy-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>在本指南中，我們將使用 Milvus Helm Charts 部署 Milvus 群集。您可以<a href="https://github.com/zilliztech/milvus-helm/tree/master/charts/milvus">在這裡</a>找到圖表。</p>
<ul>
<li>新增 Milvus Helm Chart repo。</li>
</ul>
<pre><code translate="no" class="language-bash">helm repo <span class="hljs-keyword">add</span> milvus https:<span class="hljs-comment">//zilliztech.github.io/milvus-helm/</span>
helm repo update
<button class="copy-code-btn"></button></code></pre>
<ul>
<li>準備 Milvus 配置文件<code translate="no">milvus.yaml</code> ，並將<code translate="no">&lt;bucket-name&gt;</code> 改為上面建立的 bucket 的名稱。</li>
</ul>
...
<h2 id="Verify-the-installation" class="common-anchor-header">驗證安裝<button data-href="#Verify-the-installation" class="anchor-icon" translate="no">
    ...
    </button></h2><p>請參考<a href="https://milvus.io/docs/eks.md#Verify-the-installation">Verify-the-installation</a>。</p>
