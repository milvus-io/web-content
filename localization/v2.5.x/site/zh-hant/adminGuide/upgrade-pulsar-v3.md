...
<p>d.<code translate="no">curl</code> 或<strong>Attu v2.4+</strong>用於與 milvus 管理 API 進行互動</p></li>
</ol>
</div>
...
<h3 id="Persist-data-not-consumed-in-Pulsar" class="common-anchor-header">持久化 Pulsar 中未消耗的資料</h3><p>在這個步驟中，您需要確保 Pulsar 中現有的資料已持久化到物件儲存服務。 有兩種方法可用，您可以選擇適合您需求的方法。</p>
