...
<div style="display: none;">- 進行滾動升級](#conduct-a-rolling-upgrade) 從 Milvus v2.2.3 及以後的版本升級到 v2.5.24。</div>
<ul>
<li><p><a href="#Upgrade-Milvus-using-Helm">使用 Helm 升級 Milvus</a>，從 v2.2.3 之前的次要版本升級到 v2.5.24。</p></li>
<li><p>在從 Milvus v2.1.x 升級到 v2.5.24 之前<a href="#Migrate-the-metadata">遷移元資料</a>。</p></li>
</ul>
...
<p>一旦您確保 Milvus 實例中的所有部署都處於正常狀態。您可以執行以下指令，將 Milvus 實例升級至 2.5.24。</p>
