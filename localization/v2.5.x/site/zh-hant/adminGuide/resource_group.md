...
<p>請注意，一個 Milvus 實例會維護一個預設的資源群組，在啟動時存放所有的查詢節點，並將它命名為<strong>__default_resource_group</strong> 。</p>
...
<p>本頁面的所有程式碼範例都在 PyMilvus 2.5.11 中。在執行它們之前，請先升級您的 PyMilvus 安裝。</p>
</div>
<ol>
<li><p>建立資源群組</p>
...
<li><p>在資源群組之間轉移副本。</p>
<p>Milvus 使用<a href="/docs/zh-hant/v2.5.x/replica.md">副本</a>实现分布在多个查询节点上的<a href="/docs/zh-hant/v2.5.x/glossary.md#Segment">段</a>之间的负载平衡。您可以按以下方式將資料集中的某些複製品從一個資源群組移到另一個資源群組：</p>
<pre><code translate="no" class="language-python">source = <span class="hljs-string">&#x27;__default_resource_group&#x27;</span>
target = <span class="hljs-string">&#x27;rg&#x27;</span>
...
<ul>
<li><a href="/docs/zh-hant/v2.5.x/rbac.md">啟用 RBAC</a></li>
<li><a href="/docs/zh-hant/v2.5.x/users_and_roles.md">使用者與角色</a></li>
</ul>
