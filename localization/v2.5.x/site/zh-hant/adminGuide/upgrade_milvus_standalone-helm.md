...
<p>自 Milvus Helm 圖表版本 4.2.21 起，我們引入 pulsar-v3.x 圖表作為相依性。為了向下相容性，請升級您的 helm 到 v3.14 或更高版本，並確保每次使用<code translate="no">helm upgrade</code> 時，加入<code translate="no">--reset-then-reuse-values</code> 選項。</p>
</div>
