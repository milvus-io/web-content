...
<h2 id="Configure-NATS" class="common-anchor-header">設定 NATS<button data-href="#Configure-NATS" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h4 id="Example" class="common-anchor-header">範例</h4><p>以下範例設定 NATS 服務。</p>
...
<span class="hljs-attr">spec:</span>
  ...
  <span class="hljs-attr">config:</span> {}
<button class="copy-code-btn"></button></code></pre>
<p>要將訊息儲存空間從 RocksMQ 移轉到 NATS，請執行下列步驟：</p>
<ol>
