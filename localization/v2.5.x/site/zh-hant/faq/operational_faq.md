...
<p>請參閱<a href="/docs/zh-hant/v2.5.x/prerequisite-docker.md">CPU 對 SIMD 指令集的支援</a>。</p>
...
<button class="copy-code-btn"></button></code></pre>
<h4 id="Can-I-deploy-Milvus-when-disconnected-from-the-Internet" class="common-anchor-header">我可以在斷線時部署Milvus嗎？</h4><p>是的，您可以在離線環境下安裝 Milvus。更多資訊請參閱<a href="/docs/zh-hant/v2.5.x/install_offline-helm.md">離線安裝 Milvus</a>。</p>
