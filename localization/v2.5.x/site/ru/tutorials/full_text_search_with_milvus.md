...
<h2 id="Preparation" class="common-anchor-header">Подготовка<button data-href="#Preparation" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Download-the-dataset" class="common-anchor-header">Загрузите набор данных</h3><p>Следующая команда загрузит пример данных, используемых в оригинальной <a href="https://github.com/anthropics/anthropic-cookbook/blob/main/skills/contextual-embeddings/guide.ipynb">демонстрации</a> Anthropic.</p>
...
<h3 id="Install-Milvus-25" class="common-anchor-header">Установите Milvus 2.5</h3><p>Для получения более подробной информации ознакомьтесь с <a href="https://milvus.io/docs/install_standalone-docker-compose.md">официальным руководством по установке</a>.</p>
<h3 id="Install-PyMilvus" class="common-anchor-header">Установите PyMilvus</h3><p>Выполните следующую команду для установки PyMilvus:</p>
<pre><code translate="no" class="language-python">pip install <span class="hljs-string">&quot;pymilvus[model]&quot;</span> -U 
<button class="copy-code-btn"></button></code></pre>
<h3 id="Define-the-Retriever" class="common-anchor-header">Определите ретривер</h3><pre><code translate="no" class="language-python"><span class="hljs-keyword">import</span> json
...
<h3 id="Insert-the-data" class="common-anchor-header">Вставьте данные</h3><pre><code translate="no" class="language-python">path = <span class="hljs-string">&quot;codebase_chunks.json&quot;</span>
