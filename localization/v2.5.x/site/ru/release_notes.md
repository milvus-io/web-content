...
<p>Мы рады сообщить о выходе версии Milvus 2.5.16! В этой версии исправлен ряд функциональных ошибок и улучшен пользовательский опыт. В ней также улучшена общая производительность и стабильность, а также исправлены многочисленные ошибки для обеспечения большей надежности системы. Мы рекомендуем вам обновиться до версии 2.5.16 и познакомиться с последними обновлениями!</p>
<h3 id="Improvements" class="common-anchor-header">Улучшения</h3><ul>
<li>Убрана проверка имени коллекции из <code translate="no">DescribeCollection</code> <a href="https://github.com/milvus-io/milvus/pull/43300">(#43300</a>).</li>
<li>Разблокирован файл mmap при уничтожении чанка и индекса<a href="https://github.com/milvus-io/milvus/pull/43546">(#43546</a>).</li>
<li>Использование элемента set для строкового типа термина<a href="https://github.com/milvus-io/milvus/pull/43393">(#43393</a>).</li>
<li>Обновлена версия Go до 1.24.4 для исправления CVE<a href="https://github.com/milvus-io/milvus/pull/43467">(#43467</a>).</li>
<li>Загрузка только необходимых полей на этапе анализа кластеризации<a href="https://github.com/milvus-io/milvus/pull/43362">(#43362</a>).</li>
<li>Обновлена версия Lindera<a href="https://github.com/milvus-io/milvus/pull/43457">(#43457</a>).</li>
<li>Оптимизирована балансировка узлов канала для неравномерного распределения QueryNode<a href="https://github.com/milvus-io/milvus/pull/43423">(#43423</a>).</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">Исправления ошибок</h3><ul>
<li>Исправлен гибридный поиск для поддержки offset param в RESTful API<a href="https://github.com/milvus-io/milvus/pull/43721">(#43721</a>).</li>
<li>Исправлена паника токенизатора Jieba, когда слово dict было пустой строкой<a href="https://github.com/milvus-io/milvus/pull/43718">(#43718</a>).</li>
<li>Исправлено извлечение необработанных данных из span для типа данных переменной длины<a href="https://github.com/milvus-io/milvus/pull/43703">(#43703</a>).</li>
<li>Увеличение смещения для недействительных строк данных в инвертированном индексе JSON-ключевой статистики<a href="https://github.com/milvus-io/milvus/pull/43688">(#43688</a>).</li>
<li>Исправлена ошибка загрузки изменений конфигурации после перезапуска<a href="https://github.com/milvus-io/milvus/pull/43555">(#43555</a>).</li>
<li>Исправлена ошибка pk в [...], пропускающая следующую партию при использовании сегмента с несколькими чанками<a href="https://github.com/milvus-io/milvus/pull/43619">(#43619</a>).</li>
<li>Пропускалась загрузка несуществующих сегментов L0 для предотвращения блокировки загрузки<a href="https://github.com/milvus-io/milvus/pull/43576">(#43576</a>).</li>
<li>Очистка кэша привилегий после загрузки политики в <code translate="no">InitPolicyInfo</code> <a href="https://github.com/milvus-io/milvus/pull/43643">(#43643</a>).</li>
<li>Установка статуса, если ошибка не пуста<a href="https://github.com/milvus-io/milvus/pull/43404">(#43404</a>).</li>
<li>Возвращение ID по умолчанию<a href="https://github.com/milvus-io/milvus/pull/43596">(#43596</a>).</li>
<li>Исправлен сбой при извлечении строковых представлений из-за пустого цикла, связанного с чанком<a href="https://github.com/milvus-io/milvus/pull/43482">(#43482</a>).</li>
<li>Игнорирование прокси 2.6 для предотвращения задержки по времени<a href="https://github.com/milvus-io/milvus/pull/43519">(#43519</a>).</li>
<li>Обеспечение порядка выполнения задач с помощью приоритетной очереди<a href="https://github.com/milvus-io/milvus/pull/43272">(#43272</a>).</li>
<li>Уточнено суждение для пакетных представлений<a href="https://github.com/milvus-io/milvus/pull/43479">(#43479</a>).</li>
</ul>
<h2 id="v2515" class="common-anchor-header">v2.5.15<button data-href="#v2515" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Дата выпуска: 23 июля 2025 г.</p>
<table>
<thead>
...
<p>Мы рады представить вам Milvus 2.5.15! В этой версии исправлен ряд функциональных ошибок, включая те, которые могли привести к серьезному повреждению метаданных и потере данных при переименовании коллекции. Кроме того, в ней улучшена производительность и стабильность работы, а также исправлены многочисленные ошибки для обеспечения большей надежности системы. <strong>Мы рекомендуем вам обновиться до версии 2.5.15, особенно если вы сейчас используете версию 2.5.14, и изучить эти последние обновления!</strong></p>
<h3 id="Improvements" class="common-anchor-header">Улучшения</h3><ul>
<li>Обновлена версия Knowhere для исправления ошибки перебора разреженных векторов<a href="https://github.com/milvus-io/milvus/pull/43398">(#43398</a>).</li>
<li>Реализовано сохранение метаданных с ограничениями txn<a href="https://github.com/milvus-io/milvus/pull/43287">(#43287</a>).</li>
<li>Применяется загрузка изменений конфигурации после перезапуска QueryCoord<a href="https://github.com/milvus-io/milvus/pull/43236">(#43236</a>).</li>
<li>Улучшено использование памяти переменной длины<a href="https://github.com/milvus-io/milvus/pull/43093">(#43093</a>).</li>
<li>Переупорядочено выключение RootCoord, чтобы он был последним в последовательности остановки координатора<a href="https://github.com/milvus-io/milvus/pull/43024">(#43024</a>).</li>
<li>Обновлена версия CMake до 3.31.8<a href="https://github.com/milvus-io/milvus/pull/43004">(#43004</a>).</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">Исправления ошибок</h3><ul>
<li>Пропускалась операция удаления, если ключ существовал в наборе сохранения<a href="https://github.com/milvus-io/milvus/pull/43426">(#43426</a>).</li>
<li>Исправлено выравнивание смещения нулевого растрового изображения при загрузке многоканальных данных<a href="https://github.com/milvus-io/milvus/pull/43411">(#43411</a>, <a href="https://github.com/milvus-io/milvus/pull/43342">#43342</a>).</li>
<li>Обновлен Tantivy для исправления состояния гонки удаления каталогов<a href="https://github.com/milvus-io/milvus/pull/43401">(#43401</a>).</li>
<li>Исправлена проблема с вызовом <code translate="no">AlterCollection</code> только при переименовании коллекций<a href="https://github.com/milvus-io/milvus/pull/43421">(#43421</a>).</li>
<li>Сделано так, чтобы <code translate="no">MultiSaveAndRemove</code> выполнял операции удаления первым<a href="https://github.com/milvus-io/milvus/pull/43409">(#43409</a>).</li>
<li>Использован максимальный размер сегмента диска для коллекций с разреженными и плотными векторами<a href="https://github.com/milvus-io/milvus/pull/43195">(#43195</a>).</li>
<li>Исправлена ошибка совпадения текста при адаптации к модели с несколькими чанками<a href="https://github.com/milvus-io/milvus/pull/43297">(#43297</a>).</li>
<li>Исправлен некорректный набор битов для сравнения при делении, когда правый операнд отрицательный<a href="https://github.com/milvus-io/milvus/pull/43180">(#43180</a>).</li>
<li>Устранено ненужное копирование при получении JSON-кусков<a href="https://github.com/milvus-io/milvus/pull/43183">(#43183</a>, <a href="https://github.com/milvus-io/milvus/pull/43202">#43202</a>).</li>
<li>Предотвращение выхода делегатора из строя из-за смены лидера шарда<a href="https://github.com/milvus-io/milvus/pull/43309">(#43309</a>).</li>
<li>Исправлены утечки индекса текстовых совпадений и индекса статистики ключей JSON при освобождении сегментов<a href="https://github.com/milvus-io/milvus/pull/43308">(#43308</a>).</li>
<li>Исправлен сбой <code translate="no">RegeneratePartitionStats</code> после восстановления задач кластерного уплотнения<a href="https://github.com/milvus-io/milvus/pull/43206">(#43206</a>).</li>
<li>Добавлена обработка ошибок при недопустимых параметрах функции для предотвращения паники<a href="https://github.com/milvus-io/milvus/pull/43190">(#43190</a>).</li>
<li>Удалена логика обрезки пробелов при проверке имен коллекций<a href="https://github.com/milvus-io/milvus/pull/43138">(#43138</a>).</li>
<li>Добавлена проверка свойства field mmap перед применением настроек уровня коллекции<a href="https://github.com/milvus-io/milvus/pull/43091">(#43091</a>).</li>
<li>Исправлено блокирование создания индекса из-за неудачной статистики сортировки<a href="https://github.com/milvus-io/milvus/pull/43061">(#43061</a>).</li>
<li>Исправлена логика очистки исключаемых узлов в механизме повторных попыток балансировщика нагрузки<a href="https://github.com/milvus-io/milvus/pull/43002">(#43002</a>).</li>
</ul>
<h2 id="v2514" class="common-anchor-header">v2.5.14<button data-href="#v2514" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Дата выпуска: 2 июля 2025 года</p>
<table>
<thead>
<tr><th>Версия Milvus</th><th>Версия Python SDK</th><th>Версия SDK для Node.js</th><th>Версия Java SDK</th></tr>
</thead>
...
<p>Мы рады представить Milvus 2.5.14! В этом выпуске реализован ряд улучшений производительности и стабильности, включая отдельный пул кэша чанков, автоиндексацию полей JSON и локальное кэширование статистики сегментов BM25. В этой версии также исправлено несколько критических ошибок, таких как взрыв потока в файловом наблюдателе и потенциальные паники в QueryCoord, чтобы обеспечить более надежную и прочную систему. Мы рекомендуем вам обновиться до версии 2.5.14, чтобы воспользоваться преимуществами этих последних обновлений!</p>
<h3 id="Dependency-upgrade" class="common-anchor-header">Обновление зависимостей</h3><ul>
<li>Обновлен Minio до RELEASE.2024-05-28T17-19-04Z для исправления нескольких CVE<a href="https://github.com/milvus-io/milvus/pull/43063">(#43063</a>).</li>
</ul>
<h3 id="Improvements" class="common-anchor-header">Улучшения</h3><ul>
<li>Добавлен отдельный пул кэша чанков<a href="https://github.com/milvus-io/milvus/pull/42901">(#42901</a>).</li>
<li>Добавлена поддержка <code translate="no">AUTOINDEX</code> для полей JSON<a href="https://github.com/milvus-io/milvus/pull/42161">(#42161</a>).</li>
<li>Использование английского названия в качестве идентификатора языка для всех типов языков<a href="https://github.com/milvus-io/milvus/pull/42601">(#42601</a>).</li>
<li>Включен запуск анализатора по полю коллекции<a href="https://github.com/milvus-io/milvus/pull/42812">(#42812</a>).</li>
<li>Обновлена версия Knowhere<a href="https://github.com/milvus-io/milvus/pull/42939">(#42939</a>).</li>
<li>Добавлен интерфейс размера в файловый ридер для устранения вызовов <code translate="no">statobject</code> при чтении<a href="https://github.com/milvus-io/milvus/pull/42911">(#42911</a>).</li>
<li>Введен локальный кэш для статистики сегмента BM25<a href="https://github.com/milvus-io/milvus/pull/42924">(#42924</a>, <a href="https://github.com/milvus-io/milvus/pull/42646">#42646</a>).</li>
<li>Заполнение <code translate="no">dbname</code> для <code translate="no">operateprivilegev2request</code> в перехватчике<a href="https://github.com/milvus-io/milvus/pull/42904">(#42904</a>).</li>
<li>Предотвращено изменение метаданных полей при переименовании коллекции или базы данных<a href="https://github.com/milvus-io/milvus/pull/42876">(#42876</a>).</li>
<li>Сделали веб-интерфейс отключаемым через конфигурацию<a href="https://github.com/milvus-io/milvus/pull/42815">(#42815</a>).</li>
<li>Избавление от использования пула потоков, когда столбец готов в кэше чанков<a href="https://github.com/milvus-io/milvus/pull/42804">(#42804</a>).</li>
<li>В коллекторе Tantivy появилась возможность напрямую устанавливать битовые наборы<a href="https://github.com/milvus-io/milvus/pull/39748">(#39748</a>, <a href="https://github.com/milvus-io/milvus/pull/42881">#42881</a>).</li>
<li>Замена ключей карт, основанных на указателях, на идентификаторы в сборщике мусора<a href="https://github.com/milvus-io/milvus/pull/42654">(#42654</a>).</li>
<li>Оптимизировано использование памяти при сборке мусора<a href="https://github.com/milvus-io/milvus/pull/42631">(#42631</a>).</li>
<li>Добавлена поддержка печати NQ и параметров для журналов поиска и запросов<a href="https://github.com/milvus-io/milvus/pull/42545">(#42545</a>).</li>
<li>Корректная обработка нулевых значений и значений по умолчанию при массовой вставке<a href="https://github.com/milvus-io/milvus/pull/42072">(#42072</a>).</li>
<li>Настройка имен потоков для пула потоков Segcore<a href="https://github.com/milvus-io/milvus/pull/42596">(#42596</a>).</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">Исправления ошибок</h3><ul>
<li>Предварительное распределение достаточного количества идентификаторов при импорте данных во избежание сбоев<a href="https://github.com/milvus-io/milvus/pull/42935">(#42935</a>).</li>
<li>Обновление Tantivy для исправления взрыва потока в наблюдателе за файлами<a href="https://github.com/milvus-io/milvus/pull/42828">(#42828</a>, <a href="https://github.com/milvus-io/milvus/pull/42713">#42713</a>).</li>
<li>Исправлена проблема, из-за которой отфильтрованные данные становились невидимыми при TTL<a href="https://github.com/milvus-io/milvus/pull/42944">(#42944</a>).</li>
<li>Удалены кэшированные результаты нулевых выражений для предотвращения неправильной фильтрации<a href="https://github.com/milvus-io/milvus/pull/42783">(#42783</a>).</li>
<li>Отклонение деления или модуляции на ноль в двоичных арифметических выражениях<a href="https://github.com/milvus-io/milvus/pull/42887">(#42887</a>).</li>
<li>Обеспечено освобождение ресурсов функции в графе потока после закрытия всех узлов<a href="https://github.com/milvus-io/milvus/pull/42775">(#42775</a>).</li>
<li>Исправлена проблема, из-за которой DataCoord мог застрять при обновлении с v2.5 до v2.6<a href="https://github.com/milvus-io/milvus/pull/42669">(#42669</a>).</li>
<li>Добавлена предварительная проверка для предотвращения неподдерживаемого приведения типов данных<a href="https://github.com/milvus-io/milvus/pull/42678">(#42678</a>).</li>
<li>Добавлена защита от параллелизма и закрытия для функции BM25<a href="https://github.com/milvus-io/milvus/pull/42599">(#42599</a>).</li>
<li>Отфильтрованы узлы потоковых запросов из группы ресурсов при обновлении<a href="https://github.com/milvus-io/milvus/pull/42594">(#42594</a>).</li>
<li>Исправлена проблема с <code translate="no">is_not_in</code> выражениями для индекса Trie<a href="https://github.com/milvus-io/milvus/pull/42886">(#42886</a>).</li>
<li>Исправлена проблема, из-за которой Rocksmq не завершал свою работу<a href="https://github.com/milvus-io/milvus/pull/42843">(#42843</a>).</li>
<li>Исправлена оптимизация обрезки для логических выражений <code translate="no">OR</code>, теперь обрезка производится только в том случае, если дочерние узлы являются обрезаемыми<a href="https://github.com/milvus-io/milvus/pull/42915">(#42915</a>).</li>
<li>Исправлена паника QueryCoord, вызванная тем, что контроллер не дожидался завершения проверки<a href="https://github.com/milvus-io/milvus/pull/42726">(#42726</a>).</li>
<li>Исправлена проблема, когда небольшие сегменты пропускали задачи сортировки по первичному ключу из-за того, что были неправильно помечены как индексированные<a href="https://github.com/milvus-io/milvus/pull/42615">(#42615</a>).</li>
<li>Уменьшен общий параллелизм задач DataNode в автономном режиме для предотвращения ошибок OOM<a href="https://github.com/milvus-io/milvus/pull/42809">(#42809</a>).</li>
<li>Предоставлены явные ошибки для арифметических операций над неподдерживаемыми типами<a href="https://github.com/milvus-io/milvus/pull/42890">(#42890</a>).</li>
</ul>
<h2 id="v2513" class="common-anchor-header">v2.5.13<button data-href="#v2513" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Дата выпуска: 10 июня 2025 г.</p>
<table>
<thead>
<tr><th>Версия Milvus</th><th>Версия Python SDK</th><th>Версия SDK для Node.js</th><th>Версия Java SDK</th></tr>
</thead>
...
<p>Мы рады представить Milvus 2.5.13! Эта версия расширяет ваши возможности благодаря новым функциям, таким как возможность отбрасывать свойства полей и использовать функцию <code translate="no">cast</code> для JSON-индексов. Кроме того, в ней улучшена производительность и стабильность, а также исправлены многочисленные ошибки для обеспечения большей надежности системы. Мы рекомендуем вам обновиться до версии 2.5.13 и изучить эти последние обновления!</p>
<h3 id="Features" class="common-anchor-header">Особенности</h3><ul>
<li>Добавлена поддержка выпадения свойств из поля<a href="https://github.com/milvus-io/milvus/pull/41954">(#41954</a>).</li>
<li>Добавлена функция <code translate="no">cast</code> для использования с JSON-индексами<a href="https://github.com/milvus-io/milvus/pull/42504">(#42504</a>).</li>
</ul>
<h3 id="Improvements" class="common-anchor-header">Улучшения</h3><ul>
<li>Увеличен размер буфера импорта по умолчанию<a href="https://github.com/milvus-io/milvus/pull/42542">(#42542</a>).</li>
<li>Ускорен процесс создания диспетчера<a href="https://github.com/milvus-io/milvus/pull/42544">(#42544</a>).</li>
<li>Устранены ограничения баланса между задачами каналов и сегментов<a href="https://github.com/milvus-io/milvus/pull/42410">(#42410</a>).</li>
<li>Установлен образ GPU CAGRA по умолчанию<a href="https://github.com/milvus-io/milvus/pull/42193">(#42193</a>).</li>
<li>RESTful API <code translate="no">DescribeIndex</code> теперь поддерживает возврат параметров индекса<a href="https://github.com/milvus-io/milvus/pull/42080">(#42080</a>).</li>
<li>Включен запуск анализатора по полю коллекции, чтобы избежать частого создания и уничтожения анализатора<a href="https://github.com/milvus-io/milvus/pull/42119">(#42119</a>).</li>
<li>Добавлена поддержка балансировки нескольких коллекций в одном триггере<a href="https://github.com/milvus-io/milvus/pull/42134">(#42134</a>).</li>
<li>Теперь при определении медленных запросов учитывается <code translate="no">nq</code> (количество запросов)<a href="https://github.com/milvus-io/milvus/pull/42125">(#42125</a>).</li>
<li>На стороне сервера теперь автоматически заполняются отсутствующие nullable поля<a href="https://github.com/milvus-io/milvus/pull/42120">(#42120</a>).</li>
<li>Добавлена поддержка фильтрации просроченных данных с помощью TTL<a href="https://github.com/milvus-io/milvus/pull/41960">(#41960</a>, <a href="https://github.com/milvus-io/milvus/pull/42121">#42121</a>, <a href="https://github.com/milvus-io/milvus/pull/42103">#42103</a>).</li>
<li>Усовершенствовано уплотнение данных с истекшим сроком хранения для восстановления пространства от небольшого количества старых удалений<a href="https://github.com/milvus-io/milvus/pull/42052">(#42052</a>).</li>
<li>Журналы доступа теперь поддерживают выборку гибридных поисковых выражений и полей<a href="https://github.com/milvus-io/milvus/pull/41921">(#41921</a>).</li>
<li>Добавлена семантика явного перемещения в интерфейс <code translate="no">get_batch_view</code> <a href="https://github.com/milvus-io/milvus/pull/42402">(#42402</a>).</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">Исправления ошибок</h3><ul>
<li>Исправлена утечка данных из конвейера/делегатора<a href="https://github.com/milvus-io/milvus/pull/42583">(#42583</a>).</li>
<li>Исправлена логика выбора делегатора при освобождении сегмента, чтобы избежать потенциальной паники MixCoord<a href="https://github.com/milvus-io/milvus/pull/42572">(#42572</a>).</li>
<li>Исправлена ошибка, которая могла привести к повреждению записи данных во время валидации<a href="https://github.com/milvus-io/milvus/pull/42555">(#42555</a>).</li>
<li>Добавлена проверка на то, что тип приведения является массивом для выражений JSON <code translate="no">contains</code> <a href="https://github.com/milvus-io/milvus/pull/42185">(#42185</a>).</li>
<li>Исправлена проблема с дублированием автоидентификаторов между операциями импорта и вставки<a href="https://github.com/milvus-io/milvus/pull/42520">(#42520</a>).</li>
<li>Убедились, что задачи статистики импорта сегментов запускаются только по адресу <code translate="no">import_checker</code> <a href="https://github.com/milvus-io/milvus/pull/42487">(#42487</a>).</li>
<li>Исправлена ошибка с <code translate="no">is null</code> для индекса Marisa<a href="https://github.com/milvus-io/milvus/pull/42421">(#42421</a>).</li>
<li>Обеспечено срабатывание задач статистики только для промытых сегментов<a href="https://github.com/milvus-io/milvus/pull/42425">(#42425</a>).</li>
<li>Сброс статуса уплотнения при завершении статистики сегментов<a href="https://github.com/milvus-io/milvus/pull/42005">(#42005</a>).</li>
<li>Обновлена версия Tantivy для исправления паники стеммера<a href="https://github.com/milvus-io/milvus/pull/42172">(#42172</a>).</li>
<li>Исправлена проблема, из-за которой нельзя было получить выходные поля вектора при использовании нового промежуточного индекса<a href="https://github.com/milvus-io/milvus/pull/42183">(#42183</a>).</li>
<li>Избавление от необходимости полагаться на Knowhere для управления потоками при вызове итератора Knowhere<a href="https://github.com/milvus-io/milvus/pull/42133">(#42133</a>).</li>
<li>Исправлена проблема, из-за которой сегменты могли быть преждевременно освобождены во время операции с каналом баланса<a href="https://github.com/milvus-io/milvus/pull/42043">(#42043</a>).</li>
<li>RESTful-интерфейс <code translate="no">DescribeIndex</code> теперь включает временную метку<a href="https://github.com/milvus-io/milvus/pull/42105">(#42105</a>).</li>
<li>Использование блокировки для обеспечения атомарности сброса индексов сегментов<a href="https://github.com/milvus-io/milvus/pull/42076">(#42076</a>).</li>
<li>Исправлена паника прокси в менеджере клиента шарда<a href="https://github.com/milvus-io/milvus/pull/42026">(#42026</a>).</li>
<li>Исправлена логика назначения слотов импорта<a href="https://github.com/milvus-io/milvus/pull/41982">(#41982</a>).</li>
<li>Исправлена ошибка, при которой не сбрасывалась временная точка для принудительного уплотнения по истечении срока действия<a href="https://github.com/milvus-io/milvus/pull/42000">(#42000</a>).</li>
</ul>
...
<li>Предотвращены сбои при использовании <code translate="no">contains_all</code> или <code translate="no">contains_any</code> с пустым массивом<a href="https://github.com/milvus-io/milvus/pull/41756">(#41756</a>).</li>
...
<li>Представлен <code translate="no">run_analyzer</code> API для пробных запусков, помогающий анализировать результаты токенизации. Дополнительную информацию см. в разделе <a href="/docs/ru/v2.5.x/analyzer-overview.md">Обзор анализатора</a>.</li>
<li>Токенизаторы<ul>
<li>Добавлена поддержка настройки параметров токенизатора Jieba.</li>
<li>Добавлена поддержка токенизатора Lindera. Дополнительные сведения см. в разделе <a href="/docs/ru/v2.5.x/lindera-tokenizer.md">Lindera</a>.</li>
<li>Добавлена поддержка токенизатора ICU. Дополнительную информацию см. в разделе <a href="/docs/ru/v2.5.x/icu-tokenizer.md">ICU</a>.</li>
<li>Добавлен токенизатор Language Identifier для определения языка.</li>
</ul></li>
<li>Фильтры<ul>
<li>Расширена языковая поддержка встроенного фильтра стоп-слов. Дополнительные сведения см. в разделе <a href="/docs/ru/v2.5.x/stop-filter.md">Стоп</a>.</li>
<li>Добавлен фильтр <code translate="no">remove_punct</code> для удаления знаков препинания. Дополнительные сведения см. в разделе <a href="/docs/ru/v2.5.x/removepunct-filter.md">Удалить знаки препинания</a>.</li>
<li>Добавлен фильтр <code translate="no">regex</code> для фильтрации текста на основе шаблонов. Дополнительные сведения см. в разделе <a href="/docs/ru/v2.5.x/regex-filter.md">Regex</a>.</li>
</ul></li>
</ul></li>
...
<li>Исправлена ошибка, из-за которой сохранялось неправильное смещение при создании Tantivy с нулевым полем<a href="https://github.com/milvus-io/milvus/pull/40453">(#40453</a>)</li>
...
<h3 id="Features" class="common-anchor-header">Особенности</h3><ul>
<li>Поддержка изоляции PartitionKey для повышения производительности при использовании нескольких ключей разделов<a href="https://github.com/milvus-io/milvus/pull/39245">(#39245</a>). Для получения дополнительной информации обратитесь к разделу <a href="/docs/ru/v2.5.x/use-partition-key.md">Использование ключа раздела</a>.</li>
<li>Sparse Index теперь поддерживает DAAT MaxScore <a href="https://github.com/milvus-io/knowhere/pull/1015">knowhere/#1015</a>. Дополнительные сведения см. в разделе <a href="/docs/ru/v2.5.x/sparse_vector.md">Sparse Vector</a>.</li>
...
<p>Подробнее см. в разделах <a href="/docs/ru/v2.5.x/analyzer-overview.md">Обзор анализатора</a> и <a href="/docs/ru/v2.5.x/full-text-search.md">Полнотекстовый поиск</a>.</p>
...
<p>Подробнее см. в разделе <a href="/docs/ru/v2.5.x/milvus-webui.md">Milvus WebUI</a>.</p>
...
<p>Подробнее см. в разделах <a href="/docs/ru/v2.5.x/analyzer-overview.md">"Обзор анализатора</a> " и <a href="/docs/ru/v2.5.x/keyword-match.md">"Подбор текста"</a>.</p>
...
<p>Подробнее см. в разделе <a href="/docs/ru/v2.5.x/bitmap.md">Растровый индекс</a>.</p>
...
<p>Подробности см. в разделе <a href="/docs/ru/v2.5.x/nullable-and-default.md">"Нулевые значения и значения по умолчанию</a>".</p>
...
<p>Подробности см. в разделе <a href="/docs/ru/v2.5.x/clustering-compaction.md">"Компактификация кластеризации</a>".</p>
...
<p>Подробности см. в разделе <a href="/docs/ru/v2.5.x/filtering-templating.md">Шаблонизация фильтров</a>.</p>
...
<p>Для пользователей, у которых уже есть работающее развертывание Milvus, необходимо обновить компоненты ETCD и Pulsar, прежде чем вы сможете использовать новые возможности и функции. Подробности см. в разделе <a href="/docs/ru/v2.5.x/upgrade-pulsar-v3.md">Обновление Pulsar с версии 2.x до версии 3.x.</a></p>
...
<h4 id="Security--Configuration-Updates" class="common-anchor-header">Обновления в области безопасности и конфигурации</h4><p>Поддержка TLS для защиты межузловой связи в более сложных или корпоративных средах. Подробности см. в разделе <a href="/docs/ru/v2.5.x/tls.md">Конфигурация безопасности</a>.</p>
