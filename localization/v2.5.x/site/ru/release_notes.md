...
<li>Пропущена генерация ограничителя разделов, если ни один раздел не задан<a href="https://github.com/milvus-io/milvus/pull/38911">(#38911</a>)</li>
...
<p>Подробности см. в разделе <a href="/docs/ru/filtering-templating.md">Шаблонирование фильтров</a>.</p>
...
<h3 id="Improvements" class="common-anchor-header">Улучшения</h3><h4 id="Deletion-Optimization" class="common-anchor-header">Оптимизация удаления</h4><p>Повышена скорость и снижено потребление памяти при крупномасштабных удалениях за счет оптимизации использования блокировок и управления памятью.</p>
