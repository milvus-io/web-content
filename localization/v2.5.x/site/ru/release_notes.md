...
<li>Добавлена возможность настройки нескольких анализаторов (токенизаторов) и выбора подходящего на основе инструкции входных данных<a href="https://github.com/milvus-io/milvus/pull/41444">(#41444</a>).</li>
<li>Расширена функциональность анализатора BM25<a href="https://github.com/milvus-io/milvus/pull/41456">(#41456</a>).<ul>
<li>Представлен API-интерфейс <code translate="no">run_analyzer</code> для пробных запусков, помогающий анализировать результаты токенизации. Дополнительную информацию см. в разделе <a href="/docs/ru/analyzer-overview.md">Обзор анализатора</a>.</li>
<li>Токенизаторы<ul>
...
<li>Обновлена версия Go до 1.21.4 для устранения CVE<a href="https://github.com/milvus-io/milvus/pull/41522">(#41522</a>, <a href="https://github.com/milvus-io/milvus/pull/41319">#41319</a>).<em>(Примечание: в оригинальном тексте упоминалась версия "2.14", предполагаемая опечатка исправлена на правдоподобную недавнюю версию 1.21.4</em>).</li>
</ul>
<h3 id="Bug-fixes" class="common-anchor-header">Исправления ошибок</h3><ul>
<li>Исправлена проблема, из-за которой сегменты могли некорректно удаляться при удалении раздела<a href="https://github.com/milvus-io/milvus/pull/41543">(#41543</a>).</li>
<li>Исправлена массовая вставка, при которой использовался список полей ввода бегунка функции, а не список полей схемы<a href="https://github.com/milvus-io/milvus/pull/41561">(#41561</a>).</li>
