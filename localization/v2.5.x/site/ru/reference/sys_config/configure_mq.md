...
<p>Если вы не установите поле mq.type по умолчанию, в этом файле есть примечание о включении приоритета, если мы настроим несколько mq.</p>
<ol>
...
<h2 id="mqmqBufSize" class="common-anchor-header"><code translate="no">mq.mqBufSize</code><button data-href="#mqmqBufSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Длина потребительского буфера клиента MQ  </td>
      <td>16</td>
    </tr>
  </tbody>
</table>
