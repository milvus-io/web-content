  ...
  <tbody>
    <tr>
      <td>
        ...
        <li>При уплотнении сегменты небольшого размера объединяются в большой сегмент, а удаленные сущности очищаются после истечения срока аренды Time Travel.</li>      </td>
      <td>true</td>
    </tr>
  </tbody>
</table>
