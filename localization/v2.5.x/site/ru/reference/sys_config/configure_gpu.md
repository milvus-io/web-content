...
summary: 'Узнайте, как настроить gpu для Milvus.'
---
<h1 id="gpu-related-Configurations" class="common-anchor-header">Конфигурации, связанные с gpu<button data-href="#gpu-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>#при использовании индексации на GPU Milvus будет использовать пул памяти, чтобы избежать частого выделения и удаления памяти.</p>
...
<h2 id="gpuinitMemSize" class="common-anchor-header"><code translate="no">gpu.initMemSize</code><button data-href="#gpuinitMemSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Размер инициализации пула памяти GPU   </td>
      <td></td>
    </tr>
  </tbody>
</table>
<h2 id="gpumaxMemSize" class="common-anchor-header"><code translate="no">gpu.maxMemSize</code><button data-href="#gpumaxMemSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Максимальный размер пула памяти Gpu   </td>
      <td></td>
    </tr>
  </tbody>
</table>
