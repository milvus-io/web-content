...
<h2 id="Scrape-Data-Using-Firecrawl" class="common-anchor-header">Сбор данных с помощью Firecrawl<button data-href="#Scrape-Data-Using-Firecrawl" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Initialize-the-Firecrawl-Application" class="common-anchor-header">Инициализация приложения Firecrawl</h3><p>Мы будем использовать библиотеку <code translate="no">firecrawl</code> для поиска данных с указанного URL в формате markdown. Начните с инициализации приложения Firecrawl:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Process-the-Scraped-Content" class="common-anchor-header">Обработка соскобленного контента</h3><p>Чтобы сделать соскобленный контент управляемым для вставки в Milvus, мы просто используем &quot;# &quot; для разделения контента, что позволяет примерно разделить содержимое каждой основной части соскобленного файла разметки.</p>
