...
<p>В этом блокноте показано, как создать агента, который может запрашивать Milvus на естественном языке с помощью вызова функций. Мы объединим фреймворк OpenAI Agents с мощными возможностями векторного поиска Milvus для создания удобного поиска.</p>
