...
<p>К сведению, <a href="https://grafana.com/docs/loki/latest/send-data/promtail/#promtail-agent">Promtail</a> будет устаревшим, поэтому мы представляем Alloy, который был официально предложен Grafana Labs в качестве нового агента для сбора логов Kubernetes и передачи их в Loki.</p>
