...
<h2 id="Migrate-the-metadata" class="common-anchor-header">Перенос метаданных<button data-href="#Migrate-the-metadata" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Начиная с Milvus 2.2.0, метаданные несовместимы с метаданными предыдущих выпусков. Следующие фрагменты примеров предполагают обновление с Milvus 2.1.4 до Milvus v2.5.24.</p>
...
<h3 id="2-Apply-the-new-configuration" class="common-anchor-header">2. Примените новую конфигурацию<button data-href="#2-Apply-the-new-configuration" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Выполните следующую команду, чтобы применить новую конфигурацию.</p>
