...
<p>Если вы хотите использовать экземпляр Milvus через балансировщик нагрузки уровня 7, <a href="/docs/ru/v2.5.x/gcp_layer7.md">прочтите эту статью</a>.</p>
...
<li><a href="/docs/ru/v2.5.x/azure.md">Развертывание кластера Milvus в Azure с помощью Kubernetes</a></li>
</ul>
