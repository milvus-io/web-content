...
<p>Эта тема устарела и скоро будет удалена. Вместо нее рекомендуем обратиться к разделу <a href="/docs/ru/v2.5.x/eks.md">Развертывание кластера Milvus на EKS</a>.</p>
</div>
...
<ul>
<li><a href="/docs/ru/v2.5.x/eks.md">Развертывание кластера Milvus на EKS</a></li>
<li><a href="/docs/ru/v2.5.x/gcp.md">Развертывание кластера Milvus на GCP с помощью Kubernetes</a></li>
<li><a href="/docs/ru/v2.5.x/azure.md">Руководство по развертыванию Milvus в Microsoft Azure с помощью Kubernetes</a></li>
</ul>
