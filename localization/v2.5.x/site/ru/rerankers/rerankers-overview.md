...
<li><p>Для реранкеров на базе API получите у провайдера ключ API и задайте его в соответствующих переменных окружения или аргументах.</p></li>
</ul>
</div>
<h2 id="Example-1-Use-BGE-rerank-function-to-rerank-documents-according-to-a-query" class="common-anchor-header">Пример 1: Использование функции BGE rerank для ранжирования документов в соответствии с запросом<button data-href="#Example-1-Use-BGE-rerank-function-to-rerank-documents-according-to-a-query" class="anchor-icon" translate="no">
    ...
    </button></h2><p>В этом примере мы покажем, как ранжировать результаты поиска с помощью <a href="/docs/ru/v2.5.x/rerankers-bge.md">BGE reranker</a> на основе определенного запроса.</p>
...
<li><code translate="no">doc_vector</code>: Векторные вкрапления, представляющие документ. Руководство по созданию вкраплений см. в разделе <a href="/docs/ru/v2.5.x/embeddings.md">"Вкрапления"</a>.</li>
