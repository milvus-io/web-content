...
<p>В этом разделе вы будете вставлять сущности в Коллекцию, созданную <a href="/docs/ru/create-collection-instantly.md#Quick-Setup">способом быстрой настройки</a>. Коллекция, созданная таким образом, имеет только два поля, названные <strong>id</strong> и <strong>vector</strong>. Кроме того, в этой Коллекции включено динамическое поле, поэтому сущности в коде примера включают поле **color**, которое не определено в схеме.</p>
