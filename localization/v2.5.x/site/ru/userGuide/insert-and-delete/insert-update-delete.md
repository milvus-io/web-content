...
<h1 id="Insert-Entities" class="common-anchor-header">Вставка сущностей<button data-href="#Insert-Entities" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Сущности в коллекции - это записи данных, которые имеют одинаковый набор полей. Значения полей в каждой записи данных образуют сущность. На этой странице рассказывается о том, как вставлять сущности в коллекцию.</p>
...
<p>В этом разделе вы будете вставлять сущности в Коллекцию, созданную <a href="/docs/ru/create-collection-instantly.md#Quick-Setup">способом быстрой настройки</a>. Коллекция, созданная таким образом, имеет только два поля, названные <strong>id</strong> и <strong>vector</strong>. Кроме того, в этой Коллекции включено динамическое поле, поэтому сущности в коде примера включают поле под названием <strong>color</strong>, которое не определено в схеме.</p>
...
<h2 id="Insert-Entities-into-a-Partition" class="common-anchor-header">Вставка сущностей в раздел<button data-href="#Insert-Entities-into-a-Partition" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Вы также можете вставить сущности в указанный раздел. Следующие фрагменты кода предполагают, что в вашей коллекции есть раздел с именем <strong>PartitionA</strong>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
