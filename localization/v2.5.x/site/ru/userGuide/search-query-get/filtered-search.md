...
<h2 id="Overview" class="common-anchor-header">Обзор<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Если коллекция содержит как векторные вкрапления, так и их метаданные, вы можете отфильтровать метаданные перед ANN-поиском, чтобы улучшить релевантность результатов поиска. Получив поисковый запрос с условием фильтрации, Milvus ограничивает область поиска сущностями, соответствующими указанному условию фильтрации.</p>
<p>
...
<h2 id="Examples" class="common-anchor-header">Примеры<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>В этом разделе показано, как проводить фильтрованный поиск. Фрагменты кода в этом разделе предполагают, что у вас уже есть следующие сущности в вашей коллекции. Каждая сущность имеет четыре поля, а именно <strong>id</strong>, <strong>vector</strong>, <strong>color</strong> и <strong>likes</strong>.</p>
...
<p>Поисковый запрос в следующем фрагменте кода содержит условие фильтрации и несколько выходных полей.</p>
