...
<table>
   ...
   <tr>
     ...
     <td><ul><li>Имя коллекции</li><li>Первичные ключи</li></ul></td>
     <td><ul><li>Имя коллекции</li><li>Выражения фильтрации</li></ul></td>
   ...
   <tr>
     ...
     <td><ul><li>Имя раздела</li><li>Выходные поля</li></ul></td>
...
<p>Дополнительные сведения о фильтрации метаданных см. в разделе <a href="/docs/ru/filtering">Фильтрация</a>.</p>
