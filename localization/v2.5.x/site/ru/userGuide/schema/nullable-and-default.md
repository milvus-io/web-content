...
<h2 id="Default-values​" class="common-anchor-header">Значения по умолчанию<button data-href="#Default-values​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Значения по умолчанию - это предустановленные значения, присвоенные скалярным полям. Если при вставке вы не указываете значение для поля, имеющего значение по умолчанию, система автоматически использует значение по умолчанию.</p>
