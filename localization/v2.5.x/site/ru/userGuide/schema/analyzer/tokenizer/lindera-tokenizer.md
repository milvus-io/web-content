...
<table>
   ...
   <tr>
     ...
     <td><p>Список словарей, используемых для определения словарного запаса. Возможные значения:</p>
<ul>
<li><p><code translate="no">ipadic</code>: Японский</p></li>
<li><p><code translate="no">ko-dic</code>: Корейский</p></li>
<li><p><code translate="no">cc-cedict</code>: Мандаринский китайский (традиционный/простой).</p></li>
</ul></td>
   </tr>
</table>
