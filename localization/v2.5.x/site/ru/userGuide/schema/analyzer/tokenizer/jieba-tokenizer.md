...
<h2 id="Configuration​" class="common-anchor-header">Конфигурация<button data-href="#Configuration​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Чтобы сконфигурировать анализатор, использующий токенизатор <code translate="no">jieba</code>, установите <code translate="no">tokenizer</code> на <code translate="no">jieba</code> в <code translate="no">analyzer_params</code>.</p>
