...
<h2 id="Configuration" class="common-anchor-header">Конфигурация<button data-href="#Configuration" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Чтобы настроить анализатор на использование токенизатора <code translate="no">jieba</code>, установите <code translate="no">tokenizer</code> на <code translate="no">jieba</code> в <code translate="no">analyzer_params</code>.</p>
...
<h2 id="Example-output" class="common-anchor-header">Пример вывода<button data-href="#Example-output" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Вот пример того, как токенизатор <code translate="no">jieba</code> обрабатывает текст:</p>
