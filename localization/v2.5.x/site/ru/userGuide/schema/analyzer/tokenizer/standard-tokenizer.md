...
<p>Для упрощения настройки вы можете использовать фильтр <a href="/docs/ru/standard-analyzer.md"><code translate="no">standard analyzer</code></a>, который объединяет токенизатор <code translate="no">standard</code> с фильтром <a href="/docs/ru/lowercase-filter.md"><code translate="no">lowercase filter</code></a>.</p>
</div>
