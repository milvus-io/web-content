...
<table>
   ...
   <tr>
     ...
     <td><p>Список слов, которые должны быть удалены из токенизации. По умолчанию используется предопределенный список <code translate="no">_english_</code>, содержащий распространенные английские стоп-слова. Подробную информацию о <code translate="no">_english_</code> можно найти <a href="https://github.com/milvus-io/milvus/blob/master/internal/core/thirdparty/tantivy/tantivy-binding/src/stop_words.rs">здесь</a>.</p></td>
   </tr>
</table>
