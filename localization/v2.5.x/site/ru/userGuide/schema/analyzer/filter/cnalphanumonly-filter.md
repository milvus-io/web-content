...
<button class="copy-code-btn"></button></code></pre>
<p>Фильтр <code translate="no">cnalphanumonly</code> работает с терминами, сгенерированными токенизатором, поэтому он должен использоваться в сочетании с токенизатором. Список токенизаторов, доступных в Milvus, приведен в разделе <a href="/docs/ru/tokenizers">Tokenizer Reference</a>.</p>
