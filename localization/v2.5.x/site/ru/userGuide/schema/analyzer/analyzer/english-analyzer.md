...
<ul>
<li><p><strong>Токенизатор</strong>: Использует<a href="/docs/ru/v2.5.x/standard-tokenizer.md"> токенизатор</a> <code translate="no">standard</code><a href="/docs/ru/v2.5.x/standard-tokenizer.md"></a> для разбиения текста на отдельные единицы слов.</p></li>
