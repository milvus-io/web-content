...
<h2 id="Local-install" class="common-anchor-header">Локальная установка<button data-href="#Local-install" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Если вы установили Milvus Standalone <a href="/docs/ru/v2.5.x/install_standalone-docker.md">с помощью docker</a>, вам лучше скачать и установить собранный бинарник, установить Birdwatcher как обычный модуль Go или собрать Birdwatcher из исходников.</p>
<ul>
...
<h2 id="Install-as-a-Kubernetes-pod" class="common-anchor-header">Установка в качестве капсулы Kubernetes<button data-href="#Install-as-a-Kubernetes-pod" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Если вы установили либо Milvus Standalone <a href="/docs/ru/v2.5.x/install_standalone-helm.md">с помощью диаграмм Helm</a> или <a href="/docs/ru/v2.5.x/install_standalone-operator.md">Milvus Operator</a>, либо Milvus Cluster <a href="/docs/ru/v2.5.x/install_cluster-helm.md">с помощью диаграмм Helm</a> или <a href="/docs/ru/v2.5.x/install_cluster-milvusoperator.md">Milvus Operator</a>, вам рекомендуется установить Birdwatcher в качестве капсулы Kubernetes.</p>
