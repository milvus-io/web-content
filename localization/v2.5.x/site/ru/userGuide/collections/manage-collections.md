...
<p>Для получения дополнительной информации о поиске и запросах обратитесь к статьям в главе " <a href="/docs/ru/search-rerank">Поиск и ранжирование</a> ", среди которых основными являются следующие:</p>
<ul>
