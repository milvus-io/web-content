...
<h2 id="Schema-and-Fields" class="common-anchor-header">Схема и поля<button data-href="#Schema-and-Fields" class="anchor-icon" translate="no">
    ...
    </button></h2><p>При описании объекта мы обычно упоминаем его атрибуты, такие как размер, вес и положение. Эти атрибуты можно использовать в качестве полей в коллекции. Каждое поле имеет различные ограничивающие свойства, такие как тип данных и размерность векторного поля. Вы можете сформировать схему коллекции, создав поля и определив их порядок. Возможные применимые типы данных см. в разделе <a href="/docs/ru/v2.5.x/schema.md">Объяснение схемы</a>.</p>
<p>Вы должны включить все определенные схемой поля в вставляемые сущности. Чтобы сделать некоторые из них необязательными, можно включить динамическое поле. Подробности см. в разделе <a href="/docs/ru/v2.5.x/enable-dynamic-field.md">Динамическое поле</a>.</p>
<ul>
<li><p><strong>Сделать их нулевыми или установить значения по умолчанию</strong></p>
<p>Подробнее о том, как сделать поле недействительным или установить значение по умолчанию, читайте в разделе <a href="/docs/ru/v2.5.x/nullable-and-default.md">Недействительное и по умолчанию</a>.</p></li>
<li><p><strong>Включение динамического поля</strong></p>
<p>Подробнее о том, как включить и использовать динамическое поле, читайте в разделе <a href="/docs/ru/v2.5.x/enable-dynamic-field.md">Динамическое поле</a>.</p></li>
</ul>
...
<p>Дополнительные сведения см. в разделе <a href="/docs/ru/v2.5.x/primary-field.md">Первичное поле и AutoId</a>.</p>
...
<p>Дополнительные сведения см. в разделе <a href="/docs/ru/v2.5.x/schema.md">Объяснение схемы</a>.</p>
...
<p>Более подробную информацию см. в разделе <a href="/docs/ru/v2.5.x/load-and-release.md">Загрузка и освобождение</a>.</p>
...
<p>Подробные сведения о применимых типах метрик см. в разделе <a href="/docs/ru/v2.5.x/metric.md">Типы метрик</a>.</p>
...
<ul>
<li><p><a href="/docs/ru/v2.5.x/single-vector-search.md">Базовый поиск ANN</a></p></li>
<li><p><a href="/docs/ru/v2.5.x/filtered-search.md">Фильтрованный поиск</a></p></li>
<li><p><a href="/docs/ru/v2.5.x/range-search.md">Поиск по диапазону</a></p></li>
<li><p><a href="/docs/ru/v2.5.x/grouping-search.md">Группировочный поиск</a></p></li>
<li><p><a href="/docs/ru/v2.5.x/multi-vector-search.md">Гибридный поиск</a></p></li>
<li><p><a href="/docs/ru/v2.5.x/with-iterators.md">Итератор поиска</a></p></li>
<li><p><a href="/docs/ru/v2.5.x/get-and-scalar-query.md">Запрос</a></p></li>
<li><p><a href="/docs/ru/v2.5.x/full-text-search.md">Полнотекстовый поиск</a></p></li>
<li><p><a href="/docs/ru/v2.5.x/keyword-match.md">Сопоставление текста</a></p></li>
</ul>
...
<ul>
<li><p><a href="/docs/ru/v2.5.x/use-partition-key.md">Использовать ключ раздела</a></p></li>
<li><p><a href="/docs/ru/v2.5.x/mmap.md">Использовать mmap</a></p></li>
<li><p><a href="/docs/ru/v2.5.x/clustering-compaction.md">Компактизация кластеризации</a></p></li>
</ul>
...
<p>Подробнее см. в разделе <a href="/docs/ru/v2.5.x/manage-partitions.md">Управление разделами</a>.</p>
...
<p>Подробнее о том, как задать количество шардов, см. в разделе <a href="/docs/ru/v2.5.x/create-collection.md">Создание коллекции</a>.</p>
...
<p>Для получения дополнительной информации см. раздел <a href="/docs/ru/v2.5.x/manage-aliases.md">Управление псевдонимами</a>.</p>
...
<p>Подробные сведения об этих уровнях согласованности см. в разделе <a href="/docs/ru/v2.5.x/tune_consistency.md">Уровень согласованности</a>.</p>
