...
title: Бросить коллекцию
summary: 'Вы можете отказаться от коллекции, если она больше не нужна.'
---
<h1 id="Drop-Collection" class="common-anchor-header">Бросить коллекцию<button data-href="#Drop-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>Вы можете отказаться от коллекции, если она больше не нужна.</p>
<h2 id="Examples" class="common-anchor-header">Примеры<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>В следующих фрагментах кода предполагается, что у вас есть коллекция с именем <strong>my_collection</strong>.</p>
