...
<p>В следующем фрагменте кода предполагается, что вы создали коллекцию <strong>customized_setup_2</strong>, и в ней есть два поля <strong>my_id</strong> и <strong>my_vector</strong>.</p>
<div class="multipleCode">
   <a href="#python">Python</a> <a href="#java">Java</a> <a href="#javascript">NodeJS</a> <a href="#go">Go</a> <a href="#bash">cURL</a></div>
