...
<p>Следующий фрагмент кода предполагает, что вы создали коллекцию с именем <strong>customized_setup_2</strong>, и в ней есть два поля с именами <strong>my_id</strong> и <strong>my_vector</strong>.</p>
<div class="multipleCode">
 <a href="#python">Python </a> <a href="#java">Java</a> <a href="#javascript">Node.js</a> <a href="#go">Go</a> <a href="#curl">cURL</a></div>
