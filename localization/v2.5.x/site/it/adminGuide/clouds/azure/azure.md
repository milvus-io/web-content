...
<p>Notate il valore config <code translate="no">service.type</code>, che indica che vogliamo esporre l'istanza di Milvus attraverso un bilanciatore di carico Layer-4.</p>
...
<li><a href="/docs/it/v2.5.x/gcp.md">Distribuire il cluster Milvus su GCP con Kubernetes</a></li>
</ul>
