...
<li>(vivamente consigliato) Per implementare il principio del minimo privilegio, procedere come segue:<ul>
...
<p><strong>È necessario sostituire il nome del bucket e l'ARN della policy con il proprio.</strong></p>
