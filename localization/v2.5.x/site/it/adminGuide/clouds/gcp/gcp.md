...
<p>Per facilitare il lavoro, è necessario impostare diverse regole di firewall per consentire il traffico esterno su ICMP, RDP e SSH e il traffico all'interno della VPC.</p>
...
<p>Si noti il valore <code translate="no">service.type</code>, che indica che vogliamo esporre l'istanza Milvus attraverso un bilanciatore di carico Layer-4.</p>
<p>Se volete esporre la vostra istanza Milvus attraverso un bilanciatore di carico Layer-7, <a href="/docs/it/v2.5.x/gcp_layer7.md">leggete qui</a>.</p>
...
<li><a href="/docs/it/v2.5.x/azure.md">Distribuire il cluster Milvus su Azure con Kubernetes</a></li>
</ul>
