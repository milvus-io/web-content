...
---
<div class="tab-wrapper"><a href="/docs/it/v2.5.x/upgrade_milvus_cluster-operator.md" class=''>Milvus</a><a href="/docs/it/v2.5.x/upgrade_milvus_cluster-helm.md" class='active '>OperatorHelm</a></div>
...
<p>Dalla versione 4.2.21 del grafico Milvus-Helm, abbiamo introdotto il grafico pulsar-v3.x come dipendenza. Per la retrocompatibilità, aggiornare helm alla versione 3.14 o successiva e assicurarsi di aggiungere l'opzione <code translate="no">--reset-then-reuse-values</code> ogni volta che si usa <code translate="no">helm upgrade</code>.</p>
</div>
...
<ul>
<li><p><a href="#Upgrade-Milvus-using-Helm">Aggiornare Milvus utilizzando Helm</a> per un aggiornamento da una release minore precedente alla v2.2.3 alla v2.5.19.</p></li>
