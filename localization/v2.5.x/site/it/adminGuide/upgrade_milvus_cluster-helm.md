...
<h3 id="3-Check-the-image-tag" class="common-anchor-header">3. Controllare il tag immagine<button data-href="#3-Check-the-image-tag" class="anchor-icon" translate="no">
    ...
    </button></h3><p>Controllare il tag image per il pod <code translate="no">my-release-milvus-proxy-6c548f787f-scspp</code>. Si può notare che la release del cluster Milvus è la v2.1.4.</p>
