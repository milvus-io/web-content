...
<h2 id="Privilege-group-vs-privileges" class="common-anchor-header">Gruppo di privilegi vs. privilegi<button data-href="#Privilege-group-vs-privileges" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Un gruppo di privilegi è composto da più privilegi.</p>
<p>
...
<li><p><strong>ClusterReadWrite (Cluster_RW)</strong>: include i privilegi per la lettura e la scrittura dei dati dell'istanza</p></li>
