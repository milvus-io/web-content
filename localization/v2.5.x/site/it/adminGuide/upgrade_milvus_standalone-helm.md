...
<div style="display: none;">- Eseguire un aggiornamento continuo](#conduct-a-rolling-upgrade) da Milvus v2.2.3 e versioni successive a v2.5.5.</div>
<ul>
<li><p><a href="#Upgrade-Milvus-using-Helm">Aggiornare Milvus usando Helm</a> per un aggiornamento da una release minore precedente alla v2.2.3 alla v2.5.5.</p></li>
<li><p><a href="#Migrate-the-metadata">Migrare i metadati</a> prima dell'aggiornamento da Milvus v2.1.x a v2.5.5.</p></li>
</ul>
...
<p>Dopo essersi assicurati che tutte le installazioni nella vostra istanza Milvus siano nello stato normale. È possibile eseguire il seguente comando per aggiornare l'istanza Milvus alla versione 2.5.5.</p>
...
<li>Lo script codifica l'ordine di aggiornamento delle installazioni e non può essere modificato.</li>
...
<h4 id="2-Upgrade-Milvus-from-v21x-to-255" class="common-anchor-header">2. Aggiornamento di Milvus da v2.1.x a 2.5.5</h4><p>I comandi seguenti presuppongono l'aggiornamento di Milvus dalla v2.1.4 alla 2.5.5. Modificateli in base alle vostre esigenze.</p>
<ol>
