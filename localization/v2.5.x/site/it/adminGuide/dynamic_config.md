...
<ul>
<li>Sia installato Birdwatcher. Per i dettagli, vedere <a href="/docs/it/v2.5.x/birdwatcher_install_guides.md">Installazione di Birdwatcher</a>,</li>
...
<li>Ulteriori informazioni sulle <a href="/docs/it/v2.5.x/system_configuration.md">configurazioni di sistema</a>.</li>
<li>Imparate a configurare Milvus installato usando <a href="/docs/it/v2.5.x/configure_operator.md">Milvus Operator</a>, i <a href="/docs/it/v2.5.x/configure-helm.md">grafici Helm</a> e <a href="/docs/it/v2.5.x/configure-docker.md">Docker</a>.</li>
</ul>
