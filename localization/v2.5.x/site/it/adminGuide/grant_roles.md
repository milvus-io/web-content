...
<h2 id="Describe-user​" class="common-anchor-header">Descrivere l'utente<button data-href="#Describe-user​" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Una volta assegnato un ruolo a un utente, si può verificare se l'operazione di assegnazione è andata a buon fine tramite il metodo <code translate="no">describe_user()</code>.</p>
