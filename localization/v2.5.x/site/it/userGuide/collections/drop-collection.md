...
title: Abbandono della raccolta
summary: È possibile abbandonare una raccolta se non è più necessaria.
---
<h1 id="Drop-Collection" class="common-anchor-header">Abbandono della raccolta<button data-href="#Drop-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>È possibile eliminare una raccolta se non è più necessaria.</p>
<h2 id="Examples" class="common-anchor-header">Esempi<button data-href="#Examples" class="anchor-icon" translate="no">
    ...
    </button></h2><p>I seguenti frammenti di codice presuppongono che si disponga di una collezione denominata <strong>my_collection</strong>.</p>
