...
<h2 id="Current-version" class="common-anchor-header">Versione attuale<button data-href="#Current-version" class="anchor-icon" translate="no">
    ...
    </button></h2><p>La versione attuale di Milvus_CLI è 1.0.2. Per trovare la versione installata e verificare se è necessario aggiornarla, eseguire <code translate="no">milvus_cli --version</code>.</p>
