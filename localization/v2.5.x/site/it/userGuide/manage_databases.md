...
<h2 id="Manage-database-properties" class="common-anchor-header">Gestire le proprietà dei database<button data-href="#Manage-database-properties" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ogni database ha le sue proprietà; è possibile impostare le proprietà di un database quando lo si crea, come descritto in <a href="/docs/it/v2.5.x/manage_databases.md#Create-database">Creare un database</a>, oppure è possibile modificare e eliminare le proprietà di qualsiasi database esistente.</p>
...
<table>
   ...
   <tr>
     ...
     <td><p>stringa</p></td>
     <td><p>I nomi dei gruppi di risorse associati al database specificato in un elenco comunemente separato.</p></td>
   </tr>
   <tr>
