...
<table>
   ...
   <tr>
     ...
     <td><p>Per ignorare le incorporazioni vettoriali più simili, accertarsi che <code translate="no">radius</code> &lt; distanza &lt;= <code translate="no">range_filter</code></p></td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td><p>Per ignorare le incorporazioni vettoriali più simili, assicurarsi che <code translate="no">range_filter</code> &lt;= distanza &lt;= Una distanza di Hamming minore indica una maggiore somiglianza. <code translate="no">radius</code></p></td>
   </tr>
   <tr>
