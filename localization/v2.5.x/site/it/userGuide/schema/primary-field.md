...
<h2 id="Use-Int64-Primary-Keys" class="common-anchor-header">Utilizzare le chiavi primarie Int64<button data-href="#Use-Int64-Primary-Keys" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h2><p>Per utilizzare chiavi primarie di tipo Int64, è necessario impostare <code translate="no">datatype</code> su <code translate="no">DataType.INT64</code> e <code translate="no">is_primary</code> su <code translate="no">true</code>. Se si desidera che Milvus allarghi le chiavi primarie per le entità in arrivo, impostare anche <code translate="no">auto_id</code> su <code translate="no">true</code>.</p>
