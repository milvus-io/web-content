...
<p>Oltre ai vettori densi, Milvus supporta anche vettori sparsi e vettori binari. I vettori sparsi sono adatti a corrispondenze precise basate su termini specifici, come la ricerca di parole chiave e la corrispondenza di termini, mentre i vettori binari sono comunemente usati per gestire in modo efficiente i dati binarizzati, come la corrispondenza di modelli di immagini e alcune applicazioni di hashing. Per ulteriori informazioni, consultare <a href="/docs/it/v2.5.x/binary-vector.md">Vettori binari</a> e <a href="/docs/it/v2.5.x/sparse_vector.md">vettori sparsi</a>.</p>
</div>
...
<p>Milvus supporta altri tipi di metriche. Per ulteriori informazioni, consultare la sezione <a href="/docs/it/v2.5.x/metric.md">Tipi di metriche</a>.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>Per ulteriori informazioni sui parametri di ricerca per similarità, consultare la sezione <a href="/docs/it/v2.5.x/single-vector-search.md">Ricerca di base di RNA</a>.</p>
