...
<table>
   ...
   <tr>
     ...
     <td><p>Un elenco di parole da rimuovere dalla tokenizzazione. Per impostazione predefinita, il filtro utilizza il dizionario integrato <code translate="no">_english_</code>. È possibile sovrascriverlo o estenderlo in tre modi:</p><ul><li><p><strong>Dizionari integrati</strong> - fornire uno di questi alias linguistici per utilizzare un dizionario predefinito:<code translate="no">"_english_"</code>, <code translate="no">"_danish_"</code>, <code translate="no">"_dutch_"</code>, <code translate="no">"_finnish_"</code>, <code translate="no">"_french_"</code>, <code translate="no">"_german_"</code>, <code translate="no">"_hungarian_"</code>, <code translate="no">"_italian_"</code>, <code translate="no">"_norwegian_"</code>, <code translate="no">"_portuguese_"</code>, <code translate="no">"_russian_"</code>, <code translate="no">"_spanish_"</code>, <code translate="no">"_swedish_"</code></p></li><li><p><strong>Elenco personalizzato</strong> - passare un array di termini personalizzati, ad esempio <code translate="no">["foo", "bar", "baz"]</code>.</p></li><li><p><strong>Elenco misto</strong> - combina alias e termini personalizzati, ad esempio <code translate="no">["of", "to", "_english_"]</code>.</p><p>Per i dettagli sul contenuto esatto di ciascun dizionario predefinito, fare riferimento a <a href="https://github.com/milvus-io/milvus/blob/master/internal/core/thirdparty/tantivy/tantivy-binding/src/analyzer/filter/stop_words.rs">stop_words</a>.</p></li></ul></td>
   </tr>
</table>
<p>Il filtro <code translate="no">stop</code> opera sui termini generati dal tokenizzatore, quindi deve essere usato in combinazione con un tokenizzatore. Per un elenco dei tokenizer disponibili in Milvus, consultare <a href="/docs/it/tokenizers">Tokenizer Reference</a>.</p>
