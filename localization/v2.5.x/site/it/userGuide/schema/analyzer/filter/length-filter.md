...
<p>Il filtro <code translate="no">length</code> opera sui termini generati dal tokenizer, quindi deve essere usato in combinazione con un tokenizer. Per un elenco dei tokenizer disponibili in Milvus, fare riferimento a <a href="/docs/it/v2.5.x/standard-tokenizer.md">Standard Tokenizer</a> e alle sue pagine collaterali.</p>
