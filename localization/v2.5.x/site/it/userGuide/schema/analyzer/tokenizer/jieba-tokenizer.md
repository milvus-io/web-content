...
<table>
   ...
   <tr>
     ...
     <td><p>Un elenco di dizionari usati per definire il vocabolario. Si possono fornire parole del proprio dizionario o combinarle con il dizionario predefinito usando <code translate="no">"_default_"</code>. Ad esempio, <code translate="no">["_default_", "结巴分词器"]</code>.</p></td>
