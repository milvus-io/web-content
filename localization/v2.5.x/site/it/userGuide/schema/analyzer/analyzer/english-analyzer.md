...
<ul>
<li><p><strong>Tokenizzatore</strong>: Utilizza il<a href="/docs/it/v2.5.x/standard-tokenizer.md"> tokenizer</a> di <code translate="no">standard</code> per dividere il testo in unità di parole discrete.</p></li>
