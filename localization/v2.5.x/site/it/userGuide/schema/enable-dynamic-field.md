...
<p>Per i dettagli sui parametri e le considerazioni, fare riferimento a <a href="/docs/it/v2.5.x/use-json-fields.md#Index-a-JSON-field">Indicizzare un campo JSON</a>.</p>
