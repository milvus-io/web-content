...
<h1 id="queryCoord-related-Configurations" class="common-anchor-header">Configurazioni correlate a queryCoord<button data-href="#queryCoord-related-Configurations" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Configurazione correlata a queryCoord, utilizzata per gestire la topologia e il bilanciamento del carico per i nodi di query e il passaggio da segmenti in crescita a segmenti chiusi.</p>
...
<h2 id="queryCoordautoBalanceInterval" class="common-anchor-header"><code translate="no">queryCoord.autoBalanceInterval</code><button data-href="#queryCoordautoBalanceInterval" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        l'intervallo per l'attivazione del bilanciamento automatico      </td>
      <td>3000</td>
    </tr>
  </tbody>
</table>
