...
summary: Scoprite come configurare indexNode per Milvus.
---
<h1 id="indexNode-related-Configurations" class="common-anchor-header">Configurazioni relative a indexNode<button data-href="#indexNode-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
  ...
  <tbody>
    <tr>
      <td>        abilita il nodo indice a costruire l'indice vettoriale del disco     </td>
      <td>vero</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodeip" class="common-anchor-header"><code translate="no">indexNode.ip</code><button data-href="#indexNodeip" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Indirizzo TCP/IP di indexNode. Se non viene specificato, viene utilizzato il primo indirizzo unicastable.      </td>
      <td></td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodeport" class="common-anchor-header"><code translate="no">indexNode.port</code><button data-href="#indexNodeport" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Porta TCP del nodo indice      </td>
      <td>21121</td>
    </tr>
  </tbody>
</table>
...
<h2 id="indexNodegrpcserverMaxRecvSize" class="common-anchor-header"><code translate="no">indexNode.grpc.serverMaxRecvSize</code><button data-href="#indexNodegrpcserverMaxRecvSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        La dimensione massima di ogni richiesta RPC che l'indexNode può ricevere, unità: byte    </td>
      <td>268435456</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcclientMaxSendSize" class="common-anchor-header"><code translate="no">indexNode.grpc.clientMaxSendSize</code><button data-href="#indexNodegrpcclientMaxSendSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Dimensione massima di ogni richiesta RPC che i client dell'indexNode possono inviare, unità: byte    </td>
      <td>268435456</td>
    </tr>
  </tbody>
</table>
<h2 id="indexNodegrpcclientMaxRecvSize" class="common-anchor-header"><code translate="no">indexNode.grpc.clientMaxRecvSize</code><button data-href="#indexNodegrpcclientMaxRecvSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        La dimensione massima di ogni richiesta RPC che i client su indexNode possono ricevere, unità: byte    </td>
      <td>536870912</td>
    </tr>
  </tbody>
</table>
