...
summary: Imparare a configurare la gpu per Milvus.
---
<h1 id="gpu-related-Configurations" class="common-anchor-header">Configurazioni relative alla GPU<button data-href="#gpu-related-Configurations" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>#Quando si utilizza l'indicizzazione su GPU, Milvus utilizza un pool di memoria per evitare l'allocazione e la deallocazione frequente della memoria.</p>
...
<p>#maxMemSize inizializzerà l'intera memoria disponibile della GPU.</p>
<h2 id="gpuinitMemSize" class="common-anchor-header"><code translate="no">gpu.initMemSize</code><button data-href="#gpuinitMemSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Dimensione iniziale del pool di memoria Gpu   </td>
      <td></td>
    </tr>
  </tbody>
</table>
<h2 id="gpumaxMemSize" class="common-anchor-header"><code translate="no">gpu.maxMemSize</code><button data-href="#gpumaxMemSize" class="anchor-icon" translate="no">
  ...
  <tbody>
    <tr>
      <td>        Pool di memoria Gpu Dimensione massima      </td>
      <td></td>
    </tr>
  </tbody>
</table>
