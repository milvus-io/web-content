...
<h1 id="Coordinator-HA" class="common-anchor-header">Coordinatore HA<button data-href="#Coordinator-HA" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Come mostrato nell'<a href="/docs/it/v2.5.x/architecture_overview.md">architettura</a> di <a href="/docs/it/v2.5.x/architecture_overview.md">Milvus</a>, Milvus è composto da molti componenti e li fa lavorare in modo distribuito. Tra tutti i componenti, Milvus assicura l'alta disponibilità dei lavoratori attraverso lo <a href="/docs/it/v2.5.x/scaleout.md">scaling up e lo scaling out</a> dei nodi, rendendo i coordinatori l'unico anello debole della catena.</p>
...
<ul>
<li><a href="/docs/it/v2.5.x/configure_rootcoord.md#rootCoordactiveStandbyenabled">rootCoord.activeStandby.enabled</a></li>
<li><a href="/docs/it/v2.5.x/configure_querycoord.md#queryCoordactiveStandbyenabled">queryCoord.activeStandby.enabled</a></li>
<li><a href="/docs/it/v2.5.x/configure_datacoord.md#dataCoordactiveStandbyenabled">dataCoord.activeStandby.enabled</a></li>
</ul>
