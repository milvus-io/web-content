...
<li>Leggere <a href="/docs/it/v2.5.x/four_layers.md">Computing/Storage Disaggregation</a> per comprendere il meccanismo e il principio di progettazione di Milvus.</li>
</ul>
