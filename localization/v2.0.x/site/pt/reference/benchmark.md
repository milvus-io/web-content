...
<p><strong>Suggestion</strong></p>
<p>For large data sets which are mostly stored in <a href="/docs/pt/glossary.md#Segment">sealed segments</a>, the more index nodes in the cluster, the less time it takes to build an index.</p>
...
<p><strong>Suggestion</strong></p>
<p>For large data sets which are mostly stored in <a href="/docs/pt/glossary.md#Segment">sealed segments</a>, adding query nodes to the cluster will shorten time it takes to search vectors.</p>
...
<p><strong>Suggestion</strong></p>
<p>For large data sets which are mostly stored in <a href="/docs/pt/glossary.md#Segment">sealed segments</a>, adding query nodes to the cluster will increase QPS.</p>
