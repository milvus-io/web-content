...
<p>This topic describes how to scale out and scale in a Milvus cluster. We assume that you have already <a href="/docs/pt/install_cluster-helm.md">installed a Milvus cluster</a> before scaling. Also, we recommend familiarizing yourself with the <a href="/docs/pt/architecture_overview.md">Milvus architecture</a> before you begin.</p>
...
<p>According to the <a href="/docs/pt/architecture_overview.md">Milvus architecture</a>, stateless worker nodes include query node, data node, index node, and proxy. Therefore, you can scale out these type of nodes to suit your business needs and application scenarios. You can either scale out the Milvus cluster manually or automatically.</p>
...
<ul>
<li>Learn <a href="/docs/pt/monitor.md">Monitor Milvus 2.0 with Prometheus Operator on Kubernetes</a></li>
</ul></li>
...
<ul>
<li><a href="/docs/pt/allocate.md#standalone">Allocate Resources on Kubernetes</a></li>
</ul></li>
</ul>
