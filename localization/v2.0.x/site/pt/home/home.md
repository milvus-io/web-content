...
<ul>
<li>Added Milvus cluster installation guidance with <a href="/docs/pt/install_cluster-ansible.md">Ansible</a>.</li>
...
<p><em>Mar 2022</em></p>
<ul>
<li>Added guidance on <a href="/docs/pt/calculate_distance.md">distance calculation</a>.</li>
<li>Added documentation on how to <a href="/docs/pt/load_partition.md">load</a> and <a href="/docs/pt/release_partition.md">release</a> a partition.</li>
<li>Added Milvus <a href="/docs/pt/benchmark.md">benchmark</a> report.</li>
</ul>
</div>
