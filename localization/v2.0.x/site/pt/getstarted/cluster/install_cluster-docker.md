...
title: ''
---
<div class="tab-wrapper"><a href="/docs/pt/install_cluster-docker.md" class='active '>Docker Compose</a><a href="/docs/pt/install_cluster-helm.md" class=''>Helm</a><a href="/docs/pt/install_cluster-milvusoperator.md" class=''>Milvus Operator</a><a href="/docs/pt/install_cluster-ansible.md" class=''>Ansible</a></div>
...
<h2 id="Prerequisites" class="common-anchor-header">Prerequisites<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="/docs/pt/prerequisite-docker.md">Check the requirements for hardware and software</a> prior to your installation.</p>
