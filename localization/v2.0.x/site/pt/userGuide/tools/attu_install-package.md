...
title: ''
---
<div class="tab-wrapper"><a href="/docs/pt/attu_install-docker.md" class=''>Install with Docker Compose</a><a href="/docs/pt/attu_install-helm.md" class=''>Install with Helm Chart</a><a href="/docs/pt/attu_install-package.md" class='active '>Install with Package</a></div>
<h1 id="Install-Attu-with-Pre-built-Packages" class="common-anchor-header">Install Attu with Pre-built Packages<button data-href="#Install-Attu-with-Pre-built-Packages" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
    ...
    </button></h1><p>This topic describes how to install Attu with pre-built packages, an efficient open-source management tool for Milvus.</p>
