...
<h1 id="Time-Travel" class="common-anchor-header">Time Travel<button data-href="#Time-Travel" class="anchor-icon" translate="no">
    ...
    </button></h1><p>This topic introduces the Time Travel feature in detail, including how it is designed and how it works in Milvus. See <a href="/docs/zh/timetravel.md">Search with Time Travel</a> for more information about how to use this feature.</p>
...
<p>All CRUD operations within Milvus are executed in memory. Therefore, you need to <a href="/docs/zh/search.md#Load-collection">load collection from disk to memory</a> before searching with Time Travel.</p>
...
<ul>
<li>Learn how to <a href="/docs/zh/timetravel.md">search with Time Travel</a></li>
<li>Learn the <a href="/docs/zh/architecture_overview.md">architecture</a> of Milvus.</li>
<li>Understand <a href="/docs/zh/data_processing.md">how data are processed</a> in Milvus.</li>
</ul>
