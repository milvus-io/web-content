...
title: ''
---
<div class="tab-wrapper"><a href="/docs/v2.0.x/install_standalone-docker.md" class=''>Docker Compose</a><a href="/docs/v2.0.x/install_standalone-helm.md" class='active '>Helm</a><a href="/docs/v2.0.x/install_standalone-aptyum.md" class=''>APT or YUM</a></div>
...
<h2 id="Prerequisites" class="common-anchor-header">Prerequisites<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Check <a href="/docs/v2.0.x/prerequisite-helm.md">the requirements</a>  for hardware and software prior to your installation.</p>
