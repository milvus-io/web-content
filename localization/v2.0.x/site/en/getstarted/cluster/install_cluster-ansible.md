...
title: ''
---
<div class="tab-wrapper"><a href="/docs/v2.0.x/install_cluster-docker.md" class=''>Docker Compose</a><a href="/docs/v2.0.x/install_cluster-helm.md" class=''>Helm</a><a href="/docs/v2.0.x/install_cluster-milvusoperator.md" class=''>Milvus Operator</a><a href="/docs/v2.0.x/install_cluster-ansible.md" class='active '>Ansible</a></div>
...
<li>Ensure that your CPU and RAM meet the requirements in <a href="/docs/v2.0.x/prerequisite-docker.md">Environment Checklist</a>.</li>
