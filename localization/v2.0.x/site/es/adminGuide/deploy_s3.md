...
<p>See <a href="/docs/es/configure_minio.md">MinIO/S3 Configurations</a> for more information.</p>
...
<ul>
<li><a href="/docs/es/gcp.md#Use-Google-Cloud-Storage">Use Google Cloud Storage</a></li>
<li><a href="/docs/es/azure.md#Use-Azure-Blob-Storage">Use Azure Blob Storage</a></li>
</ul>
