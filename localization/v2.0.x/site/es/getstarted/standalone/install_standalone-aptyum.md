...
title: ''
---
<div class="tab-wrapper"><a href="/docs/es/install_standalone-docker.md" class=''>Docker Compose</a><a href="/docs/es/install_standalone-helm.md" class=''>Helm</a><a href="/docs/es/install_standalone-aptyum.md" class='active '>APT or YUM</a></div>
...
<h2 id="Prerequisites" class="common-anchor-header">Prerequisites<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ensure that your CPU, RAM, and disk meets the requirements in <a href="/docs/es/prerequisite-docker.md">Environment Checklist</a> prior to your installation.</p>
