...
title: ''
---
<div class="tab-wrapper"><a href="/docs/es/install_standalone-docker.md" class='active '>Docker Compose</a><a href="/docs/es/install_standalone-helm.md" class=''>Helm</a><a href="/docs/es/install_standalone-aptyum.md" class=''>APT or YUM</a></div>
...
<h2 id="Download-the-YAML-file" class="common-anchor-header">Download the <code translate="no">YAML</code> file<button data-href="#Download-the-YAML-file" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://github.com/milvus-io/milvus/releases/download/v2.0.2/milvus-standalone-docker-compose.yml">Download</a> <code translate="no">milvus-standalone-docker-compose.yml</code> and save it as <code translate="no">docker-compose.yml</code> manually, or with the following command.</p>
