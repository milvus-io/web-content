...
<pre><code translate="no"><span class="hljs-built_in">compile</span> <span class="hljs-string">&#x27;io.milvus:milvus-sdk-java:2.0.x&#x27;</span>
<button class="copy-code-btn"></button></code></pre>
...
<li><p>Explore <a href="/api-reference/java/v2.0.x/About.md">Milvus Java API reference</a></p></li>
</ul>
