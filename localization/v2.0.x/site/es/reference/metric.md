...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.0.x/assets/euclidean_metric.png" alt="euclidean" class="doc-image" id="euclidean" />
    <span>euclidean</span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.0.x/assets/IP_formula.png" alt="ip" class="doc-image" id="ip" />
    <span>ip</span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.0.x/assets/normalize_formula.png" alt="normalize" class="doc-image" id="normalize" />
    <span>normalize</span>
  </span>
</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.0.x/assets/normalization_formula.png" alt="normalization" class="doc-image" id="normalization" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.0.x/assets/jaccard_coeff.png" alt="Jaccard similarity coefficient" class="doc-image" id="jaccard-similarity-coefficient" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.0.x/assets/jaccard_dist.png" alt="Jaccard distance" class="doc-image" id="jaccard-distance" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.0.x/assets/tanimoto_coeff.png" alt="tanimoto coefficient" class="doc-image" id="tanimoto-coefficient" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.0.x/assets/tanimoto_dist.png" alt="tanimoto distance" class="doc-image" id="tanimoto-distance" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.0.x/assets/superstructure.png" alt="superstructure" class="doc-image" id="superstructure" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.0.x/assets/substructure.png" alt="substructure" class="doc-image" id="substructure" />
