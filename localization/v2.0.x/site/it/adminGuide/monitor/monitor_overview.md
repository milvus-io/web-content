...
Currently Milvus uses the following components of Prometheus:</p>
<ul>
...
<h2 id="Grafana-in-Milvus" class="common-anchor-header">Grafana in Milvus<button data-href="#Grafana-in-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="https://grafana.com/docs/grafana/latest/introduction/">Grafana</a> is a visualizing stack. It features a dashboard that can help you visualize all the data and metrics you need. With the Grafana dashboard, you can query, understand, and analyze your data.</p>
...
<ul>
<li><a href="/docs/it/monitor.md">Deploy monitoring services</a></li>
<li><a href="/docs/it/visualize.md">Visualize Milvus metrics</a></li>
<li><a href="/docs/it/alert.md">Create an alert</a></li>
</ul>
