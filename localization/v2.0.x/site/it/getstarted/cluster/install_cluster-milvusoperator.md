...
title: ''
---
<div class="tab-wrapper"><a href="/docs/it/install_cluster-docker.md" class=''>Docker Compose</a><a href="/docs/it/install_cluster-helm.md" class=''>Helm</a><a href="/docs/it/install_cluster-milvusoperator.md" class='active '>Milvus Operator</a><a href="/docs/it/install_cluster-ansible.md" class=''>Ansible</a></div>
...
<li><a href="/docs/it/upgrade.md">Upgrade Milvus Using Helm Chart</a></li>
...
<li>Explore <a href="/docs/it/migrate_overview.md">MilvusDM</a>, an open-source tool designed for importing and exporting data in Milvus.</li>
