...
title: ''
---
<div class="tab-wrapper"><a href="/docs/de/attu_install-docker.md" class='active '>Install with Docker Compose</a><a href="/docs/de/attu_install-helm.md" class=''>Install with Helm Chart</a><a href="/docs/de/attu_install-package.md" class=''>Install with Package</a></div>
...
<li>Milvus installed on <a href="/docs/de/install_standalone-docker.md">your local device</a> or <a href="/docs/de/install_cluster-docker.md">cluster</a>.</li>
