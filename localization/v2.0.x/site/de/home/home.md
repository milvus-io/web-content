...
<ul>
<li>Added Milvus cluster installation guidance with <a href="/docs/de/install_cluster-ansible.md">Ansible</a>.</li>
...
<p><em>Mar 2022</em></p>
<ul>
<li>Added guidance on <a href="/docs/de/calculate_distance.md">distance calculation</a>.</li>
<li>Added documentation on how to <a href="/docs/de/load_partition.md">load</a> and <a href="/docs/de/release_partition.md">release</a> a partition.</li>
<li>Added Milvus <a href="/docs/de/benchmark.md">benchmark</a> report.</li>
</ul>
</div>
