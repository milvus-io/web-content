...
<p><strong>Suggestion</strong></p>
<p>For large data sets which are mostly stored in <a href="/docs/de/glossary.md#Segment">sealed segments</a>, adding query nodes to the cluster will increase QPS.</p>
