...
<p>To improve query performance, you can <a href="/docs/de/build_index.md">specify an index type</a> for each vector field.</p>
...
<p>To learn how to choose an appropriate metric for an index, see <a href="/docs/de/metric.md">Similarity Metrics</a>.</p>
...
<tbody>
<tr><td><code translate="no">metric_type</code></td><td>[Optional] The chosen distance metric.</td><td>See <a href="/docs/de/metric.md">Supported Metrics</a>.</td></tr>
</tbody>
</table>
</li>
</ul>
