...
<p>See <a href="/docs/de/configure_minio.md">MinIO/S3 Configurations</a> for more information.</p>
...
<ul>
<li><a href="/docs/de/gcp.md#Use-Google-Cloud-Storage">Use Google Cloud Storage</a></li>
<li><a href="/docs/de/azure.md#Use-Azure-Blob-Storage">Use Azure Blob Storage</a></li>
</ul>
