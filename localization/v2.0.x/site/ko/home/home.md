...
<ul>
<li>Added Milvus cluster installation guidance with <a href="/docs/ko/install_cluster-ansible.md">Ansible</a>.</li>
...
<p><em>Mar 2022</em></p>
<ul>
<li>Added guidance on <a href="/docs/ko/calculate_distance.md">distance calculation</a>.</li>
<li>Added documentation on how to <a href="/docs/ko/load_partition.md">load</a> and <a href="/docs/ko/release_partition.md">release</a> a partition.</li>
<li>Added Milvus <a href="/docs/ko/benchmark.md">benchmark</a> report.</li>
</ul>
</div>
