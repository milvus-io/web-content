...
<ul>
<li><a href="https://github.com/milvus-io/bootcamp/blob/master/solutions/nlp/recommender_system/quick_deploy">Quick deploy</a></li>
</ul>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.0.x/assets/recommendation_system.png" alt="recommender_system" class="doc-image" id="recommender_system" />
