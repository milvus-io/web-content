...
<ul>
<li><a href="/docs/fr/monitor.md">Deploy monitoring services</a></li>
<li><a href="/docs/fr/visualize.md">Visualize Milvus metrics</a></li>
<li><a href="/docs/fr/alert.md">Create an alert</a></li>
</ul>
