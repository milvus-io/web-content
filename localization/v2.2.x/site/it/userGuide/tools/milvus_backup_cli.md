...
<div class="tab-wrapper"><a href="/docs/it/attu_install-docker.md" class=''>Install with Docker Compose</a><a href="/docs/it/attu_install-helm.md" class=''>Install with Helm Chart</a><a href="/docs/it/attu_install-package.md" class=''>Install with Package</a></div>
...
<h2 id="Restore-data" class="common-anchor-header">Restore data<button data-href="#Restore-data" class="anchor-icon" translate="no">
    ...
    </button></h2><div class="tab-wrapper"><a href="/docs/it/attu_install-docker.md" class=''>Install with Docker Compose</a><a href="/docs/it/attu_install-helm.md" class=''>Install with Helm Chart</a><a href="/docs/it/attu_install-package.md" class=''>Install with Package</a></div>
