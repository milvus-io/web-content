...
<h3 id="Prerequisites" class="common-anchor-header">Prerequisites</h3><p>This tutorial assumes that you have Grafana installed and configured. If not, we recommend reading the <a href="/docs/pt/monitor.md">monitoring guide</a>.</p>
...
<ul>
<li>Read the <a href="/docs/pt/monitor.md">monitoring guide</a></li>
<li>Learn how to <a href="/docs/pt/visualize.md">visualize monitoring metrics</a></li>
</ul></li>
<li>If you have created alerts for memory usage by Milvus components:
<ul>
<li>Learn how to <a href="/docs/pt/allocate.md#standalone">allocate resources</a></li>
</ul></li>
<li>If you are looking for information about how to scale a Milvus cluster:
<ul>
<li>Learn <a href="/docs/pt/scaleout.md">scale a Milvus cluster</a></li>
</ul></li>
</ul>
