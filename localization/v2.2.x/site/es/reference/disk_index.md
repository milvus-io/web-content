...
<tr><td><code translate="no">LoadNumThreadRatio</code></td><td>Ratio between the number of threads used to load index/search and the number of CPUs. For details, refer to the first item in <a href="/docs/es/disk_index.md#references-and-facts">References and Facts</a>.</td><td>[1, 65536 / 32 / CPU number]</td><td>8.0</td></tr>
