...
<h1 id="Migrate-Data-from-Faiss-to-Milvus" class="common-anchor-header">Migrate Data from Faiss to Milvus<button data-href="#Migrate-Data-from-Faiss-to-Milvus" class="anchor-icon" translate="no">
    ...
    </button></h1><p>This topic describes how to import data from Faiss to Milvus using <a href="/docs/de/migrate_overview.md">MilvusDM</a>, an open-source tool specifically designed for Milvus data migration.</p>
...
<ul>
<li>Learn how to <a href="/docs/de/h2m.md">Migrate Data from HDF5 to Milvus</a>.</li>
</ul></li>
