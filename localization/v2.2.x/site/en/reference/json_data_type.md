...
<tr><td><strong>exists</strong></td><td><code translate="no">'exists json_field[&quot;A&quot;]'</code></td><td>This expression evaluates to true if <code translate="no">json_field</code> does not have a key named <code translate="no">A</code>.</td></tr>
...
<h2 id="Whats-next" class="common-anchor-header">What’s next<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="/docs/v2.2.x/dynamic_schema.md">Dynamic Schema</a></p>
