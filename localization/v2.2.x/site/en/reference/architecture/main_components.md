...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.2.x/assets/standalone_architecture.jpg" alt="Standalone_architecture" class="doc-image" id="standalone_architecture" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.2.x/assets/distributed_architecture.jpg" alt="Distributed_architecture" class="doc-image" id="distributed_architecture" />
...
<li>Read <a href="/docs/v2.2.x/four_layers.md">Computing/Storage Disaggregation</a> to understand the mechanism and design principle of Milvus.</li>
</ul>
