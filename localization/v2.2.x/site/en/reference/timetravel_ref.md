...
<h1 id="Time-Travel" class="common-anchor-header">Time Travel<button data-href="#Time-Travel" class="anchor-icon" translate="no">
    ...
    </button></h1><p>This topic introduces the Time Travel feature in detail. See <a href="/docs/v2.2.x/timetravel.md">Search with Time Travel</a> for more information about how to use this feature.</p>
...
<ul>
<li>Learn how to <a href="/docs/v2.2.x/timetravel.md">search with Time Travel</a></li>
<li>Learn the <a href="/docs/v2.2.x/architecture_overview.md">architecture</a> of Milvus.</li>
<li>Understand <a href="/docs/v2.2.x/data_processing.md">how data are processed</a> in Milvus.</li>
</ul>
