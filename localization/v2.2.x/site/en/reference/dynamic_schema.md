...
<h2 id="Whats-next" class="common-anchor-header">What’s next<button data-href="#Whats-next" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="/docs/v2.2.x/schema.md#Supported-data-type">Supported data types</a>
<a href="/docs/v2.2.x/boolean.md">Boolean express rules</a>
<a href="/docs/v2.2.x/json_data_type.md">JavaScript Object Notation (JSON)</a></p>
