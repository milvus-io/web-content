...
<li><p>Learn how <a href="/docs/v2.2.x/consistency.md">guarantee timestamp enables tunable consistency in Milvus</a></p></li>
<li><p>Learn how to <a href="/docs/v2.2.x/timetravel.md">search with Time Travel</a></p></li>
</ul>
