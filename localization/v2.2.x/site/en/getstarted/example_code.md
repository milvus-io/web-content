...
title: ''
---
<div class="tab-wrapper"><a href="/docs/v2.2.x/example_code.md" class='active '>Python</a></div>
...
<li><a href="/docs/v2.2.x/install_standalone-docker.md">Milvus 2.2.16</a></li>
<li>Python 3 (3.7.1 or later)</li>
<li><a href="/docs/v2.2.x/install-pymilvus.md">PyMilvus 2.2.x</a></li>
</ul>
