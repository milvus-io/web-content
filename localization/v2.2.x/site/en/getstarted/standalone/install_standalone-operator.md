...
title: ''
---
<div class="tab-wrapper"><a href="/docs/v2.2.x/install_standalone-docker.md" class=''>Docker Compose</a><a href="/docs/v2.2.x/install_standalone-operator.md" class='active '>Milvus Operator</a><a href="/docs/v2.2.x/install_standalone-helm.md" class=''>Helm</a></div>
...
<h2 id="Prerequisites" class="common-anchor-header">Prerequisites<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p><a href="/docs/v2.2.x/prerequisite-helm.md">Check the requirements for hardware and software</a> prior to your installation.</p>
...
<button class="copy-code-btn"></button></code></pre>
<p>When the Milvus is successfully installed, you can learn how to <a href="/docs/v2.2.x/manage_connection.md">Connect to Milvus server</a>.</p>
...
<ul>
<li>Check <a href="/docs/v2.2.x/example_code.md">Hello Milvus</a> to run an example code with different SDKs to see what Milvus can do.</li>
...
<li><a href="/docs/v2.2.x/upgrade_milvus_standalone-operator.md">Upgrade Milvus Using Milvus Operator</a></li>
<li>Explore <a href="/docs/v2.2.x/migrate_overview.md">MilvusDM</a>, an open-source tool designed for importing and exporting data in Milvus.</li>
<li><a href="/docs/v2.2.x/monitor.md">Monitor Milvus with Prometheus</a></li>
</ul>
