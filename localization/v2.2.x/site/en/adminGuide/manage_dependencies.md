...
<ul>
<li><a href="/docs/v2.2.x/deploy_s3.md">Configure object storage with Docker Compose/Helm</a></li>
...
<ul>
<li><a href="/docs/v2.2.x/deploy_etcd.md">Configure meta storage with Docker Compose/Helm</a></li>
...
<ul>
<li><a href="/docs/v2.2.x/deploy_pulsar.md">Configure message storage with Docker Compose/Helm</a></li>
