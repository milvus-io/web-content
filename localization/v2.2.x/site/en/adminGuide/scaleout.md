...
<p>This topic describes how to scale out and scale in a Milvus cluster. We assume that you have already <a href="/docs/v2.2.x/install_cluster-helm.md">installed a Milvus cluster</a> before scaling. Also, we recommend familiarizing yourself with the <a href="/docs/v2.2.x/architecture_overview.md">Milvus architecture</a> before you begin.</p>
...
<ul>
<li>Learn <a href="/docs/v2.2.x/monitor.md">Monitor Milvus with Prometheus Operator on Kubernetes</a></li>
</ul></li>
...
<ul>
<li><a href="/docs/v2.2.x/allocate.md#standalone">Allocate Resources on Kubernetes</a></li>
</ul></li>
</ul>
