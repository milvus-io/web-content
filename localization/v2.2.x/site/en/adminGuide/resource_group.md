...
<h3 id="Manage-resource-groups" class="common-anchor-header">Manage resource groups</h3><div class="alert note">
<p>All code samples on this page are in PyMilvus 2.2.x. Upgrade your PyMilvus installation before running them.</p>
</div>
<ol>
...
collection.load(replica_number=<span class="hljs-number">2</span>, _resource_group=resource_groups) 
...
collection.load([<span class="hljs-string">&quot;Novels&quot;</span>], replica_number=<span class="hljs-number">2</span>, _resource_group=resource_groups)
...
partition.load(replica_number=<span class="hljs-number">2</span>, _resource_group=resource_groups)
<button class="copy-code-btn"></button></code></pre>
<p>Note that <code translate="no">_resource_group</code> is an optional parameter, and leaving it unspecified have Milvus load the replicas onto the query nodes in the default resource group.</p>
...
<p>Milvus uses <a href="/docs/v2.2.x/replica.md">replicas</a> to achieve load-balancing among <a href="/docs/v2.2.x/glossary.md#Segment">segments</a> distributed across several query nodes. You can move certain replicas of a collection from one resource group to another as follows:</p>
<pre><code translate="no" class="language-Python">source = <span class="hljs-string">&#x27;__default_resource_group&#x27;</span>
target = <span class="hljs-string">&#x27;rg&#x27;</span>
...
<ul>
<li><a href="/docs/v2.2.x/rbac.md">Enable RBAC</a></li>
<li><a href="/docs/v2.2.x/users_and_roles.md">Users and roles</a></li>
</ul>
