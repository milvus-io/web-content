...
title: ''
---
<div class="tab-wrapper"><a href="/docs/ko/install_standalone-docker.md" class='active '>Docker Compose</a><a href="/docs/ko/install_standalone-operator.md" class=''>Milvus Operator</a><a href="/docs/ko/install_standalone-helm.md" class=''>Helm</a></div>
...
<h2 id="Prerequisites" class="common-anchor-header">Prerequisites<button data-href="#Prerequisites" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Check <a href="/docs/ko/prerequisite-docker.md">the requirements</a> for hardware and software prior to your installation.</p>
