...
<h3 id="Prerequisites" class="common-anchor-header">Prerequisites</h3><p>This tutorial assumes that you have Grafana installed and configured. If not, we recommend reading the <a href="/docs/ko/monitor.md">monitoring guide</a>.</p>
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.2.x/assets/alert_metric.png" alt="Alert_metric" class="doc-image" id="alert_metric" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.2.x/assets/alert_dashboard.png" alt="Alert_dashboard" class="doc-image" id="alert_dashboard" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.2.x/assets/alert_query.png" alt="Alert_query" class="doc-image" id="alert_query" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.2.x/assets/alert_notification.png" alt="Alert_notification" class="doc-image" id="alert_notification" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.2.x/assets/notification_message.png" alt="Notification_message" class="doc-image" id="notification_message" />
...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.2.x/assets/delete_alert.png" alt="Delete_alert" class="doc-image" id="delete_alert" />
...
<ul>
<li>Read the <a href="/docs/ko/monitor.md">monitoring guide</a></li>
<li>Learn how to <a href="/docs/ko/visualize.md">visualize monitoring metrics</a></li>
</ul></li>
<li>If you have created alerts for memory usage by Milvus components:
<ul>
<li>Learn how to <a href="/docs/ko/allocate.md#standalone">allocate resources</a></li>
</ul></li>
<li>If you are looking for information about how to scale a Milvus cluster:
<ul>
<li>Learn <a href="/docs/ko/scaleout.md">scale a Milvus cluster</a></li>
</ul></li>
</ul>
