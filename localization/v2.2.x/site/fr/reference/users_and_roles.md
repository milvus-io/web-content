...
<p>The following table lists the values you can choose when <a href="/docs/fr/rbac.md">enabling RBAC</a>.</p>
<table>
<thead>
...
<li>Learn how to <a href="/docs/fr/rbac.md">enable RBAC</a>.</li>
</ul>
