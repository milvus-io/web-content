...
![1566787785125](https://raw.githubusercontent.com/milvus-io/docs/v0.6.0/assets/monitoring/monitoring.png)

- Grafana

  Grafana 是一个开源的时序数据分析及可视化平台。Milvus 使用 Grafana 来展示各项性能指标：

  ![prometheus.png](https://raw.githubusercontent.com/milvus-io/docs/v0.6.0/assets/prometheus.png)
...
1. 下载 Milvus [Prometheus 配置文件](https://github.com/milvus-io/docs/blob/v0.6.0/assets/monitoring/prometheus.yml) 。
...
3. 下载 Milvus [报警规则文件](https://github.com/milvus-io/docs/blob/v0.6.0/assets/monitoring/alert.rules.yml) 到 Prometheus 根目录。
...
5. 下载 [Grafana 配置文件](https://github.com/milvus-io/docs/blob/v0.6.0/assets/monitoring/dashboard.json) :
