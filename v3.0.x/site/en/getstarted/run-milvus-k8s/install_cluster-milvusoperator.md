...
The command above deploys a Milvus cluster with **Woodpecker** as the message queue (recommended for v3.0.1) and all new architectural components including the Streaming Node. 
