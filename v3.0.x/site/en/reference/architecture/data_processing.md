...
![VChannel PChannel and StreamingNode](https://milvus-docs.s3.us-west-2.amazonaws.com/assets/pvchannel_wal.png "VChannel, PChannel and StreamingNode.")
...
![Channels 1](https://milvus-docs.s3.us-west-2.amazonaws.com/assets/channels_1.png "Each shard corresponds to a vchannel.")

Then the written data of one shard (*vchannel*) is sent to the corresponding Streaming Node of *pchannel*.

![write flow](https://milvus-docs.s3.us-west-2.amazonaws.com/assets/written_data_flow.png "Flow of write operation")
...
![Index building](https://milvus-docs.s3.us-west-2.amazonaws.com/assets/index_building.png "Index building in Milvus.")
...
![Data query](https://milvus-docs.s3.us-west-2.amazonaws.com/assets/data_query.jpg "Data query in Milvus.")
...
![Handoff](https://milvus-docs.s3.us-west-2.amazonaws.com/assets/handoff.png "Handoff in Milvus.")
