---
id: cdc_failover.md
summary: Learn how to perform a failover when the primary Milvus cluster becomes unavailable.
title: Failover
---
...
If the primary is still reachable, use [Switchover](cdc_switchover.md) instead. Switchover avoids data loss.
...
4. Keep `cluster-a` isolated until it is decommissioned or explicitly rebuilt.
