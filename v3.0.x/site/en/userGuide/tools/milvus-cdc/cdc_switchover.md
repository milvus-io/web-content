...
summary: Learn how to perform a planned switchover between primary and standby Milvus clusters with Milvus CDC.
title: Switchover
---
...
Do not use switchover if the primary is completely unavailable. In that case, use [Failover](cdc_failover.md).
