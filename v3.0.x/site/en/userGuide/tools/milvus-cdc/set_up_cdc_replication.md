...
summary: Learn how to deploy two Milvus clusters and configure CDC replication between them.
...
Before you begin, read [Milvus CDC](milvus_cdc_overview.md) to understand the primary-standby model and failover options.
