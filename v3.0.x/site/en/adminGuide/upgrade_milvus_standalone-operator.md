...
This guide describes how to upgrade a Milvus 2.6.x standalone deployment to v3.0.0 with Milvus Operator.
...
Verify that the Milvus CR reports `Healthy`, the current image is `milvusdb/milvus:v3.0.0`, and the existing collections remain queryable and searchable. Complete these checks before you enable any v3.0.0-specific feature.
