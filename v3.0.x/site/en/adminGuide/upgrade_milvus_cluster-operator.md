...
This guide describes how to upgrade your Milvus cluster from v2.5.x to v3.0-beta using Milvus Operator.
...
- You **must** upgrade to v2.5.16 or later with `mixCoord` enabled before upgrading to v3.0-beta.
...
#### 2.3 Upgrade to v3.0-beta

Once v2.5.16 is running successfully with `mixCoord`, upgrade to v3.0-beta:
