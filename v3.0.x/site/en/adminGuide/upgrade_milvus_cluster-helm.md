...
This guide describes how to upgrade your Milvus cluster from v2.5.x to v3.0-beta using Helm Chart.
...
- You **must** upgrade to v2.5.16 or later with `mixCoordinator` enabled before upgrading to v3.0-beta.
...
Once v2.5.16 is running successfully with `mixCoordinator`, upgrade to v3.0-beta:
