...
This guide describes how to upgrade your Milvus 2.6.x cluster to v3.0.0 using Helm.
...
Verify that all required workloads are ready, all Milvus components use `v3.0.0`, and your existing collections remain queryable and searchable. Complete these checks before you enable any v3.0.0-specific feature.
<div class="alert note">
