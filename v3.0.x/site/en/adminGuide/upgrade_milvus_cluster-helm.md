...
This guide describes how to upgrade your Milvus 2.6.x cluster to v3.0.1 using Helm.
...
Verify that all required workloads are ready, all Milvus components use `v3.0.1`, and your existing collections remain queryable and searchable. Complete these checks before you enable any v3.0.1-specific feature.
<div class="alert note">
