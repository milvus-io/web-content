...
This guide describes how to upgrade your Milvus 2.6.x cluster to v3.0.2 using Helm.
...
Verify that all required workloads are ready, all Milvus components use `v3.0.2`, and your existing collections remain queryable and searchable. Complete these checks before you enable any v3.0.2-specific feature.
<div class="alert note">
