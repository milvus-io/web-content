...
```bash
$ wget https://github.com/milvus-io/milvus/releases/download/v2.1.2/milvus_2.1.2-1_amd64.deb
$ sudo apt-get update
$ sudo dpkg -i milvus_2.1.2-1_amd64.deb
...
```bash
$ sudo yum install https://github.com/milvus-io/milvus/releases/download/v2.1.2/milvus-2.1.2-1.el7.x86_64.rpm
```
