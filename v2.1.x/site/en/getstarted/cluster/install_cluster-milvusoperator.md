...
helm install milvus-operator \
  ...
  --wait --wait-for-jobs \
  https://github.com/milvus-io/milvus-operator/releases/download/v0.6.2/milvus-operator-0.6.2.tgz
```
...
```
$ kubectl delete -f https://raw.githubusercontent.com/milvus-io/milvus-operator/v0.6.2/deploy/manifests/deployment.yaml
```
