...
<details>
    ...
    <table class="terminology">
        ...
        <tbody>
            ...
            <tr>
                <td>nprobe</td>
                <td>A search parameter specific to <a href="https://milvus.io/docs/v2.1.0/index.md">IVF indexes</a></td>
            </tr>
            <tr>
                <td>ef</td>
                <td>A search parameter specific to <a href="https://milvus.io/docs/v2.1.0/index.md">HNSW index</a></td>
            </tr>
        </tbody>
    </table>
</details>
...
- Milvus instance (standalone or cluster) in each test is deployed via [Helm](https://milvus.io/docs/v2.1.0/install_standalone-helm.md) on a Kubernetes cluster based on physical or virtual machines.
