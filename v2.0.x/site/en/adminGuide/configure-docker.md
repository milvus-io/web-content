...
This topic describes how to configure your Milvus with Docker Compose.
...
[Download](https://raw.githubusercontent.com/milvus-io/milvus/v2.0.2/configs/milvus.yaml) `milvus.yaml` directly or with the following command.
...
Download the installation file for Milvus [standalone](https://github.com/milvus-io/milvus/releases/download/v2.0.2/milvus-standalone-docker-compose.yml) or [cluster](https://github.com/milvus-io/milvus/releases/download/v2.0.2/milvus-cluster-docker-compose.yml), and save it as `docker-compose.yml`.
