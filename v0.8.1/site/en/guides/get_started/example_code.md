...
3. Download Python example code.
   ...
   $ wget https://raw.githubusercontent.com/milvus-io/pymilvus/0.2.10/examples/example.py
   ```
   
    > Note: If you cannot use `wget` to download the example code, you can also create `example.py` and copy the [example code](https://github.com/milvus-io/pymilvus/blob/0.2.10/examples/example.py).
