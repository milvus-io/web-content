...
1. Go to the Prometheus root directory, and download starter [Prometheus configuration file](https://github.com/milvus-io/docs/blob/v0.8.1/assets/monitoring/prometheus.yml) for Milvus.
...
3. Download starter [alerting rules](https://github.com/milvus-io/docs/blob/v0.8.1/assets/monitoring/alert_rules.yml) for Milvus to the Prometheus root directory.
...
5. Download the starter [Grafana dashboard](https://github.com/milvus-io/docs/blob/v0.8.1/assets/monitoring/dashboard.json) for Milvus:
