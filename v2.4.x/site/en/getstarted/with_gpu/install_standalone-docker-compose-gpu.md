...
[Download](https://github.com/milvus-io/milvus/releases/download/v2.4.3/milvus-standalone-docker-compose-gpu.yml) `milvus-standalone-docker-compose-gpu.yml` and save it as `docker-compose.yml` manually, or with the following command.

  ```
  $ wget https://github.com/milvus-io/milvus/releases/download/v2.4.3/milvus-standalone-docker-compose-gpu.yml -O docker-compose.yml
  ```
