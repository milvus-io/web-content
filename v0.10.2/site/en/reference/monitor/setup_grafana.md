...
5. Download the starter [Grafana dashboard](https://github.com/milvus-io/docs/blob/v0.10.2/assets/monitoring/dashboard.json) for Milvus:
...
You can use the [Grafana dashboard](https://github.com/milvus-io/docs/blob/v0.10.2/assets/monitoring/dashboard.json) for Milvus to configure the following metrics areas displayed on the dashboard:
