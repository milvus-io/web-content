...
3. Download Python example code.
   ...
   $ wget https://raw.githubusercontent.com/milvus-io/pymilvus/0.4.0/examples/example.py
   ```

   <div class="alert note">
   If you cannot use <code>wget</code> to download the example code, you can also create <b>example.py</b> and copy the <a href="https://github.com/milvus-io/pymilvus/blob/0.4.0/examples/example.py">example code.</a>
   </div>
